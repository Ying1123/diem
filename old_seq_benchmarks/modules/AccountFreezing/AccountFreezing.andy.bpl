...
procedure {:timeLimit 40} $1_DiemTimestamp_update_global_time$verify(_$t0: int, _$t1: int, _$t2: int) returns ()
{
    ...
    // @108 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:9+52
...
L5:
    ...
    // assert Implies(DiemTimestamp::$is_operating(), exists<AccountFreezing::FreezeEventsHolder>(a550c18)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:191:9+94
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:191:9+94
    assume {:print "$at(4,7405,7499)"} true;
    assert {:msg "assert_failed(4,7405,7499): global memory invariant does not hold"}
    ...
    // assert Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(a550c18)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:199:9+94
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:199:9+94
    assume {:print "$at(4,7693,7787)"} true;
    assert {:msg "assert_failed(4,7693,7787): global memory invariant does not hold"}
    ...
    // assert Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(b1e55ed)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:204:9+104
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:204:9+104
    assume {:print "$at(4,7952,8056)"} true;
    assert {:msg "assert_failed(4,7952,8056): global memory invariant does not hold"}
    ...
    // assert Implies(DiemTimestamp::$is_operating(), exists<AccountFreezing::FreezeEventsHolder>(a550c18)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:211:9+89
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:211:9+89
    assume {:print "$at(4,8312,8401)"} true;
    assert {:msg "assert_failed(4,8312,8401): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory, 173345816));
...
L7:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@108]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
...
L8:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_operating[@108]()), Neq<address>(Signer::spec_address_of[]($t0), 0)), (if Eq<address>($t1, 0) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}})) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:74:5+745
    assume {:print "$at(17,3378,4123)"} true;
    assert {:msg "assert_failed(17,3378,4123): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#108) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 0)) || if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)));

    // assert Or(Or(And(Not(DiemTimestamp::$is_operating[@108]()), Eq(1, $t11)), And(Neq<address>(Signer::spec_address_of[]($t0), 0), Eq(2, $t11))), And((if Eq<address>($t1, 0) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}}), Eq(7, $t11))) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:74:5+745
    assert {:msg "assert_failed(17,3378,4123): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#108) && $IsEqual'u8'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 0) && $IsEqual'u8'(2, $t11))) || (if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'u8'(7, $t11)));
...
L8:
    ...
    // @150 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@150](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
...
L7:
    ...
    // @184 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@184](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
...
L6:
    ...
    // @156 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@156](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
...
L7:
    ...
    // @174 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@174](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
...
// fun AccountFreezing::initialize [verification] at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:47:5+508
procedure {:timeLimit 40} $1_AccountFreezing_initialize$verify(_$t0: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(a550c18)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:47:5+508
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(4,1651,2159)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountFreezing::FreezeEventsHolder>(a550c18)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:47:5+508
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:191:9+94
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(a550c18)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:47:5+508
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:199:9+94
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(b1e55ed)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:47:5+508
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:204:9+104
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, 186537453));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:47:5+508
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:47:5+508
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<AccountFreezing::FreezeEventsHolder>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:47:5+508
    ...
    // @140 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:47:5+1
    assume {:print "$at(4,1651,1652)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#140 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @141 := save_mem(AccountFreezing::FreezeEventsHolder) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:47:5+1
    $1_AccountFreezing_FreezeEventsHolder_$memory#141 := $1_AccountFreezing_FreezeEventsHolder_$memory;

    // @142 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:47:5+1
...
L2:
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@140]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:140:9+51
    ...
    // assert Not(exists[@141]<AccountFreezing::FreezeEventsHolder>($t3)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:63:9+74
    assume {:print "$at(4,2370,2444)"} true;
    assert {:msg "assert_failed(4,2370,2444): function does not abort under this condition"}
      !$ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory#141, $t3);

    // assert exists<AccountFreezing::FreezeEventsHolder>($t3) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:64:9+41
    assume {:print "$at(4,2453,2494)"} true;
    assert {:msg "assert_failed(4,2453,2494): post-condition does not hold"}
...
L3:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_genesis[@140]()), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), exists[@141]<AccountFreezing::FreezeEventsHolder>($t3)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:59:5+336
    assume {:print "$at(4,2164,2500)"} true;
    assert {:msg "assert_failed(4,2164,2500): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#140) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || $ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory#141, $t3));

    // assert Or(Or(And(Not(DiemTimestamp::$is_genesis[@140]()), Eq(1, $t5)), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t5))), And(exists[@141]<AccountFreezing::FreezeEventsHolder>($t3), Eq(6, $t5))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:59:5+336
    assert {:msg "assert_failed(4,2164,2500): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#140) && $IsEqual'u8'(1, $t5)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t5))) || ($ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory#141, $t3) && $IsEqual'u8'(6, $t5)));

    // abort($t5) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:59:5+336
    $abort_code := $t5;
    $abort_flag := true;
    return;
...
// fun AccountFreezing::account_is_frozen [verification] at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:159:5+163
procedure {:timeLimit 40} $1_AccountFreezing_account_is_frozen$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(a550c18)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:159:5+163
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:199:9+94
    assume {:print "$at(4,6371,6534)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(b1e55ed)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:159:5+163
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:204:9+104
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, 186537453));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:166:17+6
    assume {:print "$at(4,6635,6641)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<AccountFreezing::FreezingBit>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:166:17+6
    ...
    // @90 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:159:5+1
    assume {:print "$at(4,6371,6372)"} true;
    $1_AccountFreezing_FreezingBit_$memory#90 := $1_AccountFreezing_FreezingBit_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:159:5+1
    assume {:print "$track_local(29,0,0):", $t0} $t0 == $t0;

    // $t2 := exists<AccountFreezing::FreezingBit>($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+6
    assume {:print "$at(4,6456,6462)"} true;
    $t2 := $ResourceExists($1_AccountFreezing_FreezingBit_$memory, $t0);

    // if ($t2) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
    if ($t2) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:65+4
L0:

    // $t3 := get_global<AccountFreezing::FreezingBit>($t0) on_abort goto L5 with $t4 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:38+13
    ...
    if ($abort_flag) {
        assume {:print "$at(4,6485,6498)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(29,0):", $t4} $t4 == $t4;
        goto L5;
    }

    // $t5 := get_field<AccountFreezing::FreezingBit>.is_frozen($t3) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:38+42
    $t5 := $is_frozen#$1_AccountFreezing_FreezingBit($t3);

    // $t1 := $t5 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
    $t1 := $t5;

    // trace_local[tmp#$1]($t5) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
    assume {:print "$track_local(29,0,1):", $t5} $t5 == $t5;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
L2:

    // $t6 := false at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
    $t6 := false;
    assume $IsValid'bool'($t6);

    // $t1 := $t6 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
    $t1 := $t6;

    // trace_local[tmp#$1]($t6) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
    assume {:print "$track_local(29,0,1):", $t6} $t6 == $t6;

    // label L3 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
L3:

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:9+71
    assume {:print "$track_return(29,0,0):", $t1} $t1 == $t1;

    // label L4 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:162:6+1
    assume {:print "$at(4,6533,6534)"} true;
L4:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:164:9+16
    assume {:print "$at(4,6572,6588)"} true;
    assert {:msg "assert_failed(4,6572,6588): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, AccountFreezing::spec_account_is_frozen($t0)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:166:9+47
    assume {:print "$at(4,6627,6674)"} true;
    assert {:msg "assert_failed(4,6627,6674): post-condition does not hold"}
    ...
    // return $t1 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:221:9+159
    $ret0 := $t1;
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:162:6+1
    assume {:print "$at(4,6533,6534)"} true;
L5:

    // assert false at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:5+141
    assume {:print "$at(4,6539,6680)"} true;
    assert {:msg "assert_failed(4,6539,6680): abort not covered by any of the `aborts_if` clauses"}
      false;

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:5+141
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun AccountFreezing::assert_not_frozen [verification] at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:170:5+160
procedure {:timeLimit 40} $1_AccountFreezing_assert_not_frozen$verify(_$t0: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(a550c18)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:170:5+160
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:199:9+94
    assume {:print "$at(4,6732,6892)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(b1e55ed)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:170:5+160
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:204:9+104
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, 186537453));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:170:5+160
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<AccountFreezing::FreezingBit>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:170:5+160
    assume (forall $a_0: int :: {$ResourceValue($1_AccountFreezing_FreezingBit_$memory, $a_0)}(var $rsc := $ResourceValue($1_AccountFreezing_FreezingBit_$memory, $a_0);
    ($IsValid'$1_AccountFreezing_FreezingBit'($rsc))));

    // @91 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:170:5+1
    $1_AccountFreezing_FreezingBit_$memory#91 := $1_AccountFreezing_FreezingBit_$memory;

    // trace_local[account]($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:170:5+1
    assume {:print "$track_local(29,1,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:17+26
    // >> opaque call: $t3 := AccountFreezing::account_is_frozen($t0)
    assume {:print "$at(4,6818,6844)"} true;

    // $t3 := opaque begin: AccountFreezing::account_is_frozen($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:17+26

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:17+26
    assume $IsValid'bool'($t3);

    // assume Eq<bool>($t3, AccountFreezing::spec_account_is_frozen($t0)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:17+26
    assume $IsEqual'bool'($t3, $1_AccountFreezing_spec_account_is_frozen($1_AccountFreezing_FreezingBit_$memory, $t0));

    // $t3 := opaque end: AccountFreezing::account_is_frozen($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:17+26

    // $t4 := !($t3) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:16+1
    call $t4 := $Not($t3);

    // $t5 := 5 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:67+15
    $t5 := 5;
    assume $IsValid'u64'($t5);

    // nop at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:45+38
    // >> opaque call: $t6 := Errors::invalid_state($t5)

    // $t6 := opaque begin: Errors::invalid_state($t5) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:45+38

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:45+38
    assume $IsValid'u64'($t6);

    // assume Eq<u64>($t6, 1) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:45+38
    assume $IsEqual'u64'($t6, 1);

    // $t6 := opaque end: Errors::invalid_state($t5) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:45+38

    // trace_local[tmp#$2]($t6) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:9+75
    assume {:print "$track_local(29,1,2):", $t6} $t6 == $t6;

    // trace_local[tmp#$1]($t4) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:9+75
    assume {:print "$track_local(29,1,1):", $t4} $t4 == $t4;

    // if ($t4) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:9+75
    if ($t4) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:9+75
L1:

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:9+75
    assume {:print "$at(4,6810,6885)"} true;
    assume {:print "$track_abort(29,1):", $t6} $t6 == $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:9+75
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:171:84+1
L0:

    // label L2 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:172:5+1
    assume {:print "$at(4,6891,6892)"} true;
L2:

    // assert Not(AccountFreezing::spec_account_is_frozen[@91]($t0)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:179:9+69
    ...
    // label L3 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:172:5+1
    assume {:print "$at(4,6891,6892)"} true;
L3:

    // assert AccountFreezing::spec_account_is_frozen[@91]($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:5+85
    assume {:print "$at(4,6897,6982)"} true;
    assert {:msg "assert_failed(4,6897,6982): abort not covered by any of the `aborts_if` clauses"}
      $1_AccountFreezing_spec_account_is_frozen($1_AccountFreezing_FreezingBit_$memory#91, $t0);

    // assert And(AccountFreezing::spec_account_is_frozen[@91]($t0), Eq(1, $t6)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:5+85
    assert {:msg "assert_failed(4,6897,6982): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ($1_AccountFreezing_spec_account_is_frozen($1_AccountFreezing_FreezingBit_$memory#91, $t0) && $IsEqual'u8'(1, $t6));

    // abort($t6) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:5+85
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
procedure {:timeLimit 40} $1_AccountFreezing_create$verify(_$t0: int) returns ()
{
    ...
    // @92 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:74:9+35
...
L0:
    ...
    // @236 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:67:5+236
    ...
    // assert forall addr: TypeDomain<address>() where exists[@236]<AccountFreezing::FreezingBit>(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:208:9+102
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:208:9+102
    assume {:print "$at(4,8115,8217)"} true;
    assert {:msg "assert_failed(4,8115,8217): global memory invariant does not hold"}
...
L2:
    ...
    // assert Not(exists[@92]<AccountFreezing::FreezingBit>($t4)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:75:9+67
...
L3:
    ...
    // assert exists[@92]<AccountFreezing::FreezingBit>($t4) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:72:5+242
    assume {:print "$at(4,2747,2989)"} true;
    assert {:msg "assert_failed(4,2747,2989): abort not covered by any of the `aborts_if` clauses"}
      $ResourceExists($1_AccountFreezing_FreezingBit_$memory#92, $t4);

    // assert And(exists[@92]<AccountFreezing::FreezingBit>($t4), Eq(6, $t10)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:72:5+242
...
procedure {:timeLimit 40} $1_AccountFreezing_freeze_account$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // @124 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:80:5+1
    ...
    // @125 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:80:5+1
    $1_Roles_RoleId_$memory#125 := $1_Roles_RoleId_$memory;

    // @126 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:80:5+1
...
L11:
    ...
    assume (((!$ResourceExists($1_Roles_RoleId_$memory, $t15) && $IsEqual'u8'(5, $t14)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t15)), 1) && $IsEqual'u8'(3, $t14))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t14)));
...
L4:
    ...
    // @238 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:80:5+977
    // state save for global update invariants
    assume {:print "$at(4,3033,4010)"} true;
    ...
    // assert forall addr: TypeDomain<address>() where exists[@238]<AccountFreezing::FreezingBit>(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:208:9+102
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:208:9+102
    assume {:print "$at(4,8115,8217)"} true;
    assert {:msg "assert_failed(4,8115,8217): global memory invariant does not hold"}
...
L6:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@124]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
    assume {:print "$at(17,6375,6428)"} true;
    assert {:msg "assert_failed(17,6375,6428): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#124);

    // assert Not(Not(exists[@125]<Roles::RoleId>($t9))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t9)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    ...
    // assert Not(Not(exists[@126]<AccountFreezing::FreezingBit>($t1))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:106:9+74
...
L7:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_operating[@124]()), Not(exists[@125]<Roles::RoleId>($t9))), Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t9)), 1)), Neq<address>(Signer::spec_address_of[]($t0), b1e55ed)), Eq<address>($t1, a550c18)), Eq<address>($t1, b1e55ed)), Not(exists[@126]<AccountFreezing::FreezingBit>($t1))), Not(exists[@125]<Roles::RoleId>($t12))), Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t12)), 1)), Neq<address>(Signer::spec_address_of[]($t0), b1e55ed)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:101:5+473
    assume {:print "$at(4,4015,4488)"} true;
    assert {:msg "assert_failed(4,4015,4488): abort not covered by any of the `aborts_if` clauses"}
      (((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#124) || !$ResourceExists($1_Roles_RoleId_$memory#125, $t9)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t9)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453)) || $IsEqual'address'($t1, 173345816)) || $IsEqual'address'($t1, 186537453)) || !$ResourceExists($1_AccountFreezing_FreezingBit_$memory#126, $t1)) || !$ResourceExists($1_Roles_RoleId_$memory#125, $t12)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t12)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@124]()), Eq(1, $t14)), And(Not(exists[@125]<Roles::RoleId>($t9)), Eq(5, $t14))), And(Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t9)), 1), Eq(3, $t14))), And(Neq<address>(Signer::spec_address_of[]($t0), b1e55ed), Eq(2, $t14))), And(Eq<address>($t1, a550c18), Eq(7, $t14))), And(Eq<address>($t1, b1e55ed), Eq(7, $t14))), And(Not(exists[@126]<AccountFreezing::FreezingBit>($t1)), Eq(5, $t14))), And(Not(exists[@125]<Roles::RoleId>($t12)), Eq(5, $t14))), And(Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t12)), 1), Eq(3, $t14))), And(Neq<address>(Signer::spec_address_of[]($t0), b1e55ed), Eq(2, $t14))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:101:5+473
    assert {:msg "assert_failed(4,4015,4488): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#124) && $IsEqual'u8'(1, $t14)) || (!$ResourceExists($1_Roles_RoleId_$memory#125, $t9) && $IsEqual'u8'(5, $t14))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t9)), 1) && $IsEqual'u8'(3, $t14))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t14))) || ($IsEqual'address'($t1, 173345816) && $IsEqual'u8'(7, $t14))) || ($IsEqual'address'($t1, 186537453) && $IsEqual'u8'(7, $t14))) || (!$ResourceExists($1_AccountFreezing_FreezingBit_$memory#126, $t1) && $IsEqual'u8'(5, $t14))) || (!$ResourceExists($1_Roles_RoleId_$memory#125, $t12) && $IsEqual'u8'(5, $t14))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t12)), 1) && $IsEqual'u8'(3, $t14))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t14)));
...
procedure {:timeLimit 40} $1_AccountFreezing_unfreeze_account$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // @121 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:122:5+1
    ...
    // @122 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:122:5+1
    $1_Roles_RoleId_$memory#122 := $1_Roles_RoleId_$memory;

    // @123 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:122:5+1
...
L7:
    ...
    assume (((!$ResourceExists($1_Roles_RoleId_$memory, $t11) && $IsEqual'u8'(5, $t10)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t11)), 1) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t10)));
...
L0:
    ...
    // @237 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:122:5+740
    // state save for global update invariants
    assume {:print "$at(4,4887,5627)"} true;
    ...
    // assert forall addr: TypeDomain<address>() where exists[@237]<AccountFreezing::FreezingBit>(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:208:9+102
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:208:9+102
    assume {:print "$at(4,8115,8217)"} true;
    assert {:msg "assert_failed(4,8115,8217): global memory invariant does not hold"}
...
L2:
    ...
    // assert Not(Not(exists[@122]<Roles::RoleId>($t5))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    assume {:print "$at(26,23933,23992)"} true;
    assert {:msg "assert_failed(26,23933,23992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#122, $t5);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t5)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    assume {:print "$at(26,24001,24098)"} true;
    assert {:msg "assert_failed(26,24001,24098): function does not abort under this condition"}
    ...
    // assert Not(Not(exists[@123]<AccountFreezing::FreezingBit>($t1))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:143:9+76
    ...
    // assert Not(Not(exists[@122]<Roles::RoleId>($t8))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    assume {:print "$at(26,23933,23992)"} true;
    assert {:msg "assert_failed(26,23933,23992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#122, $t8);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t8)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    assume {:print "$at(26,24001,24098)"} true;
    assert {:msg "assert_failed(26,24001,24098): function does not abort under this condition"}
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_operating[@121]()), Not(exists[@122]<Roles::RoleId>($t5))), Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t5)), 1)), Neq<address>(Signer::spec_address_of[]($t0), b1e55ed)), Not(exists[@123]<AccountFreezing::FreezingBit>($t1))), Not(exists[@122]<Roles::RoleId>($t8))), Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t8)), 1)), Neq<address>(Signer::spec_address_of[]($t0), b1e55ed)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:140:5+318
    assume {:print "$at(4,5632,5950)"} true;
    assert {:msg "assert_failed(4,5632,5950): abort not covered by any of the `aborts_if` clauses"}
      (((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#121) || !$ResourceExists($1_Roles_RoleId_$memory#122, $t5)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t5)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453)) || !$ResourceExists($1_AccountFreezing_FreezingBit_$memory#123, $t1)) || !$ResourceExists($1_Roles_RoleId_$memory#122, $t8)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t8)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453));

    // assert Or(Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@121]()), Eq(1, $t10)), And(Not(exists[@122]<Roles::RoleId>($t5)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t5)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t0), b1e55ed), Eq(2, $t10))), And(Not(exists[@123]<AccountFreezing::FreezingBit>($t1)), Eq(5, $t10))), And(Not(exists[@122]<Roles::RoleId>($t8)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t8)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t0), b1e55ed), Eq(2, $t10))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:140:5+318
    assert {:msg "assert_failed(4,5632,5950): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#121) && $IsEqual'u8'(1, $t10)) || (!$ResourceExists($1_Roles_RoleId_$memory#122, $t5) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t5)), 1) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t10))) || (!$ResourceExists($1_AccountFreezing_FreezingBit_$memory#123, $t1) && $IsEqual'u8'(5, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#122, $t8) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t8)), 1) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t10)));
...
L7:
    ...
    // @168 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@168](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
...
L7:
    ...
    // @162 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@162](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
