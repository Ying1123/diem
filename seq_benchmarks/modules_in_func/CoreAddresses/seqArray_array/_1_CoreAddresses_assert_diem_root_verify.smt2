...
(assert (not
 (=> (= (ControlFlow 0 0) 12588) (let ((anon4_Else_correct@@0  (=> (and (not $t5@0@@0) (= $t7@@0 $t7@@0)) (and (=> (= (ControlFlow 0 11368) (- 0 12726)) (not (= (|$addr#$signer| _$t0@@0) 173345816))) (=> (not (= (|$addr#$signer| _$t0@@0) 173345816)) (=> (= (ControlFlow 0 11368) (- 0 12735)) (and (not (= (|$addr#$signer| _$t0@@0) 173345816)) (= 2 $t7@@0))))))))
(let ((anon4_Then_correct@@0  (=> (and $t5@0@@0 (= (ControlFlow 0 11388) (- 0 12699))) (not (not (= (|$addr#$signer| _$t0@@0) 173345816))))))
(let ((anon0$1_correct@@0  (=> (|$IsValid'address'| (|$addr#$signer| _$t0@@0)) (=> (and (= _$t0@@0 _$t0@@0) (|$IsValid'address'| $t3@@0)) (=> (and (and (and (= $t3@@0 (|$addr#$signer| _$t0@@0)) (|$IsValid'address'| 173345816)) (and (= $t5@0@@0 (= $t3@@0 173345816)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t7@@0) (= $t7@@0 2)) (and (= $t7@@0 $t7@@0) (= $t5@0@@0 $t5@0@@0)))) (and (=> (= (ControlFlow 0 11320) 11388) anon4_Then_correct@@0) (=> (= (ControlFlow 0 11320) 11368) anon4_Else_correct@@0)))))))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 12588) 11320) anon0$1_correct@@0)))
anon0_correct@@0)))))
))
(check-sat)
(pop 1)
