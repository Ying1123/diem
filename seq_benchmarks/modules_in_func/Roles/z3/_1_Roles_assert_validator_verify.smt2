...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 280295) (let ((anon15_Then_correct  (=> $t14@0 (and (=> (= (ControlFlow 0 200009) (- 0 280618)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 200009) (- 0 280631)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3))) (and (=> (= (ControlFlow 0 200009) (- 0 280650)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0))))
 :qid |Rolesbpl.6277:15|
 :skolemid |167|
 ...
 :qid |Rolesbpl.6297:15|
 :skolemid |172|
)) (=> (= (ControlFlow 0 200009) (- 0 280944)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6))))
 :qid |Rolesbpl.6301:15|
 :skolemid |173|
))))))))))))))))))))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 199520) (- 0 281024)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3))) (=> (= (ControlFlow 0 199520) (- 0 281048)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (= 5 $t10@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3)) (= 3 $t10@0))))))))
(let ((anon15_Else_correct  (=> (and (and (not $t14@0) (= $t16 $t16)) (and (= $t10@0 $t16) (= (ControlFlow 0 199610) 199520))) L5_correct)))
(let ((anon14_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= $t12@0 (|$role_id#$1_Roles_RoleId| $t11@1)) (|$IsValid'u64'| 3)) (and (= $t14@0 (= $t12@0 3)) (|$IsValid'u64'| 7))) (and (and (|$IsValid'u64'| $t16) (= $t16 3)) (and (= $t16 $t16) (= $t14@0 $t14@0)))) (and (=> (= (ControlFlow 0 199594) 200009) anon15_Then_correct) (=> (= (ControlFlow 0 199594) 199610) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 200023) 199520))) L5_correct)))
(let ((anon13_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 200075) 200023) anon14_Then_correct) (=> (= (ControlFlow 0 200075) 199594) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) (= (ControlFlow 0 200073) 200075)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6) (=> (and (and (= $t11@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 199538) 200023) anon14_Then_correct) (=> (= (ControlFlow 0 199538) 199594) anon14_Else_correct))))))
(let ((anon12_Then_correct  (=> $t7@0 (and (=> (= (ControlFlow 0 199524) 200073) anon13_Then_correct) (=> (= (ControlFlow 0 199524) 199538) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not $t7@0) (= $t9 $t9)) (and (= $t10@0 $t9) (= (ControlFlow 0 199440) 199520))) L5_correct)))
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Rolesbpl.6120:20|
 :skolemid |166|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $a_0))
))) (and (= _$t0 _$t0) (|$IsValid'address'| $t6))) (=> (and (and (and (= $t6 (|$addr#$signer| _$t0)) (= $t6 $t6)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= $t7@0 $t7@0)))) (and (=> (= (ControlFlow 0 199424) 199524) anon12_Then_correct) (=> (= (ControlFlow 0 199424) 199440) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_83264_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 199320) 199424)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 280295) 199320) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))
))
(check-sat)
(pop 1)
