...
(declare-fun _$t2@@3 () T@Vec_29042)
(declare-fun _$t0@@13 () Int)
(declare-fun _$t3@@2 () T@Vec_29042)
(declare-fun _$t4@@2 () Int)
(declare-fun $t17@0@@0 () Int)
(declare-fun $t39 () Int)
(declare-fun $t23@@1 () T@Vec_29042)
(declare-fun $t36 () T@Vec_29042)
(declare-fun inline$$Not$1$dst@1 () Bool)
(declare-fun $t35 () Int)
(declare-fun |inline$$1_Vector_is_empty'u8'$1$b@1| () Bool)
(declare-fun $t30 () T@Vec_29042)
...
(declare-fun $t8@0@@4 () T@Vec_29042)
...
(declare-fun $t8@0@@5 () T@Vec_29042)
...
; Valid
(declare-fun $t3@2 () T@Vec_29042)
(declare-fun |inline$$1_Vector_append'u8'$2$m'@1| () T@$Mutation_118865)
(declare-fun $t9@0 () T@$Mutation_118865)
(declare-fun $t10@0@@0 () T@Vec_29042)
(declare-fun $t3@1 () T@Vec_29042)
(declare-fun |inline$$1_Vector_append'u8'$1$m'@1| () T@$Mutation_118865)
(declare-fun $t7@0@@2 () T@$Mutation_118865)
(declare-fun call1formal@res@0 () T@Vec_29042)
(declare-fun $t3@0@@2 () T@Vec_29042)
(declare-fun |inline$$1_Vector_append'u8'$0$m'@1| () T@$Mutation_118865)
(declare-fun _$t2@@4 () Int)
(declare-fun $t4@0 () T@$Mutation_118865)
(declare-fun call1formal@res@0@@0 () T@Vec_29042)
(declare-fun _$t0@@17 () Int)
(declare-fun _$t1@@11 () T@Vec_29042)
(declare-fun $t4@@7 () T@$Mutation_118865)
(declare-fun $t7@@5 () T@$Mutation_118865)
(declare-fun $t9@@8 () T@$Mutation_118865)
; Valid
...
(assert (not
 (=> (= (ControlFlow 0 0) 336573) (let ((L15_correct@@0  (and (=> (= (ControlFlow 0 251513) (- 0 337603)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 1) _$t2@@6 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 2) (div _$t2@@6 2) (+ 18446744073709551615 1)))) 18446744073709551615))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 1) _$t2@@6 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 2) (div _$t2@@6 2) (+ 18446744073709551615 1)))) 18446744073709551615)) (=> (= (ControlFlow 0 251513) (- 0 337626)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (= 5 $t11@@4)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t11@@4))) (and (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 1) _$t2@@6 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 2) (div _$t2@@6 2) (+ 18446744073709551615 1)))) 18446744073709551615) (= 8 $t11@@4))))))))
(let ((anon30_Then_correct@@2  (=> $t27@@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@13)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@13))) (= 7 $t11@@4)) (and (= $t11@@4 $t11@@4) (= (ControlFlow 0 251429) 251513))) L15_correct@@0))))
(let ((anon29_Then_correct@@2  (=> $t25@@1 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@19)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@19))) (= 7 $t11@@4)) (and (= $t11@@4 $t11@@4) (= (ControlFlow 0 251551) 251513))) L15_correct@@0))))
(let ((anon24_Then_correct@@1  (=> (and (and $t14@@5 (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t11@@4)) (and (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t12@@4) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t12@@4) 1) _$t2@@6 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t12@@4) 2) (div _$t2@@6 2) (+ 18446744073709551615 1)))) 18446744073709551615) (= 8 $t11@@4)))) (and (= $t11@@4 $t11@@4) (= (ControlFlow 0 251661) 251513))) L15_correct@@0)))
(let ((anon23_Then_correct@@1  (=> $t10@@2 (=> (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (= 5 $t11@@4)) (and (= $t11@@4 $t11@@4) (= (ControlFlow 0 251687) 251513))) L15_correct@@0))))
(let ((L14_correct@@0  (and (=> (= (ControlFlow 0 251281) (- 0 337548)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (and (=> (= (ControlFlow 0 251281) (- 0 337558)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 251281) (- 0 337568)) (not (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 1) _$t2@@6 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 2) (div _$t2@@6 2) (+ 18446744073709551615 1)))) 18446744073709551615))) (=> (not (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 1) _$t2@@6 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t8@@9) 2) (div _$t2@@6 2) (+ 18446744073709551615 1)))) 18446744073709551615)) (=> (= (ControlFlow 0 251281) (- 0 337582)) (= $t18@0@@1  (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@6 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@6 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@19 _$t1@@13))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@19) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@19)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@13) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@13))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@19) _$t0@@19 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@19))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@13) _$t1@@13 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@13)))))))))))))))))
(let ((L13_correct@@0  (=> (= $t4@0@@1 $t4@0@@1) (=> (and (= $t18@0@@1 $t4@0@@1) (= (ControlFlow 0 251221) 251281)) L14_correct@@0))))
(let ((anon30_Else_correct@@2  (=> (not $t27@@0) (=> (and (|$IsValid'address'| $t26@@0) (= $t26@@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@13) _$t1@@13 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@13))))) (=> (and (and (= $t28@0@@0  (not (= $t24@@2 $t26@@0))) (= $t28@0@@0 $t28@0@@0)) (and (= $t4@0@@1 $t28@0@@0) (= (ControlFlow 0 251391) 251221))) L13_correct@@0)))))
(let ((anon29_Else_correct@@2  (=> (and (and (not $t25@@1) (|$IsValid'address'| $t24@@2)) (and (= $t24@@2 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@19) _$t0@@19 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@19)))) (= $t27@@0  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@13)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@13)))))) (and (=> (= (ControlFlow 0 251351) 251429) anon30_Then_correct@@2) (=> (= (ControlFlow 0 251351) 251391) anon30_Else_correct@@2)))))
(let ((anon28_Then_correct@@2  (=> (and $t3@0@@4 (= $t25@@1  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@19)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@19))))) (and (=> (= (ControlFlow 0 251307) 251551) anon29_Then_correct@@2) (=> (= (ControlFlow 0 251307) 251351) anon29_Else_correct@@2)))))
(let ((anon28_Else_correct@@2  (=> (and (and (not $t3@0@@4) (= false false)) (and (= $t4@0@@1 false) (= (ControlFlow 0 251209) 251221))) L13_correct@@0)))
(let ((anon27_Else_correct@@2  (=> (not $t21@@1) (=> (and (= false false) (= $t3@0@@4 false)) (and (=> (= (ControlFlow 0 251187) 251307) anon28_Then_correct@@2) (=> (= (ControlFlow 0 251187) 251209) anon28_Else_correct@@2))))))
(let ((anon27_Then_correct@@2  (=> (and (and $t21@@1 (= $t22@@1  (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@13) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@13)))) (and (= $t22@@1 $t22@@1) (= $t3@0@@4 $t22@@1))) (and (=> (= (ControlFlow 0 251579) 251307) anon28_Then_correct@@2) (=> (= (ControlFlow 0 251579) 251209) anon28_Else_correct@@2)))))
(let ((anon26_Else_correct@@2  (=> (and (not $t19@0@@1) (= $t21@@1  (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@19) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@19)))) (and (=> (= (ControlFlow 0 251167) 251579) anon27_Then_correct@@2) (=> (= (ControlFlow 0 251167) 251187) anon27_Else_correct@@2)))))
(let ((anon26_Then_correct@@2  (=> (and (and $t19@0@@1 (= false false)) (and (= $t18@0@@1 false) (= (ControlFlow 0 251597) 251281))) L14_correct@@0)))
(let ((anon25_Else_correct@@1  (=> (and (not inline$$Not$0$dst@1@@6) (= $t19@0@@1 (= _$t0@@19 _$t1@@13))) (and (=> (= (ControlFlow 0 251145) 251597) anon26_Then_correct@@2) (=> (= (ControlFlow 0 251145) 251167) anon26_Else_correct@@2)))))
(let ((anon25_Then_correct@@1  (=> (and (and inline$$Not$0$dst@1@@6 (= false false)) (and (= $t18@0@@1 false) (= (ControlFlow 0 251615) 251281))) L14_correct@@0)))
(let ((inline$$Not$0$anon0_correct@@6  (=> (= inline$$Not$0$dst@1@@6  (not inline$$Ge$0$dst@1@@0)) (and (=> (= (ControlFlow 0 251125) 251615) anon25_Then_correct@@1) (=> (= (ControlFlow 0 251125) 251145) anon25_Else_correct@@1)))))
(let ((anon24_Else$1_correct@@1  (=> (and (= inline$$Ge$0$dst@1@@0 inline$$Ge$0$dst@1@@0) (= (ControlFlow 0 251131) 251125)) inline$$Not$0$anon0_correct@@6)))
(let ((inline$$Ge$0$anon0_correct@@0  (=> (and (= inline$$Ge$0$dst@1@@0 (>= $t13@@3 $t9@@10)) (= (ControlFlow 0 251079) 251131)) anon24_Else$1_correct@@1)))
(let ((anon24_Else_correct@@1  (=> (not $t14@@5) (=> (and (and (|$IsValid'u64'| $t13@@3) (= $t13@@3 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@6 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@6 2) (+ 18446744073709551615 1)))))) (and (= $t13@@3 $t13@@3) (= (ControlFlow 0 251085) 251079))) inline$$Ge$0$anon0_correct@@0))))
(let ((anon23_Else_correct@@1  (=> (and (not $t10@@2) (|$IsValid'u64'| $t9@@10)) (=> (and (and (= $t9@@10 (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (= $t9@@10 $t9@@10)) (and (= $t12@@4 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $t14@@5  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t12@@4) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t12@@4) 1) _$t2@@6 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t12@@4) 2) (div _$t2@@6 2) (+ 18446744073709551615 1)))) 18446744073709551615))))) (and (=> (= (ControlFlow 0 251011) 251661) anon24_Then_correct@@1) (=> (= (ControlFlow 0 251011) 251085) anon24_Else_correct@@1))))))
(let ((anon0$1_correct@@19  (=> (and (and (forall ((addr@@107 Int) ) (!  (=> (|$IsValid'address'| addr@@107) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159212| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@107) (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |DualAttestationbpl.16207:22|
 :skolemid |368|
)) (forall ((addr@@108 Int) ) (!  (=> (|$IsValid'address'| addr@@108) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159293| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@108) (|Select__T@[Int]Bool_| (|domain#$Memory_152871| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |DualAttestationbpl.16207:222|
 :skolemid |369|
))) (forall ((addr@@109 Int) ) (!  (=> (|$IsValid'address'| addr@@109) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159374| |$1_Diem_Preburn'#0'_$memory|) addr@@109) (|Select__T@[Int]Bool_| (|domain#$Memory_153007| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |DualAttestationbpl.16207:423|
 :skolemid |370|
))) (=> (and (and (and (and (and (forall ((addr@@110 Int) ) (!  (=> (|$IsValid'address'| addr@@110) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159624| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@110) (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |DualAttestationbpl.16211:22|
 :skolemid |371|
)) (forall ((addr@@111 Int) ) (!  (=> (|$IsValid'address'| addr@@111) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159741| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@111) (|Select__T@[Int]Bool_| (|domain#$Memory_152871| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |DualAttestationbpl.16211:227|
 :skolemid |372|
))) (forall ((addr@@112 Int) ) (!  (=> (|$IsValid'address'| addr@@112) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159858| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@112) (|Select__T@[Int]Bool_| (|domain#$Memory_153007| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |DualAttestationbpl.16211:433|
 :skolemid |373|
))) (and (forall ((child_addr@@5 Int) ) (!  (=> (|$IsValid'address'| child_addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) child_addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) child_addr@@5)))))
 :qid |DualAttestationbpl.16215:20|
 :skolemid |374|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)))) (and (and (|$IsValid'address'| _$t0@@19) (|$IsValid'address'| _$t1@@13)) (and (|$IsValid'u64'| _$t2@@6) (forall (($a_0@@40 Int) ) (! (let (($rsc@@40 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@40)))
 ...
 :qid |DualAttestationbpl.16232:20|
 :skolemid |375|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@40))
))))) (and (and (and (forall (($a_0@@41 Int) ) (! (let (($rsc@@41 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) $a_0@@41)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc@@41))
 :qid |DualAttestationbpl.16236:20|
 :skolemid |376|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) $a_0@@41))
)) (forall (($a_0@@42 Int) ) (! (let (($rsc@@42 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_171117| $1_VASP_ParentVASP_$memory) $a_0@@42)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@42))
 :qid |DualAttestationbpl.16240:20|
 :skolemid |377|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_171117| $1_VASP_ParentVASP_$memory) $a_0@@42))
))) (and (forall (($a_0@@43 Int) ) (! (let (($rsc@@43 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) $a_0@@43)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc@@43))
 :qid |DualAttestationbpl.16244:20|
 :skolemid |378|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) $a_0@@43))
)) (= $t8@@9 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (and (and (= _$t0@@19 _$t0@@19) (= _$t1@@13 _$t1@@13)) (and (= _$t2@@6 _$t2@@6) (= $t10@@2  (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 250951) 251687) anon23_Then_correct@@1) (=> (= (ControlFlow 0 250951) 251011) anon23_Else_correct@@1))))))
(let ((inline$$InitEventStore$0$anon0_correct@@19  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@21 T@$1_Event_EventHandle) ) (! (let ((stream@@20 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $es) handle@@21)))
 (and (= (|l#Multiset_93630| stream@@20) 0) (forall ((v@@71 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@20) v@@71) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2823:13|
 :skolemid |103|
))) (= (ControlFlow 0 250594) 250951)) anon0$1_correct@@19)))
(let ((anon0_correct@@19  (=> (= (ControlFlow 0 336573) 250594) inline$$InitEventStore$0$anon0_correct@@19)))
anon0_correct@@19))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
