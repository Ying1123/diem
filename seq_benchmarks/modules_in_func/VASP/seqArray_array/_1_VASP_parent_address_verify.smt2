...
(assert (not
 (=> (= (ControlFlow 0 0) 59259) (let ((L3_correct@@0  (=> (= $t2@0@@0 $t2@0@@0) (and (=> (= (ControlFlow 0 50531) (- 0 59740)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0@@5))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0@@5)))) (and (=> (= (ControlFlow 0 50531) (- 0 59759)) (= $t2@0@@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0@@5) _$t0@@5 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0@@5))))) (=> (= $t2@0@@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0@@5) _$t0@@5 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0@@5)))) (and (=> (= (ControlFlow 0 50531) (- 0 59772)) (forall ((a@@10 Int) ) (!  (=> (|$IsValid'address'| a@@10) (= (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) a@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) a@@10)))
 :qid |VASPbpl.3109:15|
 :skolemid |118|
))) (=> (forall ((a@@11 Int) ) (!  (=> (|$IsValid'address'| a@@11) (= (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) a@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) a@@11)))
 :qid |VASPbpl.3109:15|
 :skolemid |118|
)) (=> (= (ControlFlow 0 50531) (- 0 59797)) (forall ((parent@@4 Int) ) (!  (=> (|$IsValid'address'| parent@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) parent@@4) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) parent@@4)) (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) parent@@4)))))
 :qid |VASPbpl.3114:15|
 :skolemid |119|
))))))))))))
(let ((anon18_Else_correct  (=> (and (not $abort_flag@0@@0) (= $t9@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| $t8@1))) (=> (and (and (= $t9@0 $t9@0) (= $t9@0 $t9@0)) (and (= $t2@0@@0 $t9@0) (= (ControlFlow 0 50425) 50531))) L3_correct@@0))))
(let ((anon15_Then_correct  (=> (and (and $t3@@0 (= _$t0@@5 _$t0@@5)) (and (= $t2@0@@0 _$t0@@5) (= (ControlFlow 0 50611) 50531))) L3_correct@@0)))
(let ((L7_correct@@0  (and (=> (= (ControlFlow 0 50377) (- 0 59650)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0@@5)))) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0@@5))) (=> (= (ControlFlow 0 50377) (- 0 59664)) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0@@5))) (= 7 $t7@0)))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= $t7@0 $abort_code@1@@0) (= (ControlFlow 0 50545) 50377))) L7_correct@@0)))
(let ((anon17_Then$1_correct  (=> (= $t8@1 $t8@@0) (=> (and (= $abort_flag@0@@0 true) (= $abort_code@1@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 50597) 50545) anon18_Then_correct) (=> (= (ControlFlow 0 50597) 50425) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0@@5)) (= (ControlFlow 0 50595) 50597)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0@@5) (=> (and (and (= $t8@0 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0@@5)) (= $t8@1 $t8@0)) (and (= $abort_flag@0@@0 false) (= $abort_code@1@@0 $abort_code@0@@0))) (and (=> (= (ControlFlow 0 50395) 50545) anon18_Then_correct) (=> (= (ControlFlow 0 50395) 50425) anon18_Else_correct))))))
(let ((anon16_Then_correct  (=> $t4@@2 (and (=> (= (ControlFlow 0 50381) 50595) anon17_Then_correct) (=> (= (ControlFlow 0 50381) 50395) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (not $t4@@2) (=> (and (|$IsValid'u64'| 2) (|$IsValid'u64'| $t6)) (=> (and (and (= $t6 7) (= $t6 $t6)) (and (= $t7@0 $t6) (= (ControlFlow 0 50325) 50377))) L7_correct@@0)))))
(let ((anon15_Else_correct  (=> (and (not $t3@@0) (= $t4@@2 (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0@@5))) (and (=> (= (ControlFlow 0 50293) 50381) anon16_Then_correct) (=> (= (ControlFlow 0 50293) 50325) anon16_Else_correct)))))
(let ((anon0$1_correct@@5  (=> (forall ((child_addr@@5 Int) ) (!  (=> (|$IsValid'address'| child_addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) child_addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_34982| $1_VASP_ChildVASP_$memory) child_addr@@5)))))
 :qid |VASPbpl.2940:20|
 :skolemid |112|
)) (=> (and (and (and (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (= (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) addr@@12)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_33031| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_33031| $1_Roles_RoleId_$memory) addr@@12)) 5))))
 :qid |VASPbpl.2944:20|
 :skolemid |113|
)) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (= (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) addr@@13)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_33031| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_33031| $1_Roles_RoleId_$memory) addr@@13)) 6))))
 :qid |VASPbpl.2948:20|
 :skolemid |114|
))) (and (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_35768| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@14) (or (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) addr@@14))))
 :qid |VASPbpl.2952:20|
 :skolemid |115|
)) (|$IsValid'address'| _$t0@@5))) (and (and (forall (($a_0@@10 Int) ) (! (let (($rsc@@10 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_34982| $1_VASP_ChildVASP_$memory) $a_0@@10)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc@@10))
 :qid |VASPbpl.2959:20|
 :skolemid |116|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_34982| $1_VASP_ChildVASP_$memory) $a_0@@10))
)) (forall (($a_0@@11 Int) ) (! (let (($rsc@@11 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) $a_0@@11)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@11))
 :qid |VASPbpl.2963:20|
 :skolemid |117|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) $a_0@@11))
))) (and (= _$t0@@5 _$t0@@5) (= $t3@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0@@5))))) (and (=> (= (ControlFlow 0 50273) 50611) anon15_Then_correct) (=> (= (ControlFlow 0 50273) 50293) anon15_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@5  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@7 T@$1_Event_EventHandle) ) (! (let ((stream@@6 (|Select__T@[$1_Event_EventHandle]Multiset_20906_| (|streams#$EventStore| $es) handle@@7)))
 (and (= (|l#Multiset_20906| stream@@6) 0) (forall ((v@@26 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_20906| stream@@6) v@@26) 0)
 :qid |VASPbpl.159:13|
 :skolemid |4|
))))
 :qid |VASPbpl.1501:13|
 :skolemid |49|
))) (= (ControlFlow 0 50081) 50273)) anon0$1_correct@@5)))
(let ((anon0_correct@@5  (=> (= (ControlFlow 0 59259) 50081) inline$$InitEventStore$0$anon0_correct@@5)))
anon0_correct@@5)))))))))))))))
))
(check-sat)
(pop 1)
