...
(declare-fun $1_DiemTimestamp_CurrentTimeMicroseconds_$memory@0 () T@$Memory_463734)
...
(declare-fun $t14 () T@$Mutation_464253)
(declare-fun $t14@0 () T@$Mutation_464253)
...
(declare-fun $t7 () T@$Mutation_464253)
...
(declare-fun $1_Roles_RoleId_$memory@1@@0 () T@$Memory_465676)
...
(declare-fun $1_Roles_RoleId_$memory@0@@0 () T@$Memory_465676)
...
(declare-fun $1_Roles_RoleId_$memory@2@@0 () T@$Memory_465676)
(declare-fun |$temp_0'bool'@0@@0| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@1 () T@$Memory_465676)
(declare-fun $1_Roles_RoleId_$memory@0@@1 () T@$Memory_465676)
...
(declare-fun $1_Roles_RoleId_$memory@2@@1 () T@$Memory_465676)
(declare-fun |$temp_0'bool'@0@@1| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@2 () T@$Memory_465676)
(declare-fun $1_Roles_RoleId_$memory@0@@2 () T@$Memory_465676)
...
(declare-fun $1_Roles_RoleId_$memory@2@@2 () T@$Memory_465676)
(declare-fun |$temp_0'bool'@0@@2| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@3 () T@$Memory_465676)
(declare-fun $1_Roles_RoleId_$memory@0@@3 () T@$Memory_465676)
...
(declare-fun $1_Roles_RoleId_$memory@2@@3 () T@$Memory_465676)
(declare-fun |$temp_0'bool'@0@@3| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@4 () T@$Memory_465676)
(declare-fun $1_Roles_RoleId_$memory@0@@4 () T@$Memory_465676)
...
(declare-fun $1_Roles_RoleId_$memory@2@@4 () T@$Memory_465676)
(declare-fun |$temp_0'bool'@0@@4| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@5 () T@$Memory_465676)
(declare-fun $1_Roles_RoleId_$memory@0@@5 () T@$Memory_465676)
...
(declare-fun $1_Roles_RoleId_$memory@2@@5 () T@$Memory_465676)
(declare-fun |$temp_0'bool'@0@@5| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@6 () T@$Memory_465676)
(declare-fun $1_Roles_RoleId_$memory@0@@6 () T@$Memory_465676)
...
(declare-fun $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory@1 () T@$Memory_469320)
...
(declare-fun $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory@0 () T@$Memory_469320)
...
(declare-fun _$t2@@0 () T@Vec_37831)
(declare-fun $t16 () Int)
...
(declare-fun _$t2@@1 () T@Vec_37831)
(declare-fun $t15 () Int)
...
(declare-fun $t13@0 () T@$Mutation_490338)
(declare-fun $t12@1 () T@$Mutation_490297)
(declare-fun $t13@1 () T@$Mutation_490338)
(declare-fun $t11@@2 () |T@$1_Option_Option'address'|)
(declare-fun $t12@2 () T@$Mutation_490297)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@0@@0 () T@$Memory_469220)
...
(declare-fun $t12@0@@0 () T@$Mutation_490297)
...
(declare-fun $t13 () T@$Mutation_490338)
; Valid
...
(declare-fun $t25@1 () T@$Mutation_490297)
(declare-fun $t26@0 () T@$1_ValidatorConfig_Config)
(declare-fun _$t2@@2 () T@Vec_37831)
...
(declare-fun $t28@0 () T@$Mutation_491893)
(declare-fun $t28@1 () T@$Mutation_491893)
(declare-fun $t25@2 () T@$Mutation_490297)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@0@@1 () T@$Memory_469220)
(declare-fun _$t0@@11 () T@$signer)
(declare-fun _$t1@@9 () Int)
(declare-fun $t15@0@@0 () Int)
(declare-fun $abort_code@1@@4 () Int)
(declare-fun $t25@@0 () T@$Mutation_490297)
(declare-fun $t25@0 () T@$Mutation_490297)
...
(declare-fun $t15@@0 () Int)
(declare-fun $t11@@3 () T@$Mutation_490297)
(declare-fun $t28 () T@$Mutation_491893)
; Valid
(declare-fun $abort_flag@0@@5 () Bool)
(declare-fun $t21@0 () T@$Mutation_490338)
(declare-fun $t20@1 () T@$Mutation_490297)
(declare-fun $t21@1 () T@$Mutation_490338)
(declare-fun $t19 () |T@$1_Option_Option'address'|)
(declare-fun $t20@2 () T@$Mutation_490297)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@0@@2 () T@$Memory_469220)
...
(declare-fun $t20@@0 () T@$Mutation_490297)
...
(declare-fun $t11@@5 () T@Vec_417075)
(declare-fun _$t2@@3 () T@Vec_37831)
...
(declare-fun $t34@0 () T@$Mutation_456960)
(declare-fun $t36@0 () T@$1_VASPDomain_VASPDomainEvent)
(declare-fun $t33@1 () T@$Mutation_533326)
(declare-fun inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 () T@$1_VASPDomain_VASPDomain)
(declare-fun $t33 () T@$Mutation_533326)
(declare-fun $t33@0 () T@$Mutation_533326)
...
(declare-fun $t24@2 () T@$Mutation_533261)
(declare-fun $t24@1@@0 () T@$Mutation_533261)
(declare-fun |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$m'@1| () T@$Mutation_437868)
...
(declare-fun $t31@0 () T@$Mutation_437868)
...
(declare-fun $t26@0@@0 () T@Vec_417075)
...
(declare-fun $t24@@1 () T@$Mutation_533261)
(declare-fun $t24@0@@0 () T@$Mutation_533261)
...
(declare-fun $t9@@10 () T@$Mutation_533261)
(declare-fun $t31 () T@$Mutation_437868)
(declare-fun $t34 () T@$Mutation_456960)
(push 1)
(set-info :boogie-vc-id $1_VASPDomain_add_vasp_domain$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 1899721) (let ((anon45_Else_correct  (=> (and (not $abort_flag@2) (= $t37 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_532840| $1_VASPDomain_VASPDomains_$memory@0) _$t1@@11)))) (and (=> (= (ControlFlow 0 1108108) (- 0 1901865)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) _$t1@@11)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) _$t1@@11))) (and (=> (= (ControlFlow 0 1108108) (- 0 1901876)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (and (=> (= (ControlFlow 0 1108108) (- 0 1901886)) (not (exists ((i@@126 Int) ) (!  (and (and (|$IsValid'u64'| i@@126) (InRangeVec_377227 $t11@@5 i@@126)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $t11@@5) i@@126)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2@@3))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
)))) (=> (not (exists ((i@@127 Int) ) (!  (and (and (|$IsValid'u64'| i@@127) (InRangeVec_377227 $t11@@5 i@@127)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $t11@@5) i@@127)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2@@3))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
))) (and (=> (= (ControlFlow 0 1108108) (- 0 1901898)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t12@@3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t12@@3))) (and (=> (= (ControlFlow 0 1108108) (- 0 1901910)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t12@@3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t12@@3)) 1))) (and (=> (= (ControlFlow 0 1108108) (- 0 1901928)) (not (not (= (|$addr#$signer| _$t0@@13) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@13) 186537453))) (and (=> (= (ControlFlow 0 1108108) (- 0 1901942)) (not (> (|l#Vec_37831| _$t2@@3) 63))) (=> (not (> (|l#Vec_37831| _$t2@@3) 63)) (and (=> (= (ControlFlow 0 1108108) (- 0 1901954)) (exists ((i@@128 Int) ) (!  (and (and (|$IsValid'u64'| i@@128) (InRangeVec_377227 $t37 i@@128)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $t37) i@@128)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2@@3))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
))) (=> (exists ((i@@129 Int) ) (!  (and (and (|$IsValid'u64'| i@@129) (InRangeVec_377227 $t37 i@@129)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $t37) i@@129)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2@@3))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
)) (and (=> (= (ControlFlow 0 1108108) (- 0 1901964)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t13@@1)))
(let ((stream_new (let ((len (|l#Multiset_416285| stream@@14)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@14) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@2))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@14) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@2) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t13@@1 stream_new))))))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@15 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| expected) handle@@15)) (|l#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| actual) handle@@15))) (forall ((v@@78 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| expected) handle@@15)) v@@78) (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| actual) handle@@15)) v@@78))
...
(let ((expected@@0 (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t13@@1)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_416285| stream@@15)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@15) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@2))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@15) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@2) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t13@@1 stream_new@@0))))))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@16 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| expected@@0) handle@@16)) (|l#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| actual@@0) handle@@16))) (forall ((v@@79 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| expected@@0) handle@@16)) v@@79) (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| actual@@0) handle@@16)) v@@79))
 :qid |DiemAccountbpl.164:13|
 :skolemid |5|
)))
 :qid |DiemAccountbpl.3536:13|
 :skolemid |130|
))))) (=> (= (ControlFlow 0 1108108) (- 0 1901989)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@16 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t13@@1)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_416285| stream@@16)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@16) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@2))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@16) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@2) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t13@@1 stream_new@@1))))))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@17 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| actual@@1) handle@@17)) (|l#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| expected@@1) handle@@17))) (forall ((v@@80 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| actual@@1) handle@@17)) v@@80) (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| expected@@1) handle@@17)) v@@80))
 :qid |DiemAccountbpl.164:13|
 :skolemid |5|
)))
 :qid |DiemAccountbpl.3536:13|
...
(let ((L7_correct@@0  (and (=> (= (ControlFlow 0 1106640) (- 0 1901657)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) _$t1@@11)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (exists ((i@@130 Int) ) (!  (and (and (|$IsValid'u64'| i@@130) (InRangeVec_377227 $t11@@5 i@@130)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $t11@@5) i@@130)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2@@3))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t12@@3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t12@@3)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453))) (> (|l#Vec_37831| _$t2@@3) 63))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) _$t1@@11)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (exists ((i@@131 Int) ) (!  (and (and (|$IsValid'u64'| i@@131) (InRangeVec_377227 $t11@@5 i@@131)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $t11@@5) i@@131)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2@@3))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t12@@3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t12@@3)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453))) (> (|l#Vec_37831| _$t2@@3) 63)) (=> (= (ControlFlow 0 1106640) (- 0 1901723)) (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) _$t1@@11)) (= 5 $t17@0@@1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= 5 $t17@0@@1))) (and (exists ((i@@132 Int) ) (!  (and (and (|$IsValid'u64'| i@@132) (InRangeVec_377227 $t11@@5 i@@132)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $t11@@5) i@@132)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2@@3))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
)) (= 7 $t17@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t12@@3)) (= 5 $t17@0@@1))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t12@@3)) 1)) (= 3 $t17@0@@1))) (and (not (= (|$addr#$signer| _$t0@@13) 186537453)) (= 2 $t17@0@@1))) (and (> (|l#Vec_37831| _$t2@@3) 63) (= 7 $t17@0@@1))))))))
(let ((anon45_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0@@1 $abort_code@3) (= (ControlFlow 0 1108122) 1106640))) L7_correct@@0)))
(let ((|inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| (|v#$Mutation_456960| $t34@0)) (= $es@0 (let ((stream@@17 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_416285| stream@@17)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@17) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t36@0))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@17) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t36@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 1107922) 1108122) anon45_Then_correct) (=> (= (ControlFlow 0 1107922) 1108108) anon45_Else_correct)))))
(let ((anon44_Else_correct  (=> (and (and (not $abort_flag@2) (= $t34@0 ($Mutation_456960 (|l#$Mutation_533326| $t33@1) (let ((l@@3 (|l#Vec_37831| (|p#$Mutation_533326| $t33@1))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_533326| $t33@1)) l@@3 0) (+ l@@3 1))) (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|v#$Mutation_533326| $t33@1))))) (and (= $t36@0 ($1_VASPDomain_VASPDomainEvent false inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 _$t1@@11)) (= (ControlFlow 0 1107928) 1107922))) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|)))
(let ((anon44_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0@@1 $abort_code@3) (= (ControlFlow 0 1108136) 1106640))) L7_correct@@0)))
(let ((anon43_Then$1_correct  (=> (= $t33@1 $t33) (=> (and (= $abort_code@3 $EXEC_FAILURE_CODE) (= $abort_flag@2 true)) (and (=> (= (ControlFlow 0 1108188) 1108136) anon44_Then_correct) (=> (= (ControlFlow 0 1108188) 1107928) anon44_Else_correct))))))
(let ((anon43_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= (ControlFlow 0 1108186) 1108188)) anon43_Then$1_correct)))
(let ((anon43_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (=> (and (and (= $t33@0 ($Mutation_533326 ($Global 186537453) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (= $t33@1 $t33@0)) (and (= $abort_code@3 $abort_code@2) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 1107813) 1108136) anon44_Then_correct) (=> (= (ControlFlow 0 1107813) 1107928) anon44_Else_correct))))))
(let ((anon42_Else_correct  (=> (and (not $abort_flag@1) (= $t24@2 ($Mutation_533261 (|l#$Mutation_533261| $t24@1@@0) (|p#$Mutation_533261| $t24@1@@0) ($1_VASPDomain_VASPDomains (|v#$Mutation_437868| |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$m'@1|))))) (and (=> (= (ControlFlow 0 1107791) (- 0 1901247)) (let (($range_0 ($Range 0 (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@133 $i_1))
(<= (|l#Vec_37831| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))) i@@133))) 63)))
 :qid |DiemAccountbpl.20640:107|
 :skolemid |365|
)))) (=> (let (($range_0@@0 ($Range 0 (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@134 $i_1@@0))
(<= (|l#Vec_37831| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))) i@@134))) 63)))
 :qid |DiemAccountbpl.20640:107|
 :skolemid |365|
))) (and (=> (= (ControlFlow 0 1107791) (- 0 1901295)) (let (($range_0@@1 ($Range 0 (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@135 $i_1@@1))
(let (($range_2 ($Range (+ i@@135 1) (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))))))
(forall (($i_3 Int) ) (!  (=> ($InRange $range_2 $i_3) (let ((j@@40 $i_3))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))) i@@135)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))) j@@40))))))
 :qid |DiemAccountbpl.20648:112|
 :skolemid |366|
)))))
 :qid |DiemAccountbpl.20647:107|
 :skolemid |367|
)))) (=> (let (($range_0@@2 ($Range 0 (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@136 $i_1@@2))
(let (($range_2@@0 ($Range (+ i@@136 1) (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))))))
(forall (($i_3@@0 Int) ) (!  (=> ($InRange $range_2@@0 $i_3@@0) (let ((j@@41 $i_3@@0))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))) i@@136)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))) j@@41))))))
 :qid |DiemAccountbpl.20648:112|
 :skolemid |366|
)))))
 :qid |DiemAccountbpl.20647:107|
 :skolemid |367|
))) (and (=> (= (ControlFlow 0 1107791) (- 0 1901380)) (let (($range_0@@3 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))))
(forall (($i_1@@3 Int) ) (!  (=> (InRangeVec_377227 $range_0@@3 $i_1@@3) (let (($elem (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $range_0@@3) $i_1@@3)))
(<= (|l#Vec_37831| (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 :qid |DiemAccountbpl.20655:88|
 :skolemid |368|
)))) (=> (let (($range_0@@4 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@2))))
(forall (($i_1@@4 Int) ) (!  (=> (InRangeVec_377227 $range_0@@4 $i_1@@4) (let (($elem@@0 (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $range_0@@4) $i_1@@4)))
(<= (|l#Vec_37831| (|$domain#$1_VASPDomain_VASPDomain| $elem@@0)) 63)))
 :qid |DiemAccountbpl.20655:88|
 :skolemid |368|
))) (=> (and (= $1_VASPDomain_VASPDomains_$memory@0 ($Memory_532840 (|Store__T@[Int]Bool_| (|domain#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_533261| $t24@2)) true) (|Store__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_533261| $t24@2)) (|v#$Mutation_533261| $t24@2)))) (|$IsValid'address'| 186537453)) (and (=> (= (ControlFlow 0 1107791) 1108186) anon43_Then_correct) (=> (= (ControlFlow 0 1107791) 1107813) anon43_Else_correct))))))))))))
(let ((anon42_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0@@1 $abort_code@2) (= (ControlFlow 0 1108202) 1106640))) L7_correct@@0)))
(let ((|inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$m'@1| ($Mutation_437868 (|l#$Mutation_437868| $t31@0) (|p#$Mutation_437868| $t31@0) (let ((l@@4 (|l#Vec_417075| (|v#$Mutation_437868| $t31@0))))
(Vec_417075 (|Store__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|v#$Mutation_437868| $t31@0)) l@@4 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1) (+ l@@4 1))))) (and (=> (= (ControlFlow 0 1107565) 1108202) anon42_Then_correct) (=> (= (ControlFlow 0 1107565) 1107791) anon42_Else_correct)))))
(let ((anon41_Then_correct  (=> inline$$Not$0$dst@1@@2 (=> (and (= $t31@0 ($Mutation_437868 (|l#$Mutation_533261| $t24@1@@0) (let ((l@@5 (|l#Vec_37831| (|p#$Mutation_533261| $t24@1@@0))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_533261| $t24@1@@0)) l@@5 0) (+ l@@5 1))) (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0)))) (= (ControlFlow 0 1107571) 1107565)) |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$anon0_correct|))))
(let ((anon41_Else_correct  (=> (not inline$$Not$0$dst@1@@2) (and (=> (= (ControlFlow 0 1107498) (- 0 1901004)) (let (($range_0@@5 ($Range 0 (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))))))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((i@@137 $i_1@@5))
(<= (|l#Vec_37831| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))) i@@137))) 63)))
 :qid |DiemAccountbpl.20586:107|
 :skolemid |361|
)))) (=> (let (($range_0@@6 ($Range 0 (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))))))
(forall (($i_1@@6 Int) ) (!  (=> ($InRange $range_0@@6 $i_1@@6) (let ((i@@138 $i_1@@6))
(<= (|l#Vec_37831| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))) i@@138))) 63)))
 :qid |DiemAccountbpl.20586:107|
 :skolemid |361|
))) (and (=> (= (ControlFlow 0 1107498) (- 0 1901052)) (let (($range_0@@7 ($Range 0 (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))))))
(forall (($i_1@@7 Int) ) (!  (=> ($InRange $range_0@@7 $i_1@@7) (let ((i@@139 $i_1@@7))
(let (($range_2@@1 ($Range (+ i@@139 1) (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))))))
(forall (($i_3@@1 Int) ) (!  (=> ($InRange $range_2@@1 $i_3@@1) (let ((j@@42 $i_3@@1))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))) i@@139)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))) j@@42))))))
 :qid |DiemAccountbpl.20594:112|
 :skolemid |362|
)))))
 :qid |DiemAccountbpl.20593:107|
 :skolemid |363|
)))) (=> (let (($range_0@@8 ($Range 0 (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))))))
(forall (($i_1@@8 Int) ) (!  (=> ($InRange $range_0@@8 $i_1@@8) (let ((i@@140 $i_1@@8))
(let (($range_2@@2 ($Range (+ i@@140 1) (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))))))
(forall (($i_3@@2 Int) ) (!  (=> ($InRange $range_2@@2 $i_3@@2) (let ((j@@43 $i_3@@2))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))) i@@140)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))) j@@43))))))
 :qid |DiemAccountbpl.20594:112|
 :skolemid |362|
)))))
 :qid |DiemAccountbpl.20593:107|
 :skolemid |363|
))) (and (=> (= (ControlFlow 0 1107498) (- 0 1901137)) (let (($range_0@@9 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))))
(forall (($i_1@@9 Int) ) (!  (=> (InRangeVec_377227 $range_0@@9 $i_1@@9) (let (($elem@@1 (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $range_0@@9) $i_1@@9)))
(<= (|l#Vec_37831| (|$domain#$1_VASPDomain_VASPDomain| $elem@@1)) 63)))
 :qid |DiemAccountbpl.20601:88|
 :skolemid |364|
)))) (=> (let (($range_0@@10 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))))
(forall (($i_1@@10 Int) ) (!  (=> (InRangeVec_377227 $range_0@@10 $i_1@@10) (let (($elem@@2 (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $range_0@@10) $i_1@@10)))
(<= (|l#Vec_37831| (|$domain#$1_VASPDomain_VASPDomain| $elem@@2)) 63)))
 :qid |DiemAccountbpl.20601:88|
 :skolemid |364|
))) (=> (= $t30 $t30) (=> (and (= $t17@0@@1 $t30) (= (ControlFlow 0 1107498) 1106640)) L7_correct@@0)))))))))))
(let ((anon40_Else$1_correct  (=> (|$IsValid'u64'| 3) (=> (and (and (|$IsValid'u64'| $t30) (= $t30 7)) (and (= $t30 $t30) (= inline$$Not$0$dst@1@@2 inline$$Not$0$dst@1@@2))) (and (=> (= (ControlFlow 0 1107304) 1107571) anon41_Then_correct) (=> (= (ControlFlow 0 1107304) 1107498) anon41_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@2  (=> (and (= inline$$Not$0$dst@1@@2  (not |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1|)) (= (ControlFlow 0 1107264) 1107304)) anon40_Else$1_correct)))
(let ((anon40_Else_correct  (=> (and (not $abort_flag@1) (= (ControlFlow 0 1107270) 1107264)) inline$$Not$0$anon0_correct@@2)))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0@@1 $abort_code@2) (= (ControlFlow 0 1108216) 1106640))) L7_correct@@0)))
(let ((|inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| (exists ((i@@141 Int) ) (!  (and (and (|$IsValid'u64'| i@@141) (InRangeVec_377227 $t26@0@@0 i@@141)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $t26@0@@0) i@@141)) (|$domain#$1_VASPDomain_VASPDomain| inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
))) (and (=> (= (ControlFlow 0 1107220) 1108216) anon40_Then_correct) (=> (= (ControlFlow 0 1107220) 1107270) anon40_Else_correct)))))
(let ((anon39_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)) (and (= $t26@0@@0 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_533261| $t24@1@@0))) (= (ControlFlow 0 1107226) 1107220))) |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((anon39_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0@@1 $abort_code@2) (= (ControlFlow 0 1108230) 1106640))) L7_correct@@0)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$L3_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 inline$$1_VASPDomain_create_vasp_domain$0$$t4@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@0)) (and (=> (= (ControlFlow 0 1107120) 1108230) anon39_Then_correct) (=> (= (ControlFlow 0 1107120) 1107226) anon39_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= (ControlFlow 0 1107114) 1107120))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct  (=> (and (and $abort_flag@0@@6 (= $abort_code@1@@6 $abort_code@1@@6)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 $abort_code@1@@6) (= (ControlFlow 0 1107152) 1107120))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct  (=> (and inline$$Le$0$dst@1 (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 ($1_VASPDomain_VASPDomain _$t2@@3))) (=> (and (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1) (= $abort_flag@1 $abort_flag@0@@6)) (and (= $abort_code@2 $abort_code@1@@6) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1))) (and (=> (= (ControlFlow 0 1107138) 1108230) anon39_Then_correct) (=> (= (ControlFlow 0 1107138) 1107226) anon39_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 7)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 1107098) 1107138) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct) (=> (= (ControlFlow 0 1107098) 1107114) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 1107062) 1107098)) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct  (=> (not $abort_flag@0@@6) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 1107068) 1107062)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (|l#Vec_37831| _$t2@@3)) (and (=> (= (ControlFlow 0 1107002) 1107152) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct) (=> (= (ControlFlow 0 1107002) 1107068) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct)))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct  (=> (and (= _$t2@@3 _$t2@@3) (= (ControlFlow 0 1107008) 1107002)) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((anon38_Else_correct  (=> (and (and (not $abort_flag@0@@6) (= |$temp_0'$1_VASPDomain_VASPDomains'@0| (|v#$Mutation_533261| $t24@1@@0))) (and (= |$temp_0'$1_VASPDomain_VASPDomains'@0| |$temp_0'$1_VASPDomain_VASPDomains'@0|) (= (ControlFlow 0 1107158) 1107008))) inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct)))
(let ((anon38_Then_correct  (=> (and (and $abort_flag@0@@6 (= $abort_code@1@@6 $abort_code@1@@6)) (and (= $t17@0@@1 $abort_code@1@@6) (= (ControlFlow 0 1108244) 1106640))) L7_correct@@0)))
(let ((anon37_Then$1_correct  (=> (= $t24@1@@0 $t24@@1) (=> (and (= $abort_flag@0@@6 true) (= $abort_code@1@@6 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1108296) 1108244) anon38_Then_correct) (=> (= (ControlFlow 0 1108296) 1107158) anon38_Else_correct))))))
(let ((anon37_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) _$t1@@11)) (= (ControlFlow 0 1108294) 1108296)) anon37_Then$1_correct)))
(let ((anon37_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) _$t1@@11) (=> (and (and (= $t24@0@@0 ($Mutation_533261 ($Global _$t1@@11) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) _$t1@@11))) (= $t24@1@@0 $t24@0@@0)) (and (= $abort_flag@0@@6 false) (= $abort_code@1@@6 $abort_code@0@@6))) (and (=> (= (ControlFlow 0 1106724) 1108244) anon38_Then_correct) (=> (= (ControlFlow 0 1106724) 1107158) anon38_Else_correct))))))
(let ((anon36_Then_correct  (=> $t21@0@@0 (and (=> (= (ControlFlow 0 1106702) 1108294) anon37_Then_correct) (=> (= (ControlFlow 0 1106702) 1106724) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (and (and (not $t21@0@@0) (= $t23@@0 $t23@@0)) (and (= $t17@0@@1 $t23@@0) (= (ControlFlow 0 1106698) 1106640))) L7_correct@@0)))
(let ((anon35_Then_correct  (=> inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 (=> (and (= $t21@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) _$t1@@11)) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| $t23@@0) (= $t23@@0 5)) (and (= $t23@@0 $t23@@0) (= $t21@0@@0 $t21@0@@0))) (and (=> (= (ControlFlow 0 1106682) 1106702) anon36_Then_correct) (=> (= (ControlFlow 0 1106682) 1106698) anon36_Else_correct)))))))
(let ((anon35_Else_correct  (=> (and (and (not inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1) (= $t20@@1 $t20@@1)) (and (= $t17@0@@1 $t20@@1) (= (ControlFlow 0 1106428) 1106640))) L7_correct@@0)))
(let ((anon34_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t20@@1) (= $t20@@1 5)) (and (= $t20@@1 $t20@@1) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1))) (and (=> (= (ControlFlow 0 1106412) 1106682) anon35_Then_correct) (=> (= (ControlFlow 0 1106412) 1106428) anon35_Else_correct))))))
(let ((anon33_Then_correct  (=> $t16@@1 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t15@@2)) (= 5 $t17@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t15@@2)) 1)) (= 3 $t17@@0))) (and (not (= (|$addr#$signer| _$t0@@13) 186537453)) (= 2 $t17@@0))) (= $t17@@0 $t17@@0)) (and (= $t17@0@@1 $t17@@0) (= (ControlFlow 0 1108382) 1106640))) L7_correct@@0))))
(let ((anon34_Then_correct true))
(let ((inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct  (=> (|$IsValid'address'| 186537453) (=> (and (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1)) (and (=> (= (ControlFlow 0 1106370) 1108310) anon34_Then_correct) (=> (= (ControlFlow 0 1106370) 1106412) anon34_Else_correct))))))
(let ((anon33_Else_correct  (=> (and (not $t16@@1) (= (ControlFlow 0 1106376) 1106370)) inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct)))
(let ((anon0$1_correct@@13  (=> (|$IsValid'address'| (|$addr#$signer| _$t0@@13)) (=> (and (|$IsValid'address'| _$t1@@11) (|$IsValid'vec'u8''| _$t2@@3)) (=> (and (and (forall (($a_0@@22 Int) ) (! (let (($rsc@@22 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0@@22)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@22))
 :qid |DiemAccountbpl.20319:20|
 :skolemid |354|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0@@22))
)) (forall (($a_0@@23 Int) ) (! (let (($rsc@@23 (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@23)))
(|$IsValid'$1_VASPDomain_VASPDomainManager'| $rsc@@23))
 :qid |DiemAccountbpl.20323:20|
 :skolemid |355|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@23))
))) (and (forall (($a_0@@24 Int) ) (! (let (($rsc@@24 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) $a_0@@24)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc@@24) (and (and (let (($range_1 ($Range 0 (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@24)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@142 $i_2))
(<= (|l#Vec_37831| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@24)) i@@142))) 63)))
 :qid |DiemAccountbpl.20328:140|
 :skolemid |356|
))) (let (($range_3 ($Range 0 (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@24)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@143 $i_4))
(let (($range_5 ($Range (+ i@@143 1) (|l#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@24)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@44 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@24)) i@@143)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@24)) j@@44))))))
 :qid |DiemAccountbpl.20330:98|
 :skolemid |357|
)))))
 :qid |DiemAccountbpl.20329:202|
 :skolemid |358|
)))) (let (($range_7 (|$domains#$1_VASPDomain_VASPDomains| $rsc@@24)))
(forall (($i_8 Int) ) (!  (=> (InRangeVec_377227 $range_7 $i_8) (let (($elem@@3 (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_417075| $range_7) $i_8)))
(<= (|l#Vec_37831| (|$domain#$1_VASPDomain_VASPDomain| $elem@@3)) 63)))
 :qid |DiemAccountbpl.20331:229|
 :skolemid |359|
))))))
 :qid |DiemAccountbpl.20327:20|
 :skolemid |360|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) $a_0@@24))
)) (= $t11@@5 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_532840| $1_VASPDomain_VASPDomains_$memory) _$t1@@11))))) (=> (and (and (and (= $t12@@3 (|$addr#$signer| _$t0@@13)) (= $t13@@1 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $t14@@2 ($1_VASPDomain_VASPDomainEvent false ($1_VASPDomain_VASPDomain _$t2@@3) _$t1@@11)) (= _$t0@@13 _$t0@@13))) (and (and (= _$t1@@11 _$t1@@11) (= _$t2@@3 _$t2@@3)) (and (= $t15@@2 (|$addr#$signer| _$t0@@13)) (= $t16@@1  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t15@@2)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t15@@2)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453))))))) (and (=> (= (ControlFlow 0 1106283) 1108382) anon33_Then_correct) (=> (= (ControlFlow 0 1106283) 1106376) anon33_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@13  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@18 T@$1_Event_EventHandle) ) (! (let ((stream@@18 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@18)))
 (and (= (|l#Multiset_416285| stream@@18) 0) (forall ((v@@81 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@18) v@@81) 0)
 :qid |DiemAccountbpl.159:13|
 :skolemid |4|
))))
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1105895) 1106283)) anon0$1_correct@@13)))
(let ((anon0_correct@@13  (=> (and (= (|l#Vec_37831| (|p#$Mutation_533261| $t9@@10)) 0) (= (|l#Vec_37831| (|p#$Mutation_533261| $t24@@1)) 0)) (=> (and (and (= (|l#Vec_37831| (|p#$Mutation_437868| $t31)) 0) (= (|l#Vec_37831| (|p#$Mutation_533326| $t33)) 0)) (and (= (|l#Vec_37831| (|p#$Mutation_456960| $t34)) 0) (= (ControlFlow 0 1105905) 1105895))) inline$$InitEventStore$0$anon0_correct@@13))))
(let ((PreconditionGeneratedEntry_correct@@3  (=> (= (ControlFlow 0 1899721) 1105905) anon0_correct@@13)))
