...
(declare-fun $t7@0 () T@$Mutation_111899)
...
(declare-fun $t4 () T@$Mutation_111899)
(declare-fun $t7 () T@$Mutation_111899)
(declare-fun $t9 () T@$Mutation_111899)
(push 1)
(set-info :boogie-vc-id $1_DualAttestation_dual_attestation_message$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 317850) (let ((anon16_Else_correct  (=> (not false) (=> (and (= $t3@2 (|v#$Mutation_111899| |inline$$1_Vector_append'u8'$2$m'@1|)) (= $t3@2 $t3@2)) (and (=> (= (ControlFlow 0 237433) (- 0 318389)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 237433) (- 0 318396)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1) (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1)))
 :qid |DualAttestationbpl.15541:15|
 :skolemid |329|
 ...
 :qid |DualAttestationbpl.15541:15|
 :skolemid |329|
)) (and (=> (= (ControlFlow 0 237433) (- 0 318421)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1))))
 :qid |DualAttestationbpl.15546:15|
 :skolemid |330|
 ...
 :qid |DualAttestationbpl.15556:15|
 :skolemid |331|
)) (=> (= (ControlFlow 0 237433) (- 0 318503)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5) (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)))))
 :qid |DualAttestationbpl.15561:15|
 :skolemid |332|
)))))))))))))))))
(let ((anon16_Then_correct true))
(let ((|inline$$1_Vector_append'u8'$2$anon0_correct|  (=> (= |inline$$1_Vector_append'u8'$2$m'@1| ($Mutation_111899 (|l#$Mutation_111899| $t9@0) (|p#$Mutation_111899| $t9@0) (seq.++ (|v#$Mutation_111899| $t9@0) $t10@0))) (and (=> (= (ControlFlow 0 237249) 237447) anon16_Then_correct) (=> (= (ControlFlow 0 237249) 237433) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not false) (= $t3@1 (|v#$Mutation_111899| |inline$$1_Vector_append'u8'$1$m'@1|))) (=> (and (and (= $t9@0 ($Mutation_111899 ($Local 3) (as seq.empty (Seq Int)) $t3@1)) (= $t10@0 (seq.++ (seq.++ (seq.++ (seq.++ (seq.++ (seq.++ (seq.++ (seq.unit 64) (seq.unit 64)) (seq.unit 36)) (seq.unit 36)) (seq.++ (seq.++ (seq.++ (seq.unit 68) (seq.unit 73)) (seq.unit 69)) (seq.unit 77))) (seq.++ (seq.++ (seq.++ (seq.unit 95) (seq.unit 65)) (seq.unit 84)) (seq.unit 84))) (seq.++ (seq.++ (seq.++ (seq.unit 69) (seq.unit 83)) (seq.unit 84)) (seq.unit 36))) (seq.++ (seq.++ (seq.unit 36) (seq.unit 64)) (seq.unit 64))))) (and (|$IsValid'vec'u8''| $t10@0) (= (ControlFlow 0 237255) 237249))) |inline$$1_Vector_append'u8'$2$anon0_correct|))))
(let ((anon15_Then_correct true))
(let ((|inline$$1_Vector_append'u8'$1$anon0_correct|  (=> (= |inline$$1_Vector_append'u8'$1$m'@1| ($Mutation_111899 (|l#$Mutation_111899| $t7@0) (|p#$Mutation_111899| $t7@0) (seq.++ (|v#$Mutation_111899| $t7@0) call1formal@res@0))) (and (=> (= (ControlFlow 0 237108) 237471) anon15_Then_correct) (=> (= (ControlFlow 0 237108) 237255) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not false) (= (ControlFlow 0 237114) 237108)) |inline$$1_Vector_append'u8'$1$anon0_correct|)))
(let ((anon14_Then_correct true))
(let ((anon13_Else_correct  (=> (and (and (not false) (= $t3@0 (|v#$Mutation_111899| |inline$$1_Vector_append'u8'$0$m'@1|))) (and (= $t7@0 ($Mutation_111899 ($Local 3) (as seq.empty (Seq Int)) $t3@0)) (= call1formal@res@0 (|$1_BCS_serialize'u64'| _$t2)))) (and (=> (= (ControlFlow 0 237051) 237485) anon14_Then_correct) (=> (= (ControlFlow 0 237051) 237114) anon14_Else_correct)))))
(let ((anon13_Then_correct true))
(let ((|inline$$1_Vector_append'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_append'u8'$0$m'@1| ($Mutation_111899 (|l#$Mutation_111899| $t4@0) (|p#$Mutation_111899| $t4@0) (seq.++ (|v#$Mutation_111899| $t4@0) call1formal@res@0@@0))) (and (=> (= (ControlFlow 0 237021) 237499) anon13_Then_correct) (=> (= (ControlFlow 0 237021) 237051) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (not false) (= (ControlFlow 0 237027) 237021)) |inline$$1_Vector_append'u8'$0$anon0_correct|)))
(let ((anon12_Then_correct true))
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (and (|$IsValid'vec'u8''| _$t1) (|$IsValid'u64'| _$t2)) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (= _$t2 _$t2) (= _$t1 _$t1)) (and (= $t4@0 ($Mutation_111899 ($Local 3) (as seq.empty (Seq Int)) _$t1)) (= call1formal@res@0@@0 (|$1_BCS_serialize'address'| _$t0))))) (and (=> (= (ControlFlow 0 236964) 237513) anon12_Then_correct) (=> (= (ControlFlow 0 236964) 237027) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2787:13|
 :skolemid |79|
))) (= (ControlFlow 0 236894) 236964)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (seq.len (|p#$Mutation_111899| $t4)) 0) (= (seq.len (|p#$Mutation_111899| $t7)) 0)) (and (= (seq.len (|p#$Mutation_111899| $t9)) 0) (= (ControlFlow 0 236904) 236894))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 317850) 236904) anon0_correct)))
