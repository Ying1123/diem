...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory| () T@$Memory_146800)
(declare-fun |Select__T@[Int]$1_Roles_RoleId_| (|T@[Int]$1_Roles_RoleId| Int) T@$1_Roles_RoleId)
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@3| () T@$Memory_174360)
...
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@1| () T@$Memory_174360)
(declare-fun |inline$$1_DiemAccount_add_currency'#0'$0$$t10@1| () Int)
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@2| () T@$Memory_174360)
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@0| () T@$Memory_174360)
...
(declare-fun $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory () T@$Memory_138625)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory () T@$Memory_139588)
(declare-fun |Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|T@[Int]$1_ValidatorConfig_ValidatorConfig| Int) T@$1_ValidatorConfig_ValidatorConfig)
(declare-fun |$1_Diem_MintCapability'$1_XUS_XUS'_$memory| () T@$Memory_152578)
(declare-fun |$1_Diem_MintCapability'$1_XDX_XDX'_$memory| () T@$Memory_152665)
(declare-fun |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory| () T@$Memory_147080)
(declare-fun |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory| () T@$Memory_147167)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory| () T@$Memory_153244)
(declare-fun |$1_Diem_Preburn'$1_XUS_XUS'_$memory| () T@$Memory_152832)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory| () T@$Memory_153361)
(declare-fun |$1_Diem_Preburn'$1_XDX_XDX'_$memory| () T@$Memory_152913)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory| () T@$Memory_146600)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory| () T@$Memory_146664)
(declare-fun |$1_Diem_Preburn'#0'_$memory| () T@$Memory_152994)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory| () T@$Memory_153478)
(declare-fun $1_DualAttestation_Credential_$memory () T@$Memory_166928)
(declare-fun $1_VASPDomain_VASPDomainManager_$memory () T@$Memory_164510)
(declare-fun $1_DesignatedDealer_Dealer_$memory () T@$Memory_171666)
(declare-fun $1_VASP_ParentVASP_$memory () T@$Memory_165462)
(declare-fun $1_VASP_ChildVASP_$memory () T@$Memory_165398)
(declare-fun |Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|T@[Int]$1_Diem_CurrencyInfo'#0'| Int) |T@$1_Diem_CurrencyInfo'#0'|)
; Valid
(declare-fun $abort_flag@17@@0 () Bool)
(declare-fun _$t0@@1 () T@$signer)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@3| () T@$Memory_174178)
...
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@1| () T@$Memory_174178)
(declare-fun |inline$$1_DiemAccount_add_currency'$1_XUS_XUS'$0$$t10@1| () Int)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@2| () T@$Memory_174178)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@0| () T@$Memory_174178)
...
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3| () T@$Memory_174269)
...
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1| () T@$Memory_174269)
(declare-fun |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@1| () Int)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| () T@$Memory_174269)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@0| () T@$Memory_174269)
...
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory () T@$Memory_181412)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@0 () T@$Memory_172934)
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory@1 () T@$Memory_181412)
(declare-fun $t3@@0 () T@$1_DiemAccount_KeyRotationCapability)
(declare-fun $abort_flag@4@@3 () Bool)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@3 () T@$Mutation_183380)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2 () T@$Mutation_183380)
(declare-fun |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| () T@$Mutation_96380)
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory@0 () T@$Memory_181412)
...
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1 () T@$Mutation_96380)
...
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t21@1 () T@Vec_91158)
(declare-fun |inline$$1_RecoveryAddress_add_rotation_capability$0$$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@1| () T@Vec_91158)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@0 () T@$Mutation_183380)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@1 () T@$Mutation_183380)
...
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t8@0 () T@$Mutation_96380)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@0 () T@$Mutation_96380)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@0 () T@$Mutation_177149)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@0 () T@$Mutation_177149)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@0 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0 () T@$Mutation_177104)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@0 () T@$Memory_172934)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@0 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0 () Int)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@0 () T@$Mutation_177104)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@0 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@0 () T@$Mutation_177149)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@1 () T@$Memory_172934)
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory@3 () T@$Memory_181412)
(declare-fun $t1 () Int)
(declare-fun $abort_flag@5@@4 () Bool)
(declare-fun $abort_code@5@@4 () Int)
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory@1@@0 () T@$Memory_181412)
(declare-fun inline$$1_RecoveryAddress_publish$0$$t15@1 () Int)
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory@2 () T@$Memory_181412)
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory@0@@0 () T@$Memory_181412)
(declare-fun inline$$1_RecoveryAddress_publish$0$$t25@1 () T@$1_RecoveryAddress_RecoveryAddress)
(declare-fun $abort_flag@4@@4 () Bool)
(declare-fun |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$ret0@1| () T@Vec_91158)
(declare-fun |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$ret0@0| () T@Vec_91158)
(declare-fun |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1| () T@Vec_91158)
(declare-fun |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1@@0| () T@$Mutation_96380)
(declare-fun |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1| () T@$Mutation_96380)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@1 () T@$1_DiemAccount_KeyRotationCapability)
(declare-fun |inline$$1_Vector_empty'$1_DiemAccount_KeyRotationCapability'$0$v@1| () T@Vec_91158)
(declare-fun MapConstVec_80957 (T@$1_DiemAccount_KeyRotationCapability) |T@[Int]$1_DiemAccount_KeyRotationCapability|)
(declare-fun DefaultVecElem_80957 () T@$1_DiemAccount_KeyRotationCapability)
(declare-fun |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@0| () T@$Mutation_96380)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@1 () T@$Mutation_177149)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@1 () T@$Mutation_177149)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@1 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@1 () T@$Mutation_177104)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@1 () T@$Memory_172934)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@1 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@1 () Int)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@1 () T@$Mutation_177104)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@1 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@1 () T@$Mutation_177149)
...
(declare-fun $1_VASPDomain_VASPDomains_$memory () T@$Memory_164446)
(declare-fun $t1@@0 () Int)
(declare-fun $1_VASPDomain_VASPDomains_$memory@3 () T@$Memory_164446)
...
(declare-fun $1_VASPDomain_VASPDomains_$memory@1 () T@$Memory_164446)
(declare-fun $abort_code@1@@5 () Int)
(declare-fun $1_VASPDomain_VASPDomains_$memory@2 () T@$Memory_164446)
(declare-fun inline$$1_VASPDomain_publish_vasp_domains$0$$t7@1 () Int)
(declare-fun _$t0@@5 () T@$signer)
(declare-fun $1_VASPDomain_VASPDomains_$memory@0 () T@$Memory_164446)
...
(declare-fun |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$v@1| () T@Vec_91804)
(declare-fun MapConstVec_82163 (T@$1_VASPDomain_VASPDomain) |T@[Int]$1_VASPDomain_VASPDomain|)
(declare-fun DefaultVecElem_82163 () T@$1_VASPDomain_VASPDomain)
...
(declare-fun $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory () T@$Memory_179559)
(declare-fun $t2@@2 () Int)
(declare-fun $t3@@3 () Int)
(declare-fun _$t0@@6 () T@$signer)
(declare-fun _$t1@@1 () T@Vec_25477)
(declare-fun $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory@3 () T@$Memory_179559)
...
(declare-fun $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory@1 () T@$Memory_179559)
(declare-fun $abort_code@8@@3 () Int)
(declare-fun $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory@2 () T@$Memory_179559)
(declare-fun inline$$1_SharedEd25519PublicKey_publish$0$$t11@1 () Int)
(declare-fun $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory@0 () T@$Memory_179559)
...
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$ret0@1 () T@$Mutation_179770)
(declare-fun $abort_flag@5@@5 () Bool)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@1 () T@$Mutation_124358)
(declare-fun inline$$1_SharedEd25519PublicKey_publish$0$$t12@1 () T@$Mutation_179770)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@2 () T@$Mutation_124358)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t0@1 () T@$Mutation_179770)
...
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$ret0@0 () T@$Mutation_179770)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@0 () T@$Mutation_124358)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@0 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@0 () T@$Mutation_124358)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t9@0 () T@Vec_25477)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@0 () T@$Mutation_177104)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2@@0 () T@$Memory_172934)
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@2 () T@$Memory_172934)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@0 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@0 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@0 () T@$Mutation_177104)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@0 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@0 () T@$Mutation_124358)
...
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@0 () T@$Mutation_124358)
...
(declare-fun inline$$1_SharedEd25519PublicKey_publish$0$$t8@1 () T@Vec_25477)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@2 () T@$Mutation_177149)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@2 () T@$Mutation_177149)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@2 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@2 () T@$Mutation_177104)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@2 () T@$Memory_172934)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@2 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@2 () Int)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@2 () T@$Mutation_177104)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@2 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@2 () T@$Mutation_177149)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t7@0@@2 () Int)
(declare-fun inline$$1_SharedEd25519PublicKey_publish$0$$t12@0 () T@$Mutation_179770)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@5@@0 () T@$Memory_172934)
(declare-fun $t4@@4 () Int)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@0 () Bool)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0 () T@$Mutation_177149)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0 () T@$Mutation_177149)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@0 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0 () T@$Mutation_177104)
(declare-fun $1_DiemAccount_DiemAccount_$memory@4@@0 () T@$Memory_172934)
(declare-fun $1_DiemAccount_DiemAccount_$memory@3@@0 () T@$Memory_172934)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@0 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0 () Int)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@0 () T@$Mutation_177104)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t3@0@@0 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@0@@0 () T@$Mutation_177149)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1 () Bool)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@1 () T@$Mutation_124358)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@1 () T@$Mutation_124358)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@1 () T@$Mutation_177104)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2@@1 () T@$Memory_172934)
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@3 () T@$Memory_172934)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@1 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@1 () T@$Mutation_177104)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@1 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@1 () T@$Mutation_124358)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@3 () Bool)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3 () T@$Mutation_177149)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3 () T@$Mutation_177149)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@3 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3 () T@$Mutation_177104)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@3 () T@$Memory_172934)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@3 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 () Int)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@3 () T@$Mutation_177104)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@3 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@3 () T@$Mutation_177149)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@5@@1 () T@$Memory_172934)
(declare-fun $t5@@4 () Int)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@1 () Bool)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1 () T@$Mutation_177149)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1 () T@$Mutation_177149)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@1 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1 () T@$Mutation_177104)
(declare-fun $1_DiemAccount_DiemAccount_$memory@4@@1 () T@$Memory_172934)
(declare-fun $1_DiemAccount_DiemAccount_$memory@3@@1 () T@$Memory_172934)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@1 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1 () Int)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@1 () T@$Mutation_177104)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t3@0@@1 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@0@@1 () T@$Mutation_177149)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2 () Bool)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@2 () T@$Mutation_124358)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@2 () T@$Mutation_124358)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@2 () T@$Mutation_177104)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2@@2 () T@$Memory_172934)
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@4 () T@$Memory_172934)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@2 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@2 () T@$Mutation_177104)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@2 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@2 () T@$Mutation_124358)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@4 () Bool)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4 () T@$Mutation_177149)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4 () T@$Mutation_177149)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@4 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4 () T@$Mutation_177104)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@4 () T@$Memory_172934)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@4 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 () Int)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@4 () T@$Mutation_177104)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@4 () T@$Mutation_177104)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@4 () T@$Mutation_177149)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@0 () T@$Memory_140200)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@0 () T@$Memory_140200)
...
(assert (not
 (=> (= (ControlFlow 0 0) 366598) (let ((L2_correct@@3  (and (=> (= (ControlFlow 0 269107) (- 0 369659)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) $t7@@0))) (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t6@@3)))) (not (= (|l#Vec_25477| _$t3) 32))) (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) $t7@@0))) (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t6@@3)))) (not (= (|l#Vec_25477| _$t3) 32))) (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0)) (=> (= (ControlFlow 0 269107) (- 0 369726)) (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (= 5 $t8@0@@1)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0) 0)) (= 7 $t8@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) $t7@@0)) (= 5 $t8@0@@1))) (and (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0) (= 1 $t8@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t6@@3))) (= 5 $t8@0@@1))) (and (not (= (|l#Vec_25477| _$t3) 32)) (= 7 $t8@0@@1))) (and (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0) (= 1 $t8@0@@1))) (= 7 $t8@0@@1)) (= 1 $t8@0@@1)) (= 5 $t8@0@@1)))))))
(let ((anon13_Then_correct@@0  (=> (and (and $abort_flag@8@@4 (= $abort_code@9@@4 $abort_code@9@@4)) (and (= $t8@0@@1 $abort_code@9@@4) (= (ControlFlow 0 268863) 269107))) L2_correct@@3)))
(let ((anon12_Then_correct@@0  (=> (and (and $abort_flag@6@@6 (= $abort_code@7@@5 $abort_code@7@@5)) (and (= $t8@0@@1 $abort_code@7@@5) (= (ControlFlow 0 269121) 269107))) L2_correct@@3)))
(let ((anon11_Then_correct@@0  (=> (and (and $abort_flag@4@@7 (= $abort_code@5@@7 $abort_code@5@@7)) (and (= $t8@0@@1 $abort_code@5@@7) (= (ControlFlow 0 269135) 269107))) L2_correct@@3)))
(let ((anon10_Then_correct@@1  (=> (and (and $abort_flag@0@@8 (= $abort_code@1@@8 $abort_code@1@@8)) (and (= $t8@0@@1 $abort_code@1@@8) (= (ControlFlow 0 269149) 269107))) L2_correct@@3)))
(let ((anon13_Else_correct@@0  (=> (not $abort_flag@8@@4) (and (=> (= (ControlFlow 0 268849) (- 0 369541)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8)))) (and (=> (= (ControlFlow 0 268849) (- 0 369554)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0) 0))) (and (=> (= (ControlFlow 0 268849) (- 0 369569)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) $t7@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) $t7@@0))) (and (=> (= (ControlFlow 0 268849) (- 0 369581)) (not (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0))) (=> (not (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0)) (and (=> (= (ControlFlow 0 268849) (- 0 369592)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t6@@3))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t6@@3)))) (and (=> (= (ControlFlow 0 268849) (- 0 369606)) (not (not (= (|l#Vec_25477| _$t3) 32)))) (=> (not (not (= (|l#Vec_25477| _$t3) 32))) (and (=> (= (ControlFlow 0 268849) (- 0 369620)) (not (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0))) (=> (not (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0)) (=> (= (ControlFlow 0 268849) (- 0 369631)) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@5@@1) $t5@@4)) _$t3)))))))))))))))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Else_correct@@1  (=> (not inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@1) (=> (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1 ($Mutation_177149 (|l#$Mutation_177149| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1) (|p#$Mutation_177149| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1) |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''@1@@1|)) (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_177149| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1))) (=> (and (and (and (and (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_177149| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1)) (<= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_177149| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1))) 1)) (not (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_177149| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1))) 0))) (and (= (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_177149| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1))) 0) inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@1 ($Mutation_177104 (|l#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1) (|p#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1) ($1_DiemAccount_DiemAccount (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)) (|v#$Mutation_177149| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@4@@1 ($Memory_172934 (|Store__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@3@@1) (|a#$Global| (|l#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@1)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@3@@1) (|a#$Global| (|l#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@1)) (|v#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@1)))) (= $1_DiemAccount_DiemAccount_$memory@5@@1 $1_DiemAccount_DiemAccount_$memory@4@@1)) (and (= $abort_code@9@@4 $abort_code@8@@5) (= $abort_flag@8@@4 $abort_flag@7@@5)))) (and (=> (= (ControlFlow 0 268621) 268863) anon13_Then_correct@@0) (=> (= (ControlFlow 0 268621) 268849) anon13_Else_correct@@0)))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@1  (=> (= $1_DiemAccount_DiemAccount_$memory@5@@1 $1_DiemAccount_DiemAccount_$memory@3@@1) (=> (and (= $abort_code@9@@4 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@1) (= $abort_flag@8@@4 true)) (and (=> (= (ControlFlow 0 268467) 268863) anon13_Then_correct@@0) (=> (= (ControlFlow 0 268467) 268849) anon13_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Then_correct@@1  (=> inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@1 (=> (and (and (and (not (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_177149| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1))) 0)) (= 7 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@1)) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@1)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@1) (= (ControlFlow 0 268647) 268467))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@1))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@1  (=> (not $abort_flag@7@@5) (=> (and (and (= |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1| (|v#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)) (= |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1| |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1|)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1 ($Mutation_177149 (|l#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1) (let ((l@@13 (|l#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1))))
(Vec_25477 (|Store__T@[Int]Int_| (|v#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)) l@@13 2) (+ l@@13 1))) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)))) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@1  (not (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_177149| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1))) 0))))) (and (=> (= (ControlFlow 0 268539) 268647) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Then_correct@@1) (=> (= (ControlFlow 0 268539) 268621) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@1  (=> (and (and $abort_flag@7@@5 (= $abort_code@8@@5 $abort_code@8@@5)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@1 $abort_code@8@@5) (= (ControlFlow 0 268661) 268467))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@1)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then$1_correct@@1  (=> (= $abort_flag@7@@5 true) (=> (and (= $abort_code@8@@5 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@1)) (and (=> (= (ControlFlow 0 268713) 268661) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@1) (=> (= (ControlFlow 0 268713) 268539) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@3@@1) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1)) (= (ControlFlow 0 268711) 268713)) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then$1_correct@@1)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@3@@1) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1) (=> (and (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@1 ($Mutation_177104 ($Global inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1) (Vec_25477 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@3@@1) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1))) (= $abort_flag@7@@5 $abort_flag@6@@6)) (and (= $abort_code@8@@5 $abort_code@7@@5) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@1))) (and (=> (= (ControlFlow 0 268497) 268661) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@1) (=> (= (ControlFlow 0 268497) 268539) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Then_correct@@1  (=> (and inline$$1_DiemAccount_exists_at$3$$t1@1@@1 (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4))) (and (=> (= (ControlFlow 0 268475) 268711) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then_correct@@1) (=> (= (ControlFlow 0 268475) 268497) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Else_correct@@1)))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Else_correct@@1  (=> (and (and (not inline$$1_DiemAccount_exists_at$3$$t1@1@@1) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1) (= (ControlFlow 0 268461) 268467))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@1)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Else_correct@@1  (=> (and (not $abort_flag@6@@6) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1 5)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1) (= inline$$1_DiemAccount_exists_at$3$$t1@1@@1 inline$$1_DiemAccount_exists_at$3$$t1@1@@1))) (and (=> (= (ControlFlow 0 268445) 268475) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Then_correct@@1) (=> (= (ControlFlow 0 268445) 268461) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Then_correct@@1  (=> (and (and $abort_flag@6@@6 (= $abort_code@7@@5 $abort_code@7@@5)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@1 $abort_code@7@@5) (= (ControlFlow 0 268727) 268467))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@1)))
(let ((inline$$1_DiemAccount_exists_at$3$anon0_correct@@1  (=> (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@1) (=> (and (= inline$$1_DiemAccount_exists_at$3$$t1@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@3@@1) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@1)) (= inline$$1_DiemAccount_exists_at$3$$t1@1@@1 inline$$1_DiemAccount_exists_at$3$$t1@1@@1)) (and (=> (= (ControlFlow 0 268403) 268727) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Then_correct@@1) (=> (= (ControlFlow 0 268403) 268445) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon0_correct@@1  (=> (and (= (|l#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t3@0@@1)) 0) (= (|l#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@1)) 0)) (=> (and (and (= (|l#Vec_25477| (|p#$Mutation_177149| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@0@@1)) 0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4)) (= (ControlFlow 0 268409) 268403))) inline$$1_DiemAccount_exists_at$3$anon0_correct@@1))))
(let ((anon12_Else_correct@@0  (=> (and (not $abort_flag@6@@6) (= (ControlFlow 0 268731) 268409)) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon0_correct@@1)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@2  (=> (and (and (and inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@2 ($Mutation_124358 (|l#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2) (let ((l@@14 (|l#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2))))
(Vec_25477 (|Store__T@[Int]Int_| (|v#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2)) l@@14 0) (+ l@@14 1))) (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2))))) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@2 ($Mutation_124358 (|l#$Mutation_124358| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@2) (|p#$Mutation_124358| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@2) _$t3)) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@2 ($Mutation_177104 (|l#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2) (|p#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2) ($1_DiemAccount_DiemAccount (|v#$Mutation_124358| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@2) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2)) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@2@@2 ($Memory_172934 (|Store__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@1@@4) (|a#$Global| (|l#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@2)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@1@@4) (|a#$Global| (|l#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@2)) (|v#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@2)))) (= $abort_code@7@@5 $abort_code@6@@7)) (and (= $1_DiemAccount_DiemAccount_$memory@3@@1 $1_DiemAccount_DiemAccount_$memory@2@@2) (= $abort_flag@6@@6 $abort_flag@5@@7)))) (and (=> (= (ControlFlow 0 267708) 269121) anon12_Then_correct@@0) (=> (= (ControlFlow 0 267708) 268731) anon12_Else_correct@@0)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2  (=> (= $abort_code@7@@5 inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2) (=> (and (= $1_DiemAccount_DiemAccount_$memory@3@@1 $1_DiemAccount_DiemAccount_$memory@1@@4) (= $abort_flag@6@@6 true)) (and (=> (= (ControlFlow 0 267504) 269121) anon12_Then_correct@@0) (=> (= (ControlFlow 0 267504) 268731) anon12_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@2  (=> (and (and (not inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2) (= (ControlFlow 0 267658) 267504))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@2  (=> (and (and (and (not $abort_flag@5@@7) (|$IsValid'u64'| 32)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2 (= |inline$$1_Vector_length'u8'$0$l@1@@2| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2 7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2)))) (and (=> (= (ControlFlow 0 267642) 267708) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@2) (=> (= (ControlFlow 0 267642) 267658) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@2)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@2  (=> (and (and $abort_flag@5@@7 (= $abort_code@6@@7 $abort_code@6@@7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2 $abort_code@6@@7) (= (ControlFlow 0 267722) 267504))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2)))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct@@2|  (=> (= |inline$$1_Vector_length'u8'$0$l@1@@2| (|l#Vec_25477| _$t3)) (and (=> (= (ControlFlow 0 267584) 267722) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@2) (=> (= (ControlFlow 0 267584) 267642) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@2)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@2  (=> (and (and (not $abort_flag@5@@7) (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@2| (|v#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2))) (and (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@2| |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@2|) (= (ControlFlow 0 267590) 267584))) |inline$$1_Vector_length'u8'$0$anon0_correct@@2|)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@2  (=> (and (and $abort_flag@5@@7 (= $abort_code@6@@7 $abort_code@6@@7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2 $abort_code@6@@7) (= (ControlFlow 0 267736) 267504))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@2  (=> (= $abort_flag@5@@7 true) (=> (and (= $abort_code@6@@7 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@2)) (and (=> (= (ControlFlow 0 267788) 267736) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@2) (=> (= (ControlFlow 0 267788) 267590) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@2))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@2  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@1@@4) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2)) (= (ControlFlow 0 267786) 267788)) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@2)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@2  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@1@@4) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@2 ($Mutation_177104 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2) (Vec_25477 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@1@@4) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2))) (= $abort_flag@5@@7 $abort_flag@4@@7)) (and (= $abort_code@6@@7 $abort_code@5@@7) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@2))) (and (=> (= (ControlFlow 0 267534) 267736) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@2) (=> (= (ControlFlow 0 267534) 267590) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@2))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@2  (=> (and inline$$1_DiemAccount_exists_at$2$$t1@1@@2 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4))) (and (=> (= (ControlFlow 0 267512) 267786) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@2) (=> (= (ControlFlow 0 267512) 267534) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@2)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@2  (=> (and (and (not inline$$1_DiemAccount_exists_at$2$$t1@1@@2) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2) (= (ControlFlow 0 267498) 267504))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@2  (=> (and (not $abort_flag@4@@7) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2 5)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2) (= inline$$1_DiemAccount_exists_at$2$$t1@1@@2 inline$$1_DiemAccount_exists_at$2$$t1@1@@2))) (and (=> (= (ControlFlow 0 267482) 267512) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@2) (=> (= (ControlFlow 0 267482) 267498) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@2))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@2  (=> (and (and $abort_flag@4@@7 (= $abort_code@5@@7 $abort_code@5@@7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2 $abort_code@5@@7) (= (ControlFlow 0 267802) 267504))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2)))
(let ((inline$$1_DiemAccount_exists_at$2$anon0_correct@@2  (=> (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@2) (=> (and (= inline$$1_DiemAccount_exists_at$2$$t1@1@@2 (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory@1@@4) inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@2)) (= inline$$1_DiemAccount_exists_at$2$$t1@1@@2 inline$$1_DiemAccount_exists_at$2$$t1@1@@2)) (and (=> (= (ControlFlow 0 267440) 267802) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@2) (=> (= (ControlFlow 0 267440) 267482) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@2))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@2  (=> (= (|l#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@2)) 0) (=> (and (= (|l#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@2)) 0) (= (|l#Vec_25477| (|p#$Mutation_124358| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@2)) 0)) (=> (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4) (= _$t3 _$t3)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@2 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4)) (= (ControlFlow 0 267446) 267440))) inline$$1_DiemAccount_exists_at$2$anon0_correct@@2)))))
(let ((anon11_Else_correct@@0  (=> (not $abort_flag@4@@7) (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4) (= (ControlFlow 0 267806) 267446)) inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@2))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct@@4  (=> (not inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@4) (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4 ($Mutation_177149 (|l#$Mutation_177149| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4) (|p#$Mutation_177149| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4) |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''@1@@4|)) (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_177149| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4))) (=> (and (and (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_177149| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4)) (<= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_177149| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4))) 1)) (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@4) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@4 (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1@@4)) 0)))) (=> (and (and (and (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_177149| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4))) 0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@4 ($Mutation_177104 (|l#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4) (|p#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4) ($1_DiemAccount_DiemAccount (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4)) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4)) (|v#$Mutation_177149| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4)))))) (and (= $1_DiemAccount_DiemAccount_$memory@0@@4 ($Memory_172934 (|Store__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@4)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@4)) (|v#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@4)))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@4))) (and (and (= $abort_flag@4@@7 $abort_flag@3@@7) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@4)) (and (= $abort_code@5@@7 $abort_code@4@@7) (= $1_DiemAccount_DiemAccount_$memory@1@@4 $1_DiemAccount_DiemAccount_$memory@0@@4)))) (and (=> (= (ControlFlow 0 266644) 269135) anon11_Then_correct@@0) (=> (= (ControlFlow 0 266644) 267806) anon11_Else_correct@@0))))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4  (=> (and (and (= $abort_flag@4@@7 true) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@0@@4)) (and (= $abort_code@5@@7 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4) (= $1_DiemAccount_DiemAccount_$memory@1@@4 $1_DiemAccount_DiemAccount_$memory))) (and (=> (= (ControlFlow 0 266321) 269135) anon11_Then_correct@@0) (=> (= (ControlFlow 0 266321) 267806) anon11_Else_correct@@0)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct@@4  (=> inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@4 (=> (and (and (and (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_177149| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4))) 0) (= 7 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@4)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@4)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@4) (= (ControlFlow 0 266670) 266321))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@4  (=> (and (not $abort_flag@3@@7) (= |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@4| (|v#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4))) (=> (and (and (= |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@4| |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@4|) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4 ($Mutation_177149 (|l#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4) (let ((l@@15 (|l#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4))))
(Vec_25477 (|Store__T@[Int]Int_| (|v#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4)) l@@15 2) (+ l@@15 1))) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4))))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1@@4 (|v#$Mutation_177149| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@4 (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_177149| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4))) 0)))) (and (=> (= (ControlFlow 0 266552) 266670) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct@@4) (=> (= (ControlFlow 0 266552) 266644) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@4  (=> (and (and $abort_flag@3@@7 (= $abort_code@4@@7 $abort_code@4@@7)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 $abort_code@4@@7) (= (ControlFlow 0 266684) 266321))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct@@4  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@4) (=> (and (= $abort_code@4@@7 $EXEC_FAILURE_CODE) (= $abort_flag@3@@7 true)) (and (=> (= (ControlFlow 0 266736) 266684) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@4) (=> (= (ControlFlow 0 266736) 266552) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct@@4  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4)) (= (ControlFlow 0 266734) 266736)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct@@4  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (=> (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@4 ($Mutation_177104 ($Global inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (Vec_25477 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@4)) (and (= $abort_code@4@@7 $abort_code@3@@7) (= $abort_flag@3@@7 $abort_flag@2@@7))) (and (=> (= (ControlFlow 0 266506) 266684) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@4) (=> (= (ControlFlow 0 266506) 266552) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct@@4  (=> inline$$1_DiemAccount_exists_at$1$$t1@1@@4 (and (=> (= (ControlFlow 0 266484) 266734) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct@@4) (=> (= (ControlFlow 0 266484) 266506) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct@@4)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct@@4  (=> (and (and (not inline$$1_DiemAccount_exists_at$1$$t1@1@@4) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4) (= (ControlFlow 0 266480) 266321))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct@@4  (=> (and (not $abort_flag@2@@7) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4 5)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4) (= inline$$1_DiemAccount_exists_at$1$$t1@1@@4 inline$$1_DiemAccount_exists_at$1$$t1@1@@4))) (and (=> (= (ControlFlow 0 266464) 266484) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct@@4) (=> (= (ControlFlow 0 266464) 266480) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct@@4  (=> (and (and $abort_flag@2@@7 (= $abort_code@3@@7 $abort_code@3@@7)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 $abort_code@3@@7) (= (ControlFlow 0 266750) 266321))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_exists_at$1$anon0_correct@@4  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (=> (and (= inline$$1_DiemAccount_exists_at$1$$t1@1@@4 (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4)) (= inline$$1_DiemAccount_exists_at$1$$t1@1@@4 inline$$1_DiemAccount_exists_at$1$$t1@1@@4)) (and (=> (= (ControlFlow 0 266422) 266750) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct@@4) (=> (= (ControlFlow 0 266422) 266464) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct@@4  (=> (and inline$$Not$0$dst@1@@8 (= (ControlFlow 0 266428) 266422)) inline$$1_DiemAccount_exists_at$1$anon0_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct@@4  (=> (and (and (not inline$$Not$0$dst@1@@8) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4) (= (ControlFlow 0 266315) 266321))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct@@4  (=> (|$IsValid'u64'| 9) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4 1)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4) (= inline$$Not$0$dst@1@@8 inline$$Not$0$dst@1@@8))) (and (=> (= (ControlFlow 0 266299) 266428) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct@@4) (=> (= (ControlFlow 0 266299) 266315) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct@@4))))))
(let ((inline$$Not$0$anon0_correct@@8  (=> (and (= inline$$Not$0$dst@1@@8  (not inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@4)) (= (ControlFlow 0 266259) 266299)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@4  (=> (and (not $abort_flag@2@@7) (= (ControlFlow 0 266265) 266259)) inline$$Not$0$anon0_correct@@8)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@4  (=> (and (and $abort_flag@2@@7 (= $abort_code@3@@7 $abort_code@3@@7)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 $abort_code@3@@7) (= (ControlFlow 0 266764) 266321))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@4  (=> (not $abort_flag@1@@8) (=> (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1@@4 (|$key_rotation_capability#$1_DiemAccount_DiemAccount| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@4)) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@4 (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1@@4)) 0))) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@4) (= $abort_flag@2@@7 $abort_flag@1@@8)) (and (= $abort_code@3@@7 $abort_code@2@@8) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@4))) (and (=> (= (ControlFlow 0 266135) 266764) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@4) (=> (= (ControlFlow 0 266135) 266265) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@4)))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@4  (=> (= $abort_flag@2@@7 true) (=> (and (= $abort_code@3@@7 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@4) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@0@@4)) (and (=> (= (ControlFlow 0 266083) 266764) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@4) (=> (= (ControlFlow 0 266083) 266265) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@4  (=> (and (and $abort_flag@1@@8 (= $abort_code@2@@8 $abort_code@2@@8)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@4 $abort_code@2@@8) (= (ControlFlow 0 266149) 266083))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@4)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct@@4  (=> (= $abort_code@2@@8 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@8 true) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@0@@4)) (and (=> (= (ControlFlow 0 266201) 266149) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@4) (=> (= (ControlFlow 0 266201) 266135) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct@@4  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4)) (= (ControlFlow 0 266199) 266201)) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct@@4)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct@@4  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1@@4 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4)) (= $abort_code@2@@8 $abort_code@1@@8)) (and (= $abort_flag@1@@8 $abort_flag@0@@8) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1@@4))) (and (=> (= (ControlFlow 0 266101) 266149) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@4) (=> (= (ControlFlow 0 266101) 266135) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct@@4  (=> inline$$1_DiemAccount_exists_at$0$$t1@1@@7 (and (=> (= (ControlFlow 0 266087) 266199) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct@@4) (=> (= (ControlFlow 0 266087) 266101) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct@@4)))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct@@4  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1@@7) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4) (= (ControlFlow 0 266077) 266083))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@4)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct@@4  (=> (and (not $abort_flag@0@@8) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4 5)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@7 inline$$1_DiemAccount_exists_at$0$$t1@1@@7))) (and (=> (= (ControlFlow 0 266061) 266087) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct@@4) (=> (= (ControlFlow 0 266061) 266077) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct@@4  (=> (and (and $abort_flag@0@@8 (= $abort_code@1@@8 $abort_code@1@@8)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@4 $abort_code@1@@8) (= (ControlFlow 0 266215) 266083))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@4)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct@@7  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1@@7 (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4)) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@7 inline$$1_DiemAccount_exists_at$0$$t1@1@@7)) (and (=> (= (ControlFlow 0 266019) 266215) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct@@4) (=> (= (ControlFlow 0 266019) 266061) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct@@4  (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (= (ControlFlow 0 266025) 266019)) inline$$1_DiemAccount_exists_at$0$anon0_correct@@7)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct@@4  (=> (= (|l#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@4)) 0) (=> (and (and (and (= (|l#Vec_25477| (|p#$Mutation_177104| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@4)) 0) (= (|l#Vec_25477| (|p#$Mutation_177149| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@4)) 0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t7@0@@4 (|$addr#$signer| _$t1@@3)) (= _$t1@@3 _$t1@@3))) (and (and (|$IsValid'address'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 (|$addr#$signer| _$t1@@3))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (= (ControlFlow 0 266221) 266025)))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct@@4))))
(let ((anon10_Else_correct@@1  (=> (not $abort_flag@0@@8) (=> (and (= $t9@@1 (|$addr#$signer| _$t1@@3)) (= (ControlFlow 0 266770) 266221)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct@@4))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@0  (=> (and (= $abort_flag@0@@8 true) (= $abort_code@1@@8 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@0)) (and (=> (= (ControlFlow 0 264868) 269149) anon10_Then_correct@@1) (=> (= (ControlFlow 0 264868) 266770) anon10_Else_correct@@1)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@0  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0) (= (ControlFlow 0 264862) 264868))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@0)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@0  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@0) (= (ControlFlow 0 264918) 264868))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@0))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@0  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@0 (=> (and (= $abort_flag@0@@8 false) (= $abort_code@1@@8 $abort_code@0@@8)) (and (=> (= (ControlFlow 0 264874) 269149) anon10_Then_correct@@1) (=> (= (ControlFlow 0 264874) 266770) anon10_Else_correct@@1))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@0  (=> (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@0) (=> (and (and (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@0 ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@0)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@0 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@0 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@0)))) (and (=> (= (ControlFlow 0 264846) 264874) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@0) (=> (= (ControlFlow 0 264846) 264862) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@0))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@0  (=> (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@0|) (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@1@@0 ($Memory_140200 (|Store__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8) false) (|contents#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory))) (= (ControlFlow 0 264788) 264846)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@0))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@0  (=> |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@0| (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@0@@0 ($Memory_140200 (|Store__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1@@0|))) (= (ControlFlow 0 264888) 264846)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@0))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@0  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@0) (and (=> (= (ControlFlow 0 264774) 264888) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@0) (=> (= (ControlFlow 0 264774) 264788) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@0)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@0  (=> (= _$t0@@8 _$t0@@8) (=> (and (= _$t2@@0 _$t2@@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))))) (and (=> (= (ControlFlow 0 264768) 264918) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@0) (=> (= (ControlFlow 0 264768) 264774) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@0))))))
(let ((anon0$1_correct@@8  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (forall ((addr@@234 Int) ) (!  (=> (|$IsValid'address'| addr@@234) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@234) (or (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@234)))) 0) (and (not (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@234)))) 0)) (= addr@@234 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@234)))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.18394:20|
 :skolemid |453|
))) (=> (and (and (and (forall ((addr@@235 Int) ) (!  (=> (|$IsValid'address'| addr@@235) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@235) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@235) (= (|l#Vec_91197| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@235)))) 0)) (and (not (= (|l#Vec_91197| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@235)))) 0)) (= addr@@235 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_91197| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@235)))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.18398:20|
 :skolemid |454|
)) (forall ((addr@@236 Int) ) (!  (=> (|$IsValid'address'| addr@@236) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@236) (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@236)))
 :qid |AccountAdministrationScriptsbpl.18402:20|
 :skolemid |455|
))) (and (forall ((addr@@237 Int) ) (!  (=> (|$IsValid'address'| addr@@237) (=> (and (= addr@@237 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@237)) (|Select__T@[Int]Bool_| (|domain#$Memory_174043| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@237)))
 :qid |AccountAdministrationScriptsbpl.18406:20|
 :skolemid |456|
)) (forall ((addr@@238 Int) ) (!  (=> (|$IsValid'address'| addr@@238) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@238) (|Select__T@[Int]Bool_| (|domain#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) addr@@238)))
 :qid |AccountAdministrationScriptsbpl.18410:20|
 :skolemid |457|
)))) (and (and (forall ((addr@@239 Int) ) (!  (=> (|$IsValid'address'| addr@@239) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174178| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@239) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@239)))
 :qid |AccountAdministrationScriptsbpl.18414:22|
 :skolemid |458|
)) (forall ((addr@@240 Int) ) (!  (=> (|$IsValid'address'| addr@@240) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@240) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@240)))
 :qid |AccountAdministrationScriptsbpl.18414:218|
 :skolemid |459|
))) (forall ((addr@@241 Int) ) (!  (=> (|$IsValid'address'| addr@@241) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174360| |$1_DiemAccount_Balance'#0'_$memory|) addr@@241) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@241)))
 :qid |AccountAdministrationScriptsbpl.18414:415|
 :skolemid |460|
)))) (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@8)) (|$IsValid'address'| (|$addr#$signer| _$t1@@3))) (and (|$IsValid'u64'| _$t2@@0) (|$IsValid'vec'u8''| _$t3))) (and (and (forall (($a_0@@26 Int) ) (! (let (($rsc@@26 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@26)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@26))
 :qid |AccountAdministrationScriptsbpl.18429:20|
 :skolemid |461|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@26))
)) (forall (($a_0@@27 Int) ) (! (let (($rsc@@27 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) $a_0@@27)))
 (and (|$IsValid'$1_DiemAccount_DiemAccount'| $rsc@@27) (and (<= (|l#Vec_91197| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| $rsc@@27))) 1) (<= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| $rsc@@27))) 1))))
 :qid |AccountAdministrationScriptsbpl.18433:20|
 :skolemid |462|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) $a_0@@27))
))) (and (= $t5@@4 (|$addr#$signer| _$t1@@3)) (= $t6@@3 (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) $t5@@4)))) 0))))) (and (and (and (= $t7@@0 (|$addr#$signer| _$t1@@3)) (let ((addr@@242 (|$addr#$signer| _$t1@@3)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@242)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) addr@@242) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) addr@@242))))))) (and (let ((addr@@243 (|$addr#$signer| _$t0@@8)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@243) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@243)) 0))) (= _$t0@@8 _$t0@@8))) (and (and (= _$t1@@3 _$t1@@3) (= _$t2@@0 _$t2@@0)) (and (= _$t3 _$t3) (= (ControlFlow 0 264922) 264768))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@0))))))
(let ((inline$$InitEventStore$0$anon0_correct@@8  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@10 T@$1_Event_EventHandle) ) (! (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $es) handle@@10)))
 (and (= (|l#Multiset_91033| stream@@9) 0) (forall ((v@@69 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@9) v@@69) 0)
 :qid |AccountAdministrationScriptsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountAdministrationScriptsbpl.3307:13|
 :skolemid |119|
))) (= (ControlFlow 0 264006) 264922)) anon0$1_correct@@8)))
(let ((anon0_correct@@8  (=> (= (ControlFlow 0 366598) 264006) inline$$InitEventStore$0$anon0_correct@@8)))
anon0_correct@@8)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
