...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 93226) (let ((anon22_Else_correct  (=> (and (and (not $t16) (|$IsValid'$1_ValidatorConfig_Config'| $t15)) (and (= $t15 (seq.nth (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t11@0) 0)) (= $t15 $t15))) (and (=> (= (ControlFlow 0 81437) (- 0 93850)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0))) (and (=> (= (ControlFlow 0 81437) (- 0 93861)) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))) (=> (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0)) (=> (= (ControlFlow 0 81437) (- 0 93874)) (= $t15 (seq.nth (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0))) 0))))))))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 81265) (- 0 93771)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0)) (=> (= (ControlFlow 0 81265) (- 0 93787)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= 5 $t7@0)) (and (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0) (= 7 $t7@0))))))))
(let ((anon22_Then_correct  (=> $t16 (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t11@0)) 0) (= 7 $t7)) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 81461) 81265))) L5_correct))))
(let ((anon21_Then_correct  (=> (and $t12 (= $t16 (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t11@0)) 0))) (and (=> (= (ControlFlow 0 81371) 81461) anon22_Then_correct) (=> (= (ControlFlow 0 81371) 81437) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (and (not $t12) (= $t14 $t14)) (and (= $t7@0 $t14) (= (ControlFlow 0 81359) 81265))) L5_correct)))
(let ((anon20_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= $t11@0 (|$config#$1_ValidatorConfig_ValidatorConfig| $t10@1)) (= $t11@0 $t11@0)) (and (= $t12  (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t11@0)) 0))) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14) (= $t14 7)) (and (= $t14 $t14) (= $t12 $t12)))) (and (=> (= (ControlFlow 0 81343) 81371) anon21_Then_correct) (=> (= (ControlFlow 0 81343) 81359) anon21_Else_correct))))))
(let ((anon20_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 81475) 81265))) L5_correct)))
(let ((anon19_Then$1_correct  (=> (= $t10@1 $t10) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 81527) 81475) anon20_Then_correct) (=> (= (ControlFlow 0 81527) 81343) anon20_Else_correct))))))
(let ((anon19_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (ControlFlow 0 81525) 81527)) anon19_Then$1_correct)))
(let ((anon19_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (=> (and (and (= $t10@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= $t10@1 $t10@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 81283) 81475) anon20_Then_correct) (=> (= (ControlFlow 0 81283) 81343) anon20_Else_correct))))))
(let ((anon18_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (and (=> (= (ControlFlow 0 81269) 81525) anon19_Then_correct) (=> (= (ControlFlow 0 81269) 81283) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= $t9 $t9)) (and (= $t7@0 $t9) (= (ControlFlow 0 81201) 81265))) L5_correct)))
(let ((anon17_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 81185) 81269) anon18_Then_correct) (=> (= (ControlFlow 0 81185) 81201) anon18_Else_correct))))))
(let ((anon17_Then_correct true))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 81143) 81541) anon17_Then_correct) (=> (= (ControlFlow 0 81143) 81185) anon17_Else_correct))))))
(let ((anon0$1_correct  (=> (and (and (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) addr) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53807| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53807| $1_Roles_RoleId_$memory) addr)) 3))))
 ...
 :skolemid |154|
)))) (and (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0)))
...
))) (and (= _$t0 _$t0) (= (ControlFlow 0 81149) 81143)))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_33654_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 80872) 81149)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 93226) 80872) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
