...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 224900) (let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $a_0)))
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc) i@@44))) 63)))
 :qid |DiemIdbpl.13074:136|
 :skolemid |225|
))) (let (($range_3 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $rsc)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@45 $i_4))
(let (($range_5 ($Range (+ i@@45 1) (seq.len (|$domains#$1_DiemId_DiemIdDomains| $rsc)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@10 $i_6))
 (not (= (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc) i@@45) (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc) j@@10)))))
 :qid |DiemIdbpl.13076:96|
 :skolemid |226|
)))))
 :qid |DiemIdbpl.13075:196|
 :skolemid |227|
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| $elem)) 63)))
 :qid |DiemIdbpl.13077:221|
 :skolemid |228|
))))))
 :qid |DiemIdbpl.13073:20|
 :skolemid |229|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 164910) (- 0 225155)) (not false)) (=> (not false) (=> (= (ControlFlow 0 164910) (- 0 225162)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_69963_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemIdbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 164664) 164910)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 224900) 164664) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
