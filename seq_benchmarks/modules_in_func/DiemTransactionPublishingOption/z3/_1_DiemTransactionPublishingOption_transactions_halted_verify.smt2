...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 225852) (let ((anon0$1_correct  (=> (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $a_0)))
(|$IsValid'$1_DiemTransactionPublishingOption_HaltAllTransactions'| $rsc))
 :qid |DiemTransactionPublishingOptionbpl.12541:20|
 :skolemid |225|
 :pattern ( (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $a_0))
)) (=> (and (|$IsValid'address'| 173345816) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) 173345816))) (=> (and (and (= $t1@0 $t1@0) (= (ControlFlow 0 166206) (- 0 225942))) (|Select__T@[Int]Bool_| (|domain#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816) (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_68416_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTransactionPublishingOptionbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 166122) 166206)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 225852) 166122) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
