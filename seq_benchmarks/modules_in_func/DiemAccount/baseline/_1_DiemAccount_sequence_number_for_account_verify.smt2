...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2364198) (let ((anon0$1_correct  (=> (and (and (and (|$IsValid'$1_DiemAccount_DiemAccount'| _$t0) (and (<= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| _$t0))) 1) (<= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| _$t0))) 1))) (= _$t0 _$t0)) (and (= $t1@0 (|$sequence_number#$1_DiemAccount_DiemAccount| _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 1771308) (- 0 2364295)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (not (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0)))) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (not (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0))))))
 :qid |DiemAccountbpl.90673:15|
 :skolemid |3497|
 ...
 :qid |DiemAccountbpl.90673:15|
 :skolemid |3497|
)) (and (=> (= (ControlFlow 0 1771308) (- 0 2364343)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@2)) (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@2)))) 0)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@2)) (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@2)))) 0))))
 :qid |DiemAccountbpl.90678:15|
 :skolemid |3498|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1771099) 1771308)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2364198) 1771099) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
