...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 219790) (let ((anon15_Else_correct  (=> (and (and (not $abort_flag@0) (= (ControlFlow 0 159165) (- 0 220262))) (|Select__T@[Int]Bool_| (|domain#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816) (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)))))
(let ((anon15_Then_correct true))
(let ((anon14_Then$1_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 159231) 159179) anon15_Then_correct) (=> (= (ControlFlow 0 159231) 159165) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 159229) 159231)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) (|$addr#$signer| _$t0))) (= $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory@0 ($Memory_124447 (|Store__T@[Int]Bool_| (|domain#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) (|$addr#$signer| _$t0) $t12@0)))) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 159133) 159179) anon15_Then_correct) (=> (= (ControlFlow 0 159133) 159165) anon15_Else_correct)))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t12@0 ($1_DiemTransactionPublishingOption_HaltAllTransactions false))) (and (=> (= (ControlFlow 0 159111) 159229) anon14_Then_correct) (=> (= (ControlFlow 0 159111) 159133) anon14_Else_correct)))))
(let ((anon13_Else_correct true))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t10) (= $t10 6)) (and (= $t10 $t10) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 159075) 159111) anon13_Then_correct) (=> (= (ControlFlow 0 159075) 159091) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t7@0)) (= (ControlFlow 0 159035) 159075)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t4) (=> (and (and (|$IsValid'address'| $t6) (= $t6 (|$addr#$signer| _$t0))) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $t6)) (= (ControlFlow 0 159041) 159035))) inline$$Not$0$anon0_correct))))
...
)) (= _$t0 _$t0)) (and (= $t3 (|$addr#$signer| _$t0)) (= $t4  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_98919| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_98919| $1_Roles_RoleId_$memory) $t3)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))) (and (=> (= (ControlFlow 0 158979) 159323) anon12_Then_correct) (=> (= (ControlFlow 0 158979) 159041) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_68416_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTransactionPublishingOptionbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 158843) 158979)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 219790) 158843) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))
))
(check-sat)
(pop 1)
