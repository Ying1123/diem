...
(assert (not
 (=> (= (ControlFlow 0 0) 106719) (let ((anon10_Else_correct true))
(let ((anon10_Then_correct true))
(let ((anon9_Then$1_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 99291) 99233) anon10_Then_correct) (=> (= (ControlFlow 0 99291) 99219) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 99289) 99291)) anon9_Then$1_correct)))
(let ((anon9_Else_correct  (=> (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) (|$addr#$signer| _$t0))) (= $1_NetworkIdentity_NetworkIdentity_$memory@0 ($Memory_82842 (|Store__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) (|$addr#$signer| _$t0) $t5@0)))) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 99209) 99233) anon10_Then_correct) (=> (= (ControlFlow 0 99209) 99219) anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (not false) (=> (and (= |inline$$1_Vector_empty'vec'u8''$0$v@1| |inline$$1_Vector_empty'vec'u8''$0$v@1|) (= $t5@0 ($1_NetworkIdentity_NetworkIdentity |inline$$1_Vector_empty'vec'u8''$0$v@1|))) (and (=> (= (ControlFlow 0 99187) (- 0 106967)) (let (($range_0 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| $t5@0)))))
(let (($range_1 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| $t5@0)))))
(forall (($i_2 Int) ($i_3 Int) ) (!  (=> ($InRange $range_0 $i_2) (=> ($InRange $range_1 $i_3) (let ((i@@36 $i_2))
(let ((j@@8 $i_3))
 (=> (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| $t5@0) i@@36) (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| $t5@0) j@@8)) (= i@@36 j@@8))))))
 :qid |NetworkIdentitybpl.5828:193|
 :skolemid |208|
))))) (=> (let (($range_0@@0 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| $t5@0)))))
(let (($range_1@@0 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| $t5@0)))))
(forall (($i_2@@0 Int) ($i_3@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_2@@0) (=> ($InRange $range_1@@0 $i_3@@0) (let ((i@@37 $i_2@@0))
(let ((j@@9 $i_3@@0))
 (=> (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| $t5@0) i@@37) (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| $t5@0) j@@9)) (= i@@37 j@@9))))))
 :qid |NetworkIdentitybpl.5828:193|
 :skolemid |208|
)))) (and (=> (= (ControlFlow 0 99187) (- 0 107043)) (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 99187) 99289) anon9_Then_correct) (=> (= (ControlFlow 0 99187) 99209) anon9_Else_correct))))))))))
(let ((anon8_Then_correct true))
(let ((|inline$$1_Vector_empty'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'vec'u8''$0$v@1| (as seq.empty (Seq (Seq Int)))) (and (=> (= (ControlFlow 0 99072) 99305) anon8_Then_correct) (=> (= (ControlFlow 0 99072) 99187) anon8_Else_correct)))))
(let ((anon0$1_correct  (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $a_0)))
 (and (|$IsValid'$1_NetworkIdentity_NetworkIdentity'| $rsc) (let (($range_1@@1 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc)))))
(let (($range_2 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc)))))
(forall (($i_3@@1 Int) ($i_4 Int) ) (!  (=> ($InRange $range_1@@1 $i_3@@1) (=> ($InRange $range_2 $i_4) (let ((i@@38 $i_3@@1))
(let ((j@@10 $i_4))
 (=> (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc) i@@38) (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc) j@@10)) (= i@@38 j@@10))))))
 :qid |NetworkIdentitybpl.5791:249|
 :skolemid |206|
))))))
 :qid |NetworkIdentitybpl.5790:20|
 :skolemid |207|
...
))) (and (and (= $t2 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies $t2)) (and (= _$t0 _$t0) (= (ControlFlow 0 99078) 99072)))) |inline$$1_Vector_empty'vec'u8''$0$anon0_correct|)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |NetworkIdentitybpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 98891) 99078)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 106719) 98891) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
