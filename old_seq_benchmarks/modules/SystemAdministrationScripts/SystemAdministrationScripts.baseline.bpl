...
// spec fun at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:259:10+64
...
// fun SlidingNonce::record_nonce_or_abort [baseline] at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:37:5+212
procedure {:inline 1} $1_SlidingNonce_record_nonce_or_abort(_$t0: int, _$t1: int) returns ()
{
    // declare local variables
    var $t2: int;
    var $t3: bool;
    ...
    // bytecode translation starts here
    // trace_local[account]($t0) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:37:5+1
    assume {:print "$at(29,1547,1548)"} true;
    assume {:print "$track_local(4,1,0):", $t0} $t0 == $t0;

    // trace_local[seq_nonce]($t1) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:37:5+1
    assume {:print "$track_local(4,1,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36
    // >> opaque call: $t5 := SlidingNonce::try_record_nonce($t0, $t1)
    assume {:print "$at(29,1657,1693)"} true;

    // $t5 := opaque begin: SlidingNonce::try_record_nonce($t0, $t1) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36

    // assume Identical($t6, Not(exists<SlidingNonce::SlidingNonce>(Signer::spec_address_of($t0)))) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36
    assume ($t6 == !$ResourceExists($1_SlidingNonce_SlidingNonce_$memory, $1_Signer_spec_address_of($t0)));

    // if ($t6) goto L5 else goto L4 at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36
    if ($t6) { goto L5; } else { goto L4; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36
L5:

    // assume And(Not(exists<SlidingNonce::SlidingNonce>(Signer::spec_address_of($t0))), Eq(5, $t7)) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36
    assume (!$ResourceExists($1_SlidingNonce_SlidingNonce_$memory, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(5, $t7));

    // trace_abort($t7) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36
    assume {:print "$at(29,1657,1693)"} true;
    assume {:print "$track_abort(4,1):", $t7} $t7 == $t7;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36
    goto L3;

    // label L4 at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36
L4:

    // modifies global<SlidingNonce::SlidingNonce>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36
    havoc $temp_0'bool';
    if ($temp_0'bool') {
    ...
    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36
    assume $IsValid'u64'($t5);

    // assume Eq<u64>($t5, SlidingNonce::spec_try_record_nonce($t0, $t1)) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36
    assume $IsEqual'u64'($t5, $1_SlidingNonce_spec_try_record_nonce($t0, $t1));

    // $t5 := opaque end: SlidingNonce::try_record_nonce($t0, $t1) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:20+36

    // trace_local[code]($t5) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:38:13+4
    assume {:print "$track_local(4,1,2):", $t5} $t5 == $t5;

    // $t8 := 0 at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:24+1
    assume {:print "$at(29,1718,1719)"} true;
    $t8 := 0;
    assume $IsValid'u64'($t8);

    // $t9 := ==($t5, $t8) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:21+2
    $t9 := $IsEqual'u64'($t5, $t8);

    // nop at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:27+30
    // >> opaque call: $t8 := Errors::invalid_argument($t5)

    // $t10 := opaque begin: Errors::invalid_argument($t5) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:27+30

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:27+30
    assume $IsValid'u64'($t10);

    // assume Eq<u64>($t10, 7) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:27+30
    assume $IsEqual'u64'($t10, 7);

    // $t10 := opaque end: Errors::invalid_argument($t5) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:27+30

    // trace_local[tmp#$4]($t10) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:9+49
    assume {:print "$track_local(4,1,4):", $t10} $t10 == $t10;

    // trace_local[tmp#$3]($t9) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:9+49
    assume {:print "$track_local(4,1,3):", $t9} $t9 == $t9;

    // if ($t9) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:9+49
    if ($t9) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:9+49
L1:

    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:9+49
    assume {:print "$at(29,1703,1752)"} true;
    assume {:print "$track_abort(4,1):", $t10} $t10 == $t10;

    // $t7 := move($t10) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:9+49
    $t7 := $t10;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:9+49
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:39:58+1
L0:

    // label L2 at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:40:5+1
    assume {:print "$at(29,1758,1759)"} true;
L2:

    // return () at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:40:5+1
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:40:5+1
L3:

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:40:5+1
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
function {:inline} $1_DiemConfig_$get'$1_DiemConsensusConfig_DiemConsensusConfig'($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory: $Memory $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'): $1_DiemConsensusConfig_DiemConsensusConfig {
    (var addr := $1_CoreAddresses_$DIEM_ROOT_ADDRESS(); $payload#$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'($ResourceValue($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, addr)))
}
...
function {:inline} $1_DiemConfig_spec_is_published'$1_DiemConsensusConfig_DiemConsensusConfig'($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory: $Memory $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'): bool {
    $ResourceExists($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())
}
...
function {:inline} $1_DiemConfig_spec_get_config'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory: $Memory $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'): $1_DiemVMConfig_DiemVMConfig {
    $payload#$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'($ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()))
}
...
// struct DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig> at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:15:5+156
...
// struct DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig> at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:38:5+57
...
L7:
    ...
    // @185 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@185](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
L6:
    ...
    // @145 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@145](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
L7:
    ...
    // @175 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@175](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
L2:
    ...
    // trace_local[account#1794]($t17) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:957:13+7
...
L8:
    ...
    // @139 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@139](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
...
// struct DiemConsensusConfig::DiemConsensusConfig at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:11:5+84
...
// fun DiemConsensusConfig::initialize [baseline] at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:5+196
procedure {:inline 1} $1_DiemConsensusConfig_initialize(_$t0: int) returns ()
{
    // declare local variables
    var $t1: int;
    var $t2: int;
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_DiemConfig_Configuration_$memory#150: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
    ...
    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:5+1
    assume {:print "$at(14,465,466)"} true;
    assume {:print "$track_local(32,0,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:17:9+35
    // >> opaque call: Roles::assert_diem_root($t0)
    assume {:print "$at(14,518,553)"} true;

    // assume Identical($t3, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+44
    assume {:print "$at(26,23651,23695)"} true;
    assume ($t3 == $1_Signer_spec_address_of($t0));

    // opaque begin: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:17:9+35
    assume {:print "$at(14,518,553)"} true;

    // assume Identical($t4, Or(Or(Or(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Not(exists<Roles::RoleId>($t3))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t3)), 0)), Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:17:9+35
    assume ($t4 == (((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) || !$ResourceExists($1_Roles_RoleId_$memory, $t3)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t3)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())));

    // if ($t4) goto L4 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:17:9+35
    if ($t4) { goto L4; } else { goto L3; }

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:17:9+35
L4:

    // assume Or(Or(Or(And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t5)), And(Not(exists<Roles::RoleId>($t3)), Eq(5, $t5))), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t3)), 0), Eq(3, $t5))), And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t5))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:17:9+35
    assume ((((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t5)) || (!$ResourceExists($1_Roles_RoleId_$memory, $t3) && $IsEqual'u8'(5, $t5))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t3)), 0) && $IsEqual'u8'(3, $t5))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t5)));

    // trace_abort($t5) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:17:9+35
    assume {:print "$at(14,518,553)"} true;
    assume {:print "$track_abort(32,0):", $t5} $t5 == $t5;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:17:9+35
    goto L2;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:17:9+35
L3:

    // opaque end: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:17:9+35

    // $t6 := Vector::empty<u8>() on_abort goto L2 with $t5 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:82+15
    assume {:print "$at(14,636,651)"} true;
    ...
    // $t7 := pack DiemConsensusConfig::DiemConsensusConfig($t6) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:52+47
    $t7 := $1_DiemConsensusConfig_DiemConsensusConfig($t6);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    ...
    // opaque begin: DiemConfig::publish_new_config<DiemConsensusConfig::DiemConsensusConfig>($t0, $t7) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    assume {:print "$at(14,563,654)"} true;

    // assume Identical($t9, Or(Or(Or(Or(DiemConfig::spec_is_published<DiemConsensusConfig::DiemConsensusConfig>(), exists<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of($t0))), Not(exists<Roles::RoleId>($t8))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t8)), 0)), Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    ...
    // if ($t9) goto L6 else goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    if ($t9) { goto L6; } else { goto L5; }

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
L6:

    // assume Or(Or(Or(Or(DiemConfig::spec_is_published<DiemConsensusConfig::DiemConsensusConfig>(), exists<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of($t0))), And(Not(exists<Roles::RoleId>($t8)), Eq(5, $t5))), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t8)), 0), Eq(3, $t5))), And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t5))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    assume (((($1_DiemConfig_spec_is_published'$1_DiemConsensusConfig_DiemConsensusConfig'($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory, $t8) && $IsEqual'u8'(5, $t5))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t8)), 0) && $IsEqual'u8'(3, $t5))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t5)));

    // trace_abort($t5) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    assume {:print "$at(14,563,654)"} true;
    assume {:print "$track_abort(32,0):", $t5} $t5 == $t5;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    goto L2;

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
L5:

    // @150 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    $1_DiemConfig_Configuration_$memory#150 := $1_DiemConfig_Configuration_$memory;

    // modifies global<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    havoc $temp_0'bool';
    if ($temp_0'bool') {
        havoc $temp_0'$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'';
        $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory := $ResourceUpdate($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS(), $temp_0'$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'');
    } else {
        $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory := $ResourceRemove($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());
    }

    // modifies global<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    havoc $temp_0'bool';
    if ($temp_0'bool') {
        havoc $temp_0'$1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'';
        $1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory := $ResourceUpdate($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS(), $temp_0'$1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'');
    } else {
        $1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory := $ResourceRemove($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());
    }

    // assume exists<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    ...
    // assume DiemConfig::spec_is_published<DiemConsensusConfig::DiemConsensusConfig>() at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    ...
    // assume Eq<DiemConsensusConfig::DiemConsensusConfig>(DiemConfig::$get<DiemConsensusConfig::DiemConsensusConfig>(), $t7) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@150](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#150), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // opaque end: DiemConfig::publish_new_config<DiemConsensusConfig::DiemConsensusConfig>($t0, $t7) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:19:5+1
    assume {:print "$at(14,660,661)"} true;
L1:

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:19:5+1
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:19:5+1
L2:

    // abort($t5) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:19:5+1
    $abort_code := $t5;
    $abort_flag := true;
    return;
...
// fun DiemConsensusConfig::set [baseline] at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
procedure {:inline 1} $1_DiemConsensusConfig_set(_$t0: int, _$t1: Vec (int)) returns ()
{
    // declare local variables
    var $t2: int;
    ...
    // assume Identical($t3, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:360:9+71
    assume {:print "$at(13,15945,16016)"} true;
    assume ($t3 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t4, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:361:9+58
    assume {:print "$at(13,16025,16083)"} true;
    assume ($t4 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+1
    assume {:print "$at(14,1127,1128)"} true;
    assume {:print "$track_local(32,1,0):", $t0} $t0 == $t0;

    // trace_local[config]($t1) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+1
    assume {:print "$track_local(32,1,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:32:9+33
    // >> opaque call: DiemTimestamp::assert_operating()
    assume {:print "$at(14,1193,1226)"} true;

    // opaque begin: DiemTimestamp::assert_operating() at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:32:9+33

    // assume Identical($t5, Not(DiemTimestamp::$is_operating())) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:32:9+33
    assume ($t5 == !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t5) goto L4 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:32:9+33
    if ($t5) { goto L4; } else { goto L3; }

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:32:9+33
L4:

    // assume And(Not(DiemTimestamp::$is_operating()), Eq(1, $t6)) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:32:9+33
    assume (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t6));

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:32:9+33
    assume {:print "$at(14,1193,1226)"} true;
    assume {:print "$track_abort(32,1):", $t6} $t6 == $t6;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:32:9+33
    goto L2;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:32:9+33
L3:

    // opaque end: DiemTimestamp::assert_operating() at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:32:9+33

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+35
    // >> opaque call: Roles::assert_diem_root($t0)
    assume {:print "$at(14,1237,1272)"} true;

    // assume Identical($t7, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+44
    assume {:print "$at(26,23651,23695)"} true;
    assume ($t7 == $1_Signer_spec_address_of($t0));

    // opaque begin: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+35
    assume {:print "$at(14,1237,1272)"} true;

    // assume Identical($t8, Or(Or(Or(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Not(exists<Roles::RoleId>($t7))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t7)), 0)), Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+35
    assume ($t8 == (((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) || !$ResourceExists($1_Roles_RoleId_$memory, $t7)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t7)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())));

    // if ($t8) goto L6 else goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+35
    if ($t8) { goto L6; } else { goto L5; }

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+35
L6:

    // assume Or(Or(Or(And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t6)), And(Not(exists<Roles::RoleId>($t7)), Eq(5, $t6))), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t7)), 0), Eq(3, $t6))), And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t6))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+35
    assume ((((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t6)) || (!$ResourceExists($1_Roles_RoleId_$memory, $t7) && $IsEqual'u8'(5, $t6))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t7)), 0) && $IsEqual'u8'(3, $t6))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t6)));

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+35
    assume {:print "$at(14,1237,1272)"} true;
    assume {:print "$track_abort(32,1):", $t6} $t6 == $t6;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+35
    goto L2;

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+35
L5:

    // opaque end: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+35

    // $t9 := pack DiemConsensusConfig::DiemConsensusConfig($t1) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:38:13+30
    assume {:print "$at(14,1336,1366)"} true;
    $t9 := $1_DiemConsensusConfig_DiemConsensusConfig($t1);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    // >> opaque call: DiemConfig::set<DiemConsensusConfig::DiemConsensusConfig>($t0, $t2)
    assume {:print "$at(14,1283,1376)"} true;
    ...
    // opaque begin: DiemConfig::set<DiemConsensusConfig::DiemConsensusConfig>($t0, $t9) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    assume {:print "$at(14,1283,1376)"} true;

    // assume Identical($t12, Or(Or(Not(exists<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of($t0))), Not(exists<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS()))), And(And(And(And(DiemTimestamp::$is_operating(), DiemConfig::$reconfiguration_enabled()), Gt(DiemTimestamp::spec_now_microseconds(), 0)), Lt(select DiemConfig::Configuration.epoch($t10), 18446744073709551615)), Lt($t11, select DiemConfig::Configuration.last_reconfiguration_time($t10))))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    assume ($t12 == ((!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_Signer_spec_address_of($t0)) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) > 0)) && ($epoch#$1_DiemConfig_Configuration($t10) < 18446744073709551615)) && ($t11 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t10)))));

    // if ($t12) goto L8 else goto L7 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    if ($t12) { goto L8; } else { goto L7; }

    // label L8 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
L8:

    // assume Or(Or(And(Not(exists<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of($t0))), Eq(4, $t6)), And(Not(exists<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS())), Eq(5, $t6))), And(And(And(And(And(DiemTimestamp::$is_operating(), DiemConfig::$reconfiguration_enabled()), Gt(DiemTimestamp::spec_now_microseconds(), 0)), Lt(select DiemConfig::Configuration.epoch($t10), 18446744073709551615)), Lt($t11, select DiemConfig::Configuration.last_reconfiguration_time($t10))), Eq(1, $t6))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    assume (((!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t6)) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t6))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) > 0)) && ($epoch#$1_DiemConfig_Configuration($t10) < 18446744073709551615)) && ($t11 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t10))) && $IsEqual'u8'(1, $t6)));

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    assume {:print "$at(14,1283,1376)"} true;
    assume {:print "$track_abort(32,1):", $t6} $t6 == $t6;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    goto L2;

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
L7:

    // @169 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    $1_DiemConfig_Configuration_$memory#169 := $1_DiemConfig_Configuration_$memory;

    // modifies global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    havoc $temp_0'bool';
    if ($temp_0'bool') {
        havoc $temp_0'$1_DiemConfig_Configuration';
        $1_DiemConfig_Configuration_$memory := $ResourceUpdate($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS(), $temp_0'$1_DiemConfig_Configuration');
    ...
    // modifies global<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    havoc $temp_0'bool';
    if ($temp_0'bool') {
        havoc $temp_0'$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'';
        $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory := $ResourceUpdate($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS(), $temp_0'$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'');
    ...
    // assume DiemConfig::spec_is_published<DiemConsensusConfig::DiemConsensusConfig>() at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    assume $1_DiemConfig_spec_is_published'$1_DiemConsensusConfig_DiemConsensusConfig'($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory);

    // assume Eq<DiemConsensusConfig::DiemConsensusConfig>(DiemConfig::$get<DiemConsensusConfig::DiemConsensusConfig>(), $t9) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@169](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    ...
    // opaque end: DiemConfig::set<DiemConsensusConfig::DiemConsensusConfig>($t0, $t9) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:40:5+1
    assume {:print "$at(14,1382,1383)"} true;
L1:

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:40:5+1
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:40:5+1
L2:

    // abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:40:5+1
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
procedure {:inline 1} $1_DiemVMConfig_initialize(_$t0: int, _$t1: Vec (int), _$t2: Vec (int)) returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'vec'u8'': Vec (int);
    var $1_DiemConfig_Configuration_$memory#162: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
...
L4:
    ...
    assume {:print "$at(19,3563,3594)"} true;
    assume {:print "$track_abort(33,0):", $t8} $t8 == $t8;
...
L7:
    ...
    // @162 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    $1_DiemConfig_Configuration_$memory#162 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@162](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#162), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
// fun DiemVMConfig::set_gas_constants [baseline] at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
procedure {:inline 1} $1_DiemVMConfig_set_gas_constants(_$t0: int, _$t1: int, _$t2: int, _$t3: int, _$t4: int, _$t5: int, _$t6: int, _$t7: int, _$t8: int, _$t9: int, _$t10: int, _$t11: int) returns ()
{
    // declare local variables
    var $t12: $1_DiemVMConfig_DiemVMConfig;
    var $t13: $Mutation ($1_DiemVMConfig_GasConstants);
    var $t14: bool;
    var $t15: int;
    var $t16: bool;
    var $t17: int;
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemConfig_Configuration_$memory#199: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    $t3 := _$t3;
    ...
    // bytecode translation starts here
    // assume Identical($t18, DiemConfig::spec_get_config<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:190:9+57
    assume {:print "$at(19,8262,8319)"} true;
    ...
    // assume Identical($t20, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:360:9+71
    assume {:print "$at(13,15945,16016)"} true;
    assume ($t20 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t21, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:361:9+58
    assume {:print "$at(13,16025,16083)"} true;
    assume ($t21 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$at(19,5709,5710)"} true;
    assume {:print "$track_local(33,1,0):", $t0} $t0 == $t0;

    // trace_local[global_memory_per_byte_cost]($t1) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$track_local(33,1,1):", $t1} $t1 == $t1;

    // trace_local[global_memory_per_byte_write_cost]($t2) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$track_local(33,1,2):", $t2} $t2 == $t2;

    // trace_local[min_transaction_gas_units]($t3) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$track_local(33,1,3):", $t3} $t3 == $t3;

    // trace_local[large_transaction_cutoff]($t4) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$track_local(33,1,4):", $t4} $t4 == $t4;

    // trace_local[intrinsic_gas_per_byte]($t5) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$track_local(33,1,5):", $t5} $t5 == $t5;

    // trace_local[maximum_number_of_gas_units]($t6) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$track_local(33,1,6):", $t6} $t6 == $t6;

    // trace_local[min_price_per_gas_unit]($t7) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$track_local(33,1,7):", $t7} $t7 == $t7;

    // trace_local[max_price_per_gas_unit]($t8) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$track_local(33,1,8):", $t8} $t8 == $t8;

    // trace_local[max_transaction_size_in_bytes]($t9) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$track_local(33,1,9):", $t9} $t9 == $t9;

    // trace_local[gas_unit_scaling_factor]($t10) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$track_local(33,1,10):", $t10} $t10 == $t10;

    // trace_local[default_account_size]($t11) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    assume {:print "$track_local(33,1,11):", $t11} $t11 == $t11;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:155:9+33
    // >> opaque call: DiemTimestamp::assert_operating()
    assume {:print "$at(19,6223,6256)"} true;

    // opaque begin: DiemTimestamp::assert_operating() at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:155:9+33

    // assume Identical($t22, Not(DiemTimestamp::$is_operating())) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:155:9+33
    assume ($t22 == !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t22) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:155:9+33
    if ($t22) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:155:9+33
L7:

    // assume And(Not(DiemTimestamp::$is_operating()), Eq(1, $t23)) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:155:9+33
    assume (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t23));

    // trace_abort($t23) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:155:9+33
    assume {:print "$at(19,6223,6256)"} true;
    assume {:print "$track_abort(33,1):", $t23} $t23 == $t23;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:155:9+33
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:155:9+33
L6:

    // opaque end: DiemTimestamp::assert_operating() at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:155:9+33

    // nop at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:156:9+35
    // >> opaque call: Roles::assert_diem_root($t0)
    assume {:print "$at(19,6266,6301)"} true;

    // assume Identical($t24, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+44
    assume {:print "$at(26,23651,23695)"} true;
    assume ($t24 == $1_Signer_spec_address_of($t0));

    // opaque begin: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:156:9+35
    assume {:print "$at(19,6266,6301)"} true;

    // assume Identical($t25, Or(Or(Or(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Not(exists<Roles::RoleId>($t24))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t24)), 0)), Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:156:9+35
    assume ($t25 == (((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) || !$ResourceExists($1_Roles_RoleId_$memory, $t24)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t24)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())));

    // if ($t25) goto L9 else goto L8 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:156:9+35
    if ($t25) { goto L9; } else { goto L8; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:156:9+35
L9:

    // assume Or(Or(Or(And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t23)), And(Not(exists<Roles::RoleId>($t24)), Eq(5, $t23))), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t24)), 0), Eq(3, $t23))), And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t23))) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:156:9+35
    assume ((((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t23)) || (!$ResourceExists($1_Roles_RoleId_$memory, $t24) && $IsEqual'u8'(5, $t23))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t24)), 0) && $IsEqual'u8'(3, $t23))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t23)));

    // trace_abort($t23) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:156:9+35
    assume {:print "$at(19,6266,6301)"} true;
    assume {:print "$track_abort(33,1):", $t23} $t23 == $t23;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:156:9+35
    goto L5;

    // label L8 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:156:9+35
L8:

    // opaque end: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:156:9+35

    // $t26 := <=($t7, $t8) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:158:36+2
    assume {:print "$at(19,6354,6356)"} true;
    call $t26 := $Le($t7, $t8);

    // $t27 := 0 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:159:38+27
    assume {:print "$at(19,6418,6445)"} true;
    $t27 := 0;
    assume $IsValid'u64'($t27);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:159:13+53
    // >> opaque call: $t20 := Errors::invalid_argument($t19)

    // $t28 := opaque begin: Errors::invalid_argument($t27) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:159:13+53

    // assume WellFormed($t28) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:159:13+53
    assume $IsValid'u64'($t28);

    // assume Eq<u64>($t28, 7) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:159:13+53
    assume $IsEqual'u64'($t28, 7);

    // $t28 := opaque end: Errors::invalid_argument($t27) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:159:13+53

    // trace_local[tmp#$15]($t28) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:157:9+145
    assume {:print "$at(19,6311,6456)"} true;
    assume {:print "$track_local(33,1,15):", $t28} $t28 == $t28;

    // trace_local[tmp#$14]($t26) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:157:9+145
    assume {:print "$track_local(33,1,14):", $t26} $t26 == $t26;

    // if ($t26) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:157:9+145
    if ($t26) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:157:9+145
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:157:9+145

    // trace_abort($t28) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:157:9+145
    assume {:print "$at(19,6311,6456)"} true;
    assume {:print "$track_abort(33,1):", $t28} $t28 == $t28;

    // $t23 := move($t28) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:157:9+145
    $t23 := $t28;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:157:9+145
    goto L5;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:162:13+25
    assume {:print "$at(19,6486,6511)"} true;
L0:

    // $t29 := <=($t3, $t6) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:162:39+2
    call $t29 := $Le($t3, $t6);

    // $t30 := 0 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:163:38+27
    assume {:print "$at(19,6581,6608)"} true;
    $t30 := 0;
    assume $IsValid'u64'($t30);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:163:13+53
    // >> opaque call: $t23 := Errors::invalid_argument($t22)

    // $t31 := opaque begin: Errors::invalid_argument($t30) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:163:13+53

    // assume WellFormed($t31) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:163:13+53
    assume $IsValid'u64'($t31);

    // assume Eq<u64>($t31, 7) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:163:13+53
    assume $IsEqual'u64'($t31, 7);

    // $t31 := opaque end: Errors::invalid_argument($t30) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:163:13+53

    // trace_local[tmp#$17]($t31) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:161:9+153
    assume {:print "$at(19,6466,6619)"} true;
    assume {:print "$track_local(33,1,17):", $t31} $t31 == $t31;

    // trace_local[tmp#$16]($t29) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:161:9+153
    assume {:print "$track_local(33,1,16):", $t29} $t29 == $t29;

    // if ($t29) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:161:9+153
    if ($t29) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:161:9+153
L3:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:161:9+153

    // trace_abort($t31) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:161:9+153
    assume {:print "$at(19,6466,6619)"} true;
    assume {:print "$track_abort(33,1):", $t31} $t31 == $t31;

    // $t23 := move($t31) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:161:9+153
    $t23 := $t31;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:161:9+153
    goto L5;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31
    assume {:print "$at(19,6643,6674)"} true;
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31
    // >> opaque call: $t12 := DiemConfig::get<DiemVMConfig::DiemVMConfig>()

    // $t12 := opaque begin: DiemConfig::get<DiemVMConfig::DiemVMConfig>() at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31

    // assume Identical($t32, Not(exists<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31
    assume ($t32 == !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // if ($t32) goto L11 else goto L10 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31
    if ($t32) { goto L11; } else { goto L10; }

    // label L11 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31
L11:

    // assume And(Not(exists<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS())), Eq(5, $t23)) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31
    assume (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t23));

    // trace_abort($t23) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31
    assume {:print "$at(19,6643,6674)"} true;
    assume {:print "$track_abort(33,1):", $t23} $t23 == $t23;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31
    goto L5;

    // label L10 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31
L10:

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31
    assume $IsValid'$1_DiemVMConfig_DiemVMConfig'($t12);

    // assume Eq<DiemVMConfig::DiemVMConfig>($t12, DiemConfig::$get<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31
    assume $IsEqual'$1_DiemVMConfig_DiemVMConfig'($t12, $1_DiemConfig_$get'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory));

    // $t12 := opaque end: DiemConfig::get<DiemVMConfig::DiemVMConfig>() at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:22+31

    // trace_local[config]($t12) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:166:13+6
    assume {:print "$track_local(33,1,12):", $t12} $t12 == $t12;

    // $t33 := borrow_local($t12) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:167:34+6
    assume {:print "$at(19,6709,6715)"} true;
    $t33 := $Mutation($Local(12), EmptyVec(), $t12);

    // $t34 := borrow_field<DiemVMConfig::DiemVMConfig>.gas_schedule($t33) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:167:34+19
    $t34 := $ChildMutation($t33, 0, $gas_schedule#$1_DiemVMConfig_DiemVMConfig($Dereference($t33)));

    // $t35 := borrow_field<DiemVMConfig::GasSchedule>.gas_constants($t34) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:167:29+38
    $t35 := $ChildMutation($t34, 2, $gas_constants#$1_DiemVMConfig_GasSchedule($Dereference($t34)));

    // trace_local[gas_constants]($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:167:13+13
    $temp_0'$1_DiemVMConfig_GasConstants' := $Dereference($t35);
    assume {:print "$track_local(33,1,13):", $temp_0'$1_DiemVMConfig_GasConstants'} $temp_0'$1_DiemVMConfig_GasConstants' == $temp_0'$1_DiemVMConfig_GasConstants';

    // $t36 := borrow_field<DiemVMConfig::GasConstants>.global_memory_per_byte_cost($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:169:9+41
    assume {:print "$at(19,6753,6794)"} true;
    $t36 := $ChildMutation($t35, 0, $global_memory_per_byte_cost#$1_DiemVMConfig_GasConstants($Dereference($t35)));

    // write_ref($t36, $t1) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:169:9+77
    $t36 := $UpdateMutation($t36, $t1);

    // write_back[Reference($t35).global_memory_per_byte_cost]($t36) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:169:9+77
    $t35 := $UpdateMutation($t35, $Update'$1_DiemVMConfig_GasConstants'_global_memory_per_byte_cost($Dereference($t35), $Dereference($t36)));

    // $t37 := borrow_field<DiemVMConfig::GasConstants>.global_memory_per_byte_write_cost($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:170:9+47
    assume {:print "$at(19,6840,6887)"} true;
    $t37 := $ChildMutation($t35, 1, $global_memory_per_byte_write_cost#$1_DiemVMConfig_GasConstants($Dereference($t35)));

    // write_ref($t37, $t2) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:170:9+83
    $t37 := $UpdateMutation($t37, $t2);

    // write_back[Reference($t35).global_memory_per_byte_write_cost]($t37) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:170:9+83
    ...
    // $t38 := borrow_field<DiemVMConfig::GasConstants>.min_transaction_gas_units($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:171:9+39
    assume {:print "$at(19,6933,6972)"} true;
    $t38 := $ChildMutation($t35, 2, $min_transaction_gas_units#$1_DiemVMConfig_GasConstants($Dereference($t35)));

    // write_ref($t38, $t3) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:171:9+75
    $t38 := $UpdateMutation($t38, $t3);

    // write_back[Reference($t35).min_transaction_gas_units]($t38) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:171:9+75
    $t35 := $UpdateMutation($t35, $Update'$1_DiemVMConfig_GasConstants'_min_transaction_gas_units($Dereference($t35), $Dereference($t38)));

    // $t39 := borrow_field<DiemVMConfig::GasConstants>.large_transaction_cutoff($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:172:9+38
    assume {:print "$at(19,7018,7056)"} true;
    $t39 := $ChildMutation($t35, 3, $large_transaction_cutoff#$1_DiemVMConfig_GasConstants($Dereference($t35)));

    // write_ref($t39, $t4) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:172:9+74
    $t39 := $UpdateMutation($t39, $t4);

    // write_back[Reference($t35).large_transaction_cutoff]($t39) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:172:9+74
    $t35 := $UpdateMutation($t35, $Update'$1_DiemVMConfig_GasConstants'_large_transaction_cutoff($Dereference($t35), $Dereference($t39)));

    // $t40 := borrow_field<DiemVMConfig::GasConstants>.intrinsic_gas_per_byte($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:173:9+36
    assume {:print "$at(19,7102,7138)"} true;
    $t40 := $ChildMutation($t35, 4, $intrinsic_gas_per_byte#$1_DiemVMConfig_GasConstants($Dereference($t35)));

    // write_ref($t40, $t5) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:173:9+72
    $t40 := $UpdateMutation($t40, $t5);

    // write_back[Reference($t35).intrinsic_gas_per_byte]($t40) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:173:9+72
    $t35 := $UpdateMutation($t35, $Update'$1_DiemVMConfig_GasConstants'_intrinsic_gas_per_byte($Dereference($t35), $Dereference($t40)));

    // $t41 := borrow_field<DiemVMConfig::GasConstants>.maximum_number_of_gas_units($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:174:9+41
    assume {:print "$at(19,7184,7225)"} true;
    $t41 := $ChildMutation($t35, 5, $maximum_number_of_gas_units#$1_DiemVMConfig_GasConstants($Dereference($t35)));

    // write_ref($t41, $t6) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:174:9+77
    $t41 := $UpdateMutation($t41, $t6);

    // write_back[Reference($t35).maximum_number_of_gas_units]($t41) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:174:9+77
    $t35 := $UpdateMutation($t35, $Update'$1_DiemVMConfig_GasConstants'_maximum_number_of_gas_units($Dereference($t35), $Dereference($t41)));

    // $t42 := borrow_field<DiemVMConfig::GasConstants>.min_price_per_gas_unit($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:175:9+36
    assume {:print "$at(19,7271,7307)"} true;
    $t42 := $ChildMutation($t35, 6, $min_price_per_gas_unit#$1_DiemVMConfig_GasConstants($Dereference($t35)));

    // write_ref($t42, $t7) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:175:9+72
    $t42 := $UpdateMutation($t42, $t7);

    // write_back[Reference($t35).min_price_per_gas_unit]($t42) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:175:9+72
    $t35 := $UpdateMutation($t35, $Update'$1_DiemVMConfig_GasConstants'_min_price_per_gas_unit($Dereference($t35), $Dereference($t42)));

    // $t43 := borrow_field<DiemVMConfig::GasConstants>.max_price_per_gas_unit($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:176:9+36
    assume {:print "$at(19,7353,7389)"} true;
    $t43 := $ChildMutation($t35, 7, $max_price_per_gas_unit#$1_DiemVMConfig_GasConstants($Dereference($t35)));

    // write_ref($t43, $t8) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:176:9+72
    $t43 := $UpdateMutation($t43, $t8);

    // write_back[Reference($t35).max_price_per_gas_unit]($t43) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:176:9+72
    $t35 := $UpdateMutation($t35, $Update'$1_DiemVMConfig_GasConstants'_max_price_per_gas_unit($Dereference($t35), $Dereference($t43)));

    // $t44 := borrow_field<DiemVMConfig::GasConstants>.max_transaction_size_in_bytes($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:177:9+43
    assume {:print "$at(19,7435,7478)"} true;
    $t44 := $ChildMutation($t35, 8, $max_transaction_size_in_bytes#$1_DiemVMConfig_GasConstants($Dereference($t35)));

    // write_ref($t44, $t9) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:177:9+79
    $t44 := $UpdateMutation($t44, $t9);

    // write_back[Reference($t35).max_transaction_size_in_bytes]($t44) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:177:9+79
    $t35 := $UpdateMutation($t35, $Update'$1_DiemVMConfig_GasConstants'_max_transaction_size_in_bytes($Dereference($t35), $Dereference($t44)));

    // $t45 := borrow_field<DiemVMConfig::GasConstants>.gas_unit_scaling_factor($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:178:9+37
    assume {:print "$at(19,7524,7561)"} true;
    $t45 := $ChildMutation($t35, 9, $gas_unit_scaling_factor#$1_DiemVMConfig_GasConstants($Dereference($t35)));

    // write_ref($t45, $t10) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:178:9+73
    $t45 := $UpdateMutation($t45, $t10);

    // write_back[Reference($t35).gas_unit_scaling_factor]($t45) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:178:9+73
    $t35 := $UpdateMutation($t35, $Update'$1_DiemVMConfig_GasConstants'_gas_unit_scaling_factor($Dereference($t35), $Dereference($t45)));

    // $t46 := borrow_field<DiemVMConfig::GasConstants>.default_account_size($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:179:9+34
    assume {:print "$at(19,7607,7641)"} true;
    $t46 := $ChildMutation($t35, 10, $default_account_size#$1_DiemVMConfig_GasConstants($Dereference($t35)));

    // write_ref($t46, $t11) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:179:9+70
    $t46 := $UpdateMutation($t46, $t11);

    // write_back[Reference($t35).default_account_size]($t46) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:179:9+70
    $t35 := $UpdateMutation($t35, $Update'$1_DiemVMConfig_GasConstants'_default_account_size($Dereference($t35), $Dereference($t46)));

    // write_back[Reference($t34).gas_constants]($t35) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:179:9+70
    $t34 := $UpdateMutation($t34, $Update'$1_DiemVMConfig_GasSchedule'_gas_constants($Dereference($t34), $Dereference($t35)));

    // write_back[Reference($t33).gas_schedule]($t34) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:179:9+70
    $t33 := $UpdateMutation($t33, $Update'$1_DiemVMConfig_DiemVMConfig'_gas_schedule($Dereference($t33), $Dereference($t34)));

    // write_back[LocalRoot($t12)@]($t33) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:179:9+70
    $t12 := $Dereference($t33);

    // $t47 := move($t12) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:37+6
    assume {:print "$at(19,7716,7722)"} true;
    $t47 := $t12;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    // >> opaque call: DiemConfig::set<DiemVMConfig::DiemVMConfig>($t0, $t38)

    // assume Identical($t48, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:360:9+71
    assume {:print "$at(13,15945,16016)"} true;
    assume ($t48 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t49, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:361:9+58
    assume {:print "$at(13,16025,16083)"} true;
    assume ($t49 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // opaque begin: DiemConfig::set<DiemVMConfig::DiemVMConfig>($t0, $t47) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    assume {:print "$at(19,7688,7723)"} true;

    // assume Identical($t50, Or(Or(Not(exists<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of($t0))), Not(exists<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS()))), And(And(And(And(DiemTimestamp::$is_operating(), DiemConfig::$reconfiguration_enabled()), Gt(DiemTimestamp::spec_now_microseconds(), 0)), Lt(select DiemConfig::Configuration.epoch($t48), 18446744073709551615)), Lt($t49, select DiemConfig::Configuration.last_reconfiguration_time($t48))))) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    assume ($t50 == ((!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory, $1_Signer_spec_address_of($t0)) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) > 0)) && ($epoch#$1_DiemConfig_Configuration($t48) < 18446744073709551615)) && ($t49 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t48)))));

    // if ($t50) goto L13 else goto L12 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    if ($t50) { goto L13; } else { goto L12; }

    // label L13 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
L13:

    // assume Or(Or(And(Not(exists<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of($t0))), Eq(4, $t23)), And(Not(exists<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS())), Eq(5, $t23))), And(And(And(And(And(DiemTimestamp::$is_operating(), DiemConfig::$reconfiguration_enabled()), Gt(DiemTimestamp::spec_now_microseconds(), 0)), Lt(select DiemConfig::Configuration.epoch($t48), 18446744073709551615)), Lt($t49, select DiemConfig::Configuration.last_reconfiguration_time($t48))), Eq(1, $t23))) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    assume (((!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t23)) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t23))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) > 0)) && ($epoch#$1_DiemConfig_Configuration($t48) < 18446744073709551615)) && ($t49 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t48))) && $IsEqual'u8'(1, $t23)));

    // trace_abort($t23) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    assume {:print "$at(19,7688,7723)"} true;
    assume {:print "$track_abort(33,1):", $t23} $t23 == $t23;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    goto L5;

    // label L12 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
L12:

    // @199 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    $1_DiemConfig_Configuration_$memory#199 := $1_DiemConfig_Configuration_$memory;

    // modifies global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    havoc $temp_0'bool';
    if ($temp_0'bool') {
        havoc $temp_0'$1_DiemConfig_Configuration';
        $1_DiemConfig_Configuration_$memory := $ResourceUpdate($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS(), $temp_0'$1_DiemConfig_Configuration');
    ...
    // modifies global<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    havoc $temp_0'bool';
    if ($temp_0'bool') {
        havoc $temp_0'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'';
        $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory := $ResourceUpdate($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS(), $temp_0'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'');
    ...
    // assume DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>() at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    assume $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory);

    // assume Eq<DiemVMConfig::DiemVMConfig>(DiemConfig::$get<DiemVMConfig::DiemVMConfig>(), $t47) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@199](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#199), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // opaque end: DiemConfig::set<DiemVMConfig::DiemVMConfig>($t0, $t47) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:182:5+1
    assume {:print "$at(19,7729,7730)"} true;
L4:

    // return () at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:182:5+1
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:182:5+1
L5:

    // abort($t23) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:182:5+1
    $abort_code := $t23;
    $abort_flag := true;
    return;
...
procedure {:inline 1} $1_DiemVersion_initialize(_$t0: int, _$t1: int) returns ()
{
    ...
    assume {:print "$track_local(34,0,1):", $t1} $t1 == $t1;
...
L4:
    ...
    assume {:print "$at(20,690,721)"} true;
    assume {:print "$track_abort(34,0):", $t5} $t5 == $t5;
...
L7:
    ...
    // @156 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@156](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#156), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
// fun DiemVersion::set [baseline] at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
procedure {:inline 1} $1_DiemVersion_set(_$t0: int, _$t1: int) returns ()
{
    // declare local variables
    var $t2: $1_DiemVersion_DiemVersion;
    var $t3: bool;
    var $t4: int;
    var $t5: int;
    ...
    // assume Identical($t6, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:360:9+71
    assume {:print "$at(13,15945,16016)"} true;
    assume ($t6 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t7, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:361:9+58
    assume {:print "$at(13,16025,16083)"} true;
    assume ($t7 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+1
    assume {:print "$at(20,1410,1411)"} true;
    assume {:print "$track_local(34,1,0):", $t0} $t0 == $t0;

    // trace_local[major]($t1) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+1
    assume {:print "$track_local(34,1,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:38:9+33
    // >> opaque call: DiemTimestamp::assert_operating()
    assume {:print "$at(20,1468,1501)"} true;

    // opaque begin: DiemTimestamp::assert_operating() at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:38:9+33

    // assume Identical($t8, Not(DiemTimestamp::$is_operating())) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:38:9+33
    assume ($t8 == !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t8) goto L5 else goto L4 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:38:9+33
    if ($t8) { goto L5; } else { goto L4; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:38:9+33
L5:

    // assume And(Not(DiemTimestamp::$is_operating()), Eq(1, $t9)) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:38:9+33
    assume (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t9));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:38:9+33
    assume {:print "$at(20,1468,1501)"} true;
    assume {:print "$track_abort(34,1):", $t9} $t9 == $t9;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:38:9+33
    goto L3;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:38:9+33
L4:

    // opaque end: DiemTimestamp::assert_operating() at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:38:9+33

    // nop at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:40:9+35
    // >> opaque call: Roles::assert_diem_root($t0)
    assume {:print "$at(20,1512,1547)"} true;

    // assume Identical($t10, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+44
    assume {:print "$at(26,23651,23695)"} true;
    assume ($t10 == $1_Signer_spec_address_of($t0));

    // opaque begin: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:40:9+35
    assume {:print "$at(20,1512,1547)"} true;

    // assume Identical($t11, Or(Or(Or(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Not(exists<Roles::RoleId>($t10))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t10)), 0)), Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:40:9+35
    assume ($t11 == (((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) || !$ResourceExists($1_Roles_RoleId_$memory, $t10)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t10)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())));

    // if ($t11) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:40:9+35
    if ($t11) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:40:9+35
L7:

    // assume Or(Or(Or(And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t9)), And(Not(exists<Roles::RoleId>($t10)), Eq(5, $t9))), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t10)), 0), Eq(3, $t9))), And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t9))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:40:9+35
    assume ((((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t9)) || (!$ResourceExists($1_Roles_RoleId_$memory, $t10) && $IsEqual'u8'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t10)), 0) && $IsEqual'u8'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t9)));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:40:9+35
    assume {:print "$at(20,1512,1547)"} true;
    assume {:print "$track_abort(34,1):", $t9} $t9 == $t9;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:40:9+35
    goto L3;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:40:9+35
L6:

    // opaque end: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:40:9+35

    // nop at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30
    // >> opaque call: $t5 := DiemConfig::get<DiemVersion::DiemVersion>()
    assume {:print "$at(20,1575,1605)"} true;

    // $t12 := opaque begin: DiemConfig::get<DiemVersion::DiemVersion>() at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30

    // assume Identical($t13, Not(exists<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30
    assume ($t13 == !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // if ($t13) goto L9 else goto L8 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30
    if ($t13) { goto L9; } else { goto L8; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30
L9:

    // assume And(Not(exists<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(CoreAddresses::$DIEM_ROOT_ADDRESS())), Eq(5, $t9)) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30
    assume (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t9));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30
    assume {:print "$at(20,1575,1605)"} true;
    assume {:print "$track_abort(34,1):", $t9} $t9 == $t9;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30
    goto L3;

    // label L8 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30
L8:

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30
    assume $IsValid'$1_DiemVersion_DiemVersion'($t12);

    // assume Eq<DiemVersion::DiemVersion>($t12, DiemConfig::$get<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30
    ...
    // $t12 := opaque end: DiemConfig::get<DiemVersion::DiemVersion>() at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:26+30

    // trace_local[old_config]($t12) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:42:13+10
    assume {:print "$track_local(34,1,2):", $t12} $t12 == $t12;

    // $t14 := get_field<DiemVersion::DiemVersion>.major($t12) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:45:13+16
    assume {:print "$at(20,1636,1652)"} true;
    $t14 := $major#$1_DiemVersion_DiemVersion($t12);

    // $t15 := <($t14, $t1) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:45:30+1
    call $t15 := $Lt($t14, $t1);

    // $t16 := 0 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:46:38+29
    assume {:print "$at(20,1699,1728)"} true;
    $t16 := 0;
    assume $IsValid'u64'($t16);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:46:13+55
    // >> opaque call: $t9 := Errors::invalid_argument($t8)

    // $t17 := opaque begin: Errors::invalid_argument($t16) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:46:13+55

    // assume WellFormed($t17) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:46:13+55
    assume $IsValid'u64'($t17);

    // assume Eq<u64>($t17, 7) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:46:13+55
    assume $IsEqual'u64'($t17, 7);

    // $t17 := opaque end: Errors::invalid_argument($t16) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:46:13+55

    // trace_local[tmp#$4]($t17) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:44:9+123
    assume {:print "$at(20,1616,1739)"} true;
    assume {:print "$track_local(34,1,4):", $t17} $t17 == $t17;

    // trace_local[tmp#$3]($t15) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:44:9+123
    assume {:print "$track_local(34,1,3):", $t15} $t15 == $t15;

    // if ($t15) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:44:9+123
    if ($t15) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:44:9+123
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:44:9+123

    // trace_abort($t17) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:44:9+123
    assume {:print "$at(20,1616,1739)"} true;
    assume {:print "$track_abort(34,1):", $t17} $t17 == $t17;

    // $t9 := move($t17) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:44:9+123
    $t9 := $t17;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:44:9+123
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:50:13+10
    assume {:print "$at(20,1792,1802)"} true;
L0:

    // $t18 := pack DiemVersion::DiemVersion($t1) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:51:13+21
    assume {:print "$at(20,1816,1837)"} true;
    $t18 := $1_DiemVersion_DiemVersion($t1);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    // >> opaque call: DiemConfig::set<DiemVersion::DiemVersion>($t0, $t10)
    assume {:print "$at(20,1750,1847)"} true;

    // assume Identical($t19, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:360:9+71
    assume {:print "$at(13,15945,16016)"} true;
    assume ($t19 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t20, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:361:9+58
    assume {:print "$at(13,16025,16083)"} true;
    assume ($t20 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // opaque begin: DiemConfig::set<DiemVersion::DiemVersion>($t0, $t18) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    assume {:print "$at(20,1750,1847)"} true;

    // assume Identical($t21, Or(Or(Not(exists<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of($t0))), Not(exists<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(CoreAddresses::$DIEM_ROOT_ADDRESS()))), And(And(And(And(DiemTimestamp::$is_operating(), DiemConfig::$reconfiguration_enabled()), Gt(DiemTimestamp::spec_now_microseconds(), 0)), Lt(select DiemConfig::Configuration.epoch($t19), 18446744073709551615)), Lt($t20, select DiemConfig::Configuration.last_reconfiguration_time($t19))))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    assume ($t21 == ((!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory, $1_Signer_spec_address_of($t0)) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) > 0)) && ($epoch#$1_DiemConfig_Configuration($t19) < 18446744073709551615)) && ($t20 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t19)))));

    // if ($t21) goto L11 else goto L10 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    if ($t21) { goto L11; } else { goto L10; }

    // label L11 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
L11:

    // assume Or(Or(And(Not(exists<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of($t0))), Eq(4, $t9)), And(Not(exists<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(CoreAddresses::$DIEM_ROOT_ADDRESS())), Eq(5, $t9))), And(And(And(And(And(DiemTimestamp::$is_operating(), DiemConfig::$reconfiguration_enabled()), Gt(DiemTimestamp::spec_now_microseconds(), 0)), Lt(select DiemConfig::Configuration.epoch($t19), 18446744073709551615)), Lt($t20, select DiemConfig::Configuration.last_reconfiguration_time($t19))), Eq(1, $t9))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    assume (((!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t9)) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t9))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) > 0)) && ($epoch#$1_DiemConfig_Configuration($t19) < 18446744073709551615)) && ($t20 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t19))) && $IsEqual'u8'(1, $t9)));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    assume {:print "$at(20,1750,1847)"} true;
    assume {:print "$track_abort(34,1):", $t9} $t9 == $t9;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    goto L3;

    // label L10 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
L10:

    // @192 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    $1_DiemConfig_Configuration_$memory#192 := $1_DiemConfig_Configuration_$memory;

    // modifies global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    havoc $temp_0'bool';
    if ($temp_0'bool') {
        havoc $temp_0'$1_DiemConfig_Configuration';
        $1_DiemConfig_Configuration_$memory := $ResourceUpdate($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS(), $temp_0'$1_DiemConfig_Configuration');
    ...
    // modifies global<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    havoc $temp_0'bool';
    if ($temp_0'bool') {
        havoc $temp_0'$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'';
        $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory := $ResourceUpdate($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS(), $temp_0'$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'');
    ...
    // assume DiemConfig::spec_is_published<DiemVersion::DiemVersion>() at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    assume $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory);

    // assume Eq<DiemVersion::DiemVersion>(DiemConfig::$get<DiemVersion::DiemVersion>(), $t18) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@192](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    ...
    // opaque end: DiemConfig::set<DiemVersion::DiemVersion>($t0, $t18) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:53:5+1
    assume {:print "$at(20,1853,1854)"} true;
L2:

    // return () at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:53:5+1
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:53:5+1
L3:

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:53:5+1
    $abort_code := $t9;
    $abort_flag := true;
    return;
...
L4:
    ...
    assume {:print "$at(22,1325,1397)"} true;
    assume {:print "$track_abort(35,1):", $t20} $t20 == $t20;
...
L7:
    ...
    assume {:print "$track_local(35,1,11):", $t47} $t47 == $t47;
    ...
    assume {:print "$track_local(35,1,13):", $t49} $t49 == $t49;
...
// fun SystemAdministrationScripts::set_gas_constants [verification] at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
procedure {:timeLimit 40} $1_SystemAdministrationScripts_set_gas_constants$verify(_$t0: int, _$t1: int, _$t2: int, _$t3: int, _$t4: int, _$t5: int, _$t6: int, _$t7: int, _$t8: int, _$t9: int, _$t10: int, _$t11: int, _$t12: int) returns ()
{
    // declare local variables
    var $t13: int;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(30,7538,8709)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:284:9+113
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:287:9+123
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:219:9+90
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:72:9+89
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t2);

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t3);

    // assume WellFormed($t4) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t4);

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t5);

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t6);

    // assume WellFormed($t7) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t7);

    // assume WellFormed($t8) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t8);

    // assume WellFormed($t9) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t9);

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t10);

    // assume WellFormed($t11) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t11);

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume $IsValid'u64'($t12);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<SlidingNonce::SlidingNonce>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume (forall $a_0: int :: {$ResourceValue($1_SlidingNonce_SlidingNonce_$memory, $a_0)}(var $rsc := $ResourceValue($1_SlidingNonce_SlidingNonce_$memory, $a_0);
    ($IsValid'$1_SlidingNonce_SlidingNonce'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_Configuration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_Configuration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_Configuration'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DisableReconfiguration'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig''($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1171
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig''($rsc))));

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,0):", $t0} $t0 == $t0;

    // trace_local[sliding_nonce]($t1) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,1):", $t1} $t1 == $t1;

    // trace_local[global_memory_per_byte_cost]($t2) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,2):", $t2} $t2 == $t2;

    // trace_local[global_memory_per_byte_write_cost]($t3) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,3):", $t3} $t3 == $t3;

    // trace_local[min_transaction_gas_units]($t4) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,4):", $t4} $t4 == $t4;

    // trace_local[large_transaction_cutoff]($t5) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,5):", $t5} $t5 == $t5;

    // trace_local[intrinsic_gas_per_byte]($t6) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,6):", $t6} $t6 == $t6;

    // trace_local[maximum_number_of_gas_units]($t7) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,7):", $t7} $t7 == $t7;

    // trace_local[min_price_per_gas_unit]($t8) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,8):", $t8} $t8 == $t8;

    // trace_local[max_price_per_gas_unit]($t9) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,9):", $t9} $t9 == $t9;

    // trace_local[max_transaction_size_in_bytes]($t10) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,10):", $t10} $t10 == $t10;

    // trace_local[gas_unit_scaling_factor]($t11) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,11):", $t11} $t11 == $t11;

    // trace_local[default_account_size]($t12) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:76:5+1
    assume {:print "$track_local(36,1,12):", $t12} $t12 == $t12;

    // SlidingNonce::record_nonce_or_abort($t0, $t1) on_abort goto L2 with $t13 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:91:9+63
    assume {:print "$at(30,8087,8150)"} true;
    call $1_SlidingNonce_record_nonce_or_abort($t0, $t1);
    if ($abort_flag) {
        assume {:print "$at(30,8087,8150)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(36,1):", $t13} $t13 == $t13;
        goto L2;
    }

    // assume Identical($t14, DiemConfig::spec_get_config<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:190:9+57
    assume {:print "$at(19,8262,8319)"} true;
    ...
    // assume Identical($t16, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:360:9+71
    assume {:print "$at(13,15945,16016)"} true;
    assume ($t16 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t17, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:361:9+58
    assume {:print "$at(13,16025,16083)"} true;
    assume ($t17 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // DiemVMConfig::set_gas_constants($t0, $t2, $t3, $t4, $t5, $t6, $t7, $t8, $t9, $t10, $t11, $t12) on_abort goto L2 with $t13 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:92:9+543
    assume {:print "$at(30,8160,8703)"} true;
    ...
    // label L1 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:106:5+1
    assume {:print "$at(30,8708,8709)"} true;
L1:

    // return () at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:106:5+1
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:106:5+1
L2:

    // abort($t13) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:106:5+1
    $abort_code := $t13;
    $abort_flag := true;
    return;
...
// fun SystemAdministrationScripts::initialize_diem_consensus_config [verification] at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:131:5+217
procedure {:timeLimit 40} $1_SystemAdministrationScripts_initialize_diem_consensus_config$verify(_$t0: int, _$t1: int) returns ()
{
    // declare local variables
    var $t2: int;
    var $t3: int;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:131:5+217
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:284:9+113
    assume {:print "$at(30,10920,11137)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:131:5+217
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:287:9+123
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:131:5+217
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:131:5+217
    assume $IsValid'u64'($t1);

    // assume forall $rsc: ResourceDomain<SlidingNonce::SlidingNonce>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:131:5+217
    assume (forall $a_0: int :: {$ResourceValue($1_SlidingNonce_SlidingNonce_$memory, $a_0)}(var $rsc := $ResourceValue($1_SlidingNonce_SlidingNonce_$memory, $a_0);
    ($IsValid'$1_SlidingNonce_SlidingNonce'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:131:5+217
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:131:5+217
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:131:5+217
    ...
    // trace_local[account]($t0) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:131:5+1
    assume {:print "$track_local(36,0,0):", $t0} $t0 == $t0;

    // trace_local[sliding_nonce]($t1) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:131:5+1
    assume {:print "$track_local(36,0,1):", $t1} $t1 == $t1;

    // SlidingNonce::record_nonce_or_abort($t0, $t1) on_abort goto L2 with $t2 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:132:9+60
    assume {:print "$at(30,11019,11079)"} true;
    call $1_SlidingNonce_record_nonce_or_abort($t0, $t1);
    if ($abort_flag) {
        assume {:print "$at(30,11019,11079)"} true;
        $t2 := $abort_code;
    ...
    // DiemConsensusConfig::initialize($t0) on_abort goto L2 with $t2 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:133:9+41
    assume {:print "$at(30,11089,11130)"} true;
    ...
    // label L1 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:134:5+1
    assume {:print "$at(30,11136,11137)"} true;
L1:

    // return () at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:134:5+1
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:134:5+1
L2:

    // abort($t2) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:134:5+1
    $abort_code := $t2;
    $abort_flag := true;
    return;
...
// fun SystemAdministrationScripts::update_diem_consensus_config [verification] at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
procedure {:timeLimit 40} $1_SystemAdministrationScripts_update_diem_consensus_config$verify(_$t0: int, _$t1: int, _$t2: Vec (int)) returns ()
{
    // declare local variables
    var $t3: int;
    var $t4: int;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(30,13456,13689)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:284:9+113
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:287:9+123
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:219:9+90
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:72:9+89
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    assume $IsValid'u64'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    assume $IsValid'vec'u8''($t2);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<SlidingNonce::SlidingNonce>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    assume (forall $a_0: int :: {$ResourceValue($1_SlidingNonce_SlidingNonce_$memory, $a_0)}(var $rsc := $ResourceValue($1_SlidingNonce_SlidingNonce_$memory, $a_0);
    ($IsValid'$1_SlidingNonce_SlidingNonce'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_Configuration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_Configuration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_Configuration'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DisableReconfiguration'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig''($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+233
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig''($rsc))));

    // trace_local[account]($t0) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+1
    assume {:print "$track_local(36,2,0):", $t0} $t0 == $t0;

    // trace_local[sliding_nonce]($t1) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+1
    assume {:print "$track_local(36,2,1):", $t1} $t1 == $t1;

    // trace_local[config]($t2) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:160:5+1
    assume {:print "$track_local(36,2,2):", $t2} $t2 == $t2;

    // SlidingNonce::record_nonce_or_abort($t0, $t1) on_abort goto L2 with $t3 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:161:9+60
    assume {:print "$at(30,13571,13631)"} true;
    call $1_SlidingNonce_record_nonce_or_abort($t0, $t1);
    if ($abort_flag) {
        assume {:print "$at(30,13571,13631)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(36,2):", $t3} $t3 == $t3;
        goto L2;
    }
    ...
    // DiemConsensusConfig::set($t0, $t2) on_abort goto L2 with $t3 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:162:9+42
    assume {:print "$at(30,13641,13683)"} true;
    ...
    // label L1 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:163:5+1
    assume {:print "$at(30,13688,13689)"} true;
L1:

    // return () at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:163:5+1
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:163:5+1
L2:

    // abort($t3) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:163:5+1
    $abort_code := $t3;
    $abort_flag := true;
    return;
...
// fun SystemAdministrationScripts::update_diem_version [verification] at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
procedure {:timeLimit 40} $1_SystemAdministrationScripts_update_diem_version$verify(_$t0: int, _$t1: int, _$t2: int) returns ()
{
    // declare local variables
    var $t3: int;
    var $t4: int;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(30,3000,3207)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:284:9+113
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:287:9+123
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:219:9+90
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:72:9+89
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    assume $IsValid'u64'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    assume $IsValid'u64'($t2);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<SlidingNonce::SlidingNonce>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    assume (forall $a_0: int :: {$ResourceValue($1_SlidingNonce_SlidingNonce_$memory, $a_0)}(var $rsc := $ResourceValue($1_SlidingNonce_SlidingNonce_$memory, $a_0);
    ($IsValid'$1_SlidingNonce_SlidingNonce'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_Configuration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_Configuration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_Configuration'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DisableReconfiguration'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion''($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+207
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion''($rsc))));

    // trace_local[account]($t0) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+1
    assume {:print "$track_local(36,3,0):", $t0} $t0 == $t0;

    // trace_local[sliding_nonce]($t1) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+1
    assume {:print "$track_local(36,3,1):", $t1} $t1 == $t1;

    // trace_local[major]($t2) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:37:5+1
    assume {:print "$track_local(36,3,2):", $t2} $t2 == $t2;

    // SlidingNonce::record_nonce_or_abort($t0, $t1) on_abort goto L2 with $t3 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:38:9+60
    assume {:print "$at(30,3098,3158)"} true;
    call $1_SlidingNonce_record_nonce_or_abort($t0, $t1);
    if ($abort_flag) {
        assume {:print "$at(30,3098,3158)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(36,3):", $t3} $t3 == $t3;
        goto L2;
    }
    ...
    // DiemVersion::set($t0, $t2) on_abort goto L2 with $t3 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:39:9+33
    assume {:print "$at(30,3168,3201)"} true;
    ...
    // label L1 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:40:5+1
    assume {:print "$at(30,3206,3207)"} true;
L1:

    // return () at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:40:5+1
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:40:5+1
L2:

    // abort($t3) at /home/ying/diem/language/diem-framework/modules/SystemAdministrationScripts.move:40:5+1
    $abort_code := $t3;
    $abort_flag := true;
    return;
