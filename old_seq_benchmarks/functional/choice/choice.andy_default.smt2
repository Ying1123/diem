...
(forall ((i@@8 Int) ) (!  (=> (< i@@8 $$c) (not (and (and (|$IsValid'num'| i@@8) ($InRange ($Range 0 (seq.len $t8)) i@@8)) (= (seq.nth $t8 i@@8) 2))))
 :qid |choiceandybpl.1749:32|
 :skolemid |39|
)))))))
 :qid |choiceandybpl.1746:15|
 :skolemid |40|
)))
...
(assert (not
 (=> (= (ControlFlow 0 0) 17441) (let ((anon0$1_correct@@0  (=> (|$IsValid'u64'| 4) (=> (and (= 4 4) (= (ControlFlow 0 15276) (- 0 17481))) (<= 4 $choice_2)))))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 17441) 15276) anon0$1_correct@@0)))
anon0_correct@@0)))
))
(check-sat)
(pop 1)
...
(assert (not
 (=> (= (ControlFlow 0 0) 17493) (let ((L3_correct  (=> (= $t1@0 $t1@0) (=> (and (= $t4@@0 $choice_3) (= (ControlFlow 0 15396) (- 0 17603))) (= $t1@0 $choice_3)))))
(let ((anon3_Else_correct  (=> (not _$t0@@0) (=> (and (and (|$IsValid'u64'| 5) (= 5 5)) (and (= $t1@0 5) (= (ControlFlow 0 15368) 15396))) L3_correct))))
(let ((anon3_Then_correct  (=> _$t0@@0 (=> (and (and (|$IsValid'u64'| 4) (= 4 4)) (and (= $t1@0 4) (= (ControlFlow 0 15414) 15396))) L3_correct))))
(let ((anon0$1_correct@@1  (=> (= _$t0@@0 _$t0@@0) (and (=> (= (ControlFlow 0 15348) 15414) anon3_Then_correct) (=> (= (ControlFlow 0 15348) 15368) anon3_Else_correct)))))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 17493) 15348) anon0$1_correct@@1)))
anon0_correct@@1))))))
))
(check-sat)
(get-info :reason-unknown)
...
(let ((anon15_Else_correct@@0  (=> (not false) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 15828) 15822)) |inline$$1_Vector_push_back'u64'$3$anon0_correct|))))
(let ((anon15_Then_correct@@0 true))
(let ((|inline$$1_Vector_push_back'u64'$2$anon0_correct|  (=> (= |inline$$1_Vector_push_back'u64'$2$m'@1| ($Mutation_9732 (|l#$Mutation_9732| |inline$$1_Vector_push_back'u64'$1$m'@1|) (|p#$Mutation_9732| |inline$$1_Vector_push_back'u64'$1$m'@1|) (seq.++ (|v#$Mutation_9732| |inline$$1_Vector_push_back'u64'$1$m'@1|) (seq.unit 3)))) (and (=> (= (ControlFlow 0 15749) 15898) anon15_Then_correct@@0) (=> (= (ControlFlow 0 15749) 15828) anon15_Else_correct@@0)))))
(let ((anon14_Else_correct@@0  (=> (not false) (=> (and (|$IsValid'u64'| 3) (= (ControlFlow 0 15755) 15749)) |inline$$1_Vector_push_back'u64'$2$anon0_correct|))))
(let ((anon14_Then_correct@@0 true))
(let ((|inline$$1_Vector_push_back'u64'$1$anon0_correct|  (=> (= |inline$$1_Vector_push_back'u64'$1$m'@1| ($Mutation_9732 (|l#$Mutation_9732| |inline$$1_Vector_push_back'u64'$0$m'@1|) (|p#$Mutation_9732| |inline$$1_Vector_push_back'u64'$0$m'@1|) (seq.++ (|v#$Mutation_9732| |inline$$1_Vector_push_back'u64'$0$m'@1|) (seq.unit 2)))) (and (=> (= (ControlFlow 0 15676) 15912) anon14_Then_correct@@0) (=> (= (ControlFlow 0 15676) 15755) anon14_Else_correct@@0)))))
(let ((anon13_Else_correct@@0  (=> (not false) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 15682) 15676)) |inline$$1_Vector_push_back'u64'$1$anon0_correct|))))
(let ((anon13_Then_correct@@0 true))
(let ((|inline$$1_Vector_push_back'u64'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'u64'$0$m'@1| ($Mutation_9732 (|l#$Mutation_9732| $t3@0) (|p#$Mutation_9732| $t3@0) (seq.++ (|v#$Mutation_9732| $t3@0) (seq.unit 1)))) (and (=> (= (ControlFlow 0 15603) 15926) anon13_Then_correct@@0) (=> (= (ControlFlow 0 15603) 15682) anon13_Else_correct@@0)))))
(let ((anon12_Else_correct@@0  (=> (not false) (=> (and (= |inline$$1_Vector_empty'u64'$0$v@1| |inline$$1_Vector_empty'u64'$0$v@1|) (= $t3@0 ($Mutation_9732 ($Local 0) (as seq.empty (Seq Int)) |inline$$1_Vector_empty'u64'$0$v@1|))) (=> (and (and (= |$temp_0'vec'u64''@0| (|v#$Mutation_9732| $t3@0)) (= |$temp_0'vec'u64''@0| |$temp_0'vec'u64''@0|)) (and (|$IsValid'u64'| 1) (= (ControlFlow 0 15609) 15603))) |inline$$1_Vector_push_back'u64'$0$anon0_correct|)))))
(let ((anon12_Then_correct@@0 true))
(let ((|inline$$1_Vector_empty'u64'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'u64'$0$v@1| (as seq.empty (Seq Int))) (and (=> (= (ControlFlow 0 15502) 15940) anon12_Then_correct@@0) (=> (= (ControlFlow 0 15502) 15609) anon12_Else_correct@@0)))))
(let ((anon0$1_correct@@2  (=> (= (ControlFlow 0 15508) 15502) |inline$$1_Vector_empty'u64'$0$anon0_correct|)))
(let ((anon0_correct@@2  (=> (= (seq.len (|p#$Mutation_9732| $t1)) 0) (=> (and (= (seq.len (|p#$Mutation_9732| $t3@@0)) 0) (= (ControlFlow 0 15478) 15508)) anon0$1_correct@@2))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 17618) 15478) anon0_correct@@2)))
...
(declare-fun |inline$$1_Vector_push_back'u64'$4$m'@1| () T@$Mutation_9732)
(declare-fun $t10 () Int)
(declare-fun |inline$$1_Vector_push_back'u64'$3$m'@1@@0| () T@$Mutation_9732)
(declare-fun |inline$$1_Vector_push_back'u64'$2$m'@1@@0| () T@$Mutation_9732)
(declare-fun |inline$$1_Vector_push_back'u64'$1$m'@1@@0| () T@$Mutation_9732)
(declare-fun |inline$$1_Vector_push_back'u64'$0$m'@1@@0| () T@$Mutation_9732)
(declare-fun $t3@0@@0 () T@$Mutation_9732)
(declare-fun |inline$$1_Vector_empty'u64'$0$v@1@@0| () (Seq Int))
(declare-fun |$temp_0'vec'u64''@0@@0| () (Seq Int))
(declare-fun $t1@@0 () T@$Mutation_9732)
(declare-fun $t3@@1 () T@$Mutation_9732)
(push 1)
(set-info :boogie-vc-id $42_TestSome_test_not_using_min_incorrect$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 18024) (let ((anon19_Else_correct  (=> (not false) (=> (and (and (= $t0@0@@0 (|v#$Mutation_9732| |inline$$1_Vector_push_back'u64'$4$m'@1|)) (= $t0@0@@0 $t0@0@@0)) (and (= $t10 ($choice_5 $t0@0@@0)) (= (ControlFlow 0 16546) (- 0 18472)))) (= ($choice_5 $t0@0@@0) 1)))))
(let ((anon19_Then_correct true))
(let ((|inline$$1_Vector_push_back'u64'$4$anon0_correct|  (=> (= |inline$$1_Vector_push_back'u64'$4$m'@1| ($Mutation_9732 (|l#$Mutation_9732| |inline$$1_Vector_push_back'u64'$3$m'@1@@0|) (|p#$Mutation_9732| |inline$$1_Vector_push_back'u64'$3$m'@1@@0|) (seq.++ (|v#$Mutation_9732| |inline$$1_Vector_push_back'u64'$3$m'@1@@0|) (seq.unit 2)))) (and (=> (= (ControlFlow 0 16494) 16560) anon19_Then_correct) (=> (= (ControlFlow 0 16494) 16546) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (not false) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 16500) 16494)) |inline$$1_Vector_push_back'u64'$4$anon0_correct|))))
(let ((anon18_Then_correct true))
(let ((|inline$$1_Vector_push_back'u64'$3$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$3$m'@1@@0| ($Mutation_9732 (|l#$Mutation_9732| |inline$$1_Vector_push_back'u64'$2$m'@1@@0|) (|p#$Mutation_9732| |inline$$1_Vector_push_back'u64'$2$m'@1@@0|) (seq.++ (|v#$Mutation_9732| |inline$$1_Vector_push_back'u64'$2$m'@1@@0|) (seq.unit 2)))) (and (=> (= (ControlFlow 0 16421) 16580) anon18_Then_correct) (=> (= (ControlFlow 0 16421) 16500) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (not false) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 16427) 16421)) |inline$$1_Vector_push_back'u64'$3$anon0_correct@@0|))))
(let ((anon17_Then_correct true))
(let ((|inline$$1_Vector_push_back'u64'$2$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$2$m'@1@@0| ($Mutation_9732 (|l#$Mutation_9732| |inline$$1_Vector_push_back'u64'$1$m'@1@@0|) (|p#$Mutation_9732| |inline$$1_Vector_push_back'u64'$1$m'@1@@0|) (seq.++ (|v#$Mutation_9732| |inline$$1_Vector_push_back'u64'$1$m'@1@@0|) (seq.unit 3)))) (and (=> (= (ControlFlow 0 16348) 16594) anon17_Then_correct) (=> (= (ControlFlow 0 16348) 16427) anon17_Else_correct)))))
(let ((anon16_Else_correct@@0  (=> (not false) (=> (and (|$IsValid'u64'| 3) (= (ControlFlow 0 16354) 16348)) |inline$$1_Vector_push_back'u64'$2$anon0_correct@@0|))))
(let ((anon16_Then_correct@@0 true))
(let ((|inline$$1_Vector_push_back'u64'$1$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$1$m'@1@@0| ($Mutation_9732 (|l#$Mutation_9732| |inline$$1_Vector_push_back'u64'$0$m'@1@@0|) (|p#$Mutation_9732| |inline$$1_Vector_push_back'u64'$0$m'@1@@0|) (seq.++ (|v#$Mutation_9732| |inline$$1_Vector_push_back'u64'$0$m'@1@@0|) (seq.unit 2)))) (and (=> (= (ControlFlow 0 16275) 16608) anon16_Then_correct@@0) (=> (= (ControlFlow 0 16275) 16354) anon16_Else_correct@@0)))))
(let ((anon15_Else_correct@@1  (=> (not false) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 16281) 16275)) |inline$$1_Vector_push_back'u64'$1$anon0_correct@@0|))))
(let ((anon15_Then_correct@@1 true))
(let ((|inline$$1_Vector_push_back'u64'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$0$m'@1@@0| ($Mutation_9732 (|l#$Mutation_9732| $t3@0@@0) (|p#$Mutation_9732| $t3@0@@0) (seq.++ (|v#$Mutation_9732| $t3@0@@0) (seq.unit 1)))) (and (=> (= (ControlFlow 0 16202) 16622) anon15_Then_correct@@1) (=> (= (ControlFlow 0 16202) 16281) anon15_Else_correct@@1)))))
(let ((anon14_Else_correct@@1  (=> (not false) (=> (and (= |inline$$1_Vector_empty'u64'$0$v@1@@0| |inline$$1_Vector_empty'u64'$0$v@1@@0|) (= $t3@0@@0 ($Mutation_9732 ($Local 0) (as seq.empty (Seq Int)) |inline$$1_Vector_empty'u64'$0$v@1@@0|))) (=> (and (and (= |$temp_0'vec'u64''@0@@0| (|v#$Mutation_9732| $t3@0@@0)) (= |$temp_0'vec'u64''@0@@0| |$temp_0'vec'u64''@0@@0|)) (and (|$IsValid'u64'| 1) (= (ControlFlow 0 16208) 16202))) |inline$$1_Vector_push_back'u64'$0$anon0_correct@@0|)))))
(let ((anon14_Then_correct@@1 true))
(let ((|inline$$1_Vector_empty'u64'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_empty'u64'$0$v@1@@0| (as seq.empty (Seq Int))) (and (=> (= (ControlFlow 0 16101) 16636) anon14_Then_correct@@1) (=> (= (ControlFlow 0 16101) 16208) anon14_Else_correct@@1)))))
(let ((anon0$1_correct@@3  (=> (= (ControlFlow 0 16107) 16101) |inline$$1_Vector_empty'u64'$0$anon0_correct@@0|)))
(let ((anon0_correct@@3  (=> (= (seq.len (|p#$Mutation_9732| $t1@@0)) 0) (=> (and (= (seq.len (|p#$Mutation_9732| $t3@@1)) 0) (= (ControlFlow 0 16077) 16107)) anon0$1_correct@@3))))
(let ((PreconditionGeneratedEntry_correct@@0  (=> (= (ControlFlow 0 18024) 16077) anon0_correct@@3)))
