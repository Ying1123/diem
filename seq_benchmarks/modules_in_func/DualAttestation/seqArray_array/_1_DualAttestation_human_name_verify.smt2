...
(assert (not
 (=> (= (ControlFlow 0 0) 294536) (let ((anon12_Else_correct@@0  (=> (not $abort_flag@0@@1) (=> (and (= $t8@0 (|$human_name#$1_DualAttestation_Credential| $t7@1)) (= $t8@0 $t8@0)) (and (=> (= (ControlFlow 0 212656) (- 0 294886)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@1))) (=> (= (ControlFlow 0 212656) (- 0 294897)) (|$IsEqual'vec'u8''| $t8@0 (|$human_name#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@1))))))))))
(let ((L3_correct@@0  (and (=> (= (ControlFlow 0 212590) (- 0 294839)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@1)) (=> (= (ControlFlow 0 212590) (- 0 294845)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@1)) (= 5 $t6@0@@0)))))))
(let ((anon12_Then_correct@@0  (=> (and (and $abort_flag@0@@1 (= $abort_code@1@@1 $abort_code@1@@1)) (and (= $t6@0@@0 $abort_code@1@@1) (= (ControlFlow 0 212670) 212590))) L3_correct@@0)))
(let ((anon11_Then$1_correct@@0  (=> (= $t7@1 $t7@@0) (=> (and (= $abort_flag@0@@1 true) (= $abort_code@1@@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 212722) 212670) anon12_Then_correct@@0) (=> (= (ControlFlow 0 212722) 212656) anon12_Else_correct@@0))))))
(let ((anon11_Then_correct@@0  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@1)) (= (ControlFlow 0 212720) 212722)) anon11_Then$1_correct@@0)))
(let ((anon11_Else_correct@@0  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@1) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@1)) (= $t7@1 $t7@0)) (and (= $abort_flag@0@@1 false) (= $abort_code@1@@1 $abort_code@0@@1))) (and (=> (= (ControlFlow 0 212608) 212670) anon12_Then_correct@@0) (=> (= (ControlFlow 0 212608) 212656) anon12_Else_correct@@0))))))
(let ((anon10_Then_correct@@0  (=> $t3@0 (and (=> (= (ControlFlow 0 212594) 212720) anon11_Then_correct@@0) (=> (= (ControlFlow 0 212594) 212608) anon11_Else_correct@@0)))))
(let ((anon10_Else_correct@@0  (=> (and (and (not $t3@0) (= $t5@@0 $t5@@0)) (and (= $t6@0@@0 $t5@@0) (= (ControlFlow 0 212558) 212590))) L3_correct@@0)))
(let ((anon0$1_correct@@1  (=> (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr1@@2) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@2)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@2)) 2)))))
 :qid |DualAttestationbpl.10478:20|
 :skolemid |231|
)) (=> (and (forall ((addr@@49 Int) ) (!  (=> (|$IsValid'address'| addr@@49) (= (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr@@49)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@49) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@49)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@49) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@49)) 5)))))
 :qid |DualAttestationbpl.10482:20|
 :skolemid |232|
)) (|$IsValid'address'| _$t0@@1)) (=> (and (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0@@1)))
...
)) (= _$t0@@1 _$t0@@1)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@1)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5@@0) (= $t5@@0 5)) (and (= $t5@@0 $t5@@0) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 212542) 212594) anon10_Then_correct@@0) (=> (= (ControlFlow 0 212542) 212558) anon10_Else_correct@@0)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@3 T@$1_Event_EventHandle) ) (! (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@3)))
 (and (= (|l#Multiset_86488| stream@@2) 0) (forall ((v@@45 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@2) v@@45) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 212392) 212542)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 294536) 212392) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1))))))))))))
))
(check-sat)
(pop 1)
