...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 507656) (let ((anon46_Else_correct  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 372964) (- 0 509824)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (and (=> (= (ControlFlow 0 372964) (- 0 509835)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) _$t2))) (and (=> (= (ControlFlow 0 372964) (- 0 509846)) (not (not (= (seq.len _$t3) 32)))) (=> (not (not (= (seq.len _$t3) 32))) (and (=> (= (ControlFlow 0 372964) (- 0 509860)) (not (not (exists ((i@@56 Int) ) (!  (and (and (|$IsValid'u64'| i@@56) (and (<= 0 i@@56) (< i@@56 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) i@@56)) _$t2))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
))))) (=> (not (not (exists ((i@@57 Int) ) (!  (and (and (|$IsValid'u64'| i@@57) (and (<= 0 i@@57) (< i@@57 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) i@@57)) _$t2))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
)))) (and (=> (= (ControlFlow 0 372964) (- 0 509872)) (not (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2))))) (=> (not (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2)))) (=> (= (ControlFlow 0 372964) (- 0 509893)) (= (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_179867| $1_DiemAccount_DiemAccount_$memory@1) _$t2)) _$t3)))))))))))))))
(let ((anon47_Else_correct  (=> (and (not $abort_flag@2) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 371828) (- 0 509069)) (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (=> (= (ControlFlow 0 371828) (- 0 509076)) (let (($range_0 ($Range 0 inline$$AddU64$0$dst@2)))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((j@@13 $i_1))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth $t25@0 j@@13)) _$t2))))
 :qid |RecoveryAddressbpl.22596:49|
 :skolemid |572|
)))))))))
(let ((L17_correct  (and (=> (= (ControlFlow 0 370859) (- 0 509671)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) _$t2))) (not (= (seq.len _$t3) 32))) (not (exists ((i@@58 Int) ) (!  (and (and (|$IsValid'u64'| i@@58) (and (<= 0 i@@58) (< i@@58 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) i@@58)) _$t2))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
)))) (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2))))) (=> (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) _$t2))) (not (= (seq.len _$t3) 32))) (not (exists ((i@@59 Int) ) (!  (and (and (|$IsValid'u64'| i@@59) (and (<= 0 i@@59) (< i@@59 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) i@@59)) _$t2))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
)))) (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2)))) (=> (= (ControlFlow 0 370859) (- 0 509723)) (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= 5 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) _$t2)) (= 5 $t17@0))) (and (not (= (seq.len _$t3) 32)) (= 7 $t17@0))) (and (not (exists ((i@@60 Int) ) (!  (and (and (|$IsValid'u64'| i@@60) (and (<= 0 i@@60) (< i@@60 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) i@@60)) _$t2))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
))) (= 7 $t17@0))) (and (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2))) (= 7 $t17@0))))))))
(let ((anon46_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t17@0 $abort_code@5) (= (ControlFlow 0 372978) 370859))) L17_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct  (=> (and (and (and inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1 ($Mutation_129325 (|l#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) (seq.++ (|p#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) (seq.unit 0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))))) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2 ($Mutation_129325 (|l#$Mutation_129325| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1) (|p#$Mutation_129325| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1) _$t3)) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3 ($Mutation_219027 (|l#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) (|p#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) ($1_DiemAccount_DiemAccount (|v#$Mutation_129325| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_179867 (|Store__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)) (|v#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)))) (= $abort_flag@4 $abort_flag@3)) (and (= $abort_code@5 $abort_code@4) (= $1_DiemAccount_DiemAccount_$memory@1 $1_DiemAccount_DiemAccount_$memory@0)))) (and (=> (= (ControlFlow 0 372768) 372978) anon46_Then_correct) (=> (= (ControlFlow 0 372768) 372964) anon46_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct  (=> (= $abort_flag@4 true) (=> (and (= $abort_code@5 inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1) (= $1_DiemAccount_DiemAccount_$memory@1 $1_DiemAccount_DiemAccount_$memory)) (and (=> (= (ControlFlow 0 372564) 372978) anon46_Then_correct) (=> (= (ControlFlow 0 372564) 372964) anon46_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct  (=> (and (and (not inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0) (= (ControlFlow 0 372718) 372564))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct  (=> (and (and (and (not $abort_flag@3) (|$IsValid'u64'| 32)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1 (= |inline$$1_Vector_length'u8'$0$l@1| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0 7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1)))) (and (=> (= (ControlFlow 0 372702) 372768) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct) (=> (= (ControlFlow 0 372702) 372718) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 $abort_code@4) (= (ControlFlow 0 372782) 372564))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (seq.len _$t3)) (and (=> (= (ControlFlow 0 372644) 372782) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct) (=> (= (ControlFlow 0 372644) 372702) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct  (=> (and (and (not $abort_flag@3) (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1| (|v#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))) (and (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1| |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1|) (= (ControlFlow 0 372650) 372644))) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 $abort_code@4) (= (ControlFlow 0 372796) 372564))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct  (=> (= $abort_code@4 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@3 true) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0)) (and (=> (= (ControlFlow 0 372848) 372796) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct) (=> (= (ControlFlow 0 372848) 372650) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1)) (= (ControlFlow 0 372846) 372848)) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1 ($Mutation_219027 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1))) (= $abort_code@4 $abort_code@2)) (and (= $abort_flag@3 $abort_flag@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1))) (and (=> (= (ControlFlow 0 372594) 372796) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct) (=> (= (ControlFlow 0 372594) 372650) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct  (=> (and inline$$1_DiemAccount_exists_at$0$$t1@1 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|))) (and (=> (= (ControlFlow 0 372572) 372846) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct) (=> (= (ControlFlow 0 372572) 372594) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0) (= (ControlFlow 0 372558) 372564))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct  (=> (and (not $abort_flag@1) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0 5)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1))) (and (=> (= (ControlFlow 0 372542) 372572) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct) (=> (= (ControlFlow 0 372542) 372558) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 $abort_code@2) (= (ControlFlow 0 372862) 372564))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct  (=> (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1)) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1)) (and (=> (= (ControlFlow 0 372500) 372862) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct) (=> (= (ControlFlow 0 372500) 372542) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct  (=> (= (seq.len (|p#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0)) 0) (=> (and (= (seq.len (|p#$Mutation_219027| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0)) 0) (= (seq.len (|p#$Mutation_129325| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0)) 0)) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= _$t3 _$t3)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= (ControlFlow 0 372506) 372500))) inline$$1_DiemAccount_exists_at$0$anon0_correct)))))
(let ((anon45_Then_correct  (=> (and $t31@1 (= (ControlFlow 0 372866) 372506)) inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct)))
(let ((anon47_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 371842) 370859))) L17_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 371759) 371842) anon47_Then_correct) (=> (= (ControlFlow 0 371759) 371828) anon47_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t26@0 1) $MAX_U64) (= (ControlFlow 0 371757) 371759)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t26@0 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t26@0 1)) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 371705) 371842) anon47_Then_correct) (=> (= (ControlFlow 0 371705) 371828) anon47_Else_correct))))))
(let ((anon45_Else_correct  (=> (and (not $t31@1) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 371765) 371757) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 371765) 371705) inline$$AddU64$0$anon3_Else_correct)))))
(let ((anon44_Else_correct  (=> (and (not $abort_flag@1) (= $t31@1 (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 _$t2))) (and (=> (= (ControlFlow 0 371598) 372866) anon45_Then_correct) (=> (= (ControlFlow 0 371598) 371765) anon45_Else_correct)))))
(let ((anon44_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 372992) 370859))) L17_correct)))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 371578) 372992) anon44_Then_correct) (=> (= (ControlFlow 0 371578) 371598) anon44_Else_correct))))))
(let ((anon43_Else_correct  (=> (not $abort_flag@1) (=> (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= (ControlFlow 0 371584) 371578)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct))))
(let ((anon43_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 373006) 370859))) L17_correct)))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@0|)) (and (=> (= (ControlFlow 0 371463) 373006) anon43_Then_correct) (=> (= (ControlFlow 0 371463) 371584) anon43_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|  (=> (and (not (and (>= $t26@0 0) (< $t26@0 (seq.len $t25@0)))) (= (ControlFlow 0 371461) 371463)) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|  (=> (and (>= $t26@0 0) (< $t26@0 (seq.len $t25@0))) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1| (seq.nth $t25@0 $t26@0)) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1|))) (and (=> (= (ControlFlow 0 371411) 373006) anon43_Then_correct) (=> (= (ControlFlow 0 371411) 371584) anon43_Else_correct))))))
(let ((anon42_Then_correct  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 371469) 371461) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 371469) 371411) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|)))))
(let ((anon42_Else_correct  (=> (not inline$$Lt$0$dst@1) (and (=> (= (ControlFlow 0 371324) (- 0 508724)) (= $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (= $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (and (=> (= (ControlFlow 0 371324) (- 0 508731)) (let (($range_0@@0 ($Range 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((j@@14 $i_1@@0))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth $t25@0 j@@14)) _$t2))))
 :qid |RecoveryAddressbpl.22552:49|
 :skolemid |571|
)))) (=> (let (($range_0@@1 ($Range 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((j@@15 $i_1@@1))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth $t25@0 j@@15)) _$t2))))
 :qid |RecoveryAddressbpl.22552:49|
 :skolemid |571|
))) (=> (and (|$IsValid'u64'| 4) (|$IsValid'u64'| $t35)) (=> (and (and (= $t35 7) (= $t35 $t35)) (and (= $t17@0 $t35) (= (ControlFlow 0 371324) 370859))) L17_correct)))))))))
(let ((anon41_Else$1_correct  (and (=> (= (ControlFlow 0 371243) 371469) anon42_Then_correct) (=> (= (ControlFlow 0 371243) 371324) anon42_Else_correct))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (= (ControlFlow 0 371233) 371243)) anon41_Else$1_correct)))
(let ((anon41_Else_correct  (=> (and (not $abort_flag@0) (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (and (=> (= (ControlFlow 0 371239) (- 0 508562)) (<= 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (<= 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (and (=> (= (ControlFlow 0 371239) (- 0 508569)) (let (($range_0@@2 ($Range 0 0)))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((j@@16 $i_1@@2))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth $t25@0 j@@16)) _$t2))))
 :qid |RecoveryAddressbpl.22400:49|
 :skolemid |569|
)))) (=> (let (($range_0@@3 ($Range 0 0)))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((j@@17 $i_1@@3))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth $t25@0 j@@17)) _$t2))))
 :qid |RecoveryAddressbpl.22400:49|
 :skolemid |569|
...
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((j@@18 $i_1@@4))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth $t25@0 j@@18)) _$t2))))
 :qid |RecoveryAddressbpl.22440:54|
 :skolemid |570|
))) (= (ControlFlow 0 371239) 371233)))) inline$$Lt$0$anon0_correct)))))))))
(let ((anon41_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 373020) 370859))) L17_correct)))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| (seq.len $t25@0)) (and (=> (= (ControlFlow 0 371043) 373020) anon41_Then_correct) (=> (= (ControlFlow 0 371043) 371239) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (not $abort_flag@0) (= $t25@0 (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| $t24@1))) (=> (and (and (= $t25@0 $t25@0) (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 371049) 371043))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 373034) 370859))) L17_correct)))
(let ((anon39_Then$1_correct  (=> (= $t24@1 $t24) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 373086) 373034) anon40_Then_correct) (=> (= (ControlFlow 0 373086) 371049) anon40_Else_correct))))))
(let ((anon39_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= (ControlFlow 0 373084) 373086)) anon39_Then$1_correct)))
(let ((anon39_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1) (=> (and (and (= $t24@0 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= $t24@1 $t24@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 370979) 373034) anon40_Then_correct) (=> (= (ControlFlow 0 370979) 371049) anon40_Else_correct))))))
(let ((anon38_Then_correct  (=> $t8@0 (and (=> (= (ControlFlow 0 370965) 373084) anon39_Then_correct) (=> (= (ControlFlow 0 370965) 370979) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (and (and (not $t8@0) (= $t23 $t23)) (and (= $t17@0 $t23) (= (ControlFlow 0 370961) 370859))) L17_correct)))
(let ((L5_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t23) (= $t23 7)) (and (= $t23 $t23) (= $t8@0 $t8@0))) (and (=> (= (ControlFlow 0 370945) 370965) anon38_Then_correct) (=> (= (ControlFlow 0 370945) 370961) anon38_Else_correct))))))
(let ((anon37_Else_correct  (=> (not $t19@0) (=> (and (and (= $t21@0 (= $t18 _$t1)) (= $t21@0 $t21@0)) (and (= $t8@0 $t21@0) (= (ControlFlow 0 370911) 370945))) L5_correct))))
(let ((anon37_Then_correct  (=> (and (and $t19@0 (= true true)) (and (= $t8@0 true) (= (ControlFlow 0 373104) 370945))) L5_correct)))
(let ((anon36_Then_correct  (=> $t14@0 (=> (and (and (|$IsValid'address'| $t18) (= $t18 (|$addr#$signer| _$t0))) (and (= $t18 $t18) (= $t19@0 (= $t18 _$t2)))) (and (=> (= (ControlFlow 0 370889) 373104) anon37_Then_correct) (=> (= (ControlFlow 0 370889) 370911) anon37_Else_correct))))))
(let ((anon36_Else_correct  (=> (and (and (not $t14@0) (= $t16 $t16)) (and (= $t17@0 $t16) (= (ControlFlow 0 370683) 370859))) L17_correct)))
(let ((anon0$1_correct  (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@0) (or (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0)) (= addr@@0 (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@0))) 0)))))))
 :qid |RecoveryAddressbpl.22132:20|
 :skolemid |559|
)) (=> (and (and (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@1) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@1)))) 0)) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@1)))) 0)) (= addr@@1 (|$account_address#$1_DiemAccount_WithdrawCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@1))) 0)))))))
 :qid |RecoveryAddressbpl.22136:20|
 :skolemid |560|
)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_140658| $1_Roles_RoleId_$memory) addr@@2)))
 :qid |RecoveryAddressbpl.22140:20|
 :skolemid |561|
))) (and (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (and (= addr@@3 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@3)) (|Select__T@[Int]Bool_| (|domain#$Memory_180760| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@3)))
 :qid |RecoveryAddressbpl.22144:20|
 :skolemid |562|
)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_178917| $1_AccountFreezing_FreezingBit_$memory) addr@@4)))
 :qid |RecoveryAddressbpl.22148:20|
 :skolemid |563|
)))) (and (and (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180895| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@5)))
 :qid |RecoveryAddressbpl.22152:22|
 :skolemid |564|
)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180986| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@6)))
 :qid |RecoveryAddressbpl.22152:218|
 :skolemid |565|
))) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_181077| |$1_DiemAccount_Balance'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) addr@@7)))
 :qid |RecoveryAddressbpl.22152:415|
 :skolemid |566|
)))) (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (|$IsValid'address'| _$t1)) (and (|$IsValid'address'| _$t2) (|$IsValid'vec'u8''| _$t3))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) $a_0)))
 ...
 :qid |RecoveryAddressbpl.22167:20|
 :skolemid |567|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_179867| $1_DiemAccount_DiemAccount_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@0)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@0))
 :qid |RecoveryAddressbpl.22171:20|
 :skolemid |568|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@0))
))) (and (= _$t0 _$t0) (= _$t1 _$t1)))) (and (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| $t16) (= $t16 5)) (and (= $t16 $t16) (= $t14@0 $t14@0))))) (and (=> (= (ControlFlow 0 370667) 370889) anon36_Then_correct) (=> (= (ControlFlow 0 370667) 370683) anon36_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_102812_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |RecoveryAddressbpl.3268:13|
 :skolemid |89|
))) (= (ControlFlow 0 370289) 370667)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 507656) 370289) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
