...
(assert (not
 (=> (= (ControlFlow 0 0) 1082312) (let ((anon10_Else_correct@@9 true))
(let ((anon10_Then_correct@@9  (=> |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| (and (=> (= (ControlFlow 0 715665) (- 0 1083062)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 715665) (- 0 1083083)) (forall ((addr@@277 Int) ) (!  (=> (|$IsValid'address'| addr@@277) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@277)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@277))))
 :qid |Diembpl.11406:15|
 :skolemid |475|
))) (=> (forall ((addr@@278 Int) ) (!  (=> (|$IsValid'address'| addr@@278) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@278)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@278))))
 :qid |Diembpl.11406:15|
 :skolemid |475|
)) (and (=> (= (ControlFlow 0 715665) (- 0 1083112)) (forall ((addr@@279 Int) ) (!  (=> (|$IsValid'address'| addr@@279) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@279) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@279)))
 :qid |Diembpl.11411:15|
 :skolemid |476|
))) (=> (forall ((addr@@280 Int) ) (!  (=> (|$IsValid'address'| addr@@280) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@280) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@280)))
 :qid |Diembpl.11411:15|
 :skolemid |476|
)) (and (=> (= (ControlFlow 0 715665) (- 0 1083137)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 715665) (- 0 1083158)) (forall ((addr@@281 Int) ) (!  (=> (|$IsValid'address'| addr@@281) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@281)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@281))))
 :qid |Diembpl.11421:15|
 :skolemid |477|
))) (=> (forall ((addr@@282 Int) ) (!  (=> (|$IsValid'address'| addr@@282) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@282)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@282))))
 :qid |Diembpl.11421:15|
 :skolemid |477|
)) (and (=> (= (ControlFlow 0 715665) (- 0 1083187)) (forall ((addr@@283 Int) ) (!  (=> (|$IsValid'address'| addr@@283) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@283) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@283)))
 :qid |Diembpl.11426:15|
 :skolemid |478|
))) (=> (forall ((addr@@284 Int) ) (!  (=> (|$IsValid'address'| addr@@284) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@284) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@284)))
 :qid |Diembpl.11426:15|
 :skolemid |478|
)) (and (=> (= (ControlFlow 0 715665) (- 0 1083212)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 715665) (- 0 1083233)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 715665) (- 0 1083254)) (forall ((addr@@285 Int) ) (!  (=> (|$IsValid'address'| addr@@285) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@285) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@285))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@285))))
 :qid |Diembpl.11441:15|
 :skolemid |479|
))) (=> (forall ((addr@@286 Int) ) (!  (=> (|$IsValid'address'| addr@@286) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@286) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@286))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@286))))
 :qid |Diembpl.11441:15|
 :skolemid |479|
)) (and (=> (= (ControlFlow 0 715665) (- 0 1083290)) (forall ((addr@@287 Int) ) (!  (=> (|$IsValid'address'| addr@@287) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@287) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@287)))
 :qid |Diembpl.11446:15|
 :skolemid |480|
))) (=> (forall ((addr@@288 Int) ) (!  (=> (|$IsValid'address'| addr@@288) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@288) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@288)))
 :qid |Diembpl.11446:15|
 :skolemid |480|
)) (=> (= (ControlFlow 0 715665) (- 0 1083315)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))))))))))))))))))))))))
(let ((anon9_Else_correct@@8  (=> (and (not $abort_flag@2) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t6@@13) (= $t6@@13 1)) (and (= $t6@@13 $t6@@13) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 715357) 715665) anon10_Then_correct@@9) (=> (= (ControlFlow 0 715357) 715373) anon10_Else_correct@@9))))))
(let ((anon9_Then_correct@@8 true))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$L5_correct|  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 |inline$$1_Diem_is_SCS_currency'#0'$0$$t2@1|) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 715249) 715679) anon9_Then_correct@@8) (=> (= (ControlFlow 0 715249) 715357) anon9_Else_correct@@8))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|  (=> (and (and $abort_flag@0@@5 (= $abort_code@1@@5 $abort_code@1@@5)) (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t2@1| $abort_code@1@@5) (= (ControlFlow 0 715243) 715249))) |inline$$1_Diem_is_SCS_currency'#0'$0$L5_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|  (=> (and (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1|) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1|))) (and (=> (= (ControlFlow 0 715145) 715679) anon9_Then_correct@@8) (=> (= (ControlFlow 0 715145) 715357) anon9_Else_correct@@8)))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else$1_correct|  (=> (= inline$$Not$0$dst@1@@0 inline$$Not$0$dst@1@@0) (=> (and (and (= $abort_code@2 $abort_code@1@@5) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| inline$$Not$0$dst@1@@0)) (and (= $abort_flag@1 $abort_flag@0@@5) (= (ControlFlow 0 715229) 715145))) |inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|))))
(let ((inline$$Not$0$anon0_correct@@0  (=> (and (= inline$$Not$0$dst@1@@0  (not |inline$$1_Diem_is_SCS_currency'#0'$0$$t5@1|)) (= (ControlFlow 0 715211) 715229)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else$1_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|  (=> (not $abort_flag@0@@5) (=> (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t5@1| (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2|)) (= (ControlFlow 0 715217) 715211)) inline$$Not$0$anon0_correct@@0))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then$1_correct|  (=> (= $abort_flag@0@@5 true) (=> (and (= $abort_code@1@@5 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@0|)) (and (=> (= (ControlFlow 0 715301) 715243) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 715301) 715217) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 715299) 715301)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then$1_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@1| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $abort_flag@0@@5 false)) (and (= $abort_code@1@@5 $abort_code@0@@5) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@1|))) (and (=> (= (ControlFlow 0 715169) 715243) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 715169) 715217) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Then_correct|  (=> (and |inline$$1_Diem_is_currency'#0'$0$$t1@1| (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 715155) 715299) |inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 715155) 715169) |inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Else_correct|)))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Else_correct|  (=> (and (not |inline$$1_Diem_is_currency'#0'$0$$t1@1|) (= false false)) (=> (and (and (= $abort_code@2 $abort_code@0@@5) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| false)) (and (= $abort_flag@1 false) (= (ControlFlow 0 715133) 715145))) |inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Else_correct|  (=> (not false) (and (=> (= (ControlFlow 0 715113) 715155) |inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 715113) 715133) |inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Else_correct|)))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Then_correct| true))
(let ((|inline$$1_Diem_is_currency'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| |inline$$1_Diem_is_currency'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 715099) 715315) |inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 715099) 715113) |inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Else_correct|))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon0_correct|  (=> (= (ControlFlow 0 715105) 715099) |inline$$1_Diem_is_currency'#0'$0$anon0_correct|)))
(let ((anon8_Else_correct@@0  (=> (and (not $t2@@10) (= (ControlFlow 0 715321) 715105)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon0_correct|)))
(let ((anon8_Then_correct@@0 true))
(let ((anon0$1_correct@@19  (=> (and (and (and (and (forall ((addr3@@26 Int) ) (!  (=> (|$IsValid'address'| addr3@@26) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3@@26) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.11283:22|
 :skolemid |465|
)) (forall ((addr3@@27 Int) ) (!  (=> (|$IsValid'address'| addr3@@27) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316220| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@27) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |Diembpl.11283:261|
 :skolemid |466|
))) (forall ((addr3@@28 Int) ) (!  (=> (|$IsValid'address'| addr3@@28) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr3@@28) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |Diembpl.11283:501|
 :skolemid |467|
))) (and (and (forall ((addr@@289 Int) ) (!  (=> (|$IsValid'address'| addr@@289) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@289) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.11287:22|
 :skolemid |468|
)) (forall ((addr@@290 Int) ) (!  (=> (|$IsValid'address'| addr@@290) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@290) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.11287:222|
 :skolemid |469|
))) (forall ((addr@@291 Int) ) (!  (=> (|$IsValid'address'| addr@@291) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@291) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.11287:423|
 :skolemid |470|
)))) (and (and (and (forall ((addr@@292 Int) ) (!  (=> (|$IsValid'address'| addr@@292) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@292) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.11291:22|
 :skolemid |471|
)) (forall ((addr@@293 Int) ) (!  (=> (|$IsValid'address'| addr@@293) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@293) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.11291:227|
 :skolemid |472|
))) (forall ((addr@@294 Int) ) (!  (=> (|$IsValid'address'| addr@@294) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@294) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.11291:433|
 :skolemid |473|
))) (and (forall (($a_0@@23 Int) ) (! (let (($rsc@@23 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@23)))
 (and (|$IsValid'$1_Diem_CurrencyInfo'#0''| $rsc@@23) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@23)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@23) 10000000000))))
 :qid |Diembpl.11294:20|
 :skolemid |474|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@23))
)) (= $t2@@10  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 714766) 715705) anon8_Then_correct@@0) (=> (= (ControlFlow 0 714766) 715321) anon8_Else_correct@@0)))))
(let ((inline$$InitEventStore$0$anon0_correct@@19  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@21 T@$1_Event_EventHandle) ) (! (let ((stream@@20 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@21)))
 (and (= (|l#Multiset_275813| stream@@20) 0) (forall ((v@@68 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@20) v@@68) 0)
 :qid |Diembpl.159:13|
 :skolemid |4|
))))
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 714487) 714766)) anon0$1_correct@@19)))
(let ((anon0_correct@@19  (=> (= (ControlFlow 0 1082312) 714487) inline$$InitEventStore$0$anon0_correct@@19)))
anon0_correct@@19)))))))))))))))))))))))))
))
(check-sat)
(pop 1)
