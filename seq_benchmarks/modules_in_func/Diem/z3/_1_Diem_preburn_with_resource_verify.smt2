...
(declare-fun $t1@0 () T@$Mutation_366442)
...
(declare-fun $t30@2 () T@$Mutation_390573)
...
(declare-fun $t9 () T@$Mutation_390573)
(declare-fun $t24 () T@$Mutation_390620)
(declare-fun $t39 () T@$Mutation_13443)
(declare-fun $t42 () T@$Mutation_298711)
(push 1)
(set-info :boogie-vc-id $1_Diem_preburn_with_resource$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1195031) (let ((L7_correct  (=> (= |$temp_0'$1_Diem_Preburn'#0''@1| (|v#$Mutation_366442| $t1@0)) (=> (and (= |$temp_0'$1_Diem_Preburn'#0''@1| |$temp_0'$1_Diem_Preburn'#0''@1|) (= $t44 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816))) (and (=> (= (ControlFlow 0 876446) (- 0 1198026)) (not (> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t15@0)) 0))) (=> (not (> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t15@0)) 0)) (and (=> (= (ControlFlow 0 876446) (- 0 1198040)) (not (> (+ (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615))) (=> (not (> (+ (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615)) (and (=> (= (ControlFlow 0 876446) (- 0 1198059)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 876446) (- 0 1198069)) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816) (and (=> (= (ControlFlow 0 876446) (- 0 1198077)) (= $t44 (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (+ (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) (|$value#$1_Diem_Diem'#0'| _$t0)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10)))) (=> (= $t44 (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (+ (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) (|$value#$1_Diem_Diem'#0'| _$t0)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))) (and (=> (= (ControlFlow 0 876446) (- 0 1198097)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 876446) (- 0 1198117)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@0))))
 :qid |Diembpl.39488:15|
 :skolemid |2062|
 ...
 :qid |Diembpl.39488:15|
 :skolemid |2062|
)) (and (=> (= (ControlFlow 0 876446) (- 0 1198146)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@2)))
 :qid |Diembpl.39493:15|
 :skolemid |2063|
 ...
 :qid |Diembpl.39493:15|
 :skolemid |2063|
)) (and (=> (= (ControlFlow 0 876446) (- 0 1198171)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 876446) (- 0 1198191)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4))))
 :qid |Diembpl.39503:15|
 :skolemid |2064|
 ...
 :qid |Diembpl.39503:15|
 :skolemid |2064|
)) (and (=> (= (ControlFlow 0 876446) (- 0 1198220)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6)))
 :qid |Diembpl.39508:15|
 :skolemid |2065|
 ...
 :qid |Diembpl.39508:15|
 :skolemid |2065|
)) (and (=> (= (ControlFlow 0 876446) (- 0 1198245)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 876446) (- 0 1198265)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_308343| |$1_Diem_Preburn'#0'_$memory|) addr@@8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8))))
 :qid |Diembpl.39518:15|
 :skolemid |2066|
))) (=> (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_308343| |$1_Diem_Preburn'#0'_$memory|) addr@@9))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9))))
 :qid |Diembpl.39518:15|
 :skolemid |2066|
)) (and (=> (= (ControlFlow 0 876446) (- 0 1198301)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10)))
 :qid |Diembpl.39523:15|
 :skolemid |2067|
))) (=> (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@11)))
 :qid |Diembpl.39523:15|
 :skolemid |2067|
)) (and (=> (= (ControlFlow 0 876446) (- 0 1198326)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 876446) (- 0 1198346)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $EmptyEventStore) $t13)))
(let ((stream_new (let ((len (|l#Multiset_274042| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_274042| stream@@0) (|$ToEventRep'$1_Diem_PreburnEvent'| $t14))))
(Multiset_274042 (|Store__T@[$EventRep]Int_| (|v#Multiset_274042| stream@@0) (|$ToEventRep'$1_Diem_PreburnEvent'| $t14) (+ cnt 1)) (+ len 1))))))
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $EmptyEventStore) $t13)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_274042| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_274042| stream@@1) (|$ToEventRep'$1_Diem_PreburnEvent'| $t14))))
(Multiset_274042 (|Store__T@[$EventRep]Int_| (|v#Multiset_274042| stream@@1) (|$ToEventRep'$1_Diem_PreburnEvent'| $t14) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $EmptyEventStore) $t13 stream_new@@0)))) $EmptyEventStore)))
 ...
 :qid |Diembpl.2744:13|
 :skolemid |75|
))))) (=> (= (ControlFlow 0 876446) (- 0 1198377)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $EmptyEventStore) $t13)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_274042| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_274042| stream@@2) (|$ToEventRep'$1_Diem_PreburnEvent'| $t14))))
(Multiset_274042 (|Store__T@[$EventRep]Int_| (|v#Multiset_274042| stream@@2) (|$ToEventRep'$1_Diem_PreburnEvent'| $t14) (+ cnt@@1 1)) (+ len@@1 1))))))
...
(let ((anon45_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 877155) (- 0 1197379)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@2)) 10000000000)) (=> (and (and (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 ...
 :qid |Diembpl.39332:968|
 :skolemid |2031|
)))) (and (=> (= (ControlFlow 0 877155) (- 0 1197701)) (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.39338:17|
 :skolemid |2032|
 ...
 :qid |Diembpl.39338:256|
 :skolemid |2033|
))) (forall ((addr3@@1 Int) ) (!  (=> (|$IsValid'address'| addr3@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr3@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816))))))
 :qid |Diembpl.39338:496|
 :skolemid |2034|
 ...
 :qid |Diembpl.39338:496|
 :skolemid |2034|
))) (and (=> (= (ControlFlow 0 877155) (- 0 1197770)) (and (and (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308049| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.39344:17|
 :skolemid |2035|
 ...
 :qid |Diembpl.39344:217|
 :skolemid |2036|
))) (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308343| |$1_Diem_Preburn'#0'_$memory|) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |Diembpl.39344:418|
 :skolemid |2037|
 ...
 :qid |Diembpl.39344:217|
 :skolemid |2036|
))) (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308343| |$1_Diem_Preburn'#0'_$memory|) addr@@17) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |Diembpl.39344:418|
 :skolemid |2037|
))) (and (=> (= (ControlFlow 0 877155) (- 0 1197839)) (and (and (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307989| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.39350:17|
 :skolemid |2038|
 ...
 :qid |Diembpl.39350:222|
 :skolemid |2039|
))) (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@20) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |Diembpl.39350:428|
 :skolemid |2040|
 ...
 :qid |Diembpl.39350:222|
 :skolemid |2039|
))) (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@23) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |Diembpl.39350:428|
 :skolemid |2040|
))) (and (=> (= (ControlFlow 0 877155) (- 0 1197908)) (and (and (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr)))
 :qid |Diembpl.39356:17|
 :skolemid |2041|
 ...
 :qid |Diembpl.39356:223|
 :skolemid |2042|
))) (forall ((dr_addr@@1 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@1|) dr_addr@@1)))
 :qid |Diembpl.39356:430|
 :skolemid |2043|
 ...
 :qid |Diembpl.39356:223|
 :skolemid |2042|
))) (forall ((dr_addr@@4 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@1|) dr_addr@@4)))
 :qid |Diembpl.39356:430|
 :skolemid |2043|
))) (=> (= $es@1 $es@0) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@1|) (= (ControlFlow 0 877155) 876446)) L7_correct))))))))))))))))))
(let ((anon44_Else_correct  (=> (not inline$$Not$0$dst@1) (and (=> (= (ControlFlow 0 876024) (- 0 1196592)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@2)) 10000000000)) (=> (and (and (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@8 Int) (mint_cap_owner2@@8 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@8) (=> (|$IsValid'address'| mint_cap_owner2@@8) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner2@@8)) (= mint_cap_owner1@@8 mint_cap_owner2@@8))))
 :qid |Diembpl.39375:106|
 :skolemid |2044|
 ...
 :qid |Diembpl.39398:968|
 :skolemid |2049|
)))) (and (=> (= (ControlFlow 0 876024) (- 0 1196914)) (and (and (forall ((addr3@@5 Int) ) (!  (=> (|$IsValid'address'| addr3@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.39404:17|
 :skolemid |2050|
 ...
 :qid |Diembpl.39404:256|
 :skolemid |2051|
))) (forall ((addr3@@7 Int) ) (!  (=> (|$IsValid'address'| addr3@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr3@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816))))))
 :qid |Diembpl.39404:496|
 :skolemid |2052|
 ...
 :qid |Diembpl.39404:496|
 :skolemid |2052|
))) (and (=> (= (ControlFlow 0 876024) (- 0 1196983)) (and (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308049| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@24) (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.39410:17|
 :skolemid |2053|
 ...
 :qid |Diembpl.39410:217|
 :skolemid |2054|
))) (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308343| |$1_Diem_Preburn'#0'_$memory|) addr@@26) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |Diembpl.39410:418|
 :skolemid |2055|
 ...
 :qid |Diembpl.39410:217|
 :skolemid |2054|
))) (forall ((addr@@29 Int) ) (!  (=> (|$IsValid'address'| addr@@29) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308343| |$1_Diem_Preburn'#0'_$memory|) addr@@29) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |Diembpl.39410:418|
 :skolemid |2055|
))) (and (=> (= (ControlFlow 0 876024) (- 0 1197052)) (and (and (forall ((addr@@30 Int) ) (!  (=> (|$IsValid'address'| addr@@30) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307989| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@30) (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.39416:17|
 :skolemid |2056|
 ...
 :qid |Diembpl.39416:222|
 :skolemid |2057|
))) (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@32) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |Diembpl.39416:428|
 :skolemid |2058|
 ...
 :qid |Diembpl.39416:222|
 :skolemid |2057|
))) (forall ((addr@@35 Int) ) (!  (=> (|$IsValid'address'| addr@@35) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@35) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |Diembpl.39416:428|
 :skolemid |2058|
))) (and (=> (= (ControlFlow 0 876024) (- 0 1197121)) (and (and (forall ((dr_addr@@5 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr@@5)))
 :qid |Diembpl.39422:17|
 :skolemid |2059|
 ...
 :qid |Diembpl.39422:223|
 :skolemid |2060|
))) (forall ((dr_addr@@7 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@7)))
 :qid |Diembpl.39422:430|
 :skolemid |2061|
 ...
 :qid |Diembpl.39422:223|
 :skolemid |2060|
))) (forall ((dr_addr@@10 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@10)))
 :qid |Diembpl.39422:430|
 :skolemid |2061|
))) (=> (= $es@1 $es) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@0|) (= (ControlFlow 0 876024) 876446)) L7_correct))))))))))))))))))
(let ((L10_correct  (and (=> (= (ControlFlow 0 874706) (- 0 1197283)) (or (or (> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t15@0)) 0) (> (+ (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t15@0)) 0) (> (+ (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 874706) (- 0 1197315)) (or (or (and (> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t15@0)) 0) (= 1 $t17@0)) (and (> (+ (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615) (= 8 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17@0))))))))
(let ((anon45_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 877169) 874706))) L10_correct)))
(let ((|inline$$1_Event_emit_event'$1_Diem_PreburnEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_PreburnEvent'$0$handle@1| (|v#$Mutation_298711| $t42@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_PreburnEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_274042| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_274042| stream@@3) (|$ToEventRep'$1_Diem_PreburnEvent'| $t43@0))))
(Multiset_274042 (|Store__T@[$EventRep]Int_| (|v#Multiset_274042| stream@@3) (|$ToEventRep'$1_Diem_PreburnEvent'| $t43@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_PreburnEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 876543) 877169) anon45_Then_correct) (=> (= (ControlFlow 0 876543) 877155) anon45_Else_correct)))))
(let ((anon44_Then_correct  (=> (and (and inline$$Not$0$dst@1 (= $t42@0 ($Mutation_298711 (|l#$Mutation_390573| $t30@2) (seq.++ (|p#$Mutation_390573| $t30@2) (seq.unit 10)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@2))))) (and (= $t43@0 ($1_Diem_PreburnEvent |inline$$1_Diem_value'#0'$0$$t1@1| $t27 _$t2)) (= (ControlFlow 0 876549) 876543))) |inline$$1_Event_emit_event'$1_Diem_PreburnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not $t40@0)) (and (=> (= (ControlFlow 0 875410) 876549) anon44_Then_correct) (=> (= (ControlFlow 0 875410) 876024) anon44_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (not $abort_flag@2) (= $t39@0 ($Mutation_13443 (|l#$Mutation_390573| $t30@1) (seq.++ (|p#$Mutation_390573| $t30@1) (seq.unit 1)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1))))) (=> (and (and (= $t39@1 ($Mutation_13443 (|l#$Mutation_13443| $t39@0) (|p#$Mutation_13443| $t39@0) inline$$AddU64$0$dst@2)) (= $t30@2 ($Mutation_390573 (|l#$Mutation_390573| $t30@1) (|p#$Mutation_390573| $t30@1) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) (|v#$Mutation_13443| $t39@1) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)))))) (and (= $t40@0 (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@2))) (= (ControlFlow 0 875416) 875410))) inline$$Not$0$anon0_correct))))
(let ((anon43_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 877183) 874706))) L10_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 875326) 877183) anon43_Then_correct) (=> (= (ControlFlow 0 875326) 875416) anon43_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t37@0 |inline$$1_Diem_value'#0'$0$$t1@1|) $MAX_U64) (= (ControlFlow 0 875324) 875326)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t37@0 |inline$$1_Diem_value'#0'$0$$t1@1|)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t37@0 |inline$$1_Diem_value'#0'$0$$t1@1|)) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 875272) 877183) anon43_Then_correct) (=> (= (ControlFlow 0 875272) 875416) anon43_Else_correct))))))
(let ((anon42_Then_correct  (=> (and inline$$Ge$0$dst@1 (= $t37@0 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)))) (and (=> (= (ControlFlow 0 875332) 875324) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 875332) 875272) inline$$AddU64$0$anon3_Else_correct)))))
(let ((anon42_Else_correct  (=> (not inline$$Ge$0$dst@1) (and (=> (= (ControlFlow 0 875169) (- 0 1196352)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1)) 10000000000)) (=> (= $t36 $t36) (=> (and (= $t17@0 $t36) (= (ControlFlow 0 875169) 874706)) L10_correct)))))))
(let ((anon41_Else$1_correct  (=> (|$IsValid'u64'| 7) (=> (and (and (|$IsValid'u64'| $t36) (= $t36 8)) (and (= $t36 $t36) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 875127) 875332) anon42_Then_correct) (=> (= (ControlFlow 0 875127) 875169) anon42_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= inline$$Sub$0$dst@2 |inline$$1_Diem_value'#0'$0$$t1@1|)) (= (ControlFlow 0 875091) 875127)) anon41_Else$1_correct)))
(let ((anon41_Else_correct  (=> (and (not $abort_flag@1) (= (ControlFlow 0 875097) 875091)) inline$$Ge$0$anon0_correct)))
(let ((anon41_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 877197) 874706))) L10_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 875037) 877197) anon41_Then_correct) (=> (= (ControlFlow 0 875037) 875097) anon41_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< 18446744073709551615 $t32@0) (= (ControlFlow 0 875035) 875037)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= $t32@0 18446744073709551615) (=> (and (and (= inline$$Sub$0$dst@1 (- 18446744073709551615 $t32@0)) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 874987) 877197) anon41_Then_correct) (=> (= (ControlFlow 0 874987) 875097) anon41_Else_correct))))))
(let ((anon40_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| (|v#$Mutation_390573| $t30@1)) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| |$temp_0'$1_Diem_CurrencyInfo'#0''@0|)) (and (|$IsValid'u64'| 18446744073709551615) (= $t32@0 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_390573| $t30@1))))) (and (=> (= (ControlFlow 0 875043) 875035) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 875043) 874987) inline$$Sub$0$anon3_Else_correct))))))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 877211) 874706))) L10_correct)))
(let ((anon39_Then$1_correct  (=> (= $t30@1 $t30) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 877263) 877211) anon40_Then_correct) (=> (= (ControlFlow 0 877263) 875043) anon40_Else_correct))))))
(let ((anon39_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 877261) 877263)) anon39_Then$1_correct)))
(let ((anon39_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t30@0 ($Mutation_390573 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t30@1 $t30@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 874874) 877211) anon40_Then_correct) (=> (= (ControlFlow 0 874874) 875043) anon40_Else_correct))))))
(let ((anon38_Else_correct  (=> (not $t28) (=> (and (and (|$IsValid'vec'u8''| $t27) (= $t27 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t27 $t27) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 874852) (- 0 1196084)) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (and (=> (= (ControlFlow 0 874852) 877261) anon39_Then_correct) (=> (= (ControlFlow 0 874852) 874874) anon39_Else_correct))))))))
(let ((anon38_Then_correct  (=> $t28 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17)) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 877289) 874706))) L10_correct))))
(let ((anon37_Else_correct  (=> (not $t26) (=> (and (= $t24@1 ($Mutation_390620 (|l#$Mutation_390620| $t24@0) (|p#$Mutation_390620| $t24@0) |$temp_0'$1_Diem_Diem'#0''@0|)) (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_390620| $t24@1))) (=> (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_390620| $t24@1)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_390620| $t24@1)) (+ (|$value#$1_Diem_Diem'#0'| $t25@0) (|$value#$1_Diem_Diem'#0'| _$t0)))) (and (= $t1@0 ($Mutation_366442 (|l#$Mutation_366442| _$t1) (|p#$Mutation_366442| _$t1) (|$1_Diem_Preburn'#0'| (|v#$Mutation_390620| $t24@1)))) (= $t28  (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 874814) 877289) anon38_Then_correct) (=> (= (ControlFlow 0 874814) 874852) anon38_Else_correct)))))))
(let ((anon37_Then_correct  (=> $t26 (=> (and (and (and (> (+ (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_390620| $t24@0)) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615) (= 8 $t17)) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 877325) 874706))) L10_correct))))
(let ((anon36_Then_correct  (=> (and (and $t21@0 (= $t24@0 ($Mutation_390620 (|l#$Mutation_366442| _$t1) (seq.++ (|p#$Mutation_366442| _$t1) (seq.unit 0)) (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_366442| _$t1))))) (and (= $t25@0 (|v#$Mutation_390620| $t24@0)) (= $t26 (> (+ (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_390620| $t24@0)) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615)))) (and (=> (= (ControlFlow 0 874746) 877325) anon37_Then_correct) (=> (= (ControlFlow 0 874746) 874814) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (and (and (not $t21@0) (= $t23 $t23)) (and (= $t17@0 $t23) (= (ControlFlow 0 874602) 874706))) L10_correct)))
(let ((anon35_Else_correct  (=> (and (and (and (not false) (|$IsValid'u64'| 0)) (and (= $t21@0 (= |inline$$1_Diem_value'#0'$1$$t1@1| 0)) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t23) (= $t23 1)) (and (= $t23 $t23) (= $t21@0 $t21@0)))) (and (=> (= (ControlFlow 0 874586) 874746) anon36_Then_correct) (=> (= (ControlFlow 0 874586) 874602) anon36_Else_correct)))))
(let ((anon35_Then_correct true))
(let ((|inline$$1_Diem_value'#0'$1$anon0_correct|  (=> (= $t18@0 $t18@0) (=> (and (= |inline$$1_Diem_value'#0'$1$$t1@1| (|$value#$1_Diem_Diem'#0'| $t18@0)) (= |inline$$1_Diem_value'#0'$1$$t1@1| |inline$$1_Diem_value'#0'$1$$t1@1|)) (and (=> (= (ControlFlow 0 874532) 877339) anon35_Then_correct) (=> (= (ControlFlow 0 874532) 874586) anon35_Else_correct))))))
(let ((anon34_Else_correct  (=> (and (and (not false) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (= $t18@0 (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_366442| _$t1))) (= (ControlFlow 0 874538) 874532))) |inline$$1_Diem_value'#0'$1$anon0_correct|)))
(let ((anon34_Then_correct true))
(let ((|inline$$1_Diem_value'#0'$0$anon0_correct|  (=> (= _$t0 _$t0) (=> (and (= |inline$$1_Diem_value'#0'$0$$t1@1| (|$value#$1_Diem_Diem'#0'| _$t0)) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 874411) 877353) anon34_Then_correct) (=> (= (ControlFlow 0 874411) 874538) anon34_Else_correct))))))
(let ((anon0$1_correct  (=> (= (|l#$Mutation_366442| _$t1) ($Param 1)) (=> (and (and (forall ((addr3@@11 Int) ) (!  (=> (|$IsValid'address'| addr3@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.38902:22|
 :skolemid |2016|
 ...
 :qid |Diembpl.38902:501|
 :skolemid |2018|
))) (=> (and (and (and (forall ((addr@@36 Int) ) (!  (=> (|$IsValid'address'| addr@@36) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308049| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@36) (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.38906:22|
 :skolemid |2019|
 ...
 :qid |Diembpl.38906:423|
 :skolemid |2021|
))) (and (and (forall ((addr@@39 Int) ) (!  (=> (|$IsValid'address'| addr@@39) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307989| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@39) (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.38910:22|
 :skolemid |2022|
 ...
 :qid |Diembpl.38910:433|
 :skolemid |2024|
)))) (=> (and (and (and (and (|$IsValid'$1_Diem_Diem'#0''| _$t0) (|$IsValid'$1_Diem_Preburn'#0''| (|v#$Mutation_366442| _$t1))) (and (|$IsValid'address'| _$t2) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0)))
 ...
 :qid |Diembpl.38922:20|
 :skolemid |2025|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0))
)))) (and (and (= $t10 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t11 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t12 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t13 (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t11))))) (and (and (and (= $t14 ($1_Diem_PreburnEvent (|$value#$1_Diem_Diem'#0'| _$t0) $t12 _$t2)) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816)) (and (= $t15@0 (|v#$Mutation_366442| _$t1)) (= _$t0 _$t0))) (and (and (= |$temp_0'$1_Diem_Preburn'#0''@0| (|v#$Mutation_366442| _$t1)) (= |$temp_0'$1_Diem_Preburn'#0''@0| |$temp_0'$1_Diem_Preburn'#0''@0|)) (and (= _$t2 _$t2) (= (ControlFlow 0 874417) 874411))))) |inline$$1_Diem_value'#0'$0$anon0_correct|))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 873933) 874417)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (seq.len (|p#$Mutation_390573| $t9)) 0) (= (seq.len (|p#$Mutation_390620| $t24)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_390573| $t30)) 0) (= (seq.len (|p#$Mutation_13443| $t39)) 0)) (and (= (seq.len (|p#$Mutation_298711| $t42)) 0) (= (ControlFlow 0 873943) 873933))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 1195031) 873943) anon0_correct)))
