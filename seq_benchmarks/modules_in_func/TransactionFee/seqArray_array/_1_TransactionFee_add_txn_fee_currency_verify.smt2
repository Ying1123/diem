...
(assert (not
 (=> (= (ControlFlow 0 0) 328312) (let ((anon26_Else_correct@@0  (=> (and (and (not $abort_flag@3@@0) (= (ControlFlow 0 226829) (- 0 329847))) (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_130984| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))))
(let ((anon26_Then_correct@@0 true))
(let ((anon25_Then$1_correct  (=> (and (= $abort_flag@3@@0 true) (= $abort_code@4@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 226895) 226843) anon26_Then_correct@@0) (=> (= (ControlFlow 0 226895) 226829) anon26_Else_correct@@0)))))
(let ((anon25_Then_correct@@0  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|$addr#$signer| _$t0@@1)) (= (ControlFlow 0 226893) 226895)) anon25_Then$1_correct)))
(let ((anon25_Else_correct@@0  (=> (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|$addr#$signer| _$t0@@1))) (= |$1_TransactionFee_TransactionFee'#0'_$memory@0| ($Memory_173582 (|Store__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|$addr#$signer| _$t0@@1) true) (|Store__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|$addr#$signer| _$t0@@1) $t14@0@@0)))) (and (= $abort_flag@3@@0 $abort_flag@2@@0) (= $abort_code@4@@0 $abort_code@3@@0))) (and (=> (= (ControlFlow 0 226807) 226843) anon26_Then_correct@@0) (=> (= (ControlFlow 0 226807) 226829) anon26_Else_correct@@0)))))
(let ((anon24_Else_correct@@0  (=> (not $abort_flag@2@@0) (=> (and (= $t14@0@@0 (|$1_TransactionFee_TransactionFee'#0'| |inline$$1_Diem_zero'#0'$0$$ret0| |inline$$1_Diem_create_preburn'#0'$0$$ret0|)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_130984| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (and (=> (= (ControlFlow 0 226785) 226893) anon25_Then_correct@@0) (=> (= (ControlFlow 0 226785) 226807) anon25_Else_correct@@0))))))
(let ((anon24_Then_correct@@0 true))
(let ((|inline$$1_Diem_create_preburn'#0'$0$L2_correct|  (=> (and (= $abort_code@3@@0 |inline$$1_Diem_create_preburn'#0'$0$$t4@1|) (= $abort_flag@2@@0 true)) (and (=> (= (ControlFlow 0 226651) 226909) anon24_Then_correct@@0) (=> (= (ControlFlow 0 226651) 226785) anon24_Else_correct@@0)))))
(let ((|inline$$1_Diem_create_preburn'#0'$0$anon9_Then_correct|  (=> (and (and $abort_flag@1@@0 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= |inline$$1_Diem_create_preburn'#0'$0$$t4@1| $abort_code@2@@0) (= (ControlFlow 0 226645) 226651))) |inline$$1_Diem_create_preburn'#0'$0$L2_correct|)))
(let ((|inline$$1_Diem_create_preburn'#0'$0$anon8_Then_correct|  (=> |inline$$1_Diem_create_preburn'#0'$0$$t5@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_create_preburn'#0'$0$$t4@0|)) (= |inline$$1_Diem_create_preburn'#0'$0$$t4@0| |inline$$1_Diem_create_preburn'#0'$0$$t4@0|)) (and (= |inline$$1_Diem_create_preburn'#0'$0$$t4@1| |inline$$1_Diem_create_preburn'#0'$0$$t4@0|) (= (ControlFlow 0 226677) 226651))) |inline$$1_Diem_create_preburn'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_create_preburn'#0'$0$anon7_Then_correct|  (=> |inline$$1_Diem_create_preburn'#0'$0$$t3@0| (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'#0'$0$$t2@0|)) (= 5 |inline$$1_Diem_create_preburn'#0'$0$$t4@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'#0'$0$$t2@0|)) 1)) (= 3 |inline$$1_Diem_create_preburn'#0'$0$$t4@0|))) (and (not (= (|$addr#$signer| _$t0@@1) 186537453)) (= 2 |inline$$1_Diem_create_preburn'#0'$0$$t4@0|))) (= |inline$$1_Diem_create_preburn'#0'$0$$t4@0| |inline$$1_Diem_create_preburn'#0'$0$$t4@0|)) (and (= |inline$$1_Diem_create_preburn'#0'$0$$t4@1| |inline$$1_Diem_create_preburn'#0'$0$$t4@0|) (= (ControlFlow 0 226749) 226651))) |inline$$1_Diem_create_preburn'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_create_preburn'#0'$0$anon9_Else_correct|  (=> (not $abort_flag@1@@0) (=> (and (and (= |inline$$1_Diem_create_preburn'#0'$0$$t7@1| (|$1_Diem_Preburn'#0'| |inline$$1_Diem_zero'#0'$1$$ret0@1|)) (= |inline$$1_Diem_create_preburn'#0'$0$$t7@1| |inline$$1_Diem_create_preburn'#0'$0$$t7@1|)) (and (= $abort_code@3@@0 $abort_code@2@@0) (= $abort_flag@2@@0 $abort_flag@1@@0))) (and (=> (= (ControlFlow 0 226631) 226909) anon24_Then_correct@@0) (=> (= (ControlFlow 0 226631) 226785) anon24_Else_correct@@0))))))
(let ((|inline$$1_Diem_zero'#0'$1$anon3_Else_correct|  (=> (not |inline$$1_Diem_zero'#0'$1$$t0@0|) (=> (and (|$IsValid'u64'| 0) (= |inline$$1_Diem_zero'#0'$1$$t3@1| (|$1_Diem_Diem'#0'| 0))) (=> (and (and (= |inline$$1_Diem_zero'#0'$1$$t3@1| |inline$$1_Diem_zero'#0'$1$$t3@1|) (= $abort_code@2@@0 $abort_code@1@@1)) (and (= $abort_flag@1@@0 $abort_flag@0@@1) (= |inline$$1_Diem_zero'#0'$1$$ret0@1| |inline$$1_Diem_zero'#0'$1$$t3@1|))) (and (=> (= (ControlFlow 0 226573) 226645) |inline$$1_Diem_create_preburn'#0'$0$anon9_Then_correct|) (=> (= (ControlFlow 0 226573) 226631) |inline$$1_Diem_create_preburn'#0'$0$anon9_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'#0'$1$anon3_Then_correct|  (=> |inline$$1_Diem_zero'#0'$1$$t0@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_zero'#0'$1$$t1@0|)) (=> (and (and (= |inline$$1_Diem_zero'#0'$1$$t1@0| |inline$$1_Diem_zero'#0'$1$$t1@0|) (= $abort_code@2@@0 |inline$$1_Diem_zero'#0'$1$$t1@0|)) (and (= $abort_flag@1@@0 true) (= |inline$$1_Diem_zero'#0'$1$$ret0@1| |inline$$1_Diem_zero'#0'$1$$ret0@0|))) (and (=> (= (ControlFlow 0 226603) 226645) |inline$$1_Diem_create_preburn'#0'$0$anon9_Then_correct|) (=> (= (ControlFlow 0 226603) 226631) |inline$$1_Diem_create_preburn'#0'$0$anon9_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'#0'$1$anon0_correct|  (=> (= |inline$$1_Diem_zero'#0'$1$$t0@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 226545) 226603) |inline$$1_Diem_zero'#0'$1$anon3_Then_correct|) (=> (= (ControlFlow 0 226545) 226573) |inline$$1_Diem_zero'#0'$1$anon3_Else_correct|)))))
(let ((|inline$$1_Diem_create_preburn'#0'$0$anon8_Else_correct|  (=> (and (not |inline$$1_Diem_create_preburn'#0'$0$$t5@0|) (= (ControlFlow 0 226609) 226545)) |inline$$1_Diem_zero'#0'$1$anon0_correct|)))
(let ((|inline$$1_Diem_create_preburn'#0'$0$anon7_Else_correct|  (=> (and (not |inline$$1_Diem_create_preburn'#0'$0$$t3@0|) (= |inline$$1_Diem_create_preburn'#0'$0$$t5@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 226388) 226677) |inline$$1_Diem_create_preburn'#0'$0$anon8_Then_correct|) (=> (= (ControlFlow 0 226388) 226609) |inline$$1_Diem_create_preburn'#0'$0$anon8_Else_correct|)))))
(let ((|inline$$1_Diem_create_preburn'#0'$0$anon0_correct|  (=> (and (and (= |inline$$1_Diem_create_preburn'#0'$0$$t1@0| (|$addr#$signer| _$t0@@1)) (= _$t0@@1 _$t0@@1)) (and (= |inline$$1_Diem_create_preburn'#0'$0$$t2@0| (|$addr#$signer| _$t0@@1)) (= |inline$$1_Diem_create_preburn'#0'$0$$t3@0|  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'#0'$0$$t2@0|)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'#0'$0$$t2@0|)) 1))) (not (= (|$addr#$signer| _$t0@@1) 186537453)))))) (and (=> (= (ControlFlow 0 226370) 226749) |inline$$1_Diem_create_preburn'#0'$0$anon7_Then_correct|) (=> (= (ControlFlow 0 226370) 226388) |inline$$1_Diem_create_preburn'#0'$0$anon7_Else_correct|)))))
(let ((anon23_Else_correct@@0  (=> (not $abort_flag@0@@1) (=> (and (= $t12@@0 (|$addr#$signer| _$t0@@1)) (= (ControlFlow 0 226755) 226370)) |inline$$1_Diem_create_preburn'#0'$0$anon0_correct|))))
(let ((anon23_Then_correct@@0 true))
(let ((|inline$$1_Diem_zero'#0'$0$anon3_Else_correct|  (=> (and (not |inline$$1_Diem_zero'#0'$0$$t0@0|) (|$IsValid'u64'| 0)) (=> (and (and (= |inline$$1_Diem_zero'#0'$0$$t3@1| (|$1_Diem_Diem'#0'| 0)) (= |inline$$1_Diem_zero'#0'$0$$t3@1| |inline$$1_Diem_zero'#0'$0$$t3@1|)) (and (= $abort_flag@0@@1 false) (= $abort_code@1@@1 $abort_code@0@@1))) (and (=> (= (ControlFlow 0 225890) 226923) anon23_Then_correct@@0) (=> (= (ControlFlow 0 225890) 226755) anon23_Else_correct@@0))))))
(let ((|inline$$1_Diem_zero'#0'$0$anon3_Then_correct|  (=> |inline$$1_Diem_zero'#0'$0$$t0@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_zero'#0'$0$$t1@0|)) (= |inline$$1_Diem_zero'#0'$0$$t1@0| |inline$$1_Diem_zero'#0'$0$$t1@0|)) (and (= $abort_flag@0@@1 true) (= $abort_code@1@@1 |inline$$1_Diem_zero'#0'$0$$t1@0|))) (and (=> (= (ControlFlow 0 225920) 226923) anon23_Then_correct@@0) (=> (= (ControlFlow 0 225920) 226755) anon23_Else_correct@@0))))))
(let ((|inline$$1_Diem_zero'#0'$0$anon0_correct|  (=> (= |inline$$1_Diem_zero'#0'$0$$t0@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 225862) 225920) |inline$$1_Diem_zero'#0'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 225862) 225890) |inline$$1_Diem_zero'#0'$0$anon3_Else_correct|)))))
(let ((anon22_Then_correct@@0  (=> (and inline$$Not$0$dst@1@@0 (= (ControlFlow 0 225926) 225862)) |inline$$1_Diem_zero'#0'$0$anon0_correct|)))
(let ((anon22_Else_correct@@0 true))
(let ((anon21_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t10@@0) (= $t10@@0 6)) (and (= $t10@@0 $t10@@0) (= inline$$Not$0$dst@1@@0 inline$$Not$0$dst@1@@0))) (and (=> (= (ControlFlow 0 225685) 225926) anon22_Then_correct@@0) (=> (= (ControlFlow 0 225685) 225701) anon22_Else_correct@@0))))))
(let ((inline$$Not$0$anon0_correct@@0  (=> (and (= inline$$Not$0$dst@1@@0  (not |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|)) (= (ControlFlow 0 225645) 225685)) anon21_Else$1_correct)))
(let ((anon21_Else_correct@@0  (=> (and (not false) (= (ControlFlow 0 225651) 225645)) inline$$Not$0$anon0_correct@@0)))
(let ((anon21_Then_correct@@0 true))
(let ((|inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 186537453) (=> (and (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 225601) 226937) anon21_Then_correct@@0) (=> (= (ControlFlow 0 225601) 225651) anon21_Else_correct@@0))))))
(let ((anon20_Else_correct@@0  (=> (and (not $t6) (= (ControlFlow 0 225607) 225601)) |inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|)))
(let ((anon20_Then_correct@@0 true))
(let ((anon19_Else_correct  (=> (and (not $t4@@0) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 225514) 226963) anon20_Then_correct@@0) (=> (= (ControlFlow 0 225514) 225607) anon20_Else_correct@@0)))))
(let ((anon19_Then_correct true))
(let ((anon0$1_correct@@1  (=> (and (forall ((mint_cap_owner@@1 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_145224| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) mint_cap_owner@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) mint_cap_owner@@1)) 1))))
 :qid |TransactionFeebpl.15531:21|
 :skolemid |224|
)) (forall ((mint_cap_owner@@2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_145311| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) mint_cap_owner@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) mint_cap_owner@@2)) 1))))
 :qid |TransactionFeebpl.15531:268|
 :skolemid |225|
))) (=> (and (and (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139639| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@5)) 1))))
 :qid |TransactionFeebpl.15539:22|
 :skolemid |226|
)) (forall ((addr1@@6 Int) ) (!  (=> (|$IsValid'address'| addr1@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139726| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr1@@6) (and (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@6)) 1))))
 :qid |TransactionFeebpl.15539:232|
 :skolemid |227|
))) (forall ((addr1@@7 Int) ) (!  (=> (|$IsValid'address'| addr1@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139813| |$1_Diem_BurnCapability'#0'_$memory|) addr1@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@7)) 1))))
 :qid |TransactionFeebpl.15539:443|
 :skolemid |228|
))) (=> (and (and (and (forall ((addr1@@8 Int) ) (!  (=> (|$IsValid'address'| addr1@@8) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_145890| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_145478| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1@@8)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@8)) 2))))
 :qid |TransactionFeebpl.15543:22|
 :skolemid |229|
)) (forall ((addr1@@9 Int) ) (!  (=> (|$IsValid'address'| addr1@@9) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_146007| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr1@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_145559| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr1@@9)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@9)) 2))))
 :qid |TransactionFeebpl.15543:293|
 :skolemid |230|
))) (forall ((addr1@@10 Int) ) (!  (=> (|$IsValid'address'| addr1@@10) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_146124| |$1_Diem_PreburnQueue'#0'_$memory|) addr1@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_145640| |$1_Diem_Preburn'#0'_$memory|) addr1@@10)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) addr1@@10)) 2))))
 :qid |TransactionFeebpl.15543:565|
 :skolemid |231|
))) (and (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_145478| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_138932| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |TransactionFeebpl.15547:22|
 :skolemid |232|
)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_145559| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_138996| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |TransactionFeebpl.15547:222|
 :skolemid |233|
))) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_145640| |$1_Diem_Preburn'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |TransactionFeebpl.15547:423|
 :skolemid |234|
)))) (=> (and (and (and (and (and (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_145890| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_138932| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |TransactionFeebpl.15551:22|
 :skolemid |235|
)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_146007| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_138996| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |TransactionFeebpl.15551:227|
 :skolemid |236|
))) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_146124| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |TransactionFeebpl.15551:433|
 :skolemid |237|
))) (|$IsValid'address'| (|$addr#$signer| _$t0@@1))) (and (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) $a_0@@4)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@4))
 :qid |TransactionFeebpl.15561:20|
 :skolemid |238|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) $a_0@@4))
)) (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@5)))
 ...
 :qid |TransactionFeebpl.15565:20|
 :skolemid |239|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@5))
)))) (and (and (forall (($a_0@@6 Int) ) (! (let (($rsc@@6 (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@6)))
(|$IsValid'$1_TransactionFee_TransactionFee'#0''| $rsc@@6))
 :qid |TransactionFeebpl.15569:20|
 :skolemid |240|
 :pattern ( (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@6))
)) (= _$t0@@1 _$t0@@1)) (and (= $t3@@0 (|$addr#$signer| _$t0@@1)) (= $t4@@0  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) $t3@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) $t3@@0)) 1))) (not (= (|$addr#$signer| _$t0@@1) 186537453))))))) (and (=> (= (ControlFlow 0 225496) 227035) anon19_Then_correct) (=> (= (ControlFlow 0 225496) 225514) anon19_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@3 T@$1_Event_EventHandle) ) (! (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_91738_| (|streams#$EventStore| $es) handle@@3)))
 (and (= (|l#Multiset_91738| stream@@2) 0) (forall ((v@@50 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_91738| stream@@2) v@@50) 0)
 :qid |TransactionFeebpl.159:13|
 :skolemid |4|
))))
 :qid |TransactionFeebpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 224976) 225496)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 328312) 224976) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
