...
L8:
    ...
    assert {:msg "assert_failed(17,3378,4123): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#106) && $IsEqual'num'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 0) && $IsEqual'num'(2, $t11))) || (if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'num'(7, $t11)));
...
L3:
    ...
    assert {:msg "assert_failed(13,2579,2838): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#138) && $IsEqual'num'(6, $t4)) || (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139) && $IsEqual'num'(1, $t4))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t4)));
...
L3:
    ...
    assert {:msg "assert_failed(13,3677,3803): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory#90, 173345816) && $IsEqual'num'(5, $t7));
...
L5:
    ...
    assume ((((!$ResourceExists($1_Roles_RoleId_$memory, $t6) && $IsEqual'num'(5, $t9)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t6)), 0) && $IsEqual'num'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t9))) || ($ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory, 173345816) && $IsEqual'num'(6, $t9)));
...
L3:
    ...
    assert {:msg "assert_failed(13,10319,10596): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((($1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory#133) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'#0'_$memory#134, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory#135, $t5) && $IsEqual'num'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#135, $t5)), 0) && $IsEqual'num'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t9)));
...
L2:
    ...
    assert {:msg "assert_failed(13,11384,11584): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((!$ResourceExists($1_Roles_RoleId_$memory#145, $t1) && $IsEqual'num'(5, $t6)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t1)), 0) && $IsEqual'num'(3, $t6))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t6))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#147)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) > 0)) && ($epoch#$1_DiemConfig_Configuration($t2) < 18446744073709551615)) && ($t3 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t2))) && $IsEqual'num'(1, $t6)));
...
L17:
    ...
    assert {:msg "assert_failed(13,13497,14517): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t8), $t7)) && ($t9 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t8))) && $IsEqual'num'(1, $t15)) || (((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t8), $t7)) && ($IsEqual'u64'($epoch#$1_DiemConfig_Configuration($t8), 18446744073709551615) && !$IsEqual'u64'($t9, $last_reconfiguration_time#$1_DiemConfig_Configuration($t8)))) && $IsEqual'num'(-1, $t15))) || (((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t10), $t7)) && (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#108)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107) > 0)) && ($epoch#$1_DiemConfig_Configuration($t10) < 18446744073709551615)) && ($t11 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t10)))) && $IsEqual'num'(1, $t15)));
