...
(assert (not
 (=> (= (ControlFlow 0 0) 1898394) (let ((anon25_Else_correct@@1  (=> (and (and (not $abort_flag@0@@5) (= $t21@0 ($Mutation_490338 (|l#$Mutation_490297| $t20@1) (let ((l@@2 (|l#Vec_37831| (|p#$Mutation_490297| $t20@1))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_490297| $t20@1)) l@@2 1) (+ l@@2 1))) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@1))))) (and (= $t21@1 ($Mutation_490338 (|l#$Mutation_490338| $t21@0) (|p#$Mutation_490338| $t21@0) $t19)) (= $t20@2 ($Mutation_490297 (|l#$Mutation_490297| $t20@1) (|p#$Mutation_490297| $t20@1) ($1_ValidatorConfig_ValidatorConfig (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@1)) (|v#$Mutation_490338| $t21@1) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@1))))))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899459)) (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@2)))) 1)) (=> (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@2)))) 1) (and (=> (= (ControlFlow 0 1105547) (- 0 1899472)) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@2)))) 1)) (=> (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@2)))) 1) (=> (and (forall ((addr@@129 Int) ) (!  (=> (|$IsValid'address'| addr@@129) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@129) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@129)) 3))))
 :qid |DiemAccountbpl.11671:20|
 :skolemid |286|
)) (= $1_ValidatorConfig_ValidatorConfig_$memory@0@@2 ($Memory_469220 (|Store__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_490297| $t20@2)) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_490297| $t20@2)) (|v#$Mutation_490297| $t20@2))))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899533)) (forall ((addr@@130 Int) ) (!  (=> (|$IsValid'address'| addr@@130) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@2) addr@@130) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@130)) 3))))
 :qid |DiemAccountbpl.11682:15|
 :skolemid |287|
))) (=> (forall ((addr@@131 Int) ) (!  (=> (|$IsValid'address'| addr@@131) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@2) addr@@131) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@131)) 3))))
 :qid |DiemAccountbpl.11682:15|
 :skolemid |287|
)) (and (=> (= (ControlFlow 0 1105547) (- 0 1899561)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t7@@4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t7@@4))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899573)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t7@@4)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t7@@4)) 3))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899591)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1@@10)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1@@10))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899602)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1@@10)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1@@10))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899613)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@6))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899625)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@6)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@6)) 3))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899643)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t8@@6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t8@@6))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899655)) (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@2) $t9@@9)))) 0))) (=> (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@2) $t9@@9)))) 0)) (and (=> (= (ControlFlow 0 1105547) (- 0 1899663)) (= (let ((t_ref@@5 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@2) $t9@@9)))
(|Select__T@[Int]Int_| (|v#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@5))) 0)) _$t1@@10)) (=> (= (let ((t_ref@@6 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@2) $t9@@9)))
(|Select__T@[Int]Int_| (|v#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@6))) 0)) _$t1@@10) (=> (= (ControlFlow 0 1105547) (- 0 1899674)) (forall ((addr@@132 Int) ) (!  (=> (|$IsValid'address'| addr@@132) (=> (not (= addr@@132 $t9@@9)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@2) addr@@132))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@132))))))
 :qid |DiemAccountbpl.11736:15|
 :skolemid |288|
)))))))))))))))))))))))))))))))
(let ((anon22_Then_correct@@2 true))
(let ((L5_correct@@0  (and (=> (= (ControlFlow 0 1105027) (- 0 1899213)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t7@@4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t7@@4)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1@@10))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1@@10))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@6))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@6)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t8@@6)))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t7@@4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t7@@4)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1@@10))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1@@10))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@6))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@6)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t8@@6))) (=> (= (ControlFlow 0 1105027) (- 0 1899284)) (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t7@@4)) (= 5 $t11@0@@1)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t7@@4)) 3)) (= 3 $t11@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1@@10)) (= 7 $t11@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1@@10)) (= 5 $t11@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@6)) (= 5 $t11@0@@1))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@6)) 3)) (= 3 $t11@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t8@@6)) (= 5 $t11@0@@1))))))))
(let ((anon25_Then_correct@@1  (=> (and (and $abort_flag@0@@5 (= $abort_code@1@@5 $abort_code@1@@5)) (and (= $t11@0@@1 $abort_code@1@@5) (= (ControlFlow 0 1105561) 1105027))) L5_correct@@0)))
(let ((anon24_Then$1_correct  (=> (= $t20@1 $t20@@0) (=> (and (= $abort_flag@0@@5 true) (= $abort_code@1@@5 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1105613) 1105561) anon25_Then_correct@@1) (=> (= (ControlFlow 0 1105613) 1105547) anon25_Else_correct@@1))))))
(let ((anon24_Then_correct@@2  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t15@@1)) (= (ControlFlow 0 1105611) 1105613)) anon24_Then$1_correct)))
(let ((anon24_Else_correct@@2  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t15@@1) (=> (and (and (= $t20@0 ($Mutation_490297 ($Global $t15@@1) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t15@@1))) (= $t20@1 $t20@0)) (and (= $abort_flag@0@@5 false) (= $abort_code@1@@5 $abort_code@0@@5))) (and (=> (= (ControlFlow 0 1105256) 1105561) anon25_Then_correct@@1) (=> (= (ControlFlow 0 1105256) 1105547) anon25_Else_correct@@1))))))
(let ((anon23_Then_correct@@2  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1@@1 (=> (and (and (|$IsValid'$1_Option_Option'address''| $t19) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| $t19)) 1)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| $t19) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_37831 (|Store__T@[Int]Int_| (MapConstVec_16957 DefaultVecElem_16957) 0 _$t1@@10) 1))))) (and (=> (= (ControlFlow 0 1105234) 1105611) anon24_Then_correct@@2) (=> (= (ControlFlow 0 1105234) 1105256) anon24_Else_correct@@2))))))
(let ((anon23_Else_correct@@2  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1@@1) (= $t18@@0 $t18@@0)) (and (= $t11@0@@1 $t18@@0) (= (ControlFlow 0 1105206) 1105027))) L5_correct@@0)))
(let ((anon22_Else_correct@@2  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t18@@0) (= $t18@@0 5)) (and (= $t18@@0 $t18@@0) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1@@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1@@1))) (and (=> (= (ControlFlow 0 1105190) 1105234) anon23_Then_correct@@2) (=> (= (ControlFlow 0 1105190) 1105206) anon23_Else_correct@@2))))))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct@@1  (=> (= $t15@@1 $t15@@1) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t15@@1)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1@@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1@@1)) (and (=> (= (ControlFlow 0 1105148) 1105627) anon22_Then_correct@@2) (=> (= (ControlFlow 0 1105148) 1105190) anon22_Else_correct@@2))))))
(let ((anon21_Then_correct@@2  (=> inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1@@0 (=> (and (and (|$IsValid'address'| $t15@@1) (= $t15@@1 (|$addr#$signer| _$t0@@12))) (and (= $t15@@1 $t15@@1) (= (ControlFlow 0 1105154) 1105148))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct@@1))))
(let ((anon21_Else_correct@@2  (=> (and (and (not inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1@@0) (= $t14@@1 $t14@@1)) (and (= $t11@0@@1 $t14@@1) (= (ControlFlow 0 1104803) 1105027))) L5_correct@@0)))
(let ((anon20_Else_correct@@2  (=> (and (not false) (|$IsValid'u64'| 3)) (=> (and (and (|$IsValid'u64'| $t14@@1) (= $t14@@1 7)) (and (= $t14@@1 $t14@@1) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1@@0 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1@@0))) (and (=> (= (ControlFlow 0 1104787) 1105154) anon21_Then_correct@@2) (=> (= (ControlFlow 0 1104787) 1104803) anon21_Else_correct@@2))))))
(let ((anon19_Then_correct@@1  (=> $t10@@4 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@12))) (= 5 $t11@@4)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@12))) 3)) (= 3 $t11@@4))) (= $t11@@4 $t11@@4)) (and (= $t11@0@@1 $t11@@4) (= (ControlFlow 0 1105697) 1105027))) L5_correct@@0))))
(let ((anon20_Then_correct@@2 true))
(let ((inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct@@0  (=> (= _$t1@@10 _$t1@@10) (=> (and (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1@@10)) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1@@0 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1@@0)) (and (=> (= (ControlFlow 0 1104741) 1105641) anon20_Then_correct@@2) (=> (= (ControlFlow 0 1104741) 1104787) anon20_Else_correct@@2))))))
(let ((anon19_Else_correct@@1  (=> (and (not $t10@@4) (= (ControlFlow 0 1104747) 1104741)) inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct@@0)))
(let ((anon0$1_correct@@12  (=> (forall ((addr@@133 Int) ) (!  (=> (|$IsValid'address'| addr@@133) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@133) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@133)) 4))))
 :qid |DiemAccountbpl.11406:20|
 :skolemid |279|
)) (=> (and (forall ((addr@@134 Int) ) (!  (=> (|$IsValid'address'| addr@@134) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@134) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@134) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@134)) 3))))
 :qid |DiemAccountbpl.11410:20|
 :skolemid |280|
)) (forall ((addr@@135 Int) ) (!  (=> (|$IsValid'address'| addr@@135) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@135) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@135) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@135)) 3))))
 :qid |DiemAccountbpl.11414:20|
 :skolemid |281|
))) (=> (and (and (forall ((addr@@136 Int) ) (!  (=> (|$IsValid'address'| addr@@136) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@136) (not (= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@136)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@136) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@136)) 3))))
 :qid |DiemAccountbpl.11418:20|
 :skolemid |282|
)) (|$IsValid'address'| (|$addr#$signer| _$t0@@12))) (and (|$IsValid'address'| _$t1@@10) (forall (($a_0@@19 Int) ) (! (let (($rsc@@19 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0@@19)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@19))
 :qid |DiemAccountbpl.11427:20|
 :skolemid |283|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0@@19))
)))) (=> (and (and (and (forall (($a_0@@20 Int) ) (! (let (($rsc@@20 (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0@@20)))
(|$IsValid'$1_ValidatorOperatorConfig_ValidatorOperatorConfig'| $rsc@@20))
 :qid |DiemAccountbpl.11431:20|
 :skolemid |284|
 :pattern ( (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0@@20))
)) (forall (($a_0@@21 Int) ) (! (let (($rsc@@21 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@21)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@21) (and (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@21))) 1) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@21))) 1))))
 :qid |DiemAccountbpl.11435:20|
 :skolemid |285|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@21))
))) (and (= $t7@@4 (|$addr#$signer| _$t0@@12)) (= $t8@@6 (|$addr#$signer| _$t0@@12)))) (and (and (= $t9@@9 (|$addr#$signer| _$t0@@12)) (= _$t0@@12 _$t0@@12)) (and (= _$t1@@10 _$t1@@10) (= $t10@@4  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@12))) 3))))))) (and (=> (= (ControlFlow 0 1104636) 1105697) anon19_Then_correct@@1) (=> (= (ControlFlow 0 1104636) 1104747) anon19_Else_correct@@1))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@12  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@14 T@$1_Event_EventHandle) ) (! (let ((stream@@13 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@14)))
 (and (= (|l#Multiset_416285| stream@@13) 0) (forall ((v@@77 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@13) v@@77) 0)
 :qid |DiemAccountbpl.159:13|
 :skolemid |4|
))))
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1104344) 1104636)) anon0$1_correct@@12)))
(let ((anon0_correct@@12  (=> (= (|l#Vec_37831| (|p#$Mutation_490297| $t20@@0)) 0) (=> (and (= (|l#Vec_37831| (|p#$Mutation_490338| $t21@@0)) 0) (= (ControlFlow 0 1104354) 1104344)) inline$$InitEventStore$0$anon0_correct@@12))))
(let ((PreconditionGeneratedEntry_correct@@2  (=> (= (ControlFlow 0 1898394) 1104354) anon0_correct@@12)))
