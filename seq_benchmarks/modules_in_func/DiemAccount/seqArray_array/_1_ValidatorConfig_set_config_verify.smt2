...
(assert (not
 (=> (= (ControlFlow 0 0) 1897207) (let ((anon29_Else_correct  (=> (and (not $abort_flag@0@@4) (= |$temp_0'$1_ValidatorConfig_ValidatorConfig'@0| (|v#$Mutation_490297| $t25@1))) (=> (and (and (and (= |$temp_0'$1_ValidatorConfig_ValidatorConfig'@0| |$temp_0'$1_ValidatorConfig_ValidatorConfig'@0|) (= $t26@0 ($1_ValidatorConfig_Config _$t2@@2 _$t3 _$t4))) (and (|$IsValid'$1_Option_Option'$1_ValidatorConfig_Config''| $t27) (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t27)) 1))) (and (and (|$IsEqual'vec'$1_ValidatorConfig_Config''| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t27) (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_416371 (|Store__T@[Int]$1_ValidatorConfig_Config_| (MapConstVec_377448 DefaultVecElem_377448) 0 $t26@0) 1)))) (= $t28@0 ($Mutation_491893 (|l#$Mutation_490297| $t25@1) (let ((l@@1 (|l#Vec_37831| (|p#$Mutation_490297| $t25@1))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_490297| $t25@1)) l@@1 0) (+ l@@1 1))) (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t25@1))))) (and (= $t28@1 ($Mutation_491893 (|l#$Mutation_491893| $t28@0) (|p#$Mutation_491893| $t28@0) $t27)) (= $t25@2 ($Mutation_490297 (|l#$Mutation_490297| $t25@1) (|p#$Mutation_490297| $t25@1) ($1_ValidatorConfig_ValidatorConfig (|v#$Mutation_491893| $t28@1) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t25@1)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t25@1)))))))) (and (=> (= (ControlFlow 0 1104005) (- 0 1898172)) (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t25@2)))) 1)) (=> (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t25@2)))) 1) (and (=> (= (ControlFlow 0 1104005) (- 0 1898185)) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t25@2)))) 1)) (=> (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t25@2)))) 1) (=> (and (forall ((addr@@123 Int) ) (!  (=> (|$IsValid'address'| addr@@123) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@123) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@123)) 3))))
 :qid |DiemAccountbpl.11286:20|
 :skolemid |276|
)) (= $1_ValidatorConfig_ValidatorConfig_$memory@0@@1 ($Memory_469220 (|Store__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_490297| $t25@2)) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_490297| $t25@2)) (|v#$Mutation_490297| $t25@2))))) (and (=> (= (ControlFlow 0 1104005) (- 0 1898246)) (forall ((addr@@124 Int) ) (!  (=> (|$IsValid'address'| addr@@124) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) addr@@124) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@124)) 3))))
 :qid |DiemAccountbpl.11297:15|
 :skolemid |277|
))) (=> (forall ((addr@@125 Int) ) (!  (=> (|$IsValid'address'| addr@@125) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) addr@@125) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@125)) 3))))
 :qid |DiemAccountbpl.11297:15|
 :skolemid |277|
)) (and (=> (= (ControlFlow 0 1104005) (- 0 1898274)) (not (not (= (|$addr#$signer| _$t0@@11) (let ((t_ref (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))
(|Select__T@[Int]Int_| (|v#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref))) 0)))))) (=> (not (not (= (|$addr#$signer| _$t0@@11) (let ((t_ref@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))
(|Select__T@[Int]Int_| (|v#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0))) 0))))) (and (=> (= (ControlFlow 0 1104005) (- 0 1898290)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2))) (and (=> (= (ControlFlow 0 1104005) (- 0 1898300)) (not (not (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))) 0))))) (=> (not (not (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))) 0)))) (and (=> (= (ControlFlow 0 1104005) (- 0 1898311)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9))) (and (=> (= (ControlFlow 0 1104005) (- 0 1898322)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) _$t1@@9) (not (= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) _$t1@@9)))) 0)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) _$t1@@9) (not (= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) _$t1@@9)))) 0))) (and (=> (= (ControlFlow 0 1104005) (- 0 1898329)) (and (and (|$IsEqual'vec'$1_ValidatorConfig_Config''| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) _$t1@@9))) (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_416371 (|Store__T@[Int]$1_ValidatorConfig_Config_| (MapConstVec_377448 DefaultVecElem_377448) 0 ($1_ValidatorConfig_Config _$t2@@2 _$t3 _$t4)) 1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))))) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) _$t1@@9))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_416371 (|Store__T@[Int]$1_ValidatorConfig_Config_| (MapConstVec_377448 DefaultVecElem_377448) 0 ($1_ValidatorConfig_Config _$t2@@2 _$t3 _$t4)) 1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9))))))) (|$IsEqual'vec'u8''| (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) _$t1@@9)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_416371 (|Store__T@[Int]$1_ValidatorConfig_Config_| (MapConstVec_377448 DefaultVecElem_377448) 0 ($1_ValidatorConfig_Config _$t2@@2 _$t3 _$t4)) 1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9))))))) (=> (and (and (|$IsEqual'vec'$1_ValidatorConfig_Config''| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) _$t1@@9))) (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_416371 (|Store__T@[Int]$1_ValidatorConfig_Config_| (MapConstVec_377448 DefaultVecElem_377448) 0 ($1_ValidatorConfig_Config _$t2@@2 _$t3 _$t4)) 1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))))) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) _$t1@@9))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_416371 (|Store__T@[Int]$1_ValidatorConfig_Config_| (MapConstVec_377448 DefaultVecElem_377448) 0 ($1_ValidatorConfig_Config _$t2@@2 _$t3 _$t4)) 1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9))))))) (|$IsEqual'vec'u8''| (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) _$t1@@9)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_416371 (|Store__T@[Int]$1_ValidatorConfig_Config_| (MapConstVec_377448 DefaultVecElem_377448) 0 ($1_ValidatorConfig_Config _$t2@@2 _$t3 _$t4)) 1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))))) (=> (= (ControlFlow 0 1104005) (- 0 1898351)) (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@0) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@1) addr1@@0))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@0))))))
 :qid |DiemAccountbpl.11336:15|
 :skolemid |278|
))))))))))))))))))))))))))
(let ((anon26_Then_correct@@0 true))
(let ((anon24_Then_correct@@1 true))
(let ((L7_correct  (and (=> (= (ControlFlow 0 1103413) (- 0 1897970)) (or (or (or (not (= (|$addr#$signer| _$t0@@11) (let ((t_ref@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))
(|Select__T@[Int]Int_| (|v#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@1))) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2))) (not (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))) (=> (or (or (or (not (= (|$addr#$signer| _$t0@@11) (let ((t_ref@@2 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))
(|Select__T@[Int]Int_| (|v#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@2))) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2))) (not (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9))) (=> (= (ControlFlow 0 1103413) (- 0 1898004)) (or (or (or (and (not (= (|$addr#$signer| _$t0@@11) (let ((t_ref@@3 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))
(|Select__T@[Int]Int_| (|v#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@3))) 0)))) (= 7 $t15@0@@0)) (and (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2)) (= 7 $t15@0@@0))) (and (not (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))) 0))) (= 7 $t15@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)) (= 5 $t15@0@@0))))))))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0@@4 (= $abort_code@1@@4 $abort_code@1@@4)) (and (= $t15@0@@0 $abort_code@1@@4) (= (ControlFlow 0 1104019) 1103413))) L7_correct)))
(let ((anon28_Then$1_correct  (=> (= $t25@1 $t25@@0) (=> (and (= $abort_flag@0@@4 true) (= $abort_code@1@@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1104071) 1104019) anon29_Then_correct) (=> (= (ControlFlow 0 1104071) 1104005) anon29_Else_correct))))))
(let ((anon28_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)) (= (ControlFlow 0 1104069) 1104071)) anon28_Then$1_correct)))
(let ((anon28_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9) (=> (and (and (= $t25@0 ($Mutation_490297 ($Global _$t1@@9) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9))) (= $t25@1 $t25@0)) (and (= $abort_flag@0@@4 false) (= $abort_code@1@@4 $abort_code@0@@4))) (and (=> (= (ControlFlow 0 1103700) 1104019) anon29_Then_correct) (=> (= (ControlFlow 0 1103700) 1104005) anon29_Else_correct))))))
(let ((anon27_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0 (and (=> (= (ControlFlow 0 1103678) (- 0 1897842)) (|Select__T@[Int]Bool_| $1_ValidatorConfig_ValidatorConfig_$modifies _$t1@@9)) (=> (|Select__T@[Int]Bool_| $1_ValidatorConfig_ValidatorConfig_$modifies _$t1@@9) (and (=> (= (ControlFlow 0 1103678) 1104069) anon28_Then_correct) (=> (= (ControlFlow 0 1103678) 1103700) anon28_Else_correct)))))))
(let ((anon27_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0) (= $t24@@0 $t24@@0)) (and (= $t15@0@@0 $t24@@0) (= (ControlFlow 0 1103668) 1103413))) L7_correct)))
(let ((anon26_Else_correct@@0  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t24@@0) (= $t24@@0 5)) (and (= $t24@@0 $t24@@0) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0 inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0))) (and (=> (= (ControlFlow 0 1103652) 1103678) anon27_Then_correct) (=> (= (ControlFlow 0 1103652) 1103668) anon27_Else_correct))))))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct@@0  (=> (= _$t1@@9 _$t1@@9) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0 inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0)) (and (=> (= (ControlFlow 0 1103610) 1104085) anon26_Then_correct@@0) (=> (= (ControlFlow 0 1103610) 1103652) anon26_Else_correct@@0))))))
(let ((anon25_Then_correct@@0  (=> (and inline$$1_Signature_ed25519_validate_pubkey$0$res@1 (= (ControlFlow 0 1103616) 1103610)) inline$$1_ValidatorConfig_exists_config$0$anon0_correct@@0)))
(let ((anon25_Else_correct@@0  (=> (and (and (not inline$$1_Signature_ed25519_validate_pubkey$0$res@1) (= $t21 $t21)) (and (= $t15@0@@0 $t21) (= (ControlFlow 0 1103509) 1103413))) L7_correct)))
(let ((anon24_Else_correct@@1  (=> (and (not false) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t21) (= $t21 7)) (and (= $t21 $t21) (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 inline$$1_Signature_ed25519_validate_pubkey$0$res@1))) (and (=> (= (ControlFlow 0 1103493) 1103616) anon25_Then_correct@@0) (=> (= (ControlFlow 0 1103493) 1103509) anon25_Else_correct@@0))))))
(let ((inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct  (=> (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 ($1_Signature_$ed25519_validate_pubkey _$t2@@2)) (and (=> (= (ControlFlow 0 1103447) 1104099) anon24_Then_correct@@1) (=> (= (ControlFlow 0 1103447) 1103493) anon24_Else_correct@@1)))))
(let ((anon23_Then_correct@@1  (=> (and $t16@0 (= (ControlFlow 0 1103453) 1103447)) inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct)))
(let ((anon23_Else_correct@@1  (=> (and (and (not $t16@0) (= $t18 $t18)) (and (= $t15@0@@0 $t18) (= (ControlFlow 0 1103289) 1103413))) L7_correct)))
(let ((anon22_Else_correct@@1  (=> (not $t14@@0) (=> (and (and (and (|$IsValid'address'| $t13@@0) (= $t13@@0 (let ((t_ref@@4 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))
(|Select__T@[Int]Int_| (|v#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@4))) 0)))) (and (= $t16@0 (= $t12@@2 $t13@@0)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t18) (= $t18 7)) (and (= $t18 $t18) (= $t16@0 $t16@0)))) (and (=> (= (ControlFlow 0 1103273) 1103453) anon23_Then_correct@@1) (=> (= (ControlFlow 0 1103273) 1103289) anon23_Else_correct@@1))))))
(let ((anon22_Then_correct@@1  (=> $t14@@0 (=> (and (and (or (and (not (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))) 0))) (= 7 $t15@@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)) (= 5 $t15@@0))) (= $t15@@0 $t15@@0)) (and (= $t15@0@@0 $t15@@0) (= (ControlFlow 0 1104145) 1103413))) L7_correct))))
(let ((anon0$1_correct@@11  (=> (and (forall ((addr@@126 Int) ) (!  (=> (|$IsValid'address'| addr@@126) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@126) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@126)) 3))))
 :qid |DiemAccountbpl.10970:20|
 :skolemid |272|
)) (forall ((addr@@127 Int) ) (!  (=> (|$IsValid'address'| addr@@127) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@127) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@127)) 3))))
 :qid |DiemAccountbpl.10974:20|
 :skolemid |273|
))) (=> (and (and (and (and (forall ((addr@@128 Int) ) (!  (=> (|$IsValid'address'| addr@@128) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@128) (not (= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@128)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@128)) 3))))
 :qid |DiemAccountbpl.10978:20|
 :skolemid |274|
)) (|$IsValid'address'| (|$addr#$signer| _$t0@@11))) (and (|$IsValid'address'| _$t1@@9) (|$IsValid'vec'u8''| _$t2@@2))) (and (and (|$IsValid'vec'u8''| _$t3) (|$IsValid'vec'u8''| _$t4)) (and (forall (($a_0@@18 Int) ) (! (let (($rsc@@18 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@18)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@18) (and (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@18))) 1) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@18))) 1))))
 :qid |DiemAccountbpl.10996:20|
 :skolemid |275|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@18))
)) (|Select__T@[Int]Bool_| $1_ValidatorConfig_ValidatorConfig_$modifies _$t1@@9)))) (and (and (and (= _$t0@@11 _$t0@@11) (= _$t1@@9 _$t1@@9)) (and (= _$t2@@2 _$t2@@2) (= _$t3 _$t3))) (and (and (= _$t4 _$t4) (|$IsValid'address'| $t12@@2)) (and (= $t12@@2 (|$addr#$signer| _$t0@@11)) (= $t14@@0  (or (not (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@9)))))))) (and (=> (= (ControlFlow 0 1103215) 1104145) anon22_Then_correct@@1) (=> (= (ControlFlow 0 1103215) 1103273) anon22_Else_correct@@1))))))
(let ((inline$$InitEventStore$0$anon0_correct@@11  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@13 T@$1_Event_EventHandle) ) (! (let ((stream@@12 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@13)))
 (and (= (|l#Multiset_416285| stream@@12) 0) (forall ((v@@76 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@12) v@@76) 0)
 :qid |DiemAccountbpl.159:13|
 :skolemid |4|
))))
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1102984) 1103215)) anon0$1_correct@@11)))
(let ((anon0_correct@@11  (=> (and (and (= (|l#Vec_37831| (|p#$Mutation_490297| $t11@@3)) 0) (= (|l#Vec_37831| (|p#$Mutation_490297| $t25@@0)) 0)) (and (= (|l#Vec_37831| (|p#$Mutation_491893| $t28)) 0) (= (ControlFlow 0 1102994) 1102984))) inline$$InitEventStore$0$anon0_correct@@11)))
(let ((PreconditionGeneratedEntry_correct@@1  (=> (= (ControlFlow 0 1897207) 1102994) anon0_correct@@11)))
