...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 212119) (let ((L2_correct  (and (=> (= (ControlFlow 0 154724) (- 0 212518)) (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) _$t0)))) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) _$t0))) (=> (= (ControlFlow 0 154724) (- 0 212525)) (and (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 $t3@0)))))))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t3@0 $abort_code@1) (= (ControlFlow 0 154688) 154724))) L2_correct)))
(let ((anon9_Then_correct  (=> $t2 (=> (and (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 $t3)) (= $t3 $t3)) (and (= $t3@0 $t3) (= (ControlFlow 0 154814) 154724))) L2_correct))))
(let ((anon11_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t5@0 (|$num_children#$1_VASP_ParentVASP| $t4@1)) (= $t5@0 $t5@0)) (and (=> (= (ControlFlow 0 154674) (- 0 212437)) (not (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) _$t0))))) (=> (not (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) _$t0)))) (and (=> (= (ControlFlow 0 154674) (- 0 212449)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (= (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) a)))
 :qid |VASPbpl.9886:15|
 :skolemid |199|
 ...
 :qid |VASPbpl.9886:15|
 :skolemid |199|
)) (=> (= (ControlFlow 0 154674) (- 0 212474)) (forall ((parent Int) ) (!  (=> (|$IsValid'address'| parent) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) parent) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_119051| $1_VASP_ParentVASP_$memory) parent)) (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_119051| $1_VASP_ParentVASP_$memory) parent)))))
 :qid |VASPbpl.9891:15|
 :skolemid |200|
)))))))))))
(let ((anon10_Then$1_correct  (=> (= $t4@1 $t4) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 154776) 154688) anon11_Then_correct) (=> (= (ControlFlow 0 154776) 154674) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) $t1)) (= (ControlFlow 0 154774) 154776)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) $t1) (=> (and (and (= $t4@0 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_119051| $1_VASP_ParentVASP_$memory) $t1)) (= $t4@1 $t4@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 154580) 154688) anon11_Then_correct) (=> (= (ControlFlow 0 154580) 154674) anon11_Else_correct))))))
(let ((anon9_Else_correct  (=> (not $t2) (=> (and (|$IsValid'address'| $t1) (= $t1 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_118987| $1_VASP_ChildVASP_$memory) _$t0))))) (and (=> (= (ControlFlow 0 154566) 154774) anon10_Then_correct) (=> (= (ControlFlow 0 154566) 154580) anon10_Else_correct))))))
(let ((anon0$1_correct  (=> (and (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_118987| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |VASPbpl.9797:20|
 :skolemid |196|
)) (|$IsValid'address'| _$t0)) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_118987| $1_VASP_ChildVASP_$memory) $a_0)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc))
 :qid |VASPbpl.9803:20|
 :skolemid |197|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_118987| $1_VASP_ChildVASP_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_119051| $1_VASP_ParentVASP_$memory) $a_0@@0)))
...
))) (and (= _$t0 _$t0) (= $t2  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) _$t0)))))) (and (=> (= (ControlFlow 0 154544) 154814) anon9_Then_correct) (=> (= (ControlFlow 0 154544) 154566) anon9_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_66806_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 154419) 154544)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 212119) 154419) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
