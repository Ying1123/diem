...
(declare-fun $1_NetworkIdentity_NetworkIdentityEventHandle_$memory () T@$Memory_82712)
...
(declare-fun $1_NetworkIdentity_NetworkIdentity_$memory@2 () T@$Memory_82842)
(declare-fun |Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds| Int) T@$1_DiemTimestamp_CurrentTimeMicroseconds)
(declare-fun $1_DiemTimestamp_CurrentTimeMicroseconds_$memory () T@$Memory_69466)
(declare-fun _$t1 () (Seq (Seq Int)))
(declare-fun $1_NetworkIdentity_NetworkIdentity_$memory () T@$Memory_82842)
(declare-fun $t17 () Bool)
(declare-fun $t16 () (Seq (Seq Int)))
(declare-fun $es@1 () T@$EventStore)
(declare-fun $es () T@$EventStore)
(declare-fun |Store__T@[$EventRep]Int_| (|T@[$EventRep]Int| T@$EventRep Int) |T@[$EventRep]Int|)
(assert (forall ( ( ?x0 |T@[$EventRep]Int|) ( ?x1 T@$EventRep) ( ?x2 Int)) (! (= (|Select__T@[$EventRep]Int_| (|Store__T@[$EventRep]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[$EventRep]Int|) ( ?x1 T@$EventRep) ( ?y1 T@$EventRep) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[$EventRep]Int_| (|Store__T@[$EventRep]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[$EventRep]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun |Store__T@[$1_Event_EventHandle]Multiset_42660_| (|T@[$1_Event_EventHandle]Multiset_42660| T@$1_Event_EventHandle T@Multiset_42660) |T@[$1_Event_EventHandle]Multiset_42660|)
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_42660|) ( ?x1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_42660)) (! (= (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|Store__T@[$1_Event_EventHandle]Multiset_42660_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_42660|) ( ?x1 T@$1_Event_EventHandle) ( ?y1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_42660)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|Store__T@[$1_Event_EventHandle]Multiset_42660_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[$1_Event_EventHandle]Multiset_42660_| ?x0 ?y1))) :weight 0)))
(declare-fun $abort_flag@1 () Bool)
(declare-fun $1_NetworkIdentity_NetworkIdentity_$memory@1 () T@$Memory_82842)
(declare-fun $es@0 () T@$EventStore)
(declare-fun $t37 () Bool)
(declare-fun $t35@2 () T@$Mutation_89805)
(declare-fun $1_NetworkIdentity_NetworkIdentity_$memory@0 () T@$Memory_82842)
...
(declare-fun $t41@0 () T@$Mutation_62935)
...
(declare-fun $t19 () Int)
(declare-fun $t40@1 () T@$Mutation_89862)
(declare-fun $t40 () T@$Mutation_89862)
(declare-fun $t40@0 () T@$Mutation_89862)
(declare-fun $abort_flag@0 () Bool)
(declare-fun $abort_code@1 () Int)
(declare-fun |$temp_0'$1_NetworkIdentity_NetworkIdentity'@0| () T@$1_NetworkIdentity_NetworkIdentity)
(declare-fun $t35@1 () T@$Mutation_89805)
(declare-fun $t36@0 () T@$Mutation_57565)
(declare-fun |$temp_0'vec'vec'u8'''@0| () (Seq (Seq Int)))
(declare-fun $t38@0 () (Seq (Seq Int)))
(declare-fun $t36@1 () T@$Mutation_57565)
(declare-fun |$temp_0'vec'vec'u8'''@1| () (Seq (Seq Int)))
(declare-fun $t35 () T@$Mutation_89805)
(declare-fun $t35@0 () T@$Mutation_89805)
...
(declare-fun $t21 () Int)
(declare-fun $1_Roles_RoleId_$memory () T@$Memory_69654)
(declare-fun |Select__T@[Int]$1_Roles_RoleId_| (|T@[Int]$1_Roles_RoleId| Int) T@$1_Roles_RoleId)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory () T@$Memory_70908)
(declare-fun $1_DiemConfig_Configuration_$memory () T@$Memory_71022)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory| () T@$Memory_70941)
(declare-fun $1_DiemSystem_CapabilityHolder_$memory () T@$Memory_72153)
(declare-fun |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory| () T@$Memory_71121)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory| () T@$Memory_72490)
(declare-fun |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory| () T@$Memory_76730)
(declare-fun $1_XDX_Reserve_$memory () T@$Memory_77036)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory| () T@$Memory_72554)
(declare-fun |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory| () T@$Memory_76949)
(declare-fun |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory| () T@$Memory_77921)
(declare-fun $1_DualAttestation_Limit_$memory () T@$Memory_78164)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory| () T@$Memory_71185)
(declare-fun $1_ChainId_ChainId_$memory () T@$Memory_79234)
(declare-fun $1_AccountFreezing_FreezeEventsHolder_$memory () T@$Memory_79547)
(declare-fun $1_AccountFreezing_FreezingBit_$memory () T@$Memory_79267)
(declare-fun |Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|T@[Int]$1_AccountFreezing_FreezingBit| Int) T@$1_AccountFreezing_FreezingBit)
(declare-fun $1_DiemAccount_AccountOperationsCapability_$memory () T@$Memory_80284)
(declare-fun $1_DiemAccount_DiemWriteSetManager_$memory () T@$Memory_80677)
(declare-fun $1_DiemBlock_BlockMetadata_$memory () T@$Memory_81188)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory| () T@$Memory_71249)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory| () T@$Memory_71313)
(declare-fun $1_Signer_is_txn_signer (T@$signer) Bool)
(declare-fun $1_Signer_is_txn_signer_addr (Int) Bool)
(declare-fun $t12 () T@$Mutation_57565)
(declare-fun $t13 () T@$Mutation_89805)
(declare-fun $t36 () T@$Mutation_57565)
(declare-fun $t41 () T@$Mutation_62935)
(push 1)
(set-info :boogie-vc-id $1_NetworkIdentity_remove_identities$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 108332) (let ((L11_correct  (=> (and (= $t46 (|$identity_change_events#$1_NetworkIdentity_NetworkIdentityEventHandle| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentityEventHandle_| (|contents#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453))) (= $t47 ($1_NetworkIdentity_NetworkIdentityChangeNotification $t15 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)) (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000)))) (and (=> (= (ControlFlow 0 102845) (- 0 110627)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453))) (and (=> (= (ControlFlow 0 102845) (- 0 110637)) (not (= (seq.len _$t1) 0))) (=> (not (= (seq.len _$t1) 0)) (and (=> (= (ControlFlow 0 102845) (- 0 110649)) (not (> (seq.len _$t1) 100))) (=> (not (> (seq.len _$t1) 100)) (and (=> (= (ControlFlow 0 102845) (- 0 110661)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $t15)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $t15))) (and (=> (= (ControlFlow 0 102845) (- 0 110673)) (not (and $t17 (not (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (and $t17 (not (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 102845) (- 0 110687)) (let (($range_0 _$t1))
(forall (($i_1 Int) ) (!  (=> (and (>= $i_1 0) (< $i_1 (seq.len $range_0))) (let ((e@@8 (seq.nth $range_0 $i_1)))
 (not (exists ((i@@36 Int) ) (!  (and (and (|$IsValid'u64'| i@@36) (and (>= i@@36 0) (< i@@36 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)))))) (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)) i@@36) e@@8))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
)))))
 :qid |NetworkIdentitybpl.6866:37|
 :skolemid |250|
)))) (=> (let (($range_0@@0 _$t1))
(forall (($i_1@@0 Int) ) (!  (=> (and (>= $i_1@@0 0) (< $i_1@@0 (seq.len $range_0@@0))) (let ((e@@9 (seq.nth $range_0@@0 $i_1@@0)))
 (not (exists ((i@@37 Int) ) (!  (and (and (|$IsValid'u64'| i@@37) (and (>= i@@37 0) (< i@@37 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)))))) (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)) i@@37) e@@9))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
)))))
 :qid |NetworkIdentitybpl.6866:37|
 :skolemid |250|
))) (and (=> (= (ControlFlow 0 102845) (- 0 110725)) (let (($range_0@@1 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15))))
(forall (($i_1@@1 Int) ) (!  (=> (and (>= $i_1@@1 0) (< $i_1@@1 (seq.len $range_0@@1))) (let ((e@@10 (seq.nth $range_0@@1 $i_1@@1)))
(exists ((i@@38 Int) ) (!  (and (and (|$IsValid'u64'| i@@38) (and (>= i@@38 0) (< i@@38 (seq.len $t16)))) (= (seq.nth $t16 i@@38) e@@10))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
))))
 :qid |NetworkIdentitybpl.6872:146|
 :skolemid |251|
)))) (=> (let (($range_0@@2 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15))))
(forall (($i_1@@2 Int) ) (!  (=> (and (>= $i_1@@2 0) (< $i_1@@2 (seq.len $range_0@@2))) (let ((e@@11 (seq.nth $range_0@@2 $i_1@@2)))
(exists ((i@@39 Int) ) (!  (and (and (|$IsValid'u64'| i@@39) (and (>= i@@39 0) (< i@@39 (seq.len $t16)))) (= (seq.nth $t16 i@@39) e@@11))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
))))
 :qid |NetworkIdentitybpl.6872:146|
 :skolemid |251|
))) (and (=> (= (ControlFlow 0 102845) (- 0 110762)) (let (($range_0@@3 $t16))
(forall (($i_1@@3 Int) ) (!  (=> (and (>= $i_1@@3 0) (< $i_1@@3 (seq.len $range_0@@3))) (let ((e@@12 (seq.nth $range_0@@3 $i_1@@3)))
 (or (exists ((i@@40 Int) ) (!  (and (and (|$IsValid'u64'| i@@40) (and (>= i@@40 0) (< i@@40 (seq.len _$t1)))) (= (seq.nth _$t1 i@@40) e@@12))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
)) (exists ((i@@41 Int) ) (!  (and (and (|$IsValid'u64'| i@@41) (and (>= i@@41 0) (< i@@41 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)))))) (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)) i@@41) e@@12))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
)))))
 :qid |NetworkIdentitybpl.6878:38|
 :skolemid |252|
)))) (=> (let (($range_0@@4 $t16))
(forall (($i_1@@4 Int) ) (!  (=> (and (>= $i_1@@4 0) (< $i_1@@4 (seq.len $range_0@@4))) (let ((e@@13 (seq.nth $range_0@@4 $i_1@@4)))
 (or (exists ((i@@42 Int) ) (!  (and (and (|$IsValid'u64'| i@@42) (and (>= i@@42 0) (< i@@42 (seq.len _$t1)))) (= (seq.nth _$t1 i@@42) e@@13))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
)) (exists ((i@@43 Int) ) (!  (and (and (|$IsValid'u64'| i@@43) (and (>= i@@43 0) (< i@@43 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)))))) (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)) i@@43) e@@13))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
)))))
 :qid |NetworkIdentitybpl.6878:38|
 :skolemid |252|
))) (and (=> (= (ControlFlow 0 102845) (- 0 110806)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected (ite $t17 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| $EmptyEventStore) $t46)))
(let ((stream_new (let ((len (|l#Multiset_42660| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| stream@@0) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47))))
(Multiset_42660 (|Store__T@[$EventRep]Int_| (|v#Multiset_42660| stream@@0) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| $EmptyEventStore) $t46 stream_new)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@1 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| expected) handle@@1)) (|l#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| actual) handle@@1))) (forall ((v@@32 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| expected) handle@@1)) v@@32) (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| actual) handle@@1)) v@@32))
 :qid |NetworkIdentitybpl.139:13|
 :skolemid |3|
)))
 :qid |NetworkIdentitybpl.2388:13|
 :skolemid |65|
...
(let ((expected@@0 (ite $t17 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| $EmptyEventStore) $t46)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_42660| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| stream@@1) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47))))
(Multiset_42660 (|Store__T@[$EventRep]Int_| (|v#Multiset_42660| stream@@1) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| $EmptyEventStore) $t46 stream_new@@0)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@2 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| expected@@0) handle@@2)) (|l#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| actual@@0) handle@@2))) (forall ((v@@33 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| expected@@0) handle@@2)) v@@33) (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| actual@@0) handle@@2)) v@@33))
 :qid |NetworkIdentitybpl.139:13|
 :skolemid |3|
)))
 :qid |NetworkIdentitybpl.2388:13|
 :skolemid |65|
))))) (=> (= (ControlFlow 0 102845) (- 0 110833)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite $t17 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| $EmptyEventStore) $t46)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_42660| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| stream@@2) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47))))
(Multiset_42660 (|Store__T@[$EventRep]Int_| (|v#Multiset_42660| stream@@2) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| $EmptyEventStore) $t46 stream_new@@1)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@3 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| actual@@1) handle@@3)) (|l#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| expected@@1) handle@@3))) (forall ((v@@34 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| actual@@1) handle@@3)) v@@34) (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| expected@@1) handle@@3)) v@@34))
 :qid |NetworkIdentitybpl.139:13|
 :skolemid |3|
)))
 :qid |NetworkIdentitybpl.2388:13|
...
(let ((anon49_Else_correct  (=> (and (and (not $abort_flag@1) (= $1_NetworkIdentity_NetworkIdentity_$memory@2 $1_NetworkIdentity_NetworkIdentity_$memory@1)) (and (= $es@1 $es@0) (= (ControlFlow 0 103137) 102845))) L11_correct)))
(let ((anon45_Else_correct  (=> (not $t37) (and (=> (= (ControlFlow 0 102564) (- 0 109951)) (let (($range_0@@5 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2))))))
(let (($range_1 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2))))))
(forall (($i_2 Int) ($i_3 Int) ) (!  (=> ($InRange $range_0@@5 $i_2) (=> ($InRange $range_1 $i_3) (let ((i@@44 $i_2))
(let ((j@@8 $i_3))
 (=> (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2)) i@@44) (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2)) j@@8)) (= i@@44 j@@8))))))
 :qid |NetworkIdentitybpl.6811:223|
 :skolemid |249|
))))) (=> (let (($range_0@@6 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2))))))
(let (($range_1@@0 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2))))))
(forall (($i_2@@0 Int) ($i_3@@0 Int) ) (!  (=> ($InRange $range_0@@6 $i_2@@0) (=> ($InRange $range_1@@0 $i_3@@0) (let ((i@@45 $i_2@@0))
(let ((j@@9 $i_3@@0))
 (=> (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2)) i@@45) (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2)) j@@9)) (= i@@45 j@@9))))))
 :qid |NetworkIdentitybpl.6811:223|
 :skolemid |249|
)))) (=> (and (and (= $1_NetworkIdentity_NetworkIdentity_$memory@0 ($Memory_82842 (|Store__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) (|a#$Global| (|l#$Mutation_89805| $t35@2)) true) (|Store__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) (|a#$Global| (|l#$Mutation_89805| $t35@2)) (|v#$Mutation_89805| $t35@2)))) (= $1_NetworkIdentity_NetworkIdentity_$memory@2 $1_NetworkIdentity_NetworkIdentity_$memory@0)) (and (= $es@1 $es) (= (ControlFlow 0 102564) 102845))) L11_correct))))))
(let ((anon39_Then_correct true))
(let ((L13_correct  (and (=> (= (ControlFlow 0 101701) (- 0 110433)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)) (= (seq.len _$t1) 0)) (> (seq.len _$t1) 100)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $t15))) (and $t17 (not (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)) (= (seq.len _$t1) 0)) (> (seq.len _$t1) 100)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $t15))) (and $t17 (not (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (= (ControlFlow 0 101701) (- 0 110476)) (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)) (= 5 $t19@0)) (and (= (seq.len _$t1) 0) (= 7 $t19@0))) (and (> (seq.len _$t1) 100) (= 8 $t19@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $t15)) (= 5 $t19@0))) (and (and $t17 (not (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t19@0))))))))
(let ((anon49_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t19@0 $abort_code@2) (= (ControlFlow 0 103151) 101701))) L13_correct)))
(let ((|inline$$1_Event_emit_event'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$handle@1| (|v#$Mutation_62935| $t41@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_42660| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| stream@@3) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t45@0))))
(Multiset_42660 (|Store__T@[$EventRep]Int_| (|v#Multiset_42660| stream@@3) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t45@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 103121) 103151) anon49_Then_correct) (=> (= (ControlFlow 0 103121) 103137) anon49_Else_correct)))))
(let ((anon48_Else_correct  (=> (not $t44) (=> (and (and (|$IsValid'u64'| $t43) (= $t43 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= $t45@0 ($1_NetworkIdentity_NetworkIdentityChangeNotification $t31 $t42@0 $t43)) (= (ControlFlow 0 103127) 103121))) |inline$$1_Event_emit_event'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$anon0_correct|))))
(let ((anon48_Then_correct  (=> $t44 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t19)) (= $t19 $t19)) (and (= $t19@0 $t19) (= (ControlFlow 0 103177) 101701))) L13_correct))))
(let ((anon47_Else_correct  (=> (not $abort_flag@1) (=> (and (= $t41@0 ($Mutation_62935 (|l#$Mutation_89862| $t40@1) (seq.++ (|p#$Mutation_89862| $t40@1) (seq.unit 0)) (|$identity_change_events#$1_NetworkIdentity_NetworkIdentityEventHandle| (|v#$Mutation_89862| $t40@1)))) (= $t42@0 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2)))) (and (=> (= (ControlFlow 0 103018) (- 0 110169)) (let (($range_0@@7 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2))))))
(let (($range_1@@1 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2))))))
(forall (($i_2@@1 Int) ($i_3@@1 Int) ) (!  (=> ($InRange $range_0@@7 $i_2@@1) (=> ($InRange $range_1@@1 $i_3@@1) (let ((i@@46 $i_2@@1))
(let ((j@@10 $i_3@@1))
 (=> (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2)) i@@46) (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2)) j@@10)) (= i@@46 j@@10))))))
 :qid |NetworkIdentitybpl.6743:223|
 :skolemid |248|
))))) (=> (let (($range_0@@8 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2))))))
(let (($range_1@@2 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2))))))
(forall (($i_2@@2 Int) ($i_3@@2 Int) ) (!  (=> ($InRange $range_0@@8 $i_2@@2) (=> ($InRange $range_1@@2 $i_3@@2) (let ((i@@47 $i_2@@2))
(let ((j@@11 $i_3@@2))
 (=> (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2)) i@@47) (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@2)) j@@11)) (= i@@47 j@@11))))))
 :qid |NetworkIdentitybpl.6743:223|
 :skolemid |248|
)))) (=> (and (= $1_NetworkIdentity_NetworkIdentity_$memory@1 ($Memory_82842 (|Store__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) (|a#$Global| (|l#$Mutation_89805| $t35@2)) true) (|Store__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) (|a#$Global| (|l#$Mutation_89805| $t35@2)) (|v#$Mutation_89805| $t35@2)))) (= $t44  (not (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 103018) 103177) anon48_Then_correct) (=> (= (ControlFlow 0 103018) 103127) anon48_Else_correct)))))))))
(let ((anon47_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t19@0 $abort_code@2) (= (ControlFlow 0 103191) 101701))) L13_correct)))
(let ((anon46_Then$1_correct  (=> (= $t40@1 $t40) (=> (and (= $abort_flag@1 true) (= $abort_code@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 103243) 103191) anon47_Then_correct) (=> (= (ControlFlow 0 103243) 103018) anon47_Else_correct))))))
(let ((anon46_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)) (= (ControlFlow 0 103241) 103243)) anon46_Then$1_correct)))
(let ((anon46_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453) (=> (and (and (= $t40@0 ($Mutation_89862 ($Global 186537453) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentityEventHandle_| (|contents#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453))) (= $t40@1 $t40@0)) (and (= $abort_flag@1 $abort_flag@0) (= $abort_code@2 $abort_code@1))) (and (=> (= (ControlFlow 0 102877) 103191) anon47_Then_correct) (=> (= (ControlFlow 0 102877) 103018) anon47_Else_correct))))))
(let ((anon45_Then_correct  (=> (and $t37 (|$IsValid'address'| 186537453)) (and (=> (= (ControlFlow 0 102855) 103241) anon46_Then_correct) (=> (= (ControlFlow 0 102855) 102877) anon46_Else_correct)))))
(let ((anon44_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_NetworkIdentity_NetworkIdentity'@0| (|v#$Mutation_89805| $t35@1))) (=> (and (and (= |$temp_0'$1_NetworkIdentity_NetworkIdentity'@0| |$temp_0'$1_NetworkIdentity_NetworkIdentity'@0|) (= $t36@0 ($Mutation_57565 (|l#$Mutation_89805| $t35@1) (seq.++ (|p#$Mutation_89805| $t35@1) (seq.unit 0)) (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_89805| $t35@1))))) (and (= |$temp_0'vec'vec'u8'''@0| (|v#$Mutation_57565| $t36@0)) (= |$temp_0'vec'vec'u8'''@0| |$temp_0'vec'vec'u8'''@0|))) (and (=> (= (ControlFlow 0 102455) (- 0 109597)) (let (($range_0@@9 ($Range 0 (seq.len (|v#$Mutation_57565| $t36@0)))))
(let (($range_1@@3 ($Range 0 (seq.len (|v#$Mutation_57565| $t36@0)))))
(forall (($i_2@@3 Int) ($i_3@@3 Int) ) (!  (=> ($InRange $range_0@@9 $i_2@@3) (=> ($InRange $range_1@@3 $i_3@@3) (let ((i@@48 $i_2@@3))
(let ((j@@12 $i_3@@3))
 (=> (= (seq.nth (|v#$Mutation_57565| $t36@0) i@@48) (seq.nth (|v#$Mutation_57565| $t36@0) j@@12)) (= i@@48 j@@12))))))
 :qid |NetworkIdentitybpl.6651:127|
 :skolemid |242|
))))) (=> (let (($range_0@@10 ($Range 0 (seq.len (|v#$Mutation_57565| $t36@0)))))
(let (($range_1@@4 ($Range 0 (seq.len (|v#$Mutation_57565| $t36@0)))))
(forall (($i_2@@4 Int) ($i_3@@4 Int) ) (!  (=> ($InRange $range_0@@10 $i_2@@4) (=> ($InRange $range_1@@4 $i_3@@4) (let ((i@@49 $i_2@@4))
(let ((j@@13 $i_3@@4))
 (=> (= (seq.nth (|v#$Mutation_57565| $t36@0) i@@49) (seq.nth (|v#$Mutation_57565| $t36@0) j@@13)) (= i@@49 j@@13))))))
 :qid |NetworkIdentitybpl.6651:127|
 :skolemid |242|
)))) (=> (= $t38@0 (|v#$Mutation_57565| $t36@0)) (=> (and (= $t36@1 ($Mutation_57565 (|l#$Mutation_57565| $t36@0) (|p#$Mutation_57565| $t36@0) |$temp_0'vec'vec'u8'''@1|)) (|$IsValid'vec'vec'u8'''| (|v#$Mutation_57565| $t36@1))) (=> (and (and (and (|$IsValid'vec'vec'u8'''| (|v#$Mutation_57565| $t36@1)) (let (($range_0@@11 _$t1))
(forall (($i_1@@5 Int) ) (!  (=> (and (>= $i_1@@5 0) (< $i_1@@5 (seq.len $range_0@@11))) (let ((e@@14 (seq.nth $range_0@@11 $i_1@@5)))
 (not (exists ((i@@50 Int) ) (!  (and (and (|$IsValid'u64'| i@@50) (and (>= i@@50 0) (< i@@50 (seq.len (|v#$Mutation_57565| $t36@1))))) (= (seq.nth (|v#$Mutation_57565| $t36@1) i@@50) e@@14))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
)))))
 :qid |NetworkIdentitybpl.6672:42|
 :skolemid |243|
)))) (and (let (($range_0@@12 (|v#$Mutation_57565| $t36@1)))
(forall (($i_1@@6 Int) ) (!  (=> (and (>= $i_1@@6 0) (< $i_1@@6 (seq.len $range_0@@12))) (let ((e@@15 (seq.nth $range_0@@12 $i_1@@6)))
(exists ((i@@51 Int) ) (!  (and (and (|$IsValid'u64'| i@@51) (and (>= i@@51 0) (< i@@51 (seq.len $t38@0)))) (= (seq.nth $t38@0 i@@51) e@@15))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
))))
 :qid |NetworkIdentitybpl.6676:57|
 :skolemid |244|
))) (let (($range_0@@13 $t38@0))
(forall (($i_1@@7 Int) ) (!  (=> (and (>= $i_1@@7 0) (< $i_1@@7 (seq.len $range_0@@13))) (let ((e@@16 (seq.nth $range_0@@13 $i_1@@7)))
 (or (exists ((i@@52 Int) ) (!  (and (and (|$IsValid'u64'| i@@52) (and (>= i@@52 0) (< i@@52 (seq.len _$t1)))) (= (seq.nth _$t1 i@@52) e@@16))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
)) (exists ((i@@53 Int) ) (!  (and (and (|$IsValid'u64'| i@@53) (and (>= i@@53 0) (< i@@53 (seq.len (|v#$Mutation_57565| $t36@1))))) (= (seq.nth (|v#$Mutation_57565| $t36@1) i@@53) e@@16))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
)))))
 :qid |NetworkIdentitybpl.6680:43|
 :skolemid |245|
))))) (and (and (let (($range_0@@14 ($Range 0 (seq.len (|v#$Mutation_57565| $t36@1)))))
(let (($range_1@@5 ($Range 0 (seq.len (|v#$Mutation_57565| $t36@1)))))
(forall (($i_2@@5 Int) ($i_3@@5 Int) ) (!  (=> ($InRange $range_0@@14 $i_2@@5) (=> ($InRange $range_1@@5 $i_3@@5) (let ((i@@54 $i_2@@5))
(let ((j@@14 $i_3@@5))
 (=> (= (seq.nth (|v#$Mutation_57565| $t36@1) i@@54) (seq.nth (|v#$Mutation_57565| $t36@1) j@@14)) (= i@@54 j@@14))))))
 :qid |NetworkIdentitybpl.6684:132|
 :skolemid |246|
)))) (= $t37 (let (($range_0@@15 _$t1))
(exists (($i_1@@8 Int) ) (!  (and (and (>= $i_1@@8 0) (< $i_1@@8 (seq.len $range_0@@15))) (let ((e@@17 (seq.nth $range_0@@15 $i_1@@8)))
(exists ((i@@55 Int) ) (!  (and (and (|$IsValid'u64'| i@@55) (and (>= i@@55 0) (< i@@55 (seq.len $t38@0)))) (= (seq.nth $t38@0 i@@55) e@@17))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
))))
 :qid |NetworkIdentitybpl.6689:63|
 :skolemid |247|
))))) (and (= $t35@2 ($Mutation_89805 (|l#$Mutation_89805| $t35@1) (|p#$Mutation_89805| $t35@1) ($1_NetworkIdentity_NetworkIdentity (|v#$Mutation_57565| $t36@1)))) (= $t37 $t37)))) (and (=> (= (ControlFlow 0 102455) 102855) anon45_Then_correct) (=> (= (ControlFlow 0 102455) 102564) anon45_Else_correct)))))))))))
(let ((anon44_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t19@0 $abort_code@1) (= (ControlFlow 0 103257) 101701))) L13_correct)))
(let ((anon43_Then$1_correct  (=> (= $t35@1 $t35) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 103309) 103257) anon44_Then_correct) (=> (= (ControlFlow 0 103309) 102455) anon44_Else_correct))))))
(let ((anon43_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $t31)) (= (ControlFlow 0 103307) 103309)) anon43_Then$1_correct)))
(let ((anon43_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $t31) (=> (and (and (= $t35@0 ($Mutation_89805 ($Global $t31) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $t31))) (= $t35@1 $t35@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 102071) 103257) anon44_Then_correct) (=> (= (ControlFlow 0 102071) 102455) anon44_Else_correct))))))
(let ((anon42_Then_correct  (=> $t32@0 (and (=> (= (ControlFlow 0 102049) (- 0 109439)) (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies $t31)) (=> (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies $t31) (and (=> (= (ControlFlow 0 102049) 103307) anon43_Then_correct) (=> (= (ControlFlow 0 102049) 102071) anon43_Else_correct)))))))
(let ((anon42_Else_correct  (=> (and (and (not $t32@0) (= $t34 $t34)) (and (= $t19@0 $t34) (= (ControlFlow 0 102039) 101701))) L13_correct)))
(let ((anon41_Then_correct  (=> (and inline$$Le$0$dst@1 (|$IsValid'address'| $t31)) (=> (and (and (and (= $t31 (|$addr#$signer| _$t0)) (= $t31 $t31)) (and (= $t32@0 (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $t31)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t34) (= $t34 5)) (and (= $t34 $t34) (= $t32@0 $t32@0)))) (and (=> (= (ControlFlow 0 102023) 102049) anon42_Then_correct) (=> (= (ControlFlow 0 102023) 102039) anon42_Else_correct))))))
(let ((anon41_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= $t30 $t30)) (and (= $t19@0 $t30) (= (ControlFlow 0 101961) 101701))) L13_correct)))
(let ((anon40_Then$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t30) (= $t30 8)) (and (= $t30 $t30) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 101945) 102023) anon41_Then_correct) (=> (= (ControlFlow 0 101945) 101961) anon41_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'vec'u8''$0$l@1| 100)) (= (ControlFlow 0 101905) 101945)) anon40_Then$1_correct)))
(let ((anon40_Then_correct  (=> inline$$Gt$0$dst@1 (=> (and (|$IsValid'u64'| 100) (= (ControlFlow 0 101911) 101905)) inline$$Le$0$anon0_correct))))
(let ((anon40_Else_correct  (=> (and (and (not inline$$Gt$0$dst@1) (= $t26 $t26)) (and (= $t19@0 $t26) (= (ControlFlow 0 101855) 101701))) L13_correct)))
(let ((anon39_Else$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t26) (= $t26 7)) (and (= $t26 $t26) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 101839) 101911) anon40_Then_correct) (=> (= (ControlFlow 0 101839) 101855) anon40_Else_correct))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> |inline$$1_Vector_length'vec'u8''$0$l@1| 0)) (= (ControlFlow 0 101803) 101839)) anon39_Else$1_correct)))
(let ((anon39_Else_correct  (=> (and (and (not false) (= |inline$$1_Vector_length'vec'u8''$0$l@1| |inline$$1_Vector_length'vec'u8''$0$l@1|)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 101809) 101803))) inline$$Gt$0$anon0_correct)))
(let ((|inline$$1_Vector_length'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_length'vec'u8''$0$l@1| (seq.len _$t1)) (and (=> (= (ControlFlow 0 101735) 103323) anon39_Then_correct) (=> (= (ControlFlow 0 101735) 101809) anon39_Else_correct)))))
(let ((anon38_Then_correct  (=> (and inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1 (= (ControlFlow 0 101741) 101735)) |inline$$1_Vector_length'vec'u8''$0$anon0_correct|)))
(let ((anon38_Else_correct  (=> (and (and (not inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1) (= $t21 $t21)) (and (= $t19@0 $t21) (= (ControlFlow 0 101557) 101701))) L13_correct)))
(let ((anon37_Else_correct  (=> (and (not false) (|$IsValid'u64'| 3)) (=> (and (and (|$IsValid'u64'| $t21) (= $t21 5)) (and (= $t21 $t21) (= inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1 inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1))) (and (=> (= (ControlFlow 0 101541) 101741) anon38_Then_correct) (=> (= (ControlFlow 0 101541) 101557) anon38_Else_correct))))))
(let ((anon37_Then_correct true))
(let ((inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$anon0_correct  (=> (|$IsValid'address'| 186537453) (=> (and (= inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)) (= inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1 inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1)) (and (=> (= (ControlFlow 0 101499) 103337) anon37_Then_correct) (=> (= (ControlFlow 0 101499) 101541) anon37_Else_correct))))))
(let ((anon0$1_correct  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_69654| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_69654| $1_Roles_RoleId_$memory) 173345816)) 0)))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_69654| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_69654| $1_Roles_RoleId_$memory) 186537453)) 1))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_70908| $1_SlidingNonce_SlidingNonce_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_70908| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_71022| $1_DiemConfig_Configuration_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_70941| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_72153| $1_DiemSystem_CapabilityHolder_$memory) 173345816))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_71121| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_72490| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_76730| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816))))) (=> (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_77036| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_72554| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_76949| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_77921| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_78164| $1_DualAttestation_Limit_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_71185| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_79234| $1_ChainId_ChainId_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_79547| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79267| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_79267| $1_AccountFreezing_FreezingBit_$memory) 173345816))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79267| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_79267| $1_AccountFreezing_FreezingBit_$memory) 186537453)))))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_79547| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_80284| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_80677| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_81188| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_71249| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_71313| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'vec'vec'u8'''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |NetworkIdentitybpl.6349:20|
 :skolemid |237|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_69466| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $a_0@@0)))
 (and (|$IsValid'$1_NetworkIdentity_NetworkIdentity'| $rsc@@0) (let (($range_1@@6 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc@@0)))))
(let (($range_2 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc@@0)))))
(forall (($i_3@@6 Int) ($i_4 Int) ) (!  (=> ($InRange $range_1@@6 $i_3@@6) (=> ($InRange $range_2 $i_4) (let ((i@@56 $i_3@@6))
(let ((j@@15 $i_4))
 (=> (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc@@0) i@@56) (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc@@0) j@@15)) (= i@@56 j@@15))))))
 :qid |NetworkIdentitybpl.6354:249|
 :skolemid |238|
))))))
 :qid |NetworkIdentitybpl.6353:20|
 :skolemid |239|
 :pattern ( (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $a_0@@0))
)))) (and (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentityEventHandle_| (|contents#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) $a_0@@1)))
(|$IsValid'$1_NetworkIdentity_NetworkIdentityEventHandle'| $rsc@@1))
 :qid |NetworkIdentitybpl.6359:20|
 :skolemid |240|
 :pattern ( (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentityEventHandle_| (|contents#$Memory_82712| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) $a_0@@1))
)) (= $t15 (|$addr#$signer| _$t0))) (and (= $t16 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $t15))) (= $t17 (let (($range_0@@16 _$t1))
(exists (($i_1@@9 Int) ) (!  (and (and (>= $i_1@@9 0) (< $i_1@@9 (seq.len $range_0@@16))) (let ((e@@18 (seq.nth $range_0@@16 $i_1@@9)))
(exists ((i@@57 Int) ) (!  (and (and (|$IsValid'u64'| i@@57) (and (>= i@@57 0) (< i@@57 (seq.len $t16)))) (= (seq.nth $t16 i@@57) e@@18))
 :qid |NetworkIdentitybpl.1680:13|
 :skolemid |47|
))))
 :qid |NetworkIdentitybpl.6372:51|
 :skolemid |241|
)))))) (and (and (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies $t15) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= (ControlFlow 0 101505) 101499))))) inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_42660| stream@@4) 0) (forall ((v@@35 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| stream@@4) v@@35) 0)
 :qid |NetworkIdentitybpl.134:13|
 :skolemid |2|
))))
 :qid |NetworkIdentitybpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 100854) 101505)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (seq.len (|p#$Mutation_57565| $t12)) 0) (=> (and (= (seq.len (|p#$Mutation_89805| $t13)) 0) (= (seq.len (|p#$Mutation_89805| $t35)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_57565| $t36)) 0) (= (seq.len (|p#$Mutation_89862| $t40)) 0)) (and (= (seq.len (|p#$Mutation_62935| $t41)) 0) (= (ControlFlow 0 100864) 100854))) inline$$InitEventStore$0$anon0_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 108332) 100864) anon0_correct)))
