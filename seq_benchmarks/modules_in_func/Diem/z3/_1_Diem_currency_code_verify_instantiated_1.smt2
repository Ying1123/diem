...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1056423) (let ((L2_correct  (and (=> (= (ControlFlow 0 693306) (- 0 1057198)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (=> (= (ControlFlow 0 693306) (- 0 1057203)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t1@0)))))))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t1@0 $abort_code@1) (= (ControlFlow 0 693278) 693306))) L2_correct)))
(let ((anon9_Then_correct  (=> $t0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t1)) (= $t1 $t1)) (and (= $t1@0 $t1) (= (ControlFlow 0 693384) 693306))) L2_correct))))
(let ((anon11_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t4@0 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t3@1)) (= $t4@0 $t4@0)) (and (=> (= (ControlFlow 0 693264) (- 0 1056892)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 693264) (- 0 1056902)) (= $t4@0 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (= $t4@0 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 693264) (- 0 1056912)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 693264) (- 0 1056933)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@0))))
 :qid |Diembpl.9231:15|
 :skolemid |302|
 ...
 :qid |Diembpl.9231:15|
 :skolemid |302|
)) (and (=> (= (ControlFlow 0 693264) (- 0 1056962)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@2)))
 :qid |Diembpl.9236:15|
 :skolemid |303|
 ...
 :qid |Diembpl.9246:15|
 :skolemid |304|
)) (and (=> (= (ControlFlow 0 693264) (- 0 1057037)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307813| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_307813| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@6)))
 :qid |Diembpl.9251:15|
 :skolemid |305|
 ...
 :qid |Diembpl.9266:15|
 :skolemid |306|
)) (and (=> (= (ControlFlow 0 693264) (- 0 1057140)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308136| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_308136| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@10)))
 :qid |Diembpl.9271:15|
 :skolemid |307|
...
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 693358) 693278) anon11_Then_correct) (=> (= (ControlFlow 0 693358) 693264) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 693356) 693358)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= $t3@1 $t3@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 692942) 693278) anon11_Then_correct) (=> (= (ControlFlow 0 692942) 693264) anon11_Else_correct))))))
(let ((anon9_Else_correct  (=> (and (not $t0) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 692928) 693356) anon10_Then_correct) (=> (= (ControlFlow 0 692928) 692942) anon10_Else_correct)))))
...
)) (= $t0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 692914) 693384) anon9_Then_correct) (=> (= (ControlFlow 0 692914) 692928) anon9_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 692631) 692914)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1056423) 692631) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
