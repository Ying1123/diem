...
(assert (not
 (=> (= (ControlFlow 0 0) 1165334) (let ((anon11_Else_correct@@15  (=> (and (not $abort_flag@1@@20) (= $t16@0@@8 ($Mutation_13929 (|l#$Mutation_401271| _$t0@@37) (let ((l@@70 (|l#Vec_28308| (|p#$Mutation_401271| _$t0@@37))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_401271| _$t0@@37)) l@@70 0) (+ l@@70 1))) (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| _$t0@@37))))) (=> (and (and (= $t16@1 ($Mutation_13929 (|l#$Mutation_13929| $t16@0@@8) (|p#$Mutation_13929| $t16@0@@8) inline$$AddU64$0$dst@2@@2)) (= $t0@0@@2 ($Mutation_401271 (|l#$Mutation_401271| _$t0@@37) (|p#$Mutation_401271| _$t0@@37) (|$1_Diem_Diem'#0'| (|v#$Mutation_13929| $t16@1))))) (and (= |$temp_0'$1_Diem_Diem'#0''@1| (|v#$Mutation_401271| $t0@0@@2)) (= |$temp_0'$1_Diem_Diem'#0''@1| |$temp_0'$1_Diem_Diem'#0''@1|))) (and (=> (= (ControlFlow 0 826964) (- 0 1165926)) (not (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1@@25)) 18446744073709551615))) (=> (not (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1@@25)) 18446744073709551615)) (and (=> (= (ControlFlow 0 826964) (- 0 1165943)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| $t0@0@@2)) (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1@@25)))) (=> (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| $t0@0@@2)) (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1@@25))) (and (=> (= (ControlFlow 0 826964) (- 0 1165961)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 826964) (- 0 1165982)) (forall ((addr@@943 Int) ) (!  (=> (|$IsValid'address'| addr@@943) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@943)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@943))))
 :qid |Diembpl.27570:15|
 :skolemid |1413|
))) (=> (forall ((addr@@944 Int) ) (!  (=> (|$IsValid'address'| addr@@944) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@944)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@944))))
 :qid |Diembpl.27570:15|
 :skolemid |1413|
)) (and (=> (= (ControlFlow 0 826964) (- 0 1166011)) (forall ((addr@@945 Int) ) (!  (=> (|$IsValid'address'| addr@@945) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@945) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@945)))
 :qid |Diembpl.27575:15|
 :skolemid |1414|
))) (=> (forall ((addr@@946 Int) ) (!  (=> (|$IsValid'address'| addr@@946) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@946) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@946)))
 :qid |Diembpl.27575:15|
 :skolemid |1414|
)) (and (=> (= (ControlFlow 0 826964) (- 0 1166036)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 826964) (- 0 1166057)) (forall ((addr@@947 Int) ) (!  (=> (|$IsValid'address'| addr@@947) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@947)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@947))))
 :qid |Diembpl.27585:15|
 :skolemid |1415|
))) (=> (forall ((addr@@948 Int) ) (!  (=> (|$IsValid'address'| addr@@948) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@948)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@948))))
 :qid |Diembpl.27585:15|
 :skolemid |1415|
)) (and (=> (= (ControlFlow 0 826964) (- 0 1166086)) (forall ((addr@@949 Int) ) (!  (=> (|$IsValid'address'| addr@@949) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@949) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@949)))
 :qid |Diembpl.27590:15|
 :skolemid |1416|
))) (=> (forall ((addr@@950 Int) ) (!  (=> (|$IsValid'address'| addr@@950) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@950) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@950)))
 :qid |Diembpl.27590:15|
 :skolemid |1416|
)) (and (=> (= (ControlFlow 0 826964) (- 0 1166111)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 826964) (- 0 1166132)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 826964) (- 0 1166153)) (forall ((addr@@951 Int) ) (!  (=> (|$IsValid'address'| addr@@951) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@951) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@951))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@951))))
 :qid |Diembpl.27605:15|
 :skolemid |1417|
))) (=> (forall ((addr@@952 Int) ) (!  (=> (|$IsValid'address'| addr@@952) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@952) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@952))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@952))))
 :qid |Diembpl.27605:15|
 :skolemid |1417|
)) (and (=> (= (ControlFlow 0 826964) (- 0 1166189)) (forall ((addr@@953 Int) ) (!  (=> (|$IsValid'address'| addr@@953) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@953) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@953)))
 :qid |Diembpl.27610:15|
 :skolemid |1418|
))) (=> (forall ((addr@@954 Int) ) (!  (=> (|$IsValid'address'| addr@@954) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@954) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@954)))
 :qid |Diembpl.27610:15|
 :skolemid |1418|
...
(let ((L3_correct@@12  (and (=> (= (ControlFlow 0 826429) (- 0 1165824)) (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1@@25)) 18446744073709551615)) (=> (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1@@25)) 18446744073709551615) (=> (= (ControlFlow 0 826429) (- 0 1165836)) (and (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1@@25)) 18446744073709551615) (= 8 $t10@0@@0)))))))
(let ((anon11_Then_correct@@15  (=> (and (and $abort_flag@1@@20 (= $abort_code@2@@20 $abort_code@2@@20)) (and (= $t10@0@@0 $abort_code@2@@20) (= (ControlFlow 0 826978) 826429))) L3_correct@@12)))
(let ((inline$$AddU64$0$anon3_Then$1_correct@@2  (=> (= $abort_code@2@@20 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@20 true) (= inline$$AddU64$0$dst@2@@2 inline$$AddU64$0$dst@0@@2)) (and (=> (= (ControlFlow 0 826586) 826978) anon11_Then_correct@@15) (=> (= (ControlFlow 0 826586) 826964) anon11_Else_correct@@15))))))
(let ((inline$$AddU64$0$anon3_Then_correct@@2  (=> (and (> (+ $t14@0@@3 $t6@0@@0) $MAX_U64) (= (ControlFlow 0 826584) 826586)) inline$$AddU64$0$anon3_Then$1_correct@@2)))
(let ((inline$$AddU64$0$anon3_Else_correct@@2  (=> (>= $MAX_U64 (+ $t14@0@@3 $t6@0@@0)) (=> (and (and (= inline$$AddU64$0$dst@1@@2 (+ $t14@0@@3 $t6@0@@0)) (= $abort_code@2@@20 $abort_code@1@@29)) (and (= $abort_flag@1@@20 $abort_flag@0@@29) (= inline$$AddU64$0$dst@2@@2 inline$$AddU64$0$dst@1@@2))) (and (=> (= (ControlFlow 0 826532) 826978) anon11_Then_correct@@15) (=> (= (ControlFlow 0 826532) 826964) anon11_Else_correct@@15))))))
(let ((anon10_Then_correct@@18  (=> (and inline$$Ge$0$dst@1@@17 (= $t14@0@@3 (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| _$t0@@37)))) (and (=> (= (ControlFlow 0 826592) 826584) inline$$AddU64$0$anon3_Then_correct@@2) (=> (= (ControlFlow 0 826592) 826532) inline$$AddU64$0$anon3_Else_correct@@2)))))
(let ((anon10_Else_correct@@18  (=> (and (and (not inline$$Ge$0$dst@1@@17) (= $t13@@18 $t13@@18)) (and (= $t10@0@@0 $t13@@18) (= (ControlFlow 0 826385) 826429))) L3_correct@@12)))
(let ((anon9_Else$1_correct  (=> (|$IsValid'u64'| 7) (=> (and (and (|$IsValid'u64'| $t13@@18) (= $t13@@18 8)) (and (= $t13@@18 $t13@@18) (= inline$$Ge$0$dst@1@@17 inline$$Ge$0$dst@1@@17))) (and (=> (= (ControlFlow 0 826369) 826592) anon10_Then_correct@@18) (=> (= (ControlFlow 0 826369) 826385) anon10_Else_correct@@18))))))
(let ((inline$$Ge$0$anon0_correct@@17  (=> (and (= inline$$Ge$0$dst@1@@17 (>= inline$$Sub$0$dst@2@@17 $t6@0@@0)) (= (ControlFlow 0 826333) 826369)) anon9_Else$1_correct)))
(let ((anon9_Else_correct@@17  (=> (and (not $abort_flag@0@@29) (= (ControlFlow 0 826339) 826333)) inline$$Ge$0$anon0_correct@@17)))
(let ((anon9_Then_correct@@17  (=> (and (and $abort_flag@0@@29 (= $abort_code@1@@29 $abort_code@1@@29)) (and (= $t10@0@@0 $abort_code@1@@29) (= (ControlFlow 0 826992) 826429))) L3_correct@@12)))
(let ((inline$$Sub$0$anon3_Then$1_correct@@17  (=> (= $abort_flag@0@@29 true) (=> (and (= $abort_code@1@@29 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2@@17 inline$$Sub$0$dst@0@@17)) (and (=> (= (ControlFlow 0 826279) 826992) anon9_Then_correct@@17) (=> (= (ControlFlow 0 826279) 826339) anon9_Else_correct@@17))))))
(let ((inline$$Sub$0$anon3_Then_correct@@17  (=> (and (< 18446744073709551615 $t8@0) (= (ControlFlow 0 826277) 826279)) inline$$Sub$0$anon3_Then$1_correct@@17)))
(let ((inline$$Sub$0$anon3_Else_correct@@17  (=> (<= $t8@0 18446744073709551615) (=> (and (and (= inline$$Sub$0$dst@1@@17 (- 18446744073709551615 $t8@0)) (= $abort_flag@0@@29 false)) (and (= $abort_code@1@@29 $abort_code@0@@29) (= inline$$Sub$0$dst@2@@17 inline$$Sub$0$dst@1@@17))) (and (=> (= (ControlFlow 0 826229) 826992) anon9_Then_correct@@17) (=> (= (ControlFlow 0 826229) 826339) anon9_Else_correct@@17))))))
(let ((anon0$1_correct@@46  (=> (= (|l#$Mutation_401271| _$t0@@37) ($Param 0)) (=> (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_401271| _$t0@@37)) (|$IsValid'$1_Diem_Diem'#0''| _$t1@@25)) (=> (and (and (and (= $t5@0 (|v#$Mutation_401271| _$t0@@37)) (= |$temp_0'$1_Diem_Diem'#0''@0@@0| (|v#$Mutation_401271| _$t0@@37))) (and (= |$temp_0'$1_Diem_Diem'#0''@0@@0| |$temp_0'$1_Diem_Diem'#0''@0@@0|) (= _$t1@@25 _$t1@@25))) (and (and (= $t6@0@@0 (|$value#$1_Diem_Diem'#0'| _$t1@@25)) (= $t6@0@@0 $t6@0@@0)) (and (|$IsValid'u64'| 18446744073709551615) (= $t8@0 (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| _$t0@@37)))))) (and (=> (= (ControlFlow 0 826285) 826277) inline$$Sub$0$anon3_Then_correct@@17) (=> (= (ControlFlow 0 826285) 826229) inline$$Sub$0$anon3_Else_correct@@17)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@46  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@108 T@$1_Event_EventHandle) ) (! (let ((stream@@137 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@108)))
 (and (= (|l#Multiset_275813| stream@@137) 0) (forall ((v@@155 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@137) v@@155) 0)
 :qid |Diembpl.159:13|
 :skolemid |4|
))))
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 826058) 826285)) anon0$1_correct@@46)))
(let ((anon0_correct@@46  (=> (and (= (|l#Vec_28308| (|p#$Mutation_13929| $t16@@9)) 0) (= (ControlFlow 0 826068) 826058)) inline$$InitEventStore$0$anon0_correct@@46)))
(let ((PreconditionGeneratedEntry_correct@@9  (=> (= (ControlFlow 0 1165334) 826068) anon0_correct@@46)))
