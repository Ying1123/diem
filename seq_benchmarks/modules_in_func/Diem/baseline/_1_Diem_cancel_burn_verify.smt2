...
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@96 $i_1@@0))
 ...
 :qid |Diembpl.21995:15|
 :skolemid |1049|
)) (and (=> (= (ControlFlow 0 799170) (- 0 1143234)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@2)))
 :qid |Diembpl.22000:15|
 :skolemid |1050|
 ...
 :qid |Diembpl.22000:15|
 :skolemid |1050|
)) (and (=> (= (ControlFlow 0 799170) (- 0 1143259)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 799170) (- 0 1143279)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4))))
 :qid |Diembpl.22010:15|
 :skolemid |1051|
 ...
 :qid |Diembpl.22010:15|
 :skolemid |1051|
)) (and (=> (= (ControlFlow 0 799170) (- 0 1143308)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6)))
 :qid |Diembpl.22015:15|
 :skolemid |1052|
 ...
 :qid |Diembpl.22015:15|
 :skolemid |1052|
)) (and (=> (= (ControlFlow 0 799170) (- 0 1143333)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 799170) (- 0 1143353)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) addr@@8))))
 :qid |Diembpl.22025:15|
 :skolemid |1053|
))) (=> (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@9))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) addr@@9))))
 :qid |Diembpl.22025:15|
 :skolemid |1053|
)) (and (=> (= (ControlFlow 0 799170) (- 0 1143388)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) addr@@10)))
 :qid |Diembpl.22030:15|
 :skolemid |1054|
))) (=> (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) addr@@11)))
 :qid |Diembpl.22030:15|
 :skolemid |1054|
)) (and (=> (= (ControlFlow 0 799170) (- 0 1143412)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 799170) (- 0 1143432)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@3) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@3) (|streams#$EventStore| $es)))))
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10)) (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t12)))
(let ((stream_new (let ((len (|l#Multiset_275813| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@0) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2 $t11 _$t1)))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@0) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2 $t11 _$t1)) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t12 stream_new)))) $EmptyEventStore)))
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10)) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t12)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_275813| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@1) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2 $t11 _$t1)))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@1) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2 $t11 _$t1)) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t12 stream_new@@0)))) $EmptyEventStore)))
 ...
 :qid |Diembpl.2780:13|
 :skolemid |99|
))))) (=> (= (ControlFlow 0 799170) (- 0 1143467)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@3) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@3) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t12)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_275813| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@2) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2 $t11 _$t1)))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@2) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2 $t11 _$t1)) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t12 stream_new@@1)))) $EmptyEventStore)))
...
(let ((L3_correct  (and (=> (= (ControlFlow 0 796376) (- 0 1142782)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7) _$t2)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))) (let (($range_0@@1 ($Range 0 (|l#Vec_276448| $t8))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@97 $i_1@@1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t8) i@@97)))) _$t2))))
 :qid |Diembpl.22058:345|
 :skolemid |1055|
))))) (=> (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7) _$t2)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))) (let (($range_0@@2 ($Range 0 (|l#Vec_276448| $t8))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@98 $i_1@@2))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t8) i@@98)))) _$t2))))
 :qid |Diembpl.22058:345|
 :skolemid |1055|
)))) (=> (= (ControlFlow 0 796376) (- 0 1142858)) (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t14@0)) (and (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7) _$t2) (= 8 $t14@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t14@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)) (= 5 $t14@0))) (and (let (($range_0@@3 ($Range 0 (|l#Vec_276448| $t8))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@99 $i_1@@3))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t8) i@@99)))) _$t2))))
 :qid |Diembpl.22063:458|
 :skolemid |1056|
))) (= 1 $t14@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t14@0 $abort_code@4) (= (ControlFlow 0 799184) 796376))) L3_correct)))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$L5_correct|  (=> (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t20@1| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t20@1|) (=> (and (= $abort_flag@3 $abort_flag@2) (= |$1_Diem_CurrencyInfo'#0'_$memory@3| |$1_Diem_CurrencyInfo'#0'_$memory@2|)) (=> (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$ret0@1| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t20@1|) (= |$1_Diem_PreburnQueue'#0'_$memory@4| |$1_Diem_PreburnQueue'#0'_$memory@2|)) (and (= $abort_code@4 $abort_code@3) (= $es@3 $es@2))) (and (=> (= (ControlFlow 0 798267) 799184) anon18_Then_correct) (=> (= (ControlFlow 0 798267) 799170) anon18_Else_correct)))))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon32_Else_correct|  (=> (not $abort_flag@2) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_335624 (|Store__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3|)) (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3|)))) (= $es@2 $es@0)) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@1|) (= (ControlFlow 0 798392) 798267))) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$L5_correct|))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon31_Else_correct|  (=> (not inline$$Not$0$dst@1) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_335624 (|Store__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3|)) (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3|)))) (= $es@2 $es)) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@0|) (= (ControlFlow 0 798255) 798267))) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$L5_correct|))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$L7_correct|  (=> (and (= $abort_flag@3 true) (= |$1_Diem_CurrencyInfo'#0'_$memory@3| |$1_Diem_CurrencyInfo'#0'_$memory|)) (=> (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$ret0@1| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$ret0@0|) (= |$1_Diem_PreburnQueue'#0'_$memory@4| |$1_Diem_PreburnQueue'#0'_$memory@3|)) (and (= $abort_code@4 |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@1|) (= $es@3 $es@1))) (and (=> (= (ControlFlow 0 798002) 799184) anon18_Then_correct) (=> (= (ControlFlow 0 798002) 799170) anon18_Else_correct))))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon32_Then_correct|  (=> (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (=> (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@1| $abort_code@3) (= $es@1 $es@0)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2|) (= (ControlFlow 0 798406) 798002))) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$L7_correct|))))
(let ((|inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$handle@1| (|v#$Mutation_306796| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t34@1|)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_275813| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@3) (|$ToEventRep'$1_Diem_CancelBurnEvent'| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t35@1|))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@3) (|$ToEventRep'$1_Diem_CancelBurnEvent'| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t35@1|) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 798364) 798406) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon32_Then_correct|) (=> (= (ControlFlow 0 798364) 798392) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon32_Else_correct|)))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon31_Then_correct|  (=> (and (and inline$$Not$0$dst@1 (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t34@1| ($Mutation_306796 (|l#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3|) (let ((l (|l#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3|))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3|)) l 11) (+ l 1))) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3|))))) (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t35@1| ($1_Diem_CancelBurnEvent _$t2 |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t21@0| _$t1)) (= (ControlFlow 0 798370) 798364))) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t32@1|)) (and (=> (= (ControlFlow 0 798227) 798370) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon31_Then_correct|) (=> (= (ControlFlow 0 798227) 798255) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon31_Else_correct|)))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon30_Else_correct|  (=> (and (not $abort_flag@2) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t31@1| ($Mutation_13929 (|l#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|) (let ((l@@0 (|l#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) l@@0 1) (+ l@@0 1))) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|))))) (=> (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t31@2| ($Mutation_13929 (|l#$Mutation_13929| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t31@1|) (|p#$Mutation_13929| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t31@1|) inline$$Sub$0$dst@2)) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3| ($Mutation_401221 (|l#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|) (|p#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (|v#$Mutation_13929| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t31@2|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)))))) (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t32@1| (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3|))) (= (ControlFlow 0 798233) 798227))) inline$$Not$0$anon0_correct))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon30_Then_correct|  (=> (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (=> (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@1| $abort_code@3) (= $es@1 $es)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2|) (= (ControlFlow 0 798420) 798002))) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$L7_correct|))))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 798143) 798420) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon30_Then_correct|) (=> (= (ControlFlow 0 798143) 798233) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon30_Else_correct|))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t29@1| _$t2) (= (ControlFlow 0 798141) 798143)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= _$t2 |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t29@1|) (=> (and (and (= inline$$Sub$0$dst@1 (- |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t29@1| _$t2)) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 798093) 798420) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon30_Then_correct|) (=> (= (ControlFlow 0 798093) 798233) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon30_Else_correct|))))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon29_Then_correct|  (=> (and inline$$Ge$0$dst@1 (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t29@1| (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)))) (and (=> (= (ControlFlow 0 798149) 798141) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 798149) 798093) inline$$Sub$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon29_Else_correct|  (=> (and (not inline$$Ge$0$dst@1) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t28@0| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t28@0|)) (=> (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@1| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t28@0|) (= $es@1 $es)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2|) (= (ControlFlow 0 797996) 798002))) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$L7_correct|))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon28_Else$1_correct|  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t28@0|) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t28@0| 8)) (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t28@0| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t28@0|) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 797980) 798149) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon29_Then_correct|) (=> (= (ControlFlow 0 797980) 797996) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon29_Else_correct|))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t25@1| _$t2)) (= (ControlFlow 0 797944) 797980)) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon28_Else$1_correct|)))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon28_Else_correct|  (=> (not $abort_flag@1) (=> (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|)) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1|)) (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t25@1| (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2|))) (= (ControlFlow 0 797950) 797944))) inline$$Ge$0$anon0_correct))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon28_Then_correct|  (=> (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (=> (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@1| $abort_code@2) (= $es@1 $es)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2|) (= (ControlFlow 0 798434) 798002))) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$L7_correct|))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon27_Then$1_correct|  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@0|)) (and (=> (= (ControlFlow 0 798486) 798434) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon28_Then_correct|) (=> (= (ControlFlow 0 798486) 797950) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon28_Else_correct|))))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon27_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 798484) 798486)) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon27_Then$1_correct|)))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon27_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@1| ($Mutation_401221 ($Global 173345816) (Vec_28308 (MapConstVec_13534 DefaultVecElem_13534) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@1|))) (and (=> (= (ControlFlow 0 797878) 798434) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon28_Then_correct|) (=> (= (ControlFlow 0 797878) 797950) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon28_Else_correct|))))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon26_Else_correct|  (=> (not |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t22@0|) (=> (and (and (|$IsValid'vec'u8''| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t21@0|) (|$IsEqual'vec'u8''| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t21@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t21@0| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t21@0|) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 797856) 798484) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon27_Then_correct|) (=> (= (ControlFlow 0 797856) 797878) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon27_Else_correct|))))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon26_Then_correct|  (=> |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t22@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@0|)) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@0| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@0|)) (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@1| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@0|) (= $es@1 $es)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2|) (= (ControlFlow 0 798512) 798002)))) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$L7_correct|))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon5_correct|  (=> (and (and (and (|$IsValid'$1_Diem_PreburnWithMetadata'#0''| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t15@0|) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t1))) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t15@0|))) _$t2) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t18@1| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t15@0|)))) (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t19@1| (|$metadata#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t15@0|)) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t20@1| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t18@1|))) (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t20@1| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t20@1|) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t22@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 797824) 798512) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon26_Then_correct|) (=> (= (ControlFlow 0 797824) 797856) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon26_Else_correct|)))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon25_Else_correct|  (=> (and (and (not |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$temp_0'bool'@1|) (= |$1_Diem_PreburnQueue'#0'_$memory@1| ($Memory_316949 (|Store__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1 false) (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@1|) (= (ControlFlow 0 797762) 797824))) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon5_correct|)))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon25_Then_correct|  (=> (and (and |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$temp_0'bool'@1| (= |$1_Diem_PreburnQueue'#0'_$memory@0| ($Memory_316949 (|Store__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1 true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1 |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$temp_0'$1_Diem_PreburnQueue'#0''@1|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@0|) (= (ControlFlow 0 798524) 797824))) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon5_correct|)))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon24_Else_correct|  (=> (not |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t16@0|) (and (=> (= (ControlFlow 0 797750) 798524) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon25_Then_correct|) (=> (= (ControlFlow 0 797750) 797762) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon25_Else_correct|)))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon24_Then_correct|  (=> |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t16@0| (=> (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)) (= 5 |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@0|)) (and (let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$$range_0| ($Range 0 (|l#Vec_276448| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t14@0|))))
(forall ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$$i_1| Int) ) (!  (=> ($InRange |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$range_0| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$i_1|) (let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$i| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$i_1|))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t14@0|) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$i|)))) _$t2))))
 :qid |unknown.0:0|
 :skolemid |1130|
))) (= 1 |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@0|))) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@0| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@0|)) (=> (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@1| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t17@0|) (= $es@1 $es)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory|) (= (ControlFlow 0 798605) 798002))) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$L7_correct|)))))
(let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon0_correct|  (=> (= (|l#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t6@0|)) 0) (=> (and (= (|l#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@0|)) 0) (= (|l#Vec_28308| (|p#$Mutation_13929| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t31@0|)) 0)) (=> (and (and (= (|l#Vec_28308| (|p#$Mutation_306796| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t34@0|)) 0) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t8@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t9@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t10@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (and (and (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t12@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t13@0| (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t11@0|)) (= _$t1 _$t1))) (and (and (= $t19@1 $t19@1) (= _$t2 _$t2)) (and (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t14@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))) (= |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t16@0|  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)) (let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$$range_0@@0| ($Range 0 (|l#Vec_276448| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t14@0|))))
(forall ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$$i_1@@0| Int) ) (!  (=> ($InRange |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$range_0@@0| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$i_1@@0|) (let ((|inline$$1_Diem_cancel_burn_with_capability'#0'$0$i@@0| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$i_1@@0|))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t14@0|) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$i@@0|)))) _$t2))))
 :qid |unknown.0:0|
 :skolemid |1129|
)))))))) (and (=> (= (ControlFlow 0 797742) 798605) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon24_Then_correct|) (=> (= (ControlFlow 0 797742) 797750) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon24_Else_correct|))))))))
(let ((anon17_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t20 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t21 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)))) (=> (and (and (= $t22 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t23 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t24 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t25 (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t23)))) (and (=> (= (ControlFlow 0 798611) (- 0 1141575)) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t1)) (=> (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t1) (and (=> (= (ControlFlow 0 798611) (- 0 1141580)) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (=> (= (ControlFlow 0 798611) 797742) |inline$$1_Diem_cancel_burn_with_capability'#0'$0$anon0_correct|))))))))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 799198) 796376))) L3_correct)))
(let ((anon16_Then$1_correct  (=> (= $t19@1 $t19) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 799250) 799198) anon17_Then_correct) (=> (= (ControlFlow 0 799250) 798611) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t15)) (= (ControlFlow 0 799248) 799250)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t15) (=> (and (and (= $t19@0 (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t15)) (= $t19@1 $t19@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 796396) 799198) anon17_Then_correct) (=> (= (ControlFlow 0 796396) 798611) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t16@0 (and (=> (= (ControlFlow 0 796382) 799248) anon16_Then_correct) (=> (= (ControlFlow 0 796382) 796396) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not $t16@0) (= $t18 $t18)) (and (= $t14@0 $t18) (= (ControlFlow 0 796162) 796376))) L3_correct)))
(let ((anon14_Else_correct  (=> (and (not $t13) (|$IsValid'address'| $t15)) (=> (and (and (and (= $t15 (|$addr#$signer| _$t0)) (= $t15 $t15)) (and (= $t16@0 (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t15)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t18) (= $t18 4)) (and (= $t18 $t18) (= $t16@0 $t16@0)))) (and (=> (= (ControlFlow 0 796146) 796382) anon15_Then_correct) (=> (= (ControlFlow 0 796146) 796162) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> $t13 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t14)) (= $t14 $t14)) (and (= $t14@0 $t14) (= (ControlFlow 0 799276) 796376))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 ...
 :qid |Diembpl.21675:433|
 :skolemid |1043|
))) (|$IsValid'address'| (|$addr#$signer| _$t0))) (and (|$IsValid'address'| _$t1) (|$IsValid'u64'| _$t2))) (and (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $a_0)))
(|$IsValid'$1_Diem_BurnCapability'#0''| $rsc))
 :qid |Diembpl.21688:20|
 :skolemid |1044|
 :pattern ( (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@0)))
 ...
 :qid |Diembpl.21692:20|
 :skolemid |1045|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@1)))
 (and (|$IsValid'$1_Diem_PreburnQueue'#0''| $rsc@@1) (and (<= (|l#Vec_276448| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@1)) 256) (let (($range_1 ($Range 0 (|l#Vec_276448| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@1)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@100 $i_2))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@1)) i@@100)))) 0)))
 :qid |Diembpl.21697:199|
 :skolemid |1046|
))))))
 :qid |Diembpl.21696:20|
 :skolemid |1047|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@1))
)) (= $t6 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (and (= $t7 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t8 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)))) (and (= $t9 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t10 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= $t11 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t12 (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10))) (and (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t1) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= _$t2 _$t2) (= $t13  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))))) (and (=> (= (ControlFlow 0 796084) 799276) anon14_Then_correct) (=> (= (ControlFlow 0 796084) 796146) anon14_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 795196) 796084)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1140213) 795196) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
