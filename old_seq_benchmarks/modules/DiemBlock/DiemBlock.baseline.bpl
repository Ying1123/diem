...
procedure {:timeLimit 40} $1_DiemTimestamp_update_global_time$verify(_$t0: int, _$t1: int, _$t2: int) returns ()
{
    ...
    // @105 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:9+52
...
L7:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@105]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
...
L8:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_operating[@105]()), Neq<address>(Signer::spec_address_of[]($t0), 0)), (if Eq<address>($t1, 0) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}})) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:74:5+745
    assume {:print "$at(17,3378,4123)"} true;
    assert {:msg "assert_failed(17,3378,4123): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#105) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 0)) || if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)));

    // assert Or(Or(And(Not(DiemTimestamp::$is_operating[@105]()), Eq(1, $t11)), And(Neq<address>(Signer::spec_address_of[]($t0), 0), Eq(2, $t11))), And((if Eq<address>($t1, 0) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}}), Eq(7, $t11))) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:74:5+745
    assert {:msg "assert_failed(17,3378,4123): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#105) && $IsEqual'num'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 0) && $IsEqual'num'(2, $t11))) || (if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'num'(7, $t11)));
...
L8:
    ...
    // @140 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@140](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
...
L7:
    ...
    // @174 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@174](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
...
L6:
    ...
    // @146 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@146](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
...
L7:
    ...
    // @164 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@164](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
...
procedure {:timeLimit 40} $1_DiemBlock_block_prologue$verify(_$t0: int, _$t1: int, _$t2: int, _$t3: Vec (int), _$t4: int) returns ()
{
    ...
    // @175 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1
    ...
    // @176 := save_mem(DiemConfig::DiemConfig<DiemSystem::DiemSystem>) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1
    $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#176 := $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory;

    // @177 := save_mem(DiemBlock::BlockMetadata) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1
...
L0:
    ...
    // $t8 := $t16 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:74:13+61
    $t8 := $t16;

    // trace_local[tmp#$8]($t16) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:74:13+61
...
L12:
    ...
    // $t8 := $t17 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:74:13+61
    $t8 := $t17;

    // trace_local[tmp#$8]($t17) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:74:13+61
...
L3:
    ...
    // trace_local[tmp#$7]($t20) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:73:9+147
    assume {:print "$at(12,2624,2771)"} true;
    assume {:print "$track_local(31,0,7):", $t20} $t20 == $t20;

    // trace_local[tmp#$6]($t8) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:73:9+147
    assume {:print "$track_local(31,0,6):", $t8} $t8 == $t8;

    // if ($t8) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:73:9+147
...
L6:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@175]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
    assume {:print "$at(17,6375,6428)"} true;
    assert {:msg "assert_failed(17,6375,6428): function does not abort under this condition"}
    ...
    // assert Not(And(Neq<address>($t4, 0), Not(DiemSystem::spec_is_validator[@176]($t4)))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:94:9+120
    assume {:print "$at(12,3422,3542)"} true;
    assert {:msg "assert_failed(12,3422,3542): function does not abort under this condition"}
      !(!$IsEqual'address'($t4, 0) && !$1_DiemSystem_spec_is_validator($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#176, $t4));

    // assert Not(Gt(Add(DiemBlock::$get_current_block_height[@177](), 1), 18446744073709551615)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:99:9+74
    ...
    // assert Eq<u64>(DiemBlock::$get_current_block_height(), Add(DiemBlock::$get_current_block_height[@177](), 1)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:97:9+74
...
L7:
    ...
    // assert Or(Or(Or(Not(DiemTimestamp::$is_operating[@175]()), Neq<address>(Signer::spec_address_of[]($t0), 0)), And(Neq<address>($t4, 0), Not(DiemSystem::spec_is_validator[@176]($t4)))), Gt(Add(DiemBlock::$get_current_block_height[@177](), 1), 18446744073709551615)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:91:5+540
    assume {:print "$at(12,3280,3820)"} true;
    assert {:msg "assert_failed(12,3280,3820): abort not covered by any of the `aborts_if` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#175) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 0)) || (!$IsEqual'address'($t4, 0) && !$1_DiemSystem_spec_is_validator($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#176, $t4))) || (($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory#177) + 1) > 18446744073709551615));

    // assert Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@175]()), Eq(1, $t12)), And(Neq<address>(Signer::spec_address_of[]($t0), 0), Eq(2, $t12))), And(And(Neq<address>($t4, 0), Not(DiemSystem::spec_is_validator[@176]($t4))), Eq(2, $t12))), And(Gt(Add(DiemBlock::$get_current_block_height[@177](), 1), 18446744073709551615), Eq(-1, $t12))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:91:5+540
    assert {:msg "assert_failed(12,3280,3820): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#175) && $IsEqual'num'(1, $t12)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 0) && $IsEqual'num'(2, $t12))) || ((!$IsEqual'address'($t4, 0) && !$1_DiemSystem_spec_is_validator($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#176, $t4)) && $IsEqual'num'(2, $t12))) || ((($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory#177) + 1) > 18446744073709551615) && $IsEqual'num'(-1, $t12)));
...
procedure {:timeLimit 40} $1_DiemBlock_initialize_block_metadata$verify(_$t0: int) returns ()
{
    ...
    // @129 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+1
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#129 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @130 := save_mem(DiemBlock::BlockMetadata) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+1
...
L2:
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@129]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:140:9+51
    ...
    // assert Not(DiemBlock::$is_initialized[@130]()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:49:9+58
...
L3:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_genesis[@129]()), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), DiemBlock::$is_initialized[@130]()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:46:5+291
    assume {:print "$at(12,1666,1957)"} true;
    assert {:msg "assert_failed(12,1666,1957): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#129) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || $1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory#130));

    // assert Or(Or(And(Not(DiemTimestamp::$is_genesis[@129]()), Eq(1, $t4)), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t4))), And(DiemBlock::$is_initialized[@130](), Eq(6, $t4))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:46:5+291
    assert {:msg "assert_failed(12,1666,1957): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#129) && $IsEqual'num'(1, $t4)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t4))) || ($1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory#130) && $IsEqual'num'(6, $t4)));
...
L7:
    ...
    // @158 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@158](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
...
L7:
    ...
    // @152 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@152](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
