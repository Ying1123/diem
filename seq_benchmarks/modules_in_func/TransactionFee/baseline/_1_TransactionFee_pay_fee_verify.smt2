...
(declare-fun $t11 () T@$Mutation_180775)
(declare-fun $t11@0 () T@$Mutation_180775)
...
(declare-fun $t3 () T@$Mutation_180775)
(declare-fun $t12 () T@$Mutation_153628)
(push 1)
(set-info :boogie-vc-id $1_TransactionFee_pay_fee$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 354518) (let ((anon22_Else_correct  (=> (not $t14) (=> (and (= $t12@1 ($Mutation_153628 (|l#$Mutation_153628| $t12@0) (|p#$Mutation_153628| $t12@0) |$temp_0'$1_Diem_Diem'#0''@0|)) (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_153628| $t12@1))) (=> (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_153628| $t12@1)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_153628| $t12@1)) (+ (|$value#$1_Diem_Diem'#0'| $t13@0) (|$value#$1_Diem_Diem'#0'| _$t0)))) (and (= $t11@2 ($Mutation_180775 (|l#$Mutation_180775| $t11@1) (|p#$Mutation_180775| $t11@1) (|$1_TransactionFee_TransactionFee'#0'| (|v#$Mutation_153628| $t12@1) (|$preburn#$1_TransactionFee_TransactionFee'#0'| (|v#$Mutation_180775| $t11@1))))) (= |$1_TransactionFee_TransactionFee'#0'_$memory@0| ($Memory_173582 (|Store__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|a#$Global| (|l#$Mutation_180775| $t11@2)) true) (|Store__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|a#$Global| (|l#$Mutation_180775| $t11@2)) (|v#$Mutation_180775| $t11@2)))))) (and (=> (= (ControlFlow 0 267142) (- 0 355294)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_130984| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_130984| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)) (=> (= $t15 (|$balance#$1_TransactionFee_TransactionFee'#0'| (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory@0|) 186537453))) (and (=> (= (ControlFlow 0 267142) (- 0 355322)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 267142) (- 0 355332)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (and (=> (= (ControlFlow 0 267142) (- 0 355342)) (not (> (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615))) (=> (not (> (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615)) (=> (= (ControlFlow 0 267142) (- 0 355360)) (= (|$value#$1_Diem_Diem'#0'| $t15) (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 266904) (- 0 355136)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (> (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (> (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615)) (=> (= (ControlFlow 0 266904) (- 0 355163)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= 5 $t6@0))) (and (> (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615) (= 8 $t6@0))))))))
(let ((anon22_Then_correct  (=> $t14 (=> (and (and (and (> (+ (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_153628| $t12@0)) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615) (= 8 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 267178) 266904))) L3_correct))))
(let ((anon21_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_TransactionFee_TransactionFee'#0''@0| (|v#$Mutation_180775| $t11@1))) (=> (and (and (= |$temp_0'$1_TransactionFee_TransactionFee'#0''@0| |$temp_0'$1_TransactionFee_TransactionFee'#0''@0|) (= $t12@0 ($Mutation_153628 (|l#$Mutation_180775| $t11@1) (let ((l (|l#Vec_21840| (|p#$Mutation_180775| $t11@1))))
(Vec_21840 (|Store__T@[Int]Int_| (|v#Vec_21840| (|p#$Mutation_180775| $t11@1)) l 0) (+ l 1))) (|$balance#$1_TransactionFee_TransactionFee'#0'| (|v#$Mutation_180775| $t11@1))))) (and (= $t13@0 (|v#$Mutation_153628| $t12@0)) (= $t14 (> (+ (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_153628| $t12@0)) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615)))) (and (=> (= (ControlFlow 0 266992) 267178) anon22_Then_correct) (=> (= (ControlFlow 0 266992) 267142) anon22_Else_correct))))))
(let ((anon21_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 267192) 266904))) L3_correct)))
(let ((anon20_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 267244) 267192) anon21_Then_correct) (=> (= (ControlFlow 0 267244) 266992) anon21_Else_correct))))))
(let ((anon20_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= (ControlFlow 0 267242) 267244)) anon20_Then$1_correct)))
(let ((anon20_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453) (=> (and (and (= $t11@0 ($Mutation_180775 ($Global 186537453) (Vec_21840 (MapConstVec_13534 DefaultVecElem_13534) 0) (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 266936) 267192) anon21_Then_correct) (=> (= (ControlFlow 0 266936) 266992) anon21_Else_correct))))))
(let ((anon19_Then_correct  (=> (and |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (|$IsValid'address'| 186537453)) (and (=> (= (ControlFlow 0 266914) 267242) anon20_Then_correct) (=> (= (ControlFlow 0 266914) 266936) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (and (not |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|) (= $t9 $t9)) (and (= $t6@0 $t9) (= (ControlFlow 0 266812) 266904))) L3_correct)))
(let ((anon18_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 266796) 266914) anon19_Then_correct) (=> (= (ControlFlow 0 266796) 266812) anon19_Else_correct))))))
(let ((anon17_Then_correct  (=> $t5 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 267284) 266904))) L3_correct))))
(let ((anon18_Then_correct true))
(let ((|inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 186537453) (=> (and (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 266754) 267258) anon18_Then_correct) (=> (= (ControlFlow 0 266754) 266796) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (not $t5) (= (ControlFlow 0 266760) 266754)) |inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|)))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_133438| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_133048| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138932| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_168726| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_171620| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138996| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_168945| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_130984| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (and (|$IsValid'$1_Diem_Diem'#0''| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |TransactionFeebpl.18551:20|
 :skolemid |338|
...
)))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@0)))
(|$IsValid'$1_TransactionFee_TransactionFee'#0''| $rsc@@0))
 :qid |TransactionFeebpl.18555:20|
 :skolemid |339|
 :pattern ( (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@0))
)) (= $t4 (|$balance#$1_TransactionFee_TransactionFee'#0'| (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (and (= _$t0 _$t0) (= $t5  (not (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 266667) 267284) anon17_Then_correct) (=> (= (ControlFlow 0 266667) 266760) anon17_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_91738_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |TransactionFeebpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 266473) 266667)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_21840| (|p#$Mutation_180775| $t3)) 0) (= (|l#Vec_21840| (|p#$Mutation_180775| $t11)) 0)) (and (= (|l#Vec_21840| (|p#$Mutation_153628| $t12)) 0) (= (ControlFlow 0 266483) 266473))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 354518) 266483) anon0_correct)))
