...
L2:
    ...
    // trace_local[account#1793]($t17) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:957:13+7
...
// fun DiemConsensusConfig::initialize [verification] at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:5+196
procedure {:timeLimit 40} $1_DiemConsensusConfig_initialize$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: int;
    var $t2: int;
    ...
    var $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#146: $Memory $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig';
    var $1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#147: $Memory $1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig';
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:5+196
    assume {:print "$at(14,465,661)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:5+196
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:5+196
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:5+196
    ...
    // @145 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:5+1
    assume {:print "$at(14,465,466)"} true;
    $1_Roles_RoleId_$memory#145 := $1_Roles_RoleId_$memory;

    // @148 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:5+1
    $1_DiemConfig_Configuration_$memory#148 := $1_DiemConfig_Configuration_$memory;

    // @146 := save_mem(DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:5+1
    $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#146 := $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory;

    // @147 := save_mem(DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:5+1
    $1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#147 := $1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory;
...
L5:
    ...
    // @149 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@149](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:9+91
...
L1:
    ...
    // assert Not(DiemConfig::spec_is_published[@146]<DiemConsensusConfig::DiemConsensusConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:260:9+38
    assume {:print "$at(13,11170,11208)"} true;
    assert {:msg "assert_failed(13,11170,11208): function does not abort under this condition"}
      !$1_DiemConfig_spec_is_published'$1_DiemConsensusConfig_DiemConsensusConfig'($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#146);

    // assert Not(exists[@147]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:261:9+86
    assume {:print "$at(13,11217,11303)"} true;
    assert {:msg "assert_failed(13,11217,11303): function does not abort under this condition"}
      !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#147, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@145]<Roles::RoleId>($t2))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#145, $t2);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t2)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
    ...
    // assert exists<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:267:9+84
    ...
    // assert DiemConfig::spec_is_published<DiemConsensusConfig::DiemConsensusConfig>() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:145:9+36
    ...
    // assert Eq<DiemConsensusConfig::DiemConsensusConfig>(DiemConfig::$get<DiemConsensusConfig::DiemConsensusConfig>(), pack DiemConsensusConfig::DiemConsensusConfig(Vector::$empty<u8>())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:146:9+33
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@148](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:147:9+52
    assume {:print "$at(13,5905,5957)"} true;
    assert {:msg "assert_failed(13,5905,5957): post-condition does not hold"}
      $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#148), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assert Implies(DiemConfig::spec_is_published[@146]<DiemConsensusConfig::DiemConsensusConfig>(), Eq<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(global<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS()), global[@146]<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:59:9+258
    assume {:print "$at(14,2128,2386)"} true;
    assert {:msg "assert_failed(14,2128,2386): post-condition does not hold"}
      ($1_DiemConfig_spec_is_published'$1_DiemConsensusConfig_DiemConsensusConfig'($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#146) ==> $IsEqual'$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig''($ResourceValue($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()), $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#146, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())));

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:59:9+258
    return;
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Not(exists[@145]<Roles::RoleId>($t1)), Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t1)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), DiemConfig::spec_is_published[@146]<DiemConsensusConfig::DiemConsensusConfig>()), exists[@147]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0))), Not(exists[@145]<Roles::RoleId>($t2))), Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t2)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:20:5+408
    assume {:print "$at(14,666,1074)"} true;
    assert {:msg "assert_failed(14,666,1074): abort not covered by any of the `aborts_if` clauses"}
      (((((((!$ResourceExists($1_Roles_RoleId_$memory#145, $t1) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t1)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || $1_DiemConfig_spec_is_published'$1_DiemConsensusConfig_DiemConsensusConfig'($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#146)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#147, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#145, $t2)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t2)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assert Or(Or(Or(Or(Or(Or(Or(And(Not(exists[@145]<Roles::RoleId>($t1)), Eq(5, $t5)), And(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t1)), 0), Eq(3, $t5))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t5))), DiemConfig::spec_is_published[@146]<DiemConsensusConfig::DiemConsensusConfig>()), exists[@147]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0))), And(Not(exists[@145]<Roles::RoleId>($t2)), Eq(5, $t5))), And(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t2)), 0), Eq(3, $t5))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t5))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:20:5+408
    assert {:msg "assert_failed(14,666,1074): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((!$ResourceExists($1_Roles_RoleId_$memory#145, $t1) && $IsEqual'u8'(5, $t5)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t1)), 0) && $IsEqual'u8'(3, $t5))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t5))) || $1_DiemConfig_spec_is_published'$1_DiemConsensusConfig_DiemConsensusConfig'($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#146)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#147, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory#145, $t2) && $IsEqual'u8'(5, $t5))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t2)), 0) && $IsEqual'u8'(3, $t5))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t5)));

    // abort($t5) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:20:5+408
    $abort_code := $t5;
    $abort_flag := true;
    return;
...
// fun DiemConsensusConfig::set [verification] at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
procedure {:timeLimit 40} $1_DiemConsensusConfig_set$verify(_$t0: int, _$t1: Vec (int)) returns ()
{
    // declare local variables
    var $t2: int;
    ...
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#164: $Memory $1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig';
    var $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#165: $Memory $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig';
    var $1_DiemConfig_DisableReconfiguration_$memory#166: $Memory $1_DiemConfig_DisableReconfiguration;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(14,1127,1383)"} true;
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
    ...
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
    assume $IsValid'vec'u8''($t1);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
    ...
    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig''($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+256
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig''($rsc))));
    ...
    // @163 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+1
    assume {:print "$at(14,1127,1128)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @162 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+1
    $1_Roles_RoleId_$memory#162 := $1_Roles_RoleId_$memory;

    // @167 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+1
    $1_DiemConfig_Configuration_$memory#167 := $1_DiemConfig_Configuration_$memory;

    // @166 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#166 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @165 := save_mem(DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+1
    $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#165 := $1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory;

    // @164 := save_mem(DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:5+1
    $1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#164 := $1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory;
...
L7:
    ...
    // @168 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@168](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:36:9+93
...
L1:
    ...
    // assert Not(Not(exists[@162]<Roles::RoleId>($t2))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#162, $t2);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@162]<Roles::RoleId>($t2)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#162, $t2)), 0);
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@163]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163);

    // assert Not(Not(exists[@164]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:140:9+129
    assume {:print "$at(13,5612,5741)"} true;
    assert {:msg "assert_failed(13,5612,5741): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#164, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@165]<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:104:9+101
    assume {:print "$at(13,3930,4031)"} true;
    assert {:msg "assert_failed(13,3930,4031): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#165, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());

    // assert Not(And(And(And(And(DiemTimestamp::$is_operating[@163](), DiemConfig::$reconfiguration_enabled[@166]()), Gt(DiemTimestamp::spec_now_microseconds[@163](), 0)), Lt(select DiemConfig::Configuration.epoch($t3), 18446744073709551615)), Lt($t4, select DiemConfig::Configuration.last_reconfiguration_time($t3)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:362:9+283
    assume {:print "$at(13,16092,16375)"} true;
    assert {:msg "assert_failed(13,16092,16375): function does not abort under this condition"}
      !(((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#166)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) > 0)) && ($epoch#$1_DiemConfig_Configuration($t3) < 18446744073709551615)) && ($t4 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t3)));
    ...
    // assert Eq<DiemConsensusConfig::DiemConsensusConfig>(DiemConfig::$get<DiemConsensusConfig::DiemConsensusConfig>(), pack DiemConsensusConfig::DiemConsensusConfig($t1)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:146:9+33
    assume {:print "$at(13,5863,5896)"} true;
    assert {:msg "assert_failed(13,5863,5896): post-condition does not hold"}
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@167](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:147:9+52
    assume {:print "$at(13,5905,5957)"} true;
    assert {:msg "assert_failed(13,5905,5957): post-condition does not hold"}
      $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#167), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Not(exists[@162]<Roles::RoleId>($t2)), Neq<u64>(select Roles::RoleId.role_id(global[@162]<Roles::RoleId>($t2)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Not(DiemTimestamp::$is_operating[@163]())), Not(exists[@164]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0)))), Not(exists[@165]<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))), And(And(And(And(DiemTimestamp::$is_operating[@163](), DiemConfig::$reconfiguration_enabled[@166]()), Gt(DiemTimestamp::spec_now_microseconds[@163](), 0)), Lt(select DiemConfig::Configuration.epoch($t3), 18446744073709551615)), Lt($t4, select DiemConfig::Configuration.last_reconfiguration_time($t3)))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:41:5+410
    assume {:print "$at(14,1388,1798)"} true;
    assert {:msg "assert_failed(14,1388,1798): abort not covered by any of the `aborts_if` clauses"}
      ((((((!$ResourceExists($1_Roles_RoleId_$memory#162, $t2) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#162, $t2)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163)) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#164, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#165, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#166)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) > 0)) && ($epoch#$1_DiemConfig_Configuration($t3) < 18446744073709551615)) && ($t4 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t3))));

    // assert Or(Or(Or(Or(Or(Or(And(Not(exists[@162]<Roles::RoleId>($t2)), Eq(5, $t6)), And(Neq<u64>(select Roles::RoleId.role_id(global[@162]<Roles::RoleId>($t2)), 0), Eq(3, $t6))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t6))), And(Not(DiemTimestamp::$is_operating[@163]()), Eq(1, $t6))), And(Not(exists[@164]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0))), Eq(4, $t6))), And(Not(exists[@165]<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Eq(5, $t6))), And(And(And(And(And(DiemTimestamp::$is_operating[@163](), DiemConfig::$reconfiguration_enabled[@166]()), Gt(DiemTimestamp::spec_now_microseconds[@163](), 0)), Lt(select DiemConfig::Configuration.epoch($t3), 18446744073709551615)), Lt($t4, select DiemConfig::Configuration.last_reconfiguration_time($t3))), Eq(1, $t6))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:41:5+410
    assert {:msg "assert_failed(14,1388,1798): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$ResourceExists($1_Roles_RoleId_$memory#162, $t2) && $IsEqual'u8'(5, $t6)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#162, $t2)), 0) && $IsEqual'u8'(3, $t6))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t6))) || (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) && $IsEqual'u8'(1, $t6))) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#164, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t6))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#165, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t6))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#166)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) > 0)) && ($epoch#$1_DiemConfig_Configuration($t3) < 18446744073709551615)) && ($t4 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t3))) && $IsEqual'u8'(1, $t6)));

    // abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:41:5+410
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
L7:
    ...
    // @161 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@161](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L7:
    ...
    // @155 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@155](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
...
procedure {:timeLimit 40} $1_Genesis_initialize$verify(_$t0: int, _$t1: int, _$t2: Vec (int), _$t3: Vec (int), _$t4: Vec (Vec (int)), _$t5: bool, _$t6: Vec (int), _$t7: Vec (int), _$t8: int, _$t9: int) returns ()
{
    ...
    // trace_local[dr_account#2051]($t0) at /home/ying/diem/language/diem-framework/modules/Genesis.move:42:13+10
    assume {:print "$at(22,1252,1262)"} true;
    assume {:print "$track_local(35,1,10):", $t0} $t0 == $t0;

    // trace_local[tc_account#2052]($t1) at /home/ying/diem/language/diem-framework/modules/Genesis.move:43:13+10
