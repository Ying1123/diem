...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 54567) (let ((L3_correct  (=> (= $t2@0 $t2@0) (and (=> (= (ControlFlow 0 47427) (- 0 55048)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0)))) (and (=> (= (ControlFlow 0 47427) (- 0 55067)) (= $t2@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0))))) (=> (= $t2@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0)))) (and (=> (= (ControlFlow 0 47427) (- 0 55080)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (= (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) a)))
 :qid |VASPbpl.3081:15|
 :skolemid |108|
 ...
 :qid |VASPbpl.3081:15|
 :skolemid |108|
)) (=> (= (ControlFlow 0 47427) (- 0 55105)) (forall ((parent Int) ) (!  (=> (|$IsValid'address'| parent) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) parent) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_32262| $1_VASP_ParentVASP_$memory) parent)) (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_32262| $1_VASP_ParentVASP_$memory) parent)))))
 :qid |VASPbpl.3086:15|
 :skolemid |109|
))))))))))))
(let ((anon18_Else_correct  (=> (and (not $abort_flag@0) (= $t9@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| $t8@1))) (=> (and (and (= $t9@0 $t9@0) (= $t9@0 $t9@0)) (and (= $t2@0 $t9@0) (= (ControlFlow 0 47321) 47427))) L3_correct))))
(let ((anon15_Then_correct  (=> (and (and $t3 (= _$t0 _$t0)) (and (= $t2@0 _$t0) (= (ControlFlow 0 47507) 47427))) L3_correct)))
(let ((L7_correct  (and (=> (= (ControlFlow 0 47273) (- 0 54958)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0)))) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0))) (=> (= (ControlFlow 0 47273) (- 0 54972)) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 $t7@0)))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 47441) 47273))) L7_correct)))
(let ((anon17_Then$1_correct  (=> (= $t8@1 $t8) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 47493) 47441) anon18_Then_correct) (=> (= (ControlFlow 0 47493) 47321) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0)) (= (ControlFlow 0 47491) 47493)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0) (=> (and (and (= $t8@0 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0)) (= $t8@1 $t8@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 47291) 47441) anon18_Then_correct) (=> (= (ControlFlow 0 47291) 47321) anon18_Else_correct))))))
(let ((anon16_Then_correct  (=> $t4 (and (=> (= (ControlFlow 0 47277) 47491) anon17_Then_correct) (=> (= (ControlFlow 0 47277) 47291) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (not $t4) (=> (and (|$IsValid'u64'| 2) (|$IsValid'u64'| $t6)) (=> (and (and (= $t6 7) (= $t6 $t6)) (and (= $t7@0 $t6) (= (ControlFlow 0 47221) 47273))) L7_correct)))))
(let ((anon15_Else_correct  (=> (and (not $t3) (= $t4 (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0))) (and (=> (= (ControlFlow 0 47189) 47277) anon16_Then_correct) (=> (= (ControlFlow 0 47189) 47221) anon16_Else_correct)))))
...
))) (and (= _$t0 _$t0) (= $t3 (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) _$t0))))) (and (=> (= (ControlFlow 0 47169) 47507) anon15_Then_correct) (=> (= (ControlFlow 0 47169) 47189) anon15_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_20373_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPbpl.1472:13|
 :skolemid |39|
))) (= (ControlFlow 0 46977) 47169)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 54567) 46977) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))
))
(check-sat)
(pop 1)
