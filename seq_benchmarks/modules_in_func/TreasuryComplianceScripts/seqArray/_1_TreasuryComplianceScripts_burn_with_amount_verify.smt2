...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@9| () T@$Memory_228213)
(declare-fun $t8@@6 () |T@$1_Diem_Preburn'#0'|)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@6| () T@$Memory_234513)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@7| () T@$Memory_228213)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@4| () T@$Memory_234513)
(declare-fun $abort_code@9 () Int)
(declare-fun $es@6 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@8| () T@$Memory_228213)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@5| () T@$Memory_234513)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@6| () T@$Memory_228213)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@3| () T@$Memory_234513)
...
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@2@@0| () T@$Memory_234513)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@5| () T@$Memory_228213)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| () T@$Mutation_238744)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| () |T@$1_Diem_Preburn'#0'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1| () T@$Mutation_238744)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@4| () T@$Memory_228213)
(declare-fun $abort_code@7 () Int)
(declare-fun $abort_flag@6 () Bool)
(declare-fun $es@2@@3 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@3| () T@$Memory_228213)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4| () T@$Mutation_247003)
(declare-fun $es@0@@7 () T@$EventStore)
(declare-fun inline$$Not$0$dst@1@@0 () Bool)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@1@@1| () T@$Memory_228213)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| () T@$Memory_228213)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@0| () T@$Mutation_238744)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1| () T@$Mutation_213547)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3| () T@$Mutation_247003)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@0@@1| () T@$Memory_228213)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| () T@$Mutation_247003)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0| () T@$Mutation_247003)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1| () T@$Mutation_247003)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1| () T@$Mutation_247050)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1| () T@$Mutation_238744)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1| () |T@$1_Diem_Diem'#0'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2| () T@$Mutation_247050)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t10@0| () T@$Mutation_247003)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@0| () T@$Mutation_247050)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@0| () T@$Mutation_213547)
...
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@1@@0| () T@$Memory_234513)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@0@@0| () T@$Memory_234513)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'$1_Diem_PreburnQueue'#0''@1| () |T@$1_Diem_PreburnQueue'#0'|)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t19@0| () T@$Mutation_238744)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@2 () T@$Memory_221725)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@2 () T@$Memory_221725)
...
(assert (not
 (=> (= (ControlFlow 0 0) 803262) (let ((L2_correct@@5  (and (=> (= (ControlFlow 0 626496) (- 0 808119)) (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (let (($range_0 ($Range 0 (seq.len $t5@@7))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@74 $i_1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t5@@7 i@@74)))) _$t3@@2))))
 :qid |TreasuryComplianceScriptsbpl.36794:452|
 :skolemid |1080|
)))) (= $t6@@7 0)) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7))))) (=> (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (let (($range_0@@0 ($Range 0 (seq.len $t5@@7))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@75 $i_1@@0))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t5@@7 i@@75)))) _$t3@@2))))
 :qid |TreasuryComplianceScriptsbpl.36794:452|
 :skolemid |1080|
)))) (= $t6@@7 0)) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7)))) (=> (= (ControlFlow 0 626496) (- 0 808254)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (= 5 $t12@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7) 0)) (= 7 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7))) (= 4 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)) (= 5 $t12@0))) (and (let (($range_0@@1 ($Range 0 (seq.len $t5@@7))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@76 $i_1@@1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t5@@7 i@@76)))) _$t3@@2))))
 :qid |TreasuryComplianceScriptsbpl.36799:598|
 :skolemid |1081|
))) (= 1 $t12@0))) (and (= $t6@@7 0) (= 1 $t12@0))) (and (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7) (= 8 $t12@0))) (and (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7) (= 8 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7))) (= 4 $t12@0))) (= 7 $t12@0)) (= 4 $t12@0)) (= 5 $t12@0)) (= 1 $t12@0)) (= 8 $t12@0)))))))
(let ((anon7_Then_correct  (=> (and (and $abort_flag@9 (= $abort_code@10 $abort_code@10)) (and (= $t12@0 $abort_code@10) (= (ControlFlow 0 626062) 626496))) L2_correct@@5)))
(let ((anon6_Then_correct  (=> (and (and $abort_flag@0@@4 (= $abort_code@1@@4 $abort_code@1@@4)) (and (= $t12@0 $abort_code@1@@4) (= (ControlFlow 0 626510) 626496))) L2_correct@@5)))
(let ((anon7_Else_correct  (=> (not $abort_flag@9) (and (=> (= (ControlFlow 0 626048) (- 0 807799)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7)))) (and (=> (= (ControlFlow 0 626048) (- 0 807812)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7) 0))) (and (=> (= (ControlFlow 0 626048) (- 0 807827)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7)))) (and (=> (= (ControlFlow 0 626048) (- 0 807840)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (and (=> (= (ControlFlow 0 626048) (- 0 807851)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (and (=> (= (ControlFlow 0 626048) (- 0 807862)) (not (let (($range_0@@2 ($Range 0 (seq.len $t5@@7))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@77 $i_1@@2))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t5@@7 i@@77)))) _$t3@@2))))
 :qid |TreasuryComplianceScriptsbpl.36731:57|
 :skolemid |1079|
))))) (=> (not (let (($range_0@@3 ($Range 0 (seq.len $t5@@7))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@78 $i_1@@3))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t5@@7 i@@78)))) _$t3@@2))))
 :qid |TreasuryComplianceScriptsbpl.36731:57|
 :skolemid |1079|
)))) (and (=> (= (ControlFlow 0 626048) (- 0 807909)) (not (= $t6@@7 0))) (=> (not (= $t6@@7 0)) (and (=> (= (ControlFlow 0 626048) (- 0 807920)) (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7))) (=> (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (and (=> (= (ControlFlow 0 626048) (- 0 807933)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (and (=> (= (ControlFlow 0 626048) (- 0 807946)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 626048) (- 0 807956)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7)))) (and (=> (= (ControlFlow 0 626048) (- 0 807969)) (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8@@6))))) (=> (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8@@6)))) (and (=> (= (ControlFlow 0 626048) (- 0 807992)) (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8@@6))))) (=> (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8@@6)))) (and (=> (= (ControlFlow 0 626048) (- 0 808015)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory@6|) _$t2@@4))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory@6|) _$t2@@4)) (and (=> (= (ControlFlow 0 626048) (- 0 808028)) (let ((actual@@38 ($EventStore (- (|counter#$EventStore| $es@7) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7) (|streams#$EventStore| $es)))))
(let ((expected@@38 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9@@6)) (let ((stream@@97 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t11@@5)))
(let ((stream_new@@88 (let ((len@@88 (|l#Multiset_181229| stream@@97)))
(let ((cnt@@88 (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@97) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@97) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)) (+ cnt@@88 1)) (+ len@@88 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t11@@5 stream_new@@88)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@38) (|counter#$EventStore| actual@@38)) (forall ((handle@@48 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@38) handle@@48)) (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@38) handle@@48))) (forall ((v@@96 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@38) handle@@48)) v@@96) (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@38) handle@@48)) v@@96))
...
(let ((expected@@39 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9@@6)) (let ((stream@@98 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t11@@5)))
(let ((stream_new@@89 (let ((len@@89 (|l#Multiset_181229| stream@@98)))
(let ((cnt@@89 (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@98) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@98) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)) (+ cnt@@89 1)) (+ len@@89 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t11@@5 stream_new@@89)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@39) (|counter#$EventStore| actual@@39)) (forall ((handle@@49 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@39) handle@@49)) (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@39) handle@@49))) (forall ((v@@97 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@39) handle@@49)) v@@97) (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@39) handle@@49)) v@@97))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3464:13|
 :skolemid |95|
))))) (=> (= (ControlFlow 0 626048) (- 0 808069)) (let ((actual@@40 ($EventStore (- (|counter#$EventStore| $es@7) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7) (|streams#$EventStore| $es)))))
(let ((expected@@40 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9@@6)) (let ((stream@@99 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t11@@5)))
(let ((stream_new@@90 (let ((len@@90 (|l#Multiset_181229| stream@@99)))
(let ((cnt@@90 (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@99) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@99) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)) (+ cnt@@90 1)) (+ len@@90 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t11@@5 stream_new@@90)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| actual@@40) (|counter#$EventStore| expected@@40)) (forall ((handle@@50 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@40) handle@@50)) (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@40) handle@@50))) (forall ((v@@98 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@40) handle@@50)) v@@98) (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@40) handle@@50)) v@@98))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3464:13|
...
(let ((|inline$$1_Diem_burn'#0'$0$anon14_Else_correct|  (=> (and (not $abort_flag@8) (= $es@7 $es@5)) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@9| |$1_Diem_CurrencyInfo'#0'_$memory@7|) (= |$1_Diem_PreburnQueue'#0'_$memory@6| |$1_Diem_PreburnQueue'#0'_$memory@4|)) (and (= $abort_flag@9 $abort_flag@8) (= $abort_code@10 $abort_code@9))) (and (=> (= (ControlFlow 0 625625) 626062) anon7_Then_correct) (=> (= (ControlFlow 0 625625) 626048) anon7_Else_correct))))))
(let ((|inline$$1_Diem_burn'#0'$0$L3_correct|  (=> (= $es@7 $es@6) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@9| |$1_Diem_CurrencyInfo'#0'_$memory@8|) (= |$1_Diem_PreburnQueue'#0'_$memory@6| |$1_Diem_PreburnQueue'#0'_$memory@5|)) (and (= $abort_flag@9 true) (= $abort_code@10 |inline$$1_Diem_burn'#0'$0$$t18@1|))) (and (=> (= (ControlFlow 0 621189) 626062) anon7_Then_correct) (=> (= (ControlFlow 0 621189) 626048) anon7_Else_correct))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon14_Then_correct|  (=> $abort_flag@8 (=> (and (= $abort_code@9 $abort_code@9) (= |inline$$1_Diem_burn'#0'$0$$t18@1| $abort_code@9)) (=> (and (and (= $es@6 $es@5) (= |$1_Diem_CurrencyInfo'#0'_$memory@8| |$1_Diem_CurrencyInfo'#0'_$memory@7|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@5| |$1_Diem_PreburnQueue'#0'_$memory@4|) (= (ControlFlow 0 625639) 621189))) |inline$$1_Diem_burn'#0'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|  (=> (= $abort_code@9 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1|) (=> (and (and (= $es@5 $es@4) (= |$1_Diem_CurrencyInfo'#0'_$memory@7| |$1_Diem_CurrencyInfo'#0'_$memory@6|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@4| |$1_Diem_PreburnQueue'#0'_$memory@3|) (= $abort_flag@8 true))) (and (=> (= (ControlFlow 0 625504) 625639) |inline$$1_Diem_burn'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 625504) 625625) |inline$$1_Diem_burn'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon13_Then_correct|  (=> |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0| (=> (and (and (and (> (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) 0) (= 7 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2@@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 625498) 625504)))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|  (=> $abort_flag@7 (=> (and (= $abort_code@8 $abort_code@8) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| $abort_code@8)) (=> (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2@@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 625518) 625504))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon10_Then_correct|  (=> (and (and (and |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0| (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)) (= 5 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)) (and (let ((|inline$$1_Diem_burn_with_capability'#0'$0$$range_0| ($Range 0 (seq.len |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'#0'$0$$i_1| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'#0'$0$$range_0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1|) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$i| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1|))
 ...
 :qid |unknown.0:0|
 :skolemid |192|
))) (= 1 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@4 $es) (= (ControlFlow 0 625611) 625504)))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon13_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0|) (= $abort_code@9 $abort_code@8)) (=> (and (and (= $es@5 $es@3) (= |$1_Diem_CurrencyInfo'#0'_$memory@7| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@4| |$1_Diem_PreburnQueue'#0'_$memory@2@@0|) (= $abort_flag@8 $abort_flag@7))) (and (=> (= (ControlFlow 0 625470) 625639) |inline$$1_Diem_burn'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 625470) 625625) |inline$$1_Diem_burn'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|  (=> (not $abort_flag@7) (=> (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t3@1| (|v#$Mutation_238744| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t3@1|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0| (> (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) 0)))) (and (=> (= (ControlFlow 0 625462) 625498) |inline$$1_Diem_burn_with_capability'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 625462) 625470) |inline$$1_Diem_burn_with_capability'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|  (=> (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| (|v#$Mutation_238744| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1|)) (=> (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2|) (= |$1_Diem_CurrencyInfo'#0'_$memory@5| |$1_Diem_CurrencyInfo'#0'_$memory@4|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1|) (= $abort_code@8 $abort_code@7)) (and (= $abort_flag@7 $abort_flag@6) (= $es@3 $es@2@@3))) (and (=> (= (ControlFlow 0 625103) 625518) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 625103) 625462) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Else_correct|  (=> (not $abort_flag@6) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@3| ($Memory_228213 (|Store__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)))) (= $es@2@@3 $es@0@@7)) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@4| |$1_Diem_CurrencyInfo'#0'_$memory@3|) (= (ControlFlow 0 625228) 625103))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Else_correct|  (=> (not inline$$Not$0$dst@1@@0) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1@@1| ($Memory_228213 (|Store__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)))) (= $es@2@@3 $es)) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@4| |$1_Diem_CurrencyInfo'#0'_$memory@1@@1|) (= (ControlFlow 0 625089) 625103))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|  (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@5| |$1_Diem_CurrencyInfo'#0'_$memory@2@@1|) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@0|) (= $abort_code@8 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1|)) (and (= $abort_flag@7 true) (= $es@3 $es@1@@6))) (and (=> (= (ControlFlow 0 624019) 625518) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 624019) 625462) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Then_correct|  (=> (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@7) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es@0@@7) (= (ControlFlow 0 625242) 624019))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| (|v#$Mutation_213547| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1|)) (= $es@0@@7 (let ((stream@@100 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1|)))
(let ((stream_new@@91 (let ((len@@91 (|l#Multiset_181229| stream@@100)))
(let ((cnt@@91 (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@100) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1|))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@100) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1|) (+ cnt@@91 1)) (+ len@@91 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| stream_new@@91)))))) (and (=> (= (ControlFlow 0 625200) 625242) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Then_correct|) (=> (= (ControlFlow 0 625200) 625228) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Then_correct|  (=> (and (and inline$$Not$0$dst@1@@0 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1| ($Mutation_213547 (|l#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|) (seq.++ (|p#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|) (seq.unit 9)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1| ($1_Diem_BurnEvent |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| _$t2@@4)) (= (ControlFlow 0 625206) 625200))) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct@@0  (=> (= inline$$Not$0$dst@1@@0  (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t50@1|)) (and (=> (= (ControlFlow 0 625061) 625206) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Then_correct|) (=> (= (ControlFlow 0 625061) 625089) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|  (=> (and (not $abort_flag@6) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1| ($Mutation_16758 (|l#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (seq.++ (|p#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (seq.unit 1)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@2| ($Mutation_16758 (|l#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1|) (|p#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1|) inline$$Sub$1$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4| ($Mutation_247003 (|l#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (|p#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|v#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@2|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t50@1| (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|))) (= (ControlFlow 0 625067) 625061))) inline$$Not$0$anon0_correct@@0))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|  (=> (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@7) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 625256) 624019))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$Sub$1$anon3_Then$1_correct  (=> (= $abort_flag@6 true) (=> (and (= $abort_code@7 $EXEC_FAILURE_CODE) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@0)) (and (=> (= (ControlFlow 0 624977) 625256) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 624977) 625067) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|))))))
(let ((inline$$Sub$1$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= (ControlFlow 0 624975) 624977)) inline$$Sub$1$anon3_Then$1_correct)))
(let ((inline$$Sub$1$anon3_Else_correct  (=> (<= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1|) (=> (and (and (= inline$$Sub$1$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|)) (= $abort_flag@6 $abort_flag@5)) (and (= $abort_code@7 $abort_code@6) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@1))) (and (=> (= (ControlFlow 0 624927) 625256) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 624927) 625067) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Then_correct|  (=> (and inline$$Ge$1$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))) (and (=> (= (ControlFlow 0 624983) 624975) inline$$Sub$1$anon3_Then_correct) (=> (= (ControlFlow 0 624983) 624927) inline$$Sub$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Else_correct|  (=> (not inline$$Ge$1$dst@1) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@0@@1| ($Memory_228213 (|Store__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory@0@@1|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 624836) 624019))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else$1_correct|  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= inline$$Ge$1$dst@1 inline$$Ge$1$dst@1))) (and (=> (= (ControlFlow 0 624808) 624983) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Then_correct|) (=> (= (ControlFlow 0 624808) 624836) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Else_correct|))))))
(let ((inline$$Ge$1$anon0_correct  (=> (and (= inline$$Ge$1$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t43@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|)) (= (ControlFlow 0 624772) 624808)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|  (=> (and (not $abort_flag@5) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1| ($Mutation_16758 (|l#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (seq.++ (|p#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (seq.unit 0)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@2| ($Mutation_16758 (|l#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1|) (|p#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1|) inline$$Sub$0$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3| ($Mutation_247003 (|l#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (|p#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (|$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@2|) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t43@1| (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|))) (= (ControlFlow 0 624778) 624772))) inline$$Ge$1$anon0_correct))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|  (=> (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@6) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 625270) 624019))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_code@6 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@5 true) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 624678) 625270) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 624678) 624778) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| inline$$CastU128$1$dst@1) (= (ControlFlow 0 624676) 624678)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1|) (=> (and (and (= inline$$Sub$0$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| inline$$CastU128$1$dst@1)) (= $abort_code@6 $abort_code@5@@0)) (and (= $abort_flag@5 $abort_flag@4@@0) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 624628) 625270) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 624628) 624778) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|  (=> (not $abort_flag@4@@0) (and (=> (= (ControlFlow 0 624684) 624676) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 624684) 624628) inline$$Sub$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|  (=> (and $abort_flag@4@@0 (= $abort_code@5@@0 $abort_code@5@@0)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@5@@0) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 625284) 624019))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_flag@4@@0 true) (=> (and (= $abort_code@5@@0 $EXEC_FAILURE_CODE) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 624533) 625284) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 624533) 624684) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 624531) 624533)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= $abort_flag@4@@0 $abort_flag@3@@1)) (and (= $abort_code@5@@0 $abort_code@4@@1) (= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|))) (and (=> (= (ControlFlow 0 624483) 625284) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 624483) 624684) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Then_correct|  (=> (and inline$$Ge$0$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)))) (and (=> (= (ControlFlow 0 624539) 624531) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 624539) 624483) inline$$CastU128$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Else_correct|  (=> (and (not inline$$Ge$0$dst@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 624404) 624019))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else$1_correct|  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 624388) 624539) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Then_correct|) (=> (= (ControlFlow 0 624388) 624404) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Else_correct|))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t34@1| inline$$CastU128$0$dst@1)) (= (ControlFlow 0 624352) 624388)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|  (=> (and (not $abort_flag@3@@1) (= (ControlFlow 0 624358) 624352)) inline$$Ge$0$anon0_correct)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|  (=> (and $abort_flag@3@@1 (= $abort_code@4@@1 $abort_code@4@@1)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@4@@1) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 625298) 624019))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_code@4@@1 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@3@@1 true) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 624298) 625298) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 624298) 624358) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 624296) 624298)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= $abort_code@4@@1 $abort_code@3@@1)) (and (= $abort_flag@3@@1 $abort_flag@2@@1) (= inline$$CastU128$0$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|))) (and (=> (= (ControlFlow 0 624248) 625298) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 624248) 624358) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|  (=> (and (and (not $abort_flag@2@@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t34@1| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))) (and (=> (= (ControlFlow 0 624304) 624296) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 624304) 624248) inline$$CastU128$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|  (=> (and $abort_flag@2@@1 (= $abort_code@3@@1 $abort_code@3@@1)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@3@@1) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 625312) 624019))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then$1_correct|  (=> (= $abort_flag@2@@1 true) (=> (and (= $abort_code@3@@1 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0|)) (and (=> (= (ControlFlow 0 625364) 625312) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 625364) 624304) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 625362) 625364)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1| ($Mutation_247003 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $abort_flag@2@@1 $abort_flag@1@@1)) (and (= $abort_code@3@@1 $abort_code@2@@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1|))) (and (=> (= (ControlFlow 0 624153) 625312) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 624153) 624304) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 624131) 625362) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then_correct|) (=> (= (ControlFlow 0 624131) 624153) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 625390) 624019)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Then_correct|  (=> inline$$Gt$0$dst@1 (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1| ($Mutation_247050 (|l#$Mutation_238744| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (seq.++ (|p#$Mutation_238744| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (seq.unit 0)) (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_238744| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1| (|v#$Mutation_247050| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2| ($Mutation_247050 (|l#$Mutation_247050| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|) (|p#$Mutation_247050| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|) |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Diem'#0''@1|)) (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_247050| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)))) (=> (and (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_247050| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)) (|$IsValid'$1_Diem_Diem'#0''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|)) (and (= (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|) (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1|)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_247050| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)) 0))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1| ($Mutation_238744 (|l#$Mutation_238744| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (|p#$Mutation_238744| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (|$1_Diem_Preburn'#0'| (|v#$Mutation_247050| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 624117) 625390) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Then_correct|) (=> (= (ControlFlow 0 624117) 624131) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Else_correct|  (=> (and (not inline$$Gt$0$dst@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 624013) 624019))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else$1_correct|  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| 1)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 623997) 624117) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Then_correct|) (=> (= (ControlFlow 0 623997) 624013) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Else_correct|))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t22@1| 0)) (= (ControlFlow 0 623961) 623997)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else_correct|  (=> (and (and (and (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0|) (|$IsValid'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0|)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0|))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t21@1| (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_238744| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t22@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t21@1|))) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 623967) 623961)))) inline$$Gt$0$anon0_correct)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 625416) 624019)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon0_correct|  (=> (= (seq.len (|p#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t10@0|)) 0) (=> (and (and (and (and (= (seq.len (|p#$Mutation_247050| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@0|)) 0) (= (seq.len (|p#$Mutation_247003| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0|)) 0)) (and (= (seq.len (|p#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@0|)) 0) (= (seq.len (|p#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@0|)) 0))) (and (and (= (seq.len (|p#$Mutation_213547| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@0|)) 0) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t12@0| (|v#$Mutation_238744| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t13@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t12@0|))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t14@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t15@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t16@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t17@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t15@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1| (|v#$Mutation_238744| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1|) (= _$t2@@4 _$t2@@4)) (and (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@2|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))) (and (=> (= (ControlFlow 0 623879) 625416) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Then_correct|) (=> (= (ControlFlow 0 623879) 623967) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|  (=> (and (|$IsValid'$1_Diem_PreburnWithMetadata'#0''| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory@2@@0|) _$t2@@4))) (=> (and (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|))) _$t3@@2) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t18@1| (|$metadata#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1|))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1| ($Mutation_238744 ($Local 3) (as seq.empty (Seq Int)) |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t20@0| (|v#$Mutation_238744| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t21@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t20@0|))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t22@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t23@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t24@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t25@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t23@0|)) (= (ControlFlow 0 625422) 623879)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon0_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon11_Else_correct|  (=> (and (and (not |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'bool'@1|) (= |$1_Diem_PreburnQueue'#0'_$memory@1@@0| ($Memory_234513 (|Store__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4 false) (|contents#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2@@0| |$1_Diem_PreburnQueue'#0'_$memory@1@@0|) (= (ControlFlow 0 622319) 625422))) |inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon11_Then_correct|  (=> (and (and |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'bool'@1| (= |$1_Diem_PreburnQueue'#0'_$memory@0@@0| ($Memory_234513 (|Store__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4 true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4 |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'$1_Diem_PreburnQueue'#0''@1|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2@@0| |$1_Diem_PreburnQueue'#0'_$memory@0@@0|) (= (ControlFlow 0 625530) 625422))) |inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon10_Else_correct|  (=> (not |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0|) (and (=> (= (ControlFlow 0 622307) 625530) |inline$$1_Diem_burn_with_capability'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 622307) 622319) |inline$$1_Diem_burn_with_capability'#0'$0$anon11_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon0_correct|  (=> (and (= (seq.len (|p#$Mutation_238744| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@0|)) 0) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t6@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t7@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t8@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t9@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t10@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t8@0|))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t12@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= _$t2@@4 _$t2@@4))) (and (and (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@2|) (= _$t3@@2 _$t3@@2)) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0|  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$$range_0@@0| ($Range 0 (seq.len |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'#0'$0$$range_0@@0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0|) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$i@@0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0|))
 ...
 :qid |unknown.0:0|
 :skolemid |191|
)))))))) (and (=> (= (ControlFlow 0 622299) 625611) |inline$$1_Diem_burn_with_capability'#0'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 622299) 622307) |inline$$1_Diem_burn_with_capability'#0'$0$anon10_Else_correct|)))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon13_Else_correct|  (=> (and (not $abort_flag@1@@1) (= |inline$$1_Diem_burn'#0'$0$$t20@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (and (and (and (= |inline$$1_Diem_burn'#0'$0$$t21@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn'#0'$0$$t22@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn'#0'$0$$t20@0|))) (and (= |inline$$1_Diem_burn'#0'$0$$t23@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= |inline$$1_Diem_burn'#0'$0$$t24@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))))) (and (and (= |inline$$1_Diem_burn'#0'$0$$t25@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn'#0'$0$$t23@0|))) (= |inline$$1_Diem_burn'#0'$0$$t26@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'#0'$0$$t27@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= (ControlFlow 0 625615) 622299)))) |inline$$1_Diem_burn_with_capability'#0'$0$anon0_correct|))))
(let ((|inline$$1_Diem_burn'#0'$0$anon13_Then_correct|  (=> $abort_flag@1@@1 (=> (and (= $abort_code@2@@1 $abort_code@2@@1) (= |inline$$1_Diem_burn'#0'$0$$t18@1| $abort_code@2@@1)) (=> (and (and (= $es@6 $es) (= |$1_Diem_CurrencyInfo'#0'_$memory@8| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@5| |$1_Diem_PreburnQueue'#0'_$memory|) (= (ControlFlow 0 625653) 621189))) |inline$$1_Diem_burn'#0'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'#0'$0$anon12_Then$1_correct|  (=> (= $abort_code@2@@1 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@1 true) (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@0|)) (and (=> (= (ControlFlow 0 625705) 625653) |inline$$1_Diem_burn'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 625705) 625615) |inline$$1_Diem_burn'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon12_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|)) (= (ControlFlow 0 625703) 625705)) |inline$$1_Diem_burn'#0'$0$anon12_Then$1_correct|)))
(let ((|inline$$1_Diem_burn'#0'$0$anon12_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|) (=> (and (and (= |inline$$1_Diem_burn'#0'$0$$t19@1| (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|)) (= $abort_code@2@@1 $abort_code@1@@4)) (and (= $abort_flag@1@@1 $abort_flag@0@@4) (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@1|))) (and (=> (= (ControlFlow 0 621209) 625653) |inline$$1_Diem_burn'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 621209) 625615) |inline$$1_Diem_burn'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon11_Then_correct|  (=> |inline$$1_Diem_burn'#0'$0$$t15@1| (and (=> (= (ControlFlow 0 621195) 625703) |inline$$1_Diem_burn'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 621195) 621209) |inline$$1_Diem_burn'#0'$0$anon12_Else_correct|)))))
(let ((|inline$$1_Diem_burn'#0'$0$anon11_Else_correct|  (=> (not |inline$$1_Diem_burn'#0'$0$$t15@1|) (=> (and (= |inline$$1_Diem_burn'#0'$0$$t17@0| |inline$$1_Diem_burn'#0'$0$$t17@0|) (= |inline$$1_Diem_burn'#0'$0$$t18@1| |inline$$1_Diem_burn'#0'$0$$t17@0|)) (=> (and (and (= $es@6 $es) (= |$1_Diem_CurrencyInfo'#0'_$memory@8| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@5| |$1_Diem_PreburnQueue'#0'_$memory|) (= (ControlFlow 0 621183) 621189))) |inline$$1_Diem_burn'#0'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'#0'$0$anon0_correct|  (=> (and (and (= |inline$$1_Diem_burn'#0'$0$$t6@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= |inline$$1_Diem_burn'#0'$0$$t7@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)))) (and (= |inline$$1_Diem_burn'#0'$0$$t8@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn'#0'$0$$t6@0|))) (= |inline$$1_Diem_burn'#0'$0$$t9@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (and (and (and (and (= |inline$$1_Diem_burn'#0'$0$$t10@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= |inline$$1_Diem_burn'#0'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'#0'$0$$t12@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn'#0'$0$$t13@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn'#0'$0$$t11@0|)))) (and (and (= _$t0@@7 _$t0@@7) (= _$t2@@4 _$t2@@4)) (and (= _$t3@@2 _$t3@@2) (|$IsValid'address'| |inline$$1_Diem_burn'#0'$0$$t14@0|)))) (and (and (and (= |inline$$1_Diem_burn'#0'$0$$t14@0| (|$addr#$signer| _$t0@@7)) (= |inline$$1_Diem_burn'#0'$0$$t14@0| |inline$$1_Diem_burn'#0'$0$$t14@0|)) (and (= |inline$$1_Diem_burn'#0'$0$$t15@1| (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| |inline$$1_Diem_burn'#0'$0$$t17@0|) (= |inline$$1_Diem_burn'#0'$0$$t17@0| 4)) (and (= |inline$$1_Diem_burn'#0'$0$$t17@0| |inline$$1_Diem_burn'#0'$0$$t17@0|) (= |inline$$1_Diem_burn'#0'$0$$t15@1| |inline$$1_Diem_burn'#0'$0$$t15@1|))))) (and (=> (= (ControlFlow 0 621167) 621195) |inline$$1_Diem_burn'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 621167) 621183) |inline$$1_Diem_burn'#0'$0$anon11_Else_correct|))))))
(let ((anon6_Else_correct  (=> (and (not $abort_flag@0@@4) (= $t13@@5 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) (=> (and (and (and (= $t14@@5 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (= $t15@@5 (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t13@@5)))) (and (= $t16@@5 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t17@@5 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))))) (and (and (= $t18@@5 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t19@@5 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t20@@5 (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t18@@5)) (= (ControlFlow 0 625709) 621167)))) |inline$$1_Diem_burn'#0'$0$anon0_correct|))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@2  (=> (and (= $abort_flag@0@@4 true) (= $abort_code@1@@4 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@2)) (and (=> (= (ControlFlow 0 620242) 626510) anon6_Then_correct) (=> (= (ControlFlow 0 620242) 625709) anon6_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@2  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@2) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2) (= (ControlFlow 0 620236) 620242))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@2)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@2  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@2 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@2)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@2)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@2) (= (ControlFlow 0 620292) 620242))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@2))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@2  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@2 (=> (and (= $abort_flag@0@@4 false) (= $abort_code@1@@4 $abort_code@0@@4)) (and (=> (= (ControlFlow 0 620248) 626510) anon6_Then_correct) (=> (= (ControlFlow 0 620248) 625709) anon6_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@2  (=> (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@2) (=> (and (and (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@2 ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@2)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@2 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@2 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@2)))) (and (=> (= (ControlFlow 0 620220) 620248) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@2) (=> (= (ControlFlow 0 620220) 620236) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@2))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@2  (=> (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@2|) (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@1@@2 ($Memory_221725 (|Store__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7) false) (|contents#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory))) (= (ControlFlow 0 620162) 620220)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@2))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@2  (=> |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@2| (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@0@@2 ($Memory_221725 (|Store__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1@@2|))) (= (ControlFlow 0 620262) 620220)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@2))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@2  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@2) (and (=> (= (ControlFlow 0 620148) 620262) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@2) (=> (= (ControlFlow 0 620148) 620162) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@2)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@2  (=> (= _$t0@@7 _$t0@@7) (=> (and (= _$t1@@7 _$t1@@7) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@2  (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))))) (and (=> (= (ControlFlow 0 620142) 620292) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@2) (=> (= (ControlFlow 0 620142) 620148) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@2))))))
(let ((anon0$1_correct@@7  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_219763| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_219763| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) 186537453))) (=> (and (and (forall ((addr1@@55 Int) ) (!  (=> (|$IsValid'address'| addr1@@55) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_228752| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1@@55) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@55) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@55)) 1))))
 :qid |TreasuryComplianceScriptsbpl.36535:22|
 :skolemid |1056|
)) (forall ((addr1@@56 Int) ) (!  (=> (|$IsValid'address'| addr1@@56) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_228839| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr1@@56) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@56) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@56)) 1))))
 :qid |TreasuryComplianceScriptsbpl.36535:232|
 :skolemid |1057|
))) (forall ((addr1@@57 Int) ) (!  (=> (|$IsValid'address'| addr1@@57) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) addr1@@57) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@57) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@57)) 1))))
 :qid |TreasuryComplianceScriptsbpl.36535:443|
 :skolemid |1058|
))) (=> (and (and (and (and (forall ((addr1@@58 Int) ) (!  (=> (|$IsValid'address'| addr1@@58) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_234315| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1@@58) (|Select__T@[Int]Bool_| (|domain#$Memory_233906| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1@@58)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@58) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@58)) 2))))
 :qid |TreasuryComplianceScriptsbpl.36539:22|
 :skolemid |1059|
)) (forall ((addr1@@59 Int) ) (!  (=> (|$IsValid'address'| addr1@@59) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_234414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr1@@59) (|Select__T@[Int]Bool_| (|domain#$Memory_233997| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr1@@59)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@59) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@59)) 2))))
 :qid |TreasuryComplianceScriptsbpl.36539:293|
 :skolemid |1060|
))) (forall ((addr1@@60 Int) ) (!  (=> (|$IsValid'address'| addr1@@60) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) addr1@@60) (|Select__T@[Int]Bool_| (|domain#$Memory_234088| |$1_Diem_Preburn'#0'_$memory|) addr1@@60)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@60) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@60)) 2))))
 :qid |TreasuryComplianceScriptsbpl.36539:565|
 :skolemid |1061|
))) (and (and (forall ((dd_addr@@17 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233906| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@17) (and (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_Preburn'$1_XUS_XUS'_| (|contents#$Memory_233906| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@17))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234315| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) dd_addr@@17)))))
 :qid |TreasuryComplianceScriptsbpl.36543:22|
 :skolemid |1062|
)) (forall ((dd_addr@@18 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233997| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@18) (and (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_Preburn'$1_XDX_XDX'_| (|contents#$Memory_233997| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@18))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) dd_addr@@18)))))
 :qid |TreasuryComplianceScriptsbpl.36543:375|
 :skolemid |1063|
))) (forall ((dd_addr@@19 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@19) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234088| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@19) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_234088| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@19))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@19)))))
 :qid |TreasuryComplianceScriptsbpl.36543:729|
 :skolemid |1064|
)))) (and (and (and (forall ((dd_addr@@20 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@20) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234315| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) dd_addr@@20) (not (|Select__T@[Int]Bool_| (|domain#$Memory_233906| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@20))))
 :qid |TreasuryComplianceScriptsbpl.36547:22|
 :skolemid |1065|
)) (forall ((dd_addr@@21 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@21) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) dd_addr@@21) (not (|Select__T@[Int]Bool_| (|domain#$Memory_233997| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@21))))
 :qid |TreasuryComplianceScriptsbpl.36547:220|
 :skolemid |1066|
))) (forall ((dd_addr@@22 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@22) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234088| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@22))))
 :qid |TreasuryComplianceScriptsbpl.36547:419|
 :skolemid |1067|
))) (and (and (forall ((addr@@217 Int) ) (!  (=> (|$IsValid'address'| addr@@217) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233906| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@217) (|Select__T@[Int]Bool_| (|domain#$Memory_227922| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36551:22|
 :skolemid |1068|
)) (forall ((addr@@218 Int) ) (!  (=> (|$IsValid'address'| addr@@218) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233997| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@218) (|Select__T@[Int]Bool_| (|domain#$Memory_227986| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36551:222|
 :skolemid |1069|
))) (forall ((addr@@219 Int) ) (!  (=> (|$IsValid'address'| addr@@219) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234088| |$1_Diem_Preburn'#0'_$memory|) addr@@219) (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36551:423|
 :skolemid |1070|
))))) (=> (and (and (and (and (and (forall ((addr@@220 Int) ) (!  (=> (|$IsValid'address'| addr@@220) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234315| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@220) (|Select__T@[Int]Bool_| (|domain#$Memory_227922| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36555:22|
 :skolemid |1071|
)) (forall ((addr@@221 Int) ) (!  (=> (|$IsValid'address'| addr@@221) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@221) (|Select__T@[Int]Bool_| (|domain#$Memory_227986| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36555:227|
 :skolemid |1072|
))) (forall ((addr@@222 Int) ) (!  (=> (|$IsValid'address'| addr@@222) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@222) (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36555:433|
 :skolemid |1073|
))) (and (|$IsValid'address'| (|$addr#$signer| _$t0@@7)) (|$IsValid'u64'| _$t1@@7))) (and (and (|$IsValid'address'| _$t2@@4) (|$IsValid'u64'| _$t3@@2)) (and (forall (($a_0@@95 Int) ) (! (let (($rsc@@95 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@95)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@95))
 :qid |TreasuryComplianceScriptsbpl.36570:20|
 :skolemid |1074|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@95))
)) (forall (($a_0@@96 Int) ) (! (let (($rsc@@96 (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) $a_0@@96)))
(|$IsValid'$1_Diem_BurnCapability'#0''| $rsc@@96))
 :qid |TreasuryComplianceScriptsbpl.36574:20|
 :skolemid |1075|
 :pattern ( (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) $a_0@@96))
))))) (and (and (and (and (forall (($a_0@@97 Int) ) (! (let (($rsc@@97 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@97)))
 ...
 :qid |TreasuryComplianceScriptsbpl.36578:20|
 :skolemid |1076|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@97))
)) (forall (($a_0@@98 Int) ) (! (let (($rsc@@98 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@98)))
...
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@98) i@@79)))) 0)))
 :qid |TreasuryComplianceScriptsbpl.36583:199|
 :skolemid |1077|
))))))
 :qid |TreasuryComplianceScriptsbpl.36582:20|
 :skolemid |1078|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@98))
))) (and (= $t4@@4 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= $t5@@7 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))))) (and (and (= $t6@@7 (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t4@@4))) (= $t7@@6 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t8@@6 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= $t9@@6 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= $t10@@6 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t11@@5 (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t9@@6))) (and (let ((addr@@223 (|$addr#$signer| _$t0@@7)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_219763| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_296946| $1_DiemAccount_DiemAccount_$memory) addr@@223)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_293319| $1_AccountFreezing_FreezingBit_$memory) addr@@223) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_293319| $1_AccountFreezing_FreezingBit_$memory) addr@@223)))))) (= _$t0@@7 _$t0@@7))) (and (and (= _$t1@@7 _$t1@@7) (= _$t2@@4 _$t2@@4)) (and (= _$t3@@2 _$t3@@2) (= (ControlFlow 0 620296) 620142)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@2))))))
(let ((inline$$InitEventStore$0$anon0_correct@@7  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@51 T@$1_Event_EventHandle) ) (! (let ((stream@@101 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $es) handle@@51)))
 (and (= (|l#Multiset_181229| stream@@101) 0) (forall ((v@@99 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@101) v@@99) 0)
 :qid |TreasuryComplianceScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |TreasuryComplianceScriptsbpl.3448:13|
 :skolemid |94|
))) (= (ControlFlow 0 618935) 620296)) anon0$1_correct@@7)))
(let ((anon0_correct@@7  (=> (= (ControlFlow 0 803262) 618935) inline$$InitEventStore$0$anon0_correct@@7)))
anon0_correct@@7))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
