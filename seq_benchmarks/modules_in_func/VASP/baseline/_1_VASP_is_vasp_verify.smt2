...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 226537) (let ((L3_correct  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 164353) (- 0 226751)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 164353) (- 0 226758)) (= $t1@0  (or (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0)))) (=> (= $t1@0  (or (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0))) (and (=> (= (ControlFlow 0 164353) (- 0 226771)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) a)))
 :qid |VASPbpl.9813:15|
 :skolemid |216|
 ...
 :qid |VASPbpl.9813:15|
 :skolemid |216|
)) (=> (= (ControlFlow 0 164353) (- 0 226796)) (forall ((parent Int) ) (!  (=> (|$IsValid'address'| parent) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) parent) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_128063| $1_VASP_ParentVASP_$memory) parent)) (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_128063| $1_VASP_ParentVASP_$memory) parent)))))
 :qid |VASPbpl.9818:15|
 :skolemid |217|
))))))))))))
(let ((anon3_Else_correct  (=> (not $t2) (=> (and (and (= $t4 (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0)) (= $t4 $t4)) (and (= $t1@0 $t4) (= (ControlFlow 0 164263) 164353))) L3_correct))))
(let ((anon3_Then_correct  (=> (and (and $t2 (= true true)) (and (= $t1@0 true) (= (ControlFlow 0 164371) 164353))) L3_correct)))
...
))) (and (= _$t0 _$t0) (= $t2 (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0)))) (and (=> (= (ControlFlow 0 164235) 164371) anon3_Then_correct) (=> (= (ControlFlow 0 164235) 164263) anon3_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_68395_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 164114) 164235)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 226537) 164114) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))
))
(check-sat)
(pop 1)
