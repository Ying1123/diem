...
(assert (not
 (=> (= (ControlFlow 0 0) 333289) (let ((anon12_Else_correct@@2  (=> (not $abort_flag@0@@3) (=> (and (= $t8@0@@4 (|$base_url#$1_DualAttestation_Credential| $t7@1@@0)) (= $t8@0@@4 $t8@0@@4)) (and (=> (= (ControlFlow 0 247334) (- 0 333613)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@14)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@14))) (and (=> (= (ControlFlow 0 247334) (- 0 333624)) (|$IsEqual'vec'u8''| $t8@0@@4 (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@14)))) (=> (|$IsEqual'vec'u8''| $t8@0@@4 (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@14))) (and (=> (= (ControlFlow 0 247334) (- 0 333637)) (forall ((addr1@@28 Int) ) (!  (=> (|$IsValid'address'| addr1@@28) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@28) (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@28)))
 :qid |DualAttestationbpl.15042:15|
 :skolemid |336|
))) (=> (forall ((addr1@@29 Int) ) (!  (=> (|$IsValid'address'| addr1@@29) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@29) (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@29)))
 :qid |DualAttestationbpl.15042:15|
 :skolemid |336|
)) (and (=> (= (ControlFlow 0 247334) (- 0 333662)) (forall ((addr1@@30 Int) ) (!  (=> (|$IsValid'address'| addr1@@30) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@30)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@30))))
 :qid |DualAttestationbpl.15047:15|
 :skolemid |337|
))) (=> (forall ((addr1@@31 Int) ) (!  (=> (|$IsValid'address'| addr1@@31) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@31)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@31))))
 :qid |DualAttestationbpl.15047:15|
 :skolemid |337|
)) (and (=> (= (ControlFlow 0 247334) (- 0 333691)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)))) (and (=> (= (ControlFlow 0 247334) (- 0 333708)) (forall ((addr1@@32 Int) ) (!  (=> (|$IsValid'address'| addr1@@32) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@32) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@32)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@32)))))
 :qid |DualAttestationbpl.15057:15|
 :skolemid |338|
))) (=> (forall ((addr1@@33 Int) ) (!  (=> (|$IsValid'address'| addr1@@33) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@33) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@33)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@33)))))
 :qid |DualAttestationbpl.15057:15|
 :skolemid |338|
)) (=> (= (ControlFlow 0 247334) (- 0 333744)) (forall ((addr1@@34 Int) ) (!  (=> (|$IsValid'address'| addr1@@34) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@34) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@34)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@34)))))
 :qid |DualAttestationbpl.15062:15|
 :skolemid |339|
)))))))))))))))))))
(let ((L3_correct@@1  (and (=> (= (ControlFlow 0 247122) (- 0 333566)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@14))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@14)) (=> (= (ControlFlow 0 247122) (- 0 333572)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@14)) (= 5 $t6@0@@1)))))))
(let ((anon12_Then_correct@@2  (=> (and (and $abort_flag@0@@3 (= $abort_code@1@@3 $abort_code@1@@3)) (and (= $t6@0@@1 $abort_code@1@@3) (= (ControlFlow 0 247348) 247122))) L3_correct@@1)))
(let ((anon11_Then$1_correct@@1  (=> (= $t7@1@@0 $t7@@3) (=> (and (= $abort_flag@0@@3 true) (= $abort_code@1@@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 247400) 247348) anon12_Then_correct@@2) (=> (= (ControlFlow 0 247400) 247334) anon12_Else_correct@@2))))))
(let ((anon11_Then_correct@@7  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@14)) (= (ControlFlow 0 247398) 247400)) anon11_Then$1_correct@@1)))
(let ((anon11_Else_correct@@7  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@14) (=> (and (and (= $t7@0@@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@14)) (= $t7@1@@0 $t7@0@@0)) (and (= $abort_flag@0@@3 false) (= $abort_code@1@@3 $abort_code@0@@3))) (and (=> (= (ControlFlow 0 247140) 247348) anon12_Then_correct@@2) (=> (= (ControlFlow 0 247140) 247334) anon12_Else_correct@@2))))))
(let ((anon10_Then_correct@@6  (=> $t3@0@@0 (and (=> (= (ControlFlow 0 247126) 247398) anon11_Then_correct@@7) (=> (= (ControlFlow 0 247126) 247140) anon11_Else_correct@@7)))))
(let ((anon10_Else_correct@@6  (=> (and (and (not $t3@0@@0) (= $t5@@8 $t5@@8)) (and (= $t6@0@@1 $t5@@8) (= (ControlFlow 0 247090) 247122))) L3_correct@@1)))
(let ((anon0$1_correct@@14  (=> (and (forall ((addr1@@35 Int) ) (!  (=> (|$IsValid'address'| addr1@@35) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@35) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@35)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@35)) 2)))))
 :qid |DualAttestationbpl.14939:20|
 :skolemid |334|
)) (|$IsValid'address'| _$t0@@14)) (=> (and (and (and (forall (($a_0@@32 Int) ) (! (let (($rsc@@32 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) $a_0@@32)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@32))
 :qid |DualAttestationbpl.14946:20|
 :skolemid |335|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) $a_0@@32))
)) (= _$t0@@14 _$t0@@14)) (and (= $t3@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@14)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5@@8) (= $t5@@8 5)) (and (= $t5@@8 $t5@@8) (= $t3@0@@0 $t3@0@@0)))) (and (=> (= (ControlFlow 0 247074) 247126) anon10_Then_correct@@6) (=> (= (ControlFlow 0 247074) 247090) anon10_Else_correct@@6))))))
(let ((inline$$InitEventStore$0$anon0_correct@@14  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@16 T@$1_Event_EventHandle) ) (! (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $es) handle@@16)))
 (and (= (|l#Multiset_93630| stream@@15) 0) (forall ((v@@66 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@15) v@@66) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2823:13|
 :skolemid |103|
))) (= (ControlFlow 0 246953) 247074)) anon0$1_correct@@14)))
(let ((anon0_correct@@14  (=> (= (ControlFlow 0 333289) 246953) inline$$InitEventStore$0$anon0_correct@@14)))
anon0_correct@@14))))))))))))
))
(check-sat)
(pop 1)
