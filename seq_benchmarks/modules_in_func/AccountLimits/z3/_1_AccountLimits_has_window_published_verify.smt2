...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 272280) (let ((anon0$1_correct  (=> (and (and (and (forall ((window_addr Int) ) (!  (=> (|$IsValid'address'| window_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) window_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) window_addr)))))
 :qid |AccountLimitsbpl.9482:20|
 :skolemid |222|
)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) addr) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr)) 6)))))
 :qid |AccountLimitsbpl.9486:20|
 :skolemid |223|
))) (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) $a_0)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc))
 :qid |AccountLimitsbpl.9493:20|
 :skolemid |224|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) $a_0))
)))) (and (and (= _$t0 _$t0) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) _$t0))) (and (= $t1@0 $t1@0) (= (ControlFlow 0 217477) (- 0 272456))))) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) _$t0)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 217317) 217477)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 272280) 217317) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
