...
procedure {:timeLimit 40} $1_DiemTimestamp_update_global_time$verify(_$t0: int, _$t1: int, _$t2: int) returns ()
{
    ...
    // @110 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:9+52
...
L5:
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:124:9+61
    assume {:print "$at(38,5624,5685)"} true;
    assert {:msg "assert_failed(38,5624,5685): global memory invariant does not hold"}
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:127:9+69
    assume {:print "$at(38,5741,5810)"} true;
    assert {:msg "assert_failed(38,5741,5810): global memory invariant does not hold"}
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:140:9+112
    assume {:print "$at(38,6284,6396)"} true;
    assert {:msg "assert_failed(38,6284,6396): global memory invariant does not hold"}
...
L7:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@110]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
...
L8:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_operating[@110]()), Neq<address>(Signer::spec_address_of[]($t0), 0)), (if Eq<address>($t1, 0) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}})) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:74:5+745
    assume {:print "$at(17,3378,4123)"} true;
    assert {:msg "assert_failed(17,3378,4123): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#110) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 0)) || if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)));

    // assert Or(Or(And(Not(DiemTimestamp::$is_operating[@110]()), Eq(1, $t11)), And(Neq<address>(Signer::spec_address_of[]($t0), 0), Eq(2, $t11))), And((if Eq<address>($t1, 0) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}}), Eq(7, $t11))) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:74:5+745
    assert {:msg "assert_failed(17,3378,4123): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#110) && $IsEqual'num'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 0) && $IsEqual'num'(2, $t11))) || (if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'num'(7, $t11)));
...
L8:
    ...
    // @145 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@145](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
...
L7:
    ...
    // @179 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@179](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
...
L6:
    ...
    // @151 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@151](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
...
procedure {:timeLimit 40} $1_XDX_initialize$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(38,2328,3301)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));
    ...
    // @213 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/XDX.move:48:5+1
    assume {:print "$at(38,2328,2329)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @210 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/XDX.move:48:5+1
    $1_Roles_RoleId_$memory#210 := $1_Roles_RoleId_$memory;

    // @214 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/XDX.move:48:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#214 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @211 := save_mem(DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/XDX.move:48:5+1
    ...
    // @212 := save_mem(DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/XDX.move:48:5+1
    ...
    // @209 := save_mem(Diem::CurrencyInfo<XDX::XDX>) at /home/ying/diem/language/diem-framework/modules/XDX.move:48:5+1
    $1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#209 := $1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory;

    // @215 := save_mem(AccountLimits::LimitsDefinition<XDX::XDX>) at /home/ying/diem/language/diem-framework/modules/XDX.move:48:5+1
    $1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory#215 := $1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory;

    // @208 := save_mem(XDX::Reserve) at /home/ying/diem/language/diem-framework/modules/XDX.move:48:5+1
...
L8:
    ...
    // @239 := save_mem(XDX::Reserve) at /home/ying/diem/language/diem-framework/modules/XDX.move:48:5+973
    ...
    // assert Implies(exists[@239]<XDX::Reserve>(XDX::$reserve_address[]()), exists<XDX::Reserve>(XDX::$reserve_address())) at /home/ying/diem/language/diem-framework/modules/XDX.move:148:9+108
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:148:9+108
    assume {:print "$at(38,6645,6753)"} true;
    assert {:msg "assert_failed(38,6645,6753): global memory invariant does not hold"}
...
L2:
    ...
    // assert Not(exists[@208]<XDX::Reserve>(a550c18)) at /home/ying/diem/language/diem-framework/modules/XDX.move:74:9+68
    assume {:print "$at(38,3442,3510)"} true;
    assert {:msg "assert_failed(38,3442,3510): function does not abort under this condition"}
      !$ResourceExists($1_XDX_Reserve_$memory#208, 173345816);
    ...
    // assert Not(exists[@209]<Diem::CurrencyInfo<XDX::XDX>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/Diem.move:1281:9+121
    ...
    // assert Not(Not(exists[@210]<Roles::RoleId>($t7))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t7)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    ...
    // assert Not(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@211]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 68, 88])) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:70:9+154
    ...
    // assert Not(Not(exists[@212]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:137:9+129
    ...
    // assert Not(Not(exists[@211]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:101:9+76
    assume {:print "$at(13,3859,3935)"} true;
    assert {:msg "assert_failed(13,3859,3935): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211, 173345816);
    ...
    // assert Not(exists[@215]<AccountLimits::LimitsDefinition<XDX::XDX>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:208:9+130
    assume {:print "$at(5,8823,8953)"} true;
    assert {:msg "assert_failed(5,8823,8953): function does not abort under this condition"}
      !$ResourceExists($1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory#215, $1_Signer_spec_address_of($t0));

    // assert Not(Not(DiemTimestamp::$is_genesis[@213]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:140:9+51
    ...
    // assert Not(Not(exists[@210]<Roles::RoleId>($t10))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    assume {:print "$at(26,23574,23633)"} true;
    assert {:msg "assert_failed(26,23574,23633): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#210, $t10);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t10)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    assume {:print "$at(26,23642,23729)"} true;
    assert {:msg "assert_failed(26,23642,23729): function does not abort under this condition"}
    ...
    // assert Not(Not(exists[@210]<Roles::RoleId>($t11))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t11)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    ...
    assume {:print "$at(5,9062,9147)"} true;
    assert {:msg "assert_failed(5,9062,9147): post-condition does not hold"}
    ...
    assume {:print "$at(38,3979,4014)"} true;
    assert {:msg "assert_failed(38,3979,4014): post-condition does not hold"}
      $ResourceExists($1_XDX_Reserve_$memory, 173345816);
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Neq<address>(Signer::spec_address_of[]($t0), a550c18), exists[@208]<XDX::Reserve>(a550c18)), Or(Eq<u64>(1000000, 0), Gt(1000000, 10000000000))), exists[@209]<Diem::CurrencyInfo<XDX::XDX>>(Signer::spec_address_of[]($t0))), Not(exists[@210]<Roles::RoleId>($t7))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t7)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@211]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 68, 88])), Not(exists[@212]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))), Not(exists[@211]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(a550c18))), And(And(And(And(DiemTimestamp::$is_operating[@213](), DiemConfig::$reconfiguration_enabled[@214]()), Gt(DiemTimestamp::spec_now_microseconds[@213](), 0)), Lt(select DiemConfig::Configuration.epoch($t8), 18446744073709551615)), Lt($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8)))), exists[@215]<AccountLimits::LimitsDefinition<XDX::XDX>>(Signer::spec_address_of[]($t0))), Not(DiemTimestamp::$is_genesis[@213]())), Not(exists[@210]<Roles::RoleId>($t10))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t10)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), Not(exists[@210]<Roles::RoleId>($t11))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t11)), 1)), Neq<address>(Signer::spec_address_of[]($t1), b1e55ed)) at /home/ying/diem/language/diem-framework/modules/XDX.move:71:5+1237
    assume {:print "$at(38,3306,4543)"} true;
    assert {:msg "assert_failed(38,3306,4543): abort not covered by any of the `aborts_if` clauses"}
      (((((((((((((((((((!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) || $ResourceExists($1_XDX_Reserve_$memory#208, 173345816)) || ($IsEqual'num'(1000000, 0) || (1000000 > 10000000000))) || $ResourceExists($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#209, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t7)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t7)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || $ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211)), MakeVec3(88, 68, 88))) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211, 173345816)) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#214)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) > 0)) && ($epoch#$1_DiemConfig_Configuration($t8) < 18446744073709551615)) && ($t9 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t8)))) || $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory#215, $1_Signer_spec_address_of($t0))) || !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213)) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t10)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t10)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t11)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t11)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t13)), And(exists[@208]<XDX::Reserve>(a550c18), Eq(6, $t13))), And(Or(Eq<u64>(1000000, 0), Gt(1000000, 10000000000)), Eq(7, $t13))), And(exists[@209]<Diem::CurrencyInfo<XDX::XDX>>(Signer::spec_address_of[]($t0)), Eq(6, $t13))), And(Not(exists[@210]<Roles::RoleId>($t7)), Eq(5, $t13))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t7)), 0), Eq(3, $t13))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t13))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t13))), And(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@211]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 68, 88]), Eq(7, $t13))), And(Not(exists[@212]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))), Eq(4, $t13))), And(Not(exists[@211]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(a550c18)), Eq(5, $t13))), And(And(And(And(And(DiemTimestamp::$is_operating[@213](), DiemConfig::$reconfiguration_enabled[@214]()), Gt(DiemTimestamp::spec_now_microseconds[@213](), 0)), Lt(select DiemConfig::Configuration.epoch($t8), 18446744073709551615)), Lt($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8))), Eq(1, $t13))), And(exists[@215]<AccountLimits::LimitsDefinition<XDX::XDX>>(Signer::spec_address_of[]($t0)), Eq(6, $t13))), And(Not(DiemTimestamp::$is_genesis[@213]()), Eq(1, $t13))), And(Not(exists[@210]<Roles::RoleId>($t10)), Eq(5, $t13))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t10)), 0), Eq(3, $t13))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t13))), And(Not(exists[@210]<Roles::RoleId>($t11)), Eq(5, $t13))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t11)), 1), Eq(3, $t13))), And(Neq<address>(Signer::spec_address_of[]($t1), b1e55ed), Eq(2, $t13))) at /home/ying/diem/language/diem-framework/modules/XDX.move:71:5+1237
    assert {:msg "assert_failed(38,3306,4543): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((((((((((((((!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t13)) || ($ResourceExists($1_XDX_Reserve_$memory#208, 173345816) && $IsEqual'num'(6, $t13))) || (($IsEqual'num'(1000000, 0) || (1000000 > 10000000000)) && $IsEqual'num'(7, $t13))) || ($ResourceExists($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#209, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(6, $t13))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t7) && $IsEqual'num'(5, $t13))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t7)), 0) && $IsEqual'num'(3, $t13))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t13))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t13))) || ($ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211)), MakeVec3(88, 68, 88)) && $IsEqual'num'(7, $t13))) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(4, $t13))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211, 173345816) && $IsEqual'num'(5, $t13))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#214)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) > 0)) && ($epoch#$1_DiemConfig_Configuration($t8) < 18446744073709551615)) && ($t9 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t8))) && $IsEqual'num'(1, $t13))) || ($ResourceExists($1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory#215, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(6, $t13))) || (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) && $IsEqual'num'(1, $t13))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t10) && $IsEqual'num'(5, $t13))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t10)), 0) && $IsEqual'num'(3, $t13))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t13))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t11) && $IsEqual'num'(5, $t13))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t11)), 1) && $IsEqual'num'(3, $t13))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453) && $IsEqual'num'(2, $t13)));
...
// fun XDX::is_xdx [verification] at /home/ying/diem/language/diem-framework/modules/XDX.move:96:5+165
procedure {:timeLimit 40} $1_XDX_is_xdx$verify() returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XDX::XDX>()) at /home/ying/diem/language/diem-framework/modules/XDX.move:96:5+165
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:127:9+69
    assume {:print "$at(38,4598,4763)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Diem_$is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory));
    ...
    assume {:print "$at(38,4907,4913)"} true;
    assume (forall $a_0: int :: {$ResourceValue($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory, $a_0)}(var $rsc := $ResourceValue($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory, $a_0);
    (($IsValid'$1_Diem_CurrencyInfo'$1_XDX_XDX''($rsc) && ((0 < $scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'($rsc)) && ($scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'($rsc) <= 10000000000))))));
    ...
    // @112 := save_mem(Diem::CurrencyInfo<XDX::XDX>) at /home/ying/diem/language/diem-framework/modules/XDX.move:96:5+1
    assume {:print "$at(38,4598,4599)"} true;
    $1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#112 := $1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory;

    // @111 := save_mem(Diem::CurrencyInfo<#0>) at /home/ying/diem/language/diem-framework/modules/XDX.move:96:5+1
    ...
    assume {:print "$at(38,4651,4680)"} true;
...
L1:
    ...
    assume {:print "$at(38,4696,4727)"} true;
L0:
...
L9:
    ...
    assume {:print "$at(38,4731,4757)"} true;
    assume {:print "$track_abort(21,1):", $t2} $t2 == $t2;
...
L8:
    ...
    assume {:print "$at(38,4651,4757)"} true;
    $t0 := $t7;
...
L3:
    ...
    assume {:print "$at(38,4762,4763)"} true;
L4:

    // assert Not(And(Diem::spec_is_currency[@111]<#0>(), Not(Diem::spec_is_currency[@112]<XDX::XDX>()))) at /home/ying/diem/language/diem-framework/modules/Diem.move:1549:9+67
    ...
    assume {:print "$at(38,4899,4941)"} true;
    assert {:msg "assert_failed(38,4899,4941): post-condition does not hold"}
...
L5:
    ...
    // assert And(Diem::spec_is_currency[@111]<#0>(), Not(Diem::spec_is_currency[@112]<XDX::XDX>())) at /home/ying/diem/language/diem-framework/modules/XDX.move:100:5+179
    assume {:print "$at(38,4768,4947)"} true;
    assert {:msg "assert_failed(38,4768,4947): abort not covered by any of the `aborts_if` clauses"}
      ($1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#111) && !$1_Diem_spec_is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#112));

    // assert And(And(Diem::spec_is_currency[@111]<#0>(), Not(Diem::spec_is_currency[@112]<XDX::XDX>())), Eq(5, $t2)) at /home/ying/diem/language/diem-framework/modules/XDX.move:100:5+179
    assert {:msg "assert_failed(38,4768,4947): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (($1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#111) && !$1_Diem_spec_is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#112)) && $IsEqual'num'(5, $t2));
...
procedure {:timeLimit 40} $1_XDX_reserve_address$verify() returns ($ret0: int)
{
    ...
    assume {:print "$at(38,5310,5323)"} true;
    $t0 := 173345816;
    assume $IsValid'address'($t0);
    ...
    assume {:print "$at(38,5328,5329)"} true;
L1:
...
L7:
    ...
    // @169 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@169](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
...
L7:
    ...
    // @163 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@163](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
...
L7:
    ...
    // @157 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@157](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
