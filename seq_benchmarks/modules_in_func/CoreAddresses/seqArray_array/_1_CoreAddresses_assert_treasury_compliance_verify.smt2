...
(assert (forall ((s1 T@Vec_2977) (s2 T@Vec_2977) (k1@@0 T@Vec_2977) (k2@@0 T@Vec_2977) (m1 T@Vec_2977) (m2 T@Vec_2977) ) (!  (=> (and (and (|$IsEqual'vec'u8''| s1 s2) (|$IsEqual'vec'u8''| k1@@0 k2@@0)) (|$IsEqual'vec'u8''| m1 m2)) (= ($1_Signature_$ed25519_verify s1 k1@@0 m1) ($1_Signature_$ed25519_verify s2 k2@@0 m2)))
 :qid |CoreAddressesbpl.893:15|
 :skolemid |27|
 :pattern ( ($1_Signature_$ed25519_verify s1 k1@@0 m1) ($1_Signature_$ed25519_verify s2 k2@@0 m2))
)))
(assert (forall ((s T@$signer) ) (!  (=> (|$IsValid'address'| (|$addr#$signer| s)) ($1_Signer_is_signer (|$addr#$signer| s)))
 :qid |CoreAddressesbpl.932:15|
 :skolemid |28|
)))
(assert (forall ((addr Int) ) (! true
 :qid |CoreAddressesbpl.936:15|
 :skolemid |29|
)))
...
(assert (not
 (=> (= (ControlFlow 0 0) 12766) (let ((anon4_Else_correct@@1  (=> (and (not $t5@0@@1) (= $t7@@1 $t7@@1)) (and (=> (= (ControlFlow 0 11574) (- 0 12910)) (not (= (|$addr#$signer| _$t0@@1) 186537453))) (=> (not (= (|$addr#$signer| _$t0@@1) 186537453)) (=> (= (ControlFlow 0 11574) (- 0 12919)) (and (not (= (|$addr#$signer| _$t0@@1) 186537453)) (= 2 $t7@@1))))))))
(let ((anon4_Then_correct@@1  (=> (and $t5@0@@1 (= (ControlFlow 0 11594) (- 0 12883))) (not (not (= (|$addr#$signer| _$t0@@1) 186537453))))))
(let ((anon0$1_correct@@1  (=> (|$IsValid'address'| (|$addr#$signer| _$t0@@1)) (=> (and (= _$t0@@1 _$t0@@1) (|$IsValid'address'| $t3@@1)) (=> (and (and (and (= $t3@@1 (|$addr#$signer| _$t0@@1)) (|$IsValid'address'| 186537453)) (and (= $t5@0@@1 (= $t3@@1 186537453)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t7@@1) (= $t7@@1 2)) (and (= $t7@@1 $t7@@1) (= $t5@0@@1 $t5@0@@1)))) (and (=> (= (ControlFlow 0 11526) 11594) anon4_Then_correct@@1) (=> (= (ControlFlow 0 11526) 11574) anon4_Else_correct@@1)))))))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 12766) 11526) anon0$1_correct@@1)))
anon0_correct@@1)))))
))
(check-sat)
(pop 1)
