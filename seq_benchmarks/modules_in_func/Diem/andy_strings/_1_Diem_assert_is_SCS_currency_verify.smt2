...
(assert (not
 (=> (= (ControlFlow 0 0) 1064524) (let ((anon10_Else_correct@@9 true))
(let ((anon10_Then_correct@@9  (=> |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| (and (=> (= (ControlFlow 0 703123) (- 0 1065274)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 703123) (- 0 1065295)) (forall ((addr@@277 Int) ) (!  (=> (|$IsValid'address'| addr@@277) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@277)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@277))))
 :qid |Diembpl.11342:15|
 :skolemid |451|
))) (=> (forall ((addr@@278 Int) ) (!  (=> (|$IsValid'address'| addr@@278) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@278)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@278))))
 :qid |Diembpl.11342:15|
 :skolemid |451|
)) (and (=> (= (ControlFlow 0 703123) (- 0 1065324)) (forall ((addr@@279 Int) ) (!  (=> (|$IsValid'address'| addr@@279) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@279) (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@279)))
 :qid |Diembpl.11347:15|
 :skolemid |452|
))) (=> (forall ((addr@@280 Int) ) (!  (=> (|$IsValid'address'| addr@@280) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@280) (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@280)))
 :qid |Diembpl.11347:15|
 :skolemid |452|
)) (and (=> (= (ControlFlow 0 703123) (- 0 1065349)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 703123) (- 0 1065370)) (forall ((addr@@281 Int) ) (!  (=> (|$IsValid'address'| addr@@281) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@281)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@281))))
 :qid |Diembpl.11357:15|
 :skolemid |453|
))) (=> (forall ((addr@@282 Int) ) (!  (=> (|$IsValid'address'| addr@@282) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@282)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@282))))
 :qid |Diembpl.11357:15|
 :skolemid |453|
)) (and (=> (= (ControlFlow 0 703123) (- 0 1065399)) (forall ((addr@@283 Int) ) (!  (=> (|$IsValid'address'| addr@@283) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@283) (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@283)))
 :qid |Diembpl.11362:15|
 :skolemid |454|
))) (=> (forall ((addr@@284 Int) ) (!  (=> (|$IsValid'address'| addr@@284) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@284) (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@284)))
 :qid |Diembpl.11362:15|
 :skolemid |454|
)) (and (=> (= (ControlFlow 0 703123) (- 0 1065424)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 703123) (- 0 1065445)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 703123) (- 0 1065466)) (forall ((addr@@285 Int) ) (!  (=> (|$IsValid'address'| addr@@285) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@285) (|Select__T@[Int]Bool_| (|domain#$Memory_308343| |$1_Diem_Preburn'#0'_$memory|) addr@@285))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@285))))
 :qid |Diembpl.11377:15|
 :skolemid |455|
))) (=> (forall ((addr@@286 Int) ) (!  (=> (|$IsValid'address'| addr@@286) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@286) (|Select__T@[Int]Bool_| (|domain#$Memory_308343| |$1_Diem_Preburn'#0'_$memory|) addr@@286))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@286))))
 :qid |Diembpl.11377:15|
 :skolemid |455|
)) (and (=> (= (ControlFlow 0 703123) (- 0 1065502)) (forall ((addr@@287 Int) ) (!  (=> (|$IsValid'address'| addr@@287) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@287) (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@287)))
 :qid |Diembpl.11382:15|
 :skolemid |456|
))) (=> (forall ((addr@@288 Int) ) (!  (=> (|$IsValid'address'| addr@@288) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@288) (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@288)))
 :qid |Diembpl.11382:15|
 :skolemid |456|
)) (=> (= (ControlFlow 0 703123) (- 0 1065527)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))))))))))))))))))))))))
(let ((anon9_Else_correct@@8  (=> (and (not $abort_flag@2) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t6@@13) (= $t6@@13 1)) (and (= $t6@@13 $t6@@13) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 702815) 703123) anon10_Then_correct@@9) (=> (= (ControlFlow 0 702815) 702831) anon10_Else_correct@@9))))))
(let ((anon9_Then_correct@@8 true))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$L5_correct|  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 |inline$$1_Diem_is_SCS_currency'#0'$0$$t2@1|) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 702707) 703137) anon9_Then_correct@@8) (=> (= (ControlFlow 0 702707) 702815) anon9_Else_correct@@8))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|  (=> (and (and $abort_flag@0@@5 (= $abort_code@1@@5 $abort_code@1@@5)) (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t2@1| $abort_code@1@@5) (= (ControlFlow 0 702701) 702707))) |inline$$1_Diem_is_SCS_currency'#0'$0$L5_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|  (=> (and (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1|) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1|))) (and (=> (= (ControlFlow 0 702603) 703137) anon9_Then_correct@@8) (=> (= (ControlFlow 0 702603) 702815) anon9_Else_correct@@8)))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else$1_correct|  (=> (= inline$$Not$0$dst@1@@0 inline$$Not$0$dst@1@@0) (=> (and (and (= $abort_code@2 $abort_code@1@@5) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| inline$$Not$0$dst@1@@0)) (and (= $abort_flag@1 $abort_flag@0@@5) (= (ControlFlow 0 702687) 702603))) |inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|))))
(let ((inline$$Not$0$anon0_correct@@0  (=> (and (= inline$$Not$0$dst@1@@0  (not |inline$$1_Diem_is_SCS_currency'#0'$0$$t5@1|)) (= (ControlFlow 0 702669) 702687)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else$1_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|  (=> (not $abort_flag@0@@5) (=> (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t5@1| (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2|)) (= (ControlFlow 0 702675) 702669)) inline$$Not$0$anon0_correct@@0))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then$1_correct|  (=> (= $abort_flag@0@@5 true) (=> (and (= $abort_code@1@@5 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@0|)) (and (=> (= (ControlFlow 0 702759) 702701) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 702759) 702675) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 702757) 702759)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then$1_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@1| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $abort_flag@0@@5 false)) (and (= $abort_code@1@@5 $abort_code@0@@5) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@1|))) (and (=> (= (ControlFlow 0 702627) 702701) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 702627) 702675) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Then_correct|  (=> (and |inline$$1_Diem_is_currency'#0'$0$$t1@1| (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 702613) 702757) |inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 702613) 702627) |inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Else_correct|)))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Else_correct|  (=> (and (not |inline$$1_Diem_is_currency'#0'$0$$t1@1|) (= false false)) (=> (and (and (= $abort_code@2 $abort_code@0@@5) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| false)) (and (= $abort_flag@1 false) (= (ControlFlow 0 702591) 702603))) |inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Else_correct|  (=> (not false) (and (=> (= (ControlFlow 0 702571) 702613) |inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 702571) 702591) |inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Else_correct|)))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Then_correct| true))
(let ((|inline$$1_Diem_is_currency'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| |inline$$1_Diem_is_currency'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 702557) 702773) |inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 702557) 702571) |inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Else_correct|))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon0_correct|  (=> (= (ControlFlow 0 702563) 702557) |inline$$1_Diem_is_currency'#0'$0$anon0_correct|)))
(let ((anon8_Else_correct@@0  (=> (and (not $t2@@10) (= (ControlFlow 0 702779) 702563)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon0_correct|)))
(let ((anon8_Then_correct@@0 true))
(let ((anon0$1_correct@@19  (=> (and (and (and (and (forall ((addr3@@26 Int) ) (!  (=> (|$IsValid'address'| addr3@@26) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3@@26) (and (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.11219:22|
 :skolemid |441|
)) (forall ((addr3@@27 Int) ) (!  (=> (|$IsValid'address'| addr3@@27) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@27) (and (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |Diembpl.11219:261|
 :skolemid |442|
))) (forall ((addr3@@28 Int) ) (!  (=> (|$IsValid'address'| addr3@@28) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr3@@28) (and (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |Diembpl.11219:501|
 :skolemid |443|
))) (and (and (forall ((addr@@289 Int) ) (!  (=> (|$IsValid'address'| addr@@289) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308049| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@289) (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.11223:22|
 :skolemid |444|
)) (forall ((addr@@290 Int) ) (!  (=> (|$IsValid'address'| addr@@290) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308196| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@290) (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.11223:222|
 :skolemid |445|
))) (forall ((addr@@291 Int) ) (!  (=> (|$IsValid'address'| addr@@291) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308343| |$1_Diem_Preburn'#0'_$memory|) addr@@291) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.11223:423|
 :skolemid |446|
)))) (and (and (and (forall ((addr@@292 Int) ) (!  (=> (|$IsValid'address'| addr@@292) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307989| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@292) (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.11227:22|
 :skolemid |447|
)) (forall ((addr@@293 Int) ) (!  (=> (|$IsValid'address'| addr@@293) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308136| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@293) (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.11227:227|
 :skolemid |448|
))) (forall ((addr@@294 Int) ) (!  (=> (|$IsValid'address'| addr@@294) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@294) (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.11227:433|
 :skolemid |449|
))) (and (forall (($a_0@@23 Int) ) (! (let (($rsc@@23 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@23)))
 ...
 :qid |Diembpl.11230:20|
 :skolemid |450|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@23))
)) (= $t2@@10  (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 702224) 703163) anon8_Then_correct@@0) (=> (= (ControlFlow 0 702224) 702779) anon8_Else_correct@@0)))))
(let ((inline$$InitEventStore$0$anon0_correct@@19  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@21 T@$1_Event_EventHandle) ) (! (let ((stream@@20 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@21)))
 (and (= (|l#Multiset_274042| stream@@20) 0) (forall ((v@@58 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_274042| stream@@20) v@@58) 0)
 :qid |Diembpl.134:13|
 :skolemid |2|
))))
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 701945) 702224)) anon0$1_correct@@19)))
(let ((anon0_correct@@19  (=> (= (ControlFlow 0 1064524) 701945) inline$$InitEventStore$0$anon0_correct@@19)))
anon0_correct@@19)))))))))))))))))))))))))
))
(check-sat)
(pop 1)
