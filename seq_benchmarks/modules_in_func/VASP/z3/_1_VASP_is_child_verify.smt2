...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 52652) (let ((anon0$1_correct  (=> (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_32198| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |VASPbpl.2169:20|
 :skolemid |70|
...
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 45028) (- 0 52812)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 45028) (- 0 52819)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0))) (=> (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0)) (and (=> (= (ControlFlow 0 45028) (- 0 52830)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (= (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) a)))
 :qid |VASPbpl.2217:15|
 :skolemid |73|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_20373_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPbpl.1472:13|
 :skolemid |39|
))) (= (ControlFlow 0 44826) 45028)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 52652) 44826) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
