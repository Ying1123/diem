...
(declare-fun $t12@@2 () T@Vec_184062)
(declare-fun |Select__T@[Int]$1_VASPDomain_VASPDomains_| (|T@[Int]$1_VASPDomain_VASPDomains| Int) T@$1_VASPDomain_VASPDomains)
(declare-fun $1_VASPDomain_VASPDomains_$memory@2 () T@$Memory_291108)
(declare-fun _$t1@@2 () Int)
(declare-fun $1_VASPDomain_VASPDomains_$memory () T@$Memory_291108)
(declare-fun $t3@@2 () T@Vec_184062)
(declare-fun _$t2 () T@Vec_25539)
...
(declare-fun $1_VASPDomain_VASPDomains_$memory@0 () T@$Memory_291108)
(declare-fun $es@0@@2 () T@$EventStore)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 () Int)
(declare-fun $1_VASPDomain_VASPDomains_$memory@1 () T@$Memory_291108)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t34@1 () T@$Mutation_223780)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t36@1 () T@$1_VASPDomain_VASPDomainEvent)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t33@2 () T@$Mutation_291209)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t33@0 () T@$Mutation_291209)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t33@1 () T@$Mutation_291209)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t24@3 () T@$Mutation_291144)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t24@2 () T@$Mutation_291144)
(declare-fun |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$m'@1| () T@$Mutation_204852)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t31@1 () T@$Mutation_204852)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t26@1 () T@Vec_184062)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t24@0 () T@$Mutation_291144)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t24@1 () T@$Mutation_291144)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t9@0 () T@$Mutation_291144)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t31@0 () T@$Mutation_204852)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t34@0 () T@$Mutation_223780)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t11@0 () T@Vec_184062)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t35@1 () T@$Mutation_223780)
(declare-fun $es@0@@3 () T@$EventStore)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t37@1 () T@$1_VASPDomain_VASPDomainEvent)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t34 () T@$Mutation_291209)
(declare-fun inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0 () T@$1_VASPDomain_VASPDomain)
(declare-fun _$t1@@3 () Int)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t34@1 () T@$Mutation_291209)
(declare-fun $abort_code@3@@0 () Int)
(declare-fun $abort_flag@2@@0 () Bool)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@3 () T@$Mutation_291144)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2 () T@$Mutation_291144)
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'| () T@$Mutation_204852)
(declare-fun $1_VASPDomain_VASPDomains_$memory@0@@0 () T@$Memory_291108)
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| () T@Vec_184062)
...
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@1| () T@$Mutation_204852)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t31@1 () T@$Mutation_204852)
(declare-fun DefaultVecElem_164571 () T@$1_VASPDomain_VASPDomain)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t26@1 () T@Vec_184062)
...
(declare-fun _$t2@@0 () T@Vec_25539)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@0 () T@$Mutation_291144)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@1 () T@$Mutation_291144)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t7@0 () T@$Mutation_291144)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t31@0 () T@$Mutation_204852)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t34@0 () T@$Mutation_291209)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t35@0 () T@$Mutation_223780)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t11@0 () T@Vec_184062)
...
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@2@@0| () T@$Memory_310063)
(declare-fun $t29@@2 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@2@@0| () T@$Memory_239540)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@1@@0| () T@$Memory_239540)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@0@@0| () T@$Memory_239540)
(declare-fun |$temp_0'$1_Diem_CurrencyInfo'#0''@0@@0| () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |$temp_0'bool'@4@@2| () Bool)
(declare-fun |$1_AccountLimits_Window'#0'_$memory@1@@0| () T@$Memory_284162)
(declare-fun |$1_AccountLimits_Window'#0'_$memory@0@@0| () T@$Memory_284162)
(declare-fun |$temp_0'$1_AccountLimits_Window'#0''@0@@0| () |T@$1_AccountLimits_Window'#0'|)
(declare-fun |$temp_0'bool'@3@@2| () Bool)
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@1@@0| () T@$Memory_310063)
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@0@@0| () T@$Memory_310063)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@2 () T@$Memory_310146)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@2 () T@$Memory_310146)
...
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@2@@0| () T@$Memory_309897)
(declare-fun $t29@@3 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2@@0| () T@$Memory_239245)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@1@@0| () T@$Memory_239245)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0@@0| () T@$Memory_239245)
(declare-fun |$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@0@@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |$temp_0'bool'@4@@3| () Bool)
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@1@@0| () T@$Memory_284034)
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0@@0| () T@$Memory_284034)
...
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@1@@0| () T@$Memory_309897)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@0@@0| () T@$Memory_309897)
(declare-fun |$temp_0'$1_DiemAccount_Balance'$1_XUS_XUS''@0@@0| () |T@$1_DiemAccount_Balance'$1_XUS_XUS'|)
(declare-fun |$temp_0'bool'@2@@3| () Bool)
(declare-fun |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory@1| () T@$Memory_305902)
(declare-fun |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory| () T@$Memory_305902)
(declare-fun |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory@0| () T@$Memory_305902)
...
(declare-fun $1_DesignatedDealer_Dealer_$memory@1@@0 () T@$Memory_305546)
(declare-fun $1_DesignatedDealer_Dealer_$memory@0@@0 () T@$Memory_305546)
(declare-fun |$temp_0'$1_DesignatedDealer_Dealer'@0@@0| () T@$1_DesignatedDealer_Dealer)
(declare-fun |$temp_0'bool'@0@@3| () Bool)
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@3 () T@$Memory_310146)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@3 () T@$Memory_310146)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@0 () T@$Memory_232707)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@0 () T@$Memory_232707)
...
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2@@0| () T@$Memory_309980)
(declare-fun $t29@@4 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@0| () T@$Memory_239309)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1@@0| () T@$Memory_239309)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@0| () T@$Memory_239309)
(declare-fun |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0@@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |$temp_0'bool'@4@@4| () Bool)
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1@@0| () T@$Memory_284098)
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@0| () T@$Memory_284098)
...
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1@@0| () T@$Memory_309980)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@0@@0| () T@$Memory_309980)
(declare-fun |$temp_0'$1_DiemAccount_Balance'$1_XDX_XDX''@0@@0| () |T@$1_DiemAccount_Balance'$1_XDX_XDX'|)
(declare-fun |$temp_0'bool'@2@@4| () Bool)
(declare-fun |$1_DesignatedDealer_TierInfo'$1_XDX_XDX'_$memory@1| () T@$Memory_306125)
(declare-fun |$1_DesignatedDealer_TierInfo'$1_XDX_XDX'_$memory| () T@$Memory_306125)
(declare-fun |$1_DesignatedDealer_TierInfo'$1_XDX_XDX'_$memory@0| () T@$Memory_306125)
...
(declare-fun $1_DesignatedDealer_Dealer_$memory@1@@1 () T@$Memory_305546)
(declare-fun $1_DesignatedDealer_Dealer_$memory@0@@1 () T@$Memory_305546)
(declare-fun |$temp_0'$1_DesignatedDealer_Dealer'@0@@1| () T@$1_DesignatedDealer_Dealer)
(declare-fun |$temp_0'bool'@0@@4| () Bool)
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@4 () T@$Memory_310146)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@4 () T@$Memory_310146)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@1 () T@$Memory_232707)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@1 () T@$Memory_232707)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@9| () T@$Memory_239540)
(declare-fun $t8@@6 () |T@$1_Diem_Preburn'#0'|)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@6| () T@$Memory_246653)
(declare-fun $es@7 () T@$EventStore)
(declare-fun $t9@@6 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun $t11@@5 () T@$1_Event_EventHandle)
(declare-fun $t10@@6 () T@Vec_25539)
(declare-fun $abort_flag@8 () Bool)
(declare-fun $es@5 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@7| () T@$Memory_239540)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@4| () T@$Memory_246653)
(declare-fun $abort_code@9 () Int)
(declare-fun $es@6 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@8| () T@$Memory_239540)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@5| () T@$Memory_246653)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@6| () T@$Memory_239540)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@3| () T@$Memory_246653)
...
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@2@@0| () T@$Memory_246653)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@5| () T@$Memory_239540)
(declare-fun $es@3 () T@$EventStore)
(declare-fun $abort_flag@7 () Bool)
(declare-fun $abort_code@8 () Int)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0| () Bool)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0| () T@Vec_183907)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t3@1| () |T@$1_Diem_Preburn'#0'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| () T@$Mutation_250954)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| () |T@$1_Diem_Preburn'#0'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1| () T@$Mutation_250954)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@4| () T@$Memory_239540)
(declare-fun $abort_code@7 () Int)
(declare-fun $abort_flag@6 () Bool)
(declare-fun $es@2@@3 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@3| () T@$Memory_239540)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4| () T@$Mutation_259343)
(declare-fun $es@0@@7 () T@$EventStore)
(declare-fun inline$$Not$0$dst@1@@0 () Bool)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@1@@1| () T@$Memory_239540)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| () T@$Memory_239540)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@0| () T@$Mutation_250954)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1| () T@$Mutation_223780)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| () T@Vec_25539)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3| () T@$Mutation_259343)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@0@@1| () T@$Memory_239540)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| () T@$Mutation_259343)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0| () T@$Mutation_259343)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1| () T@$Mutation_259343)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1| () T@$Mutation_259393)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1| () T@$Mutation_250954)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1| () |T@$1_Diem_Diem'#0'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2| () T@$Mutation_259393)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t10@0| () T@$Mutation_259343)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@0| () T@$Mutation_259393)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@0| () T@$Mutation_223780)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t16@0| () T@Vec_25539)
...
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t18@1| () T@Vec_25539)
...
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t24@0| () T@Vec_25539)
...
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@1@@0| () T@$Memory_246653)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@0@@0| () T@$Memory_246653)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'$1_Diem_PreburnQueue'#0''@1| () |T@$1_Diem_PreburnQueue'#0'|)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t19@0| () T@$Mutation_250954)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0| () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t6@0| () T@Vec_25539)
...
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t9@0| () T@Vec_183907)
...
(declare-fun |inline$$1_Diem_burn'#0'$0$$t21@0| () T@Vec_25539)
...
(declare-fun |inline$$1_Diem_burn'#0'$0$$t24@0| () T@Vec_183907)
...
(declare-fun |inline$$1_Diem_burn'#0'$0$$t7@0| () T@Vec_183907)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@2 () T@$Memory_232707)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@2 () T@$Memory_232707)
...
(assert (not
 (=> (= (ControlFlow 0 0) 824295) (let ((L2_correct@@5  (and (=> (= (ControlFlow 0 640855) (- 0 829152)) (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (let (($range_0 ($Range 0 (|l#Vec_183907| $t5@@7))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@141 $i_1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_183907| $t5@@7) i@@141)))) _$t3@@2))))
 :qid |TreasuryComplianceScriptsbpl.36876:452|
 :skolemid |1112|
)))) (= $t6@@7 0)) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7))))) (=> (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (let (($range_0@@0 ($Range 0 (|l#Vec_183907| $t5@@7))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@142 $i_1@@0))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_183907| $t5@@7) i@@142)))) _$t3@@2))))
 :qid |TreasuryComplianceScriptsbpl.36876:452|
 :skolemid |1112|
)))) (= $t6@@7 0)) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7)))) (=> (= (ControlFlow 0 640855) (- 0 829287)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (= 5 $t12@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7) 0)) (= 7 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7))) (= 4 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)) (= 5 $t12@0))) (and (let (($range_0@@1 ($Range 0 (|l#Vec_183907| $t5@@7))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@143 $i_1@@1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_183907| $t5@@7) i@@143)))) _$t3@@2))))
 :qid |TreasuryComplianceScriptsbpl.36881:598|
 :skolemid |1113|
))) (= 1 $t12@0))) (and (= $t6@@7 0) (= 1 $t12@0))) (and (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7) (= 8 $t12@0))) (and (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7) (= 8 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7))) (= 4 $t12@0))) (= 7 $t12@0)) (= 4 $t12@0)) (= 5 $t12@0)) (= 1 $t12@0)) (= 8 $t12@0)))))))
(let ((anon7_Then_correct  (=> (and (and $abort_flag@9 (= $abort_code@10 $abort_code@10)) (and (= $t12@0 $abort_code@10) (= (ControlFlow 0 640421) 640855))) L2_correct@@5)))
(let ((anon6_Then_correct  (=> (and (and $abort_flag@0@@4 (= $abort_code@1@@4 $abort_code@1@@4)) (and (= $t12@0 $abort_code@1@@4) (= (ControlFlow 0 640869) 640855))) L2_correct@@5)))
(let ((anon7_Else_correct  (=> (not $abort_flag@9) (and (=> (= (ControlFlow 0 640407) (- 0 828832)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7)))) (and (=> (= (ControlFlow 0 640407) (- 0 828845)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7) 0))) (and (=> (= (ControlFlow 0 640407) (- 0 828860)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7)))) (and (=> (= (ControlFlow 0 640407) (- 0 828873)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (and (=> (= (ControlFlow 0 640407) (- 0 828884)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (and (=> (= (ControlFlow 0 640407) (- 0 828895)) (not (let (($range_0@@2 ($Range 0 (|l#Vec_183907| $t5@@7))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@144 $i_1@@2))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_183907| $t5@@7) i@@144)))) _$t3@@2))))
 :qid |TreasuryComplianceScriptsbpl.36813:57|
 :skolemid |1111|
))))) (=> (not (let (($range_0@@3 ($Range 0 (|l#Vec_183907| $t5@@7))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@145 $i_1@@3))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_183907| $t5@@7) i@@145)))) _$t3@@2))))
 :qid |TreasuryComplianceScriptsbpl.36813:57|
 :skolemid |1111|
)))) (and (=> (= (ControlFlow 0 640407) (- 0 828942)) (not (= $t6@@7 0))) (=> (not (= $t6@@7 0)) (and (=> (= (ControlFlow 0 640407) (- 0 828953)) (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7))) (=> (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (and (=> (= (ControlFlow 0 640407) (- 0 828966)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7@@6) $t6@@7)) (and (=> (= (ControlFlow 0 640407) (- 0 828979)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 640407) (- 0 828989)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@7)))) (and (=> (= (ControlFlow 0 640407) (- 0 829002)) (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8@@6))))) (=> (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8@@6)))) (and (=> (= (ControlFlow 0 640407) (- 0 829025)) (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8@@6))))) (=> (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8@@6)))) (and (=> (= (ControlFlow 0 640407) (- 0 829048)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory@6|) _$t2@@4))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory@6|) _$t2@@4)) (and (=> (= (ControlFlow 0 640407) (- 0 829061)) (let ((actual@@38 ($EventStore (- (|counter#$EventStore| $es@7) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7) (|streams#$EventStore| $es)))))
(let ((expected@@38 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9@@6)) (let ((stream@@97 (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t11@@5)))
(let ((stream_new@@88 (let ((len@@88 (|l#Multiset_183272| stream@@97)))
(let ((cnt@@88 (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@97) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)))))
(Multiset_183272 (|Store__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@97) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)) (+ cnt@@88 1)) (+ len@@88 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t11@@5 stream_new@@88)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@38) (|counter#$EventStore| actual@@38)) (forall ((handle@@48 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| expected@@38) handle@@48)) (|l#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| actual@@38) handle@@48))) (forall ((v@@109 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| expected@@38) handle@@48)) v@@109) (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| actual@@38) handle@@48)) v@@109))
...
(let ((expected@@39 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9@@6)) (let ((stream@@98 (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t11@@5)))
(let ((stream_new@@89 (let ((len@@89 (|l#Multiset_183272| stream@@98)))
(let ((cnt@@89 (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@98) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)))))
(Multiset_183272 (|Store__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@98) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)) (+ cnt@@89 1)) (+ len@@89 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t11@@5 stream_new@@89)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@39) (|counter#$EventStore| actual@@39)) (forall ((handle@@49 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| expected@@39) handle@@49)) (|l#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| actual@@39) handle@@49))) (forall ((v@@110 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| expected@@39) handle@@49)) v@@110) (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| actual@@39) handle@@49)) v@@110))
 :qid |TreasuryComplianceScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |TreasuryComplianceScriptsbpl.3504:13|
 :skolemid |127|
))))) (=> (= (ControlFlow 0 640407) (- 0 829102)) (let ((actual@@40 ($EventStore (- (|counter#$EventStore| $es@7) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7) (|streams#$EventStore| $es)))))
(let ((expected@@40 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9@@6)) (let ((stream@@99 (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t11@@5)))
(let ((stream_new@@90 (let ((len@@90 (|l#Multiset_183272| stream@@99)))
(let ((cnt@@90 (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@99) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)))))
(Multiset_183272 (|Store__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@99) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) $t10@@6 _$t2@@4)) (+ cnt@@90 1)) (+ len@@90 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t11@@5 stream_new@@90)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| actual@@40) (|counter#$EventStore| expected@@40)) (forall ((handle@@50 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| actual@@40) handle@@50)) (|l#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| expected@@40) handle@@50))) (forall ((v@@111 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| actual@@40) handle@@50)) v@@111) (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| expected@@40) handle@@50)) v@@111))
 :qid |TreasuryComplianceScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |TreasuryComplianceScriptsbpl.3504:13|
...
(let ((|inline$$1_Diem_burn'#0'$0$anon14_Else_correct|  (=> (and (not $abort_flag@8) (= $es@7 $es@5)) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@9| |$1_Diem_CurrencyInfo'#0'_$memory@7|) (= |$1_Diem_PreburnQueue'#0'_$memory@6| |$1_Diem_PreburnQueue'#0'_$memory@4|)) (and (= $abort_flag@9 $abort_flag@8) (= $abort_code@10 $abort_code@9))) (and (=> (= (ControlFlow 0 639984) 640421) anon7_Then_correct) (=> (= (ControlFlow 0 639984) 640407) anon7_Else_correct))))))
(let ((|inline$$1_Diem_burn'#0'$0$L3_correct|  (=> (= $es@7 $es@6) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@9| |$1_Diem_CurrencyInfo'#0'_$memory@8|) (= |$1_Diem_PreburnQueue'#0'_$memory@6| |$1_Diem_PreburnQueue'#0'_$memory@5|)) (and (= $abort_flag@9 true) (= $abort_code@10 |inline$$1_Diem_burn'#0'$0$$t18@1|))) (and (=> (= (ControlFlow 0 635548) 640421) anon7_Then_correct) (=> (= (ControlFlow 0 635548) 640407) anon7_Else_correct))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon14_Then_correct|  (=> $abort_flag@8 (=> (and (= $abort_code@9 $abort_code@9) (= |inline$$1_Diem_burn'#0'$0$$t18@1| $abort_code@9)) (=> (and (and (= $es@6 $es@5) (= |$1_Diem_CurrencyInfo'#0'_$memory@8| |$1_Diem_CurrencyInfo'#0'_$memory@7|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@5| |$1_Diem_PreburnQueue'#0'_$memory@4|) (= (ControlFlow 0 639998) 635548))) |inline$$1_Diem_burn'#0'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|  (=> (= $abort_code@9 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1|) (=> (and (and (= $es@5 $es@4) (= |$1_Diem_CurrencyInfo'#0'_$memory@7| |$1_Diem_CurrencyInfo'#0'_$memory@6|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@4| |$1_Diem_PreburnQueue'#0'_$memory@3|) (= $abort_flag@8 true))) (and (=> (= (ControlFlow 0 639863) 639998) |inline$$1_Diem_burn'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 639863) 639984) |inline$$1_Diem_burn'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon13_Then_correct|  (=> |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0| (=> (and (and (and (> (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) 0) (= 7 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2@@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 639857) 639863)))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|  (=> $abort_flag@7 (=> (and (= $abort_code@8 $abort_code@8) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| $abort_code@8)) (=> (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2@@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 639877) 639863))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon10_Then_correct|  (=> (and (and (and |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0| (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)) (= 5 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)) (and (let ((|inline$$1_Diem_burn_with_capability'#0'$0$$range_0| ($Range 0 (|l#Vec_183907| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'#0'$0$$i_1| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'#0'$0$$range_0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1|) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$i| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1|))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_183907| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|) |inline$$1_Diem_burn_with_capability'#0'$0$i|)))) _$t3@@2))))
 :qid |unknown.0:0|
 :skolemid |224|
))) (= 1 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@4 $es) (= (ControlFlow 0 639970) 639863)))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon13_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0|) (= $abort_code@9 $abort_code@8)) (=> (and (and (= $es@5 $es@3) (= |$1_Diem_CurrencyInfo'#0'_$memory@7| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@4| |$1_Diem_PreburnQueue'#0'_$memory@2@@0|) (= $abort_flag@8 $abort_flag@7))) (and (=> (= (ControlFlow 0 639829) 639998) |inline$$1_Diem_burn'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 639829) 639984) |inline$$1_Diem_burn'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|  (=> (not $abort_flag@7) (=> (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t3@1| (|v#$Mutation_250954| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t3@1|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0| (> (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) 0)))) (and (=> (= (ControlFlow 0 639821) 639857) |inline$$1_Diem_burn_with_capability'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 639821) 639829) |inline$$1_Diem_burn_with_capability'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|  (=> (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| (|v#$Mutation_250954| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1|)) (=> (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2|) (= |$1_Diem_CurrencyInfo'#0'_$memory@5| |$1_Diem_CurrencyInfo'#0'_$memory@4|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1|) (= $abort_code@8 $abort_code@7)) (and (= $abort_flag@7 $abort_flag@6) (= $es@3 $es@2@@3))) (and (=> (= (ControlFlow 0 639462) 639877) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 639462) 639821) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Else_correct|  (=> (not $abort_flag@6) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@3| ($Memory_239540 (|Store__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)))) (= $es@2@@3 $es@0@@7)) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@4| |$1_Diem_CurrencyInfo'#0'_$memory@3|) (= (ControlFlow 0 639587) 639462))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Else_correct|  (=> (not inline$$Not$0$dst@1@@0) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1@@1| ($Memory_239540 (|Store__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)))) (= $es@2@@3 $es)) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@4| |$1_Diem_CurrencyInfo'#0'_$memory@1@@1|) (= (ControlFlow 0 639448) 639462))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|  (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@5| |$1_Diem_CurrencyInfo'#0'_$memory@2@@1|) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@0|) (= $abort_code@8 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1|)) (and (= $abort_flag@7 true) (= $es@3 $es@1@@6))) (and (=> (= (ControlFlow 0 638378) 639877) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 638378) 639821) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Then_correct|  (=> (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@7) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es@0@@7) (= (ControlFlow 0 639601) 638378))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| (|v#$Mutation_223780| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1|)) (= $es@0@@7 (let ((stream@@100 (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1|)))
(let ((stream_new@@91 (let ((len@@91 (|l#Multiset_183272| stream@@100)))
(let ((cnt@@91 (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@100) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1|))))
(Multiset_183272 (|Store__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@100) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1|) (+ cnt@@91 1)) (+ len@@91 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| stream_new@@91)))))) (and (=> (= (ControlFlow 0 639559) 639601) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Then_correct|) (=> (= (ControlFlow 0 639559) 639587) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Then_correct|  (=> (and (and inline$$Not$0$dst@1@@0 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1| ($Mutation_223780 (|l#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|) (let ((l@@5 (|l#Vec_25539| (|p#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|))))
(Vec_25539 (|Store__T@[Int]Int_| (|v#Vec_25539| (|p#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) l@@5 9) (+ l@@5 1))) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1| ($1_Diem_BurnEvent |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| _$t2@@4)) (= (ControlFlow 0 639565) 639559))) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct@@0  (=> (= inline$$Not$0$dst@1@@0  (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t50@1|)) (and (=> (= (ControlFlow 0 639420) 639565) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Then_correct|) (=> (= (ControlFlow 0 639420) 639448) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|  (=> (and (not $abort_flag@6) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1| ($Mutation_17352 (|l#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (let ((l@@6 (|l#Vec_25539| (|p#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|))))
(Vec_25539 (|Store__T@[Int]Int_| (|v#Vec_25539| (|p#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) l@@6 1) (+ l@@6 1))) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@2| ($Mutation_17352 (|l#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1|) (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1|) inline$$Sub$1$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4| ($Mutation_259343 (|l#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (|p#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|v#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@2|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t50@1| (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|))) (= (ControlFlow 0 639426) 639420))) inline$$Not$0$anon0_correct@@0))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|  (=> (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@7) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 639615) 638378))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$Sub$1$anon3_Then$1_correct  (=> (= $abort_flag@6 true) (=> (and (= $abort_code@7 $EXEC_FAILURE_CODE) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@0)) (and (=> (= (ControlFlow 0 639336) 639615) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 639336) 639426) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|))))))
(let ((inline$$Sub$1$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= (ControlFlow 0 639334) 639336)) inline$$Sub$1$anon3_Then$1_correct)))
(let ((inline$$Sub$1$anon3_Else_correct  (=> (<= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1|) (=> (and (and (= inline$$Sub$1$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|)) (= $abort_flag@6 $abort_flag@5)) (and (= $abort_code@7 $abort_code@6) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@1))) (and (=> (= (ControlFlow 0 639286) 639615) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 639286) 639426) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Then_correct|  (=> (and inline$$Ge$1$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))) (and (=> (= (ControlFlow 0 639342) 639334) inline$$Sub$1$anon3_Then_correct) (=> (= (ControlFlow 0 639342) 639286) inline$$Sub$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Else_correct|  (=> (not inline$$Ge$1$dst@1) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@0@@1| ($Memory_239540 (|Store__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory@0@@1|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 639195) 638378))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else$1_correct|  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= inline$$Ge$1$dst@1 inline$$Ge$1$dst@1))) (and (=> (= (ControlFlow 0 639167) 639342) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Then_correct|) (=> (= (ControlFlow 0 639167) 639195) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Else_correct|))))))
(let ((inline$$Ge$1$anon0_correct  (=> (and (= inline$$Ge$1$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t43@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|)) (= (ControlFlow 0 639131) 639167)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|  (=> (and (not $abort_flag@5) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1| ($Mutation_17352 (|l#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (let ((l@@7 (|l#Vec_25539| (|p#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))
(Vec_25539 (|Store__T@[Int]Int_| (|v#Vec_25539| (|p#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) l@@7 0) (+ l@@7 1))) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@2| ($Mutation_17352 (|l#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1|) (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1|) inline$$Sub$0$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3| ($Mutation_259343 (|l#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (|p#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (|$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@2|) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t43@1| (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|))) (= (ControlFlow 0 639137) 639131))) inline$$Ge$1$anon0_correct))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|  (=> (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@6) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 639629) 638378))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_code@6 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@5 true) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 639037) 639629) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 639037) 639137) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| inline$$CastU128$1$dst@1) (= (ControlFlow 0 639035) 639037)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1|) (=> (and (and (= inline$$Sub$0$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| inline$$CastU128$1$dst@1)) (= $abort_code@6 $abort_code@5@@0)) (and (= $abort_flag@5 $abort_flag@4@@0) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 638987) 639629) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 638987) 639137) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|  (=> (not $abort_flag@4@@0) (and (=> (= (ControlFlow 0 639043) 639035) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 639043) 638987) inline$$Sub$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|  (=> (and $abort_flag@4@@0 (= $abort_code@5@@0 $abort_code@5@@0)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@5@@0) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 639643) 638378))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_flag@4@@0 true) (=> (and (= $abort_code@5@@0 $EXEC_FAILURE_CODE) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 638892) 639643) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 638892) 639043) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 638890) 638892)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= $abort_flag@4@@0 $abort_flag@3@@1)) (and (= $abort_code@5@@0 $abort_code@4@@1) (= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|))) (and (=> (= (ControlFlow 0 638842) 639643) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 638842) 639043) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Then_correct|  (=> (and inline$$Ge$0$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)))) (and (=> (= (ControlFlow 0 638898) 638890) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 638898) 638842) inline$$CastU128$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Else_correct|  (=> (and (not inline$$Ge$0$dst@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 638763) 638378))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else$1_correct|  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 638747) 638898) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Then_correct|) (=> (= (ControlFlow 0 638747) 638763) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Else_correct|))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t34@1| inline$$CastU128$0$dst@1)) (= (ControlFlow 0 638711) 638747)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|  (=> (and (not $abort_flag@3@@1) (= (ControlFlow 0 638717) 638711)) inline$$Ge$0$anon0_correct)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|  (=> (and $abort_flag@3@@1 (= $abort_code@4@@1 $abort_code@4@@1)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@4@@1) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 639657) 638378))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_code@4@@1 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@3@@1 true) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 638657) 639657) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 638657) 638717) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 638655) 638657)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= $abort_code@4@@1 $abort_code@3@@1)) (and (= $abort_flag@3@@1 $abort_flag@2@@1) (= inline$$CastU128$0$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|))) (and (=> (= (ControlFlow 0 638607) 639657) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 638607) 638717) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|  (=> (and (and (not $abort_flag@2@@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t34@1| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))) (and (=> (= (ControlFlow 0 638663) 638655) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 638663) 638607) inline$$CastU128$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|  (=> (and $abort_flag@2@@1 (= $abort_code@3@@1 $abort_code@3@@1)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@3@@1) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 639671) 638378))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then$1_correct|  (=> (= $abort_flag@2@@1 true) (=> (and (= $abort_code@3@@1 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0|)) (and (=> (= (ControlFlow 0 639723) 639671) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 639723) 638663) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 639721) 639723)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1| ($Mutation_259343 ($Global 173345816) (Vec_25539 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $abort_flag@2@@1 $abort_flag@1@@1)) (and (= $abort_code@3@@1 $abort_code@2@@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1|))) (and (=> (= (ControlFlow 0 638512) 639671) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 638512) 638663) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 638490) 639721) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then_correct|) (=> (= (ControlFlow 0 638490) 638512) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 639749) 638378)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Then_correct|  (=> inline$$Gt$0$dst@1 (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1| ($Mutation_259393 (|l#$Mutation_250954| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (let ((l@@8 (|l#Vec_25539| (|p#$Mutation_250954| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))))
(Vec_25539 (|Store__T@[Int]Int_| (|v#Vec_25539| (|p#$Mutation_250954| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)) l@@8 0) (+ l@@8 1))) (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_250954| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1| (|v#$Mutation_259393| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2| ($Mutation_259393 (|l#$Mutation_259393| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|) (|p#$Mutation_259393| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|) |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Diem'#0''@1|)) (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_259393| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)))) (=> (and (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_259393| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)) (|$IsValid'$1_Diem_Diem'#0''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|)) (and (= (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|) (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1|)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_259393| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)) 0))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1| ($Mutation_250954 (|l#$Mutation_250954| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (|p#$Mutation_250954| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (|$1_Diem_Preburn'#0'| (|v#$Mutation_259393| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 638476) 639749) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Then_correct|) (=> (= (ControlFlow 0 638476) 638490) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Else_correct|  (=> (and (not inline$$Gt$0$dst@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 638372) 638378))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else$1_correct|  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| 1)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 638356) 638476) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Then_correct|) (=> (= (ControlFlow 0 638356) 638372) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Else_correct|))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t22@1| 0)) (= (ControlFlow 0 638320) 638356)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else_correct|  (=> (and (and (and (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0|) (|$IsValid'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0|)) (and (|$IsEqual'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0|))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t21@1| (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_250954| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t22@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t21@1|))) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 638326) 638320)))) inline$$Gt$0$anon0_correct)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1@@6 $es) (= (ControlFlow 0 639775) 638378)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon0_correct|  (=> (= (|l#Vec_25539| (|p#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t10@0|)) 0) (=> (and (and (and (and (= (|l#Vec_25539| (|p#$Mutation_259393| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@0|)) 0) (= (|l#Vec_25539| (|p#$Mutation_259343| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0|)) 0)) (and (= (|l#Vec_25539| (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@0|)) 0) (= (|l#Vec_25539| (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@0|)) 0))) (and (and (= (|l#Vec_25539| (|p#$Mutation_223780| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@0|)) 0) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t12@0| (|v#$Mutation_250954| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t13@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t12@0|))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t14@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t15@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t16@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t17@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t15@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1| (|v#$Mutation_250954| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1|) (= _$t2@@4 _$t2@@4)) (and (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@2|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))) (and (=> (= (ControlFlow 0 638238) 639775) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Then_correct|) (=> (= (ControlFlow 0 638238) 638326) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|  (=> (and (|$IsValid'$1_Diem_PreburnWithMetadata'#0''| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory@2@@0|) _$t2@@4))) (=> (and (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|))) _$t3@@2) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t18@1| (|$metadata#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1|))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1| ($Mutation_250954 ($Local 3) (Vec_25539 (MapConstVec_16957 DefaultVecElem_16957) 0) |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t20@0| (|v#$Mutation_250954| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t21@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t20@0|))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t22@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t23@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t24@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t25@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t23@0|)) (= (ControlFlow 0 639781) 638238)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon0_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon11_Else_correct|  (=> (and (and (not |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'bool'@1|) (= |$1_Diem_PreburnQueue'#0'_$memory@1@@0| ($Memory_246653 (|Store__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4 false) (|contents#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2@@0| |$1_Diem_PreburnQueue'#0'_$memory@1@@0|) (= (ControlFlow 0 636678) 639781))) |inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon11_Then_correct|  (=> (and (and |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'bool'@1| (= |$1_Diem_PreburnQueue'#0'_$memory@0@@0| ($Memory_246653 (|Store__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4 true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4 |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'$1_Diem_PreburnQueue'#0''@1|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2@@0| |$1_Diem_PreburnQueue'#0'_$memory@0@@0|) (= (ControlFlow 0 639889) 639781))) |inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon10_Else_correct|  (=> (not |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0|) (and (=> (= (ControlFlow 0 636666) 639889) |inline$$1_Diem_burn_with_capability'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 636666) 636678) |inline$$1_Diem_burn_with_capability'#0'$0$anon11_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon0_correct|  (=> (and (= (|l#Vec_25539| (|p#$Mutation_250954| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@0|)) 0) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t6@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t7@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t8@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t9@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t10@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t8@0|))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t12@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= _$t2@@4 _$t2@@4))) (and (and (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@2|) (= _$t3@@2 _$t3@@2)) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0|  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$$range_0@@0| ($Range 0 (|l#Vec_183907| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'#0'$0$$range_0@@0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0|) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$i@@0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0|))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_183907| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|) |inline$$1_Diem_burn_with_capability'#0'$0$i@@0|)))) _$t3@@2))))
 :qid |unknown.0:0|
 :skolemid |223|
)))))))) (and (=> (= (ControlFlow 0 636658) 639970) |inline$$1_Diem_burn_with_capability'#0'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 636658) 636666) |inline$$1_Diem_burn_with_capability'#0'$0$anon10_Else_correct|)))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon13_Else_correct|  (=> (and (not $abort_flag@1@@1) (= |inline$$1_Diem_burn'#0'$0$$t20@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (and (and (and (= |inline$$1_Diem_burn'#0'$0$$t21@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn'#0'$0$$t22@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn'#0'$0$$t20@0|))) (and (= |inline$$1_Diem_burn'#0'$0$$t23@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= |inline$$1_Diem_burn'#0'$0$$t24@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))))) (and (and (= |inline$$1_Diem_burn'#0'$0$$t25@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn'#0'$0$$t23@0|))) (= |inline$$1_Diem_burn'#0'$0$$t26@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'#0'$0$$t27@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= (ControlFlow 0 639974) 636658)))) |inline$$1_Diem_burn_with_capability'#0'$0$anon0_correct|))))
(let ((|inline$$1_Diem_burn'#0'$0$anon13_Then_correct|  (=> $abort_flag@1@@1 (=> (and (= $abort_code@2@@1 $abort_code@2@@1) (= |inline$$1_Diem_burn'#0'$0$$t18@1| $abort_code@2@@1)) (=> (and (and (= $es@6 $es) (= |$1_Diem_CurrencyInfo'#0'_$memory@8| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@5| |$1_Diem_PreburnQueue'#0'_$memory|) (= (ControlFlow 0 640012) 635548))) |inline$$1_Diem_burn'#0'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'#0'$0$anon12_Then$1_correct|  (=> (= $abort_code@2@@1 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@1 true) (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@0|)) (and (=> (= (ControlFlow 0 640064) 640012) |inline$$1_Diem_burn'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 640064) 639974) |inline$$1_Diem_burn'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon12_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|)) (= (ControlFlow 0 640062) 640064)) |inline$$1_Diem_burn'#0'$0$anon12_Then$1_correct|)))
(let ((|inline$$1_Diem_burn'#0'$0$anon12_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|) (=> (and (and (= |inline$$1_Diem_burn'#0'$0$$t19@1| (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|)) (= $abort_code@2@@1 $abort_code@1@@4)) (and (= $abort_flag@1@@1 $abort_flag@0@@4) (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@1|))) (and (=> (= (ControlFlow 0 635568) 640012) |inline$$1_Diem_burn'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 635568) 639974) |inline$$1_Diem_burn'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon11_Then_correct|  (=> |inline$$1_Diem_burn'#0'$0$$t15@1| (and (=> (= (ControlFlow 0 635554) 640062) |inline$$1_Diem_burn'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 635554) 635568) |inline$$1_Diem_burn'#0'$0$anon12_Else_correct|)))))
(let ((|inline$$1_Diem_burn'#0'$0$anon11_Else_correct|  (=> (not |inline$$1_Diem_burn'#0'$0$$t15@1|) (=> (and (= |inline$$1_Diem_burn'#0'$0$$t17@0| |inline$$1_Diem_burn'#0'$0$$t17@0|) (= |inline$$1_Diem_burn'#0'$0$$t18@1| |inline$$1_Diem_burn'#0'$0$$t17@0|)) (=> (and (and (= $es@6 $es) (= |$1_Diem_CurrencyInfo'#0'_$memory@8| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@5| |$1_Diem_PreburnQueue'#0'_$memory|) (= (ControlFlow 0 635542) 635548))) |inline$$1_Diem_burn'#0'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'#0'$0$anon0_correct|  (=> (and (and (= |inline$$1_Diem_burn'#0'$0$$t6@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= |inline$$1_Diem_burn'#0'$0$$t7@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4)))) (and (= |inline$$1_Diem_burn'#0'$0$$t8@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn'#0'$0$$t6@0|))) (= |inline$$1_Diem_burn'#0'$0$$t9@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (and (and (and (and (= |inline$$1_Diem_burn'#0'$0$$t10@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= |inline$$1_Diem_burn'#0'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'#0'$0$$t12@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn'#0'$0$$t13@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn'#0'$0$$t11@0|)))) (and (and (= _$t0@@7 _$t0@@7) (= _$t2@@4 _$t2@@4)) (and (= _$t3@@2 _$t3@@2) (|$IsValid'address'| |inline$$1_Diem_burn'#0'$0$$t14@0|)))) (and (and (and (= |inline$$1_Diem_burn'#0'$0$$t14@0| (|$addr#$signer| _$t0@@7)) (= |inline$$1_Diem_burn'#0'$0$$t14@0| |inline$$1_Diem_burn'#0'$0$$t14@0|)) (and (= |inline$$1_Diem_burn'#0'$0$$t15@1| (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| |inline$$1_Diem_burn'#0'$0$$t17@0|) (= |inline$$1_Diem_burn'#0'$0$$t17@0| 4)) (and (= |inline$$1_Diem_burn'#0'$0$$t17@0| |inline$$1_Diem_burn'#0'$0$$t17@0|) (= |inline$$1_Diem_burn'#0'$0$$t15@1| |inline$$1_Diem_burn'#0'$0$$t15@1|))))) (and (=> (= (ControlFlow 0 635526) 635554) |inline$$1_Diem_burn'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 635526) 635542) |inline$$1_Diem_burn'#0'$0$anon11_Else_correct|))))))
(let ((anon6_Else_correct  (=> (and (not $abort_flag@0@@4) (= $t13@@5 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2)))) (=> (and (and (and (= $t14@@5 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))) (= $t15@@5 (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t13@@5)))) (and (= $t16@@5 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t17@@5 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))))) (and (and (= $t18@@5 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t19@@5 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t20@@5 (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t18@@5)) (= (ControlFlow 0 640068) 635526)))) |inline$$1_Diem_burn'#0'$0$anon0_correct|))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@2  (=> (and (= $abort_flag@0@@4 true) (= $abort_code@1@@4 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@2)) (and (=> (= (ControlFlow 0 634601) 640869) anon6_Then_correct) (=> (= (ControlFlow 0 634601) 640068) anon6_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@2  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@2) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2) (= (ControlFlow 0 634595) 634601))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@2)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@2  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@2 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@2)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@2)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@2) (= (ControlFlow 0 634651) 634601))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@2))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@2  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@2 (=> (and (= $abort_flag@0@@4 false) (= $abort_code@1@@4 $abort_code@0@@4)) (and (=> (= (ControlFlow 0 634607) 640869) anon6_Then_correct) (=> (= (ControlFlow 0 634607) 640068) anon6_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@2  (=> (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@2) (=> (and (and (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@2 ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@7)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@2)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@2 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@2 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@2) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@2 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@2)))) (and (=> (= (ControlFlow 0 634579) 634607) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@2) (=> (= (ControlFlow 0 634579) 634595) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@2))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@2  (=> (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@2|) (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@1@@2 ($Memory_232707 (|Store__T@[Int]Bool_| (|domain#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7) false) (|contents#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory))) (= (ControlFlow 0 634521) 634579)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@2))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@2  (=> |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@2| (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@0@@2 ($Memory_232707 (|Store__T@[Int]Bool_| (|domain#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1@@2|))) (= (ControlFlow 0 634621) 634579)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@2))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@2  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@2) (and (=> (= (ControlFlow 0 634507) 634621) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@2) (=> (= (ControlFlow 0 634507) 634521) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@2)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@2  (=> (= _$t0@@7 _$t0@@7) (=> (and (= _$t1@@7 _$t1@@7) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@2  (not (|Select__T@[Int]Bool_| (|domain#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))))) (and (=> (= (ControlFlow 0 634501) 634651) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@2) (=> (= (ControlFlow 0 634501) 634507) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@2))))))
(let ((anon0$1_correct@@7  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_230554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_230554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) 186537453))) (=> (and (and (forall ((addr1@@55 Int) ) (!  (=> (|$IsValid'address'| addr1@@55) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_240081| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1@@55) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@55) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@55)) 1))))
 :qid |TreasuryComplianceScriptsbpl.36617:22|
 :skolemid |1088|
)) (forall ((addr1@@56 Int) ) (!  (=> (|$IsValid'address'| addr1@@56) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_240168| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr1@@56) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@56) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@56)) 1))))
 :qid |TreasuryComplianceScriptsbpl.36617:232|
 :skolemid |1089|
))) (forall ((addr1@@57 Int) ) (!  (=> (|$IsValid'address'| addr1@@57) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) addr1@@57) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@57) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@57)) 1))))
 :qid |TreasuryComplianceScriptsbpl.36617:443|
 :skolemid |1090|
))) (=> (and (and (and (and (forall ((addr1@@58 Int) ) (!  (=> (|$IsValid'address'| addr1@@58) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_246419| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1@@58) (|Select__T@[Int]Bool_| (|domain#$Memory_246007| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1@@58)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@58) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@58)) 2))))
 :qid |TreasuryComplianceScriptsbpl.36621:22|
 :skolemid |1091|
)) (forall ((addr1@@59 Int) ) (!  (=> (|$IsValid'address'| addr1@@59) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_246536| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr1@@59) (|Select__T@[Int]Bool_| (|domain#$Memory_246088| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr1@@59)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@59) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@59)) 2))))
 :qid |TreasuryComplianceScriptsbpl.36621:293|
 :skolemid |1092|
))) (forall ((addr1@@60 Int) ) (!  (=> (|$IsValid'address'| addr1@@60) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) addr1@@60) (|Select__T@[Int]Bool_| (|domain#$Memory_246169| |$1_Diem_Preburn'#0'_$memory|) addr1@@60)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@60) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr1@@60)) 2))))
 :qid |TreasuryComplianceScriptsbpl.36621:565|
 :skolemid |1093|
))) (and (and (forall ((dd_addr@@17 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246007| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@17) (and (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_Preburn'$1_XUS_XUS'_| (|contents#$Memory_246007| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@17))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_246419| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) dd_addr@@17)))))
 :qid |TreasuryComplianceScriptsbpl.36625:22|
 :skolemid |1094|
)) (forall ((dd_addr@@18 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246088| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@18) (and (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_Preburn'$1_XDX_XDX'_| (|contents#$Memory_246088| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@18))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_246536| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) dd_addr@@18)))))
 :qid |TreasuryComplianceScriptsbpl.36625:375|
 :skolemid |1095|
))) (forall ((dd_addr@@19 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@19) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246169| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@19) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_246169| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@19))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@19)))))
 :qid |TreasuryComplianceScriptsbpl.36625:729|
 :skolemid |1096|
)))) (and (and (and (forall ((dd_addr@@20 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@20) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246419| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) dd_addr@@20) (not (|Select__T@[Int]Bool_| (|domain#$Memory_246007| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@20))))
 :qid |TreasuryComplianceScriptsbpl.36629:22|
 :skolemid |1097|
)) (forall ((dd_addr@@21 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@21) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246536| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) dd_addr@@21) (not (|Select__T@[Int]Bool_| (|domain#$Memory_246088| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@21))))
 :qid |TreasuryComplianceScriptsbpl.36629:220|
 :skolemid |1098|
))) (forall ((dd_addr@@22 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@22) (not (|Select__T@[Int]Bool_| (|domain#$Memory_246169| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@22))))
 :qid |TreasuryComplianceScriptsbpl.36629:419|
 :skolemid |1099|
))) (and (and (forall ((addr@@217 Int) ) (!  (=> (|$IsValid'address'| addr@@217) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246007| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@217) (|Select__T@[Int]Bool_| (|domain#$Memory_239245| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36633:22|
 :skolemid |1100|
)) (forall ((addr@@218 Int) ) (!  (=> (|$IsValid'address'| addr@@218) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246088| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@218) (|Select__T@[Int]Bool_| (|domain#$Memory_239309| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36633:222|
 :skolemid |1101|
))) (forall ((addr@@219 Int) ) (!  (=> (|$IsValid'address'| addr@@219) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246169| |$1_Diem_Preburn'#0'_$memory|) addr@@219) (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36633:423|
 :skolemid |1102|
))))) (=> (and (and (and (and (and (forall ((addr@@220 Int) ) (!  (=> (|$IsValid'address'| addr@@220) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246419| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@220) (|Select__T@[Int]Bool_| (|domain#$Memory_239245| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36637:22|
 :skolemid |1103|
)) (forall ((addr@@221 Int) ) (!  (=> (|$IsValid'address'| addr@@221) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246536| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@221) (|Select__T@[Int]Bool_| (|domain#$Memory_239309| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36637:227|
 :skolemid |1104|
))) (forall ((addr@@222 Int) ) (!  (=> (|$IsValid'address'| addr@@222) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@222) (|Select__T@[Int]Bool_| (|domain#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.36637:433|
 :skolemid |1105|
))) (and (|$IsValid'address'| (|$addr#$signer| _$t0@@7)) (|$IsValid'u64'| _$t1@@7))) (and (and (|$IsValid'address'| _$t2@@4) (|$IsValid'u64'| _$t3@@2)) (and (forall (($a_0@@95 Int) ) (! (let (($rsc@@95 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@95)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@95))
 :qid |TreasuryComplianceScriptsbpl.36652:20|
 :skolemid |1106|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_232707| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@95))
)) (forall (($a_0@@96 Int) ) (! (let (($rsc@@96 (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) $a_0@@96)))
(|$IsValid'$1_Diem_BurnCapability'#0''| $rsc@@96))
 :qid |TreasuryComplianceScriptsbpl.36656:20|
 :skolemid |1107|
 :pattern ( (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_240255| |$1_Diem_BurnCapability'#0'_$memory|) $a_0@@96))
))))) (and (and (and (and (forall (($a_0@@97 Int) ) (! (let (($rsc@@97 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@97)))
 ...
 :qid |TreasuryComplianceScriptsbpl.36660:20|
 :skolemid |1108|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@97))
)) (forall (($a_0@@98 Int) ) (! (let (($rsc@@98 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@98)))
 (and (|$IsValid'$1_Diem_PreburnQueue'#0''| $rsc@@98) (and (<= (|l#Vec_183907| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@98)) 256) (let (($range_1@@4 ($Range 0 (|l#Vec_183907| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@98)))))
(forall (($i_2@@4 Int) ) (!  (=> ($InRange $range_1@@4 $i_2@@4) (let ((i@@146 $i_2@@4))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_183907| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@98)) i@@146)))) 0)))
 :qid |TreasuryComplianceScriptsbpl.36665:199|
 :skolemid |1109|
))))))
 :qid |TreasuryComplianceScriptsbpl.36664:20|
 :skolemid |1110|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@98))
))) (and (= $t4@@4 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= $t5@@7 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_246653| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2@@4))))) (and (and (= $t6@@7 (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t4@@4))) (= $t7@@6 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t8@@6 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3@@2))) (= $t9@@6 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= $t10@@6 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_239540| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t11@@5 (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t9@@6))) (and (let ((addr@@223 (|$addr#$signer| _$t0@@7)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_230554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_310146| $1_DiemAccount_DiemAccount_$memory) addr@@223)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_306468| $1_AccountFreezing_FreezingBit_$memory) addr@@223) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_306468| $1_AccountFreezing_FreezingBit_$memory) addr@@223)))))) (= _$t0@@7 _$t0@@7))) (and (and (= _$t1@@7 _$t1@@7) (= _$t2@@4 _$t2@@4)) (and (= _$t3@@2 _$t3@@2) (= (ControlFlow 0 634655) 634501)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@2))))))
(let ((inline$$InitEventStore$0$anon0_correct@@7  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@51 T@$1_Event_EventHandle) ) (! (let ((stream@@101 (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $es) handle@@51)))
 (and (= (|l#Multiset_183272| stream@@101) 0) (forall ((v@@112 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@101) v@@112) 0)
 :qid |TreasuryComplianceScriptsbpl.159:13|
 :skolemid |4|
))))
 :qid |TreasuryComplianceScriptsbpl.3488:13|
 :skolemid |126|
))) (= (ControlFlow 0 633294) 634655)) anon0$1_correct@@7)))
(let ((anon0_correct@@7  (=> (= (ControlFlow 0 824295) 633294) inline$$InitEventStore$0$anon0_correct@@7)))
anon0_correct@@7))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
