...
// fun DiemTimestamp::assert_genesis [verification] at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:132:5+102
procedure {:timeLimit 40} $1_DiemTimestamp_assert_genesis$verify() returns ()
{
    ...
    var $temp_0'u64': int;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#92: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;

    // verification entrypoint assumptions
    call $InitVerification();

    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:132:5+102
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(17,5480,5582)"} true;
    ...
    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:132:5+102
    ...
    // @92 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:132:5+1
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#92 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // $t2 := DiemTimestamp::is_genesis() on_abort goto L3 with $t3 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:16+12
    assume {:print "$at(17,5525,5537)"} true;
    ...
    // $t4 := 0 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:52+12
    $t4 := 0;
    assume $IsValid'u64'($t4);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:30+35
    // >> opaque call: $t4 := Errors::invalid_state($t3)

    // $t5 := opaque begin: Errors::invalid_state($t4) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:30+35

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:30+35
    assume $IsValid'u64'($t5);

    // assume Eq<u64>($t5, 1) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:30+35
    assume $IsEqual'u64'($t5, 1);

    // $t5 := opaque end: Errors::invalid_state($t4) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:30+35

    // trace_local[tmp#$1]($t5) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:9+57
    assume {:print "$track_local(3,0,1):", $t5} $t5 == $t5;

    // trace_local[tmp#$0]($t2) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:9+57
    assume {:print "$track_local(3,0,0):", $t2} $t2 == $t2;

    // if ($t2) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:9+57
    if ($t2) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:9+57
L1:

    // trace_abort($t5) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:9+57
    assume {:print "$at(17,5518,5575)"} true;
    assume {:print "$track_abort(3,0):", $t5} $t5 == $t5;

    // $t3 := move($t5) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:9+57
    $t3 := $t5;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:9+57
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:66+1
L0:

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:134:5+1
    assume {:print "$at(17,5581,5582)"} true;
L2:

    // assert Not(Not(DiemTimestamp::$is_genesis[@92]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:142:9+51
    assume {:print "$at(17,5802,5853)"} true;
    assert {:msg "assert_failed(17,5802,5853): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#92);

    // return () at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:142:9+51
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:134:5+1
    assume {:print "$at(17,5581,5582)"} true;
L3:

    // assert Not(DiemTimestamp::$is_genesis[@92]()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:135:5+93
    assume {:print "$at(17,5587,5680)"} true;
    assert {:msg "assert_failed(17,5587,5680): abort not covered by any of the `aborts_if` clauses"}
      !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#92);

    // assert And(Not(DiemTimestamp::$is_genesis[@92]()), Eq(1, $t3)) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:135:5+93
    assert {:msg "assert_failed(17,5587,5680): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#92) && $IsEqual'u8'(1, $t3));

    // abort($t3) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:135:5+93
    $abort_code := $t3;
    $abort_flag := true;
    return;
...
// fun DiemTimestamp::assert_operating [verification] at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:152:5+108
procedure {:timeLimit 40} $1_DiemTimestamp_assert_operating$verify() returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#91: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;

    // verification entrypoint assumptions
    call $InitVerification();

    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:152:5+108
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(17,6247,6355)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:152:5+108
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // @91 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:152:5+1
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#91 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // $t2 := DiemTimestamp::is_operating() on_abort goto L3 with $t3 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:16+14
    assume {:print "$at(17,6294,6308)"} true;
    ...
    // $t4 := 1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:54+14
    $t4 := 1;
    assume $IsValid'u64'($t4);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:32+37
    // >> opaque call: $t4 := Errors::invalid_state($t3)

    // $t5 := opaque begin: Errors::invalid_state($t4) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:32+37

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:32+37
    assume $IsValid'u64'($t5);

    // assume Eq<u64>($t5, 1) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:32+37
    assume $IsEqual'u64'($t5, 1);

    // $t5 := opaque end: Errors::invalid_state($t4) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:32+37

    // trace_local[tmp#$1]($t5) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:9+61
    assume {:print "$track_local(3,1,1):", $t5} $t5 == $t5;

    // trace_local[tmp#$0]($t2) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:9+61
    assume {:print "$track_local(3,1,0):", $t2} $t2 == $t2;

    // if ($t2) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:9+61
    if ($t2) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:9+61
L1:

    // trace_abort($t5) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:9+61
    assume {:print "$at(17,6287,6348)"} true;
    assume {:print "$track_abort(3,1):", $t5} $t5 == $t5;

    // $t3 := move($t5) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:9+61
    $t3 := $t5;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:9+61
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:70+1
L0:

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:154:5+1
    assume {:print "$at(17,6354,6355)"} true;
L2:

    // assert Not(Not(DiemTimestamp::$is_operating[@91]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#91);

    // return () at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:154:5+1
    assume {:print "$at(17,6354,6355)"} true;
L3:

    // assert Not(DiemTimestamp::$is_operating[@91]()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:155:5+97
    assume {:print "$at(17,6360,6457)"} true;
    assert {:msg "assert_failed(17,6360,6457): abort not covered by any of the `aborts_if` clauses"}
      !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#91);

    // assert And(Not(DiemTimestamp::$is_operating[@91]()), Eq(1, $t3)) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:155:5+97
    assert {:msg "assert_failed(17,6360,6457): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#91) && $IsEqual'u8'(1, $t3));

    // abort($t3) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:155:5+97
    $abort_code := $t3;
    $abort_flag := true;
    return;
...
// fun DiemTimestamp::is_genesis [verification] at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:127:5+114
procedure {:timeLimit 40} $1_DiemTimestamp_is_genesis$verify() returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:127:5+114
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(17,5311,5425)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:127:5+114
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));
...
L1:
    ...
    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:129:5+1
    assert {:msg "assert_failed(17,5424,5425): function does not abort under this condition"}
      !false;
...
L2:
    ...
    // assert false at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:127:5+114
    assume {:print "$at(17,5311,5425)"} true;
    assert {:msg "assert_failed(17,5311,5425): abort not covered by any of the `aborts_if` clauses"}
      false;

    // abort($t1) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:127:5+114
    $abort_code := $t1;
    $abort_flag := true;
    return;
...
// fun DiemTimestamp::is_operating [baseline] at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:147:5+115
procedure {:inline 1} $1_DiemTimestamp_is_operating() returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // $t0 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L2 with $t1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:148:41+34
    assume {:print "$at(17,6138,6172)"} true;
    call $t0 := $1_CoreAddresses_DIEM_ROOT_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(17,6138,6172)"} true;
        $t1 := $abort_code;
        assume {:print "$track_abort(3,3):", $t1} $t1 == $t1;
        goto L2;
    }

    // $t2 := exists<DiemTimestamp::CurrentTimeMicroseconds>($t0) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:148:9+6
    $t2 := $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $t0);

    // trace_return[0]($t2) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:148:9+67
    assume {:print "$track_return(3,3,0):", $t2} $t2 == $t2;

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:149:5+1
    assume {:print "$at(17,6178,6179)"} true;
L1:

    // return $t2 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:149:5+1
    $ret0 := $t2;
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:149:5+1
L2:

    // abort($t1) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:149:5+1
    $abort_code := $t1;
    $abort_flag := true;
    return;
...
// fun DiemTimestamp::is_operating [verification] at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:147:5+115
procedure {:timeLimit 40} $1_DiemTimestamp_is_operating$verify() returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:147:5+115
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(17,6064,6179)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:147:5+115
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));
...
L1:
    ...
    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:149:5+1
    assert {:msg "assert_failed(17,6178,6179): function does not abort under this condition"}
      !false;
...
L2:
    ...
    // assert false at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:147:5+115
    assume {:print "$at(17,6064,6179)"} true;
    assert {:msg "assert_failed(17,6064,6179): abort not covered by any of the `aborts_if` clauses"}
      false;

    // abort($t1) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:147:5+115
    $abort_code := $t1;
    $abort_flag := true;
    return;
...
// fun DiemTimestamp::now_microseconds [verification] at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:100:5+199
procedure {:timeLimit 40} $1_DiemTimestamp_now_microseconds$verify() returns ($ret0: int)
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:100:5+199
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(17,4256,4455)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:107:17+6
    assume {:print "$at(17,4561,4567)"} true;
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // @104 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:100:5+1
    assume {:print "$at(17,4256,4257)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#104 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:101:9+18
    // >> opaque call: DiemTimestamp::assert_operating()
    assume {:print "$at(17,4334,4352)"} true;

    // opaque begin: DiemTimestamp::assert_operating() at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:101:9+18

    // assume Identical($t0, Not(DiemTimestamp::$is_operating())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:101:9+18
    assume ($t0 == !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t0) goto L4 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:101:9+18
    if ($t0) { goto L4; } else { goto L3; }

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:101:9+18
L4:

    // assume And(Not(DiemTimestamp::$is_operating()), Eq(1, $t1)) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:101:9+18
    assume (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t1));

    // trace_abort($t1) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:101:9+18
    assume {:print "$at(17,4334,4352)"} true;
    assume {:print "$track_abort(3,4):", $t1} $t1 == $t1;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:101:9+18
    goto L2;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:101:9+18
L3:

    // opaque end: DiemTimestamp::assert_operating() at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:101:9+18

    // $t2 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L2 with $t1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:102:48+34
    assume {:print "$at(17,4401,4435)"} true;
    ...
    // $t3 := get_global<DiemTimestamp::CurrentTimeMicroseconds>($t2) on_abort goto L2 with $t1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:102:9+13
    ...
    if ($abort_flag) {
        assume {:print "$at(17,4362,4375)"} true;
        $t1 := $abort_code;
        assume {:print "$track_abort(3,4):", $t1} $t1 == $t1;
        goto L2;
    }

    // $t4 := get_field<DiemTimestamp::CurrentTimeMicroseconds>.microseconds($t3) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:102:9+87
    $t4 := $microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds($t3);

    // trace_return[0]($t4) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:102:9+87
    assume {:print "$track_return(3,4,0):", $t4} $t4 == $t4;

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:103:5+1
    assume {:print "$at(17,4454,4455)"} true;
L1:

    // assert Not(Not(DiemTimestamp::$is_operating[@104]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#104);

    // assert Eq<u64>($t4, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:107:9+42
    assume {:print "$at(17,4553,4595)"} true;
    assert {:msg "assert_failed(17,4553,4595): post-condition does not hold"}
      $IsEqual'u64'($t4, $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // return $t4 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:107:9+42
    $ret0 := $t4;
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:103:5+1
    assume {:print "$at(17,4454,4455)"} true;
L2:

    // assert Not(DiemTimestamp::$is_operating[@104]()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:104:5+141
    assume {:print "$at(17,4460,4601)"} true;
    assert {:msg "assert_failed(17,4460,4601): abort not covered by any of the `aborts_if` clauses"}
      !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#104);

    // assert And(Not(DiemTimestamp::$is_operating[@104]()), Eq(1, $t1)) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:104:5+141
    assert {:msg "assert_failed(17,4460,4601): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#104) && $IsEqual'u8'(1, $t1));

    // abort($t1) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:104:5+141
    $abort_code := $t1;
    $abort_flag := true;
    return;
...
// fun DiemTimestamp::now_seconds [verification] at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:114:5+123
procedure {:timeLimit 40} $1_DiemTimestamp_now_seconds$verify() returns ($ret0: int)
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:114:5+123
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(17,4788,4911)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:120:17+6
    assume {:print "$at(17,5012,5018)"} true;
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // @109 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:114:5+1
    assume {:print "$at(17,4788,4789)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#109 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18
    // >> opaque call: $t0 := DiemTimestamp::now_microseconds()
    assume {:print "$at(17,4861,4879)"} true;

    // $t0 := opaque begin: DiemTimestamp::now_microseconds() at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18

    // assume Identical($t1, Not(DiemTimestamp::$is_operating())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18
    assume ($t1 == !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t1) goto L4 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18
    if ($t1) { goto L4; } else { goto L3; }

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18
L4:

    // assume And(Not(DiemTimestamp::$is_operating()), Eq(1, $t2)) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18
    assume (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t2));

    // trace_abort($t2) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18
    assume {:print "$at(17,4861,4879)"} true;
    assume {:print "$track_abort(3,5):", $t2} $t2 == $t2;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18
    goto L2;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18
L3:

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18
    assume $IsValid'u64'($t0);

    // assume Eq<u64>($t0, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18
    assume $IsEqual'u64'($t0, $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // $t0 := opaque end: DiemTimestamp::now_microseconds() at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+18

    // $t3 := 1000000 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:30+23
    $t3 := 1000000;
    assume $IsValid'u64'($t3);

    // $t4 := /($t0, $t3) on_abort goto L2 with $t2 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:28+1
    call $t4 := $Div($t0, $t3);
    if ($abort_flag) {
        assume {:print "$at(17,4880,4881)"} true;
        $t2 := $abort_code;
        assume {:print "$track_abort(3,5):", $t2} $t2 == $t2;
        goto L2;
    }

    // trace_return[0]($t4) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:9+44
    assume {:print "$track_return(3,5,0):", $t4} $t4 == $t4;

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:116:5+1
    assume {:print "$at(17,4910,4911)"} true;
L1:

    // assert Not(Not(DiemTimestamp::$is_operating[@109]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#109);

    // assert Eq<u64>($t4, Div(DiemTimestamp::spec_now_microseconds(), 1000000)) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:120:9+69
    assume {:print "$at(17,5004,5073)"} true;
    assert {:msg "assert_failed(17,5004,5073): post-condition does not hold"}
      $IsEqual'u64'($t4, ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) div 1000000));

    // return $t4 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:120:9+69
    $ret0 := $t4;
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:116:5+1
    assume {:print "$at(17,4910,4911)"} true;
L2:

    // assert Not(DiemTimestamp::$is_operating[@109]()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:117:5+163
    assume {:print "$at(17,4916,5079)"} true;
    assert {:msg "assert_failed(17,4916,5079): abort not covered by any of the `aborts_if` clauses"}
      !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#109);

    // assert And(Not(DiemTimestamp::$is_operating[@109]()), Eq(1, $t2)) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:117:5+163
    assert {:msg "assert_failed(17,4916,5079): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#109) && $IsEqual'u8'(1, $t2));

    // abort($t2) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:117:5+163
    $abort_code := $t2;
    $abort_flag := true;
    return;
...
procedure {:timeLimit 40} $1_DiemTimestamp_update_global_time$verify(_$t0: int, _$t1: int, _$t2: int) returns ()
{
    ...
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#228: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
...
L5:
    ...
    // @228 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    // state save for global update invariants
    assume {:print "$at(17,2559,3403)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#228 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;
    ...
    // assert Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(17,6865,6962)"} true;
    assert {:msg "assert_failed(17,6865,6962): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assert Implies(DiemTimestamp::$is_operating[@228](), Le(DiemTimestamp::spec_now_microseconds[@228](), DiemTimestamp::spec_now_microseconds())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:174:9+109
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:174:9+109
    assume {:print "$at(17,7030,7139)"} true;
    assert {:msg "assert_failed(17,7030,7139): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#228) ==> ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#228) <= $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory)));
...
L7:
    ...
    // @176 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@176](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
L6:
    ...
    // @148 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@148](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
L7:
    ...
    // @166 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@166](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
procedure {:inline 1} $1_DiemSystem_initialize_validator_set(_$t0: int) returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemConfig_Configuration_$memory#142: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
...
L8:
    ...
    // @142 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    $1_DiemConfig_Configuration_$memory#142 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@142](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#142), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L7:
    ...
    // @160 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@160](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L7:
    ...
    // @154 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@154](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
