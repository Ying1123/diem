...
L5:
    ...
    // assume Implies(DiemTimestamp::$is_operating(), exists<ChainId::ChainId>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assert Implies(DiemTimestamp::$is_operating(), exists<ChainId::ChainId>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/ChainId.move:51:9+96
    // global invariant at /home/ying/diem/language/diem-framework/modules/ChainId.move:51:9+96
    assume {:print "$at(7,1854,1950)"} true;
    assert {:msg "assert_failed(7,1854,1950): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_ChainId_ChainId_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));
...
// fun ChainId::initialize [verification] at /home/ying/diem/language/diem-framework/modules/ChainId.move:19:5+300
procedure {:timeLimit 40} $1_ChainId_initialize$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/ChainId.move:19:5+300
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(7,662,962)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), exists<ChainId::ChainId>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/ChainId.move:19:5+300
    // global invariant at /home/ying/diem/language/diem-framework/modules/ChainId.move:51:9+96
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_ChainId_ChainId_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ChainId.move:19:5+300
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/ChainId.move:19:5+300
    assume $IsValid'u8'($t1);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ChainId.move:19:5+300
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<ChainId::ChainId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ChainId.move:19:5+300
    ...
    // assume Identical($t4, Signer::$address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ChainId.move:28:9+45
    assume {:print "$at(7,1017,1062)"} true;
    assume ($t4 == $1_Signer_$address_of($t0));

    // assume CanModify<ChainId::ChainId>($t4) at /home/ying/diem/language/diem-framework/modules/ChainId.move:29:9+34
    assume {:print "$at(7,1071,1105)"} true;
    assume $1_ChainId_ChainId_$modifies[$t4];

    // @106 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/ChainId.move:29:9+34
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#106 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @107 := save_mem(ChainId::ChainId) at /home/ying/diem/language/diem-framework/modules/ChainId.move:29:9+34
    $1_ChainId_ChainId_$memory#107 := $1_ChainId_ChainId_$memory;

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/ChainId.move:19:5+1
    assume {:print "$at(7,662,663)"} true;
    assume {:print "$track_local(27,1,0):", $t0} $t0 == $t0;

    // trace_local[id]($t1) at /home/ying/diem/language/diem-framework/modules/ChainId.move:19:5+1
    assume {:print "$track_local(27,1,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/ChainId.move:20:9+31
    // >> opaque call: DiemTimestamp::assert_genesis()
    assume {:print "$at(7,723,754)"} true;

    // opaque begin: DiemTimestamp::assert_genesis() at /home/ying/diem/language/diem-framework/modules/ChainId.move:20:9+31

    // assume Identical($t5, Not(DiemTimestamp::$is_genesis())) at /home/ying/diem/language/diem-framework/modules/ChainId.move:20:9+31
    assume ($t5 == !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t5) goto L5 else goto L4 at /home/ying/diem/language/diem-framework/modules/ChainId.move:20:9+31
    if ($t5) { goto L5; } else { goto L4; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/ChainId.move:20:9+31
L5:

    // assume And(Not(DiemTimestamp::$is_genesis()), Eq(1, $t6)) at /home/ying/diem/language/diem-framework/modules/ChainId.move:20:9+31
    assume (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t6));

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/ChainId.move:20:9+31
    assume {:print "$at(7,723,754)"} true;
    assume {:print "$track_abort(27,1):", $t6} $t6 == $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ChainId.move:20:9+31
    goto L3;

    // label L4 at /home/ying/diem/language/diem-framework/modules/ChainId.move:20:9+31
L4:

    // opaque end: DiemTimestamp::assert_genesis() at /home/ying/diem/language/diem-framework/modules/ChainId.move:20:9+31

    // nop at /home/ying/diem/language/diem-framework/modules/ChainId.move:21:9+43
    // >> opaque call: CoreAddresses::assert_diem_root($t0)
    assume {:print "$at(7,764,807)"} true;

    // opaque begin: CoreAddresses::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/ChainId.move:21:9+43

    // assume Identical($t7, Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/ChainId.move:21:9+43
    assume ($t7 == !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // if ($t7) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/ChainId.move:21:9+43
    if ($t7) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/ChainId.move:21:9+43
L7:

    // assume And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t6)) at /home/ying/diem/language/diem-framework/modules/ChainId.move:21:9+43
    assume (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t6));

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/ChainId.move:21:9+43
    assume {:print "$at(7,764,807)"} true;
    assume {:print "$track_abort(27,1):", $t6} $t6 == $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ChainId.move:21:9+43
    goto L3;

    // label L6 at /home/ying/diem/language/diem-framework/modules/ChainId.move:21:9+43
L6:

    // opaque end: CoreAddresses::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/ChainId.move:21:9+43

    // nop at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:33+30
    // >> opaque call: $t4 := Signer::address_of($t0)
    assume {:print "$at(7,841,871)"} true;

    // $t8 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:33+30

    // assume WellFormed($t8) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:33+30
    assume $IsValid'address'($t8);

    // assume Eq<address>($t8, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:33+30
    assume $IsEqual'address'($t8, $1_Signer_spec_address_of($t0));

    // $t8 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:33+30

    // $t9 := exists<ChainId::ChainId>($t8) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:17+6
    $t9 := $ResourceExists($1_ChainId_ChainId_$memory, $t8);

    // $t10 := !($t9) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:16+1
    call $t10 := $Not($t9);

    // $t11 := 0 at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:92+9
    $t11 := 0;
    assume $IsValid'u64'($t11);

    // nop at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:66+36
    // >> opaque call: $t8 := Errors::already_published($t7)

    // $t12 := opaque begin: Errors::already_published($t11) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:66+36

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:66+36
    assume $IsValid'u64'($t12);

    // assume Eq<u64>($t12, 6) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:66+36
    assume $IsEqual'u64'($t12, 6);

    // $t12 := opaque end: Errors::already_published($t11) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:66+36

    // trace_local[tmp#$3]($t12) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:9+94
    assume {:print "$track_local(27,1,3):", $t12} $t12 == $t12;

    // trace_local[tmp#$2]($t10) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:9+94
    assume {:print "$track_local(27,1,2):", $t10} $t10 == $t10;

    // if ($t10) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:9+94
    if ($t10) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:9+94
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:9+94

    // trace_abort($t12) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:9+94
    assume {:print "$at(7,817,911)"} true;
    assume {:print "$track_abort(27,1):", $t12} $t12 == $t12;

    // $t6 := move($t12) at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:9+94
    $t6 := $t12;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ChainId.move:22:9+94
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ChainId.move:23:17+10
    assume {:print "$at(7,929,939)"} true;
L0:

    // $t13 := pack ChainId::ChainId($t1) at /home/ying/diem/language/diem-framework/modules/ChainId.move:23:29+14
    $t13 := $1_ChainId_ChainId($t1);

    // assert CanModify<ChainId::ChainId>($t0) at /home/ying/diem/language/diem-framework/modules/ChainId.move:23:9+7
    assert {:msg "assert_failed(7,921,928): caller does not have permission to modify `ChainId::ChainId` at given address"}
      $1_ChainId_ChainId_$modifies[$t0];

    // move_to<ChainId::ChainId>($t13, $t0) on_abort goto L3 with $t6 at /home/ying/diem/language/diem-framework/modules/ChainId.move:23:9+7
    ...
    if ($abort_flag) {
        assume {:print "$at(7,921,928)"} true;
        $t6 := $abort_code;
        assume {:print "$track_abort(27,1):", $t6} $t6 == $t6;
        goto L3;
    }
    ...
    // label L2 at /home/ying/diem/language/diem-framework/modules/ChainId.move:24:5+1
    assume {:print "$at(7,961,962)"} true;
L2:

    // assert Not(Not(DiemTimestamp::$is_genesis[@106]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:142:9+51
    ...
    // assert Not(exists[@107]<ChainId::ChainId>($t4)) at /home/ying/diem/language/diem-framework/modules/ChainId.move:32:9+66
    assume {:print "$at(7,1238,1304)"} true;
    assert {:msg "assert_failed(7,1238,1304): function does not abort under this condition"}
      !$ResourceExists($1_ChainId_ChainId_$memory#107, $t4);

    // assert exists<ChainId::ChainId>($t4) at /home/ying/diem/language/diem-framework/modules/ChainId.move:33:9+33
    assume {:print "$at(7,1313,1346)"} true;
    assert {:msg "assert_failed(7,1313,1346): post-condition does not hold"}
      $ResourceExists($1_ChainId_ChainId_$memory, $t4);

    // return () at /home/ying/diem/language/diem-framework/modules/ChainId.move:33:9+33
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/ChainId.move:24:5+1
    assume {:print "$at(7,961,962)"} true;
L3:

    // assert Or(Or(Not(DiemTimestamp::$is_genesis[@106]()), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), exists[@107]<ChainId::ChainId>($t4)) at /home/ying/diem/language/diem-framework/modules/ChainId.move:26:5+384
    assume {:print "$at(7,968,1352)"} true;
    assert {:msg "assert_failed(7,968,1352): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#106) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || $ResourceExists($1_ChainId_ChainId_$memory#107, $t4));

    // assert Or(Or(And(Not(DiemTimestamp::$is_genesis[@106]()), Eq(1, $t6)), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t6))), And(exists[@107]<ChainId::ChainId>($t4), Eq(6, $t6))) at /home/ying/diem/language/diem-framework/modules/ChainId.move:26:5+384
    assert {:msg "assert_failed(7,968,1352): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#106) && $IsEqual'u8'(1, $t6)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t6))) || ($ResourceExists($1_ChainId_ChainId_$memory#107, $t4) && $IsEqual'u8'(6, $t6)));

    // abort($t6) at /home/ying/diem/language/diem-framework/modules/ChainId.move:26:5+384
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
// fun ChainId::get [verification] at /home/ying/diem/language/diem-framework/modules/ChainId.move:37:5+158
procedure {:timeLimit 40} $1_ChainId_get$verify() returns ($ret0: int)
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/ChainId.move:37:5+158
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(7,1408,1566)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), exists<ChainId::ChainId>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/ChainId.move:37:5+158
    // global invariant at /home/ying/diem/language/diem-framework/modules/ChainId.move:51:9+96
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_ChainId_ChainId_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ChainId.move:37:5+158
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<ChainId::ChainId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ChainId.move:37:5+158
    assume (forall $a_0: int :: {$ResourceValue($1_ChainId_ChainId_$memory, $a_0)}(var $rsc := $ResourceValue($1_ChainId_ChainId_$memory, $a_0);
    ($IsValid'$1_ChainId_ChainId'($rsc))));
