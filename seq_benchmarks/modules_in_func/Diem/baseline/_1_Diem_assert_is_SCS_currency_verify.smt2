...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1082312) (let ((anon10_Else_correct true))
(let ((anon10_Then_correct  (=> |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| (and (=> (= (ControlFlow 0 715665) (- 0 1083062)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 715665) (- 0 1083083)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@0))))
 ...
 :qid |Diembpl.11406:15|
 :skolemid |475|
)) (and (=> (= (ControlFlow 0 715665) (- 0 1083112)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@2)))
 ...
 :qid |Diembpl.11411:15|
 :skolemid |476|
)) (and (=> (= (ControlFlow 0 715665) (- 0 1083137)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 715665) (- 0 1083158)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4))))
 ...
 :qid |Diembpl.11421:15|
 :skolemid |477|
)) (and (=> (= (ControlFlow 0 715665) (- 0 1083187)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6)))
 ...
 :qid |Diembpl.11426:15|
 :skolemid |478|
)) (and (=> (= (ControlFlow 0 715665) (- 0 1083212)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 715665) (- 0 1083233)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 715665) (- 0 1083254)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8))))
 ...
 :qid |Diembpl.11441:15|
 :skolemid |479|
)) (and (=> (= (ControlFlow 0 715665) (- 0 1083290)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10)))
...
(let ((anon9_Else_correct  (=> (and (not $abort_flag@2) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t6) (= $t6 1)) (and (= $t6 $t6) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 715357) 715665) anon10_Then_correct) (=> (= (ControlFlow 0 715357) 715373) anon10_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$L5_correct|  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 |inline$$1_Diem_is_SCS_currency'#0'$0$$t2@1|) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 715249) 715679) anon9_Then_correct) (=> (= (ControlFlow 0 715249) 715357) anon9_Else_correct))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t2@1| $abort_code@1) (= (ControlFlow 0 715243) 715249))) |inline$$1_Diem_is_SCS_currency'#0'$0$L5_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|  (=> (and (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1|) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1|))) (and (=> (= (ControlFlow 0 715145) 715679) anon9_Then_correct) (=> (= (ControlFlow 0 715145) 715357) anon9_Else_correct)))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else$1_correct|  (=> (= inline$$Not$0$dst@1 inline$$Not$0$dst@1) (=> (and (and (= $abort_code@2 $abort_code@1) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| inline$$Not$0$dst@1)) (and (= $abort_flag@1 $abort_flag@0) (= (ControlFlow 0 715229) 715145))) |inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not |inline$$1_Diem_is_SCS_currency'#0'$0$$t5@1|)) (= (ControlFlow 0 715211) 715229)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else$1_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|  (=> (not $abort_flag@0) (=> (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t5@1| (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2|)) (= (ControlFlow 0 715217) 715211)) inline$$Not$0$anon0_correct))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then$1_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@0|)) (and (=> (= (ControlFlow 0 715301) 715243) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 715301) 715217) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|))))))
...
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@1| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@1|))) (and (=> (= (ControlFlow 0 715169) 715243) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 715169) 715217) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|))))))
...
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Else_correct|  (=> (and (not |inline$$1_Diem_is_currency'#0'$0$$t1@1|) (= false false)) (=> (and (and (= $abort_code@2 $abort_code@0) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| false)) (and (= $abort_flag@1 false) (= (ControlFlow 0 715133) 715145))) |inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|))))
...
(let ((anon8_Else_correct  (=> (and (not $t2) (= (ControlFlow 0 715321) 715105)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon0_correct|)))
(let ((anon8_Then_correct true))
(let ((anon0$1_correct  (=> (and (and (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 ...
 :skolemid |473|
))) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0)))
...
)) (= $t2  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 714766) 715705) anon8_Then_correct) (=> (= (ControlFlow 0 714766) 715321) anon8_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 714487) 714766)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1082312) 714487) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))
))
(check-sat)
(pop 1)
