...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2004596) (let ((anon15_Else_correct  (=> (and (not $abort_flag@1) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1|)) (and (=> (= (ControlFlow 0 1240477) (- 0 2005131)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 1240477) (- 0 2005142)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)))))
 :qid |DiemAccountbpl.43984:15|
 :skolemid |1236|
 ...
 :qid |DiemAccountbpl.43984:15|
 :skolemid |1236|
)) (=> (= (ControlFlow 0 1240477) (- 0 2005178)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2) (>= (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2))) (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2))))))
 :qid |DiemAccountbpl.43989:15|
 :skolemid |1237|
))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 1240056) (- 0 2005093)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)) (=> (= (ControlFlow 0 1240056) (- 0 2005099)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)) (= 5 $t6@0)))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 1240491) 1240056))) L3_correct)))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon3_Else_correct|  (=> (and (and (not $abort_flag@0) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_Diem_value'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1240345) 1240491) anon15_Then_correct) (=> (= (ControlFlow 0 1240345) 1240477) anon15_Else_correct)))))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon3_Then_correct|  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $abort_flag@1 true) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 1240363) 1240491) anon15_Then_correct) (=> (= (ControlFlow 0 1240363) 1240477) anon15_Else_correct)))))
(let ((|inline$$1_Diem_value'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1| |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1|) (=> (and (= |inline$$1_Diem_value'#0'$0$$t1@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1|)) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1240321) 1240363) |inline$$1_DiemAccount_balance_for'#0'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1240321) 1240345) |inline$$1_DiemAccount_balance_for'#0'$0$anon3_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon0_correct|  (=> (= $t7@1 $t7@1) (=> (and (= |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1| (|$coin#$1_DiemAccount_Balance'#0'| $t7@1)) (= (ControlFlow 0 1240327) 1240321)) |inline$$1_Diem_value'#0'$0$anon0_correct|))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 1240369) 1240327)) |inline$$1_DiemAccount_balance_for'#0'$0$anon0_correct|)))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 1240505) 1240056))) L3_correct)))
(let ((anon13_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1240557) 1240505) anon14_Then_correct) (=> (= (ControlFlow 0 1240557) 1240369) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 1240555) 1240557)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1240074) 1240505) anon14_Then_correct) (=> (= (ControlFlow 0 1240074) 1240369) anon14_Else_correct))))))
(let ((anon12_Then_correct  (=> $t3@0 (and (=> (= (ControlFlow 0 1240060) 1240555) anon13_Then_correct) (=> (= (ControlFlow 0 1240060) 1240074) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not $t3@0) (= $t5 $t5)) (and (= $t6@0 $t5) (= (ControlFlow 0 1240024) 1240056))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (and (and (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468892| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@3)))
 :qid |DiemAccountbpl.43882:22|
 :skolemid |1232|
)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4)))
 :qid |DiemAccountbpl.43882:218|
 :skolemid |1233|
))) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@5)))
 :qid |DiemAccountbpl.43882:415|
 :skolemid |1234|
))) (|$IsValid'address'| _$t0)) (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $a_0)))
(|$IsValid'$1_DiemAccount_Balance'#0''| $rsc))
 :qid |DiemAccountbpl.43888:20|
 :skolemid |1235|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $a_0))
)) (= _$t0 _$t0)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)) (|$IsValid'u64'| 19))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0))))) (and (=> (= (ControlFlow 0 1240008) 1240060) anon12_Then_correct) (=> (= (ControlFlow 0 1240008) 1240024) anon12_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1239849) 1240008)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2004596) 1239849) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))
))
(check-sat)
(pop 1)
