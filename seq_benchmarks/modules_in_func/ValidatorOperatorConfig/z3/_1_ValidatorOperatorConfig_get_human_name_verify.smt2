...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 230891) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t8@0 (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| $t7@1)) (= $t8@0 $t8@0)) (and (=> (= (ControlFlow 0 169810) (- 0 231265)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0))) (=> (= (ControlFlow 0 169810) (- 0 231276)) (= $t8@0 (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 169746) (- 0 231218)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)) (=> (= (ControlFlow 0 169746) (- 0 231224)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)) (= 5 $t4@0)))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t4@0 $abort_code@1) (= (ControlFlow 0 169824) 169746))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 169876) 169824) anon15_Then_correct) (=> (= (ControlFlow 0 169876) 169810) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)) (= (ControlFlow 0 169874) 169876)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 169764) 169824) anon15_Then_correct) (=> (= (ControlFlow 0 169764) 169810) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 (and (=> (= (ControlFlow 0 169750) 169874) anon14_Then_correct) (=> (= (ControlFlow 0 169750) 169764) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1) (= $t6 $t6)) (and (= $t4@0 $t6) (= (ControlFlow 0 169714) 169746))) L3_correct)))
(let ((anon12_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t6) (= $t6 5)) (and (= $t6 $t6) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1))) (and (=> (= (ControlFlow 0 169698) 169750) anon13_Then_correct) (=> (= (ControlFlow 0 169698) 169714) anon13_Else_correct))))))
(let ((anon12_Then_correct true))
(let ((inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1)) (and (=> (= (ControlFlow 0 169656) 169890) anon12_Then_correct) (=> (= (ControlFlow 0 169656) 169698) anon12_Else_correct))))))
(let ((anon0$1_correct  (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_99251| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_99251| $1_Roles_RoleId_$memory) addr@@0)) 4))))
 :qid |ValidatorOperatorConfigbpl.5890:20|
 :skolemid |164|
)) (=> (and (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0)))
(|$IsValid'$1_ValidatorOperatorConfig_ValidatorOperatorConfig'| $rsc))
 :qid |ValidatorOperatorConfigbpl.5897:20|
 :skolemid |165|
 :pattern ( (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0))
))) (and (= _$t0 _$t0) (= (ControlFlow 0 169662) 169656))) inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_70082_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorOperatorConfigbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 169482) 169662)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 230891) 169482) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))
))
(check-sat)
(pop 1)
