...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1149686) (let ((anon11_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t4@0 (|$fractional_part#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t3@1)) (= $t4@0 $t4@0)) (and (=> (= (ControlFlow 0 816785) (- 0 1150149)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 816785) (- 0 1150170)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@0))))
 ...
 :qid |Diembpl.28068:15|
 :skolemid |1427|
)) (and (=> (= (ControlFlow 0 816785) (- 0 1150199)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@2)))
 ...
 :qid |Diembpl.28073:15|
 :skolemid |1428|
)) (and (=> (= (ControlFlow 0 816785) (- 0 1150224)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 816785) (- 0 1150245)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@4))))
 ...
 :qid |Diembpl.28083:15|
 :skolemid |1429|
)) (and (=> (= (ControlFlow 0 816785) (- 0 1150274)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@6)))
 ...
 :qid |Diembpl.28103:15|
 :skolemid |1431|
)) (and (=> (= (ControlFlow 0 816785) (- 0 1150377)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307989| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_307989| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@10)))
...
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 816857) 816799) anon11_Then_correct) (=> (= (ControlFlow 0 816857) 816785) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= (ControlFlow 0 816855) 816857)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= $t3@1 $t3@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 816483) 816799) anon11_Then_correct) (=> (= (ControlFlow 0 816483) 816785) anon11_Else_correct))))))
(let ((anon9_Else_correct  (=> (and (not $t0) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 816469) 816855) anon10_Then_correct) (=> (= (ControlFlow 0 816469) 816483) anon10_Else_correct)))))
...
)) (= $t0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 816455) 816883) anon9_Then_correct) (=> (= (ControlFlow 0 816455) 816469) anon9_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 816176) 816455)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1149686) 816176) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))
))
(check-sat)
(pop 1)
