...
L5:
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:91:9+98
    assume {:print "$at(25,3536,3634)"} true;
    assert {:msg "assert_failed(25,3536,3634): global memory invariant does not hold"}
...
procedure {:timeLimit 40} $1_RegisteredCurrencies_initialize$verify(_$t0: int) returns ()
{
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(25,847,1127)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));
    ...
    // @173 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:22:5+1
    assume {:print "$at(25,847,848)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#173 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @174 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:22:5+1
    $1_Roles_RoleId_$memory#174 := $1_Roles_RoleId_$memory;

    // @177 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:22:5+1
    $1_DiemConfig_Configuration_$memory#177 := $1_DiemConfig_Configuration_$memory;

    // @175 := save_mem(DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:22:5+1
    ...
    // @176 := save_mem(DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:22:5+1
...
L1:
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@173]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:140:9+51
    ...
    // assert Not(Not(exists[@174]<Roles::RoleId>($t1))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t1)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    ...
    // assert Not(DiemConfig::spec_is_published[@175]<RegisteredCurrencies::RegisteredCurrencies>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:257:9+38
    ...
    // assert Not(exists[@176]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:258:9+86
    ...
    // assert Not(Not(exists[@174]<Roles::RoleId>($t2))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    assume {:print "$at(26,23574,23633)"} true;
    assert {:msg "assert_failed(26,23574,23633): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#174, $t2);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t2)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    assume {:print "$at(26,23642,23729)"} true;
    assert {:msg "assert_failed(26,23642,23729): function does not abort under this condition"}
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_genesis[@173]()), Not(exists[@174]<Roles::RoleId>($t1))), Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t1)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), DiemConfig::spec_is_published[@175]<RegisteredCurrencies::RegisteredCurrencies>()), exists[@176]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))), Not(exists[@174]<Roles::RoleId>($t2))), Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t2)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:30:5+94
    assume {:print "$at(25,1132,1226)"} true;
    assert {:msg "assert_failed(25,1132,1226): abort not covered by any of the `aborts_if` clauses"}
      ((((((((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#173) || !$ResourceExists($1_Roles_RoleId_$memory#174, $t1)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#174, $t1)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || $1_DiemConfig_spec_is_published'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#175)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#176, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#174, $t2)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#174, $t2)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_genesis[@173]()), Eq(1, $t4)), And(Not(exists[@174]<Roles::RoleId>($t1)), Eq(5, $t4))), And(Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t1)), 0), Eq(3, $t4))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t4))), DiemConfig::spec_is_published[@175]<RegisteredCurrencies::RegisteredCurrencies>()), exists[@176]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))), And(Not(exists[@174]<Roles::RoleId>($t2)), Eq(5, $t4))), And(Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t2)), 0), Eq(3, $t4))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t4))) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:30:5+94
    assert {:msg "assert_failed(25,1132,1226): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#173) && $IsEqual'num'(1, $t4)) || (!$ResourceExists($1_Roles_RoleId_$memory#174, $t1) && $IsEqual'num'(5, $t4))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#174, $t1)), 0) && $IsEqual'num'(3, $t4))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t4))) || $1_DiemConfig_spec_is_published'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#175)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#176, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory#174, $t2) && $IsEqual'num'(5, $t4))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#174, $t2)), 0) && $IsEqual'num'(3, $t4))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t4)));
...
L6:
    ...
    // @150 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@150](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
...
procedure {:timeLimit 40} $1_RegisteredCurrencies_add_currency_code$verify(_$t0: int, _$t1: Vec (int)) returns ()
{
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(25,1822,2271)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));
    ...
    // @141 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:49:5+1
    assume {:print "$at(25,1822,1823)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @143 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:49:5+1
    $1_DiemConfig_Configuration_$memory#143 := $1_DiemConfig_Configuration_$memory;

    // @142 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:49:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#142 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @139 := save_mem(DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:49:5+1
    ...
    // @140 := save_mem(DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:49:5+1
...
L2:
    ...
    // assert Not(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@139]<RegisteredCurrencies::RegisteredCurrencies>()), $t1)) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:70:9+154
    ...
    // assert Not(Not(exists[@140]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:137:9+129
    ...
    // assert Not(Not(exists[@139]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:101:9+76
    assume {:print "$at(13,3859,3935)"} true;
    assert {:msg "assert_failed(13,3859,3935): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139, 173345816);
    ...
    // assert Vector::eq_push_back<vector<u8>>(RegisteredCurrencies::get_currency_codes(), RegisteredCurrencies::get_currency_codes[@139](), $t1) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:78:9+93
    assume {:print "$at(25,3010,3103)"} true;
    assert {:msg "assert_failed(25,3010,3103): post-condition does not hold"}
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@143](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:144:9+52
    assume {:print "$at(13,5734,5786)"} true;
    assert {:msg "assert_failed(13,5734,5786): post-condition does not hold"}
...
L3:
    ...
    // assert Or(Or(Or(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@139]<RegisteredCurrencies::RegisteredCurrencies>()), $t1), Not(exists[@140]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))), Not(exists[@139]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(a550c18))), And(And(And(And(DiemTimestamp::$is_operating[@141](), DiemConfig::$reconfiguration_enabled[@142]()), Gt(DiemTimestamp::spec_now_microseconds[@141](), 0)), Lt(select DiemConfig::Configuration.epoch($t5), 18446744073709551615)), Lt($t6, select DiemConfig::Configuration.last_reconfiguration_time($t5)))) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:5+111
    assume {:print "$at(25,2276,2387)"} true;
    assert {:msg "assert_failed(25,2276,2387): abort not covered by any of the `aborts_if` clauses"}
      ((($ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139)), $t1) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#140, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139, 173345816)) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#142)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141) > 0)) && ($epoch#$1_DiemConfig_Configuration($t5) < 18446744073709551615)) && ($t6 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t5))));

    // assert Or(Or(Or(And(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@139]<RegisteredCurrencies::RegisteredCurrencies>()), $t1), Eq(7, $t8)), And(Not(exists[@140]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))), Eq(4, $t8))), And(Not(exists[@139]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(a550c18)), Eq(5, $t8))), And(And(And(And(And(DiemTimestamp::$is_operating[@141](), DiemConfig::$reconfiguration_enabled[@142]()), Gt(DiemTimestamp::spec_now_microseconds[@141](), 0)), Lt(select DiemConfig::Configuration.epoch($t5), 18446744073709551615)), Lt($t6, select DiemConfig::Configuration.last_reconfiguration_time($t5))), Eq(1, $t8))) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:5+111
    assert {:msg "assert_failed(25,2276,2387): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((($ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139)), $t1) && $IsEqual'num'(7, $t8)) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#140, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(4, $t8))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139, 173345816) && $IsEqual'num'(5, $t8))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#142)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141) > 0)) && ($epoch#$1_DiemConfig_Configuration($t5) < 18446744073709551615)) && ($t6 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t5))) && $IsEqual'num'(1, $t8)));
