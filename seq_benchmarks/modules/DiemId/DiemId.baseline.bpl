...
L7:
    ...
    // @182 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@182](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
L6:
    ...
    // @154 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@154](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
L7:
    ...
    // @172 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@172](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
// fun DiemId::add_diem_id_domain [verification] at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1139
procedure {:timeLimit 40} $1_DiemId_add_diem_id_domain$verify(_$t0: int, _$t1: int, _$t2: Vec (int)) returns ()
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1139
    assume {:print "$at(15,5856,6995)"} true;
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1139
    assume $IsValid'address'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1139
    assume $IsValid'vec'u8''($t2);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1139
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemId::DiemIdDomainManager>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1139
    ...
    // assume Identical($t11, select DiemId::DiemIdDomains.domains(global<DiemId::DiemIdDomains>($t1))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:187:9+53
    assume {:print "$at(15,7283,7336)"} true;
    ...
    // assume Identical($t13, select DiemId::DiemIdDomainManager.diem_id_domain_events(global<DiemId::DiemIdDomainManager>(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:203:9+109
    assume {:print "$at(15,8035,8144)"} true;
    assume ($t13 == $diem_id_domain_events#$1_DiemId_DiemIdDomainManager($ResourceValue($1_DiemId_DiemIdDomainManager_$memory, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())));

    // assume Identical($t14, pack DiemId::DiemIdDomainEvent(false, pack DiemId::DiemIdDomain($t2), $t1)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:204:9+134
    assume {:print "$at(15,8153,8287)"} true;
    assume ($t14 == $1_DiemId_DiemIdDomainEvent(false, $1_DiemId_DiemIdDomain($t2), $t1));

    // @122 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1
    assume {:print "$at(15,5856,5857)"} true;
    $1_Roles_RoleId_$memory#122 := $1_Roles_RoleId_$memory;

    // @121 := save_mem(DiemId::DiemIdDomainManager) at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1
    $1_DiemId_DiemIdDomainManager_$memory#121 := $1_DiemId_DiemIdDomainManager_$memory;

    // @120 := save_mem(DiemId::DiemIdDomains) at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1
    $1_DiemId_DiemIdDomains_$memory#120 := $1_DiemId_DiemIdDomains_$memory;

    // trace_local[tc_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1
    assume {:print "$track_local(25,0,0):", $t0} $t0 == $t0;

    // trace_local[address]($t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1
    assume {:print "$track_local(25,0,1):", $t1} $t1 == $t1;

    // trace_local[domain]($t2) at /home/ying/diem/language/diem-framework/modules/DiemId.move:147:5+1
    assume {:print "$track_local(25,0,2):", $t2} $t2 == $t2;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemId.move:152:9+45
    // >> opaque call: Roles::assert_treasury_compliance($t0)
    assume {:print "$at(15,6030,6075)"} true;
    ...
    // opaque begin: Roles::assert_treasury_compliance($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:152:9+45
    assume {:print "$at(15,6030,6075)"} true;

    // assume Identical($t16, Or(Or(Not(exists<Roles::RoleId>($t15)), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t15)), 1)), Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:152:9+45
    ...
    // if ($t16) goto L9 else goto L8 at /home/ying/diem/language/diem-framework/modules/DiemId.move:152:9+45
    if ($t16) { goto L9; } else { goto L8; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/DiemId.move:152:9+45
L9:

    // assume Or(Or(And(Not(exists<Roles::RoleId>($t15)), Eq(5, $t17)), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t15)), 1), Eq(3, $t17))), And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS()), Eq(2, $t17))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:152:9+45
    assume (((!$ResourceExists($1_Roles_RoleId_$memory, $t15) && $IsEqual'u8'(5, $t17)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t15)), 1) && $IsEqual'u8'(3, $t17))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t17)));

    // trace_abort($t17) at /home/ying/diem/language/diem-framework/modules/DiemId.move:152:9+45
    assume {:print "$at(15,6030,6075)"} true;
    assume {:print "$track_abort(25,0):", $t17} $t17 == $t17;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemId.move:152:9+45
    goto L7;

    // label L8 at /home/ying/diem/language/diem-framework/modules/DiemId.move:152:9+45
L8:

    // opaque end: Roles::assert_treasury_compliance($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:152:9+45

    // $t18 := DiemId::tc_domain_manager_exists() on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:16+26
    assume {:print "$at(15,6092,6118)"} true;
    ...
    // $t19 := 1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:66+23
    $t19 := 1;
    assume $IsValid'u64'($t19);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:44+46
    // >> opaque call: $t13 := Errors::not_published($t12)

    // $t20 := opaque begin: Errors::not_published($t19) at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:44+46

    // assume WellFormed($t20) at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:44+46
    assume $IsValid'u64'($t20);

    // assume Eq<u64>($t20, 5) at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:44+46
    assume $IsEqual'u64'($t20, 5);

    // $t20 := opaque end: Errors::not_published($t19) at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:44+46

    // trace_local[tmp#$6]($t20) at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:9+82
    assume {:print "$track_local(25,0,6):", $t20} $t20 == $t20;

    // trace_local[tmp#$5]($t18) at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:9+82
    assume {:print "$track_local(25,0,5):", $t18} $t18 == $t18;

    // if ($t18) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:9+82
    if ($t18) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:9+82
L1:

    // trace_abort($t20) at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:9+82
    assume {:print "$at(15,6085,6167)"} true;
    assume {:print "$track_abort(25,0):", $t20} $t20 == $t20;

    // $t17 := move($t20) at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:9+82
    $t17 := $t20;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemId.move:153:9+82
    goto L7;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemId.move:155:35+7
    assume {:print "$at(15,6219,6226)"} true;
L0:

    // $t21 := exists<DiemId::DiemIdDomains>($t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:155:13+6
    $t21 := $ResourceExists($1_DiemId_DiemIdDomains_$memory, $t1);

    // $t22 := 4 at /home/ying/diem/language/diem-framework/modules/DiemId.move:156:35+30
    assume {:print "$at(15,6263,6293)"} true;
    $t22 := 4;
    assume $IsValid'u64'($t22);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemId.move:156:13+53
    // >> opaque call: $t16 := Errors::not_published($t15)

    // $t23 := opaque begin: Errors::not_published($t22) at /home/ying/diem/language/diem-framework/modules/DiemId.move:156:13+53

    // assume WellFormed($t23) at /home/ying/diem/language/diem-framework/modules/DiemId.move:156:13+53
    assume $IsValid'u64'($t23);

    // assume Eq<u64>($t23, 5) at /home/ying/diem/language/diem-framework/modules/DiemId.move:156:13+53
    assume $IsEqual'u64'($t23, 5);

    // $t23 := opaque end: Errors::not_published($t22) at /home/ying/diem/language/diem-framework/modules/DiemId.move:156:13+53

    // trace_local[tmp#$8]($t23) at /home/ying/diem/language/diem-framework/modules/DiemId.move:154:9+127
    assume {:print "$at(15,6177,6304)"} true;
    assume {:print "$track_local(25,0,8):", $t23} $t23 == $t23;

    // trace_local[tmp#$7]($t21) at /home/ying/diem/language/diem-framework/modules/DiemId.move:154:9+127
    assume {:print "$track_local(25,0,7):", $t21} $t21 == $t21;

    // if ($t21) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemId.move:154:9+127
    if ($t21) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemId.move:154:9+127
L3:

    // trace_abort($t23) at /home/ying/diem/language/diem-framework/modules/DiemId.move:154:9+127
    assume {:print "$at(15,6177,6304)"} true;
    assume {:print "$track_abort(25,0):", $t23} $t23 == $t23;

    // $t17 := move($t23) at /home/ying/diem/language/diem-framework/modules/DiemId.move:154:9+127
    $t17 := $t23;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemId.move:154:9+127
    goto L7;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemId.move:159:64+7
    assume {:print "$at(15,6370,6377)"} true;
L2:

    // $t24 := borrow_global<DiemId::DiemIdDomains>($t1) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:159:31+17
    ...
    if ($abort_flag) {
        assume {:print "$at(15,6337,6354)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(25,0):", $t17} $t17 == $t17;
        goto L7;
    }

    // trace_local[account_domains]($t24) at /home/ying/diem/language/diem-framework/modules/DiemId.move:159:13+15
    $temp_0'$1_DiemId_DiemIdDomains' := $Dereference($t24);
    assume {:print "$track_local(25,0,3):", $temp_0'$1_DiemId_DiemIdDomains'} $temp_0'$1_DiemId_DiemIdDomains' == $temp_0'$1_DiemId_DiemIdDomains';

    // $t25 := DiemId::create_diem_id_domain($t2) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:160:30+29
    assume {:print "$at(15,6409,6438)"} true;
    ...
    // trace_local[diem_id_domain]($t25) at /home/ying/diem/language/diem-framework/modules/DiemId.move:160:13+14
    assume {:print "$track_local(25,0,4):", $t25} $t25 == $t25;

    // $t26 := get_field<DiemId::DiemIdDomains>.domains($t24) at /home/ying/diem/language/diem-framework/modules/DiemId.move:163:31+24
    assume {:print "$at(15,6487,6511)"} true;
    $t26 := $domains#$1_DiemId_DiemIdDomains($Dereference($t24));

    // $t27 := Vector::contains<DiemId::DiemIdDomain>($t26, $t25) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:163:14+59
    call $t27 := $1_Vector_contains'$1_DiemId_DiemIdDomain'($t26, $t25);
    if ($abort_flag) {
        assume {:print "$at(15,6470,6529)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(25,0):", $t17} $t17 == $t17;
        goto L7;
    }

    // $t28 := !($t27) at /home/ying/diem/language/diem-framework/modules/DiemId.move:163:13+1
    call $t28 := $Not($t27);

    // $t29 := 3 at /home/ying/diem/language/diem-framework/modules/DiemId.move:164:38+22
    assume {:print "$at(15,6568,6590)"} true;
    $t29 := 3;
    assume $IsValid'u64'($t29);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemId.move:164:13+48
    // >> opaque call: $t23 := Errors::invalid_argument($t22)

    // $t30 := opaque begin: Errors::invalid_argument($t29) at /home/ying/diem/language/diem-framework/modules/DiemId.move:164:13+48

    // assume WellFormed($t30) at /home/ying/diem/language/diem-framework/modules/DiemId.move:164:13+48
    assume $IsValid'u64'($t30);

    // assume Eq<u64>($t30, 7) at /home/ying/diem/language/diem-framework/modules/DiemId.move:164:13+48
    assume $IsEqual'u64'($t30, 7);

    // $t30 := opaque end: Errors::invalid_argument($t29) at /home/ying/diem/language/diem-framework/modules/DiemId.move:164:13+48

    // trace_local[tmp#$10]($t30) at /home/ying/diem/language/diem-framework/modules/DiemId.move:162:9+152
    assume {:print "$at(15,6449,6601)"} true;
    assume {:print "$track_local(25,0,10):", $t30} $t30 == $t30;

    // trace_local[tmp#$9]($t28) at /home/ying/diem/language/diem-framework/modules/DiemId.move:162:9+152
    assume {:print "$track_local(25,0,9):", $t28} $t28 == $t28;

    // if ($t28) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/DiemId.move:162:9+152
    if ($t28) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemId.move:162:9+152
L5:

    // assert forall i: Range(0, Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($t24))): Le(Len<u8>(select DiemId::DiemIdDomain.domain(Index(select DiemId::DiemIdDomains.domains($t24), i))), 63) at /home/ying/diem/language/diem-framework/modules/DiemId.move:20:9+79
    // data invariant at /home/ying/diem/language/diem-framework/modules/DiemId.move:20:9+79
    assume {:print "$at(15,611,690)"} true;
    assert {:msg "assert_failed(15,611,690): data invariant does not hold"}
    ...
    // assert forall $elem: select DiemId::DiemIdDomains.domains($t24): Le(Len<u8>(select DiemId::DiemIdDomain.domain($elem)), 63) at /home/ying/diem/language/diem-framework/modules/DiemId.move:32:9+39
    // data invariant at /home/ying/diem/language/diem-framework/modules/DiemId.move:32:9+39
    assume {:print "$at(15,1131,1170)"} true;
    assert {:msg "assert_failed(15,1131,1170): data invariant does not hold"}
    ...
    // destroy($t24) at /home/ying/diem/language/diem-framework/modules/DiemId.move:162:9+152
    assume {:print "$at(15,6449,6601)"} true;

    // trace_abort($t30) at /home/ying/diem/language/diem-framework/modules/DiemId.move:162:9+152
    assume {:print "$at(15,6449,6601)"} true;
    assume {:print "$track_abort(25,0):", $t30} $t30 == $t30;

    // $t17 := move($t30) at /home/ying/diem/language/diem-framework/modules/DiemId.move:162:9+152
    $t17 := $t30;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemId.move:162:9+152
    goto L7;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemId.move:167:32+15
    assume {:print "$at(15,6635,6650)"} true;
L4:

    // $t31 := borrow_field<DiemId::DiemIdDomains>.domains($t24) at /home/ying/diem/language/diem-framework/modules/DiemId.move:167:27+28
    $t31 := $ChildMutation($t24, 0, $domains#$1_DiemId_DiemIdDomains($Dereference($t24)));

    // Vector::push_back<DiemId::DiemIdDomain>($t31, $t25) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:167:9+68
    call $t31 := $1_Vector_push_back'$1_DiemId_DiemIdDomain'($t31, $t25);
    if ($abort_flag) {
        assume {:print "$at(15,6612,6680)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(25,0):", $t17} $t17 == $t17;
        goto L7;
    }

    // write_back[Reference($t24).domains]($t31) at /home/ying/diem/language/diem-framework/modules/DiemId.move:167:9+68
    ...
    // write_back[DiemId::DiemIdDomains@]($t24) at /home/ying/diem/language/diem-framework/modules/DiemId.move:167:9+68
    assume {:print "$at(15,6612,6680)"} true;
    $1_DiemId_DiemIdDomains_$memory := $ResourceUpdate($1_DiemId_DiemIdDomains_$memory, $GlobalLocationAddress($t24),
        $Dereference($t24));

    // $t32 := CoreAddresses::TREASURY_COMPLIANCE_ADDRESS() on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:170:57+44
    assume {:print "$at(15,6766,6810)"} true;
    call $t32 := $1_CoreAddresses_TREASURY_COMPLIANCE_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(15,6766,6810)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(25,0):", $t17} $t17 == $t17;
    ...
    // $t33 := borrow_global<DiemId::DiemIdDomainManager>($t32) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:170:18+17
    ...
    if ($abort_flag) {
        assume {:print "$at(15,6727,6744)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(25,0):", $t17} $t17 == $t17;
        goto L7;
    }

    // $t34 := borrow_field<DiemId::DiemIdDomainManager>.diem_id_domain_events($t33) at /home/ying/diem/language/diem-framework/modules/DiemId.move:170:13+111
    $t34 := $ChildMutation($t33, 0, $diem_id_domain_events#$1_DiemId_DiemIdDomainManager($Dereference($t33)));

    // $t35 := false at /home/ying/diem/language/diem-framework/modules/DiemId.move:172:26+5
    assume {:print "$at(15,6892,6897)"} true;
    $t35 := false;
    assume $IsValid'bool'($t35);

    // $t36 := pack DiemId::DiemIdDomainEvent($t35, $t25, $t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:171:13+130
    assume {:print "$at(15,6847,6977)"} true;
    $t36 := $1_DiemId_DiemIdDomainEvent($t35, $t25, $t1);

    // Event::emit_event<DiemId::DiemIdDomainEvent>($t34, $t36) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:169:9+297
    assume {:print "$at(15,6691,6988)"} true;
    ...
    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemId.move:177:5+1
    assume {:print "$at(15,6994,6995)"} true;
L6:

    // assume Identical($t37, select DiemId::DiemIdDomains.domains(global<DiemId::DiemIdDomains>($t1))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:197:9+58
    assume {:print "$at(15,7809,7867)"} true;
    assume ($t37 == $domains#$1_DiemId_DiemIdDomains($ResourceValue($1_DiemId_DiemIdDomains_$memory, $t1)));

    // assert Not(Not(exists[@120]<DiemId::DiemIdDomains>($t1))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:190:9+69
    assume {:print "$at(15,7464,7533)"} true;
    assert {:msg "assert_failed(15,7464,7533): function does not abort under this condition"}
      !!$ResourceExists($1_DiemId_DiemIdDomains_$memory#120, $t1);

    // assert Not(Not(DiemId::$tc_domain_manager_exists[@121]())) at /home/ying/diem/language/diem-framework/modules/DiemId.move:191:9+65
    assume {:print "$at(15,7542,7607)"} true;
    assert {:msg "assert_failed(15,7542,7607): function does not abort under this condition"}
      !!$1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#121);

    // assert Not(ContainsVec<DiemId::DiemIdDomain>($t11, pack DiemId::DiemIdDomain($t2))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:192:9+83
    assume {:print "$at(15,7616,7699)"} true;
    assert {:msg "assert_failed(15,7616,7699): function does not abort under this condition"}
      !$ContainsVec'$1_DiemId_DiemIdDomain'($t11, $1_DiemId_DiemIdDomain($t2));

    // assert Not(Not(exists[@122]<Roles::RoleId>($t12))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t12)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    ...
    // assert Not(Gt(Vector::$length[]<u8>($t2), 63)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:76:9+79
    assume {:print "$at(15,2741,2820)"} true;
    assert {:msg "assert_failed(15,2741,2820): function does not abort under this condition"}
      !($1_Vector_$length'u8'($t2) > 63);

    // assert ContainsVec<DiemId::DiemIdDomain>($t37, pack DiemId::DiemIdDomain($t2)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:198:9+51
    assume {:print "$at(15,7876,7927)"} true;
    assert {:msg "assert_failed(15,7876,7927): post-condition does not hold"}
      $ContainsVec'$1_DiemId_DiemIdDomain'($t37, $1_DiemId_DiemIdDomain($t2));

    // assert EventStoreIncludes(ExtendEventStore(EmptyEventStore(), $t14, $t13)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:209:9+20
    assume {:print "$at(15,8296,8316)"} true;
    assert {:msg "assert_failed(15,8296,8316): function does not emit the expected event"}
    ...
    // assert EventStoreIncludedIn(ExtendEventStore(EmptyEventStore(), $t14, $t13)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:178:5+150
    assume {:print "$at(15,7000,7150)"} true;
    assert {:msg "assert_failed(15,7000,7150): emitted event not covered by any of the `emits` clauses"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/DiemId.move:178:5+150
    return;

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemId.move:177:5+1
    assume {:print "$at(15,6994,6995)"} true;
L7:

    // assert Or(Or(Or(Or(Or(Or(Not(exists[@120]<DiemId::DiemIdDomains>($t1)), Not(DiemId::$tc_domain_manager_exists[@121]())), ContainsVec<DiemId::DiemIdDomain>($t11, pack DiemId::DiemIdDomain($t2))), Not(exists[@122]<Roles::RoleId>($t12))), Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t12)), 1)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), Gt(Vector::$length[]<u8>($t2), 63)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:178:5+150
    assume {:print "$at(15,7000,7150)"} true;
    assert {:msg "assert_failed(15,7000,7150): abort not covered by any of the `aborts_if` clauses"}
      ((((((!$ResourceExists($1_DiemId_DiemIdDomains_$memory#120, $t1) || !$1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#121)) || $ContainsVec'$1_DiemId_DiemIdDomain'($t11, $1_DiemId_DiemIdDomain($t2))) || !$ResourceExists($1_Roles_RoleId_$memory#122, $t12)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t12)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || ($1_Vector_$length'u8'($t2) > 63));

    // assert Or(Or(Or(Or(Or(Or(And(Not(exists[@120]<DiemId::DiemIdDomains>($t1)), Eq(5, $t17)), And(Not(DiemId::$tc_domain_manager_exists[@121]()), Eq(5, $t17))), And(ContainsVec<DiemId::DiemIdDomain>($t11, pack DiemId::DiemIdDomain($t2)), Eq(7, $t17))), And(Not(exists[@122]<Roles::RoleId>($t12)), Eq(5, $t17))), And(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t12)), 1), Eq(3, $t17))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t17))), And(Gt(Vector::$length[]<u8>($t2), 63), Eq(7, $t17))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:178:5+150
    assert {:msg "assert_failed(15,7000,7150): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$ResourceExists($1_DiemId_DiemIdDomains_$memory#120, $t1) && $IsEqual'u8'(5, $t17)) || (!$1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#121) && $IsEqual'u8'(5, $t17))) || ($ContainsVec'$1_DiemId_DiemIdDomain'($t11, $1_DiemId_DiemIdDomain($t2)) && $IsEqual'u8'(7, $t17))) || (!$ResourceExists($1_Roles_RoleId_$memory#122, $t12) && $IsEqual'u8'(5, $t17))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t12)), 1) && $IsEqual'u8'(3, $t17))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t17))) || (($1_Vector_$length'u8'($t2) > 63) && $IsEqual'u8'(7, $t17)));

    // abort($t17) at /home/ying/diem/language/diem-framework/modules/DiemId.move:178:5+150
    $abort_code := $t17;
    $abort_flag := true;
    return;
...
// fun DiemId::create_diem_id_domain [baseline] at /home/ying/diem/language/diem-framework/modules/DiemId.move:66:5+207
procedure {:inline 1} $1_DiemId_create_diem_id_domain(_$t0: Vec (int)) returns ($ret0: $1_DiemId_DiemIdDomain)
{
    ...
    // bytecode translation starts here
    // trace_local[domain]($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:66:5+1
    assume {:print "$at(15,2318,2319)"} true;
    assume {:print "$track_local(25,1,0):", $t0} $t0 == $t0;

    // $t3 := Vector::length<u8>($t0) on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:16+23
    assume {:print "$at(15,2395,2418)"} true;
    ...
    // $t5 := 63 at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:43+13
    $t5 := 63;
    assume $IsValid'u64'($t5);

    // $t6 := <=($t3, $t5) at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:40+2
    call $t6 := $Le($t3, $t5);

    // $t7 := 5 at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:83+23
    $t7 := 5;
    assume $IsValid'u64'($t7);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:58+49
    // >> opaque call: $t7 := Errors::invalid_argument($t6)

    // $t8 := opaque begin: Errors::invalid_argument($t7) at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:58+49

    // assume WellFormed($t8) at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:58+49
    assume $IsValid'u64'($t8);

    // assume Eq<u64>($t8, 7) at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:58+49
    assume $IsEqual'u64'($t8, 7);

    // $t8 := opaque end: Errors::invalid_argument($t7) at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:58+49

    // trace_local[tmp#$2]($t8) at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:9+99
    assume {:print "$track_local(25,1,2):", $t8} $t8 == $t8;

    // trace_local[tmp#$1]($t6) at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:9+99
    assume {:print "$track_local(25,1,1):", $t6} $t6 == $t6;

    // if ($t6) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:9+99
    if ($t6) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:9+99
L1:

    // trace_abort($t8) at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:9+99
    assume {:print "$at(15,2388,2487)"} true;
    assume {:print "$track_abort(25,1):", $t8} $t8 == $t8;

    // $t4 := move($t8) at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:9+99
    $t4 := $t8;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemId.move:67:9+99
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemId.move:68:23+6
    assume {:print "$at(15,2511,2517)"} true;
L0:

    // $t9 := pack DiemId::DiemIdDomain($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:68:9+22
    $t9 := $1_DiemId_DiemIdDomain($t0);

    // trace_return[0]($t9) at /home/ying/diem/language/diem-framework/modules/DiemId.move:68:9+22
    assume {:print "$track_return(25,1,0):", $t9} $t9 == $t9;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemId.move:69:5+1
    assume {:print "$at(15,2524,2525)"} true;
L2:

    // return $t9 at /home/ying/diem/language/diem-framework/modules/DiemId.move:69:5+1
    $ret0 := $t9;
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemId.move:69:5+1
L3:

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/DiemId.move:69:5+1
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun DiemId::create_diem_id_domain [verification] at /home/ying/diem/language/diem-framework/modules/DiemId.move:66:5+207
procedure {:timeLimit 40} $1_DiemId_create_diem_id_domain$verify(_$t0: Vec (int)) returns ($ret0: $1_DiemId_DiemIdDomain)
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:72:17+6
    assume {:print "$at(15,2619,2625)"} true;
...
L0:
    ...
    // assert Le(Len<u8>(select DiemId::DiemIdDomain.domain($t9)), 63) at /home/ying/diem/language/diem-framework/modules/DiemId.move:32:9+39
    // data invariant at /home/ying/diem/language/diem-framework/modules/DiemId.move:32:9+39
    assume {:print "$at(15,1131,1170)"} true;
    assert {:msg "assert_failed(15,1131,1170): data invariant does not hold"}
    ...
    // trace_return[0]($t9) at /home/ying/diem/language/diem-framework/modules/DiemId.move:68:9+22
    assume {:print "$at(15,2497,2519)"} true;
    assume {:print "$track_return(25,1,0):", $t9} $t9 == $t9;
...
L2:
    ...
    // assert Not(Gt(Vector::$length[]<u8>($t0), 63)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:76:9+79
    assume {:print "$at(15,2741,2820)"} true;
    assert {:msg "assert_failed(15,2741,2820): function does not abort under this condition"}
      !($1_Vector_$length'u8'($t0) > 63);

    // assert Eq<DiemId::DiemIdDomain>($t9, pack DiemId::DiemIdDomain($t0)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:72:9+42
    assume {:print "$at(15,2611,2653)"} true;
    assert {:msg "assert_failed(15,2611,2653): post-condition does not hold"}
      $IsEqual'$1_DiemId_DiemIdDomain'($t9, $1_DiemId_DiemIdDomain($t0));

    // return $t9 at /home/ying/diem/language/diem-framework/modules/DiemId.move:72:9+42
    $ret0 := $t9;
    return;
...
L3:
    ...
    // assert Gt(Vector::$length[]<u8>($t0), 63) at /home/ying/diem/language/diem-framework/modules/DiemId.move:70:5+129
    assume {:print "$at(15,2530,2659)"} true;
    assert {:msg "assert_failed(15,2530,2659): abort not covered by any of the `aborts_if` clauses"}
      ($1_Vector_$length'u8'($t0) > 63);

    // assert And(Gt(Vector::$length[]<u8>($t0), 63), Eq(7, $t4)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:70:5+129
    assert {:msg "assert_failed(15,2530,2659): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (($1_Vector_$length'u8'($t0) > 63) && $IsEqual'u8'(7, $t4));

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/DiemId.move:70:5+129
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun DiemId::has_diem_id_domain [verification] at /home/ying/diem/language/diem-framework/modules/DiemId.move:279:5+429
procedure {:timeLimit 40} $1_DiemId_has_diem_id_domain$verify(_$t0: int, _$t1: Vec (int)) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:291:17+6
    assume {:print "$at(15,11523,11529)"} true;
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:291:17+6
    assume $IsValid'vec'u8''($t1);

    // assume forall $rsc: ResourceDomain<DiemId::DiemIdDomains>(): And(WellFormed($rsc), And(And(forall i: Range(0, Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): Le(Len<u8>(select DiemId::DiemIdDomain.domain(Index(select DiemId::DiemIdDomains.domains($rsc), i))), 63), forall i: Range(0, Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): forall j: Range(Add(i, 1), Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): Neq<DiemId::DiemIdDomain>(Index(select DiemId::DiemIdDomains.domains($rsc), i), Index(select DiemId::DiemIdDomains.domains($rsc), j))), forall $elem: select DiemId::DiemIdDomains.domains($rsc): Le(Len<u8>(select DiemId::DiemIdDomain.domain($elem)), 63))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:291:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_DiemId_DiemIdDomains_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemId_DiemIdDomains_$memory, $a_0);
    (($IsValid'$1_DiemId_DiemIdDomains'($rsc) && (((var $range_1 := $Range(0, LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_2: int :: $InRange($range_1, $i_2) ==> (var i := $i_2;
    ((LenVec($domain#$1_DiemId_DiemIdDomain(ReadVec($domains#$1_DiemId_DiemIdDomains($rsc), i))) <= 63))))) && (var $range_3 := $Range(0, LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_4: int :: $InRange($range_3, $i_4) ==> (var i := $i_4;
    ((var $range_5 := $Range((i + 1), LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_6: int :: $InRange($range_5, $i_6) ==> (var j := $i_6;
    ...
    // assume Identical($t6, pack DiemId::DiemIdDomain($t1)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:290:9+40
    assume {:print "$at(15,11466,11506)"} true;
    assume ($t6 == $1_DiemId_DiemIdDomain($t1));

    // @104 := save_mem(DiemId::DiemIdDomains) at /home/ying/diem/language/diem-framework/modules/DiemId.move:279:5+1
    assume {:print "$at(15,10957,10958)"} true;
    $1_DiemId_DiemIdDomains_$memory#104 := $1_DiemId_DiemIdDomains_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:279:5+1
    assume {:print "$track_local(25,2,0):", $t0} $t0 == $t0;

    // trace_local[domain]($t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:279:5+1
    assume {:print "$track_local(25,2,1):", $t1} $t1 == $t1;

    // $t7 := exists<DiemId::DiemIdDomains>($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:281:13+6
    assume {:print "$at(15,11081,11087)"} true;
    $t7 := $ResourceExists($1_DiemId_DiemIdDomains_$memory, $t0);

    // $t8 := 4 at /home/ying/diem/language/diem-framework/modules/DiemId.move:282:35+30
    assume {:print "$at(15,11144,11174)"} true;
    $t8 := 4;
    assume $IsValid'u64'($t8);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemId.move:282:13+53
    // >> opaque call: $t8 := Errors::not_published($t7)

    // $t9 := opaque begin: Errors::not_published($t8) at /home/ying/diem/language/diem-framework/modules/DiemId.move:282:13+53

    // assume WellFormed($t9) at /home/ying/diem/language/diem-framework/modules/DiemId.move:282:13+53
    assume $IsValid'u64'($t9);

    // assume Eq<u64>($t9, 5) at /home/ying/diem/language/diem-framework/modules/DiemId.move:282:13+53
    assume $IsEqual'u64'($t9, 5);

    // $t9 := opaque end: Errors::not_published($t8) at /home/ying/diem/language/diem-framework/modules/DiemId.move:282:13+53

    // trace_local[tmp#$5]($t9) at /home/ying/diem/language/diem-framework/modules/DiemId.move:280:9+124
    assume {:print "$at(15,11061,11185)"} true;
    assume {:print "$track_local(25,2,5):", $t9} $t9 == $t9;

    // trace_local[tmp#$4]($t7) at /home/ying/diem/language/diem-framework/modules/DiemId.move:280:9+124
    assume {:print "$track_local(25,2,4):", $t7} $t7 == $t7;

    // if ($t7) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:280:9+124
    if ($t7) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:280:9+124
L1:

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemId.move:280:9+124
    assume {:print "$at(15,11061,11185)"} true;
    assume {:print "$track_abort(25,2):", $t9} $t9 == $t9;

    // $t10 := move($t9) at /home/ying/diem/language/diem-framework/modules/DiemId.move:280:9+124
    $t10 := $t9;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemId.move:280:9+124
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemId.move:284:60+4
    assume {:print "$at(15,11246,11250)"} true;
L0:

    // $t11 := get_global<DiemId::DiemIdDomains>($t0) on_abort goto L3 with $t10 at /home/ying/diem/language/diem-framework/modules/DiemId.move:284:31+13
    ...
    if ($abort_flag) {
        assume {:print "$at(15,11217,11230)"} true;
        $t10 := $abort_code;
        assume {:print "$track_abort(25,2):", $t10} $t10 == $t10;
        goto L3;
    }

    // trace_local[account_domains]($t11) at /home/ying/diem/language/diem-framework/modules/DiemId.move:284:13+15
    assume {:print "$track_local(25,2,2):", $t11} $t11 == $t11;

    // $t12 := DiemId::create_diem_id_domain($t1) on_abort goto L3 with $t10 at /home/ying/diem/language/diem-framework/modules/DiemId.move:285:30+29
    assume {:print "$at(15,11282,11311)"} true;
    ...
    // trace_local[diem_id_domain]($t12) at /home/ying/diem/language/diem-framework/modules/DiemId.move:285:13+14
    assume {:print "$track_local(25,2,3):", $t12} $t12 == $t12;

    // $t13 := get_field<DiemId::DiemIdDomains>.domains($t11) at /home/ying/diem/language/diem-framework/modules/DiemId.move:286:26+24
    assume {:print "$at(15,11338,11362)"} true;
    $t13 := $domains#$1_DiemId_DiemIdDomains($t11);

    // $t14 := Vector::contains<DiemId::DiemIdDomain>($t13, $t12) on_abort goto L3 with $t10 at /home/ying/diem/language/diem-framework/modules/DiemId.move:286:9+59
    call $t14 := $1_Vector_contains'$1_DiemId_DiemIdDomain'($t13, $t12);
    if ($abort_flag) {
        assume {:print "$at(15,11321,11380)"} true;
        $t10 := $abort_code;
        assume {:print "$track_abort(25,2):", $t10} $t10 == $t10;
        goto L3;
    }

    // trace_return[0]($t14) at /home/ying/diem/language/diem-framework/modules/DiemId.move:286:9+59
    assume {:print "$track_return(25,2,0):", $t14} $t14 == $t14;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemId.move:287:5+1
    assume {:print "$at(15,11385,11386)"} true;
L2:

    // assert Not(Not(exists[@104]<DiemId::DiemIdDomains>($t0))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:297:9+66
    assume {:print "$at(15,11742,11808)"} true;
    assert {:msg "assert_failed(15,11742,11808): function does not abort under this condition"}
      !!$ResourceExists($1_DiemId_DiemIdDomains_$memory#104, $t0);

    // assert Not(Gt(Vector::$length[]<u8>($t1), 63)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:76:9+79
    assume {:print "$at(15,2741,2820)"} true;
    assert {:msg "assert_failed(15,2741,2820): function does not abort under this condition"}
      !($1_Vector_$length'u8'($t1) > 63);

    // assert Eq<bool>($t14, ContainsVec<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains(global<DiemId::DiemIdDomains>($t0)), $t6)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:291:9+75
    assume {:print "$at(15,11515,11590)"} true;
    assert {:msg "assert_failed(15,11515,11590): post-condition does not hold"}
    ...
    // return $t14 at /home/ying/diem/language/diem-framework/modules/DiemId.move:291:9+75
    $ret0 := $t14;
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemId.move:287:5+1
    assume {:print "$at(15,11385,11386)"} true;
L3:

    // assert Or(Not(exists[@104]<DiemId::DiemIdDomains>($t0)), Gt(Vector::$length[]<u8>($t1), 63)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:288:5+205
    assume {:print "$at(15,11391,11596)"} true;
    assert {:msg "assert_failed(15,11391,11596): abort not covered by any of the `aborts_if` clauses"}
      (!$ResourceExists($1_DiemId_DiemIdDomains_$memory#104, $t0) || ($1_Vector_$length'u8'($t1) > 63));

    // assert Or(And(Not(exists[@104]<DiemId::DiemIdDomains>($t0)), Eq(5, $t10)), And(Gt(Vector::$length[]<u8>($t1), 63), Eq(7, $t10))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:288:5+205
    assert {:msg "assert_failed(15,11391,11596): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$ResourceExists($1_DiemId_DiemIdDomains_$memory#104, $t0) && $IsEqual'u8'(5, $t10)) || (($1_Vector_$length'u8'($t1) > 63) && $IsEqual'u8'(7, $t10)));

    // abort($t10) at /home/ying/diem/language/diem-framework/modules/DiemId.move:288:5+205
    $abort_code := $t10;
    $abort_flag := true;
    return;
...
// fun DiemId::has_diem_id_domains [verification] at /home/ying/diem/language/diem-framework/modules/DiemId.move:110:5+95
procedure {:timeLimit 40} $1_DiemId_has_diem_id_domains$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:115:17+6
    assume {:print "$at(15,4308,4314)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<DiemId::DiemIdDomains>(): And(WellFormed($rsc), And(And(forall i: Range(0, Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): Le(Len<u8>(select DiemId::DiemIdDomain.domain(Index(select DiemId::DiemIdDomains.domains($rsc), i))), 63), forall i: Range(0, Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): forall j: Range(Add(i, 1), Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): Neq<DiemId::DiemIdDomain>(Index(select DiemId::DiemIdDomains.domains($rsc), i), Index(select DiemId::DiemIdDomains.domains($rsc), j))), forall $elem: select DiemId::DiemIdDomains.domains($rsc): Le(Len<u8>(select DiemId::DiemIdDomain.domain($elem)), 63))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:115:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_DiemId_DiemIdDomains_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemId_DiemIdDomains_$memory, $a_0);
    (($IsValid'$1_DiemId_DiemIdDomains'($rsc) && (((var $range_1 := $Range(0, LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_2: int :: $InRange($range_1, $i_2) ==> (var i := $i_2;
    ((LenVec($domain#$1_DiemId_DiemIdDomain(ReadVec($domains#$1_DiemId_DiemIdDomains($rsc), i))) <= 63))))) && (var $range_3 := $Range(0, LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_4: int :: $InRange($range_3, $i_4) ==> (var i := $i_4;
    ((var $range_5 := $Range((i + 1), LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_6: int :: $InRange($range_5, $i_6) ==> (var j := $i_6;
    ...
    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:110:5+1
    assume {:print "$at(15,4140,4141)"} true;
    assume {:print "$track_local(25,3,0):", $t0} $t0 == $t0;

    // $t1 := exists<DiemId::DiemIdDomains>($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:111:9+6
    assume {:print "$at(15,4202,4208)"} true;
    $t1 := $ResourceExists($1_DiemId_DiemIdDomains_$memory, $t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:111:9+27
    assume {:print "$track_return(25,3,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:112:5+1
    assume {:print "$at(15,4234,4235)"} true;
L1:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/DiemId.move:114:9+16
    assume {:print "$at(15,4275,4291)"} true;
    assert {:msg "assert_failed(15,4275,4291): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, exists<DiemId::DiemIdDomains>($t0)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:115:9+46
    assume {:print "$at(15,4300,4346)"} true;
    assert {:msg "assert_failed(15,4300,4346): post-condition does not hold"}
      $IsEqual'bool'($t1, $ResourceExists($1_DiemId_DiemIdDomains_$memory, $t0));

    // return $t1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:115:9+46
    $ret0 := $t1;
    return;

}

// fun DiemId::publish_diem_id_domain_manager [verification] at /home/ying/diem/language/diem-framework/modules/DiemId.move:121:5+500
procedure {:timeLimit 40} $1_DiemId_publish_diem_id_domain_manager$verify(_$t0: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:121:5+500
    assume {:print "$at(15,4674,5174)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemId.move:121:5+500
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemId::DiemIdDomainManager>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemId.move:121:5+500
    assume (forall $a_0: int :: {$ResourceValue($1_DiemId_DiemIdDomainManager_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemId_DiemIdDomainManager_$memory, $a_0);
    ($IsValid'$1_DiemId_DiemIdDomainManager'($rsc))));
    ...
    // assume CanModify<DiemId::DiemIdDomainManager>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:140:9+74
    assume {:print "$at(15,5459,5533)"} true;
    assume $1_DiemId_DiemIdDomainManager_$modifies[$1_Signer_spec_address_of($t0)];

    // @142 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemId.move:140:9+74
    $1_Roles_RoleId_$memory#142 := $1_Roles_RoleId_$memory;

    // @143 := save_mem(DiemId::DiemIdDomainManager) at /home/ying/diem/language/diem-framework/modules/DiemId.move:140:9+74
...
L0:
    ...
    // assert CanModify<DiemId::DiemIdDomainManager>($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:129:9+7
    assume {:print "$at(15,4982,4989)"} true;
    assert {:msg "assert_failed(15,4982,4989): caller does not have permission to modify `DiemId::DiemIdDomainManager` at given address"}
...
L2:
    ...
    // assert Not(Not(exists[@142]<Roles::RoleId>($t3))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    assume {:print "$at(26,24063,24122)"} true;
    assert {:msg "assert_failed(26,24063,24122): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#142, $t3);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@142]<Roles::RoleId>($t3)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    assume {:print "$at(26,24131,24228)"} true;
    assert {:msg "assert_failed(26,24131,24228): function does not abort under this condition"}
    ...
    // assert Not(DiemId::$tc_domain_manager_exists[@143]()) at /home/ying/diem/language/diem-framework/modules/DiemId.move:138:9+68
    assume {:print "$at(15,5300,5368)"} true;
    assert {:msg "assert_failed(15,5300,5368): function does not abort under this condition"}
      !$1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#143);

    // assert exists<DiemId::DiemIdDomainManager>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:139:9+73
    assume {:print "$at(15,5377,5450)"} true;
    assert {:msg "assert_failed(15,5377,5450): post-condition does not hold"}
      $ResourceExists($1_DiemId_DiemIdDomainManager_$memory, $1_Signer_spec_address_of($t0));

    // return () at /home/ying/diem/language/diem-framework/modules/DiemId.move:139:9+73
    return;
...
L3:
    ...
    // assert Or(Or(Or(Not(exists[@142]<Roles::RoleId>($t3)), Neq<u64>(select Roles::RoleId.role_id(global[@142]<Roles::RoleId>($t3)), 1)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), DiemId::$tc_domain_manager_exists[@143]()) at /home/ying/diem/language/diem-framework/modules/DiemId.move:136:5+360
    assume {:print "$at(15,5179,5539)"} true;
    assert {:msg "assert_failed(15,5179,5539): abort not covered by any of the `aborts_if` clauses"}
      (((!$ResourceExists($1_Roles_RoleId_$memory#142, $t3) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#142, $t3)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || $1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#143));

    // assert Or(Or(Or(And(Not(exists[@142]<Roles::RoleId>($t3)), Eq(5, $t6)), And(Neq<u64>(select Roles::RoleId.role_id(global[@142]<Roles::RoleId>($t3)), 1), Eq(3, $t6))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t6))), And(DiemId::$tc_domain_manager_exists[@143](), Eq(6, $t6))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:136:5+360
    assert {:msg "assert_failed(15,5179,5539): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((!$ResourceExists($1_Roles_RoleId_$memory#142, $t3) && $IsEqual'u8'(5, $t6)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#142, $t3)), 1) && $IsEqual'u8'(3, $t6))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t6))) || ($1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#143) && $IsEqual'u8'(6, $t6)));

    // abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemId.move:136:5+360
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
// fun DiemId::publish_diem_id_domains [verification] at /home/ying/diem/language/diem-framework/modules/DiemId.move:82:5+381
procedure {:timeLimit 40} $1_DiemId_publish_diem_id_domains$verify(_$t0: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:82:5+381
    assume {:print "$at(15,3121,3502)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemId.move:82:5+381
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemId::DiemIdDomains>(): And(WellFormed($rsc), And(And(forall i: Range(0, Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): Le(Len<u8>(select DiemId::DiemIdDomain.domain(Index(select DiemId::DiemIdDomains.domains($rsc), i))), 63), forall i: Range(0, Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): forall j: Range(Add(i, 1), Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): Neq<DiemId::DiemIdDomain>(Index(select DiemId::DiemIdDomains.domains($rsc), i), Index(select DiemId::DiemIdDomains.domains($rsc), j))), forall $elem: select DiemId::DiemIdDomains.domains($rsc): Le(Len<u8>(select DiemId::DiemIdDomain.domain($elem)), 63))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:82:5+381
    assume (forall $a_0: int :: {$ResourceValue($1_DiemId_DiemIdDomains_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemId_DiemIdDomains_$memory, $a_0);
    (($IsValid'$1_DiemId_DiemIdDomains'($rsc) && (((var $range_1 := $Range(0, LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_2: int :: $InRange($range_1, $i_2) ==> (var i := $i_2;
    ((LenVec($domain#$1_DiemId_DiemIdDomain(ReadVec($domains#$1_DiemId_DiemIdDomains($rsc), i))) <= 63))))) && (var $range_3 := $Range(0, LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_4: int :: $InRange($range_3, $i_4) ==> (var i := $i_4;
    ((var $range_5 := $Range((i + 1), LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_6: int :: $InRange($range_5, $i_6) ==> (var j := $i_6;
    ...
    // @105 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemId.move:82:5+1
    assume {:print "$at(15,3121,3122)"} true;
    $1_Roles_RoleId_$memory#105 := $1_Roles_RoleId_$memory;

    // @106 := save_mem(DiemId::DiemIdDomains) at /home/ying/diem/language/diem-framework/modules/DiemId.move:82:5+1
...
L0:
    ...
    // assert forall i: Range(0, Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($t14))): Le(Len<u8>(select DiemId::DiemIdDomain.domain(Index(select DiemId::DiemIdDomains.domains($t14), i))), 63) at /home/ying/diem/language/diem-framework/modules/DiemId.move:20:9+79
    // data invariant at /home/ying/diem/language/diem-framework/modules/DiemId.move:20:9+79
    assume {:print "$at(15,611,690)"} true;
    assert {:msg "assert_failed(15,611,690): data invariant does not hold"}
...
L2:
    ...
    // assert Not(Not(exists[@105]<Roles::RoleId>($t4))) at /home/ying/diem/language/diem-framework/modules/Roles.move:543:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@105]<Roles::RoleId>($t4)), 5)) at /home/ying/diem/language/diem-framework/modules/Roles.move:544:9+89
    ...
    // assert Not(DiemId::$has_diem_id_domains[@106]($t3)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:102:9+72
    ...
    // assert exists<DiemId::DiemIdDomains>($t3) at /home/ying/diem/language/diem-framework/modules/DiemId.move:106:9+41
    ...
    // assert Vector::$is_empty<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains(global<DiemId::DiemIdDomains>($t3))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:107:9+67
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/DiemId.move:107:9+67
    return;
...
L3:
    ...
    // assert Or(Or(Not(exists[@105]<Roles::RoleId>($t4)), Neq<u64>(select Roles::RoleId.role_id(global[@105]<Roles::RoleId>($t4)), 5)), DiemId::$has_diem_id_domains[@106]($t3)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:94:5+259
    assume {:print "$at(15,3507,3766)"} true;
    assert {:msg "assert_failed(15,3507,3766): abort not covered by any of the `aborts_if` clauses"}
    ...
    // assert Or(Or(And(Not(exists[@105]<Roles::RoleId>($t4)), Eq(5, $t7)), And(Neq<u64>(select Roles::RoleId.role_id(global[@105]<Roles::RoleId>($t4)), 5), Eq(3, $t7))), And(DiemId::$has_diem_id_domains[@106]($t3), Eq(6, $t7))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:94:5+259
    assert {:msg "assert_failed(15,3507,3766): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t7) at /home/ying/diem/language/diem-framework/modules/DiemId.move:94:5+259
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun DiemId::remove_diem_id_domain [verification] at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1171
procedure {:timeLimit 40} $1_DiemId_remove_diem_id_domain$verify(_$t0: int, _$t1: int, _$t2: Vec (int)) returns ()
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1171
    assume {:print "$at(15,8403,9574)"} true;
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1171
    assume $IsValid'address'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1171
    assume $IsValid'vec'u8''($t2);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1171
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemId::DiemIdDomainManager>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1171
    assume (forall $a_0: int :: {$ResourceValue($1_DiemId_DiemIdDomainManager_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemId_DiemIdDomainManager_$memory, $a_0);
    ($IsValid'$1_DiemId_DiemIdDomainManager'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemId::DiemIdDomains>(): And(WellFormed($rsc), And(And(forall i: Range(0, Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): Le(Len<u8>(select DiemId::DiemIdDomain.domain(Index(select DiemId::DiemIdDomains.domains($rsc), i))), 63), forall i: Range(0, Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): forall j: Range(Add(i, 1), Len<DiemId::DiemIdDomain>(select DiemId::DiemIdDomains.domains($rsc))): Neq<DiemId::DiemIdDomain>(Index(select DiemId::DiemIdDomains.domains($rsc), i), Index(select DiemId::DiemIdDomains.domains($rsc), j))), forall $elem: select DiemId::DiemIdDomains.domains($rsc): Le(Len<u8>(select DiemId::DiemIdDomain.domain($elem)), 63))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1171
    assume (forall $a_0: int :: {$ResourceValue($1_DiemId_DiemIdDomains_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemId_DiemIdDomains_$memory, $a_0);
    (($IsValid'$1_DiemId_DiemIdDomains'($rsc) && (((var $range_1 := $Range(0, LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_2: int :: $InRange($range_1, $i_2) ==> (var i := $i_2;
    ((LenVec($domain#$1_DiemId_DiemIdDomain(ReadVec($domains#$1_DiemId_DiemIdDomains($rsc), i))) <= 63))))) && (var $range_3 := $Range(0, LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_4: int :: $InRange($range_3, $i_4) ==> (var i := $i_4;
    ((var $range_5 := $Range((i + 1), LenVec($domains#$1_DiemId_DiemIdDomains($rsc))); (forall $i_6: int :: $InRange($range_5, $i_6) ==> (var j := $i_6;
    ...
    // assume Identical($t11, select DiemId::DiemIdDomains.domains(global<DiemId::DiemIdDomains>($t1))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:253:9+53
    assume {:print "$at(15,9877,9930)"} true;
    assume ($t11 == $domains#$1_DiemId_DiemIdDomains($ResourceValue($1_DiemId_DiemIdDomains_$memory, $t1)));
    ...
    // assume Identical($t13, select DiemId::DiemIdDomainManager.diem_id_domain_events(global<DiemId::DiemIdDomainManager>(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:270:9+109
    assume {:print "$at(15,10665,10774)"} true;
    assume ($t13 == $diem_id_domain_events#$1_DiemId_DiemIdDomainManager($ResourceValue($1_DiemId_DiemIdDomainManager_$memory, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())));

    // assume Identical($t14, pack DiemId::DiemIdDomainEvent(true, pack DiemId::DiemIdDomain($t2), $t1)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:271:9+133
    assume {:print "$at(15,10783,10916)"} true;
    assume ($t14 == $1_DiemId_DiemIdDomainEvent(true, $1_DiemId_DiemIdDomain($t2), $t1));

    // @125 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1
    assume {:print "$at(15,8403,8404)"} true;
    $1_Roles_RoleId_$memory#125 := $1_Roles_RoleId_$memory;

    // @124 := save_mem(DiemId::DiemIdDomainManager) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1
    $1_DiemId_DiemIdDomainManager_$memory#124 := $1_DiemId_DiemIdDomainManager_$memory;

    // @123 := save_mem(DiemId::DiemIdDomains) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1
    $1_DiemId_DiemIdDomains_$memory#123 := $1_DiemId_DiemIdDomains_$memory;

    // trace_local[tc_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1
    assume {:print "$track_local(25,6,0):", $t0} $t0 == $t0;

    // trace_local[address]($t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1
    assume {:print "$track_local(25,6,1):", $t1} $t1 == $t1;

    // trace_local[domain]($t2) at /home/ying/diem/language/diem-framework/modules/DiemId.move:213:5+1
    assume {:print "$track_local(25,6,2):", $t2} $t2 == $t2;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemId.move:218:9+45
    // >> opaque call: Roles::assert_treasury_compliance($t0)
    assume {:print "$at(15,8580,8625)"} true;

    // assume Identical($t15, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+44
    assume {:print "$at(26,24010,24054)"} true;
    assume ($t15 == $1_Signer_spec_address_of($t0));

    // opaque begin: Roles::assert_treasury_compliance($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:218:9+45
    assume {:print "$at(15,8580,8625)"} true;

    // assume Identical($t16, Or(Or(Not(exists<Roles::RoleId>($t15)), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t15)), 1)), Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:218:9+45
    assume ($t16 == ((!$ResourceExists($1_Roles_RoleId_$memory, $t15) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t15)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())));

    // if ($t16) goto L9 else goto L8 at /home/ying/diem/language/diem-framework/modules/DiemId.move:218:9+45
    if ($t16) { goto L9; } else { goto L8; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/DiemId.move:218:9+45
L9:

    // assume Or(Or(And(Not(exists<Roles::RoleId>($t15)), Eq(5, $t17)), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t15)), 1), Eq(3, $t17))), And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS()), Eq(2, $t17))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:218:9+45
    assume (((!$ResourceExists($1_Roles_RoleId_$memory, $t15) && $IsEqual'u8'(5, $t17)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t15)), 1) && $IsEqual'u8'(3, $t17))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t17)));

    // trace_abort($t17) at /home/ying/diem/language/diem-framework/modules/DiemId.move:218:9+45
    assume {:print "$at(15,8580,8625)"} true;
    assume {:print "$track_abort(25,6):", $t17} $t17 == $t17;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemId.move:218:9+45
    goto L7;

    // label L8 at /home/ying/diem/language/diem-framework/modules/DiemId.move:218:9+45
L8:

    // opaque end: Roles::assert_treasury_compliance($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:218:9+45

    // $t18 := DiemId::tc_domain_manager_exists() on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:16+26
    assume {:print "$at(15,8642,8668)"} true;
    call $t18 := $1_DiemId_tc_domain_manager_exists();
    if ($abort_flag) {
        assume {:print "$at(15,8642,8668)"} true;
        $t17 := $abort_code;
    ...
    // $t19 := 1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:66+23
    $t19 := 1;
    assume $IsValid'u64'($t19);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:44+46
    // >> opaque call: $t13 := Errors::not_published($t12)

    // $t20 := opaque begin: Errors::not_published($t19) at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:44+46

    // assume WellFormed($t20) at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:44+46
    assume $IsValid'u64'($t20);

    // assume Eq<u64>($t20, 5) at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:44+46
    assume $IsEqual'u64'($t20, 5);

    // $t20 := opaque end: Errors::not_published($t19) at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:44+46

    // trace_local[tmp#$8]($t20) at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:9+82
    assume {:print "$track_local(25,6,8):", $t20} $t20 == $t20;

    // trace_local[tmp#$7]($t18) at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:9+82
    assume {:print "$track_local(25,6,7):", $t18} $t18 == $t18;

    // if ($t18) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:9+82
    if ($t18) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:9+82
L1:

    // trace_abort($t20) at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:9+82
    assume {:print "$at(15,8635,8717)"} true;
    assume {:print "$track_abort(25,6):", $t20} $t20 == $t20;

    // $t17 := move($t20) at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:9+82
    $t17 := $t20;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemId.move:219:9+82
    goto L7;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemId.move:221:35+7
    assume {:print "$at(15,8769,8776)"} true;
L0:

    // $t21 := exists<DiemId::DiemIdDomains>($t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:221:13+6
    $t21 := $ResourceExists($1_DiemId_DiemIdDomains_$memory, $t1);

    // $t22 := 4 at /home/ying/diem/language/diem-framework/modules/DiemId.move:222:35+30
    assume {:print "$at(15,8813,8843)"} true;
    $t22 := 4;
    assume $IsValid'u64'($t22);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemId.move:222:13+53
    // >> opaque call: $t16 := Errors::not_published($t15)

    // $t23 := opaque begin: Errors::not_published($t22) at /home/ying/diem/language/diem-framework/modules/DiemId.move:222:13+53

    // assume WellFormed($t23) at /home/ying/diem/language/diem-framework/modules/DiemId.move:222:13+53
    assume $IsValid'u64'($t23);

    // assume Eq<u64>($t23, 5) at /home/ying/diem/language/diem-framework/modules/DiemId.move:222:13+53
    assume $IsEqual'u64'($t23, 5);

    // $t23 := opaque end: Errors::not_published($t22) at /home/ying/diem/language/diem-framework/modules/DiemId.move:222:13+53

    // trace_local[tmp#$10]($t23) at /home/ying/diem/language/diem-framework/modules/DiemId.move:220:9+127
    assume {:print "$at(15,8727,8854)"} true;
    assume {:print "$track_local(25,6,10):", $t23} $t23 == $t23;

    // trace_local[tmp#$9]($t21) at /home/ying/diem/language/diem-framework/modules/DiemId.move:220:9+127
    assume {:print "$track_local(25,6,9):", $t21} $t21 == $t21;

    // if ($t21) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemId.move:220:9+127
    if ($t21) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemId.move:220:9+127
L3:

    // trace_abort($t23) at /home/ying/diem/language/diem-framework/modules/DiemId.move:220:9+127
    assume {:print "$at(15,8727,8854)"} true;
    assume {:print "$track_abort(25,6):", $t23} $t23 == $t23;

    // $t17 := move($t23) at /home/ying/diem/language/diem-framework/modules/DiemId.move:220:9+127
    $t17 := $t23;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemId.move:220:9+127
    goto L7;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemId.move:225:64+7
    assume {:print "$at(15,8920,8927)"} true;
L2:

    // $t24 := borrow_global<DiemId::DiemIdDomains>($t1) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:225:31+17
    if (!$ResourceExists($1_DiemId_DiemIdDomains_$memory, $t1)) {
        call $ExecFailureAbort();
    } else {
        $t24 := $Mutation($Global($t1), EmptyVec(), $ResourceValue($1_DiemId_DiemIdDomains_$memory, $t1));
    ...
    if ($abort_flag) {
        assume {:print "$at(15,8887,8904)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(25,6):", $t17} $t17 == $t17;
        goto L7;
    }

    // trace_local[account_domains]($t24) at /home/ying/diem/language/diem-framework/modules/DiemId.move:225:13+15
    $temp_0'$1_DiemId_DiemIdDomains' := $Dereference($t24);
    assume {:print "$track_local(25,6,3):", $temp_0'$1_DiemId_DiemIdDomains'} $temp_0'$1_DiemId_DiemIdDomains' == $temp_0'$1_DiemId_DiemIdDomains';

    // $t25 := DiemId::create_diem_id_domain($t2) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:226:30+29
    assume {:print "$at(15,8959,8988)"} true;
    call $t25 := $1_DiemId_create_diem_id_domain($t2);
    if ($abort_flag) {
        assume {:print "$at(15,8959,8988)"} true;
        $t17 := $abort_code;
    ...
    // trace_local[diem_id_domain]($t25) at /home/ying/diem/language/diem-framework/modules/DiemId.move:226:13+14
    assume {:print "$track_local(25,6,4):", $t25} $t25 == $t25;

    // $t26 := get_field<DiemId::DiemIdDomains>.domains($t24) at /home/ying/diem/language/diem-framework/modules/DiemId.move:228:45+24
    assume {:print "$at(15,9035,9059)"} true;
    $t26 := $domains#$1_DiemId_DiemIdDomains($Dereference($t24));

    // ($t27, $t28) := Vector::index_of<DiemId::DiemIdDomain>($t26, $t25) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:228:28+59
    call $t27,$t28 := $1_Vector_index_of'$1_DiemId_DiemIdDomain'($t26, $t25);
    if ($abort_flag) {
        assume {:print "$at(15,9018,9077)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(25,6):", $t17} $t17 == $t17;
        goto L7;
    }

    // trace_local[index]($t28) at /home/ying/diem/language/diem-framework/modules/DiemId.move:228:19+5
    assume {:print "$track_local(25,6,6):", $t28} $t28 == $t28;

    // trace_local[has]($t27) at /home/ying/diem/language/diem-framework/modules/DiemId.move:228:14+3
    assume {:print "$track_local(25,6,5):", $t27} $t27 == $t27;

    // if ($t27) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/DiemId.move:229:9+164
    assume {:print "$at(15,9087,9251)"} true;
    if ($t27) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemId.move:232:13+49
    assume {:print "$at(15,9192,9241)"} true;
L5:
    ...
    // destroy($t24) at /home/ying/diem/language/diem-framework/modules/DiemId.move:232:13+49
    assume {:print "$at(15,9192,9241)"} true;

    // $t29 := 2 at /home/ying/diem/language/diem-framework/modules/DiemId.move:232:44+17
    $t29 := 2;
    assume $IsValid'u64'($t29);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemId.move:232:19+43
    // >> opaque call: $t23 := Errors::invalid_argument($t22)

    // $t30 := opaque begin: Errors::invalid_argument($t29) at /home/ying/diem/language/diem-framework/modules/DiemId.move:232:19+43

    // assume WellFormed($t30) at /home/ying/diem/language/diem-framework/modules/DiemId.move:232:19+43
    assume $IsValid'u64'($t30);

    // assume Eq<u64>($t30, 7) at /home/ying/diem/language/diem-framework/modules/DiemId.move:232:19+43
    assume $IsEqual'u64'($t30, 7);

    // $t30 := opaque end: Errors::invalid_argument($t29) at /home/ying/diem/language/diem-framework/modules/DiemId.move:232:19+43

    // trace_abort($t30) at /home/ying/diem/language/diem-framework/modules/DiemId.move:232:13+49
    assume {:print "$at(15,9192,9241)"} true;
    assume {:print "$track_abort(25,6):", $t30} $t30 == $t30;

    // $t17 := move($t30) at /home/ying/diem/language/diem-framework/modules/DiemId.move:232:13+49
    $t17 := $t30;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemId.move:232:13+49
    goto L7;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemId.move:230:33+15
    assume {:print "$at(15,9130,9145)"} true;
L4:

    // $t31 := borrow_field<DiemId::DiemIdDomains>.domains($t24) at /home/ying/diem/language/diem-framework/modules/DiemId.move:230:28+28
    $t31 := $ChildMutation($t24, 0, $domains#$1_DiemId_DiemIdDomains($Dereference($t24)));

    // $t32 := Vector::remove<DiemId::DiemIdDomain>($t31, $t28) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:230:13+51
    call $t32,$t31 := $1_Vector_remove'$1_DiemId_DiemIdDomain'($t31, $t28);
    if ($abort_flag) {
        assume {:print "$at(15,9110,9161)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(25,6):", $t17} $t17 == $t17;
        goto L7;
    }

    // write_back[Reference($t24).domains]($t31) at /home/ying/diem/language/diem-framework/modules/DiemId.move:230:13+51
    $t24 := $UpdateMutation($t24, $Update'$1_DiemId_DiemIdDomains'_domains($Dereference($t24), $Dereference($t31)));
    ...
    // write_back[DiemId::DiemIdDomains@]($t24) at /home/ying/diem/language/diem-framework/modules/DiemId.move:230:13+51
    assume {:print "$at(15,9110,9161)"} true;
    $1_DiemId_DiemIdDomains_$memory := $ResourceUpdate($1_DiemId_DiemIdDomains_$memory, $GlobalLocationAddress($t24),
        $Dereference($t24));

    // destroy($t32) at /home/ying/diem/language/diem-framework/modules/DiemId.move:230:13+51

    // $t33 := CoreAddresses::TREASURY_COMPLIANCE_ADDRESS() on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:236:57+44
    assume {:print "$at(15,9337,9381)"} true;
    call $t33 := $1_CoreAddresses_TREASURY_COMPLIANCE_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(15,9337,9381)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(25,6):", $t17} $t17 == $t17;
    ...
    // $t34 := borrow_global<DiemId::DiemIdDomainManager>($t33) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:236:18+17
    ...
    if ($abort_flag) {
        assume {:print "$at(15,9298,9315)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(25,6):", $t17} $t17 == $t17;
        goto L7;
    }

    // $t35 := borrow_field<DiemId::DiemIdDomainManager>.diem_id_domain_events($t34) at /home/ying/diem/language/diem-framework/modules/DiemId.move:236:13+111
    $t35 := $ChildMutation($t34, 0, $diem_id_domain_events#$1_DiemId_DiemIdDomainManager($Dereference($t34)));

    // $t36 := true at /home/ying/diem/language/diem-framework/modules/DiemId.move:238:26+4
    assume {:print "$at(15,9463,9467)"} true;
    $t36 := true;
    assume $IsValid'bool'($t36);

    // $t37 := pack DiemId::DiemIdDomainEvent($t36, $t25, $t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:237:13+138
    assume {:print "$at(15,9418,9556)"} true;
    $t37 := $1_DiemId_DiemIdDomainEvent($t36, $t25, $t1);

    // Event::emit_event<DiemId::DiemIdDomainEvent>($t35, $t37) on_abort goto L7 with $t17 at /home/ying/diem/language/diem-framework/modules/DiemId.move:235:9+305
    assume {:print "$at(15,9262,9567)"} true;
    ...
    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemId.move:243:5+1
    assume {:print "$at(15,9573,9574)"} true;
L6:

    // assume Identical($t38, select DiemId::DiemIdDomains.domains(global<DiemId::DiemIdDomains>($t1))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:263:9+58
    assume {:print "$at(15,10407,10465)"} true;
    assume ($t38 == $domains#$1_DiemId_DiemIdDomains($ResourceValue($1_DiemId_DiemIdDomains_$memory, $t1)));

    // assert Not(Not(exists[@123]<DiemId::DiemIdDomains>($t1))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:256:9+69
    assume {:print "$at(15,10058,10127)"} true;
    assert {:msg "assert_failed(15,10058,10127): function does not abort under this condition"}
      !!$ResourceExists($1_DiemId_DiemIdDomains_$memory#123, $t1);

    // assert Not(Not(DiemId::$tc_domain_manager_exists[@124]())) at /home/ying/diem/language/diem-framework/modules/DiemId.move:257:9+65
    assume {:print "$at(15,10136,10201)"} true;
    assert {:msg "assert_failed(15,10136,10201): function does not abort under this condition"}
      !!$1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#124);

    // assert Not(Not(ContainsVec<DiemId::DiemIdDomain>($t11, pack DiemId::DiemIdDomain($t2)))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:258:9+84
    assume {:print "$at(15,10210,10294)"} true;
    assert {:msg "assert_failed(15,10210,10294): function does not abort under this condition"}
      !!$ContainsVec'$1_DiemId_DiemIdDomain'($t11, $1_DiemId_DiemIdDomain($t2));

    // assert Not(Not(exists[@125]<Roles::RoleId>($t12))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    assume {:print "$at(26,24063,24122)"} true;
    assert {:msg "assert_failed(26,24063,24122): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#125, $t12);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t12)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    assume {:print "$at(26,24131,24228)"} true;
    assert {:msg "assert_failed(26,24131,24228): function does not abort under this condition"}
    ...
    // assert Not(ContainsVec<DiemId::DiemIdDomain>($t38, pack DiemId::DiemIdDomain($t2))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:264:9+52
    assume {:print "$at(15,10474,10526)"} true;
    assert {:msg "assert_failed(15,10474,10526): post-condition does not hold"}
      !$ContainsVec'$1_DiemId_DiemIdDomain'($t38, $1_DiemId_DiemIdDomain($t2));

    // assert EventStoreIncludes(ExtendEventStore(EmptyEventStore(), $t14, $t13)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:276:9+20
    assume {:print "$at(15,10925,10945)"} true;
    assert {:msg "assert_failed(15,10925,10945): function does not emit the expected event"}
      (var actual := $EventStore__subtract($es, old($es)); (var expected := $ExtendEventStore'$1_DiemId_DiemIdDomainEvent'($EmptyEventStore, $t13, $t14); $EventStore__is_subset(expected, actual)));

    // assert EventStoreIncludedIn(ExtendEventStore(EmptyEventStore(), $t14, $t13)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:244:5+162
    assume {:print "$at(15,9579,9741)"} true;
    assert {:msg "assert_failed(15,9579,9741): emitted event not covered by any of the `emits` clauses"}
      (var actual := $EventStore__subtract($es, old($es)); (var expected := $ExtendEventStore'$1_DiemId_DiemIdDomainEvent'($EmptyEventStore, $t13, $t14); $EventStore__is_subset(actual, expected)));

    // return () at /home/ying/diem/language/diem-framework/modules/DiemId.move:244:5+162
    return;

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemId.move:243:5+1
    assume {:print "$at(15,9573,9574)"} true;
L7:

    // assert Or(Or(Or(Or(Or(Or(Not(exists[@123]<DiemId::DiemIdDomains>($t1)), Not(DiemId::$tc_domain_manager_exists[@124]())), Not(ContainsVec<DiemId::DiemIdDomain>($t11, pack DiemId::DiemIdDomain($t2)))), Not(exists[@125]<Roles::RoleId>($t12))), Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t12)), 1)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), Gt(Vector::$length[]<u8>($t2), 63)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:244:5+162
    assume {:print "$at(15,9579,9741)"} true;
    assert {:msg "assert_failed(15,9579,9741): abort not covered by any of the `aborts_if` clauses"}
    ...
    // assert Or(Or(Or(Or(Or(Or(And(Not(exists[@123]<DiemId::DiemIdDomains>($t1)), Eq(5, $t17)), And(Not(DiemId::$tc_domain_manager_exists[@124]()), Eq(5, $t17))), And(Not(ContainsVec<DiemId::DiemIdDomain>($t11, pack DiemId::DiemIdDomain($t2))), Eq(7, $t17))), And(Not(exists[@125]<Roles::RoleId>($t12)), Eq(5, $t17))), And(Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t12)), 1), Eq(3, $t17))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t17))), And(Gt(Vector::$length[]<u8>($t2), 63), Eq(7, $t17))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:244:5+162
    assert {:msg "assert_failed(15,9579,9741): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t17) at /home/ying/diem/language/diem-framework/modules/DiemId.move:244:5+162
    $abort_code := $t17;
    $abort_flag := true;
    return;
...
// fun DiemId::tc_domain_manager_exists [baseline] at /home/ying/diem/language/diem-framework/modules/DiemId.move:300:5+133
procedure {:inline 1} $1_DiemId_tc_domain_manager_exists() returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // $t0 := CoreAddresses::TREASURY_COMPLIANCE_ADDRESS() on_abort goto L2 with $t1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:301:37+44
    assume {:print "$at(15,11902,11946)"} true;
    call $t0 := $1_CoreAddresses_TREASURY_COMPLIANCE_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(15,11902,11946)"} true;
        $t1 := $abort_code;
        assume {:print "$track_abort(25,7):", $t1} $t1 == $t1;
        goto L2;
    }

    // $t2 := exists<DiemId::DiemIdDomainManager>($t0) at /home/ying/diem/language/diem-framework/modules/DiemId.move:301:9+6
    $t2 := $ResourceExists($1_DiemId_DiemIdDomainManager_$memory, $t0);

    // trace_return[0]($t2) at /home/ying/diem/language/diem-framework/modules/DiemId.move:301:9+73
    assume {:print "$track_return(25,7,0):", $t2} $t2 == $t2;

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemId.move:302:5+1
    assume {:print "$at(15,11952,11953)"} true;
L1:

    // return $t2 at /home/ying/diem/language/diem-framework/modules/DiemId.move:302:5+1
    $ret0 := $t2;
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemId.move:302:5+1
L2:

    // abort($t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:302:5+1
    $abort_code := $t1;
    $abort_flag := true;
    return;
...
// fun DiemId::tc_domain_manager_exists [verification] at /home/ying/diem/language/diem-framework/modules/DiemId.move:300:5+133
procedure {:timeLimit 40} $1_DiemId_tc_domain_manager_exists$verify() returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume forall $rsc: ResourceDomain<DiemId::DiemIdDomainManager>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemId.move:305:17+6
    assume {:print "$at(15,12031,12037)"} true;
    assume (forall $a_0: int :: {$ResourceValue($1_DiemId_DiemIdDomainManager_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemId_DiemIdDomainManager_$memory, $a_0);
    ($IsValid'$1_DiemId_DiemIdDomainManager'($rsc))));
...
L1:
    ...
    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/DiemId.move:304:9+16
    assume {:print "$at(15,11998,12014)"} true;
    assert {:msg "assert_failed(15,11998,12014): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t2, exists<DiemId::DiemIdDomainManager>(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemId.move:305:9+92
    assume {:print "$at(15,12023,12115)"} true;
    assert {:msg "assert_failed(15,12023,12115): post-condition does not hold"}
      $IsEqual'bool'($t2, $ResourceExists($1_DiemId_DiemIdDomainManager_$memory, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // return $t2 at /home/ying/diem/language/diem-framework/modules/DiemId.move:305:9+92
    $ret0 := $t2;
    return;
...
L2:
    ...
    // assert false at /home/ying/diem/language/diem-framework/modules/DiemId.move:303:5+163
    assume {:print "$at(15,11958,12121)"} true;
    assert {:msg "assert_failed(15,11958,12121): abort not covered by any of the `aborts_if` clauses"}
      false;

    // abort($t1) at /home/ying/diem/language/diem-framework/modules/DiemId.move:303:5+163
    $abort_code := $t1;
    $abort_flag := true;
    return;
...
L8:
    ...
    // @148 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@148](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
...
L7:
    ...
    // @166 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@166](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L7:
    ...
    // @160 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@160](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
