...
(assert (not
 (=> (= (ControlFlow 0 0) 53668) (let ((L9_correct  (=> (= (ControlFlow 0 39929) (- 0 54340)) false)))
(let ((anon21_Then_correct@@0  (=> $abort_flag@1@@0 (=> (and (= $abort_code@2@@0 $abort_code@2@@0) (= (ControlFlow 0 39919) 39929)) L9_correct))))
(let ((anon19_Then_correct@@0  (=> $abort_flag@0@@0 (=> (and (= $abort_code@1@@0 $abort_code@1@@0) (= (ControlFlow 0 39961) 39929)) L9_correct))))
(let ((anon21_Else_correct@@0  (=> (not $abort_flag@1@@0) (=> (and (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2) (= (ControlFlow 0 39905) (- 0 54303))) (not (let (($range_0@@8 ($Range 0 inline$$AddU64$0$dst@2)))
(exists (($i_1@@13 Int) ) (!  (and ($InRange $range_0@@8 $i_1@@13) (let ((j@@1 $i_1@@13))
(= (seq.nth _$t0@@0 j@@1) _$t1@@0)))
 :qid |verifyvectorandybpl.1660:50|
 :skolemid |41|
))))))))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@2@@0 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@0 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 39846) 39919) anon21_Then_correct@@0) (=> (= (ControlFlow 0 39846) 39905) anon21_Else_correct@@0))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t4@0 1) $MAX_U64) (= (ControlFlow 0 39844) 39846)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t4@0 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t4@0 1)) (= $abort_code@2@@0 $abort_code@1@@0)) (and (= $abort_flag@1@@0 $abort_flag@0@@0) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 39792) 39919) anon21_Then_correct@@0) (=> (= (ControlFlow 0 39792) 39905) anon21_Else_correct@@0))))))
(let ((anon20_Else_correct@@0  (=> (and (not $t9@1) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 39852) 39844) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 39852) 39792) inline$$AddU64$0$anon3_Else_correct)))))
(let ((L8_correct  (and (=> (= (ControlFlow 0 39528) (- 0 54157)) (not false)) (=> (not false) (=> (= (ControlFlow 0 39528) (- 0 54164)) (= $t13@0@@0 (let (($range_0@@9 _$t0@@0))
(exists (($i_1@@14 Int) ) (!  (and (and (>= $i_1@@14 0) (< $i_1@@14 (seq.len $range_0@@9))) (let ((x (seq.nth $range_0@@9 $i_1@@14)))
(= x _$t1@@0)))
 :qid |verifyvectorandybpl.1679:58|
 :skolemid |42|
)))))))))
(let ((anon20_Then_correct@@0  (=> (and (and $t9@1 (= true true)) (and (= $t13@0@@0 true) (= (ControlFlow 0 39947) 39528))) L8_correct)))
(let ((anon19_Else_correct@@0  (=> (and (not $abort_flag@0@@0) (= $t9@1 (= |inline$$1_Vector_borrow'#0'$0$dst@2| _$t1@@0))) (and (=> (= (ControlFlow 0 39687) 39947) anon20_Then_correct@@0) (=> (= (ControlFlow 0 39687) 39852) anon20_Else_correct@@0)))))
(let ((|inline$$1_Vector_borrow'#0'$0$anon3_Then$1_correct|  (=> (= $abort_flag@0@@0 true) (=> (and (= $abort_code@1@@0 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'#0'$0$dst@2| |inline$$1_Vector_borrow'#0'$0$dst@0|)) (and (=> (= (ControlFlow 0 39667) 39961) anon19_Then_correct@@0) (=> (= (ControlFlow 0 39667) 39687) anon19_Else_correct@@0))))))
(let ((|inline$$1_Vector_borrow'#0'$0$anon3_Then_correct|  (=> (and (not (and (>= $t4@0 0) (< $t4@0 (seq.len _$t0@@0)))) (= (ControlFlow 0 39665) 39667)) |inline$$1_Vector_borrow'#0'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'#0'$0$anon3_Else_correct|  (=> (and (>= $t4@0 0) (< $t4@0 (seq.len _$t0@@0))) (=> (and (and (= |inline$$1_Vector_borrow'#0'$0$dst@1| (seq.nth _$t0@@0 $t4@0)) (= $abort_flag@0@@0 false)) (and (= $abort_code@1@@0 $abort_code@0@@0) (= |inline$$1_Vector_borrow'#0'$0$dst@2| |inline$$1_Vector_borrow'#0'$0$dst@1|))) (and (=> (= (ControlFlow 0 39615) 39961) anon19_Then_correct@@0) (=> (= (ControlFlow 0 39615) 39687) anon19_Else_correct@@0))))))
(let ((anon18_Then_correct@@0  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 39673) 39665) |inline$$1_Vector_borrow'#0'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 39673) 39615) |inline$$1_Vector_borrow'#0'$0$anon3_Else_correct|)))))
(let ((anon18_Else_correct@@0  (=> (not inline$$Lt$0$dst@1) (and (=> (= (ControlFlow 0 39483) (- 0 53992)) (not (let (($range_0@@10 _$t0@@0))
(exists (($i_1@@15 Int) ) (!  (and (and (>= $i_1@@15 0) (< $i_1@@15 (seq.len $range_0@@10))) (let ((x@@0 (seq.nth $range_0@@10 $i_1@@15)))
(= x@@0 _$t1@@0)))
 :qid |verifyvectorandybpl.1635:38|
 :skolemid |40|
))))) (=> (not (let (($range_0@@10 _$t0@@0))
(exists (($i_1@@16 Int) ) (!  (and (and (>= $i_1@@16 0) (< $i_1@@16 (seq.len $range_0@@10))) (let ((x@@0 (seq.nth $range_0@@10 $i_1@@16)))
(= x@@0 _$t1@@0)))
 :qid |verifyvectorandybpl.1635:38|
 :skolemid |40|
)))) (=> (= false false) (=> (and (= $t13@0@@0 false) (= (ControlFlow 0 39483) 39528)) L8_correct)))))))
(let ((anon17_Else$1_correct  (and (=> (= (ControlFlow 0 39428) 39673) anon18_Then_correct@@0) (=> (= (ControlFlow 0 39428) 39483) anon18_Else_correct@@0))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< $t4@0 |inline$$1_Vector_length'#0'$0$l@1|)) (= (ControlFlow 0 39418) 39428)) anon17_Else$1_correct)))
(let ((anon17_Else_correct@@0  (=> (and (not false) (= |inline$$1_Vector_length'#0'$0$l@1| |inline$$1_Vector_length'#0'$0$l@1|)) (and (=> (= (ControlFlow 0 39424) (- 0 53857)) (not (let (($range_0@@11 ($Range 0 0)))
(exists (($i_1@@17 Int) ) (!  (and ($InRange $range_0@@11 $i_1@@17) (let ((j@@2 $i_1@@17))
(= (seq.nth _$t0@@0 j@@2) _$t1@@0)))
 :qid |verifyvectorandybpl.1512:49|
 :skolemid |38|
))))) (=> (not (let (($range_0@@11 ($Range 0 0)))
(exists (($i_1@@18 Int) ) (!  (and ($InRange $range_0@@11 $i_1@@18) (let ((j@@2 $i_1@@18))
(= (seq.nth _$t0@@0 j@@2) _$t1@@0)))
 :qid |verifyvectorandybpl.1512:49|
 :skolemid |38|
)))) (=> (and (|$IsValid'u64'| $t4@0) (|$IsValid'u64'| $t10@0@@0)) (=> (and (and (|$IsValid'u64'| $t11@0@@0) (not false)) (and (not (let (($range_0@@12 ($Range 0 $t4@0)))
(exists (($i_1@@19 Int) ) (!  (and ($InRange $range_0@@12 $i_1@@19) (let ((j@@3 $i_1@@19))
(= (seq.nth _$t0@@0 j@@3) _$t1@@0)))
 :qid |verifyvectorandybpl.1543:54|
 :skolemid |39|
)))) (= (ControlFlow 0 39424) 39418))) inline$$Lt$0$anon0_correct)))))))
(let ((anon17_Then_correct@@0 true))
(let ((|inline$$1_Vector_length'#0'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'#0'$0$l@1| (seq.len _$t0@@0)) (and (=> (= (ControlFlow 0 39254) 39975) anon17_Then_correct@@0) (=> (= (ControlFlow 0 39254) 39424) anon17_Else_correct@@0)))))
(let ((anon0$1_correct@@0  (=> (and (|$IsValid'vec'#0''| _$t0@@0) (= _$t0@@0 _$t0@@0)) (=> (and (and (= _$t1@@0 _$t1@@0) (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 39260) 39254))) |inline$$1_Vector_length'#0'$0$anon0_correct|))))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 53668) 39260) anon0$1_correct@@0)))
anon0_correct@@0))))))))))))))))))))))))
))
