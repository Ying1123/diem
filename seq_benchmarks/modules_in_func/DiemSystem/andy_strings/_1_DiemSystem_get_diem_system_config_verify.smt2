...
(assert (not
 (=> (= (ControlFlow 0 0) 870922) (let ((anon4_Else_correct  (=> (not $t1) (=> (and (and (|$IsValid'$1_DiemSystem_DiemSystem'| $t0) (let (($range_0@@26 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| $t0)))))
(let (($range_1@@3 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| $t0)))))
(forall (($i_2@@2 Int) ($i_3@@3 Int) ) (!  (=> ($InRange $range_0@@26 $i_2@@2) (=> ($InRange $range_1@@3 $i_3@@3) (let ((i@@74 $i_2@@2))
(let ((j@@18 $i_3@@3))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| $t0) i@@74)) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| $t0) j@@18))) (= i@@74 j@@18))))))
 :qid |DiemSystembpl.19300:222|
 :skolemid |600|
))))) (and (= $t0 (let ((addr@@435 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@435)))) (= $t0 $t0))) (and (=> (= (ControlFlow 0 543879) (- 0 871410)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 543879) (- 0 871422)) (= $t0 (let ((addr@@436 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@436))))) (=> (= $t0 (let ((addr@@437 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@437)))) (=> (= (ControlFlow 0 543879) (- 0 871433)) (= (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@438 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@438)))) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@439 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@439))))))))))))))
(let ((anon4_Then_correct  (=> $t1 (=> (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t2)) (= $t2 $t2)) (and (=> (= (ControlFlow 0 543937) (- 0 871270)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (=> (= (ControlFlow 0 543937) (- 0 871277)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t2)))))))))
(let ((anon0$1_correct@@24  (=> (forall ((config_address@@62 Int) ) (!  (=> (|$IsValid'address'| config_address@@62) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address@@62) (= config_address@@62 173345816)))
 :qid |DiemSystembpl.19243:20|
 :skolemid |594|
)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_239008| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_240125| $1_DiemSystem_CapabilityHolder_$memory) 173345816))) (forall ((addr@@440 Int) ) (!  (=> (|$IsValid'address'| addr@@440) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@440) (= addr@@440 173345816)))
 :qid |DiemSystembpl.19251:20|
 :skolemid |595|
))) (=> (and (and (let (($range_0@@27 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@441 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@441))))))))
(forall (($i_1@@23 Int) ) (!  (=> ($InRange $range_0@@27 $i_1@@23) (let ((i1@@7 $i_1@@23))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@442 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@442)))) i1@@7))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@442 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@442)))) i1@@7)))) 3))))
 :qid |DiemSystembpl.19255:151|
 :skolemid |596|
))) (let (($range_0@@28 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@443 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@443))))))))
(forall (($i_1@@24 Int) ) (!  (=> ($InRange $range_0@@28 $i_1@@24) (let ((i1@@8 $i_1@@24))
(= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@444 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@444)))) i1@@8)) 1)))
 :qid |DiemSystembpl.19260:151|
 :skolemid |597|
)))) (and (forall (($a_0@@83 Int) ) (! (let (($rsc@@83 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@83)))
 (and (|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem''| $rsc@@83) (let (($range_1@@4 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@83))))))
(let (($range_2@@0 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@83))))))
(forall (($i_3@@4 Int) ($i_4@@0 Int) ) (!  (=> ($InRange $range_1@@4 $i_3@@4) (=> ($InRange $range_2@@0 $i_4@@0) (let ((i@@75 $i_3@@4))
(let ((j@@19 $i_4@@0))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@83)) i@@75)) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@83)) j@@19))) (= i@@75 j@@19))))))
 :qid |DiemSystembpl.19266:367|
 :skolemid |598|
))))))
 :qid |DiemSystembpl.19265:20|
 :skolemid |599|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@83))
)) (= $t1  (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 543734) 543937) anon4_Then_correct) (=> (= (ControlFlow 0 543734) 543879) anon4_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@24  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@44 T@$1_Event_EventHandle) ) (! (let ((stream@@54 (|Select__T@[$1_Event_EventHandle]Multiset_200533_| (|streams#$EventStore| $es) handle@@44)))
 (and (= (|l#Multiset_200533| stream@@54) 0) (forall ((v@@100 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_200533| stream@@54) v@@100) 0)
 :qid |DiemSystembpl.134:13|
 :skolemid |2|
))))
 :qid |DiemSystembpl.3452:13|
 :skolemid |94|
))) (= (ControlFlow 0 543441) 543734)) anon0$1_correct@@24)))
(let ((anon0_correct@@24  (=> (= (ControlFlow 0 870922) 543441) inline$$InitEventStore$0$anon0_correct@@24)))
anon0_correct@@24))))))
))
(check-sat)
(pop 1)
