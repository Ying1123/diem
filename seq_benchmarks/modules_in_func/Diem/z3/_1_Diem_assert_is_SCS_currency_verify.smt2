...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1064524) (let ((anon10_Else_correct true))
(let ((anon10_Then_correct  (=> |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| (and (=> (= (ControlFlow 0 703123) (- 0 1065274)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 703123) (- 0 1065295)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@0))))
 ...
 :qid |Diembpl.11342:15|
 :skolemid |451|
)) (and (=> (= (ControlFlow 0 703123) (- 0 1065324)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@2)))
 ...
 :qid |Diembpl.11347:15|
 :skolemid |452|
)) (and (=> (= (ControlFlow 0 703123) (- 0 1065349)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 703123) (- 0 1065370)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4))))
 ...
 :qid |Diembpl.11357:15|
 :skolemid |453|
)) (and (=> (= (ControlFlow 0 703123) (- 0 1065399)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6)))
 ...
 :qid |Diembpl.11377:15|
 :skolemid |455|
)) (and (=> (= (ControlFlow 0 703123) (- 0 1065502)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10)))
...
(let ((anon9_Else_correct  (=> (and (not $abort_flag@2) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t6) (= $t6 1)) (and (= $t6 $t6) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 702815) 703123) anon10_Then_correct) (=> (= (ControlFlow 0 702815) 702831) anon10_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$L5_correct|  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 |inline$$1_Diem_is_SCS_currency'#0'$0$$t2@1|) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 702707) 703137) anon9_Then_correct) (=> (= (ControlFlow 0 702707) 702815) anon9_Else_correct))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t2@1| $abort_code@1) (= (ControlFlow 0 702701) 702707))) |inline$$1_Diem_is_SCS_currency'#0'$0$L5_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|  (=> (and (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1|) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1|))) (and (=> (= (ControlFlow 0 702603) 703137) anon9_Then_correct) (=> (= (ControlFlow 0 702603) 702815) anon9_Else_correct)))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else$1_correct|  (=> (= inline$$Not$0$dst@1 inline$$Not$0$dst@1) (=> (and (and (= $abort_code@2 $abort_code@1) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| inline$$Not$0$dst@1)) (and (= $abort_flag@1 $abort_flag@0) (= (ControlFlow 0 702687) 702603))) |inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not |inline$$1_Diem_is_SCS_currency'#0'$0$$t5@1|)) (= (ControlFlow 0 702669) 702687)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else$1_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|  (=> (not $abort_flag@0) (=> (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t5@1| (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2|)) (= (ControlFlow 0 702675) 702669)) inline$$Not$0$anon0_correct))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then$1_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@0|)) (and (=> (= (ControlFlow 0 702759) 702701) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 702759) 702675) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|))))))
...
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@1| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@1|))) (and (=> (= (ControlFlow 0 702627) 702701) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 702627) 702675) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|))))))
...
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Else_correct|  (=> (and (not |inline$$1_Diem_is_currency'#0'$0$$t1@1|) (= false false)) (=> (and (and (= $abort_code@2 $abort_code@0) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| false)) (and (= $abort_flag@1 false) (= (ControlFlow 0 702591) 702603))) |inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|))))
...
(let ((anon8_Else_correct  (=> (and (not $t2) (= (ControlFlow 0 702779) 702563)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon0_correct|)))
...
)) (= $t2  (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 702224) 703163) anon8_Then_correct) (=> (= (ControlFlow 0 702224) 702779) anon8_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 701945) 702224)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1064524) 701945) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))
))
(check-sat)
(pop 1)
