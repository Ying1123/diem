...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 225572) (let ((anon0$1_correct  (=> (and (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127999| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |VASPbpl.9267:20|
 :skolemid |200|
...
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 163206) (- 0 225707)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 163206) (- 0 225714)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0))) (=> (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0)) (and (=> (= (ControlFlow 0 163206) (- 0 225725)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) a)))
 :qid |VASPbpl.9311:15|
 :skolemid |202|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_68395_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 163029) 163206)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 225572) 163029) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
