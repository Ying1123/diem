...
procedure {:timeLimit 40} $1_DiemTimestamp_assert_genesis$verify() returns ()
{
    ...
    // @91 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:130:5+1
...
L2:
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@91]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:140:9+51
    assume {:print "$at(17,5622,5673)"} true;
    assert {:msg "assert_failed(17,5622,5673): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#91);
...
L3:
    ...
    // assert Not(DiemTimestamp::$is_genesis[@91]()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:5+93
    assume {:print "$at(17,5407,5500)"} true;
    assert {:msg "assert_failed(17,5407,5500): abort not covered by any of the `aborts_if` clauses"}
      !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#91);

    // assert And(Not(DiemTimestamp::$is_genesis[@91]()), Eq(1, $t3)) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:133:5+93
    assert {:msg "assert_failed(17,5407,5500): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#91) && $IsEqual'num'(1, $t3));
...
procedure {:timeLimit 40} $1_DiemTimestamp_assert_operating$verify() returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#90: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    ...
    // @90 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:150:5+1
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#90 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;
...
L2:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@90]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
    assume {:print "$at(17,6375,6428)"} true;
    assert {:msg "assert_failed(17,6375,6428): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#90);
...
L3:
    ...
    // assert Not(DiemTimestamp::$is_operating[@90]()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:5+97
    assume {:print "$at(17,6155,6252)"} true;
    assert {:msg "assert_failed(17,6155,6252): abort not covered by any of the `aborts_if` clauses"}
      !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#90);

    // assert And(Not(DiemTimestamp::$is_operating[@90]()), Eq(1, $t3)) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:5+97
    assert {:msg "assert_failed(17,6155,6252): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#90) && $IsEqual'num'(1, $t3));
...
procedure {:timeLimit 40} $1_DiemTimestamp_now_microseconds$verify() returns ($ret0: int)
{
    ...
    // @104 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:98:5+1
...
L1:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@104]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
    assume {:print "$at(17,6375,6428)"} true;
    assert {:msg "assert_failed(17,6375,6428): function does not abort under this condition"}
...
L2:
    ...
    // assert Not(DiemTimestamp::$is_operating[@104]()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:102:5+141
    assume {:print "$at(17,4355,4496)"} true;
    assert {:msg "assert_failed(17,4355,4496): abort not covered by any of the `aborts_if` clauses"}
      !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#104);

    // assert And(Not(DiemTimestamp::$is_operating[@104]()), Eq(1, $t1)) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:102:5+141
    assert {:msg "assert_failed(17,4355,4496): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#104) && $IsEqual'num'(1, $t1));
...
procedure {:timeLimit 40} $1_DiemTimestamp_now_seconds$verify() returns ($ret0: int)
{
    ...
    // @109 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:112:5+1
...
L2:
    ...
    // assert Not(DiemTimestamp::$is_operating[@109]()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:5+163
    assume {:print "$at(17,4786,4949)"} true;
    assert {:msg "assert_failed(17,4786,4949): abort not covered by any of the `aborts_if` clauses"}
      !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#109);

    // assert And(Not(DiemTimestamp::$is_operating[@109]()), Eq(1, $t2)) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:115:5+163
    assert {:msg "assert_failed(17,4786,4949): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#109) && $IsEqual'num'(1, $t2));
...
L5:
    ...
    // @228 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:54:5+794
    ...
    // assert Implies(DiemTimestamp::$is_operating[@228](), Le(DiemTimestamp::spec_now_microseconds[@228](), DiemTimestamp::spec_now_microseconds())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:172:9+109
...
L8:
    ...
    // @142 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@142](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
...
L7:
    ...
    // @176 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@176](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
...
L6:
    ...
    // @148 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@148](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
...
L7:
    ...
    // @166 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@166](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
...
L7:
    ...
    // @160 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@160](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
...
L7:
    ...
    // @154 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@154](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
