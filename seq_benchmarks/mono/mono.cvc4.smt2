...
(assert (not
 (=> (= (ControlFlow 0 0) 40001) (let ((anon8_Else_correct@@0  (=> (not $abort_flag@0@@0) (and (=> (= (ControlFlow 0 36687) (- 0 40220)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_32085| |$42_TestMonomorphization_R'#0'_$memory|) _$t0@@0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_32085| |$42_TestMonomorphization_R'#0'_$memory|) _$t0@@0)) (=> (= (ControlFlow 0 36687) (- 0 40231)) (|Select__T@[Int]Bool_| (|domain#$Memory_32085| |$42_TestMonomorphization_R'#0'_$memory@1|) _$t0@@0)))))))
(let ((anon8_Then_correct@@0  (=> $abort_flag@0@@0 (=> (and (= $abort_code@1@@0 $abort_code@1@@0) (= (ControlFlow 0 36715) (- 0 40200))) (|Select__T@[Int]Bool_| (|domain#$Memory_32085| |$42_TestMonomorphization_R'#0'_$memory|) _$t0@@0)))))
...
(let ((anon7_Then_correct@@0  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_32085| |$42_TestMonomorphization_R'#0'_$memory|) _$t0@@0) (= (ControlFlow 0 36763) 36765)) anon7_Then$1_correct@@0)))
(let ((anon7_Else_correct@@0  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_32085| |$42_TestMonomorphization_R'#0'_$memory|) _$t0@@0)) (=> (and (and (= |$42_TestMonomorphization_R'#0'_$memory@0| ($Memory_32085 (|Store__T@[Int]Bool_| (|domain#$Memory_32085| |$42_TestMonomorphization_R'#0'_$memory|) _$t0@@0 true) (|Store__T@[Int]$42_TestMonomorphization_R'#0'_| (|contents#$Memory_32085| |$42_TestMonomorphization_R'#0'_$memory|) _$t0@@0 $t3@0@@0))) (= |$42_TestMonomorphization_R'#0'_$memory@1| |$42_TestMonomorphization_R'#0'_$memory@0|)) (and (= $abort_flag@0@@0 false) (= $abort_code@1@@0 $abort_code@0@@0))) (and (=> (= (ControlFlow 0 36655) 36715) anon8_Then_correct@@0) (=> (= (ControlFlow 0 36655) 36687) anon8_Else_correct@@0))))))
(let ((anon0$1_correct@@0  (=> (and (|$IsValid'address'| _$t0@@0) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$42_TestMonomorphization_R'#0'_| (|contents#$Memory_32085| |$42_TestMonomorphization_R'#0'_$memory|) $a_0@@0)))
(|$IsValid'$42_TestMonomorphization_R'#0''| $rsc@@0))
 :qid |monocvc4bpl.2367:20|
 :skolemid |69|
 :pattern ( (|Select__T@[Int]$42_TestMonomorphization_R'#0'_| (|contents#$Memory_32085| |$42_TestMonomorphization_R'#0'_$memory|) $a_0@@0))
...
(assert (not
 (=> (= (ControlFlow 0 0) 40245) (let ((anon8_Else_correct@@1  (=> (and (not $abort_flag@0@@1) (= $t4@0 ($Mutation_6804 (|l#$Mutation_32807| $t2@1) (seq.++ (|p#$Mutation_32807| $t2@1) (seq.unit 1)) (|$y#$42_TestMonomorphization_R'bool'| (|v#$Mutation_32807| $t2@1))))) (=> (and (and (= $t4@1 ($Mutation_6804 (|l#$Mutation_6804| $t4@0) (|p#$Mutation_6804| $t4@0) false)) (= $t2@2 ($Mutation_32807 (|l#$Mutation_32807| $t2@1) (|p#$Mutation_32807| $t2@1) (|$42_TestMonomorphization_R'bool'| (|$x#$42_TestMonomorphization_R'bool'| (|v#$Mutation_32807| $t2@1)) (|v#$Mutation_6804| $t4@1))))) (and (= |$42_TestMonomorphization_R'bool'_$memory@0| ($Memory_31748 (|Store__T@[Int]Bool_| (|domain#$Memory_31748| |$42_TestMonomorphization_R'bool'_$memory|) (|a#$Global| (|l#$Mutation_32807| $t2@2)) true) (|Store__T@[Int]$42_TestMonomorphization_R'bool'_| (|contents#$Memory_31748| |$42_TestMonomorphization_R'bool'_$memory|) (|a#$Global| (|l#$Mutation_32807| $t2@2)) (|v#$Mutation_32807| $t2@2)))) (= (ControlFlow 0 37018) (- 0 40510)))) (= (|Select__T@[Int]$42_TestMonomorphization_R'bool'_| (|contents#$Memory_31748| |$42_TestMonomorphization_R'bool'_$memory@0|) _$t0@@1) (|$42_TestMonomorphization_R'bool'| (|$x#$42_TestMonomorphization_R'bool'| (|Select__T@[Int]$42_TestMonomorphization_R'bool'_| (|contents#$Memory_31748| |$42_TestMonomorphization_R'bool'_$memory|) _$t0@@1)) false))))))
...
(let ((anon7_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_31748| |$42_TestMonomorphization_R'bool'_$memory|) _$t0@@1)) (= (ControlFlow 0 37086) 37088)) anon7_Then$1_correct@@1)))
(let ((anon7_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_31748| |$42_TestMonomorphization_R'bool'_$memory|) _$t0@@1) (=> (and (and (= $t2@0 ($Mutation_32807 ($Global _$t0@@1) (as seq.empty (Seq Int)) (|Select__T@[Int]$42_TestMonomorphization_R'bool'_| (|contents#$Memory_31748| |$42_TestMonomorphization_R'bool'_$memory|) _$t0@@1))) (= $t2@1 $t2@0)) (and (= $abort_flag@0@@1 false) (= $abort_code@1@@1 $abort_code@0@@1))) (and (=> (= (ControlFlow 0 36944) 37036) anon8_Then_correct@@1) (=> (= (ControlFlow 0 36944) 37018) anon8_Else_correct@@1))))))
(let ((anon0$1_correct@@1  (=> (|$IsValid'address'| _$t0@@1) (=> (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$42_TestMonomorphization_R'bool'_| (|contents#$Memory_31748| |$42_TestMonomorphization_R'bool'_$memory|) $a_0@@1)))
(|$IsValid'$42_TestMonomorphization_R'bool''| $rsc@@1))
 :qid |monocvc4bpl.2456:20|
 :skolemid |70|
 :pattern ( (|Select__T@[Int]$42_TestMonomorphization_R'bool'_| (|contents#$Memory_31748| |$42_TestMonomorphization_R'bool'_$memory|) $a_0@@1))
...
(declare-fun _$t0@@3 () T@$Mutation_31295)
...
(assert (not
 (=> (= (ControlFlow 0 0) 40841) (let ((anon4_Else_correct  (=> (not false) (=> (and (= |$temp_0'$1_Event_EventHandle'$42_TestMonomorphization_E''@1| (|v#$Mutation_31295| _$t0@@3)) (= |$temp_0'$1_Event_EventHandle'$42_TestMonomorphization_E''@1| |$temp_0'$1_Event_EventHandle'$42_TestMonomorphization_E''@1|)) (and (=> (= (ControlFlow 0 37708) (- 0 41025)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_17592_| (|streams#$EventStore| $EmptyEventStore) (|v#$Mutation_31295| _$t0@@3))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_17592_| (|streams#$EventStore| $EmptyEventStore) (|v#$Mutation_31295| _$t0@@3) stream_new))))))
...
(let ((expected@@0 (let ((stream@@6 (|Select__T@[$1_Event_EventHandle]Multiset_17592_| (|streams#$EventStore| $EmptyEventStore) (|v#$Mutation_31295| _$t0@@3))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_17592_| (|streams#$EventStore| $EmptyEventStore) (|v#$Mutation_31295| _$t0@@3) stream_new@@0))))))
...
(let ((|inline$$1_Event_emit_event'$42_TestMonomorphization_E'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$42_TestMonomorphization_E'$0$handle@1| (|v#$Mutation_31295| _$t0@@3)) (= $es@0 (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_17592_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$42_TestMonomorphization_E'$0$handle@1|)))
...
(let ((anon0$1_correct@@4  (=> (= (|l#$Mutation_31295| _$t0@@3) ($Param 0)) (=> (and (|$IsValid'$1_Event_EventHandle'$42_TestMonomorphization_E''| (|v#$Mutation_31295| _$t0@@3)) (= |$temp_0'$1_Event_EventHandle'$42_TestMonomorphization_E''@0| (|v#$Mutation_31295| _$t0@@3))) (=> (and (and (= |$temp_0'$1_Event_EventHandle'$42_TestMonomorphization_E''@0| |$temp_0'$1_Event_EventHandle'$42_TestMonomorphization_E''@0|) (|$IsValid'u64'| 0)) (and (= $t2@0@@1 ($42_TestMonomorphization_E 0)) (= (ControlFlow 0 37622) 37616))) |inline$$1_Event_emit_event'$42_TestMonomorphization_E'$0$anon0_correct|)))))
...
(let ((anon0$1_correct@@5  (=> (|$IsValid'vec'address''| _$t0@@4) (=> (and (and (= _$t0@@4 _$t0@@4) (= $t1@0 ($Mutation_23937 ($Local 0) (as seq.empty (Seq Int)) _$t0@@4))) (and (|$IsValid'address'| 1) (= (ControlFlow 0 38034) 38028))) |inline$$1_Vector_push_back'address'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct@@5  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@10 T@$1_Event_EventHandle) ) (! (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_17592_| (|streams#$EventStore| $es) handle@@10)))
 ...
 :qid |monocvc4bpl.2057:13|
 :skolemid |59|
))) (= (ControlFlow 0 37935) 38034)) anon0$1_correct@@5)))
(let ((anon0_correct@@5  (=> (and (= (seq.len (|p#$Mutation_23937| $t1)) 0) (= (ControlFlow 0 37945) 37935)) inline$$InitEventStore$0$anon0_correct@@5)))
(let ((PreconditionGeneratedEntry_correct@@0  (=> (= (ControlFlow 0 41136) 37945) anon0_correct@@5)))
