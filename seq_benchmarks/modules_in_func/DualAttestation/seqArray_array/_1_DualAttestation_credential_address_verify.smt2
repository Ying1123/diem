...
(assert (not
 (=> (= (ControlFlow 0 0) 303636) (let ((anon7_Then_correct  (=> $t4@@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_150926| $1_VASP_ParentVASP_$memory) _$t0@@9)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_150862| $1_VASP_ChildVASP_$memory) _$t0@@9))) (= 7 $t5@@3)) (and (= $t5@@3 $t5@@3) (= (ControlFlow 0 224117) (- 0 303923)))) false))))
(let ((L3_correct@@3  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 224015) (- 0 303980)) (not false)) (=> (not false) (=> (= (ControlFlow 0 224015) (- 0 303987)) (= $t1@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_150862| $1_VASP_ChildVASP_$memory) _$t0@@9) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_150926| $1_VASP_ParentVASP_$memory) _$t0@@9) _$t0@@9 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_150862| $1_VASP_ChildVASP_$memory) _$t0@@9))) _$t0@@9))))))))
(let ((anon7_Else_correct  (=> (and (not $t4@@0) (|$IsValid'address'| $t3)) (=> (and (and (= $t3 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_150926| $1_VASP_ParentVASP_$memory) _$t0@@9) _$t0@@9 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_150862| $1_VASP_ChildVASP_$memory) _$t0@@9)))) (= $t3 $t3)) (and (= $t1@0 $t3) (= (ControlFlow 0 224071) 224015))) L3_correct@@3))))
(let ((anon6_Then_correct  (=> (and $t2 (= $t4@@0  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_150926| $1_VASP_ParentVASP_$memory) _$t0@@9)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_150862| $1_VASP_ChildVASP_$memory) _$t0@@9))))) (and (=> (= (ControlFlow 0 224041) 224117) anon7_Then_correct) (=> (= (ControlFlow 0 224041) 224071) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (and (not $t2) (= _$t0@@9 _$t0@@9)) (and (= $t1@0 _$t0@@9) (= (ControlFlow 0 223983) 224015))) L3_correct@@3)))
(let ((anon0$1_correct@@9  (=> (forall ((child_addr@@3 Int) ) (!  (=> (|$IsValid'address'| child_addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150862| $1_VASP_ChildVASP_$memory) child_addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_150926| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_150862| $1_VASP_ChildVASP_$memory) child_addr@@3)))))
 :qid |DualAttestationbpl.13247:20|
 :skolemid |298|
)) (=> (and (and (and (forall ((addr@@72 Int) ) (!  (=> (|$IsValid'address'| addr@@72) (= (|Select__T@[Int]Bool_| (|domain#$Memory_150926| $1_VASP_ParentVASP_$memory) addr@@72)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@72) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@72)) 5))))
 :qid |DualAttestationbpl.13251:20|
 :skolemid |299|
)) (forall ((addr@@73 Int) ) (!  (=> (|$IsValid'address'| addr@@73) (= (|Select__T@[Int]Bool_| (|domain#$Memory_150862| $1_VASP_ChildVASP_$memory) addr@@73)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@73) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@73)) 6))))
 :qid |DualAttestationbpl.13255:20|
 :skolemid |300|
))) (and (forall ((addr@@74 Int) ) (!  (=> (|$IsValid'address'| addr@@74) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_157019| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@74) (or (|Select__T@[Int]Bool_| (|domain#$Memory_150926| $1_VASP_ParentVASP_$memory) addr@@74) (|Select__T@[Int]Bool_| (|domain#$Memory_150862| $1_VASP_ChildVASP_$memory) addr@@74))))
 :qid |DualAttestationbpl.13259:20|
 :skolemid |301|
)) (|$IsValid'address'| _$t0@@9))) (and (and (forall (($a_0@@25 Int) ) (! (let (($rsc@@25 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_150862| $1_VASP_ChildVASP_$memory) $a_0@@25)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc@@25))
 :qid |DualAttestationbpl.13266:20|
 :skolemid |302|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_150862| $1_VASP_ChildVASP_$memory) $a_0@@25))
)) (forall (($a_0@@26 Int) ) (! (let (($rsc@@26 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_150926| $1_VASP_ParentVASP_$memory) $a_0@@26)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@26))
 :qid |DualAttestationbpl.13270:20|
 :skolemid |303|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_150926| $1_VASP_ParentVASP_$memory) $a_0@@26))
))) (and (= _$t0@@9 _$t0@@9) (= $t2 (|Select__T@[Int]Bool_| (|domain#$Memory_150862| $1_VASP_ChildVASP_$memory) _$t0@@9))))) (and (=> (= (ControlFlow 0 223969) 224041) anon6_Then_correct) (=> (= (ControlFlow 0 223969) 223983) anon6_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@9  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@11 T@$1_Event_EventHandle) ) (! (let ((stream@@10 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@11)))
 (and (= (|l#Multiset_86488| stream@@10) 0) (forall ((v@@53 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@10) v@@53) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 223781) 223969)) anon0$1_correct@@9)))
(let ((anon0_correct@@9  (=> (= (ControlFlow 0 303636) 223781) inline$$InitEventStore$0$anon0_correct@@9)))
anon0_correct@@9)))))))))
))
(check-sat)
(pop 1)
