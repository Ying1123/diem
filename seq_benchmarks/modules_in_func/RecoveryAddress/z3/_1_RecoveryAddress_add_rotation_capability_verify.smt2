...
(declare-fun $t19@2 () T@$Mutation_225059)
(declare-fun $t19@1 () T@$Mutation_225059)
(declare-fun |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| () T@$Mutation_107079)
...
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory@0 () T@$Memory_170774)
...
(declare-fun $t8 () T@$Mutation_107079)
(declare-fun $t20 () T@$Mutation_107079)
(push 1)
(set-info :boogie-vc-id $1_RecoveryAddress_add_rotation_capability$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 509910) (let ((anon30_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t19@2 ($Mutation_225059 (|l#$Mutation_225059| $t19@1) (|p#$Mutation_225059| $t19@1) ($1_RecoveryAddress_RecoveryAddress (|v#$Mutation_107079| |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1|)))) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr1) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr1))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr1)) 0)) addr1))))
 :qid |RecoveryAddressbpl.22982:20|
 :skolemid |579|
))) (and (forall ((recovery_addr Int) ) (!  (=> (|$IsValid'address'| recovery_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr) (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) recovery_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) recovery_addr))))
 :qid |RecoveryAddressbpl.22986:20|
 :skolemid |580|
)) (= $1_RecoveryAddress_RecoveryAddress_$memory@0 ($Memory_170774 (|Store__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) (|a#$Global| (|l#$Mutation_225059| $t19@2)) true) (|Store__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) (|a#$Global| (|l#$Mutation_225059| $t19@2)) (|v#$Mutation_225059| $t19@2)))))) (and (=> (= (ControlFlow 0 374558) (- 0 510928)) (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr1@@0) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr1@@0))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr1@@0)) 0)) addr1@@0))))
 :qid |RecoveryAddressbpl.23001:15|
 :skolemid |581|
))) (=> (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr1@@1) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr1@@1))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr1@@1)) 0)) addr1@@1))))
 :qid |RecoveryAddressbpl.23001:15|
 :skolemid |581|
)) (and (=> (= (ControlFlow 0 374558) (- 0 510975)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@0)))
 :qid |RecoveryAddressbpl.23007:15|
 :skolemid |582|
))) (=> (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@1)))
 :qid |RecoveryAddressbpl.23007:15|
 :skolemid |582|
)) (and (=> (= (ControlFlow 0 374558) (- 0 510999)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@2)))
 :qid |RecoveryAddressbpl.23013:15|
 :skolemid |583|
))) (=> (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@3)))
 :qid |RecoveryAddressbpl.23013:15|
 :skolemid |583|
)) (and (=> (= (ControlFlow 0 374558) (- 0 511023)) (forall ((recovery_addr@@0 Int) (to_recovery_addr Int) ) (!  (=> (|$IsValid'address'| recovery_addr@@0) (=> (|$IsValid'address'| to_recovery_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@0) (=> (exists ((i@@56 Int) ) (!  (and (and (|$IsValid'u64'| i@@56) (and (<= 0 i@@56) (< i@@56 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@0)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@0)) i@@56)) to_recovery_addr))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
)) (exists ((i@@57 Int) ) (!  (and (and (|$IsValid'u64'| i@@57) (and (<= 0 i@@57) (< i@@57 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr@@0)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr@@0)) i@@57)) to_recovery_addr))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
))))))
 :qid |RecoveryAddressbpl.23019:15|
 :skolemid |584|
))) (=> (forall ((recovery_addr@@1 Int) (to_recovery_addr@@0 Int) ) (!  (=> (|$IsValid'address'| recovery_addr@@1) (=> (|$IsValid'address'| to_recovery_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@1) (=> (exists ((i@@58 Int) ) (!  (and (and (|$IsValid'u64'| i@@58) (and (<= 0 i@@58) (< i@@58 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@1)) i@@58)) to_recovery_addr@@0))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
)) (exists ((i@@59 Int) ) (!  (and (and (|$IsValid'u64'| i@@59) (and (<= 0 i@@59) (< i@@59 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr@@1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr@@1)) i@@59)) to_recovery_addr@@0))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
))))))
 :qid |RecoveryAddressbpl.23019:15|
 :skolemid |584|
)) (and (=> (= (ControlFlow 0 374558) (- 0 511064)) (forall ((recovery_addr@@2 Int) ) (!  (=> (|$IsValid'address'| recovery_addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr@@2) (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) recovery_addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) recovery_addr@@2))))
 :qid |RecoveryAddressbpl.23025:15|
 :skolemid |585|
))) (=> (forall ((recovery_addr@@3 Int) ) (!  (=> (|$IsValid'address'| recovery_addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr@@3) (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) recovery_addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) recovery_addr@@3))))
 :qid |RecoveryAddressbpl.23025:15|
 :skolemid |585|
)) (=> (= $t27 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) _$t1)))) (and (=> (= (ControlFlow 0 374558) (- 0 511107)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (and (=> (= (ControlFlow 0 374558) (- 0 511118)) (not (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256))) (=> (not (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (and (=> (= (ControlFlow 0 374558) (- 0 511135)) (not (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) $t10)))))))) (=> (not (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) $t10))))))) (=> (= (ControlFlow 0 374558) (- 0 511149)) (= (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@0) _$t1)) (- $t27 1)) _$t0)))))))))))))))))))))))
(let ((anon24_Then_correct true))
(let ((L7_correct  (and (=> (= (ControlFlow 0 373741) (- 0 510720)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) $t10)))))))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) $t10))))))) (=> (= (ControlFlow 0 373741) (- 0 510751)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= 5 $t14@0)) (and (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256) (= 8 $t14@0))) (and (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) $t10)))))) (= 7 $t14@0))))))))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 374572) 373741))) L7_correct)))
(let ((|inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| ($Mutation_107079 (|l#$Mutation_107079| $t20@0) (|p#$Mutation_107079| $t20@0) (seq.++ (|v#$Mutation_107079| $t20@0) (seq.unit _$t0)))) (and (=> (= (ControlFlow 0 374189) 374572) anon30_Then_correct) (=> (= (ControlFlow 0 374189) 374558) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (and inline$$Lt$0$dst@1 (= (ControlFlow 0 374195) 374189)) |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|)))
(let ((anon29_Else_correct  (=> (and (and (not inline$$Lt$0$dst@1) (= $t26 $t26)) (and (= $t14@0 $t26) (= (ControlFlow 0 374134) 373741))) L7_correct)))
(let ((anon28_Else$1_correct  (=> (|$IsValid'u64'| 6) (=> (and (and (|$IsValid'u64'| $t26) (= $t26 8)) (and (= $t26 $t26) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 374118) 374195) anon29_Then_correct) (=> (= (ControlFlow 0 374118) 374134) anon29_Else_correct))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| 256)) (= (ControlFlow 0 374078) 374118)) anon28_Else$1_correct)))
(let ((anon28_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 256) (= (ControlFlow 0 374084) 374078)) inline$$Lt$0$anon0_correct))))
(let ((anon28_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 374586) 373741))) L7_correct)))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| (seq.len $t21@0)) (and (=> (= (ControlFlow 0 374018) 374586) anon28_Then_correct) (=> (= (ControlFlow 0 374018) 374084) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (not $abort_flag@0) (= $t20@0 ($Mutation_107079 (|l#$Mutation_225059| $t19@1) (seq.++ (|p#$Mutation_225059| $t19@1) (seq.unit 0)) (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|v#$Mutation_225059| $t19@1))))) (=> (and (and (= |$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@0| (|v#$Mutation_107079| $t20@0)) (= |$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@0| |$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@0|)) (and (= $t21@0 (|v#$Mutation_107079| $t20@0)) (= (ControlFlow 0 374024) 374018))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((anon27_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 374600) 373741))) L7_correct)))
(let ((anon26_Then$1_correct  (=> (= $t19@1 $t19) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 374652) 374600) anon27_Then_correct) (=> (= (ControlFlow 0 374652) 374024) anon27_Else_correct))))))
(let ((anon26_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= (ControlFlow 0 374650) 374652)) anon26_Then$1_correct)))
(let ((anon26_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1) (=> (and (and (= $t19@0 ($Mutation_225059 ($Global _$t1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (= $t19@1 $t19@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 373952) 374600) anon27_Then_correct) (=> (= (ControlFlow 0 373952) 374024) anon27_Else_correct))))))
(let ((anon25_Then_correct  (=> $t16 (and (=> (= (ControlFlow 0 373930) 374650) anon26_Then_correct) (=> (= (ControlFlow 0 373930) 373952) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (and (not $t16) (= $t18 $t18)) (and (= $t14@0 $t18) (= (ControlFlow 0 373926) 373741))) L7_correct)))
(let ((anon24_Else_correct  (=> (and (and (and (not false) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (= $t16  (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)))))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t18) (= $t18 7)) (and (= $t18 $t18) (= $t16 $t16)))) (and (=> (= (ControlFlow 0 373910) 373930) anon25_Then_correct) (=> (= (ControlFlow 0 373910) 373926) anon25_Else_correct)))))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t0)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 373838) 374666) anon24_Then_correct) (=> (= (ControlFlow 0 373838) 373910) anon24_Else_correct))))))
(let ((anon23_Then_correct  (=> (and $t11@0 (= (ControlFlow 0 373844) 373838)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct)))
(let ((anon23_Else_correct  (=> (and (and (not $t11@0) (= $t13 $t13)) (and (= $t14@0 $t13) (= (ControlFlow 0 373633) 373741))) L7_correct)))
(let ((anon0$1_correct  (=> (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |RecoveryAddressbpl.22714:20|
 :skolemid |573|
)) (=> (and (and (and (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) addr@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_140658| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140658| $1_Roles_RoleId_$memory) addr@@4)) 5))))
 :qid |RecoveryAddressbpl.22718:20|
 :skolemid |574|
)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) addr@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_140658| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140658| $1_Roles_RoleId_$memory) addr@@5)) 6))))
 :qid |RecoveryAddressbpl.22722:20|
 :skolemid |575|
))) (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| _$t0) (|$IsValid'address'| _$t1))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) $a_0)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc))
 :qid |RecoveryAddressbpl.22731:20|
 :skolemid |576|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_167732| $1_VASP_ParentVASP_$memory) $a_0@@0)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@0))
 :qid |RecoveryAddressbpl.22735:20|
 :skolemid |577|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_167732| $1_VASP_ParentVASP_$memory) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@1)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@1))
 :qid |RecoveryAddressbpl.22739:20|
 :skolemid |578|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@1))
)) (= $t10 (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t0))))) (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t11@0 (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| $t13) (= $t13 5)) (and (= $t13 $t13) (= $t11@0 $t11@0))))) (and (=> (= (ControlFlow 0 373617) 373844) anon23_Then_correct) (=> (= (ControlFlow 0 373617) 373633) anon23_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_102812_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |RecoveryAddressbpl.3268:13|
 :skolemid |89|
))) (= (ControlFlow 0 373388) 373617)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (seq.len (|p#$Mutation_107079| $t8)) 0) (= (seq.len (|p#$Mutation_225059| $t19)) 0)) (and (= (seq.len (|p#$Mutation_107079| $t20)) 0) (= (ControlFlow 0 373398) 373388))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 509910) 373398) anon0_correct)))
