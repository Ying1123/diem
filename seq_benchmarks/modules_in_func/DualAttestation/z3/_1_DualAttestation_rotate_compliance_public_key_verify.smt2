...
(declare-fun $t21 () T@$Mutation_167619)
(declare-fun $t13 () Int)
(declare-fun $t21@0 () T@$Mutation_167619)
...
(declare-fun $t10 () Int)
(declare-fun $t7 () T@$Mutation_167619)
(declare-fun $t22 () T@$Mutation_100577)
(declare-fun $t23 () T@$Mutation_105462)
(push 1)
(set-info :boogie-vc-id $1_DualAttestation_rotate_compliance_public_key$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 297350) (let ((anon26_Else_correct  (=> (and (not $abort_flag@0) (= $1_DualAttestation_Credential_$memory@0 ($Memory_117094 (|Store__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_167619| $t21@2)) true) (|Store__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_167619| $t21@2)) (|v#$Mutation_167619| $t21@2))))) (and (=> (= (ControlFlow 0 224004) (- 0 298545)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory@0) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |DualAttestationbpl.16542:15|
 :skolemid |354|
))) (=> (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory@0) addr1@@0) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@0)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@0)) 2)))))
 :qid |DualAttestationbpl.16542:15|
 :skolemid |354|
)) (and (=> (= (ControlFlow 0 224004) (- 0 298578)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) a) (=> (not (= (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory@0) a)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) a)))) ($1_Signer_is_txn_signer_addr a))))
 :qid |DualAttestationbpl.16548:15|
 :skolemid |355|
))) (=> (forall ((a@@0 Int) ) (!  (=> (|$IsValid'address'| a@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) a@@0) (=> (not (= (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory@0) a@@0)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) a@@0)))) ($1_Signer_is_txn_signer_addr a@@0))))
 :qid |DualAttestationbpl.16548:15|
 :skolemid |355|
)) (and (=> (= (ControlFlow 0 224004) (- 0 298621)) (forall ((a@@1 Int) ) (!  (=> (|$IsValid'address'| a@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) a@@1) (=> (not (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory@0) a@@1)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) a@@1)))) ($1_Signer_is_txn_signer_addr a@@1))))
 :qid |DualAttestationbpl.16554:15|
 :skolemid |356|
))) (=> (forall ((a@@2 Int) ) (!  (=> (|$IsValid'address'| a@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) a@@2) (=> (not (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory@0) a@@2)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) a@@2)))) ($1_Signer_is_txn_signer_addr a@@2))))
 :qid |DualAttestationbpl.16554:15|
 :skolemid |356|
)) (and (=> (= (ControlFlow 0 224004) (- 0 298664)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (= (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory@0) addr)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr)) 5)))))
 :qid |DualAttestationbpl.16560:15|
 :skolemid |357|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (= (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory@0) addr@@0)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@0)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@0)) 5)))))
 :qid |DualAttestationbpl.16560:15|
 :skolemid |357|
)) (and (=> (= (ControlFlow 0 224004) (- 0 298700)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t1)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t1))) (and (=> (= (ControlFlow 0 224004) (- 0 298710)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) $t8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) $t8))) (and (=> (= (ControlFlow 0 224004) (- 0 298722)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 224004) (- 0 298732)) (= (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory@0) $t9)) _$t1)) (=> (= (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory@0) $t9)) _$t1) (and (=> (= (ControlFlow 0 224004) (- 0 298745)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (= addr1@@1 $t9)) (= (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory@0) addr1@@1)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) addr1@@1)))))
 :qid |DualAttestationbpl.16589:15|
 :skolemid |358|
))) (=> (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (not (= addr1@@2 $t9)) (= (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory@0) addr1@@2)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) addr1@@2)))))
 :qid |DualAttestationbpl.16589:15|
 :skolemid |358|
)) (and (=> (= (ControlFlow 0 224004) (- 0 298783)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new (let ((len (|l#Multiset_84854| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| stream@@0) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_84854 (|Store__T@[$EventRep]Int_| (|v#Multiset_84854| stream@@0) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new))))))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@1 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| expected) handle@@1)) (|l#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| actual) handle@@1))) (forall ((v@@35 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| expected) handle@@1)) v@@35) (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| actual) handle@@1)) v@@35))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_84854| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| stream@@1) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_84854 (|Store__T@[$EventRep]Int_| (|v#Multiset_84854| stream@@1) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@0))))))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@2 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| expected@@0) handle@@2)) (|l#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| actual@@0) handle@@2))) (forall ((v@@36 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| expected@@0) handle@@2)) v@@36) (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| actual@@0) handle@@2)) v@@36))
 :qid |DualAttestationbpl.139:13|
 :skolemid |3|
)))
 :qid |DualAttestationbpl.2447:13|
 :skolemid |70|
))))) (=> (= (ControlFlow 0 224004) (- 0 298808)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_84854| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| stream@@2) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_84854 (|Store__T@[$EventRep]Int_| (|v#Multiset_84854| stream@@2) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@1))))))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@3 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| actual@@1) handle@@3)) (|l#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| expected@@1) handle@@3))) (forall ((v@@37 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| actual@@1) handle@@3)) v@@37) (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| expected@@1) handle@@3)) v@@37))
 :qid |DualAttestationbpl.139:13|
 :skolemid |3|
)))
 :qid |DualAttestationbpl.2447:13|
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) $a_0@@0)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@0))
 :qid |DualAttestationbpl.16308:20|
 :skolemid |353|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) $a_0@@0))
)))) (and (and (and (and (= $t8 (|$addr#$signer| _$t0)) (= $t9 (|$addr#$signer| _$t0))) (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) $t10))))) (and (and (= $t12 ($1_DualAttestation_ComplianceKeyRotationEvent _$t1 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| $t13)))) (and (and (and (= $t13 (|$addr#$signer| _$t0)) (= $t13 $t13)) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) $t13)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t16) (= $t16 5)) (and (= $t16 $t16) (= $t14@0 $t14@0)))))) (and (=> (= (ControlFlow 0 223282) 223418) anon20_Then_correct) (=> (= (ControlFlow 0 223282) 223298) anon20_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_84854| stream@@4) 0) (forall ((v@@38 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| stream@@4) v@@38) 0)
 :qid |DualAttestationbpl.134:13|
 :skolemid |2|
))))
 :qid |DualAttestationbpl.2431:13|
 :skolemid |69|
))) (= (ControlFlow 0 222712) 223282)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (seq.len (|p#$Mutation_167619| $t7)) 0) (=> (and (and (= (seq.len (|p#$Mutation_167619| $t21)) 0) (= (seq.len (|p#$Mutation_100577| $t22)) 0)) (and (= (seq.len (|p#$Mutation_105462| $t23)) 0) (= (ControlFlow 0 222722) 222712))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 297350) 222722) anon0_correct)))
