...
(assert (not
 (=> (= (ControlFlow 0 0) 294917) (let ((anon37_Else_correct  (=> (not $abort_flag@6) (and (=> (= (ControlFlow 0 214813) (- 0 296680)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 214813) (- 0 296692)) (forall ((a@@7 Int) ) (!  (=> (|$IsValid'address'| a@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816) (=> (not (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory@1) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)))) (exists ((a@@8 Int) ) (!  (and (|$IsValid'address'| a@@8) (and ($1_Signer_is_txn_signer_addr a@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) a@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) a@@8)) 1))))
 :qid |DualAttestationbpl.4293:13|
 :skolemid |127|
)))))
 :qid |DualAttestationbpl.11326:15|
 :skolemid |240|
))) (=> (forall ((a@@9 Int) ) (!  (=> (|$IsValid'address'| a@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816) (=> (not (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory@1) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)))) (exists ((a@@10 Int) ) (!  (and (|$IsValid'address'| a@@10) (and ($1_Signer_is_txn_signer_addr a@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) a@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) a@@10)) 1))))
 :qid |DualAttestationbpl.4293:13|
 :skolemid |127|
)))))
 :qid |DualAttestationbpl.11326:15|
 :skolemid |240|
)) (and (=> (= (ControlFlow 0 214813) (- 0 296730)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 214813) (- 0 296740)) (not (not (= (|$addr#$signer| _$t0@@2) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@2) 173345816))) (and (=> (= (ControlFlow 0 214813) (- 0 296754)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (and (=> (= (ControlFlow 0 214813) (- 0 296764)) (not (> $t6 18446744073709551615))) (=> (not (> $t6 18446744073709551615)) (=> (= (ControlFlow 0 214813) (- 0 296775)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))))))))))
(let ((L5_correct@@0  (and (=> (= (ControlFlow 0 213604) (- 0 296558)) (or (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0@@2) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (> $t6 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (or (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0@@2) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (> $t6 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 213604) (- 0 296596)) (or (or (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t8@0@@0)) (and (not (= (|$addr#$signer| _$t0@@2) 173345816)) (= 2 $t8@0@@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816) (= 6 $t8@0@@0))) (and (> $t6 18446744073709551615) (= 8 $t8@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t8@0@@0))))))))
(let ((anon37_Then_correct  (=> (and (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (and (= $t8@0@@0 $abort_code@7) (= (ControlFlow 0 214827) 213604))) L5_correct@@0)))
...
(let ((anon35_Then_correct  (=> (and (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (and (= $t8@0@@0 $abort_code@6) (= (ControlFlow 0 214893) 213604))) L5_correct@@0)))
...
(let ((anon34_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= $t23@@0 $t23@@0)) (and (= $t8@0@@0 $t23@@0) (= (ControlFlow 0 214527) 213604))) L5_correct@@0)))
(let ((anon33_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t23@@0) (= $t23@@0 8)) (and (= $t23@@0 $t23@@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 214511) 214658) anon34_Then_correct) (=> (= (ControlFlow 0 214511) 214527) anon34_Else_correct))))))
...
(let ((anon33_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t8@0@@0 $abort_code@5) (= (ControlFlow 0 214907) 213604))) L5_correct@@0)))
...
(let ((anon32_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t8@0@@0 $abort_code@4) (= (ControlFlow 0 214921) 213604))) L5_correct@@0)))
...
(let ((anon31_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t8@0@@0 $abort_code@3) (= (ControlFlow 0 214935) 213604))) L5_correct@@0)))
...
(let ((anon30_Else_correct  (=> (and (not $abort_flag@0@@2) (= (ControlFlow 0 214119) 213965)) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon0_correct|)))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@0@@2 (= $abort_code@1@@2 $abort_code@1@@2)) (and (= $t8@0@@0 $abort_code@1@@2) (= (ControlFlow 0 214949) 213604))) L5_correct@@0)))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_flag@0@@2 true) (=> (and (= $abort_code@1@@2 $EXEC_FAILURE_CODE) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 213733) 214949) anon30_Then_correct) (=> (= (ControlFlow 0 213733) 214119) anon30_Else_correct))))))
...
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@2))
 ...
 :skolemid |238|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@3))
)))) (and (and (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) $a_0@@4)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc@@4))
 :qid |DualAttestationbpl.11063:20|
 :skolemid |239|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) $a_0@@4))
)) (= $t6 (* 1000 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (= _$t0@@2 _$t0@@2) (= $t7@@1  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 213348) 215005) anon27_Then_correct) (=> (= (ControlFlow 0 213348) 213370) anon27_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_86488| stream@@3) 0) (forall ((v@@46 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@3) v@@46) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 212809) 213348)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 294917) 212809) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2)))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
