...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 248221) (let ((anon21_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 178626) (- 0 248844)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory@1) 173345816)) (=> (= $t15 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_107487| $1_DiemConfig_Configuration_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 178626) (- 0 248871)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) 173345816)) (and (=> (= (ControlFlow 0 178626) (- 0 248879)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 178626) (- 0 248889)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 178626) (- 0 248903)) (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory@1) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory@1) 173345816) (and (=> (= (ControlFlow 0 178626) (- 0 248909)) (= (|$epoch#$1_DiemConfig_Configuration| $t15) 0)) (=> (= (|$epoch#$1_DiemConfig_Configuration| $t15) 0) (=> (= (ControlFlow 0 178626) (- 0 248920)) (= (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t15) 0))))))))))))))))))
(let ((anon19_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 178390) (- 0 248770)) (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) 173345816) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) 173345816) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (not (= (|$addr#$signer| _$t0) 173345816))) (=> (= (ControlFlow 0 178390) (- 0 248791)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) 173345816) (= 6 $t4@0)) (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t4@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t4@0))))))))
(let ((anon21_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t4@0 $abort_code@1) (= (ControlFlow 0 178640) 178390))) L3_correct)))
(let ((anon20_Then$1_correct  (=> (= $1_DiemConfig_Configuration_$memory@1 $1_DiemConfig_Configuration_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 178692) 178640) anon21_Then_correct) (=> (= (ControlFlow 0 178692) 178626) anon21_Else_correct))))))
(let ((anon20_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 178690) 178692)) anon20_Then$1_correct)))
(let ((anon20_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_DiemConfig_Configuration_$memory@0 ($Memory_107487 (|Store__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_107487| $1_DiemConfig_Configuration_$memory) (|$addr#$signer| _$t0) $t14@0))) (= $1_DiemConfig_Configuration_$memory@1 $1_DiemConfig_Configuration_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 178534) 178640) anon21_Then_correct) (=> (= (ControlFlow 0 178534) 178626) anon21_Else_correct))))))
(let ((anon19_Else_correct  (=> (and (not false) (= $t14@0 ($1_DiemConfig_Configuration 0 0 |inline$$1_Event_new_event_handle'$1_DiemConfig_NewEpochEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 178512) (- 0 248661)) (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 178512) 178690) anon20_Then_correct) (=> (= (ControlFlow 0 178512) 178534) anon20_Else_correct)))))))
...
(let ((anon18_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t10 $t10)) (and (= $t4@0 $t10) (= (ControlFlow 0 178310) 178390))) L3_correct)))
(let ((anon17_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t10) (= $t10 6)) (and (= $t10 $t10) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 178294) 178484) anon18_Then_correct) (=> (= (ControlFlow 0 178294) 178310) anon18_Else_correct))))))
...
(let ((anon17_Then_correct  (=> $t5 (=> (and (and (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t4)) (= $t4 $t4)) (and (= $t4@0 $t4) (= (ControlFlow 0 178736) 178390))) L3_correct))))
(let ((anon16_Else_correct  (=> (and (not $t3) (= $t5  (not (= (|$addr#$signer| _$t0) 173345816)))) (and (=> (= (ControlFlow 0 178208) 178736) anon17_Then_correct) (=> (= (ControlFlow 0 178208) 178264) anon17_Else_correct)))))
...
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) 173345816)) (|$IsValid'address'| (|$addr#$signer| _$t0))) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_107487| $1_DiemConfig_Configuration_$memory) $a_0@@0)))
...
)))) (and (and (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816) (|Select__T@[Int]Bool_| $1_Event_EventHandleGenerator_$modifies (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (= $t3  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 178186) 178762) anon16_Then_correct) (=> (= (ControlFlow 0 178186) 178208) anon16_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_77118_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemConfigbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 178060) 178186)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 248221) 178060) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))
))
(check-sat)
(pop 1)
