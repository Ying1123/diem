...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 255894) (let ((anon11_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 188814) (- 0 256197))) false))))
(let ((L3_correct  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 188742) (- 0 256257)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 188742) (- 0 256264)) (= $t1@0  (and (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))))) (=> (= $t1@0  (and (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0)))) (=> (= (ControlFlow 0 188742) (- 0 256275)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1) (= (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1)))))
 :qid |ValidatorConfigbpl.7608:15|
 :skolemid |212|
))))))))))
(let ((anon11_Else_correct  (=> (and (not $abort_flag@0) (= $t5@0 (|$config#$1_ValidatorConfig_ValidatorConfig| $t3@1))) (=> (and (and (= $t6  (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t5@0)) 0))) (= $t6 $t6)) (and (= $t1@0 $t6) (= (ControlFlow 0 188792) 188742))) L3_correct))))
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 188866) 188814) anon11_Then_correct) (=> (= (ControlFlow 0 188866) 188792) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (ControlFlow 0 188864) 188866)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= $t3@1 $t3@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 188760) 188814) anon11_Then_correct) (=> (= (ControlFlow 0 188760) 188792) anon11_Else_correct))))))
(let ((anon9_Then_correct  (=> $t2@0 (and (=> (= (ControlFlow 0 188746) 188864) anon10_Then_correct) (=> (= (ControlFlow 0 188746) 188760) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (and (not $t2@0) (= false false)) (and (= $t1@0 false) (= (ControlFlow 0 188675) 188742))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105364| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105364| $1_Roles_RoleId_$memory) addr@@0)) 3))))
 :qid |ValidatorConfigbpl.7493:20|
 :skolemid |208|
 ...
 :qid |ValidatorConfigbpl.7497:20|
 :skolemid |209|
 ...
 :qid |ValidatorConfigbpl.7501:20|
 :skolemid |210|
 ...
 :qid |ValidatorConfigbpl.7508:20|
 :skolemid |211|
...
))) (and (= _$t0 _$t0) (= $t2@0 (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) (and (=> (= (ControlFlow 0 188655) 188746) anon9_Then_correct) (=> (= (ControlFlow 0 188655) 188675) anon9_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_76195_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 188498) 188655)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 255894) 188498) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
