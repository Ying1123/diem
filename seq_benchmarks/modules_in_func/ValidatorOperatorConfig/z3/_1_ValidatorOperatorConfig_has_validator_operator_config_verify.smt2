...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 231292) (let ((anon0$1_correct  (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_99251| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_99251| $1_Roles_RoleId_$memory) addr@@0)) 4))))
 :qid |ValidatorOperatorConfigbpl.6066:20|
 :skolemid |166|
)) (=> (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0)))
...
))) (=> (and (and (= _$t0 _$t0) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0))) (and (= $t1@0 $t1@0) (= (ControlFlow 0 170076) (- 0 231411)))) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_101295| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_70082_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorOperatorConfigbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 169973) 170076)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 231292) 169973) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
