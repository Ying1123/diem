...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1067677) (let ((L3_correct  (and (=> (= (ControlFlow 0 706420) (- 0 1068391)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (=> (= (ControlFlow 0 706420) (- 0 1068396)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t3@0)))))))
(let ((anon7_Else_correct  (=> (and (and (not |inline$$1_Diem_is_currency'#0'$0$$t1@1|) (= $t5 $t5)) (and (= $t3@0 $t5) (= (ControlFlow 0 706392) 706420))) L3_correct)))
(let ((anon7_Then_correct  (=> |inline$$1_Diem_is_currency'#0'$0$$t1@1| (and (=> (= (ControlFlow 0 706716) (- 0 1068082)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 706716) (- 0 1068092)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 706716) (- 0 1068113)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@0))))
 ...
 :qid |Diembpl.11952:15|
 :skolemid |499|
)) (and (=> (= (ControlFlow 0 706716) (- 0 1068142)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@2)))
 ...
 :qid |Diembpl.11957:15|
 :skolemid |500|
)) (and (=> (= (ControlFlow 0 706716) (- 0 1068167)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 706716) (- 0 1068188)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4))))
 ...
 :qid |Diembpl.11967:15|
 :skolemid |501|
)) (and (=> (= (ControlFlow 0 706716) (- 0 1068217)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6)))
 ...
 :qid |Diembpl.11987:15|
 :skolemid |503|
)) (and (=> (= (ControlFlow 0 706716) (- 0 1068320)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10)))
...
(let ((anon6_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| |inline$$1_Diem_is_currency'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 706376) 706716) anon7_Then_correct) (=> (= (ControlFlow 0 706376) 706392) anon7_Else_correct))))))
(let ((anon6_Then_correct true))
(let ((|inline$$1_Diem_is_currency'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| |inline$$1_Diem_is_currency'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 706334) 706730) anon6_Then_correct) (=> (= (ControlFlow 0 706334) 706376) anon6_Else_correct))))))
...
)) (= (ControlFlow 0 706340) 706334)))) |inline$$1_Diem_is_currency'#0'$0$anon0_correct|)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 705986) 706340)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1067677) 705986) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))
))
(check-sat)
(pop 1)
