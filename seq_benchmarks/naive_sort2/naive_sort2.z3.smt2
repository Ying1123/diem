...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |naivesort2z3bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |naivesort2z3bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |naivesort2z3bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |naivesort2z3bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |naivesort2z3bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |naivesort2z3bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |naivesort2z3bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |naivesort2z3bpl.461:15|
 :skolemid |14|
...
(forall (($i_3 Int) ) (!  (=> ($InRange $range_2 $i_3) (let ((l $i_3))
 ...
 :qid |naivesort2z3bpl.1809:48|
 :skolemid |48|
)))))
 :qid |naivesort2z3bpl.1808:49|
 :skolemid |49|
))))))))))))))))))
...
(forall (($i_3@@0 Int) ) (!  (=> ($InRange $range_2@@0 $i_3@@0) (let ((j@@1 $i_3@@0))
 ...
 :qid |naivesort2z3bpl.1847:56|
 :skolemid |53|
)))))
 :qid |naivesort2z3bpl.1846:70|
 :skolemid |54|
))))))))))))))
...
(forall (($i_3@@1 Int) ) (!  (=> ($InRange $range_2@@1 $i_3@@1) (let ((l@@0 $i_3@@1))
 ...
 :qid |naivesort2z3bpl.1409:48|
 :skolemid |35|
)))))
 :qid |naivesort2z3bpl.1408:49|
 :skolemid |36|
...
(forall (($i_3@@3 Int) ) (!  (=> ($InRange $range_2@@2 $i_3@@3) (let ((l@@1 $i_3@@3))
 ...
 :qid |naivesort2z3bpl.1524:48|
 :skolemid |41|
)))))
 :qid |naivesort2z3bpl.1523:54|
 :skolemid |42|
