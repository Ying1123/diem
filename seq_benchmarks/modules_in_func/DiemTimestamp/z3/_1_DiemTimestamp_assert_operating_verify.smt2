...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 201868) (let ((L3_correct  (and (=> (= (ControlFlow 0 146711) (- 0 202079)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (= (ControlFlow 0 146711) (- 0 202084)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t3@0)))))))
(let ((anon7_Else_correct  (=> (and (and (not inline$$1_DiemTimestamp_is_operating$0$$t1@1) (= $t5 $t5)) (and (= $t3@0 $t5) (= (ControlFlow 0 146683) 146711))) L3_correct)))
(let ((anon7_Then_correct  (=> (and inline$$1_DiemTimestamp_is_operating$0$$t1@1 (= (ControlFlow 0 146727) (- 0 202044))) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))
(let ((anon6_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t5) (= $t5 1)) (and (= $t5 $t5) (= inline$$1_DiemTimestamp_is_operating$0$$t1@1 inline$$1_DiemTimestamp_is_operating$0$$t1@1))) (and (=> (= (ControlFlow 0 146667) 146727) anon7_Then_correct) (=> (= (ControlFlow 0 146667) 146683) anon7_Else_correct))))))
(let ((anon6_Then_correct true))
(let ((inline$$1_DiemTimestamp_is_operating$0$anon0_correct  (=> (|$IsValid'address'| 173345816) (=> (and (= inline$$1_DiemTimestamp_is_operating$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= inline$$1_DiemTimestamp_is_operating$0$$t1@1 inline$$1_DiemTimestamp_is_operating$0$$t1@1)) (and (=> (= (ControlFlow 0 146625) 146741) anon6_Then_correct) (=> (= (ControlFlow 0 146625) 146667) anon6_Else_correct))))))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_64028_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTimestampbpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 146494) 146631)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 201868) 146494) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))
))
(check-sat)
(pop 1)
