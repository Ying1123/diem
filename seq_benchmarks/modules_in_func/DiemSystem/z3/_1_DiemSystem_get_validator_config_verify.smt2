...
(declare-fun $t15 () Int)
(declare-fun $t14@0 () (Seq T@$1_DiemSystem_ValidatorInfo))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 293107) (let ((anon14_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t18@0 (|$config#$1_DiemSystem_ValidatorInfo| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (= $t18@0 $t18@0)) (and (=> (= (ControlFlow 0 216818) (- 0 294139)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 216818) (- 0 294151)) (not (not (let (($range_0 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@37) _$t0)))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@38) _$t0)))
 :qid |DiemSystembpl.6921:125|
 :skolemid |191|
))))) (and (=> (= (ControlFlow 0 216818) (- 0 294162)) (let (($range_0@@1 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@2 173345816))
...
(exists (($i_1@@1 Int) ) (!  (and (and (>= $i_1@@1 0) (< $i_1@@1 (seq.len $range_0@@1))) (let ((info (seq.nth $range_0@@1 $i_1@@1)))
 (and (= (|$addr#$1_DiemSystem_ValidatorInfo| info) _$t0) (= $t18@0 (|$config#$1_DiemSystem_ValidatorInfo| info)))))
 :qid |DiemSystembpl.8553:176|
 :skolemid |249|
...
(exists (($i_1@@2 Int) ) (!  (and (and (>= $i_1@@2 0) (< $i_1@@2 (seq.len $range_0@@2))) (let ((info@@0 (seq.nth $range_0@@2 $i_1@@2)))
 (and (= (|$addr#$1_DiemSystem_ValidatorInfo| info@@0) _$t0) (= $t18@0 (|$config#$1_DiemSystem_ValidatorInfo| info@@0)))))
 :qid |DiemSystembpl.8553:176|
 :skolemid |249|
))) (=> (= (ControlFlow 0 216818) (- 0 294208)) (= (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@4 173345816))
...
(let ((L3_correct  (and (=> (= (ControlFlow 0 216538) (- 0 294067)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (not (let (($range_0@@3 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@6 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@6))))))
(exists (($i_1@@3 Int) ) (!  (and (and (>= $i_1@@3 0) (< $i_1@@3 (seq.len $range_0@@3))) (let ((v@@39 (seq.nth $range_0@@3 $i_1@@3)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@39) _$t0)))
 :qid |DiemSystembpl.6921:125|
 :skolemid |191|
)))))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (not (let (($range_0@@4 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@7 173345816))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@40) _$t0)))
 :qid |DiemSystembpl.6921:125|
 :skolemid |191|
))))) (=> (= (ControlFlow 0 216538) (- 0 294082)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t7@0)) (and (not (let (($range_0@@5 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@8 173345816))
...
(exists (($i_1@@5 Int) ) (!  (and (and (>= $i_1@@5 0) (< $i_1@@5 (seq.len $range_0@@5))) (let ((v@@41 (seq.nth $range_0@@5 $i_1@@5)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@41) _$t0)))
 :qid |DiemSystembpl.6921:125|
 :skolemid |191|
)))) (= 7 $t7@0))))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 216832) 216538))) L3_correct)))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@0|)) (and (=> (= (ControlFlow 0 216707) 216832) anon14_Then_correct) (=> (= (ControlFlow 0 216707) 216818) anon14_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|  (=> (and (not (and (>= $t15 0) (< $t15 (seq.len $t14@0)))) (= (ControlFlow 0 216705) 216707)) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|  (=> (and (>= $t15 0) (< $t15 (seq.len $t14@0))) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1| (seq.nth $t14@0 $t15)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1|))) (and (=> (= (ControlFlow 0 216655) 216832) anon14_Then_correct) (=> (= (ControlFlow 0 216655) 216818) anon14_Else_correct))))))
(let ((anon13_Else_correct  (=> (not $t16) (=> (and (|$IsValid'u64'| $t15) (= $t15 (seq.nth (|$vec#$1_Option_Option'u64'| $t10) 0))) (and (=> (= (ControlFlow 0 216713) 216705) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 216713) 216655) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|))))))
(let ((anon13_Then_correct  (=> $t16 (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'u64'| $t10)) 0) (= 7 $t7)) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 216856) 216538))) L3_correct))))
(let ((anon12_Then_correct  (=> $t11 (=> (and (= $t14@0 (|$validators#$1_DiemSystem_DiemSystem| $t5)) (= $t16 (= (seq.len (|$vec#$1_Option_Option'u64'| $t10)) 0))) (and (=> (= (ControlFlow 0 216554) 216856) anon13_Then_correct) (=> (= (ControlFlow 0 216554) 216713) anon13_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (and (not $t11) (= $t13 $t13)) (and (= $t7@0 $t13) (= (ControlFlow 0 216478) 216538))) L3_correct)))
(let ((anon11_Else_correct  (=> (not $t6) (=> (and (|$IsValid'$1_DiemSystem_DiemSystem'| $t5) (let (($range_0@@6 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| $t5)))))
(let (($range_1 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| $t5)))))
(forall (($i_2 Int) ($i_3 Int) ) (!  (=> ($InRange $range_0@@6 $i_2) (=> ($InRange $range_1 $i_3) (let ((i@@43 $i_2))
(let ((j@@10 $i_3))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| $t5) i@@43)) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| $t5) j@@10))) (= i@@43 j@@10))))))
 :qid |DiemSystembpl.8384:222|
 :skolemid |246|
))))) (=> (and (and (and (and (= $t5 (let ((addr@@9 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@9)))) (= $t5 $t5)) (and (= $t8@0 (|$validators#$1_DiemSystem_DiemSystem| $t5)) (= $t9 (seq.len $t8@0)))) (and (and (|$IsValid'$1_Option_Option'u64''| $t10) (<= (seq.len (|$vec#$1_Option_Option'u64'| $t10)) 1)) (=> (let (($range_0@@7 ($Range 0 $t9)))
(forall (($i_1@@6 Int) ) (!  (=> ($InRange $range_0@@7 $i_1@@6) (let ((i@@44 $i_1@@6))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t8@0 i@@44)) _$t0))))
 :qid |DiemSystembpl.8414:54|
 :skolemid |247|
))) (= (seq.len (|$vec#$1_Option_Option'u64'| $t10)) 0)))) (and (and (and (=> (let (($range_0@@8 ($Range 0 $t9)))
(exists (($i_1@@7 Int) ) (!  (and ($InRange $range_0@@8 $i_1@@7) (let ((i@@45 $i_1@@7))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t8@0 i@@45)) _$t0)))
 :qid |DiemSystembpl.8418:54|
 :skolemid |248|
))) (and (not (= (seq.len (|$vec#$1_Option_Option'u64'| $t10)) 0)) (let ((at (seq.nth (|$vec#$1_Option_Option'u64'| $t10) 0)))
 (and (and (<= 0 at) (< at $t9)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t8@0 at)) _$t0))))) (= $t10 $t10)) (and (= $t11  (not (= (seq.len (|$vec#$1_Option_Option'u64'| $t10)) 0))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t13) (= $t13 7)) (and (= $t13 $t13) (= $t11 $t11))))) (and (=> (= (ControlFlow 0 216462) 216554) anon12_Then_correct) (=> (= (ControlFlow 0 216462) 216478) anon12_Else_correct)))))))
(let ((anon11_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t7)) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 216884) 216538))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (and (and (and (and (and (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address) (= config_address 173345816)))
 ...
 :qid |DiemSystembpl.8322:969|
 :skolemid |241|
))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115855| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_117374| $1_DiemSystem_CapabilityHolder_$memory) 173345816)))) (and (let (($range_0@@9 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@10 173345816))
...
(forall (($i_1@@8 Int) ) (!  (=> ($InRange $range_0@@9 $i_1@@8) (let ((i1 $i_1@@8))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_117755| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@11 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@11)))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_117755| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@11 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@11)))) i1)))) 3))))
 :qid |DiemSystembpl.8330:151|
 :skolemid |242|
))) (let (($range_0@@10 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@12 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13)))) i1@@0)) 1)))
 :qid |DiemSystembpl.8335:151|
 :skolemid |243|
))))) (and (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0)))
...
(forall (($i_3@@0 Int) ($i_4 Int) ) (!  (=> ($InRange $range_1@@0 $i_3@@0) (=> ($InRange $range_2 $i_4) (let ((i@@46 $i_3@@0))
(let ((j@@11 $i_4))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc)) i@@46)) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc)) j@@11))) (= i@@46 j@@11))))))
 :qid |DiemSystembpl.8344:367|
 :skolemid |244|
))))))
 :qid |DiemSystembpl.8343:20|
 :skolemid |245|
...
))) (and (= _$t0 _$t0) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 216153) 216884) anon11_Then_correct) (=> (= (ControlFlow 0 216153) 216462) anon11_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_86040_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_86040| stream@@0) 0) (forall ((v@@42 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_86040| stream@@0) v@@42) 0)
 :qid |DiemSystembpl.134:13|
 :skolemid |2|
))))
 :qid |DiemSystembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 215773) 216153)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 293107) 215773) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
