...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_89261_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@0))))))
 ...
 :qid |DesignatedDealerbpl.2961:13|
 :skolemid |106|
))))) (and (=> (= (ControlFlow 0 239382) (- 0 320957)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t12)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_89261_| (|streams#$EventStore| (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_89261_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
(let ((expected@@2 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t12)) (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_89261_| (|streams#$EventStore| (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_89261_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_89261_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@3)))))))
 ...
 :qid |DesignatedDealerbpl.2961:13|
 :skolemid |106|
))))) (=> (= (ControlFlow 0 239382) (- 0 320994)) (let ((actual@@3 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected@@3 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t12)) (let ((stream@@6 (|Select__T@[$1_Event_EventHandle]Multiset_89261_| (|streams#$EventStore| (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_89261_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
(let ((|inline$$1_Diem_mint'$1_XUS_XUS'$0$L3_correct|  (=> (= $abort_code@5 |inline$$1_Diem_mint'$1_XUS_XUS'$0$$t10@1|) (=> (and (and (= $es@2 $es@0) (= $abort_flag@4 true)) (and (= |inline$$1_Diem_mint'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_mint'$1_XUS_XUS'$0$$ret0@0|) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@3| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|))) (and (=> (= (ControlFlow 0 238690) 239396) anon40_Then_correct) (=> (= (ControlFlow 0 238690) 239382) anon40_Else_correct))))))
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_89261_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DesignatedDealer_ReceivedMintEvent'$0$handle@1| stream_new@@8)))))) (and (=> (= (ControlFlow 0 237883) 239410) anon39_Then_correct) (=> (= (ControlFlow 0 237883) 239078) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (not $t33) (=> (and (and (|$IsValid'vec'u8''| $t32) (|$IsEqual'vec'u8''| $t32 (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_136513| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (= $t34@0 ($1_DesignatedDealer_ReceivedMintEvent $t32 _$t2 _$t1)) (= (ControlFlow 0 237889) 237883))) |inline$$1_Event_emit_event'$1_DesignatedDealer_ReceivedMintEvent'$0$anon0_correct|))))
(let ((anon38_Then_correct  (=> $t33 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_136513| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t17)) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 239436) 237644))) L8_correct))))
...
(Vec_22116 (|Store__T@[Int]Int_| (|v#Vec_22116| (|p#$Mutation_185301| $t30@1)) l 0) (+ l 1))) (|$mint_event_handle#$1_DesignatedDealer_Dealer| (|v#$Mutation_185301| $t30@1)))) (= $t33  (not (|Select__T@[Int]Bool_| (|domain#$Memory_136513| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 237784) 239436) anon38_Then_correct) (=> (= (ControlFlow 0 237784) 237889) anon38_Else_correct))))))
(let ((anon37_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 239450) 237644))) L8_correct)))
(let ((anon36_Then$1_correct  (=> (= $t30@1 $t30) (=> (and (= $abort_flag@2 true) (= $abort_code@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 239502) 239450) anon37_Then_correct) (=> (= (ControlFlow 0 239502) 237784) anon37_Else_correct))))))
(let ((anon36_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161495| $1_DesignatedDealer_Dealer_$memory) _$t2)) (= (ControlFlow 0 239500) 239502)) anon36_Then$1_correct)))
(let ((anon36_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161495| $1_DesignatedDealer_Dealer_$memory) _$t2) (=> (and (and (= $t30@0 ($Mutation_185301 ($Global _$t2) (Vec_22116 (MapConstVec_13534 DefaultVecElem_13534) 0) (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_161495| $1_DesignatedDealer_Dealer_$memory) _$t2))) (= $t30@1 $t30@0)) (and (= $abort_flag@2 $abort_flag@1) (= $abort_code@3 $abort_code@2))) (and (=> (= (ControlFlow 0 237752) 239450) anon37_Then_correct) (=> (= (ControlFlow 0 237752) 237784) anon37_Else_correct))))))
(let ((L6_correct  (and (=> (= (ControlFlow 0 237730) (- 0 319616)) (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies _$t2)) (=> (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies _$t2) (and (=> (= (ControlFlow 0 237730) 239500) anon36_Then_correct) (=> (= (ControlFlow 0 237730) 237752) anon36_Else_correct))))))
(let ((anon35_Else_correct  (=> (and (and (and (not $abort_flag@0) (= $t27@0 (|$window_start#$1_DesignatedDealer_TierInfo'$1_XUS_XUS'| $t26))) (and (= $t28@0 (|$window_inflow#$1_DesignatedDealer_TierInfo'$1_XUS_XUS'| $t26)) (= $t29@0 (|$tiers#$1_DesignatedDealer_TierInfo'$1_XUS_XUS'| $t26)))) (and (and (= $abort_flag@1 $abort_flag@0) (= |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory@2| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory@1|)) (and (= $abort_code@2 $abort_code@1) (= (ControlFlow 0 239554) 237730)))) L6_correct)))
(let ((anon34_Then$1_correct  (=> (= |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory@1| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 239620) 239568) anon35_Then_correct) (=> (= (ControlFlow 0 239620) 239554) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161851| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory|) _$t2)) (= (ControlFlow 0 239618) 239620)) anon34_Then$1_correct)))
(let ((anon34_Else_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_161851| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory|) _$t2) (= $t26@0 (|Select__T@[Int]$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_| (|contents#$Memory_161851| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory|) _$t2))) (=> (and (and (= |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory@0| ($Memory_161851 (|Store__T@[Int]Bool_| (|domain#$Memory_161851| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory|) _$t2 false) (|contents#$Memory_161851| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory|))) (= |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory@1| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 239532) 239568) anon35_Then_correct) (=> (= (ControlFlow 0 239532) 239554) anon35_Else_correct))))))
(let ((anon33_Then_correct  (=> $t25@0 (and (=> (= (ControlFlow 0 239512) (- 0 319461)) (|Select__T@[Int]Bool_| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$modifies| _$t2)) (=> (|Select__T@[Int]Bool_| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$modifies| _$t2) (and (=> (= (ControlFlow 0 239512) 239618) anon34_Then_correct) (=> (= (ControlFlow 0 239512) 239532) anon34_Else_correct)))))))
(let ((anon33_Else_correct  (=> (not $t25@0) (=> (and (and (= $abort_flag@1 false) (= |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory@2| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory|)) (and (= $abort_code@2 $abort_code@0) (= (ControlFlow 0 237722) 237730))) L6_correct))))
(let ((anon32_Then_correct  (=> (and $t22 (= $t25@0 (|Select__T@[Int]Bool_| (|domain#$Memory_161851| |$1_DesignatedDealer_TierInfo'$1_XUS_XUS'_$memory|) _$t2))) (and (=> (= (ControlFlow 0 237716) 239512) anon33_Then_correct) (=> (= (ControlFlow 0 237716) 237722) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (and (not $t22) (= $t24 $t24)) (and (= $t17@0 $t24) (= (ControlFlow 0 237706) 237644))) L8_correct)))
(let ((anon31_Then_correct  (=> inline$$Gt$0$dst@1 (=> (and (= $t22 (|Select__T@[Int]Bool_| (|domain#$Memory_161495| $1_DesignatedDealer_Dealer_$memory) _$t2)) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t24) (= $t24 5)) (and (= $t24 $t24) (= $t22 $t22))) (and (=> (= (ControlFlow 0 237690) 237716) anon32_Then_correct) (=> (= (ControlFlow 0 237690) 237706) anon32_Else_correct)))))))
(let ((anon31_Else_correct  (=> (and (and (not inline$$Gt$0$dst@1) (= $t21 $t21)) (and (= $t17@0 $t21) (= (ControlFlow 0 237364) 237644))) L8_correct)))
(let ((anon30_Else$1_correct  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| $t21) (= $t21 7)) (and (= $t21 $t21) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 237348) 237690) anon31_Then_correct) (=> (= (ControlFlow 0 237348) 237364) anon31_Else_correct))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> _$t1 0)) (= (ControlFlow 0 237312) 237348)) anon30_Else$1_correct)))
(let ((anon30_Else_correct  (=> (not $t16) (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 237318) 237312)) inline$$Gt$0$anon0_correct))))
(let ((anon30_Then_correct  (=> $t16 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_128959| $1_Roles_RoleId_$memory) $t15)) (= 5 $t17)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_128959| $1_Roles_RoleId_$memory) $t15)) 1)) (= 3 $t17))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t17))) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 239692) 237644))) L8_correct))))
(let ((anon0$1_correct  (=> (and (and (and (and (forall ((mint_cap_owner Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142775| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner) (and (|Select__T@[Int]Bool_| (|domain#$Memory_128959| $1_Roles_RoleId_$memory) mint_cap_owner) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_128959| $1_Roles_RoleId_$memory) mint_cap_owner)) 1))))
 ...
 :skolemid |424|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_128465| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_136513| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$IsValid'address'| (|$addr#$signer| _$t0)))) (and (and (and (|$IsValid'u64'| _$t1) (|$IsValid'address'| _$t2)) (and (|$IsValid'u64'| _$t3) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_128959| $1_Roles_RoleId_$memory) $a_0)))
...
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Diem_MintCapability'$1_XUS_XUS'_| (|contents#$Memory_142775| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) $a_0@@1)))
(|$IsValid'$1_Diem_MintCapability'$1_XUS_XUS''| $rsc@@1))
 :qid |DesignatedDealerbpl.15273:20|
 :skolemid |427|
 :pattern ( (|Select__T@[Int]$1_Diem_MintCapability'$1_XUS_XUS'_| (|contents#$Memory_142775| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) $a_0@@1))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@6 T@$1_Event_EventHandle) ) (! (let ((stream@@10 (|Select__T@[$1_Event_EventHandle]Multiset_89261_| (|streams#$EventStore| $es) handle@@6)))
 ...
 :qid |DesignatedDealerbpl.2945:13|
 :skolemid |105|
))) (= (ControlFlow 0 236530) 237258)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_22116| (|p#$Mutation_185301| $t30)) 0) (=> (and (= (|l#Vec_22116| (|p#$Mutation_121668| $t31)) 0) (= (ControlFlow 0 236540) 236530)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 318329) 236540) anon0_correct)))
