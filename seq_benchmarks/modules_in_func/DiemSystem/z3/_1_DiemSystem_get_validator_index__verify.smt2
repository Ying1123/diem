...
(declare-fun _$t0 () (Seq T@$1_DiemSystem_ValidatorInfo))
...
(let ((anon22_Then_correct  (=> $abort_flag@1 (=> (and (= $abort_code@2 $abort_code@2) (= (ControlFlow 0 218008) 218018)) L9_correct))))
(let ((anon20_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 218084) 218018)) L9_correct))))
(let ((anon22_Else_correct  (=> (and (not $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 217994) (- 0 295088)) (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (=> (= (ControlFlow 0 217994) (- 0 295095)) (let (($range_0 ($Range 0 inline$$AddU64$0$dst@2)))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((j@@10 $i_1))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@10)) _$t1))))
 :qid |DiemSystembpl.8869:49|
 :skolemid |253|
)))))))))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 217925) 218008) anon22_Then_correct) (=> (= (ControlFlow 0 217925) 217994) anon22_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t8@0 1) $MAX_U64) (= (ControlFlow 0 217923) 217925)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t8@0 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t8@0 1)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 217871) 218008) anon22_Then_correct) (=> (= (ControlFlow 0 217871) 217994) anon22_Else_correct))))))
(let ((anon21_Else_correct  (=> (and (not $t12@1) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 217931) 217923) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 217931) 217871) inline$$AddU64$0$anon3_Else_correct)))))
(let ((L8_correct  (and (=> (= (ControlFlow 0 217595) (- 0 294846)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 217595) (- 0 294853)) (=> (let (($range_0@@0 ($Range 0 $t5)))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@43 $i_1@@0))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 i@@43)) _$t1))))
 :qid |DiemSystembpl.8888:49|
 :skolemid |254|
))) (= (seq.len (|$vec#$1_Option_Option'u64'| $t16@0)) 0))) (=> (=> (let (($range_0@@1 ($Range 0 $t5)))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@44 $i_1@@1))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 i@@44)) _$t1))))
 :qid |DiemSystembpl.8888:49|
 :skolemid |254|
))) (= (seq.len (|$vec#$1_Option_Option'u64'| $t16@0)) 0)) (and (=> (= (ControlFlow 0 217595) (- 0 294896)) (=> (let (($range_0@@2 ($Range 0 $t5)))
(exists (($i_1@@2 Int) ) (!  (and ($InRange $range_0@@2 $i_1@@2) (let ((i@@45 $i_1@@2))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 i@@45)) _$t1)))
 :qid |DiemSystembpl.8894:49|
 :skolemid |255|
))) (and (not (= (seq.len (|$vec#$1_Option_Option'u64'| $t16@0)) 0)) (let ((at (seq.nth (|$vec#$1_Option_Option'u64'| $t16@0) 0)))
 (and (and (<= 0 at) (< at $t5)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 at)) _$t1)))))) (=> (=> (let (($range_0@@3 ($Range 0 $t5)))
(exists (($i_1@@3 Int) ) (!  (and ($InRange $range_0@@3 $i_1@@3) (let ((i@@46 $i_1@@3))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 i@@46)) _$t1)))
 :qid |DiemSystembpl.8894:49|
 :skolemid |255|
))) (and (not (= (seq.len (|$vec#$1_Option_Option'u64'| $t16@0)) 0)) (let ((at@@0 (seq.nth (|$vec#$1_Option_Option'u64'| $t16@0) 0)))
 (and (and (<= 0 at@@0) (< at@@0 $t5)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 at@@0)) _$t1))))) (=> (= (ControlFlow 0 217595) (- 0 294970)) (= (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@0)))) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_117301| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@1))))))))))))))
(let ((anon21_Then_correct  (=> $t12@1 (and (=> (= (ControlFlow 0 218070) (- 0 294789)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 $t8@0)) _$t1)) (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 $t8@0)) _$t1) (=> (and (|$IsValid'$1_Option_Option'u64''| $t15) (<= (seq.len (|$vec#$1_Option_Option'u64'| $t15)) 1)) (=> (and (and (= $t15 (|$1_Option_Option'u64'| (seq.unit $t8@0))) (= $t15 $t15)) (and (= $t16@0 $t15) (= (ControlFlow 0 218070) 217595))) L8_correct)))))))
(let ((anon20_Else_correct  (=> (and (and (not $abort_flag@0) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (and (= $t11@1 (|$addr#$1_DiemSystem_ValidatorInfo| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (= $t12@1 (= $t11@1 _$t1)))) (and (=> (= (ControlFlow 0 217766) 218070) anon21_Then_correct) (=> (= (ControlFlow 0 217766) 217931) anon21_Else_correct)))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@0|)) (and (=> (= (ControlFlow 0 217734) 218084) anon20_Then_correct) (=> (= (ControlFlow 0 217734) 217766) anon20_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|  (=> (and (not (and (>= $t8@0 0) (< $t8@0 (seq.len _$t0)))) (= (ControlFlow 0 217732) 217734)) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|  (=> (and (>= $t8@0 0) (< $t8@0 (seq.len _$t0))) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1| (seq.nth _$t0 $t8@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1|))) (and (=> (= (ControlFlow 0 217682) 218084) anon20_Then_correct) (=> (= (ControlFlow 0 217682) 217766) anon20_Else_correct))))))
(let ((anon19_Then_correct  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 217740) 217732) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 217740) 217682) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|)))))
(let ((anon19_Else_correct  (=> (not inline$$Lt$0$dst@1) (and (=> (= (ControlFlow 0 217449) (- 0 294598)) (= $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (= $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (and (=> (= (ControlFlow 0 217449) (- 0 294605)) (let (($range_0@@4 ($Range 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((j@@11 $i_1@@4))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@11)) _$t1))))
 :qid |DiemSystembpl.8830:48|
 :skolemid |252|
)))) (=> (let (($range_0@@5 ($Range 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((j@@12 $i_1@@5))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@12)) _$t1))))
 :qid |DiemSystembpl.8830:48|
 :skolemid |252|
))) (=> (and (|$IsValid'$1_Option_Option'u64''| $t17) (<= (seq.len (|$vec#$1_Option_Option'u64'| $t17)) 1)) (=> (and (and (= $t17 (|$1_Option_Option'u64'| (as seq.empty (Seq Int)))) (= $t17 $t17)) (and (= $t16@0 $t17) (= (ControlFlow 0 217449) 217595))) L8_correct)))))))))
...
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (= (ControlFlow 0 217354) 217364)) anon18_Else$1_correct)))
(let ((anon18_Else_correct  (=> (and (and (not false) (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (and (|$IsValid'u64'| 0) (= 0 0))) (and (=> (= (ControlFlow 0 217360) (- 0 294436)) (<= 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (<= 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (and (=> (= (ControlFlow 0 217360) (- 0 294443)) (let (($range_0@@6 ($Range 0 0)))
(forall (($i_1@@6 Int) ) (!  (=> ($InRange $range_0@@6 $i_1@@6) (let ((j@@13 $i_1@@6))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@13)) _$t1))))
 :qid |DiemSystembpl.8674:48|
 :skolemid |250|
)))) (=> (let (($range_0@@7 ($Range 0 0)))
(forall (($i_1@@7 Int) ) (!  (=> ($InRange $range_0@@7 $i_1@@7) (let ((j@@14 $i_1@@7))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@14)) _$t1))))
 :qid |DiemSystembpl.8674:48|
 :skolemid |250|
...
(forall (($i_1@@8 Int) ) (!  (=> ($InRange $range_0@@8 $i_1@@8) (let ((j@@15 $i_1@@8))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@15)) _$t1))))
 :qid |DiemSystembpl.8714:53|
 :skolemid |251|
))) (= (ControlFlow 0 217360) 217354)))) inline$$Lt$0$anon0_correct)))))))))
(let ((anon18_Then_correct true))
(let ((|inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| (seq.len _$t0)) (and (=> (= (ControlFlow 0 217150) 218098) anon18_Then_correct) (=> (= (ControlFlow 0 217150) 217360) anon18_Else_correct)))))
(let ((anon0$1_correct  (=> (and (|$IsValid'vec'$1_DiemSystem_ValidatorInfo''| _$t0) (|$IsValid'address'| _$t1)) (=> (and (and (= $t5 (seq.len _$t0)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= (ControlFlow 0 217156) 217150))) |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_86040_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemSystembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 217070) 217156)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 294230) 217070) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))
))
(check-sat)
