...
(assert (not
 ...
 :qid |DiemAccountbpl.49930:415|
 :skolemid |1614|
))) (|$IsValid'address'| _$t0)) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_468892| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $a_0)))
(|$IsValid'$1_DiemAccount_Balance'$1_XUS_XUS''| $rsc))
 :qid |DiemAccountbpl.49936:20|
 :skolemid |1615|
...
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_468892| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) _$t0)) (= $t1@0 $t1@0)))) (and (=> (= (ControlFlow 0 1283316) (- 0 2039214)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4)))))
 :qid |DiemAccountbpl.49962:15|
 :skolemid |1616|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1283066) 1283316)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2039010) 1283066) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
