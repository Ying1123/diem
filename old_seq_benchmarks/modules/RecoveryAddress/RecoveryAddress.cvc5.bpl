...
// fun Vector::singleton<DiemAccount::KeyRotationCapability> [baseline] at /home/ying/diem/language/move-stdlib/modules/Vector.move:48:5+131
procedure {:inline 1} $1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'(_$t0: $1_DiemAccount_KeyRotationCapability) returns ($ret0: Vec ($1_DiemAccount_KeyRotationCapability))
{
    ...
    // bytecode translation starts here
    // trace_local[e]($t0) at /home/ying/diem/language/move-stdlib/modules/Vector.move:48:5+1
    assume {:print "$at(46,2077,2078)"} true;
    assume {:print "$track_local(8,13,0):", $t0} $t0 == $t0;

    // $t1 := Vector::empty<#0>() on_abort goto L2 with $t2 at /home/ying/diem/language/move-stdlib/modules/Vector.move:49:17+7
    assume {:print "$at(46,2154,2161)"} true;
    call $t1 := $1_Vector_empty'$1_DiemAccount_KeyRotationCapability'();
    if ($abort_flag) {
        assume {:print "$at(46,2154,2161)"} true;
        $t2 := $abort_code;
        assume {:print "$track_abort(8,13):", $t2} $t2 == $t2;
        goto L2;
    }

    // trace_local[v]($t1) at /home/ying/diem/language/move-stdlib/modules/Vector.move:49:13+1
    assume {:print "$track_local(8,13,1):", $t1} $t1 == $t1;

    // $t3 := borrow_local($t1) at /home/ying/diem/language/move-stdlib/modules/Vector.move:50:19+6
    assume {:print "$at(46,2181,2187)"} true;
    $t3 := $Mutation($Local(1), EmptyVec(), $t1);

    // Vector::push_back<#0>($t3, $t0) on_abort goto L2 with $t2 at /home/ying/diem/language/move-stdlib/modules/Vector.move:50:9+20
    call $t3 := $1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'($t3, $t0);
    if ($abort_flag) {
        assume {:print "$at(46,2171,2191)"} true;
        $t2 := $abort_code;
        assume {:print "$track_abort(8,13):", $t2} $t2 == $t2;
        goto L2;
    }

    // write_back[LocalRoot($t1)@]($t3) at /home/ying/diem/language/move-stdlib/modules/Vector.move:50:9+20
    $t1 := $Dereference($t3);

    // $t4 := move($t1) at /home/ying/diem/language/move-stdlib/modules/Vector.move:51:9+1
    assume {:print "$at(46,2201,2202)"} true;
    $t4 := $t1;

    // trace_return[0]($t4) at /home/ying/diem/language/move-stdlib/modules/Vector.move:51:9+1
    assume {:print "$track_return(8,13,0):", $t4} $t4 == $t4;

    // label L1 at /home/ying/diem/language/move-stdlib/modules/Vector.move:52:5+1
    assume {:print "$at(46,2207,2208)"} true;
L1:

    // return $t4 at /home/ying/diem/language/move-stdlib/modules/Vector.move:52:5+1
    $ret0 := $t4;
    return;

    // label L2 at /home/ying/diem/language/move-stdlib/modules/Vector.move:52:5+1
L2:

    // abort($t2) at /home/ying/diem/language/move-stdlib/modules/Vector.move:52:5+1
    $abort_code := $t2;
    $abort_flag := true;
    return;
...
L7:
    ...
    // @193 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@193](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
L6:
    ...
    // @165 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@165](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
procedure {:timeLimit 40} $1_VASP_publish_child_vasp_credential$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume true at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+896
    ...
    // @119 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+1
    assume {:print "$at(33,3032,3033)"} true;
    $1_Roles_RoleId_$memory#119 := $1_Roles_RoleId_$memory;

    // @117 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+1
    $1_VASP_ChildVASP_$memory#117 := $1_VASP_ChildVASP_$memory;

    // @118 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+1
...
L4:
    ...
    // assume forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+896
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:237:9+163
    assume {:print "$at(33,3032,3928)"} true;
    ...
    // assert forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:237:9+163
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:237:9+163
    assume {:print "$at(24,10891,11054)"} true;
    assert {:msg "assert_failed(24,10891,11054): global memory invariant does not hold"}
    ...
    // assume forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:237:9+163
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:237:9+163
    assume {:print "$at(24,10891,11054)"} true;
    assume (forall recovery_addr: int :: $IsValid'address'(recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr))  ==> ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, recovery_addr)));
...
L6:
    ...
    // assert Not(VASP::$is_vasp[@117, @118]($t11)) at /home/ying/diem/language/diem-framework/modules/VASP.move:101:9+61
    ...
    // assert Not(Not(VASP::$is_parent[@118]($t12))) at /home/ying/diem/language/diem-framework/modules/VASP.move:102:9+64
    ...
    // assert Not(Gt(Add(VASP::spec_num_children[@118]($t12), 1), 65536)) at /home/ying/diem/language/diem-framework/modules/VASP.move:103:9+94
    ...
    // assert Not(Not(exists[@119]<Roles::RoleId>($t13))) at /home/ying/diem/language/diem-framework/modules/Roles.move:543:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@119]<Roles::RoleId>($t13)), 5)) at /home/ying/diem/language/diem-framework/modules/Roles.move:544:9+89
    ...
    // assert Not(Not(exists[@119]<Roles::RoleId>($t11))) at /home/ying/diem/language/diem-framework/modules/Roles.move:549:9+62
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@119]<Roles::RoleId>($t11)), 6)) at /home/ying/diem/language/diem-framework/modules/Roles.move:550:9+91
    ...
    // assert Eq<u64>(VASP::spec_num_children(Signer::spec_address_of($t0)), Add(VASP::spec_num_children[@118](Signer::spec_address_of[]($t0)), 1)) at /home/ying/diem/language/diem-framework/modules/VASP.move:109:9+82
...
procedure {:timeLimit 40} $1_VASP_publish_parent_vasp_credential$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // assume true at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:552:9+318
    assume true;
    ...
    // @139 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+1
    ...
    // @140 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+1
    $1_Roles_RoleId_$memory#140 := $1_Roles_RoleId_$memory;

    // @141 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+1
    $1_VASP_ChildVASP_$memory#141 := $1_VASP_ChildVASP_$memory;

    // @142 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+1
...
L0:
    ...
    // assume forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:237:9+163
    assume {:print "$at(33,1911,2332)"} true;
    assume (forall recovery_addr: int :: $IsValid'address'(recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr))  ==> ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, recovery_addr)));
...
L2:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@139]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    ...
    // assert Not(Not(exists[@140]<Roles::RoleId>($t6))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t6)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    ...
    // assert Not(Not(exists[@140]<Roles::RoleId>($t7))) at /home/ying/diem/language/diem-framework/modules/Roles.move:543:9+59
    assume {:print "$at(26,24362,24421)"} true;
    assert {:msg "assert_failed(26,24362,24421): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#140, $t7);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t7)), 5)) at /home/ying/diem/language/diem-framework/modules/Roles.move:544:9+89
    assume {:print "$at(26,24430,24519)"} true;
    assert {:msg "assert_failed(26,24430,24519): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#140, $t7)), 5);

    // assert Not(VASP::$is_vasp[@141, @142]($t5)) at /home/ying/diem/language/diem-framework/modules/VASP.move:59:9+60
    ...
    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@141]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:254:9+78
    ...
    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@142](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@142](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_operating[@139]()), Not(exists[@140]<Roles::RoleId>($t6))), Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t6)), 1)), Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), Not(exists[@140]<Roles::RoleId>($t7))), Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t7)), 5)), VASP::$is_vasp[@141, @142]($t5)) at /home/ying/diem/language/diem-framework/modules/VASP.move:54:5+420
    assume {:print "$at(33,2338,2758)"} true;
    assert {:msg "assert_failed(33,2338,2758): abort not covered by any of the `aborts_if` clauses"}
      ((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139) || !$ResourceExists($1_Roles_RoleId_$memory#140, $t6)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#140, $t6)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || !$ResourceExists($1_Roles_RoleId_$memory#140, $t7)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#140, $t7)), 5)) || $1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#141, $1_VASP_ParentVASP_$memory#142, $t5));

    // assert Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@139]()), Eq(1, $t9)), And(Not(exists[@140]<Roles::RoleId>($t6)), Eq(5, $t9))), And(Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t6)), 1), Eq(3, $t9))), And(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t9))), And(Not(exists[@140]<Roles::RoleId>($t7)), Eq(5, $t9))), And(Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t7)), 5), Eq(3, $t9))), And(VASP::$is_vasp[@141, @142]($t5), Eq(6, $t9))) at /home/ying/diem/language/diem-framework/modules/VASP.move:54:5+420
...
L7:
    ...
    // @183 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@183](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
// spec fun at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:1565:5+213
...
// spec fun at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:1590:5+118
...
L2:
    ...
    // trace_local[account#1818]($t17) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:957:13+7
...
// fun DiemAccount::key_rotation_capability_address [baseline] at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:1590:5+118
procedure {:inline 1} $1_DiemAccount_key_rotation_capability_address(_$t0: $1_DiemAccount_KeyRotationCapability) returns ($ret0: int)
{
    ...
    assume {:print "$at(11,73745,73746)"} true;
...
L1:
    ...
    // return $t1 at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:1592:5+1
    $ret0 := $t1;
    return;
...
// spec fun at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:246:9+111
...
// spec fun at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:252:9+197
...
// spec fun at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:260:9+325
...
// struct RecoveryAddress::RecoveryAddress at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:19:5+91
...
// fun RecoveryAddress::publish [verification] at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1012
procedure {:timeLimit 40} $1_RecoveryAddress_publish$verify(_$t0: int, _$t1: $1_DiemAccount_KeyRotationCapability) returns ()
{
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1012
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume {:print "$at(24,2256,3268)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1012
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1012
    assume $IsValid'$1_DiemAccount_KeyRotationCapability'($t1);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1012
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1012
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<RecoveryAddress::RecoveryAddress>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1012
    ...
    // assume Identical($t9, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:71:9+53
    assume {:print "$at(24,3480,3533)"} true;
    assume ($t9 == $1_Signer_spec_address_of($t0));

    // assume Identical($t10, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:80:9+53
    assume {:print "$at(24,3939,3992)"} true;
    assume ($t10 == $1_Signer_spec_address_of($t0));

    // @98 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1
    assume {:print "$at(24,2256,2257)"} true;
    $1_VASP_ChildVASP_$memory#98 := $1_VASP_ChildVASP_$memory;

    // @99 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1
    $1_VASP_ParentVASP_$memory#99 := $1_VASP_ParentVASP_$memory;

    // @100 := save_mem(RecoveryAddress::RecoveryAddress) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1
    $1_RecoveryAddress_RecoveryAddress_$memory#100 := $1_RecoveryAddress_RecoveryAddress_$memory;

    // trace_local[recovery_account]($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1
    assume {:print "$track_local(30,1,0):", $t0} $t0 == $t0;

    // trace_local[rotation_cap]($t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1
    assume {:print "$track_local(30,1,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:46:20+36
    // >> opaque call: $t9 := Signer::address_of($t0)
    assume {:print "$at(24,2360,2396)"} true;

    // $t11 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:46:20+36

    // assume WellFormed($t11) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:46:20+36
    assume $IsValid'address'($t11);

    // assume Eq<address>($t11, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:46:20+36
    assume $IsEqual'address'($t11, $1_Signer_spec_address_of($t0));

    // $t11 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:46:20+36

    // trace_local[addr]($t11) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:46:13+4
    assume {:print "$track_local(30,1,2):", $t11} $t11 == $t11;

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:16+19
    // >> opaque call: $t10 := VASP::is_vasp($t9)
    assume {:print "$at(24,2465,2484)"} true;

    // $t12 := opaque begin: VASP::is_vasp($t11) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:16+19

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:16+19
    assume $IsValid'bool'($t12);

    // assume Eq<bool>($t12, VASP::$is_vasp($t11)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:16+19
    assume $IsEqual'bool'($t12, $1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t11));

    // $t12 := opaque end: VASP::is_vasp($t11) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:16+19

    // $t13 := 0 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:62+11
    $t13 := 0;
    assume $IsValid'u64'($t13);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:37+37
    // >> opaque call: $t12 := Errors::invalid_argument($t11)

    // $t14 := opaque begin: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:37+37

    // assume WellFormed($t14) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:37+37
    assume $IsValid'u64'($t14);

    // assume Eq<u64>($t14, 7) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:37+37
    assume $IsEqual'u64'($t14, 7);

    // $t14 := opaque end: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:37+37

    // trace_local[tmp#$4]($t14) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:9+66
    assume {:print "$track_local(30,1,4):", $t14} $t14 == $t14;

    // trace_local[tmp#$3]($t12) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:9+66
    assume {:print "$track_local(30,1,3):", $t12} $t12 == $t12;

    // if ($t12) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:9+66
    if ($t12) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:9+66
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:9+66

    // trace_abort($t14) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:9+66
    assume {:print "$at(24,2458,2524)"} true;
    assume {:print "$track_abort(30,1):", $t14} $t14 == $t14;

    // $t15 := move($t14) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:9+66
    $t15 := $t14;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:48:9+66
    goto L7;

    // label L0 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:55:59+13
    assume {:print "$at(24,2928,2941)"} true;
L0:

    // $t16 := DiemAccount::key_rotation_capability_address($t1) on_abort goto L7 with $t15 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:55:14+59
    call $t16 := $1_DiemAccount_key_rotation_capability_address($t1);
    if ($abort_flag) {
        assume {:print "$at(24,2883,2942)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(30,1):", $t15} $t15 == $t15;
        goto L7;
    }

    // $t17 := ==($t16, $t11) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:55:74+2
    $t17 := $IsEqual'address'($t16, $t11);

    // $t18 := 1 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:56:39+30
    assume {:print "$at(24,2990,3020)"} true;
    $t18 := 1;
    assume $IsValid'u64'($t18);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:56:14+56
    // >> opaque call: $t16 := Errors::invalid_argument($t15)

    // $t19 := opaque begin: Errors::invalid_argument($t18) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:56:14+56

    // assume WellFormed($t19) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:56:14+56
    assume $IsValid'u64'($t19);

    // assume Eq<u64>($t19, 7) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:56:14+56
    assume $IsEqual'u64'($t19, 7);

    // $t19 := opaque end: Errors::invalid_argument($t18) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:56:14+56

    // trace_local[tmp#$6]($t19) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:54:9+169
    assume {:print "$at(24,2862,3031)"} true;
    assume {:print "$track_local(30,1,6):", $t19} $t19 == $t19;

    // trace_local[tmp#$5]($t17) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:54:9+169
    assume {:print "$track_local(30,1,5):", $t17} $t17 == $t17;

    // if ($t17) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:54:9+169
    if ($t17) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:54:9+169
L3:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:54:9+169

    // trace_abort($t19) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:54:9+169
    assume {:print "$at(24,2862,3031)"} true;
    assume {:print "$track_abort(30,1):", $t19} $t19 == $t19;

    // $t15 := move($t19) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:54:9+169
    $t15 := $t19;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:54:9+169
    goto L7;

    // label L2 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:41+4
    assume {:print "$at(24,3073,3077)"} true;
L2:

    // $t20 := exists<RecoveryAddress::RecoveryAddress>($t11) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:17+6
    $t20 := $ResourceExists($1_RecoveryAddress_RecoveryAddress_$memory, $t11);

    // $t21 := !($t20) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:16+1
    call $t21 := $Not($t20);

    // $t22 := 5 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:74+17
    $t22 := 5;
    assume $IsValid'u64'($t22);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:48+44
    // >> opaque call: $t20 := Errors::already_published($t19)

    // $t23 := opaque begin: Errors::already_published($t22) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:48+44

    // assume WellFormed($t23) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:48+44
    assume $IsValid'u64'($t23);

    // assume Eq<u64>($t23, 6) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:48+44
    assume $IsEqual'u64'($t23, 6);

    // $t23 := opaque end: Errors::already_published($t22) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:48+44

    // trace_local[tmp#$8]($t23) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:9+84
    assume {:print "$track_local(30,1,8):", $t23} $t23 == $t23;

    // trace_local[tmp#$7]($t21) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:9+84
    assume {:print "$track_local(30,1,7):", $t21} $t21 == $t21;

    // if ($t21) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:9+84
    if ($t21) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:9+84
L5:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:9+84

    // trace_abort($t23) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:9+84
    assume {:print "$at(24,3041,3125)"} true;
    assume {:print "$track_abort(30,1):", $t23} $t23 == $t23;

    // $t15 := move($t23) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:9+84
    $t15 := $t23;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:58:9+84
    goto L7;

    // label L4 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:60:13+16
    assume {:print "$at(24,3156,3172)"} true;
L4:

    // $t24 := Vector::singleton<DiemAccount::KeyRotationCapability>($t1) on_abort goto L7 with $t15 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:61:46+31
    assume {:print "$at(24,3219,3250)"} true;
    ...
    // $t25 := pack RecoveryAddress::RecoveryAddress($t24) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:61:13+66
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:202:9+234
    assume {:print "$at(24,2256,3268)"} true;
    ...
    // assume forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1012
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:237:9+163
    assume (forall recovery_addr: int :: $IsValid'address'(recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr))  ==> ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, recovery_addr)));

    // @245 := save_mem(RecoveryAddress::RecoveryAddress) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:45:5+1012
    ...
    // move_to<RecoveryAddress::RecoveryAddress>($t25, $t0) on_abort goto L7 with $t15 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:59:9+7
    assume {:print "$at(24,3135,3142)"} true;
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:202:9+234
    assume {:print "$at(24,9551,9785)"} true;
    assert {:msg "assert_failed(24,9551,9785): global memory invariant does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, addr1))  ==> (((LenVec($1_RecoveryAddress_spec_get_rotation_caps($1_RecoveryAddress_RecoveryAddress_$memory, addr1)) > 0) && $IsEqual'address'($account_address#$1_DiemAccount_KeyRotationCapability(ReadVec($1_RecoveryAddress_spec_get_rotation_caps($1_RecoveryAddress_RecoveryAddress_$memory, addr1), 0)), addr1))));

    // assert forall addr: TypeDomain<address>(): Implies(RecoveryAddress::spec_is_recovery_address[@245](addr), RecoveryAddress::spec_is_recovery_address(addr)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:211:9+136
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:211:9+136
    assume {:print "$at(24,9854,9990)"} true;
    assert {:msg "assert_failed(24,9854,9990): global memory invariant does not hold"}
    ...
    // assert forall addr: TypeDomain<address>() where exists[@245]<RecoveryAddress::RecoveryAddress>(addr): exists<RecoveryAddress::RecoveryAddress>(addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:220:9+122
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:220:9+122
    assume {:print "$at(24,10111,10233)"} true;
    assert {:msg "assert_failed(24,10111,10233): global memory invariant does not hold"}
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:225:9+321
    assume {:print "$at(24,10424,10745)"} true;
    assert {:msg "assert_failed(24,10424,10745): global memory invariant does not hold"}
    ...
    // label L6 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:63:5+1
    assume {:print "$at(24,3267,3268)"} true;
L6:

    // assert Not(Not(VASP::$is_vasp[@98, @99]($t9))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:72:9+61
    assume {:print "$at(24,3542,3603)"} true;
    assert {:msg "assert_failed(24,3542,3603): function does not abort under this condition"}
      !!$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#98, $1_VASP_ParentVASP_$memory#99, $t9);

    // assert Not(RecoveryAddress::spec_is_recovery_address[@100]($t9)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:73:9+72
    assume {:print "$at(24,3612,3684)"} true;
    assert {:msg "assert_failed(24,3612,3684): function does not abort under this condition"}
      !$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#100, $t9);

    // assert Not(Neq<address>(DiemAccount::$key_rotation_capability_address[]($t1), $t9)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:74:9+119
    assume {:print "$at(24,3693,3812)"} true;
    assert {:msg "assert_failed(24,3693,3812): function does not abort under this condition"}
      !!$IsEqual'address'($1_DiemAccount_$key_rotation_capability_address($t1), $t9);

    // assert RecoveryAddress::spec_is_recovery_address($t10) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:81:9+39
    assume {:print "$at(24,4001,4040)"} true;
    assert {:msg "assert_failed(24,4001,4040): post-condition does not hold"}
      $1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, $t10);

    // assert Eq<num>(Len<DiemAccount::KeyRotationCapability>(RecoveryAddress::spec_get_rotation_caps($t10)), 1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:82:9+47
    assume {:print "$at(24,4049,4096)"} true;
    assert {:msg "assert_failed(24,4049,4096): post-condition does not hold"}
      $IsEqual'num'(LenVec($1_RecoveryAddress_spec_get_rotation_caps($1_RecoveryAddress_RecoveryAddress_$memory, $t10)), 1);

    // assert Eq<DiemAccount::KeyRotationCapability>(Index(RecoveryAddress::spec_get_rotation_caps($t10), 0), $t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:83:9+56
    assume {:print "$at(24,4105,4161)"} true;
    assert {:msg "assert_failed(24,4105,4161): post-condition does not hold"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:83:9+56
    return;

    // label L7 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:63:5+1
    assume {:print "$at(24,3267,3268)"} true;
L7:

    // assert Or(Or(Not(VASP::$is_vasp[@98, @99]($t9)), RecoveryAddress::spec_is_recovery_address[@100]($t9)), Neq<address>(DiemAccount::$key_rotation_capability_address[]($t1), $t9)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:64:5+85
    assume {:print "$at(24,3273,3358)"} true;
    assert {:msg "assert_failed(24,3273,3358): abort not covered by any of the `aborts_if` clauses"}
    ...
    // assert Or(Or(And(Not(VASP::$is_vasp[@98, @99]($t9)), Eq(7, $t15)), And(RecoveryAddress::spec_is_recovery_address[@100]($t9), Eq(6, $t15))), And(Neq<address>(DiemAccount::$key_rotation_capability_address[]($t1), $t9), Eq(7, $t15))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:64:5+85
    assert {:msg "assert_failed(24,3273,3358): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t15) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:64:5+85
    $abort_code := $t15;
    $abort_flag := true;
    return;
...
// fun RecoveryAddress::rotate_authentication_key [verification] at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1642
procedure {:timeLimit 40} $1_RecoveryAddress_rotate_authentication_key$verify(_$t0: int, _$t1: int, _$t2: int, _$t3: Vec (int)) returns ()
{
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): Or(DiemAccount::$delegated_key_rotation_capability(addr), DiemAccount::spec_holds_own_key_rotation_cap(addr)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1642
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2205:9+147
    assume {:print "$at(24,4407,6049)"} true;
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): Or(DiemAccount::spec_holds_delegated_withdraw_capability(addr), DiemAccount::spec_holds_own_withdraw_cap(addr)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1642
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<Roles::RoleId>(addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1642
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1642
    ...
    // assume true at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1642
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2332:9+115
    assume true;

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1642
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1642
    assume $IsValid'address'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1642
    assume $IsValid'address'($t2);

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1642
    ...
    // assume forall $rsc: ResourceDomain<RecoveryAddress::RecoveryAddress>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1642
    assume (forall $a_0: int :: {$ResourceValue($1_RecoveryAddress_RecoveryAddress_$memory, $a_0)}(var $rsc := $ResourceValue($1_RecoveryAddress_RecoveryAddress_$memory, $a_0);
    ($IsValid'$1_RecoveryAddress_RecoveryAddress'($rsc))));

    // @114 := save_mem(DiemAccount::DiemAccount) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1
    $1_DiemAccount_DiemAccount_$memory#114 := $1_DiemAccount_DiemAccount_$memory;

    // @113 := save_mem(RecoveryAddress::RecoveryAddress) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1
    $1_RecoveryAddress_RecoveryAddress_$memory#113 := $1_RecoveryAddress_RecoveryAddress_$memory;

    // trace_local[account]($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1
    assume {:print "$track_local(30,2,0):", $t0} $t0 == $t0;

    // trace_local[recovery_address]($t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1
    assume {:print "$track_local(30,2,1):", $t1} $t1 == $t1;

    // trace_local[to_recover]($t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1
    assume {:print "$track_local(30,2,2):", $t2} $t2 == $t2;

    // trace_local[new_key]($t3) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:89:5+1
    assume {:print "$track_local(30,2,3):", $t3} $t3 == $t3;

    // $t14 := exists<RecoveryAddress::RecoveryAddress>($t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:16+6
    assume {:print "$at(24,4685,4691)"} true;
    $t14 := $ResourceExists($1_RecoveryAddress_RecoveryAddress_$memory, $t1);

    // $t15 := 5 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:81+17
    $t15 := 5;
    assume $IsValid'u64'($t15);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:59+40
    // >> opaque call: $t16 := Errors::not_published($t15)

    // $t16 := opaque begin: Errors::not_published($t15) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:59+40

    // assume WellFormed($t16) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:59+40
    assume $IsValid'u64'($t16);

    // assume Eq<u64>($t16, 5) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:59+40
    assume $IsEqual'u64'($t16, 5);

    // $t16 := opaque end: Errors::not_published($t15) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:59+40

    // trace_local[tmp#$10]($t16) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:9+91
    assume {:print "$track_local(30,2,10):", $t16} $t16 == $t16;

    // trace_local[tmp#$9]($t14) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:9+91
    assume {:print "$track_local(30,2,9):", $t14} $t14 == $t14;

    // if ($t14) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:9+91
    if ($t14) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:9+91
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:9+91

    // trace_abort($t16) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:9+91
    assume {:print "$at(24,4678,4769)"} true;
    assume {:print "$track_abort(30,2):", $t16} $t16 == $t16;

    // $t17 := move($t16) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:9+91
    $t17 := $t16;

    // goto L17 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:9+91
    goto L17;

    // label L0 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:97:41+7
    assume {:print "$at(24,4811,4818)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:97:22+27
    // >> opaque call: $t17 := Signer::address_of($t0)

    // $t18 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:97:22+27

    // assume WellFormed($t18) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:97:22+27
    assume $IsValid'address'($t18);

    // assume Eq<address>($t18, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:97:22+27
    assume $IsEqual'address'($t18, $1_Signer_spec_address_of($t0));

    // $t18 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:97:22+27

    // trace_local[sender]($t18) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:97:13+6
    assume {:print "$track_local(30,2,8):", $t18} $t18 == $t18;

    // $t19 := ==($t18, $t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:20+2
    assume {:print "$at(24,4942,4944)"} true;
    $t19 := $IsEqual'address'($t18, $t2);

    // if ($t19) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:13+140
    if ($t19) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:13+140
L3:

    // goto L4 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:13+140
    goto L4;

    // label L2 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:13+140
L2:

    // $t20 := true at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:13+140
    $t20 := true;
    assume $IsValid'bool'($t20);

    // $t13 := $t20 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:13+140
    $t13 := $t20;

    // trace_local[tmp#$13]($t20) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:13+140
    assume {:print "$track_local(30,2,13):", $t20} $t20 == $t20;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:13+140
    goto L5;

    // label L4 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:102:13+6
    assume {:print "$at(24,5049,5055)"} true;
L4:

    // $t21 := ==($t18, $t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:102:20+2
    $t21 := $IsEqual'address'($t18, $t1);

    // $t13 := $t21 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:13+140
    assume {:print "$at(24,4935,5075)"} true;
    $t13 := $t21;

    // trace_local[tmp#$13]($t21) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:13+140
    assume {:print "$track_local(30,2,13):", $t21} $t21 == $t21;

    // label L5 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:13+140
L5:

    // $t22 := 2 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:103:38+18
    assume {:print "$at(24,5114,5132)"} true;
    $t22 := 2;
    assume $IsValid'u64'($t22);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:103:13+44
    // >> opaque call: $t22 := Errors::invalid_argument($t21)

    // $t23 := opaque begin: Errors::invalid_argument($t22) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:103:13+44

    // assume WellFormed($t23) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:103:13+44
    assume $IsValid'u64'($t23);

    // assume Eq<u64>($t23, 7) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:103:13+44
    assume $IsEqual'u64'($t23, 7);

    // $t23 := opaque end: Errors::invalid_argument($t22) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:103:13+44

    // trace_local[tmp#$12]($t23) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:98:9+314
    assume {:print "$at(24,4829,5143)"} true;
    assume {:print "$track_local(30,2,12):", $t23} $t23 == $t23;

    // trace_local[tmp#$11]($t13) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:98:9+314
    assume {:print "$track_local(30,2,11):", $t13} $t13 == $t13;

    // if ($t13) goto L6 else goto L7 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:98:9+314
    if ($t13) { goto L6; } else { goto L7; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:98:9+314
L7:

    // trace_abort($t23) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:98:9+314
    assume {:print "$at(24,4829,5143)"} true;
    assume {:print "$track_abort(30,2):", $t23} $t23 == $t23;

    // $t17 := move($t23) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:98:9+314
    $t17 := $t23;

    // goto L17 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:98:9+314
    goto L17;

    // label L6 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:106:52+16
    assume {:print "$at(24,5197,5213)"} true;
L6:

    // $t24 := get_global<RecoveryAddress::RecoveryAddress>($t1) on_abort goto L17 with $t17 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:106:21+13
    ...
    if ($abort_flag) {
        assume {:print "$at(24,5166,5179)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(30,2):", $t17} $t17 == $t17;
        goto L17;
    }

    // $t25 := get_field<RecoveryAddress::RecoveryAddress>.rotation_caps($t24) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:106:20+63
    $t25 := $rotation_caps#$1_RecoveryAddress_RecoveryAddress($t24);

    // trace_local[caps]($t25) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:106:13+4
    assume {:print "$track_local(30,2,5):", $t25} $t25 == $t25;

    // $t26 := 0 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:107:17+1
    assume {:print "$at(24,5246,5247)"} true;
    $t26 := 0;
    assume $IsValid'u64'($t26);

    // trace_local[i]($t26) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:107:13+1
    assume {:print "$track_local(30,2,6):", $t26} $t26 == $t26;

    // $t27 := Vector::length<DiemAccount::KeyRotationCapability>($t25) on_abort goto L17 with $t17 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:108:19+20
    assume {:print "$at(24,5267,5287)"} true;
    ...
    // trace_local[len]($t27) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:108:13+3
    assume {:print "$track_local(30,2,7):", $t27} $t27 == $t27;

    // label L14 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:13+133
    assume {:print "$at(24,5318,5451)"} true;
L14:

    // assert Le($t26, $t27) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:111:17+16
    assume {:print "$at(24,5341,5357)"} true;
    assert {:msg "assert_failed(24,5341,5357): base case of the loop invariant does not hold"}
      ($t26 <= $t27);

    // assert forall j: Range(0, $t26): Neq<address>(select DiemAccount::KeyRotationCapability.account_address(Index($t25, j)), $t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    assume {:print "$at(24,5374,5437)"} true;
    assert {:msg "assert_failed(24,5374,5437): base case of the loop invariant does not hold"}
    ...
    // havoc[val]($t26) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    havoc $t26;
    assume $IsValid'u64'($t26);

    // havoc[val]($t28) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    havoc $t28;
    assume $IsValid'bool'($t28);

    // havoc[val]($t29) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    havoc $t29;
    assume $IsValid'$1_DiemAccount_KeyRotationCapability'($t29);

    // havoc[val]($t30) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    havoc $t30;
    assume $IsValid'address'($t30);

    // havoc[val]($t31) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    havoc $t31;
    assume $IsValid'bool'($t31);

    // havoc[val]($t32) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    havoc $t32;
    assume $IsValid'u64'($t32);

    // havoc[val]($t33) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    havoc $t33;
    assume $IsValid'u64'($t33);

    // assume Not(AbortFlag()) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    assume !$abort_flag;

    // assume Le($t26, $t27) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:111:17+16
    assume {:print "$at(24,5341,5357)"} true;
    assume ($t26 <= $t27);

    // assume forall j: Range(0, $t26): Neq<address>(select DiemAccount::KeyRotationCapability.account_address(Index($t25, j)), $t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    assume {:print "$at(24,5374,5437)"} true;
    assume (var $range_0 := $Range(0, $t26); (forall $i_1: int :: $InRange($range_0, $i_1) ==> (var j := $i_1;
    (!$IsEqual'address'($account_address#$1_DiemAccount_KeyRotationCapability(ReadVec($t25, j)), $t2)))));

    // $t28 := <($t26, $t27) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:114:16+1
    assume {:print "$at(24,5468,5469)"} true;
    call $t28 := $Lt($t26, $t27);

    // if ($t28) goto L8 else goto L9 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:109:9+469
    assume {:print "$at(24,5297,5766)"} true;
    if ($t28) { goto L8; } else { goto L9; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:109:9+469
L9:

    // goto L10 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:109:9+469
    goto L10;

    // label L8 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:117:38+4
    assume {:print "$at(24,5533,5537)"} true;
L8:

    // $t29 := Vector::borrow<DiemAccount::KeyRotationCapability>($t25, $t26) on_abort goto L17 with $t17 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:117:23+23
    call $t29 := $1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'($t25, $t26);
    if ($abort_flag) {
        assume {:print "$at(24,5518,5541)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(30,2):", $t17} $t17 == $t17;
        goto L17;
    }

    // trace_local[cap]($t29) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:117:17+3
    assume {:print "$track_local(30,2,4):", $t29} $t29 == $t29;

    // $t30 := DiemAccount::key_rotation_capability_address($t29) on_abort goto L17 with $t17 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:118:17+49
    assume {:print "$at(24,5559,5608)"} true;
    ...
    // $t31 := ==($t30, $t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:118:67+2
    $t31 := $IsEqual'address'($t30, $t2);

    // if ($t31) goto L11 else goto L12 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:118:13+178
    if ($t31) { goto L11; } else { goto L12; }

    // label L12 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:118:13+178
L12:

    // goto L13 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:118:13+178
    goto L13;

    // label L11 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:119:17+52
    assume {:print "$at(24,5643,5695)"} true;
L11:

    // destroy($t25) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:119:17+52

    // DiemAccount::rotate_authentication_key($t29, $t3) on_abort goto L17 with $t17 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:119:17+52
    ...
    // goto L16 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:120:17+6
    assume {:print "$at(24,5713,5719)"} true;
    goto L16;

    // label L13 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:118:13+178
    assume {:print "$at(24,5555,5733)"} true;
L13:

    // destroy($t29) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:118:13+178

    // $t32 := 1 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:122:21+1
    assume {:print "$at(24,5755,5756)"} true;
    $t32 := 1;
    assume $IsValid'u64'($t32);

    // $t33 := +($t26, $t32) on_abort goto L17 with $t17 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:122:19+1
    call $t33 := $AddU64($t26, $t32);
    if ($abort_flag) {
        assume {:print "$at(24,5753,5754)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(30,2):", $t17} $t17 == $t17;
        goto L17;
    }

    // trace_local[i]($t33) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:122:13+1
    assume {:print "$track_local(30,2,6):", $t33} $t33 == $t33;

    // goto L15 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:122:13+9
    goto L15;

    // label L10 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:124:9+123
    assume {:print "$at(24,5776,5899)"} true;
L10:

    // assert Eq<u64>($t26, $t27) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:125:13+16
    assume {:print "$at(24,5795,5811)"} true;
    assert {:msg "assert_failed(24,5795,5811): unknown assertion failed"}
      $IsEqual'u64'($t26, $t27);

    // assert forall j: Range(0, $t27): Neq<address>(select DiemAccount::KeyRotationCapability.account_address(Index($t25, j)), $t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:126:13+65
    assume {:print "$at(24,5824,5889)"} true;
    assert {:msg "assert_failed(24,5824,5889): unknown assertion failed"}
      (var $range_0 := $Range(0, $t27); (forall $i_1: int :: $InRange($range_0, $i_1) ==> (var j := $i_1;
    (!$IsEqual'address'($account_address#$1_DiemAccount_KeyRotationCapability(ReadVec($t25, j)), $t2)))));

    // $t34 := 4 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:129:40+24
    assume {:print "$at(24,6018,6042)"} true;
    $t34 := 4;
    assume $IsValid'u64'($t34);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:129:15+50
    // >> opaque call: $t34 := Errors::invalid_argument($t33)

    // $t35 := opaque begin: Errors::invalid_argument($t34) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:129:15+50

    // assume WellFormed($t35) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:129:15+50
    assume $IsValid'u64'($t35);

    // assume Eq<u64>($t35, 7) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:129:15+50
    assume $IsEqual'u64'($t35, 7);

    // $t35 := opaque end: Errors::invalid_argument($t34) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:129:15+50

    // trace_abort($t35) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:129:9+56
    assume {:print "$at(24,5987,6043)"} true;
    assume {:print "$track_abort(30,2):", $t35} $t35 == $t35;

    // $t17 := move($t35) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:129:9+56
    $t17 := $t35;

    // goto L17 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:129:9+56
    goto L17;

    // label L15 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:124:9+123
    // Loop invariant checking block for the loop started with header: L14
    assume {:print "$at(24,5776,5899)"} true;
L15:

    // assert Le($t33, $t27) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:111:17+16
    assume {:print "$at(24,5341,5357)"} true;
    assert {:msg "assert_failed(24,5341,5357): induction case of the loop invariant does not hold"}
      ($t33 <= $t27);

    // assert forall j: Range(0, $t33): Neq<address>(select DiemAccount::KeyRotationCapability.account_address(Index($t25, j)), $t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    assume {:print "$at(24,5374,5437)"} true;
    assert {:msg "assert_failed(24,5374,5437): induction case of the loop invariant does not hold"}
      (var $range_0 := $Range(0, $t33); (forall $i_1: int :: $InRange($range_0, $i_1) ==> (var j := $i_1;
    (!$IsEqual'address'($account_address#$1_DiemAccount_KeyRotationCapability(ReadVec($t25, j)), $t2)))));

    // stop() at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:112:17+63
    assume false;
    return;

    // label L16 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:130:5+1
    assume {:print "$at(24,6048,6049)"} true;
L16:

    // assert Not(Not(RecoveryAddress::spec_is_recovery_address[@113]($t1))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:140:9+81
    assume {:print "$at(24,6366,6447)"} true;
    assert {:msg "assert_failed(24,6366,6447): function does not abort under this condition"}
      !!$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#113, $t1);

    // assert Not(Not(DiemAccount::$exists_at[@114]($t2))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:141:9+73
    assume {:print "$at(24,6456,6529)"} true;
    assert {:msg "assert_failed(24,6456,6529): function does not abort under this condition"}
      !!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#114, $t2);

    // assert Not(Neq<num>(Len<u8>($t3), 32)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:142:9+59
    assume {:print "$at(24,6538,6597)"} true;
    assert {:msg "assert_failed(24,6538,6597): function does not abort under this condition"}
      !!$IsEqual'num'(LenVec($t3), 32);

    // assert Not(Not(RecoveryAddress::spec_holds_key_rotation_cap_for[@113]($t1, $t2))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:143:9+103
    assume {:print "$at(24,6606,6709)"} true;
    assert {:msg "assert_failed(24,6606,6709): function does not abort under this condition"}
      !!$1_RecoveryAddress_spec_holds_key_rotation_cap_for($1_RecoveryAddress_RecoveryAddress_$memory#113, $t1, $t2);

    // assert Not(Not(Or(Eq<address>(Signer::spec_address_of[]($t0), $t1), Eq<address>(Signer::spec_address_of[]($t0), $t2)))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:144:9+166
    assume {:print "$at(24,6718,6884)"} true;
    assert {:msg "assert_failed(24,6718,6884): function does not abort under this condition"}
      !!($IsEqual'address'($1_Signer_spec_address_of($t0), $t1) || $IsEqual'address'($1_Signer_spec_address_of($t0), $t2));

    // assert Eq<vector<u8>>(DiemAccount::$authentication_key($t2), $t3) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:150:9+63
    assume {:print "$at(24,7006,7069)"} true;
    assert {:msg "assert_failed(24,7006,7069): post-condition does not hold"}
      $IsEqual'vec'u8''($1_DiemAccount_$authentication_key($1_DiemAccount_DiemAccount_$memory, $t2), $t3);

    // return () at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:150:9+63
    return;

    // label L17 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:130:5+1
    assume {:print "$at(24,6048,6049)"} true;
L17:
    ...
    assume {:print "$at(24,6054,6189)"} true;
    assert {:msg "assert_failed(24,6054,6189): abort not covered by any of the `aborts_if` clauses"}
    ...
    assert {:msg "assert_failed(24,6054,6189): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t17) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:131:5+135
    $abort_code := $t17;
    $abort_flag := true;
    return;
...
// fun RecoveryAddress::add_rotation_capability [verification] at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+963
procedure {:timeLimit 40} $1_RecoveryAddress_add_rotation_capability$verify(_$t0: $1_DiemAccount_KeyRotationCapability, _$t1: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+963
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume {:print "$at(24,7332,8295)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+963
    assume $IsValid'$1_DiemAccount_KeyRotationCapability'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+963
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+963
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+963
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<RecoveryAddress::RecoveryAddress>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+963
    assume (forall $a_0: int :: {$ResourceValue($1_RecoveryAddress_RecoveryAddress_$memory, $a_0)}(var $rsc := $ResourceValue($1_RecoveryAddress_RecoveryAddress_$memory, $a_0);
    ($IsValid'$1_RecoveryAddress_RecoveryAddress'($rsc))));

    // assume Identical($t10, DiemAccount::$key_rotation_capability_address($t0)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:184:9+82
    assume {:print "$at(24,8785,8867)"} true;
    assume ($t10 == $1_DiemAccount_$key_rotation_capability_address($t0));

    // @121 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+1
    assume {:print "$at(24,7332,7333)"} true;
    $1_VASP_ChildVASP_$memory#121 := $1_VASP_ChildVASP_$memory;

    // @122 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+1
    $1_VASP_ParentVASP_$memory#122 := $1_VASP_ParentVASP_$memory;

    // @120 := save_mem(RecoveryAddress::RecoveryAddress) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+1
    $1_RecoveryAddress_RecoveryAddress_$memory#120 := $1_RecoveryAddress_RecoveryAddress_$memory;

    // trace_local[to_recover]($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+1
    assume {:print "$track_local(30,0,0):", $t0} $t0 == $t0;

    // trace_local[recovery_address]($t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+1
    assume {:print "$track_local(30,0,1):", $t1} $t1 == $t1;

    // $t11 := exists<RecoveryAddress::RecoveryAddress>($t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:16+6
    assume {:print "$at(24,7549,7555)"} true;
    $t11 := $ResourceExists($1_RecoveryAddress_RecoveryAddress_$memory, $t1);

    // $t12 := 5 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:81+17
    $t12 := 5;
    assume $IsValid'u64'($t12);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:59+40
    // >> opaque call: $t12 := Errors::not_published($t11)

    // $t13 := opaque begin: Errors::not_published($t12) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:59+40

    // assume WellFormed($t13) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:59+40
    assume $IsValid'u64'($t13);

    // assume Eq<u64>($t13, 5) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:59+40
    assume $IsEqual'u64'($t13, 5);

    // $t13 := opaque end: Errors::not_published($t12) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:59+40

    // trace_local[tmp#$4]($t13) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:9+91
    assume {:print "$track_local(30,0,4):", $t13} $t13 == $t13;

    // trace_local[tmp#$3]($t11) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:9+91
    assume {:print "$track_local(30,0,3):", $t11} $t11 == $t11;

    // if ($t11) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:9+91
    if ($t11) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:9+91
L1:

    // trace_abort($t13) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:9+91
    assume {:print "$at(24,7542,7633)"} true;
    assume {:print "$track_abort(30,0):", $t13} $t13 == $t13;

    // $t14 := move($t13) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:9+91
    $t14 := $t13;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:9+91
    goto L7;

    // label L0 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:161:80+11
    assume {:print "$at(24,7802,7813)"} true;
L0:

    // $t15 := DiemAccount::key_rotation_capability_address($t0) on_abort goto L7 with $t14 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:161:35+57
    call $t15 := $1_DiemAccount_key_rotation_capability_address($t0);
    if ($abort_flag) {
        assume {:print "$at(24,7757,7814)"} true;
        $t14 := $abort_code;
        assume {:print "$track_abort(30,0):", $t14} $t14 == $t14;
        goto L7;
    }

    // trace_local[to_recover_address]($t15) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:161:13+18
    assume {:print "$track_local(30,0,9):", $t15} $t15 == $t15;

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:163:13+56
    // >> opaque call: $t14 := VASP::is_same_vasp($t1, $t13)
    assume {:print "$at(24,7844,7900)"} true;

    // $t16 := opaque begin: VASP::is_same_vasp($t1, $t15) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:163:13+56

    // assume WellFormed($t16) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:163:13+56
    assume $IsValid'bool'($t16);

    // assume Eq<bool>($t16, VASP::spec_is_same_vasp($t1, $t15)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:163:13+56
    assume $IsEqual'bool'($t16, $1_VASP_spec_is_same_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t1, $t15));

    // $t16 := opaque end: VASP::is_same_vasp($t1, $t15) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:163:13+56

    // $t17 := 3 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:164:38+32
    assume {:print "$at(24,7939,7971)"} true;
    $t17 := 3;
    assume $IsValid'u64'($t17);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:164:13+58
    // >> opaque call: $t16 := Errors::invalid_argument($t15)

    // $t18 := opaque begin: Errors::invalid_argument($t17) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:164:13+58

    // assume WellFormed($t18) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:164:13+58
    assume $IsValid'u64'($t18);

    // assume Eq<u64>($t18, 7) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:164:13+58
    assume $IsEqual'u64'($t18, 7);

    // $t18 := opaque end: Errors::invalid_argument($t17) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:164:13+58

    // trace_local[tmp#$6]($t18) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:162:9+158
    assume {:print "$at(24,7824,7982)"} true;
    assume {:print "$track_local(30,0,6):", $t18} $t18 == $t18;

    // trace_local[tmp#$5]($t16) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:162:9+158
    assume {:print "$track_local(30,0,5):", $t16} $t16 == $t16;

    // if ($t16) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:162:9+158
    if ($t16) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:162:9+158
L3:

    // trace_abort($t18) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:162:9+158
    assume {:print "$at(24,7824,7982)"} true;
    assume {:print "$track_abort(30,0):", $t18} $t18 == $t18;

    // $t14 := move($t18) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:162:9+158
    $t14 := $t18;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:162:9+158
    goto L7;

    // label L2 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:167:69+16
    assume {:print "$at(24,8053,8069)"} true;
L2:

    // $t19 := borrow_global<RecoveryAddress::RecoveryAddress>($t1) on_abort goto L7 with $t14 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:167:34+17
    if (!$ResourceExists($1_RecoveryAddress_RecoveryAddress_$memory, $t1)) {
        call $ExecFailureAbort();
    } else {
    ...
    if ($abort_flag) {
        assume {:print "$at(24,8018,8035)"} true;
        $t14 := $abort_code;
        assume {:print "$track_abort(30,0):", $t14} $t14 == $t14;
        goto L7;
    }

    // $t20 := borrow_field<RecoveryAddress::RecoveryAddress>.rotation_caps($t19) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:167:29+71
    $t20 := $ChildMutation($t19, 0, $rotation_caps#$1_RecoveryAddress_RecoveryAddress($Dereference($t19)));

    // trace_local[recovery_caps]($t20) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:167:13+13
    $temp_0'vec'$1_DiemAccount_KeyRotationCapability'' := $Dereference($t20);
    assume {:print "$track_local(30,0,2):", $temp_0'vec'$1_DiemAccount_KeyRotationCapability''} $temp_0'vec'$1_DiemAccount_KeyRotationCapability'' == $temp_0'vec'$1_DiemAccount_KeyRotationCapability'';

    // $t21 := read_ref($t20) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:169:28+13
    assume {:print "$at(24,8129,8142)"} true;
    $t21 := $Dereference($t20);

    // $t22 := Vector::length<DiemAccount::KeyRotationCapability>($t21) on_abort goto L7 with $t14 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:169:13+29
    call $t22 := $1_Vector_length'$1_DiemAccount_KeyRotationCapability'($t21);
    if ($abort_flag) {
        assume {:print "$at(24,8114,8143)"} true;
        $t14 := $abort_code;
        assume {:print "$track_abort(30,0):", $t14} $t14 == $t14;
        goto L7;
    }

    // $t23 := 256 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:169:45+19
    $t23 := 256;
    assume $IsValid'u64'($t23);

    // $t24 := <($t22, $t23) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:169:43+1
    call $t24 := $Lt($t22, $t23);

    // $t25 := 6 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:170:36+20
    assume {:print "$at(24,8202,8222)"} true;
    $t25 := 6;
    assume $IsValid'u64'($t25);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:170:13+44
    // >> opaque call: $t24 := Errors::limit_exceeded($t23)

    // $t26 := opaque begin: Errors::limit_exceeded($t25) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:170:13+44

    // assume WellFormed($t26) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:170:13+44
    assume $IsValid'u64'($t26);

    // assume Eq<u64>($t26, 8) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:170:13+44
    assume $IsEqual'u64'($t26, 8);

    // $t26 := opaque end: Errors::limit_exceeded($t25) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:170:13+44

    // trace_local[tmp#$8]($t26) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:168:9+139
    assume {:print "$at(24,8094,8233)"} true;
    assume {:print "$track_local(30,0,8):", $t26} $t26 == $t26;

    // trace_local[tmp#$7]($t24) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:168:9+139
    assume {:print "$track_local(30,0,7):", $t24} $t24 == $t24;

    // if ($t24) goto L4 else goto L8 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:168:9+139
    if ($t24) { goto L4; } else { goto L8; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:168:9+139
L5:

    // destroy($t20) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:168:9+139

    // trace_abort($t26) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:168:9+139
    assume {:print "$at(24,8094,8233)"} true;
    assume {:print "$track_abort(30,0):", $t26} $t26 == $t26;

    // $t14 := move($t26) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:168:9+139
    $t14 := $t26;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:168:9+139
    goto L7;

    // label L4 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:173:27+13
    assume {:print "$at(24,8262,8275)"} true;
L4:

    // Vector::push_back<DiemAccount::KeyRotationCapability>($t20, $t0) on_abort goto L7 with $t14 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:173:9+44
    call $t20 := $1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'($t20, $t0);
    if ($abort_flag) {
        assume {:print "$at(24,8244,8288)"} true;
        $t14 := $abort_code;
        assume {:print "$track_abort(30,0):", $t14} $t14 == $t14;
        goto L7;
    }

    // write_back[Reference($t19).rotation_caps]($t20) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:173:9+44
    ...
    // assume forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+963
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:237:9+163
    assume (forall recovery_addr: int :: $IsValid'address'(recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr))  ==> ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, recovery_addr)));

    // @246 := save_mem(RecoveryAddress::RecoveryAddress) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:156:5+963
    // state save for global update invariants
    $1_RecoveryAddress_RecoveryAddress_$memory#246 := $1_RecoveryAddress_RecoveryAddress_$memory;

    // write_back[RecoveryAddress::RecoveryAddress@]($t19) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:173:9+44
    assume {:print "$at(24,8244,8288)"} true;
    ...
    // assert forall addr: TypeDomain<address>(): Implies(RecoveryAddress::spec_is_recovery_address[@246](addr), RecoveryAddress::spec_is_recovery_address(addr)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:211:9+136
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:211:9+136
    assume {:print "$at(24,9854,9990)"} true;
    assert {:msg "assert_failed(24,9854,9990): global memory invariant does not hold"}
    ...
    // assert forall addr: TypeDomain<address>() where exists[@246]<RecoveryAddress::RecoveryAddress>(addr): exists<RecoveryAddress::RecoveryAddress>(addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:220:9+122
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:220:9+122
    assume {:print "$at(24,10111,10233)"} true;
    assert {:msg "assert_failed(24,10111,10233): global memory invariant does not hold"}
    ...
    // label L6 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:174:5+1
    assume {:print "$at(24,8294,8295)"} true;
L6:

    // assume Identical($t27, Len<DiemAccount::KeyRotationCapability>(RecoveryAddress::spec_get_rotation_caps($t1))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:190:9+75
    assume {:print "$at(24,9119,9194)"} true;
    assume ($t27 == LenVec($1_RecoveryAddress_spec_get_rotation_caps($1_RecoveryAddress_RecoveryAddress_$memory, $t1)));

    // assert Not(Not(RecoveryAddress::spec_is_recovery_address[@120]($t1))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:182:9+81
    assume {:print "$at(24,8564,8645)"} true;
    assert {:msg "assert_failed(24,8564,8645): function does not abort under this condition"}
      !!$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#120, $t1);

    // assert Not(Ge(Len<DiemAccount::KeyRotationCapability>(select RecoveryAddress::RecoveryAddress.rotation_caps(global[@120]<RecoveryAddress::RecoveryAddress>($t1))), 256)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:183:9+122
    assume {:print "$at(24,8654,8776)"} true;
    assert {:msg "assert_failed(24,8654,8776): function does not abort under this condition"}
    ...
    // assert Not(Not(VASP::spec_is_same_vasp[@121, @122]($t1, $t10))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:185:9+103
    assume {:print "$at(24,8876,8979)"} true;
    assert {:msg "assert_failed(24,8876,8979): function does not abort under this condition"}
      !!$1_VASP_spec_is_same_vasp($1_VASP_ChildVASP_$memory#121, $1_VASP_ParentVASP_$memory#122, $t1, $t10);

    // assert Eq<DiemAccount::KeyRotationCapability>(Index(RecoveryAddress::spec_get_rotation_caps($t1), Sub($t27, 1)), $t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:191:9+86
    assume {:print "$at(24,9203,9289)"} true;
    assert {:msg "assert_failed(24,9203,9289): post-condition does not hold"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:191:9+86
    return;

    // label L7 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:174:5+1
    assume {:print "$at(24,8294,8295)"} true;
L7:
    ...
    assume {:print "$at(24,8300,8429)"} true;
    assert {:msg "assert_failed(24,8300,8429): abort not covered by any of the `aborts_if` clauses"}
    ...
    assert {:msg "assert_failed(24,8300,8429): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t14) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:175:5+129
    $abort_code := $t14;
    $abort_flag := true;
    return;
...
L5:
    ...
    assume {:print "$at(16,4504,4535)"} true;
    assume {:print "$track_abort(31,5):", $t7} $t7 == $t7;
...
L8:
    ...
    // @159 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@159](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    ...
    assume {:print "$track_local(31,5,1):", $t14} $t14 == $t14;
...
L1:
    ...
    assume {:print "$at(16,4819,4969)"} true;
    assume {:print "$track_abort(31,5):", $t20} $t20 == $t20;
...
procedure {:inline 1} $1_DiemBlock_is_initialized() returns ($ret0: bool)
{
    ...
    if ($abort_flag) {
        assume {:print "$at(12,2071,2105)"} true;
        $t1 := $abort_code;
        assume {:print "$track_abort(32,3):", $t1} $t1 == $t1;
        goto L2;
    }
    ...
    assume {:print "$track_return(32,3,0):", $t2} $t2 == $t2;
...
L7:
    ...
    // @177 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@177](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L7:
    ...
    // @171 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@171](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
...
procedure {:timeLimit 40} $1_Genesis_initialize$verify(_$t0: int, _$t1: int, _$t2: Vec (int), _$t3: Vec (int), _$t4: Vec (Vec (int)), _$t5: bool, _$t6: Vec (int), _$t7: Vec (int), _$t8: int, _$t9: int) returns ()
{
    ...
    // trace_local[dr_account#2076]($t0) at /home/ying/diem/language/diem-framework/modules/Genesis.move:42:13+10
    assume {:print "$at(22,1252,1262)"} true;
    assume {:print "$track_local(35,1,10):", $t0} $t0 == $t0;

    // trace_local[tc_account#2077]($t1) at /home/ying/diem/language/diem-framework/modules/Genesis.move:43:13+10
