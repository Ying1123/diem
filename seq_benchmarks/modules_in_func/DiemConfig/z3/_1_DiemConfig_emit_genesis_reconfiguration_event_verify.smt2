...
(declare-fun $t12 () T@$Mutation_112908)
(declare-fun $abort_code@1 () Int)
(declare-fun $t12@0 () T@$Mutation_112908)
(declare-fun $abort_code@0 () Int)
(declare-fun $t7@0 () Bool)
(declare-fun $t9 () Int)
(declare-fun $t5 () T@$Mutation_112908)
(declare-fun $t23 () T@$Mutation_12338)
(declare-fun $t24 () T@$Mutation_99585)
(push 1)
(set-info :boogie-vc-id $1_DiemConfig_emit_genesis_reconfiguration_event$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 249533) (let ((anon22_Else_correct  (=> (and (not $abort_flag@0) (= $1_DiemConfig_Configuration_$memory@0 ($Memory_107487 (|Store__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) (|a#$Global| (|l#$Mutation_112908| $t12@2)) true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_107487| $1_DiemConfig_Configuration_$memory) (|a#$Global| (|l#$Mutation_112908| $t12@2)) (|v#$Mutation_112908| $t12@2))))) (and (=> (= (ControlFlow 0 180156) (- 0 250173)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory@0) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory@0) 173345816)) (=> (= $t27 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_107487| $1_DiemConfig_Configuration_$memory@0) 173345816)) (=> (and (= $t28 (|$events#$1_DiemConfig_Configuration| $t27)) (= $t29 ($1_DiemConfig_NewEpochEvent (|$epoch#$1_DiemConfig_Configuration| $t27)))) (and (=> (= (ControlFlow 0 180156) (- 0 250224)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_77118_| (|streams#$EventStore| $EmptyEventStore) $t28)))
(let ((stream_new (let ((len (|l#Multiset_77118| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_77118| stream@@0) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29))))
(Multiset_77118 (|Store__T@[$EventRep]Int_| (|v#Multiset_77118| stream@@0) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29) (+ cnt 1)) (+ len 1))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_77118_| (|streams#$EventStore| $EmptyEventStore) $t28)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_77118| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_77118| stream@@1) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29))))
(Multiset_77118 (|Store__T@[$EventRep]Int_| (|v#Multiset_77118| stream@@1) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29) (+ cnt@@0 1)) (+ len@@0 1))))))
...
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_77118_| (|streams#$EventStore| $EmptyEventStore) $t28)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_77118| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_77118| stream@@2) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29))))
(Multiset_77118 (|Store__T@[$EventRep]Int_| (|v#Multiset_77118| stream@@2) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29) (+ cnt@@1 1)) (+ len@@1 1))))))
...
(let ((|inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$handle@1| (|v#$Mutation_99585| $t24@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_77118_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_77118| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_77118| stream@@3) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t26@0))))
(Multiset_77118 (|Store__T@[$EventRep]Int_| (|v#Multiset_77118| stream@@3) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t26@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_77118_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 180026) 180170) anon22_Then_correct) (=> (= (ControlFlow 0 180026) 180156) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> $t4@0 (=> (and (and (and (|$IsValid'u64'| 1) (= $t23@0 ($Mutation_12338 (|l#$Mutation_112908| $t12@1) (seq.++ (|p#$Mutation_112908| $t12@1) (seq.unit 0)) (|$epoch#$1_DiemConfig_Configuration| (|v#$Mutation_112908| $t12@1))))) (and (= $t23@1 ($Mutation_12338 (|l#$Mutation_12338| $t23@0) (|p#$Mutation_12338| $t23@0) 1)) (= $t12@2 ($Mutation_112908 (|l#$Mutation_112908| $t12@1) (|p#$Mutation_112908| $t12@1) ($1_DiemConfig_Configuration (|v#$Mutation_12338| $t23@1) (|$last_reconfiguration_time#$1_DiemConfig_Configuration| (|v#$Mutation_112908| $t12@1)) (|$events#$1_DiemConfig_Configuration| (|v#$Mutation_112908| $t12@1))))))) (and (and (= $t24@0 ($Mutation_99585 (|l#$Mutation_112908| $t12@2) (seq.++ (|p#$Mutation_112908| $t12@2) (seq.unit 2)) (|$events#$1_DiemConfig_Configuration| (|v#$Mutation_112908| $t12@2)))) (= $t25@0 (|$epoch#$1_DiemConfig_Configuration| (|v#$Mutation_112908| $t12@2)))) (and (= $t26@0 ($1_DiemConfig_NewEpochEvent $t25@0)) (= (ControlFlow 0 180032) 180026)))) |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$anon0_correct|))))
(let ((anon21_Else_correct true))
(let ((L5_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t21) (= $t21 1)) (and (= $t21 $t21) (= $t4@0 $t4@0))) (and (=> (= (ControlFlow 0 179869) 180032) anon21_Then_correct) (=> (= (ControlFlow 0 179869) 179885) anon21_Else_correct))))))
(let ((anon20_Else_correct  (=> (and (and (not $t15@0) (= false false)) (and (= $t4@0 false) (= (ControlFlow 0 179839) 179869))) L5_correct)))
(let ((anon20_Then_correct  (=> $t15@0 (=> (and (= $t16@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| (|v#$Mutation_112908| $t12@1))) (|$IsValid'u64'| 0)) (=> (and (and (= $t18@0 (= $t16@0 0)) (= $t18@0 $t18@0)) (and (= $t4@0 $t18@0) (= (ControlFlow 0 180200) 179869))) L5_correct)))))
(let ((anon19_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_DiemConfig_Configuration'@0| (|v#$Mutation_112908| $t12@1))) (=> (and (and (= |$temp_0'$1_DiemConfig_Configuration'@0| |$temp_0'$1_DiemConfig_Configuration'@0|) (= $t13@0 (|$epoch#$1_DiemConfig_Configuration| (|v#$Mutation_112908| $t12@1)))) (and (|$IsValid'u64'| 0) (= $t15@0 (= $t13@0 0)))) (and (=> (= (ControlFlow 0 179819) 180200) anon20_Then_correct) (=> (= (ControlFlow 0 179819) 179839) anon20_Else_correct))))))
(let ((anon19_Then_correct true))
(let ((anon18_Then$1_correct  (=> (= $t12@1 $t12) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 180266) 180214) anon19_Then_correct) (=> (= (ControlFlow 0 180266) 179819) anon19_Else_correct))))))
(let ((anon18_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) 173345816)) (= (ControlFlow 0 180264) 180266)) anon18_Then$1_correct)))
(let ((anon18_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) 173345816) (=> (and (and (= $t12@0 ($Mutation_112908 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_107487| $1_DiemConfig_Configuration_$memory) 173345816))) (= $t12@1 $t12@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 179781) 180214) anon19_Then_correct) (=> (= (ControlFlow 0 179781) 179819) anon19_Else_correct))))))
(let ((anon17_Then_correct  (=> (and $t7@0 (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 179759) 180264) anon18_Then_correct) (=> (= (ControlFlow 0 179759) 179781) anon18_Else_correct)))))
(let ((anon17_Else_correct true))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105801| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_107487| $1_DiemConfig_Configuration_$memory) $a_0)))
(|$IsValid'$1_DiemConfig_Configuration'| $rsc))
 :qid |DiemConfigbpl.5285:20|
 :skolemid |137|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_107487| $1_DiemConfig_Configuration_$memory) $a_0))
)) (|$IsValid'address'| 173345816)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_107487| $1_DiemConfig_Configuration_$memory) 173345816)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= $t7@0 $t7@0)))) (and (=> (= (ControlFlow 0 179727) 179759) anon17_Then_correct) (=> (= (ControlFlow 0 179727) 179743) anon17_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_77118_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemConfigbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 179639) 179727)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (seq.len (|p#$Mutation_112908| $t5)) 0) (=> (and (and (= (seq.len (|p#$Mutation_112908| $t12)) 0) (= (seq.len (|p#$Mutation_12338| $t23)) 0)) (and (= (seq.len (|p#$Mutation_99585| $t24)) 0) (= (ControlFlow 0 179649) 179639))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 249533) 179649) anon0_correct)))
