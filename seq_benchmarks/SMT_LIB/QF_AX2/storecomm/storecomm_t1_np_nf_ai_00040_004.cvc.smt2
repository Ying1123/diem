...
(assert (not (= i1 i3)))
(assert (not (= i1 i2)))
(assert (not (= (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store a1 i1 e1) i2 e2) i3 e3) i4 e4) i5 e5) i6 e6) i7 e7) i8 e8) i9 e9) i10 e10) i11 e11) i12 e12) i13 e13) i14 e14) i15 e15) i16 e16) i17 e17) i18 e18) i19 e19) i20 e20) i21 e21) i22 e22) i23 e23) i24 e24) i25 e25) i26 e26) i27 e27) i28 e28) i29 e29) i30 e30) i31 e31) i32 e32) i33 e33) i34 e34) i35 e35) i36 e36) i37 e37) i38 e38) i39 e39) i40 e40) (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store a1 i2 e2) i15 e15) i10 e10) i40 e40) i20 e20) i8 e8) i27 e27) i35 e35) i25 e25) i18 e18) i1 e1) i31 e31) i4 e4) i11 e11) i33 e33) i30 e30) i17 e17) i32 e32) i14 e14) i13 e13) i7 e7) i9 e9) i19 e19) i34 e34) i6 e6) i26 e26) i21 e21) i23 e23) i24 e24) i37 e37) i38 e38) i39 e39) i5 e5) i28 e28) i36 e36) i16 e16) i3 e3) i12 e12) i22 e22) i29 e29))))
(check-sat)
(exit)
