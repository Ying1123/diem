...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 222453) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t12@0 (|$dummy_field#$1_DiemTransactionPublishingOption_HaltAllTransactions| $t11)) (= (ControlFlow 0 162669) (- 0 222916))) (|Select__T@[Int]Bool_| (|domain#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816) (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))))
(let ((anon15_Then_correct true))
(let ((anon14_Then$1_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 162735) 162683) anon15_Then_correct) (=> (= (ControlFlow 0 162735) 162669) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $t7)) (= (ControlFlow 0 162733) 162735)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $t7) (=> (and (and (= $t11@0 (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $t7)) (= $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory@0 ($Memory_124447 (|Store__T@[Int]Bool_| (|domain#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $t7 false) (|contents#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory)))) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 162633) 162683) anon15_Then_correct) (=> (= (ControlFlow 0 162633) 162669) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> $t8@0 (and (=> (= (ControlFlow 0 162613) 162733) anon14_Then_correct) (=> (= (ControlFlow 0 162613) 162633) anon14_Else_correct)))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (=> (and (not $t5) (|$IsValid'address'| $t7)) (=> (and (and (and (= $t7 (|$addr#$signer| _$t0)) (= $t7 $t7)) (and (= $t8@0 (|Select__T@[Int]Bool_| (|domain#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $t7)) (|$IsValid'u64'| 2))) (and (and (|$IsValid'u64'| $t10) (= $t10 6)) (and (= $t10 $t10) (= $t8@0 $t8@0)))) (and (=> (= (ControlFlow 0 162587) 162613) anon13_Then_correct) (=> (= (ControlFlow 0 162587) 162603) anon13_Else_correct))))))
(let ((anon12_Then_correct true))
(let ((anon0$1_correct  (=> (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_98919| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemTransactionPublishingOptionbpl.11648:20|
 :skolemid |201|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_98919| $1_Roles_RoleId_$memory) $a_0))
))) (=> (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $a_0@@0)))
(|$IsValid'$1_DiemTransactionPublishingOption_HaltAllTransactions'| $rsc@@0))
 :qid |DiemTransactionPublishingOptionbpl.11652:20|
 :skolemid |202|
 :pattern ( (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_124447| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $a_0@@0))
)) (= _$t0 _$t0)) (and (= $t4 (|$addr#$signer| _$t0)) (= $t5  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_98919| $1_Roles_RoleId_$memory) $t4))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_98919| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))) (and (=> (= (ControlFlow 0 162521) 162827) anon12_Then_correct) (=> (= (ControlFlow 0 162521) 162587) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_68416_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTransactionPublishingOptionbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 162385) 162521)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 222453) 162385) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))
))
(check-sat)
(pop 1)
