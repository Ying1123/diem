...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1306712) (let ((anon8_Else_correct  (=> (and (and (and (not $abort_flag@0) (= $t12@0 ($Mutation_13929 (|l#$Mutation_401271| _$t0) (let ((l (|l#Vec_28308| (|p#$Mutation_401271| _$t0))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_401271| _$t0)) l 0) (+ l 1))) (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| _$t0))))) (and (= $t12@1 ($Mutation_13929 (|l#$Mutation_13929| $t12@0) (|p#$Mutation_13929| $t12@0) inline$$Sub$0$dst@2)) (= $t0@0 ($Mutation_401271 (|l#$Mutation_401271| _$t0) (|p#$Mutation_401271| _$t0) (|$1_Diem_Diem'#0'| (|v#$Mutation_13929| $t12@1)))))) (and (and (= $t13@0 (|$1_Diem_Diem'#0'| _$t1)) (= $t13@0 $t13@0)) (and (= |$temp_0'$1_Diem_Diem'#0''@1| (|v#$Mutation_401271| $t0@0)) (= |$temp_0'$1_Diem_Diem'#0''@1| |$temp_0'$1_Diem_Diem'#0''@1|)))) (and (=> (= (ControlFlow 0 1001932) (- 0 1307174)) (not (< (|$value#$1_Diem_Diem'#0'| $t4@0) _$t1))) (=> (not (< (|$value#$1_Diem_Diem'#0'| $t4@0) _$t1)) (and (=> (= (ControlFlow 0 1001932) (- 0 1307185)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| $t0@0)) (- (|$value#$1_Diem_Diem'#0'| $t4@0) _$t1))) (=> (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| $t0@0)) (- (|$value#$1_Diem_Diem'#0'| $t4@0) _$t1)) (and (=> (= (ControlFlow 0 1001932) (- 0 1307201)) (= (|$value#$1_Diem_Diem'#0'| $t13@0) _$t1)) (=> (= (|$value#$1_Diem_Diem'#0'| $t13@0) _$t1) (and (=> (= (ControlFlow 0 1001932) (- 0 1307210)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 1001932) (- 0 1307231)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@0))))
 :qid |Diembpl.60763:15|
 :skolemid |3413|
 ...
 :qid |Diembpl.60763:15|
 :skolemid |3413|
)) (and (=> (= (ControlFlow 0 1001932) (- 0 1307260)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@2)))
 :qid |Diembpl.60768:15|
 :skolemid |3414|
 ...
 :qid |Diembpl.60768:15|
 :skolemid |3414|
)) (and (=> (= (ControlFlow 0 1001932) (- 0 1307285)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 1001932) (- 0 1307306)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4))))
 :qid |Diembpl.60778:15|
 :skolemid |3415|
 ...
 :qid |Diembpl.60778:15|
 :skolemid |3415|
)) (and (=> (= (ControlFlow 0 1001932) (- 0 1307335)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6)))
 :qid |Diembpl.60783:15|
 :skolemid |3416|
 ...
 :qid |Diembpl.60783:15|
 :skolemid |3416|
)) (and (=> (= (ControlFlow 0 1001932) (- 0 1307360)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 1001932) (- 0 1307381)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 1001932) (- 0 1307402)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8))))
 :qid |Diembpl.60798:15|
 :skolemid |3417|
 ...
 :qid |Diembpl.60798:15|
 :skolemid |3417|
)) (and (=> (= (ControlFlow 0 1001932) (- 0 1307438)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10)))
 :qid |Diembpl.60803:15|
 :skolemid |3418|
 ...
 :qid |Diembpl.60803:15|
 :skolemid |3418|
)) (=> (= (ControlFlow 0 1001932) (- 0 1307463)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 1001397) (- 0 1307067)) (< (|$value#$1_Diem_Diem'#0'| $t4@0) _$t1)) (=> (< (|$value#$1_Diem_Diem'#0'| $t4@0) _$t1) (=> (= (ControlFlow 0 1001397) (- 0 1307073)) (and (< (|$value#$1_Diem_Diem'#0'| $t4@0) _$t1) (= 8 $t9@0)))))))
(let ((anon8_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t9@0 $abort_code@1) (= (ControlFlow 0 1001946) 1001397))) L3_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 1001538) 1001946) anon8_Then_correct) (=> (= (ControlFlow 0 1001538) 1001932) anon8_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< $t10@0 _$t1) (= (ControlFlow 0 1001536) 1001538)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= _$t1 $t10@0) (=> (and (and (= inline$$Sub$0$dst@1 (- $t10@0 _$t1)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 1001488) 1001946) anon8_Then_correct) (=> (= (ControlFlow 0 1001488) 1001932) anon8_Else_correct))))))
(let ((anon7_Then_correct  (=> (and inline$$Ge$0$dst@1 (= $t10@0 (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| _$t0)))) (and (=> (= (ControlFlow 0 1001544) 1001536) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 1001544) 1001488) inline$$Sub$0$anon3_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (and (not inline$$Ge$0$dst@1) (= $t8 $t8)) (and (= $t9@0 $t8) (= (ControlFlow 0 1001365) 1001397))) L3_correct)))
(let ((anon0$2_correct  (=> (|$IsValid'u64'| 10) (=> (and (and (|$IsValid'u64'| $t8) (= $t8 8)) (and (= $t8 $t8) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 1001349) 1001544) anon7_Then_correct) (=> (= (ControlFlow 0 1001349) 1001365) anon7_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= $t5@0 _$t1)) (= (ControlFlow 0 1001313) 1001349)) anon0$2_correct)))
(let ((anon0$1_correct  (=> (= (|l#$Mutation_401271| _$t0) ($Param 0)) (=> (and (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_401271| _$t0)) (|$IsValid'u64'| _$t1)) (and (= $t4@0 (|v#$Mutation_401271| _$t0)) (= |$temp_0'$1_Diem_Diem'#0''@0| (|v#$Mutation_401271| _$t0)))) (and (and (= |$temp_0'$1_Diem_Diem'#0''@0| |$temp_0'$1_Diem_Diem'#0''@0|) (= _$t1 _$t1)) (and (= $t5@0 (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| _$t0))) (= (ControlFlow 0 1001319) 1001313)))) inline$$Ge$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 1001199) 1001319)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (|l#Vec_28308| (|p#$Mutation_13929| $t12)) 0) (= (ControlFlow 0 1001209) 1001199)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 1306712) 1001209) anon0_correct)))
