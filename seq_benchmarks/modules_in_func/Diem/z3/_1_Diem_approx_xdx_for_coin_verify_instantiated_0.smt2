...
(assert (not
 ...
 :qid |Diembpl.7931:15|
 :skolemid |296|
)) (and (=> (= (ControlFlow 0 541433) (- 0 807745)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256249| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256249| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@1)))
 :qid |Diembpl.7936:15|
 :skolemid |297|
 ...
 :qid |Diembpl.7936:15|
 :skolemid |297|
)) (and (=> (= (ControlFlow 0 541433) (- 0 807770)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 541433) (- 0 807791)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256696| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256696| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@3))))
 :qid |Diembpl.7946:15|
 :skolemid |298|
 ...
 :qid |Diembpl.7946:15|
 :skolemid |298|
)) (and (=> (= (ControlFlow 0 541433) (- 0 807820)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256696| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_256696| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@5)))
 :qid |Diembpl.7951:15|
 :skolemid |299|
 ...
 :qid |Diembpl.7966:15|
 :skolemid |300|
)) (=> (= (ControlFlow 0 541433) (- 0 807923)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262172| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_262172| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@9)))
 :qid |Diembpl.7971:15|
 :skolemid |301|
))))))))))))))))))))))))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (and (and (not false) (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1|)) (and (= $t4 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $t6  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4) 1) |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4) 2) (div |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| 2) (+ 18446744073709551615 1)))) 18446744073709551615))))) (and (=> (= (ControlFlow 0 541145) 541479) anon7_Then_correct) (=> (= (ControlFlow 0 541145) 541433) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((|inline$$1_Diem_value'$1_XUS_XUS'$0$anon0_correct|  (=> (= _$t0 _$t0) (=> (and (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| (|$value#$1_Diem_Diem'$1_XUS_XUS'| _$t0)) (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1|)) (and (=> (= (ControlFlow 0 541091) 541499) anon6_Then_correct) (=> (= (ControlFlow 0 541091) 541145) anon6_Else_correct))))))
...
))) (and (= _$t0 _$t0) (= (ControlFlow 0 541097) 541091)))) |inline$$1_Diem_value'$1_XUS_XUS'$0$anon0_correct|)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 540825) 541097)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 807299) 540825) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))
))
(check-sat)
(pop 1)
