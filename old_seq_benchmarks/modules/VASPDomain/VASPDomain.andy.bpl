...
L7:
    ...
    assert {:msg "assert_failed(34,6687,6828): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$ResourceExists($1_VASPDomain_VASPDomains_$memory#120, $t1) && $IsEqual'u8'(5, $t17)) || (!$1_VASPDomain_$tc_domain_manager_exists($1_VASPDomain_VASPDomainManager_$memory#121) && $IsEqual'u8'(5, $t17))) || ($ContainsVec'$1_VASPDomain_VASPDomain'($t11, $1_VASPDomain_VASPDomain($t2)) && $IsEqual'u8'(7, $t17))) || (!$ResourceExists($1_Roles_RoleId_$memory#122, $t12) && $IsEqual'u8'(5, $t17))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t12)), 1) && $IsEqual'u8'(3, $t17))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t17))) || (($1_Vector_$length'u8'($t2) > 63) && $IsEqual'u8'(7, $t17)));
...
L3:
    ...
    assert {:msg "assert_failed(34,10875,11071): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$ResourceExists($1_VASPDomain_VASPDomains_$memory#104, $t0) && $IsEqual'u8'(5, $t10)) || (($1_Vector_$length'u8'($t1) > 63) && $IsEqual'u8'(7, $t10)));
...
L3:
    ...
    assert {:msg "assert_failed(34,3325,3577): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$ResourceExists($1_Roles_RoleId_$memory#105, $t4) && $IsEqual'u8'(5, $t7)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#105, $t4)), 5) && $IsEqual'u8'(3, $t7))) || ($1_VASPDomain_$has_vasp_domains($1_VASPDomain_VASPDomains_$memory#106, $t3) && $IsEqual'u8'(6, $t7)));
...
L7:
    ...
    assert {:msg "assert_failed(34,9145,9298): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$ResourceExists($1_VASPDomain_VASPDomains_$memory#123, $t1) && $IsEqual'u8'(5, $t17)) || (!$1_VASPDomain_$tc_domain_manager_exists($1_VASPDomain_VASPDomainManager_$memory#124) && $IsEqual'u8'(5, $t17))) || (!$ContainsVec'$1_VASPDomain_VASPDomain'($t11, $1_VASPDomain_VASPDomain($t2)) && $IsEqual'u8'(7, $t17))) || (!$ResourceExists($1_Roles_RoleId_$memory#125, $t12) && $IsEqual'u8'(5, $t17))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t12)), 1) && $IsEqual'u8'(3, $t17))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t17))) || (($1_Vector_$length'u8'($t2) > 63) && $IsEqual'u8'(7, $t17)));
