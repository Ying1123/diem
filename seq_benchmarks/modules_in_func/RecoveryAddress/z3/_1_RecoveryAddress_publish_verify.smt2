...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 506323) (let ((anon26_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 369943) (- 0 507404)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr1) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr1))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr1)) 0)) addr1))))
 :qid |RecoveryAddressbpl.21988:15|
 :skolemid |554|
))) (=> (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr1@@0) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr1@@0))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr1@@0)) 0)) addr1@@0))))
 :qid |RecoveryAddressbpl.21988:15|
 :skolemid |554|
)) (and (=> (= (ControlFlow 0 369943) (- 0 507451)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@0)))
 :qid |RecoveryAddressbpl.21994:15|
 :skolemid |555|
))) (=> (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@1)))
 :qid |RecoveryAddressbpl.21994:15|
 :skolemid |555|
)) (and (=> (= (ControlFlow 0 369943) (- 0 507475)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@2)))
 :qid |RecoveryAddressbpl.22000:15|
 :skolemid |556|
))) (=> (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@3)))
 :qid |RecoveryAddressbpl.22000:15|
 :skolemid |556|
)) (and (=> (= (ControlFlow 0 369943) (- 0 507499)) (forall ((recovery_addr Int) (to_recovery_addr Int) ) (!  (=> (|$IsValid'address'| recovery_addr) (=> (|$IsValid'address'| to_recovery_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr) (=> (exists ((i@@56 Int) ) (!  (and (and (|$IsValid'u64'| i@@56) (and (<= 0 i@@56) (< i@@56 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr)) i@@56)) to_recovery_addr))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
)) (exists ((i@@57 Int) ) (!  (and (and (|$IsValid'u64'| i@@57) (and (<= 0 i@@57) (< i@@57 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) recovery_addr)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) recovery_addr)) i@@57)) to_recovery_addr))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
))))))
 :qid |RecoveryAddressbpl.22006:15|
 :skolemid |557|
))) (=> (forall ((recovery_addr@@0 Int) (to_recovery_addr@@0 Int) ) (!  (=> (|$IsValid'address'| recovery_addr@@0) (=> (|$IsValid'address'| to_recovery_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@0) (=> (exists ((i@@58 Int) ) (!  (and (and (|$IsValid'u64'| i@@58) (and (<= 0 i@@58) (< i@@58 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@0)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@0)) i@@58)) to_recovery_addr@@0))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
)) (exists ((i@@59 Int) ) (!  (and (and (|$IsValid'u64'| i@@59) (and (<= 0 i@@59) (< i@@59 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) recovery_addr@@0)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) recovery_addr@@0)) i@@59)) to_recovery_addr@@0))
 :qid |RecoveryAddressbpl.21640:13|
 :skolemid |544|
))))))
 :qid |RecoveryAddressbpl.22006:15|
 :skolemid |557|
)) (and (=> (= (ControlFlow 0 369943) (- 0 507540)) (forall ((recovery_addr@@1 Int) ) (!  (=> (|$IsValid'address'| recovery_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) recovery_addr@@1) (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) recovery_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) recovery_addr@@1))))
 :qid |RecoveryAddressbpl.22012:15|
 :skolemid |558|
))) (=> (forall ((recovery_addr@@2 Int) ) (!  (=> (|$IsValid'address'| recovery_addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) recovery_addr@@2) (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) recovery_addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) recovery_addr@@2))))
 :qid |RecoveryAddressbpl.22012:15|
 :skolemid |558|
)) (and (=> (= (ControlFlow 0 369943) (- 0 507570)) (not (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t9) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) $t9))))) (=> (not (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t9) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) $t9)))) (and (=> (= (ControlFlow 0 369943) (- 0 507583)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) $t9))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) $t9)) (and (=> (= (ControlFlow 0 369943) (- 0 507593)) (not (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1) $t9)))) (=> (not (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1) $t9))) (and (=> (= (ControlFlow 0 369943) (- 0 507607)) (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10) (and (=> (= (ControlFlow 0 369943) (- 0 507615)) (= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10))) 1)) (=> (= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10))) 1) (=> (= (ControlFlow 0 369943) (- 0 507629)) (= (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10)) 0) _$t1)))))))))))))))))))))))))
...
(let ((L7_correct  (and (=> (= (ControlFlow 0 368914) (- 0 507320)) (or (or (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t9) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) $t9))) (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) $t9)) (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1) $t9)))) (=> (or (or (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t9) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) $t9))) (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) $t9)) (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1) $t9))) (=> (= (ControlFlow 0 368914) (- 0 507346)) (or (or (and (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t9) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) $t9))) (= 7 $t15@0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) $t9) (= 6 $t15@0))) (and (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1) $t9)) (= 7 $t15@0))))))))
(let ((anon26_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 369957) 368914))) L7_correct)))
(let ((anon25_Then$1_correct  (=> (= $1_RecoveryAddress_RecoveryAddress_$memory@1 $1_RecoveryAddress_RecoveryAddress_$memory) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= $abort_flag@1 true)) (and (=> (= (ControlFlow 0 370009) 369957) anon26_Then_correct) (=> (= (ControlFlow 0 370009) 369943) anon26_Else_correct))))))
(let ((anon25_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 370007) 370009)) anon25_Then$1_correct)))
(let ((anon25_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_RecoveryAddress_RecoveryAddress_$memory@0 ($Memory_170774 (|Store__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0) $t25@0))) (= $1_RecoveryAddress_RecoveryAddress_$memory@1 $1_RecoveryAddress_RecoveryAddress_$memory@0)) (and (= $abort_code@1 $abort_code@0) (= $abort_flag@1 $abort_flag@0))) (and (=> (= (ControlFlow 0 369688) 369957) anon26_Then_correct) (=> (= (ControlFlow 0 369688) 369943) anon26_Else_correct))))))
(let ((anon24_Else_correct  (=> (and (and (not $abort_flag@0) (= $t25@0 ($1_RecoveryAddress_RecoveryAddress |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$ret0@1|))) (and (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr1@@1) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr1@@1))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) addr1@@1)) 0)) addr1@@1))))
...
(let ((anon24_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@0 $abort_code@0)) (and (= $t15@0 $abort_code@0) (= (ControlFlow 0 370023) 368914))) L7_correct)))
(let ((|inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon6_Else_correct|  (=> (not false) (=> (and (and (= |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1| (|v#$Mutation_107079| |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1|)) (= |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1|)) (and (= $abort_flag@0 false) (= |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$ret0@1| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1|))) (and (=> (= (ControlFlow 0 369536) 370023) anon24_Then_correct) (=> (= (ControlFlow 0 369536) 369666) anon24_Else_correct))))))
(let ((|inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| ($Mutation_107079 (|l#$Mutation_107079| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1|) (|p#$Mutation_107079| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1|) (seq.++ (|v#$Mutation_107079| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1|) (seq.unit _$t1)))) (and (=> (= (ControlFlow 0 369504) 369550) |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon6_Then_correct|) (=> (= (ControlFlow 0 369504) 369536) |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon6_Else_correct|)))))
...
(let ((|inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= (seq.len (|p#$Mutation_107079| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@0|)) 0) (=> (and (= _$t1 _$t1) (= (ControlFlow 0 369427) 369421)) |inline$$1_Vector_empty'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((anon23_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 369576) 369427)) |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|)))
(let ((anon23_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t23 $t23)) (and (= $t15@0 $t23) (= (ControlFlow 0 369171) 368914))) L7_correct)))
(let ((anon22_Then$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| $t23) (= $t23 6)) (and (= $t23 $t23) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 369155) 369576) anon23_Then_correct) (=> (= (ControlFlow 0 369155) 369171) anon23_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t20@0)) (= (ControlFlow 0 369119) 369155)) anon22_Then$1_correct)))
(let ((anon22_Then_correct  (=> $t17@0 (=> (and (= $t20@0 (|Select__T@[Int]Bool_| (|domain#$Memory_170774| $1_RecoveryAddress_RecoveryAddress_$memory) $t11)) (= (ControlFlow 0 369125) 369119)) inline$$Not$0$anon0_correct))))
(let ((anon22_Else_correct  (=> (and (and (not $t17@0) (= $t19 $t19)) (and (= $t15@0 $t19) (= (ControlFlow 0 369079) 368914))) L7_correct)))
(let ((anon21_Else_correct  (=> (not false) (=> (and (= $t17@0 (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 $t11)) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t19) (= $t19 7)) (and (= $t19 $t19) (= $t17@0 $t17@0))) (and (=> (= (ControlFlow 0 369063) 369125) anon22_Then_correct) (=> (= (ControlFlow 0 369063) 369079) anon22_Else_correct)))))))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= _$t1 _$t1) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 369011) 370037) anon21_Then_correct) (=> (= (ControlFlow 0 369011) 369063) anon21_Else_correct))))))
(let ((anon20_Then_correct  (=> (and $t12 (= (ControlFlow 0 369017) 369011)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct)))
(let ((anon20_Else_correct  (=> (and (and (not $t12) (= $t14 $t14)) (and (= $t15@0 $t14) (= (ControlFlow 0 368822) 368914))) L7_correct)))
(let ((anon0$1_correct  (=> (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) child_addr)))))
 ...
 :skolemid |548|
))) (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (|$IsValid'$1_DiemAccount_KeyRotationCapability'| _$t1))) (=> (and (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_167668| $1_VASP_ChildVASP_$memory) $a_0)))
...
)) (= $t9 (|$addr#$signer| _$t0)))) (and (and (= $t10 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| $t11)))) (and (and (and (= $t11 (|$addr#$signer| _$t0)) (= $t11 $t11)) (and (= $t12  (or (|Select__T@[Int]Bool_| (|domain#$Memory_167732| $1_VASP_ParentVASP_$memory) $t11) (|Select__T@[Int]Bool_| (|domain#$Memory_167668| $1_VASP_ChildVASP_$memory) $t11))) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14) (= $t14 7)) (and (= $t14 $t14) (= $t12 $t12))))) (and (=> (= (ControlFlow 0 368806) 369017) anon20_Then_correct) (=> (= (ControlFlow 0 368806) 368822) anon20_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_102812_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |RecoveryAddressbpl.3268:13|
 :skolemid |89|
))) (= (ControlFlow 0 368537) 368806)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 506323) 368537) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
