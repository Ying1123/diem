...
L7:
    ...
    assert {:msg "assert_failed(33,3962,4513): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#117, $1_VASP_ParentVASP_$memory#118, $t11) && $IsEqual'num'(6, $t16)) || (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#118, $t12) && $IsEqual'num'(7, $t16))) || ((($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#118, $t12) + 1) > 65536) && $IsEqual'num'(8, $t16))) || (!$ResourceExists($1_Roles_RoleId_$memory#119, $t13) && $IsEqual'num'(5, $t16))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#119, $t13)), 5) && $IsEqual'num'(3, $t16))) || (!$ResourceExists($1_Roles_RoleId_$memory#119, $t11) && $IsEqual'num'(5, $t16))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#119, $t11)), 6) && $IsEqual'num'(3, $t16)));
...
L3:
    ...
    assert {:msg "assert_failed(33,2367,2787): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139) && $IsEqual'num'(1, $t9)) || (!$ResourceExists($1_Roles_RoleId_$memory#140, $t6) && $IsEqual'num'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#140, $t6)), 1) && $IsEqual'num'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453) && $IsEqual'num'(2, $t9))) || (!$ResourceExists($1_Roles_RoleId_$memory#140, $t7) && $IsEqual'num'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#140, $t7)), 5) && $IsEqual'num'(3, $t9))) || ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#141, $1_VASP_ParentVASP_$memory#142, $t5) && $IsEqual'num'(6, $t9)));
...
L7:
    ...
    assert {:msg "assert_failed(24,3293,3378): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#98, $1_VASP_ParentVASP_$memory#99, $t9) && $IsEqual'num'(7, $t15)) || ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#100, $t9) && $IsEqual'num'(6, $t15))) || (!$IsEqual'address'($1_DiemAccount_$key_rotation_capability_address($t1), $t9) && $IsEqual'num'(7, $t15)));
...
L17:
    ...
    assert {:msg "assert_failed(24,6074,6209): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((!$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#113, $t1) && $IsEqual'num'(5, $t17)) || (!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#114, $t2) && $IsEqual'num'(5, $t17))) || (!$IsEqual'num'(LenVec($t3), 32) && $IsEqual'num'(7, $t17))) || (!$1_RecoveryAddress_spec_holds_key_rotation_cap_for($1_RecoveryAddress_RecoveryAddress_$memory#113, $t1, $t2) && $IsEqual'num'(7, $t17))) || (!($IsEqual'address'($1_Signer_spec_address_of($t0), $t1) || $IsEqual'address'($1_Signer_spec_address_of($t0), $t2)) && $IsEqual'num'(7, $t17)));
...
L7:
    ...
    assert {:msg "assert_failed(24,8320,8449): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#120, $t1) && $IsEqual'num'(5, $t14)) || ((LenVec($rotation_caps#$1_RecoveryAddress_RecoveryAddress($ResourceValue($1_RecoveryAddress_RecoveryAddress_$memory#120, $t1))) >= 256) && $IsEqual'num'(8, $t14))) || (!$1_VASP_spec_is_same_vasp($1_VASP_ChildVASP_$memory#121, $1_VASP_ParentVASP_$memory#122, $t1, $t10) && $IsEqual'num'(7, $t14)));
