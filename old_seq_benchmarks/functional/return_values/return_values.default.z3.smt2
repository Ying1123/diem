...
(declare-datatypes ((T@$Mutation_7865 0)) ((($Mutation_7865 (|l#$Mutation_7865| T@$Location) (|p#$Mutation_7865| T@Vec_2977) (|v#$Mutation_7865| T@Vec_2977) ) ) ))
...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |returnvaluesdefaultz3bpl.190:23|
 :skolemid |6|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |returnvaluesdefaultz3bpl.194:24|
 :skolemid |7|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |returnvaluesdefaultz3bpl.198:25|
 :skolemid |8|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |returnvaluesdefaultz3bpl.202:24|
 :skolemid |9|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |returnvaluesdefaultz3bpl.206:28|
 :skolemid |10|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |returnvaluesdefaultz3bpl.216:19|
 :skolemid |11|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |returnvaluesdefaultz3bpl.482:15|
 :skolemid |15|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |returnvaluesdefaultz3bpl.491:15|
 :skolemid |16|
...
(assert (forall ((v1 T@Vec_2977) (v2 T@Vec_2977) ) (! (= (|$IsEqual'vec'u8''| v1 v2)  (and (= (|l#Vec_2977| v1) (|l#Vec_2977| v2)) (forall ((i@@0 Int) ) (!  (=> (InRangeVec_2977 v1 i@@0) (= (|Select__T@[Int]Int_| (|v#Vec_2977| v1) i@@0) (|Select__T@[Int]Int_| (|v#Vec_2977| v2) i@@0)))
 :qid |returnvaluesdefaultz3bpl.615:13|
 :skolemid |17|
))))
 :qid |returnvaluesdefaultz3bpl.613:28|
 :skolemid |18|
...
(assert (forall ((v@@4 T@Vec_2977) ) (! (= (|$IsValid'vec'u8''| v@@4)  (and (|$IsValid'u64'| (|l#Vec_2977| v@@4)) (forall ((i@@1 Int) ) (!  (=> (InRangeVec_2977 v@@4 i@@1) (|$IsValid'u8'| (|Select__T@[Int]Int_| (|v#Vec_2977| v@@4) i@@1)))
 :qid |returnvaluesdefaultz3bpl.621:13|
 :skolemid |19|
))))
 :qid |returnvaluesdefaultz3bpl.619:28|
 :skolemid |20|
...
(ite  (not (exists ((i@@3 Int) ) (!  (and (and (|$IsValid'u64'| i@@3) (InRangeVec_2977 v@@5 i@@3)) (= (|Select__T@[Int]Int_| (|v#Vec_2977| v@@5) i@@3) e))
 :qid |returnvaluesdefaultz3bpl.626:13|
 :skolemid |21|
 ...
 :qid |returnvaluesdefaultz3bpl.634:17|
 :skolemid |22|
)))))
 :qid |returnvaluesdefaultz3bpl.630:15|
 :skolemid |23|
...
(assert (forall ((v1@@0 T@Vec_2977) (v2@@0 T@Vec_2977) ) (! (= (|$IsEqual'vec'u8''| v1@@0 v2@@0) (|$IsEqual'vec'u8''| ($1_Hash_sha2 v1@@0) ($1_Hash_sha2 v2@@0)))
 :qid |returnvaluesdefaultz3bpl.807:15|
 :skolemid |24|
...
(assert (forall ((v1@@1 T@Vec_2977) (v2@@1 T@Vec_2977) ) (! (= (|$IsEqual'vec'u8''| v1@@1 v2@@1) (|$IsEqual'vec'u8''| ($1_Hash_sha3 v1@@1) ($1_Hash_sha3 v2@@1)))
 :qid |returnvaluesdefaultz3bpl.823:15|
 :skolemid |25|
...
(assert (forall ((k1 T@Vec_2977) (k2 T@Vec_2977) ) (!  (=> (|$IsEqual'vec'u8''| k1 k2) (= ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2)))
 :qid |returnvaluesdefaultz3bpl.870:15|
 :skolemid |26|
...
(ite  (not (exists ((i@@6 Int) ) (!  (and (InRangeVec_2977 v@@7 i@@6) (= (|Select__T@[Int]Int_| (|v#Vec_2977| v@@7) i@@6) e@@0))
 :qid |returnvaluesdefaultz3bpl.109:13|
 :skolemid |0|
 ...
 :qid |returnvaluesdefaultz3bpl.117:17|
 :skolemid |1|
)))))
 :qid |returnvaluesdefaultz3bpl.113:32|
 :skolemid |2|
 :pattern ( (IndexOfVec_2977 v@@7 e@@0))
)))
(assert (forall ((|l#0| Bool) (i@@7 Int) ) (! (= (|Select__T@[Int]Bool_| (|lambda#0| |l#0|) i@@7) |l#0|)
 :qid |returnvaluesdefaultz3bpl.275:54|
 :skolemid |28|
...
(assert (forall ((|l#0@@0| Int) (|l#1| Int) (|l#2| Int) (|l#3| |T@[Int]Int|) (|l#4| |T@[Int]Int|) (|l#5| Int) (|l#6| Int) (i@@8 Int) ) (! (= (|Select__T@[Int]Int_| (|lambda#2| |l#0@@0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6|) i@@8) (ite  (and (>= i@@8 |l#0@@0|) (< i@@8 |l#1|)) (ite (< i@@8 |l#2|) (|Select__T@[Int]Int_| |l#3| i@@8) (|Select__T@[Int]Int_| |l#4| (- i@@8 |l#5|))) |l#6|))
 :qid |returnvaluesdefaultz3bpl.73:19|
 :skolemid |29|
...
(assert (forall ((|l#0@@1| Int) (|l#1@@0| Int) (|l#2@@0| |T@[Int]Int|) (|l#3@@0| Int) (|l#4@@0| Int) (|l#5@@0| Int) (i@@9 Int) ) (! (= (|Select__T@[Int]Int_| (|lambda#3| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0| |l#4@@0| |l#5@@0|) i@@9) (ite  (and (<= |l#0@@1| i@@9) (< i@@9 |l#1@@0|)) (|Select__T@[Int]Int_| |l#2@@0| (- (- |l#3@@0| i@@9) |l#4@@0|)) |l#5@@0|))
 :qid |returnvaluesdefaultz3bpl.82:30|
 :skolemid |30|
...
(assert (forall ((|l#0@@2| Int) (|l#1@@1| Int) (|l#2@@1| Int) (|l#3@@1| |T@[Int]Int|) (|l#4@@1| |T@[Int]Int|) (|l#5@@1| Int) (|l#6@@0| Int) (j@@1 Int) ) (! (= (|Select__T@[Int]Int_| (|lambda#4| |l#0@@2| |l#1@@1| |l#2@@1| |l#3@@1| |l#4@@1| |l#5@@1| |l#6@@0|) j@@1) (ite  (and (>= j@@1 |l#0@@2|) (< j@@1 |l#1@@1|)) (ite (< j@@1 |l#2@@1|) (|Select__T@[Int]Int_| |l#3@@1| j@@1) (|Select__T@[Int]Int_| |l#4@@1| (+ j@@1 |l#5@@1|))) |l#6@@0|))
 :qid |returnvaluesdefaultz3bpl.63:20|
 :skolemid |31|
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12717) (let ((anon0$1_correct  (=> (and (and (|$IsValid'u64'| 1) (|$IsValid'u64'| 2)) (and (= 1 1) (= 2 2))) (and (=> (= (ControlFlow 0 10964) (- 0 12775)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 10964) (- 0 12782)) (= 1 1)) (=> (= 1 1) (=> (= (ControlFlow 0 10964) (- 0 12790)) (= 2 2)))))))))
(let ((anon0_correct  (=> (= (ControlFlow 0 12717) 10964) anon0$1_correct)))
anon0_correct)))
))
(check-sat)
(pop 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12885) (let ((anon4_Else_correct  (=> (not false) (=> (and (= 1 1) (= 2 2)) (and (=> (= (ControlFlow 0 11265) (- 0 13017)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 11265) (- 0 13024)) (= 1 1)) (=> (= 1 1) (=> (= (ControlFlow 0 11265) (- 0 13032)) (= 2 2))))))))))
(let ((anon4_Then_correct true))
(let ((inline$$42_TestReturnValue_one_two$0$anon0_correct  (=> (and (and (|$IsValid'u64'| 1) (|$IsValid'u64'| 2)) (and (= 1 1) (= 2 2))) (and (=> (= (ControlFlow 0 11209) 11287) anon4_Then_correct) (=> (= (ControlFlow 0 11209) 11265) anon4_Else_correct)))))
(let ((anon0$1_correct  (=> (= (ControlFlow 0 11217) 11209) inline$$42_TestReturnValue_one_two$0$anon0_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 12885) 11217) anon0$1_correct)))
anon0_correct))))))
))
(check-sat)
(pop 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13051) (let ((anon4_Else_correct  (=> (not false) (=> (and (= 1 1) (= 2 2)) (and (=> (= (ControlFlow 0 11524) (- 0 13187)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 11524) (- 0 13194)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 11524) (- 0 13201)) (= 1 2)) (=> (= 1 2) (and (=> (= (ControlFlow 0 11524) (- 0 13209)) (= 2 1)) (=> (= 2 1) (and (=> (= (ControlFlow 0 11524) (- 0 13217)) (= 1 2)) (=> (= 1 2) (=> (= (ControlFlow 0 11524) (- 0 13225)) (= 2 1))))))))))))))))
(let ((anon4_Then_correct true))
(let ((inline$$42_TestReturnValue_one_two$0$anon0_correct  (=> (and (and (|$IsValid'u64'| 1) (|$IsValid'u64'| 2)) (and (= 1 1) (= 2 2))) (and (=> (= (ControlFlow 0 11446) 11550) anon4_Then_correct) (=> (= (ControlFlow 0 11446) 11524) anon4_Else_correct)))))
(let ((anon0$1_correct  (=> (= (ControlFlow 0 11454) 11446) inline$$42_TestReturnValue_one_two$0$anon0_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 13051) 11454) anon0$1_correct)))
anon0_correct))))))
))
(check-sat)
...
(get-value ((ControlFlow 0 11454)))
(get-value ((ControlFlow 0 11446)))
(get-value ((ControlFlow 0 11524)))
(assert (not (= (ControlFlow 0 11524) (- 13201))))
(check-sat)
(pop 1)
; Invalid
(reset)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13240) (let ((anon0$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (= true true) (= 1 1)) (and (=> (= (ControlFlow 0 11658) (- 0 13298)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 11658) (- 0 13305)) (= true true)) (=> (= true true) (=> (= (ControlFlow 0 11658) (- 0 13313)) (= 1 1))))))))))
(let ((anon0_correct  (=> (= (ControlFlow 0 13240) 11658) anon0$1_correct)))
anon0_correct)))
))
(check-sat)
(pop 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13331) (let ((anon4_Else_correct  (=> (not false) (=> (and (= true true) (= 1 1)) (and (=> (= (ControlFlow 0 11867) (- 0 13458)) (= true true)) (=> (= true true) (=> (= (ControlFlow 0 11867) (- 0 13466)) (= 1 1))))))))
(let ((anon4_Then_correct true))
(let ((inline$$42_TestReturnValue_true_one$0$anon0_correct  (=> (|$IsValid'u64'| 1) (=> (and (= true true) (= 1 1)) (and (=> (= (ControlFlow 0 11817) 11885) anon4_Then_correct) (=> (= (ControlFlow 0 11817) 11867) anon4_Else_correct))))))
(let ((anon0$1_correct  (=> (= (ControlFlow 0 11825) 11817) inline$$42_TestReturnValue_true_one$0$anon0_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 13331) 11825) anon0$1_correct)))
anon0_correct))))))
))
(check-sat)
(pop 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13485) (let ((anon4_Else_correct  (=> (and (and (not false) (= true true)) (and (= 1 1) (= (ControlFlow 0 12114) (- 0 13612)))) false)))
(let ((anon4_Then_correct true))
(let ((inline$$42_TestReturnValue_true_one$0$anon0_correct  (=> (|$IsValid'u64'| 1) (=> (and (= true true) (= 1 1)) (and (=> (= (ControlFlow 0 12044) 12132) anon4_Then_correct) (=> (= (ControlFlow 0 12044) 12114) anon4_Else_correct))))))
(let ((anon0$1_correct  (=> (= (ControlFlow 0 12052) 12044) inline$$42_TestReturnValue_true_one$0$anon0_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 13485) 12052) anon0$1_correct)))
anon0_correct))))))
))
(check-sat)
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 13485)))
(get-value ((ControlFlow 0 12052)))
(get-value ((ControlFlow 0 12044)))
(get-value ((ControlFlow 0 12114)))
(assert (not (= (ControlFlow 0 12114) (- 13612))))
(check-sat)
(pop 1)
; Invalid
