...
(assert (not
 (=> (= (ControlFlow 0 0) 215322) (let ((L3_correct@@0  (and (=> (= (ControlFlow 0 155996) (- 0 215533)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (= (ControlFlow 0 155996) (- 0 215538)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t3@0@@0)))))))
(let ((anon7_Else_correct@@0  (=> (and (and (not inline$$1_DiemTimestamp_is_operating$0$$t1@1) (= $t5@@0 $t5@@0)) (and (= $t3@0@@0 $t5@@0) (= (ControlFlow 0 155968) 155996))) L3_correct@@0)))
(let ((anon7_Then_correct@@0  (=> (and inline$$1_DiemTimestamp_is_operating$0$$t1@1 (= (ControlFlow 0 156012) (- 0 215498))) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))
(let ((anon6_Else_correct@@0  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t5@@0) (= $t5@@0 1)) (and (= $t5@@0 $t5@@0) (= inline$$1_DiemTimestamp_is_operating$0$$t1@1 inline$$1_DiemTimestamp_is_operating$0$$t1@1))) (and (=> (= (ControlFlow 0 155952) 156012) anon7_Then_correct@@0) (=> (= (ControlFlow 0 155952) 155968) anon7_Else_correct@@0))))))
(let ((anon6_Then_correct@@0 true))
(let ((inline$$1_DiemTimestamp_is_operating$0$anon0_correct  (=> (|$IsValid'address'| 173345816) (=> (and (= inline$$1_DiemTimestamp_is_operating$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= inline$$1_DiemTimestamp_is_operating$0$$t1@1 inline$$1_DiemTimestamp_is_operating$0$$t1@1)) (and (=> (= (ControlFlow 0 155910) 156026) anon6_Then_correct@@0) (=> (= (ControlFlow 0 155910) 155952) anon6_Else_correct@@0))))))
(let ((anon0$1_correct@@0  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@0))
 :qid |DiemTimestampbpl.3571:20|
 :skolemid |122|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@0))
)) (= (ControlFlow 0 155916) 155910)) inline$$1_DiemTimestamp_is_operating$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_65544_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_65544| stream@@1) 0) (forall ((v@@41 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_65544| stream@@1) v@@41) 0)
 :qid |DiemTimestampbpl.159:13|
 :skolemid |4|
))))
 :qid |DiemTimestampbpl.2406:13|
 :skolemid |84|
))) (= (ControlFlow 0 155779) 155916)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 215322) 155779) inline$$InitEventStore$0$anon0_correct@@0)))
anon0_correct@@0))))))))))
))
(check-sat)
(pop 1)
