...
(assert (not
 (=> (= (ControlFlow 0 0) 270031) (let ((anon19_Else_correct@@1  (=> (and (and (not $t17@@0) (|$IsValid'address'| $t16@@1)) (and (= $t16@@1 (|Select__T@[Int]Int_| (|v#Vec_26921| (|$vec#$1_Option_Option'address'| $t15@0)) 0)) (= $t16@@1 $t16@@1))) (and (=> (= (ControlFlow 0 198341) (- 0 270576)) (not (not (not (= (|l#Vec_26921| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)))) 0))))) (=> (not (not (not (= (|l#Vec_26921| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)))) 0)))) (and (=> (= (ControlFlow 0 198341) (- 0 270587)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12))) (and (=> (= (ControlFlow 0 198341) (- 0 270598)) (= $t16@@1 (let ((t_ref@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)))
(|Select__T@[Int]Int_| (|v#Vec_26921| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@1))) 0)))) (=> (= $t16@@1 (let ((t_ref@@2 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)))
(|Select__T@[Int]Int_| (|v#Vec_26921| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@2))) 0))) (=> (= (ControlFlow 0 198341) (- 0 270610)) (forall ((addr1@@4 Int) ) (!  (=> (|$IsValid'address'| addr1@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@4) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@4))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@4))))))
 :qid |ValidatorConfigbpl.7424:15|
 :skolemid |228|
))))))))))))
(let ((L5_correct@@0  (and (=> (= (ControlFlow 0 198130) (- 0 270501)) (or (not (not (= (|l#Vec_26921| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)))) (=> (or (not (not (= (|l#Vec_26921| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12))) (=> (= (ControlFlow 0 198130) (- 0 270515)) (or (and (not (not (= (|l#Vec_26921| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)))) 0))) (= 7 $t9@0@@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)) (= 5 $t9@0@@0))))))))
(let ((anon19_Then_correct@@1  (=> $t17@@0 (=> (and (and (and (= (|l#Vec_26921| (|$vec#$1_Option_Option'address'| $t15@0)) 0) (= 7 $t9@@8)) (= $t9@@8 $t9@@8)) (and (= $t9@0@@0 $t9@@8) (= (ControlFlow 0 198365) 198130))) L5_correct@@0))))
(let ((anon18_Then_correct@@1  (=> $t12@@0 (=> (and (= $t15@0 (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $t10@1@@0)) (= $t17@@0 (= (|l#Vec_26921| (|$vec#$1_Option_Option'address'| $t15@0)) 0))) (and (=> (= (ControlFlow 0 198240) 198365) anon19_Then_correct@@1) (=> (= (ControlFlow 0 198240) 198341) anon19_Else_correct@@1))))))
(let ((anon18_Else_correct@@1  (=> (and (and (not $t12@@0) (= $t14@@0 $t14@@0)) (and (= $t9@0@@0 $t14@@0) (= (ControlFlow 0 198224) 198130))) L5_correct@@0)))
(let ((anon17_Else_correct@@2  (=> (not $abort_flag@0@@3) (=> (and (and (and (= $t10@1@@0 $t10@1@@0) (= $t11@0@@1 (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $t10@1@@0))) (and (= $t12@@0  (not (= (|l#Vec_26921| (|$vec#$1_Option_Option'address'| $t11@0@@1)) 0))) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14@@0) (= $t14@@0 7)) (and (= $t14@@0 $t14@@0) (= $t12@@0 $t12@@0)))) (and (=> (= (ControlFlow 0 198208) 198240) anon18_Then_correct@@1) (=> (= (ControlFlow 0 198208) 198224) anon18_Else_correct@@1))))))
(let ((anon17_Then_correct@@2  (=> (and (and $abort_flag@0@@3 (= $abort_code@1@@3 $abort_code@1@@3)) (and (= $t9@0@@0 $abort_code@1@@3) (= (ControlFlow 0 198379) 198130))) L5_correct@@0)))
(let ((anon16_Then$1_correct  (=> (= $t10@1@@0 $t10@@2) (=> (and (= $abort_flag@0@@3 true) (= $abort_code@1@@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 198431) 198379) anon17_Then_correct@@2) (=> (= (ControlFlow 0 198431) 198208) anon17_Else_correct@@2))))))
(let ((anon16_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)) (= (ControlFlow 0 198429) 198431)) anon16_Then$1_correct)))
(let ((anon16_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12) (=> (and (and (= $t10@0@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)) (= $t10@1@@0 $t10@0@@1)) (and (= $abort_flag@0@@3 false) (= $abort_code@1@@3 $abort_code@0@@3))) (and (=> (= (ControlFlow 0 198148) 198379) anon17_Then_correct@@2) (=> (= (ControlFlow 0 198148) 198208) anon17_Else_correct@@2))))))
(let ((anon15_Then_correct@@0  (=> $t6@0@@0 (and (=> (= (ControlFlow 0 198134) 198429) anon16_Then_correct@@1) (=> (= (ControlFlow 0 198134) 198148) anon16_Else_correct@@1)))))
(let ((anon15_Else_correct@@0  (=> (and (and (not $t6@0@@0) (= $t8@@6 $t8@@6)) (and (= $t9@0@@0 $t8@@6) (= (ControlFlow 0 198070) 198130))) L5_correct@@0)))
(let ((anon0$1_correct@@12  (=> (and (and (forall ((addr@@105 Int) ) (!  (=> (|$IsValid'address'| addr@@105) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@105) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@105) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@105)) 3))))
 :qid |ValidatorConfigbpl.7211:20|
 :skolemid |224|
)) (forall ((addr@@106 Int) ) (!  (=> (|$IsValid'address'| addr@@106) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@106) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@106) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@106)) 3))))
 :qid |ValidatorConfigbpl.7215:20|
 :skolemid |225|
))) (and (forall ((addr@@107 Int) ) (!  (=> (|$IsValid'address'| addr@@107) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@107) (not (= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@107)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@107) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@107)) 3))))
 :qid |ValidatorConfigbpl.7219:20|
 :skolemid |226|
)) (|$IsValid'address'| _$t0@@12))) (=> (and (and (and (forall (($a_0@@15 Int) ) (! (let (($rsc@@15 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@15)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@15) (and (<= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@15))) 1) (<= (|l#Vec_26921| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@15))) 1))))
 :qid |ValidatorConfigbpl.7226:20|
 :skolemid |227|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@15))
)) (= _$t0@@12 _$t0@@12)) (and (= $t6@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@12)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t8@@6) (= $t8@@6 5)) (and (= $t8@@6 $t8@@6) (= $t6@0@@0 $t6@0@@0)))) (and (=> (= (ControlFlow 0 198054) 198134) anon15_Then_correct@@0) (=> (= (ControlFlow 0 198054) 198070) anon15_Else_correct@@0))))))
(let ((inline$$InitEventStore$0$anon0_correct@@12  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@14 T@$1_Event_EventHandle) ) (! (let ((stream@@13 (|Select__T@[$1_Event_EventHandle]Multiset_77784_| (|streams#$EventStore| $es) handle@@14)))
 (and (= (|l#Multiset_77784| stream@@13) 0) (forall ((v@@57 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_77784| stream@@13) v@@57) 0)
 :qid |ValidatorConfigbpl.159:13|
 :skolemid |4|
))))
 :qid |ValidatorConfigbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 197869) 198054)) anon0$1_correct@@12)))
(let ((anon0_correct@@12  (=> (= (ControlFlow 0 270031) 197869) inline$$InitEventStore$0$anon0_correct@@12)))
anon0_correct@@12))))))))))))))))
))
(check-sat)
(pop 1)
