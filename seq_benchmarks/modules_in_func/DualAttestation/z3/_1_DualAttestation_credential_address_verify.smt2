...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 317393) (let ((anon7_Then_correct  (=> $t4 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161035| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_160971| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 $t5)) (and (= $t5 $t5) (= (ControlFlow 0 236779) (- 0 317619)))) false))))
(let ((L3_correct  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 236677) (- 0 317676)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 236677) (- 0 317683)) (= $t1@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_160971| $1_VASP_ChildVASP_$memory) _$t0) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_161035| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_160971| $1_VASP_ChildVASP_$memory) _$t0))) _$t0))) (=> (= $t1@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_160971| $1_VASP_ChildVASP_$memory) _$t0) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_161035| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_160971| $1_VASP_ChildVASP_$memory) _$t0))) _$t0)) (and (=> (= (ControlFlow 0 236677) (- 0 317696)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1) (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1)))
 :qid |DualAttestationbpl.15346:15|
 :skolemid |325|
 ...
 :qid |DualAttestationbpl.15346:15|
 :skolemid |325|
)) (and (=> (= (ControlFlow 0 236677) (- 0 317721)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1))))
 :qid |DualAttestationbpl.15351:15|
 :skolemid |326|
 ...
 :qid |DualAttestationbpl.15361:15|
 :skolemid |327|
)) (=> (= (ControlFlow 0 236677) (- 0 317803)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5) (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)))))
 :qid |DualAttestationbpl.15366:15|
 :skolemid |328|
))))))))))))))))))
(let ((anon7_Else_correct  (=> (and (not $t4) (|$IsValid'address'| $t3)) (=> (and (and (= $t3 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_161035| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_160971| $1_VASP_ChildVASP_$memory) _$t0)))) (= $t3 $t3)) (and (= $t1@0 $t3) (= (ControlFlow 0 236733) 236677))) L3_correct))))
(let ((anon6_Then_correct  (=> (and $t2 (= $t4  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161035| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_160971| $1_VASP_ChildVASP_$memory) _$t0))))) (and (=> (= (ControlFlow 0 236703) 236779) anon7_Then_correct) (=> (= (ControlFlow 0 236703) 236733) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (and (not $t2) (= _$t0 _$t0)) (and (= $t1@0 _$t0) (= (ControlFlow 0 236499) 236677))) L3_correct)))
(let ((anon0$1_correct  (=> (and (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_160971| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_161035| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_160971| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |DualAttestationbpl.15220:20|
 :skolemid |322|
)) (|$IsValid'address'| _$t0)) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_160971| $1_VASP_ChildVASP_$memory) $a_0)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc))
 :qid |DualAttestationbpl.15227:20|
 :skolemid |323|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_160971| $1_VASP_ChildVASP_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_161035| $1_VASP_ParentVASP_$memory) $a_0@@0)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@0))
 :qid |DualAttestationbpl.15231:20|
 :skolemid |324|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_161035| $1_VASP_ParentVASP_$memory) $a_0@@0))
))) (and (= _$t0 _$t0) (= $t2 (|Select__T@[Int]Bool_| (|domain#$Memory_160971| $1_VASP_ChildVASP_$memory) _$t0)))) (and (=> (= (ControlFlow 0 236485) 236703) anon6_Then_correct) (=> (= (ControlFlow 0 236485) 236499) anon6_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2787:13|
 :skolemid |79|
))) (= (ControlFlow 0 236364) 236485)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 317393) 236364) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))
))
(check-sat)
(pop 1)
