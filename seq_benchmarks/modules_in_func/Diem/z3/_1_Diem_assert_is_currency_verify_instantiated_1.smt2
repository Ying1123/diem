...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1069165) (let ((L3_correct  (and (=> (= (ControlFlow 0 708154) (- 0 1069879)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (=> (= (ControlFlow 0 708154) (- 0 1069884)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t3@0)))))))
(let ((anon7_Else_correct  (=> (and (and (not |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|) (= $t5 $t5)) (and (= $t3@0 $t5) (= (ControlFlow 0 708126) 708154))) L3_correct)))
(let ((anon7_Then_correct  (=> |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (and (=> (= (ControlFlow 0 708450) (- 0 1069570)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 708450) (- 0 1069580)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 708450) (- 0 1069601)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@0))))
 ...
 :qid |Diembpl.12344:15|
 :skolemid |531|
)) (and (=> (= (ControlFlow 0 708450) (- 0 1069630)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@2)))
 ...
 :qid |Diembpl.12349:15|
 :skolemid |532|
)) (and (=> (= (ControlFlow 0 708450) (- 0 1069655)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 708450) (- 0 1069676)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307813| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307813| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@4))))
 ...
 :qid |Diembpl.12359:15|
 :skolemid |533|
)) (and (=> (= (ControlFlow 0 708450) (- 0 1069705)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307813| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_307813| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@6)))
 ...
 :qid |Diembpl.12379:15|
 :skolemid |535|
)) (and (=> (= (ControlFlow 0 708450) (- 0 1069808)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308136| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_308136| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@10)))
...
(let ((anon6_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|))) (and (=> (= (ControlFlow 0 708110) 708450) anon7_Then_correct) (=> (= (ControlFlow 0 708110) 708126) anon7_Else_correct))))))
(let ((anon6_Then_correct true))
(let ((|inline$$1_Diem_is_currency'$1_XDX_XDX'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|)) (and (=> (= (ControlFlow 0 708068) 708464) anon6_Then_correct) (=> (= (ControlFlow 0 708068) 708110) anon6_Else_correct))))))
...
)) (= (ControlFlow 0 708074) 708068)))) |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$anon0_correct|)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 707720) 708074)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1069165) 707720) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))
))
(check-sat)
(pop 1)
