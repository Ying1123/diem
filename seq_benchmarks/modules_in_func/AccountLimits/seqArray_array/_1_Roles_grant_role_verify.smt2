...
(assert (not
 (=> (= (ControlFlow 0 0) 393306) (let ((anon12_Else_correct@@0  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 277119) (- 0 393857)) (and (and (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@11) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@11)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@11)) 6)))))
 :qid |AccountLimitsbpl.4256:17|
 :skolemid |143|
)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@12) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@12) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@12)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@12)) 6)))))
 :qid |AccountLimitsbpl.4256:383|
 :skolemid |144|
))) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) addr@@13) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@13) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@13)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@13)) 6)))))
 :qid |AccountLimitsbpl.4256:750|
 :skolemid |145|
)))) (=> (and (and (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@14) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@14) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@14)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@14)) 6)))))
 :qid |AccountLimitsbpl.4256:17|
 :skolemid |143|
)) (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@15) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@15) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@15)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@15)) 6)))))
 :qid |AccountLimitsbpl.4256:383|
 :skolemid |144|
))) (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) addr@@16) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@16) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@16)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) addr@@16)) 6)))))
 :qid |AccountLimitsbpl.4256:750|
 :skolemid |145|
))) (and (=> (= (ControlFlow 0 277119) (- 0 394011)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@0)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@0))) (and (=> (= (ControlFlow 0 277119) (- 0 394022)) (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) (|$addr#$signer| _$t0@@0))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) (|$addr#$signer| _$t0@@0)) (=> (= (ControlFlow 0 277119) (- 0 394031)) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory@1@@0) (|$addr#$signer| _$t0@@0))) _$t1)))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 276713) (- 0 393827)) (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@0))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@0)) (=> (= (ControlFlow 0 276713) (- 0 393833)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@0)) (= 6 $t10@0)))))))
(let ((anon12_Then_correct@@0  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 277133) 276713))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $1_Roles_RoleId_$memory@1@@0 $1_Roles_RoleId_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 277185) 277133) anon12_Then_correct@@0) (=> (= (ControlFlow 0 277185) 277119) anon12_Else_correct@@0))))))
(let ((anon11_Then_correct@@0  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@0)) (= (ControlFlow 0 277183) 277185)) anon11_Then$1_correct)))
(let ((anon11_Else_correct@@0  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@0))) (=> (and (and (= $1_Roles_RoleId_$memory@0@@0 ($Memory_148428 (|Store__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@0) true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@0) $t11@0))) (= $1_Roles_RoleId_$memory@1@@0 $1_Roles_RoleId_$memory@0@@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 276912) 277133) anon12_Then_correct@@0) (=> (= (ControlFlow 0 276912) 277119) anon12_Else_correct@@0))))))
(let ((anon10_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t11@0 ($1_Roles_RoleId _$t1))) (and (=> (= (ControlFlow 0 276890) (- 0 393550)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies@@0 (|$addr#$signer| _$t0@@0))) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies@@0 (|$addr#$signer| _$t0@@0)) (=> (and (and (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@17) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@17) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@17)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@17)) 6)))))
 :qid |AccountLimitsbpl.4236:22|
 :skolemid |140|
)) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@18) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@18) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@18)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@18)) 6)))))
 :qid |AccountLimitsbpl.4236:388|
 :skolemid |141|
))) (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) addr@@19) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@19) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@19)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@19)) 6)))))
 :qid |AccountLimitsbpl.4236:755|
 :skolemid |142|
))) (and (=> (= (ControlFlow 0 276890) 277183) anon11_Then_correct@@0) (=> (= (ControlFlow 0 276890) 276912) anon11_Else_correct@@0))))))))
(let ((anon10_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t9 $t9)) (and (= $t10@0 $t9) (= (ControlFlow 0 276681) 276713))) L3_correct)))
(let ((anon0$2_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t9) (= $t9 6)) (and (= $t9 $t9) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 276665) 276890) anon10_Then_correct) (=> (= (ControlFlow 0 276665) 276681) anon10_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t6@0)) (= (ControlFlow 0 276629) 276665)) anon0$2_correct)))
(let ((anon0$1_correct@@0  (=> (|$IsValid'address'| (|$addr#$signer| _$t0@@0)) (=> (and (and (|$IsValid'u64'| _$t1) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $a_0@@1)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@1))
 :qid |AccountLimitsbpl.4132:20|
 :skolemid |139|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $a_0@@1))
))) (and (= $t4 (|$addr#$signer| _$t0@@0)) (=> (= _$t1 0) (= $t4 173345816)))) (=> (and (and (and (=> (= _$t1 1) (= $t4 186537453)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies@@0 (|$addr#$signer| _$t0@@0))) (and (= _$t0@@0 _$t0@@0) (= _$t1 _$t1))) (and (and (|$IsValid'address'| $t5@@0) (= $t5@@0 (|$addr#$signer| _$t0@@0))) (and (= $t6@0 (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t5@@0)) (= (ControlFlow 0 276635) 276629)))) inline$$Not$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_112887_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_112887| stream@@1) 0) (forall ((v@@45 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_112887| stream@@1) v@@45) 0)
 :qid |AccountLimitsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountLimitsbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 276467) 276635)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 393306) 276467) inline$$InitEventStore$0$anon0_correct@@0)))
anon0_correct@@0))))))))))))))
))
(check-sat)
(pop 1)
