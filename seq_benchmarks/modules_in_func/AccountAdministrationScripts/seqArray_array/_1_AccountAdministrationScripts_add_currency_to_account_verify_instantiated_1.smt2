...
(assert (not
 (=> (= (ControlFlow 0 0) 349612) (let ((anon4_Else_correct@@1  (=> (not $abort_flag@17@@1) (and (=> (= (ControlFlow 0 241380) (- 0 353137)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2))) (and (=> (= (ControlFlow 0 241380) (- 0 353148)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 241380) (- 0 353158)) (not (not (or (or (let ((addr@@123 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@123)) 5))) (let ((addr@@124 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@124)) 6)))) (let ((addr@@125 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@125)) 2))))))) (=> (not (not (or (or (let ((addr@@126 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@126)) 5))) (let ((addr@@127 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@127)) 6)))) (let ((addr@@128 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@128)) 2)))))) (and (=> (= (ControlFlow 0 241380) (- 0 353169)) (not (not (or (or (let ((addr@@129 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@129)) 5))) (let ((addr@@130 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@130)) 6)))) (let ((addr@@131 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@131)) 2))))))) (=> (not (not (or (or (let ((addr@@132 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@132)) 5))) (let ((addr@@133 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@133)) 6)))) (let ((addr@@134 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@134) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@134)) 2)))))) (and (=> (= (ControlFlow 0 241380) (- 0 353180)) (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3|) (|$addr#$signer| _$t0@@2))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3|) (|$addr#$signer| _$t0@@2)) (=> (= (ControlFlow 0 241380) (- 0 353189)) (= (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3|) (|$addr#$signer| _$t0@@2)) (|$1_DiemAccount_Balance'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| 0)))))))))))))))))
(let ((anon4_Then_correct@@1  (=> (and $abort_flag@17@@1 (= $abort_code@15@@1 $abort_code@15@@1)) (and (=> (= (ControlFlow 0 241528) (- 0 353016)) (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (not (or (or (let ((addr@@135 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@135) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@135)) 5))) (let ((addr@@136 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@136) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@136)) 6)))) (let ((addr@@137 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@137) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@137)) 2)))))) (not (or (or (let ((addr@@138 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@138) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@138)) 5))) (let ((addr@@139 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@139) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@139)) 6)))) (let ((addr@@140 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@140) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@140)) 2))))))) (=> (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (not (or (or (let ((addr@@141 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@141) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@141)) 5))) (let ((addr@@142 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@142) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@142)) 6)))) (let ((addr@@143 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@143) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@143)) 2)))))) (not (or (or (let ((addr@@144 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@144) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@144)) 5))) (let ((addr@@145 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@145)) 6)))) (let ((addr@@146 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@146)) 2)))))) (=> (= (ControlFlow 0 241528) (- 0 353045)) (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2)) (= 6 $abort_code@15@@1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $abort_code@15@@1))) (and (not (or (or (let ((addr@@147 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@147)) 5))) (let ((addr@@148 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@148)) 6)))) (let ((addr@@149 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@149) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@149)) 2))))) (= 7 $abort_code@15@@1))) (and (not (or (or (let ((addr@@150 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@150) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@150)) 5))) (let ((addr@@151 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@151) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@151)) 6)))) (let ((addr@@152 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@152) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@152)) 2))))) (= 7 $abort_code@15@@1))) (= 5 $abort_code@15@@1)) (= 7 $abort_code@15@@1)) (= 6 $abort_code@15@@1))))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Else_correct|  (=> (and (and (not $abort_flag@16@@1) (= $abort_code@15@@1 $abort_code@14@@1)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1|) (= $abort_flag@17@@1 $abort_flag@16@@1))) (and (=> (= (ControlFlow 0 241158) 241528) anon4_Then_correct@@1) (=> (= (ControlFlow 0 241158) 241380) anon4_Else_correct@@1)))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|  (=> (= $abort_code@15@@1 |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@1|) (=> (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2|) (= $abort_flag@17@@1 true)) (and (=> (= (ControlFlow 0 238243) 241528) anon4_Then_correct@@1) (=> (= (ControlFlow 0 238243) 241380) anon4_Else_correct@@1))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Then_correct|  (=> $abort_flag@16@@1 (=> (and (and (= $abort_code@14@@1 $abort_code@14@@1) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@1| $abort_code@14@@1)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1|) (= (ControlFlow 0 241172) 238243))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Then$1_correct|  (=> (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (=> (and (= $abort_code@14@@1 $EXEC_FAILURE_CODE) (= $abort_flag@16@@1 true)) (and (=> (= (ControlFlow 0 241224) 241172) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Then_correct|) (=> (= (ControlFlow 0 241224) 241158) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Else_correct|))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Then_correct|  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2)) (= (ControlFlow 0 241222) 241224)) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Else_correct|  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2))) (=> (and (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@0| ($Memory_174269 (|Store__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2) true) (|Store__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t22@1|))) (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@0|)) (and (= $abort_code@14@@1 $abort_code@13@@1) (= $abort_flag@16@@1 $abort_flag@15@@1))) (and (=> (= (ControlFlow 0 241148) 241172) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Then_correct|) (=> (= (ControlFlow 0 241148) 241158) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Else_correct|))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Else_correct|  (=> (and (not $abort_flag@15@@1) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t22@1| (|$1_DiemAccount_Balance'$1_XDX_XDX'| |inline$$1_Diem_zero'$1_XDX_XDX'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 241126) 241222) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Then_correct|) (=> (= (ControlFlow 0 241126) 241148) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Else_correct|)))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Then_correct|  (=> $abort_flag@15@@1 (=> (and (and (= $abort_code@13@@1 $abort_code@13@@1) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@1| $abort_code@13@@1)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 241238) 238243))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((|inline$$1_Diem_zero'$1_XDX_XDX'$0$anon3_Else_correct|  (=> (not |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t0@0|) (=> (and (|$IsValid'u64'| 0) (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t3@1| (|$1_Diem_Diem'$1_XDX_XDX'| 0))) (=> (and (and (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t3@1| |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t3@1|) (= $abort_flag@15@@1 $abort_flag@14@@1)) (and (= $abort_code@13@@1 $abort_code@12@@1) (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t3@1|))) (and (=> (= (ControlFlow 0 241078) 241238) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Then_correct|) (=> (= (ControlFlow 0 241078) 241126) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'$1_XDX_XDX'$0$anon3_Then_correct|  (=> |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t0@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t1@0|)) (=> (and (and (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t1@0| |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t1@0|) (= $abort_flag@15@@1 true)) (and (= $abort_code@13@@1 |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t1@0|) (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_zero'$1_XDX_XDX'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 241108) 241238) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Then_correct|) (=> (= (ControlFlow 0 241108) 241126) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'$1_XDX_XDX'$0$anon0_correct|  (=> (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t0@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 241050) 241108) |inline$$1_Diem_zero'$1_XDX_XDX'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 241050) 241078) |inline$$1_Diem_zero'$1_XDX_XDX'$0$anon3_Else_correct|)))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon28_Then_correct|  (=> (and inline$$Not$0$dst@1@@2 (= (ControlFlow 0 241114) 241050)) |inline$$1_Diem_zero'$1_XDX_XDX'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon28_Else_correct|  (=> (not inline$$Not$0$dst@1@@2) (=> (and (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t20@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t20@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@1| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t20@0|)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 240897) 238243))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Then$1_correct|  (=> (|$IsValid'u64'| 15) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t20@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t20@0| 6)) (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t20@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t20@0|) (= inline$$Not$0$dst@1@@2 inline$$Not$0$dst@1@@2))) (and (=> (= (ControlFlow 0 240881) 241114) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon28_Then_correct|) (=> (= (ControlFlow 0 240881) 240897) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon28_Else_correct|))))))
(let ((inline$$Not$0$anon0_correct@@2  (=> (and (= inline$$Not$0$dst@1@@2  (not |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t17@1|)) (= (ControlFlow 0 240845) 240881)) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Then_correct|  (=> inline$$1_Roles_can_hold_balance$0$$ret0@1@@1 (=> (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t17@1| (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t8@0|)) (= (ControlFlow 0 240851) 240845)) inline$$Not$0$anon0_correct@@2))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Else_correct|  (=> (not inline$$1_Roles_can_hold_balance$0$$ret0@1@@1) (=> (and (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t16@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t16@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@1| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t16@0|)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 240805) 238243))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Else_correct|  (=> (and (not $abort_flag@14@@1) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t16@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t16@0| 7)) (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t16@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t16@0|) (= inline$$1_Roles_can_hold_balance$0$$ret0@1@@1 inline$$1_Roles_can_hold_balance$0$$ret0@1@@1))) (and (=> (= (ControlFlow 0 240789) 240851) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Then_correct|) (=> (= (ControlFlow 0 240789) 240805) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Else_correct|))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Then_correct|  (=> $abort_flag@14@@1 (=> (and (and (= $abort_code@12@@1 $abort_code@12@@1) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@1| $abort_code@12@@1)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 241252) 238243))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((inline$$1_Roles_can_hold_balance$0$L9_correct@@1  (=> (= $abort_flag@14@@1 true) (=> (and (= inline$$1_Roles_can_hold_balance$0$$ret0@1@@1 inline$$1_Roles_can_hold_balance$0$$ret0@0@@1) (= $abort_code@12@@1 inline$$1_Roles_can_hold_balance$0$$t4@1@@1)) (and (=> (= (ControlFlow 0 240679) 241252) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Then_correct|) (=> (= (ControlFlow 0 240679) 240789) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Else_correct|))))))
(let ((inline$$1_Roles_can_hold_balance$0$anon17_Then_correct@@1  (=> (and (and $abort_flag@12@@1 (= $abort_code@10@@1 $abort_code@10@@1)) (and (= inline$$1_Roles_can_hold_balance$0$$t4@1@@1 $abort_code@10@@1) (= (ControlFlow 0 240673) 240679))) inline$$1_Roles_can_hold_balance$0$L9_correct@@1)))
(let ((inline$$1_Roles_can_hold_balance$0$anon15_Then_correct@@1  (=> (and (and $abort_flag@7@@2 (= $abort_code@6@@2 $abort_code@6@@2)) (and (= inline$$1_Roles_can_hold_balance$0$$t4@1@@1 $abort_code@6@@2) (= (ControlFlow 0 240711) 240679))) inline$$1_Roles_can_hold_balance$0$L9_correct@@1)))
(let ((inline$$1_Roles_can_hold_balance$0$anon13_Then_correct@@1  (=> (and (and $abort_flag@3@@2 (= $abort_code@3@@2 $abort_code@3@@2)) (and (= inline$$1_Roles_can_hold_balance$0$$t4@1@@1 $abort_code@3@@2) (= (ControlFlow 0 240743) 240679))) inline$$1_Roles_can_hold_balance$0$L9_correct@@1)))
(let ((inline$$1_Roles_can_hold_balance$0$L7_correct@@1  (=> (and (and (= inline$$1_Roles_can_hold_balance$0$$t2@1@@1 inline$$1_Roles_can_hold_balance$0$$t2@1@@1) (= $abort_flag@14@@1 $abort_flag@13@@1)) (and (= inline$$1_Roles_can_hold_balance$0$$ret0@1@@1 inline$$1_Roles_can_hold_balance$0$$t2@1@@1) (= $abort_code@12@@1 $abort_code@11@@1))) (and (=> (= (ControlFlow 0 240659) 241252) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Then_correct|) (=> (= (ControlFlow 0 240659) 240789) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Else_correct|)))))
(let ((inline$$1_Roles_can_hold_balance$0$anon17_Else_correct@@1  (=> (and (not $abort_flag@12@@1) (= inline$$1_Roles_has_designated_dealer_role$0$$ret0@1@@1 inline$$1_Roles_has_designated_dealer_role$0$$ret0@1@@1)) (=> (and (and (= inline$$1_Roles_can_hold_balance$0$$t2@1@@1 inline$$1_Roles_has_designated_dealer_role$0$$ret0@1@@1) (= $abort_code@11@@1 $abort_code@10@@1)) (and (= $abort_flag@13@@1 $abort_flag@12@@1) (= (ControlFlow 0 240647) 240659))) inline$$1_Roles_can_hold_balance$0$L7_correct@@1))))
(let ((inline$$1_Roles_has_designated_dealer_role$0$anon3_Else_correct@@1  (=> (and (and (not $abort_flag@11@@1) (= inline$$1_Roles_has_role$2$$ret0@1@@1 inline$$1_Roles_has_role$2$$ret0@1@@1)) (and (= inline$$1_Roles_has_designated_dealer_role$0$$ret0@1@@1 inline$$1_Roles_has_role$2$$ret0@1@@1) (= $abort_flag@12@@1 $abort_flag@11@@1))) (and (=> (= (ControlFlow 0 240605) 240673) inline$$1_Roles_can_hold_balance$0$anon17_Then_correct@@1) (=> (= (ControlFlow 0 240605) 240647) inline$$1_Roles_can_hold_balance$0$anon17_Else_correct@@1)))))
(let ((inline$$1_Roles_has_designated_dealer_role$0$anon3_Then_correct@@1  (=> (and (and $abort_flag@11@@1 (= $abort_code@10@@1 $abort_code@10@@1)) (and (= inline$$1_Roles_has_designated_dealer_role$0$$ret0@1@@1 inline$$1_Roles_has_designated_dealer_role$0$$ret0@0@@1) (= $abort_flag@12@@1 true))) (and (=> (= (ControlFlow 0 240623) 240673) inline$$1_Roles_can_hold_balance$0$anon17_Then_correct@@1) (=> (= (ControlFlow 0 240623) 240647) inline$$1_Roles_can_hold_balance$0$anon17_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$2$anon11_Then_correct@@1  (=> $abort_flag@9@@1 (=> (and (and (= $abort_code@8@@2 $abort_code@8@@2) (= $abort_flag@11@@1 true)) (and (= $abort_code@10@@1 $abort_code@8@@2) (= inline$$1_Roles_has_role$2$$ret0@1@@1 inline$$1_Roles_has_role$2$$ret0@0@@1))) (and (=> (= (ControlFlow 0 240529) 240623) inline$$1_Roles_has_designated_dealer_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 240529) 240605) inline$$1_Roles_has_designated_dealer_role$0$anon3_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$2$L3_correct@@1  (=> (and (and (= inline$$1_Roles_has_role$2$$t2@1@@1 inline$$1_Roles_has_role$2$$t2@1@@1) (= $abort_flag@11@@1 $abort_flag@10@@1)) (and (= $abort_code@10@@1 $abort_code@9@@1) (= inline$$1_Roles_has_role$2$$ret0@1@@1 inline$$1_Roles_has_role$2$$t2@1@@1))) (and (=> (= (ControlFlow 0 240465) 240623) inline$$1_Roles_has_designated_dealer_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 240465) 240605) inline$$1_Roles_has_designated_dealer_role$0$anon3_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$2$anon11_Else_correct@@1  (=> (and (and (and (not $abort_flag@9@@1) (= inline$$1_Roles_has_role$2$$t8@1@@1 (|$role_id#$1_Roles_RoleId| inline$$1_Roles_has_role$2$$t6@2@@1))) (and (= inline$$1_Roles_has_role$2$$t9@1@@1 (= inline$$1_Roles_has_role$2$$t8@1@@1 2)) (= inline$$1_Roles_has_role$2$$t9@1@@1 inline$$1_Roles_has_role$2$$t9@1@@1))) (and (and (= $abort_flag@10@@1 $abort_flag@9@@1) (= inline$$1_Roles_has_role$2$$t2@1@@1 inline$$1_Roles_has_role$2$$t9@1@@1)) (and (= $abort_code@9@@1 $abort_code@8@@2) (= (ControlFlow 0 240511) 240465)))) inline$$1_Roles_has_role$2$L3_correct@@1)))
(let ((inline$$1_Roles_has_role$2$anon10_Then$1_correct@@1  (=> (= $abort_code@8@@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@9@@1 true) (= inline$$1_Roles_has_role$2$$t6@2@@1 inline$$1_Roles_has_role$2$$t6@0@@1)) (and (=> (= (ControlFlow 0 240581) 240529) inline$$1_Roles_has_role$2$anon11_Then_correct@@1) (=> (= (ControlFlow 0 240581) 240511) inline$$1_Roles_has_role$2$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$2$anon10_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$2$$t4@0@@1)) (= (ControlFlow 0 240579) 240581)) inline$$1_Roles_has_role$2$anon10_Then$1_correct@@1)))
(let ((inline$$1_Roles_has_role$2$anon10_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$2$$t4@0@@1) (=> (and (and (= inline$$1_Roles_has_role$2$$t6@1@@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$2$$t4@0@@1)) (= $abort_code@8@@2 $abort_code@7@@2)) (and (= $abort_flag@9@@1 $abort_flag@8@@1) (= inline$$1_Roles_has_role$2$$t6@2@@1 inline$$1_Roles_has_role$2$$t6@1@@1))) (and (=> (= (ControlFlow 0 240483) 240529) inline$$1_Roles_has_role$2$anon11_Then_correct@@1) (=> (= (ControlFlow 0 240483) 240511) inline$$1_Roles_has_role$2$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$2$anon9_Then_correct@@1  (=> inline$$1_Roles_has_role$2$$t5@1@@1 (and (=> (= (ControlFlow 0 240469) 240579) inline$$1_Roles_has_role$2$anon10_Then_correct@@1) (=> (= (ControlFlow 0 240469) 240483) inline$$1_Roles_has_role$2$anon10_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$2$anon9_Else_correct@@1  (=> (and (not inline$$1_Roles_has_role$2$$t5@1@@1) (= false false)) (=> (and (and (= $abort_flag@10@@1 $abort_flag@8@@1) (= inline$$1_Roles_has_role$2$$t2@1@@1 false)) (and (= $abort_code@9@@1 $abort_code@7@@2) (= (ControlFlow 0 240453) 240465))) inline$$1_Roles_has_role$2$L3_correct@@1))))
(let ((inline$$1_Roles_has_role$2$anon0_correct@@1  (=> (and (= _$t0@@2 _$t0@@2) (= 2 2)) (=> (and (and (|$IsValid'address'| inline$$1_Roles_has_role$2$$t4@0@@1) (= inline$$1_Roles_has_role$2$$t4@0@@1 (|$addr#$signer| _$t0@@2))) (and (= inline$$1_Roles_has_role$2$$t4@0@@1 inline$$1_Roles_has_role$2$$t4@0@@1) (= inline$$1_Roles_has_role$2$$t5@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$2$$t4@0@@1)))) (and (=> (= (ControlFlow 0 240433) 240469) inline$$1_Roles_has_role$2$anon9_Then_correct@@1) (=> (= (ControlFlow 0 240433) 240453) inline$$1_Roles_has_role$2$anon9_Else_correct@@1))))))
(let ((inline$$1_Roles_has_designated_dealer_role$0$anon0_correct@@1  (=> (= _$t0@@2 _$t0@@2) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 240587) 240433)) inline$$1_Roles_has_role$2$anon0_correct@@1))))
(let ((inline$$1_Roles_can_hold_balance$0$anon16_Else_correct@@1  (=> (and (not inline$$1_Roles_can_hold_balance$0$$t1@1@@1) (= (ControlFlow 0 240629) 240587)) inline$$1_Roles_has_designated_dealer_role$0$anon0_correct@@1)))
(let ((inline$$1_Roles_can_hold_balance$0$anon16_Then_correct@@1  (=> (and inline$$1_Roles_can_hold_balance$0$$t1@1@@1 (= true true)) (=> (and (and (= inline$$1_Roles_can_hold_balance$0$$t2@1@@1 true) (= $abort_code@11@@1 $abort_code@7@@2)) (and (= $abort_flag@13@@1 $abort_flag@8@@1) (= (ControlFlow 0 240697) 240659))) inline$$1_Roles_can_hold_balance$0$L7_correct@@1))))
(let ((inline$$1_Roles_can_hold_balance$0$anon15_Else_correct@@1  (=> (not $abort_flag@7@@2) (=> (and (and (= inline$$1_Roles_has_child_VASP_role$0$$ret0@1@@1 inline$$1_Roles_has_child_VASP_role$0$$ret0@1@@1) (= inline$$1_Roles_can_hold_balance$0$$t1@1@@1 inline$$1_Roles_has_child_VASP_role$0$$ret0@1@@1)) (and (= $abort_flag@8@@1 $abort_flag@7@@2) (= $abort_code@7@@2 $abort_code@6@@2))) (and (=> (= (ControlFlow 0 239947) 240697) inline$$1_Roles_can_hold_balance$0$anon16_Then_correct@@1) (=> (= (ControlFlow 0 239947) 240629) inline$$1_Roles_can_hold_balance$0$anon16_Else_correct@@1))))))
(let ((inline$$1_Roles_has_child_VASP_role$0$anon3_Else_correct@@1  (=> (and (and (not $abort_flag@6@@2) (= inline$$1_Roles_has_role$1$$ret0@1@@1 inline$$1_Roles_has_role$1$$ret0@1@@1)) (and (= inline$$1_Roles_has_child_VASP_role$0$$ret0@1@@1 inline$$1_Roles_has_role$1$$ret0@1@@1) (= $abort_flag@7@@2 $abort_flag@6@@2))) (and (=> (= (ControlFlow 0 239905) 240711) inline$$1_Roles_can_hold_balance$0$anon15_Then_correct@@1) (=> (= (ControlFlow 0 239905) 239947) inline$$1_Roles_can_hold_balance$0$anon15_Else_correct@@1)))))
(let ((inline$$1_Roles_has_child_VASP_role$0$anon3_Then_correct@@1  (=> (and (and $abort_flag@6@@2 (= $abort_code@6@@2 $abort_code@6@@2)) (and (= inline$$1_Roles_has_child_VASP_role$0$$ret0@1@@1 inline$$1_Roles_has_child_VASP_role$0$$ret0@0@@1) (= $abort_flag@7@@2 true))) (and (=> (= (ControlFlow 0 239923) 240711) inline$$1_Roles_can_hold_balance$0$anon15_Then_correct@@1) (=> (= (ControlFlow 0 239923) 239947) inline$$1_Roles_can_hold_balance$0$anon15_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$1$anon11_Then_correct@@1  (=> $abort_flag@4@@2 (=> (and (and (= $abort_code@4@@2 $abort_code@4@@2) (= $abort_code@6@@2 $abort_code@4@@2)) (and (= $abort_flag@6@@2 true) (= inline$$1_Roles_has_role$1$$ret0@1@@1 inline$$1_Roles_has_role$1$$ret0@0@@1))) (and (=> (= (ControlFlow 0 239829) 239923) inline$$1_Roles_has_child_VASP_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 239829) 239905) inline$$1_Roles_has_child_VASP_role$0$anon3_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$1$L3_correct@@1  (=> (and (and (= inline$$1_Roles_has_role$1$$t2@1@@1 inline$$1_Roles_has_role$1$$t2@1@@1) (= $abort_code@6@@2 $abort_code@5@@2)) (and (= $abort_flag@6@@2 $abort_flag@5@@2) (= inline$$1_Roles_has_role$1$$ret0@1@@1 inline$$1_Roles_has_role$1$$t2@1@@1))) (and (=> (= (ControlFlow 0 239765) 239923) inline$$1_Roles_has_child_VASP_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 239765) 239905) inline$$1_Roles_has_child_VASP_role$0$anon3_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$1$anon11_Else_correct@@1  (=> (and (and (and (not $abort_flag@4@@2) (= inline$$1_Roles_has_role$1$$t8@1@@1 (|$role_id#$1_Roles_RoleId| inline$$1_Roles_has_role$1$$t6@2@@1))) (and (= inline$$1_Roles_has_role$1$$t9@1@@1 (= inline$$1_Roles_has_role$1$$t8@1@@1 6)) (= inline$$1_Roles_has_role$1$$t9@1@@1 inline$$1_Roles_has_role$1$$t9@1@@1))) (and (and (= $abort_code@5@@2 $abort_code@4@@2) (= inline$$1_Roles_has_role$1$$t2@1@@1 inline$$1_Roles_has_role$1$$t9@1@@1)) (and (= $abort_flag@5@@2 $abort_flag@4@@2) (= (ControlFlow 0 239811) 239765)))) inline$$1_Roles_has_role$1$L3_correct@@1)))
(let ((inline$$1_Roles_has_role$1$anon10_Then$1_correct@@1  (=> (= $abort_flag@4@@2 true) (=> (and (= $abort_code@4@@2 $EXEC_FAILURE_CODE) (= inline$$1_Roles_has_role$1$$t6@2@@1 inline$$1_Roles_has_role$1$$t6@0@@1)) (and (=> (= (ControlFlow 0 239881) 239829) inline$$1_Roles_has_role$1$anon11_Then_correct@@1) (=> (= (ControlFlow 0 239881) 239811) inline$$1_Roles_has_role$1$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$1$anon10_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$1$$t4@0@@1)) (= (ControlFlow 0 239879) 239881)) inline$$1_Roles_has_role$1$anon10_Then$1_correct@@1)))
(let ((inline$$1_Roles_has_role$1$anon10_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$1$$t4@0@@1) (=> (and (and (= inline$$1_Roles_has_role$1$$t6@1@@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$1$$t4@0@@1)) (= $abort_flag@4@@2 $abort_flag@3@@2)) (and (= $abort_code@4@@2 $abort_code@3@@2) (= inline$$1_Roles_has_role$1$$t6@2@@1 inline$$1_Roles_has_role$1$$t6@1@@1))) (and (=> (= (ControlFlow 0 239783) 239829) inline$$1_Roles_has_role$1$anon11_Then_correct@@1) (=> (= (ControlFlow 0 239783) 239811) inline$$1_Roles_has_role$1$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$1$anon9_Then_correct@@1  (=> inline$$1_Roles_has_role$1$$t5@1@@1 (and (=> (= (ControlFlow 0 239769) 239879) inline$$1_Roles_has_role$1$anon10_Then_correct@@1) (=> (= (ControlFlow 0 239769) 239783) inline$$1_Roles_has_role$1$anon10_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$1$anon9_Else_correct@@1  (=> (and (not inline$$1_Roles_has_role$1$$t5@1@@1) (= false false)) (=> (and (and (= $abort_code@5@@2 $abort_code@3@@2) (= inline$$1_Roles_has_role$1$$t2@1@@1 false)) (and (= $abort_flag@5@@2 $abort_flag@3@@2) (= (ControlFlow 0 239753) 239765))) inline$$1_Roles_has_role$1$L3_correct@@1))))
(let ((inline$$1_Roles_has_role$1$anon0_correct@@1  (=> (and (= _$t0@@2 _$t0@@2) (= 6 6)) (=> (and (and (|$IsValid'address'| inline$$1_Roles_has_role$1$$t4@0@@1) (= inline$$1_Roles_has_role$1$$t4@0@@1 (|$addr#$signer| _$t0@@2))) (and (= inline$$1_Roles_has_role$1$$t4@0@@1 inline$$1_Roles_has_role$1$$t4@0@@1) (= inline$$1_Roles_has_role$1$$t5@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$1$$t4@0@@1)))) (and (=> (= (ControlFlow 0 239733) 239769) inline$$1_Roles_has_role$1$anon9_Then_correct@@1) (=> (= (ControlFlow 0 239733) 239753) inline$$1_Roles_has_role$1$anon9_Else_correct@@1))))))
(let ((inline$$1_Roles_has_child_VASP_role$0$anon0_correct@@1  (=> (= _$t0@@2 _$t0@@2) (=> (and (|$IsValid'u64'| 6) (= (ControlFlow 0 239887) 239733)) inline$$1_Roles_has_role$1$anon0_correct@@1))))
(let ((inline$$1_Roles_can_hold_balance$0$anon14_Else_correct@@1  (=> (and (not inline$$1_Roles_has_parent_VASP_role$0$$ret0@1@@1) (= (ControlFlow 0 239929) 239887)) inline$$1_Roles_has_child_VASP_role$0$anon0_correct@@1)))
(let ((inline$$1_Roles_can_hold_balance$0$anon14_Then_correct@@1  (=> inline$$1_Roles_has_parent_VASP_role$0$$ret0@1@@1 (=> (and (and (= true true) (= inline$$1_Roles_can_hold_balance$0$$t1@1@@1 true)) (and (= $abort_flag@8@@1 $abort_flag@3@@2) (= $abort_code@7@@2 $abort_code@3@@2))) (and (=> (= (ControlFlow 0 240729) 240697) inline$$1_Roles_can_hold_balance$0$anon16_Then_correct@@1) (=> (= (ControlFlow 0 240729) 240629) inline$$1_Roles_can_hold_balance$0$anon16_Else_correct@@1))))))
(let ((inline$$1_Roles_can_hold_balance$0$anon13_Else_correct@@1  (=> (not $abort_flag@3@@2) (and (=> (= (ControlFlow 0 239249) 240729) inline$$1_Roles_can_hold_balance$0$anon14_Then_correct@@1) (=> (= (ControlFlow 0 239249) 239929) inline$$1_Roles_can_hold_balance$0$anon14_Else_correct@@1)))))
(let ((inline$$1_Roles_has_parent_VASP_role$0$anon3_Else_correct@@1  (=> (and (and (not $abort_flag@2@@2) (= inline$$1_Roles_has_role$0$$ret0@1@@1 inline$$1_Roles_has_role$0$$ret0@1@@1)) (and (= inline$$1_Roles_has_parent_VASP_role$0$$ret0@1@@1 inline$$1_Roles_has_role$0$$ret0@1@@1) (= $abort_flag@3@@2 $abort_flag@2@@2))) (and (=> (= (ControlFlow 0 239217) 240743) inline$$1_Roles_can_hold_balance$0$anon13_Then_correct@@1) (=> (= (ControlFlow 0 239217) 239249) inline$$1_Roles_can_hold_balance$0$anon13_Else_correct@@1)))))
(let ((inline$$1_Roles_has_parent_VASP_role$0$anon3_Then_correct@@1  (=> (and (and $abort_flag@2@@2 (= $abort_code@3@@2 $abort_code@3@@2)) (and (= inline$$1_Roles_has_parent_VASP_role$0$$ret0@1@@1 inline$$1_Roles_has_parent_VASP_role$0$$ret0@0@@1) (= $abort_flag@3@@2 true))) (and (=> (= (ControlFlow 0 239235) 240743) inline$$1_Roles_can_hold_balance$0$anon13_Then_correct@@1) (=> (= (ControlFlow 0 239235) 239249) inline$$1_Roles_can_hold_balance$0$anon13_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$0$anon11_Then_correct@@1  (=> $abort_flag@0@@2 (=> (and (and (= $abort_code@1@@2 $abort_code@1@@2) (= $abort_code@3@@2 $abort_code@1@@2)) (and (= $abort_flag@2@@2 true) (= inline$$1_Roles_has_role$0$$ret0@1@@1 inline$$1_Roles_has_role$0$$ret0@0@@1))) (and (=> (= (ControlFlow 0 239141) 239235) inline$$1_Roles_has_parent_VASP_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 239141) 239217) inline$$1_Roles_has_parent_VASP_role$0$anon3_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$0$L3_correct@@1  (=> (and (and (= inline$$1_Roles_has_role$0$$t2@1@@1 inline$$1_Roles_has_role$0$$t2@1@@1) (= $abort_code@3@@2 $abort_code@2@@2)) (and (= $abort_flag@2@@2 $abort_flag@1@@2) (= inline$$1_Roles_has_role$0$$ret0@1@@1 inline$$1_Roles_has_role$0$$t2@1@@1))) (and (=> (= (ControlFlow 0 239077) 239235) inline$$1_Roles_has_parent_VASP_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 239077) 239217) inline$$1_Roles_has_parent_VASP_role$0$anon3_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$0$anon11_Else_correct@@1  (=> (and (and (and (not $abort_flag@0@@2) (= inline$$1_Roles_has_role$0$$t8@1@@1 (|$role_id#$1_Roles_RoleId| inline$$1_Roles_has_role$0$$t6@2@@1))) (and (= inline$$1_Roles_has_role$0$$t9@1@@1 (= inline$$1_Roles_has_role$0$$t8@1@@1 5)) (= inline$$1_Roles_has_role$0$$t9@1@@1 inline$$1_Roles_has_role$0$$t9@1@@1))) (and (and (= $abort_code@2@@2 $abort_code@1@@2) (= inline$$1_Roles_has_role$0$$t2@1@@1 inline$$1_Roles_has_role$0$$t9@1@@1)) (and (= $abort_flag@1@@2 $abort_flag@0@@2) (= (ControlFlow 0 239123) 239077)))) inline$$1_Roles_has_role$0$L3_correct@@1)))
(let ((inline$$1_Roles_has_role$0$anon10_Then$1_correct@@1  (=> (= $abort_flag@0@@2 true) (=> (and (= $abort_code@1@@2 $EXEC_FAILURE_CODE) (= inline$$1_Roles_has_role$0$$t6@2@@1 inline$$1_Roles_has_role$0$$t6@0@@1)) (and (=> (= (ControlFlow 0 239193) 239141) inline$$1_Roles_has_role$0$anon11_Then_correct@@1) (=> (= (ControlFlow 0 239193) 239123) inline$$1_Roles_has_role$0$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$0$anon10_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0@@1)) (= (ControlFlow 0 239191) 239193)) inline$$1_Roles_has_role$0$anon10_Then$1_correct@@1)))
(let ((inline$$1_Roles_has_role$0$anon10_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0@@1) (=> (and (and (= inline$$1_Roles_has_role$0$$t6@1@@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0@@1)) (= $abort_flag@0@@2 false)) (and (= $abort_code@1@@2 $abort_code@0@@2) (= inline$$1_Roles_has_role$0$$t6@2@@1 inline$$1_Roles_has_role$0$$t6@1@@1))) (and (=> (= (ControlFlow 0 239095) 239141) inline$$1_Roles_has_role$0$anon11_Then_correct@@1) (=> (= (ControlFlow 0 239095) 239123) inline$$1_Roles_has_role$0$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$0$anon9_Then_correct@@1  (=> inline$$1_Roles_has_role$0$$t5@1@@1 (and (=> (= (ControlFlow 0 239081) 239191) inline$$1_Roles_has_role$0$anon10_Then_correct@@1) (=> (= (ControlFlow 0 239081) 239095) inline$$1_Roles_has_role$0$anon10_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$0$anon9_Else_correct@@1  (=> (and (not inline$$1_Roles_has_role$0$$t5@1@@1) (= false false)) (=> (and (and (= $abort_code@2@@2 $abort_code@0@@2) (= inline$$1_Roles_has_role$0$$t2@1@@1 false)) (and (= $abort_flag@1@@2 false) (= (ControlFlow 0 239065) 239077))) inline$$1_Roles_has_role$0$L3_correct@@1))))
(let ((inline$$1_Roles_has_role$0$anon0_correct@@1  (=> (and (= _$t0@@2 _$t0@@2) (= 5 5)) (=> (and (and (|$IsValid'address'| inline$$1_Roles_has_role$0$$t4@0@@1) (= inline$$1_Roles_has_role$0$$t4@0@@1 (|$addr#$signer| _$t0@@2))) (and (= inline$$1_Roles_has_role$0$$t4@0@@1 inline$$1_Roles_has_role$0$$t4@0@@1) (= inline$$1_Roles_has_role$0$$t5@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0@@1)))) (and (=> (= (ControlFlow 0 239045) 239081) inline$$1_Roles_has_role$0$anon9_Then_correct@@1) (=> (= (ControlFlow 0 239045) 239065) inline$$1_Roles_has_role$0$anon9_Else_correct@@1))))))
(let ((inline$$1_Roles_has_parent_VASP_role$0$anon0_correct@@1  (=> (= _$t0@@2 _$t0@@2) (=> (and (|$IsValid'u64'| 5) (= (ControlFlow 0 239199) 239045)) inline$$1_Roles_has_role$0$anon0_correct@@1))))
(let ((inline$$1_Roles_can_hold_balance$0$anon0_correct@@1  (=> (and (= _$t0@@2 _$t0@@2) (= (ControlFlow 0 239241) 239199)) inline$$1_Roles_has_parent_VASP_role$0$anon0_correct@@1)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon25_Then_correct|  (=> (and inline$$1_DiemAccount_exists_at$0$$t1@1@@2 (= (ControlFlow 0 240749) 239241)) inline$$1_Roles_can_hold_balance$0$anon0_correct@@1)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon25_Else_correct|  (=> (not inline$$1_DiemAccount_exists_at$0$$t1@1@@2) (=> (and (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t13@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t13@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@1| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t13@0|)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 238237) 238243))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon24_Else_correct|  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t13@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t13@0| 5)) (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t13@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t13@0|) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@2 inline$$1_DiemAccount_exists_at$0$$t1@1@@2))) (and (=> (= (ControlFlow 0 238221) 240749) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon25_Then_correct|) (=> (= (ControlFlow 0 238221) 238237) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon25_Else_correct|))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon23_Then_correct|  (=> |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t9@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@0|)) (=> (and (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@1| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@0|)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 241292) 238243))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|)))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon24_Then_correct| true))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct@@2  (=> (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t8@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t8@0|) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1@@2 (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t8@0|)) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@2 inline$$1_DiemAccount_exists_at$0$$t1@1@@2)) (and (=> (= (ControlFlow 0 238179) 241266) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon24_Then_correct|) (=> (= (ControlFlow 0 238179) 238221) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon24_Else_correct|))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon23_Else_correct|  (=> (and (not |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t9@0|) (= (ControlFlow 0 238185) 238179)) inline$$1_DiemAccount_exists_at$0$anon0_correct@@2)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon0_correct|  (=> (= _$t0@@2 _$t0@@2) (=> (and (and (|$IsValid'address'| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t8@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t8@0| (|$addr#$signer| _$t0@@2))) (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t8@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t8@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t9@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 238074) 241292) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon23_Then_correct|) (=> (= (ControlFlow 0 238074) 238185) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon23_Else_correct|))))))
(let ((anon0$1_correct@@2  (=> (and (forall ((addr@@153 Int) ) (!  (=> (|$IsValid'address'| addr@@153) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_138625| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@153) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@153) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@153)) 4))))
 :qid |AccountAdministrationScriptsbpl.17104:20|
 :skolemid |340|
)) (forall ((addr@@154 Int) ) (!  (=> (|$IsValid'address'| addr@@154) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139588| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@154) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@154) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@154)) 3))))
 :qid |AccountAdministrationScriptsbpl.17108:20|
 :skolemid |341|
))) (=> (and (and (forall ((addr@@155 Int) ) (!  (=> (|$IsValid'address'| addr@@155) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139588| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@155) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@155) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@155)) 3))))
 :qid |AccountAdministrationScriptsbpl.17112:20|
 :skolemid |342|
)) (forall ((addr@@156 Int) ) (!  (=> (|$IsValid'address'| addr@@156) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_139588| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@156) (not (= (|l#Vec_91119| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139588| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@156)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@156) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@156)) 3))))
 :qid |AccountAdministrationScriptsbpl.17116:20|
 :skolemid |343|
))) (and (forall ((mint_cap_owner@@3 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_152578| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) mint_cap_owner@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) mint_cap_owner@@3)) 1))))
 :qid |AccountAdministrationScriptsbpl.17120:21|
 :skolemid |344|
)) (forall ((mint_cap_owner@@4 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_152665| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) mint_cap_owner@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) mint_cap_owner@@4)) 1))))
 :qid |AccountAdministrationScriptsbpl.17120:268|
 :skolemid |345|
)))) (=> (and (and (and (forall ((addr1@@9 Int) ) (!  (=> (|$IsValid'address'| addr1@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147080| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1@@9) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@9)) 1))))
 :qid |AccountAdministrationScriptsbpl.17128:21|
 :skolemid |346|
)) (forall ((addr1@@10 Int) ) (!  (=> (|$IsValid'address'| addr1@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147167| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr1@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@10)) 1))))
 :qid |AccountAdministrationScriptsbpl.17128:231|
 :skolemid |347|
))) (and (forall ((addr1@@11 Int) ) (!  (=> (|$IsValid'address'| addr1@@11) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_153244| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_152832| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1@@11)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@11)) 2))))
 :qid |AccountAdministrationScriptsbpl.17132:21|
 :skolemid |348|
)) (forall ((addr1@@12 Int) ) (!  (=> (|$IsValid'address'| addr1@@12) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_153361| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr1@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_152913| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr1@@12)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@12)) 2))))
 :qid |AccountAdministrationScriptsbpl.17132:292|
 :skolemid |349|
)))) (and (and (forall ((addr@@157 Int) ) (!  (=> (|$IsValid'address'| addr@@157) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_152832| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@157) (|Select__T@[Int]Bool_| (|domain#$Memory_146600| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |AccountAdministrationScriptsbpl.17136:22|
 :skolemid |350|
)) (forall ((addr@@158 Int) ) (!  (=> (|$IsValid'address'| addr@@158) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_152913| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@158) (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |AccountAdministrationScriptsbpl.17136:222|
 :skolemid |351|
))) (forall ((addr@@159 Int) ) (!  (=> (|$IsValid'address'| addr@@159) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_152994| |$1_Diem_Preburn'#0'_$memory|) addr@@159) (|Select__T@[Int]Bool_| (|domain#$Memory_146800| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |AccountAdministrationScriptsbpl.17136:423|
 :skolemid |352|
)))) (=> (and (and (and (and (and (and (forall ((addr@@160 Int) ) (!  (=> (|$IsValid'address'| addr@@160) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_153244| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@160) (|Select__T@[Int]Bool_| (|domain#$Memory_146600| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |AccountAdministrationScriptsbpl.17140:22|
 :skolemid |353|
)) (forall ((addr@@161 Int) ) (!  (=> (|$IsValid'address'| addr@@161) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_153361| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@161) (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |AccountAdministrationScriptsbpl.17140:227|
 :skolemid |354|
))) (forall ((addr@@162 Int) ) (!  (=> (|$IsValid'address'| addr@@162) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_153478| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@162) (|Select__T@[Int]Bool_| (|domain#$Memory_146800| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |AccountAdministrationScriptsbpl.17140:433|
 :skolemid |355|
))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (forall ((addr1@@13 Int) ) (!  (=> (|$IsValid'address'| addr1@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) addr1@@13) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@13)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@13)) 2)))))
 :qid |AccountAdministrationScriptsbpl.17152:20|
 :skolemid |356|
)) (forall ((addr@@163 Int) ) (!  (=> (|$IsValid'address'| addr@@163) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@163) (or (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@163)))) 0) (and (not (= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@163)))) 0)) (= addr@@163 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@163)))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.17156:20|
 :skolemid |357|
)))) (and (and (and (forall ((addr@@164 Int) ) (!  (=> (|$IsValid'address'| addr@@164) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@164) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@164) (= (|l#Vec_91197| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@164)))) 0)) (and (not (= (|l#Vec_91197| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@164)))) 0)) (= addr@@164 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_91197| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@164)))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.17160:20|
 :skolemid |358|
)) (forall ((addr@@165 Int) ) (!  (=> (|$IsValid'address'| addr@@165) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@165) (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@165)))
 :qid |AccountAdministrationScriptsbpl.17164:20|
 :skolemid |359|
))) (and (forall ((addr@@166 Int) ) (!  (=> (|$IsValid'address'| addr@@166) (=> (and (= addr@@166 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@166)) (|Select__T@[Int]Bool_| (|domain#$Memory_174043| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@166)))
 :qid |AccountAdministrationScriptsbpl.17168:20|
 :skolemid |360|
)) (forall ((addr@@167 Int) ) (!  (=> (|$IsValid'address'| addr@@167) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164510| $1_VASPDomain_VASPDomainManager_$memory) addr@@167) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@167) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@167)) 1))))
 :qid |AccountAdministrationScriptsbpl.17172:20|
 :skolemid |361|
)))) (and (and (forall ((addr@@168 Int) ) (!  (=> (|$IsValid'address'| addr@@168) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_174178| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@168) (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@168)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@168) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@168)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@168) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@168)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@168) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@168)) 2)))))
 :qid |AccountAdministrationScriptsbpl.17176:20|
 :skolemid |362|
)) (forall ((addr@@169 Int) ) (!  (=> (|$IsValid'address'| addr@@169) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_171666| $1_DesignatedDealer_Dealer_$memory) addr@@169) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@169) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@169)) 2))))
 :qid |AccountAdministrationScriptsbpl.17180:20|
 :skolemid |363|
))) (and (forall ((addr@@170 Int) ) (!  (=> (|$IsValid'address'| addr@@170) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) addr@@170) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@170) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@170)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@170) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@170)) 5)))))
 :qid |AccountAdministrationScriptsbpl.17184:20|
 :skolemid |364|
)) (forall ((addr@@171 Int) ) (!  (=> (|$IsValid'address'| addr@@171) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@171) (|Select__T@[Int]Bool_| (|domain#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) addr@@171)))
 :qid |AccountAdministrationScriptsbpl.17188:20|
 :skolemid |365|
)))))) (and (and (and (and (forall ((addr@@172 Int) ) (!  (=> (|$IsValid'address'| addr@@172) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174178| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@172) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@172)))
 :qid |AccountAdministrationScriptsbpl.17192:22|
 :skolemid |366|
)) (forall ((addr@@173 Int) ) (!  (=> (|$IsValid'address'| addr@@173) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@173) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@173)))
 :qid |AccountAdministrationScriptsbpl.17192:218|
 :skolemid |367|
))) (forall ((addr@@174 Int) ) (!  (=> (|$IsValid'address'| addr@@174) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174360| |$1_DiemAccount_Balance'#0'_$memory|) addr@@174) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@174)))
 :qid |AccountAdministrationScriptsbpl.17192:415|
 :skolemid |368|
))) (and (and (forall ((addr@@175 Int) ) (!  (=> (|$IsValid'address'| addr@@175) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139588| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@175) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@175) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@175)) 3))))
 :qid |AccountAdministrationScriptsbpl.17196:20|
 :skolemid |369|
)) (forall ((addr@@176 Int) ) (!  (=> (|$IsValid'address'| addr@@176) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_138625| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@176) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@176) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@176)) 4))))
 :qid |AccountAdministrationScriptsbpl.17200:20|
 :skolemid |370|
))) (and (forall ((addr@@177 Int) ) (!  (=> (|$IsValid'address'| addr@@177) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_165462| $1_VASP_ParentVASP_$memory) addr@@177) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@177) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@177)) 5))))
 :qid |AccountAdministrationScriptsbpl.17204:20|
 :skolemid |371|
)) (forall ((addr@@178 Int) ) (!  (=> (|$IsValid'address'| addr@@178) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_165398| $1_VASP_ChildVASP_$memory) addr@@178) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@178) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@178)) 6))))
 :qid |AccountAdministrationScriptsbpl.17208:20|
 :skolemid |372|
))))) (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@2)) (forall (($a_0@@8 Int) ) (! (let (($rsc@@8 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) $a_0@@8)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@8))
 :qid |AccountAdministrationScriptsbpl.17214:20|
 :skolemid |373|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) $a_0@@8))
))) (and (forall (($a_0@@9 Int) ) (! (let (($rsc@@9 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@9)))
 ...
 :qid |AccountAdministrationScriptsbpl.17218:20|
 :skolemid |374|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@9))
)) (forall (($a_0@@10 Int) ) (! (let (($rsc@@10 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) $a_0@@10)))
 (and (|$IsValid'$1_DiemAccount_DiemAccount'| $rsc@@10) (and (<= (|l#Vec_91197| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| $rsc@@10))) 1) (<= (|l#Vec_91158| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| $rsc@@10))) 1))))
 :qid |AccountAdministrationScriptsbpl.17222:20|
 :skolemid |375|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) $a_0@@10))
)))) (and (and (forall (($a_0@@11 Int) ) (! (let (($rsc@@11 (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) $a_0@@11)))
(|$IsValid'$1_DiemAccount_Balance'$1_XDX_XDX''| $rsc@@11))
 :qid |AccountAdministrationScriptsbpl.17226:20|
 :skolemid |376|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) $a_0@@11))
)) (let ((addr@@179 (|$addr#$signer| _$t0@@2)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@179)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) addr@@179) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) addr@@179))))))) (and (= _$t0@@2 _$t0@@2) (= (ControlFlow 0 241296) 238074)))))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon0_correct|))))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_91033| stream@@3) 0) (forall ((v@@63 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@3) v@@63) 0)
 :qid |AccountAdministrationScriptsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountAdministrationScriptsbpl.3307:13|
 :skolemid |119|
))) (= (ControlFlow 0 236428) 241296)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 349612) 236428) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
