...
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@28))
 ...
 :skolemid |357|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'#0'_| (|contents#$Memory_122943| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $a_0@@29))
)) (forall (($a_0@@30 Int) ) (! (let (($rsc@@30 (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@30)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc@@30))
 :qid |AccountLimitsbpl.12333:20|
 :skolemid |358|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@30))
))) (and (|Select__T@[Int]Bool_| |$1_AccountLimits_Window'#0'_$modifies| _$t1@@10) (= _$t0@@13 _$t0@@13)))) (and (and (and (= _$t1@@10 _$t1@@10) (= _$t2@@2 _$t2@@2)) (and (= $t5@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) _$t1@@10)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t7@@3) (= $t7@@3 5)) (and (= $t7@@3 $t7@@3) (= $t5@0@@0 $t5@0@@0)))))) (and (=> (= (ControlFlow 0 237995) 238407) anon12_Then_correct@@1) (=> (= (ControlFlow 0 237995) 238011) anon12_Else_correct@@1)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@13  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@15 T@$1_Event_EventHandle) ) (! (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_82546_| (|streams#$EventStore| $es) handle@@15)))
 (and (= (|l#Multiset_82546| stream@@14) 0) (forall ((v@@50 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_82546| stream@@14) v@@50) 0)
 :qid |AccountLimitsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountLimitsbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 237415) 237995)) anon0$1_correct@@13)))
(let ((anon0_correct@@13  (=> (and (= (|l#Vec_18658| (|p#$Mutation_127147| $t9@@3)) 0) (= (ControlFlow 0 237425) 237415)) inline$$InitEventStore$0$anon0_correct@@13)))
(let ((PreconditionGeneratedEntry_correct@@6  (=> (= (ControlFlow 0 294455) 237425) anon0_correct@@13)))
