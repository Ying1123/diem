...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 210801) (let ((anon4_Else_correct  (=> (and (not inline$$Not$0$dst@1) (= $t6 $t6)) (and (=> (= (ControlFlow 0 153300) (- 0 211029)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0))) (=> (= (ControlFlow 0 153300) (- 0 211033)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0))) (= 1 $t6))))))))
(let ((anon4_Then_correct  (=> inline$$Not$0$dst@1 (and (=> (= (ControlFlow 0 153353) (- 0 210971)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0)))) (=> (= (ControlFlow 0 153353) (- 0 210980)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) addr@@0) (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) addr@@0)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) addr@@0)))))
 :qid |AccountFreezingbpl.11260:15|
 :skolemid |187|
))))))))
(let ((anon0$2_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| $t6) (= $t6 1)) (and (= $t6 $t6) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 153260) 153353) anon4_Then_correct) (=> (= (ControlFlow 0 153260) 153300) anon4_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t3)) (= (ControlFlow 0 153224) 153260)) anon0$2_correct)))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_94864| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) 173345816))))) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_94864| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (|$IsValid'address'| _$t0)) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) $a_0)))
...
)) (= _$t0 _$t0)) (and (= $t3  (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0)))) (= (ControlFlow 0 153230) 153224))) inline$$Not$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_66189_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountFreezingbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 153106) 153230)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 210801) 153106) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))
))
(check-sat)
(pop 1)
