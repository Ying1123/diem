...
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@16) i@@48)))) 0)))
 :qid |Diemcvc4bpl.9390:199|
 :skolemid |320|
))))))
 :qid |Diemcvc4bpl.9389:20|
 :skolemid |321|
