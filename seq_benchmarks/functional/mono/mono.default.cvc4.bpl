...
function $IsEqual'vec'$42_TestMonomorphization_R'address'''(v1: Vec ($42_TestMonomorphization_R'address'), v2: Vec ($42_TestMonomorphization_R'address')): bool {
    LenVec(v1) == LenVec(v2) &&
    (forall i: int:: InRangeVec(v1, i) ==> $IsEqual'$42_TestMonomorphization_R'address''(ReadVec(v1, i), ReadVec(v2, i)))
}
...
// Not inlined. It appears faster this way.
function $IsEqual'vec'$42_TestMonomorphization_R'u64'''(v1: Vec ($42_TestMonomorphization_R'u64'), v2: Vec ($42_TestMonomorphization_R'u64')): bool {
    LenVec(v1) == LenVec(v2) &&
    (forall i: int:: InRangeVec(v1, i) ==> $IsEqual'$42_TestMonomorphization_R'u64''(ReadVec(v1, i), ReadVec(v2, i)))
}
...
// Not inlined. It appears faster this way.
function $IsEqual'vec'vec'u64'''(v1: Vec (Vec (int)), v2: Vec (Vec (int))): bool {
    LenVec(v1) == LenVec(v2) &&
    (forall i: int:: InRangeVec(v1, i) ==> $IsEqual'vec'u64''(ReadVec(v1, i), ReadVec(v2, i)))
}
