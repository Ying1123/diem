...
(declare-datatypes ((T@$Memory_9600 0)) ((($Memory_9600 (|domain#$Memory_9600| |T@[Int]Bool|) (|contents#$Memory_9600| |T@[Int]$42_TestInvariants_R'#0'|) ) ) ))
...
(declare-datatypes ((T@$Mutation_7449 0)) ((($Mutation_7449 (|l#$Mutation_7449| T@$Location) (|p#$Mutation_7449| T@Vec_2977) (|v#$Mutation_7449| T@Vec_2977) ) ) ))
...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |invariantsresourcesdefaultz3bpl.190:23|
 :skolemid |6|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |invariantsresourcesdefaultz3bpl.194:24|
 :skolemid |7|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |invariantsresourcesdefaultz3bpl.198:25|
 :skolemid |8|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |invariantsresourcesdefaultz3bpl.202:24|
 :skolemid |9|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |invariantsresourcesdefaultz3bpl.206:28|
 :skolemid |10|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |invariantsresourcesdefaultz3bpl.216:19|
 :skolemid |11|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |invariantsresourcesdefaultz3bpl.482:15|
 :skolemid |15|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |invariantsresourcesdefaultz3bpl.491:15|
 :skolemid |16|
...
(assert (forall ((v1 T@Vec_2977) (v2 T@Vec_2977) ) (! (= (|$IsEqual'vec'u8''| v1 v2)  (and (= (|l#Vec_2977| v1) (|l#Vec_2977| v2)) (forall ((i@@0 Int) ) (!  (=> (InRangeVec_2977 v1 i@@0) (= (|Select__T@[Int]Int_| (|v#Vec_2977| v1) i@@0) (|Select__T@[Int]Int_| (|v#Vec_2977| v2) i@@0)))
 :qid |invariantsresourcesdefaultz3bpl.615:13|
 :skolemid |17|
))))
 :qid |invariantsresourcesdefaultz3bpl.613:28|
 :skolemid |18|
...
(assert (forall ((v@@4 T@Vec_2977) ) (! (= (|$IsValid'vec'u8''| v@@4)  (and (|$IsValid'u64'| (|l#Vec_2977| v@@4)) (forall ((i@@1 Int) ) (!  (=> (InRangeVec_2977 v@@4 i@@1) (|$IsValid'u8'| (|Select__T@[Int]Int_| (|v#Vec_2977| v@@4) i@@1)))
 :qid |invariantsresourcesdefaultz3bpl.621:13|
 :skolemid |19|
))))
 :qid |invariantsresourcesdefaultz3bpl.619:28|
 :skolemid |20|
...
(ite  (not (exists ((i@@3 Int) ) (!  (and (and (|$IsValid'u64'| i@@3) (InRangeVec_2977 v@@5 i@@3)) (= (|Select__T@[Int]Int_| (|v#Vec_2977| v@@5) i@@3) e))
 :qid |invariantsresourcesdefaultz3bpl.626:13|
 :skolemid |21|
 ...
 :qid |invariantsresourcesdefaultz3bpl.634:17|
 :skolemid |22|
)))))
 :qid |invariantsresourcesdefaultz3bpl.630:15|
 :skolemid |23|
...
(assert (forall ((v1@@0 T@Vec_2977) (v2@@0 T@Vec_2977) ) (! (= (|$IsEqual'vec'u8''| v1@@0 v2@@0) (|$IsEqual'vec'u8''| ($1_Hash_sha2 v1@@0) ($1_Hash_sha2 v2@@0)))
 :qid |invariantsresourcesdefaultz3bpl.807:15|
 :skolemid |24|
...
(assert (forall ((v1@@1 T@Vec_2977) (v2@@1 T@Vec_2977) ) (! (= (|$IsEqual'vec'u8''| v1@@1 v2@@1) (|$IsEqual'vec'u8''| ($1_Hash_sha3 v1@@1) ($1_Hash_sha3 v2@@1)))
 :qid |invariantsresourcesdefaultz3bpl.823:15|
 :skolemid |25|
...
(assert (forall ((k1 T@Vec_2977) (k2 T@Vec_2977) ) (!  (=> (|$IsEqual'vec'u8''| k1 k2) (= ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2)))
 :qid |invariantsresourcesdefaultz3bpl.870:15|
 :skolemid |26|
...
(assert (forall ((s1 T@Vec_2977) (s2 T@Vec_2977) (k1@@0 T@Vec_2977) (k2@@0 T@Vec_2977) (m1 T@Vec_2977) (m2 T@Vec_2977) ) (!  (=> (and (and (|$IsEqual'vec'u8''| s1 s2) (|$IsEqual'vec'u8''| k1@@0 k2@@0)) (|$IsEqual'vec'u8''| m1 m2)) (= ($1_Signature_$ed25519_verify s1 k1@@0 m1) ($1_Signature_$ed25519_verify s2 k2@@0 m2)))
 :qid |invariantsresourcesdefaultz3bpl.873:15|
 :skolemid |27|
...
(assert (forall ((s |T@$42_TestInvariants_R'#0'|) ) (! (= (|$IsValid'$42_TestInvariants_R'#0''| s)  (and (|$IsValid'u64'| (|$x#$42_TestInvariants_R'#0'| s)) true))
 :qid |invariantsresourcesdefaultz3bpl.943:45|
 :skolemid |28|
...
(assert (forall ((v@@6 T@Vec_2977) (i@@4 Int) ) (! (= (InRangeVec_2977 v@@6 i@@4)  (and (>= i@@4 0) (< i@@4 (|l#Vec_2977| v@@6))))
 :qid |invariantsresourcesdefaultz3bpl.122:24|
 :skolemid |3|
...
(ite  (not (exists ((i@@6 Int) ) (!  (and (InRangeVec_2977 v@@7 i@@6) (= (|Select__T@[Int]Int_| (|v#Vec_2977| v@@7) i@@6) e@@0))
 :qid |invariantsresourcesdefaultz3bpl.109:13|
 :skolemid |0|
 ...
 :qid |invariantsresourcesdefaultz3bpl.117:17|
 :skolemid |1|
)))))
 :qid |invariantsresourcesdefaultz3bpl.113:32|
 :skolemid |2|
 :pattern ( (IndexOfVec_2977 v@@7 e@@0))
)))
(assert (forall ((|l#0| Bool) (i@@7 Int) ) (! (= (|Select__T@[Int]Bool_| (|lambda#0| |l#0|) i@@7) |l#0|)
 :qid |invariantsresourcesdefaultz3bpl.275:54|
 :skolemid |31|
...
(assert (forall ((|l#0@@0| Int) (|l#1| Int) (|l#2| Int) (|l#3| |T@[Int]Int|) (|l#4| |T@[Int]Int|) (|l#5| Int) (|l#6| Int) (i@@8 Int) ) (! (= (|Select__T@[Int]Int_| (|lambda#2| |l#0@@0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6|) i@@8) (ite  (and (>= i@@8 |l#0@@0|) (< i@@8 |l#1|)) (ite (< i@@8 |l#2|) (|Select__T@[Int]Int_| |l#3| i@@8) (|Select__T@[Int]Int_| |l#4| (- i@@8 |l#5|))) |l#6|))
 :qid |invariantsresourcesdefaultz3bpl.73:19|
 :skolemid |32|
...
(assert (forall ((|l#0@@1| Int) (|l#1@@0| Int) (|l#2@@0| |T@[Int]Int|) (|l#3@@0| Int) (|l#4@@0| Int) (|l#5@@0| Int) (i@@9 Int) ) (! (= (|Select__T@[Int]Int_| (|lambda#3| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0| |l#4@@0| |l#5@@0|) i@@9) (ite  (and (<= |l#0@@1| i@@9) (< i@@9 |l#1@@0|)) (|Select__T@[Int]Int_| |l#2@@0| (- (- |l#3@@0| i@@9) |l#4@@0|)) |l#5@@0|))
 :qid |invariantsresourcesdefaultz3bpl.82:30|
 :skolemid |33|
...
(assert (forall ((|l#0@@2| Int) (|l#1@@1| Int) (|l#2@@1| Int) (|l#3@@1| |T@[Int]Int|) (|l#4@@1| |T@[Int]Int|) (|l#5@@1| Int) (|l#6@@0| Int) (j@@1 Int) ) (! (= (|Select__T@[Int]Int_| (|lambda#4| |l#0@@2| |l#1@@1| |l#2@@1| |l#3@@1| |l#4@@1| |l#5@@1| |l#6@@0|) j@@1) (ite  (and (>= j@@1 |l#0@@2|) (< j@@1 |l#1@@1|)) (ite (< j@@1 |l#2@@1|) (|Select__T@[Int]Int_| |l#3@@1| j@@1) (|Select__T@[Int]Int_| |l#4@@1| (+ j@@1 |l#5@@1|))) |l#6@@0|))
 :qid |invariantsresourcesdefaultz3bpl.63:20|
 :skolemid |34|
...
(declare-fun |$42_TestInvariants_R'#0'_$memory| () T@$Memory_9600)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11315) (let ((anon8_Else_correct  (=> (and (and (not $abort_flag@0) (= $t3@0 (|$x#$42_TestInvariants_R'#0'| $t1@1))) (and (= $t3@0 $t3@0) (= (ControlFlow 0 10418) (- 0 11506)))) (> $t3@0 0))))
(let ((anon8_Then_correct true))
(let ((anon7_Then$1_correct  (=> (= $t1@1 $t1) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 10488) 10436) anon8_Then_correct) (=> (= (ControlFlow 0 10488) 10418) anon8_Else_correct))))))
(let ((anon7_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_9600| |$42_TestInvariants_R'#0'_$memory|) _$t0)) (= (ControlFlow 0 10486) 10488)) anon7_Then$1_correct)))
(let ((anon7_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9600| |$42_TestInvariants_R'#0'_$memory|) _$t0) (=> (and (and (= $t1@0 (|Select__T@[Int]$42_TestInvariants_R'#0'_| (|contents#$Memory_9600| |$42_TestInvariants_R'#0'_$memory|) _$t0)) (= $t1@1 $t1@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 10388) 10436) anon8_Then_correct) (=> (= (ControlFlow 0 10388) 10418) anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$42_TestInvariants_R'#0'_| (|contents#$Memory_9600| |$42_TestInvariants_R'#0'_$memory|) $a_0)))
 (and (|$IsValid'$42_TestInvariants_R'#0''| $rsc) (> (|$x#$42_TestInvariants_R'#0'| $rsc) 1)))
 :qid |invariantsresourcesdefaultz3bpl.973:20|
 :skolemid |29|
 :pattern ( (|Select__T@[Int]$42_TestInvariants_R'#0'_| (|contents#$Memory_9600| |$42_TestInvariants_R'#0'_$memory|) $a_0))
)) (= _$t0 _$t0)) (and (=> (= (ControlFlow 0 10374) 10486) anon7_Then_correct) (=> (= (ControlFlow 0 10374) 10388) anon7_Else_correct))))))
(let ((anon0_correct  (=> (= (ControlFlow 0 11315) 10374) anon0$1_correct)))
anon0_correct))))))))
))
(check-sat)
(pop 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11537) (let ((anon8_Else_correct  (=> (and (and (not $abort_flag@0) (= $t3@0 (|$x#$42_TestInvariants_R'#0'| $t1@1))) (and (= $t3@0 $t3@0) (= (ControlFlow 0 10645) (- 0 11728)))) (< $t3@0 1))))
(let ((anon8_Then_correct true))
(let ((anon7_Then$1_correct  (=> (= $t1@1 $t1) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 10715) 10663) anon8_Then_correct) (=> (= (ControlFlow 0 10715) 10645) anon8_Else_correct))))))
(let ((anon7_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_9600| |$42_TestInvariants_R'#0'_$memory|) _$t0)) (= (ControlFlow 0 10713) 10715)) anon7_Then$1_correct)))
(let ((anon7_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9600| |$42_TestInvariants_R'#0'_$memory|) _$t0) (=> (and (and (= $t1@0 (|Select__T@[Int]$42_TestInvariants_R'#0'_| (|contents#$Memory_9600| |$42_TestInvariants_R'#0'_$memory|) _$t0)) (= $t1@1 $t1@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 10615) 10663) anon8_Then_correct) (=> (= (ControlFlow 0 10615) 10645) anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$42_TestInvariants_R'#0'_| (|contents#$Memory_9600| |$42_TestInvariants_R'#0'_$memory|) $a_0)))
 (and (|$IsValid'$42_TestInvariants_R'#0''| $rsc) (> (|$x#$42_TestInvariants_R'#0'| $rsc) 1)))
 :qid |invariantsresourcesdefaultz3bpl.1045:20|
 :skolemid |30|
 :pattern ( (|Select__T@[Int]$42_TestInvariants_R'#0'_| (|contents#$Memory_9600| |$42_TestInvariants_R'#0'_$memory|) $a_0))
)) (= _$t0 _$t0)) (and (=> (= (ControlFlow 0 10601) 10713) anon7_Then_correct) (=> (= (ControlFlow 0 10601) 10615) anon7_Else_correct))))))
(let ((anon0_correct  (=> (= (ControlFlow 0 11537) 10601) anon0$1_correct)))
anon0_correct))))))))
))
(check-sat)
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 11537)))
(get-value ((ControlFlow 0 10601)))
(get-value ((ControlFlow 0 10615)))
(get-value ((ControlFlow 0 10645)))
(assert (not (= (ControlFlow 0 10645) (- 11728))))
(check-sat)
(pop 1)
; Invalid
