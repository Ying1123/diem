...
(declare-fun _$t0 () T@$Mutation_182906)
(declare-fun $t20@0 () T@$Mutation_12788)
...
(declare-fun $t22@0 () T@$Mutation_12788)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 422299) (let ((L5_correct  (=> (and (= |$temp_0'$1_AccountLimits_Window'#0''@1| (|v#$Mutation_182906| $t0@3)) (= |$temp_0'$1_AccountLimits_Window'#0''@1| |$temp_0'$1_AccountLimits_Window'#0''@1|)) (and (=> (= (ControlFlow 0 311547) (- 0 423208)) (not (> (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)) $MAX_U64))) (=> (not (> (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)) $MAX_U64)) (and (=> (= (ControlFlow 0 311547) (- 0 423225)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 311547) (- 0 423235)) (= (|v#$Mutation_182906| $t0@3) (ite (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1))) (|$1_AccountLimits_Window'#0'| (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0 0 (|$tracked_balance#$1_AccountLimits_Window'#0'| $t5@0) (|$limit_address#$1_AccountLimits_Window'#0'| $t5@0)) $t5@0))))))))))
(let ((anon19_Else_correct  (=> (not inline$$Gt$0$dst@1) (=> (and (= $t0@3 _$t0) (= (ControlFlow 0 311487) 311547)) L5_correct))))
(let ((anon19_Then_correct  (=> (and inline$$Gt$0$dst@1 (= $t20@0 ($Mutation_12788 (|l#$Mutation_182906| _$t0) (let ((l (|l#Vec_27093| (|p#$Mutation_182906| _$t0))))
(Vec_27093 (|Store__T@[Int]Int_| (|v#Vec_27093| (|p#$Mutation_182906| _$t0)) l 0) (+ l 1))) (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| _$t0))))) (=> (and (and (= $t20@1 ($Mutation_12788 (|l#$Mutation_12788| $t20@0) (|p#$Mutation_12788| $t20@0) $t6)) (= $t0@0 ($Mutation_182906 (|l#$Mutation_182906| _$t0) (|p#$Mutation_182906| _$t0) (|$1_AccountLimits_Window'#0'| (|v#$Mutation_12788| $t20@1) (|$window_inflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| _$t0)) (|$window_outflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| _$t0)) (|$tracked_balance#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| _$t0)) (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| _$t0)))))) (and (|$IsValid'u64'| 0) (= $t22@0 ($Mutation_12788 (|l#$Mutation_182906| $t0@0) (let ((l@@0 (|l#Vec_27093| (|p#$Mutation_182906| $t0@0))))
(Vec_27093 (|Store__T@[Int]Int_| (|v#Vec_27093| (|p#$Mutation_182906| $t0@0)) l@@0 1) (+ l@@0 1))) (|$window_inflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| $t0@0)))))) (=> (and (and (and (= $t22@1 ($Mutation_12788 (|l#$Mutation_12788| $t22@0) (|p#$Mutation_12788| $t22@0) 0)) (= $t0@1 ($Mutation_182906 (|l#$Mutation_182906| $t0@0) (|p#$Mutation_182906| $t0@0) (|$1_AccountLimits_Window'#0'| (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| $t0@0)) (|v#$Mutation_12788| $t22@1) (|$window_outflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| $t0@0)) (|$tracked_balance#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| $t0@0)) (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| $t0@0)))))) (and (|$IsValid'u64'| 0) (= $t24@0 ($Mutation_12788 (|l#$Mutation_182906| $t0@1) (let ((l@@1 (|l#Vec_27093| (|p#$Mutation_182906| $t0@1))))
(Vec_27093 (|Store__T@[Int]Int_| (|v#Vec_27093| (|p#$Mutation_182906| $t0@1)) l@@1 2) (+ l@@1 1))) (|$window_outflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| $t0@1)))))) (and (and (= $t24@1 ($Mutation_12788 (|l#$Mutation_12788| $t24@0) (|p#$Mutation_12788| $t24@0) 0)) (= $t0@2 ($Mutation_182906 (|l#$Mutation_182906| $t0@1) (|p#$Mutation_182906| $t0@1) (|$1_AccountLimits_Window'#0'| (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| $t0@1)) (|$window_inflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| $t0@1)) (|v#$Mutation_12788| $t24@1) (|$tracked_balance#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| $t0@1)) (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| $t0@1)))))) (and (= $t0@3 $t0@2) (= (ControlFlow 0 311665) 311547)))) L5_correct)))))
(let ((inline$$Gt$0$anon0_correct  (=> (= inline$$Gt$0$dst@1 (> $t6 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 311473) 311665) anon19_Then_correct) (=> (= (ControlFlow 0 311473) 311487) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not $abort_flag@1) (= (ControlFlow 0 311479) 311473)) inline$$Gt$0$anon0_correct)))
(let ((L7_correct  (and (=> (= (ControlFlow 0 311258) (- 0 422944)) (or (> (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)) $MAX_U64) (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (or (> (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)) $MAX_U64) (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 311258) (- 0 422963)) (or (and (> (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)) $MAX_U64) (= 8 $t8@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t8@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t8@0 $abort_code@2) (= (ControlFlow 0 311679) 311258))) L7_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 311419) 311679) anon18_Then_correct) (=> (= (ControlFlow 0 311419) 311479) anon18_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t16@0 $t17@0) $MAX_U64) (= (ControlFlow 0 311417) 311419)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t16@0 $t17@0)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t16@0 $t17@0)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 311365) 311679) anon18_Then_correct) (=> (= (ControlFlow 0 311365) 311479) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> inline$$Le$0$dst@1 (=> (and (= $t16@0 (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| _$t0))) (= $t17@0 (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1))) (and (=> (= (ControlFlow 0 311425) 311417) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 311425) 311365) inline$$AddU64$0$anon3_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= $t15 $t15)) (and (= $t8@0 $t15) (= (ControlFlow 0 311190) 311258))) L7_correct)))
(let ((anon16_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t15) (= $t15 8)) (and (= $t15 $t15) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 311174) 311425) anon17_Then_correct) (=> (= (ControlFlow 0 311174) 311190) anon17_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= $t9@0 inline$$Sub$0$dst@2)) (= (ControlFlow 0 311138) 311174)) anon16_Else$1_correct)))
(let ((anon16_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 311144) 311138)) inline$$Le$0$anon0_correct)))
(let ((anon16_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 311693) 311258))) L7_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 311084) 311693) anon16_Then_correct) (=> (= (ControlFlow 0 311084) 311144) anon16_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< 18446744073709551615 $t11@0) (= (ControlFlow 0 311082) 311084)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= $t11@0 18446744073709551615) (=> (and (and (= inline$$Sub$0$dst@1 (- 18446744073709551615 $t11@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 311034) 311693) anon16_Then_correct) (=> (= (ControlFlow 0 311034) 311144) anon16_Else_correct))))))
(let ((anon15_Else_correct  (=> (not $t7) (=> (and (|$IsValid'u64'| $t6) (= $t6 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (and (and (= $t6 $t6) (= $t9@0 (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| _$t0)))) (and (|$IsValid'u64'| 18446744073709551615) (= $t11@0 (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)))) (and (=> (= (ControlFlow 0 311090) 311082) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 311090) 311034) inline$$Sub$0$anon3_Else_correct)))))))
(let ((anon15_Then_correct  (=> $t7 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t8)) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 311719) 311258))) L7_correct))))
(let ((anon0$1_correct  (=> (= (|l#$Mutation_182906| _$t0) ($Param 0)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (|$IsValid'$1_AccountLimits_Window'#0''| (|v#$Mutation_182906| _$t0))) (=> (and (and (and (|$IsValid'$1_AccountLimits_LimitsDefinition'#0''| _$t1) (and (and (and (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| _$t1) 0) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| _$t1) 0)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1) 0)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| _$t1) 0))) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
...
)) (= $t5@0 (|v#$Mutation_182906| _$t0)))) (and (and (= |$temp_0'$1_AccountLimits_Window'#0''@0| (|v#$Mutation_182906| _$t0)) (= |$temp_0'$1_AccountLimits_Window'#0''@0| |$temp_0'$1_AccountLimits_Window'#0''@0|)) (and (= _$t1 _$t1) (= $t7  (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 310911) 311719) anon15_Then_correct) (=> (= (ControlFlow 0 310911) 311090) anon15_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_112887_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 310769) 310911)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_27093| (|p#$Mutation_12788| $t20)) 0) (= (|l#Vec_27093| (|p#$Mutation_12788| $t22)) 0)) (and (= (|l#Vec_27093| (|p#$Mutation_12788| $t24)) 0) (= (ControlFlow 0 310779) 310769))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 422299) 310779) anon0_correct)))
