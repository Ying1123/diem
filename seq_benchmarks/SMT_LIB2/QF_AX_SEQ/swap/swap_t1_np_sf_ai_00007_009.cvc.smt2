...
(assert (= a_11 (seq.update a_9 i1 (seq.unit e_10))))
(assert (= a_13 (seq.update a_11 i4 (seq.unit e_12))))
(assert (= a_15 (seq.update a_13 i2 (seq.unit e_14))))
(assert (= a_17 (seq.update a_15 i4 (seq.unit e_16))))
(assert (= a_19 (seq.update a_17 i3 (seq.unit e_18))))
(assert (= a_21 (seq.update a_19 i5 (seq.unit e_20))))
(assert (= a_23 (seq.update a_21 i2 (seq.unit e_22))))
(assert (= a_25 (seq.update a_23 i0 (seq.unit e_24))))
(assert (= a_27 (seq.update a_25 i3 (seq.unit e_26))))
(assert (= a_28 (seq.update a_7 i1 (seq.unit e_10))))
(assert (= a_29 (seq.update a_28 i6 (seq.unit e_8))))
(assert (= a_3 (seq.update a_1 i1 (seq.unit e_2))))
(assert (= a_31 (seq.update a_29 i4 (seq.unit e_30))))
(assert (= a_33 (seq.update a_31 i2 (seq.unit e_32))))
(assert (= a_35 (seq.update a_33 i4 (seq.unit e_34))))
(assert (= a_37 (seq.update a_35 i3 (seq.unit e_36))))
(assert (= a_39 (seq.update a_37 i2 (seq.unit e_38))))
(assert (= a_41 (seq.update a_39 i5 (seq.unit e_40))))
(assert (= a_43 (seq.update a_41 i0 (seq.unit e_42))))
(assert (= a_45 (seq.update a_43 i3 (seq.unit e_44))))
(assert (= a_5 (seq.update a_3 i5 (seq.unit e_4))))
(assert (= a_7 (seq.update a_5 i1 (seq.unit e_6))))
(assert (= a_9 (seq.update a_7 i6 (seq.unit e_8))))
(assert (= e_0 (seq.nth a1 i1)))
(assert (= e_10 (seq.nth a_7 i6)))
(assert (= e_12 (seq.nth a_11 i2)))
(assert (= e_14 (seq.nth a_11 i4)))
(assert (= e_16 (seq.nth a_15 i3)))
(assert (= e_18 (seq.nth a_15 i4)))
(assert (= e_2 (seq.nth a1 i0)))
(assert (= e_20 (seq.nth a_19 i2)))
(assert (= e_22 (seq.nth a_19 i5)))
(assert (= e_24 (seq.nth a_23 i3)))
(assert (= e_26 (seq.nth a_23 i0)))
(assert (= e_30 (seq.nth a_29 i2)))
(assert (= e_32 (seq.nth a_29 i4)))
(assert (= e_34 (seq.nth a_33 i3)))
(assert (= e_36 (seq.nth a_33 i4)))
(assert (= e_38 (seq.nth a_37 i5)))
(assert (= e_4 (seq.nth a_3 i1)))
(assert (= e_40 (seq.nth a_37 i2)))
(assert (= e_42 (seq.nth a_41 i3)))
(assert (= e_44 (seq.nth a_41 i0)))
(assert (= e_6 (seq.nth a_3 i5)))
(assert (= e_8 (seq.nth a_7 i1)))
