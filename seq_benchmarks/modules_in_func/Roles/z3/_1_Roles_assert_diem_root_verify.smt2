...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 274202) (let ((anon18_Then_correct  (=> $t16@0 (and (=> (= (ControlFlow 0 193638) (- 0 274581)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 193638) (- 0 274595)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6))) (and (=> (= (ControlFlow 0 193638) (- 0 274607)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) 0))) (and (=> (= (ControlFlow 0 193638) (- 0 274625)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 193638) (- 0 274639)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0))))
...
(let ((L5_correct  (and (=> (= (ControlFlow 0 193129) (- 0 275017)) (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (=> (= (ControlFlow 0 193129) (- 0 275061)) (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) 0)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8@0))))))))
(let ((anon18_Else_correct  (=> (and (and (not $t16@0) (= $t18 $t18)) (and (= $t8@0 $t18) (= (ControlFlow 0 193215) 193129))) L5_correct)))
(let ((anon17_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= $t14@0 (|$role_id#$1_Roles_RoleId| $t13@1)) (|$IsValid'u64'| 0)) (and (= $t16@0 (= $t14@0 0)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t18) (= $t18 3)) (and (= $t18 $t18) (= $t16@0 $t16@0)))) (and (=> (= (ControlFlow 0 193199) 193638) anon18_Then_correct) (=> (= (ControlFlow 0 193199) 193215) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 193652) 193129))) L5_correct)))
(let ((anon16_Then$1_correct  (=> (= $t13@1 $t13) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 193704) 193652) anon17_Then_correct) (=> (= (ControlFlow 0 193704) 193199) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t9)) (= (ControlFlow 0 193702) 193704)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t9) (=> (and (and (= $t13@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t9)) (= $t13@1 $t13@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 193147) 193652) anon17_Then_correct) (=> (= (ControlFlow 0 193147) 193199) anon17_Else_correct))))))
...
(let ((anon15_Else_correct  (=> (and (and (not $t10@0) (= $t12 $t12)) (and (= $t8@0 $t12) (= (ControlFlow 0 192993) 193129))) L5_correct)))
(let ((anon14_Else_correct  (=> (and (not $t7) (|$IsValid'address'| $t9)) (=> (and (and (and (= $t9 (|$addr#$signer| _$t0)) (= $t9 $t9)) (and (= $t10@0 (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t9)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t12) (= $t12 5)) (and (= $t12 $t12) (= $t10@0 $t10@0)))) (and (=> (= (ControlFlow 0 192977) 193133) anon15_Then_correct) (=> (= (ControlFlow 0 192977) 192993) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7 (=> (and (and (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8)) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 193734) 193129))) L5_correct))))
...
)) (= $t6 (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (= $t7  (not (= (|$addr#$signer| _$t0) 173345816))))) (and (=> (= (ControlFlow 0 192915) 193734) anon14_Then_correct) (=> (= (ControlFlow 0 192915) 192977) anon14_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_83264_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 192839) 192915)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 274202) 192839) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
