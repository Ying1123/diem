...
(let ((inline$$AddU64$3$anon3_Then_correct  (=> (and (> (+ $t48@0 _$t0@@0) $MAX_U64) (= (ControlFlow 0 209365) 209367)) inline$$AddU64$3$anon3_Then$1_correct)))
(let ((inline$$AddU64$3$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t48@0 _$t0@@0)) (=> (and (and (= inline$$AddU64$3$dst@1 (+ $t48@0 _$t0@@0)) (= $abort_code@7 $abort_code@6)) (and (= $abort_flag@6 $abort_flag@5) (= inline$$AddU64$3$dst@2 inline$$AddU64$3$dst@1))) (and (=> (= (ControlFlow 0 209313) 209427) anon50_Then_correct) (=> (= (ControlFlow 0 209313) 209413) anon50_Else_correct))))))
...
(let ((inline$$AddU64$2$anon3_Then_correct  (=> (and (> (+ $t45@0 _$t0@@0) $MAX_U64) (= (ControlFlow 0 209164) 209166)) inline$$AddU64$2$anon3_Then$1_correct)))
(let ((inline$$AddU64$2$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t45@0 _$t0@@0)) (=> (and (and (= inline$$AddU64$2$dst@1 (+ $t45@0 _$t0@@0)) (= $abort_flag@5 $abort_flag@4)) (and (= $abort_code@6 $abort_code@5) (= inline$$AddU64$2$dst@2 inline$$AddU64$2$dst@1))) (and (=> (= (ControlFlow 0 209112) 209441) anon49_Then_correct) (=> (= (ControlFlow 0 209112) 209373) anon49_Else_correct))))))
...
(let ((inline$$AddU64$1$anon3_Then_correct  (=> (and (> (+ $t40@0 _$t0@@0) $MAX_U64) (= (ControlFlow 0 208597) 208599)) inline$$AddU64$1$anon3_Then$1_correct)))
(let ((inline$$AddU64$1$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t40@0 _$t0@@0)) (=> (and (and (= inline$$AddU64$1$dst@1 (+ $t40@0 _$t0@@0)) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@4 $abort_flag@3) (= inline$$AddU64$1$dst@2 inline$$AddU64$1$dst@1))) (and (=> (= (ControlFlow 0 208545) 209455) anon47_Then_correct) (=> (= (ControlFlow 0 208545) 208663) anon47_Else_correct))))))
...
(let ((inline$$Sub$1$anon3_Then_correct  (=> (and (< 18446744073709551615 _$t0@@0) (= (ControlFlow 0 208334) 208336)) inline$$Sub$1$anon3_Then$1_correct)))
...
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t30@0 _$t0@@0) $MAX_U64) (= (ControlFlow 0 208117) 208119)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t30@0 _$t0@@0)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t30@0 _$t0@@0)) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 208065) 209483) anon44_Then_correct) (=> (= (ControlFlow 0 208065) 208183) anon44_Else_correct))))))
...
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< 18446744073709551615 _$t0@@0) (= (ControlFlow 0 207854) 207856)) inline$$Sub$0$anon3_Then$1_correct)))
...
(let ((anon39_Then_correct  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= $t16@0 $abort_code@1@@0) (= (ControlFlow 0 209591) 207581))) L14_correct)))
(let ((anon38_Then$1_correct  (=> (= $t18@1 $t18) (=> (and (= $abort_flag@0@@0 true) (= $abort_code@1@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 209643) 209591) anon39_Then_correct) (=> (= (ControlFlow 0 209643) 207633) anon39_Else_correct))))))
...
)) (= $t11@0@@0 (|v#$Mutation_127147| _$t1@@0))) (and (= _$t0@@0 _$t0@@0) (= |$temp_0'$1_AccountLimits_Window'#0''@0| (|v#$Mutation_127147| _$t1@@0))))) (and (and (and (= |$temp_0'$1_AccountLimits_Window'#0''@0| |$temp_0'$1_AccountLimits_Window'#0''@0|) (= $t12@0 (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| _$t1@@0)))) (and (= $t13@0 (|Select__T@[Int]Bool_| (|domain#$Memory_122943| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $t12@0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t15) (= $t15 5)) (and (= $t15 $t15) (= $t13@0 $t13@0)))))) (and (=> (= (ControlFlow 0 207281) 207591) anon37_Then_correct) (=> (= (ControlFlow 0 207281) 207297) anon37_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_82546_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_82546| stream@@1) 0) (forall ((v@@37 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_82546| stream@@1) v@@37) 0)
 :qid |AccountLimitsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountLimitsbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 206768) 207281)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (|l#Vec_18658| (|p#$Mutation_10506| $t47)) 0) (=> (and (= (|l#Vec_18658| (|p#$Mutation_10506| $t50)) 0) (= (ControlFlow 0 206778) 206768)) inline$$InitEventStore$0$anon0_correct@@0))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 268682) 206778) anon0_correct@@0)))
