...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 222199) (let ((L3_correct  (and (=> (= (ControlFlow 0 161759) (- 0 222441)) (> (seq.len _$t0) 63)) (=> (> (seq.len _$t0) 63) (=> (= (ControlFlow 0 161759) (- 0 222448)) (and (> (seq.len _$t0) 63) (= 7 $t4@0)))))))
(let ((anon8_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= $t8 $t8)) (and (= $t4@0 $t8) (= (ControlFlow 0 161727) 161759))) L3_correct)))
(let ((anon8_Then_correct  (=> (and inline$$Le$0$dst@1 (= $t9@0 ($1_VASPDomain_VASPDomain _$t0))) (and (=> (= (ControlFlow 0 161813) (- 0 222370)) (<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $t9@0)) 63)) (=> (<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $t9@0)) 63) (=> (= $t9@0 $t9@0) (and (=> (= (ControlFlow 0 161813) (- 0 222393)) (not (> (seq.len _$t0) 63))) (=> (not (> (seq.len _$t0) 63)) (=> (= (ControlFlow 0 161813) (- 0 222405)) (= $t9@0 ($1_VASPDomain_VASPDomain _$t0)))))))))))
(let ((anon7_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| $t8) (= $t8 7)) (and (= $t8 $t8) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 161711) 161813) anon8_Then_correct) (=> (= (ControlFlow 0 161711) 161727) anon8_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 161675) 161711)) anon7_Else$1_correct)))
(let ((anon7_Else_correct  (=> (not false) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 161681) 161675)) inline$$Le$0$anon0_correct))))
(let ((anon7_Then_correct true))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (seq.len _$t0)) (and (=> (= (ControlFlow 0 161615) 161827) anon7_Then_correct) (=> (= (ControlFlow 0 161615) 161681) anon7_Else_correct)))))
(let ((anon0$1_correct  (=> (|$IsValid'vec'u8''| _$t0) (=> (and (= _$t0 _$t0) (= (ControlFlow 0 161621) 161615)) |inline$$1_Vector_length'u8'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_69290_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_69290| stream@@0) 0) (forall ((v@@38 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_69290| stream@@0) v@@38) 0)
 :qid |VASPDomainbpl.134:13|
 :skolemid |2|
))))
 :qid |VASPDomainbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 161557) 161621)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 222199) 161557) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
