...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |naivesortz3bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |naivesortz3bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |naivesortz3bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |naivesortz3bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |naivesortz3bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |naivesortz3bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |naivesortz3bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |naivesortz3bpl.461:15|
 :skolemid |14|
...
(= (seq.nth p@@1 ind) num)))
 :qid |naivesortz3bpl.1581:69|
 :skolemid |43|
)))))
 :qid |naivesortz3bpl.1580:148|
 :skolemid |44|
))))))
 :qid |naivesortz3bpl.1579:120|
 :skolemid |45|
))))
 :qid |naivesortz3bpl.1579:15|
 :skolemid |46|
)))))))))))))
...
(= (seq.nth p@@2 ind@@0) num@@0)))
 :qid |naivesortz3bpl.1608:69|
 :skolemid |48|
)))))
 :qid |naivesortz3bpl.1607:147|
 :skolemid |49|
))))))
 :qid |naivesortz3bpl.1606:120|
 :skolemid |50|
))))
 :qid |naivesortz3bpl.1606:15|
 :skolemid |51|
)))))))))
...
(= (seq.nth p@@3 ind@@1) num@@1)))
 :qid |naivesortz3bpl.1246:69|
 :skolemid |31|
)))))
 :qid |naivesortz3bpl.1245:148|
 :skolemid |32|
))))))
 :qid |naivesortz3bpl.1244:120|
 :skolemid |33|
))))
 :qid |naivesortz3bpl.1244:15|
 :skolemid |34|
...
(= (seq.nth p@@5 ind@@2) num@@2)))
 :qid |naivesortz3bpl.1347:69|
 :skolemid |37|
)))))
 :qid |naivesortz3bpl.1346:147|
 :skolemid |38|
))))))
 :qid |naivesortz3bpl.1345:125|
 :skolemid |39|
))))
 :qid |naivesortz3bpl.1345:20|
 :skolemid |40|
