...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 312051) (let ((anon4_Else_correct  (=> (not $t4) (=> (and (and (and (|$IsValid'$1_DiemSystem_DiemSystem'| $t3) (let (($range_0 ($Range 0 (|l#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| $t3)))))
(let (($range_1 ($Range 0 (|l#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| $t3)))))
(forall (($i_2 Int) ($i_3 Int) ) (!  (=> ($InRange $range_0 $i_2) (=> ($InRange $range_1 $i_3) (let ((i@@90 $i_2))
(let ((j@@28 $i_3))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| $t3)) i@@90)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| $t3)) j@@28))) (= i@@90 j@@28))))))
 :qid |DiemSystembpl.9773:222|
 :skolemid |306|
))))) (and (= (|$scheme#$1_DiemSystem_DiemSystem| $t3) (|$scheme#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@0))))) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| $t3) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@0))))))) (and (and (= $t3 $t3) (= $t6@0 (|$validators#$1_DiemSystem_DiemSystem| $t3))) (and (= $t7 (let (($range_0@@0 $t6@0))
(exists (($i_1 Int) ) (!  (and (InRangeVec_78413 $range_0@@0 $i_1) (let ((v@@46 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $range_0@@0) $i_1)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@46) _$t0)))
 :qid |DiemSystembpl.9797:62|
 :skolemid |307|
)))) (= $t7 $t7)))) (and (=> (= (ControlFlow 0 231187) (- 0 312690)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 231187) (- 0 312702)) (= $t7 (let (($range_0@@1 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@1 173345816))
...
(exists (($i_1@@0 Int) ) (!  (and (InRangeVec_78413 $range_0@@1 $i_1@@0) (let ((v@@47 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $range_0@@1) $i_1@@0)))
...
(exists (($i_1@@1 Int) ) (!  (and (InRangeVec_78413 $range_0@@2 $i_1@@1) (let ((v@@48 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $range_0@@2) $i_1@@1)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@48) _$t0)))
 :qid |DiemSystembpl.6950:125|
 :skolemid |215|
)))) (=> (= (ControlFlow 0 231187) (- 0 312714)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@3 173345816))
...
(let ((anon4_Then_correct  (=> $t4 (=> (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t5)) (= $t5 $t5)) (and (=> (= (ControlFlow 0 231245) (- 0 312496)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (=> (= (ControlFlow 0 231245) (- 0 312503)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t5)))))))))
(let ((anon0$1_correct  (=> (and (and (and (and (and (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address) (= config_address 173345816)))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@6))))) i1)))) 3))))
 ...
 :skolemid |302|
)))) (and (let (($range_0@@4 ($Range 0 (|l#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@7 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@8))))) i1@@0)) 1)))
 ...
 :skolemid |303|
))) (|$IsValid'address'| _$t0))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0)))
...
)) (= _$t0 _$t0)) (and (= _$t0 _$t0) (= $t4  (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))))))) (and (=> (= (ControlFlow 0 230991) 231245) anon4_Then_correct) (=> (= (ControlFlow 0 230991) 231187) anon4_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_87682_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_87682| stream@@0) 0) (forall ((v@@49 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_87682| stream@@0) v@@49) 0)
 :qid |DiemSystembpl.159:13|
 :skolemid |4|
))))
 :qid |DiemSystembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 230605) 230991)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 312051) 230605) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))
))
(check-sat)
(pop 1)
