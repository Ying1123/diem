...
(let ((L3_correct  (=> (= $t2@0 $t2@0) (and (=> (= (ControlFlow 0 212603) (- 0 290879)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0))))
 ...
 :qid |Rolesbpl.8647:15|
 :skolemid |272|
)) (=> (= (ControlFlow 0 212603) (- 0 291173)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6))))
 :qid |Rolesbpl.8651:15|
 :skolemid |273|
))))))))))))))))))
(let ((anon12_Else_correct  (=> (and (not $abort_flag@0) (= $t8@0 (|$role_id#$1_Roles_RoleId| $t6@1))) (=> (and (and (= $t9@0 (= $t8@0 _$t1)) (= $t9@0 $t9@0)) (and (= $t2@0 $t9@0) (= (ControlFlow 0 212649) 212603))) L3_correct))))
(let ((anon11_Then$1_correct  (=> (= $t6@1 $t6) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 212719) 212667) anon12_Then_correct) (=> (= (ControlFlow 0 212719) 212649) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t4)) (= (ControlFlow 0 212717) 212719)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t4) (=> (and (and (= $t6@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t4)) (= $t6@1 $t6@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 212621) 212667) anon12_Then_correct) (=> (= (ControlFlow 0 212621) 212649) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t5@0 (and (=> (= (ControlFlow 0 212607) 212717) anon11_Then_correct) (=> (= (ControlFlow 0 212607) 212621) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t5@0) (= false false)) (and (= $t2@0 false) (= (ControlFlow 0 212232) 212603))) L3_correct)))
(let ((anon0$1_correct  (=> (|$IsValid'address'| (|$addr#$signer| _$t0)) (=> (and (and (and (|$IsValid'u64'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Rolesbpl.8526:20|
 :skolemid |266|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $a_0))
))) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (|$IsValid'address'| $t4) (= $t4 (|$addr#$signer| _$t0))) (and (= $t4 $t4) (= $t5@0 (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t4))))) (and (=> (= (ControlFlow 0 212212) 212607) anon10_Then_correct) (=> (= (ControlFlow 0 212212) 212232) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_83264_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 212126) 212212)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 290585) 212126) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
