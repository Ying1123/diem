...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1152023) (let ((anon15_Then_correct true))
(let ((L3_correct  (=> (= $t0@0 $t0@0) (and (=> (= (ControlFlow 0 819488) (- 0 1152572)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 819488) (- 0 1152593)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@0))))
 ...
 :qid |Diembpl.28986:15|
 :skolemid |1475|
)) (and (=> (= (ControlFlow 0 819488) (- 0 1152622)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@2)))
 ...
 :qid |Diembpl.28991:15|
 :skolemid |1476|
)) (and (=> (= (ControlFlow 0 819488) (- 0 1152647)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 819488) (- 0 1152668)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@4))))
 ...
 :qid |Diembpl.29001:15|
 :skolemid |1477|
)) (and (=> (= (ControlFlow 0 819488) (- 0 1152697)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@6)))
 ...
 :qid |Diembpl.29021:15|
 :skolemid |1479|
)) (and (=> (= (ControlFlow 0 819488) (- 0 1152800)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307989| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_307989| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@10)))
...
(let ((anon15_Else$1_correct  (=> (= inline$$Not$0$dst@1 inline$$Not$0$dst@1) (=> (and (= $t0@0 inline$$Not$0$dst@1) (= (ControlFlow 0 819572) 819488)) L3_correct))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t5@0)) (= (ControlFlow 0 819554) 819572)) anon15_Else$1_correct)))
(let ((anon15_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t5@0 (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t4@1)) (= (ControlFlow 0 819560) 819554)) inline$$Not$0$anon0_correct))))
(let ((anon14_Then$1_correct  (=> (= $t4@1 $t4) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 819644) 819586) anon15_Then_correct) (=> (= (ControlFlow 0 819644) 819560) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= (ControlFlow 0 819642) 819644)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (and (and (= $t4@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= $t4@1 $t4@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 819512) 819586) anon15_Then_correct) (=> (= (ControlFlow 0 819512) 819560) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1| (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 819498) 819642) anon14_Then_correct) (=> (= (ControlFlow 0 819498) 819512) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (and (not |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1|) (= false false)) (and (= $t0@0 false) (= (ControlFlow 0 819196) 819488))) L3_correct)))
(let ((anon12_Else_correct  (=> (not false) (and (=> (= (ControlFlow 0 819176) 819498) anon13_Then_correct) (=> (= (ControlFlow 0 819176) 819196) anon13_Else_correct)))))
(let ((anon12_Then_correct true))
(let ((|inline$$1_Diem_is_currency'$1_XUS_XUS'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1| |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1|)) (and (=> (= (ControlFlow 0 819162) 819658) anon12_Then_correct) (=> (= (ControlFlow 0 819162) 819176) anon12_Else_correct))))))
...
)) (= (ControlFlow 0 819168) 819162)))) |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$anon0_correct|)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 818814) 819168)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1152023) 818814) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))
))
(check-sat)
(pop 1)
