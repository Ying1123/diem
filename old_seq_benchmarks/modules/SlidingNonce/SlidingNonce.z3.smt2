...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |SlidingNoncez3bpl.165:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |SlidingNoncez3bpl.169:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |SlidingNoncez3bpl.173:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |SlidingNoncez3bpl.177:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |SlidingNoncez3bpl.181:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |SlidingNoncez3bpl.191:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |SlidingNoncez3bpl.457:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |SlidingNoncez3bpl.466:15|
 :skolemid |14|
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12441) (let ((L3_correct  (and (=> (= (ControlFlow 0 11822) (- 0 12762)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (=> (= (ControlFlow 0 11822) (- 0 12782)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 $t7@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)) (= 7 $t7@0))))))))
(let ((anon11_Else_correct  (=> (and (and (not $t9@0) (= $t10 $t10)) (and (= $t7@0 $t10) (= (ControlFlow 0 11750) 11822))) L3_correct)))
(let ((anon9_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 $t7)) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 11902) 11822))) L3_correct))))
(let ((anon11_Then_correct  (=> $t9@0 (and (=> (= (ControlFlow 0 11858) (- 0 12708)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)))) (=> (= (ControlFlow 0 11858) (- 0 12721)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)))))))))
(let ((anon5_correct  (=> (|$IsValid'u64'| $t5) (=> (and (and (and (= $t5 ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1)) (= $t5 $t5)) (and (|$IsValid'u64'| 0) (= $t9@0 (= $t5 0)))) (and (and (|$IsValid'u64'| $t10) (= $t10 7)) (and (= $t10 $t10) (= $t9@0 $t9@0)))) (and (=> (= (ControlFlow 0 11734) 11858) anon11_Then_correct) (=> (= (ControlFlow 0 11734) 11750) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (not |$temp_0'bool'@0|) (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_9636 (|Store__T@[Int]Bool_| (|domain#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) false) (|contents#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory))) (= (ControlFlow 0 11676) 11734)) anon5_correct))))
(let ((anon10_Then_correct  (=> |$temp_0'bool'@0| (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_9636 (|Store__T@[Int]Bool_| (|domain#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) |$temp_0'$1_SlidingNonce_SlidingNonce'@0|))) (= (ControlFlow 0 11872) 11734)) anon5_correct))))
(let ((anon9_Else_correct  (=> (not $t6) (and (=> (= (ControlFlow 0 11662) 11872) anon10_Then_correct) (=> (= (ControlFlow 0 11662) 11676) anon10_Else_correct)))))
(let ((anon0$1_correct  (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) 186537453))) (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (|$IsValid'u64'| _$t1))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) $a_0)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc))
 :qid |SlidingNoncez3bpl.1196:20|
 :skolemid |30|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_9636| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))))) (and (=> (= (ControlFlow 0 11656) 11902) anon9_Then_correct) (=> (= (ControlFlow 0 11656) 11662) anon9_Else_correct)))))
(let ((anon0_correct  (=> (= (ControlFlow 0 12441) 11656) anon0$1_correct)))
anon0_correct)))))))))))
))
(check-sat)
(pop 1)
