...
(declare-fun $1_VASPDomain_VASPDomainManager_$memory@1 () T@$Memory_122812)
(declare-fun $t6@0 () Int)
(declare-fun $abort_code@1@@1 () Int)
(declare-fun $1_VASPDomain_VASPDomainManager_$memory@0 () T@$Memory_122812)
...
(assert (not
 (=> (= (ControlFlow 0 0) 223625) (let ((anon18_Else_correct@@0  (=> (not $abort_flag@0@@1) (and (=> (= (ControlFlow 0 163991) (- 0 224291)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100618| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100618| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 163991) (- 0 224303)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100618| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100618| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 163991) (- 0 224321)) (not (not (= (|$addr#$signer| _$t0@@3) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@3) 186537453))) (and (=> (= (ControlFlow 0 163991) (- 0 224335)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 163991) (- 0 224343)) (|Select__T@[Int]Bool_| (|domain#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory@1) (|$addr#$signer| _$t0@@3))))))))))))))
(let ((anon16_Then_correct@@0 true))
(let ((L3_correct@@1  (and (=> (= (ControlFlow 0 163795) (- 0 224173)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_100618| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100618| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0@@3) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_100618| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100618| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0@@3) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 163795) (- 0 224211)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_100618| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100618| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0@@3) 186537453)) (= 2 $t6@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (= 6 $t6@0))))))))
(let ((anon18_Then_correct@@0  (=> (and (and $abort_flag@0@@1 (= $abort_code@1@@1 $abort_code@1@@1)) (and (= $t6@0 $abort_code@1@@1) (= (ControlFlow 0 164005) 163795))) L3_correct@@1)))
(let ((anon17_Then$1_correct  (=> (= $1_VASPDomain_VASPDomainManager_$memory@1 $1_VASPDomain_VASPDomainManager_$memory) (=> (and (= $abort_flag@0@@1 true) (= $abort_code@1@@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 164057) 164005) anon18_Then_correct@@0) (=> (= (ControlFlow 0 164057) 163991) anon18_Else_correct@@0))))))
(let ((anon17_Then_correct@@0  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) (|$addr#$signer| _$t0@@3)) (= (ControlFlow 0 164055) 164057)) anon17_Then$1_correct)))
(let ((anon17_Else_correct@@0  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) (|$addr#$signer| _$t0@@3))) (=> (and (and (= $1_VASPDomain_VASPDomainManager_$memory@0 ($Memory_122812 (|Store__T@[Int]Bool_| (|domain#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) (|$addr#$signer| _$t0@@3) true) (|Store__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) (|$addr#$signer| _$t0@@3) $t13@0@@0))) (= $1_VASPDomain_VASPDomainManager_$memory@1 $1_VASPDomain_VASPDomainManager_$memory@0)) (and (= $abort_flag@0@@1 false) (= $abort_code@1@@1 $abort_code@0@@1))) (and (=> (= (ControlFlow 0 163919) 164005) anon18_Then_correct@@0) (=> (= (ControlFlow 0 163919) 163991) anon18_Else_correct@@0))))))
(let ((anon16_Else_correct@@0  (=> (and (not false) (= $t13@0@@0 ($1_VASPDomain_VASPDomainManager |inline$$1_Event_new_event_handle'$1_VASPDomain_VASPDomainEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 163897) (- 0 224068)) (|Select__T@[Int]Bool_| $1_VASPDomain_VASPDomainManager_$modifies (|$addr#$signer| _$t0@@3))) (=> (|Select__T@[Int]Bool_| $1_VASPDomain_VASPDomainManager_$modifies (|$addr#$signer| _$t0@@3)) (and (=> (= (ControlFlow 0 163897) 164055) anon17_Then_correct@@0) (=> (= (ControlFlow 0 163897) 163919) anon17_Else_correct@@0)))))))
(let ((|inline$$1_Event_new_event_handle'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_VASPDomain_VASPDomainEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_VASPDomain_VASPDomainEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 163867) 164071) anon16_Then_correct@@0) (=> (= (ControlFlow 0 163867) 163897) anon16_Else_correct@@0)))))
(let ((anon15_Then_correct@@0  (=> (and inline$$Not$0$dst@1@@0 (= (ControlFlow 0 163873) 163867)) |inline$$1_Event_new_event_handle'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|)))
(let ((anon15_Else_correct@@0  (=> (and (and (not inline$$Not$0$dst@1@@0) (= $t11@@1 $t11@@1)) (and (= $t6@0 $t11@@1) (= (ControlFlow 0 163671) 163795))) L3_correct@@1)))
(let ((anon14_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t11@@1) (= $t11@@1 6)) (and (= $t11@@1 $t11@@1) (= inline$$Not$0$dst@1@@0 inline$$Not$0$dst@1@@0))) (and (=> (= (ControlFlow 0 163655) 163873) anon15_Then_correct@@0) (=> (= (ControlFlow 0 163655) 163671) anon15_Else_correct@@0))))))
(let ((inline$$Not$0$anon0_correct@@0  (=> (and (= inline$$Not$0$dst@1@@0  (not $t8@0)) (= (ControlFlow 0 163615) 163655)) anon14_Else$1_correct)))
(let ((anon14_Else_correct@@0  (=> (not $t5) (=> (and (and (|$IsValid'address'| $t7) (= $t7 (|$addr#$signer| _$t0@@3))) (and (= $t8@0 (|Select__T@[Int]Bool_| (|domain#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) $t7)) (= (ControlFlow 0 163621) 163615))) inline$$Not$0$anon0_correct@@0))))
(let ((anon14_Then_correct@@0  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_100618| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100618| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6@@0))) (and (not (= (|$addr#$signer| _$t0@@3) 186537453)) (= 2 $t6@@0))) (= $t6@@0 $t6@@0)) (and (= $t6@0 $t6@@0) (= (ControlFlow 0 164143) 163795))) L3_correct@@1))))
(let ((anon0$1_correct@@3  (=> (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@3)) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100618| $1_Roles_RoleId_$memory) $a_0@@4)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@4))
 :qid |VASPDomainbpl.10214:20|
 :skolemid |196|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100618| $1_Roles_RoleId_$memory) $a_0@@4))
))) (and (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@5)))
(|$IsValid'$1_VASPDomain_VASPDomainManager'| $rsc@@5))
 :qid |VASPDomainbpl.10218:20|
 :skolemid |197|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_122812| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@5))
)) (= $t3 (|$addr#$signer| _$t0@@3)))) (and (and (|Select__T@[Int]Bool_| $1_VASPDomain_VASPDomainManager_$modifies (|$addr#$signer| _$t0@@3)) (= _$t0@@3 _$t0@@3)) (and (= $t4 (|$addr#$signer| _$t0@@3)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_100618| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100618| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0@@3) 186537453))))))) (and (=> (= (ControlFlow 0 163559) 164143) anon14_Then_correct@@0) (=> (= (ControlFlow 0 163559) 163621) anon14_Else_correct@@0)))))
(let ((inline$$InitEventStore$0$anon0_correct@@3  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@8 T@$1_Event_EventHandle) ) (! (let ((stream@@8 (|Select__T@[$1_Event_EventHandle]Multiset_69290_| (|streams#$EventStore| $es) handle@@8)))
 (and (= (|l#Multiset_69290| stream@@8) 0) (forall ((v@@45 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_69290| stream@@8) v@@45) 0)
 :qid |VASPDomainbpl.134:13|
 :skolemid |2|
))))
 :qid |VASPDomainbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 163411) 163559)) anon0$1_correct@@3)))
(let ((anon0_correct@@3  (=> (= (ControlFlow 0 223625) 163411) inline$$InitEventStore$0$anon0_correct@@3)))
anon0_correct@@3)))))))))))))))))))
))
(check-sat)
(pop 1)
