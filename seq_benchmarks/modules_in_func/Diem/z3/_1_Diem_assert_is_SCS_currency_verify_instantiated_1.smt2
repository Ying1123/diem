...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1066626) (let ((anon10_Else_correct true))
(let ((anon10_Then_correct  (=> |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$ret0@1| (and (=> (= (ControlFlow 0 705817) (- 0 1067376)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 705817) (- 0 1067397)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@0))))
 ...
 :qid |Diembpl.11768:15|
 :skolemid |483|
)) (and (=> (= (ControlFlow 0 705817) (- 0 1067426)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_307554| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@2)))
 ...
 :qid |Diembpl.11783:15|
 :skolemid |485|
)) (and (=> (= (ControlFlow 0 705817) (- 0 1067501)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307813| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_307813| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@6)))
 ...
 :qid |Diembpl.11803:15|
 :skolemid |487|
)) (and (=> (= (ControlFlow 0 705817) (- 0 1067604)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308136| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_308136| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@10)))
...
(let ((anon9_Else_correct  (=> (and (not $abort_flag@2) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t6) (= $t6 1)) (and (= $t6 $t6) (= |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 705509) 705817) anon10_Then_correct) (=> (= (ControlFlow 0 705509) 705525) anon10_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((|inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$L5_correct|  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t2@1|) (= |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 705401) 705831) anon9_Then_correct) (=> (= (ControlFlow 0 705401) 705509) anon9_Else_correct))))))
(let ((|inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$anon14_Then_correct|  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t2@1| $abort_code@1) (= (ControlFlow 0 705395) 705401))) |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$L5_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$L3_correct|  (=> (and (and (= |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t0@1| |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t0@1|) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t0@1|))) (and (=> (= (ControlFlow 0 705297) 705831) anon9_Then_correct) (=> (= (ControlFlow 0 705297) 705509) anon9_Else_correct)))))
(let ((|inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$anon14_Else$1_correct|  (=> (= inline$$Not$0$dst@1 inline$$Not$0$dst@1) (=> (and (and (= $abort_code@2 $abort_code@1) (= |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t0@1| inline$$Not$0$dst@1)) (and (= $abort_flag@1 $abort_flag@0) (= (ControlFlow 0 705381) 705297))) |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$L3_correct|))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t5@1|)) (= (ControlFlow 0 705363) 705381)) |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$anon14_Else$1_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$anon14_Else_correct|  (=> (not $abort_flag@0) (=> (and (= |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t5@1| (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t4@2|)) (= (ControlFlow 0 705369) 705363)) inline$$Not$0$anon0_correct))))
(let ((|inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$anon13_Then$1_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t4@0|)) (and (=> (= (ControlFlow 0 705453) 705395) |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 705453) 705369) |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$anon14_Else_correct|))))))
...
(let ((|inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$anon13_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t4@1| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$$t4@1|))) (and (=> (= (ControlFlow 0 705321) 705395) |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 705321) 705369) |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$anon14_Else_correct|))))))
...
(let ((anon8_Else_correct  (=> (and (not $t2) (= (ControlFlow 0 705473) 705257)) |inline$$1_Diem_is_SCS_currency'$1_XDX_XDX'$0$anon0_correct|)))
...
)) (= $t2  (not (|Select__T@[Int]Bool_| (|domain#$Memory_326018| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 704918) 705857) anon8_Then_correct) (=> (= (ControlFlow 0 704918) 705473) anon8_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 704639) 704918)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1066626) 704639) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))
))
(check-sat)
(pop 1)
