...
(let ((anon40_Then_correct  (=> $t19 (=> (and (= true true) (= |$temp_0'$1_AccountLimits_Window'#0''@1| (|v#$Mutation_119553| _$t1))) (=> (and (and (= |$temp_0'$1_AccountLimits_Window'#0''@1| |$temp_0'$1_AccountLimits_Window'#0''@1|) (= $t1@4 _$t1)) (and (= $t21@0 true) (= (ControlFlow 0 201171) 200603))) L13_correct)))))
...
(let ((inline$$AddU64$3$anon3_Then_correct  (=> (and (> (+ $t48@0 _$t0) $MAX_U64) (= (ControlFlow 0 200959) 200961)) inline$$AddU64$3$anon3_Then$1_correct)))
(let ((inline$$AddU64$3$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t48@0 _$t0)) (=> (and (and (= inline$$AddU64$3$dst@1 (+ $t48@0 _$t0)) (= $abort_code@7 $abort_code@6)) (and (= $abort_flag@6 $abort_flag@5) (= inline$$AddU64$3$dst@2 inline$$AddU64$3$dst@1))) (and (=> (= (ControlFlow 0 200907) 201021) anon50_Then_correct) (=> (= (ControlFlow 0 200907) 201007) anon50_Else_correct))))))
...
(let ((inline$$AddU64$2$anon3_Then_correct  (=> (and (> (+ $t45@0 _$t0) $MAX_U64) (= (ControlFlow 0 200758) 200760)) inline$$AddU64$2$anon3_Then$1_correct)))
(let ((inline$$AddU64$2$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t45@0 _$t0)) (=> (and (and (= inline$$AddU64$2$dst@1 (+ $t45@0 _$t0)) (= $abort_flag@5 $abort_flag@4)) (and (= $abort_code@6 $abort_code@5) (= inline$$AddU64$2$dst@2 inline$$AddU64$2$dst@1))) (and (=> (= (ControlFlow 0 200706) 201035) anon49_Then_correct) (=> (= (ControlFlow 0 200706) 200967) anon49_Else_correct))))))
...
(let ((inline$$AddU64$1$anon3_Then_correct  (=> (and (> (+ $t40@0 _$t0) $MAX_U64) (= (ControlFlow 0 200191) 200193)) inline$$AddU64$1$anon3_Then$1_correct)))
(let ((inline$$AddU64$1$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t40@0 _$t0)) (=> (and (and (= inline$$AddU64$1$dst@1 (+ $t40@0 _$t0)) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@4 $abort_flag@3) (= inline$$AddU64$1$dst@2 inline$$AddU64$1$dst@1))) (and (=> (= (ControlFlow 0 200139) 201049) anon47_Then_correct) (=> (= (ControlFlow 0 200139) 200257) anon47_Else_correct))))))
...
(let ((inline$$Sub$1$anon3_Then_correct  (=> (and (< 18446744073709551615 _$t0) (= (ControlFlow 0 199928) 199930)) inline$$Sub$1$anon3_Then$1_correct)))
...
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t30@0 _$t0) $MAX_U64) (= (ControlFlow 0 199711) 199713)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t30@0 _$t0)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t30@0 _$t0)) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 199659) 201077) anon44_Then_correct) (=> (= (ControlFlow 0 199659) 199777) anon44_Else_correct))))))
...
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< 18446744073709551615 _$t0) (= (ControlFlow 0 199448) 199450)) inline$$Sub$0$anon3_Then$1_correct)))
...
(let ((anon39_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t16@0 $abort_code@1) (= (ControlFlow 0 201185) 199175))) L14_correct)))
(let ((anon38_Then$1_correct  (=> (= $t18@1 $t18) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 201237) 201185) anon39_Then_correct) (=> (= (ControlFlow 0 201237) 199227) anon39_Else_correct))))))
...
(let ((anon38_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $t17@0) (=> (and (and (= $t18@0 (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'#0'_| (|contents#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $t17@0)) (= $t18@1 $t18@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 199199) 201185) anon39_Then_correct) (=> (= (ControlFlow 0 199199) 199227) anon39_Else_correct))))))
(let ((anon37_Then_correct  (=> (and $t13@0 (= $t17@0 (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| _$t1)))) (and (=> (= (ControlFlow 0 199185) 201235) anon38_Then_correct) (=> (= (ControlFlow 0 199185) 199199) anon38_Else_correct)))))
...
)) (= $t11@0 (|v#$Mutation_119553| _$t1))) (and (= _$t0 _$t0) (= |$temp_0'$1_AccountLimits_Window'#0''@0| (|v#$Mutation_119553| _$t1))))) (and (and (and (= |$temp_0'$1_AccountLimits_Window'#0''@0| |$temp_0'$1_AccountLimits_Window'#0''@0|) (= $t12@0 (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| _$t1)))) (and (= $t13@0 (|Select__T@[Int]Bool_| (|domain#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $t12@0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t15) (= $t15 5)) (and (= $t15 $t15) (= $t13@0 $t13@0)))))) (and (=> (= (ControlFlow 0 198875) 199185) anon37_Then_correct) (=> (= (ControlFlow 0 198875) 198891) anon37_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 198362) 198875)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (seq.len (|p#$Mutation_10128| $t47)) 0) (=> (and (= (seq.len (|p#$Mutation_10128| $t50)) 0) (= (ControlFlow 0 198372) 198362)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 256584) 198372) anon0_correct)))
