...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 187336) (let ((anon18_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 138442) (- 0 187882)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 138442) (- 0 187899)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 138442) (- 0 187909)) (not (not (= _$t0 173345816)))) (=> (not (not (= _$t0 173345816))) (and (=> (= (ControlFlow 0 138442) (- 0 187923)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory) $t4))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory) $t4)) (=> (= (ControlFlow 0 138442) (- 0 187933)) (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory@1) $t4)))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 138344) (- 0 187804)) (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= _$t0 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory) $t4))) (=> (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= _$t0 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory) $t4)) (=> (= (ControlFlow 0 138344) (- 0 187827)) (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t6@0)) (and (not (= _$t0 173345816)) (= 2 $t6@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory) $t4) (= 6 $t6@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 138456) 138344))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $1_ChainId_ChainId_$memory@1 $1_ChainId_ChainId_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 138506) 138456) anon18_Then_correct) (=> (= (ControlFlow 0 138506) 138442) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory) _$t0) (= (ControlFlow 0 138504) 138506)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory) _$t0)) (=> (and (and (= $1_ChainId_ChainId_$memory@0 ($Memory_90973 (|Store__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory) _$t0 true) (|Store__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_90973| $1_ChainId_ChainId_$memory) _$t0 $t13@0))) (= $1_ChainId_ChainId_$memory@1 $1_ChainId_ChainId_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 138376) 138456) anon18_Then_correct) (=> (= (ControlFlow 0 138376) 138442) anon18_Else_correct))))))
(let ((anon16_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t13@0 ($1_ChainId_ChainId _$t1))) (and (=> (= (ControlFlow 0 138358) (- 0 187690)) (|Select__T@[Int]Bool_| $1_ChainId_ChainId_$modifies _$t0)) (=> (|Select__T@[Int]Bool_| $1_ChainId_ChainId_$modifies _$t0) (and (=> (= (ControlFlow 0 138358) 138504) anon17_Then_correct) (=> (= (ControlFlow 0 138358) 138376) anon17_Else_correct)))))))
(let ((anon16_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t6@0 $t12) (= (ControlFlow 0 138260) 138344))) L3_correct)))
(let ((anon15_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 138244) 138358) anon16_Then_correct) (=> (= (ControlFlow 0 138244) 138260) anon16_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 138208) 138244)) anon15_Else$1_correct)))
(let ((anon15_Else_correct  (=> (not $t7) (=> (and (and (|$IsValid'address'| $t8) (= $t8 _$t0)) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory) $t8)) (= (ControlFlow 0 138214) 138208))) inline$$Not$0$anon0_correct))))
(let ((anon15_Then_correct  (=> $t7 (=> (and (and (and (not (= _$t0 173345816)) (= 2 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 138536) 138344))) L3_correct))))
(let ((anon14_Else_correct  (=> (and (not $t5) (= $t7  (not (= _$t0 173345816)))) (and (=> (= (ControlFlow 0 138152) 138536) anon15_Then_correct) (=> (= (ControlFlow 0 138152) 138214) anon15_Else_correct)))))
...
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_90973| $1_ChainId_ChainId_$memory) 173345816)) (|$IsValid'address'| _$t0)) (=> (and (and (and (|$IsValid'u8'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |ChainIdz3bpl.10128:20|
 :skolemid |168|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_90973| $1_ChainId_ChainId_$memory) $a_0@@0)))
(|$IsValid'$1_ChainId_ChainId'| $rsc@@0))
 :qid |ChainIdz3bpl.10132:20|
 :skolemid |169|
 :pattern ( (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_90973| $1_ChainId_ChainId_$memory) $a_0@@0))
)) (= $t4 _$t0))) (and (and (|Select__T@[Int]Bool_| $1_ChainId_ChainId_$modifies $t4) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t5  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89527| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 138130) 138562) anon14_Then_correct) (=> (= (ControlFlow 0 138130) 138152) anon14_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_60597_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_60597| stream@@0) 0) (forall ((v@@35 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_60597| stream@@0) v@@35) 0)
 :qid |ChainIdz3bpl.129:13|
 :skolemid |2|
 ...
 :qid |ChainIdz3bpl.2538:13|
 :skolemid |69|
))) (= (ControlFlow 0 137992) 138130)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 187336) 137992) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))
))
(check-sat)
(pop 1)
