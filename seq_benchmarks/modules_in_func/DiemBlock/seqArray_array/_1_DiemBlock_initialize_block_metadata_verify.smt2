...
(declare-fun $1_DiemBlock_BlockMetadata_$memory@1 () T@$Memory_102007)
(declare-fun _$t0@@1 () T@$signer)
(declare-fun $t4@0 () Int)
(declare-fun $abort_code@1@@1 () Int)
(declare-fun $1_DiemBlock_BlockMetadata_$memory@0@@0 () T@$Memory_102007)
...
(assert (not
 (=> (= (ControlFlow 0 0) 218925) (let ((anon24_Else_correct@@0  (=> (not $abort_flag@0@@1) (and (=> (= (ControlFlow 0 159573) (- 0 219582)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 159573) (- 0 219597)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 159573) (- 0 219607)) (not (not (= (|$addr#$signer| _$t0@@1) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@1) 173345816))) (and (=> (= (ControlFlow 0 159573) (- 0 219621)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816)) (and (=> (= (ControlFlow 0 159573) (- 0 219629)) (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory@1) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory@1) 173345816) (=> (= (ControlFlow 0 159573) (- 0 219635)) (= (|$height#$1_DiemBlock_BlockMetadata| (|Select__T@[Int]$1_DiemBlock_BlockMetadata_| (|contents#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory@1) 173345816)) 0)))))))))))))))
(let ((anon22_Then_correct@@0 true))
(let ((L3_correct@@0  (and (=> (= (ControlFlow 0 159377) (- 0 219508)) (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0@@1) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (=> (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0@@1) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816)) (=> (= (ControlFlow 0 159377) (- 0 219529)) (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t4@0)) (and (not (= (|$addr#$signer| _$t0@@1) 173345816)) (= 2 $t4@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816) (= 6 $t4@0))))))))
(let ((anon24_Then_correct@@0  (=> (and (and $abort_flag@0@@1 (= $abort_code@1@@1 $abort_code@1@@1)) (and (= $t4@0 $abort_code@1@@1) (= (ControlFlow 0 159587) 159377))) L3_correct@@0)))
(let ((anon23_Then$1_correct  (=> (= $1_DiemBlock_BlockMetadata_$memory@1 $1_DiemBlock_BlockMetadata_$memory) (=> (and (= $abort_flag@0@@1 true) (= $abort_code@1@@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 159639) 159587) anon24_Then_correct@@0) (=> (= (ControlFlow 0 159639) 159573) anon24_Else_correct@@0))))))
(let ((anon23_Then_correct@@0  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) (|$addr#$signer| _$t0@@1)) (= (ControlFlow 0 159637) 159639)) anon23_Then$1_correct)))
(let ((anon23_Else_correct@@0  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) (|$addr#$signer| _$t0@@1))) (=> (and (and (= $1_DiemBlock_BlockMetadata_$memory@0@@0 ($Memory_102007 (|Store__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) (|$addr#$signer| _$t0@@1) true) (|Store__T@[Int]$1_DiemBlock_BlockMetadata_| (|contents#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) (|$addr#$signer| _$t0@@1) $t12@0@@0))) (= $1_DiemBlock_BlockMetadata_$memory@1 $1_DiemBlock_BlockMetadata_$memory@0@@0)) (and (= $abort_flag@0@@1 false) (= $abort_code@1@@1 $abort_code@0@@1))) (and (=> (= (ControlFlow 0 159503) 159587) anon24_Then_correct@@0) (=> (= (ControlFlow 0 159503) 159573) anon24_Else_correct@@0))))))
(let ((anon22_Else_correct@@0  (=> (and (not false) (= $t12@0@@0 ($1_DiemBlock_BlockMetadata 0 |inline$$1_Event_new_event_handle'$1_DiemBlock_NewBlockEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 159481) 159637) anon23_Then_correct@@0) (=> (= (ControlFlow 0 159481) 159503) anon23_Else_correct@@0)))))
(let ((|inline$$1_Event_new_event_handle'$1_DiemBlock_NewBlockEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemBlock_NewBlockEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemBlock_NewBlockEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 159457) 159653) anon22_Then_correct@@0) (=> (= (ControlFlow 0 159457) 159481) anon22_Else_correct@@0)))))
(let ((anon21_Then_correct@@0  (=> inline$$Not$0$dst@1 (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 159463) 159457)) |inline$$1_Event_new_event_handle'$1_DiemBlock_NewBlockEvent'$0$anon0_correct|))))
(let ((anon21_Else_correct@@0  (=> (and (and (not inline$$Not$0$dst@1) (= $t9@@1 $t9@@1)) (and (= $t4@0 $t9@@1) (= (ControlFlow 0 159297) 159377))) L3_correct@@0)))
(let ((anon20_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t9@@1) (= $t9@@1 6)) (and (= $t9@@1 $t9@@1) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 159281) 159463) anon21_Then_correct@@0) (=> (= (ControlFlow 0 159281) 159297) anon21_Else_correct@@0))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not inline$$1_DiemBlock_is_initialized$0$$t1@1)) (= (ControlFlow 0 159245) 159281)) anon20_Else$1_correct)))
(let ((anon20_Else_correct@@0  (=> (and (not false) (= (ControlFlow 0 159251) 159245)) inline$$Not$0$anon0_correct)))
(let ((anon19_Then_correct  (=> $t5 (=> (and (and (and (not (= (|$addr#$signer| _$t0@@1) 173345816)) (= 2 $t4)) (= $t4 $t4)) (and (= $t4@0 $t4) (= (ControlFlow 0 159697) 159377))) L3_correct@@0))))
(let ((anon18_Then_correct  (=> $t3 (=> (and (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t4)) (= $t4 $t4)) (and (= $t4@0 $t4) (= (ControlFlow 0 159723) 159377))) L3_correct@@0))))
(let ((anon20_Then_correct@@0 true))
(let ((inline$$1_DiemBlock_is_initialized$0$anon0_correct  (=> (|$IsValid'address'| 173345816) (=> (and (= inline$$1_DiemBlock_is_initialized$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816)) (= inline$$1_DiemBlock_is_initialized$0$$t1@1 inline$$1_DiemBlock_is_initialized$0$$t1@1)) (and (=> (= (ControlFlow 0 159201) 159667) anon20_Then_correct@@0) (=> (= (ControlFlow 0 159201) 159251) anon20_Else_correct@@0))))))
(let ((anon19_Else_correct  (=> (and (not $t5) (= (ControlFlow 0 159207) 159201)) inline$$1_DiemBlock_is_initialized$0$anon0_correct)))
(let ((anon18_Else_correct  (=> (and (not $t3) (= $t5  (not (= (|$addr#$signer| _$t0@@1) 173345816)))) (and (=> (= (ControlFlow 0 159114) 159697) anon19_Then_correct) (=> (= (ControlFlow 0 159114) 159207) anon19_Else_correct)))))
(let ((anon0$1_correct@@1  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_104448| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_103977| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_106232| $1_DiemSystem_CapabilityHolder_$memory) 173345816)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816)) (|$IsValid'address'| (|$addr#$signer| _$t0@@1)))) (and (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@3)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@3))
 :qid |DiemBlockbpl.12879:20|
 :skolemid |230|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@3))
)) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DiemBlock_BlockMetadata_| (|contents#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) $a_0@@4)))
(|$IsValid'$1_DiemBlock_BlockMetadata'| $rsc@@4))
 :qid |DiemBlockbpl.12883:20|
 :skolemid |231|
 :pattern ( (|Select__T@[Int]$1_DiemBlock_BlockMetadata_| (|contents#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) $a_0@@4))
))) (and (= _$t0@@1 _$t0@@1) (= $t3  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 159092) 159723) anon18_Then_correct) (=> (= (ControlFlow 0 159092) 159114) anon18_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@6 T@$1_Event_EventHandle) ) (! (let ((stream@@6 (|Select__T@[$1_Event_EventHandle]Multiset_65564_| (|streams#$EventStore| $es) handle@@6)))
 (and (= (|l#Multiset_65564| stream@@6) 0) (forall ((v@@55 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_65564| stream@@6) v@@55) 0)
 :qid |DiemBlockbpl.159:13|
 :skolemid |4|
))))
 :qid |DiemBlockbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 158958) 159092)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 218925) 158958) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1))))))))))))))))))))))))
))
(check-sat)
(pop 1)
