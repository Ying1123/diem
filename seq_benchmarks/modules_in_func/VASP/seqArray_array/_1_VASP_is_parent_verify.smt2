...
(assert (not
 (=> (= (ControlFlow 0 0) 225786) (let ((anon0$1_correct@@1  (=> (and (forall ((child_addr@@1 Int) ) (!  (=> (|$IsValid'address'| child_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) child_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127999| $1_VASP_ChildVASP_$memory) child_addr@@1)))))
 :qid |VASPbpl.9343:20|
 :skolemid |204|
)) (|$IsValid'address'| _$t0@@1)) (=> (and (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_128063| $1_VASP_ParentVASP_$memory) $a_0@@3)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@3))
 :qid |VASPbpl.9350:20|
 :skolemid |205|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_128063| $1_VASP_ParentVASP_$memory) $a_0@@3))
)) (= _$t0@@1 _$t0@@1)) (and (= $t1@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0@@1)) (= $t1@0@@0 $t1@0@@0))) (and (=> (= (ControlFlow 0 163457) (- 0 225921)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 163457) (- 0 225928)) (= $t1@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0@@1))) (=> (= $t1@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0@@1)) (and (=> (= (ControlFlow 0 163457) (- 0 225939)) (forall ((a@@2 Int) ) (!  (=> (|$IsValid'address'| a@@2) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) a@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) a@@2)))
 :qid |VASPbpl.9387:15|
 :skolemid |206|
))) (=> (forall ((a@@3 Int) ) (!  (=> (|$IsValid'address'| a@@3) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) a@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) a@@3)))
 :qid |VASPbpl.9387:15|
 :skolemid |206|
)) (=> (= (ControlFlow 0 163457) (- 0 225964)) (forall ((parent@@0 Int) ) (!  (=> (|$IsValid'address'| parent@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) parent@@0) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_128063| $1_VASP_ParentVASP_$memory) parent@@0)) (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_128063| $1_VASP_ParentVASP_$memory) parent@@0)))))
 :qid |VASPbpl.9392:15|
 :skolemid |207|
)))))))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@3 T@$1_Event_EventHandle) ) (! (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_68395_| (|streams#$EventStore| $es) handle@@3)))
 (and (= (|l#Multiset_68395| stream@@2) 0) (forall ((v@@46 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_68395| stream@@2) v@@46) 0)
 :qid |VASPbpl.159:13|
 :skolemid |4|
))))
 :qid |VASPbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 163280) 163457)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 225786) 163280) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1))))
))
(check-sat)
(pop 1)
