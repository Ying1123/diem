...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 921279) (let ((anon11_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t4@0 (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t3@1)) (= $t4@0 $t4@0)) (and (=> (= (ControlFlow 0 695556) (- 0 921636)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 695556) (- 0 921657)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256249| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256249| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr))))
 ...
 :qid |Diembpl.33376:15|
 :skolemid |1226|
)) (and (=> (= (ControlFlow 0 695556) (- 0 921686)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256249| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256249| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@1)))
 ...
 :qid |Diembpl.33381:15|
 :skolemid |1227|
)) (and (=> (= (ControlFlow 0 695556) (- 0 921711)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 695556) (- 0 921732)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256696| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256696| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@3))))
 ...
 :qid |Diembpl.33391:15|
 :skolemid |1228|
)) (and (=> (= (ControlFlow 0 695556) (- 0 921761)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256696| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_256696| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@5)))
 ...
 :qid |Diembpl.33411:15|
 :skolemid |1230|
)) (=> (= (ControlFlow 0 695556) (- 0 921864)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262172| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_262172| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@9)))
 :qid |Diembpl.33416:15|
 :skolemid |1231|
)))))))))))))))))))))))))
(let ((anon11_Then_correct true))
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 695628) 695570) anon11_Then_correct) (=> (= (ControlFlow 0 695628) 695556) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= (ControlFlow 0 695626) 695628)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= $t3@1 $t3@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 695276) 695570) anon11_Then_correct) (=> (= (ControlFlow 0 695276) 695556) anon11_Else_correct))))))
(let ((anon9_Else_correct  (=> (and (not $t0) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 695262) 695626) anon10_Then_correct) (=> (= (ControlFlow 0 695262) 695276) anon10_Else_correct)))))
...
)) (= $t0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_255502| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 695248) 695654) anon9_Then_correct) (=> (= (ControlFlow 0 695248) 695262) anon9_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 695075) 695248)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 921279) 695075) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))
))
(check-sat)
(pop 1)
