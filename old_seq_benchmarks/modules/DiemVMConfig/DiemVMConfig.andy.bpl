...
L8:
    ...
    assert {:msg "assert_failed(17,3378,4123): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#105) && $IsEqual'u8'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 0) && $IsEqual'u8'(2, $t11))) || (if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'u8'(7, $t11)));
...
L8:
    ...
    // @138 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@138](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#138), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L7:
    ...
    // @178 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@178](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
...
procedure {:inline 1} $1_RegisteredCurrencies_add_currency_code(_$t0: int, _$t1: Vec (int)) returns ()
{
    ...
    var $1_DiemConfig_Configuration_$memory#144: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
    $t1 := _$t1;
...
L6:
    ...
    // @144 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
    $1_DiemConfig_Configuration_$memory#144 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@144](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#144), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L7:
    ...
    // @168 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@168](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#168), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L7:
    ...
    // @162 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@162](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
...
procedure {:timeLimit 40} $1_DiemVMConfig_initialize$verify(_$t0: int, _$t1: Vec (int), _$t2: Vec (int)) returns ()
{
    // declare local variables
    var $t3: $1_DiemVMConfig_GasConstants;
    var $t4: $1_DiemVMConfig_GasConstants;
    ...
    var $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#153: $Memory $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig';
    var $1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#154: $Memory $1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig';
    ...
    // @152 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:73:5+1
    assume {:print "$at(19,3418,3419)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#152 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @151 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:73:5+1
    $1_Roles_RoleId_$memory#151 := $1_Roles_RoleId_$memory;

    // @155 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:73:5+1
    $1_DiemConfig_Configuration_$memory#155 := $1_DiemConfig_Configuration_$memory;

    // @153 := save_mem(DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:73:5+1
    $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#153 := $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory;

    // @154 := save_mem(DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:73:5+1
    $1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#154 := $1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory;
...
L7:
    ...
    // @156 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@156](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
...
L1:
    ...
    // assert Not(Not(exists[@151]<Roles::RoleId>($t5))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    assume {:print "$at(26,23574,23633)"} true;
    assert {:msg "assert_failed(26,23574,23633): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#151, $t5);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t5)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    assume {:print "$at(26,23642,23729)"} true;
    assert {:msg "assert_failed(26,23642,23729): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#151, $t5)), 0);
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@152]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:140:9+51
    assume {:print "$at(17,5622,5673)"} true;
    assert {:msg "assert_failed(17,5622,5673): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#152);

    // assert Not(DiemConfig::spec_is_published[@153]<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:257:9+38
    assume {:print "$at(13,10749,10787)"} true;
    assert {:msg "assert_failed(13,10749,10787): function does not abort under this condition"}
      !$1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#153);

    // assert Not(exists[@154]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:258:9+86
    assume {:print "$at(13,10796,10882)"} true;
    assert {:msg "assert_failed(13,10796,10882): function does not abort under this condition"}
      !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#154, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@151]<Roles::RoleId>($t6))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    assume {:print "$at(26,23574,23633)"} true;
    assert {:msg "assert_failed(26,23574,23633): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#151, $t6);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t6)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    assume {:print "$at(26,23642,23729)"} true;
    assert {:msg "assert_failed(26,23642,23729): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#151, $t6)), 0);
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@155](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:144:9+52
    assume {:print "$at(13,5734,5786)"} true;
    assert {:msg "assert_failed(13,5734,5786): post-condition does not hold"}
      $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#155), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assert Implies(DiemConfig::spec_is_published[@153]<DiemVMConfig::DiemVMConfig>(), Eq<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(global<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(a550c18), global[@153]<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:223:9+187
    assume {:print "$at(19,9784,9971)"} true;
    assert {:msg "assert_failed(19,9784,9971): post-condition does not hold"}
      ($1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#153) ==> $IsEqual'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig''($ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, 173345816), $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#153, 173345816)));
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Not(exists[@151]<Roles::RoleId>($t5)), Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t5)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), Not(DiemTimestamp::$is_genesis[@152]())), DiemConfig::spec_is_published[@153]<DiemVMConfig::DiemVMConfig>()), exists[@154]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0))), Not(exists[@151]<Roles::RoleId>($t6))), Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t6)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:108:5+1132
    assume {:print "$at(19,4573,5705)"} true;
    assert {:msg "assert_failed(19,4573,5705): abort not covered by any of the `aborts_if` clauses"}
      ((((((((!$ResourceExists($1_Roles_RoleId_$memory#151, $t5) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#151, $t5)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#152)) || $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#153)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#154, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#151, $t6)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#151, $t6)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(And(Not(exists[@151]<Roles::RoleId>($t5)), Eq(5, $t8)), And(Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t5)), 0), Eq(3, $t8))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t8))), And(Not(DiemTimestamp::$is_genesis[@152]()), Eq(1, $t8))), DiemConfig::spec_is_published[@153]<DiemVMConfig::DiemVMConfig>()), exists[@154]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0))), And(Not(exists[@151]<Roles::RoleId>($t6)), Eq(5, $t8))), And(Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t6)), 0), Eq(3, $t8))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t8))) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:108:5+1132
    assert {:msg "assert_failed(19,4573,5705): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((((!$ResourceExists($1_Roles_RoleId_$memory#151, $t5) && $IsEqual'u8'(5, $t8)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#151, $t5)), 0) && $IsEqual'u8'(3, $t8))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t8))) || (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#152) && $IsEqual'u8'(1, $t8))) || $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#153)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#154, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory#151, $t6) && $IsEqual'u8'(5, $t8))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#151, $t6)), 0) && $IsEqual'u8'(3, $t8))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t8)));
...
procedure {:timeLimit 40} $1_DiemVMConfig_set_gas_constants$verify(_$t0: int, _$t1: int, _$t2: int, _$t3: int, _$t4: int, _$t5: int, _$t6: int, _$t7: int, _$t8: int, _$t9: int, _$t10: int, _$t11: int) returns ()
{
    // declare local variables
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_Roles_RoleId_$memory#180: $Memory $1_Roles_RoleId;
    var $1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#181: $Memory $1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig';
    var $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#182: $Memory $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig';
    var $1_DiemConfig_DisableReconfiguration_$memory#183: $Memory $1_DiemConfig_DisableReconfiguration;
    ...
    // assume Identical($t20, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:357:9+46
    assume {:print "$at(13,15374,15420)"} true;
    assume ($t20 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t21, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:358:9+58
    assume {:print "$at(13,15429,15487)"} true;
    assume ($t21 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // @179 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:138:5+1
    assume {:print "$at(19,5711,5712)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @180 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:138:5+1
    $1_Roles_RoleId_$memory#180 := $1_Roles_RoleId_$memory;

    // @184 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:138:5+1
    $1_DiemConfig_Configuration_$memory#184 := $1_DiemConfig_Configuration_$memory;

    // @183 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:138:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#183 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @182 := save_mem(DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:138:5+1
    $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#182 := $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory;

    // @181 := save_mem(DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:138:5+1
    $1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#181 := $1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory;
...
L7:
    ...
    assume {:print "$at(19,6225,6258)"} true;
    assume {:print "$track_abort(32,1):", $t23} $t23 == $t23;
...
L6:
    ...
    // assume Identical($t24, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:525:9+44
    assume {:print "$at(26,23521,23565)"} true;
...
L9:
    ...
    assume ((((!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t23)) || (!$ResourceExists($1_Roles_RoleId_$memory, $t24) && $IsEqual'u8'(5, $t23))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t24)), 0) && $IsEqual'u8'(3, $t23))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t23)));
...
L8:
    ...
    // trace_local[tmp#$15]($t28) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:154:9+145
    assume {:print "$at(19,6313,6458)"} true;
    assume {:print "$track_local(32,1,15):", $t28} $t28 == $t28;

    // trace_local[tmp#$14]($t26) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:154:9+145
    assume {:print "$track_local(32,1,14):", $t26} $t26 == $t26;
...
L1:
    ...
    assume {:print "$at(19,6313,6458)"} true;
    assume {:print "$track_abort(32,1):", $t28} $t28 == $t28;
...
L0:
    ...
    // trace_local[tmp#$17]($t31) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:158:9+153
    assume {:print "$at(19,6468,6621)"} true;
    assume {:print "$track_local(32,1,17):", $t31} $t31 == $t31;

    // trace_local[tmp#$16]($t29) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:158:9+153
    assume {:print "$track_local(32,1,16):", $t29} $t29 == $t29;
...
L3:
    ...
    assume {:print "$at(19,6468,6621)"} true;
    assume {:print "$track_abort(32,1):", $t31} $t31 == $t31;
...
L2:
    ...
    // $t12 := opaque begin: DiemConfig::get<DiemVMConfig::DiemVMConfig>() at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:163:22+31
...
L11:
    ...
    assume (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, 173345816) && $IsEqual'u8'(5, $t23));
...
L10:
    ...
    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:163:22+31
    assume $IsValid'$1_DiemVMConfig_DiemVMConfig'($t12);

    // assume Eq<DiemVMConfig::DiemVMConfig>($t12, DiemConfig::$get<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:163:22+31
    ...
    // $t12 := opaque end: DiemConfig::get<DiemVMConfig::DiemVMConfig>() at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:163:22+31

    // trace_local[config]($t12) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:163:13+6
    assume {:print "$track_local(32,1,12):", $t12} $t12 == $t12;

    // $t33 := borrow_local($t12) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:164:34+6
    ...
    assume {:print "$track_local(32,1,13):", $temp_0'$1_DiemVMConfig_GasConstants'} $temp_0'$1_DiemVMConfig_GasConstants' == $temp_0'$1_DiemVMConfig_GasConstants';
    ...
    // write_back[LocalRoot($t12)@]($t33) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:176:9+70
    $t12 := $Dereference($t33);

    // $t47 := move($t12) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:178:37+6
    ...
    // assume Identical($t48, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:357:9+46
    assume {:print "$at(13,15374,15420)"} true;
    assume ($t48 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t49, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:358:9+58
    assume {:print "$at(13,15429,15487)"} true;
...
L13:
    ...
    assume (((!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t23)) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, 173345816) && $IsEqual'u8'(5, $t23))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) > 0)) && ($epoch#$1_DiemConfig_Configuration($t48) < 18446744073709551615)) && ($t49 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t48))) && $IsEqual'u8'(1, $t23)));
...
L12:
    ...
    // @185 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:178:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@185](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:178:9+35
...
L4:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@179]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
    assume {:print "$at(17,6375,6428)"} true;
    assert {:msg "assert_failed(17,6375,6428): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179);

    // assert Not(Not(exists[@180]<Roles::RoleId>($t19))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    assume {:print "$at(26,23574,23633)"} true;
    assert {:msg "assert_failed(26,23574,23633): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#180, $t19);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@180]<Roles::RoleId>($t19)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    assume {:print "$at(26,23642,23729)"} true;
    assert {:msg "assert_failed(26,23642,23729): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#180, $t19)), 0);
    ...
    // assert Not(Not(exists[@181]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:137:9+129
    assume {:print "$at(13,5441,5570)"} true;
    assert {:msg "assert_failed(13,5441,5570): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#181, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@182]<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:101:9+76
    assume {:print "$at(13,3859,3935)"} true;
    assert {:msg "assert_failed(13,3859,3935): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#182, 173345816);

    // assert Not(And(And(And(And(DiemTimestamp::$is_operating[@179](), DiemConfig::$reconfiguration_enabled[@183]()), Gt(DiemTimestamp::spec_now_microseconds[@179](), 0)), Lt(select DiemConfig::Configuration.epoch($t20), 18446744073709551615)), Lt($t21, select DiemConfig::Configuration.last_reconfiguration_time($t20)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:359:9+283
    assume {:print "$at(13,15496,15779)"} true;
    assert {:msg "assert_failed(13,15496,15779): function does not abort under this condition"}
      !(((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#183)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) > 0)) && ($epoch#$1_DiemConfig_Configuration($t20) < 18446744073709551615)) && ($t21 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t20)));
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@184](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:208:9+76
    assume {:print "$at(19,9311,9387)"} true;
    assert {:msg "assert_failed(19,9311,9387): post-condition does not hold"}
      $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#184), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L5:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_operating[@179]()), Not(exists[@180]<Roles::RoleId>($t19))), Neq<u64>(select Roles::RoleId.role_id(global[@180]<Roles::RoleId>($t19)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), Not(exists[@181]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0)))), Not(exists[@182]<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(a550c18))), And(And(And(And(DiemTimestamp::$is_operating[@179](), DiemConfig::$reconfiguration_enabled[@183]()), Gt(DiemTimestamp::spec_now_microseconds[@179](), 0)), Lt(select DiemConfig::Configuration.epoch($t20), 18446744073709551615)), Lt($t21, select DiemConfig::Configuration.last_reconfiguration_time($t20)))), Gt($t7, $t8)), Gt($t3, $t6)) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:180:5+1656
    assume {:print "$at(19,7737,9393)"} true;
    assert {:msg "assert_failed(19,7737,9393): abort not covered by any of the `aborts_if` clauses"}
      ((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) || !$ResourceExists($1_Roles_RoleId_$memory#180, $t19)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#180, $t19)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#181, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#182, 173345816)) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#183)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) > 0)) && ($epoch#$1_DiemConfig_Configuration($t20) < 18446744073709551615)) && ($t21 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t20)))) || ($t7 > $t8)) || ($t3 > $t6));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@179]()), Eq(1, $t23)), And(Not(exists[@180]<Roles::RoleId>($t19)), Eq(5, $t23))), And(Neq<u64>(select Roles::RoleId.role_id(global[@180]<Roles::RoleId>($t19)), 0), Eq(3, $t23))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t23))), And(Not(exists[@181]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0))), Eq(4, $t23))), And(Not(exists[@182]<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(a550c18)), Eq(5, $t23))), And(And(And(And(And(DiemTimestamp::$is_operating[@179](), DiemConfig::$reconfiguration_enabled[@183]()), Gt(DiemTimestamp::spec_now_microseconds[@179](), 0)), Lt(select DiemConfig::Configuration.epoch($t20), 18446744073709551615)), Lt($t21, select DiemConfig::Configuration.last_reconfiguration_time($t20))), Eq(1, $t23))), And(Gt($t7, $t8), Eq(7, $t23))), And(Gt($t3, $t6), Eq(7, $t23))) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:180:5+1656
    assert {:msg "assert_failed(19,7737,9393): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) && $IsEqual'u8'(1, $t23)) || (!$ResourceExists($1_Roles_RoleId_$memory#180, $t19) && $IsEqual'u8'(5, $t23))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#180, $t19)), 0) && $IsEqual'u8'(3, $t23))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t23))) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#181, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t23))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#182, 173345816) && $IsEqual'u8'(5, $t23))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#183)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) > 0)) && ($epoch#$1_DiemConfig_Configuration($t20) < 18446744073709551615)) && ($t21 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t20))) && $IsEqual'u8'(1, $t23))) || (($t7 > $t8) && $IsEqual'u8'(7, $t23))) || (($t3 > $t6) && $IsEqual'u8'(7, $t23)));
...
L7:
    ...
    // @150 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@150](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
