...
procedure {:timeLimit 40} $1_DiemTimestamp_update_global_time$verify(_$t0: int, _$t1: int, _$t2: int) returns ()
{
    ...
    var $temp_0'u64': int;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#110: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    ...
    // @110 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:78:9+77
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#110 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;
...
L5:
    ...
    // assume Implies(DiemTimestamp::$is_operating(), XDX::reserve_exists()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assume Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XDX::XDX>()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountLimits::LimitsDefinition<XDX::XDX>>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assert Implies(DiemTimestamp::$is_operating(), XDX::reserve_exists()) at /home/ying/diem/language/diem-framework/modules/XDX.move:125:9+61
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:125:9+61
    assume {:print "$at(37,5696,5757)"} true;
    assert {:msg "assert_failed(37,5696,5757): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_XDX_reserve_exists($1_XDX_Reserve_$memory));

    // assert Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XDX::XDX>()) at /home/ying/diem/language/diem-framework/modules/XDX.move:128:9+69
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:128:9+69
    assume {:print "$at(37,5813,5882)"} true;
    assert {:msg "assert_failed(37,5813,5882): global memory invariant does not hold"}
    ...
    // assert Implies(DiemTimestamp::$is_operating(), exists<AccountLimits::LimitsDefinition<XDX::XDX>>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/XDX.move:141:9+137
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:141:9+137
    assume {:print "$at(37,6381,6518)"} true;
    assert {:msg "assert_failed(37,6381,6518): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));
...
L7:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@110]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#110);
...
L8:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_operating[@110]()), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$VM_RESERVED_ADDRESS[]())), (if Eq<address>($t1, CoreAddresses::$VM_RESERVED_ADDRESS[]()) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}})) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:5+795
    assume {:print "$at(17,3408,4203)"} true;
    assert {:msg "assert_failed(17,3408,4203): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#110) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS())) || if ($IsEqual'address'($t1, $1_CoreAddresses_$VM_RESERVED_ADDRESS())) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)));

    // assert Or(Or(And(Not(DiemTimestamp::$is_operating[@110]()), Eq(1, $t11)), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$VM_RESERVED_ADDRESS[]()), Eq(2, $t11))), And((if Eq<address>($t1, CoreAddresses::$VM_RESERVED_ADDRESS[]()) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}}), Eq(7, $t11))) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:5+795
    assert {:msg "assert_failed(17,3408,4203): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#110) && $IsEqual'u8'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS()) && $IsEqual'u8'(2, $t11))) || (if ($IsEqual'address'($t1, $1_CoreAddresses_$VM_RESERVED_ADDRESS())) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'u8'(7, $t11)));
...
L7:
    ...
    // @179 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@179](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
L6:
    ...
    // @151 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@151](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
function {:inline} $1_Diem_spec_currency_info'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory: $Memory $1_Diem_CurrencyInfo'$1_XDX_XDX'): $1_Diem_CurrencyInfo'$1_XDX_XDX' {
    $ResourceValue($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory, $1_CoreAddresses_$CURRENCY_INFO_ADDRESS())
}
...
// spec fun at /home/ying/diem/language/diem-framework/modules/XDX.move:112:5+92
function {:inline} $1_XDX_$reserve_address(): int {
    $1_CoreAddresses_$CURRENCY_INFO_ADDRESS()
}

// spec fun at /home/ying/diem/language/diem-framework/modules/XDX.move:106:10+206
...
// fun XDX::initialize [verification] at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
procedure {:timeLimit 40} $1_XDX_initialize$verify(_$t0: int, _$t1: int) returns ()
{
    // declare local variables
    var $t2: $1_Diem_BurnCapability'$1_XDX_XDX';
    var $t3: $1_Diem_MintCapability'$1_XDX_XDX';
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_XDX_Reserve_$memory#208: $Memory $1_XDX_Reserve;
    var $1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#209: $Memory $1_Diem_CurrencyInfo'$1_XDX_XDX';
    var $1_Roles_RoleId_$memory#210: $Memory $1_Roles_RoleId;
    var $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211: $Memory $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies';
    var $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212: $Memory $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies';
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_DiemConfig_DisableReconfiguration_$memory#214: $Memory $1_DiemConfig_DisableReconfiguration;
    var $1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory#215: $Memory $1_AccountLimits_LimitsDefinition'$1_XDX_XDX';
    var $1_XDX_Reserve_$memory#239: $Memory $1_XDX_Reserve;
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(37,2310,3308)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<RegisteredCurrencies::RegisteredCurrencies>()) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    ...
    // assume true at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:552:9+318
    assume true;

    // assume Implies(DiemTimestamp::$is_operating(), XDX::reserve_exists()) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:125:9+61
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_XDX_reserve_exists($1_XDX_Reserve_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XDX::XDX>()) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:128:9+69
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Diem_$is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountLimits::LimitsDefinition<XDX::XDX>>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:141:9+137
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume forall addr: TypeDomain<address>() where exists<AccountLimits::LimitsDefinition<XDX::XDX>>(addr): Eq<address>(addr, CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    ...
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    ...
    // assume forall $rsc: ResourceDomain<Diem::CurrencyInfo<XDX::XDX>>(): And(WellFormed($rsc), And(Lt(0, select Diem::CurrencyInfo.scaling_factor($rsc)), Le(select Diem::CurrencyInfo.scaling_factor($rsc), 10000000000))) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    ...
    // assume forall $rsc: ResourceDomain<XDX::Reserve>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    ...
    // @213 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+1
    assume {:print "$at(37,2310,2311)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @210 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+1
    $1_Roles_RoleId_$memory#210 := $1_Roles_RoleId_$memory;

    // @214 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#214 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @211 := save_mem(DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+1
    $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211 := $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory;

    // @212 := save_mem(DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+1
    $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212 := $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory;

    // @209 := save_mem(Diem::CurrencyInfo<XDX::XDX>) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+1
    $1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#209 := $1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory;

    // @215 := save_mem(AccountLimits::LimitsDefinition<XDX::XDX>) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+1
    $1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory#215 := $1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory;

    // @208 := save_mem(XDX::Reserve) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+1
    $1_XDX_Reserve_$memory#208 := $1_XDX_Reserve_$memory;
...
L8:
    ...
    // @239 := save_mem(XDX::Reserve) at /home/ying/diem/language/diem-framework/modules/XDX.move:49:5+998
    // state save for global update invariants
    assume {:print "$at(37,2310,3308)"} true;
    $1_XDX_Reserve_$memory#239 := $1_XDX_Reserve_$memory;
    ...
    // assert Implies(exists[@239]<XDX::Reserve>(XDX::$reserve_address[]()), exists<XDX::Reserve>(XDX::$reserve_address())) at /home/ying/diem/language/diem-framework/modules/XDX.move:149:9+108
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:149:9+108
    assume {:print "$at(37,6792,6900)"} true;
    assert {:msg "assert_failed(37,6792,6900): global memory invariant does not hold"}
      ($ResourceExists($1_XDX_Reserve_$memory#239, $1_XDX_$reserve_address()) ==> $ResourceExists($1_XDX_Reserve_$memory, $1_XDX_$reserve_address()));
...
L2:
    ...
    // assert Not(exists[@208]<XDX::Reserve>(CoreAddresses::$DIEM_ROOT_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/XDX.move:75:9+93
    assume {:print "$at(37,3439,3532)"} true;
    assert {:msg "assert_failed(37,3439,3532): function does not abort under this condition"}
      !$ResourceExists($1_XDX_Reserve_$memory#208, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());

    // assert Not(Or(Eq<u64>(1000000, 0), Gt(1000000, 10000000000))) at /home/ying/diem/language/diem-framework/modules/Diem.move:1281:9+99
    assume {:print "$at(10,61646,61745)"} true;
    assert {:msg "assert_failed(10,61646,61745): function does not abort under this condition"}
      !($IsEqual'u128'(1000000, 0) || (1000000 > 10000000000));

    // assert Not(exists[@209]<Diem::CurrencyInfo<XDX::XDX>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/Diem.move:1283:9+121
    assume {:print "$at(10,61831,61952)"} true;
    assert {:msg "assert_failed(10,61831,61952): function does not abort under this condition"}
      !$ResourceExists($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#209, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@210]<Roles::RoleId>($t7))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#210, $t7);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t7)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t7)), 0);
    ...
    // assert Not(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@211]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 68, 88])) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:72:9+154
    assume {:print "$at(25,2617,2771)"} true;
    assert {:msg "assert_failed(25,2617,2771): function does not abort under this condition"}
      !$ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211)), MakeVec3(88, 68, 88));

    // assert Not(Not(exists[@212]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:140:9+129
    assume {:print "$at(13,5612,5741)"} true;
    assert {:msg "assert_failed(13,5612,5741): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@211]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:104:9+101
    assume {:print "$at(13,3930,4031)"} true;
    assert {:msg "assert_failed(13,3930,4031): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());

    // assert Not(And(And(And(And(DiemTimestamp::$is_operating[@213](), DiemConfig::$reconfiguration_enabled[@214]()), Gt(DiemTimestamp::spec_now_microseconds[@213](), 0)), Lt(select DiemConfig::Configuration.epoch($t8), 18446744073709551615)), Lt($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:362:9+283
    assume {:print "$at(13,16092,16375)"} true;
    assert {:msg "assert_failed(13,16092,16375): function does not abort under this condition"}
      !(((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#214)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) > 0)) && ($epoch#$1_DiemConfig_Configuration($t8) < 18446744073709551615)) && ($t9 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t8)));

    // assert Not(exists[@215]<AccountLimits::LimitsDefinition<XDX::XDX>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:211:9+130
    assume {:print "$at(5,8837,8967)"} true;
    assert {:msg "assert_failed(5,8837,8967): function does not abort under this condition"}
      !$ResourceExists($1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory#215, $1_Signer_spec_address_of($t0));

    // assert Not(Not(DiemTimestamp::$is_genesis[@213]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:142:9+51
    assume {:print "$at(17,5802,5853)"} true;
    assert {:msg "assert_failed(17,5802,5853): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213);

    // assert Not(Not(exists[@210]<Roles::RoleId>($t10))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#210, $t10);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t10)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t10)), 0);
    ...
    // assert Not(Not(exists[@210]<Roles::RoleId>($t11))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    assume {:print "$at(26,24063,24122)"} true;
    assert {:msg "assert_failed(26,24063,24122): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#210, $t11);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t11)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    assume {:print "$at(26,24131,24228)"} true;
    assert {:msg "assert_failed(26,24131,24228): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t11)), 1);
    ...
    // assert Diem::spec_is_currency<XDX::XDX>() at /home/ying/diem/language/diem-framework/modules/Diem.move:1289:9+37
    ...
    // assert Eq<u128>(select Diem::CurrencyInfo.total_value(Diem::spec_currency_info<XDX::XDX>()), 0) at /home/ying/diem/language/diem-framework/modules/Diem.move:1290:9+56
    ...
    // assert Eq<bool>(select Diem::CurrencyInfo.can_mint(Diem::spec_currency_info<XDX::XDX>()), false) at /home/ying/diem/language/diem-framework/modules/Diem.move:1535:9+60
    ...
    // assert exists<AccountLimits::LimitsDefinition<XDX::XDX>>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:216:9+85
    assume {:print "$at(5,9076,9161)"} true;
    assert {:msg "assert_failed(5,9076,9161): post-condition does not hold"}
      $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory, $1_Signer_spec_address_of($t0));

    // assert exists<XDX::Reserve>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/XDX.move:85:9+60
    assume {:print "$at(37,4001,4061)"} true;
    assert {:msg "assert_failed(37,4001,4061): post-condition does not hold"}
      $ResourceExists($1_XDX_Reserve_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());

    // return () at /home/ying/diem/language/diem-framework/modules/XDX.move:85:9+60
    return;
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$CURRENCY_INFO_ADDRESS[]()), exists[@208]<XDX::Reserve>(CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Or(Eq<u64>(1000000, 0), Gt(1000000, 10000000000))), exists[@209]<Diem::CurrencyInfo<XDX::XDX>>(Signer::spec_address_of[]($t0))), Not(exists[@210]<Roles::RoleId>($t7))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t7)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$CURRENCY_INFO_ADDRESS[]())), ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@211]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 68, 88])), Not(exists[@212]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))), Not(exists[@211]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))), And(And(And(And(DiemTimestamp::$is_operating[@213](), DiemConfig::$reconfiguration_enabled[@214]()), Gt(DiemTimestamp::spec_now_microseconds[@213](), 0)), Lt(select DiemConfig::Configuration.epoch($t8), 18446744073709551615)), Lt($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8)))), exists[@215]<AccountLimits::LimitsDefinition<XDX::XDX>>(Signer::spec_address_of[]($t0))), Not(DiemTimestamp::$is_genesis[@213]())), Not(exists[@210]<Roles::RoleId>($t10))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t10)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Not(exists[@210]<Roles::RoleId>($t11))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t11)), 1)), Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/XDX.move:72:5+1277
    assume {:print "$at(37,3313,4590)"} true;
    assert {:msg "assert_failed(37,3313,4590): abort not covered by any of the `aborts_if` clauses"}
      (((((((((((((((((((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$CURRENCY_INFO_ADDRESS()) || $ResourceExists($1_XDX_Reserve_$memory#208, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || ($IsEqual'u128'(1000000, 0) || (1000000 > 10000000000))) || $ResourceExists($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#209, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t7)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t7)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$CURRENCY_INFO_ADDRESS())) || $ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211)), MakeVec3(88, 68, 88))) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#214)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) > 0)) && ($epoch#$1_DiemConfig_Configuration($t8) < 18446744073709551615)) && ($t9 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t8)))) || $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory#215, $1_Signer_spec_address_of($t0))) || !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213)) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t10)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t10)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t11)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t11)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$CURRENCY_INFO_ADDRESS[]()), Eq(2, $t13)), And(exists[@208]<XDX::Reserve>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(6, $t13))), And(Or(Eq<u64>(1000000, 0), Gt(1000000, 10000000000)), Eq(7, $t13))), And(exists[@209]<Diem::CurrencyInfo<XDX::XDX>>(Signer::spec_address_of[]($t0)), Eq(6, $t13))), And(Not(exists[@210]<Roles::RoleId>($t7)), Eq(5, $t13))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t7)), 0), Eq(3, $t13))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t13))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$CURRENCY_INFO_ADDRESS[]()), Eq(2, $t13))), And(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@211]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 68, 88]), Eq(7, $t13))), And(Not(exists[@212]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))), Eq(4, $t13))), And(Not(exists[@211]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Eq(5, $t13))), And(And(And(And(And(DiemTimestamp::$is_operating[@213](), DiemConfig::$reconfiguration_enabled[@214]()), Gt(DiemTimestamp::spec_now_microseconds[@213](), 0)), Lt(select DiemConfig::Configuration.epoch($t8), 18446744073709551615)), Lt($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8))), Eq(1, $t13))), And(exists[@215]<AccountLimits::LimitsDefinition<XDX::XDX>>(Signer::spec_address_of[]($t0)), Eq(6, $t13))), And(Not(DiemTimestamp::$is_genesis[@213]()), Eq(1, $t13))), And(Not(exists[@210]<Roles::RoleId>($t10)), Eq(5, $t13))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t10)), 0), Eq(3, $t13))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t13))), And(Not(exists[@210]<Roles::RoleId>($t11)), Eq(5, $t13))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t11)), 1), Eq(3, $t13))), And(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t13))) at /home/ying/diem/language/diem-framework/modules/XDX.move:72:5+1277
    assert {:msg "assert_failed(37,3313,4590): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((((((((((((((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$CURRENCY_INFO_ADDRESS()) && $IsEqual'u8'(2, $t13)) || ($ResourceExists($1_XDX_Reserve_$memory#208, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(6, $t13))) || (($IsEqual'u128'(1000000, 0) || (1000000 > 10000000000)) && $IsEqual'u8'(7, $t13))) || ($ResourceExists($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#209, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(6, $t13))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t7) && $IsEqual'u8'(5, $t13))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t7)), 0) && $IsEqual'u8'(3, $t13))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t13))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$CURRENCY_INFO_ADDRESS()) && $IsEqual'u8'(2, $t13))) || ($ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211)), MakeVec3(88, 68, 88)) && $IsEqual'u8'(7, $t13))) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t13))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#211, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t13))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#214)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) > 0)) && ($epoch#$1_DiemConfig_Configuration($t8) < 18446744073709551615)) && ($t9 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t8))) && $IsEqual'u8'(1, $t13))) || ($ResourceExists($1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory#215, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(6, $t13))) || (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#213) && $IsEqual'u8'(1, $t13))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t10) && $IsEqual'u8'(5, $t13))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t10)), 0) && $IsEqual'u8'(3, $t13))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t13))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t11) && $IsEqual'u8'(5, $t13))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t11)), 1) && $IsEqual'u8'(3, $t13))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t13)));

    // abort($t13) at /home/ying/diem/language/diem-framework/modules/XDX.move:72:5+1277
    $abort_code := $t13;
    $abort_flag := true;
    return;
...
// fun XDX::is_xdx [verification] at /home/ying/diem/language/diem-framework/modules/XDX.move:97:5+165
procedure {:timeLimit 40} $1_XDX_is_xdx$verify() returns ($ret0: bool)
{
    ...
    var $t8: bool;
    var $temp_0'bool': bool;
    var $1_Diem_CurrencyInfo'#0'_$memory#111: $Memory $1_Diem_CurrencyInfo'#0';
    var $1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#112: $Memory $1_Diem_CurrencyInfo'$1_XDX_XDX';

    // verification entrypoint assumptions
    call $InitVerification();

    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XDX::XDX>()) at /home/ying/diem/language/diem-framework/modules/XDX.move:97:5+165
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:128:9+69
    assume {:print "$at(37,4645,4810)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Diem_$is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory));

    // assume forall $rsc: ResourceDomain<Diem::CurrencyInfo<XDX::XDX>>(): And(WellFormed($rsc), And(Lt(0, select Diem::CurrencyInfo.scaling_factor($rsc)), Le(select Diem::CurrencyInfo.scaling_factor($rsc), 10000000000))) at /home/ying/diem/language/diem-framework/modules/XDX.move:104:17+6
    assume {:print "$at(37,4954,4960)"} true;
    assume (forall $a_0: int :: {$ResourceValue($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory, $a_0)}(var $rsc := $ResourceValue($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory, $a_0);
    (($IsValid'$1_Diem_CurrencyInfo'$1_XDX_XDX''($rsc) && ((0 < $scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'($rsc)) && ($scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'($rsc) <= 10000000000))))));

    // assume forall $rsc: ResourceDomain<Diem::CurrencyInfo<#0>>(): And(WellFormed($rsc), And(Lt(0, select Diem::CurrencyInfo.scaling_factor($rsc)), Le(select Diem::CurrencyInfo.scaling_factor($rsc), 10000000000))) at /home/ying/diem/language/diem-framework/modules/XDX.move:104:17+6
    ...
    // @112 := save_mem(Diem::CurrencyInfo<XDX::XDX>) at /home/ying/diem/language/diem-framework/modules/XDX.move:97:5+1
    assume {:print "$at(37,4645,4646)"} true;
    $1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#112 := $1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory;

    // @111 := save_mem(Diem::CurrencyInfo<#0>) at /home/ying/diem/language/diem-framework/modules/XDX.move:97:5+1
    $1_Diem_CurrencyInfo'#0'_$memory#111 := $1_Diem_CurrencyInfo'#0'_$memory;

    // $t1 := Diem::is_currency<#0>() on_abort goto L5 with $t2 at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+29
    assume {:print "$at(37,4698,4727)"} true;
    ...
    // if ($t1) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
    if ($t1) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31
    assume {:print "$at(37,4743,4774)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31
    // >> opaque call: $t2 := Diem::currency_code<#0>()

    // $t3 := opaque begin: Diem::currency_code<#0>() at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31

    // assume Identical($t4, Not(Diem::spec_is_currency<#0>())) at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31
    assume ($t4 == !$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory));

    // if ($t4) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31
    if ($t4) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31
L7:

    // assume And(Not(Diem::spec_is_currency<#0>()), Eq(5, $t2)) at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31
    assume (!$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory) && $IsEqual'u8'(5, $t2));

    // trace_abort($t2) at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31
    assume {:print "$at(37,4743,4774)"} true;
    assume {:print "$track_abort(16,1):", $t2} $t2 == $t2;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31
L6:

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31
    assume $IsValid'vec'u8''($t3);

    // assume Eq<vector<u8>>($t3, Diem::spec_currency_code<#0>()) at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31
    assume $IsEqual'vec'u8''($t3, $1_Diem_spec_currency_code'#0'($1_Diem_CurrencyInfo'#0'_$memory));

    // $t3 := opaque end: Diem::currency_code<#0>() at /home/ying/diem/language/diem-framework/modules/XDX.move:99:13+31

    // nop at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26
    // >> opaque call: $t3 := Diem::currency_code<XDX::XDX>()

    // $t5 := opaque begin: Diem::currency_code<XDX::XDX>() at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26

    // assume Identical($t6, Not(Diem::spec_is_currency<XDX::XDX>())) at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26
    assume ($t6 == !$1_Diem_spec_is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory));

    // if ($t6) goto L9 else goto L8 at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26
    if ($t6) { goto L9; } else { goto L8; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26
L9:

    // assume And(Not(Diem::spec_is_currency<XDX::XDX>()), Eq(5, $t2)) at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26
    assume (!$1_Diem_spec_is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory) && $IsEqual'u8'(5, $t2));

    // trace_abort($t2) at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26
    assume {:print "$at(37,4778,4804)"} true;
    assume {:print "$track_abort(16,1):", $t2} $t2 == $t2;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26
    goto L5;

    // label L8 at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26
L8:

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26
    assume $IsValid'vec'u8''($t5);

    // assume Eq<vector<u8>>($t5, Diem::spec_currency_code<XDX::XDX>()) at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26
    assume $IsEqual'vec'u8''($t5, $1_Diem_spec_currency_code'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory));

    // $t5 := opaque end: Diem::currency_code<XDX::XDX>() at /home/ying/diem/language/diem-framework/modules/XDX.move:99:48+26

    // $t7 := ==($t3, $t5) at /home/ying/diem/language/diem-framework/modules/XDX.move:99:45+2
    $t7 := $IsEqual'vec'u8''($t3, $t5);

    // $t0 := $t7 at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
    assume {:print "$at(37,4698,4804)"} true;
    $t0 := $t7;

    // trace_local[tmp#$0]($t7) at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
    assume {:print "$track_local(16,1,0):", $t7} $t7 == $t7;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
L2:

    // $t8 := false at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
    $t8 := false;
    assume $IsValid'bool'($t8);

    // $t0 := $t8 at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
    $t0 := $t8;

    // trace_local[tmp#$0]($t8) at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
    assume {:print "$track_local(16,1,0):", $t8} $t8 == $t8;

    // label L3 at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
L3:

    // trace_return[0]($t0) at /home/ying/diem/language/diem-framework/modules/XDX.move:98:9+106
    assume {:print "$track_return(16,1,0):", $t0} $t0 == $t0;

    // label L4 at /home/ying/diem/language/diem-framework/modules/XDX.move:100:5+1
    assume {:print "$at(37,4809,4810)"} true;
L4:

    // assert Not(And(Diem::spec_is_currency[@111]<#0>(), Not(Diem::spec_is_currency[@112]<XDX::XDX>()))) at /home/ying/diem/language/diem-framework/modules/Diem.move:1551:9+67
    assume {:print "$at(10,73620,73687)"} true;
    assert {:msg "assert_failed(10,73620,73687): function does not abort under this condition"}
      !($1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#111) && !$1_Diem_spec_is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#112));

    // assert Eq<bool>($t0, XDX::spec_is_xdx<#0>()) at /home/ying/diem/language/diem-framework/modules/XDX.move:104:9+42
    assume {:print "$at(37,4946,4988)"} true;
    assert {:msg "assert_failed(37,4946,4988): post-condition does not hold"}
      $IsEqual'bool'($t0, $1_XDX_spec_is_xdx'#0'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory, $1_Diem_CurrencyInfo'#0'_$memory));

    // return $t0 at /home/ying/diem/language/diem-framework/modules/XDX.move:104:9+42
    $ret0 := $t0;
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/XDX.move:100:5+1
    assume {:print "$at(37,4809,4810)"} true;
L5:

    // assert And(Diem::spec_is_currency[@111]<#0>(), Not(Diem::spec_is_currency[@112]<XDX::XDX>())) at /home/ying/diem/language/diem-framework/modules/XDX.move:101:5+179
    assume {:print "$at(37,4815,4994)"} true;
    assert {:msg "assert_failed(37,4815,4994): abort not covered by any of the `aborts_if` clauses"}
      ($1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#111) && !$1_Diem_spec_is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#112));

    // assert And(And(Diem::spec_is_currency[@111]<#0>(), Not(Diem::spec_is_currency[@112]<XDX::XDX>())), Eq(5, $t2)) at /home/ying/diem/language/diem-framework/modules/XDX.move:101:5+179
    assert {:msg "assert_failed(37,4815,4994): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (($1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#111) && !$1_Diem_spec_is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory#112)) && $IsEqual'u8'(5, $t2));

    // abort($t2) at /home/ying/diem/language/diem-framework/modules/XDX.move:101:5+179
    $abort_code := $t2;
    $abort_flag := true;
    return;
...
// fun XDX::reserve_address [verification] at /home/ying/diem/language/diem-framework/modules/XDX.move:112:5+92
procedure {:timeLimit 40} $1_XDX_reserve_address$verify() returns ($ret0: int)
{
    ...
    // bytecode translation starts here
    // $t0 := CoreAddresses::CURRENCY_INFO_ADDRESS() on_abort goto L2 with $t1 at /home/ying/diem/language/diem-framework/modules/XDX.move:113:9+38
    assume {:print "$at(37,5357,5395)"} true;
    call $t0 := $1_CoreAddresses_CURRENCY_INFO_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(37,5357,5395)"} true;
        $t1 := $abort_code;
        assume {:print "$track_abort(16,2):", $t1} $t1 == $t1;
        goto L2;
    }

    // trace_return[0]($t0) at /home/ying/diem/language/diem-framework/modules/XDX.move:113:9+38
    assume {:print "$track_return(16,2,0):", $t0} $t0 == $t0;

    // label L1 at /home/ying/diem/language/diem-framework/modules/XDX.move:114:5+1
    assume {:print "$at(37,5400,5401)"} true;
L1:

    // return $t0 at /home/ying/diem/language/diem-framework/modules/XDX.move:114:5+1
    $ret0 := $t0;
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/XDX.move:114:5+1
L2:

    // abort($t1) at /home/ying/diem/language/diem-framework/modules/XDX.move:114:5+1
    $abort_code := $t1;
    $abort_flag := true;
    return;
...
L7:
    ...
    // @169 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@169](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
L8:
    ...
    // @145 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@145](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
...
L7:
    ...
    // @163 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@163](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L7:
    ...
    // @157 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@157](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
