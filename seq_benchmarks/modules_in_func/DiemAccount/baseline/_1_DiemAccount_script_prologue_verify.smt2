...
(declare-fun $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory () T@$Memory_562714)
(declare-fun _$t7 () T@Vec_37831)
...
(declare-fun $t11 () Int)
(declare-fun |$1_TransactionFee_TransactionFee'#0'_$memory| () T@$Memory_548952)
...
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t91@1| () Bool)
(declare-fun $abort_flag@16 () Bool)
(declare-fun $abort_code@15 () Int)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| () Int)
(declare-fun inline$$Ge$1$dst@1 () Bool)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t75@0| () Int)
(declare-fun $abort_flag@14 () Bool)
(declare-fun $abort_code@13 () Int)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t69@1| () Bool)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@0| () Int)
(declare-fun |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| () Bool)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t68@0| () Int)
...
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t90@1| () Int)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@2| () T@$1_DiemAccount_DiemAccount)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0| () Int)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t86@1| () Int)
(declare-fun inline$$Lt$1$dst@1 () Bool)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t85@0| () Int)
...
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t80@0| () Int)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t76@0| () Int)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0| () Bool)
...
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t62@0| () Int)
...
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t53@1| () Bool)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@0| () Int)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@1| () T@Vec_37831)
(declare-fun call1formal@res@0 () T@Vec_37831)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@0| () T@$1_DiemAccount_DiemAccount)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@1| () T@$1_DiemAccount_DiemAccount)
(declare-fun $abort_code@6 () Int)
(declare-fun $abort_flag@6 () Bool)
(declare-fun inline$$Not$0$dst@1 () Bool)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t49@0| () Int)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t46@0| () Bool)
(declare-fun inline$$1_DiemAccount_exists_at$0$$t1@1 () Bool)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t45@0| () Int)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t40@1| () Bool)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@0| () Int)
...
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t35@0| () Int)
(declare-fun |inline$$1_DiemAccount_prologue_common'#0'$0$$t36@0| () Int)
...
(declare-fun inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t17@1 () T@Vec_416632)
...
(declare-fun inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t14@1 () T@Vec_416632)
...
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory| () T@$Memory_495677)
(declare-fun |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory| () T@$Memory_495758)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory| () T@$Memory_495920)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory| () T@$Memory_496001)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2343876) (let ((anon11_Else_correct  (=> (not $abort_flag@17) (and (=> (= (ControlFlow 0 1749068) (- 0 2350084)) (not (not (let ((publish_option (|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))
 (or (let ((addr@@0 (|$addr#$signer| _$t0)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0)) 0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_562714| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) 173345816)) (or (= (|l#Vec_37831| _$t7) 0) (or (= (|l#Vec_416632| (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option)) 0) (exists ((i@@126 Int) ) (!  (and (and (|$IsValid'u64'| i@@126) (InRangeVec_447989 (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option) i@@126)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_37831_| (|v#Vec_416632| (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option)) i@@126) _$t7))
 :qid |DiemAccountbpl.2617:13|
 :skolemid |98|
)))))))))) (=> (not (not (let ((publish_option@@0 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))
 (or (let ((addr@@1 (|$addr#$signer| _$t0)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@1)) 0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_562714| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) 173345816)) (or (= (|l#Vec_37831| _$t7) 0) (or (= (|l#Vec_416632| (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@0)) 0) (exists ((i@@127 Int) ) (!  (and (and (|$IsValid'u64'| i@@127) (InRangeVec_447989 (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@0) i@@127)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_37831_| (|v#Vec_416632| (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@0)) i@@127) _$t7))
 :qid |DiemAccountbpl.2617:13|
 :skolemid |98|
))))))))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350098)) (not (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_589759| $1_ChainId_ChainId_$memory) 173345816)))))) (=> (not (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_589759| $1_ChainId_ChainId_$memory) 173345816))))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350111)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350123)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t12) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t12))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t12) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t12)))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350133)) (not (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12)))))) (=> (not (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12))))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350152)) (not (> $t11 18446744073709551615))) (=> (not (> $t11 18446744073709551615)) (and (=> (= (ControlFlow 0 1749068) (- 0 2350163)) (not (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_548952| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))))) (=> (not (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_548952| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350181)) (not (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $t12))))) (=> (not (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $t12)))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350201)) (not (and (> $t11 0) (< (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $t12))) $t11)))) (=> (not (and (> $t11 0) (< (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $t12))) $t11))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350223)) (not (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5))) (=> (not (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5)) (and (=> (= (ControlFlow 0 1749068) (- 0 2350234)) (not (>= _$t1 18446744073709551615))) (=> (not (>= _$t1 18446744073709551615)) (and (=> (= (ControlFlow 0 1749068) (- 0 2350244)) (not (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12))))) (=> (not (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12)))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350259)) (not (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12))))) (=> (not (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12)))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350274)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350284)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350301)) (let ((addr@@2 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@2)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) addr@@2) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) addr@@2))))))) (=> (let ((addr@@3 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@3)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) addr@@3) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) addr@@3)))))) (and (=> (= (ControlFlow 0 1749068) (- 0 2350313)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4)))))
 :qid |DiemAccountbpl.89319:15|
 :skolemid |3385|
))) (=> (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@5) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@5)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@5)))))
 :qid |DiemAccountbpl.89319:15|
 :skolemid |3385|
)) (=> (= (ControlFlow 0 1749068) (- 0 2350349)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@6) (>= (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@6))) (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@6))))))
 :qid |DiemAccountbpl.89324:15|
 :skolemid |3386|
))))))))))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 1743331) (- 0 2349625)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (not (let ((publish_option@@1 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))
 (or (let ((addr@@7 (|$addr#$signer| _$t0)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@7)) 0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_562714| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) 173345816)) (or (= (|l#Vec_37831| _$t7) 0) (or (= (|l#Vec_416632| (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@1)) 0) (exists ((i@@128 Int) ) (!  (and (and (|$IsValid'u64'| i@@128) (InRangeVec_447989 (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@1) i@@128)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_37831_| (|v#Vec_416632| (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@1)) i@@128) _$t7))
 :qid |DiemAccountbpl.2617:13|
 :skolemid |98|
)))))))) (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_589759| $1_ChainId_ChainId_$memory) 173345816))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t12) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t12)))) (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12))))) (> $t11 18446744073709551615)) (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_548952| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $t12)))) (and (> $t11 0) (< (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $t12))) $t11))) (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5)) (>= _$t1 18446744073709551615)) (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12)))) (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))) (=> (or (or (or (or (or (or (or (or (or (or (or (or (or (or (not (let ((publish_option@@2 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))
 (or (let ((addr@@8 (|$addr#$signer| _$t0)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@8)) 0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_562714| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) 173345816)) (or (= (|l#Vec_37831| _$t7) 0) (or (= (|l#Vec_416632| (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@2)) 0) (exists ((i@@129 Int) ) (!  (and (and (|$IsValid'u64'| i@@129) (InRangeVec_447989 (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@2) i@@129)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_37831_| (|v#Vec_416632| (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@2)) i@@129) _$t7))
 :qid |DiemAccountbpl.2617:13|
 :skolemid |98|
)))))))) (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_589759| $1_ChainId_ChainId_$memory) 173345816))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t12) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t12)))) (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12))))) (> $t11 18446744073709551615)) (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_548952| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $t12)))) (and (> $t11 0) (< (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $t12))) $t11))) (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5)) (>= _$t1 18446744073709551615)) (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12)))) (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)))) (=> (= (ControlFlow 0 1743331) (- 0 2349795)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (let ((publish_option@@3 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))
 (or (let ((addr@@9 (|$addr#$signer| _$t0)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@9)) 0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_562714| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) 173345816)) (or (= (|l#Vec_37831| _$t7) 0) (or (= (|l#Vec_416632| (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@3)) 0) (exists ((i@@130 Int) ) (!  (and (and (|$IsValid'u64'| i@@130) (InRangeVec_447989 (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@3) i@@130)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_37831_| (|v#Vec_416632| (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| publish_option@@3)) i@@130) _$t7))
 :qid |DiemAccountbpl.2617:13|
 :skolemid |98|
)))))))) (= 1 $t14@0)) (and (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_589759| $1_ChainId_ChainId_$memory) 173345816)))) (= 7 $t14@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12)) (= 7 $t14@0))) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t12) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t12))) (= 1 $t14@0))) (and (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12)))) (= 7 $t14@0))) (and (> $t11 18446744073709551615) (= 7 $t14@0))) (and (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_548952| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (= 7 $t14@0))) (and (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $t12))) (= 7 $t14@0))) (and (and (> $t11 0) (< (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $t12))) $t11)) (= 7 $t14@0))) (and (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5) (= 7 $t14@0))) (and (>= _$t1 18446744073709551615) (= 8 $t14@0))) (and (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12))) (= 7 $t14@0))) (and (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t12))) (= 7 $t14@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t14@0))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))) (= 5 $t14@0))))))))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@17 (= $abort_code@16 $abort_code@16)) (and (= $t14@0 $abort_code@16) (= (ControlFlow 0 1749082) 1743331))) L3_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Then_correct|  (=> |inline$$1_DiemAccount_prologue_common'#0'$0$$t91@1| (=> (and (= $abort_flag@17 $abort_flag@16) (= $abort_code@16 $abort_code@15)) (and (=> (= (ControlFlow 0 1747430) 1749082) anon11_Then_correct) (=> (= (ControlFlow 0 1747430) 1749068) anon11_Else_correct))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|  (=> (and (= $abort_flag@17 true) (= $abort_code@16 |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1|)) (and (=> (= (ControlFlow 0 1745762) 1749082) anon11_Then_correct) (=> (= (ControlFlow 0 1745762) 1749068) anon11_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Else_correct|  (=> (and (and (not inline$$Ge$1$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t75@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t75@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t75@0|) (= (ControlFlow 0 1748542) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Then_correct|  (=> (and (and $abort_flag@14 (= $abort_code@13 $abort_code@13)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| $abort_code@13) (= (ControlFlow 0 1748560) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t69@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@0|) (= (ControlFlow 0 1747673) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Else_correct|  (=> (and (and (not |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t68@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t68@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t68@0|) (= (ControlFlow 0 1747615) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Then_correct|  (=> (and (and $abort_flag@11 (= $abort_code@11 $abort_code@11)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| $abort_code@11) (= (ControlFlow 0 1748574) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t91@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|) (= (ControlFlow 0 1747424) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Then_correct|  (=> (and (and (and inline$$Ge$0$dst@1 (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t90@1| (|$sequence_number#$1_DiemAccount_DiemAccount| |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@2|))) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t91@1| (= _$t1 |inline$$1_DiemAccount_prologue_common'#0'$0$$t90@1|)) (|$IsValid'u64'| 1003))) (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t91@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t91@1|)))) (and (=> (= (ControlFlow 0 1747408) 1747430) |inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Then_correct|) (=> (= (ControlFlow 0 1747408) 1747424) |inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Else_correct|  (=> (and (and (not inline$$Ge$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0|) (= (ControlFlow 0 1747362) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Then$1_correct|  (=> (|$IsValid'u64'| 1002) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0|) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 1747346) 1747408) |inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Then_correct|) (=> (= (ControlFlow 0 1747346) 1747362) |inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Else_correct|))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= _$t1 |inline$$1_DiemAccount_prologue_common'#0'$0$$t86@1|)) (= (ControlFlow 0 1747306) 1747346)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Then_correct|  (=> inline$$Lt$1$dst@1 (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t86@1| (|$sequence_number#$1_DiemAccount_DiemAccount| |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@2|)) (= (ControlFlow 0 1747312) 1747306)) inline$$Ge$0$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Else_correct|  (=> (and (and (not inline$$Lt$1$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t85@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t85@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t85@0|) (= (ControlFlow 0 1747258) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else$1_correct|  (=> (|$IsValid'u64'| 1011) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t85@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t85@0| 8)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t85@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t85@0|) (= inline$$Lt$1$dst@1 inline$$Lt$1$dst@1))) (and (=> (= (ControlFlow 0 1747242) 1747312) |inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Then_correct|) (=> (= (ControlFlow 0 1747242) 1747258) |inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Else_correct|))))))
(let ((inline$$Lt$1$anon0_correct  (=> (and (= inline$$Lt$1$dst@1 (< inline$$CastU128$2$dst@1 18446744073709551615)) (= (ControlFlow 0 1747202) 1747242)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else_correct|  (=> (not $abort_flag@16) (=> (and (|$IsValid'u128'| 18446744073709551615) (= (ControlFlow 0 1747208) 1747202)) inline$$Lt$1$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Then_correct|  (=> (and (and $abort_flag@16 (= $abort_code@15 $abort_code@15)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| $abort_code@15) (= (ControlFlow 0 1747444) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((inline$$CastU128$2$anon3_Then$1_correct  (=> (= $abort_code@15 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@16 true) (= inline$$CastU128$2$dst@1 inline$$CastU128$2$dst@0)) (and (=> (= (ControlFlow 0 1747142) 1747444) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Then_correct|) (=> (= (ControlFlow 0 1747142) 1747208) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else_correct|))))))
(let ((inline$$CastU128$2$anon3_Then_correct  (=> (and (> _$t1 $MAX_U128) (= (ControlFlow 0 1747140) 1747142)) inline$$CastU128$2$anon3_Then$1_correct)))
(let ((inline$$CastU128$2$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t1) (= $abort_code@15 $abort_code@14)) (and (= $abort_flag@16 $abort_flag@15) (= inline$$CastU128$2$dst@1 _$t1))) (and (=> (= (ControlFlow 0 1747092) 1747444) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Then_correct|) (=> (= (ControlFlow 0 1747092) 1747208) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Then_correct|  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 1747148) 1747140) inline$$CastU128$2$anon3_Then_correct) (=> (= (ControlFlow 0 1747148) 1747092) inline$$CastU128$2$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Else_correct|  (=> (and (and (not inline$$Lt$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t80@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t80@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t80@0|) (= (ControlFlow 0 1747019) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Else$1_correct|  (=> (|$IsValid'u64'| 1006) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t80@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t80@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t80@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t80@0|) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 1747003) 1747148) |inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Then_correct|) (=> (= (ControlFlow 0 1747003) 1747019) |inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Else_correct|))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< |inline$$1_DiemAccount_prologue_common'#0'$0$$t76@0| _$t5)) (= (ControlFlow 0 1746963) 1747003)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0|) (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t76@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t76@0| (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000)) (= (ControlFlow 0 1746969) 1746963))) inline$$Lt$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Then_correct|  (=> |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (= (ControlFlow 0 1747470) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$L12_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1746901) 1747470) |inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Then_correct|) (=> (= (ControlFlow 0 1746901) 1746969) |inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Then_correct|  (=> (and (and inline$$Ge$1$dst@1 (= $abort_flag@15 $abort_flag@14)) (and (= $abort_code@14 $abort_code@13) (= (ControlFlow 0 1748546) 1746901))) |inline$$1_DiemAccount_prologue_common'#0'$0$L12_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Else$1_correct|  (=> (|$IsValid'u64'| 1005) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t75@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t75@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t75@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t75@0|) (= inline$$Ge$1$dst@1 inline$$Ge$1$dst@1))) (and (=> (= (ControlFlow 0 1748526) 1748546) |inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Then_correct|) (=> (= (ControlFlow 0 1748526) 1748542) |inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Else_correct|))))))
(let ((inline$$Ge$1$anon0_correct  (=> (and (= inline$$Ge$1$dst@1 (>= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| inline$$MulU64$0$dst@2)) (= (ControlFlow 0 1748486) 1748526)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Else_correct|  (=> (not $abort_flag@14) (=> (and (= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance'#0'$0$$ret0@1|) (= (ControlFlow 0 1748492) 1748486)) inline$$Ge$1$anon0_correct))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon14_Else_correct|  (=> (not $abort_flag@13) (=> (and (and (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1|) (= $abort_code@13 $abort_code@12)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1|) (= $abort_flag@14 $abort_flag@13))) (and (=> (= (ControlFlow 0 1748344) 1748560) |inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Then_correct|) (=> (= (ControlFlow 0 1748344) 1748492) |inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$L3_correct|  (=> (= $abort_code@13 |inline$$1_DiemAccount_balance'#0'$0$$t6@1|) (=> (and (= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance'#0'$0$$ret0@0|) (= $abort_flag@14 true)) (and (=> (= (ControlFlow 0 1748013) 1748560) |inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Then_correct|) (=> (= (ControlFlow 0 1748013) 1748492) |inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon14_Then_correct|  (=> (and (and $abort_flag@13 (= $abort_code@12 $abort_code@12)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t6@1| $abort_code@12) (= (ControlFlow 0 1748358) 1748013))) |inline$$1_DiemAccount_balance'#0'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon3_Else_correct|  (=> (and (and (not $abort_flag@12) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (= $abort_flag@13 $abort_flag@12) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_Diem_value'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1748302) 1748358) |inline$$1_DiemAccount_balance'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 1748302) 1748344) |inline$$1_DiemAccount_balance'#0'$0$anon14_Else_correct|)))))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon3_Then_correct|  (=> (and (and $abort_flag@12 (= $abort_code@12 $abort_code@12)) (and (= $abort_flag@13 true) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 1748320) 1748358) |inline$$1_DiemAccount_balance'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 1748320) 1748344) |inline$$1_DiemAccount_balance'#0'$0$anon14_Else_correct|)))))
(let ((|inline$$1_Diem_value'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1| |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1|) (=> (and (= |inline$$1_Diem_value'#0'$0$$t1@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1|)) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1748278) 1748320) |inline$$1_DiemAccount_balance_for'#0'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1748278) 1748302) |inline$$1_DiemAccount_balance_for'#0'$0$anon3_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance'#0'$0$$t7@2| |inline$$1_DiemAccount_balance'#0'$0$$t7@2|) (=> (and (= |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1| (|$coin#$1_DiemAccount_Balance'#0'| |inline$$1_DiemAccount_balance'#0'$0$$t7@2|)) (= (ControlFlow 0 1748284) 1748278)) |inline$$1_Diem_value'#0'$0$anon0_correct|))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon13_Else_correct|  (=> (and (not $abort_flag@12) (= (ControlFlow 0 1748326) 1748284)) |inline$$1_DiemAccount_balance_for'#0'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon13_Then_correct|  (=> (and (and $abort_flag@12 (= $abort_code@12 $abort_code@12)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t6@1| $abort_code@12) (= (ControlFlow 0 1748372) 1748013))) |inline$$1_DiemAccount_balance'#0'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon12_Then$1_correct|  (=> (= $abort_flag@12 true) (=> (and (= $abort_code@12 $EXEC_FAILURE_CODE) (= |inline$$1_DiemAccount_balance'#0'$0$$t7@2| |inline$$1_DiemAccount_balance'#0'$0$$t7@0|)) (and (=> (= (ControlFlow 0 1748424) 1748372) |inline$$1_DiemAccount_balance'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 1748424) 1748326) |inline$$1_DiemAccount_balance'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon12_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|)) (= (ControlFlow 0 1748422) 1748424)) |inline$$1_DiemAccount_balance'#0'$0$anon12_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon12_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|) (=> (and (and (= |inline$$1_DiemAccount_balance'#0'$0$$t7@1| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|)) (= $abort_flag@12 $abort_flag@11)) (and (= $abort_code@12 $abort_code@11) (= |inline$$1_DiemAccount_balance'#0'$0$$t7@2| |inline$$1_DiemAccount_balance'#0'$0$$t7@1|))) (and (=> (= (ControlFlow 0 1748031) 1748372) |inline$$1_DiemAccount_balance'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 1748031) 1748326) |inline$$1_DiemAccount_balance'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon11_Then_correct|  (=> |inline$$1_DiemAccount_balance'#0'$0$$t3@1| (and (=> (= (ControlFlow 0 1748017) 1748422) |inline$$1_DiemAccount_balance'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 1748017) 1748031) |inline$$1_DiemAccount_balance'#0'$0$anon12_Else_correct|)))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon11_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_balance'#0'$0$$t3@1|) (= |inline$$1_DiemAccount_balance'#0'$0$$t5@0| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t6@1| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|) (= (ControlFlow 0 1748007) 1748013))) |inline$$1_DiemAccount_balance'#0'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|) (=> (and (= |inline$$1_DiemAccount_balance'#0'$0$$t3@1| (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|)) (|$IsValid'u64'| 19)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|) (= |inline$$1_DiemAccount_balance'#0'$0$$t5@0| 5)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t5@0| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|) (= |inline$$1_DiemAccount_balance'#0'$0$$t3@1| |inline$$1_DiemAccount_balance'#0'$0$$t3@1|))) (and (=> (= (ControlFlow 0 1747991) 1748017) |inline$$1_DiemAccount_balance'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 1747991) 1748007) |inline$$1_DiemAccount_balance'#0'$0$anon11_Else_correct|)))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Then_correct|  (=> (and |inline$$1_DiemAccount_prologue_common'#0'$0$$t69@1| (= (ControlFlow 0 1748430) 1747991)) |inline$$1_DiemAccount_balance'#0'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Then_correct|  (=> |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t69@1| (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|)) (|$IsValid'u64'| 1005)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t69@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t69@1|))) (and (=> (= (ControlFlow 0 1747657) 1748430) |inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Then_correct|) (=> (= (ControlFlow 0 1747657) 1747673) |inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Else_correct|)))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Else_correct|  (=> (and (not $abort_flag@11) (|$IsValid'u64'| 1012)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t68@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t68@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t68@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t68@0|) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1747599) 1747657) |inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Then_correct|) (=> (= (ControlFlow 0 1747599) 1747615) |inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Else_correct|))))))
(let ((|inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 186537453) (=> (and (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_548952| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1747553) 1748574) |inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Then_correct|) (=> (= (ControlFlow 0 1747553) 1747599) |inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Then_correct|  (=> (and inline$$Gt$0$dst@1 (= (ControlFlow 0 1747559) 1747553)) |inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Else_correct|  (=> (and (and (not inline$$Gt$0$dst@1) (= $abort_flag@15 $abort_flag@11)) (and (= $abort_code@14 $abort_code@11) (= (ControlFlow 0 1746889) 1746901))) |inline$$1_DiemAccount_prologue_common'#0'$0$L12_correct|)))
(let ((inline$$Gt$0$anon0_correct  (=> (= inline$$Gt$0$dst@1 (> inline$$MulU64$0$dst@2 0)) (and (=> (= (ControlFlow 0 1746875) 1747559) |inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Then_correct|) (=> (= (ControlFlow 0 1746875) 1746889) |inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Else_correct|  (=> (and (and (not $abort_flag@11) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@2)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 1746881) 1746875))) inline$$Gt$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Then_correct|  (=> (and (and $abort_flag@11 (= $abort_code@11 $abort_code@11)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| $abort_code@11) (= (ControlFlow 0 1748588) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((inline$$MulU64$0$anon3_Then$1_correct  (=> (= $abort_code@11 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@11 true) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@0)) (and (=> (= (ControlFlow 0 1746807) 1748588) |inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Then_correct|) (=> (= (ControlFlow 0 1746807) 1746881) |inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Else_correct|))))))
(let ((inline$$MulU64$0$anon3_Then_correct  (=> (and (> (* _$t3 _$t4) $MAX_U64) (= (ControlFlow 0 1746805) 1746807)) inline$$MulU64$0$anon3_Then$1_correct)))
(let ((inline$$MulU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (* _$t3 _$t4)) (=> (and (and (= inline$$MulU64$0$dst@1 (* _$t3 _$t4)) (= $abort_code@11 $abort_code@10)) (and (= $abort_flag@11 $abort_flag@10) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@1))) (and (=> (= (ControlFlow 0 1746753) 1748588) |inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Then_correct|) (=> (= (ControlFlow 0 1746753) 1746881) |inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Then_correct|  (=> inline$$Le$0$dst@1 (and (=> (= (ControlFlow 0 1746813) 1746805) inline$$MulU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 1746813) 1746753) inline$$MulU64$0$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Else_correct|  (=> (and (and (not inline$$Le$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t62@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t62@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t62@0|) (= (ControlFlow 0 1746656) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Else$1_correct|  (=> (|$IsValid'u64'| 1005) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t62@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t62@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t62@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t62@0|) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 1746640) 1746813) |inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Then_correct|) (=> (= (ControlFlow 0 1746640) 1746656) |inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Else_correct|))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= inline$$MulU128$0$dst@2 18446744073709551615)) (= (ControlFlow 0 1746600) 1746640)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Else_correct|  (=> (not $abort_flag@10) (=> (and (|$IsValid'u128'| 18446744073709551615) (= (ControlFlow 0 1746606) 1746600)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Then_correct|  (=> (and (and $abort_flag@10 (= $abort_code@10 $abort_code@10)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| $abort_code@10) (= (ControlFlow 0 1748602) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((inline$$MulU128$0$anon3_Then$1_correct  (=> (= $abort_flag@10 true) (=> (and (= $abort_code@10 $EXEC_FAILURE_CODE) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@0)) (and (=> (= (ControlFlow 0 1746540) 1748602) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Then_correct|) (=> (= (ControlFlow 0 1746540) 1746606) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Else_correct|))))))
(let ((inline$$MulU128$0$anon3_Then_correct  (=> (and (> (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1) $MAX_U128) (= (ControlFlow 0 1746538) 1746540)) inline$$MulU128$0$anon3_Then$1_correct)))
(let ((inline$$MulU128$0$anon3_Else_correct  (=> (>= $MAX_U128 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (=> (and (and (= inline$$MulU128$0$dst@1 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (= $abort_flag@10 $abort_flag@9)) (and (= $abort_code@10 $abort_code@9) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@1))) (and (=> (= (ControlFlow 0 1746486) 1748602) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Then_correct|) (=> (= (ControlFlow 0 1746486) 1746606) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon77_Else_correct|  (=> (not $abort_flag@9) (and (=> (= (ControlFlow 0 1746546) 1746538) inline$$MulU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 1746546) 1746486) inline$$MulU128$0$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon77_Then_correct|  (=> (and (and $abort_flag@9 (= $abort_code@9 $abort_code@9)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| $abort_code@9) (= (ControlFlow 0 1748616) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_code@9 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@9 true) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 1746379) 1748616) |inline$$1_DiemAccount_prologue_common'#0'$0$anon77_Then_correct|) (=> (= (ControlFlow 0 1746379) 1746546) |inline$$1_DiemAccount_prologue_common'#0'$0$anon77_Else_correct|))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> _$t4 $MAX_U128) (= (ControlFlow 0 1746377) 1746379)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t4) (= $abort_code@9 $abort_code@8)) (and (= $abort_flag@9 $abort_flag@8) (= inline$$CastU128$1$dst@1 _$t4))) (and (=> (= (ControlFlow 0 1746329) 1748616) |inline$$1_DiemAccount_prologue_common'#0'$0$anon77_Then_correct|) (=> (= (ControlFlow 0 1746329) 1746546) |inline$$1_DiemAccount_prologue_common'#0'$0$anon77_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon76_Else_correct|  (=> (not $abort_flag@8) (and (=> (= (ControlFlow 0 1746385) 1746377) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 1746385) 1746329) inline$$CastU128$1$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon76_Then_correct|  (=> (and (and $abort_flag@8 (= $abort_code@8 $abort_code@8)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| $abort_code@8) (= (ControlFlow 0 1748630) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_flag@8 true) (=> (and (= $abort_code@8 $EXEC_FAILURE_CODE) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 1746246) 1748630) |inline$$1_DiemAccount_prologue_common'#0'$0$anon76_Then_correct|) (=> (= (ControlFlow 0 1746246) 1746385) |inline$$1_DiemAccount_prologue_common'#0'$0$anon76_Else_correct|))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> _$t3 $MAX_U128) (= (ControlFlow 0 1746244) 1746246)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t3) (= $abort_flag@8 $abort_flag@7)) (and (= $abort_code@8 $abort_code@7) (= inline$$CastU128$0$dst@1 _$t3))) (and (=> (= (ControlFlow 0 1746196) 1748630) |inline$$1_DiemAccount_prologue_common'#0'$0$anon76_Then_correct|) (=> (= (ControlFlow 0 1746196) 1746385) |inline$$1_DiemAccount_prologue_common'#0'$0$anon76_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon75_Then_correct|  (=> |inline$$1_DiemAccount_prologue_common'#0'$0$$t53@1| (and (=> (= (ControlFlow 0 1746252) 1746244) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 1746252) 1746196) inline$$CastU128$0$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon75_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t53@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@0|) (= (ControlFlow 0 1746123) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon74_Else_correct|  (=> (and (and (and (not $abort_flag@7) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@1| (|$authentication_key#$1_DiemAccount_DiemAccount| |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@2|))) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t53@1| (|$IsEqual'vec'u8''| call1formal@res@0 |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@1|)) (|$IsValid'u64'| 1001))) (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t53@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t53@1|)))) (and (=> (= (ControlFlow 0 1746107) 1746252) |inline$$1_DiemAccount_prologue_common'#0'$0$anon75_Then_correct|) (=> (= (ControlFlow 0 1746107) 1746123) |inline$$1_DiemAccount_prologue_common'#0'$0$anon75_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon74_Then_correct|  (=> (and (and $abort_flag@7 (= $abort_code@7 $abort_code@7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| $abort_code@7) (= (ControlFlow 0 1748644) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon73_Else_correct|  (=> (not $abort_flag@7) (=> (and (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@2| |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@2|) (= call1formal@res@0 ($1_Hash_sha3 _$t2))) (and (|$IsValid'vec'u8''| call1formal@res@0) (= (|l#Vec_37831| call1formal@res@0) 32))) (and (=> (= (ControlFlow 0 1746059) 1748644) |inline$$1_DiemAccount_prologue_common'#0'$0$anon74_Then_correct|) (=> (= (ControlFlow 0 1746059) 1746107) |inline$$1_DiemAccount_prologue_common'#0'$0$anon74_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon73_Then_correct|  (=> (and (and $abort_flag@7 (= $abort_code@7 $abort_code@7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| $abort_code@7) (= (ControlFlow 0 1748658) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon72_Then$1_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@2| |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@0|) (=> (and (= $abort_code@7 $EXEC_FAILURE_CODE) (= $abort_flag@7 true)) (and (=> (= (ControlFlow 0 1748710) 1748658) |inline$$1_DiemAccount_prologue_common'#0'$0$anon73_Then_correct|) (=> (= (ControlFlow 0 1748710) 1746059) |inline$$1_DiemAccount_prologue_common'#0'$0$anon73_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon72_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|)) (= (ControlFlow 0 1748708) 1748710)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon72_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon72_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|) (=> (and (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@1| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|)) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@2| |inline$$1_DiemAccount_prologue_common'#0'$0$$t50@1|)) (and (= $abort_code@7 $abort_code@6) (= $abort_flag@7 $abort_flag@6))) (and (=> (= (ControlFlow 0 1746043) 1748658) |inline$$1_DiemAccount_prologue_common'#0'$0$anon73_Then_correct|) (=> (= (ControlFlow 0 1746043) 1746059) |inline$$1_DiemAccount_prologue_common'#0'$0$anon73_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon71_Then_correct|  (=> inline$$Not$0$dst@1 (and (=> (= (ControlFlow 0 1746029) 1748708) |inline$$1_DiemAccount_prologue_common'#0'$0$anon72_Then_correct|) (=> (= (ControlFlow 0 1746029) 1746043) |inline$$1_DiemAccount_prologue_common'#0'$0$anon72_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon71_Else_correct|  (=> (and (and (not inline$$Not$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t49@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t49@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t49@0|) (= (ControlFlow 0 1746025) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon70_Then$1_correct|  (=> (|$IsValid'u64'| 1000) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t49@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t49@0| 1)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t49@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t49@0|) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 1746009) 1746029) |inline$$1_DiemAccount_prologue_common'#0'$0$anon71_Then_correct|) (=> (= (ControlFlow 0 1746009) 1746025) |inline$$1_DiemAccount_prologue_common'#0'$0$anon71_Else_correct|))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t46@0|)) (= (ControlFlow 0 1745969) 1746009)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon70_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon70_Then_correct|  (=> inline$$1_DiemAccount_exists_at$0$$t1@1 (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t46@0|  (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|)))) (= (ControlFlow 0 1745975) 1745969)) inline$$Not$0$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon70_Else_correct|  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t45@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t45@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t45@0|) (= (ControlFlow 0 1745921) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon69_Else_correct|  (=> (and (not $abort_flag@6) (|$IsValid'u64'| 1004)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t45@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t45@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t45@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t45@0|) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1))) (and (=> (= (ControlFlow 0 1745905) 1745975) |inline$$1_DiemAccount_prologue_common'#0'$0$anon70_Then_correct|) (=> (= (ControlFlow 0 1745905) 1745921) |inline$$1_DiemAccount_prologue_common'#0'$0$anon70_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon69_Then_correct|  (=> (and (and $abort_flag@6 (= $abort_code@6 $abort_code@6)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| $abort_code@6) (= (ControlFlow 0 1748724) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|)) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1)) (and (=> (= (ControlFlow 0 1745863) 1748724) |inline$$1_DiemAccount_prologue_common'#0'$0$anon69_Then_correct|) (=> (= (ControlFlow 0 1745863) 1745905) |inline$$1_DiemAccount_prologue_common'#0'$0$anon69_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon68_Then_correct|  (=> (and |inline$$1_DiemAccount_prologue_common'#0'$0$$t40@1| (= (ControlFlow 0 1745869) 1745863)) inline$$1_DiemAccount_exists_at$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon68_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t40@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@0|) (= (ControlFlow 0 1745756) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon67_Else_correct|  (=> (not $abort_flag@6) (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t40@1| (= inline$$1_ChainId_get$0$$ret0@1 _$t6)) (|$IsValid'u64'| 1007)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t40@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t40@1|))) (and (=> (= (ControlFlow 0 1745740) 1745869) |inline$$1_DiemAccount_prologue_common'#0'$0$anon68_Then_correct|) (=> (= (ControlFlow 0 1745740) 1745756) |inline$$1_DiemAccount_prologue_common'#0'$0$anon68_Else_correct|)))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon67_Then_correct|  (=> (and (and $abort_flag@6 (= $abort_code@6 $abort_code@6)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@1| $abort_code@6) (= (ControlFlow 0 1748738) 1745762))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((inline$$1_ChainId_get$0$L2_correct  (=> (= $abort_flag@6 true) (=> (and (= $abort_code@6 inline$$1_ChainId_get$0$$t1@1) (= inline$$1_ChainId_get$0$$ret0@1 inline$$1_ChainId_get$0$$ret0@0)) (and (=> (= (ControlFlow 0 1745614) 1748738) |inline$$1_DiemAccount_prologue_common'#0'$0$anon67_Then_correct|) (=> (= (ControlFlow 0 1745614) 1745740) |inline$$1_DiemAccount_prologue_common'#0'$0$anon67_Else_correct|))))))
(let ((inline$$1_ChainId_get$0$anon10_Then_correct  (=> (and (and $abort_flag@5 (= $abort_code@5 $abort_code@5)) (and (= inline$$1_ChainId_get$0$$t1@1 $abort_code@5) (= (ControlFlow 0 1745608) 1745614))) inline$$1_ChainId_get$0$L2_correct)))
(let ((inline$$1_ChainId_get$0$anon8_Then_correct  (=> inline$$1_ChainId_get$0$$t0@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_ChainId_get$0$$t1@0)) (= inline$$1_ChainId_get$0$$t1@0 inline$$1_ChainId_get$0$$t1@0)) (and (= inline$$1_ChainId_get$0$$t1@1 inline$$1_ChainId_get$0$$t1@0) (= (ControlFlow 0 1745692) 1745614))) inline$$1_ChainId_get$0$L2_correct))))
(let ((inline$$1_ChainId_get$0$anon10_Else_correct  (=> (and (not $abort_flag@5) (= inline$$1_ChainId_get$0$$t4@1 (|$id#$1_ChainId_ChainId| inline$$1_ChainId_get$0$$t3@2))) (=> (and (and (= inline$$1_ChainId_get$0$$t4@1 inline$$1_ChainId_get$0$$t4@1) (= $abort_flag@6 $abort_flag@5)) (and (= $abort_code@6 $abort_code@5) (= inline$$1_ChainId_get$0$$ret0@1 inline$$1_ChainId_get$0$$t4@1))) (and (=> (= (ControlFlow 0 1745594) 1748738) |inline$$1_DiemAccount_prologue_common'#0'$0$anon67_Then_correct|) (=> (= (ControlFlow 0 1745594) 1745740) |inline$$1_DiemAccount_prologue_common'#0'$0$anon67_Else_correct|))))))
(let ((inline$$1_ChainId_get$0$anon9_Then$1_correct  (=> (= $abort_code@5 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@5 true) (= inline$$1_ChainId_get$0$$t3@2 inline$$1_ChainId_get$0$$t3@0)) (and (=> (= (ControlFlow 0 1745666) 1745608) inline$$1_ChainId_get$0$anon10_Then_correct) (=> (= (ControlFlow 0 1745666) 1745594) inline$$1_ChainId_get$0$anon10_Else_correct))))))
(let ((inline$$1_ChainId_get$0$anon9_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_589759| $1_ChainId_ChainId_$memory) 173345816)) (= (ControlFlow 0 1745664) 1745666)) inline$$1_ChainId_get$0$anon9_Then$1_correct)))
(let ((inline$$1_ChainId_get$0$anon9_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_589759| $1_ChainId_ChainId_$memory) 173345816) (=> (and (and (= inline$$1_ChainId_get$0$$t3@1 (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_589759| $1_ChainId_ChainId_$memory) 173345816)) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@5 $abort_flag@4) (= inline$$1_ChainId_get$0$$t3@2 inline$$1_ChainId_get$0$$t3@1))) (and (=> (= (ControlFlow 0 1745572) 1745608) inline$$1_ChainId_get$0$anon10_Then_correct) (=> (= (ControlFlow 0 1745572) 1745594) inline$$1_ChainId_get$0$anon10_Else_correct))))))
(let ((inline$$1_ChainId_get$0$anon8_Else_correct  (=> (and (not inline$$1_ChainId_get$0$$t0@0) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 1745558) 1745664) inline$$1_ChainId_get$0$anon9_Then_correct) (=> (= (ControlFlow 0 1745558) 1745572) inline$$1_ChainId_get$0$anon9_Else_correct)))))
(let ((inline$$1_ChainId_get$0$anon0_correct  (=> (= inline$$1_ChainId_get$0$$t0@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1745544) 1745692) inline$$1_ChainId_get$0$anon8_Then_correct) (=> (= (ControlFlow 0 1745544) 1745558) inline$$1_ChainId_get$0$anon8_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t35@0| (|$addr#$signer| _$t0)) (=> (and (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t36@0| (* _$t3 _$t4)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= _$t2 _$t2))) (=> (and (and (and (= _$t3 _$t3) (= _$t4 _$t4)) (and (= _$t5 _$t5) (= _$t6 _$t6))) (and (and (|$IsValid'address'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0| (|$addr#$signer| _$t0))) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0|) (= (ControlFlow 0 1745698) 1745544)))) inline$$1_ChainId_get$0$anon0_correct)))))
(let ((anon10_Then_correct  (=> (and (and inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1 (= $t17 (|$addr#$signer| _$t0))) (and (= $t18 (* _$t3 _$t4)) (= (ControlFlow 0 1748742) 1745698))) |inline$$1_DiemAccount_prologue_common'#0'$0$anon0_correct|)))
(let ((anon10_Else_correct  (=> (and (and (not inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1) (= $t16 $t16)) (and (= $t14@0 $t16) (= (ControlFlow 0 1742815) 1743331))) L3_correct)))
(let ((anon9_Else_correct  (=> (and (not $abort_flag@4) (|$IsValid'u64'| 1008)) (=> (and (and (|$IsValid'u64'| $t16) (= $t16 1)) (and (= $t16 $t16) (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1))) (and (=> (= (ControlFlow 0 1742799) 1748742) anon10_Then_correct) (=> (= (ControlFlow 0 1742799) 1742815) anon10_Else_correct))))))
(let ((anon9_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@4 $abort_code@4)) (and (= $t14@0 $abort_code@4) (= (ControlFlow 0 1749096) 1743331))) L3_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct  (=> (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@0) (=> (and (= $abort_flag@4 true) (= $abort_code@4 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1)) (and (=> (= (ControlFlow 0 1742597) 1749096) anon9_Then_correct) (=> (= (ControlFlow 0 1742597) 1742799) anon9_Else_correct))))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon34_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 $abort_code@3) (= (ControlFlow 0 1742591) 1742597))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon32_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 $abort_code@3) (= (ControlFlow 0 1742629) 1742597))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon31_Then_correct  (=> inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t13@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= 5 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@0)) (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@0 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@0)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@0) (= (ControlFlow 0 1742657) 1742597))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon29_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 $abort_code@3) (= (ControlFlow 0 1742689) 1742597))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon27_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 $abort_code@3) (= (ControlFlow 0 1742721) 1742597))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 $abort_code@3) (= (ControlFlow 0 1742753) 1742597))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L13_correct  (=> (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t7@1) (=> (and (= $abort_flag@4 $abort_flag@3) (= $abort_code@4 $abort_code@3)) (and (=> (= (ControlFlow 0 1742577) 1749096) anon9_Then_correct) (=> (= (ControlFlow 0 1742577) 1742799) anon9_Else_correct))))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L12_correct  (=> (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t2@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t2@1) (=> (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t7@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t2@1) (= (ControlFlow 0 1742573) 1742577)) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L13_correct))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon34_Else_correct  (=> (and (and (not $abort_flag@3) (= |inline$$1_Vector_contains'vec'u8''$0$res@1| |inline$$1_Vector_contains'vec'u8''$0$res@1|)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t2@1 |inline$$1_Vector_contains'vec'u8''$0$res@1|) (= (ControlFlow 0 1742561) 1742573))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L12_correct)))
(let ((|inline$$1_Vector_contains'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'vec'u8''$0$res@1| (exists ((i@@131 Int) ) (!  (and (and (|$IsValid'u64'| i@@131) (InRangeVec_447989 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t17@1 i@@131)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_37831_| (|v#Vec_416632| inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t17@1) i@@131) _$t7))
 :qid |DiemAccountbpl.2617:13|
 :skolemid |98|
))) (and (=> (= (ControlFlow 0 1742537) 1742591) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon34_Then_correct) (=> (= (ControlFlow 0 1742537) 1742561) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon34_Else_correct)))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon33_Else_correct  (=> (not |inline$$1_Vector_is_empty'vec'u8''$0$b@1|) (=> (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t17@1 (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t12@0)) (= (ControlFlow 0 1742543) 1742537)) |inline$$1_Vector_contains'vec'u8''$0$anon0_correct|))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon33_Then_correct  (=> (and (and |inline$$1_Vector_is_empty'vec'u8''$0$b@1| (= true true)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t2@1 true) (= (ControlFlow 0 1742615) 1742573))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L12_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon32_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 1742487) 1742615) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon33_Then_correct) (=> (= (ControlFlow 0 1742487) 1742543) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon33_Else_correct)))))
(let ((|inline$$1_Vector_is_empty'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_is_empty'vec'u8''$0$b@1| (= (|l#Vec_416632| inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t14@1) 0)) (and (=> (= (ControlFlow 0 1742473) 1742629) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon32_Then_correct) (=> (= (ControlFlow 0 1742473) 1742487) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon32_Else_correct)))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) addr@@10))))) (= (|$module_publishing_allowed#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t12@0) (|$module_publishing_allowed#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| (let ((addr@@10 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) addr@@10)))))) (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t12@0 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t12@0)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t14@1 (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t12@0)) (= (ControlFlow 0 1742479) 1742473))) |inline$$1_Vector_is_empty'vec'u8''$0$anon0_correct|))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon30_Else_correct  (=> (and (not |inline$$1_Vector_is_empty'u8'$0$b@1|) (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t13@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 1742413) 1742657) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon31_Then_correct) (=> (= (ControlFlow 0 1742413) 1742479) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon31_Else_correct)))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon30_Then_correct  (=> (and (and |inline$$1_Vector_is_empty'u8'$0$b@1| (= true true)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t7@1 true) (= (ControlFlow 0 1742675) 1742577))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L13_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon29_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 1742395) 1742675) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon30_Then_correct) (=> (= (ControlFlow 0 1742395) 1742413) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon30_Else_correct)))))
(let ((|inline$$1_Vector_is_empty'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_is_empty'u8'$0$b@1| (= (|l#Vec_37831| _$t7) 0)) (and (=> (= (ControlFlow 0 1742381) 1742689) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon29_Then_correct) (=> (= (ControlFlow 0 1742381) 1742395) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon29_Else_correct)))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon28_Else_correct  (=> (and (not inline$$1_DiemTransactionPublishingOption_transactions_halted$0$$t1@1) (= (ControlFlow 0 1742387) 1742381)) |inline$$1_Vector_is_empty'u8'$0$anon0_correct|)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon28_Then_correct  (=> (and (and inline$$1_DiemTransactionPublishingOption_transactions_halted$0$$t1@1 (= false false)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t7@1 false) (= (ControlFlow 0 1742707) 1742577))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L13_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon27_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 1742345) 1742707) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon28_Then_correct) (=> (= (ControlFlow 0 1742345) 1742387) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon28_Else_correct)))))
(let ((inline$$1_DiemTransactionPublishingOption_transactions_halted$0$anon0_correct  (=> (|$IsValid'address'| 173345816) (=> (and (= inline$$1_DiemTransactionPublishingOption_transactions_halted$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_562714| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) 173345816)) (= inline$$1_DiemTransactionPublishingOption_transactions_halted$0$$t1@1 inline$$1_DiemTransactionPublishingOption_transactions_halted$0$$t1@1)) (and (=> (= (ControlFlow 0 1742331) 1742721) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon27_Then_correct) (=> (= (ControlFlow 0 1742331) 1742345) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon27_Else_correct))))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon26_Else_correct  (=> (and (not inline$$1_Roles_has_diem_root_role$0$$ret0@1) (= (ControlFlow 0 1742337) 1742331)) inline$$1_DiemTransactionPublishingOption_transactions_halted$0$anon0_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon26_Then_correct  (=> (and (and inline$$1_Roles_has_diem_root_role$0$$ret0@1 (= true true)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t7@1 true) (= (ControlFlow 0 1742739) 1742577))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L13_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 1742246) 1742739) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon26_Then_correct) (=> (= (ControlFlow 0 1742246) 1742337) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon26_Else_correct)))))
(let ((inline$$1_Roles_has_diem_root_role$0$anon3_Else_correct  (=> (and (and (not $abort_flag@2) (= inline$$1_Roles_has_role$0$$ret0@1 inline$$1_Roles_has_role$0$$ret0@1)) (and (= inline$$1_Roles_has_diem_root_role$0$$ret0@1 inline$$1_Roles_has_role$0$$ret0@1) (= $abort_flag@3 $abort_flag@2))) (and (=> (= (ControlFlow 0 1742214) 1742753) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Then_correct) (=> (= (ControlFlow 0 1742214) 1742246) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Else_correct)))))
(let ((inline$$1_Roles_has_diem_root_role$0$anon3_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_Roles_has_diem_root_role$0$$ret0@1 inline$$1_Roles_has_diem_root_role$0$$ret0@0) (= $abort_flag@3 true))) (and (=> (= (ControlFlow 0 1742232) 1742753) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Then_correct) (=> (= (ControlFlow 0 1742232) 1742246) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Else_correct)))))
(let ((inline$$1_Roles_has_role$0$anon11_Then_correct  (=> $abort_flag@0 (=> (and (and (= $abort_code@1 $abort_code@1) (= $abort_code@3 $abort_code@1)) (and (= $abort_flag@2 true) (= inline$$1_Roles_has_role$0$$ret0@1 inline$$1_Roles_has_role$0$$ret0@0))) (and (=> (= (ControlFlow 0 1742138) 1742232) inline$$1_Roles_has_diem_root_role$0$anon3_Then_correct) (=> (= (ControlFlow 0 1742138) 1742214) inline$$1_Roles_has_diem_root_role$0$anon3_Else_correct))))))
(let ((inline$$1_Roles_has_role$0$L3_correct  (=> (and (and (= inline$$1_Roles_has_role$0$$t2@1 inline$$1_Roles_has_role$0$$t2@1) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$1_Roles_has_role$0$$ret0@1 inline$$1_Roles_has_role$0$$t2@1))) (and (=> (= (ControlFlow 0 1742074) 1742232) inline$$1_Roles_has_diem_root_role$0$anon3_Then_correct) (=> (= (ControlFlow 0 1742074) 1742214) inline$$1_Roles_has_diem_root_role$0$anon3_Else_correct)))))
(let ((inline$$1_Roles_has_role$0$anon11_Else_correct  (=> (and (and (and (not $abort_flag@0) (= inline$$1_Roles_has_role$0$$t8@1 (|$role_id#$1_Roles_RoleId| inline$$1_Roles_has_role$0$$t6@2))) (and (= inline$$1_Roles_has_role$0$$t9@1 (= inline$$1_Roles_has_role$0$$t8@1 0)) (= inline$$1_Roles_has_role$0$$t9@1 inline$$1_Roles_has_role$0$$t9@1))) (and (and (= $abort_code@2 $abort_code@1) (= inline$$1_Roles_has_role$0$$t2@1 inline$$1_Roles_has_role$0$$t9@1)) (and (= $abort_flag@1 $abort_flag@0) (= (ControlFlow 0 1742120) 1742074)))) inline$$1_Roles_has_role$0$L3_correct)))
(let ((inline$$1_Roles_has_role$0$anon10_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$1_Roles_has_role$0$$t6@2 inline$$1_Roles_has_role$0$$t6@0)) (and (=> (= (ControlFlow 0 1742190) 1742138) inline$$1_Roles_has_role$0$anon11_Then_correct) (=> (= (ControlFlow 0 1742190) 1742120) inline$$1_Roles_has_role$0$anon11_Else_correct))))))
(let ((inline$$1_Roles_has_role$0$anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0)) (= (ControlFlow 0 1742188) 1742190)) inline$$1_Roles_has_role$0$anon10_Then$1_correct)))
(let ((inline$$1_Roles_has_role$0$anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0) (=> (and (and (= inline$$1_Roles_has_role$0$$t6@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_Roles_has_role$0$$t6@2 inline$$1_Roles_has_role$0$$t6@1))) (and (=> (= (ControlFlow 0 1742092) 1742138) inline$$1_Roles_has_role$0$anon11_Then_correct) (=> (= (ControlFlow 0 1742092) 1742120) inline$$1_Roles_has_role$0$anon11_Else_correct))))))
(let ((inline$$1_Roles_has_role$0$anon9_Then_correct  (=> inline$$1_Roles_has_role$0$$t5@1 (and (=> (= (ControlFlow 0 1742078) 1742188) inline$$1_Roles_has_role$0$anon10_Then_correct) (=> (= (ControlFlow 0 1742078) 1742092) inline$$1_Roles_has_role$0$anon10_Else_correct)))))
(let ((inline$$1_Roles_has_role$0$anon9_Else_correct  (=> (and (not inline$$1_Roles_has_role$0$$t5@1) (= false false)) (=> (and (and (= $abort_code@2 $abort_code@0) (= inline$$1_Roles_has_role$0$$t2@1 false)) (and (= $abort_flag@1 false) (= (ControlFlow 0 1742062) 1742074))) inline$$1_Roles_has_role$0$L3_correct))))
(let ((inline$$1_Roles_has_role$0$anon0_correct  (=> (and (= _$t0 _$t0) (= 0 0)) (=> (and (and (|$IsValid'address'| inline$$1_Roles_has_role$0$$t4@0) (= inline$$1_Roles_has_role$0$$t4@0 (|$addr#$signer| _$t0))) (and (= inline$$1_Roles_has_role$0$$t4@0 inline$$1_Roles_has_role$0$$t4@0) (= inline$$1_Roles_has_role$0$$t5@1 (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0)))) (and (=> (= (ControlFlow 0 1742042) 1742078) inline$$1_Roles_has_role$0$anon9_Then_correct) (=> (= (ControlFlow 0 1742042) 1742062) inline$$1_Roles_has_role$0$anon9_Else_correct))))))
(let ((inline$$1_Roles_has_diem_root_role$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 1742196) 1742042)) inline$$1_Roles_has_role$0$anon0_correct))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= _$t7 _$t7) (= (ControlFlow 0 1742238) 1742196)) inline$$1_Roles_has_diem_root_role$0$anon0_correct))))
(let ((anon0$1_correct  (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@11)) 4))))
 :qid |DiemAccountbpl.88869:20|
 :skolemid |3338|
))) (and (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@12) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@12)) 3))))
 :qid |DiemAccountbpl.88873:20|
 :skolemid |3339|
)) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@13) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@13)) 3))))
 :qid |DiemAccountbpl.88877:20|
 :skolemid |3340|
)))) (and (and (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@14) (not (= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@14)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@14)) 3))))
 :qid |DiemAccountbpl.88881:20|
 :skolemid |3341|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_496194| $1_DiemConfig_Configuration_$memory) 173345816))))) (=> (and (and (and (and (and (and (and (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_495677| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address) (= config_address 173345816)))
 :qid |DiemAccountbpl.88897:24|
 :skolemid |3342|
)) (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_495758| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemAccountbpl.88897:243|
 :skolemid |3343|
))) (forall ((config_address@@1 Int) ) (!  (=> (|$IsValid'address'| config_address@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) config_address@@1) (= config_address@@1 173345816)))
 :qid |DiemAccountbpl.88897:483|
 :skolemid |3344|
))) (forall ((config_address@@2 Int) ) (!  (=> (|$IsValid'address'| config_address@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_495920| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) config_address@@2) (= config_address@@2 173345816)))
 :qid |DiemAccountbpl.88897:745|
 :skolemid |3345|
))) (forall ((config_address@@3 Int) ) (!  (=> (|$IsValid'address'| config_address@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_496001| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) config_address@@3) (= config_address@@3 173345816)))
 :qid |DiemAccountbpl.88897:969|
 :skolemid |3346|
))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_495758| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (and (and (and (forall ((mint_cap_owner Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_508305| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) mint_cap_owner) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) mint_cap_owner)) 1))))
 :qid |DiemAccountbpl.88905:22|
 :skolemid |3347|
 ...
 :qid |DiemAccountbpl.88913:565|
 :skolemid |3355|
))) (and (and (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_525677| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@15) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@15) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@15)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@15)) 6)))))
 :qid |DiemAccountbpl.88917:22|
 :skolemid |3356|
)) (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_525741| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@16) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@16) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@16)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@16)) 6)))))
 :qid |DiemAccountbpl.88917:388|
 :skolemid |3357|
))) (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_525805| |$1_AccountLimits_Window'#0'_$memory|) addr@@17) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@17) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@17)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@17)) 6)))))
 :qid |DiemAccountbpl.88917:755|
 :skolemid |3358|
)))))) (and (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_501767| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_525873| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_531513| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_501831| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_526329| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_548824| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@5) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr1@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr1@@5)) 2)))))
 :qid |DiemAccountbpl.88949:20|
 :skolemid |3359|
))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_589759| $1_ChainId_ChainId_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 173345816))))))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@18) (or (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@18)))) 0) (and (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@18)))) 0)) (= addr@@18 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@18)))) 0)))))))
 :qid |DiemAccountbpl.88973:20|
 :skolemid |3360|
))) (and (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@19) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@19) (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@19)))) 0)) (and (not (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@19)))) 0)) (= addr@@19 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@19)))) 0)))))))
 :qid |DiemAccountbpl.88977:20|
 :skolemid |3361|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))))) (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@20) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@20)))
 :qid |DiemAccountbpl.88989:20|
 :skolemid |3362|
))) (and (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (and (= addr@@21 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@21)) (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@21)))
 :qid |DiemAccountbpl.88993:20|
 :skolemid |3363|
)) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) addr@@22) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@22)) 1))))
 :qid |DiemAccountbpl.88997:20|
 :skolemid |3364|
)))) (and (and (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_468892| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@23) (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@23)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@23)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@23)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@23)) 2)))))
 :qid |DiemAccountbpl.89001:20|
 :skolemid |3365|
)) (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469037| $1_DesignatedDealer_Dealer_$memory) addr@@24) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@24)) 2))))
 :qid |DiemAccountbpl.89005:20|
 :skolemid |3366|
))) (and (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr@@25) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@25)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@25)) 5)))))
 :qid |DiemAccountbpl.89009:20|
 :skolemid |3367|
)) (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@26) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) addr@@26)))
 :qid |DiemAccountbpl.89013:20|
 :skolemid |3368|
))))) (and (and (and (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468892| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@27) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@27)))
 :qid |DiemAccountbpl.89017:22|
 :skolemid |3369|
)) (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@28) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@28)))
 :qid |DiemAccountbpl.89017:218|
 :skolemid |3370|
))) (forall ((addr@@29 Int) ) (!  (=> (|$IsValid'address'| addr@@29) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@29) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@29)))
 :qid |DiemAccountbpl.89017:415|
 :skolemid |3371|
))) (forall ((addr@@30 Int) ) (!  (=> (|$IsValid'address'| addr@@30) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@30) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@30)) 3))))
 :qid |DiemAccountbpl.89021:20|
 :skolemid |3372|
))))) (and (and (and (and (and (forall ((addr@@31 Int) ) (!  (=> (|$IsValid'address'| addr@@31) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@31) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@31)) 4))))
 :qid |DiemAccountbpl.89025:20|
 :skolemid |3373|
)) (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469420| $1_VASP_ParentVASP_$memory) addr@@32) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@32)) 5))))
 :qid |DiemAccountbpl.89029:20|
 :skolemid |3374|
))) (and (forall ((addr@@33 Int) ) (!  (=> (|$IsValid'address'| addr@@33) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469520| $1_VASP_ChildVASP_$memory) addr@@33) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@33)) 6))))
 :qid |DiemAccountbpl.89033:20|
 :skolemid |3375|
)) (|$IsValid'address'| (|$addr#$signer| _$t0)))) (and (and (|$IsValid'u64'| _$t1) (|$IsValid'vec'u8''| _$t2)) (and (|$IsValid'u64'| _$t3) (|$IsValid'u64'| _$t4)))) (and (and (and (|$IsValid'u64'| _$t5) (|$IsValid'u8'| _$t6)) (and (|$IsValid'vec'u8''| _$t7) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemAccountbpl.89060:20|
 :skolemid |3376|
...
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |DiemAccountbpl.89064:20|
 :skolemid |3377|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0@@0))
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) $a_0@@1)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption''| $rsc@@1))
 :qid |DiemAccountbpl.89068:20|
 :skolemid |3378|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) $a_0@@1))
))) (and (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_548952| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@2)))
(|$IsValid'$1_TransactionFee_TransactionFee'#0''| $rsc@@2))
 :qid |DiemAccountbpl.89072:20|
 :skolemid |3379|
 :pattern ( (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_548952| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@2))
)) (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_562714| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $a_0@@3)))
(|$IsValid'$1_DiemTransactionPublishingOption_HaltAllTransactions'| $rsc@@3))
 :qid |DiemAccountbpl.89076:20|
 :skolemid |3380|
 :pattern ( (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_562714| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $a_0@@3))
)))))) (and (and (and (and (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_589759| $1_ChainId_ChainId_$memory) $a_0@@4)))
(|$IsValid'$1_ChainId_ChainId'| $rsc@@4))
 :qid |DiemAccountbpl.89080:20|
 :skolemid |3381|
 :pattern ( (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_589759| $1_ChainId_ChainId_$memory) $a_0@@4))
)) (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $a_0@@5)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@5))
 :qid |DiemAccountbpl.89084:20|
 :skolemid |3382|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $a_0@@5))
))) (and (forall (($a_0@@6 Int) ) (! (let (($rsc@@6 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $a_0@@6)))
 (and (|$IsValid'$1_DiemAccount_DiemAccount'| $rsc@@6) (and (<= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| $rsc@@6))) 1) (<= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| $rsc@@6))) 1))))
 :qid |DiemAccountbpl.89088:20|
 :skolemid |3383|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $a_0@@6))
)) (forall (($a_0@@7 Int) ) (! (let (($rsc@@7 (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $a_0@@7)))
(|$IsValid'$1_DiemAccount_Balance'#0''| $rsc@@7))
 :qid |DiemAccountbpl.89092:20|
 :skolemid |3384|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) $a_0@@7))
)))) (and (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (* _$t3 _$t4))) (and (= $t12 (|$addr#$signer| _$t0)) (= _$t0 _$t0)))) (and (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= _$t4 _$t4))) (and (and (= _$t5 _$t5) (= _$t6 _$t6)) (and (= _$t7 _$t7) (= (ControlFlow 0 1742759) 1742238)))))))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1739340) 1742759)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2343876) 1739340) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
