...
(assert (not
 (=> (= (ControlFlow 0 0) 284378) (let ((anon0$1_correct@@7  (=> (and (and (and (forall ((window_addr@@5 Int) ) (!  (=> (|$IsValid'address'| window_addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_122943| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@5)))))
 :qid |AccountLimitsbpl.9535:20|
 :skolemid |240|
)) (forall ((addr@@63 Int) ) (!  (=> (|$IsValid'address'| addr@@63) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) addr@@63) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112234| $1_Roles_RoleId_$memory) addr@@63) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112234| $1_Roles_RoleId_$memory) addr@@63)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112234| $1_Roles_RoleId_$memory) addr@@63)) 6)))))
 :qid |AccountLimitsbpl.9539:20|
 :skolemid |241|
))) (and (|$IsValid'address'| _$t0@@7) (forall (($a_0@@14 Int) ) (! (let (($rsc@@14 (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@14)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc@@14))
 :qid |AccountLimitsbpl.9546:20|
 :skolemid |242|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@14))
)))) (and (and (= _$t0@@7 _$t0@@7) (= $t1@0@@5 (|Select__T@[Int]Bool_| (|domain#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) _$t0@@7))) (and (= $t1@0@@5 $t1@0@@5) (= (ControlFlow 0 225883) (- 0 284554))))) (= $t1@0@@5 (|Select__T@[Int]Bool_| (|domain#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) _$t0@@7)))))
(let ((inline$$InitEventStore$0$anon0_correct@@7  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@9 T@$1_Event_EventHandle) ) (! (let ((stream@@8 (|Select__T@[$1_Event_EventHandle]Multiset_82546_| (|streams#$EventStore| $es) handle@@9)))
 (and (= (|l#Multiset_82546| stream@@8) 0) (forall ((v@@44 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_82546| stream@@8) v@@44) 0)
 :qid |AccountLimitsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountLimitsbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 225723) 225883)) anon0$1_correct@@7)))
(let ((anon0_correct@@7  (=> (= (ControlFlow 0 284378) 225723) inline$$InitEventStore$0$anon0_correct@@7)))
anon0_correct@@7))))
))
(check-sat)
(pop 1)
