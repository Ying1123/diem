...
(assert (not
 (=> (= (ControlFlow 0 0) 400080) (let ((anon0$1_correct@@14  (=> (and (and (forall ((window_addr@@17 Int) ) (!  (=> (|$IsValid'address'| window_addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142572| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@17) (|Select__T@[Int]Bool_| (|domain#$Memory_170725| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_142572| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@17)))))
 :qid |AccountLimitsbpl.14151:22|
 :skolemid |267|
)) (forall ((window_addr@@18 Int) ) (!  (=> (|$IsValid'address'| window_addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142703| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_170799| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_142703| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@18)))))
 :qid |AccountLimitsbpl.14151:369|
 :skolemid |268|
))) (forall ((window_addr@@19 Int) ) (!  (=> (|$IsValid'address'| window_addr@@19) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@19) (|Select__T@[Int]Bool_| (|domain#$Memory_170873| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@19)))))
 :qid |AccountLimitsbpl.14151:717|
 :skolemid |269|
))) (=> (and (and (and (and (forall ((addr@@89 Int) ) (!  (=> (|$IsValid'address'| addr@@89) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142572| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@89) (and (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) addr@@89) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@89)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@89)) 6)))))
 :qid |AccountLimitsbpl.14155:22|
 :skolemid |270|
)) (forall ((addr@@90 Int) ) (!  (=> (|$IsValid'address'| addr@@90) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142703| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@90) (and (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) addr@@90) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@90)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@90)) 6)))))
 :qid |AccountLimitsbpl.14155:388|
 :skolemid |271|
))) (forall ((addr@@91 Int) ) (!  (=> (|$IsValid'address'| addr@@91) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) addr@@91) (and (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) addr@@91) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@91)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@91)) 6)))))
 :qid |AccountLimitsbpl.14155:755|
 :skolemid |272|
))) (and (|$IsValid'address'| _$t0@@14) (forall (($a_0@@23 Int) ) (! (let (($rsc@@23 (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@23)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc@@23))
 :qid |AccountLimitsbpl.14162:20|
 :skolemid |273|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@23))
)))) (and (and (= _$t0@@14 _$t0@@14) (= $t1@0@@5 (|Select__T@[Int]Bool_| (|domain#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) _$t0@@14))) (and (= $t1@0@@5 $t1@0@@5) (= (ControlFlow 0 292374) (- 0 400424))))) (= $t1@0@@5 (|Select__T@[Int]Bool_| (|domain#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) _$t0@@14))))))
(let ((inline$$InitEventStore$0$anon0_correct@@14  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@16 T@$1_Event_EventHandle) ) (! (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_111298_| (|streams#$EventStore| $es) handle@@16)))
 (and (= (|l#Multiset_111298| stream@@15) 0) (forall ((v@@50 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_111298| stream@@15) v@@50) 0)
 :qid |AccountLimitsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountLimitsbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 292046) 292374)) anon0$1_correct@@14)))
(let ((anon0_correct@@14  (=> (= (ControlFlow 0 400080) 292046) inline$$InitEventStore$0$anon0_correct@@14)))
anon0_correct@@14))))
))
(check-sat)
(pop 1)
