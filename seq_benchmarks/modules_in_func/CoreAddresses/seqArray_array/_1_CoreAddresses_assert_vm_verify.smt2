...
(assert (not
 (=> (= (ControlFlow 0 0) 12950) (let ((anon4_Else_correct@@2  (=> (and (not $t5@0@@2) (= $t7@@2 $t7@@2)) (and (=> (= (ControlFlow 0 11776) (- 0 13088)) (not (= (|$addr#$signer| _$t0@@2) 0))) (=> (not (= (|$addr#$signer| _$t0@@2) 0)) (=> (= (ControlFlow 0 11776) (- 0 13097)) (and (not (= (|$addr#$signer| _$t0@@2) 0)) (= 2 $t7@@2))))))))
(let ((anon4_Then_correct@@2  (=> (and $t5@0@@2 (= (ControlFlow 0 11796) (- 0 13061))) (not (not (= (|$addr#$signer| _$t0@@2) 0))))))
(let ((anon0$1_correct@@2  (=> (|$IsValid'address'| (|$addr#$signer| _$t0@@2)) (=> (and (= _$t0@@2 _$t0@@2) (|$IsValid'address'| $t3@@2)) (=> (and (and (and (= $t3@@2 (|$addr#$signer| _$t0@@2)) (|$IsValid'address'| 0)) (and (= $t5@0@@2 (= $t3@@2 0)) (|$IsValid'u64'| 2))) (and (and (|$IsValid'u64'| $t7@@2) (= $t7@@2 2)) (and (= $t7@@2 $t7@@2) (= $t5@0@@2 $t5@0@@2)))) (and (=> (= (ControlFlow 0 11728) 11796) anon4_Then_correct@@2) (=> (= (ControlFlow 0 11728) 11776) anon4_Else_correct@@2)))))))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 12950) 11728) anon0$1_correct@@2)))
anon0_correct@@2)))))
))
(check-sat)
(pop 1)
