...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.461:15|
 :skolemid |14|
...
(|$IsValid'$0_A_S'| $rsc))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.937:20|
 :skolemid |25|
...
(|$IsValid'$0_A_S'| $rsc@@0))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.1048:20|
 :skolemid |26|
...
(|$IsValid'$0_A_S'| $rsc@@1))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.1164:20|
 :skolemid |28|
...
(|$IsValid'$0_B_T'| $rsc@@2))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.1168:20|
 :skolemid |29|
...
(|$IsValid'$0_A_S'| $rsc@@3))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.1336:20|
 :skolemid |30|
...
(|$IsValid'$0_B_T'| $rsc@@4))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.1340:20|
 :skolemid |31|
...
(|$IsValid'$0_A_S'| $rsc@@5))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.1507:20|
 :skolemid |32|
...
(|$IsValid'$0_A_S'| $rsc@@6))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.1691:20|
 :skolemid |33|
...
(|$IsValid'$0_A_S'| $rsc@@7))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.1878:20|
 :skolemid |34|
...
(|$IsValid'$0_B_T'| $rsc@@8))
 :qid |ModifiesErrorTestSmtSeqcvc4bpl.1882:20|
 :skolemid |35|
