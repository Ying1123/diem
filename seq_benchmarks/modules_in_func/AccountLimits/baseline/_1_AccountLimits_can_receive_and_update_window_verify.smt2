...
(let ((inline$$AddU64$3$anon3_Then_correct  (=> (and (> (+ $t48@0 _$t0) $MAX_U64) (= (ControlFlow 0 287391) 287393)) inline$$AddU64$3$anon3_Then$1_correct)))
(let ((inline$$AddU64$3$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t48@0 _$t0)) (=> (and (and (= inline$$AddU64$3$dst@1 (+ $t48@0 _$t0)) (= $abort_code@7 $abort_code@6)) (and (= $abort_flag@6 $abort_flag@5) (= inline$$AddU64$3$dst@2 inline$$AddU64$3$dst@1))) (and (=> (= (ControlFlow 0 287339) 287453) anon50_Then_correct) (=> (= (ControlFlow 0 287339) 287439) anon50_Else_correct))))))
...
(let ((inline$$AddU64$2$anon3_Then_correct  (=> (and (> (+ $t45@0 _$t0) $MAX_U64) (= (ControlFlow 0 287190) 287192)) inline$$AddU64$2$anon3_Then$1_correct)))
(let ((inline$$AddU64$2$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t45@0 _$t0)) (=> (and (and (= inline$$AddU64$2$dst@1 (+ $t45@0 _$t0)) (= $abort_flag@5 $abort_flag@4)) (and (= $abort_code@6 $abort_code@5) (= inline$$AddU64$2$dst@2 inline$$AddU64$2$dst@1))) (and (=> (= (ControlFlow 0 287138) 287467) anon49_Then_correct) (=> (= (ControlFlow 0 287138) 287399) anon49_Else_correct))))))
...
(let ((inline$$AddU64$1$anon3_Then_correct  (=> (and (> (+ $t40@0 _$t0) $MAX_U64) (= (ControlFlow 0 286623) 286625)) inline$$AddU64$1$anon3_Then$1_correct)))
(let ((inline$$AddU64$1$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t40@0 _$t0)) (=> (and (and (= inline$$AddU64$1$dst@1 (+ $t40@0 _$t0)) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@4 $abort_flag@3) (= inline$$AddU64$1$dst@2 inline$$AddU64$1$dst@1))) (and (=> (= (ControlFlow 0 286571) 287481) anon47_Then_correct) (=> (= (ControlFlow 0 286571) 286689) anon47_Else_correct))))))
...
(let ((inline$$Sub$1$anon3_Then_correct  (=> (and (< 18446744073709551615 _$t0) (= (ControlFlow 0 286360) 286362)) inline$$Sub$1$anon3_Then$1_correct)))
...
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t30@0 _$t0) $MAX_U64) (= (ControlFlow 0 286143) 286145)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t30@0 _$t0)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t30@0 _$t0)) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 286091) 287509) anon44_Then_correct) (=> (= (ControlFlow 0 286091) 286209) anon44_Else_correct))))))
...
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< 18446744073709551615 _$t0) (= (ControlFlow 0 285880) 285882)) inline$$Sub$0$anon3_Then$1_correct)))
...
(let ((anon39_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t16@0 $abort_code@1) (= (ControlFlow 0 287617) 285607))) L14_correct)))
(let ((anon38_Then$1_correct  (=> (= $t18@1 $t18) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 287669) 287617) anon39_Then_correct) (=> (= (ControlFlow 0 287669) 285659) anon39_Else_correct))))))
...
(let ((anon38_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $t17@0) (=> (and (and (= $t18@0 (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'#0'_| (|contents#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $t17@0)) (= $t18@1 $t18@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 285631) 287617) anon39_Then_correct) (=> (= (ControlFlow 0 285631) 285659) anon39_Else_correct))))))
(let ((anon37_Then_correct  (=> (and $t13@0 (= $t17@0 (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| _$t1)))) (and (=> (= (ControlFlow 0 285617) 287667) anon38_Then_correct) (=> (= (ControlFlow 0 285617) 285631) anon38_Else_correct)))))
...
)) (= $t11@0 (|v#$Mutation_182906| _$t1))) (and (= _$t0 _$t0) (= |$temp_0'$1_AccountLimits_Window'#0''@0| (|v#$Mutation_182906| _$t1))))) (and (and (and (= |$temp_0'$1_AccountLimits_Window'#0''@0| |$temp_0'$1_AccountLimits_Window'#0''@0|) (= $t12@0 (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_182906| _$t1)))) (and (= $t13@0 (|Select__T@[Int]Bool_| (|domain#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $t12@0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t15) (= $t15 5)) (and (= $t15 $t15) (= $t13@0 $t13@0))))) (and (=> (= (ControlFlow 0 285307) 285617) anon37_Then_correct) (=> (= (ControlFlow 0 285307) 285323) anon37_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_112887_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 285016) 285307)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_27093| (|p#$Mutation_12788| $t47)) 0) (=> (and (= (|l#Vec_27093| (|p#$Mutation_12788| $t50)) 0) (= (ControlFlow 0 285026) 285016)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 400709) 285026) anon0_correct)))
