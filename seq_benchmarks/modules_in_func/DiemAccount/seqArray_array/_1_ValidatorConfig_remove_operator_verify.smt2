...
(assert (not
 (=> (= (ControlFlow 0 0) 1896242) (let ((anon18_Else_correct@@1  (=> (and (and (not $abort_flag@0@@3) (= $t13@0 ($Mutation_490338 (|l#$Mutation_490297| $t12@1) (let ((l@@0 (|l#Vec_37831| (|p#$Mutation_490297| $t12@1))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_490297| $t12@1)) l@@0 1) (+ l@@0 1))) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t12@1))))) (and (= $t13@1 ($Mutation_490338 (|l#$Mutation_490338| $t13@0) (|p#$Mutation_490338| $t13@0) $t11@@2)) (= $t12@2 ($Mutation_490297 (|l#$Mutation_490297| $t12@1) (|p#$Mutation_490297| $t12@1) ($1_ValidatorConfig_ValidatorConfig (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t12@1)) (|v#$Mutation_490338| $t13@1) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t12@1))))))) (and (=> (= (ControlFlow 0 1102680) (- 0 1897004)) (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t12@2)))) 1)) (=> (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t12@2)))) 1) (and (=> (= (ControlFlow 0 1102680) (- 0 1897017)) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t12@2)))) 1)) (=> (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t12@2)))) 1) (=> (and (forall ((addr@@115 Int) ) (!  (=> (|$IsValid'address'| addr@@115) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@115) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@115)) 3))))
 :qid |DiemAccountbpl.10848:20|
 :skolemid |269|
)) (= $1_ValidatorConfig_ValidatorConfig_$memory@0@@0 ($Memory_469220 (|Store__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_490297| $t12@2)) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_490297| $t12@2)) (|v#$Mutation_490297| $t12@2))))) (and (=> (= (ControlFlow 0 1102680) (- 0 1897078)) (forall ((addr@@116 Int) ) (!  (=> (|$IsValid'address'| addr@@116) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@116) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@116)) 3))))
 :qid |DiemAccountbpl.10859:15|
 :skolemid |270|
))) (=> (forall ((addr@@117 Int) ) (!  (=> (|$IsValid'address'| addr@@117) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@117) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@117)) 3))))
 :qid |DiemAccountbpl.10859:15|
 :skolemid |270|
)) (and (=> (= (ControlFlow 0 1102680) (- 0 1897106)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t4@@6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t4@@6))) (and (=> (= (ControlFlow 0 1102680) (- 0 1897118)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t4@@6)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t4@@6)) 3))) (and (=> (= (ControlFlow 0 1102680) (- 0 1897136)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t4@@6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t4@@6))) (and (=> (= (ControlFlow 0 1102680) (- 0 1897148)) (not (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) (|$addr#$signer| _$t0@@10))))) 0)))) (=> (not (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) (|$addr#$signer| _$t0@@10))))) 0))) (=> (= (ControlFlow 0 1102680) (- 0 1897159)) (forall ((addr@@118 Int) ) (!  (=> (|$IsValid'address'| addr@@118) (=> (not (= addr@@118 $t4@@6)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@118))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@118))))))
 :qid |DiemAccountbpl.10888:15|
 :skolemid |271|
)))))))))))))))))))))
(let ((L3_correct@@2  (and (=> (= (ControlFlow 0 1102403) (- 0 1896866)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t4@@6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t4@@6)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t4@@6)))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t4@@6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t4@@6)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t4@@6))) (=> (= (ControlFlow 0 1102403) (- 0 1896897)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t4@@6)) (= 5 $t6@0@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t4@@6)) 3)) (= 3 $t6@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t4@@6)) (= 5 $t6@0@@0))))))))
(let ((anon18_Then_correct@@1  (=> (and (and $abort_flag@0@@3 (= $abort_code@1@@3 $abort_code@1@@3)) (and (= $t6@0@@0 $abort_code@1@@3) (= (ControlFlow 0 1102694) 1102403))) L3_correct@@2)))
(let ((anon17_Then$1_correct  (=> (= $t12@1 $t12@@1) (=> (and (= $abort_flag@0@@3 true) (= $abort_code@1@@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1102746) 1102694) anon18_Then_correct@@1) (=> (= (ControlFlow 0 1102746) 1102680) anon18_Else_correct@@1))))))
(let ((anon17_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t7@@3)) (= (ControlFlow 0 1102744) 1102746)) anon17_Then$1_correct)))
(let ((anon17_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t7@@3) (=> (and (and (= $t12@0@@0 ($Mutation_490297 ($Global $t7@@3) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t7@@3))) (= $t12@1 $t12@0@@0)) (and (= $abort_flag@0@@3 false) (= $abort_code@1@@3 $abort_code@0@@3))) (and (=> (= (ControlFlow 0 1102451) 1102694) anon18_Then_correct@@1) (=> (= (ControlFlow 0 1102451) 1102680) anon18_Else_correct@@1))))))
(let ((anon16_Then_correct@@1  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (=> (and (and (|$IsValid'$1_Option_Option'address''| $t11@@2) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| $t11@@2)) 1)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| $t11@@2) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0))))) (and (=> (= (ControlFlow 0 1102429) 1102744) anon17_Then_correct@@1) (=> (= (ControlFlow 0 1102429) 1102451) anon17_Else_correct@@1))))))
(let ((anon16_Else_correct@@1  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= $t10@@3 $t10@@3)) (and (= $t6@0@@0 $t10@@3) (= (ControlFlow 0 1102303) 1102403))) L3_correct@@2)))
(let ((anon15_Else_correct@@0  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t10@@3) (= $t10@@3 5)) (and (= $t10@@3 $t10@@3) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 1102287) 1102429) anon16_Then_correct@@1) (=> (= (ControlFlow 0 1102287) 1102303) anon16_Else_correct@@1))))))
(let ((anon14_Then_correct@@1  (=> $t5@@9 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@10))) (= 5 $t6@@8)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@10))) 3)) (= 3 $t6@@8))) (= $t6@@8 $t6@@8)) (and (= $t6@0@@0 $t6@@8) (= (ControlFlow 0 1102816) 1102403))) L3_correct@@2))))
(let ((anon15_Then_correct@@0 true))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= $t7@@3 $t7@@3) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t7@@3)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 1102245) 1102760) anon15_Then_correct@@0) (=> (= (ControlFlow 0 1102245) 1102287) anon15_Else_correct@@0))))))
(let ((anon14_Else_correct@@1  (=> (not $t5@@9) (=> (and (and (|$IsValid'address'| $t7@@3) (= $t7@@3 (|$addr#$signer| _$t0@@10))) (and (= $t7@@3 $t7@@3) (= (ControlFlow 0 1102251) 1102245))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct))))
(let ((anon0$1_correct@@10  (=> (and (forall ((addr@@119 Int) ) (!  (=> (|$IsValid'address'| addr@@119) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@119) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@119)) 4))))
 :qid |DiemAccountbpl.10660:20|
 :skolemid |263|
)) (forall ((addr@@120 Int) ) (!  (=> (|$IsValid'address'| addr@@120) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@120) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@120)) 3))))
 :qid |DiemAccountbpl.10664:20|
 :skolemid |264|
))) (=> (and (and (and (forall ((addr@@121 Int) ) (!  (=> (|$IsValid'address'| addr@@121) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@121) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@121) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@121)) 3))))
 :qid |DiemAccountbpl.10668:20|
 :skolemid |265|
)) (forall ((addr@@122 Int) ) (!  (=> (|$IsValid'address'| addr@@122) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@122) (not (= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@122)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@122)) 3))))
 :qid |DiemAccountbpl.10672:20|
 :skolemid |266|
))) (and (|$IsValid'address'| (|$addr#$signer| _$t0@@10)) (forall (($a_0@@16 Int) ) (! (let (($rsc@@16 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0@@16)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@16))
 :qid |DiemAccountbpl.10678:20|
 :skolemid |267|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0@@16))
)))) (and (and (forall (($a_0@@17 Int) ) (! (let (($rsc@@17 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@17)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@17) (and (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@17))) 1) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@17))) 1))))
 :qid |DiemAccountbpl.10682:20|
 :skolemid |268|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@17))
)) (= $t4@@6 (|$addr#$signer| _$t0@@10))) (and (= _$t0@@10 _$t0@@10) (= $t5@@9  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@10))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@10))) 3))))))) (and (=> (= (ControlFlow 0 1102120) 1102816) anon14_Then_correct@@1) (=> (= (ControlFlow 0 1102120) 1102251) anon14_Else_correct@@1))))))
(let ((inline$$InitEventStore$0$anon0_correct@@10  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@12 T@$1_Event_EventHandle) ) (! (let ((stream@@11 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@12)))
 (and (= (|l#Multiset_416285| stream@@11) 0) (forall ((v@@75 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@11) v@@75) 0)
 :qid |DiemAccountbpl.159:13|
 :skolemid |4|
))))
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1101882) 1102120)) anon0$1_correct@@10)))
(let ((anon0_correct@@10  (=> (= (|l#Vec_37831| (|p#$Mutation_490297| $t12@@1)) 0) (=> (and (= (|l#Vec_37831| (|p#$Mutation_490338| $t13)) 0) (= (ControlFlow 0 1101892) 1101882)) inline$$InitEventStore$0$anon0_correct@@10))))
(let ((PreconditionGeneratedEntry_correct@@0  (=> (= (ControlFlow 0 1896242) 1101892) anon0_correct@@10)))
