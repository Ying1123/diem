...
(declare-fun $t18@0 () T@$Mutation_65773)
(declare-fun $t17@1 () T@$Mutation_592036)
(declare-fun $t18@1 () T@$Mutation_65773)
(declare-fun $t17@2 () T@$Mutation_592036)
...
(declare-fun $t17 () T@$Mutation_592036)
(declare-fun $t17@0 () T@$Mutation_592036)
...
(declare-fun $t18 () T@$Mutation_65773)
(declare-fun $t22 () T@$Mutation_456960)
(push 1)
(set-info :boogie-vc-id $1_AccountFreezing_unfreeze_account$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1933085) (let ((anon28_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 1146570) (- 0 1934318)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1146570) (- 0 1934328)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 1146570) (- 0 1934340)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) 1))) (and (=> (= (ControlFlow 0 1146570) (- 0 1934358)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 1146570) (- 0 1934372)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (and (=> (= (ControlFlow 0 1146570) (- 0 1934383)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8))) (and (=> (= (ControlFlow 0 1146570) (- 0 1934395)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) 1))) (and (=> (= (ControlFlow 0 1146570) (- 0 1934413)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 1146570) (- 0 1934427)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@0) _$t1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@0) _$t1))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@0) _$t1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@0) _$t1)))) (and (=> (= (ControlFlow 0 1146570) (- 0 1934436)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t6)))
(let ((stream_new (let ((len (|l#Multiset_416285| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t6 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t6)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_416285| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t6 stream_new@@0))))))
 ...
 :qid |DiemAccountbpl.3536:13|
 :skolemid |130|
))))) (=> (= (ControlFlow 0 1146570) (- 0 1934461)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t6)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_416285| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@2) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@2) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t6 stream_new@@1))))))
...
(let ((L3_correct  (and (=> (= (ControlFlow 0 1146093) (- 0 1934082)) (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 1146093) (- 0 1934165)) (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t10@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) (= 5 $t10@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) 1)) (= 3 $t10@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t10@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (= 5 $t10@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) (= 5 $t10@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) 1)) (= 3 $t10@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t10@0))))))))
(let ((anon28_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 1146584) 1146093))) L3_correct)))
(let ((|inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$handle@1| (|v#$Mutation_456960| $t22@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_416285| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@3) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t23@0))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@3) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t23@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 1146378) 1146584) anon28_Then_correct) (=> (= (ControlFlow 0 1146378) 1146570) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (and (not $abort_flag@1) (= $t22@0 ($Mutation_456960 (|l#$Mutation_592079| $t21@1) (let ((l (|l#Vec_37831| (|p#$Mutation_592079| $t21@1))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_592079| $t21@1)) l 1) (+ l 1))) (|$unfreeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|v#$Mutation_592079| $t21@1))))) (and (= $t23@0 ($1_AccountFreezing_UnfreezeAccountEvent $t19 _$t1)) (= (ControlFlow 0 1146384) 1146378))) |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$anon0_correct|)))
(let ((anon27_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 1146598) 1146093))) L3_correct)))
(let ((anon26_Then$1_correct  (=> (= $t21@1 $t21) (=> (and (= $abort_flag@1 true) (= $abort_code@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1146650) 1146598) anon27_Then_correct) (=> (= (ControlFlow 0 1146650) 1146384) anon27_Else_correct))))))
(let ((anon26_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (= (ControlFlow 0 1146648) 1146650)) anon26_Then$1_correct)))
(let ((anon26_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816) (=> (and (and (= $t21@0 ($Mutation_592079 ($Global 173345816) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (= $t21@1 $t21@0)) (and (= $abort_flag@1 $abort_flag@0) (= $abort_code@2 $abort_code@1))) (and (=> (= (ControlFlow 0 1146279) 1146598) anon27_Then_correct) (=> (= (ControlFlow 0 1146279) 1146384) anon27_Else_correct))))))
(let ((anon25_Else_correct  (=> (and (not $abort_flag@0) (= $t18@0 ($Mutation_65773 (|l#$Mutation_592036| $t17@1) (let ((l@@0 (|l#Vec_37831| (|p#$Mutation_592036| $t17@1))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_592036| $t17@1)) l@@0 0) (+ l@@0 1))) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|v#$Mutation_592036| $t17@1))))) (=> (and (and (= $t18@1 ($Mutation_65773 (|l#$Mutation_65773| $t18@0) (|p#$Mutation_65773| $t18@0) false)) (= $t17@2 ($Mutation_592036 (|l#$Mutation_592036| $t17@1) (|p#$Mutation_592036| $t17@1) ($1_AccountFreezing_FreezingBit (|v#$Mutation_65773| $t18@1))))) (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) addr@@0)))
 :qid |DiemAccountbpl.33066:20|
 :skolemid |662|
)) (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_590069 (|Store__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_592036| $t17@2)) true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_592036| $t17@2)) (|v#$Mutation_592036| $t17@2)))))) (and (=> (= (ControlFlow 0 1146257) (- 0 1933840)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@0) addr@@1)))
 :qid |DiemAccountbpl.33077:15|
 :skolemid |663|
 ...
 :qid |DiemAccountbpl.33077:15|
 :skolemid |663|
)) (=> (and (and (|$IsValid'address'| $t19) (= $t19 (|$addr#$signer| _$t0))) (and (= $t19 $t19) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 1146257) 1146648) anon26_Then_correct) (=> (= (ControlFlow 0 1146257) 1146279) anon26_Else_correct)))))))))
(let ((anon25_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 1146664) 1146093))) L3_correct)))
(let ((anon24_Then$1_correct  (=> (= $t17@1 $t17) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1146716) 1146664) anon25_Then_correct) (=> (= (ControlFlow 0 1146716) 1146257) anon25_Else_correct))))))
(let ((anon24_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (= (ControlFlow 0 1146714) 1146716)) anon24_Then$1_correct)))
(let ((anon24_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1) (=> (and (and (= $t17@0 ($Mutation_592036 ($Global _$t1) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (= $t17@1 $t17@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1146125) 1146664) anon25_Then_correct) (=> (= (ControlFlow 0 1146125) 1146257) anon25_Else_correct))))))
(let ((anon23_Then_correct  (=> $t13@0 (and (=> (= (ControlFlow 0 1146103) 1146714) anon24_Then_correct) (=> (= (ControlFlow 0 1146103) 1146125) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (and (not $t13@0) (= $t15 $t15)) (and (= $t10@0 $t15) (= (ControlFlow 0 1145837) 1146093))) L3_correct)))
(let ((anon22_Else_correct  (=> (not $t12) (=> (and (= $t13@0 (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t15) (= $t15 5)) (and (= $t15 $t15) (= $t13@0 $t13@0))) (and (=> (= (ControlFlow 0 1145821) 1146103) anon23_Then_correct) (=> (= (ControlFlow 0 1145821) 1145837) anon23_Else_correct)))))))
(let ((anon22_Then_correct  (=> $t12 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t11)) (= 5 $t10)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t11)) 1)) (= 3 $t10))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t10))) (= $t10 $t10)) (and (= $t10@0 $t10) (= (ControlFlow 0 1146788) 1146093))) L3_correct))))
(let ((anon21_Else_correct  (=> (not $t9) (=> (and (= $t11 (|$addr#$signer| _$t0)) (= $t12  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t11)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t11)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))) (and (=> (= (ControlFlow 0 1145779) 1146788) anon22_Then_correct) (=> (= (ControlFlow 0 1145779) 1145821) anon22_Else_correct))))))
(let ((anon21_Then_correct  (=> $t9 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t10)) (= $t10 $t10)) (and (= $t10@0 $t10) (= (ControlFlow 0 1146814) 1146093))) L3_correct))))
...
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@2))
 :qid |DiemAccountbpl.32888:20|
 :skolemid |661|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2))
)) (= $t5 (|$addr#$signer| _$t0))) (and (= $t6 (|$unfreeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (= $t7 ($1_AccountFreezing_UnfreezeAccountEvent (|$addr#$signer| _$t0) _$t1)))) (and (and (= $t8 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t9  (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 1145719) 1146814) anon21_Then_correct) (=> (= (ControlFlow 0 1145719) 1145779) anon21_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1145481) 1145719)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_37831| (|p#$Mutation_592036| $t17)) 0) (=> (and (and (= (|l#Vec_37831| (|p#$Mutation_65773| $t18)) 0) (= (|l#Vec_37831| (|p#$Mutation_592079| $t21)) 0)) (and (= (|l#Vec_37831| (|p#$Mutation_456960| $t22)) 0) (= (ControlFlow 0 1145491) 1145481))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 1933085) 1145491) anon0_correct)))
