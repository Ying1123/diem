...
(assert (not
 (=> (= (ControlFlow 0 0) 225180) (let ((anon18_Else_correct@@0  (=> (not $abort_flag@0@@1) (and (=> (= (ControlFlow 0 165571) (- 0 225846)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 165571) (- 0 225858)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 165571) (- 0 225876)) (not (not (= (|$addr#$signer| _$t0@@3) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@3) 186537453))) (and (=> (= (ControlFlow 0 165571) (- 0 225890)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 165571) (- 0 225898)) (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory@1) (|$addr#$signer| _$t0@@3))))))))))))))
(let ((anon16_Then_correct@@0 true))
(let ((L3_correct@@1  (and (=> (= (ControlFlow 0 165375) (- 0 225728)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0@@3) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0@@3) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 165375) (- 0 225766)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0@@3) 186537453)) (= 2 $t6@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) 186537453) (= 6 $t6@0))))))))
(let ((anon18_Then_correct@@0  (=> (and (and $abort_flag@0@@1 (= $abort_code@1@@1 $abort_code@1@@1)) (and (= $t6@0 $abort_code@1@@1) (= (ControlFlow 0 165585) 165375))) L3_correct@@1)))
(let ((anon17_Then$1_correct  (=> (= $1_DiemId_DiemIdDomainManager_$memory@1 $1_DiemId_DiemIdDomainManager_$memory) (=> (and (= $abort_flag@0@@1 true) (= $abort_code@1@@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 165637) 165585) anon18_Then_correct@@0) (=> (= (ControlFlow 0 165637) 165571) anon18_Else_correct@@0))))))
(let ((anon17_Then_correct@@0  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0@@3)) (= (ControlFlow 0 165635) 165637)) anon17_Then$1_correct)))
(let ((anon17_Else_correct@@0  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0@@3))) (=> (and (and (= $1_DiemId_DiemIdDomainManager_$memory@0 ($Memory_134529 (|Store__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0@@3) true) (|Store__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0@@3) $t13@0@@0))) (= $1_DiemId_DiemIdDomainManager_$memory@1 $1_DiemId_DiemIdDomainManager_$memory@0)) (and (= $abort_flag@0@@1 false) (= $abort_code@1@@1 $abort_code@0@@1))) (and (=> (= (ControlFlow 0 165499) 165585) anon18_Then_correct@@0) (=> (= (ControlFlow 0 165499) 165571) anon18_Else_correct@@0))))))
(let ((anon16_Else_correct@@0  (=> (and (not false) (= $t13@0@@0 ($1_DiemId_DiemIdDomainManager |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 165477) (- 0 225623)) (|Select__T@[Int]Bool_| $1_DiemId_DiemIdDomainManager_$modifies (|$addr#$signer| _$t0@@3))) (=> (|Select__T@[Int]Bool_| $1_DiemId_DiemIdDomainManager_$modifies (|$addr#$signer| _$t0@@3)) (and (=> (= (ControlFlow 0 165477) 165635) anon17_Then_correct@@0) (=> (= (ControlFlow 0 165477) 165499) anon17_Else_correct@@0)))))))
(let ((|inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 165447) 165651) anon16_Then_correct@@0) (=> (= (ControlFlow 0 165447) 165477) anon16_Else_correct@@0)))))
(let ((anon15_Then_correct@@0  (=> (and inline$$Not$0$dst@1@@0 (= (ControlFlow 0 165453) 165447)) |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|)))
(let ((anon15_Else_correct@@0  (=> (and (and (not inline$$Not$0$dst@1@@0) (= $t11@@1 $t11@@1)) (and (= $t6@0 $t11@@1) (= (ControlFlow 0 165251) 165375))) L3_correct@@1)))
(let ((anon14_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t11@@1) (= $t11@@1 6)) (and (= $t11@@1 $t11@@1) (= inline$$Not$0$dst@1@@0 inline$$Not$0$dst@1@@0))) (and (=> (= (ControlFlow 0 165235) 165453) anon15_Then_correct@@0) (=> (= (ControlFlow 0 165235) 165251) anon15_Else_correct@@0))))))
(let ((inline$$Not$0$anon0_correct@@0  (=> (and (= inline$$Not$0$dst@1@@0  (not $t8@0)) (= (ControlFlow 0 165195) 165235)) anon14_Else$1_correct)))
(let ((anon14_Else_correct@@0  (=> (not $t5) (=> (and (and (|$IsValid'address'| $t7) (= $t7 (|$addr#$signer| _$t0@@3))) (and (= $t8@0 (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) $t7)) (= (ControlFlow 0 165201) 165195))) inline$$Not$0$anon0_correct@@0))))
(let ((anon14_Then_correct@@0  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6@@0))) (and (not (= (|$addr#$signer| _$t0@@3) 186537453)) (= 2 $t6@@0))) (= $t6@@0 $t6@@0)) (and (= $t6@0 $t6@@0) (= (ControlFlow 0 165723) 165375))) L3_correct@@1))))
(let ((anon0$1_correct@@4  (=> (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@3)) (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $a_0@@5)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@5))
 :qid |DiemIdbpl.13146:20|
 :skolemid |230|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $a_0@@5))
))) (and (forall (($a_0@@6 Int) ) (! (let (($rsc@@6 (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) $a_0@@6)))
(|$IsValid'$1_DiemId_DiemIdDomainManager'| $rsc@@6))
 :qid |DiemIdbpl.13150:20|
 :skolemid |231|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) $a_0@@6))
)) (= $t3 (|$addr#$signer| _$t0@@3)))) (and (and (|Select__T@[Int]Bool_| $1_DiemId_DiemIdDomainManager_$modifies (|$addr#$signer| _$t0@@3)) (= _$t0@@3 _$t0@@3)) (and (= $t4 (|$addr#$signer| _$t0@@3)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0@@3) 186537453))))))) (and (=> (= (ControlFlow 0 165139) 165723) anon14_Then_correct@@0) (=> (= (ControlFlow 0 165139) 165201) anon14_Else_correct@@0)))))
(let ((inline$$InitEventStore$0$anon0_correct@@4  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@9 T@$1_Event_EventHandle) ) (! (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_69963_| (|streams#$EventStore| $es) handle@@9)))
 (and (= (|l#Multiset_69963| stream@@9) 0) (forall ((v@@46 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_69963| stream@@9) v@@46) 0)
 :qid |DiemIdbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemIdbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 164991) 165139)) anon0$1_correct@@4)))
(let ((anon0_correct@@4  (=> (= (ControlFlow 0 225180) 164991) inline$$InitEventStore$0$anon0_correct@@4)))
anon0_correct@@4)))))))))))))))))))
))
(check-sat)
(pop 1)
