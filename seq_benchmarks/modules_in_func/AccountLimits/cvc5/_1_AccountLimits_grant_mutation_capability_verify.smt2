...
(assert (not
 (=> (= (ControlFlow 0 0) 398709) (let ((L2_correct@@6  (and (=> (= (ControlFlow 0 291097) (- 0 399282)) (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_139986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) $t1@@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) $t1@@0)) 0))) (not (= (|$addr#$signer| _$t0@@13) 173345816)))) (=> (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_139986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) $t1@@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) $t1@@0)) 0))) (not (= (|$addr#$signer| _$t0@@13) 173345816))) (=> (= (ControlFlow 0 291097) (- 0 399322)) (or (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_139986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t3@@6)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) $t1@@0)) (= 5 $t3@@6))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) $t1@@0)) 0)) (= 3 $t3@@6))) (and (not (= (|$addr#$signer| _$t0@@13) 173345816)) (= 2 $t3@@6))))))))
(let ((anon7_Then_correct  (=> (and (and $t5@@7 (or (or (or (and (not (= (|$addr#$signer| _$t0@@13) 173345816)) (= 2 $t3@@6)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) $t4@@6)) (= 5 $t3@@6))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) $t4@@6)) 0)) (= 3 $t3@@6))) (and (not (= (|$addr#$signer| _$t0@@13) 173345816)) (= 2 $t3@@6)))) (and (= $t3@@6 $t3@@6) (= (ControlFlow 0 290969) 291097))) L2_correct@@6)))
(let ((anon6_Then_correct  (=> $t2@@6 (=> (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_139986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t3@@6)) (and (= $t3@@6 $t3@@6) (= (ControlFlow 0 291123) 291097))) L2_correct@@6))))
(let ((anon7_Else_correct  (=> (not $t5@@7) (=> (and (= $t7@0 ($1_AccountLimits_AccountLimitMutationCapability false)) (= $t7@0 $t7@0)) (and (=> (= (ControlFlow 0 290877) (- 0 399226)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_139986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_139986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 290877) (- 0 399236)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) $t1@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) $t1@@0))) (and (=> (= (ControlFlow 0 290877) (- 0 399248)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) $t1@@0)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) $t1@@0)) 0))) (=> (= (ControlFlow 0 290877) (- 0 399266)) (not (not (= (|$addr#$signer| _$t0@@13) 173345816))))))))))))))
(let ((anon6_Else_correct  (=> (not $t2@@6) (=> (and (= $t4@@6 (|$addr#$signer| _$t0@@13)) (= $t5@@7  (or (or (or (not (= (|$addr#$signer| _$t0@@13) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) $t4@@6))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) $t4@@6)) 0))) (not (= (|$addr#$signer| _$t0@@13) 173345816))))) (and (=> (= (ControlFlow 0 290795) 290969) anon7_Then_correct) (=> (= (ControlFlow 0 290795) 290877) anon7_Else_correct))))))
(let ((anon0$1_correct@@13  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_139986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (and (and (and (forall ((addr@@86 Int) ) (!  (=> (|$IsValid'address'| addr@@86) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142572| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@86) (and (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) addr@@86) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@86)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@86)) 6)))))
 :qid |AccountLimitsbpl.13839:22|
 :skolemid |250|
)) (forall ((addr@@87 Int) ) (!  (=> (|$IsValid'address'| addr@@87) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142703| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@87) (and (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) addr@@87) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@87)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@87)) 6)))))
 :qid |AccountLimitsbpl.13839:388|
 :skolemid |251|
))) (forall ((addr@@88 Int) ) (!  (=> (|$IsValid'address'| addr@@88) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) addr@@88) (and (|Select__T@[Int]Bool_| (|domain#$Memory_140524| $1_Roles_RoleId_$memory) addr@@88) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@88)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) addr@@88)) 6)))))
 :qid |AccountLimitsbpl.13839:755|
 :skolemid |252|
))) (and (|$IsValid'address'| (|$addr#$signer| _$t0@@13)) (forall (($a_0@@21 Int) ) (! (let (($rsc@@21 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_139986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@21)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@21))
 :qid |AccountLimitsbpl.13845:20|
 :skolemid |253|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_139986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@21))
)))) (and (and (forall (($a_0@@22 Int) ) (! (let (($rsc@@22 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) $a_0@@22)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@22))
 :qid |AccountLimitsbpl.13849:20|
 :skolemid |254|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_140524| $1_Roles_RoleId_$memory) $a_0@@22))
)) (= $t1@@0 (|$addr#$signer| _$t0@@13))) (and (= _$t0@@13 _$t0@@13) (= $t2@@6  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_139986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 290723) 291123) anon6_Then_correct) (=> (= (ControlFlow 0 290723) 290795) anon6_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@13  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@15 T@$1_Event_EventHandle) ) (! (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_111298_| (|streams#$EventStore| $es) handle@@15)))
 (and (= (|l#Multiset_111298| stream@@14) 0) (forall ((v@@49 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_111298| stream@@14) v@@49) 0)
 :qid |AccountLimitsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountLimitsbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 290458) 290723)) anon0$1_correct@@13)))
(let ((anon0_correct@@13  (=> (= (ControlFlow 0 398709) 290458) inline$$InitEventStore$0$anon0_correct@@13)))
anon0_correct@@13)))))))))
))
(check-sat)
(pop 1)
