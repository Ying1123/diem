...
(declare-fun $t9 () T@$Mutation_119553)
(declare-fun $t9@0 () T@$Mutation_119553)
...
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@1)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc@@1))
 :qid |AccountLimitsbpl.12280:20|
 :skolemid |340|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@1))
))) (and (|Select__T@[Int]Bool_| |$1_AccountLimits_Window'#0'_$modifies| _$t1) (= _$t0 _$t0)))) (and (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= $t5@0 (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) _$t1)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t7) (= $t7 5)) (and (= $t7 $t7) (= $t5@0 $t5@0)))))) (and (=> (= (ControlFlow 0 229589) 230001) anon12_Then_correct) (=> (= (ControlFlow 0 229589) 229605) anon12_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 229009) 229589)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (seq.len (|p#$Mutation_119553| $t9)) 0) (= (ControlFlow 0 229019) 229009)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 282357) 229019) anon0_correct)))
