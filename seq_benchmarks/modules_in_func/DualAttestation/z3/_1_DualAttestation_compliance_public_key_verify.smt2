...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 316896) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t8@0 (|$compliance_public_key#$1_DualAttestation_Credential| $t7@1)) (= $t8@0 $t8@0)) (and (=> (= (ControlFlow 0 236198) (- 0 317220)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) _$t0))) (and (=> (= (ControlFlow 0 236198) (- 0 317231)) (= $t8@0 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) _$t0)))) (=> (= $t8@0 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) _$t0))) (and (=> (= (ControlFlow 0 236198) (- 0 317242)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1) (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1)))
 :qid |DualAttestationbpl.15152:15|
 :skolemid |318|
 ...
 :qid |DualAttestationbpl.15152:15|
 :skolemid |318|
)) (and (=> (= (ControlFlow 0 236198) (- 0 317267)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1))))
 :qid |DualAttestationbpl.15157:15|
 :skolemid |319|
 ...
 :qid |DualAttestationbpl.15167:15|
 :skolemid |320|
)) (=> (= (ControlFlow 0 236198) (- 0 317349)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5) (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)))))
 :qid |DualAttestationbpl.15172:15|
 :skolemid |321|
)))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 235988) (- 0 317173)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) _$t0)) (=> (= (ControlFlow 0 235988) (- 0 317179)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) _$t0)) (= 5 $t6@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 236212) 235988))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 236264) 236212) anon12_Then_correct) (=> (= (ControlFlow 0 236264) 236198) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) _$t0)) (= (ControlFlow 0 236262) 236264)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 236006) 236212) anon12_Then_correct) (=> (= (ControlFlow 0 236006) 236198) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t3@0 (and (=> (= (ControlFlow 0 235992) 236262) anon11_Then_correct) (=> (= (ControlFlow 0 235992) 236006) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t3@0) (= $t5 $t5)) (and (= $t6@0 $t5) (= (ControlFlow 0 235956) 235988))) L3_correct)))
(let ((anon0$1_correct  (=> (and (forall ((addr1@@6 Int) ) (!  (=> (|$IsValid'address'| addr1@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@6) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@6)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@6)) 2)))))
 :qid |DualAttestationbpl.15049:20|
 :skolemid |316|
)) (|$IsValid'address'| _$t0)) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) $a_0)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc))
 :qid |DualAttestationbpl.15056:20|
 :skolemid |317|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) _$t0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 235940) 235992) anon10_Then_correct) (=> (= (ControlFlow 0 235940) 235956) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2787:13|
 :skolemid |79|
))) (= (ControlFlow 0 235819) 235940)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 316896) 235819) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
