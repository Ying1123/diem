...
(let ((expected (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| $EmptyEventStore) $t13)))
(let ((stream_new (let ((len (|l#Multiset_71640| stream@@1)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_71640| stream@@1) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t14))))
(Multiset_71640 (|Store__T@[$EventRep]Int_| (|v#Multiset_71640| stream@@1) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t14) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| $EmptyEventStore) $t13 stream_new))))))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@2 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| expected) handle@@2)) (|l#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| actual) handle@@2))) (forall ((v@@49 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| expected) handle@@2)) v@@49) (|Select__T@[$EventRep]Int_| (|v#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| actual) handle@@2)) v@@49))
...
(let ((expected@@0 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| $EmptyEventStore) $t13)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_71640| stream@@2)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_71640| stream@@2) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t14))))
(Multiset_71640 (|Store__T@[$EventRep]Int_| (|v#Multiset_71640| stream@@2) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t14) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| $EmptyEventStore) $t13 stream_new@@0))))))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@3 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| expected@@0) handle@@3)) (|l#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| actual@@0) handle@@3))) (forall ((v@@50 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| expected@@0) handle@@3)) v@@50) (|Select__T@[$EventRep]Int_| (|v#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| actual@@0) handle@@3)) v@@50))
 :qid |DiemIdbpl.164:13|
 :skolemid |5|
)))
 :qid |DiemIdbpl.2780:13|
...
(let ((expected@@1 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| $EmptyEventStore) $t13)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_71640| stream@@3)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_71640| stream@@3) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t14))))
(Multiset_71640 (|Store__T@[$EventRep]Int_| (|v#Multiset_71640| stream@@3) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t14) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| $EmptyEventStore) $t13 stream_new@@1))))))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@4 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| actual@@1) handle@@4)) (|l#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| expected@@1) handle@@4))) (forall ((v@@51 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| actual@@1) handle@@4)) v@@51) (|Select__T@[$EventRep]Int_| (|v#Multiset_71640| (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| expected@@1) handle@@4)) v@@51))
 :qid |DiemIdbpl.164:13|
 :skolemid |5|
)))
 :qid |DiemIdbpl.2780:13|
...
(let ((|inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$handle@1| (|v#$Mutation_102556| $t34@0)) (= $es@0 (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_71640| stream@@4)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_71640| stream@@4) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t36@0))))
(Multiset_71640 (|Store__T@[$EventRep]Int_| (|v#Multiset_71640| stream@@4) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t36@0) (+ cnt@@2 1)) (+ len@@2 1))))))
...
(let ((anon0$1_correct@@0  (=> (|$IsValid'address'| (|$addr#$signer| _$t0)) (=> (and (|$IsValid'address'| _$t1) (|$IsValid'vec'u8''| _$t2)) (=> (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $a_0@@0)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |DiemIdbpl.12202:20|
 :skolemid |229|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $a_0@@0))
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) $a_0@@1)))
(|$IsValid'$1_DiemId_DiemIdDomainManager'| $rsc@@1))
 :qid |DiemIdbpl.12206:20|
 :skolemid |230|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) $a_0@@1))
))) (and (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) $a_0@@2)))
 (and (|$IsValid'$1_DiemId_DiemIdDomains'| $rsc@@2) (and (and (let (($range_1 ($Range 0 (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@2)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@111 $i_2))
(<= (|l#Vec_21250| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@2)) i@@111))) 63)))
 :qid |DiemIdbpl.12211:136|
 :skolemid |231|
))) (let (($range_3 ($Range 0 (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@2)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@112 $i_4))
(let (($range_5 ($Range (+ i@@112 1) (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@2)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@34 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@2)) i@@112)) (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@2)) j@@34))))))
...
(<= (|l#Vec_21250| (|$domain#$1_DiemId_DiemIdDomain| $elem@@3)) 63)))
 ...
 :skolemid |235|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) $a_0@@2))
...
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@5 T@$1_Event_EventHandle) ) (! (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| $es) handle@@5)))
 (and (= (|l#Multiset_71640| stream@@5) 0) (forall ((v@@52 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_71640| stream@@5) v@@52) 0)
 :qid |DiemIdbpl.159:13|
 :skolemid |4|
))))
 :qid |DiemIdbpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 171134) 171522)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (and (= (|l#Vec_21250| (|p#$Mutation_145274| $t9)) 0) (= (|l#Vec_21250| (|p#$Mutation_145274| $t24)) 0)) (=> (and (and (= (|l#Vec_21250| (|p#$Mutation_82213| $t31)) 0) (= (|l#Vec_21250| (|p#$Mutation_145339| $t33)) 0)) (and (= (|l#Vec_21250| (|p#$Mutation_102556| $t34)) 0) (= (ControlFlow 0 171144) 171134))) inline$$InitEventStore$0$anon0_correct@@0))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 237428) 171144) anon0_correct@@0)))
