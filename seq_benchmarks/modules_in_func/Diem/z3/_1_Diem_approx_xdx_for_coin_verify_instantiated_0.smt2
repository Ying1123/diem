...
(assert (not
 ...
 :qid |Diembpl.10176:15|
 :skolemid |371|
)) (and (=> (= (ControlFlow 0 697886) (- 0 1060914)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@2)))
 ...
 :qid |Diembpl.10181:15|
 :skolemid |372|
)) (and (=> (= (ControlFlow 0 697886) (- 0 1060939)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 697886) (- 0 1060960)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@4))))
 ...
 :qid |Diembpl.10191:15|
 :skolemid |373|
)) (and (=> (= (ControlFlow 0 697886) (- 0 1060989)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_307728| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@6)))
 ...
 :qid |Diembpl.10211:15|
 :skolemid |375|
)) (and (=> (= (ControlFlow 0 697886) (- 0 1061092)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307989| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_307989| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@10)))
...
(let ((anon6_Else_correct  (=> (and (and (not false) (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1|)) (and (= $t4 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $t6  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4) 1) |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4) 2) (div |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| 2) (+ 18446744073709551615 1)))) 18446744073709551615))))) (and (=> (= (ControlFlow 0 697576) 697932) anon7_Then_correct) (=> (= (ControlFlow 0 697576) 697886) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((|inline$$1_Diem_value'$1_XUS_XUS'$0$anon0_correct|  (=> (= _$t0 _$t0) (=> (and (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| (|$value#$1_Diem_Diem'$1_XUS_XUS'| _$t0)) (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1|)) (and (=> (= (ControlFlow 0 697520) 697952) anon6_Then_correct) (=> (= (ControlFlow 0 697520) 697576) anon6_Else_correct))))))
(let ((anon0$1_correct  (=> (and (and (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307469| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 ...
 :skolemid |369|
))) (and (and (|$IsValid'$1_Diem_Diem'$1_XUS_XUS''| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_325899| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0)))
...
))) (and (= _$t0 _$t0) (= (ControlFlow 0 697526) 697520))))) |inline$$1_Diem_value'$1_XUS_XUS'$0$anon0_correct|)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 697148) 697526)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1060359) 697148) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))
))
(check-sat)
(pop 1)
