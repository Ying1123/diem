...
(declare-fun $t6@0@@0 () (Seq T@$1_DiemSystem_ValidatorInfo))
(declare-fun $t7@@24 () Bool)
(declare-fun _$t0@@28 () Int)
(declare-fun $t5@@19 () Int)
(push 1)
(set-info :boogie-vc-id $1_DiemSystem_is_validator$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 877034) (let ((anon4_Else_correct@@0  (=> (not $t4@@8) (=> (and (and (and (|$IsValid'$1_DiemSystem_DiemSystem'| $t3) (let (($range_0@@64 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| $t3)))))
(let (($range_1@@12 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| $t3)))))
(forall (($i_2@@7 Int) ($i_3@@12 Int) ) (!  (=> ($InRange $range_0@@64 $i_2@@7) (=> ($InRange $range_1@@12 $i_3@@12) (let ((i@@91 $i_2@@7))
(let ((j@@33 $i_3@@12))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| $t3) i@@91)) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| $t3) j@@33))) (= i@@91 j@@33))))))
 :qid |DiemSystembpl.21258:222|
 :skolemid |672|
))))) (= $t3 (let ((addr@@537 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@537))))) (and (and (= $t3 $t3) (= $t6@0@@0 (|$validators#$1_DiemSystem_DiemSystem| $t3))) (and (= $t7@@24 (let (($range_0@@65 $t6@0@@0))
(exists (($i_1@@56 Int) ) (!  (and (and (>= $i_1@@56 0) (< $i_1@@56 (seq.len $range_0@@65))) (let ((v@@110 (seq.nth $range_0@@65 $i_1@@56)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@110) _$t0@@28)))
 :qid |DiemSystembpl.21279:62|
 :skolemid |673|
)))) (= $t7@@24 $t7@@24)))) (and (=> (= (ControlFlow 0 551034) (- 0 877596)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 551034) (- 0 877608)) (= $t7@@24 (let (($range_0@@66 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@538 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@538))))))
(exists (($i_1@@57 Int) ) (!  (and (and (>= $i_1@@57 0) (< $i_1@@57 (seq.len $range_0@@66))) (let ((v@@111 (seq.nth $range_0@@66 $i_1@@57)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@111) _$t0@@28)))
 :qid |DiemSystembpl.18014:125|
 :skolemid |543|
))))) (=> (= $t7@@24 (let (($range_0@@67 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@539 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@539))))))
(exists (($i_1@@58 Int) ) (!  (and (and (>= $i_1@@58 0) (< $i_1@@58 (seq.len $range_0@@67))) (let ((v@@112 (seq.nth $range_0@@67 $i_1@@58)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@112) _$t0@@28)))
 :qid |DiemSystembpl.18014:125|
 :skolemid |543|
)))) (=> (= (ControlFlow 0 551034) (- 0 877620)) (= (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@540 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@540)))) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@541 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@541))))))))))))))
(let ((anon4_Then_correct@@0  (=> $t4@@8 (=> (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t5@@19)) (= $t5@@19 $t5@@19)) (and (=> (= (ControlFlow 0 551092) (- 0 877402)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (=> (= (ControlFlow 0 551092) (- 0 877409)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t5@@19)))))))))
(let ((anon0$1_correct@@29  (=> (and (forall ((config_address@@68 Int) ) (!  (=> (|$IsValid'address'| config_address@@68) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address@@68) (= config_address@@68 173345816)))
 :qid |DiemSystembpl.21192:20|
 :skolemid |666|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_239008| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_240125| $1_DiemSystem_CapabilityHolder_$memory) 173345816)))) (=> (and (and (and (forall ((addr@@542 Int) ) (!  (=> (|$IsValid'address'| addr@@542) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@542) (= addr@@542 173345816)))
 :qid |DiemSystembpl.21200:20|
 :skolemid |667|
)) (let (($range_0@@68 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@543 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@543))))))))
(forall (($i_1@@59 Int) ) (!  (=> ($InRange $range_0@@68 $i_1@@59) (let ((i1@@19 $i_1@@59))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@544 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@544)))) i1@@19))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@544 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@544)))) i1@@19)))) 3))))
 :qid |DiemSystembpl.21204:151|
 :skolemid |668|
)))) (and (let (($range_0@@69 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@545 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@545))))))))
(forall (($i_1@@60 Int) ) (!  (=> ($InRange $range_0@@69 $i_1@@60) (let ((i1@@20 $i_1@@60))
(= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@546 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@546)))) i1@@20)) 1)))
 :qid |DiemSystembpl.21209:151|
 :skolemid |669|
))) (|$IsValid'address'| _$t0@@28))) (and (and (forall (($a_0@@90 Int) ) (! (let (($rsc@@90 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@90)))
 (and (|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem''| $rsc@@90) (let (($range_1@@13 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@90))))))
(let (($range_2@@4 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@90))))))
(forall (($i_3@@13 Int) ($i_4@@4 Int) ) (!  (=> ($InRange $range_1@@13 $i_3@@13) (=> ($InRange $range_2@@4 $i_4@@4) (let ((i@@92 $i_3@@13))
(let ((j@@34 $i_4@@4))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@90)) i@@92)) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@90)) j@@34))) (= i@@92 j@@34))))))
 :qid |DiemSystembpl.21218:367|
 :skolemid |670|
))))))
 :qid |DiemSystembpl.21217:20|
 :skolemid |671|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@90))
)) (= _$t0@@28 _$t0@@28)) (and (= _$t0@@28 _$t0@@28) (= $t4@@8  (not (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 550838) 551092) anon4_Then_correct@@0) (=> (= (ControlFlow 0 550838) 551034) anon4_Else_correct@@0))))))
(let ((inline$$InitEventStore$0$anon0_correct@@29  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@49 T@$1_Event_EventHandle) ) (! (let ((stream@@59 (|Select__T@[$1_Event_EventHandle]Multiset_200533_| (|streams#$EventStore| $es) handle@@49)))
 (and (= (|l#Multiset_200533| stream@@59) 0) (forall ((v@@113 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_200533| stream@@59) v@@113) 0)
 :qid |DiemSystembpl.134:13|
 :skolemid |2|
))))
 :qid |DiemSystembpl.3452:13|
 :skolemid |94|
))) (= (ControlFlow 0 550529) 550838)) anon0$1_correct@@29)))
(let ((anon0_correct@@29  (=> (= (ControlFlow 0 877034) 550529) inline$$InitEventStore$0$anon0_correct@@29)))
anon0_correct@@29))))))
))
(check-sat)
(pop 1)
