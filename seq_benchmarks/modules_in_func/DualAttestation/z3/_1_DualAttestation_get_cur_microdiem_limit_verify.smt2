...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 293985) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t9@0 (|$micro_xdx_limit#$1_DualAttestation_Limit| $t8@1)) (= $t9@0 $t9@0)) (and (=> (= (ControlFlow 0 219011) (- 0 294284)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816))) (=> (= (ControlFlow 0 219011) (- 0 294294)) (= $t9@0 (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 218945) (- 0 294239)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (=> (= (ControlFlow 0 218945) (- 0 294244)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (= 5 $t6@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 219025) 218945))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $t8@1 $t8) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 219077) 219025) anon12_Then_correct) (=> (= (ControlFlow 0 219077) 219011) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (= (ControlFlow 0 219075) 219077)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816) (=> (and (and (= $t8@0 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (= $t8@1 $t8@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 218969) 219025) anon12_Then_correct) (=> (= (ControlFlow 0 218969) 219011) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> (and $t3@0 (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 218955) 219075) anon11_Then_correct) (=> (= (ControlFlow 0 218955) 218969) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t3@0) (= $t5 $t5)) (and (= $t6@0 $t5) (= (ControlFlow 0 218917) 218945))) L3_correct)))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) $a_0)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc))
 :qid |DualAttestationbpl.15154:20|
 :skolemid |320|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) $a_0))
)) (|$IsValid'address'| 173345816)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 218901) 218955) anon10_Then_correct) (=> (= (ControlFlow 0 218901) 218917) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2431:13|
 :skolemid |69|
))) (= (ControlFlow 0 218807) 218901)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 293985) 218807) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
