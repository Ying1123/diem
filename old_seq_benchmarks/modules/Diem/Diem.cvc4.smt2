...
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@5) i@@46)))) 0)))
 :qid |Diemcvc4bpl.6474:199|
 :skolemid |199|
))))))
 :qid |Diemcvc4bpl.6473:20|
 :skolemid |200|
