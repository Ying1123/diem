...
(declare-fun $t20 () T@$Mutation_490297)
(declare-fun $t15 () Int)
...
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_490297| $t20@1)) l 1) (+ l 1))) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@1))))) (and (= $t21@1 ($Mutation_490338 (|l#$Mutation_490338| $t21@0) (|p#$Mutation_490338| $t21@0) $t19)) (= $t20@2 ($Mutation_490297 (|l#$Mutation_490297| $t20@1) (|p#$Mutation_490297| $t20@1) ($1_ValidatorConfig_ValidatorConfig (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@1)) (|v#$Mutation_490338| $t21@1) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@1))))))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899459)) (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@2)))) 1)) (=> (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@2)))) 1) (and (=> (= (ControlFlow 0 1105547) (- 0 1899472)) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@2)))) 1)) (=> (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_490297| $t20@2)))) 1) (=> (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0)) 3))))
 ...
 :qid |DiemAccountbpl.11682:15|
 :skolemid |287|
)) (and (=> (= (ControlFlow 0 1105547) (- 0 1899561)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t7)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t7))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899573)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t7)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t7)) 3))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899591)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899602)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899613)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899625)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) 3))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899643)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t8))) (and (=> (= (ControlFlow 0 1105547) (- 0 1899655)) (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0) $t9)))) 0))) (=> (not (= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0) $t9)))) 0)) (and (=> (= (ControlFlow 0 1105547) (- 0 1899663)) (= (let ((t_ref (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0) $t9)))
(|Select__T@[Int]Int_| (|v#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref))) 0)) _$t1)) (=> (= (let ((t_ref@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0) $t9)))
(|Select__T@[Int]Int_| (|v#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0))) 0)) _$t1) (=> (= (ControlFlow 0 1105547) (- 0 1899674)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (= addr@@3 $t9)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@3))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@3))))))
 :qid |DiemAccountbpl.11736:15|
 :skolemid |288|
)))))))))))))))))))))))))))))))
(let ((anon22_Then_correct true))
(let ((L5_correct  (and (=> (= (ControlFlow 0 1105027) (- 0 1899213)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t7)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t7)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t8)))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t7)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t7)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t8))) (=> (= (ControlFlow 0 1105027) (- 0 1899284)) (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t7)) (= 5 $t11@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t7)) 3)) (= 3 $t11@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1)) (= 7 $t11@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1)) (= 5 $t11@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) (= 5 $t11@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8)) 3)) (= 3 $t11@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t8)) (= 5 $t11@0))))))))
(let ((anon25_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t11@0 $abort_code@1) (= (ControlFlow 0 1105561) 1105027))) L5_correct)))
(let ((anon24_Then$1_correct  (=> (= $t20@1 $t20) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1105613) 1105561) anon25_Then_correct) (=> (= (ControlFlow 0 1105613) 1105547) anon25_Else_correct))))))
(let ((anon24_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t15)) (= (ControlFlow 0 1105611) 1105613)) anon24_Then$1_correct)))
(let ((anon24_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t15) (=> (and (and (= $t20@0 ($Mutation_490297 ($Global $t15) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t15))) (= $t20@1 $t20@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1105256) 1105561) anon25_Then_correct) (=> (= (ControlFlow 0 1105256) 1105547) anon25_Else_correct))))))
(let ((anon23_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (=> (and (and (|$IsValid'$1_Option_Option'address''| $t19) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| $t19)) 1)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| $t19) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_37831 (|Store__T@[Int]Int_| (MapConstVec_16957 DefaultVecElem_16957) 0 _$t1) 1))))) (and (=> (= (ControlFlow 0 1105234) 1105611) anon24_Then_correct) (=> (= (ControlFlow 0 1105234) 1105256) anon24_Else_correct))))))
(let ((anon23_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= $t18 $t18)) (and (= $t11@0 $t18) (= (ControlFlow 0 1105206) 1105027))) L5_correct)))
(let ((anon22_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t18) (= $t18 5)) (and (= $t18 $t18) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 1105190) 1105234) anon23_Then_correct) (=> (= (ControlFlow 0 1105190) 1105206) anon23_Else_correct))))))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= $t15 $t15) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t15)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 1105148) 1105627) anon22_Then_correct) (=> (= (ControlFlow 0 1105148) 1105190) anon22_Else_correct))))))
(let ((anon21_Then_correct  (=> inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 (=> (and (and (|$IsValid'address'| $t15) (= $t15 (|$addr#$signer| _$t0))) (and (= $t15 $t15) (= (ControlFlow 0 1105154) 1105148))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct))))
(let ((anon21_Else_correct  (=> (and (and (not inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1) (= $t14 $t14)) (and (= $t11@0 $t14) (= (ControlFlow 0 1104803) 1105027))) L5_correct)))
(let ((anon20_Else_correct  (=> (and (not false) (|$IsValid'u64'| 3)) (=> (and (and (|$IsValid'u64'| $t14) (= $t14 7)) (and (= $t14 $t14) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1))) (and (=> (= (ControlFlow 0 1104787) 1105154) anon21_Then_correct) (=> (= (ControlFlow 0 1104787) 1104803) anon21_Else_correct))))))
(let ((anon19_Then_correct  (=> $t10 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (= 5 $t11)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3)) (= 3 $t11))) (= $t11 $t11)) (and (= $t11@0 $t11) (= (ControlFlow 0 1105697) 1105027))) L5_correct))))
(let ((anon20_Then_correct true))
(let ((inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct  (=> (= _$t1 _$t1) (=> (and (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t1)) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1)) (and (=> (= (ControlFlow 0 1104741) 1105641) anon20_Then_correct) (=> (= (ControlFlow 0 1104741) 1104787) anon20_Else_correct))))))
(let ((anon19_Else_correct  (=> (and (not $t10) (= (ControlFlow 0 1104747) 1104741)) inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct)))
(let ((anon0$1_correct  (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@4)) 4))))
 ...
 :skolemid |282|
)) (|$IsValid'address'| (|$addr#$signer| _$t0))) (and (|$IsValid'address'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemAccountbpl.11427:20|
 :skolemid |283|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0))
)))) (=> (and (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0@@0)))
(|$IsValid'$1_ValidatorOperatorConfig_ValidatorOperatorConfig'| $rsc@@0))
 :qid |DiemAccountbpl.11431:20|
 :skolemid |284|
 :pattern ( (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0@@0))
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1)))
...
))) (and (= $t7 (|$addr#$signer| _$t0)) (= $t8 (|$addr#$signer| _$t0)))) (and (and (= $t9 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t10  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3))))))) (and (=> (= (ControlFlow 0 1104636) 1105697) anon19_Then_correct) (=> (= (ControlFlow 0 1104636) 1104747) anon19_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1104344) 1104636)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_37831| (|p#$Mutation_490297| $t20)) 0) (=> (and (= (|l#Vec_37831| (|p#$Mutation_490338| $t21)) 0) (= (ControlFlow 0 1104354) 1104344)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 1898394) 1104354) anon0_correct)))
