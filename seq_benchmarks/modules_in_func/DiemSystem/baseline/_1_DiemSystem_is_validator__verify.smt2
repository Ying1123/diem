...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 312732) (let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (|$IsValid'vec'$1_DiemSystem_ValidatorInfo''| _$t1) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t3 (|l#Vec_87979| _$t1)))) (=> (and (and (and (|$IsValid'$1_Option_Option'u64''| $t4) (<= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t4)) 1)) (=> (let (($range_0 ($Range 0 $t3)))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@90 $i_1))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t1) i@@90)) _$t0))))
 :qid |DiemSystembpl.9902:54|
 :skolemid |308|
))) (= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t4)) 0))) (and (and (=> (let (($range_0@@0 ($Range 0 $t3)))
(exists (($i_1@@0 Int) ) (!  (and ($InRange $range_0@@0 $i_1@@0) (let ((i@@91 $i_1@@0))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t1) i@@91)) _$t0)))
 :qid |DiemSystembpl.9906:54|
 :skolemid |309|
))) (and (not (= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t4)) 0)) (let ((at (|Select__T@[Int]Int_| (|v#Vec_28829| (|$vec#$1_Option_Option'u64'| $t4)) 0)))
 (and (and (<= 0 at) (< at $t3)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t1) at)) _$t0))))) (= $t4 $t4)) (and (= $t5  (not (= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t4)) 0))) (= $t5 $t5)))) (and (=> (= (ControlFlow 0 231636) (- 0 312972)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 231636) (- 0 312979)) (= $t5 (let (($range_0@@1 _$t1))
(exists (($i_1@@1 Int) ) (!  (and (InRangeVec_78413 $range_0@@1 $i_1@@1) (let ((v@@46 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $range_0@@1) $i_1@@1)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@46) _$t0)))
 :qid |DiemSystembpl.9942:57|
 :skolemid |310|
))))) (=> (= $t5 (let (($range_0@@2 _$t1))
(exists (($i_1@@2 Int) ) (!  (and (InRangeVec_78413 $range_0@@2 $i_1@@2) (let ((v@@47 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $range_0@@2) $i_1@@2)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@47) _$t0)))
 :qid |DiemSystembpl.9942:57|
 :skolemid |310|
)))) (=> (= (ControlFlow 0 231636) (- 0 313015)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_87682_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_87682| stream@@0) 0) (forall ((v@@48 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_87682| stream@@0) v@@48) 0)
 :qid |DiemSystembpl.159:13|
 :skolemid |4|
))))
 :qid |DiemSystembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 231365) 231636)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 312732) 231365) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
