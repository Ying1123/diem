...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 238635) (let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 205069) (- 0 238949))) (|Select__T@[Int]Bool_| (|domain#$Memory_141367| $1_NetworkIdentity_NetworkIdentity_$memory@1) $t3))))
(let ((anon14_Then_correct true))
(let ((anon13_Then$1_correct  (=> (= $1_NetworkIdentity_NetworkIdentity_$memory@1 $1_NetworkIdentity_NetworkIdentity_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 205141) 205083) anon14_Then_correct) (=> (= (ControlFlow 0 205141) 205069) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_141367| $1_NetworkIdentity_NetworkIdentity_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 205139) 205141)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_141367| $1_NetworkIdentity_NetworkIdentity_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_NetworkIdentity_NetworkIdentity_$memory@0 ($Memory_141367 (|Store__T@[Int]Bool_| (|domain#$Memory_141367| $1_NetworkIdentity_NetworkIdentity_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_141367| $1_NetworkIdentity_NetworkIdentity_$memory) (|$addr#$signer| _$t0) $t7@0))) (= $1_NetworkIdentity_NetworkIdentity_$memory@1 $1_NetworkIdentity_NetworkIdentity_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 205051) 205083) anon14_Then_correct) (=> (= (ControlFlow 0 205051) 205069) anon14_Else_correct))))))
(let ((anon12_Else_correct  (=> (not false) (=> (and (= |inline$$1_Event_new_event_handle'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$res@0| |inline$$1_Event_new_event_handle'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$res@0|) (= $t7@0 ($1_NetworkIdentity_NetworkIdentity |inline$$1_Vector_empty'vec'u8''$0$v@1| |inline$$1_Event_new_event_handle'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$res@0|))) (and (=> (= (ControlFlow 0 205029) (- 0 238854)) (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 205029) 205139) anon13_Then_correct) (=> (= (ControlFlow 0 205029) 205051) anon13_Else_correct))))))))
(let ((anon12_Then_correct true))
(let ((|inline$$1_Event_new_event_handle'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$res@0| true))) (and (=> (= (ControlFlow 0 204993) 205155) anon12_Then_correct) (=> (= (ControlFlow 0 204993) 205029) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (not false) (=> (and (= |inline$$1_Vector_empty'vec'u8''$0$v@1| |inline$$1_Vector_empty'vec'u8''$0$v@1|) (= (ControlFlow 0 204999) 204993)) |inline$$1_Event_new_event_handle'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$anon0_correct|))))
(let ((anon11_Then_correct true))
(let ((|inline$$1_Vector_empty'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'vec'u8''$0$v@1| (as seq.empty (Seq (Seq Int)))) (and (=> (= (ControlFlow 0 204905) 205169) anon11_Then_correct) (=> (= (ControlFlow 0 204905) 204999) anon11_Else_correct)))))
(let ((anon0$1_correct  (=> (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_141367| $1_NetworkIdentity_NetworkIdentity_$memory) $a_0)))
(|$IsValid'$1_NetworkIdentity_NetworkIdentity'| $rsc))
 :qid |NetworkIdentitybpl.14787:20|
 :skolemid |279|
...
))) (=> (and (and (= $t3 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies $t3)) (and (= _$t0 _$t0) (= (ControlFlow 0 204911) 204905))) |inline$$1_Vector_empty'vec'u8''$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_66089_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |NetworkIdentitybpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 204817) 204911)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 238635) 204817) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))
))
(check-sat)
(pop 1)
