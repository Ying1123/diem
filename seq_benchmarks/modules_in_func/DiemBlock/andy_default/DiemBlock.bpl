...
procedure {:timeLimit 40} $1_DiemTimestamp_update_global_time$verify(_$t0: $signer, _$t1: int, _$t2: int) returns ()
{
    ...
    var $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#273: $Memory $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion';
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    ...
    // @136 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:89:9+52
...
L5:
    ...
    // @272 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:67:5+794
    ...
    // @273 := save_mem(DiemConfig::DiemConfig<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:67:5+794
    $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#273 := $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory;
    ...
    // assert Implies(DiemTimestamp::$is_operating(), Le(select DiemVersion::DiemVersion.major(DiemConfig::$get[@273]<DiemVersion::DiemVersion>()), select DiemVersion::DiemVersion.major(DiemConfig::$get<DiemVersion::DiemVersion>()))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:101:9+177
    ...
    assert {:msg "assert_failed(21,3945,4122): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> ($major#$1_DiemVersion_DiemVersion($1_DiemConfig_$get'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#273)) <= $major#$1_DiemVersion_DiemVersion($1_DiemConfig_$get'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory))));
...
L8:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_operating[@136]()), Neq<address>(Signer::spec_address_of[]($t0), 0)), (if Eq<address>($t1, 0) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}})) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:87:5+745
    assume {:print "$at(18,4046,4791)"} true;
    assert {:msg "assert_failed(18,4046,4791): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#136) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 0)) || if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)));

    // assert Or(Or(And(Not(DiemTimestamp::$is_operating[@136]()), Eq(1, $t11)), And(Neq<address>(Signer::spec_address_of[]($t0), 0), Eq(2, $t11))), And((if Eq<address>($t1, 0) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}}), Eq(7, $t11))) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:87:5+745
    assert {:msg "assert_failed(18,4046,4791): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#136) && $IsEqual'num'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 0) && $IsEqual'num'(2, $t11))) || (if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'num'(7, $t11)));
...
L8:
    ...
    // @169 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:105:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@169](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:105:19+208
...
procedure {:inline 1} $1_RegisteredCurrencies_initialize(_$t0: $signer) returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'signer': $signer;
    var $1_DiemConfig_Configuration_$memory#215: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
...
L7:
    ...
    // @215 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    $1_DiemConfig_Configuration_$memory#215 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@215](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#215), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L6:
    ...
    // @175 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@175](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
...
L7:
    ...
    // @205 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@205](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
...
procedure {:timeLimit 40} $1_DiemBlock_is_initialized$verify() returns ($ret0: bool)
{
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:129:9+75
    assume {:print "$at(13,2042,2117)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory));
...
procedure {:timeLimit 40} $1_DiemBlock_block_prologue$verify(_$t0: $signer, _$t1: int, _$t2: int, _$t3: Vec (int), _$t4: int) returns ()
{
    ...
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#216: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#217: $Memory $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem';
    var $1_DiemBlock_BlockMetadata_$memory#218: $Memory $1_DiemBlock_BlockMetadata;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    $t3 := _$t3;
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:182:9+72
    assume {:print "$at(13,2254,3275)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), Roles::spec_has_diem_root_role_addr(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/Roles.move:433:9+110
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Roles_spec_has_diem_root_role_addr($1_Roles_RoleId_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), Roles::spec_has_treasury_compliance_role_addr(b1e55ed)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/Roles.move:440:9+130
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Roles_spec_has_treasury_compliance_role_addr($1_Roles_RoleId_$memory, 186537453));

    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:282:9+102
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(b1e55ed)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:285:9+112
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, 186537453));
    ...
    // assume forall config_address: TypeDomain<address>() where exists<DiemConfig::DiemConfig<DiemSystem::DiemSystem>>(config_address): Eq<address>(config_address, a550c18) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    ...
    // assume forall addr: TypeDomain<address>() where exists<DiemConfig::DiemConfig<DiemSystem::DiemSystem>>(addr): Eq<address>(addr, a550c18) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<RegisteredCurrencies::RegisteredCurrencies>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:91:9+112
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XUS::XUS>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/XUS.move:56:9+83
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Diem_$is_currency'$1_XUS_XUS'($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountLimits::LimitsDefinition<XUS::XUS>>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/XUS.move:61:9+126
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), XDX::reserve_exists()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:124:9+75
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_XDX_reserve_exists($1_XDX_Reserve_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XDX::XDX>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:127:9+83
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Diem_$is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountLimits::LimitsDefinition<XDX::XDX>>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:140:9+126
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), TransactionFee::$is_initialized()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/TransactionFee.move:158:9+75
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_TransactionFee_$is_initialized($1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DualAttestation::spec_is_published()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/DualAttestation.move:539:9+78
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DualAttestation_spec_is_published($1_DualAttestation_Limit_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemTransactionPublishingOption::DiemTransactionPublishingOption>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:162:9+135
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'($1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), exists<ChainId::ChainId>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/ChainId.move:50:9+85
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_ChainId_ChainId_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountFreezing::FreezeEventsHolder>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:196:9+108
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:204:9+108
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(b1e55ed)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:209:9+118
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, 186537453));
    ...
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemAccount::AccountOperationsCapability>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2356:9+105
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemAccount_AccountOperationsCapability_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemAccount::DiemWriteSetManager>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2359:9+97
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemAccount_DiemWriteSetManager_$memory, 173345816));
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:216:9+104
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1021
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:70:9+103
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory));
    ...
    assume {:print "$at(13,3984,4047)"} true;
    ...
    assume {:print "$at(13,4056,4209)"} true;
    assume ($t10 == $1_DiemBlock_NewBlockEvent($t1, $t4, $t3, $t2));

    // @216 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1
    assume {:print "$at(13,2254,2255)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#216 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @217 := save_mem(DiemConfig::DiemConfig<DiemSystem::DiemSystem>) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1
    $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#217 := $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory;

    // @218 := save_mem(DiemBlock::BlockMetadata) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:61:5+1
    $1_DiemBlock_BlockMetadata_$memory#218 := $1_DiemBlock_BlockMetadata_$memory;
    ...
    assume {:print "$at(13,2450,2483)"} true;
...
L9:
    ...
    assume {:print "$at(13,2450,2483)"} true;
    assume {:print "$track_abort(37,0):", $t12} $t12 == $t12;
...
L8:
    ...
    assume {:print "$at(13,2559,2588)"} true;
...
L10:
    ...
    assume {:print "$at(13,2656,2667)"} true;
    $t14 := 0;
...
L0:
    ...
    assume {:print "$track_local(37,0,7):", $t16} $t16 == $t16;
...
L13:
    ...
    assume {:print "$at(13,2671,2705)"} true;
    assume {:print "$track_abort(37,0):", $t12} $t12 == $t12;
...
L12:
    ...
    assume {:print "$track_local(37,0,7):", $t17} $t17 == $t17;
...
L3:
    ...
    assume {:print "$at(13,2744,2760)"} true;
    $t19 := 1;
    assume $IsValid'u64'($t19);
    ...
    assume {:print "$at(13,2624,2771)"} true;
    assume {:print "$track_local(37,0,6):", $t20} $t20 == $t20;

    // trace_local[tmp#$5]($t7) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:73:9+147
    assume {:print "$track_local(37,0,5):", $t7} $t7 == $t7;
...
L5:
    ...
    assume {:print "$at(13,2624,2771)"} true;
    assume {:print "$track_abort(37,0):", $t20} $t20 == $t20;
    ...
    assume {:print "$at(13,2840,2849)"} true;
L4:
    ...
    if ($abort_flag) {
        assume {:print "$at(13,2807,2824)"} true;
        $t12 := $abort_code;
        assume {:print "$track_abort(37,0):", $t12} $t12 == $t12;
        goto L7;
    }
    ...
    assume {:print "$track_local(37,0,8):", $temp_0'$1_DiemBlock_BlockMetadata'} $temp_0'$1_DiemBlock_BlockMetadata' == $temp_0'$1_DiemBlock_BlockMetadata';

    // assume Identical($t23, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:91:9+34
    assume {:print "$at(18,4165,4199)"} true;
    ...
    assume {:print "$at(13,2860,2919)"} true;
...
L14:
    ...
    // assume Eq<u64>($t25, $t2) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:92:9+44
    assume $IsEqual'u64'($t25, $t2);

    // opaque end: DiemTimestamp::update_global_time($t0, $t4, $t2) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:92:9+44
    ...
    assume {:print "$at(13,2957,2982)"} true;
    ...
    if ($abort_flag) {
        assume {:print "$at(13,2983,2984)"} true;
        $t12 := $abort_code;
        assume {:print "$track_abort(37,0):", $t12} $t12 == $t12;
        goto L7;
    }
    ...
    assume {:print "$at(13,3042,3082)"} true;
    ...
    assume {:print "$at(13,3096,3258)"} true;
    ...
    assume {:print "$at(13,2996,3268)"} true;
    ...
    assume {:print "$at(13,3274,3275)"} true;
L6:

    // assert Not(Not(DiemTimestamp::$is_operating[@216]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:173:9+53
    assume {:print "$at(18,7043,7096)"} true;
    assert {:msg "assert_failed(18,7043,7096): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#216);
    ...
    // assert Not(And(Neq<address>($t4, 0), Not(DiemSystem::spec_is_validator[@217]($t4)))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:94:9+120
    assume {:print "$at(13,3422,3542)"} true;
    assert {:msg "assert_failed(13,3422,3542): function does not abort under this condition"}
      !(!$IsEqual'address'($t4, 0) && !$1_DiemSystem_spec_is_validator($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#217, $t4));

    // assert Not(Gt(Add(DiemBlock::$get_current_block_height[@218](), 1), 18446744073709551615)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:99:9+74
    assume {:print "$at(13,3704,3778)"} true;
    assert {:msg "assert_failed(13,3704,3778): function does not abort under this condition"}
      !(($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory#218) + 1) > 18446744073709551615);
    ...
    assume {:print "$at(13,3551,3611)"} true;
    assert {:msg "assert_failed(13,3551,3611): post-condition does not hold"}
      $IsEqual'u64'($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory), $t2);

    // assert Eq<u64>(DiemBlock::$get_current_block_height(), Add(DiemBlock::$get_current_block_height[@218](), 1)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:97:9+74
    assume {:print "$at(13,3620,3694)"} true;
    assert {:msg "assert_failed(13,3620,3694): post-condition does not hold"}
      $IsEqual'u64'($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory), ($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory#218) + 1));
    ...
    assume {:print "$at(13,4218,4238)"} true;
    assert {:msg "assert_failed(13,4218,4238): function does not emit the expected event"}
    ...
    assume {:print "$at(13,3280,3820)"} true;
    assert {:msg "assert_failed(13,3280,3820): emitted event not covered by any of the `emits` clauses"}
...
L7:
    ...
    // assert Or(Or(Or(Not(DiemTimestamp::$is_operating[@216]()), Neq<address>(Signer::spec_address_of[]($t0), 0)), And(Neq<address>($t4, 0), Not(DiemSystem::spec_is_validator[@217]($t4)))), Gt(Add(DiemBlock::$get_current_block_height[@218](), 1), 18446744073709551615)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:91:5+540
    assume {:print "$at(13,3280,3820)"} true;
    assert {:msg "assert_failed(13,3280,3820): abort not covered by any of the `aborts_if` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#216) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 0)) || (!$IsEqual'address'($t4, 0) && !$1_DiemSystem_spec_is_validator($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#217, $t4))) || (($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory#218) + 1) > 18446744073709551615));

    // assert Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@216]()), Eq(1, $t12)), And(Neq<address>(Signer::spec_address_of[]($t0), 0), Eq(2, $t12))), And(And(Neq<address>($t4, 0), Not(DiemSystem::spec_is_validator[@217]($t4))), Eq(2, $t12))), And(Gt(Add(DiemBlock::$get_current_block_height[@218](), 1), 18446744073709551615), Eq(-1, $t12))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:91:5+540
    assert {:msg "assert_failed(13,3280,3820): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#216) && $IsEqual'num'(1, $t12)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 0) && $IsEqual'num'(2, $t12))) || ((!$IsEqual'address'($t4, 0) && !$1_DiemSystem_spec_is_validator($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#217, $t4)) && $IsEqual'num'(2, $t12))) || ((($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory#218) + 1) > 18446744073709551615) && $IsEqual'num'(-1, $t12)));
...
procedure {:timeLimit 40} $1_DiemBlock_get_current_block_height$verify() returns ($ret0: int)
{
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:129:9+75
    assume {:print "$at(13,4287,4489)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory));
    ...
    assume {:print "$at(13,4370,4386)"} true;
    call $t2 := $1_DiemBlock_is_initialized();
    if ($abort_flag) {
        assume {:print "$at(13,4370,4386)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(37,1):", $t3} $t3 == $t3;
        goto L3;
    }
...
L1:
    ...
    assume {:print "$at(13,4363,4427)"} true;
    assume {:print "$track_abort(37,1):", $t5} $t5 == $t5;
    ...
    assume {:print "$at(13,4466,4475)"} true;
L0:
    ...
    if ($abort_flag) {
        assume {:print "$at(13,4437,4450)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(37,1):", $t3} $t3 == $t3;
        goto L3;
    }
...
procedure {:timeLimit 40} $1_DiemBlock_initialize_block_metadata$verify(_$t0: $signer) returns ()
{
    ...
    var $1_DiemBlock_BlockMetadata_$memory#160: $Memory $1_DiemBlock_BlockMetadata;
    $t0 := _$t0;
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:182:9+72
    assume {:print "$at(13,1130,1661)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), Roles::spec_has_diem_root_role_addr(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/Roles.move:433:9+110
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Roles_spec_has_diem_root_role_addr($1_Roles_RoleId_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), Roles::spec_has_treasury_compliance_role_addr(b1e55ed)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/Roles.move:440:9+130
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Roles_spec_has_treasury_compliance_role_addr($1_Roles_RoleId_$memory, 186537453));

    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:282:9+102
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), exists<SlidingNonce::SlidingNonce>(b1e55ed)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/SlidingNonce.move:285:9+112
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_SlidingNonce_SlidingNonce_$memory, 186537453));
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<RegisteredCurrencies::RegisteredCurrencies>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:91:9+112
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XUS::XUS>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/XUS.move:56:9+83
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Diem_$is_currency'$1_XUS_XUS'($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountLimits::LimitsDefinition<XUS::XUS>>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/XUS.move:61:9+126
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), XDX::reserve_exists()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:124:9+75
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_XDX_reserve_exists($1_XDX_Reserve_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XDX::XDX>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:127:9+83
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Diem_$is_currency'$1_XDX_XDX'($1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountLimits::LimitsDefinition<XDX::XDX>>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/XDX.move:140:9+126
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), TransactionFee::$is_initialized()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/TransactionFee.move:158:9+75
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_TransactionFee_$is_initialized($1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DualAttestation::spec_is_published()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/DualAttestation.move:539:9+78
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DualAttestation_spec_is_published($1_DualAttestation_Limit_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemTransactionPublishingOption::DiemTransactionPublishingOption>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:162:9+135
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'($1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), exists<ChainId::ChainId>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/ChainId.move:50:9+85
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_ChainId_ChainId_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountFreezing::FreezeEventsHolder>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:196:9+108
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:204:9+108
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(b1e55ed)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:209:9+118
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, 186537453));
    ...
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemAccount::AccountOperationsCapability>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2356:9+105
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemAccount_AccountOperationsCapability_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemAccount::DiemWriteSetManager>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2359:9+97
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemAccount_DiemWriteSetManager_$memory, 173345816));
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:216:9+104
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:70:9+103
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory));
    ...
    // @159 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+1
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#159 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @160 := save_mem(DiemBlock::BlockMetadata) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:32:5+1
    $1_DiemBlock_BlockMetadata_$memory#160 := $1_DiemBlock_BlockMetadata_$memory;
...
L2:
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@159]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:153:9+51
    assume {:print "$at(18,6290,6341)"} true;
    assert {:msg "assert_failed(18,6290,6341): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#159);
    ...
    // assert Not(DiemBlock::$is_initialized[@160]()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:49:9+58
    assume {:print "$at(13,1810,1868)"} true;
    assert {:msg "assert_failed(13,1810,1868): function does not abort under this condition"}
      !$1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory#160);

    // assert DiemBlock::$is_initialized() at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:50:9+25
    assume {:print "$at(13,1877,1902)"} true;
    assert {:msg "assert_failed(13,1877,1902): post-condition does not hold"}
    ...
    assume {:print "$at(13,1911,1951)"} true;
    assert {:msg "assert_failed(13,1911,1951): post-condition does not hold"}
...
L3:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_genesis[@159]()), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), DiemBlock::$is_initialized[@160]()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:46:5+291
    assume {:print "$at(13,1666,1957)"} true;
    assert {:msg "assert_failed(13,1666,1957): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#159) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || $1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory#160));

    // assert Or(Or(And(Not(DiemTimestamp::$is_genesis[@159]()), Eq(1, $t4)), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t4))), And(DiemBlock::$is_initialized[@160](), Eq(6, $t4))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:46:5+291
    assert {:msg "assert_failed(13,1666,1957): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#159) && $IsEqual'num'(1, $t4)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t4))) || ($1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory#160) && $IsEqual'num'(6, $t4)));
...
L5:
    ...
    // @182 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:9+93
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@182](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:31:9+93
...
L5:
    ...
    // @187 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:15:9+91
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@187](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:15:9+91
...
L7:
    ...
    // @199 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@199](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
...
L7:
    ...
    // @193 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@193](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
...
procedure {:timeLimit 40} $1_Genesis_initialize_internal$verify(_$t0: $signer, _$t1: $signer, _$t2: Vec (int), _$t3: Vec (int), _$t4: Vec (Vec (int)), _$t5: bool, _$t6: Vec (int), _$t7: Vec (int), _$t8: int, _$t9: int, _$t10: Vec (int)) returns ()
{
    ...
    var $temp_0'vec'u8'': Vec (int);
    var $temp_0'vec'vec'u8''': Vec (Vec (int));
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#274: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#275: $Memory $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion';
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    $t3 := _$t3;
...
L7:
    ...
    // @274 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/Genesis.move:58:5+2490
    // state save for global update invariants
    assume {:print "$at(23,1972,4462)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#274 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @275 := save_mem(DiemConfig::DiemConfig<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/Genesis.move:58:5+2490
    $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#275 := $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory;
    ...
    // assert Implies(DiemTimestamp::$is_operating[@274](), Le(DiemTimestamp::spec_now_microseconds[@274](), DiemTimestamp::spec_now_microseconds())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:185:9+109
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:185:9+109
    assume {:print "$at(18,7468,7577)"} true;
    assert {:msg "assert_failed(18,7468,7577): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#274) ==> ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#274) <= $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory)));
    ...
    // assert Implies(DiemTimestamp::$is_operating(), Le(select DiemVersion::DiemVersion.major(DiemConfig::$get[@275]<DiemVersion::DiemVersion>()), select DiemVersion::DiemVersion.major(DiemConfig::$get<DiemVersion::DiemVersion>()))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:101:9+177
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:101:9+177
    assume {:print "$at(21,3945,4122)"} true;
    assert {:msg "assert_failed(21,3945,4122): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> ($major#$1_DiemVersion_DiemVersion($1_DiemConfig_$get'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#275)) <= $major#$1_DiemVersion_DiemVersion($1_DiemConfig_$get'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory))));
