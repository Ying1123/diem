...
L7:
    ...
    // @181 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@181](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
L6:
    ...
    // @153 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@153](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
L7:
    ...
    // @171 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@171](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
// fun DesignatedDealer::add_currency [verification] at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:104:5+325
procedure {:timeLimit 40} $1_DesignatedDealer_add_currency$verify(_$t0: int, _$t1: int) returns ()
{
    // declare local variables
    var $t2: int;
    var $t3: bool;
    ...
    var $1_DesignatedDealer_Dealer_$memory#139: $Memory $1_DesignatedDealer_Dealer;
    var $1_Diem_CurrencyInfo'#0'_$memory#140: $Memory $1_Diem_CurrencyInfo'#0';
    var $1_Diem_PreburnQueue'#0'_$memory#141: $Memory $1_Diem_PreburnQueue'#0';
    var $1_Diem_Preburn'#0'_$memory#142: $Memory $1_Diem_Preburn'#0';
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // assume true at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:104:5+325
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:552:9+318
    assume true;

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:104:5+325
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:104:5+325
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:104:5+325
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<Diem::CurrencyInfo<#0>>(): And(WellFormed($rsc), And(Lt(0, select Diem::CurrencyInfo.scaling_factor($rsc)), Le(select Diem::CurrencyInfo.scaling_factor($rsc), 10000000000))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:104:5+325
    ...
    // assume forall $rsc: ResourceDomain<Diem::Preburn<#0>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:104:5+325
    ...
    // assume forall $rsc: ResourceDomain<DesignatedDealer::Dealer>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:104:5+325
    ...
    // assume Identical($t5, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:113:9+42
    ...
    // assume CanModify<Diem::PreburnQueue<#0>>($t5) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:120:9+55
    assume {:print "$at(9,4934,4989)"} true;
    assume $1_Diem_PreburnQueue'#0'_$modifies[$t5];

    // @138 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:120:9+55
    $1_Roles_RoleId_$memory#138 := $1_Roles_RoleId_$memory;

    // @140 := save_mem(Diem::CurrencyInfo<#0>) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:120:9+55
    $1_Diem_CurrencyInfo'#0'_$memory#140 := $1_Diem_CurrencyInfo'#0'_$memory;

    // @142 := save_mem(Diem::Preburn<#0>) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:120:9+55
    $1_Diem_Preburn'#0'_$memory#142 := $1_Diem_Preburn'#0'_$memory;

    // @141 := save_mem(Diem::PreburnQueue<#0>) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:120:9+55
    $1_Diem_PreburnQueue'#0'_$memory#141 := $1_Diem_PreburnQueue'#0'_$memory;

    // @139 := save_mem(DesignatedDealer::Dealer) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:120:9+55
    $1_DesignatedDealer_Dealer_$memory#139 := $1_DesignatedDealer_Dealer_$memory;

    // trace_local[dd]($t0) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:104:5+1
    assume {:print "$at(9,4242,4243)"} true;
    assume {:print "$track_local(26,0,0):", $t0} $t0 == $t0;

    // trace_local[tc_account]($t1) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:104:5+1
    assume {:print "$track_local(26,0,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:105:9+45
    // >> opaque call: Roles::assert_treasury_compliance($t1)
    assume {:print "$at(9,4327,4372)"} true;

    // assume Identical($t8, Signer::spec_address_of($t1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+44
    assume {:print "$at(26,24010,24054)"} true;
    assume ($t8 == $1_Signer_spec_address_of($t1));

    // opaque begin: Roles::assert_treasury_compliance($t1) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:105:9+45
    assume {:print "$at(9,4327,4372)"} true;

    // assume Identical($t9, Or(Or(Not(exists<Roles::RoleId>($t8)), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t8)), 1)), Neq<address>(Signer::spec_address_of($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:105:9+45
    ...
    // if ($t9) goto L5 else goto L4 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:105:9+45
    if ($t9) { goto L5; } else { goto L4; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:105:9+45
L5:

    // assume Or(Or(And(Not(exists<Roles::RoleId>($t8)), Eq(5, $t10)), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t8)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS()), Eq(2, $t10))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:105:9+45
    ...
    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:105:9+45
    assume {:print "$at(9,4327,4372)"} true;
    assume {:print "$track_abort(26,0):", $t10} $t10 == $t10;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:105:9+45
    goto L3;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:105:9+45
L4:

    // opaque end: Roles::assert_treasury_compliance($t1) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:105:9+45

    // nop at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:106:23+22
    // >> opaque call: $t5 := Signer::address_of($t0)
    assume {:print "$at(9,4396,4418)"} true;

    // $t11 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:106:23+22

    // assume WellFormed($t11) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:106:23+22
    assume $IsValid'address'($t11);

    // assume Eq<address>($t11, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:106:23+22
    assume $IsEqual'address'($t11, $1_Signer_spec_address_of($t0));

    // $t11 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:106:23+22

    // trace_local[dd_addr]($t11) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:106:13+7
    assume {:print "$track_local(26,0,2):", $t11} $t11 == $t11;

    // nop at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:16+18
    // >> opaque call: $t6 := DesignatedDealer::exists_at($t5)
    assume {:print "$at(9,4435,4453)"} true;

    // $t12 := opaque begin: DesignatedDealer::exists_at($t11) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:16+18

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:16+18
    assume $IsValid'bool'($t12);

    // assume Eq<bool>($t12, exists<DesignatedDealer::Dealer>($t11)) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:16+18
    assume $IsEqual'bool'($t12, $ResourceExists($1_DesignatedDealer_Dealer_$memory, $t11));

    // $t12 := opaque end: DesignatedDealer::exists_at($t11) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:16+18

    // $t13 := 0 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:58+7
    $t13 := 0;
    assume $IsValid'u64'($t13);

    // nop at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:36+30
    // >> opaque call: $t8 := Errors::not_published($t7)

    // $t14 := opaque begin: Errors::not_published($t13) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:36+30

    // assume WellFormed($t14) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:36+30
    assume $IsValid'u64'($t14);

    // assume Eq<u64>($t14, 5) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:36+30
    assume $IsEqual'u64'($t14, 5);

    // $t14 := opaque end: Errors::not_published($t13) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:36+30

    // trace_local[tmp#$4]($t14) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:9+58
    assume {:print "$track_local(26,0,4):", $t14} $t14 == $t14;

    // trace_local[tmp#$3]($t12) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:9+58
    assume {:print "$track_local(26,0,3):", $t12} $t12 == $t12;

    // if ($t12) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:9+58
    if ($t12) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:9+58
L1:

    // destroy($t1) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:9+58

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:9+58

    // trace_abort($t14) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:9+58
    assume {:print "$at(9,4428,4486)"} true;
    assume {:print "$track_abort(26,0):", $t14} $t14 == $t14;

    // $t10 := move($t14) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:9+58
    $t10 := $t14;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:107:9+58
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:58+2
    assume {:print "$at(9,4545,4547)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    // >> opaque call: Diem::publish_preburn_queue_to_account<#0>($t0, $t1)
    ...
    // assume Identical($t16, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:555:9+44
    assume {:print "$at(26,24849,24893)"} true;
    assume ($t16 == $1_Signer_spec_address_of($t0));

    // assume Identical($t17, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:555:9+44
    ...
    // assume Identical($t19, Signer::spec_address_of($t1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+44
    assume {:print "$at(26,24010,24054)"} true;
    ...
    // assert CanModify<Diem::PreburnQueue<#0>>($t15) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    assume {:print "$at(9,4496,4560)"} true;
    assert {:msg "assert_failed(9,4496,4560): caller does not have permission to modify `Diem::PreburnQueue<#0>` at given address"}
      $1_Diem_PreburnQueue'#0'_$modifies[$t15];

    // opaque begin: Diem::publish_preburn_queue_to_account<#0>($t0, $t1) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64

    // assume Identical($t21, Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Not(exists<Roles::RoleId>($t16)), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t16)), 2)), Not(exists<Roles::RoleId>($t17))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t17)), 2)), Not(Diem::spec_is_currency<#0>())), Not(exists<Roles::RoleId>($t19))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t19)), 1)), Neq<address>(Signer::spec_address_of($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS())), Not(Diem::spec_is_currency<#0>())), Diem::$is_synthetic_currency<#0>()), exists<Diem::PreburnQueue<#0>>($t15)), exists<Diem::Preburn<#0>>($t15))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    assume ($t21 == (((((((((((!$ResourceExists($1_Roles_RoleId_$memory, $t16) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t16)), 2)) || !$ResourceExists($1_Roles_RoleId_$memory, $t17)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t17)), 2)) || !$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory)) || !$ResourceExists($1_Roles_RoleId_$memory, $t19)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t19)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || !$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory)) || $1_Diem_$is_synthetic_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory)) || $ResourceExists($1_Diem_PreburnQueue'#0'_$memory, $t15)) || $ResourceExists($1_Diem_Preburn'#0'_$memory, $t15)));

    // if ($t21) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    if ($t21) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
L7:

    // assume Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(And(Not(exists<Roles::RoleId>($t16)), Eq(5, $t10)), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t16)), 2), Eq(3, $t10))), And(Not(exists<Roles::RoleId>($t17)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t17)), 2), Eq(3, $t10))), And(Not(Diem::spec_is_currency<#0>()), Eq(5, $t10))), And(Not(exists<Roles::RoleId>($t19)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t19)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS()), Eq(2, $t10))), And(Not(Diem::spec_is_currency<#0>()), Eq(5, $t10))), And(Diem::$is_synthetic_currency<#0>(), Eq(7, $t10))), And(exists<Diem::PreburnQueue<#0>>($t15), Eq(6, $t10))), And(exists<Diem::Preburn<#0>>($t15), Eq(1, $t10))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    assume ((((((((((((!$ResourceExists($1_Roles_RoleId_$memory, $t16) && $IsEqual'u8'(5, $t10)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t16)), 2) && $IsEqual'u8'(3, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory, $t17) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t17)), 2) && $IsEqual'u8'(3, $t10))) || (!$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory) && $IsEqual'u8'(5, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory, $t19) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t19)), 1) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t10))) || (!$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory) && $IsEqual'u8'(5, $t10))) || ($1_Diem_$is_synthetic_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory) && $IsEqual'u8'(7, $t10))) || ($ResourceExists($1_Diem_PreburnQueue'#0'_$memory, $t15) && $IsEqual'u8'(6, $t10))) || ($ResourceExists($1_Diem_Preburn'#0'_$memory, $t15) && $IsEqual'u8'(1, $t10)));

    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    assume {:print "$at(9,4496,4560)"} true;
    assume {:print "$track_abort(26,0):", $t10} $t10 == $t10;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    goto L3;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
L6:

    // modifies global<Diem::PreburnQueue<#0>>($t15) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    havoc $temp_0'bool';
    if ($temp_0'bool') {
    ...
    // assume exists<Diem::PreburnQueue<#0>>($t18) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    assume $ResourceExists($1_Diem_PreburnQueue'#0'_$memory, $t18);

    // assume Not(exists<Diem::Preburn<#0>>($t18)) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    assume !$ResourceExists($1_Diem_Preburn'#0'_$memory, $t18);

    // assume Eq<u64>(Vector::$length<Diem::PreburnWithMetadata<#0>>(select Diem::PreburnQueue.preburns(global<Diem::PreburnQueue<#0>>($t18))), 0) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    ...
    // assume exists<Diem::PreburnQueue<#0>>($t15) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64
    assume $ResourceExists($1_Diem_PreburnQueue'#0'_$memory, $t15);

    // opaque end: Diem::publish_preburn_queue_to_account<#0>($t0, $t1) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:108:9+64

    // label L2 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:109:5+1
    assume {:print "$at(9,4566,4567)"} true;
L2:
    ...
    // assert Not(Not(exists[@138]<Roles::RoleId>($t7))) at /home/ying/diem/language/diem-framework/modules/Roles.move:556:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t7)), 2)) at /home/ying/diem/language/diem-framework/modules/Roles.move:557:9+95
    assume {:print "$at(26,24970,25065)"} true;
    assert {:msg "assert_failed(26,24970,25065): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t7)), 2);

    // assert Not(Not(exists[@139]<DesignatedDealer::Dealer>($t5))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:22:9+62
    assume {:print "$at(9,643,705)"} true;
    assert {:msg "assert_failed(9,643,705): function does not abort under this condition"}
      !!$ResourceExists($1_DesignatedDealer_Dealer_$memory#139, $t5);

    // assert Not(Diem::$is_synthetic_currency[@140]<#0>()) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:125:9+80
    assume {:print "$at(9,5130,5210)"} true;
    assert {:msg "assert_failed(9,5130,5210): function does not abort under this condition"}
      !$1_Diem_$is_synthetic_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#140);

    // assert Not(exists[@141]<Diem::PreburnQueue<#0>>($t5)) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:126:9+87
    assume {:print "$at(9,5219,5306)"} true;
    assert {:msg "assert_failed(9,5219,5306): function does not abort under this condition"}
      !$ResourceExists($1_Diem_PreburnQueue'#0'_$memory#141, $t5);

    // assert Not(exists[@142]<Diem::Preburn<#0>>($t5)) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:127:9+78
    assume {:print "$at(9,5315,5393)"} true;
    assert {:msg "assert_failed(9,5315,5393): function does not abort under this condition"}
      !$ResourceExists($1_Diem_Preburn'#0'_$memory#142, $t5);

    // assert Not(Not(Diem::spec_is_currency[@140]<#0>())) at /home/ying/diem/language/diem-framework/modules/Diem.move:1551:9+67
    assume {:print "$at(10,73620,73687)"} true;
    assert {:msg "assert_failed(10,73620,73687): function does not abort under this condition"}
      !!$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#140);

    // return () at /home/ying/diem/language/diem-framework/modules/Diem.move:1551:9+67
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:109:5+1
    assume {:print "$at(9,4566,4567)"} true;
L3:

    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Not(exists[@138]<Roles::RoleId>($t6)), Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t6)), 1)), Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), Not(exists[@138]<Roles::RoleId>($t7))), Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t7)), 2)), Not(exists[@139]<DesignatedDealer::Dealer>($t5))), Diem::$is_synthetic_currency[@140]<#0>()), exists[@141]<Diem::PreburnQueue<#0>>($t5)), exists[@142]<Diem::Preburn<#0>>($t5)), Not(Diem::spec_is_currency[@140]<#0>())) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:110:5+423
    assume {:print "$at(9,4572,4995)"} true;
    assert {:msg "assert_failed(9,4572,4995): abort not covered by any of the `aborts_if` clauses"}
      (((((((((!$ResourceExists($1_Roles_RoleId_$memory#138, $t6) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t6)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || !$ResourceExists($1_Roles_RoleId_$memory#138, $t7)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t7)), 2)) || !$ResourceExists($1_DesignatedDealer_Dealer_$memory#139, $t5)) || $1_Diem_$is_synthetic_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#140)) || $ResourceExists($1_Diem_PreburnQueue'#0'_$memory#141, $t5)) || $ResourceExists($1_Diem_Preburn'#0'_$memory#142, $t5)) || !$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#140));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(And(Not(exists[@138]<Roles::RoleId>($t6)), Eq(5, $t10)), And(Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t6)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t10))), And(Not(exists[@138]<Roles::RoleId>($t7)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t7)), 2), Eq(3, $t10))), And(Not(exists[@139]<DesignatedDealer::Dealer>($t5)), Eq(5, $t10))), And(Diem::$is_synthetic_currency[@140]<#0>(), Eq(7, $t10))), And(exists[@141]<Diem::PreburnQueue<#0>>($t5), Eq(6, $t10))), And(exists[@142]<Diem::Preburn<#0>>($t5), Eq(1, $t10))), And(Not(Diem::spec_is_currency[@140]<#0>()), Eq(5, $t10))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:110:5+423
    assert {:msg "assert_failed(9,4572,4995): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((((!$ResourceExists($1_Roles_RoleId_$memory#138, $t6) && $IsEqual'u8'(5, $t10)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t6)), 1) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#138, $t7) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t7)), 2) && $IsEqual'u8'(3, $t10))) || (!$ResourceExists($1_DesignatedDealer_Dealer_$memory#139, $t5) && $IsEqual'u8'(5, $t10))) || ($1_Diem_$is_synthetic_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#140) && $IsEqual'u8'(7, $t10))) || ($ResourceExists($1_Diem_PreburnQueue'#0'_$memory#141, $t5) && $IsEqual'u8'(6, $t10))) || ($ResourceExists($1_Diem_Preburn'#0'_$memory#142, $t5) && $IsEqual'u8'(1, $t10))) || (!$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#140) && $IsEqual'u8'(5, $t10)));

    // abort($t10) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:110:5+423
    $abort_code := $t10;
    $abort_flag := true;
    return;
...
// fun DesignatedDealer::exists_at [verification] at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:186:5+84
procedure {:timeLimit 40} $1_DesignatedDealer_exists_at$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:192:17+6
    assume {:print "$at(9,8164,8170)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<DesignatedDealer::Dealer>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:192:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_DesignatedDealer_Dealer_$memory, $a_0)}(var $rsc := $ResourceValue($1_DesignatedDealer_Dealer_$memory, $a_0);
    ($IsValid'$1_DesignatedDealer_Dealer'($rsc))));

    // trace_local[dd_addr]($t0) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:186:5+1
    assume {:print "$at(9,7994,7995)"} true;
    assume {:print "$track_local(26,1,0):", $t0} $t0 == $t0;

    // $t1 := exists<DesignatedDealer::Dealer>($t0) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:187:9+6
    assume {:print "$at(9,8049,8055)"} true;
    $t1 := $ResourceExists($1_DesignatedDealer_Dealer_$memory, $t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:187:9+23
    assume {:print "$track_return(26,1,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:188:5+1
    assume {:print "$at(9,8077,8078)"} true;
L1:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:191:9+16
    assume {:print "$at(9,8131,8147)"} true;
    assert {:msg "assert_failed(9,8131,8147): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, exists<DesignatedDealer::Dealer>($t0)) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:192:9+42
    assume {:print "$at(9,8156,8198)"} true;
    assert {:msg "assert_failed(9,8156,8198): post-condition does not hold"}
      $IsEqual'bool'($t1, $ResourceExists($1_DesignatedDealer_Dealer_$memory, $t0));

    // return $t1 at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:192:9+42
    $ret0 := $t1;
    return;
...
procedure {:timeLimit 40} $1_DesignatedDealer_publish_designated_dealer_credential$verify(_$t0: int, _$t1: int, _$t2: bool) returns ()
{
    ...
    var $1_DesignatedDealer_Dealer_$memory#187: $Memory $1_DesignatedDealer_Dealer;
    var $1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#188: $Memory $1_Diem_CurrencyInfo'$1_XUS_XUS';
    var $1_Diem_PreburnQueue'$1_XUS_XUS'_$memory#189: $Memory $1_Diem_PreburnQueue'$1_XUS_XUS';
    var $1_Diem_Preburn'$1_XUS_XUS'_$memory#190: $Memory $1_Diem_Preburn'$1_XUS_XUS';
    var $1_Diem_CurrencyInfo'#0'_$memory#191: $Memory $1_Diem_CurrencyInfo'#0';
    var $1_Diem_PreburnQueue'#0'_$memory#192: $Memory $1_Diem_PreburnQueue'#0';
    var $1_Diem_Preburn'#0'_$memory#193: $Memory $1_Diem_Preburn'#0';
    var $1_DesignatedDealer_Dealer_$memory#245: $Memory $1_DesignatedDealer_Dealer;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    ...
    // assume true at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:64:5+615
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:552:9+318
    assume true;
    ...
    // @186 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:94:9+50
    $1_Roles_RoleId_$memory#186 := $1_Roles_RoleId_$memory;

    // @188 := save_mem(Diem::CurrencyInfo<XUS::XUS>) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:94:9+50
    $1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#188 := $1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory;

    // @190 := save_mem(Diem::Preburn<XUS::XUS>) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:94:9+50
    $1_Diem_Preburn'$1_XUS_XUS'_$memory#190 := $1_Diem_Preburn'$1_XUS_XUS'_$memory;

    // @189 := save_mem(Diem::PreburnQueue<XUS::XUS>) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:94:9+50
    $1_Diem_PreburnQueue'$1_XUS_XUS'_$memory#189 := $1_Diem_PreburnQueue'$1_XUS_XUS'_$memory;

    // @191 := save_mem(Diem::CurrencyInfo<#0>) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:94:9+50
    $1_Diem_CurrencyInfo'#0'_$memory#191 := $1_Diem_CurrencyInfo'#0'_$memory;

    // @193 := save_mem(Diem::Preburn<#0>) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:94:9+50
    $1_Diem_Preburn'#0'_$memory#193 := $1_Diem_Preburn'#0'_$memory;

    // @192 := save_mem(Diem::PreburnQueue<#0>) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:94:9+50
    $1_Diem_PreburnQueue'#0'_$memory#192 := $1_Diem_PreburnQueue'#0'_$memory;

    // @187 := save_mem(DesignatedDealer::Dealer) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:94:9+50
    $1_DesignatedDealer_Dealer_$memory#187 := $1_DesignatedDealer_Dealer_$memory;
...
L0:
    ...
    // @245 := save_mem(DesignatedDealer::Dealer) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:64:5+615
    // state save for global update invariants
    assume {:print "$at(9,2379,2994)"} true;
    $1_DesignatedDealer_Dealer_$memory#245 := $1_DesignatedDealer_Dealer_$memory;
    ...
    // assert forall addr: TypeDomain<address>() where exists[@245]<DesignatedDealer::Dealer>(addr): exists<DesignatedDealer::Dealer>(addr) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:202:9+92
    // global invariant at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:202:9+92
    assume {:print "$at(9,8458,8550)"} true;
    assert {:msg "assert_failed(9,8458,8550): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_DesignatedDealer_Dealer_$memory#245, addr))  ==> ($ResourceExists($1_DesignatedDealer_Dealer_$memory, addr)));
...
L6:
    ...
    // assert Not(Not(exists[@186]<Roles::RoleId>($t6))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    assume {:print "$at(26,24063,24122)"} true;
    assert {:msg "assert_failed(26,24063,24122): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#186, $t6);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@186]<Roles::RoleId>($t6)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    assume {:print "$at(26,24131,24228)"} true;
    assert {:msg "assert_failed(26,24131,24228): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#186, $t6)), 1);
    ...
    // assert Not(Not(exists[@186]<Roles::RoleId>($t7))) at /home/ying/diem/language/diem-framework/modules/Roles.move:556:9+59
    assume {:print "$at(26,24902,24961)"} true;
    assert {:msg "assert_failed(26,24902,24961): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#186, $t7);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@186]<Roles::RoleId>($t7)), 2)) at /home/ying/diem/language/diem-framework/modules/Roles.move:557:9+95
    assume {:print "$at(26,24970,25065)"} true;
    assert {:msg "assert_failed(26,24970,25065): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#186, $t7)), 2);

    // assert Not(exists[@187]<DesignatedDealer::Dealer>($t5)) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:86:9+65
    assume {:print "$at(9,3267,3332)"} true;
    assert {:msg "assert_failed(9,3267,3332): function does not abort under this condition"}
      !$ResourceExists($1_DesignatedDealer_Dealer_$memory#187, $t5);

    // assert Not(And($t2, Diem::$is_synthetic_currency[@188]<XUS::XUS>())) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:125:9+80
    assume {:print "$at(9,5130,5210)"} true;
    assert {:msg "assert_failed(9,5130,5210): function does not abort under this condition"}
      !($t2 && $1_Diem_$is_synthetic_currency'$1_XUS_XUS'($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#188));

    // assert Not(And($t2, exists[@189]<Diem::PreburnQueue<XUS::XUS>>($t5))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:126:9+87
    assume {:print "$at(9,5219,5306)"} true;
    assert {:msg "assert_failed(9,5219,5306): function does not abort under this condition"}
      !($t2 && $ResourceExists($1_Diem_PreburnQueue'$1_XUS_XUS'_$memory#189, $t5));

    // assert Not(And($t2, exists[@190]<Diem::Preburn<XUS::XUS>>($t5))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:127:9+78
    assume {:print "$at(9,5315,5393)"} true;
    assert {:msg "assert_failed(9,5315,5393): function does not abort under this condition"}
      !($t2 && $ResourceExists($1_Diem_Preburn'$1_XUS_XUS'_$memory#190, $t5));

    // assert Not(And($t2, Not(Diem::spec_is_currency[@188]<XUS::XUS>()))) at /home/ying/diem/language/diem-framework/modules/Diem.move:1551:9+67
    assume {:print "$at(10,73620,73687)"} true;
    assert {:msg "assert_failed(10,73620,73687): function does not abort under this condition"}
      !($t2 && !$1_Diem_spec_is_currency'$1_XUS_XUS'($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#188));

    // assert Not(And(Not($t2), Diem::$is_synthetic_currency[@191]<#0>())) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:125:9+80
    assume {:print "$at(9,5130,5210)"} true;
    assert {:msg "assert_failed(9,5130,5210): function does not abort under this condition"}
      !(!$t2 && $1_Diem_$is_synthetic_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#191));

    // assert Not(And(Not($t2), exists[@192]<Diem::PreburnQueue<#0>>($t5))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:126:9+87
    assume {:print "$at(9,5219,5306)"} true;
    assert {:msg "assert_failed(9,5219,5306): function does not abort under this condition"}
      !(!$t2 && $ResourceExists($1_Diem_PreburnQueue'#0'_$memory#192, $t5));

    // assert Not(And(Not($t2), exists[@193]<Diem::Preburn<#0>>($t5))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:127:9+78
    assume {:print "$at(9,5315,5393)"} true;
    assert {:msg "assert_failed(9,5315,5393): function does not abort under this condition"}
      !(!$t2 && $ResourceExists($1_Diem_Preburn'#0'_$memory#193, $t5));

    // assert Not(And(Not($t2), Not(Diem::spec_is_currency[@191]<#0>()))) at /home/ying/diem/language/diem-framework/modules/Diem.move:1551:9+67
    assume {:print "$at(10,73620,73687)"} true;
    assert {:msg "assert_failed(10,73620,73687): function does not abort under this condition"}
      !(!$t2 && !$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#191));
...
L7:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Not(exists[@186]<Roles::RoleId>($t6)), Neq<u64>(select Roles::RoleId.role_id(global[@186]<Roles::RoleId>($t6)), 1)), Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), Not(exists[@186]<Roles::RoleId>($t7))), Neq<u64>(select Roles::RoleId.role_id(global[@186]<Roles::RoleId>($t7)), 2)), exists[@187]<DesignatedDealer::Dealer>($t5)), And($t2, Diem::$is_synthetic_currency[@188]<XUS::XUS>())), And($t2, exists[@189]<Diem::PreburnQueue<XUS::XUS>>($t5))), And($t2, exists[@190]<Diem::Preburn<XUS::XUS>>($t5))), And($t2, Not(Diem::spec_is_currency[@188]<XUS::XUS>()))), And(Not($t2), Diem::$is_synthetic_currency[@191]<#0>())), And(Not($t2), exists[@192]<Diem::PreburnQueue<#0>>($t5))), And(Not($t2), exists[@193]<Diem::Preburn<#0>>($t5))), And(Not($t2), Not(Diem::spec_is_currency[@191]<#0>()))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:79:5+762
    assume {:print "$at(9,2999,3761)"} true;
    assert {:msg "assert_failed(9,2999,3761): abort not covered by any of the `aborts_if` clauses"}
      (((((((((((((!$ResourceExists($1_Roles_RoleId_$memory#186, $t6) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#186, $t6)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || !$ResourceExists($1_Roles_RoleId_$memory#186, $t7)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#186, $t7)), 2)) || $ResourceExists($1_DesignatedDealer_Dealer_$memory#187, $t5)) || ($t2 && $1_Diem_$is_synthetic_currency'$1_XUS_XUS'($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#188))) || ($t2 && $ResourceExists($1_Diem_PreburnQueue'$1_XUS_XUS'_$memory#189, $t5))) || ($t2 && $ResourceExists($1_Diem_Preburn'$1_XUS_XUS'_$memory#190, $t5))) || ($t2 && !$1_Diem_spec_is_currency'$1_XUS_XUS'($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#188))) || (!$t2 && $1_Diem_$is_synthetic_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#191))) || (!$t2 && $ResourceExists($1_Diem_PreburnQueue'#0'_$memory#192, $t5))) || (!$t2 && $ResourceExists($1_Diem_Preburn'#0'_$memory#193, $t5))) || (!$t2 && !$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#191)));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(And(Not(exists[@186]<Roles::RoleId>($t6)), Eq(5, $t10)), And(Neq<u64>(select Roles::RoleId.role_id(global[@186]<Roles::RoleId>($t6)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t10))), And(Not(exists[@186]<Roles::RoleId>($t7)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@186]<Roles::RoleId>($t7)), 2), Eq(3, $t10))), And(exists[@187]<DesignatedDealer::Dealer>($t5), Eq(6, $t10))), And(And($t2, Diem::$is_synthetic_currency[@188]<XUS::XUS>()), Eq(7, $t10))), And(And($t2, exists[@189]<Diem::PreburnQueue<XUS::XUS>>($t5)), Eq(6, $t10))), And(And($t2, exists[@190]<Diem::Preburn<XUS::XUS>>($t5)), Eq(1, $t10))), And(And($t2, Not(Diem::spec_is_currency[@188]<XUS::XUS>())), Eq(5, $t10))), And(And(Not($t2), Diem::$is_synthetic_currency[@191]<#0>()), Eq(7, $t10))), And(And(Not($t2), exists[@192]<Diem::PreburnQueue<#0>>($t5)), Eq(6, $t10))), And(And(Not($t2), exists[@193]<Diem::Preburn<#0>>($t5)), Eq(1, $t10))), And(And(Not($t2), Not(Diem::spec_is_currency[@191]<#0>())), Eq(5, $t10))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:79:5+762
    assert {:msg "assert_failed(9,2999,3761): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((((((((!$ResourceExists($1_Roles_RoleId_$memory#186, $t6) && $IsEqual'u8'(5, $t10)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#186, $t6)), 1) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#186, $t7) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#186, $t7)), 2) && $IsEqual'u8'(3, $t10))) || ($ResourceExists($1_DesignatedDealer_Dealer_$memory#187, $t5) && $IsEqual'u8'(6, $t10))) || (($t2 && $1_Diem_$is_synthetic_currency'$1_XUS_XUS'($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#188)) && $IsEqual'u8'(7, $t10))) || (($t2 && $ResourceExists($1_Diem_PreburnQueue'$1_XUS_XUS'_$memory#189, $t5)) && $IsEqual'u8'(6, $t10))) || (($t2 && $ResourceExists($1_Diem_Preburn'$1_XUS_XUS'_$memory#190, $t5)) && $IsEqual'u8'(1, $t10))) || (($t2 && !$1_Diem_spec_is_currency'$1_XUS_XUS'($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#188)) && $IsEqual'u8'(5, $t10))) || ((!$t2 && $1_Diem_$is_synthetic_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#191)) && $IsEqual'u8'(7, $t10))) || ((!$t2 && $ResourceExists($1_Diem_PreburnQueue'#0'_$memory#192, $t5)) && $IsEqual'u8'(6, $t10))) || ((!$t2 && $ResourceExists($1_Diem_Preburn'#0'_$memory#193, $t5)) && $IsEqual'u8'(1, $t10))) || ((!$t2 && !$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#191)) && $IsEqual'u8'(5, $t10)));
...
procedure {:timeLimit 40} $1_DesignatedDealer_tiered_mint$verify(_$t0: int, _$t1: int, _$t2: int, _$t3: int) returns ($ret0: $1_Diem_Diem'#0')
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_Diem_MintCapability'#0'_$memory#182: $Memory $1_Diem_MintCapability'#0';
    var $1_Roles_RoleId_$memory#183: $Memory $1_Roles_RoleId;
    var $1_DesignatedDealer_Dealer_$memory#184: $Memory $1_DesignatedDealer_Dealer;
    var $1_Diem_CurrencyInfo'#0'_$memory#185: $Memory $1_Diem_CurrencyInfo'#0';
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    $t3 := _$t3;
    ...
    // assume true at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:130:5+1246
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:552:9+318
    assume true;
    ...
    // @183 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:168:9+45
    $1_Roles_RoleId_$memory#183 := $1_Roles_RoleId_$memory;

    // @185 := save_mem(Diem::CurrencyInfo<#0>) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:168:9+45
    $1_Diem_CurrencyInfo'#0'_$memory#185 := $1_Diem_CurrencyInfo'#0'_$memory;

    // @182 := save_mem(Diem::MintCapability<#0>) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:168:9+45
    $1_Diem_MintCapability'#0'_$memory#182 := $1_Diem_MintCapability'#0'_$memory;

    // @184 := save_mem(DesignatedDealer::Dealer) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:168:9+45
    $1_DesignatedDealer_Dealer_$memory#184 := $1_DesignatedDealer_Dealer_$memory;
...
L7:
    ...
    // assert Not(Not(exists[@182]<Diem::MintCapability<#0>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:182:9+120
    assume {:print "$at(9,7801,7921)"} true;
    assert {:msg "assert_failed(9,7801,7921): function does not abort under this condition"}
      !!$ResourceExists($1_Diem_MintCapability'#0'_$memory#182, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@183]<Roles::RoleId>($t9))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    assume {:print "$at(26,24063,24122)"} true;
    assert {:msg "assert_failed(26,24063,24122): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#183, $t9);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@183]<Roles::RoleId>($t9)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    assume {:print "$at(26,24131,24228)"} true;
    assert {:msg "assert_failed(26,24131,24228): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#183, $t9)), 1);
    ...
    // assert Not(Not(exists[@184]<DesignatedDealer::Dealer>($t2))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:22:9+62
    assume {:print "$at(9,643,705)"} true;
    assert {:msg "assert_failed(9,643,705): function does not abort under this condition"}
      !!$ResourceExists($1_DesignatedDealer_Dealer_$memory#184, $t2);

    // assert Not(Not(select Diem::CurrencyInfo.can_mint(Diem::spec_currency_info[@185]<#0>()))) at /home/ying/diem/language/diem-framework/modules/Diem.move:446:9+78
    assume {:print "$at(10,21552,21630)"} true;
    assert {:msg "assert_failed(10,21552,21630): function does not abort under this condition"}
      !!$can_mint#$1_Diem_CurrencyInfo'#0'($1_Diem_spec_currency_info'#0'($1_Diem_CurrencyInfo'#0'_$memory#185));

    // assert Not(Gt(Add(select Diem::CurrencyInfo.total_value(Diem::spec_currency_info[@185]<#0>()), $t1), MaxU128())) at /home/ying/diem/language/diem-framework/modules/Diem.move:447:9+102
    assume {:print "$at(10,21639,21741)"} true;
    assert {:msg "assert_failed(10,21639,21741): function does not abort under this condition"}
      !(($total_value#$1_Diem_CurrencyInfo'#0'($1_Diem_spec_currency_info'#0'($1_Diem_CurrencyInfo'#0'_$memory#185)) + $t1) > $MAX_U128);

    // assert Not(Not(Diem::spec_is_currency[@185]<#0>())) at /home/ying/diem/language/diem-framework/modules/Diem.move:1551:9+67
    assume {:print "$at(10,73620,73687)"} true;
    assert {:msg "assert_failed(10,73620,73687): function does not abort under this condition"}
      !!$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#185);
...
L8:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Eq<u64>($t1, 0), Not(exists[@182]<Diem::MintCapability<#0>>(Signer::spec_address_of[]($t0)))), Not(exists[@183]<Roles::RoleId>($t9))), Neq<u64>(select Roles::RoleId.role_id(global[@183]<Roles::RoleId>($t9)), 1)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), Not(exists[@184]<DesignatedDealer::Dealer>($t2))), Not(select Diem::CurrencyInfo.can_mint(Diem::spec_currency_info[@185]<#0>()))), Gt(Add(select Diem::CurrencyInfo.total_value(Diem::spec_currency_info[@185]<#0>()), $t1), MaxU128())), Not(Diem::spec_is_currency[@185]<#0>())) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:159:5+844
    assume {:print "$at(9,6656,7500)"} true;
    assert {:msg "assert_failed(9,6656,7500): abort not covered by any of the `aborts_if` clauses"}
      (((((((($IsEqual'u64'($t1, 0) || !$ResourceExists($1_Diem_MintCapability'#0'_$memory#182, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#183, $t9)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#183, $t9)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || !$ResourceExists($1_DesignatedDealer_Dealer_$memory#184, $t2)) || !$can_mint#$1_Diem_CurrencyInfo'#0'($1_Diem_spec_currency_info'#0'($1_Diem_CurrencyInfo'#0'_$memory#185))) || (($total_value#$1_Diem_CurrencyInfo'#0'($1_Diem_spec_currency_info'#0'($1_Diem_CurrencyInfo'#0'_$memory#185)) + $t1) > $MAX_U128)) || !$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#185));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(And(Eq<u64>($t1, 0), Eq(7, $t12)), And(Not(exists[@182]<Diem::MintCapability<#0>>(Signer::spec_address_of[]($t0))), Eq(4, $t12))), And(Not(exists[@183]<Roles::RoleId>($t9)), Eq(5, $t12))), And(Neq<u64>(select Roles::RoleId.role_id(global[@183]<Roles::RoleId>($t9)), 1), Eq(3, $t12))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t12))), And(Not(exists[@184]<DesignatedDealer::Dealer>($t2)), Eq(5, $t12))), And(Not(select Diem::CurrencyInfo.can_mint(Diem::spec_currency_info[@185]<#0>())), Eq(1, $t12))), And(Gt(Add(select Diem::CurrencyInfo.total_value(Diem::spec_currency_info[@185]<#0>()), $t1), MaxU128()), Eq(8, $t12))), And(Not(Diem::spec_is_currency[@185]<#0>()), Eq(5, $t12))) at /home/ying/diem/language/diem-framework/modules/DesignatedDealer.move:159:5+844
    assert {:msg "assert_failed(9,6656,7500): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((($IsEqual'u64'($t1, 0) && $IsEqual'u8'(7, $t12)) || (!$ResourceExists($1_Diem_MintCapability'#0'_$memory#182, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t12))) || (!$ResourceExists($1_Roles_RoleId_$memory#183, $t9) && $IsEqual'u8'(5, $t12))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#183, $t9)), 1) && $IsEqual'u8'(3, $t12))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t12))) || (!$ResourceExists($1_DesignatedDealer_Dealer_$memory#184, $t2) && $IsEqual'u8'(5, $t12))) || (!$can_mint#$1_Diem_CurrencyInfo'#0'($1_Diem_spec_currency_info'#0'($1_Diem_CurrencyInfo'#0'_$memory#185)) && $IsEqual'u8'(1, $t12))) || ((($total_value#$1_Diem_CurrencyInfo'#0'($1_Diem_spec_currency_info'#0'($1_Diem_CurrencyInfo'#0'_$memory#185)) + $t1) > $MAX_U128) && $IsEqual'u8'(8, $t12))) || (!$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#185) && $IsEqual'u8'(5, $t12)));
...
procedure {:inline 1} $1_DiemSystem_initialize_validator_set(_$t0: int) returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemConfig_Configuration_$memory#147: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
...
L8:
    ...
    // @147 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    $1_DiemConfig_Configuration_$memory#147 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@147](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#147), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L7:
    ...
    // @165 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@165](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L7:
    ...
    // @159 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@159](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
