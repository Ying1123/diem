...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 276053) (let ((anon15_Then_correct  (=> $t14@0 (and (=> (= (ControlFlow 0 195513) (- 0 276376)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 195513) (- 0 276389)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 6)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 6))) (and (=> (= (ControlFlow 0 195513) (- 0 276408)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0))))
 :qid |Rolesbpl.4920:15|
 :skolemid |127|
 ...
 :qid |Rolesbpl.4940:15|
 :skolemid |132|
)) (=> (= (ControlFlow 0 195513) (- 0 276702)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6))))
 :qid |Rolesbpl.4944:15|
 :skolemid |133|
))))))))))))))))))))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 195024) (- 0 276782)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 6)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 6))) (=> (= (ControlFlow 0 195024) (- 0 276806)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (= 5 $t10@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 6)) (= 3 $t10@0))))))))
(let ((anon15_Else_correct  (=> (and (and (not $t14@0) (= $t16 $t16)) (and (= $t10@0 $t16) (= (ControlFlow 0 195114) 195024))) L5_correct)))
(let ((anon14_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= $t12@0 (|$role_id#$1_Roles_RoleId| $t11@1)) (|$IsValid'u64'| 6)) (and (= $t14@0 (= $t12@0 6)) (|$IsValid'u64'| 9))) (and (and (|$IsValid'u64'| $t16) (= $t16 3)) (and (= $t16 $t16) (= $t14@0 $t14@0)))) (and (=> (= (ControlFlow 0 195098) 195513) anon15_Then_correct) (=> (= (ControlFlow 0 195098) 195114) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 195527) 195024))) L5_correct)))
(let ((anon13_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 195579) 195527) anon14_Then_correct) (=> (= (ControlFlow 0 195579) 195098) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) (= (ControlFlow 0 195577) 195579)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6) (=> (and (and (= $t11@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 195042) 195527) anon14_Then_correct) (=> (= (ControlFlow 0 195042) 195098) anon14_Else_correct))))))
...
(let ((anon12_Else_correct  (=> (and (and (not $t7@0) (= $t9 $t9)) (and (= $t10@0 $t9) (= (ControlFlow 0 194944) 195024))) L5_correct)))
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Rolesbpl.4763:20|
 :skolemid |126|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $a_0))
))) (and (= _$t0 _$t0) (|$IsValid'address'| $t6))) (=> (and (and (and (= $t6 (|$addr#$signer| _$t0)) (= $t6 $t6)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= $t7@0 $t7@0)))) (and (=> (= (ControlFlow 0 194928) 195028) anon12_Then_correct) (=> (= (ControlFlow 0 194928) 194944) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_83264_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 194824) 194928)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 276053) 194824) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))
))
(check-sat)
(pop 1)
