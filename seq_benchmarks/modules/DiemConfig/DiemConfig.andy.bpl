...
// fun DiemTimestamp::is_genesis [baseline] at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:125:5+89
procedure {:inline 1} $1_DiemTimestamp_is_genesis() returns ($ret0: bool)
{
    ...
    // $t0 := 0xa550c18 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:126:42+9
    assume {:print "$at(17,5229,5238)"} true;
    $t0 := 173345816;
    assume $IsValid'address'($t0);

    // $t1 := exists<DiemTimestamp::CurrentTimeMicroseconds>($t0) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:126:10+6
    $t1 := $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $t0);

    // $t2 := !($t1) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:126:9+1
    call $t2 := $Not($t1);

    // trace_return[0]($t2) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:126:9+43
    ...
    assume {:print "$at(17,5244,5245)"} true;
L1:

    // return $t2 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:127:5+1
    $ret0 := $t2;
    return;
...
procedure {:timeLimit 40} $1_DiemTimestamp_update_global_time$verify(_$t0: int, _$t1: int, _$t2: int) returns ()
{
    ...
    // @106 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:9+52
...
L5:
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:54:5+794
    ...
    // @239 := save_mem(DiemConfig::DiemConfig<DiemSystem::DiemSystem>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:54:5+794
    ...
    // @239 := save_mem(DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:54:5+794
    // state save for global update invariants
    ...
    // @239 := save_mem(DiemConfig::DiemConfig<DiemTransactionPublishingOption::DiemTransactionPublishingOption>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:54:5+794
    // state save for global update invariants
    ...
    // @239 := save_mem(DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:54:5+794
    // state save for global update invariants
    ...
    // @239 := save_mem(DiemConfig::DiemConfig<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:54:5+794
    // state save for global update invariants
    ...
    // @239 := save_mem(DiemConfig::DiemConfig<#0>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:54:5+794
    // state save for global update invariants
    ...
    // assert Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:409:9+62
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:409:9+62
    assume {:print "$at(13,17494,17556)"} true;
    assert {:msg "assert_failed(13,17494,17556): global memory invariant does not hold"}
    ...
    // assert Implies(DiemTimestamp::$is_operating(), And(And(And(And(And(Implies(DiemConfig::spec_is_published<DiemSystem::DiemSystem>(), DiemConfig::spec_is_published[@239]<DiemSystem::DiemSystem>()), Implies(DiemConfig::spec_is_published<RegisteredCurrencies::RegisteredCurrencies>(), DiemConfig::spec_is_published[@239]<RegisteredCurrencies::RegisteredCurrencies>())), Implies(DiemConfig::spec_is_published<DiemTransactionPublishingOption::DiemTransactionPublishingOption>(), DiemConfig::spec_is_published[@239]<DiemTransactionPublishingOption::DiemTransactionPublishingOption>())), Implies(DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>(), DiemConfig::spec_is_published[@239]<DiemVMConfig::DiemVMConfig>())), Implies(DiemConfig::spec_is_published<DiemVersion::DiemVersion>(), DiemConfig::spec_is_published[@239]<DiemVersion::DiemVersion>())), Implies(DiemConfig::spec_is_published<#0>(), DiemConfig::spec_is_published[@239]<#0>()))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:420:9+184
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:420:9+184
    assume {:print "$at(13,17921,18105)"} true;
    assert {:msg "assert_failed(13,17921,18105): global memory invariant does not hold"}
...
L7:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@106]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
...
L8:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_operating[@106]()), Neq<address>(Signer::spec_address_of[]($t0), 0)), (if Eq<address>($t1, 0) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}})) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:74:5+745
    assume {:print "$at(17,3378,4123)"} true;
    assert {:msg "assert_failed(17,3378,4123): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#106) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 0)) || if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)));

    // assert Or(Or(And(Not(DiemTimestamp::$is_operating[@106]()), Eq(1, $t11)), And(Neq<address>(Signer::spec_address_of[]($t0), 0), Eq(2, $t11))), And((if Eq<address>($t1, 0) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}}), Eq(7, $t11))) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:74:5+745
    assert {:msg "assert_failed(17,3378,4123): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#106) && $IsEqual'u8'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 0) && $IsEqual'u8'(2, $t11))) || (if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'u8'(7, $t11)));
...
function {:inline} $1_DiemConfig_$get'#0'($1_DiemConfig_DiemConfig'#0'_$memory: $Memory $1_DiemConfig_DiemConfig'#0'): #0 {
    (var addr := 173345816; $payload#$1_DiemConfig_DiemConfig'#0'($ResourceValue($1_DiemConfig_DiemConfig'#0'_$memory, addr)))
}
...
// spec fun at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:319:10+156
...
function {:inline} $1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory: $Memory $1_DiemConfig_DiemConfig'#0'): bool {
    $ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory, 173345816)
}
...
// struct DiemConfig::DiemConfig<#0> at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:12:5+156
...
// struct DiemConfig::ModifyConfigCapability<#0> at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:35:5+57
...
// fun DiemConfig::initialize [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:52:5+510
procedure {:timeLimit 40} $1_DiemConfig_initialize$verify(_$t0: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:52:5+510
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(13,2064,2574)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:52:5+510
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:409:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:52:5+510
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:52:5+510
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:52:5+510
    ...
    // assume CanModify<DiemConfig::Configuration>(a550c18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:71:9+42
    assume {:print "$at(13,2699,2741)"} true;
    assume $1_DiemConfig_Configuration_$modifies[173345816];

    // assume CanModify<Event::EventHandleGenerator>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:72:9+82
    assume {:print "$at(13,2750,2832)"} true;
    assume $1_Event_EventHandleGenerator_$modifies[$1_Signer_spec_address_of($t0)];

    // @139 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:72:9+82
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @138 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:72:9+82
    $1_DiemConfig_Configuration_$memory#138 := $1_DiemConfig_Configuration_$memory;

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:52:5+1
    assume {:print "$at(13,2064,2065)"} true;
    assume {:print "$track_local(13,4,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:9+31
    // >> opaque call: DiemTimestamp::assert_genesis()
    assume {:print "$at(13,2132,2163)"} true;

    // opaque begin: DiemTimestamp::assert_genesis() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:9+31

    // assume Identical($t3, Not(DiemTimestamp::$is_genesis())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:9+31
    assume ($t3 == !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t3) goto L5 else goto L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:9+31
    if ($t3) { goto L5; } else { goto L4; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:9+31
L5:

    // assume And(Not(DiemTimestamp::$is_genesis()), Eq(1, $t4)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:9+31
    assume (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t4));

    // trace_abort($t4) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:9+31
    assume {:print "$at(13,2132,2163)"} true;
    assume {:print "$track_abort(13,4):", $t4} $t4 == $t4;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:9+31
    goto L3;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:9+31
L4:

    // opaque end: DiemTimestamp::assert_genesis() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:9+31

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:56:9+43
    // >> opaque call: CoreAddresses::assert_diem_root($t0)
    assume {:print "$at(13,2173,2216)"} true;

    // opaque begin: CoreAddresses::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:56:9+43

    // assume Identical($t5, Neq<address>(Signer::spec_address_of($t0), a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:56:9+43
    assume ($t5 == !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816));

    // if ($t5) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:56:9+43
    if ($t5) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:56:9+43
L7:

    // assume And(Neq<address>(Signer::spec_address_of($t0), a550c18), Eq(2, $t4)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:56:9+43
    assume (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t4));

    // trace_abort($t4) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:56:9+43
    assume {:print "$at(13,2173,2216)"} true;
    assume {:print "$track_abort(13,4):", $t4} $t4 == $t4;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:56:9+43
    goto L3;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:56:9+43
L6:

    // opaque end: CoreAddresses::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:56:9+43

    // $t6 := 0xa550c18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:39+9
    assume {:print "$at(13,2256,2265)"} true;
    $t6 := 173345816;
    assume $IsValid'address'($t6);

    // $t7 := exists<DiemConfig::Configuration>($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:17+6
    $t7 := $ResourceExists($1_DiemConfig_Configuration_$memory, $t6);

    // $t8 := !($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:16+1
    call $t8 := $Not($t7);

    // $t9 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:77+14
    $t9 := 0;
    assume $IsValid'u64'($t9);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:51+41
    // >> opaque call: $t7 := Errors::already_published($t6)

    // $t10 := opaque begin: Errors::already_published($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:51+41

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:51+41
    assume $IsValid'u64'($t10);

    // assume Eq<u64>($t10, 6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:51+41
    assume $IsEqual'u64'($t10, 6);

    // $t10 := opaque end: Errors::already_published($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:51+41

    // trace_local[tmp#$2]($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:9+84
    assume {:print "$track_local(13,4,2):", $t10} $t10 == $t10;

    // trace_local[tmp#$1]($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:9+84
    assume {:print "$track_local(13,4,1):", $t8} $t8 == $t8;

    // if ($t8) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:9+84
    if ($t8) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:9+84
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:9+84

    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:9+84
    assume {:print "$at(13,2226,2310)"} true;
    assume {:print "$track_abort(13,4):", $t10} $t10 == $t10;

    // $t4 := move($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:9+84
    $t4 := $t10;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:57:9+84
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:59:13+10
    assume {:print "$at(13,2356,2366)"} true;
L0:

    // $t11 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:61:24+1
    assume {:print "$at(13,2419,2420)"} true;
    $t11 := 0;
    assume $IsValid'u64'($t11);

    // $t12 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:62:44+1
    assume {:print "$at(13,2465,2466)"} true;
    $t12 := 0;
    assume $IsValid'u64'($t12);

    // $t13 := Event::new_event_handle<DiemConfig::NewEpochEvent>($t0) on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:63:25+50
    assume {:print "$at(13,2492,2542)"} true;
    ...
    // $t14 := pack DiemConfig::Configuration($t11, $t12, $t13) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:13+177
    assume {:print "$at(13,2380,2557)"} true;
    $t14 := $1_DiemConfig_Configuration($t11, $t12, $t13);

    // assert CanModify<DiemConfig::Configuration>($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+7
    assume {:print "$at(13,2320,2327)"} true;
    assert {:msg "assert_failed(13,2320,2327): caller does not have permission to modify `DiemConfig::Configuration` at given address"}
      $1_DiemConfig_Configuration_$modifies[$t0];

    // move_to<DiemConfig::Configuration>($t14, $t0) on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+7
    ...
    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:66:5+1
    assume {:print "$at(13,2573,2574)"} true;
L2:

    // assume Identical($t15, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:82:9+56
    assume {:print "$at(13,3181,3237)"} true;
    assume ($t15 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assert Not(DiemConfig::spec_has_config[@138]()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:78:9+59
    assume {:print "$at(13,3036,3095)"} true;
    assert {:msg "assert_failed(13,3036,3095): function does not abort under this condition"}
      !$1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#138);

    // assert Not(Not(DiemTimestamp::$is_genesis[@139]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:140:9+51
    ...
    // assert DiemConfig::spec_has_config() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:81:9+26
    assume {:print "$at(13,3146,3172)"} true;
    assert {:msg "assert_failed(13,3146,3172): post-condition does not hold"}
      $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory);

    // assert Eq<u64>(select DiemConfig::Configuration.epoch($t15), 0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:83:9+31
    assume {:print "$at(13,3246,3277)"} true;
    assert {:msg "assert_failed(13,3246,3277): post-condition does not hold"}
      $IsEqual'u64'($epoch#$1_DiemConfig_Configuration($t15), 0);

    // assert Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t15), 0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:84:9+51
    assume {:print "$at(13,3286,3337)"} true;
    assert {:msg "assert_failed(13,3286,3337): post-condition does not hold"}
      $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t15), 0);

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:84:9+51
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:66:5+1
    assume {:print "$at(13,2573,2574)"} true;
L3:

    // assert Or(Or(DiemConfig::spec_has_config[@138](), Not(DiemTimestamp::$is_genesis[@139]())), Neq<address>(Signer::spec_address_of[]($t0), a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:67:5+259
    assume {:print "$at(13,2579,2838)"} true;
    assert {:msg "assert_failed(13,2579,2838): abort not covered by any of the `aborts_if` clauses"}
      (($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#138) || !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816));

    // assert Or(Or(And(DiemConfig::spec_has_config[@138](), Eq(6, $t4)), And(Not(DiemTimestamp::$is_genesis[@139]()), Eq(1, $t4))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t4))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:67:5+259
    assert {:msg "assert_failed(13,2579,2838): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#138) && $IsEqual'u8'(6, $t4)) || (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139) && $IsEqual'u8'(1, $t4))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t4)));

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:67:5+259
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun DiemConfig::disable_reconfiguration [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:177:5+374
procedure {:timeLimit 40} $1_DiemConfig_disable_reconfiguration$verify(_$t0: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:177:5+374
    assume {:print "$at(13,7335,7709)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:177:5+374
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:177:5+374
    ...
    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:177:5+1
    assume {:print "$track_local(13,0,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:179:13+30
    // >> opaque call: $t5 := Signer::address_of($t0)
    assume {:print "$at(13,7414,7444)"} true;

    // $t5 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:179:13+30

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:179:13+30
    assume $IsValid'address'($t5);

    // assume Eq<address>($t5, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:179:13+30
    assume $IsEqual'address'($t5, $1_Signer_spec_address_of($t0));

    // $t5 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:179:13+30

    // $t6 := 0xa550c18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:179:47+9
    $t6 := 173345816;
    assume $IsValid'address'($t6);

    // $t7 := ==($t5, $t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:179:44+2
    $t7 := $IsEqual'address'($t5, $t6);

    // $t8 := 1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:180:38+12
    assume {:print "$at(13,7496,7508)"} true;
    $t8 := 1;
    assume $IsValid'u64'($t8);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:180:13+38
    // >> opaque call: $t9 := Errors::requires_address($t8)

    // $t9 := opaque begin: Errors::requires_address($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:180:13+38

    // assume WellFormed($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:180:13+38
    assume $IsValid'u64'($t9);

    // assume Eq<u64>($t9, 2) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:180:13+38
    assume $IsEqual'u64'($t9, 2);

    // $t9 := opaque end: Errors::requires_address($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:180:13+38

    // trace_local[tmp#$2]($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:178:9+125
    assume {:print "$at(13,7394,7519)"} true;
    assume {:print "$track_local(13,0,2):", $t9} $t9 == $t9;

    // trace_local[tmp#$1]($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:178:9+125
    assume {:print "$track_local(13,0,1):", $t7} $t7 == $t7;

    // if ($t7) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:178:9+125
    if ($t7) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:178:9+125
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:178:9+125

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:178:9+125
    assume {:print "$at(13,7394,7519)"} true;
    assume {:print "$track_abort(13,0):", $t9} $t9 == $t9;

    // $t10 := move($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:178:9+125
    $t10 := $t9;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:178:9+125
    goto L5;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:33+10
    assume {:print "$at(13,7553,7563)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:9+35
    ...
    // opaque begin: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:9+35
    assume {:print "$at(13,7529,7564)"} true;

    // assume Identical($t12, Or(Or(Or(Neq<address>(Signer::spec_address_of($t0), a550c18), Not(exists<Roles::RoleId>($t11))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t11)), 0)), Neq<address>(Signer::spec_address_of($t0), a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:9+35
...
L7:
    ...
    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:9+35
    assume {:print "$at(13,7529,7564)"} true;
    assume {:print "$track_abort(13,0):", $t10} $t10 == $t10;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:9+35
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:9+35
L6:

    // opaque end: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:9+35

    // $t13 := DiemConfig::reconfiguration_enabled() on_abort goto L5 with $t10 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:16+25
    assume {:print "$at(13,7581,7606)"} true;
    ...
    // $t14 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:65+14
    $t14 := 0;
    assume $IsValid'u64'($t14);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:43+37
    // >> opaque call: $t12 := Errors::invalid_state($t11)

    // $t15 := opaque begin: Errors::invalid_state($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:43+37

    // assume WellFormed($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:43+37
    assume $IsValid'u64'($t15);

    // assume Eq<u64>($t15, 1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:43+37
    assume $IsEqual'u64'($t15, 1);

    // $t15 := opaque end: Errors::invalid_state($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:43+37

    // trace_local[tmp#$4]($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:9+72
    assume {:print "$track_local(13,0,4):", $t15} $t15 == $t15;

    // trace_local[tmp#$3]($t13) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:9+72
    assume {:print "$track_local(13,0,3):", $t13} $t13 == $t13;

    // if ($t13) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:9+72
    if ($t13) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:9+72
L3:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:9+72

    // trace_abort($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:9+72
    assume {:print "$at(13,7574,7646)"} true;
    assume {:print "$track_abort(13,0):", $t15} $t15 == $t15;

    // $t10 := move($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:9+72
    $t10 := $t15;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:9+72
    goto L5;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:184:17+10
    assume {:print "$at(13,7664,7674)"} true;
L2:

    // $t16 := false at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:184:29+25
    $t16 := false;
    assume $IsValid'bool'($t16);

    // $t17 := pack DiemConfig::DisableReconfiguration($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:184:29+25
    $t17 := $1_DiemConfig_DisableReconfiguration($t16);

    // move_to<DiemConfig::DisableReconfiguration>($t17, $t0) on_abort goto L5 with $t10 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:184:9+7
    ...
    if ($abort_flag) {
        assume {:print "$at(13,7656,7663)"} true;
        $t10 := $abort_code;
        assume {:print "$track_abort(13,0):", $t10} $t10 == $t10;
        goto L5;
    }

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:5+1
    assume {:print "$at(13,7708,7709)"} true;
L4:

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:5+1
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:5+1
L5:

    // abort($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:5+1
    $abort_code := $t10;
    $abort_flag := true;
    return;
...
// fun DiemConfig::emit_genesis_reconfiguration_event [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:379:5+557
procedure {:timeLimit 40} $1_DiemConfig_emit_genesis_reconfiguration_event$verify() returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:379:5+557
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:409:9+62
    assume {:print "$at(13,16390,16947)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:379:5+557
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_Configuration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_Configuration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_Configuration'($rsc))));

    // $t6 := 0xa550c18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:38+9
    assume {:print "$at(13,16493,16502)"} true;
    $t6 := 173345816;
    assume $IsValid'address'($t6);

    // $t7 := exists<DiemConfig::Configuration>($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:16+6
    $t7 := $ResourceExists($1_DiemConfig_Configuration_$memory, $t6);

    // $t8 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:72+14
    $t8 := 0;
    assume $IsValid'u64'($t8);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:50+37
    // >> opaque call: $t9 := Errors::not_published($t8)

    // $t9 := opaque begin: Errors::not_published($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:50+37

    // assume WellFormed($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:50+37
    assume $IsValid'u64'($t9);

    // assume Eq<u64>($t9, 5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:50+37
    assume $IsEqual'u64'($t9, 5);

    // $t9 := opaque end: Errors::not_published($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:50+37

    // trace_local[tmp#$2]($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:9+79
    assume {:print "$track_local(13,1,2):", $t9} $t9 == $t9;

    // trace_local[tmp#$1]($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:9+79
    assume {:print "$track_local(13,1,1):", $t7} $t7 == $t7;

    // if ($t7) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:9+79
    if ($t7) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:9+79
L1:

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:9+79
    assume {:print "$at(13,16464,16543)"} true;
    assume {:print "$track_abort(13,1):", $t9} $t9 == $t9;

    // $t10 := move($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:9+79
    $t10 := $t9;

    // goto L9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:380:9+79
    goto L9;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:381:59+9
    assume {:print "$at(13,16603,16612)"} true;
L0:

    // $t11 := 0xa550c18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:381:59+9
    $t11 := 173345816;
    assume $IsValid'address'($t11);

    // $t12 := borrow_global<DiemConfig::Configuration>($t11) on_abort goto L9 with $t10 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:381:26+17
    ...
    if ($abort_flag) {
        assume {:print "$at(13,16570,16587)"} true;
        $t10 := $abort_code;
        assume {:print "$track_abort(13,1):", $t10} $t10 == $t10;
        goto L9;
    }

    // trace_local[config_ref]($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:381:13+10
    $temp_0'$1_DiemConfig_Configuration' := $Dereference($t12);
    assume {:print "$track_local(13,1,0):", $temp_0'$1_DiemConfig_Configuration'} $temp_0'$1_DiemConfig_Configuration' == $temp_0'$1_DiemConfig_Configuration';

    // $t13 := get_field<DiemConfig::Configuration>.epoch($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+16
    assume {:print "$at(13,16630,16646)"} true;
    $t13 := $epoch#$1_DiemConfig_Configuration($Dereference($t12));

    // $t14 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:36+1
    $t14 := 0;
    assume $IsValid'u64'($t14);

    // $t15 := ==($t13, $t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:33+2
    $t15 := $IsEqual'u64'($t13, $t14);

    // if ($t15) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+66
    if ($t15) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+66
L3:

    // goto L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+66
    goto L4;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:41+10
L2:

    // $t16 := get_field<DiemConfig::Configuration>.last_reconfiguration_time($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:41+36
    $t16 := $last_reconfiguration_time#$1_DiemConfig_Configuration($Dereference($t12));

    // $t17 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:81+1
    $t17 := 0;
    assume $IsValid'u64'($t17);

    // $t18 := ==($t16, $t17) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:78+2
    $t18 := $IsEqual'u64'($t16, $t17);

    // $t5 := $t18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+66
    $t5 := $t18;

    // trace_local[tmp#$5]($t18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+66
    assume {:print "$track_local(13,1,5):", $t18} $t18 == $t18;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+66
    goto L5;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+66
L4:

    // $t19 := false at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+66
    $t19 := false;
    assume $IsValid'bool'($t19);

    // $t5 := $t19 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+66
    $t5 := $t19;

    // trace_local[tmp#$5]($t19) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+66
    assume {:print "$track_local(13,1,5):", $t19} $t19 == $t19;

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:16+66
L5:

    // $t20 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:106+14
    $t20 := 0;
    assume $IsValid'u64'($t20);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:84+37
    // >> opaque call: $t20 := Errors::invalid_state($t19)

    // $t21 := opaque begin: Errors::invalid_state($t20) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:84+37

    // assume WellFormed($t21) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:84+37
    assume $IsValid'u64'($t21);

    // assume Eq<u64>($t21, 1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:84+37
    assume $IsEqual'u64'($t21, 1);

    // $t21 := opaque end: Errors::invalid_state($t20) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:84+37

    // trace_local[tmp#$4]($t21) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:9+113
    assume {:print "$track_local(13,1,4):", $t21} $t21 == $t21;

    // trace_local[tmp#$3]($t5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:9+113
    assume {:print "$track_local(13,1,3):", $t5} $t5 == $t5;

    // if ($t5) goto L6 else goto L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:9+113
    if ($t5) { goto L6; } else { goto L7; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:9+113
L7:

    // destroy($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:9+113

    // trace_abort($t21) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:9+113
    assume {:print "$at(13,16623,16736)"} true;
    assume {:print "$track_abort(13,1):", $t21} $t21 == $t21;

    // $t10 := move($t21) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:9+113
    $t10 := $t21;

    // goto L9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:9+113
    goto L9;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:28+1
    assume {:print "$at(13,16765,16766)"} true;
L6:

    // $t22 := 1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:28+1
    $t22 := 1;
    assume $IsValid'u64'($t22);

    // $t23 := borrow_field<DiemConfig::Configuration>.epoch($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:9+16
    $t23 := $ChildMutation($t12, 0, $epoch#$1_DiemConfig_Configuration($Dereference($t12)));

    // write_ref($t23, $t22) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:9+20
    $t23 := $UpdateMutation($t23, $t22);

    // write_back[Reference($t12).epoch]($t23) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:9+20
    $t12 := $UpdateMutation($t12, $Update'$1_DiemConfig_Configuration'_epoch($Dereference($t12), $Dereference($t23)));

    // $t24 := borrow_field<DiemConfig::Configuration>.events($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:386:13+22
    assume {:print "$at(13,16823,16845)"} true;
    $t24 := $ChildMutation($t12, 2, $events#$1_DiemConfig_Configuration($Dereference($t12)));

    // $t25 := get_field<DiemConfig::Configuration>.epoch($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:388:24+16
    assume {:print "$at(13,16898,16914)"} true;
    $t25 := $epoch#$1_DiemConfig_Configuration($Dereference($t12));

    // $t26 := pack DiemConfig::NewEpochEvent($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:387:13+70
    assume {:print "$at(13,16859,16929)"} true;
    $t26 := $1_DiemConfig_NewEpochEvent($t25);

    // Event::emit_event<DiemConfig::NewEpochEvent>($t24, $t26) on_abort goto L9 with $t10 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:9+163
    assume {:print "$at(13,16777,16940)"} true;
    ...
    // write_back[DiemConfig::Configuration@]($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:9+163
    ...
    // label L8 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:391:5+1
    assume {:print "$at(13,16946,16947)"} true;
L8:

    // assume Identical($t27, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:393:9+51
    assume {:print "$at(13,17002,17053)"} true;
    assume ($t27 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t28, select DiemConfig::Configuration.events($t27)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:394:9+32
    assume {:print "$at(13,17062,17094)"} true;
    assume ($t28 == $events#$1_DiemConfig_Configuration($t27));

    // assume Identical($t29, pack DiemConfig::NewEpochEvent(select DiemConfig::Configuration.epoch($t27))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:395:9+78
    assume {:print "$at(13,17103,17181)"} true;
    assume ($t29 == $1_DiemConfig_NewEpochEvent($epoch#$1_DiemConfig_Configuration($t27)));

    // assert EventStoreIncludes(ExtendEventStore(EmptyEventStore(), $t29, $t28)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:398:9+20
    assume {:print "$at(13,17190,17210)"} true;
    assert {:msg "assert_failed(13,17190,17210): function does not emit the expected event"}
    ...
    // assert EventStoreIncludedIn(ExtendEventStore(EmptyEventStore(), $t29, $t28)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:392:5+264
    assume {:print "$at(13,16952,17216)"} true;
    assert {:msg "assert_failed(13,16952,17216): emitted event not covered by any of the `emits` clauses"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:392:5+264
    return;

    // label L9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:391:5+1
    assume {:print "$at(13,16946,16947)"} true;
L9:

    // abort($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:391:5+1
    $abort_code := $t10;
    $abort_flag := true;
    return;
...
// fun DiemConfig::enable_reconfiguration [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:189:5+454
procedure {:timeLimit 40} $1_DiemConfig_enable_reconfiguration$verify(_$t0: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:189:5+454
    assume {:print "$at(13,7887,8341)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:189:5+454
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:189:5+454
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DisableReconfiguration'($rsc))));

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:189:5+1
    assume {:print "$track_local(13,2,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:191:13+30
    // >> opaque call: $t5 := Signer::address_of($t0)
    assume {:print "$at(13,7997,8027)"} true;

    // $t5 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:191:13+30

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:191:13+30
    assume $IsValid'address'($t5);

    // assume Eq<address>($t5, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:191:13+30
    assume $IsEqual'address'($t5, $1_Signer_spec_address_of($t0));

    // $t5 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:191:13+30

    // $t6 := 0xa550c18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:191:47+9
    $t6 := 173345816;
    assume $IsValid'address'($t6);

    // $t7 := ==($t5, $t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:191:44+2
    $t7 := $IsEqual'address'($t5, $t6);

    // $t8 := 1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:192:38+12
    assume {:print "$at(13,8079,8091)"} true;
    $t8 := 1;
    assume $IsValid'u64'($t8);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:192:13+38
    // >> opaque call: $t9 := Errors::requires_address($t8)

    // $t9 := opaque begin: Errors::requires_address($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:192:13+38

    // assume WellFormed($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:192:13+38
    assume $IsValid'u64'($t9);

    // assume Eq<u64>($t9, 2) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:192:13+38
    assume $IsEqual'u64'($t9, 2);

    // $t9 := opaque end: Errors::requires_address($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:192:13+38

    // trace_local[tmp#$2]($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:190:9+125
    assume {:print "$at(13,7977,8102)"} true;
    assume {:print "$track_local(13,2,2):", $t9} $t9 == $t9;

    // trace_local[tmp#$1]($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:190:9+125
    assume {:print "$track_local(13,2,1):", $t7} $t7 == $t7;

    // if ($t7) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:190:9+125
    if ($t7) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:190:9+125
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:190:9+125

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:190:9+125
    assume {:print "$at(13,7977,8102)"} true;
    assume {:print "$track_abort(13,2):", $t9} $t9 == $t9;

    // $t10 := move($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:190:9+125
    $t10 := $t9;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:190:9+125
    goto L5;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:33+10
    assume {:print "$at(13,8136,8146)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:9+35
    // >> opaque call: Roles::assert_diem_root($t0)
    ...
    // opaque begin: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:9+35
    assume {:print "$at(13,8112,8147)"} true;

    // assume Identical($t12, Or(Or(Or(Neq<address>(Signer::spec_address_of($t0), a550c18), Not(exists<Roles::RoleId>($t11))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t11)), 0)), Neq<address>(Signer::spec_address_of($t0), a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:9+35
    assume ($t12 == (((!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) || !$ResourceExists($1_Roles_RoleId_$memory, $t11)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t11)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)));

    // if ($t12) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:9+35
    if ($t12) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:9+35
L7:

    // assume Or(Or(Or(And(Neq<address>(Signer::spec_address_of($t0), a550c18), Eq(2, $t10)), And(Not(exists<Roles::RoleId>($t11)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t11)), 0), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of($t0), a550c18), Eq(2, $t10))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:9+35
    assume ((((!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t10)) || (!$ResourceExists($1_Roles_RoleId_$memory, $t11) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t11)), 0) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t10)));

    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:9+35
    assume {:print "$at(13,8112,8147)"} true;
    assume {:print "$track_abort(13,2):", $t10} $t10 == $t10;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:9+35
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:9+35
L6:

    // opaque end: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:9+35

    // $t13 := DiemConfig::reconfiguration_enabled() on_abort goto L5 with $t10 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:17+25
    assume {:print "$at(13,8166,8191)"} true;
    call $t13 := $1_DiemConfig_reconfiguration_enabled();
    if ($abort_flag) {
        assume {:print "$at(13,8166,8191)"} true;
        $t10 := $abort_code;
    ...
    // $t14 := !($t13) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:16+1
    call $t14 := $Not($t13);

    // $t15 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:66+14
    $t15 := 0;
    assume $IsValid'u64'($t15);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:44+37
    // >> opaque call: $t13 := Errors::invalid_state($t12)

    // $t16 := opaque begin: Errors::invalid_state($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:44+37

    // assume WellFormed($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:44+37
    assume $IsValid'u64'($t16);

    // assume Eq<u64>($t16, 1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:44+37
    assume $IsEqual'u64'($t16, 1);

    // $t16 := opaque end: Errors::invalid_state($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:44+37

    // trace_local[tmp#$4]($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:9+73
    assume {:print "$track_local(13,2,4):", $t16} $t16 == $t16;

    // trace_local[tmp#$3]($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:9+73
    assume {:print "$track_local(13,2,3):", $t14} $t14 == $t14;

    // if ($t14) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:9+73
    if ($t14) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:9+73
L3:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:9+73

    // trace_abort($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:9+73
    assume {:print "$at(13,8158,8231)"} true;
    assume {:print "$track_abort(13,2):", $t16} $t16 == $t16;

    // $t10 := move($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:9+73
    $t10 := $t16;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:196:9+73
    goto L5;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:90+10
    assume {:print "$at(13,8322,8332)"} true;
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:71+30
    // >> opaque call: $t14 := Signer::address_of($t0)

    // $t17 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:71+30

    // assume WellFormed($t17) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:71+30
    assume $IsValid'address'($t17);

    // assume Eq<address>($t17, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:71+30
    assume $IsEqual'address'($t17, $1_Signer_spec_address_of($t0));

    // $t17 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:71+30

    // $t18 := move_from<DiemConfig::DisableReconfiguration>($t17) on_abort goto L5 with $t10 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:37+9
    ...
    if ($abort_flag) {
        assume {:print "$at(13,8269,8278)"} true;
        $t10 := $abort_code;
        assume {:print "$track_abort(13,2):", $t10} $t10 == $t10;
        goto L5;
    }

    // $t19 := unpack DiemConfig::DisableReconfiguration($t18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+25
    $t19 := $dummy_field#$1_DiemConfig_DisableReconfiguration($t18);

    // destroy($t19) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+25

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:198:5+1
    assume {:print "$at(13,8340,8341)"} true;
L4:

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:198:5+1
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:198:5+1
L5:

    // abort($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:198:5+1
    $abort_code := $t10;
    $abort_flag := true;
    return;
...
// fun DiemConfig::get [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:89:5+260
procedure {:timeLimit 40} $1_DiemConfig_get$verify() returns ($ret0: #0)
{
    ...
    // bytecode translation starts here
    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<#0>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:98:17+6
    assume {:print "$at(13,3773,3779)"} true;
    ...
    // @90 := save_mem(DiemConfig::DiemConfig<#0>) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:89:5+1
    assume {:print "$at(13,3412,3413)"} true;
    $1_DiemConfig_DiemConfig'#0'_$memory#90 := $1_DiemConfig_DiemConfig'#0'_$memory;

    // $t3 := 0xa550c18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:91:20+9
    assume {:print "$at(13,3511,3520)"} true;
    $t3 := 173345816;
    assume $IsValid'address'($t3);

    // trace_local[addr]($t3) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:91:13+4
    assume {:print "$track_local(13,3,0):", $t3} $t3 == $t3;

    // $t4 := exists<DiemConfig::DiemConfig<#0>>($t3) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:16+6
    assume {:print "$at(13,3537,3543)"} true;
    $t4 := $ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory, $t3);

    // $t5 := 1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:72+12
    $t5 := 1;
    assume $IsValid'u64'($t5);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:50+35
    // >> opaque call: $t6 := Errors::not_published($t5)

    // $t6 := opaque begin: Errors::not_published($t5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:50+35

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:50+35
    assume $IsValid'u64'($t6);

    // assume Eq<u64>($t6, 5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:50+35
    assume $IsEqual'u64'($t6, 5);

    // $t6 := opaque end: Errors::not_published($t5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:50+35

    // trace_local[tmp#$2]($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:9+77
    assume {:print "$track_local(13,3,2):", $t6} $t6 == $t6;

    // trace_local[tmp#$1]($t4) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:9+77
    assume {:print "$track_local(13,3,1):", $t4} $t4 == $t4;

    // if ($t4) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:9+77
    if ($t4) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:9+77
L1:

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:9+77
    assume {:print "$at(13,3530,3607)"} true;
    assume {:print "$track_abort(13,3):", $t6} $t6 == $t6;

    // $t7 := move($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:9+77
    $t7 := $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:9+77
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:93:45+4
    assume {:print "$at(13,3653,3657)"} true;
L0:

    // $t8 := get_global<DiemConfig::DiemConfig<#0>>($t3) on_abort goto L3 with $t7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:93:11+13
    ...
    if ($abort_flag) {
        assume {:print "$at(13,3619,3632)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(13,3):", $t7} $t7 == $t7;
        goto L3;
    }

    // $t9 := get_field<DiemConfig::DiemConfig<#0>>.payload($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:93:10+48
    $t9 := $payload#$1_DiemConfig_DiemConfig'#0'($t8);

    // trace_return[0]($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:93:9+49
    assume {:print "$track_return(13,3,0):", $t9} $t9 == $t9;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:94:5+1
    assume {:print "$at(13,3671,3672)"} true;
L2:

    // assert Not(Not(exists[@90]<DiemConfig::DiemConfig<#0>>(a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:101:9+76
    assume {:print "$at(13,3859,3935)"} true;
    assert {:msg "assert_failed(13,3859,3935): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory#90, 173345816);

    // assert Eq<#0>($t9, DiemConfig::$get<#0>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:98:9+32
    assume {:print "$at(13,3765,3797)"} true;
    assert {:msg "assert_failed(13,3765,3797): post-condition does not hold"}
      $IsEqual'#0'($t9, $1_DiemConfig_$get'#0'($1_DiemConfig_DiemConfig'#0'_$memory));

    // return $t9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:98:9+32
    $ret0 := $t9;
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:94:5+1
    assume {:print "$at(13,3671,3672)"} true;
L3:

    // assert Not(exists[@90]<DiemConfig::DiemConfig<#0>>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:5+126
    assume {:print "$at(13,3677,3803)"} true;
    assert {:msg "assert_failed(13,3677,3803): abort not covered by any of the `aborts_if` clauses"}
      !$ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory#90, 173345816);

    // assert And(Not(exists[@90]<DiemConfig::DiemConfig<#0>>(a550c18)), Eq(5, $t7)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:5+126
    assert {:msg "assert_failed(13,3677,3803): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory#90, 173345816) && $IsEqual'u8'(5, $t7));

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:5+126
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun DiemConfig::publish_new_config [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:236:5+430
procedure {:timeLimit 40} $1_DiemConfig_publish_new_config$verify(_$t0: int, _$t1: #0) returns ()
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:236:5+430
    assume {:print "$at(13,9884,10314)"} true;
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:236:5+430
    assume $IsValid'#0'($t1);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:236:5+430
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<#0>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:236:5+430
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DiemConfig'#0'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DiemConfig'#0'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DiemConfig'#0''($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<#0>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:236:5+430
    ...
    // assume CanModify<DiemConfig::DiemConfig<#0>>(a550c18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:249:9+47
    assume {:print "$at(13,10376,10423)"} true;
    assume $1_DiemConfig_DiemConfig'#0'_$modifies[173345816];

    // assume CanModify<DiemConfig::ModifyConfigCapability<#0>>(a550c18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:250:9+59
    assume {:print "$at(13,10432,10491)"} true;
    assume $1_DiemConfig_ModifyConfigCapability'#0'_$modifies[173345816];

    // @135 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:250:9+59
    $1_Roles_RoleId_$memory#135 := $1_Roles_RoleId_$memory;

    // @136 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:250:9+59
    $1_DiemConfig_Configuration_$memory#136 := $1_DiemConfig_Configuration_$memory;

    // @133 := save_mem(DiemConfig::DiemConfig<#0>) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:250:9+59
    $1_DiemConfig_DiemConfig'#0'_$memory#133 := $1_DiemConfig_DiemConfig'#0'_$memory;

    // @134 := save_mem(DiemConfig::ModifyConfigCapability<#0>) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:250:9+59
    $1_DiemConfig_ModifyConfigCapability'#0'_$memory#134 := $1_DiemConfig_ModifyConfigCapability'#0'_$memory;

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:236:5+1
    assume {:print "$at(13,9884,9885)"} true;
    assume {:print "$track_local(13,5,0):", $t0} $t0 == $t0;

    // trace_local[payload]($t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:236:5+1
    assume {:print "$track_local(13,5,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    // >> opaque call: $t5 := DiemConfig::publish_new_config_and_get_capability<#0>($t0, $t1)
    assume {:print "$at(13,10030,10096)"} true;
    ...
    // assert CanModify<DiemConfig::DiemConfig<#0>>(a550c18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    assume {:print "$at(13,10030,10096)"} true;
    assert {:msg "assert_failed(13,10030,10096): caller does not have permission to modify `DiemConfig::DiemConfig<#0>` at given address"}
      $1_DiemConfig_DiemConfig'#0'_$modifies[173345816];

    // $t7 := opaque begin: DiemConfig::publish_new_config_and_get_capability<#0>($t0, $t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66

    // assume Identical($t8, Or(Or(Or(Not(exists<Roles::RoleId>($t6)), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t6)), 0)), Neq<address>(Signer::spec_address_of($t0), a550c18)), exists<DiemConfig::DiemConfig<#0>>(a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    assume ($t8 == (((!$ResourceExists($1_Roles_RoleId_$memory, $t6) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t6)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || $ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory, 173345816)));

    // if ($t8) goto L5 else goto L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    if ($t8) { goto L5; } else { goto L4; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
L5:

    // assume Or(Or(Or(And(Not(exists<Roles::RoleId>($t6)), Eq(5, $t9)), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t6)), 0), Eq(3, $t9))), And(Neq<address>(Signer::spec_address_of($t0), a550c18), Eq(2, $t9))), And(exists<DiemConfig::DiemConfig<#0>>(a550c18), Eq(6, $t9))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    assume ((((!$ResourceExists($1_Roles_RoleId_$memory, $t6) && $IsEqual'u8'(5, $t9)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t6)), 0) && $IsEqual'u8'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t9))) || ($ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory, 173345816) && $IsEqual'u8'(6, $t9)));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    assume {:print "$at(13,10030,10096)"} true;
    assume {:print "$track_abort(13,5):", $t9} $t9 == $t9;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    goto L3;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
L4:

    // @137 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    $1_DiemConfig_Configuration_$memory#137 := $1_DiemConfig_Configuration_$memory;

    // modifies global<DiemConfig::DiemConfig<#0>>(a550c18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    havoc $temp_0'bool';
    if ($temp_0'bool') {
        havoc $temp_0'$1_DiemConfig_DiemConfig'#0'';
        $1_DiemConfig_DiemConfig'#0'_$memory := $ResourceUpdate($1_DiemConfig_DiemConfig'#0'_$memory, 173345816, $temp_0'$1_DiemConfig_DiemConfig'#0'');
    } else {
        $1_DiemConfig_DiemConfig'#0'_$memory := $ResourceRemove($1_DiemConfig_DiemConfig'#0'_$memory, 173345816);
    }

    // assume WellFormed($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    assume $IsValid'$1_DiemConfig_ModifyConfigCapability'#0''($t7);

    // assume DiemConfig::spec_is_published<#0>() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    assume $1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory);

    // assume Eq<#0>(DiemConfig::$get<#0>(), $t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    assume $IsEqual'#0'($1_DiemConfig_$get'#0'($1_DiemConfig_DiemConfig'#0'_$memory), $t1);

    // assume Eq<bool>(DiemConfig::spec_has_config[@137](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66
    ...
    // $t7 := opaque end: DiemConfig::publish_new_config_and_get_capability<#0>($t0, $t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:26+66

    // trace_local[capability]($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:240:13+10
    assume {:print "$track_local(13,5,2):", $t7} $t7 == $t7;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:242:53+30
    // >> opaque call: $t6 := Signer::address_of($t0)
    assume {:print "$at(13,10166,10196)"} true;

    // $t10 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:242:53+30

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:242:53+30
    assume $IsValid'address'($t10);

    // assume Eq<address>($t10, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:242:53+30
    assume $IsEqual'address'($t10, $1_Signer_spec_address_of($t0));

    // $t10 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:242:53+30

    // $t11 := exists<DiemConfig::ModifyConfigCapability<#0>>($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:242:14+6
    $t11 := $ResourceExists($1_DiemConfig_ModifyConfigCapability'#0'_$memory, $t10);

    // $t12 := !($t11) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:242:13+1
    call $t12 := $Not($t11);

    // $t13 := 2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:39+18
    assume {:print "$at(13,10237,10255)"} true;
    $t13 := 2;
    assume $IsValid'u64'($t13);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:13+45
    // >> opaque call: $t10 := Errors::already_published($t9)

    // $t14 := opaque begin: Errors::already_published($t13) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:13+45

    // assume WellFormed($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:13+45
    assume $IsValid'u64'($t14);

    // assume Eq<u64>($t14, 6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:13+45
    assume $IsEqual'u64'($t14, 6);

    // $t14 := opaque end: Errors::already_published($t13) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:13+45

    // trace_local[tmp#$4]($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:241:9+160
    assume {:print "$at(13,10106,10266)"} true;
    assume {:print "$track_local(13,5,4):", $t14} $t14 == $t14;

    // trace_local[tmp#$3]($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:241:9+160
    assume {:print "$track_local(13,5,3):", $t12} $t12 == $t12;

    // if ($t12) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:241:9+160
    if ($t12) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:241:9+160
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:241:9+160

    // trace_abort($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:241:9+160
    assume {:print "$at(13,10106,10266)"} true;
    assume {:print "$track_abort(13,5):", $t14} $t14 == $t14;

    // $t9 := move($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:241:9+160
    $t9 := $t14;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:241:9+160
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:245:17+10
    assume {:print "$at(13,10284,10294)"} true;
L0:

    // assert CanModify<DiemConfig::ModifyConfigCapability<#0>>($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:245:9+7
    assert {:msg "assert_failed(13,10276,10283): caller does not have permission to modify `DiemConfig::ModifyConfigCapability<#0>` at given address"}
      $1_DiemConfig_ModifyConfigCapability'#0'_$modifies[$t0];

    // move_to<DiemConfig::ModifyConfigCapability<#0>>($t7, $t0) on_abort goto L3 with $t9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:245:9+7
    ...
    if ($abort_flag) {
        assume {:print "$at(13,10276,10283)"} true;
        $t9 := $abort_code;
        assume {:print "$track_abort(13,5):", $t9} $t9 == $t9;
        goto L3;
    }

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:246:5+1
    assume {:print "$at(13,10313,10314)"} true;
L2:

    // assert Not(DiemConfig::spec_is_published[@133]<#0>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:257:9+38
    ...
    // assert Not(exists[@134]<DiemConfig::ModifyConfigCapability<#0>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:258:9+86
    ...
    // assert Not(Not(exists[@135]<Roles::RoleId>($t5))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@135]<Roles::RoleId>($t5)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    ...
    // assert exists<DiemConfig::ModifyConfigCapability<#0>>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:264:9+84
    ...
    // assert DiemConfig::spec_is_published<#0>() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:142:9+36
    ...
    // assert Eq<#0>(DiemConfig::$get<#0>(), $t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:143:9+33
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@136](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:144:9+52
    ...
    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:246:5+1
    assume {:print "$at(13,10313,10314)"} true;
L3:

    // assert Or(Or(Or(Or(DiemConfig::spec_is_published[@133]<#0>(), exists[@134]<DiemConfig::ModifyConfigCapability<#0>>(Signer::spec_address_of[]($t0))), Not(exists[@135]<Roles::RoleId>($t5))), Neq<u64>(select Roles::RoleId.role_id(global[@135]<Roles::RoleId>($t5)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:247:5+277
    assume {:print "$at(13,10319,10596)"} true;
    assert {:msg "assert_failed(13,10319,10596): abort not covered by any of the `aborts_if` clauses"}
    ...
    // assert Or(Or(Or(Or(DiemConfig::spec_is_published[@133]<#0>(), exists[@134]<DiemConfig::ModifyConfigCapability<#0>>(Signer::spec_address_of[]($t0))), And(Not(exists[@135]<Roles::RoleId>($t5)), Eq(5, $t9))), And(Neq<u64>(select Roles::RoleId.role_id(global[@135]<Roles::RoleId>($t5)), 0), Eq(3, $t9))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t9))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:247:5+277
    assert {:msg "assert_failed(13,10319,10596): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((($1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory#133) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'#0'_$memory#134, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory#135, $t5) && $IsEqual'u8'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#135, $t5)), 0) && $IsEqual'u8'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t9)));

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:247:5+277
    $abort_code := $t9;
    $abort_flag := true;
    return;
...
// fun DiemConfig::reconfiguration_enabled [baseline] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:5+94
procedure {:inline 1} $1_DiemConfig_reconfiguration_enabled() returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // $t0 := 0xa550c18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:201:41+9
    assume {:print "$at(13,8425,8434)"} true;
    $t0 := 173345816;
    assume $IsValid'address'($t0);

    // $t1 := exists<DiemConfig::DisableReconfiguration>($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:201:10+6
    $t1 := $ResourceExists($1_DiemConfig_DisableReconfiguration_$memory, $t0);

    // $t2 := !($t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:201:9+1
    call $t2 := $Not($t1);

    // trace_return[0]($t2) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:201:9+42
    assume {:print "$track_return(13,7,0):", $t2} $t2 == $t2;

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:202:5+1
    assume {:print "$at(13,8440,8441)"} true;
L1:

    // return $t2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:202:5+1
    $ret0 := $t2;
    return;

}

// fun DiemConfig::reconfiguration_enabled [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:5+94
procedure {:timeLimit 40} $1_DiemConfig_reconfiguration_enabled$verify() returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:5+94
    assume {:print "$at(13,8347,8441)"} true;
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DisableReconfiguration'($rsc))));
...
// fun DiemConfig::reconfigure [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:268:5+158
procedure {:timeLimit 40} $1_DiemConfig_reconfigure$verify(_$t0: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:268:5+158
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(13,11221,11379)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:268:5+158
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:409:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:268:5+158
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:268:5+158
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:268:5+158
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:268:5+158
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_Configuration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_Configuration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_Configuration'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:268:5+158
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DisableReconfiguration'($rsc))));
    ...
    // assume Identical($t2, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:357:9+46
    assume {:print "$at(13,15374,15420)"} true;
    assume ($t2 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t3, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:358:9+58
    ...
    // assume CanModify<DiemConfig::Configuration>(a550c18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:276:9+42
    assume {:print "$at(13,11434,11476)"} true;
    assume $1_DiemConfig_Configuration_$modifies[173345816];

    // @146 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:276:9+42
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @145 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:276:9+42
    $1_Roles_RoleId_$memory#145 := $1_Roles_RoleId_$memory;

    // @147 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:276:9+42
    $1_DiemConfig_DisableReconfiguration_$memory#147 := $1_DiemConfig_DisableReconfiguration_$memory;

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:268:5+1
    assume {:print "$at(13,11221,11222)"} true;
    assume {:print "$track_local(13,8,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:9+35
    // >> opaque call: Roles::assert_diem_root($t0)
    assume {:print "$at(13,11313,11348)"} true;
    ...
    // opaque begin: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:9+35
    assume {:print "$at(13,11313,11348)"} true;

    // assume Identical($t5, Or(Or(Or(Neq<address>(Signer::spec_address_of($t0), a550c18), Not(exists<Roles::RoleId>($t4))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t4)), 0)), Neq<address>(Signer::spec_address_of($t0), a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:9+35
...
L4:
    ...
    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:9+35
    assume {:print "$at(13,11313,11348)"} true;
    assume {:print "$track_abort(13,8):", $t6} $t6 == $t6;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:9+35
    goto L2;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:9+35
L3:

    // opaque end: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:9+35

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14
    // >> opaque call: DiemConfig::reconfigure_()
    assume {:print "$at(13,11358,11372)"} true;

    // assume Identical($t7, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:326:9+46
    assume {:print "$at(13,13660,13706)"} true;
    assume ($t7 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t8, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:328:9+49
    assume {:print "$at(13,13780,13829)"} true;
    assume ($t8 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t9, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:349:9+46
    assume {:print "$at(13,14900,14946)"} true;
    assume ($t9 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t10, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:350:9+58
    assume {:print "$at(13,14955,15013)"} true;
    assume ($t10 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t11, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:357:9+46
    assume {:print "$at(13,15374,15420)"} true;
    assume ($t11 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t12, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:358:9+58
    assume {:print "$at(13,15429,15487)"} true;
    assume ($t12 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t13, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:367:9+46
    assume {:print "$at(13,15829,15875)"} true;
    assume ($t13 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t14, select DiemConfig::Configuration.events($t13)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:373:9+27
    assume {:print "$at(13,16100,16127)"} true;
    assume ($t14 == $events#$1_DiemConfig_Configuration($t13));

    // assert CanModify<DiemConfig::Configuration>(a550c18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14
    assume {:print "$at(13,11358,11372)"} true;
    assert {:msg "assert_failed(13,11358,11372): caller does not have permission to modify `DiemConfig::Configuration` at given address"}
      $1_DiemConfig_Configuration_$modifies[173345816];

    // opaque begin: DiemConfig::reconfigure_() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14

    // assume Identical($t15, And(Or(Not(DiemConfig::spec_reconfigure_omitted()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t11), $t8)), And(And(And(And(DiemTimestamp::$is_operating(), DiemConfig::$reconfiguration_enabled()), Gt(DiemTimestamp::spec_now_microseconds(), 0)), Lt(select DiemConfig::Configuration.epoch($t11), 18446744073709551615)), Lt($t12, select DiemConfig::Configuration.last_reconfiguration_time($t11))))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14
    ...
    // if ($t15) goto L6 else goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14
    if ($t15) { goto L6; } else { goto L5; }

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14
L6:
    ...
    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14
    assume {:print "$at(13,11358,11372)"} true;
    assume {:print "$track_abort(13,8):", $t6} $t6 == $t6;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14
    goto L2;

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14
L5:

    // @148 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14
    $1_DiemConfig_Configuration_$memory#148 := $1_DiemConfig_Configuration_$memory;

    // modifies global<DiemConfig::Configuration>(a550c18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14
    havoc $temp_0'bool';
    if ($temp_0'bool') {
    ...
    // assume Identical($t16, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:327:9+56
    assume {:print "$at(13,13715,13771)"} true;
    assume ($t16 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t17, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:329:9+59
    assume {:print "$at(13,13838,13897)"} true;
    assume ($t17 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t18, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:368:9+56
    assume {:print "$at(13,15884,15940)"} true;
    assume ($t18 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t19, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:369:9+54
    assume {:print "$at(13,15949,16003)"} true;
    assume ($t19 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t20, pack DiemConfig::NewEpochEvent(select DiemConfig::Configuration.epoch($t18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:370:9+79
    assume {:print "$at(13,16012,16091)"} true;
    assume ($t20 == $1_DiemConfig_NewEpochEvent($epoch#$1_DiemConfig_Configuration($t18)));

    // assume Eq<bool>(DiemConfig::spec_has_config[@148](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:370:9+79
    ...
    // assume Implies(Or(DiemConfig::spec_reconfigure_omitted(), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t7), $t8)), Eq<DiemConfig::Configuration>($t16, $t7)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:370:9+79
    ...
    // assume Identical($t21, $t20) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:370:9+79
    assume ($t21 == $t20);

    // assume Identical($t22, $t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:370:9+79
    assume ($t22 == $t14);

    // assume Identical($t23, And(Not(DiemConfig::spec_reconfigure_omitted()), Neq<u64>($t19, select DiemConfig::Configuration.last_reconfiguration_time($t13)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:370:9+79
    ...
    // emit_event($t21, $t22, $t23) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:272:9+14
    assume {:print "$at(13,11358,11372)"} true;
    $es := $CondExtendEventStore'$1_DiemConfig_NewEpochEvent'($es, $t22, $t21, $t23);

    // opaque end: DiemConfig::reconfigure_() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:370:9+79
    assume {:print "$at(13,16012,16091)"} true;

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:273:5+1
    assume {:print "$at(13,11378,11379)"} true;
L1:

    // assert Not(Not(exists[@145]<Roles::RoleId>($t1))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    assume {:print "$at(26,23574,23633)"} true;
    assert {:msg "assert_failed(26,23574,23633): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#145, $t1);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t1)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    assume {:print "$at(26,23642,23729)"} true;
    assert {:msg "assert_failed(26,23642,23729): function does not abort under this condition"}
    ...
    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:273:5+1
    assume {:print "$at(13,11378,11379)"} true;
L2:

    // assert Or(Or(Or(Not(exists[@145]<Roles::RoleId>($t1)), Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t1)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), And(And(And(And(DiemTimestamp::$is_operating[@146](), DiemConfig::$reconfiguration_enabled[@147]()), Gt(DiemTimestamp::spec_now_microseconds[@146](), 0)), Lt(select DiemConfig::Configuration.epoch($t2), 18446744073709551615)), Lt($t3, select DiemConfig::Configuration.last_reconfiguration_time($t2)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:274:5+200
    assume {:print "$at(13,11384,11584)"} true;
    assert {:msg "assert_failed(13,11384,11584): abort not covered by any of the `aborts_if` clauses"}
      (((!$ResourceExists($1_Roles_RoleId_$memory#145, $t1) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t1)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#147)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) > 0)) && ($epoch#$1_DiemConfig_Configuration($t2) < 18446744073709551615)) && ($t3 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t2))));

    // assert Or(Or(Or(And(Not(exists[@145]<Roles::RoleId>($t1)), Eq(5, $t6)), And(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t1)), 0), Eq(3, $t6))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t6))), And(And(And(And(And(DiemTimestamp::$is_operating[@146](), DiemConfig::$reconfiguration_enabled[@147]()), Gt(DiemTimestamp::spec_now_microseconds[@146](), 0)), Lt(select DiemConfig::Configuration.epoch($t2), 18446744073709551615)), Lt($t3, select DiemConfig::Configuration.last_reconfiguration_time($t2))), Eq(1, $t6))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:274:5+200
    assert {:msg "assert_failed(13,11384,11584): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:274:5+200
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
// fun DiemConfig::reconfigure_ [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:283:5+1595
procedure {:timeLimit 40} $1_DiemConfig_reconfigure_$verify() returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:283:5+1595
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(13,11731,13326)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:283:5+1595
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:409:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:283:5+1595
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:283:5+1595
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_Configuration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_Configuration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_Configuration'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:283:5+1595
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DisableReconfiguration'($rsc))));

    // assume Identical($t6, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:326:9+46
    assume {:print "$at(13,13660,13706)"} true;
    assume ($t6 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t7, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:328:9+49
    assume {:print "$at(13,13780,13829)"} true;
    assume ($t7 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t8, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:349:9+46
    assume {:print "$at(13,14900,14946)"} true;
    assume ($t8 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t9, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:350:9+58
    assume {:print "$at(13,14955,15013)"} true;
    assume ($t9 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t10, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:357:9+46
    assume {:print "$at(13,15374,15420)"} true;
    assume ($t10 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t11, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:358:9+58
    assume {:print "$at(13,15429,15487)"} true;
    assume ($t11 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t12, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:367:9+46
    assume {:print "$at(13,15829,15875)"} true;
    assume ($t12 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t13, select DiemConfig::Configuration.events($t12)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:373:9+27
    assume {:print "$at(13,16100,16127)"} true;
    assume ($t13 == $events#$1_DiemConfig_Configuration($t12));

    // assume CanModify<DiemConfig::Configuration>(a550c18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:324:9+42
    assume {:print "$at(13,13548,13590)"} true;
    assume $1_DiemConfig_Configuration_$modifies[173345816];

    // @107 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:324:9+42
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @109 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:324:9+42
    $1_DiemConfig_Configuration_$memory#109 := $1_DiemConfig_Configuration_$memory;

    // @108 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:324:9+42
    $1_DiemConfig_DisableReconfiguration_$memory#108 := $1_DiemConfig_DisableReconfiguration_$memory;

    // $t14 := DiemTimestamp::is_genesis() on_abort goto L17 with $t15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+27
    assume {:print "$at(13,11846,11873)"} true;
    call $t14 := $1_DiemTimestamp_is_genesis();
    if ($abort_flag) {
        assume {:print "$at(13,11846,11873)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(13,9):", $t15} $t15 == $t15;
        goto L17;
    }

    // if ($t14) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+69
    if ($t14) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+69
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+69
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+69
L0:

    // $t16 := true at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+69
    $t16 := true;
    assume $IsValid'bool'($t16);

    // $t2 := $t16 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+69
    $t2 := $t16;

    // trace_local[tmp#$2]($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+69
    assume {:print "$track_local(13,9,2):", $t16} $t16 == $t16;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+69
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33
    // >> opaque call: $t8 := DiemTimestamp::now_microseconds()

    // $t17 := opaque begin: DiemTimestamp::now_microseconds() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33

    // assume Identical($t18, Not(DiemTimestamp::$is_operating())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33
    assume ($t18 == !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t18) goto L19 else goto L18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33
    if ($t18) { goto L19; } else { goto L18; }

    // label L19 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33
L19:

    // assume And(Not(DiemTimestamp::$is_operating()), Eq(1, $t15)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33
    assume (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t15));

    // trace_abort($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33
    assume {:print "$at(13,11877,11910)"} true;
    assume {:print "$track_abort(13,9):", $t15} $t15 == $t15;

    // goto L17 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33
    goto L17;

    // label L18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33
L18:

    // assume WellFormed($t17) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33
    assume $IsValid'u64'($t17);

    // assume Eq<u64>($t17, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33
    assume $IsEqual'u64'($t17, $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // $t17 := opaque end: DiemTimestamp::now_microseconds() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:44+33

    // $t19 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:81+1
    $t19 := 0;
    assume $IsValid'u64'($t19);

    // $t20 := ==($t17, $t19) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:78+2
    $t20 := $IsEqual'u64'($t17, $t19);

    // $t2 := $t20 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+69
    $t2 := $t20;

    // trace_local[tmp#$2]($t20) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+69
    assume {:print "$track_local(13,9,2):", $t20} $t20 == $t20;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+69
L3:

    // if ($t2) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+99
    if ($t2) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+99
L5:

    // goto L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+99
    goto L6;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+99
L4:

    // $t21 := true at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+99
    $t21 := true;
    assume $IsValid'bool'($t21);

    // $t3 := $t21 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+99
    $t3 := $t21;

    // trace_local[tmp#$3]($t21) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+99
    assume {:print "$track_local(13,9,3):", $t21} $t21 == $t21;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+99
    goto L7;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:87+25
L6:

    // $t22 := DiemConfig::reconfiguration_enabled() on_abort goto L17 with $t15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:87+25
    call $t22 := $1_DiemConfig_reconfiguration_enabled();
    if ($abort_flag) {
        assume {:print "$at(13,11920,11945)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(13,9):", $t15} $t15 == $t15;
        goto L17;
    }

    // $t23 := !($t22) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:86+1
    call $t23 := $Not($t22);

    // $t3 := $t23 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+99
    $t3 := $t23;

    // trace_local[tmp#$3]($t23) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+99
    assume {:print "$track_local(13,9,3):", $t23} $t23 == $t23;

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:13+99
L7:

    // if ($t3) goto L8 else goto L9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:9+138
    if ($t3) { goto L8; } else { goto L9; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:9+138
L9:

    // goto L10 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:285:9+138
    goto L10;

    // label L8 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:286:13+9
    assume {:print "$at(13,11961,11970)"} true;
L8:

    // goto L16 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:286:13+9
    goto L16;

    // label L10 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:289:59+9
    assume {:print "$at(13,12041,12050)"} true;
L10:

    // $t24 := 0xa550c18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:289:59+9
    $t24 := 173345816;
    assume $IsValid'address'($t24);

    // assert CanModify<DiemConfig::Configuration>($t24) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:289:26+17
    assert {:msg "assert_failed(13,12008,12025): caller does not have permission to modify `DiemConfig::Configuration` at given address"}
      $1_DiemConfig_Configuration_$modifies[$t24];

    // $t25 := borrow_global<DiemConfig::Configuration>($t24) on_abort goto L17 with $t15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:289:26+17
    ...
    if ($abort_flag) {
        assume {:print "$at(13,12008,12025)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(13,9):", $t15} $t15 == $t15;
        goto L17;
    }

    // trace_local[config_ref]($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:289:13+10
    $temp_0'$1_DiemConfig_Configuration' := $Dereference($t25);
    assume {:print "$track_local(13,9,0):", $temp_0'$1_DiemConfig_Configuration'} $temp_0'$1_DiemConfig_Configuration' == $temp_0'$1_DiemConfig_Configuration';

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33
    // >> opaque call: $t16 := DiemTimestamp::now_microseconds()
    assume {:print "$at(13,12080,12113)"} true;

    // $t26 := opaque begin: DiemTimestamp::now_microseconds() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33

    // assume Identical($t27, Not(DiemTimestamp::$is_operating())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33
    assume ($t27 == !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t27) goto L22 else goto L20 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33
    if ($t27) { goto L22; } else { goto L20; }

    // label L21 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33
L21:

    // assume And(Not(DiemTimestamp::$is_operating()), Eq(1, $t15)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33
    assume (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t15));

    // trace_abort($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33
    assume {:print "$at(13,12080,12113)"} true;
    assume {:print "$track_abort(13,9):", $t15} $t15 == $t15;

    // goto L17 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33
    goto L17;

    // label L20 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33
L20:

    // assume WellFormed($t26) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33
    assume $IsValid'u64'($t26);

    // assume Eq<u64>($t26, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33
    assume $IsEqual'u64'($t26, $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // $t26 := opaque end: DiemTimestamp::now_microseconds() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:28+33

    // trace_local[current_time]($t26) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:290:13+12
    assume {:print "$track_local(13,9,1):", $t26} $t26 == $t26;

    // $t28 := get_field<DiemConfig::Configuration>.last_reconfiguration_time($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:304:29+36
    assume {:print "$at(13,12853,12889)"} true;
    $t28 := $last_reconfiguration_time#$1_DiemConfig_Configuration($Dereference($t25));

    // $t29 := ==($t26, $t28) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:304:26+2
    $t29 := $IsEqual'u64'($t26, $t28);

    // if ($t29) goto L11 else goto L12 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:304:9+88
    if ($t29) { goto L11; } else { goto L12; }

    // label L12 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:304:9+88
L12:

    // goto L13 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:304:9+88
    goto L13;

    // label L11 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:305:13+6
    assume {:print "$at(13,12905,12911)"} true;
L11:

    // destroy($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:305:13+6

    // goto L16 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:305:13+6
    goto L16;

    // label L13 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:16+12
    assume {:print "$at(13,12939,12951)"} true;
L13:

    // $t30 := get_field<DiemConfig::Configuration>.last_reconfiguration_time($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:31+36
    $t30 := $last_reconfiguration_time#$1_DiemConfig_Configuration($Dereference($t25));

    // $t31 := >($t26, $t30) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:29+1
    call $t31 := $Gt($t26, $t30);

    // $t32 := 3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:91+19
    $t32 := 3;
    assume $IsValid'u64'($t32);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:69+42
    // >> opaque call: $t22 := Errors::invalid_state($t21)

    // $t33 := opaque begin: Errors::invalid_state($t32) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:69+42

    // assume WellFormed($t33) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:69+42
    assume $IsValid'u64'($t33);

    // assume Eq<u64>($t33, 1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:69+42
    assume $IsEqual'u64'($t33, 1);

    // $t33 := opaque end: Errors::invalid_state($t32) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:69+42

    // trace_local[tmp#$5]($t33) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:9+103
    assume {:print "$track_local(13,9,5):", $t33} $t33 == $t33;

    // trace_local[tmp#$4]($t31) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:9+103
    assume {:print "$track_local(13,9,4):", $t31} $t31 == $t31;

    // if ($t31) goto L14 else goto L15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:9+103
    if ($t31) { goto L14; } else { goto L15; }

    // label L15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:9+103
L15:

    // destroy($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:9+103

    // trace_abort($t33) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:9+103
    assume {:print "$at(13,12932,13035)"} true;
    assume {:print "$track_abort(13,9):", $t33} $t33 == $t33;

    // $t15 := move($t33) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:9+103
    $t15 := $t33;

    // goto L17 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:9+103
    goto L17;

    // label L14 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:309:48+12
    assume {:print "$at(13,13084,13096)"} true;
L14:

    // $t34 := borrow_field<DiemConfig::Configuration>.last_reconfiguration_time($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:309:9+36
    $t34 := $ChildMutation($t25, 1, $last_reconfiguration_time#$1_DiemConfig_Configuration($Dereference($t25)));

    // write_ref($t34, $t26) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:309:9+51
    $t34 := $UpdateMutation($t34, $t26);

    // write_back[Reference($t25).last_reconfiguration_time]($t34) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:309:9+51
    $t25 := $UpdateMutation($t25, $Update'$1_DiemConfig_Configuration'_last_reconfiguration_time($Dereference($t25), $Dereference($t34)));

    // $t35 := get_field<DiemConfig::Configuration>.epoch($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:310:28+16
    assume {:print "$at(13,13125,13141)"} true;
    $t35 := $epoch#$1_DiemConfig_Configuration($Dereference($t25));

    // $t36 := 1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:310:47+1
    $t36 := 1;
    assume $IsValid'u64'($t36);

    // $t37 := +($t35, $t36) on_abort goto L17 with $t15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:310:45+1
    call $t37 := $AddU64($t35, $t36);
    if ($abort_flag) {
        assume {:print "$at(13,13142,13143)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(13,9):", $t15} $t15 == $t15;
        goto L17;
    }

    // $t38 := borrow_field<DiemConfig::Configuration>.epoch($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:310:9+16
    $t38 := $ChildMutation($t25, 0, $epoch#$1_DiemConfig_Configuration($Dereference($t25)));

    // write_ref($t38, $t37) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:310:9+39
    $t38 := $UpdateMutation($t38, $t37);

    // write_back[Reference($t25).epoch]($t38) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:310:9+39
    $t25 := $UpdateMutation($t25, $Update'$1_DiemConfig_Configuration'_epoch($Dereference($t25), $Dereference($t38)));

    // $t39 := borrow_field<DiemConfig::Configuration>.events($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:313:13+22
    assume {:print "$at(13,13202,13224)"} true;
    $t39 := $ChildMutation($t25, 2, $events#$1_DiemConfig_Configuration($Dereference($t25)));

    // $t40 := get_field<DiemConfig::Configuration>.epoch($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:315:24+16
    assume {:print "$at(13,13277,13293)"} true;
    $t40 := $epoch#$1_DiemConfig_Configuration($Dereference($t25));

    // $t41 := pack DiemConfig::NewEpochEvent($t40) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:314:13+70
    assume {:print "$at(13,13238,13308)"} true;
    $t41 := $1_DiemConfig_NewEpochEvent($t40);

    // Event::emit_event<DiemConfig::NewEpochEvent>($t39, $t41) on_abort goto L17 with $t15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:312:9+163
    assume {:print "$at(13,13156,13319)"} true;
    ...
    // write_back[DiemConfig::Configuration@]($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:312:9+163
    ...
    // label L16 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:318:5+1
    assume {:print "$at(13,13325,13326)"} true;
L16:

    // assume Identical($t42, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:327:9+56
    assume {:print "$at(13,13715,13771)"} true;
    assume ($t42 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t43, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:329:9+59
    assume {:print "$at(13,13838,13897)"} true;
    assume ($t43 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t44, global<DiemConfig::Configuration>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:368:9+56
    assume {:print "$at(13,15884,15940)"} true;
    assume ($t44 == $ResourceValue($1_DiemConfig_Configuration_$memory, 173345816));

    // assume Identical($t45, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:369:9+54
    assume {:print "$at(13,15949,16003)"} true;
    assume ($t45 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t46, pack DiemConfig::NewEpochEvent(select DiemConfig::Configuration.epoch($t44))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:370:9+79
    assume {:print "$at(13,16012,16091)"} true;
    assume ($t46 == $1_DiemConfig_NewEpochEvent($epoch#$1_DiemConfig_Configuration($t44)));

    // assert Not(And(Or(Not(DiemConfig::spec_reconfigure_omitted[@107, @108]()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t8), $t7)), Lt($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:351:9+96
    assume {:print "$at(13,15022,15118)"} true;
    assert {:msg "assert_failed(13,15022,15118): function does not abort under this condition"}
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@109](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:325:9+52
    assume {:print "$at(13,13599,13651)"} true;
    assert {:msg "assert_failed(13,13599,13651): post-condition does not hold"}
    ...
    // assert Implies(Or(DiemConfig::spec_reconfigure_omitted(), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t6), $t7)), Eq<DiemConfig::Configuration>($t42, $t6)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:334:9+118
    assume {:print "$at(13,14065,14183)"} true;
    assert {:msg "assert_failed(13,14065,14183): post-condition does not hold"}
    ...
    // assert EventStoreIncludes(ExtendEventStore(EmptyEventStore(), $t46, $t13, And(Not(DiemConfig::spec_reconfigure_omitted()), Neq<u64>($t45, select DiemConfig::Configuration.last_reconfiguration_time($t12))))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:374:9+96
    assume {:print "$at(13,16136,16232)"} true;
    assert {:msg "assert_failed(13,16136,16232): function does not emit the expected event"}
    ...
    // assert EventStoreIncludedIn(ExtendEventStore(EmptyEventStore(), $t46, $t13, And(Not(DiemConfig::spec_reconfigure_omitted()), Neq<u64>($t45, select DiemConfig::Configuration.last_reconfiguration_time($t12))))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:322:5+1020
    assume {:print "$at(13,13497,14517)"} true;
    assert {:msg "assert_failed(13,13497,14517): emitted event not covered by any of the `emits` clauses"}
...
L17:
    ...
    assert {:msg "assert_failed(13,13497,14517): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:322:5+1020
    $abort_code := $t15;
    $abort_flag := true;
    return;
