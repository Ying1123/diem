...
(assert (not
 (=> (= (ControlFlow 0 0) 22559) (let ((anon0$1_correct@@0  (=> (= (|l#$Mutation_4535| _$t0@@0) ($Param 0)) (=> (and (and (and (|$IsValid'u64'| (|v#$Mutation_4535| _$t0@@0)) (= |$temp_0'u64'@0@@0| (|v#$Mutation_4535| _$t0@@0))) (and (= |$temp_0'u64'@0@@0| |$temp_0'u64'@0@@0|) (|$IsValid'u64'| 10))) (and (and (= $t0@0@@0 ($Mutation_4535 (|l#$Mutation_4535| _$t0@@0) (|p#$Mutation_4535| _$t0@@0) 10)) (= |$temp_0'u64'@1@@0| (|v#$Mutation_4535| $t0@0@@0))) (and (= |$temp_0'u64'@1@@0| |$temp_0'u64'@1@@0|) (= (ControlFlow 0 19485) (- 0 22663))))) (= (|v#$Mutation_4535| $t0@0@@0) 10)))))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 22559) 19485) anon0$1_correct@@0)))
anon0_correct@@0)))
))
(check-sat)
(pop 1)
...
(let ((anon6_Else_correct  (=> (and (not false) (= $t0@0@@1 (|v#$Mutation_4535| inline$$42_TestReferences_mut_b$0$$t0@1))) (=> (and (and (= $t0@1 (|v#$Mutation_4535| inline$$42_TestReferences_mut_b$0$$t0@1)) (= $t0@1 $t0@1)) (and (|$IsValid'u64'| 10) (= $t7@0  (not (= $t0@1 10))))) (and (=> (= (ControlFlow 0 19784) 19818) anon7_Then_correct) (=> (= (ControlFlow 0 19784) 19798) anon7_Else_correct))))))
...
(let ((anon0$1_correct@@1  (=> (and (|$IsValid'u64'| 20) (= 20 20)) (=> (and (and (= $t3@0 ($Mutation_4535 ($Local 0) (as seq.empty (Seq Int)) 20)) (= |$temp_0'u64'@0@@1| (|v#$Mutation_4535| $t3@0))) (and (= |$temp_0'u64'@0@@1| |$temp_0'u64'@0@@1|) (= (ControlFlow 0 19742) 19736))) inline$$42_TestReferences_mut_b$0$anon0_correct))))
(let ((anon0_correct@@1  (=> (= (seq.len (|p#$Mutation_4535| $t1)) 0) (=> (and (= (seq.len (|p#$Mutation_4535| $t3)) 0) (= (ControlFlow 0 19563) 19742)) anon0$1_correct@@1))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 22679) 19563) anon0_correct@@1)))
...
(assert (not
 (=> (= (ControlFlow 0 0) 22991) (let ((L4_correct@@0  (=> (= (ControlFlow 0 20196) (- 0 23286)) true)))
(let ((anon7_Then_correct@@0  (=> (and (and $t7@0@@0 (|$IsValid'u64'| 1)) (and (= 1 1) (= (ControlFlow 0 20186) 20196))) L4_correct@@0)))
(let ((anon7_Else_correct@@0  (=> (and (not $t7@0@@0) (= (ControlFlow 0 20166) (- 0 23279))) (not true))))
(let ((anon6_Else_correct@@0  (=> (and (not false) (= $t0@0@@2 (|v#$Mutation_4535| inline$$42_TestReferences_mut_b$0$$t0@1@@0))) (=> (and (and (= $t0@1@@0 (|v#$Mutation_4535| inline$$42_TestReferences_mut_b$0$$t0@1@@0)) (= $t0@1@@0 $t0@1@@0)) (and (|$IsValid'u64'| 10) (= $t7@0@@0  (not (= $t0@1@@0 10))))) (and (=> (= (ControlFlow 0 20152) 20186) anon7_Then_correct@@0) (=> (= (ControlFlow 0 20152) 20166) anon7_Else_correct@@0))))))
(let ((anon6_Then_correct@@0 true))
(let ((inline$$42_TestReferences_mut_b$0$anon0_correct@@0  (=> (and (= |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@1@@0| (|v#$Mutation_4535| $t3@0@@0)) (= |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@1@@0| |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@1@@0|)) (=> (and (and (|$IsValid'u64'| 10) (= inline$$42_TestReferences_mut_b$0$$t0@1@@0 ($Mutation_4535 (|l#$Mutation_4535| $t3@0@@0) (|p#$Mutation_4535| $t3@0@@0) 10))) (and (= |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@2@@0| (|v#$Mutation_4535| inline$$42_TestReferences_mut_b$0$$t0@1@@0)) (= |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@2@@0| |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@2@@0|))) (and (=> (= (ControlFlow 0 20104) 20210) anon6_Then_correct@@0) (=> (= (ControlFlow 0 20104) 20152) anon6_Else_correct@@0))))))
(let ((anon0$1_correct@@2  (=> (and (|$IsValid'u64'| 20) (= 20 20)) (=> (and (and (= $t3@0@@0 ($Mutation_4535 ($Local 0) (as seq.empty (Seq Int)) 20)) (= |$temp_0'u64'@0@@2| (|v#$Mutation_4535| $t3@0@@0))) (and (= |$temp_0'u64'@0@@2| |$temp_0'u64'@0@@2|) (= (ControlFlow 0 20110) 20104))) inline$$42_TestReferences_mut_b$0$anon0_correct@@0))))
(let ((anon0_correct@@2  (=> (= (seq.len (|p#$Mutation_4535| $t1@@0)) 0) (=> (and (= (seq.len (|p#$Mutation_4535| $t3@@0)) 0) (= (ControlFlow 0 19931) 20110)) anon0$1_correct@@2))))
(let ((PreconditionGeneratedEntry_correct@@0  (=> (= (ControlFlow 0 22991) 19931) anon0_correct@@2)))
...
(let ((|inline$$1_Vector_borrow_mut'u64'$0$anon3_Else_correct|  (=> (and (and (and (>= 0 0) (< 0 (seq.len |inline$$1_Vector_borrow_mut'u64'$0$v@1|))) (= |inline$$1_Vector_borrow_mut'u64'$0$dst@1| ($Mutation_4535 (|l#$Mutation_13758| $t5@0) (seq.++ (|p#$Mutation_13758| $t5@0) (seq.unit 0)) (seq.nth |inline$$1_Vector_borrow_mut'u64'$0$v@1| 0)))) (and (and (= $abort_flag@0@@0 false) (= $abort_code@1@@0 $abort_code@0@@0)) (and (= |inline$$1_Vector_borrow_mut'u64'$0$dst@2| |inline$$1_Vector_borrow_mut'u64'$0$dst@1|) (= |inline$$1_Vector_borrow_mut'u64'$0$m'@1| $t5@0)))) (and (=> (= (ControlFlow 0 20590) 20752) anon10_Then_correct) (=> (= (ControlFlow 0 20590) 20738) anon10_Else_correct)))))
...
(let ((anon9_Else_correct  (=> (not false) (=> (and (and (= $t1@0@@0 (|v#$Mutation_13758| |inline$$1_Vector_push_back'u64'$0$m'@1|)) (= $t5@0 ($Mutation_13758 ($Local 1) (as seq.empty (Seq Int)) $t1@0@@0))) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 20650) 20560))) |inline$$1_Vector_borrow_mut'u64'$0$anon0_correct|))))
(let ((anon9_Then_correct true))
(let ((|inline$$1_Vector_push_back'u64'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'u64'$0$m'@1| ($Mutation_13758 (|l#$Mutation_13758| $t3@0@@1) (|p#$Mutation_13758| $t3@0@@1) (seq.++ (|v#$Mutation_13758| $t3@0@@1) (seq.unit 1)))) (and (=> (= (ControlFlow 0 20424) 20772) anon9_Then_correct) (=> (= (ControlFlow 0 20424) 20650) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (not false) (=> (and (and (= |inline$$1_Vector_empty'u64'$0$v@1| |inline$$1_Vector_empty'u64'$0$v@1|) (= $t3@0@@1 ($Mutation_13758 ($Local 1) (as seq.empty (Seq Int)) |inline$$1_Vector_empty'u64'$0$v@1|))) (and (|$IsValid'u64'| 1) (= (ControlFlow 0 20430) 20424))) |inline$$1_Vector_push_back'u64'$0$anon0_correct|))))
...
(let ((anon0$1_correct@@3  (=> (= (ControlFlow 0 20341) 20335) |inline$$1_Vector_empty'u64'$0$anon0_correct|)))
(let ((anon0_correct@@3  (=> (= (seq.len (|p#$Mutation_4535| $t0)) 0) (=> (and (and (= (seq.len (|p#$Mutation_13758| $t3@@1)) 0) (= (seq.len (|p#$Mutation_13758| $t5)) 0)) (and (= (seq.len (|p#$Mutation_4535| $t7)) 0) (= (ControlFlow 0 20311) 20341))) anon0$1_correct@@3))))
(let ((PreconditionGeneratedEntry_correct@@1  (=> (= (ControlFlow 0 23303) 20311) anon0_correct@@3)))
