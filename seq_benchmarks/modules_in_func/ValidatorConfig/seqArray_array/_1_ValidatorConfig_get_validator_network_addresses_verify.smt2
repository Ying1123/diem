...
(assert (not
 (=> (= (ControlFlow 0 0) 104822) (let ((anon0$1_correct@@6  (=> (|$IsValid'$1_ValidatorConfig_Config'| _$t0@@6) (=> (and (and (= _$t0@@6 _$t0@@6) (= $t1@0@@1 (|$validator_network_addresses#$1_ValidatorConfig_Config| _$t0@@6))) (and (= $t1@0@@1 $t1@0@@1) (= (ControlFlow 0 89002) (- 0 104885)))) (not false)))))
(let ((inline$$InitEventStore$0$anon0_correct@@6  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@8 T@$1_Event_EventHandle) ) (! (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_34623_| (|streams#$EventStore| $es) handle@@8)))
 (and (= (|l#Multiset_34623| stream@@7) 0) (forall ((v@@43 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_34623| stream@@7) v@@43) 0)
 :qid |ValidatorConfigbpl.159:13|
 :skolemid |4|
))))
 :qid |ValidatorConfigbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 88958) 89002)) anon0$1_correct@@6)))
(let ((anon0_correct@@6  (=> (= (ControlFlow 0 104822) 88958) inline$$InitEventStore$0$anon0_correct@@6)))
anon0_correct@@6))))
))
(check-sat)
(pop 1)
