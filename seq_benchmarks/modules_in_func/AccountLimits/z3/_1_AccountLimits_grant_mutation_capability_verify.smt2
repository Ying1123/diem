...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 270804) (let ((L2_correct  (and (=> (= (ControlFlow 0 216476) (- 0 271598)) (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t1)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t1)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (=> (= (ControlFlow 0 216476) (- 0 271638)) (or (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t3)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t1)) (= 5 $t3))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t1)) 0)) (= 3 $t3))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t3))))))))
(let ((anon7_Then_correct  (=> (and (and $t5 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t3)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t4)) (= 5 $t3))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t3))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t3)))) (and (= $t3 $t3) (= (ControlFlow 0 216348) 216476))) L2_correct)))
...
(let ((anon0$1_correct  (=> (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr)) 0)) (= addr 173345816)))
 ...
 :skolemid |205|
))) (and (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106453| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@8)) 4))))
 :qid |AccountLimitsbpl.9143:20|
 :skolemid |206|
)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@9) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@9)) 3))))
 :qid |AccountLimitsbpl.9147:20|
 :skolemid |207|
)))) (and (and (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@10)) 3))))
 :qid |AccountLimitsbpl.9151:20|
 :skolemid |208|
)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@11)) 3))))
 :qid |AccountLimitsbpl.9155:20|
 :skolemid |209|
))) (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106790| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |AccountLimitsbpl.9159:20|
 :skolemid |210|
)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_106905| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_106965| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@12)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@12)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@12)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@12)) 2)))))
 :qid |AccountLimitsbpl.9163:20|
 :skolemid |211|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
...
))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $a_0@@0)))
...
)) (= $t1 (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (= $t2  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 216104) 216502) anon6_Then_correct) (=> (= (ControlFlow 0 216104) 216174) anon6_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 215613) 216104)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 270804) 215613) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))
))
(check-sat)
(pop 1)
