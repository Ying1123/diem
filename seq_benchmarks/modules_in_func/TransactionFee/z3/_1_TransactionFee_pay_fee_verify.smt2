...
(declare-fun $t11 () T@$Mutation_170516)
(declare-fun $t11@0 () T@$Mutation_170516)
...
(declare-fun $t3 () T@$Mutation_170516)
(declare-fun $t12 () T@$Mutation_143508)
(push 1)
(set-info :boogie-vc-id $1_TransactionFee_pay_fee$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 337932) (let ((anon22_Else_correct  (=> (not $t14) (=> (and (= $t12@1 ($Mutation_143508 (|l#$Mutation_143508| $t12@0) (|p#$Mutation_143508| $t12@0) |$temp_0'$1_Diem_Diem'#0''@0|)) (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_143508| $t12@1))) (=> (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_143508| $t12@1)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_143508| $t12@1)) (+ (|$value#$1_Diem_Diem'#0'| $t13@0) (|$value#$1_Diem_Diem'#0'| _$t0)))) (and (= $t11@2 ($Mutation_170516 (|l#$Mutation_170516| $t11@1) (|p#$Mutation_170516| $t11@1) (|$1_TransactionFee_TransactionFee'#0'| (|v#$Mutation_143508| $t12@1) (|$preburn#$1_TransactionFee_TransactionFee'#0'| (|v#$Mutation_170516| $t11@1))))) (= |$1_TransactionFee_TransactionFee'#0'_$memory@0| ($Memory_163323 (|Store__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|a#$Global| (|l#$Mutation_170516| $t11@2)) true) (|Store__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|a#$Global| (|l#$Mutation_170516| $t11@2)) (|v#$Mutation_170516| $t11@2)))))) (and (=> (= (ControlFlow 0 255767) (- 0 338708)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_122309| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_122309| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)) (=> (= $t15 (|$balance#$1_TransactionFee_TransactionFee'#0'| (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory@0|) 186537453))) (and (=> (= (ControlFlow 0 255767) (- 0 338736)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 255767) (- 0 338746)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (and (=> (= (ControlFlow 0 255767) (- 0 338756)) (not (> (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615))) (=> (not (> (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615)) (=> (= (ControlFlow 0 255767) (- 0 338774)) (= (|$value#$1_Diem_Diem'#0'| $t15) (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 255529) (- 0 338550)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (> (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (> (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615)) (=> (= (ControlFlow 0 255529) (- 0 338577)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= 5 $t6@0))) (and (> (+ (|$value#$1_Diem_Diem'#0'| $t4) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615) (= 8 $t6@0))))))))
(let ((anon22_Then_correct  (=> $t14 (=> (and (and (and (> (+ (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_143508| $t12@0)) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615) (= 8 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 255803) 255529))) L3_correct))))
(let ((anon21_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_TransactionFee_TransactionFee'#0''@0| (|v#$Mutation_170516| $t11@1))) (=> (and (and (= |$temp_0'$1_TransactionFee_TransactionFee'#0''@0| |$temp_0'$1_TransactionFee_TransactionFee'#0''@0|) (= $t12@0 ($Mutation_143508 (|l#$Mutation_170516| $t11@1) (seq.++ (|p#$Mutation_170516| $t11@1) (seq.unit 0)) (|$balance#$1_TransactionFee_TransactionFee'#0'| (|v#$Mutation_170516| $t11@1))))) (and (= $t13@0 (|v#$Mutation_143508| $t12@0)) (= $t14 (> (+ (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_143508| $t12@0)) (|$value#$1_Diem_Diem'#0'| _$t0)) 18446744073709551615)))) (and (=> (= (ControlFlow 0 255617) 255803) anon22_Then_correct) (=> (= (ControlFlow 0 255617) 255767) anon22_Else_correct))))))
(let ((anon21_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 255817) 255529))) L3_correct)))
(let ((anon20_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 255869) 255817) anon21_Then_correct) (=> (= (ControlFlow 0 255869) 255617) anon21_Else_correct))))))
(let ((anon20_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= (ControlFlow 0 255867) 255869)) anon20_Then$1_correct)))
(let ((anon20_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453) (=> (and (and (= $t11@0 ($Mutation_170516 ($Global 186537453) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 255561) 255817) anon21_Then_correct) (=> (= (ControlFlow 0 255561) 255617) anon21_Else_correct))))))
(let ((anon19_Then_correct  (=> (and |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (|$IsValid'address'| 186537453)) (and (=> (= (ControlFlow 0 255539) 255867) anon20_Then_correct) (=> (= (ControlFlow 0 255539) 255561) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (and (not |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|) (= $t9 $t9)) (and (= $t6@0 $t9) (= (ControlFlow 0 255437) 255529))) L3_correct)))
(let ((anon18_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 255421) 255539) anon19_Then_correct) (=> (= (ControlFlow 0 255421) 255437) anon19_Else_correct))))))
(let ((anon17_Then_correct  (=> $t5 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 255909) 255529))) L3_correct))))
(let ((anon18_Then_correct true))
(let ((|inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 186537453) (=> (and (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 255379) 255883) anon18_Then_correct) (=> (= (ControlFlow 0 255379) 255421) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (not $t5) (= (ControlFlow 0 255385) 255379)) |inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|)))
...
)))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@0)))
(|$IsValid'$1_TransactionFee_TransactionFee'#0''| $rsc@@0))
 :qid |TransactionFeebpl.18492:20|
 :skolemid |315|
 :pattern ( (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@0))
)) (= $t4 (|$balance#$1_TransactionFee_TransactionFee'#0'| (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (and (= _$t0 _$t0) (= $t5  (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 255292) 255909) anon17_Then_correct) (=> (= (ControlFlow 0 255292) 255385) anon17_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_89967_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |TransactionFeebpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 255098) 255292)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (seq.len (|p#$Mutation_170516| $t3)) 0) (= (seq.len (|p#$Mutation_170516| $t11)) 0)) (and (= (seq.len (|p#$Mutation_143508| $t12)) 0) (= (ControlFlow 0 255108) 255098))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 337932) 255108) anon0_correct)))
