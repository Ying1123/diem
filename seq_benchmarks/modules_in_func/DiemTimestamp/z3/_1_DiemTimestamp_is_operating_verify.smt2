...
))) (=> (and (and (|$IsValid'address'| 173345816) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_91217| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (= $t1@0 $t1@0) (= (ControlFlow 0 142572) (- 0 196389)))) (not false)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_62542_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTimestampbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 142496) 142572)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 196295) 142496) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
