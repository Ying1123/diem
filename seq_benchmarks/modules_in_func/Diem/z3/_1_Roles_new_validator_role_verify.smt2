...
(let ((anon11_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= $1_Roles_RoleId_$memory@1 ($Memory_305421 (|Store__T@[Int]Bool_| (|domain#$Memory_305421| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t1) false) (|contents#$Memory_305421| $1_Roles_RoleId_$memory)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@1) (= (ControlFlow 0 686733) 687193))) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and |$temp_0'bool'@0| (= $1_Roles_RoleId_$memory@0 ($Memory_305421 (|Store__T@[Int]Bool_| (|domain#$Memory_305421| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t1) true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_305421| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t1) |$temp_0'$1_Roles_RoleId'@0|)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@0) (= (ControlFlow 0 687207) 687193))) anon7_correct)))
(let ((anon10_Else_correct  (=> (not $t9) (and (=> (= (ControlFlow 0 686719) 687207) anon11_Then_correct) (=> (= (ControlFlow 0 686719) 686733) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (not $t5) (=> (and (|$IsValid'u64'| 3) (= $t8 (|$addr#$signer| _$t1))) (and (=> (= (ControlFlow 0 686713) (- 0 1051800)) (=> (= 3 0) (= $t8 173345816))) (=> (=> (= 3 0) (= $t8 173345816)) (and (=> (= (ControlFlow 0 686713) (- 0 1051816)) (=> (= 3 1) (= $t8 186537453))) (=> (=> (= 3 1) (= $t8 186537453)) (and (=> (= (ControlFlow 0 686713) (- 0 1051832)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| _$t1))) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| _$t1)) (=> (= $t9 (|Select__T@[Int]Bool_| (|domain#$Memory_305421| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t1))) (and (=> (= (ControlFlow 0 686713) 687235) anon10_Then_correct) (=> (= (ControlFlow 0 686713) 686719) anon10_Else_correct)))))))))))))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 686481) 686635)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1051499) 686481) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
