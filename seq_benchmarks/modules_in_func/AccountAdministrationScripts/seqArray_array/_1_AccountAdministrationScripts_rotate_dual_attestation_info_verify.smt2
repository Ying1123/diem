...
(assert (not
 (=> (= (ControlFlow 0 0) 372489) (let ((L2_correct@@4  (and (=> (= (ControlFlow 0 277544) (- 0 374874)) (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) $t3@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) $t5@@5))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0@@10))))) (=> (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) $t3@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) $t5@@5))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0@@10)))) (=> (= (ControlFlow 0 277544) (- 0 374921)) (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) $t3@@4)) (= 5 $t18@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t18@0))) (and (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2)) (= 7 $t18@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) $t5@@5)) (= 5 $t18@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t18@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0@@10))) (= 5 $t18@0))) (= 5 $t18@0)) (= 7 $t18@0)))))))
(let ((anon7_Then_correct@@1  (=> (and (and $abort_flag@3@@9 (= $abort_code@4@@9 $abort_code@4@@9)) (and (= $t18@0 $abort_code@4@@9) (= (ControlFlow 0 277364) 277544))) L2_correct@@4)))
(let ((anon6_Then_correct@@1  (=> (and (and $abort_flag@1@@10 (= $abort_code@2@@10 $abort_code@2@@10)) (and (= $t18@0 $abort_code@2@@10) (= (ControlFlow 0 277558) 277544))) L2_correct@@4)))
(let ((anon7_Else_correct@@1  (=> (not $abort_flag@3@@9) (and (=> (= (ControlFlow 0 277350) (- 0 374609)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) $t3@@4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) $t3@@4))) (and (=> (= (ControlFlow 0 277350) (- 0 374621)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 277350) (- 0 374631)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2))) (and (=> (= (ControlFlow 0 277350) (- 0 374641)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) $t5@@5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) $t5@@5))) (and (=> (= (ControlFlow 0 277350) (- 0 374653)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 277350) (- 0 374663)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0@@10))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0@@10)))) (and (=> (= (ControlFlow 0 277350) (- 0 374676)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@3) $t4@@6)) _$t1@@5)) (=> (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@3) $t4@@6)) _$t1@@5) (and (=> (= (ControlFlow 0 277350) (- 0 374689)) (forall ((addr1@@19 Int) ) (!  (=> (|$IsValid'address'| addr1@@19) (=> (not (= addr1@@19 $t4@@6)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@3) addr1@@19)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) addr1@@19)))))
 :qid |AccountAdministrationScriptsbpl.19066:15|
 :skolemid |477|
))) (=> (forall ((addr1@@20 Int) ) (!  (=> (|$IsValid'address'| addr1@@20) (=> (not (= addr1@@20 $t4@@6)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@3) addr1@@20)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) addr1@@20)))))
 :qid |AccountAdministrationScriptsbpl.19066:15|
 :skolemid |477|
)) (and (=> (= (ControlFlow 0 277350) (- 0 374727)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@3) $t6@@4)) _$t2@@2)) (=> (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@3) $t6@@4)) _$t2@@2) (and (=> (= (ControlFlow 0 277350) (- 0 374740)) (forall ((addr1@@21 Int) ) (!  (=> (|$IsValid'address'| addr1@@21) (=> (not (= addr1@@21 $t6@@4)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@3) addr1@@21)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) addr1@@21)))))
 :qid |AccountAdministrationScriptsbpl.19076:15|
 :skolemid |478|
))) (=> (forall ((addr1@@22 Int) ) (!  (=> (|$IsValid'address'| addr1@@22) (=> (not (= addr1@@22 $t6@@4)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@3) addr1@@22)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) addr1@@22)))))
 :qid |AccountAdministrationScriptsbpl.19076:15|
 :skolemid |478|
)) (and (=> (= (ControlFlow 0 277350) (- 0 374778)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@5) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@5) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@11 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1)))
(let ((stream_new (let ((len (|l#Multiset_91033| stream@@11)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@11) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@11) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1 stream_new))))))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@12 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| expected) handle@@12)) (|l#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| actual) handle@@12))) (forall ((v@@71 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| expected) handle@@12)) v@@71) (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| actual) handle@@12)) v@@71))
 :qid |AccountAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |AccountAdministrationScriptsbpl.3323:13|
 :skolemid |120|
...
(let ((expected@@0 (let ((stream@@12 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_91033| stream@@12)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@12) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@12) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1 stream_new@@0))))))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@13 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| expected@@0) handle@@13)) (|l#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| actual@@0) handle@@13))) (forall ((v@@72 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| expected@@0) handle@@13)) v@@72) (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| actual@@0) handle@@13)) v@@72))
 :qid |AccountAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |AccountAdministrationScriptsbpl.3323:13|
 :skolemid |120|
))))) (and (=> (= (ControlFlow 0 277350) (- 0 374803)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@5) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@5) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@13 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_91033| stream@@14)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@14) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@14) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1 stream_new@@1))))) $t11)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_91033| stream@@13)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@13) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@13) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_91033| stream@@14)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@14) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@14) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1 stream_new@@1))))) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_91033| stream@@14)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@14) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@14) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1 stream_new@@1))))) $t11 stream_new@@2))))))
 (and (<= (|counter#$EventStore| expected@@1) (|counter#$EventStore| actual@@1)) (forall ((handle@@14 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| expected@@1) handle@@14)) (|l#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| actual@@1) handle@@14))) (forall ((v@@73 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| expected@@1) handle@@14)) v@@73) (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| actual@@1) handle@@14)) v@@73))
 :qid |AccountAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |AccountAdministrationScriptsbpl.3323:13|
...
(let ((expected@@2 (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| (let ((stream@@16 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_91033| stream@@16)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@16) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@16) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1 stream_new@@3))))) $t11)))
(let ((stream_new@@4 (let ((len@@4 (|l#Multiset_91033| stream@@15)))
(let ((cnt@@4 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@15) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@15) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@4 1)) (+ len@@4 1))))))
($EventStore (+ (|counter#$EventStore| (let ((stream@@16 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_91033| stream@@16)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@16) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@16) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1 stream_new@@3))))) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| (let ((stream@@16 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_91033| stream@@16)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@16) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@16) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1 stream_new@@3))))) $t11 stream_new@@4))))))
 (and (<= (|counter#$EventStore| expected@@2) (|counter#$EventStore| actual@@2)) (forall ((handle@@15 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| expected@@2) handle@@15)) (|l#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| actual@@2) handle@@15))) (forall ((v@@74 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| expected@@2) handle@@15)) v@@74) (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| actual@@2) handle@@15)) v@@74))
 :qid |AccountAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |AccountAdministrationScriptsbpl.3323:13|
 :skolemid |120|
))))) (=> (= (ControlFlow 0 277350) (- 0 374834)) (let ((actual@@3 ($EventStore (- (|counter#$EventStore| $es@5) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@5) (|streams#$EventStore| $es)))))
(let ((expected@@3 (let ((stream@@17 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| (let ((stream@@18 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_91033| stream@@18)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@18) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@18) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1 stream_new@@5))))) $t11)))
(let ((stream_new@@6 (let ((len@@6 (|l#Multiset_91033| stream@@17)))
(let ((cnt@@6 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@17) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@17) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@6 1)) (+ len@@6 1))))))
($EventStore (+ (|counter#$EventStore| (let ((stream@@18 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_91033| stream@@18)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@18) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@18) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1 stream_new@@5))))) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| (let ((stream@@18 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_91033| stream@@18)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@18) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@18) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9@@2) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $EmptyEventStore) $t8@@1 stream_new@@5))))) $t11 stream_new@@6))))))
 (and (<= (|counter#$EventStore| actual@@3) (|counter#$EventStore| expected@@3)) (forall ((handle@@16 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| actual@@3) handle@@16)) (|l#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| expected@@3) handle@@16))) (forall ((v@@75 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| actual@@3) handle@@16)) v@@75) (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| expected@@3) handle@@16)) v@@75))
 :qid |AccountAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |AccountAdministrationScriptsbpl.3323:13|
...
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon25_Else_correct  (=> (and (not $abort_flag@2@@9) (= $1_DualAttestation_Credential_$memory@2 ($Memory_166928 (|Store__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory@1) (|a#$Global| (|l#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3)) true) (|Store__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@1) (|a#$Global| (|l#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3)) (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3))))) (=> (and (and (= $1_DualAttestation_Credential_$memory@3 $1_DualAttestation_Credential_$memory@2) (= $abort_code@4@@9 $abort_code@3@@9)) (and (= $es@5 $es@3) (= $abort_flag@3@@9 $abort_flag@2@@9))) (and (=> (= (ControlFlow 0 276946) 277364) anon7_Then_correct@@1) (=> (= (ControlFlow 0 276946) 277350) anon7_Else_correct@@1))))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct  (=> (and (and (= $1_DualAttestation_Credential_$memory@3 $1_DualAttestation_Credential_$memory@1) (= $abort_code@4@@9 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1)) (and (= $es@5 $es@4) (= $abort_flag@3@@9 true))) (and (=> (= (ControlFlow 0 276623) 277364) anon7_Then_correct@@1) (=> (= (ControlFlow 0 276623) 277350) anon7_Else_correct@@1)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon25_Then_correct  (=> $abort_flag@2@@9 (=> (and (and (= $abort_code@3@@9 $abort_code@3@@9) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 $abort_code@3@@9)) (and (= $es@4 $es@3) (= (ControlFlow 0 276960) 276623))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct))))
(let ((|inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1| (|v#$Mutation_130100| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t23@1)) (= $es@3 (let ((stream@@19 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $es@2) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1|)))
(let ((stream_new@@7 (let ((len@@7 (|l#Multiset_91033| stream@@19)))
(let ((cnt@@7 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@19) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t26@1))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@19) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t26@1) (+ cnt@@7 1)) (+ len@@7 1))))))
($EventStore (+ (|counter#$EventStore| $es@2) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $es@2) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1| stream_new@@7)))))) (and (=> (= (ControlFlow 0 276918) 276960) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon25_Then_correct) (=> (= (ControlFlow 0 276918) 276946) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon25_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon24_Else_correct  (=> (not inline$$1_DualAttestation_rotate_compliance_public_key$0$$t25@0) (=> (and (and (|$IsValid'u64'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t24@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t24@0 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t26@1 ($1_DualAttestation_ComplianceKeyRotationEvent _$t2@@2 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t24@0)) (= (ControlFlow 0 276924) 276918))) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon24_Then_correct  (=> inline$$1_DualAttestation_rotate_compliance_public_key$0$$t25@0 (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@0)) (=> (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@0)) (and (= $es@4 $es@2) (= (ControlFlow 0 276986) 276623))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Else_correct  (=> (and (and (and (not $abort_flag@2@@9) (= |inline$$1_DualAttestation_rotate_compliance_public_key$0$$temp_0'$1_DualAttestation_Credential'@1| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2))) (and (= |inline$$1_DualAttestation_rotate_compliance_public_key$0$$temp_0'$1_DualAttestation_Credential'@1| |inline$$1_DualAttestation_rotate_compliance_public_key$0$$temp_0'$1_DualAttestation_Credential'@1|) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@1 ($Mutation_124358 (|l#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2) (let ((l@@17 (|l#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2))))
(Vec_25477 (|Store__T@[Int]Int_| (|v#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)) l@@17 2) (+ l@@17 1))) (|$compliance_public_key#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)))))) (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@2 ($Mutation_124358 (|l#$Mutation_124358| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@1) (|p#$Mutation_124358| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@1) _$t2@@2)) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3 ($Mutation_168487 (|l#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2) (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2) ($1_DualAttestation_Credential (|$human_name#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)) (|$base_url#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)) (|v#$Mutation_124358| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@2) (|$expiration_date#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)))))) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t23@1 ($Mutation_130100 (|l#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3) (let ((l@@18 (|l#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3))))
(Vec_25477 (|Store__T@[Int]Int_| (|v#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3)) l@@18 4) (+ l@@18 1))) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3)))) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t25@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 276819) 276986) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon24_Then_correct) (=> (= (ControlFlow 0 276819) 276924) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon24_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Then_correct  (=> $abort_flag@2@@9 (=> (and (and (= $abort_code@3@@9 $abort_code@3@@9) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 $abort_code@3@@9)) (and (= $es@4 $es@2) (= (ControlFlow 0 277000) 276623))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Then$1_correct  (=> (= $abort_flag@2@@9 true) (=> (and (= $abort_code@3@@9 $EXEC_FAILURE_CODE) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@0)) (and (=> (= (ControlFlow 0 277052) 277000) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Then_correct) (=> (= (ControlFlow 0 277052) 276819) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory@1) inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0)) (= (ControlFlow 0 277050) 277052)) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Then$1_correct)))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory@1) inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0) (=> (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@1 ($Mutation_168487 ($Global inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0) (Vec_25477 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@1) inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0))) (= $abort_flag@2@@9 $abort_flag@1@@10)) (and (= $abort_code@3@@9 $abort_code@2@@10) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@1))) (and (=> (= (ControlFlow 0 276741) 277000) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Then_correct) (=> (= (ControlFlow 0 276741) 276819) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon21_Then_correct  (=> inline$$1_Signature_ed25519_validate_pubkey$0$res@1@@0 (and (=> (= (ControlFlow 0 276719) 277050) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Then_correct) (=> (= (ControlFlow 0 276719) 276741) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon21_Else_correct  (=> (not inline$$1_Signature_ed25519_validate_pubkey$0$res@1@@0) (=> (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0)) (and (= $es@4 $es@2) (= (ControlFlow 0 276715) 276623))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon20_Else_correct  (=> (and (not $abort_flag@1@@10) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0 7)) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0) (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1@@0 inline$$1_Signature_ed25519_validate_pubkey$0$res@1@@0))) (and (=> (= (ControlFlow 0 276699) 276719) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon21_Then_correct) (=> (= (ControlFlow 0 276699) 276715) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon21_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon20_Then_correct  (=> $abort_flag@1@@10 (=> (and (and (= $abort_code@2@@10 $abort_code@2@@10) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 $abort_code@2@@10)) (and (= $es@4 $es@2) (= (ControlFlow 0 277066) 276623))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct))))
(let ((inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct@@0  (=> (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1@@0 ($1_Signature_$ed25519_validate_pubkey _$t2@@2)) (and (=> (= (ControlFlow 0 276657) 277066) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon20_Then_correct) (=> (= (ControlFlow 0 276657) 276699) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon20_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon19_Then_correct  (=> (and inline$$1_DualAttestation_rotate_compliance_public_key$0$$t14@1 (= (ControlFlow 0 276663) 276657)) inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct@@0)))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon19_Else_correct  (=> (not inline$$1_DualAttestation_rotate_compliance_public_key$0$$t14@1) (=> (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0)) (and (= $es@4 $es@2) (= (ControlFlow 0 276617) 276623))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon0_correct  (=> (and (and (= (|l#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t7@0)) 0) (= (|l#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@0)) 0)) (and (= (|l#Vec_25477| (|p#$Mutation_124358| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@0)) 0) (= (|l#Vec_25477| (|p#$Mutation_130100| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t23@0)) 0))) (=> (and (and (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t8@0 (|$addr#$signer| _$t0@@10)) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t9@0 (|$addr#$signer| _$t0@@10))) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t10@0 (|$addr#$signer| _$t0@@10)) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t11@0 (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@1) inline$$1_DualAttestation_rotate_compliance_public_key$0$$t10@0))))) (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t12@0 ($1_DualAttestation_ComplianceKeyRotationEvent _$t2@@2 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= _$t0@@10 _$t0@@10)) (and (= _$t2@@2 _$t2@@2) (|$IsValid'address'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0)))) (and (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0 (|$addr#$signer| _$t0@@10)) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0)) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t14@1 (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory@1) inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0 5)) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t14@1 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t14@1))))) (and (=> (= (ControlFlow 0 276601) 276663) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon19_Then_correct) (=> (= (ControlFlow 0 276601) 276617) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon19_Else_correct))))))
(let ((anon6_Else_correct@@1  (=> (not $abort_flag@1@@10) (=> (and (= $t19 (|$addr#$signer| _$t0@@10)) (= $t20 (|$addr#$signer| _$t0@@10))) (=> (and (and (= $t21 (|$addr#$signer| _$t0@@10)) (= $t22 (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory@1) $t21)))) (and (= $t23 ($1_DualAttestation_ComplianceKeyRotationEvent _$t2@@2 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= (ControlFlow 0 277070) 276601))) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon0_correct)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon18_Else_correct  (=> (and (not $abort_flag@0@@10) (= $1_DualAttestation_Credential_$memory@0 ($Memory_166928 (|Store__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@3)) true) (|Store__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@3)) (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@3))))) (=> (and (and (= $abort_code@2@@10 $abort_code@1@@10) (= $abort_flag@1@@10 $abort_flag@0@@10)) (and (= $es@2 $es@0) (= $1_DualAttestation_Credential_$memory@1 $1_DualAttestation_Credential_$memory@0))) (and (=> (= (ControlFlow 0 275557) 277558) anon6_Then_correct@@1) (=> (= (ControlFlow 0 275557) 277070) anon6_Else_correct@@1))))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$L3_correct  (=> (and (and (= $abort_code@2@@10 inline$$1_DualAttestation_rotate_base_url$0$$t15@1) (= $abort_flag@1@@10 true)) (and (= $es@2 $es@1) (= $1_DualAttestation_Credential_$memory@1 $1_DualAttestation_Credential_$memory))) (and (=> (= (ControlFlow 0 275326) 277558) anon6_Then_correct@@1) (=> (= (ControlFlow 0 275326) 277070) anon6_Else_correct@@1)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon18_Then_correct  (=> $abort_flag@0@@10 (=> (and (and (= $abort_code@1@@10 $abort_code@1@@10) (= inline$$1_DualAttestation_rotate_base_url$0$$t15@1 $abort_code@1@@10)) (and (= $es@1 $es@0) (= (ControlFlow 0 275571) 275326))) inline$$1_DualAttestation_rotate_base_url$0$L3_correct))))
(let ((|inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| (|v#$Mutation_130100| inline$$1_DualAttestation_rotate_base_url$0$$t18@1)) (= $es@0 (let ((stream@@20 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1|)))
(let ((stream_new@@8 (let ((len@@8 (|l#Multiset_91033| stream@@20)))
(let ((cnt@@8 (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@20) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| inline$$1_DualAttestation_rotate_base_url$0$$t21@1))))
(Multiset_91033 (|Store__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@20) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| inline$$1_DualAttestation_rotate_base_url$0$$t21@1) (+ cnt@@8 1)) (+ len@@8 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| stream_new@@8)))))) (and (=> (= (ControlFlow 0 275529) 275571) inline$$1_DualAttestation_rotate_base_url$0$anon18_Then_correct) (=> (= (ControlFlow 0 275529) 275557) inline$$1_DualAttestation_rotate_base_url$0$anon18_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon17_Else_correct  (=> (not inline$$1_DualAttestation_rotate_base_url$0$$t20@0) (=> (and (and (|$IsValid'u64'| inline$$1_DualAttestation_rotate_base_url$0$$t19@0) (= inline$$1_DualAttestation_rotate_base_url$0$$t19@0 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= inline$$1_DualAttestation_rotate_base_url$0$$t21@1 ($1_DualAttestation_BaseUrlRotationEvent _$t1@@5 inline$$1_DualAttestation_rotate_base_url$0$$t19@0)) (= (ControlFlow 0 275535) 275529))) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon17_Then_correct  (=> inline$$1_DualAttestation_rotate_base_url$0$$t20@0 (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_DualAttestation_rotate_base_url$0$$t15@0)) (=> (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t15@0 inline$$1_DualAttestation_rotate_base_url$0$$t15@0) (= inline$$1_DualAttestation_rotate_base_url$0$$t15@1 inline$$1_DualAttestation_rotate_base_url$0$$t15@0)) (and (= $es@1 $es) (= (ControlFlow 0 275597) 275326))) inline$$1_DualAttestation_rotate_base_url$0$L3_correct)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon16_Else_correct  (=> (and (and (and (not $abort_flag@0@@10) (= |inline$$1_DualAttestation_rotate_base_url$0$$temp_0'$1_DualAttestation_Credential'@1| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2))) (and (= |inline$$1_DualAttestation_rotate_base_url$0$$temp_0'$1_DualAttestation_Credential'@1| |inline$$1_DualAttestation_rotate_base_url$0$$temp_0'$1_DualAttestation_Credential'@1|) (= inline$$1_DualAttestation_rotate_base_url$0$$t17@1 ($Mutation_124358 (|l#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2) (let ((l@@19 (|l#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2))))
(Vec_25477 (|Store__T@[Int]Int_| (|v#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)) l@@19 1) (+ l@@19 1))) (|$base_url#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)))))) (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t17@2 ($Mutation_124358 (|l#$Mutation_124358| inline$$1_DualAttestation_rotate_base_url$0$$t17@1) (|p#$Mutation_124358| inline$$1_DualAttestation_rotate_base_url$0$$t17@1) _$t1@@5)) (= inline$$1_DualAttestation_rotate_base_url$0$$t16@3 ($Mutation_168487 (|l#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2) (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2) ($1_DualAttestation_Credential (|$human_name#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)) (|v#$Mutation_124358| inline$$1_DualAttestation_rotate_base_url$0$$t17@2) (|$compliance_public_key#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)) (|$expiration_date#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)))))) (and (= inline$$1_DualAttestation_rotate_base_url$0$$t18@1 ($Mutation_130100 (|l#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@3) (let ((l@@20 (|l#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@3))))
(Vec_25477 (|Store__T@[Int]Int_| (|v#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@3)) l@@20 5) (+ l@@20 1))) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@3)))) (= inline$$1_DualAttestation_rotate_base_url$0$$t20@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 275430) 275597) inline$$1_DualAttestation_rotate_base_url$0$anon17_Then_correct) (=> (= (ControlFlow 0 275430) 275535) inline$$1_DualAttestation_rotate_base_url$0$anon17_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon16_Then_correct  (=> $abort_flag@0@@10 (=> (and (and (= $abort_code@1@@10 $abort_code@1@@10) (= inline$$1_DualAttestation_rotate_base_url$0$$t15@1 $abort_code@1@@10)) (and (= $es@1 $es) (= (ControlFlow 0 275611) 275326))) inline$$1_DualAttestation_rotate_base_url$0$L3_correct))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon15_Then$1_correct  (=> (= $abort_flag@0@@10 true) (=> (and (= $abort_code@1@@10 $EXEC_FAILURE_CODE) (= inline$$1_DualAttestation_rotate_base_url$0$$t16@2 inline$$1_DualAttestation_rotate_base_url$0$$t16@0)) (and (=> (= (ControlFlow 0 275663) 275611) inline$$1_DualAttestation_rotate_base_url$0$anon16_Then_correct) (=> (= (ControlFlow 0 275663) 275430) inline$$1_DualAttestation_rotate_base_url$0$anon16_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon15_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) inline$$1_DualAttestation_rotate_base_url$0$$t11@0)) (= (ControlFlow 0 275661) 275663)) inline$$1_DualAttestation_rotate_base_url$0$anon15_Then$1_correct)))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon15_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) inline$$1_DualAttestation_rotate_base_url$0$$t11@0) (=> (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t16@1 ($Mutation_168487 ($Global inline$$1_DualAttestation_rotate_base_url$0$$t11@0) (Vec_25477 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) inline$$1_DualAttestation_rotate_base_url$0$$t11@0))) (= $abort_flag@0@@10 false)) (and (= $abort_code@1@@10 $abort_code@0@@10) (= inline$$1_DualAttestation_rotate_base_url$0$$t16@2 inline$$1_DualAttestation_rotate_base_url$0$$t16@1))) (and (=> (= (ControlFlow 0 275352) 275611) inline$$1_DualAttestation_rotate_base_url$0$anon16_Then_correct) (=> (= (ControlFlow 0 275352) 275430) inline$$1_DualAttestation_rotate_base_url$0$anon16_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon14_Then_correct  (=> inline$$1_DualAttestation_rotate_base_url$0$$t12@1 (and (=> (= (ControlFlow 0 275330) 275661) inline$$1_DualAttestation_rotate_base_url$0$anon15_Then_correct) (=> (= (ControlFlow 0 275330) 275352) inline$$1_DualAttestation_rotate_base_url$0$anon15_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon14_Else_correct  (=> (not inline$$1_DualAttestation_rotate_base_url$0$$t12@1) (=> (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t14@0 inline$$1_DualAttestation_rotate_base_url$0$$t14@0) (= inline$$1_DualAttestation_rotate_base_url$0$$t15@1 inline$$1_DualAttestation_rotate_base_url$0$$t14@0)) (and (= $es@1 $es) (= (ControlFlow 0 275320) 275326))) inline$$1_DualAttestation_rotate_base_url$0$L3_correct))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon0_correct  (=> (and (and (= (|l#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t5@0)) 0) (= (|l#Vec_25477| (|p#$Mutation_168487| inline$$1_DualAttestation_rotate_base_url$0$$t16@0)) 0)) (and (= (|l#Vec_25477| (|p#$Mutation_124358| inline$$1_DualAttestation_rotate_base_url$0$$t17@0)) 0) (= (|l#Vec_25477| (|p#$Mutation_130100| inline$$1_DualAttestation_rotate_base_url$0$$t18@0)) 0))) (=> (and (and (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t6@0 (|$addr#$signer| _$t0@@10)) (= inline$$1_DualAttestation_rotate_base_url$0$$t7@0 (|$addr#$signer| _$t0@@10))) (and (= inline$$1_DualAttestation_rotate_base_url$0$$t8@0 (|$addr#$signer| _$t0@@10)) (= inline$$1_DualAttestation_rotate_base_url$0$$t9@0 (|$base_url_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) inline$$1_DualAttestation_rotate_base_url$0$$t8@0))))) (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t10@0 ($1_DualAttestation_BaseUrlRotationEvent _$t1@@5 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= _$t0@@10 _$t0@@10)) (and (= _$t1@@5 _$t1@@5) (|$IsValid'address'| inline$$1_DualAttestation_rotate_base_url$0$$t11@0)))) (and (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t11@0 (|$addr#$signer| _$t0@@10)) (= inline$$1_DualAttestation_rotate_base_url$0$$t11@0 inline$$1_DualAttestation_rotate_base_url$0$$t11@0)) (and (= inline$$1_DualAttestation_rotate_base_url$0$$t12@1 (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) inline$$1_DualAttestation_rotate_base_url$0$$t11@0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| inline$$1_DualAttestation_rotate_base_url$0$$t14@0) (= inline$$1_DualAttestation_rotate_base_url$0$$t14@0 5)) (and (= inline$$1_DualAttestation_rotate_base_url$0$$t14@0 inline$$1_DualAttestation_rotate_base_url$0$$t14@0) (= inline$$1_DualAttestation_rotate_base_url$0$$t12@1 inline$$1_DualAttestation_rotate_base_url$0$$t12@1))))) (and (=> (= (ControlFlow 0 275304) 275330) inline$$1_DualAttestation_rotate_base_url$0$anon14_Then_correct) (=> (= (ControlFlow 0 275304) 275320) inline$$1_DualAttestation_rotate_base_url$0$anon14_Else_correct))))))
(let ((anon0$1_correct@@10  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) 173345816))) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_140200| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_141106| $1_DiemConfig_Configuration_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_140716| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_146600| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_160407| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_163119| $1_XDX_Reserve_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_146664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_160626| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165818| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166992| $1_DualAttestation_Limit_$memory) 173345816))) (and (forall ((addr1@@23 Int) ) (!  (=> (|$IsValid'address'| addr1@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) addr1@@23) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@23)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@23)) 2)))))
 :qid |AccountAdministrationScriptsbpl.18853:20|
 :skolemid |473|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_140797| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))) (=> (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_171886| $1_ChainId_ChainId_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_172264| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) 173345816))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) 186537453))))))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_174043| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_174538| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816))) (and (forall ((addr@@253 Int) ) (!  (=> (|$IsValid'address'| addr@@253) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) addr@@253) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@253) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@253)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@253) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@253)) 5)))))
 :qid |AccountAdministrationScriptsbpl.18885:20|
 :skolemid |474|
)) (|$IsValid'address'| (|$addr#$signer| _$t0@@10))))) (and (and (and (|$IsValid'vec'u8''| _$t1@@5) (|$IsValid'vec'u8''| _$t2@@2)) (and (forall (($a_0@@30 Int) ) (! (let (($rsc@@30 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@30)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@30))
 :qid |AccountAdministrationScriptsbpl.18897:20|
 :skolemid |475|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@30))
)) (forall (($a_0@@31 Int) ) (! (let (($rsc@@31 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) $a_0@@31)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@31))
 :qid |AccountAdministrationScriptsbpl.18901:20|
 :skolemid |476|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) $a_0@@31))
)))) (and (and (= $t3@@4 (|$addr#$signer| _$t0@@10)) (= $t4@@6 (|$addr#$signer| _$t0@@10))) (and (= $t5@@5 (|$addr#$signer| _$t0@@10)) (= $t6@@4 (|$addr#$signer| _$t0@@10)))))) (and (and (and (and (= $t7@@1 (|$addr#$signer| _$t0@@10)) (= $t8@@1 (|$base_url_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) $t7@@1)))) (and (= $t9@@2 ($1_DualAttestation_BaseUrlRotationEvent _$t1@@5 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= $t10 (|$addr#$signer| _$t0@@10)))) (and (and (= $t11 (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) $t10))) (= $t12 ($1_DualAttestation_ComplianceKeyRotationEvent _$t2@@2 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000)))) (and (let ((addr@@254 (|$addr#$signer| _$t0@@10)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@254)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) addr@@254) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) addr@@254)))))) (= _$t0@@10 _$t0@@10)))) (and (and (and (= _$t1@@5 _$t1@@5) (= _$t2@@2 _$t2@@2)) (and (= $t13 (|$addr#$signer| _$t0@@10)) (= $t14 (|$addr#$signer| _$t0@@10)))) (and (and (= $t15 (|$addr#$signer| _$t0@@10)) (= $t16 (|$base_url_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_166928| $1_DualAttestation_Credential_$memory) $t15)))) (and (= $t17 ($1_DualAttestation_BaseUrlRotationEvent _$t1@@5 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= (ControlFlow 0 275667) 275304)))))) inline$$1_DualAttestation_rotate_base_url$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@10  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@17 T@$1_Event_EventHandle) ) (! (let ((stream@@21 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $es) handle@@17)))
 (and (= (|l#Multiset_91033| stream@@21) 0) (forall ((v@@76 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@21) v@@76) 0)
 :qid |AccountAdministrationScriptsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountAdministrationScriptsbpl.3307:13|
 :skolemid |119|
))) (= (ControlFlow 0 273986) 275667)) anon0$1_correct@@10)))
(let ((anon0_correct@@10  (=> (= (ControlFlow 0 372489) 273986) inline$$InitEventStore$0$anon0_correct@@10)))
anon0_correct@@10))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
