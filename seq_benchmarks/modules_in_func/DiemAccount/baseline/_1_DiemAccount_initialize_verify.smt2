...
(declare-fun $1_Roles_RoleId_$memory@5 () T@$Memory_465676)
(declare-fun $t19 () Int)
...
(declare-fun $1_DiemAccount_AccountOperationsCapability_$memory@5 () T@$Memory_465211)
(declare-fun $t23 () T@$1_Event_EventHandle)
(declare-fun $t24 () T@$1_DiemAccount_CreateAccountEvent)
(declare-fun $1_Roles_RoleId_$memory@11 () T@$Memory_465676)
(declare-fun $t20 () Int)
(declare-fun $1_DiemAccount_DiemAccount_$memory@5 () T@$Memory_468705)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@5 () T@$Memory_495622)
(declare-fun $1_AccountFreezing_FreezingBit_$memory@5 () T@$Memory_590069)
...
(declare-fun $t3 () Int)
(declare-fun $1_DiemAccount_DiemWriteSetManager_$memory@2 () T@$Memory_465282)
(declare-fun $t5 () Int)
(declare-fun $1_DiemAccount_DiemAccount_$memory () T@$Memory_468705)
(declare-fun |$temp_0'bool'@15| () Bool)
(declare-fun $1_Roles_RoleId_$memory@10 () T@$Memory_465676)
(declare-fun |Store__T@[Int]Bool_| (|T@[Int]Bool| Int Bool) |T@[Int]Bool|)
(assert (forall ( ( ?x0 |T@[Int]Bool|) ( ?x1 Int) ( ?x2 Bool)) (! (= (|Select__T@[Int]Bool_| (|Store__T@[Int]Bool_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Bool|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Bool)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Bool_| (|Store__T@[Int]Bool_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Bool_| ?x0 ?y1))) :weight 0)))
(declare-fun $1_Roles_RoleId_$memory@8 () T@$Memory_465676)
(declare-fun $1_Roles_RoleId_$memory@9 () T@$Memory_465676)
...
(declare-fun $1_AccountFreezing_FreezingBit_$memory@4 () T@$Memory_590069)
(declare-fun $1_AccountFreezing_FreezingBit_$memory@3 () T@$Memory_590069)
...
(declare-fun $1_Roles_RoleId_$memory@7 () T@$Memory_465676)
(declare-fun $1_Roles_RoleId_$memory@6 () T@$Memory_465676)
(declare-fun |$temp_0'$1_Roles_RoleId'@2| () T@$1_Roles_RoleId)
(declare-fun |$temp_0'bool'@9| () Bool)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@4 () T@$Memory_495622)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@3 () T@$Memory_495622)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@4 () T@$Memory_468705)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2 () T@$Memory_468705)
(declare-fun $1_DiemAccount_DiemAccount_$memory@3 () T@$Memory_468705)
...
(declare-fun $1_Roles_RoleId_$memory@4 () T@$Memory_465676)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1934492) (let ((L2_correct  (and (=> (= (ControlFlow 0 1150553) (- 0 1938327)) (or (or (or (or (or (or (or (or (or (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 173345816)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 173345816)) (not (= (+ 16 (|l#Vec_37831| _$t1)) 32))) (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 186537453)) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 186537453))) (=> (or (or (or (or (or (or (or (or (or (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 173345816)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 173345816)) (not (= (+ 16 (|l#Vec_37831| _$t1)) 32))) (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 186537453)) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 186537453)) (=> (= (ControlFlow 0 1150553) (- 0 1938426)) (or (or (or (or (or (or (or (or (or (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 173345816) (= 6 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816) (= 6 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816) (= 6 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 173345816) (= 6 $t7))) (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 173345816) (= 6 $t7))) (and (not (= (+ 16 (|l#Vec_37831| _$t1)) 32)) (= 7 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 186537453) (= 6 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (= 6 $t7))) (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 186537453) (= 6 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 186537453) (= 6 $t7))))))))
(let ((anon69_Then_correct  (=> (and (and $t21 (or (or (or (or (or (or (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@2) 186537453) (= 6 $t7)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (= 6 $t7))) (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@5) 186537453) (= 6 $t7))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@5) $t19)) (= 5 $t7))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@5) $t19)) 0)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7))) (and (= 186537453 0) (= 7 $t7))) (and (= 186537453 1) (= 7 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@2) 186537453) (= 6 $t7))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (= 5 $t7))) (and (not (= (+ 16 (|l#Vec_37831| _$t1)) 32)) (= 7 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (= 6 $t7)))) (and (= $t7 $t7) (= (ControlFlow 0 1150217) 1150553))) L2_correct)))
(let ((anon60_Then_correct  (=> (and (and $t11 (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 173345816) (= 6 $t7)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816) (= 6 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816) (= 6 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 173345816) (= 6 $t7))) (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t7))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 173345816) (= 6 $t7))) (and (not (= (+ 16 (|l#Vec_37831| _$t1)) 32)) (= 7 $t7)))) (and (= $t7 $t7) (= (ControlFlow 0 1150779) 1150553))) L2_correct)))
(let ((anon59_Then_correct  (=> $t8 (=> (and (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7)) (and (= $t7 $t7) (= (ControlFlow 0 1150809) 1150553))) L2_correct))))
(let ((anon58_Then_correct  (=> $t6 (=> (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t7)) (and (= $t7 $t7) (= (ControlFlow 0 1150835) 1150553))) L2_correct))))
(let ((anon56_correct  (=> (and (= $t22 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@5) 173345816)) (= $t23 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@5) 173345816)))) (=> (and (and (and (= $t24 ($1_DiemAccount_CreateAccountEvent 186537453 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@11) 186537453)))) (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@5) 173345816)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@11) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@11) 186537453)) 1))) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@11) $t20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@11) $t20)) 1)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t20) (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@5) $t20)))) (=> (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@5) $t20) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@5) $t20)))) (and (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t20)))) 0)) (= $t20 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t20)))) 0))))) (and (and (not (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t20)))) 0)) (= $t20 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t20)))) 0)))) (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory@2) $t20))) (and (and (and (= (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t22) (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t17) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t17)))) (= (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t22) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t17) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t17))))) (= $t25 $t24)) (and (= $t26 $t23) (= $es@1 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es@0) $t26)))
(let ((stream_new (let ((len (|l#Multiset_416285| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t25))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t25) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $es@0) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es@0) $t26 stream_new)))))))) (and (=> (= (ControlFlow 0 1149877) (- 0 1937980)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 1149877) (- 0 1937994)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (and (=> (= (ControlFlow 0 1149877) (- 0 1938004)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (and (=> (= (ControlFlow 0 1149877) (- 0 1938014)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (and (=> (= (ControlFlow 0 1149877) (- 0 1938024)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 173345816)) (and (=> (= (ControlFlow 0 1149877) (- 0 1938034)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 1149877) (- 0 1938044)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 173345816)) (and (=> (= (ControlFlow 0 1149877) (- 0 1938054)) (not (not (= (+ 16 (|l#Vec_37831| _$t1)) 32)))) (=> (not (not (= (+ 16 (|l#Vec_37831| _$t1)) 32))) (and (=> (= (ControlFlow 0 1149877) (- 0 1938072)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 186537453))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (and (=> (= (ControlFlow 0 1149877) (- 0 1938082)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (and (=> (= (ControlFlow 0 1149877) (- 0 1938090)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 1149877) (- 0 1938100)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 186537453))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 186537453)) (and (=> (= (ControlFlow 0 1149877) (- 0 1938110)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 186537453))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 186537453)) (and (=> (= (ControlFlow 0 1149877) (- 0 1938120)) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@11) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@11) 173345816) (and (=> (= (ControlFlow 0 1149877) (- 0 1938128)) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@11) 173345816)) 0)) (=> (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@11) 173345816)) 0) (and (=> (= (ControlFlow 0 1149877) (- 0 1938142)) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@11) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@11) 186537453) (and (=> (= (ControlFlow 0 1149877) (- 0 1938150)) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@11) 186537453)) 1)) (=> (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@11) 186537453)) 1) (and (=> (= (ControlFlow 0 1149877) (- 0 1938164)) (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@5) $t3)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@5) $t3) (and (=> (= (ControlFlow 0 1149877) (- 0 1938172)) (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory@2) $t3)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory@2) $t3) (and (=> (= (ControlFlow 0 1149877) (- 0 1938180)) (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@5) $t3)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@5) $t3) (and (=> (= (ControlFlow 0 1149877) (- 0 1938188)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@11) $t3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@11) $t3)) 0))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@11) $t3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@11) $t3)) 0)) (and (=> (= (ControlFlow 0 1149877) (- 0 1938196)) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t3)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t3) (and (=> (= (ControlFlow 0 1149877) (- 0 1938204)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@5) $t3) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@5) $t3))))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@5) $t3) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@5) $t3)))) (and (=> (= (ControlFlow 0 1149877) (- 0 1938212)) (and (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t3)))) 0)) (= $t3 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t3)))) 0))))) (=> (and (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t3)))) 0)) (= $t3 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t3)))) 0)))) (and (=> (= (ControlFlow 0 1149877) (- 0 1938220)) (and (not (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t3)))) 0)) (= $t3 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t3)))) 0))))) (=> (and (not (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t3)))) 0)) (= $t3 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t3)))) 0)))) (and (=> (= (ControlFlow 0 1149877) (- 0 1938228)) (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@5) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@5) 173345816) (and (=> (= (ControlFlow 0 1149877) (- 0 1938236)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@11) $t5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@11) $t5)) 1))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@11) $t5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@11) $t5)) 1)) (and (=> (= (ControlFlow 0 1149877) (- 0 1938244)) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t5)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t5) (and (=> (= (ControlFlow 0 1149877) (- 0 1938252)) (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@5) $t5)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@5) $t5) (and (=> (= (ControlFlow 0 1149877) (- 0 1938260)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@5) $t5) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@5) $t5))))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@5) $t5) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@5) $t5)))) (and (=> (= (ControlFlow 0 1149877) (- 0 1938268)) (and (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t5)))) 0)) (= $t5 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t5)))) 0))))) (=> (and (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t5)))) 0)) (= $t5 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t5)))) 0)))) (and (=> (= (ControlFlow 0 1149877) (- 0 1938276)) (and (not (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t5)))) 0)) (= $t5 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t5)))) 0))))) (=> (and (not (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t5)))) 0)) (= $t5 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) $t5)))) 0)))) (and (=> (= (ControlFlow 0 1149877) (- 0 1938284)) (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory@2) $t5)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory@2) $t5) (=> (= (ControlFlow 0 1149877) (- 0 1938292)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@5) addr@@0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)))))
 :qid |DiemAccountbpl.34591:15|
 :skolemid |719|
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon77_Else_correct  (=> (and (and (not |$temp_0'bool'@15|) (= $1_Roles_RoleId_$memory@10 ($Memory_465676 (|Store__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@8) 186537453 false) (|contents#$Memory_465676| $1_Roles_RoleId_$memory@8)))) (and (= $1_Roles_RoleId_$memory@11 $1_Roles_RoleId_$memory@10) (= (ControlFlow 0 1149380) 1149877))) anon56_correct)))
(let ((anon77_Then_correct  (=> (and (and |$temp_0'bool'@15| (= $1_Roles_RoleId_$memory@9 ($Memory_465676 (|Store__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@8) 186537453 true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@8) 186537453 |$temp_0'$1_Roles_RoleId'@3|)))) (and (= $1_Roles_RoleId_$memory@11 $1_Roles_RoleId_$memory@9) (= (ControlFlow 0 1149889) 1149877))) anon56_correct)))
(let ((anon76_Else_correct  (=> (not |$temp_0'bool'@14|) (=> (and (= $1_VASPDomain_VASPDomainManager_$memory@1 ($Memory_468805 (|Store__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) $t18 false) (|contents#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory))) (= $1_VASPDomain_VASPDomainManager_$memory@2 $1_VASPDomain_VASPDomainManager_$memory@1)) (and (=> (= (ControlFlow 0 1149366) 1149889) anon77_Then_correct) (=> (= (ControlFlow 0 1149366) 1149380) anon77_Else_correct))))))
(let ((anon76_Then_correct  (=> |$temp_0'bool'@14| (=> (and (= $1_VASPDomain_VASPDomainManager_$memory@0 ($Memory_468805 (|Store__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) $t18 true) (|Store__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) $t18 |$temp_0'$1_VASPDomain_VASPDomainManager'@0|))) (= $1_VASPDomain_VASPDomainManager_$memory@2 $1_VASPDomain_VASPDomainManager_$memory@0)) (and (=> (= (ControlFlow 0 1149901) 1149889) anon77_Then_correct) (=> (= (ControlFlow 0 1149901) 1149380) anon77_Else_correct))))))
(let ((anon75_Else_correct  (=> (and (not |$temp_0'bool'@13|) (= $1_Event_EventHandleGenerator_$memory@3 ($Memory_456329 (|Store__T@[Int]Bool_| (|domain#$Memory_456329| $1_Event_EventHandleGenerator_$memory) 186537453 false) (|contents#$Memory_456329| $1_Event_EventHandleGenerator_$memory)))) (and (=> (= (ControlFlow 0 1149352) 1149901) anon76_Then_correct) (=> (= (ControlFlow 0 1149352) 1149366) anon76_Else_correct)))))
(let ((anon75_Then_correct  (=> (and |$temp_0'bool'@13| (= $1_Event_EventHandleGenerator_$memory@2 ($Memory_456329 (|Store__T@[Int]Bool_| (|domain#$Memory_456329| $1_Event_EventHandleGenerator_$memory) 186537453 true) (|Store__T@[Int]$1_Event_EventHandleGenerator_| (|contents#$Memory_456329| $1_Event_EventHandleGenerator_$memory) 186537453 |$temp_0'$1_Event_EventHandleGenerator'@1|)))) (and (=> (= (ControlFlow 0 1149913) 1149901) anon76_Then_correct) (=> (= (ControlFlow 0 1149913) 1149366) anon76_Else_correct)))))
(let ((anon74_Else_correct  (=> (not |$temp_0'bool'@12|) (=> (and (= $1_DiemAccount_AccountOperationsCapability_$memory@4 ($Memory_465211 (|Store__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816 false) (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2))) (= $1_DiemAccount_AccountOperationsCapability_$memory@5 $1_DiemAccount_AccountOperationsCapability_$memory@4)) (and (=> (= (ControlFlow 0 1149338) 1149913) anon75_Then_correct) (=> (= (ControlFlow 0 1149338) 1149352) anon75_Else_correct))))))
(let ((anon74_Then_correct  (=> |$temp_0'bool'@12| (=> (and (= $1_DiemAccount_AccountOperationsCapability_$memory@3 ($Memory_465211 (|Store__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816 true) (|Store__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816 |$temp_0'$1_DiemAccount_AccountOperationsCapability'@1|))) (= $1_DiemAccount_AccountOperationsCapability_$memory@5 $1_DiemAccount_AccountOperationsCapability_$memory@3)) (and (=> (= (ControlFlow 0 1149925) 1149913) anon75_Then_correct) (=> (= (ControlFlow 0 1149925) 1149352) anon75_Else_correct))))))
(let ((anon73_Else_correct  (=> (not |$temp_0'bool'@11|) (=> (and (= $1_AccountFreezing_FreezingBit_$memory@4 ($Memory_590069 (|Store__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@2) $t18 false) (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@2))) (= $1_AccountFreezing_FreezingBit_$memory@5 $1_AccountFreezing_FreezingBit_$memory@4)) (and (=> (= (ControlFlow 0 1149324) 1149925) anon74_Then_correct) (=> (= (ControlFlow 0 1149324) 1149338) anon74_Else_correct))))))
(let ((anon73_Then_correct  (=> |$temp_0'bool'@11| (=> (and (= $1_AccountFreezing_FreezingBit_$memory@3 ($Memory_590069 (|Store__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@2) $t18 true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@2) $t18 |$temp_0'$1_AccountFreezing_FreezingBit'@1|))) (= $1_AccountFreezing_FreezingBit_$memory@5 $1_AccountFreezing_FreezingBit_$memory@3)) (and (=> (= (ControlFlow 0 1149937) 1149925) anon74_Then_correct) (=> (= (ControlFlow 0 1149937) 1149338) anon74_Else_correct))))))
(let ((anon72_Else_correct  (=> (not |$temp_0'bool'@10|) (=> (and (= $1_Roles_RoleId_$memory@7 ($Memory_465676 (|Store__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@5) $t18 false) (|contents#$Memory_465676| $1_Roles_RoleId_$memory@5))) (= $1_Roles_RoleId_$memory@8 $1_Roles_RoleId_$memory@7)) (and (=> (= (ControlFlow 0 1149310) 1149937) anon73_Then_correct) (=> (= (ControlFlow 0 1149310) 1149324) anon73_Else_correct))))))
(let ((anon72_Then_correct  (=> |$temp_0'bool'@10| (=> (and (= $1_Roles_RoleId_$memory@6 ($Memory_465676 (|Store__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@5) $t18 true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@5) $t18 |$temp_0'$1_Roles_RoleId'@2|))) (= $1_Roles_RoleId_$memory@8 $1_Roles_RoleId_$memory@6)) (and (=> (= (ControlFlow 0 1149949) 1149937) anon73_Then_correct) (=> (= (ControlFlow 0 1149949) 1149324) anon73_Else_correct))))))
(let ((anon71_Else_correct  (=> (not |$temp_0'bool'@9|) (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@4 ($Memory_495622 (|Store__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@2) $t18 false) (|contents#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@2))) (= $1_SlidingNonce_SlidingNonce_$memory@5 $1_SlidingNonce_SlidingNonce_$memory@4)) (and (=> (= (ControlFlow 0 1149296) 1149949) anon72_Then_correct) (=> (= (ControlFlow 0 1149296) 1149310) anon72_Else_correct))))))
(let ((anon71_Then_correct  (=> |$temp_0'bool'@9| (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@3 ($Memory_495622 (|Store__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@2) $t18 true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@2) $t18 |$temp_0'$1_SlidingNonce_SlidingNonce'@1|))) (= $1_SlidingNonce_SlidingNonce_$memory@5 $1_SlidingNonce_SlidingNonce_$memory@3)) (and (=> (= (ControlFlow 0 1149961) 1149949) anon72_Then_correct) (=> (= (ControlFlow 0 1149961) 1149310) anon72_Else_correct))))))
(let ((anon70_Else_correct  (=> (not |$temp_0'bool'@8|) (=> (and (= $1_DiemAccount_DiemAccount_$memory@4 ($Memory_468705 (|Store__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t18 false) (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2))) (= $1_DiemAccount_DiemAccount_$memory@5 $1_DiemAccount_DiemAccount_$memory@4)) (and (=> (= (ControlFlow 0 1149282) 1149961) anon71_Then_correct) (=> (= (ControlFlow 0 1149282) 1149296) anon71_Else_correct))))))
(let ((anon70_Then_correct  (=> |$temp_0'bool'@8| (=> (and (= $1_DiemAccount_DiemAccount_$memory@3 ($Memory_468705 (|Store__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t18 true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t18 |$temp_0'$1_DiemAccount_DiemAccount'@1|))) (= $1_DiemAccount_DiemAccount_$memory@5 $1_DiemAccount_DiemAccount_$memory@3)) (and (=> (= (ControlFlow 0 1149973) 1149961) anon71_Then_correct) (=> (= (ControlFlow 0 1149973) 1149296) anon71_Else_correct))))))
(let ((anon69_Else_correct  (=> (not $t21) (and (=> (= (ControlFlow 0 1149270) 1149973) anon70_Then_correct) (=> (= (ControlFlow 0 1149270) 1149282) anon70_Else_correct)))))
(let ((anon30_correct  (=> (= $t12 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (=> (and (= $t13 ($1_DiemAccount_CreateAccountEvent 173345816 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@5) 173345816)))) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@5) 173345816)) (=> (and (and (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@5) 173345816)) 0) (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) $t10)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory@2) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@2) $t10))) (=> (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@5) $t10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@5) $t10)) 0)) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t10)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@2) $t10) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@2) $t10))))) (and (and (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t10)))) 0)) (= $t10 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t10)))) 0)))) (and (not (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t10)))) 0)) (= $t10 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t10)))) 0)))))) (and (and (and (= $t14 $t13) (= $t15 $t12)) (and (= $es@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) $t15)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_416285| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t14))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t14) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) $t15 stream_new@@0))))) (= $t16 186537453))) (and (and (= $t17 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816)) (= $t18 186537453)) (and (= $t19 (|$addr#$signer| _$t0)) (= $t20 186537453))))) (and (=> (= (ControlFlow 0 1149264) (- 0 1937090)) (|Select__T@[Int]Bool_| $1_DiemAccount_DiemAccount_$modifies $t18)) (=> (|Select__T@[Int]Bool_| $1_DiemAccount_DiemAccount_$modifies $t18) (and (=> (= (ControlFlow 0 1149264) (- 0 1937096)) (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies $t18)) (=> (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies $t18) (and (=> (= (ControlFlow 0 1149264) (- 0 1937102)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies $t18)) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies $t18) (and (=> (= (ControlFlow 0 1149264) (- 0 1937108)) (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies $t18)) (=> (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies $t18) (and (=> (= (ControlFlow 0 1149264) (- 0 1937114)) (|Select__T@[Int]Bool_| $1_DiemAccount_AccountOperationsCapability_$modifies 173345816)) (=> (|Select__T@[Int]Bool_| $1_DiemAccount_AccountOperationsCapability_$modifies 173345816) (and (=> (= (ControlFlow 0 1149264) (- 0 1937120)) (|Select__T@[Int]Bool_| $1_Event_EventHandleGenerator_$modifies 186537453)) (=> (|Select__T@[Int]Bool_| $1_Event_EventHandleGenerator_$modifies 186537453) (and (=> (= (ControlFlow 0 1149264) (- 0 1937126)) (|Select__T@[Int]Bool_| $1_VASPDomain_VASPDomainManager_$modifies $t18)) (=> (|Select__T@[Int]Bool_| $1_VASPDomain_VASPDomainManager_$modifies $t18) (and (=> (= (ControlFlow 0 1149264) (- 0 1937132)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies 186537453)) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies 186537453) (=> (= $t21  (or (or (or (or (or (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory@2) 186537453) (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@5) 186537453)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@5) $t19))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@5) $t19)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (= 186537453 0)) (= 186537453 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@2) 186537453)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816)))) (not (= (+ 16 (|l#Vec_37831| _$t1)) 32))) (|Select__T@[Int]Bool_| (|domain#$Memory_468805| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (and (=> (= (ControlFlow 0 1149264) 1150217) anon69_Then_correct) (=> (= (ControlFlow 0 1149264) 1149270) anon69_Else_correct)))))))))))))))))))))))))
(let ((anon68_Else_correct  (=> (and (and (not |$temp_0'bool'@7|) (= $1_Roles_RoleId_$memory@4 ($Memory_465676 (|Store__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@2) 173345816 false) (|contents#$Memory_465676| $1_Roles_RoleId_$memory@2)))) (and (= $1_Roles_RoleId_$memory@5 $1_Roles_RoleId_$memory@4) (= (ControlFlow 0 1148912) 1149264))) anon30_correct)))
(let ((anon68_Then_correct  (=> (and (and |$temp_0'bool'@7| (= $1_Roles_RoleId_$memory@3 ($Memory_465676 (|Store__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@2) 173345816 true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@2) 173345816 |$temp_0'$1_Roles_RoleId'@1|)))) (and (= $1_Roles_RoleId_$memory@5 $1_Roles_RoleId_$memory@3) (= (ControlFlow 0 1150565) 1149264))) anon30_correct)))
(let ((anon67_Else_correct  (=> (not |$temp_0'bool'@6|) (=> (and (= $1_AccountFreezing_FreezingBit_$memory@1 ($Memory_590069 (|Store__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t9 false) (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@1)) (and (=> (= (ControlFlow 0 1148898) 1150565) anon68_Then_correct) (=> (= (ControlFlow 0 1148898) 1148912) anon68_Else_correct))))))
(let ((anon67_Then_correct  (=> |$temp_0'bool'@6| (=> (and (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_590069 (|Store__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t9 true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t9 |$temp_0'$1_AccountFreezing_FreezingBit'@0|))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@0)) (and (=> (= (ControlFlow 0 1150577) 1150565) anon68_Then_correct) (=> (= (ControlFlow 0 1150577) 1148912) anon68_Else_correct))))))
(let ((anon66_Else_correct  (=> (not |$temp_0'bool'@5|) (=> (and (= $1_Roles_RoleId_$memory@1 ($Memory_465676 (|Store__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t9 false) (|contents#$Memory_465676| $1_Roles_RoleId_$memory))) (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@1)) (and (=> (= (ControlFlow 0 1148884) 1150577) anon67_Then_correct) (=> (= (ControlFlow 0 1148884) 1148898) anon67_Else_correct))))))
(let ((anon66_Then_correct  (=> |$temp_0'bool'@5| (=> (and (= $1_Roles_RoleId_$memory@0 ($Memory_465676 (|Store__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t9 true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t9 |$temp_0'$1_Roles_RoleId'@0|))) (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@0)) (and (=> (= (ControlFlow 0 1150589) 1150577) anon67_Then_correct) (=> (= (ControlFlow 0 1150589) 1148898) anon67_Else_correct))))))
(let ((anon65_Else_correct  (=> (not |$temp_0'bool'@4|) (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_495622 (|Store__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) $t9 false) (|contents#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory))) (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1)) (and (=> (= (ControlFlow 0 1148870) 1150589) anon66_Then_correct) (=> (= (ControlFlow 0 1148870) 1148884) anon66_Else_correct))))))
(let ((anon65_Then_correct  (=> |$temp_0'bool'@4| (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_495622 (|Store__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) $t9 true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) $t9 |$temp_0'$1_SlidingNonce_SlidingNonce'@0|))) (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0)) (and (=> (= (ControlFlow 0 1150601) 1150589) anon66_Then_correct) (=> (= (ControlFlow 0 1150601) 1148884) anon66_Else_correct))))))
(let ((anon64_Else_correct  (=> (not |$temp_0'bool'@3|) (=> (and (= $1_DiemAccount_DiemWriteSetManager_$memory@1 ($Memory_465282 (|Store__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) $t9 false) (|contents#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory))) (= $1_DiemAccount_DiemWriteSetManager_$memory@2 $1_DiemAccount_DiemWriteSetManager_$memory@1)) (and (=> (= (ControlFlow 0 1148856) 1150601) anon65_Then_correct) (=> (= (ControlFlow 0 1148856) 1148870) anon65_Else_correct))))))
(let ((anon64_Then_correct  (=> |$temp_0'bool'@3| (=> (and (= $1_DiemAccount_DiemWriteSetManager_$memory@0 ($Memory_465282 (|Store__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) $t9 true) (|Store__T@[Int]$1_DiemAccount_DiemWriteSetManager_| (|contents#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) $t9 |$temp_0'$1_DiemAccount_DiemWriteSetManager'@0|))) (= $1_DiemAccount_DiemWriteSetManager_$memory@2 $1_DiemAccount_DiemWriteSetManager_$memory@0)) (and (=> (= (ControlFlow 0 1150613) 1150601) anon65_Then_correct) (=> (= (ControlFlow 0 1150613) 1148870) anon65_Else_correct))))))
(let ((anon63_Else_correct  (=> (not |$temp_0'bool'@2|) (=> (and (= $1_DiemAccount_AccountOperationsCapability_$memory@1 ($Memory_465211 (|Store__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) $t9 false) (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory))) (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@1)) (and (=> (= (ControlFlow 0 1148842) 1150613) anon64_Then_correct) (=> (= (ControlFlow 0 1148842) 1148856) anon64_Else_correct))))))
(let ((anon63_Then_correct  (=> |$temp_0'bool'@2| (=> (and (= $1_DiemAccount_AccountOperationsCapability_$memory@0 ($Memory_465211 (|Store__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) $t9 true) (|Store__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) $t9 |$temp_0'$1_DiemAccount_AccountOperationsCapability'@0|))) (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@0)) (and (=> (= (ControlFlow 0 1150625) 1150613) anon64_Then_correct) (=> (= (ControlFlow 0 1150625) 1148856) anon64_Else_correct))))))
(let ((anon62_Else_correct  (=> (not |$temp_0'bool'@1|) (=> (and (= $1_DiemAccount_DiemAccount_$memory@1 ($Memory_468705 (|Store__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t9 false) (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@1)) (and (=> (= (ControlFlow 0 1148828) 1150625) anon63_Then_correct) (=> (= (ControlFlow 0 1148828) 1148842) anon63_Else_correct))))))
(let ((anon62_Then_correct  (=> |$temp_0'bool'@1| (=> (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_468705 (|Store__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t9 true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t9 |$temp_0'$1_DiemAccount_DiemAccount'@0|))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@0)) (and (=> (= (ControlFlow 0 1150637) 1150625) anon63_Then_correct) (=> (= (ControlFlow 0 1150637) 1148842) anon63_Else_correct))))))
(let ((anon61_Else_correct  (=> (and (not |$temp_0'bool'@0|) (= $1_Event_EventHandleGenerator_$memory@1 ($Memory_456329 (|Store__T@[Int]Bool_| (|domain#$Memory_456329| $1_Event_EventHandleGenerator_$memory) $t9 false) (|contents#$Memory_456329| $1_Event_EventHandleGenerator_$memory)))) (and (=> (= (ControlFlow 0 1148814) 1150637) anon62_Then_correct) (=> (= (ControlFlow 0 1148814) 1148828) anon62_Else_correct)))))
(let ((anon61_Then_correct  (=> (and |$temp_0'bool'@0| (= $1_Event_EventHandleGenerator_$memory@0 ($Memory_456329 (|Store__T@[Int]Bool_| (|domain#$Memory_456329| $1_Event_EventHandleGenerator_$memory) $t9 true) (|Store__T@[Int]$1_Event_EventHandleGenerator_| (|contents#$Memory_456329| $1_Event_EventHandleGenerator_$memory) $t9 |$temp_0'$1_Event_EventHandleGenerator'@0|)))) (and (=> (= (ControlFlow 0 1150649) 1150637) anon62_Then_correct) (=> (= (ControlFlow 0 1150649) 1148828) anon62_Else_correct)))))
(let ((anon60_Else_correct  (=> (not $t11) (and (=> (= (ControlFlow 0 1148802) 1150649) anon61_Then_correct) (=> (= (ControlFlow 0 1148802) 1148814) anon61_Else_correct)))))
(let ((anon59_Else_correct  (=> (not $t8) (=> (and (= $t9 173345816) (= $t10 173345816)) (and (=> (= (ControlFlow 0 1148796) (- 0 1936330)) (|Select__T@[Int]Bool_| $1_Event_EventHandleGenerator_$modifies $t9)) (=> (|Select__T@[Int]Bool_| $1_Event_EventHandleGenerator_$modifies $t9) (and (=> (= (ControlFlow 0 1148796) (- 0 1936336)) (|Select__T@[Int]Bool_| $1_DiemAccount_DiemAccount_$modifies $t9)) (=> (|Select__T@[Int]Bool_| $1_DiemAccount_DiemAccount_$modifies $t9) (and (=> (= (ControlFlow 0 1148796) (- 0 1936342)) (|Select__T@[Int]Bool_| $1_DiemAccount_AccountOperationsCapability_$modifies $t9)) (=> (|Select__T@[Int]Bool_| $1_DiemAccount_AccountOperationsCapability_$modifies $t9) (and (=> (= (ControlFlow 0 1148796) (- 0 1936348)) (|Select__T@[Int]Bool_| $1_DiemAccount_DiemWriteSetManager_$modifies $t9)) (=> (|Select__T@[Int]Bool_| $1_DiemAccount_DiemWriteSetManager_$modifies $t9) (and (=> (= (ControlFlow 0 1148796) (- 0 1936354)) (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies $t9)) (=> (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies $t9) (and (=> (= (ControlFlow 0 1148796) (- 0 1936360)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies $t9)) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies $t9) (and (=> (= (ControlFlow 0 1148796) (- 0 1936366)) (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies $t9)) (=> (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies $t9) (and (=> (= (ControlFlow 0 1148796) (- 0 1936372)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies 173345816)) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies 173345816) (=> (= $t11  (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_495622| $1_SlidingNonce_SlidingNonce_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 173345816)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) 173345816)) (not (= (+ 16 (|l#Vec_37831| _$t1)) 32)))) (and (=> (= (ControlFlow 0 1148796) 1150779) anon60_Then_correct) (=> (= (ControlFlow 0 1148796) 1148802) anon60_Else_correct)))))))))))))))))))))))
(let ((anon58_Else_correct  (=> (and (not $t6) (= $t8  (not (= (|$addr#$signer| _$t0) 173345816)))) (and (=> (= (ControlFlow 0 1148656) 1150809) anon59_Then_correct) (=> (= (ControlFlow 0 1148656) 1148796) anon59_Else_correct)))))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@1)) 4))))
 :qid |DiemAccountbpl.33642:20|
 :skolemid |677|
)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@2)) 3))))
 :qid |DiemAccountbpl.33646:20|
 :skolemid |678|
))) (and (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@3)) 3))))
 :qid |DiemAccountbpl.33650:20|
 :skolemid |679|
)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@4) (not (= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@4)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@4)) 3))))
 :qid |DiemAccountbpl.33654:20|
 :skolemid |680|
 ...
 :qid |DiemAccountbpl.33718:20|
 :skolemid |693|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_495839| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))))) (=> (and (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_589759| $1_ChainId_ChainId_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 173345816))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) 186537453))))))) (and (and (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@8) (or (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@8)))) 0) (and (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@8)))) 0)) (= addr@@8 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@8)))) 0)))))))
 :qid |DiemAccountbpl.33742:20|
 :skolemid |694|
)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@9) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@9) (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@9)))) 0)) (and (not (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@9)))) 0)) (= addr@@9 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@9)))) 0)))))))
 :qid |DiemAccountbpl.33746:20|
 :skolemid |695|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816))))) (and (and (and (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@10)))
 :qid |DiemAccountbpl.33758:20|
 :skolemid |696|
)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (and (= addr@@11 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@11)) (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@11)))
 :qid |DiemAccountbpl.33762:20|
 :skolemid |697|
))) (and (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (not (= addr@@12 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465282| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@12))))
 :qid |DiemAccountbpl.33766:20|
 :skolemid |698|
 ...
 :qid |DiemAccountbpl.33786:20|
 :skolemid |703|
)))))) (and (and (and (and (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468892| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@18)))
 :qid |DiemAccountbpl.33790:22|
 :skolemid |704|
 ...
 :qid |DiemAccountbpl.33806:20|
 :skolemid |710|
)) (|$IsValid'address'| (|$addr#$signer| _$t0)))))) (and (and (and (and (and (|$IsValid'vec'u8''| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemAccountbpl.33815:20|
 :skolemid |711|
