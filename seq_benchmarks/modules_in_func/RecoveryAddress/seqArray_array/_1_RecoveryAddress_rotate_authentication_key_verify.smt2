...
(assert (not
 (=> (= (ControlFlow 0 0) 86026) (let ((anon46_Else_correct  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 76042) (- 0 88259)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2))) (and (=> (= (ControlFlow 0 76042) (- 0 88270)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) _$t2))) (and (=> (= (ControlFlow 0 76042) (- 0 88281)) (not (not (= (|l#Vec_12290| _$t3) 32)))) (=> (not (not (= (|l#Vec_12290| _$t3) 32))) (and (=> (= (ControlFlow 0 76042) (- 0 88295)) (not (not (exists ((i@@54 Int) ) (!  (and (and (|$IsValid'u64'| i@@54) (and (<= 0 i@@54) (< i@@54 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2))) i@@54)) _$t2))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
))))) (=> (not (not (exists ((i@@55 Int) ) (!  (and (and (|$IsValid'u64'| i@@55) (and (<= 0 i@@55) (< i@@55 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2))) i@@55)) _$t2))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
)))) (and (=> (= (ControlFlow 0 76042) (- 0 88307)) (not (not (or (= (|$addr#$signer| _$t0@@2) _$t1@@2) (= (|$addr#$signer| _$t0@@2) _$t2))))) (=> (not (not (or (= (|$addr#$signer| _$t0@@2) _$t1@@2) (= (|$addr#$signer| _$t0@@2) _$t2)))) (=> (= (ControlFlow 0 76042) (- 0 88328)) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory@1) _$t2)) _$t3)))))))))))))))
(let ((anon47_Else_correct  (=> (and (not $abort_flag@2@@0) (= inline$$AddU64$0$dst@2@@0 inline$$AddU64$0$dst@2@@0)) (and (=> (= (ControlFlow 0 74906) (- 0 87504)) (<= inline$$AddU64$0$dst@2@@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (<= inline$$AddU64$0$dst@2@@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (=> (= (ControlFlow 0 74906) (- 0 87511)) (let (($range_0 ($Range 0 inline$$AddU64$0$dst@2@@0)))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((j@@15 $i_1))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0@@0) j@@15)) _$t2))))
 :qid |RecoveryAddressbpl.5391:49|
 :skolemid |192|
)))))))))
(let ((L17_correct  (and (=> (= (ControlFlow 0 73937) (- 0 88106)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) _$t2))) (not (= (|l#Vec_12290| _$t3) 32))) (not (exists ((i@@56 Int) ) (!  (and (and (|$IsValid'u64'| i@@56) (and (<= 0 i@@56) (< i@@56 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2))) i@@56)) _$t2))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
)))) (not (or (= (|$addr#$signer| _$t0@@2) _$t1@@2) (= (|$addr#$signer| _$t0@@2) _$t2))))) (=> (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) _$t2))) (not (= (|l#Vec_12290| _$t3) 32))) (not (exists ((i@@57 Int) ) (!  (and (and (|$IsValid'u64'| i@@57) (and (<= 0 i@@57) (< i@@57 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2))) i@@57)) _$t2))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
)))) (not (or (= (|$addr#$signer| _$t0@@2) _$t1@@2) (= (|$addr#$signer| _$t0@@2) _$t2)))) (=> (= (ControlFlow 0 73937) (- 0 88158)) (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)) (= 5 $t17@0@@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) _$t2)) (= 5 $t17@0@@0))) (and (not (= (|l#Vec_12290| _$t3) 32)) (= 7 $t17@0@@0))) (and (not (exists ((i@@58 Int) ) (!  (and (and (|$IsValid'u64'| i@@58) (and (<= 0 i@@58) (< i@@58 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2))) i@@58)) _$t2))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
))) (= 7 $t17@0@@0))) (and (not (or (= (|$addr#$signer| _$t0@@2) _$t1@@2) (= (|$addr#$signer| _$t0@@2) _$t2))) (= 7 $t17@0@@0))))))))
(let ((anon46_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t17@0@@0 $abort_code@5) (= (ControlFlow 0 76056) 73937))) L17_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct  (=> (and (and (and inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1 ($Mutation_41428 (|l#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) (let ((l@@1 (|l#Vec_12290| (|p#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))))
(Vec_12290 (|Store__T@[Int]Int_| (|v#Vec_12290| (|p#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) l@@1 0) (+ l@@1 1))) (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))))) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2 ($Mutation_41428 (|l#$Mutation_41428| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1) (|p#$Mutation_41428| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1) _$t3)) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3 ($Mutation_59386 (|l#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) (|p#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) ($1_DiemAccount_DiemAccount (|v#$Mutation_41428| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_57353 (|Store__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)) (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)))) (= $abort_flag@4 $abort_flag@3)) (and (= $abort_code@5 $abort_code@4) (= $1_DiemAccount_DiemAccount_$memory@1 $1_DiemAccount_DiemAccount_$memory@0)))) (and (=> (= (ControlFlow 0 75846) 76056) anon46_Then_correct) (=> (= (ControlFlow 0 75846) 76042) anon46_Else_correct)))))
...
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1 ($Mutation_59386 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1) (Vec_12290 (MapConstVec_7770 DefaultVecElem_7770) 0) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1))) (= $abort_code@4 $abort_code@2@@0)) (and (= $abort_flag@3 $abort_flag@1@@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1))) (and (=> (= (ControlFlow 0 75672) 75874) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct) (=> (= (ControlFlow 0 75672) 75728) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct))))))
...
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct  (=> (and (and $abort_flag@1@@1 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 $abort_code@2@@0) (= (ControlFlow 0 75940) 75642))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
...
(let ((anon47_Then_correct  (=> (and (and $abort_flag@2@@0 (= $abort_code@3@@0 $abort_code@3@@0)) (and (= $t17@0@@0 $abort_code@3@@0) (= (ControlFlow 0 74920) 73937))) L17_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct@@0  (=> (= $abort_code@3@@0 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2@@0 true) (= inline$$AddU64$0$dst@2@@0 inline$$AddU64$0$dst@0@@0)) (and (=> (= (ControlFlow 0 74837) 74920) anon47_Then_correct) (=> (= (ControlFlow 0 74837) 74906) anon47_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct@@0  (=> (and (> (+ $t26@0 1) $MAX_U64) (= (ControlFlow 0 74835) 74837)) inline$$AddU64$0$anon3_Then$1_correct@@0)))
(let ((inline$$AddU64$0$anon3_Else_correct@@0  (=> (>= $MAX_U64 (+ $t26@0 1)) (=> (and (and (= inline$$AddU64$0$dst@1@@0 (+ $t26@0 1)) (= $abort_code@3@@0 $abort_code@2@@0)) (and (= $abort_flag@2@@0 $abort_flag@1@@1) (= inline$$AddU64$0$dst@2@@0 inline$$AddU64$0$dst@1@@0))) (and (=> (= (ControlFlow 0 74783) 74920) anon47_Then_correct) (=> (= (ControlFlow 0 74783) 74906) anon47_Else_correct))))))
(let ((anon45_Else_correct  (=> (and (not $t31@1) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 74843) 74835) inline$$AddU64$0$anon3_Then_correct@@0) (=> (= (ControlFlow 0 74843) 74783) inline$$AddU64$0$anon3_Else_correct@@0)))))
(let ((anon44_Else_correct  (=> (and (not $abort_flag@1@@1) (= $t31@1 (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@0 _$t2))) (and (=> (= (ControlFlow 0 74676) 75944) anon45_Then_correct) (=> (= (ControlFlow 0 74676) 74843) anon45_Else_correct)))))
(let ((anon44_Then_correct  (=> (and (and $abort_flag@1@@1 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= $t17@0@@0 $abort_code@2@@0) (= (ControlFlow 0 76070) 73937))) L17_correct)))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct@@0  (=> (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@0 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@0 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@0)) (and (=> (= (ControlFlow 0 74656) 76070) anon44_Then_correct) (=> (= (ControlFlow 0 74656) 74676) anon44_Else_correct))))))
(let ((anon43_Else_correct  (=> (not $abort_flag@1@@1) (=> (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= (ControlFlow 0 74662) 74656)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct@@0))))
(let ((anon43_Then_correct  (=> (and (and $abort_flag@1@@1 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= $t17@0@@0 $abort_code@2@@0) (= (ControlFlow 0 76084) 73937))) L17_correct)))
...
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_25329 $t25@0@@0 $t26@0)) (= (ControlFlow 0 74539) 74541)) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|  (=> (InRangeVec_25329 $t25@0@@0 $t26@0) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0@@0) $t26@0)) (= $abort_flag@1@@1 $abort_flag@0@@2)) (and (= $abort_code@2@@0 $abort_code@1@@2) (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1|))) (and (=> (= (ControlFlow 0 74489) 76084) anon43_Then_correct) (=> (= (ControlFlow 0 74489) 74662) anon43_Else_correct))))))
(let ((anon42_Then_correct  (=> inline$$Lt$0$dst@1@@0 (and (=> (= (ControlFlow 0 74547) 74539) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 74547) 74489) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|)))))
(let ((anon42_Else_correct  (=> (not inline$$Lt$0$dst@1@@0) (and (=> (= (ControlFlow 0 74402) (- 0 87159)) (= $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (= $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (and (=> (= (ControlFlow 0 74402) (- 0 87166)) (let (($range_0@@0 ($Range 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((j@@16 $i_1@@0))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0@@0) j@@16)) _$t2))))
...
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((j@@17 $i_1@@1))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0@@0) j@@17)) _$t2))))
 :qid |RecoveryAddressbpl.5350:49|
 :skolemid |191|
))) (=> (and (|$IsValid'u64'| 4) (|$IsValid'u64'| $t35)) (=> (and (and (= $t35 7) (= $t35 $t35)) (and (= $t17@0@@0 $t35) (= (ControlFlow 0 74402) 73937))) L17_correct)))))))))
...
(let ((inline$$Lt$0$anon0_correct@@0  (=> (and (= inline$$Lt$0$dst@1@@0 (< $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (= (ControlFlow 0 74311) 74321)) anon41_Else$1_correct)))
...
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((j@@18 $i_1@@2))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0@@0) j@@18)) _$t2))))
 :qid |RecoveryAddressbpl.5198:49|
 :skolemid |189|
)))) (=> (let (($range_0@@3 ($Range 0 0)))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((j@@19 $i_1@@3))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0@@0) j@@19)) _$t2))))
 :qid |RecoveryAddressbpl.5198:49|
 :skolemid |189|
...
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((j@@20 $i_1@@4))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0@@0) j@@20)) _$t2))))
 :qid |RecoveryAddressbpl.5238:54|
 :skolemid |190|
))) (= (ControlFlow 0 74317) 74311)))) inline$$Lt$0$anon0_correct@@0)))))))))
(let ((anon41_Then_correct  (=> (and (and $abort_flag@0@@2 (= $abort_code@1@@2 $abort_code@1@@2)) (and (= $t17@0@@0 $abort_code@1@@2) (= (ControlFlow 0 76098) 73937))) L17_correct)))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| (|l#Vec_28962| $t25@0@@0)) (and (=> (= (ControlFlow 0 74121) 76098) anon41_Then_correct) (=> (= (ControlFlow 0 74121) 74317) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (not $abort_flag@0@@2) (= $t25@0@@0 (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| $t24@1))) (=> (and (and (= $t25@0@@0 $t25@0@@0) (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 74127) 74121))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@0@@2 (= $abort_code@1@@2 $abort_code@1@@2)) (and (= $t17@0@@0 $abort_code@1@@2) (= (ControlFlow 0 76112) 73937))) L17_correct)))
(let ((anon39_Then$1_correct  (=> (= $t24@1 $t24@@0) (=> (and (= $abort_flag@0@@2 true) (= $abort_code@1@@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 76164) 76112) anon40_Then_correct) (=> (= (ControlFlow 0 76164) 74127) anon40_Else_correct))))))
(let ((anon39_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)) (= (ControlFlow 0 76162) 76164)) anon39_Then$1_correct)))
(let ((anon39_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2) (=> (and (and (= $t24@0 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)) (= $t24@1 $t24@0)) (and (= $abort_flag@0@@2 false) (= $abort_code@1@@2 $abort_code@0@@2))) (and (=> (= (ControlFlow 0 74057) 76112) anon40_Then_correct) (=> (= (ControlFlow 0 74057) 74127) anon40_Else_correct))))))
...
(let ((anon38_Else_correct  (=> (and (and (not $t8@0) (= $t23@@1 $t23@@1)) (and (= $t17@0@@0 $t23@@1) (= (ControlFlow 0 74039) 73937))) L17_correct)))
(let ((L5_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t23@@1) (= $t23@@1 7)) (and (= $t23@@1 $t23@@1) (= $t8@0 $t8@0))) (and (=> (= (ControlFlow 0 74023) 74043) anon38_Then_correct) (=> (= (ControlFlow 0 74023) 74039) anon38_Else_correct))))))
(let ((anon37_Else_correct@@0  (=> (not $t19@0) (=> (and (and (= $t21@0 (= $t18@@1 _$t1@@2)) (= $t21@0 $t21@0)) (and (= $t8@0 $t21@0) (= (ControlFlow 0 73989) 74023))) L5_correct))))
(let ((anon37_Then_correct@@0  (=> (and (and $t19@0 (= true true)) (and (= $t8@0 true) (= (ControlFlow 0 76182) 74023))) L5_correct)))
(let ((anon36_Then_correct@@0  (=> $t14@0 (=> (and (and (|$IsValid'address'| $t18@@1) (= $t18@@1 (|$addr#$signer| _$t0@@2))) (and (= $t18@@1 $t18@@1) (= $t19@0 (= $t18@@1 _$t2)))) (and (=> (= (ControlFlow 0 73967) 76182) anon37_Then_correct@@0) (=> (= (ControlFlow 0 73967) 73989) anon37_Else_correct@@0))))))
(let ((anon36_Else_correct@@0  (=> (and (and (not $t14@0) (= $t16@@0 $t16@@0)) (and (= $t17@0@@0 $t16@@0) (= (ControlFlow 0 73761) 73937))) L17_correct)))
(let ((anon0$1_correct@@2  (=> (forall ((addr@@53 Int) ) (!  (=> (|$IsValid'address'| addr@@53) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@53) (or (= (|l#Vec_28962| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@53)))) 0) (and (not (= (|l#Vec_28962| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@53)))) 0)) (= addr@@53 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@53)))) 0)))))))
 :qid |RecoveryAddressbpl.4927:20|
 :skolemid |178|
)) (=> (and (and (and (forall ((addr@@54 Int) ) (!  (=> (|$IsValid'address'| addr@@54) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@54) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@54) (= (|l#Vec_29001| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@54)))) 0)) (and (not (= (|l#Vec_29001| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@54)))) 0)) (= addr@@54 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_29001| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@54)))) 0)))))))
 :qid |RecoveryAddressbpl.4931:20|
 :skolemid |179|
)) (forall ((addr@@55 Int) ) (!  (=> (|$IsValid'address'| addr@@55) (= (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@55) (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@55)))
 :qid |RecoveryAddressbpl.4935:20|
 :skolemid |180|
))) (and (forall ((addr@@56 Int) ) (!  (=> (|$IsValid'address'| addr@@56) (= (|Select__T@[Int]Bool_| (|domain#$Memory_58402| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@56)  (and (= addr@@56 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@56))))
 :qid |RecoveryAddressbpl.4939:20|
 :skolemid |181|
)) (forall ((addr@@57 Int) ) (!  (=> (|$IsValid'address'| addr@@57) (= (|Select__T@[Int]Bool_| (|domain#$Memory_58748| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@57)  (and (= addr@@57 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@57))))
 :qid |RecoveryAddressbpl.4943:20|
 :skolemid |182|
)))) (and (and (forall ((addr@@58 Int) ) (!  (=> (|$IsValid'address'| addr@@58) (= (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@58) (|Select__T@[Int]Bool_| (|domain#$Memory_57320| $1_AccountFreezing_FreezingBit_$memory) addr@@58)))
 :qid |RecoveryAddressbpl.4947:20|
 :skolemid |183|
)) (forall ((addr@@59 Int) ) (!  (=> (|$IsValid'address'| addr@@59) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@59) (|Select__T@[Int]Bool_| (|domain#$Memory_57320| $1_AccountFreezing_FreezingBit_$memory) addr@@59)))
 :qid |RecoveryAddressbpl.4951:20|
 :skolemid |184|
))) (and (forall ((addr@@60 Int) ) (!  (=> (|$IsValid'address'| addr@@60) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@60) (and (> (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@60))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@60))) 0)) addr@@60))))
 :qid |RecoveryAddressbpl.4955:20|
 :skolemid |185|
)) (forall ((addr@@61 Int) ) (!  (=> (|$IsValid'address'| addr@@61) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@61) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) addr@@61) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@61))))
 :qid |RecoveryAddressbpl.4959:20|
 :skolemid |186|
))))) (=> (and (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@2)) ($1_Signer_is_txn_signer _$t0@@2)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@2))) (|$IsValid'address'| _$t1@@2)) (and (|$IsValid'address'| _$t2) (|$IsValid'vec'u8''| _$t3))) (and (and (forall (($a_0@@9 Int) ) (! (let (($rsc@@9 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) $a_0@@9)))
 (and (|$IsValid'$1_DiemAccount_DiemAccount'| $rsc@@9) (and (<= (|l#Vec_29001| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| $rsc@@9))) 1) (<= (|l#Vec_28962| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| $rsc@@9))) 1))))
 :qid |RecoveryAddressbpl.4974:20|
 :skolemid |187|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) $a_0@@9))
)) (forall (($a_0@@10 Int) ) (! (let (($rsc@@10 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@10)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@10))
 :qid |RecoveryAddressbpl.4978:20|
 :skolemid |188|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@10))
))) (and (= _$t0@@2 _$t0@@2) (= _$t1@@2 _$t1@@2)))) (and (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@2)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| $t16@@0) (= $t16@@0 5)) (and (= $t16@@0 $t16@@0) (= $t14@0 $t14@0))))) (and (=> (= (ControlFlow 0 73745) 73967) anon36_Then_correct@@0) (=> (= (ControlFlow 0 73745) 73761) anon36_Else_correct@@0)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_28837_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_28837| stream@@3) 0) (forall ((v@@31 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_28837| stream@@3) v@@31) 0)
 :qid |RecoveryAddressbpl.159:13|
 :skolemid |4|
))))
 :qid |RecoveryAddressbpl.1863:13|
 :skolemid |63|
))) (= (ControlFlow 0 73300) 73745)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 86026) 73300) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
