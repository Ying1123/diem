...
(assert (not
 (=> (= (ControlFlow 0 0) 303256) (let ((anon12_Else_correct@@2  (=> (not $abort_flag@0@@4) (=> (and (= $t8@0@@5 (|$compliance_public_key#$1_DualAttestation_Credential| $t7@1@@1)) (= $t8@0@@5 $t8@0@@5)) (and (=> (= (ControlFlow 0 223628) (- 0 303606)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@8))) (=> (= (ControlFlow 0 223628) (- 0 303617)) (|$IsEqual'vec'u8''| $t8@0@@5 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@8))))))))))
(let ((L3_correct@@2  (and (=> (= (ControlFlow 0 223564) (- 0 303559)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@8))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@8)) (=> (= (ControlFlow 0 223564) (- 0 303565)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@8)) (= 5 $t6@0@@2)))))))
(let ((anon12_Then_correct@@2  (=> (and (and $abort_flag@0@@4 (= $abort_code@1@@4 $abort_code@1@@4)) (and (= $t6@0@@2 $abort_code@1@@4) (= (ControlFlow 0 223642) 223564))) L3_correct@@2)))
(let ((anon11_Then$1_correct@@2  (=> (= $t7@1@@1 $t7@@3) (=> (and (= $abort_flag@0@@4 true) (= $abort_code@1@@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 223694) 223642) anon12_Then_correct@@2) (=> (= (ControlFlow 0 223694) 223628) anon12_Else_correct@@2))))))
(let ((anon11_Then_correct@@2  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@8)) (= (ControlFlow 0 223692) 223694)) anon11_Then$1_correct@@2)))
(let ((anon11_Else_correct@@2  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@8) (=> (and (and (= $t7@0@@1 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@8)) (= $t7@1@@1 $t7@0@@1)) (and (= $abort_flag@0@@4 false) (= $abort_code@1@@4 $abort_code@0@@4))) (and (=> (= (ControlFlow 0 223582) 223642) anon12_Then_correct@@2) (=> (= (ControlFlow 0 223582) 223628) anon12_Else_correct@@2))))))
(let ((anon10_Then_correct@@2  (=> $t3@0@@1 (and (=> (= (ControlFlow 0 223568) 223692) anon11_Then_correct@@2) (=> (= (ControlFlow 0 223568) 223582) anon11_Else_correct@@2)))))
(let ((anon10_Else_correct@@2  (=> (and (and (not $t3@0@@1) (= $t5@@2 $t5@@2)) (and (= $t6@0@@2 $t5@@2) (= (ControlFlow 0 223532) 223564))) L3_correct@@2)))
(let ((anon0$1_correct@@8  (=> (forall ((addr1@@8 Int) ) (!  (=> (|$IsValid'address'| addr1@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr1@@8) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@8)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@8)) 2)))))
 :qid |DualAttestationbpl.13105:20|
 :skolemid |295|
)) (=> (and (forall ((addr@@71 Int) ) (!  (=> (|$IsValid'address'| addr@@71) (= (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr@@71)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@71) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@71)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@71) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@71)) 5)))))
 :qid |DualAttestationbpl.13109:20|
 :skolemid |296|
)) (|$IsValid'address'| _$t0@@8)) (=> (and (and (and (forall (($a_0@@24 Int) ) (! (let (($rsc@@24 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0@@24)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@24))
 :qid |DualAttestationbpl.13116:20|
 :skolemid |297|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0@@24))
)) (= _$t0@@8 _$t0@@8)) (and (= $t3@0@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@8)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5@@2) (= $t5@@2 5)) (and (= $t5@@2 $t5@@2) (= $t3@0@@1 $t3@0@@1)))) (and (=> (= (ControlFlow 0 223516) 223568) anon10_Then_correct@@2) (=> (= (ControlFlow 0 223516) 223532) anon10_Else_correct@@2)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@8  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@10 T@$1_Event_EventHandle) ) (! (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@10)))
 (and (= (|l#Multiset_86488| stream@@9) 0) (forall ((v@@52 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@9) v@@52) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 223366) 223516)) anon0$1_correct@@8)))
(let ((anon0_correct@@8  (=> (= (ControlFlow 0 303256) 223366) inline$$InitEventStore$0$anon0_correct@@8)))
anon0_correct@@8))))))))))))
))
(check-sat)
(pop 1)
