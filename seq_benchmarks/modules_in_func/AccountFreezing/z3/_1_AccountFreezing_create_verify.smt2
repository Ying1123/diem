...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 211059) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 153823) (- 0 211452)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_94864| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) 173345816)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_94864| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) 173345816))))) (and (=> (= (ControlFlow 0 153823) (- 0 211466)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_94864| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) 186537453)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_94864| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) 186537453))))) (and (=> (= (ControlFlow 0 153823) (- 0 211480)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) addr@@0)))
 :qid |AccountFreezingbpl.11461:15|
 :skolemid |189|
))) (=> (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) addr@@1)))
 :qid |AccountFreezingbpl.11461:15|
 :skolemid |189|
)) (and (=> (= (ControlFlow 0 153823) (- 0 211507)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) $t4))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) $t4)) (and (=> (= (ControlFlow 0 153823) (- 0 211517)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) $t4) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) $t4))))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) $t4) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) $t4)))) (=> (= (ControlFlow 0 153823) (- 0 211525)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) addr@@2) (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory@1) addr@@2)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) addr@@2)))))
 :qid |AccountFreezingbpl.11480:15|
 :skolemid |190|
))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 153655) (- 0 211424)) (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) $t4)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) $t4) (=> (= (ControlFlow 0 153655) (- 0 211429)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) $t4) (= 6 $t10@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 153837) 153655))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $1_AccountFreezing_FreezingBit_$memory@1 $1_AccountFreezing_FreezingBit_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 153889) 153837) anon12_Then_correct) (=> (= (ControlFlow 0 153889) 153823) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 153887) 153889)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_96379 (|Store__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0) $t12@0))) (= $1_AccountFreezing_FreezingBit_$memory@1 $1_AccountFreezing_FreezingBit_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 153705) 153837) anon12_Then_correct) (=> (= (ControlFlow 0 153705) 153823) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t12@0 ($1_AccountFreezing_FreezingBit false))) (and (=> (= (ControlFlow 0 153683) (- 0 211301)) (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 153683) 153887) anon11_Then_correct) (=> (= (ControlFlow 0 153683) 153705) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t9 $t9)) (and (= $t10@0 $t9) (= (ControlFlow 0 153627) 153655))) L3_correct)))
(let ((anon0$2_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t9) (= $t9 6)) (and (= $t9 $t9) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 153611) 153683) anon10_Then_correct) (=> (= (ControlFlow 0 153611) 153627) anon10_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t6@0)) (= (ControlFlow 0 153575) 153611)) anon0$2_correct)))
(let ((anon0$1_correct  (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_94864| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) 173345816))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_94864| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) 186537453)))))) (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) $a_0)))
...
)))) (=> (and (and (and (= $t4 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies $t4)) (and (= _$t0 _$t0) (|$IsValid'address'| $t5))) (and (and (= $t5 (|$addr#$signer| _$t0)) (= $t5 $t5)) (and (= $t6@0 (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) $t5)) (= (ControlFlow 0 153581) 153575)))) inline$$Not$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_66189_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountFreezingbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 153425) 153581)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 211059) 153425) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))
))
(check-sat)
(pop 1)
