...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 243578) (let ((anon0$1_correct  (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_132399| $1_VASPDomain_VASPDomainManager_$memory) $a_0)))
(|$IsValid'$1_VASPDomain_VASPDomainManager'| $rsc))
 :qid |VASPDomainbpl.11323:20|
 :skolemid |246|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_132399| $1_VASPDomain_VASPDomainManager_$memory) $a_0))
)) (|$IsValid'address'| 186537453)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_132399| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 179111) (- 0 243663)) (not false)) (=> (not false) (=> (= (ControlFlow 0 179111) (- 0 243670)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_132399| $1_VASPDomain_VASPDomainManager_$memory) 186537453))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_70934_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPDomainbpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 179033) 179111)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 243578) 179033) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
