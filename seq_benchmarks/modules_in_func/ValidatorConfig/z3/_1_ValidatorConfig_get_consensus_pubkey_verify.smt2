...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 93892) (let ((anon0$1_correct  (=> (|$IsValid'$1_ValidatorConfig_Config'| _$t0) (=> (and (and (= _$t0 _$t0) (= $t1@0 (|$consensus_pubkey#$1_ValidatorConfig_Config| _$t0))) (and (= $t1@0 $t1@0) (= (ControlFlow 0 81689) (- 0 93955)))) (not false)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_33654_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 81645) 81689)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 93892) 81645) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
