...
procedure {:timeLimit 40} $1_Roles_grant_role$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    var $temp_0'u64': int;
    var $1_Roles_RoleId_$memory#96: $Memory $1_Roles_RoleId;
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // @96 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/Roles.move:182:9+30
    $1_Roles_RoleId_$memory#96 := $1_Roles_RoleId_$memory;
...
L0:
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/Roles.move:164:5+199
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/Roles.move:164:5+199
    ...
    // assert forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:345:9+112
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:345:9+112
    assume {:print "$at(35,14748,14860)"} true;
    assert {:msg "assert_failed(35,14748,14860): global memory invariant does not hold"}
    ...
    // assert forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:350:9+112
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:350:9+112
    assume {:print "$at(35,15089,15201)"} true;
    assert {:msg "assert_failed(35,15089,15201): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assert forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:357:9+107
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:357:9+107
    assume {:print "$at(35,15535,15642)"} true;
    assert {:msg "assert_failed(35,15535,15642): global memory invariant does not hold"}
...
L2:
    ...
    // assert Not(exists[@96]<Roles::RoleId>(Signer::$address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/Roles.move:179:9+62
    assume {:print "$at(26,7535,7597)"} true;
    assert {:msg "assert_failed(26,7535,7597): function does not abort under this condition"}
      !$ResourceExists($1_Roles_RoleId_$memory#96, $1_Signer_$address_of($t0));
...
L3:
    ...
    // assert exists[@96]<Roles::RoleId>(Signer::$address_of[]($t0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:168:5+419
    assume {:print "$at(26,7034,7453)"} true;
    assert {:msg "assert_failed(26,7034,7453): abort not covered by any of the `aborts_if` clauses"}
      $ResourceExists($1_Roles_RoleId_$memory#96, $1_Signer_$address_of($t0));

    // assert And(exists[@96]<Roles::RoleId>(Signer::$address_of[]($t0)), Eq(6, $t10)) at /home/ying/diem/language/diem-framework/modules/Roles.move:168:5+419
    assert {:msg "assert_failed(26,7034,7453): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ($ResourceExists($1_Roles_RoleId_$memory#96, $1_Signer_$address_of($t0)) && $IsEqual'u8'(6, $t10));
...
L7:
    ...
    // @189 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@189](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
L6:
    ...
    // @161 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@161](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
// spec fun at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:264:5+259
...
// spec fun at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:5+379
...
// spec fun at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:258:10+111
...
// spec fun at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:364:10+122
...
// fun ValidatorConfig::publish [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+602
procedure {:timeLimit 40} $1_ValidatorConfig_publish$verify(_$t0: int, _$t1: int, _$t2: Vec (int)) returns ()
{
    // declare local variables
    var $t3: bool;
    var $t4: int;
    ...
    var $temp_0'u64': int;
    var $temp_0'vec'u8'': Vec (int);
    var $1_ValidatorConfig_ValidatorConfig_$memory#135: $Memory $1_ValidatorConfig_ValidatorConfig;
    ...
    var $1_ValidatorConfig_ValidatorConfig_$memory#243: $Memory $1_ValidatorConfig_ValidatorConfig;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+602
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(35,1987,2589)"} true;
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorOperatorConfig::$has_validator_operator_config(addr): Roles::spec_has_validator_operator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+602
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+602
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:345:9+112
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+602
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:357:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+602
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+602
    assume $IsValid'address'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+602
    assume $IsValid'vec'u8''($t2);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+602
    ...
    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+602
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));
    ...
    // @136 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+1
    ...
    // @137 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+1
    $1_Roles_RoleId_$memory#137 := $1_Roles_RoleId_$memory;

    // @135 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+1
    $1_ValidatorConfig_ValidatorConfig_$memory#135 := $1_ValidatorConfig_ValidatorConfig_$memory;
...
L0:
    ...
    // @243 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:50:5+602
    // state save for global update invariants
    assume {:print "$at(35,1987,2589)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#243 := $1_ValidatorConfig_ValidatorConfig_$memory;
    ...
    // assert forall validator: TypeDomain<address>() where ValidatorConfig::$is_valid[@243](validator): ValidatorConfig::$is_valid(validator) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:336:9+107
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:336:9+107
    assume {:print "$at(35,14475,14582)"} true;
    assert {:msg "assert_failed(35,14475,14582): global memory invariant does not hold"}
      (forall validator: int :: $IsValid'address'(validator) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory#243, validator))  ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, validator)));
...
L2:
    ...
    // assert Not(ValidatorConfig::$exists_config[@135](Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:80:9+83
    assume {:print "$at(35,3084,3167)"} true;
    assert {:msg "assert_failed(35,3084,3167): function does not abort under this condition"}
      !$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#135, $1_Signer_spec_address_of($t0));

    // assert Not(Not(DiemTimestamp::$is_operating[@136]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    ...
    // assert Not(Not(exists[@137]<Roles::RoleId>($t5))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#137, $t5);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>($t5)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $t5)), 0);
    ...
    // assert Not(Not(exists[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/Roles.move:580:9+69
    assume {:print "$at(26,25923,25992)"} true;
    assert {:msg "assert_failed(26,25923,25992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0));

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0))), 3)) at /home/ying/diem/language/diem-framework/modules/Roles.move:581:9+97
    assume {:print "$at(26,26001,26098)"} true;
    assert {:msg "assert_failed(26,26001,26098): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0))), 3);

    // assert ValidatorConfig::$exists_config(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:71:9+66
    assume {:print "$at(35,2712,2778)"} true;
    assert {:msg "assert_failed(35,2712,2778): post-condition does not hold"}
      $1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, $1_Signer_spec_address_of($t0));

    // assert forall addr1: TypeDomain<address>() where exists[@135]<ValidatorConfig::ValidatorConfig>(addr1): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr1)), select ValidatorConfig::ValidatorConfig.operator_account(global[@135]<ValidatorConfig::ValidatorConfig>(addr1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    assume {:print "$at(35,14075,14264)"} true;
    assert {:msg "assert_failed(35,14075,14264): post-condition does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory#135, addr1))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr1)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#135, addr1)))));

    // return () at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    return;
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(ValidatorConfig::$exists_config[@135](Signer::spec_address_of[]($t0)), Not(DiemTimestamp::$is_operating[@136]())), Not(exists[@137]<Roles::RoleId>($t5))), Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>($t5)), 0)), Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Not(exists[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0)))), Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0))), 3)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:69:5+189
    assume {:print "$at(35,2595,2784)"} true;
    assert {:msg "assert_failed(35,2595,2784): abort not covered by any of the `aborts_if` clauses"}
      (((((($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#135, $1_Signer_spec_address_of($t0)) || !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#136)) || !$ResourceExists($1_Roles_RoleId_$memory#137, $t5)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $t5)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$ResourceExists($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0))) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0))), 3));

    // assert Or(Or(Or(Or(Or(Or(And(ValidatorConfig::$exists_config[@135](Signer::spec_address_of[]($t0)), Eq(6, $t7)), And(Not(DiemTimestamp::$is_operating[@136]()), Eq(1, $t7))), And(Not(exists[@137]<Roles::RoleId>($t5)), Eq(5, $t7))), And(Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>($t5)), 0), Eq(3, $t7))), And(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t7))), And(Not(exists[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0))), Eq(5, $t7))), And(Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0))), 3), Eq(3, $t7))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:69:5+189
    assert {:msg "assert_failed(35,2595,2784): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#135, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(6, $t7)) || (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#136) && $IsEqual'u8'(1, $t7))) || (!$ResourceExists($1_Roles_RoleId_$memory#137, $t5) && $IsEqual'u8'(5, $t7))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $t5)), 0) && $IsEqual'u8'(3, $t7))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t7))) || (!$ResourceExists($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(5, $t7))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0))), 3) && $IsEqual'u8'(3, $t7)));

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:69:5+189
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::get_human_name [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:264:5+259
procedure {:timeLimit 40} $1_ValidatorConfig_get_human_name$verify(_$t0: int) returns ($ret0: Vec (int))
{
    // declare local variables
    var $t1: $1_ValidatorConfig_ValidatorConfig;
    var $t2: bool;
    var $t3: int;
    var $t4: bool;
    var $t5: int;
    ...
    var $temp_0'u64': int;
    var $temp_0'vec'u8'': Vec (int);
    var $1_ValidatorConfig_ValidatorConfig_$memory#94: $Memory $1_ValidatorConfig_ValidatorConfig;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:264:5+259
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:345:9+112
    assume {:print "$at(35,11777,12036)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:264:5+259
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:357:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:273:17+6
    assume {:print "$at(35,12146,12152)"} true;
    assume $IsValid'address'($t0);
    ...
    // @94 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:264:5+1
    assume {:print "$at(35,11777,11778)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#94 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:264:5+1
    assume {:print "$track_local(19,3,0):", $t0} $t0 == $t0;

    // $t4 := exists<ValidatorConfig::ValidatorConfig>($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:16+6
    assume {:print "$at(35,11872,11878)"} true;
    $t4 := $ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0);

    // $t5 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:69+17
    $t5 := 0;
    assume $IsValid'u64'($t5);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:47+40
    // >> opaque call: $t6 := Errors::not_published($t5)

    // $t6 := opaque begin: Errors::not_published($t5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:47+40

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:47+40
    assume $IsValid'u64'($t6);

    // assume Eq<u64>($t6, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:47+40
    assume $IsEqual'u64'($t6, 5);

    // $t6 := opaque end: Errors::not_published($t5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:47+40

    // trace_local[tmp#$3]($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:9+79
    assume {:print "$track_local(19,3,3):", $t6} $t6 == $t6;

    // trace_local[tmp#$2]($t4) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:9+79
    assume {:print "$track_local(19,3,2):", $t4} $t4 == $t4;

    // if ($t4) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:9+79
    if ($t4) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:9+79
L1:

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:9+79
    assume {:print "$at(35,11865,11944)"} true;
    assume {:print "$track_abort(19,3):", $t6} $t6 == $t6;

    // $t7 := move($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:9+79
    $t7 := $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:9+79
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:266:52+4
    assume {:print "$at(35,11997,12001)"} true;
L0:

    // $t8 := get_global<ValidatorConfig::ValidatorConfig>($t0) on_abort goto L3 with $t7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:266:21+13
    if (!$ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
    ...
    if ($abort_flag) {
        assume {:print "$at(35,11966,11979)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(19,3):", $t7} $t7 == $t7;
        goto L3;
    }

    // trace_local[t_ref]($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:266:13+5
    assume {:print "$track_local(19,3,1):", $t8} $t8 == $t8;

    // $t9 := get_field<ValidatorConfig::ValidatorConfig>.human_name($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:267:10+17
    assume {:print "$at(35,12013,12030)"} true;
    $t9 := $human_name#$1_ValidatorConfig_ValidatorConfig($t8);

    // trace_return[0]($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:267:9+18
    assume {:print "$track_return(19,3,0):", $t9} $t9 == $t9;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:268:5+1
    assume {:print "$at(35,12035,12036)"} true;
L2:

    // assert Not(Not(ValidatorConfig::$exists_config[@94]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:92:9+58
    assume {:print "$at(35,3469,3527)"} true;
    assert {:msg "assert_failed(35,3469,3527): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#94, $t0);

    // assert Eq<vector<u8>>($t9, ValidatorConfig::$get_human_name($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:273:9+39
    assume {:print "$at(35,12138,12177)"} true;
    assert {:msg "assert_failed(35,12138,12177): post-condition does not hold"}
      $IsEqual'vec'u8''($t9, $1_ValidatorConfig_$get_human_name($1_ValidatorConfig_ValidatorConfig_$memory, $t0));

    // assert forall addr1: TypeDomain<address>() where exists[@94]<ValidatorConfig::ValidatorConfig>(addr1): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr1)), select ValidatorConfig::ValidatorConfig.operator_account(global[@94]<ValidatorConfig::ValidatorConfig>(addr1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    assume {:print "$at(35,14075,14264)"} true;
    assert {:msg "assert_failed(35,14075,14264): post-condition does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory#94, addr1))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr1)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#94, addr1)))));

    // return $t9 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    $ret0 := $t9;
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:268:5+1
    assume {:print "$at(35,12035,12036)"} true;
L3:

    // assert Not(ValidatorConfig::$exists_config[@94]($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:270:5+141
    assume {:print "$at(35,12042,12183)"} true;
    assert {:msg "assert_failed(35,12042,12183): abort not covered by any of the `aborts_if` clauses"}
      !$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#94, $t0);

    // assert And(Not(ValidatorConfig::$exists_config[@94]($t0)), Eq(5, $t7)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:270:5+141
    assert {:msg "assert_failed(35,12042,12183): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#94, $t0) && $IsEqual'u8'(5, $t7));

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:270:5+141
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::exists_config [baseline] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:85:5+84
procedure {:inline 1} $1_ValidatorConfig_exists_config(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:85:5+1
    assume {:print "$at(35,3249,3250)"} true;
    assume {:print "$track_local(19,0,0):", $t0} $t0 == $t0;

    // $t1 := exists<ValidatorConfig::ValidatorConfig>($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:86:9+6
    assume {:print "$at(35,3298,3304)"} true;
    $t1 := $ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:86:9+29
    assume {:print "$track_return(19,0,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:87:5+1
    assume {:print "$at(35,3332,3333)"} true;
L1:

    // return $t1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:87:5+1
    $ret0 := $t1;
    return;

}

// fun ValidatorConfig::exists_config [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:85:5+84
procedure {:timeLimit 40} $1_ValidatorConfig_exists_config$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_ValidatorConfig_ValidatorConfig_$memory#92: $Memory $1_ValidatorConfig_ValidatorConfig;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:85:5+84
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:345:9+112
    assume {:print "$at(35,3249,3333)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:85:5+84
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:357:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:85:5+84
    assume $IsValid'address'($t0);
    ...
    // @92 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:85:5+1
    $1_ValidatorConfig_ValidatorConfig_$memory#92 := $1_ValidatorConfig_ValidatorConfig_$memory;
...
L1:
    ...
    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:87:5+1
    assert {:msg "assert_failed(35,3332,3333): function does not abort under this condition"}
      !false;

    // assert forall addr1: TypeDomain<address>() where exists[@92]<ValidatorConfig::ValidatorConfig>(addr1): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr1)), select ValidatorConfig::ValidatorConfig.operator_account(global[@92]<ValidatorConfig::ValidatorConfig>(addr1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    assume {:print "$at(35,14075,14264)"} true;
    assert {:msg "assert_failed(35,14075,14264): post-condition does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory#92, addr1))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr1)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#92, addr1)))));

    // return $t1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    $ret0 := $t1;
    return;

}

// fun ValidatorConfig::get_config [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:5+341
procedure {:timeLimit 40} $1_ValidatorConfig_get_config$verify(_$t0: int) returns ($ret0: $1_ValidatorConfig_Config)
{
    // declare local variables
    var $t1: $1_Option_Option'$1_ValidatorConfig_Config';
    var $t2: bool;
    var $t3: int;
    var $t4: bool;
    var $t5: int;
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_ValidatorConfig_ValidatorConfig_$memory#130: $Memory $1_ValidatorConfig_ValidatorConfig;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:5+341
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:345:9+112
    assume {:print "$at(35,10914,11255)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:5+341
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:357:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:254:17+6
    assume {:print "$at(35,11464,11470)"} true;
    assume $IsValid'address'($t0);
    ...
    // @130 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:5+1
    assume {:print "$at(35,10914,10915)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#130 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:5+1
    assume {:print "$track_local(19,1,0):", $t0} $t0 == $t0;

    // $t6 := ValidatorConfig::exists_config($t0) on_abort goto L5 with $t7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:16+19
    assume {:print "$at(35,11001,11020)"} true;
    call $t6 := $1_ValidatorConfig_exists_config($t0);
    if ($abort_flag) {
        assume {:print "$at(35,11001,11020)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(19,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t8 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:59+17
    $t8 := 0;
    assume $IsValid'u64'($t8);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:37+40
    // >> opaque call: $t8 := Errors::not_published($t7)

    // $t9 := opaque begin: Errors::not_published($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:37+40

    // assume WellFormed($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:37+40
    assume $IsValid'u64'($t9);

    // assume Eq<u64>($t9, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:37+40
    assume $IsEqual'u64'($t9, 5);

    // $t9 := opaque end: Errors::not_published($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:37+40

    // trace_local[tmp#$3]($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:9+69
    assume {:print "$track_local(19,1,3):", $t9} $t9 == $t9;

    // trace_local[tmp#$2]($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:9+69
    assume {:print "$track_local(19,1,2):", $t6} $t6 == $t6;

    // if ($t6) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:9+69
    if ($t6) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:9+69
L1:

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:9+69
    assume {:print "$at(35,10994,11063)"} true;
    assume {:print "$track_abort(19,1):", $t9} $t9 == $t9;

    // $t7 := move($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:9+69
    $t7 := $t9;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:9+69
    goto L5;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:245:54+4
    assume {:print "$at(35,11118,11122)"} true;
L0:

    // $t10 := get_global<ValidatorConfig::ValidatorConfig>($t0) on_abort goto L5 with $t7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:245:23+13
    if (!$ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
    ...
    if ($abort_flag) {
        assume {:print "$at(35,11087,11100)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(19,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t11 := get_field<ValidatorConfig::ValidatorConfig>.config($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:245:22+44
    $t11 := $config#$1_ValidatorConfig_ValidatorConfig($t10);

    // trace_local[config]($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:245:13+6
    assume {:print "$track_local(19,1,1):", $t11} $t11 == $t11;

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:16+23
    // >> opaque call: $t11 := Option::is_some<ValidatorConfig::Config>($t10)
    assume {:print "$at(35,11147,11170)"} true;

    // $t12 := opaque begin: Option::is_some<ValidatorConfig::Config>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:16+23

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:16+23
    assume $IsValid'bool'($t12);

    // assume Eq<bool>($t12, Option::$is_some<ValidatorConfig::Config>($t11)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:16+23
    assume $IsEqual'bool'($t12, $1_Option_$is_some'$1_ValidatorConfig_Config'($t11));

    // $t12 := opaque end: Option::is_some<ValidatorConfig::Config>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:16+23

    // $t13 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:66+17
    $t13 := 0;
    assume $IsValid'u64'($t13);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:41+43
    // >> opaque call: $t13 := Errors::invalid_argument($t12)

    // $t14 := opaque begin: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:41+43

    // assume WellFormed($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:41+43
    assume $IsValid'u64'($t14);

    // assume Eq<u64>($t14, 7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:41+43
    assume $IsEqual'u64'($t14, 7);

    // $t14 := opaque end: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:41+43

    // trace_local[tmp#$5]($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:9+76
    assume {:print "$track_local(19,1,5):", $t14} $t14 == $t14;

    // trace_local[tmp#$4]($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:9+76
    assume {:print "$track_local(19,1,4):", $t12} $t12 == $t12;

    // if ($t12) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:9+76
    if ($t12) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:9+76
L3:

    // destroy($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:9+76

    // trace_abort($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:9+76
    assume {:print "$at(35,11140,11216)"} true;
    assume {:print "$track_abort(19,1):", $t14} $t14 == $t14;

    // $t7 := move($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:9+76
    $t7 := $t14;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:246:9+76
    goto L5;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:25+6
    assume {:print "$at(35,11242,11248)"} true;
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22
    // >> opaque call: $t14 := Option::borrow<ValidatorConfig::Config>($t10)

    // $t15 := opaque begin: Option::borrow<ValidatorConfig::Config>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22

    // assume Identical($t16, Option::$is_none<ValidatorConfig::Config>($t11)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22
    assume ($t16 == $1_Option_$is_none'$1_ValidatorConfig_Config'($t11));

    // if ($t16) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22
    if ($t16) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22
L7:

    // assume And(Option::$is_none<ValidatorConfig::Config>($t11), Eq(7, $t7)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22
    assume ($1_Option_$is_none'$1_ValidatorConfig_Config'($t11) && $IsEqual'u8'(7, $t7));

    // trace_abort($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22
    assume {:print "$at(35,11227,11249)"} true;
    assume {:print "$track_abort(19,1):", $t7} $t7 == $t7;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22
L6:

    // assume WellFormed($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22
    assume $IsValid'$1_ValidatorConfig_Config'($t15);

    // assume Eq<ValidatorConfig::Config>($t15, Option::$borrow<ValidatorConfig::Config>($t11)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22
    assume $IsEqual'$1_ValidatorConfig_Config'($t15, $1_Option_$borrow'$1_ValidatorConfig_Config'($t11));

    // $t15 := opaque end: Option::borrow<ValidatorConfig::Config>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:10+22

    // trace_return[0]($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:9+23
    assume {:print "$track_return(19,1,0):", $t15} $t15 == $t15;

    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:248:5+1
    assume {:print "$at(35,11254,11255)"} true;
L4:

    // assert Not(Not(ValidatorConfig::$exists_config[@130]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:92:9+58
    assume {:print "$at(35,3469,3527)"} true;
    assert {:msg "assert_failed(35,3469,3527): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#130, $t0);

    // assert Not(Option::$is_none[]<ValidatorConfig::Config>(select ValidatorConfig::ValidatorConfig.config(global[@130]<ValidatorConfig::ValidatorConfig>($t0)))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:253:9+94
    assume {:print "$at(35,11353,11447)"} true;
    assert {:msg "assert_failed(35,11353,11447): function does not abort under this condition"}
      !$1_Option_$is_none'$1_ValidatorConfig_Config'($config#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#130, $t0)));

    // assert Eq<ValidatorConfig::Config>($t15, ValidatorConfig::spec_get_config($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:254:9+40
    assume {:print "$at(35,11456,11496)"} true;
    assert {:msg "assert_failed(35,11456,11496): post-condition does not hold"}
      $IsEqual'$1_ValidatorConfig_Config'($t15, $1_ValidatorConfig_spec_get_config($1_ValidatorConfig_ValidatorConfig_$memory, $t0));

    // assert forall addr1: TypeDomain<address>() where exists[@130]<ValidatorConfig::ValidatorConfig>(addr1): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr1)), select ValidatorConfig::ValidatorConfig.operator_account(global[@130]<ValidatorConfig::ValidatorConfig>(addr1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    assume {:print "$at(35,14075,14264)"} true;
    assert {:msg "assert_failed(35,14075,14264): post-condition does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory#130, addr1))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr1)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#130, addr1)))));

    // return $t15 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    $ret0 := $t15;
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:248:5+1
    assume {:print "$at(35,11254,11255)"} true;
L5:

    // assert Or(Not(ValidatorConfig::$exists_config[@130]($t0)), Option::$is_none[]<ValidatorConfig::Config>(select ValidatorConfig::ValidatorConfig.config(global[@130]<ValidatorConfig::ValidatorConfig>($t0)))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:250:5+241
    assume {:print "$at(35,11261,11502)"} true;
    assert {:msg "assert_failed(35,11261,11502): abort not covered by any of the `aborts_if` clauses"}
      (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#130, $t0) || $1_Option_$is_none'$1_ValidatorConfig_Config'($config#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#130, $t0))));

    // assert Or(And(Not(ValidatorConfig::$exists_config[@130]($t0)), Eq(5, $t7)), And(Option::$is_none[]<ValidatorConfig::Config>(select ValidatorConfig::ValidatorConfig.config(global[@130]<ValidatorConfig::ValidatorConfig>($t0))), Eq(7, $t7))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:250:5+241
    assert {:msg "assert_failed(35,11261,11502): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#130, $t0) && $IsEqual'u8'(5, $t7)) || ($1_Option_$is_none'$1_ValidatorConfig_Config'($config#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#130, $t0))) && $IsEqual'u8'(7, $t7)));

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:250:5+241
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::get_consensus_pubkey [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:300:5+110
procedure {:timeLimit 40} $1_ValidatorConfig_get_consensus_pubkey$verify(_$t0: $1_ValidatorConfig_Config) returns ($ret0: Vec (int))
{
    ...
    var $temp_0'$1_ValidatorConfig_Config': $1_ValidatorConfig_Config;
    var $temp_0'vec'u8'': Vec (int);
    var $1_ValidatorConfig_ValidatorConfig_$memory#91: $Memory $1_ValidatorConfig_ValidatorConfig;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:300:5+110
    assume {:print "$at(35,13088,13198)"} true;
    assume $IsValid'$1_ValidatorConfig_Config'($t0);

    // @91 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:300:5+1
    $1_ValidatorConfig_ValidatorConfig_$memory#91 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[config_ref]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:300:5+1
    assume {:print "$track_local(19,2,0):", $t0} $t0 == $t0;

    // $t1 := get_field<ValidatorConfig::Config>.consensus_pubkey($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:301:9+28
    assume {:print "$at(35,13164,13192)"} true;
    $t1 := $consensus_pubkey#$1_ValidatorConfig_Config($t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:301:9+28
    assume {:print "$track_return(19,2,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:302:5+1
    assume {:print "$at(35,13197,13198)"} true;
L1:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:302:5+1
    assert {:msg "assert_failed(35,13197,13198): function does not abort under this condition"}
      !false;

    // assert forall addr1: TypeDomain<address>() where exists[@91]<ValidatorConfig::ValidatorConfig>(addr1): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr1)), select ValidatorConfig::ValidatorConfig.operator_account(global[@91]<ValidatorConfig::ValidatorConfig>(addr1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    assume {:print "$at(35,14075,14264)"} true;
    assert {:msg "assert_failed(35,14075,14264): post-condition does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory#91, addr1))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr1)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#91, addr1)))));
...
// fun ValidatorConfig::get_operator [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:5+379
procedure {:timeLimit 40} $1_ValidatorConfig_get_operator$verify(_$t0: int) returns ($ret0: int)
{
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:5+379
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:345:9+112
    assume {:print "$at(35,12319,12698)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:5+379
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:357:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:289:17+6
    assume {:print "$at(35,12800,12806)"} true;
    assume $IsValid'address'($t0);
    ...
    // @123 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:5+1
    assume {:print "$at(35,12319,12320)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#123 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:5+1
    assume {:print "$track_local(19,4,0):", $t0} $t0 == $t0;

    // $t6 := exists<ValidatorConfig::ValidatorConfig>($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:16+6
    assume {:print "$at(35,12409,12415)"} true;
    $t6 := $ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0);

    // $t7 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:69+17
    $t7 := 0;
    assume $IsValid'u64'($t7);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:47+40
    // >> opaque call: $t8 := Errors::not_published($t7)

    // $t8 := opaque begin: Errors::not_published($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:47+40

    // assume WellFormed($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:47+40
    assume $IsValid'u64'($t8);

    // assume Eq<u64>($t8, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:47+40
    assume $IsEqual'u64'($t8, 5);

    // $t8 := opaque end: Errors::not_published($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:47+40

    // trace_local[tmp#$3]($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:9+79
    assume {:print "$track_local(19,4,3):", $t8} $t8 == $t8;

    // trace_local[tmp#$2]($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:9+79
    assume {:print "$track_local(19,4,2):", $t6} $t6 == $t6;

    // if ($t6) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:9+79
    if ($t6) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:9+79
L1:

    // trace_abort($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:9+79
    assume {:print "$at(35,12402,12481)"} true;
    assume {:print "$track_abort(19,4):", $t8} $t8 == $t8;

    // $t9 := move($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:9+79
    $t9 := $t8;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:9+79
    goto L5;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:281:52+4
    assume {:print "$at(35,12534,12538)"} true;
L0:

    // $t10 := get_global<ValidatorConfig::ValidatorConfig>($t0) on_abort goto L5 with $t9 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:281:21+13
    if (!$ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
        $t10 := $ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, $t0);
    ...
    if ($abort_flag) {
        assume {:print "$at(35,12503,12516)"} true;
        $t9 := $abort_code;
        assume {:print "$track_abort(19,4):", $t9} $t9 == $t9;
        goto L5;
    }

    // trace_local[t_ref]($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:281:13+5
    assume {:print "$track_local(19,4,1):", $t10} $t10 == $t10;

    // $t11 := get_field<ValidatorConfig::ValidatorConfig>.operator_account($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:32+23
    assume {:print "$at(35,12572,12595)"} true;
    $t11 := $operator_account#$1_ValidatorConfig_ValidatorConfig($t10);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:16+40
    // >> opaque call: $t11 := Option::is_some<address>($t10)

    // $t12 := opaque begin: Option::is_some<address>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:16+40

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:16+40
    assume $IsValid'bool'($t12);

    // assume Eq<bool>($t12, Option::$is_some<address>($t11)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:16+40
    assume $IsEqual'bool'($t12, $1_Option_$is_some'address'($t11));

    // $t12 := opaque end: Option::is_some<address>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:16+40

    // $t13 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:83+17
    $t13 := 0;
    assume $IsValid'u64'($t13);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:58+43
    // >> opaque call: $t13 := Errors::invalid_argument($t12)

    // $t14 := opaque begin: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:58+43

    // assume WellFormed($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:58+43
    assume $IsValid'u64'($t14);

    // assume Eq<u64>($t14, 7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:58+43
    assume $IsEqual'u64'($t14, 7);

    // $t14 := opaque end: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:58+43

    // trace_local[tmp#$5]($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:9+93
    assume {:print "$track_local(19,4,5):", $t14} $t14 == $t14;

    // trace_local[tmp#$4]($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:9+93
    assume {:print "$track_local(19,4,4):", $t12} $t12 == $t12;

    // if ($t12) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:9+93
    if ($t12) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:9+93
L3:

    // destroy($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:9+93

    // trace_abort($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:9+93
    assume {:print "$at(35,12549,12642)"} true;
    assume {:print "$track_abort(19,4):", $t14} $t14 == $t14;

    // $t9 := move($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:9+93
    $t9 := $t14;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:282:9+93
    goto L5;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:26+5
    assume {:print "$at(35,12669,12674)"} true;
L2:

    // $t15 := get_field<ValidatorConfig::ValidatorConfig>.operator_account($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:25+23
    $t15 := $operator_account#$1_ValidatorConfig_ValidatorConfig($t10);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39
    // >> opaque call: $t15 := Option::borrow<address>($t14)

    // $t16 := opaque begin: Option::borrow<address>($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39

    // assume Identical($t17, Option::$is_none<address>($t15)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39
    assume ($t17 == $1_Option_$is_none'address'($t15));

    // if ($t17) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39
    if ($t17) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39
L7:

    // assume And(Option::$is_none<address>($t15), Eq(7, $t9)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39
    assume ($1_Option_$is_none'address'($t15) && $IsEqual'u8'(7, $t9));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39
    assume {:print "$at(35,12653,12692)"} true;
    assume {:print "$track_abort(19,4):", $t9} $t9 == $t9;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39
L6:

    // assume WellFormed($t16) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39
    assume $IsValid'address'($t16);

    // assume Eq<address>($t16, Option::$borrow<address>($t15)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39
    assume $IsEqual'address'($t16, $1_Option_$borrow'address'($t15));

    // $t16 := opaque end: Option::borrow<address>($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:10+39

    // trace_return[0]($t16) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:9+40
    assume {:print "$track_return(19,4,0):", $t16} $t16 == $t16;

    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:284:5+1
    assume {:print "$at(35,12697,12698)"} true;
L4:

    // assert Not(Not(ValidatorConfig::spec_has_operator[@123]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:295:9+65
    assume {:print "$at(35,12949,13014)"} true;
    assert {:msg "assert_failed(35,12949,13014): function does not abort under this condition"}
      !!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#123, $t0);

    // assert Not(Not(ValidatorConfig::$exists_config[@123]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:92:9+58
    assume {:print "$at(35,3469,3527)"} true;
    assert {:msg "assert_failed(35,3469,3527): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#123, $t0);

    // assert Eq<address>($t16, ValidatorConfig::$get_operator($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:289:9+37
    assume {:print "$at(35,12792,12829)"} true;
    assert {:msg "assert_failed(35,12792,12829): post-condition does not hold"}
      $IsEqual'address'($t16, $1_ValidatorConfig_$get_operator($1_ValidatorConfig_ValidatorConfig_$memory, $t0));

    // assert forall addr1: TypeDomain<address>() where exists[@123]<ValidatorConfig::ValidatorConfig>(addr1): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr1)), select ValidatorConfig::ValidatorConfig.operator_account(global[@123]<ValidatorConfig::ValidatorConfig>(addr1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    assume {:print "$at(35,14075,14264)"} true;
    assert {:msg "assert_failed(35,14075,14264): post-condition does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory#123, addr1))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr1)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#123, addr1)))));

    // return $t16 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    $ret0 := $t16;
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:284:5+1
    assume {:print "$at(35,12697,12698)"} true;
L5:

    // assert Or(Not(ValidatorConfig::spec_has_operator[@123]($t0)), Not(ValidatorConfig::$exists_config[@123]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:286:5+131
    assume {:print "$at(35,12704,12835)"} true;
    assert {:msg "assert_failed(35,12704,12835): abort not covered by any of the `aborts_if` clauses"}
      (!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#123, $t0) || !$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#123, $t0));

    // assert Or(And(Not(ValidatorConfig::spec_has_operator[@123]($t0)), Eq(7, $t9)), And(Not(ValidatorConfig::$exists_config[@123]($t0)), Eq(5, $t9))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:286:5+131
    assert {:msg "assert_failed(35,12704,12835): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#123, $t0) && $IsEqual'u8'(7, $t9)) || (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#123, $t0) && $IsEqual'u8'(5, $t9)));

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:286:5+131
    $abort_code := $t9;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::get_validator_network_addresses [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:306:5+132
procedure {:timeLimit 40} $1_ValidatorConfig_get_validator_network_addresses$verify(_$t0: $1_ValidatorConfig_Config) returns ($ret0: Vec (int))
{
    ...
    var $temp_0'$1_ValidatorConfig_Config': $1_ValidatorConfig_Config;
    var $temp_0'vec'u8'': Vec (int);
    var $1_ValidatorConfig_ValidatorConfig_$memory#90: $Memory $1_ValidatorConfig_ValidatorConfig;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:306:5+132
    assume {:print "$at(35,13277,13409)"} true;
    assume $IsValid'$1_ValidatorConfig_Config'($t0);

    // @90 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:306:5+1
    $1_ValidatorConfig_ValidatorConfig_$memory#90 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[config_ref]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:306:5+1
    assume {:print "$track_local(19,5,0):", $t0} $t0 == $t0;

    // $t1 := get_field<ValidatorConfig::Config>.validator_network_addresses($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:307:9+39
    assume {:print "$at(35,13364,13403)"} true;
    $t1 := $validator_network_addresses#$1_ValidatorConfig_Config($t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:307:9+39
    assume {:print "$track_return(19,5,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:308:5+1
    assume {:print "$at(35,13408,13409)"} true;
L1:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:308:5+1
    assert {:msg "assert_failed(35,13408,13409): function does not abort under this condition"}
      !false;

    // assert forall addr1: TypeDomain<address>() where exists[@90]<ValidatorConfig::ValidatorConfig>(addr1): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr1)), select ValidatorConfig::ValidatorConfig.operator_account(global[@90]<ValidatorConfig::ValidatorConfig>(addr1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    assume {:print "$at(35,14075,14264)"} true;
    assert {:msg "assert_failed(35,14075,14264): post-condition does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory#90, addr1))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr1)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#90, addr1)))));
...
// fun ValidatorConfig::is_valid [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:231:5+176
procedure {:timeLimit 40} $1_ValidatorConfig_is_valid$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_ValidatorConfig_ValidatorConfig_$memory#98: $Memory $1_ValidatorConfig_ValidatorConfig;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:231:5+176
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:345:9+112
    assume {:print "$at(35,10515,10691)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:231:5+176
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:357:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:238:17+6
    assume {:print "$at(35,10777,10783)"} true;
    assume $IsValid'address'($t0);
    ...
    // @98 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:231:5+1
    assume {:print "$at(35,10515,10516)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#98 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:231:5+1
    assume {:print "$track_local(19,6,0):", $t0} $t0 == $t0;

    // $t2 := exists<ValidatorConfig::ValidatorConfig>($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+6
    assume {:print "$at(35,10591,10597)"} true;
    $t2 := $ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0);

    // if ($t2) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
    if ($t2) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:90+4
L0:

    // $t3 := get_global<ValidatorConfig::ValidatorConfig>($t0) on_abort goto L5 with $t4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:59+13
    if (!$ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
    ...
    if ($abort_flag) {
        assume {:print "$at(35,10641,10654)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(19,6):", $t4} $t4 == $t4;
        goto L5;
    }

    // $t5 := get_field<ValidatorConfig::ValidatorConfig>.config($t3) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:58+44
    $t5 := $config#$1_ValidatorConfig_ValidatorConfig($t3);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:42+61
    // >> opaque call: $t5 := Option::is_some<ValidatorConfig::Config>($t4)

    // $t6 := opaque begin: Option::is_some<ValidatorConfig::Config>($t5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:42+61

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:42+61
    assume $IsValid'bool'($t6);

    // assume Eq<bool>($t6, Option::$is_some<ValidatorConfig::Config>($t5)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:42+61
    assume $IsEqual'bool'($t6, $1_Option_$is_some'$1_ValidatorConfig_Config'($t5));

    // $t6 := opaque end: Option::is_some<ValidatorConfig::Config>($t5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:42+61

    // $t1 := $t6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
    $t1 := $t6;

    // trace_local[tmp#$1]($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
    assume {:print "$track_local(19,6,1):", $t6} $t6 == $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
L2:

    // $t7 := false at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
    $t7 := false;
    assume $IsValid'bool'($t7);

    // $t1 := $t7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
    $t1 := $t7;

    // trace_local[tmp#$1]($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
    assume {:print "$track_local(19,6,1):", $t7} $t7 == $t7;

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
L3:

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:9+94
    assume {:print "$track_return(19,6,0):", $t1} $t1 == $t1;

    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:233:5+1
    assume {:print "$at(35,10690,10691)"} true;
L4:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:237:9+16
    assume {:print "$at(35,10744,10760)"} true;
    assert {:msg "assert_failed(35,10744,10760): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, ValidatorConfig::$is_valid($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:238:9+33
    assume {:print "$at(35,10769,10802)"} true;
    assert {:msg "assert_failed(35,10769,10802): post-condition does not hold"}
      $IsEqual'bool'($t1, $1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, $t0));

    // assert forall addr1: TypeDomain<address>() where exists[@98]<ValidatorConfig::ValidatorConfig>(addr1): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr1)), select ValidatorConfig::ValidatorConfig.operator_account(global[@98]<ValidatorConfig::ValidatorConfig>(addr1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    assume {:print "$at(35,14075,14264)"} true;
    assert {:msg "assert_failed(35,14075,14264): post-condition does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory#98, addr1))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr1)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#98, addr1)))));

    // return $t1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    $ret0 := $t1;
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:233:5+1
    assume {:print "$at(35,10690,10691)"} true;
L5:

    // assert false at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:235:5+111
    assume {:print "$at(35,10697,10808)"} true;
    assert {:msg "assert_failed(35,10697,10808): abort not covered by any of the `aborts_if` clauses"}
      false;

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:235:5+111
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::remove_operator [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:146:5+404
procedure {:timeLimit 40} $1_ValidatorConfig_remove_operator$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: int;
    var $t2: bool;
    ...
    var $t10: int;
    var $t11: $1_Option_Option'address';
    var $t12: $Mutation ($1_ValidatorConfig_ValidatorConfig);
    var $t13: $Mutation ($1_Option_Option'address');
    var $t0: int;
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_Roles_RoleId_$memory#111: $Memory $1_Roles_RoleId;
    var $1_ValidatorConfig_ValidatorConfig_$memory#112: $Memory $1_ValidatorConfig_ValidatorConfig;
    var $1_ValidatorConfig_ValidatorConfig_$memory#241: $Memory $1_ValidatorConfig_ValidatorConfig;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorOperatorConfig::$has_validator_operator_config(addr): Roles::spec_has_validator_operator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:146:5+404
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:77:9+137
    assume {:print "$at(35,6296,6700)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_operator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:146:5+404
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:345:9+112
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:146:5+404
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:357:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:146:5+404
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:146:5+404
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));
    ...
    // assume Identical($t4, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:156:9+56
    assume {:print "$at(35,6828,6884)"} true;
    assume ($t4 == $1_Signer_spec_address_of($t0));

    // @111 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:146:5+1
    assume {:print "$at(35,6296,6297)"} true;
    $1_Roles_RoleId_$memory#111 := $1_Roles_RoleId_$memory;

    // @112 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:146:5+1
    $1_ValidatorConfig_ValidatorConfig_$memory#112 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[validator_account]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:146:5+1
    assume {:print "$track_local(19,8,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+42
    // >> opaque call: Roles::assert_validator($t0)
    assume {:print "$at(35,6386,6428)"} true;

    // opaque begin: Roles::assert_validator($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+42

    // assume Identical($t5, Or(Not(exists<Roles::RoleId>(Signer::$address_of($t0))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(Signer::$address_of($t0))), 3))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+42
    assume ($t5 == (!$ResourceExists($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0))), 3)));

    // if ($t5) goto L5 else goto L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+42
    if ($t5) { goto L5; } else { goto L4; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+42
L5:

    // assume Or(And(Not(exists<Roles::RoleId>(Signer::$address_of($t0))), Eq(5, $t6)), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(Signer::$address_of($t0))), 3), Eq(3, $t6))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+42
    assume ((!$ResourceExists($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0)) && $IsEqual'u8'(5, $t6)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0))), 3) && $IsEqual'u8'(3, $t6)));

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+42
    assume {:print "$at(35,6386,6428)"} true;
    assume {:print "$track_abort(19,8):", $t6} $t6 == $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+42
    goto L3;

    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+42
L4:

    // opaque end: Roles::assert_validator($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+42

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:22+37
    // >> opaque call: $t4 := Signer::address_of($t0)
    assume {:print "$at(35,6451,6488)"} true;

    // $t7 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:22+37

    // assume WellFormed($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:22+37
    assume $IsValid'address'($t7);

    // assume Eq<address>($t7, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:22+37
    assume $IsEqual'address'($t7, $1_Signer_spec_address_of($t0));

    // $t7 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:22+37

    // trace_local[sender]($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:13+6
    assume {:print "$track_local(19,8,1):", $t7} $t7 == $t7;

    // $t8 := ValidatorConfig::exists_config($t7) on_abort goto L3 with $t6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:16+21
    assume {:print "$at(35,6541,6562)"} true;
    call $t8 := $1_ValidatorConfig_exists_config($t7);
    if ($abort_flag) {
        assume {:print "$at(35,6541,6562)"} true;
        $t6 := $abort_code;
        assume {:print "$track_abort(19,8):", $t6} $t6 == $t6;
    ...
    // $t9 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:61+17
    $t9 := 0;
    assume $IsValid'u64'($t9);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:39+40
    // >> opaque call: $t7 := Errors::not_published($t6)

    // $t10 := opaque begin: Errors::not_published($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:39+40

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:39+40
    assume $IsValid'u64'($t10);

    // assume Eq<u64>($t10, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:39+40
    assume $IsEqual'u64'($t10, 5);

    // $t10 := opaque end: Errors::not_published($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:39+40

    // trace_local[tmp#$3]($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:9+71
    assume {:print "$track_local(19,8,3):", $t10} $t10 == $t10;

    // trace_local[tmp#$2]($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:9+71
    assume {:print "$track_local(19,8,2):", $t8} $t8 == $t8;

    // if ($t8) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:9+71
    if ($t8) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:9+71
L1:

    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:9+71
    assume {:print "$at(35,6534,6605)"} true;
    assume {:print "$track_abort(19,8):", $t10} $t10 == $t10;

    // $t6 := move($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:9+71
    $t6 := $t10;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:150:9+71
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:73+14
    assume {:print "$at(35,6679,6693)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:73+14
    // >> opaque call: $t8 := Option::none<address>()

    // $t11 := opaque begin: Option::none<address>() at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:73+14

    // assume And(WellFormed($t11), Le(Len<address>(select Option::Option.vec($t11)), 1)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:73+14
    assume ($IsValid'$1_Option_Option'address''($t11) && (LenVec($vec#$1_Option_Option'address'($t11)) <= 1));

    // assume Eq<Option::Option<address>>($t11, Option::spec_none<address>()) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:73+14
    assume $IsEqual'$1_Option_Option'address''($t11, $1_Option_spec_none'address'());

    // $t11 := opaque end: Option::none<address>() at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:73+14

    // $t12 := borrow_global<ValidatorConfig::ValidatorConfig>($t7) on_abort goto L3 with $t6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:10+17
    if (!$ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t7)) {
        call $ExecFailureAbort();
    } else {
        $t12 := $Mutation($Global($t7), EmptyVec(), $ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, $t7));
    }
    if ($abort_flag) {
        assume {:print "$at(35,6616,6633)"} true;
        $t6 := $abort_code;
        assume {:print "$track_abort(19,8):", $t6} $t6 == $t6;
        goto L3;
    }

    // $t13 := borrow_field<ValidatorConfig::ValidatorConfig>.operator_account($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:9+61
    $t13 := $ChildMutation($t12, 1, $operator_account#$1_ValidatorConfig_ValidatorConfig($Dereference($t12)));

    // write_ref($t13, $t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:9+78
    $t13 := $UpdateMutation($t13, $t11);

    // write_back[Reference($t12).operator_account]($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:9+78
    $t12 := $UpdateMutation($t12, $Update'$1_ValidatorConfig_ValidatorConfig'_operator_account($Dereference($t12), $Dereference($t13)));

    // assert Le(Len<ValidatorConfig::Config>(select Option::Option.vec(select ValidatorConfig::ValidatorConfig.config($t12))), 1) at /home/ying/diem/language/move-stdlib/modules/Option.move:16:9+24
    ...
    assert {:msg "assert_failed(44,561,585): data invariant does not hold"}
      (LenVec($vec#$1_Option_Option'$1_ValidatorConfig_Config'($config#$1_ValidatorConfig_ValidatorConfig($Dereference($t12)))) <= 1);

    // assert Le(Len<address>(select Option::Option.vec(select ValidatorConfig::ValidatorConfig.operator_account($t12))), 1) at /home/ying/diem/language/move-stdlib/modules/Option.move:16:9+24
    // data invariant at /home/ying/diem/language/move-stdlib/modules/Option.move:16:9+24
    assert {:msg "assert_failed(44,561,585): data invariant does not hold"}
      (LenVec($vec#$1_Option_Option'address'($operator_account#$1_ValidatorConfig_ValidatorConfig($Dereference($t12)))) <= 1);

    // @241 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:146:5+404
    // state save for global update invariants
    assume {:print "$at(35,6296,6700)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#241 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // write_back[ValidatorConfig::ValidatorConfig@]($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:9+78
    assume {:print "$at(35,6615,6693)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory := $ResourceUpdate($1_ValidatorConfig_ValidatorConfig_$memory, $GlobalLocationAddress($t12),
        $Dereference($t12));

    // assert forall validator: TypeDomain<address>() where ValidatorConfig::$is_valid[@241](validator): ValidatorConfig::$is_valid(validator) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:336:9+107
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:336:9+107
    assume {:print "$at(35,14475,14582)"} true;
    assert {:msg "assert_failed(35,14475,14582): global memory invariant does not hold"}
      (forall validator: int :: $IsValid'address'(validator) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory#241, validator))  ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, validator)));
    ...
    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:152:5+1
    assume {:print "$at(35,6699,6700)"} true;
L2:

    // assert Not(Not(exists[@111]<Roles::RoleId>($t4))) at /home/ying/diem/language/diem-framework/modules/Roles.move:580:9+69
    assume {:print "$at(26,25923,25992)"} true;
    assert {:msg "assert_failed(26,25923,25992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#111, $t4);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@111]<Roles::RoleId>($t4)), 3)) at /home/ying/diem/language/diem-framework/modules/Roles.move:581:9+97
    assume {:print "$at(26,26001,26098)"} true;
    assert {:msg "assert_failed(26,26001,26098): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#111, $t4)), 3);

    // assert Not(Not(ValidatorConfig::$exists_config[@112]($t4))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:92:9+58
    assume {:print "$at(35,3469,3527)"} true;
    assert {:msg "assert_failed(35,3469,3527): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#112, $t4);

    // assert Not(ValidatorConfig::spec_has_operator(Signer::spec_address_of($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:159:9+71
    assume {:print "$at(35,7019,7090)"} true;
    assert {:msg "assert_failed(35,7019,7090): post-condition does not hold"}
      !$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory, $1_Signer_spec_address_of($t0));

    // assert forall addr: TypeDomain<address>() where Neq<address>(addr, $t4): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr)), select ValidatorConfig::ValidatorConfig.operator_account(global[@112]<ValidatorConfig::ValidatorConfig>(addr))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:162:9+165
    assume {:print "$at(35,7185,7350)"} true;
    assert {:msg "assert_failed(35,7185,7350): post-condition does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> (!$IsEqual'address'(addr, $t4))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#112, addr)))));

    // return () at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:162:9+165
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:152:5+1
    assume {:print "$at(35,6699,6700)"} true;
L3:

    // assert Or(Or(Not(exists[@111]<Roles::RoleId>($t4)), Neq<u64>(select Roles::RoleId.role_id(global[@111]<Roles::RoleId>($t4)), 3)), Not(ValidatorConfig::$exists_config[@112]($t4))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:154:5+650
    assume {:print "$at(35,6706,7356)"} true;
    assert {:msg "assert_failed(35,6706,7356): abort not covered by any of the `aborts_if` clauses"}
      ((!$ResourceExists($1_Roles_RoleId_$memory#111, $t4) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#111, $t4)), 3)) || !$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#112, $t4));

    // assert Or(Or(And(Not(exists[@111]<Roles::RoleId>($t4)), Eq(5, $t6)), And(Neq<u64>(select Roles::RoleId.role_id(global[@111]<Roles::RoleId>($t4)), 3), Eq(3, $t6))), And(Not(ValidatorConfig::$exists_config[@112]($t4)), Eq(5, $t6))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:154:5+650
    assert {:msg "assert_failed(35,6706,7356): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$ResourceExists($1_Roles_RoleId_$memory#111, $t4) && $IsEqual'u8'(5, $t6)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#111, $t4)), 3) && $IsEqual'u8'(3, $t6))) || (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#112, $t4) && $IsEqual'u8'(5, $t6)));

    // abort($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:154:5+650
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::set_config [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1025
procedure {:timeLimit 40} $1_ValidatorConfig_set_config$verify(_$t0: int, _$t1: int, _$t2: Vec (int), _$t3: Vec (int), _$t4: Vec (int)) returns ()
{
    // declare local variables
    var $t5: $Mutation ($1_ValidatorConfig_ValidatorConfig);
    var $t6: bool;
    var $t7: int;
    var $t8: bool;
    var $t9: int;
    ...
    var $temp_0'u64': int;
    var $temp_0'vec'u8'': Vec (int);
    var $1_ValidatorConfig_ValidatorConfig_$memory#145: $Memory $1_ValidatorConfig_ValidatorConfig;
    var $1_ValidatorConfig_ValidatorConfig_$memory#244: $Memory $1_ValidatorConfig_ValidatorConfig;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    $t3 := _$t3;
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1025
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:345:9+112
    assume {:print "$at(35,7778,8803)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1025
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:357:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1025
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1025
    assume $IsValid'address'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1025
    assume $IsValid'vec'u8''($t2);

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1025
    assume $IsValid'vec'u8''($t3);

    // assume WellFormed($t4) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1025
    ...
    // assume CanModify<ValidatorConfig::ValidatorConfig>($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:199:9+49
    assume {:print "$at(35,8857,8906)"} true;
    assume $1_ValidatorConfig_ValidatorConfig_$modifies[$t1];

    // @145 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:199:9+49
    $1_ValidatorConfig_ValidatorConfig_$memory#145 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[validator_operator_account]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1
    assume {:print "$at(35,7778,7779)"} true;
    assume {:print "$track_local(19,9,0):", $t0} $t0 == $t0;

    // trace_local[validator_addr]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1
    assume {:print "$track_local(19,9,1):", $t1} $t1 == $t1;

    // trace_local[consensus_pubkey]($t2) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1
    assume {:print "$track_local(19,9,2):", $t2} $t2 == $t2;

    // trace_local[validator_network_addresses]($t3) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1
    assume {:print "$track_local(19,9,3):", $t3} $t3 == $t3;

    // trace_local[fullnode_network_addresses]($t4) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1
    assume {:print "$track_local(19,9,4):", $t4} $t4 == $t4;

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:13+46
    // >> opaque call: $t12 := Signer::address_of($t0)
    assume {:print "$at(35,8075,8121)"} true;

    // $t12 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:13+46

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:13+46
    assume $IsValid'address'($t12);

    // assume Eq<address>($t12, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:13+46
    assume $IsEqual'address'($t12, $1_Signer_spec_address_of($t0));

    // $t12 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:13+46

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28
    // >> opaque call: $t13 := ValidatorConfig::get_operator($t1)

    // $t13 := opaque begin: ValidatorConfig::get_operator($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28

    // assume Identical($t14, Or(Not(ValidatorConfig::spec_has_operator($t1)), Not(ValidatorConfig::$exists_config($t1)))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28
    ...
    // if ($t14) goto L9 else goto L8 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28
    if ($t14) { goto L9; } else { goto L8; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28
L9:

    // assume Or(And(Not(ValidatorConfig::spec_has_operator($t1)), Eq(7, $t15)), And(Not(ValidatorConfig::$exists_config($t1)), Eq(5, $t15))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28
    assume ((!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory, $t1) && $IsEqual'u8'(7, $t15)) || (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, $t1) && $IsEqual'u8'(5, $t15)));

    // trace_abort($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28
    assume {:print "$at(35,8125,8153)"} true;
    assume {:print "$track_abort(19,9):", $t15} $t15 == $t15;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28
    goto L7;

    // label L8 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28
L8:

    // assume WellFormed($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28
    assume $IsValid'address'($t13);

    // assume Eq<address>($t13, ValidatorConfig::$get_operator($t1)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28
    assume $IsEqual'address'($t13, $1_ValidatorConfig_$get_operator($1_ValidatorConfig_ValidatorConfig_$memory, $t1));

    // $t13 := opaque end: ValidatorConfig::get_operator($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:63+28

    // $t16 := ==($t12, $t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:60+2
    $t16 := $IsEqual'address'($t12, $t13);

    // $t17 := 1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:182:38+27
    assume {:print "$at(35,8192,8219)"} true;
    $t17 := 1;
    assume $IsValid'u64'($t17);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:182:13+53
    // >> opaque call: $t16 := Errors::invalid_argument($t15)

    // $t18 := opaque begin: Errors::invalid_argument($t17) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:182:13+53

    // assume WellFormed($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:182:13+53
    assume $IsValid'u64'($t18);

    // assume Eq<u64>($t18, 7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:182:13+53
    assume $IsEqual'u64'($t18, 7);

    // $t18 := opaque end: Errors::invalid_argument($t17) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:182:13+53

    // trace_local[tmp#$7]($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:180:9+175
    assume {:print "$at(35,8055,8230)"} true;
    assume {:print "$track_local(19,9,7):", $t18} $t18 == $t18;

    // trace_local[tmp#$6]($t16) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:180:9+175
    assume {:print "$track_local(19,9,6):", $t16} $t16 == $t16;

    // if ($t16) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:180:9+175
    if ($t16) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:180:9+175
L1:

    // trace_abort($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:180:9+175
    assume {:print "$at(35,8055,8230)"} true;
    assume {:print "$track_abort(19,9):", $t18} $t18 == $t18;

    // $t15 := move($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:180:9+175
    $t15 := $t18;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:180:9+175
    goto L7;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:185:48+21
    assume {:print "$at(35,8295,8316)"} true;
L0:

    // $t19 := Signature::ed25519_validate_pubkey($t2) on_abort goto L7 with $t15 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:185:13+57
    call $t19 := $1_Signature_ed25519_validate_pubkey($t2);
    if ($abort_flag) {
        assume {:print "$at(35,8260,8317)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(19,9):", $t15} $t15 == $t15;
        goto L7;
    }

    // $t20 := 2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:38+22
    assume {:print "$at(35,8356,8378)"} true;
    $t20 := 2;
    assume $IsValid'u64'($t20);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:13+48
    // >> opaque call: $t19 := Errors::invalid_argument($t18)

    // $t21 := opaque begin: Errors::invalid_argument($t20) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:13+48

    // assume WellFormed($t21) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:13+48
    assume $IsValid'u64'($t21);

    // assume Eq<u64>($t21, 7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:13+48
    assume $IsEqual'u64'($t21, 7);

    // $t21 := opaque end: Errors::invalid_argument($t20) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:13+48

    // trace_local[tmp#$9]($t21) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:184:9+149
    assume {:print "$at(35,8240,8389)"} true;
    assume {:print "$track_local(19,9,9):", $t21} $t21 == $t21;

    // trace_local[tmp#$8]($t19) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:184:9+149
    assume {:print "$track_local(19,9,8):", $t19} $t19 == $t19;

    // if ($t19) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:184:9+149
    if ($t19) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:184:9+149
L3:

    // trace_abort($t21) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:184:9+149
    assume {:print "$at(35,8240,8389)"} true;
    assume {:print "$track_abort(19,9):", $t21} $t21 == $t21;

    // $t15 := move($t21) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:184:9+149
    $t15 := $t21;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:184:9+149
    goto L7;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:30+14
    assume {:print "$at(35,8498,8512)"} true;
L2:

    // $t22 := ValidatorConfig::exists_config($t1) on_abort goto L7 with $t15 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:16+29
    call $t22 := $1_ValidatorConfig_exists_config($t1);
    if ($abort_flag) {
        assume {:print "$at(35,8484,8513)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(19,9):", $t15} $t15 == $t15;
        goto L7;
    }

    // $t23 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:69+17
    $t23 := 0;
    assume $IsValid'u64'($t23);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:47+40
    // >> opaque call: $t22 := Errors::not_published($t21)

    // $t24 := opaque begin: Errors::not_published($t23) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:47+40

    // assume WellFormed($t24) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:47+40
    assume $IsValid'u64'($t24);

    // assume Eq<u64>($t24, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:47+40
    assume $IsEqual'u64'($t24, 5);

    // $t24 := opaque end: Errors::not_published($t23) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:47+40

    // trace_local[tmp#$11]($t24) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:9+79
    assume {:print "$track_local(19,9,11):", $t24} $t24 == $t24;

    // trace_local[tmp#$10]($t22) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:9+79
    assume {:print "$track_local(19,9,10):", $t22} $t22 == $t22;

    // if ($t22) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:9+79
    if ($t22) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:9+79
L5:

    // trace_abort($t24) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:9+79
    assume {:print "$at(35,8477,8556)"} true;
    assume {:print "$track_abort(19,9):", $t24} $t24 == $t24;

    // $t15 := move($t24) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:9+79
    $t15 := $t24;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:189:9+79
    goto L7;

    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:190:56+14
    assume {:print "$at(35,8613,8627)"} true;
L4:

    // assert CanModify<ValidatorConfig::ValidatorConfig>($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:190:21+17
    assert {:msg "assert_failed(35,8578,8595): caller does not have permission to modify `ValidatorConfig::ValidatorConfig` at given address"}
      $1_ValidatorConfig_ValidatorConfig_$modifies[$t1];

    // $t25 := borrow_global<ValidatorConfig::ValidatorConfig>($t1) on_abort goto L7 with $t15 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:190:21+17
    ...
    if ($abort_flag) {
        assume {:print "$at(35,8578,8595)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(19,9):", $t15} $t15 == $t15;
        goto L7;
    }

    // trace_local[t_ref]($t25) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:190:13+5
    $temp_0'$1_ValidatorConfig_ValidatorConfig' := $Dereference($t25);
    assume {:print "$track_local(19,9,5):", $temp_0'$1_ValidatorConfig_ValidatorConfig'} $temp_0'$1_ValidatorConfig_ValidatorConfig' == $temp_0'$1_ValidatorConfig_ValidatorConfig';

    // $t26 := pack ValidatorConfig::Config($t2, $t3, $t4) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:191:37+129
    assume {:print "$at(35,8666,8795)"} true;
    $t26 := $1_ValidatorConfig_Config($t2, $t3, $t4);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:191:24+143
    // >> opaque call: $t25 := Option::some<ValidatorConfig::Config>($t24)

    // $t27 := opaque begin: Option::some<ValidatorConfig::Config>($t26) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:191:24+143

    // assume And(WellFormed($t27), Le(Len<ValidatorConfig::Config>(select Option::Option.vec($t27)), 1)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:191:24+143
    assume ($IsValid'$1_Option_Option'$1_ValidatorConfig_Config''($t27) && (LenVec($vec#$1_Option_Option'$1_ValidatorConfig_Config'($t27)) <= 1));

    // assume Eq<Option::Option<ValidatorConfig::Config>>($t27, Option::spec_some<ValidatorConfig::Config>($t26)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:191:24+143
    assume $IsEqual'$1_Option_Option'$1_ValidatorConfig_Config''($t27, $1_Option_spec_some'$1_ValidatorConfig_Config'($t26));

    // $t27 := opaque end: Option::some<ValidatorConfig::Config>($t26) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:191:24+143

    // $t28 := borrow_field<ValidatorConfig::ValidatorConfig>.config($t25) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:191:9+12
    $t28 := $ChildMutation($t25, 0, $config#$1_ValidatorConfig_ValidatorConfig($Dereference($t25)));

    // write_ref($t28, $t27) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:191:9+158
    $t28 := $UpdateMutation($t28, $t27);

    // write_back[Reference($t25).config]($t28) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:191:9+158
    $t25 := $UpdateMutation($t25, $Update'$1_ValidatorConfig_ValidatorConfig'_config($Dereference($t25), $Dereference($t28)));

    // assert Le(Len<ValidatorConfig::Config>(select Option::Option.vec(select ValidatorConfig::ValidatorConfig.config($t25))), 1) at /home/ying/diem/language/move-stdlib/modules/Option.move:16:9+24
    // data invariant at /home/ying/diem/language/move-stdlib/modules/Option.move:16:9+24
    assume {:print "$at(44,561,585)"} true;
    assert {:msg "assert_failed(44,561,585): data invariant does not hold"}
      (LenVec($vec#$1_Option_Option'$1_ValidatorConfig_Config'($config#$1_ValidatorConfig_ValidatorConfig($Dereference($t25)))) <= 1);

    // assert Le(Len<address>(select Option::Option.vec(select ValidatorConfig::ValidatorConfig.operator_account($t25))), 1) at /home/ying/diem/language/move-stdlib/modules/Option.move:16:9+24
    // data invariant at /home/ying/diem/language/move-stdlib/modules/Option.move:16:9+24
    assert {:msg "assert_failed(44,561,585): data invariant does not hold"}
      (LenVec($vec#$1_Option_Option'address'($operator_account#$1_ValidatorConfig_ValidatorConfig($Dereference($t25)))) <= 1);

    // @244 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:173:5+1025
    // state save for global update invariants
    assume {:print "$at(35,7778,8803)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#244 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // write_back[ValidatorConfig::ValidatorConfig@]($t25) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:191:9+158
    assume {:print "$at(35,8638,8796)"} true;
    ...
    // assert forall validator: TypeDomain<address>() where ValidatorConfig::$is_valid[@244](validator): ValidatorConfig::$is_valid(validator) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:336:9+107
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:336:9+107
    assume {:print "$at(35,14475,14582)"} true;
    assert {:msg "assert_failed(35,14475,14582): global memory invariant does not hold"}
      (forall validator: int :: $IsValid'address'(validator) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory#244, validator))  ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, validator)));
    ...
    // label L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:196:5+1
    assume {:print "$at(35,8802,8803)"} true;
L6:

    // assert Not(Neq<address>(Signer::$address_of[]($t0), ValidatorConfig::$get_operator[@145]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:215:9+131
    assume {:print "$at(35,9654,9785)"} true;
    assert {:msg "assert_failed(35,9654,9785): function does not abort under this condition"}
      !!$IsEqual'address'($1_Signer_$address_of($t0), $1_ValidatorConfig_$get_operator($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1));

    // assert Not(Not(Signature::$ed25519_validate_pubkey[]($t2))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:218:9+94
    assume {:print "$at(35,9853,9947)"} true;
    assert {:msg "assert_failed(35,9853,9947): function does not abort under this condition"}
      !!$1_Signature_$ed25519_validate_pubkey($t2);

    // assert Not(Not(ValidatorConfig::spec_has_operator[@145]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:295:9+65
    assume {:print "$at(35,12949,13014)"} true;
    assert {:msg "assert_failed(35,12949,13014): function does not abort under this condition"}
      !!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1);

    // assert Not(Not(ValidatorConfig::$exists_config[@145]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:92:9+58
    assume {:print "$at(35,3469,3527)"} true;
    assert {:msg "assert_failed(35,3469,3527): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1);

    // assert ValidatorConfig::$is_valid($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:201:9+33
    assume {:print "$at(35,8950,8983)"} true;
    assert {:msg "assert_failed(35,8950,8983): post-condition does not hold"}
      $1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, $t1);

    // assert Eq<ValidatorConfig::ValidatorConfig>(global<ValidatorConfig::ValidatorConfig>($t1), update ValidatorConfig::ValidatorConfig.config<ValidatorConfig::ValidatorConfig>(global[@145]<ValidatorConfig::ValidatorConfig>($t1), Option::spec_some<ValidatorConfig::Config>(pack ValidatorConfig::Config($t2, $t3, $t4)))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:202:9+496
    assume {:print "$at(35,8992,9488)"} true;
    assert {:msg "assert_failed(35,8992,9488): post-condition does not hold"}
      $IsEqual'$1_ValidatorConfig_ValidatorConfig'($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, $t1), $Update'$1_ValidatorConfig_ValidatorConfig'_config($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1), $1_Option_spec_some'$1_ValidatorConfig_Config'($1_ValidatorConfig_Config($t2, $t3, $t4))));

    // assert forall addr1: TypeDomain<address>() where exists[@145]<ValidatorConfig::ValidatorConfig>(addr1): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr1)), select ValidatorConfig::ValidatorConfig.operator_account(global[@145]<ValidatorConfig::ValidatorConfig>(addr1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    assume {:print "$at(35,14075,14264)"} true;
    assert {:msg "assert_failed(35,14075,14264): post-condition does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory#145, addr1))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr1)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#145, addr1)))));

    // return () at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:327:9+189
    return;

    // label L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:196:5+1
    assume {:print "$at(35,8802,8803)"} true;
L7:

    // assert Or(Or(Or(Neq<address>(Signer::$address_of[]($t0), ValidatorConfig::$get_operator[@145]($t1)), Not(Signature::$ed25519_validate_pubkey[]($t2))), Not(ValidatorConfig::spec_has_operator[@145]($t1))), Not(ValidatorConfig::$exists_config[@145]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:197:5+686
    assume {:print "$at(35,8808,9494)"} true;
    assert {:msg "assert_failed(35,8808,9494): abort not covered by any of the `aborts_if` clauses"}
      (((!$IsEqual'address'($1_Signer_$address_of($t0), $1_ValidatorConfig_$get_operator($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1)) || !$1_Signature_$ed25519_validate_pubkey($t2)) || !$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1)) || !$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1));

    // assert Or(Or(Or(And(Neq<address>(Signer::$address_of[]($t0), ValidatorConfig::$get_operator[@145]($t1)), Eq(7, $t15)), And(Not(Signature::$ed25519_validate_pubkey[]($t2)), Eq(7, $t15))), And(Not(ValidatorConfig::spec_has_operator[@145]($t1)), Eq(7, $t15))), And(Not(ValidatorConfig::$exists_config[@145]($t1)), Eq(5, $t15))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:197:5+686
    assert {:msg "assert_failed(35,8808,9494): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((!$IsEqual'address'($1_Signer_$address_of($t0), $1_ValidatorConfig_$get_operator($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1)) && $IsEqual'u8'(7, $t15)) || (!$1_Signature_$ed25519_validate_pubkey($t2) && $IsEqual'u8'(7, $t15))) || (!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1) && $IsEqual'u8'(7, $t15))) || (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1) && $IsEqual'u8'(5, $t15)));

    // abort($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:197:5+686
    $abort_code := $t15;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::set_operator [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+705
procedure {:timeLimit 40} $1_ValidatorConfig_set_operator$verify(_$t0: int, _$t1: int) returns ()
{
    // declare local variables
    var $t2: int;
    var $t3: bool;
    ...
    var $t20: $Mutation ($1_ValidatorConfig_ValidatorConfig);
    var $t21: $Mutation ($1_Option_Option'address');
    var $t0: int;
    var $t1: int;
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    ...
    var $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115: $Memory $1_ValidatorOperatorConfig_ValidatorOperatorConfig;
    var $1_ValidatorConfig_ValidatorConfig_$memory#116: $Memory $1_ValidatorConfig_ValidatorConfig;
    var $1_ValidatorConfig_ValidatorConfig_$memory#242: $Memory $1_ValidatorConfig_ValidatorConfig;
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorOperatorConfig::$has_validator_operator_config(addr): Roles::spec_has_validator_operator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+705
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:77:9+137
    assume {:print "$at(35,3918,4623)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_operator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+705
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:345:9+112
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+705
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:357:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+705
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+705
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+705
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<ValidatorOperatorConfig::ValidatorOperatorConfig>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+705
    ...
    // assume Identical($t7, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:115:9+56
    assume {:print "$at(35,4747,4803)"} true;
    assume ($t7 == $1_Signer_spec_address_of($t0));

    // assume Identical($t8, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:125:9+64
    assume {:print "$at(35,5143,5207)"} true;
    assume ($t8 == $1_Signer_spec_address_of($t0));

    // assume Identical($t9, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:136:9+64
    assume {:print "$at(35,5718,5782)"} true;
    assume ($t9 == $1_Signer_spec_address_of($t0));

    // @114 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+1
    assume {:print "$at(35,3918,3919)"} true;
    $1_Roles_RoleId_$memory#114 := $1_Roles_RoleId_$memory;

    // @115 := save_mem(ValidatorOperatorConfig::ValidatorOperatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+1
    $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115 := $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory;

    // @116 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+1
    $1_ValidatorConfig_ValidatorConfig_$memory#116 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[validator_account]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+1
    assume {:print "$track_local(19,10,0):", $t0} $t0 == $t0;

    // trace_local[operator_addr]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+1
    assume {:print "$track_local(19,10,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+42
    // >> opaque call: Roles::assert_validator($t0)
    assume {:print "$at(35,4029,4071)"} true;

    // opaque begin: Roles::assert_validator($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+42

    // assume Identical($t10, Or(Not(exists<Roles::RoleId>(Signer::$address_of($t0))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(Signer::$address_of($t0))), 3))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+42
    assume ($t10 == (!$ResourceExists($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0))), 3)));

    // if ($t10) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+42
    if ($t10) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+42
L7:

    // assume Or(And(Not(exists<Roles::RoleId>(Signer::$address_of($t0))), Eq(5, $t11)), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(Signer::$address_of($t0))), 3), Eq(3, $t11))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+42
    assume ((!$ResourceExists($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0)) && $IsEqual'u8'(5, $t11)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0))), 3) && $IsEqual'u8'(3, $t11)));

    // trace_abort($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+42
    assume {:print "$at(35,4029,4071)"} true;
    assume {:print "$track_abort(19,10):", $t11} $t11 == $t11;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+42
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+42
L6:

    // opaque end: Roles::assert_validator($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+42

    // $t12 := ValidatorOperatorConfig::has_validator_operator_config($t1) on_abort goto L5 with $t11 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:106:13+69
    assume {:print "$at(35,4230,4299)"} true;
    call $t12 := $1_ValidatorOperatorConfig_has_validator_operator_config($t1);
    if ($abort_flag) {
        assume {:print "$at(35,4230,4299)"} true;
        $t11 := $abort_code;
        assume {:print "$track_abort(19,10):", $t11} $t11 == $t11;
    ...
    // $t13 := 3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:38+25
    assume {:print "$at(35,4338,4363)"} true;
    $t13 := 3;
    assume $IsValid'u64'($t13);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:13+51
    // >> opaque call: $t9 := Errors::invalid_argument($t8)

    // $t14 := opaque begin: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:13+51

    // assume WellFormed($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:13+51
    assume $IsValid'u64'($t14);

    // assume Eq<u64>($t14, 7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:13+51
    assume $IsEqual'u64'($t14, 7);

    // $t14 := opaque end: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:13+51

    // trace_local[tmp#$4]($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:105:9+164
    assume {:print "$at(35,4210,4374)"} true;
    assume {:print "$track_local(19,10,4):", $t14} $t14 == $t14;

    // trace_local[tmp#$3]($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:105:9+164
    assume {:print "$track_local(19,10,3):", $t12} $t12 == $t12;

    // if ($t12) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:105:9+164
    if ($t12) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:105:9+164
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:105:9+164

    // trace_abort($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:105:9+164
    assume {:print "$at(35,4210,4374)"} true;
    assume {:print "$track_abort(19,10):", $t14} $t14 == $t14;

    // $t11 := move($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:105:9+164
    $t11 := $t14;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:105:9+164
    goto L5;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:109:41+17
    assume {:print "$at(35,4416,4433)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:109:22+37
    // >> opaque call: $t10 := Signer::address_of($t0)

    // $t15 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:109:22+37

    // assume WellFormed($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:109:22+37
    assume $IsValid'address'($t15);

    // assume Eq<address>($t15, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:109:22+37
    assume $IsEqual'address'($t15, $1_Signer_spec_address_of($t0));

    // $t15 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:109:22+37

    // trace_local[sender]($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:109:13+6
    assume {:print "$track_local(19,10,2):", $t15} $t15 == $t15;

    // $t16 := ValidatorConfig::exists_config($t15) on_abort goto L5 with $t11 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:16+21
    assume {:print "$at(35,4451,4472)"} true;
    call $t16 := $1_ValidatorConfig_exists_config($t15);
    if ($abort_flag) {
        assume {:print "$at(35,4451,4472)"} true;
        $t11 := $abort_code;
        assume {:print "$track_abort(19,10):", $t11} $t11 == $t11;
    ...
    // $t17 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:61+17
    $t17 := 0;
    assume $IsValid'u64'($t17);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:39+40
    // >> opaque call: $t13 := Errors::not_published($t12)

    // $t18 := opaque begin: Errors::not_published($t17) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:39+40

    // assume WellFormed($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:39+40
    assume $IsValid'u64'($t18);

    // assume Eq<u64>($t18, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:39+40
    assume $IsEqual'u64'($t18, 5);

    // $t18 := opaque end: Errors::not_published($t17) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:39+40

    // trace_local[tmp#$6]($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:9+71
    assume {:print "$track_local(19,10,6):", $t18} $t18 == $t18;

    // trace_local[tmp#$5]($t16) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:9+71
    assume {:print "$track_local(19,10,5):", $t16} $t16 == $t16;

    // if ($t16) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:9+71
    if ($t16) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:9+71
L3:

    // trace_abort($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:9+71
    assume {:print "$at(35,4444,4515)"} true;
    assume {:print "$track_abort(19,10):", $t18} $t18 == $t18;

    // $t11 := move($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:9+71
    $t11 := $t18;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:9+71
    goto L5;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:111:86+13
    assume {:print "$at(35,4602,4615)"} true;
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:111:73+27
    // >> opaque call: $t14 := Option::some<address>($t1)

    // $t19 := opaque begin: Option::some<address>($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:111:73+27

    // assume And(WellFormed($t19), Le(Len<address>(select Option::Option.vec($t19)), 1)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:111:73+27
    assume ($IsValid'$1_Option_Option'address''($t19) && (LenVec($vec#$1_Option_Option'address'($t19)) <= 1));

    // assume Eq<Option::Option<address>>($t19, Option::spec_some<address>($t1)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:111:73+27
    assume $IsEqual'$1_Option_Option'address''($t19, $1_Option_spec_some'address'($t1));

    // $t19 := opaque end: Option::some<address>($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:111:73+27

    // $t20 := borrow_global<ValidatorConfig::ValidatorConfig>($t15) on_abort goto L5 with $t11 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:111:10+17
    if (!$ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t15)) {
        call $ExecFailureAbort();
    } else {
        $t20 := $Mutation($Global($t15), EmptyVec(), $ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, $t15));
    }
    if ($abort_flag) {
        assume {:print "$at(35,4526,4543)"} true;
        $t11 := $abort_code;
        assume {:print "$track_abort(19,10):", $t11} $t11 == $t11;
        goto L5;
    }

    // $t21 := borrow_field<ValidatorConfig::ValidatorConfig>.operator_account($t20) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:111:9+61
    $t21 := $ChildMutation($t20, 1, $operator_account#$1_ValidatorConfig_ValidatorConfig($Dereference($t20)));

    // write_ref($t21, $t19) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:111:9+91
    $t21 := $UpdateMutation($t21, $t19);

    // write_back[Reference($t20).operator_account]($t21) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:111:9+91
    $t20 := $UpdateMutation($t20, $Update'$1_ValidatorConfig_ValidatorConfig'_operator_account($Dereference($t20), $Dereference($t21)));

    // assert Le(Len<ValidatorConfig::Config>(select Option::Option.vec(select ValidatorConfig::ValidatorConfig.config($t20))), 1) at /home/ying/diem/language/move-stdlib/modules/Option.move:16:9+24
    // data invariant at /home/ying/diem/language/move-stdlib/modules/Option.move:16:9+24
    assume {:print "$at(44,561,585)"} true;
    assert {:msg "assert_failed(44,561,585): data invariant does not hold"}
      (LenVec($vec#$1_Option_Option'$1_ValidatorConfig_Config'($config#$1_ValidatorConfig_ValidatorConfig($Dereference($t20)))) <= 1);

    // assert Le(Len<address>(select Option::Option.vec(select ValidatorConfig::ValidatorConfig.operator_account($t20))), 1) at /home/ying/diem/language/move-stdlib/modules/Option.move:16:9+24
    // data invariant at /home/ying/diem/language/move-stdlib/modules/Option.move:16:9+24
    assert {:msg "assert_failed(44,561,585): data invariant does not hold"}
      (LenVec($vec#$1_Option_Option'address'($operator_account#$1_ValidatorConfig_ValidatorConfig($Dereference($t20)))) <= 1);

    // @242 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:101:5+705
    // state save for global update invariants
    assume {:print "$at(35,3918,4623)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#242 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // write_back[ValidatorConfig::ValidatorConfig@]($t20) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:111:9+91
    assume {:print "$at(35,4525,4616)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory := $ResourceUpdate($1_ValidatorConfig_ValidatorConfig_$memory, $GlobalLocationAddress($t20),
        $Dereference($t20));

    // assert forall validator: TypeDomain<address>() where ValidatorConfig::$is_valid[@242](validator): ValidatorConfig::$is_valid(validator) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:336:9+107
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:336:9+107
    assume {:print "$at(35,14475,14582)"} true;
    assert {:msg "assert_failed(35,14475,14582): global memory invariant does not hold"}
      (forall validator: int :: $IsValid'address'(validator) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory#242, validator))  ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, validator)));
    ...
    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:112:5+1
    assume {:print "$at(35,4622,4623)"} true;
L4:

    // assert Not(Not(exists[@114]<Roles::RoleId>($t7))) at /home/ying/diem/language/diem-framework/modules/Roles.move:580:9+69
    assume {:print "$at(26,25923,25992)"} true;
    assert {:msg "assert_failed(26,25923,25992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#114, $t7);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@114]<Roles::RoleId>($t7)), 3)) at /home/ying/diem/language/diem-framework/modules/Roles.move:581:9+97
    assume {:print "$at(26,26001,26098)"} true;
    assert {:msg "assert_failed(26,26001,26098): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#114, $t7)), 3);

    // assert Not(Not(ValidatorOperatorConfig::$has_validator_operator_config[@115]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:127:9+123
    assume {:print "$at(35,5293,5416)"} true;
    assert {:msg "assert_failed(35,5293,5416): function does not abort under this condition"}
      !!$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115, $t1);

    // assert Not(Not(ValidatorOperatorConfig::$has_validator_operator_config[@115]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:130:9+108
    assume {:print "$at(35,5490,5598)"} true;
    assert {:msg "assert_failed(35,5490,5598): function does not abort under this condition"}
      !!$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115, $t1);

    // assert Not(Not(exists[@114]<Roles::RoleId>($t8))) at /home/ying/diem/language/diem-framework/modules/Roles.move:580:9+69
    assume {:print "$at(26,25923,25992)"} true;
    assert {:msg "assert_failed(26,25923,25992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#114, $t8);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@114]<Roles::RoleId>($t8)), 3)) at /home/ying/diem/language/diem-framework/modules/Roles.move:581:9+97
    assume {:print "$at(26,26001,26098)"} true;
    assert {:msg "assert_failed(26,26001,26098): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#114, $t8)), 3);

    // assert Not(Not(ValidatorConfig::$exists_config[@116]($t8))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:92:9+58
    assume {:print "$at(35,3469,3527)"} true;
    assert {:msg "assert_failed(35,3469,3527): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#116, $t8);

    // assert ValidatorConfig::spec_has_operator($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:137:9+42
    assume {:print "$at(35,5791,5833)"} true;
    assert {:msg "assert_failed(35,5791,5833): post-condition does not hold"}
      $1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory, $t9);

    // assert Eq<address>(ValidatorConfig::$get_operator($t9), $t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:138:9+54
    assume {:print "$at(35,5842,5896)"} true;
    assert {:msg "assert_failed(35,5842,5896): post-condition does not hold"}
      $IsEqual'address'($1_ValidatorConfig_$get_operator($1_ValidatorConfig_ValidatorConfig_$memory, $t9), $t1);

    // assert forall addr: TypeDomain<address>() where Neq<address>(addr, $t9): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr)), select ValidatorConfig::ValidatorConfig.operator_account(global[@116]<ValidatorConfig::ValidatorConfig>(addr))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:140:9+173
    assume {:print "$at(35,5990,6163)"} true;
    assert {:msg "assert_failed(35,5990,6163): post-condition does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> (!$IsEqual'address'(addr, $t9))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#116, addr)))));

    // return () at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:140:9+173
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:112:5+1
    assume {:print "$at(35,4622,4623)"} true;
L5:

    // assert Or(Or(Or(Or(Or(Or(Not(exists[@114]<Roles::RoleId>($t7)), Neq<u64>(select Roles::RoleId.role_id(global[@114]<Roles::RoleId>($t7)), 3)), Not(ValidatorOperatorConfig::$has_validator_operator_config[@115]($t1))), Not(ValidatorOperatorConfig::$has_validator_operator_config[@115]($t1))), Not(exists[@114]<Roles::RoleId>($t8))), Neq<u64>(select Roles::RoleId.role_id(global[@114]<Roles::RoleId>($t8)), 3)), Not(ValidatorConfig::$exists_config[@116]($t8))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:113:5+323
    assume {:print "$at(35,4628,4951)"} true;
    assert {:msg "assert_failed(35,4628,4951): abort not covered by any of the `aborts_if` clauses"}
      ((((((!$ResourceExists($1_Roles_RoleId_$memory#114, $t7) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#114, $t7)), 3)) || !$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115, $t1)) || !$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115, $t1)) || !$ResourceExists($1_Roles_RoleId_$memory#114, $t8)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#114, $t8)), 3)) || !$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#116, $t8));

    // assert Or(Or(Or(Or(Or(Or(And(Not(exists[@114]<Roles::RoleId>($t7)), Eq(5, $t11)), And(Neq<u64>(select Roles::RoleId.role_id(global[@114]<Roles::RoleId>($t7)), 3), Eq(3, $t11))), And(Not(ValidatorOperatorConfig::$has_validator_operator_config[@115]($t1)), Eq(7, $t11))), And(Not(ValidatorOperatorConfig::$has_validator_operator_config[@115]($t1)), Eq(5, $t11))), And(Not(exists[@114]<Roles::RoleId>($t8)), Eq(5, $t11))), And(Neq<u64>(select Roles::RoleId.role_id(global[@114]<Roles::RoleId>($t8)), 3), Eq(3, $t11))), And(Not(ValidatorConfig::$exists_config[@116]($t8)), Eq(5, $t11))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:113:5+323
    assert {:msg "assert_failed(35,4628,4951): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$ResourceExists($1_Roles_RoleId_$memory#114, $t7) && $IsEqual'u8'(5, $t11)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#114, $t7)), 3) && $IsEqual'u8'(3, $t11))) || (!$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115, $t1) && $IsEqual'u8'(7, $t11))) || (!$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115, $t1) && $IsEqual'u8'(5, $t11))) || (!$ResourceExists($1_Roles_RoleId_$memory#114, $t8) && $IsEqual'u8'(5, $t11))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#114, $t8)), 3) && $IsEqual'u8'(3, $t11))) || (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#116, $t8) && $IsEqual'u8'(5, $t11)));

    // abort($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:113:5+323
    $abort_code := $t11;
    $abort_flag := true;
    return;
...
L7:
    ...
    // @179 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@179](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
L8:
    ...
    // @155 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@155](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
...
L7:
    ...
    // @173 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@173](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L7:
    ...
    // @167 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@167](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
