...
(let ((anon22_Then_correct  (=> $abort_flag@1 (=> (and (= $abort_code@2 $abort_code@2) (= (ControlFlow 0 228502) 228512)) L9_correct))))
(let ((anon20_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 228578) 228512)) L9_correct))))
(let ((anon22_Else_correct  (=> (and (not $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 228488) (- 0 310273)) (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (=> (= (ControlFlow 0 228488) (- 0 310280)) (let (($range_0 ($Range 0 inline$$AddU64$0$dst@2)))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((j@@28 $i_1))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) j@@28)) _$t1))))
 :qid |DiemSystembpl.8900:49|
 :skolemid |277|
)))))))))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 228419) 228502) anon22_Then_correct) (=> (= (ControlFlow 0 228419) 228488) anon22_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t8@0 1) $MAX_U64) (= (ControlFlow 0 228417) 228419)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t8@0 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t8@0 1)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 228365) 228502) anon22_Then_correct) (=> (= (ControlFlow 0 228365) 228488) anon22_Else_correct))))))
(let ((anon21_Else_correct  (=> (and (not $t12@1) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 228425) 228417) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 228425) 228365) inline$$AddU64$0$anon3_Else_correct)))))
(let ((L8_correct  (and (=> (= (ControlFlow 0 228089) (- 0 310031)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 228089) (- 0 310038)) (=> (let (($range_0@@0 ($Range 0 $t5)))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@90 $i_1@@0))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) i@@90)) _$t1))))
 :qid |DiemSystembpl.8919:49|
 :skolemid |278|
))) (= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t16@0)) 0))) (=> (=> (let (($range_0@@1 ($Range 0 $t5)))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@91 $i_1@@1))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) i@@91)) _$t1))))
 :qid |DiemSystembpl.8919:49|
 :skolemid |278|
))) (= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t16@0)) 0)) (and (=> (= (ControlFlow 0 228089) (- 0 310081)) (=> (let (($range_0@@2 ($Range 0 $t5)))
(exists (($i_1@@2 Int) ) (!  (and ($InRange $range_0@@2 $i_1@@2) (let ((i@@92 $i_1@@2))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) i@@92)) _$t1)))
 :qid |DiemSystembpl.8925:49|
 :skolemid |279|
))) (and (not (= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t16@0)) 0)) (let ((at (|Select__T@[Int]Int_| (|v#Vec_28829| (|$vec#$1_Option_Option'u64'| $t16@0)) 0)))
 (and (and (<= 0 at) (< at $t5)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) at)) _$t1)))))) (=> (=> (let (($range_0@@3 ($Range 0 $t5)))
(exists (($i_1@@3 Int) ) (!  (and ($InRange $range_0@@3 $i_1@@3) (let ((i@@93 $i_1@@3))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) i@@93)) _$t1)))
 :qid |DiemSystembpl.8925:49|
 :skolemid |279|
 ...
 (and (and (<= 0 at@@0) (< at@@0 $t5)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) at@@0)) _$t1))))) (=> (= (ControlFlow 0 228089) (- 0 310155)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@0)))) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@1))))))))))))))
(let ((anon21_Then_correct  (=> $t12@1 (and (=> (= (ControlFlow 0 228564) (- 0 309974)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) $t8@0)) _$t1)) (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) $t8@0)) _$t1) (=> (and (|$IsValid'$1_Option_Option'u64''| $t15) (<= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t15)) 1)) (=> (and (and (|$IsEqual'vec'u64''| (|$vec#$1_Option_Option'u64'| $t15) (|$vec#$1_Option_Option'u64'| (|$1_Option_Option'u64'| (Vec_28829 (|Store__T@[Int]Int_| (MapConstVec_12393 DefaultVecElem_12393) 0 $t8@0) 1)))) (= $t15 $t15)) (and (= $t16@0 $t15) (= (ControlFlow 0 228564) 228089))) L8_correct)))))))
(let ((anon20_Else_correct  (=> (and (and (not $abort_flag@0) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (and (= $t11@1 (|$addr#$1_DiemSystem_ValidatorInfo| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (= $t12@1 (= $t11@1 _$t1)))) (and (=> (= (ControlFlow 0 228260) 228564) anon21_Then_correct) (=> (= (ControlFlow 0 228260) 228425) anon21_Else_correct)))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@0|)) (and (=> (= (ControlFlow 0 228228) 228578) anon20_Then_correct) (=> (= (ControlFlow 0 228228) 228260) anon20_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_78413 _$t0 $t8@0)) (= (ControlFlow 0 228226) 228228)) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|  (=> (InRangeVec_78413 _$t0 $t8@0) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) $t8@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1|))) (and (=> (= (ControlFlow 0 228176) 228578) anon20_Then_correct) (=> (= (ControlFlow 0 228176) 228260) anon20_Else_correct))))))
(let ((anon19_Then_correct  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 228234) 228226) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 228234) 228176) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|)))))
(let ((anon19_Else_correct  (=> (not inline$$Lt$0$dst@1) (and (=> (= (ControlFlow 0 227943) (- 0 309783)) (= $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (= $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (and (=> (= (ControlFlow 0 227943) (- 0 309790)) (let (($range_0@@4 ($Range 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((j@@29 $i_1@@4))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) j@@29)) _$t1))))
 :qid |DiemSystembpl.8861:48|
 :skolemid |276|
)))) (=> (let (($range_0@@5 ($Range 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((j@@30 $i_1@@5))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) j@@30)) _$t1))))
 :qid |DiemSystembpl.8861:48|
 :skolemid |276|
))) (=> (and (|$IsValid'$1_Option_Option'u64''| $t17) (<= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t17)) 1)) (=> (and (and (|$IsEqual'vec'u64''| (|$vec#$1_Option_Option'u64'| $t17) (|$vec#$1_Option_Option'u64'| (|$1_Option_Option'u64'| (Vec_28829 (MapConstVec_12393 DefaultVecElem_12393) 0)))) (= $t17 $t17)) (and (= $t16@0 $t17) (= (ControlFlow 0 227943) 228089))) L8_correct)))))))))
...
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (= (ControlFlow 0 227848) 227858)) anon18_Else$1_correct)))
(let ((anon18_Else_correct  (=> (and (and (not false) (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (and (|$IsValid'u64'| 0) (= 0 0))) (and (=> (= (ControlFlow 0 227854) (- 0 309621)) (<= 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (<= 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (and (=> (= (ControlFlow 0 227854) (- 0 309628)) (let (($range_0@@6 ($Range 0 0)))
(forall (($i_1@@6 Int) ) (!  (=> ($InRange $range_0@@6 $i_1@@6) (let ((j@@31 $i_1@@6))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) j@@31)) _$t1))))
 :qid |DiemSystembpl.8705:48|
 :skolemid |274|
)))) (=> (let (($range_0@@7 ($Range 0 0)))
(forall (($i_1@@7 Int) ) (!  (=> ($InRange $range_0@@7 $i_1@@7) (let ((j@@32 $i_1@@7))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) j@@32)) _$t1))))
 :qid |DiemSystembpl.8705:48|
 :skolemid |274|
...
(forall (($i_1@@8 Int) ) (!  (=> ($InRange $range_0@@8 $i_1@@8) (let ((j@@33 $i_1@@8))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| _$t0) j@@33)) _$t1))))
 :qid |DiemSystembpl.8745:53|
 :skolemid |275|
))) (= (ControlFlow 0 227854) 227848)))) inline$$Lt$0$anon0_correct)))))))))
(let ((anon18_Then_correct true))
(let ((|inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| (|l#Vec_87979| _$t0)) (and (=> (= (ControlFlow 0 227644) 228592) anon18_Then_correct) (=> (= (ControlFlow 0 227644) 227854) anon18_Else_correct)))))
(let ((anon0$1_correct  (=> (and (|$IsValid'vec'$1_DiemSystem_ValidatorInfo''| _$t0) (|$IsValid'address'| _$t1)) (=> (and (and (= $t5 (|l#Vec_87979| _$t0)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= (ControlFlow 0 227650) 227644))) |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_87682_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemSystembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 227564) 227650)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 309415) 227564) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))
))
(check-sat)
(pop 1)
