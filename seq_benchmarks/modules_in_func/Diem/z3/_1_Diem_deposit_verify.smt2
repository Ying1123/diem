...
(declare-fun $t16@0 () T@$Mutation_13443)
(declare-fun _$t0 () T@$Mutation_312361)
(declare-fun $t16@1 () T@$Mutation_13443)
(declare-fun inline$$AddU64$0$dst@2 () Int)
(declare-fun $t0@0 () T@$Mutation_312361)
...
(declare-fun $t16 () T@$Mutation_13443)
(push 1)
(set-info :boogie-vc-id $1_Diem_deposit$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 882194) (let ((anon11_Else_correct  (=> (and (not $abort_flag@1) (= $t16@0 ($Mutation_13443 (|l#$Mutation_312361| _$t0) (seq.++ (|p#$Mutation_312361| _$t0) (seq.unit 0)) (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_312361| _$t0))))) (=> (and (and (= $t16@1 ($Mutation_13443 (|l#$Mutation_13443| $t16@0) (|p#$Mutation_13443| $t16@0) inline$$AddU64$0$dst@2)) (= $t0@0 ($Mutation_312361 (|l#$Mutation_312361| _$t0) (|p#$Mutation_312361| _$t0) (|$1_Diem_Diem'#0'| (|v#$Mutation_13443| $t16@1))))) (and (= |$temp_0'$1_Diem_Diem'#0''@1| (|v#$Mutation_312361| $t0@0)) (= |$temp_0'$1_Diem_Diem'#0''@1| |$temp_0'$1_Diem_Diem'#0''@1|))) (and (=> (= (ControlFlow 0 644974) (- 0 882786)) (not (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615))) (=> (not (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615)) (and (=> (= (ControlFlow 0 644974) (- 0 882803)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_312361| $t0@0)) (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)))) (=> (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_312361| $t0@0)) (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1))) (and (=> (= (ControlFlow 0 644974) (- 0 882821)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 644974) (- 0 882842)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr))))
 ...
 :qid |Diembpl.24527:15|
 :skolemid |865|
)) (and (=> (= (ControlFlow 0 644974) (- 0 882871)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)))
 ...
 :qid |Diembpl.24532:15|
 :skolemid |866|
)) (and (=> (= (ControlFlow 0 644974) (- 0 882896)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 644974) (- 0 882917)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3))))
 ...
 :qid |Diembpl.24542:15|
 :skolemid |867|
)) (and (=> (= (ControlFlow 0 644974) (- 0 882946)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)))
 ...
 :qid |Diembpl.24547:15|
 :skolemid |868|
)) (and (=> (= (ControlFlow 0 644974) (- 0 882971)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 644974) (- 0 882992)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 644974) (- 0 883013)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7))))
 ...
 :qid |Diembpl.24562:15|
 :skolemid |869|
)) (=> (= (ControlFlow 0 644974) (- 0 883049)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9)))
 :qid |Diembpl.24567:15|
 :skolemid |870|
)))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 644461) (- 0 882684)) (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615)) (=> (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615) (=> (= (ControlFlow 0 644461) (- 0 882696)) (and (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615) (= 8 $t10@0)))))))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 644988) 644461))) L3_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 644618) 644988) anon11_Then_correct) (=> (= (ControlFlow 0 644618) 644974) anon11_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t14@0 $t6@0) $MAX_U64) (= (ControlFlow 0 644616) 644618)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t14@0 $t6@0)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t14@0 $t6@0)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 644564) 644988) anon11_Then_correct) (=> (= (ControlFlow 0 644564) 644974) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and inline$$Ge$0$dst@1 (= $t14@0 (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_312361| _$t0)))) (and (=> (= (ControlFlow 0 644624) 644616) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 644624) 644564) inline$$AddU64$0$anon3_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not inline$$Ge$0$dst@1) (= $t13 $t13)) (and (= $t10@0 $t13) (= (ControlFlow 0 644417) 644461))) L3_correct)))
(let ((anon9_Else$1_correct  (=> (|$IsValid'u64'| 7) (=> (and (and (|$IsValid'u64'| $t13) (= $t13 8)) (and (= $t13 $t13) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 644401) 644624) anon10_Then_correct) (=> (= (ControlFlow 0 644401) 644417) anon10_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= inline$$Sub$0$dst@2 $t6@0)) (= (ControlFlow 0 644365) 644401)) anon9_Else$1_correct)))
(let ((anon9_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 644371) 644365)) inline$$Ge$0$anon0_correct)))
(let ((anon9_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 645002) 644461))) L3_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 644311) 645002) anon9_Then_correct) (=> (= (ControlFlow 0 644311) 644371) anon9_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< 18446744073709551615 $t8@0) (= (ControlFlow 0 644309) 644311)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= $t8@0 18446744073709551615) (=> (and (and (= inline$$Sub$0$dst@1 (- 18446744073709551615 $t8@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 644261) 645002) anon9_Then_correct) (=> (= (ControlFlow 0 644261) 644371) anon9_Else_correct))))))
(let ((anon0$1_correct  (=> (= (|l#$Mutation_312361| _$t0) ($Param 0)) (=> (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_312361| _$t0)) (|$IsValid'$1_Diem_Diem'#0''| _$t1)) (=> (and (and (and (= $t5@0 (|v#$Mutation_312361| _$t0)) (= |$temp_0'$1_Diem_Diem'#0''@0| (|v#$Mutation_312361| _$t0))) (and (= |$temp_0'$1_Diem_Diem'#0''@0| |$temp_0'$1_Diem_Diem'#0''@0|) (= _$t1 _$t1))) (and (and (= $t6@0 (|$value#$1_Diem_Diem'#0'| _$t1)) (= $t6@0 $t6@0)) (and (|$IsValid'u64'| 18446744073709551615) (= $t8@0 (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_312361| _$t0)))))) (and (=> (= (ControlFlow 0 644317) 644309) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 644317) 644261) inline$$Sub$0$anon3_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 644090) 644317)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (seq.len (|p#$Mutation_13443| $t16)) 0) (= (ControlFlow 0 644100) 644090)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 882194) 644100) anon0_correct)))
