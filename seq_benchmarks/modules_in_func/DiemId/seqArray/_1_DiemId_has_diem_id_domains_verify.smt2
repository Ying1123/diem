...
(assert (not
 (=> (= (ControlFlow 0 0) 224900) (let ((anon0$1_correct@@3  (=> (|$IsValid'address'| _$t0@@2) (=> (and (and (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $a_0@@4)))
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| $elem@@5)) 63)))
 ...
 :skolemid |229|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $a_0@@4))
)) (= _$t0@@2 _$t0@@2)) (and (= $t1@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@2)) (= $t1@0@@0 $t1@0@@0))) (and (=> (= (ControlFlow 0 164910) (- 0 225155)) (not false)) (=> (not false) (=> (= (ControlFlow 0 164910) (- 0 225162)) (= $t1@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@2)))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@3  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@8 T@$1_Event_EventHandle) ) (! (let ((stream@@8 (|Select__T@[$1_Event_EventHandle]Multiset_69963_| (|streams#$EventStore| $es) handle@@8)))
 (and (= (|l#Multiset_69963| stream@@8) 0) (forall ((v@@45 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_69963| stream@@8) v@@45) 0)
 :qid |DiemIdbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemIdbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 164664) 164910)) anon0$1_correct@@3)))
(let ((anon0_correct@@3  (=> (= (ControlFlow 0 224900) 164664) inline$$InitEventStore$0$anon0_correct@@3)))
anon0_correct@@3))))
))
(check-sat)
(pop 1)
