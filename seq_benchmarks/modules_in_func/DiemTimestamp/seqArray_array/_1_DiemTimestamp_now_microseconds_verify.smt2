...
(let ((anon11_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t1@0@@1 $abort_code@1) (= (ControlFlow 0 156549) 156577))) L2_correct)))
(let ((anon9_Then_correct  (=> $t0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t1)) (= $t1 $t1)) (and (= $t1@0@@1 $t1) (= (ControlFlow 0 156655) 156577))) L2_correct))))
...
(let ((inline$$InitEventStore$0$anon0_correct@@3  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@5 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_65544_| (|streams#$EventStore| $es) handle@@5)))
 (and (= (|l#Multiset_65544| stream@@4) 0) (forall ((v@@44 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_65544| stream@@4) v@@44) 0)
 :qid |DiemTimestampbpl.159:13|
 :skolemid |4|
))))
 :qid |DiemTimestampbpl.2406:13|
 :skolemid |84|
))) (= (ControlFlow 0 156399) 156465)) anon0$1_correct@@3)))
(let ((anon0_correct@@3  (=> (= (ControlFlow 0 215794) 156399) inline$$InitEventStore$0$anon0_correct@@3)))
anon0_correct@@3))))))))))))
))
(check-sat)
(pop 1)
