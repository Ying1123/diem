...
(let ((anon12_Then_correct  (=> $t8 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 $t9)) (and (= $t9 $t9) (= (ControlFlow 0 163992) 163954))) L9_correct))))
(let ((L7_correct  (=> (= $t3@0 $t3@0) (and (=> (= (ControlFlow 0 163800) (- 0 226443)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 163800) (- 0 226450)) (= $t3@0  (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t1))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t1))))))) (=> (= $t3@0  (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t1))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t1)))))) (and (=> (= (ControlFlow 0 163800) (- 0 226464)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) a)))
 :qid |VASPbpl.9656:15|
 :skolemid |211|
 ...
 :qid |VASPbpl.9656:15|
 :skolemid |211|
)) (=> (= (ControlFlow 0 163800) (- 0 226489)) (forall ((parent Int) ) (!  (=> (|$IsValid'address'| parent) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) parent) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_128063| $1_VASP_ParentVASP_$memory) parent)) (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_128063| $1_VASP_ParentVASP_$memory) parent)))))
 :qid |VASPbpl.9661:15|
 :skolemid |212|
))))))))))))
...
(let ((anon12_Else_correct  (=> (and (and (not $t8) (|$IsValid'address'| $t7)) (and (= $t7 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0)))) (= $t11  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t1)))))) (and (=> (= (ControlFlow 0 163870) 163944) anon13_Then_correct) (=> (= (ControlFlow 0 163870) 163906) anon13_Else_correct)))))
(let ((anon11_Then_correct  (=> (and $t2@0 (= $t8  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0))))) (and (=> (= (ControlFlow 0 163826) 163992) anon12_Then_correct) (=> (= (ControlFlow 0 163826) 163870) anon12_Else_correct)))))
...
(let ((anon0$1_correct  (=> (and (and (and (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127999| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |VASPbpl.9432:20|
 :skolemid |208|
)) (|$IsValid'address'| _$t0)) (and (|$IsValid'address'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127999| $1_VASP_ChildVASP_$memory) $a_0)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc))
 :qid |VASPbpl.9442:20|
 :skolemid |209|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127999| $1_VASP_ChildVASP_$memory) $a_0))
)))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_128063| $1_VASP_ParentVASP_$memory) $a_0@@0)))
...
)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t4  (or (|Select__T@[Int]Bool_| (|domain#$Memory_128063| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_127999| $1_VASP_ChildVASP_$memory) _$t0)))))) (and (=> (= (ControlFlow 0 163666) 164020) anon10_Then_correct) (=> (= (ControlFlow 0 163666) 163686) anon10_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_68395_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 163533) 163666)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 226005) 163533) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))
))
(check-sat)
(pop 1)
