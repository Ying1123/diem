...
(declare-fun $t11 () T@$Mutation_173758)
(declare-fun $t11@0 () T@$Mutation_173758)
...
)))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163355| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@0)))
(|$IsValid'$1_TransactionFee_TransactionFee'#0''| $rsc@@0))
 :qid |TransactionFeebpl.18957:20|
 :skolemid |415|
 :pattern ( (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163355| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@0))
)) (= $t4 (|$balance#$1_TransactionFee_TransactionFee'#0'| (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163355| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (and (= _$t0 _$t0) (= $t5  (not (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 269667) 270272) anon17_Then_correct) (=> (= (ControlFlow 0 269667) 269760) anon17_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_92611_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |TransactionFeebpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 269273) 269667)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (seq.len (|p#$Mutation_173758| $t3)) 0) (= (seq.len (|p#$Mutation_173758| $t11)) 0)) (and (= (seq.len (|p#$Mutation_143660| $t12)) 0) (= (ControlFlow 0 269283) 269273))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 356764) 269283) anon0_correct)))
