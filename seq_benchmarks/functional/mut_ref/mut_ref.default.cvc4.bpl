...
function $IsEqual'vec'$1_TestMutRef_T''(v1: Vec ($1_TestMutRef_T), v2: Vec ($1_TestMutRef_T)): bool {
    LenVec(v1) == LenVec(v2) &&
    (forall i: int:: InRangeVec(v1, i) ==> $IsEqual'$1_TestMutRef_T'(ReadVec(v1, i), ReadVec(v2, i)))
}
...
function {:inline} $IsEqual'$1_TestMutRef_V'(s1: $1_TestMutRef_V, s2: $1_TestMutRef_V): bool {
    $IsEqual'vec'u64''($is#$1_TestMutRef_V(s1), $is#$1_TestMutRef_V(s2))
    && $IsEqual'vec'$1_TestMutRef_T''($ts#$1_TestMutRef_V(s1), $ts#$1_TestMutRef_V(s2))}
