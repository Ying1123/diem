...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 773778) (let ((anon4_Else_correct  (=> (and (not $abort_flag@3) (= $t12 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_291108| $1_VASPDomain_VASPDomains_$memory@2) _$t1)))) (and (=> (= (ControlFlow 0 560426) (- 0 776731)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) _$t1))) (and (=> (= (ControlFlow 0 560426) (- 0 776742)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_290709| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_290709| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (and (=> (= (ControlFlow 0 560426) (- 0 776752)) (not (exists ((i@@126 Int) ) (!  (and (and (|$IsValid'u64'| i@@126) (InRangeVec_164551 $t3 i@@126)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_184062| $t3) i@@126)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |TreasuryComplianceScriptsbpl.1893:13|
 :skolemid |70|
)))) (=> (not (exists ((i@@127 Int) ) (!  (and (and (|$IsValid'u64'| i@@127) (InRangeVec_164551 $t3 i@@127)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_184062| $t3) i@@127)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |TreasuryComplianceScriptsbpl.1893:13|
 :skolemid |70|
))) (and (=> (= (ControlFlow 0 560426) (- 0 776764)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 560426) (- 0 776776)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) $t4)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) $t4)) 1))) (and (=> (= (ControlFlow 0 560426) (- 0 776794)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 560426) (- 0 776808)) (not (> (|l#Vec_25539| _$t2) 63))) (=> (not (> (|l#Vec_25539| _$t2) 63)) (and (=> (= (ControlFlow 0 560426) (- 0 776820)) (exists ((i@@128 Int) ) (!  (and (and (|$IsValid'u64'| i@@128) (InRangeVec_164551 $t12 i@@128)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_184062| $t12) i@@128)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |TreasuryComplianceScriptsbpl.1893:13|
 :skolemid |70|
))) (=> (exists ((i@@129 Int) ) (!  (and (and (|$IsValid'u64'| i@@129) (InRangeVec_164551 $t12 i@@129)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_184062| $t12) i@@129)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |TreasuryComplianceScriptsbpl.1893:13|
 :skolemid |70|
)) (and (=> (= (ControlFlow 0 560426) (- 0 776830)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t5)))
(let ((stream_new (let ((len (|l#Multiset_183272| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@0) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6))))
(Multiset_183272 (|Store__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@0) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t5 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t5)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_183272| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@1) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6))))
(Multiset_183272 (|Store__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@1) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t5 stream_new@@0))))))
 ...
 :qid |TreasuryComplianceScriptsbpl.3504:13|
 :skolemid |127|
))))) (=> (= (ControlFlow 0 560426) (- 0 776855)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t5)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_183272| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@2) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6))))
(Multiset_183272 (|Store__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@2) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $EmptyEventStore) $t5 stream_new@@1))))))
...
(let ((anon4_Then_correct  (=> (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (=> (= (ControlFlow 0 560682) (- 0 776495)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_290709| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (exists ((i@@130 Int) ) (!  (and (and (|$IsValid'u64'| i@@130) (InRangeVec_164551 $t3 i@@130)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_184062| $t3) i@@130)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |TreasuryComplianceScriptsbpl.1893:13|
 :skolemid |70|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) $t4))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (> (|l#Vec_25539| _$t2) 63))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_290709| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (exists ((i@@131 Int) ) (!  (and (and (|$IsValid'u64'| i@@131) (InRangeVec_164551 $t3 i@@131)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_184062| $t3) i@@131)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |TreasuryComplianceScriptsbpl.1893:13|
 :skolemid |70|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) $t4))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (> (|l#Vec_25539| _$t2) 63)) (=> (= (ControlFlow 0 560682) (- 0 776561)) (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) _$t1)) (= 5 $abort_code@4)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_290709| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= 5 $abort_code@4))) (and (exists ((i@@132 Int) ) (!  (and (and (|$IsValid'u64'| i@@132) (InRangeVec_164551 $t3 i@@132)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_184062| $t3) i@@132)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |TreasuryComplianceScriptsbpl.1893:13|
 :skolemid |70|
)) (= 7 $abort_code@4))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) $t4)) (= 5 $abort_code@4))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $abort_code@4))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $abort_code@4))) (and (> (|l#Vec_25539| _$t2) 63) (= 7 $abort_code@4))) (= 3 $abort_code@4)) (= 2 $abort_code@4)) (= 5 $abort_code@4)) (= 7 $abort_code@4))))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon44_Else_correct  (=> (not $abort_flag@2) (=> (and (and (= $abort_code@4 $abort_code@3) (= $abort_flag@3 $abort_flag@2)) (and (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory@0) (= $es@2 $es@0))) (and (=> (= (ControlFlow 0 559968) 560682) anon4_Then_correct) (=> (= (ControlFlow 0 559968) 560426) anon4_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$L7_correct  (=> (and (and (= $abort_code@4 inline$$1_VASPDomain_add_vasp_domain$0$$t17@1) (= $abort_flag@3 true)) (and (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory@1) (= $es@2 $es@1))) (and (=> (= (ControlFlow 0 559026) 560682) anon4_Then_correct) (=> (= (ControlFlow 0 559026) 560426) anon4_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon44_Then_correct  (=> (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@3) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory@0)) (and (= $es@1 $es@0) (= (ControlFlow 0 559982) 559026))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((|inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| (|v#$Mutation_223780| inline$$1_VASPDomain_add_vasp_domain$0$$t34@1)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_183272| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@3) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| inline$$1_VASPDomain_add_vasp_domain$0$$t36@1))))
(Multiset_183272 (|Store__T@[$EventRep]Int_| (|v#Multiset_183272| stream@@3) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| inline$$1_VASPDomain_add_vasp_domain$0$$t36@1) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 559952) 559982) inline$$1_VASPDomain_add_vasp_domain$0$anon44_Then_correct) (=> (= (ControlFlow 0 559952) 559968) inline$$1_VASPDomain_add_vasp_domain$0$anon44_Else_correct)))))
...
(Vec_25539 (|Store__T@[Int]Int_| (|v#Vec_25539| (|p#$Mutation_291209| inline$$1_VASPDomain_add_vasp_domain$0$$t33@2)) l 0) (+ l 1))) (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|v#$Mutation_291209| inline$$1_VASPDomain_add_vasp_domain$0$$t33@2))))) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t36@1 ($1_VASPDomain_VASPDomainEvent false inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 _$t1)) (= (ControlFlow 0 559958) 559952))) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon43_Then_correct  (=> (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@3) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory@0)) (and (= $es@1 $es) (= (ControlFlow 0 559996) 559026))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
...
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon40_Else_correct  (=> (and (not inline$$Not$0$dst@1) (= inline$$1_VASPDomain_add_vasp_domain$0$$t30@0 inline$$1_VASPDomain_add_vasp_domain$0$$t30@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t30@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 559706) 559026))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
...
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon39_Then_correct  (=> (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@2) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 560076) 559026))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((|inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| (exists ((i@@133 Int) ) (!  (and (and (|$IsValid'u64'| i@@133) (InRangeVec_164551 inline$$1_VASPDomain_add_vasp_domain$0$$t26@1 i@@133)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_184062| inline$$1_VASPDomain_add_vasp_domain$0$$t26@1) i@@133)) (|$domain#$1_VASPDomain_VASPDomain| inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)))
 :qid |TreasuryComplianceScriptsbpl.1893:13|
 :skolemid |70|
...
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon38_Then_correct  (=> (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@2) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 560090) 559026))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
...
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon37_Then_correct  (=> (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@1) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 560104) 559026))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
...
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon36_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) _$t1)) (= (ControlFlow 0 560154) 560156)) inline$$1_VASPDomain_add_vasp_domain$0$anon36_Then$1_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon36_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) _$t1) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t24@1 ($Mutation_291144 ($Global _$t1) (Vec_25539 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) _$t1))) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t24@2 inline$$1_VASPDomain_add_vasp_domain$0$$t24@1))) (and (=> (= (ControlFlow 0 559110) 560104) inline$$1_VASPDomain_add_vasp_domain$0$anon37_Then_correct) (=> (= (ControlFlow 0 559110) 559544) inline$$1_VASPDomain_add_vasp_domain$0$anon37_Else_correct))))))
...
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon35_Else_correct  (=> (and (not inline$$1_VASPDomain_add_vasp_domain$0$$t21@1) (= inline$$1_VASPDomain_add_vasp_domain$0$$t23@0 inline$$1_VASPDomain_add_vasp_domain$0$$t23@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t23@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 559084) 559026))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon34_Then_correct  (=> inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 (=> (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t21@1 (|Select__T@[Int]Bool_| (|domain#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) _$t1)) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_add_vasp_domain$0$$t23@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t23@0 5)) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t23@0 inline$$1_VASPDomain_add_vasp_domain$0$$t23@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t21@1 inline$$1_VASPDomain_add_vasp_domain$0$$t21@1))) (and (=> (= (ControlFlow 0 559068) 559088) inline$$1_VASPDomain_add_vasp_domain$0$anon35_Then_correct) (=> (= (ControlFlow 0 559068) 559084) inline$$1_VASPDomain_add_vasp_domain$0$anon35_Else_correct)))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon34_Else_correct  (=> (and (not inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1) (= inline$$1_VASPDomain_add_vasp_domain$0$$t20@0 inline$$1_VASPDomain_add_vasp_domain$0$$t20@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t20@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 559020) 559026))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
...
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon32_Then_correct  (=> inline$$1_VASPDomain_add_vasp_domain$0$$t16@0 (=> (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_add_vasp_domain$0$$t15@0)) (= 5 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_add_vasp_domain$0$$t15@0)) 1)) (= 3 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0))) (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@0 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 560242) 559026))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct)))))
...
(let ((anon0$1_correct  (=> (and (and (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_231375| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@0)) 4))))
 ...
 :skolemid |674|
))))) (=> (and (and (and (and (and (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_284034| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@4) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@4)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@4)) 6)))))
 :qid |TreasuryComplianceScriptsbpl.32355:22|
 :skolemid |675|
)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_284098| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@5) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@5)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@5)) 6)))))
 :qid |TreasuryComplianceScriptsbpl.32355:388|
 :skolemid |676|
))) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_284162| |$1_AccountLimits_Window'#0'_$memory|) addr@@6) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@6) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@6)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@6)) 6)))))
 ...
 :skolemid |678|
))) (and (and (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_310146| $1_DiemAccount_DiemAccount_$memory) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@7)))
 :qid |TreasuryComplianceScriptsbpl.32363:20|
 :skolemid |679|
)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_290709| $1_VASPDomain_VASPDomainManager_$memory) addr@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@8)) 1))))
 :qid |TreasuryComplianceScriptsbpl.32367:20|
 :skolemid |680|
))) (and (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_309897| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_309980| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@9)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@9)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@9)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@9)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.32371:20|
 :skolemid |681|
)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_305546| $1_DesignatedDealer_Dealer_$memory) addr@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@10)) 2))))
 :qid |TreasuryComplianceScriptsbpl.32375:20|
 :skolemid |682|
))))) (and (and (and (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_301456| $1_DualAttestation_Credential_$memory) addr@@11) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@11)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@11)) 5)))))
 :qid |TreasuryComplianceScriptsbpl.32379:20|
 :skolemid |683|
)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_232095| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@12) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@12)) 3))))
 :qid |TreasuryComplianceScriptsbpl.32383:20|
 :skolemid |684|
))) (and (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_231375| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@13) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@13)) 4))))
 :qid |TreasuryComplianceScriptsbpl.32387:20|
 :skolemid |685|
)) (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_294457| $1_VASP_ParentVASP_$memory) addr@@14) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@14)) 5))))
 :qid |TreasuryComplianceScriptsbpl.32391:20|
 :skolemid |686|
)))) (and (and (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_294393| $1_VASP_ChildVASP_$memory) addr@@15) (and (|Select__T@[Int]Bool_| (|domain#$Memory_231048| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) addr@@15)) 6))))
 :qid |TreasuryComplianceScriptsbpl.32395:20|
 :skolemid |687|
)) (|$IsValid'address'| (|$addr#$signer| _$t0))) (and (|$IsValid'address'| _$t1) (|$IsValid'vec'u8''| _$t2))))) (and (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_231048| $1_Roles_RoleId_$memory) $a_0)))
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_290709| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@0)))
(|$IsValid'$1_VASPDomain_VASPDomainManager'| $rsc@@0))
 :qid |TreasuryComplianceScriptsbpl.32411:20|
 :skolemid |689|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_290709| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) $a_0@@1)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc@@1) (and (and (let (($range_1 ($Range 0 (|l#Vec_184062| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@134 $i_2))
(<= (|l#Vec_25539| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_184062| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)) i@@134))) 63)))
 :qid |TreasuryComplianceScriptsbpl.32416:140|
 :skolemid |690|
))) (let (($range_3 ($Range 0 (|l#Vec_184062| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@135 $i_4))
(let (($range_5 ($Range (+ i@@135 1) (|l#Vec_184062| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@40 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_184062| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)) i@@135)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_184062| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)) j@@40))))))
...
(<= (|l#Vec_25539| (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 ...
 :skolemid |694|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) $a_0@@1))
)) (= $t3 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) _$t1))))) (and (and (= $t4 (|$addr#$signer| _$t0)) (= $t5 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_290709| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $t6 ($1_VASPDomain_VASPDomainEvent false ($1_VASPDomain_VASPDomain _$t2) _$t1)) (let ((addr@@16 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_230554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_310146| $1_DiemAccount_DiemAccount_$memory) addr@@16)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_306468| $1_AccountFreezing_FreezingBit_$memory) addr@@16) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_306468| $1_AccountFreezing_FreezingBit_$memory) addr@@16))))))))) (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= _$t2 _$t2) (= $t7 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_291108| $1_VASPDomain_VASPDomains_$memory) _$t1))))) (and (and (= $t8 (|$addr#$signer| _$t0)) (= $t9 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_290709| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $t10 ($1_VASPDomain_VASPDomainEvent false ($1_VASPDomain_VASPDomain _$t2) _$t1)) (= (ControlFlow 0 560246) 558875)))))) inline$$1_VASPDomain_add_vasp_domain$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_183272_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |TreasuryComplianceScriptsbpl.3488:13|
 :skolemid |126|
))) (= (ControlFlow 0 556469) 560246)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 773778) 556469) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
