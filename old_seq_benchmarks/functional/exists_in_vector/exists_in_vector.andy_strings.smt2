...
(assert (forall ((k1 (Seq Int)) (k2 (Seq Int)) ) (!  (=> (= k1 k2) (= ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2)))
 :qid |existsinvectorandybpl.1019:15|
 :skolemid |27|
 :pattern ( ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2))
)))
(assert (forall ((s1 (Seq Int)) (s2 (Seq Int)) (k1@@0 (Seq Int)) (k2@@0 (Seq Int)) (m1 (Seq Int)) (m2 (Seq Int)) ) (!  (=> (and (and (= s1 s2) (= k1@@0 k2@@0)) (= m1 m2)) (= ($1_Signature_$ed25519_verify s1 k1@@0 m1) ($1_Signature_$ed25519_verify s2 k2@@0 m2)))
 :qid |existsinvectorandybpl.1022:15|
 :skolemid |28|
...
(assert (not
 ...
 :qid |existsinvectorandybpl.1128:15|
 :skolemid |32|
...
(= x 0)))
 :qid |existsinvectorandybpl.1077:33|
 :skolemid |29|
))) (let (($range_0@@0 _$t0))
...
(= (seq.nth _$t0 i@@8) 0)))
 :qid |existsinvectorandybpl.1083:52|
 :skolemid |30|
...
(= (seq.nth _$t0 i@@9) 0)))
 ...
 :qid |existsinvectorandybpl.1089:13|
 :skolemid |31|
...
(= x@@2 e@@1)))
 ...
 :qid |existsinvectorandybpl.1153:15|
 :skolemid |34|
...
(assert (not
 ...
 :qid |existsinvectorandybpl.1216:15|
 :skolemid |37|
...
(= x@@6 e@@6)))
 ...
 :qid |existsinvectorandybpl.1246:15|
 :skolemid |40|
