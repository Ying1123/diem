...
procedure {:timeLimit 40} $1_DiemTimestamp_update_global_time$verify(_$t0: int, _$t1: int, _$t2: int) returns ()
{
    ...
    var $temp_0'u64': int;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#105: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    ...
    // @105 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:78:9+77
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#105 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;
...
L5:
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemBlock::$is_initialized()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assert Implies(DiemTimestamp::$is_operating(), DiemBlock::$is_initialized()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:131:9+61
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:131:9+61
    assume {:print "$at(12,4847,4908)"} true;
    assert {:msg "assert_failed(12,4847,4908): global memory invariant does not hold"}
...
L7:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@105]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#105);
...
L8:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_operating[@105]()), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$VM_RESERVED_ADDRESS[]())), (if Eq<address>($t1, CoreAddresses::$VM_RESERVED_ADDRESS[]()) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}})) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:5+795
    assume {:print "$at(17,3408,4203)"} true;
    assert {:msg "assert_failed(17,3408,4203): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#105) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS())) || if ($IsEqual'address'($t1, $1_CoreAddresses_$VM_RESERVED_ADDRESS())) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)));

    // assert Or(Or(And(Not(DiemTimestamp::$is_operating[@105]()), Eq(1, $t11)), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$VM_RESERVED_ADDRESS[]()), Eq(2, $t11))), And((if Eq<address>($t1, CoreAddresses::$VM_RESERVED_ADDRESS[]()) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}}), Eq(7, $t11))) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:5+795
    assert {:msg "assert_failed(17,3408,4203): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#105) && $IsEqual'u8'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS()) && $IsEqual'u8'(2, $t11))) || (if ($IsEqual'address'($t1, $1_CoreAddresses_$VM_RESERVED_ADDRESS())) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'u8'(7, $t11)));
...
procedure {:inline 1} $1_RegisteredCurrencies_initialize(_$t0: int) returns ()
{
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_DiemConfig_Configuration_$memory#174: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
...
L7:
    ...
    // @174 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    $1_DiemConfig_Configuration_$memory#174 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@174](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#174), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L6:
    ...
    // @146 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@146](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
L7:
    ...
    // @164 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@164](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
// spec fun at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:393:10+108
...
procedure {:inline 1} $1_DiemSystem_initialize_validator_set(_$t0: int) returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemConfig_Configuration_$memory#140: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
...
L8:
    ...
    // @140 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    $1_DiemConfig_Configuration_$memory#140 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@140](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#140), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
// spec fun at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:120:5+227
function {:inline} $1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory: $Memory $1_DiemBlock_BlockMetadata): int {
    $height#$1_DiemBlock_BlockMetadata($ResourceValue($1_DiemBlock_BlockMetadata_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()))
}
...
// fun DiemBlock::is_initialized [verification] at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:57:5+100
procedure {:timeLimit 40} $1_DiemBlock_is_initialized$verify() returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), DiemBlock::$is_initialized()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:57:5+100
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:131:9+61
    assume {:print "$at(12,2012,2112)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory));

    // assume forall $rsc: ResourceDomain<DiemBlock::BlockMetadata>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:57:5+100
...
// fun DiemBlock::block_prologue [verification] at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
procedure {:timeLimit 40} $1_DiemBlock_block_prologue$verify(_$t0: int, _$t1: int, _$t2: int, _$t3: Vec (int), _$t4: int) returns ()
{
    // declare local variables
    var $t5: $Mutation ($1_DiemBlock_BlockMetadata);
    var $t6: bool;
    var $t7: int;
    var $t8: bool;
    ...
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#175: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#176: $Memory $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem';
    var $1_DiemBlock_BlockMetadata_$memory#177: $Memory $1_DiemBlock_BlockMetadata;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    $t3 := _$t3;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(12,2249,3320)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    ...
    // assume Implies(DiemTimestamp::$is_operating(), And(DiemConfig::spec_is_published<DiemSystem::DiemSystem>(), exists<DiemSystem::CapabilityHolder>(CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    ...
    // assume forall i1: Range(0, Len<DiemSystem::ValidatorInfo>(DiemSystem::spec_get_validators())): Roles::spec_has_validator_role_addr(select DiemSystem::ValidatorInfo.addr(Index(DiemSystem::spec_get_validators(), i1))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    ...
    // assume forall i1: Range(0, Len<DiemSystem::ValidatorInfo>(DiemSystem::spec_get_validators())): Eq<u64>(select DiemSystem::ValidatorInfo.consensus_voting_power(Index(DiemSystem::spec_get_validators(), i1)), 1) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemBlock::$is_initialized()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:131:9+61
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    assume $IsValid'u64'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    assume $IsValid'u64'($t2);

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    assume $IsValid'vec'address''($t3);

    // assume WellFormed($t4) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    assume $IsValid'address'($t4);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemSystem::DiemSystem>>(): And(WellFormed($rsc), forall i: Range(0, Len<DiemSystem::ValidatorInfo>(select DiemSystem::DiemSystem.validators(select DiemConfig::DiemConfig.payload($rsc)))), j: Range(0, Len<DiemSystem::ValidatorInfo>(select DiemSystem::DiemSystem.validators(select DiemConfig::DiemConfig.payload($rsc)))): Implies(Eq<address>(select DiemSystem::ValidatorInfo.addr(Index(select DiemSystem::DiemSystem.validators(select DiemConfig::DiemConfig.payload($rsc)), i)), select DiemSystem::ValidatorInfo.addr(Index(select DiemSystem::DiemSystem.validators(select DiemConfig::DiemConfig.payload($rsc)), j))), Eq<num>(i, j))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    ...
    // assume forall $rsc: ResourceDomain<DiemBlock::BlockMetadata>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1071
    assume (forall $a_0: int :: {$ResourceValue($1_DiemBlock_BlockMetadata_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemBlock_BlockMetadata_$memory, $a_0);
    ($IsValid'$1_DiemBlock_BlockMetadata'($rsc))));

    // assume Identical($t9, select DiemBlock::BlockMetadata.new_block_events(global<DiemBlock::BlockMetadata>(CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:109:9+88
    assume {:print "$at(12,4054,4142)"} true;
    assume ($t9 == $new_block_events#$1_DiemBlock_BlockMetadata($ResourceValue($1_DiemBlock_BlockMetadata_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())));

    // assume Identical($t10, pack DiemBlock::NewBlockEvent($t1, $t4, $t3, $t2)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:110:9+153
    assume {:print "$at(12,4151,4304)"} true;
    assume ($t10 == $1_DiemBlock_NewBlockEvent($t1, $t4, $t3, $t2));

    // @175 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1
    assume {:print "$at(12,2249,2250)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#175 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @176 := save_mem(DiemConfig::DiemConfig<DiemSystem::DiemSystem>) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1
    $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#176 := $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory;

    // @177 := save_mem(DiemBlock::BlockMetadata) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1
    $1_DiemBlock_BlockMetadata_$memory#177 := $1_DiemBlock_BlockMetadata_$memory;

    // trace_local[vm]($t0) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1
    assume {:print "$track_local(31,0,0):", $t0} $t0 == $t0;

    // trace_local[round]($t1) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1
    assume {:print "$track_local(31,0,1):", $t1} $t1 == $t1;

    // trace_local[timestamp]($t2) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1
    assume {:print "$track_local(31,0,2):", $t2} $t2 == $t2;

    // trace_local[previous_block_votes]($t3) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1
    assume {:print "$track_local(31,0,3):", $t3} $t3 == $t3;

    // trace_local[proposer]($t4) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:63:5+1
    assume {:print "$track_local(31,0,4):", $t4} $t4 == $t4;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:70:9+33
    // >> opaque call: DiemTimestamp::assert_operating()
    assume {:print "$at(12,2445,2478)"} true;

    // opaque begin: DiemTimestamp::assert_operating() at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:70:9+33

    // assume Identical($t11, Not(DiemTimestamp::$is_operating())) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:70:9+33
    assume ($t11 == !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t11) goto L9 else goto L8 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:70:9+33
    if ($t11) { goto L9; } else { goto L8; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:70:9+33
L9:

    // assume And(Not(DiemTimestamp::$is_operating()), Eq(1, $t12)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:70:9+33
    assume (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t12));

    // trace_abort($t12) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:70:9+33
    assume {:print "$at(12,2445,2478)"} true;
    assume {:print "$track_abort(31,0):", $t12} $t12 == $t12;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:70:9+33
    goto L7;

    // label L8 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:70:9+33
L8:

    // opaque end: DiemTimestamp::assert_operating() at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:70:9+33

    // nop at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:72:9+29
    // >> opaque call: CoreAddresses::assert_vm($t0)
    assume {:print "$at(12,2554,2583)"} true;

    // opaque begin: CoreAddresses::assert_vm($t0) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:72:9+29

    // assume Identical($t13, Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$VM_RESERVED_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:72:9+29
    assume ($t13 == !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS()));

    // if ($t13) goto L11 else goto L10 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:72:9+29
    if ($t13) { goto L11; } else { goto L10; }

    // label L11 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:72:9+29
L11:

    // assume And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$VM_RESERVED_ADDRESS()), Eq(2, $t12)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:72:9+29
    assume (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS()) && $IsEqual'u8'(2, $t12));

    // trace_abort($t12) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:72:9+29
    assume {:print "$at(12,2554,2583)"} true;
    assume {:print "$track_abort(31,0):", $t12} $t12 == $t12;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:72:9+29
    goto L7;

    // label L10 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:72:9+29
L10:

    // opaque end: CoreAddresses::assert_vm($t0) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:72:9+29

    // $t14 := CoreAddresses::VM_RESERVED_ADDRESS() on_abort goto L7 with $t12 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:25+36
    assume {:print "$at(12,2651,2687)"} true;
    call $t14 := $1_CoreAddresses_VM_RESERVED_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(12,2651,2687)"} true;
        $t12 := $abort_code;
        assume {:print "$track_abort(31,0):", $t12} $t12 == $t12;
    ...
    // $t15 := ==($t4, $t14) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:22+2
    $t15 := $IsEqual'address'($t4, $t14);

    // if ($t15) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:13+86
    if ($t15) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:13+86
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:13+86
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:13+86
L0:

    // $t16 := true at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:13+86
    $t16 := true;
    assume $IsValid'bool'($t16);

    // $t8 := $t16 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:13+86
    $t8 := $t16;

    // trace_local[tmp#$8]($t16) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:13+86
    assume {:print "$track_local(31,0,8):", $t16} $t16 == $t16;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:13+86
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:90+8
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34
    // >> opaque call: $t12 := DiemSystem::is_validator($t4)

    // $t17 := opaque begin: DiemSystem::is_validator($t4) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34

    // assume Identical($t18, Not(exists<DiemConfig::DiemConfig<DiemSystem::DiemSystem>>(CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34
    assume ($t18 == !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // if ($t18) goto L13 else goto L12 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34
    if ($t18) { goto L13; } else { goto L12; }

    // label L13 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34
L13:

    // assume And(Not(exists<DiemConfig::DiemConfig<DiemSystem::DiemSystem>>(CoreAddresses::$DIEM_ROOT_ADDRESS())), Eq(5, $t12)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34
    assume (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t12));

    // trace_abort($t12) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34
    assume {:print "$at(12,2691,2725)"} true;
    assume {:print "$track_abort(31,0):", $t12} $t12 == $t12;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34
    goto L7;

    // label L12 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34
L12:

    // assume WellFormed($t17) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34
    assume $IsValid'bool'($t17);

    // assume Eq<bool>($t17, DiemSystem::spec_is_validator($t4)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34
    assume $IsEqual'bool'($t17, $1_DiemSystem_spec_is_validator($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory, $t4));

    // $t17 := opaque end: DiemSystem::is_validator($t4) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:65+34

    // $t8 := $t17 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:13+86
    $t8 := $t17;

    // trace_local[tmp#$8]($t17) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:13+86
    assume {:print "$track_local(31,0,8):", $t17} $t17 == $t17;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:76:13+86
L3:

    // $t19 := 1 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:77:38+16
    assume {:print "$at(12,2764,2780)"} true;
    $t19 := 1;
    assume $IsValid'u64'($t19);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:77:13+42
    // >> opaque call: $t14 := Errors::requires_address($t13)

    // $t20 := opaque begin: Errors::requires_address($t19) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:77:13+42

    // assume WellFormed($t20) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:77:13+42
    assume $IsValid'u64'($t20);

    // assume Eq<u64>($t20, 2) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:77:13+42
    assume $IsEqual'u64'($t20, 2);

    // $t20 := opaque end: Errors::requires_address($t19) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:77:13+42

    // trace_local[tmp#$7]($t20) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:75:9+172
    assume {:print "$at(12,2619,2791)"} true;
    assume {:print "$track_local(31,0,7):", $t20} $t20 == $t20;

    // trace_local[tmp#$6]($t8) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:75:9+172
    assume {:print "$track_local(31,0,6):", $t8} $t8 == $t8;

    // if ($t8) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:75:9+172
    if ($t8) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:75:9+172
L5:

    // trace_abort($t20) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:75:9+172
    assume {:print "$at(12,2619,2791)"} true;
    assume {:print "$track_abort(31,0):", $t20} $t20 == $t20;

    // $t12 := move($t20) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:75:9+172
    $t12 := $t20;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:75:9+172
    goto L7;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:80:67+34
    assume {:print "$at(12,2860,2894)"} true;
L4:

    // $t21 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L7 with $t12 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:80:67+34
    call $t21 := $1_CoreAddresses_DIEM_ROOT_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(12,2860,2894)"} true;
        $t12 := $abort_code;
        assume {:print "$track_abort(31,0):", $t12} $t12 == $t12;
    ...
    // $t22 := borrow_global<DiemBlock::BlockMetadata>($t21) on_abort goto L7 with $t12 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:80:34+17
    ...
    if ($abort_flag) {
        assume {:print "$at(12,2827,2844)"} true;
        $t12 := $abort_code;
        assume {:print "$track_abort(31,0):", $t12} $t12 == $t12;
        goto L7;
    }

    // trace_local[block_metadata_ref]($t22) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:80:13+18
    $temp_0'$1_DiemBlock_BlockMetadata' := $Dereference($t22);
    assume {:print "$track_local(31,0,5):", $temp_0'$1_DiemBlock_BlockMetadata'} $temp_0'$1_DiemBlock_BlockMetadata' == $temp_0'$1_DiemBlock_BlockMetadata';

    // nop at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:81:9+59
    // >> opaque call: DiemTimestamp::update_global_time($t0, $t4, $t2)
    assume {:print "$at(12,2905,2964)"} true;

    // assume Identical($t23, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:80:9+34
    assume {:print "$at(17,3552,3586)"} true;
    assume ($t23 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // opaque begin: DiemTimestamp::update_global_time($t0, $t4, $t2) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:81:9+59
    assume {:print "$at(12,2905,2964)"} true;

    // assume Identical($t24, Or(Not(DiemTimestamp::$is_operating()), Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$VM_RESERVED_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:81:9+59
    assume ($t24 == (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS())));

    // if ($t24) goto L16 else goto L14 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:81:9+59
    if ($t24) { goto L16; } else { goto L14; }

    // label L15 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:81:9+59
L15:

    // assume Or(And(Not(DiemTimestamp::$is_operating()), Eq(1, $t12)), And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$VM_RESERVED_ADDRESS()), Eq(2, $t12))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:81:9+59
    assume ((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t12)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS()) && $IsEqual'u8'(2, $t12)));

    // trace_abort($t12) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:81:9+59
    assume {:print "$at(12,2905,2964)"} true;
    assume {:print "$track_abort(31,0):", $t12} $t12 == $t12;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:81:9+59
    goto L7;

    // label L14 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:81:9+59
L14:

    // modifies global<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:81:9+59
    havoc $temp_0'bool';
    if ($temp_0'bool') {
        havoc $temp_0'$1_DiemTimestamp_CurrentTimeMicroseconds';
        $1_DiemTimestamp_CurrentTimeMicroseconds_$memory := $ResourceUpdate($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS(), $temp_0'$1_DiemTimestamp_CurrentTimeMicroseconds');
    } else {
        $1_DiemTimestamp_CurrentTimeMicroseconds_$memory := $ResourceRemove($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());
    }

    // assume Identical($t25, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:81:9+44
    assume ($t25 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Eq<u64>($t25, $t2) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:81:9+44
    assume $IsEqual'u64'($t25, $t2);

    // opaque end: DiemTimestamp::update_global_time($t0, $t4, $t2) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:81:9+44

    // $t26 := get_field<DiemBlock::BlockMetadata>.height($t22) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:82:37+25
    assume {:print "$at(12,3002,3027)"} true;
    $t26 := $height#$1_DiemBlock_BlockMetadata($Dereference($t22));

    // $t27 := 1 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:82:65+1
    $t27 := 1;
    assume $IsValid'u64'($t27);

    // $t28 := +($t26, $t27) on_abort goto L7 with $t12 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:82:63+1
    call $t28 := $AddU64($t26, $t27);
    if ($abort_flag) {
        assume {:print "$at(12,3028,3029)"} true;
        $t12 := $abort_code;
        assume {:print "$track_abort(31,0):", $t12} $t12 == $t12;
        goto L7;
    }

    // $t29 := borrow_field<DiemBlock::BlockMetadata>.height($t22) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:82:9+25
    $t29 := $ChildMutation($t22, 0, $height#$1_DiemBlock_BlockMetadata($Dereference($t22)));

    // write_ref($t29, $t28) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:82:9+57
    $t29 := $UpdateMutation($t29, $t28);

    // write_back[Reference($t22).height]($t29) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:82:9+57
    $t22 := $UpdateMutation($t22, $Update'$1_DiemBlock_BlockMetadata'_height($Dereference($t22), $Dereference($t29)));

    // $t30 := borrow_field<DiemBlock::BlockMetadata>.new_block_events($t22) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:84:13+40
    assume {:print "$at(12,3087,3127)"} true;
    $t30 := $ChildMutation($t22, 1, $new_block_events#$1_DiemBlock_BlockMetadata($Dereference($t22)));

    // $t31 := pack DiemBlock::NewBlockEvent($t1, $t4, $t3, $t2) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:85:13+162
    assume {:print "$at(12,3141,3303)"} true;
    $t31 := $1_DiemBlock_NewBlockEvent($t1, $t4, $t3, $t2);

    // Event::emit_event<DiemBlock::NewBlockEvent>($t30, $t31) on_abort goto L7 with $t12 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:83:9+272
    assume {:print "$at(12,3041,3313)"} true;
    ...
    // write_back[DiemBlock::BlockMetadata@]($t22) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:83:9+272
    ...
    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:92:5+1
    assume {:print "$at(12,3319,3320)"} true;
L6:

    // assert Not(Not(DiemTimestamp::$is_operating[@175]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#175);
    ...
    // assert Not(And(Neq<address>($t4, CoreAddresses::$VM_RESERVED_ADDRESS[]()), Not(DiemSystem::spec_is_validator[@176]($t4)))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:96:9+145
    assume {:print "$at(12,3467,3612)"} true;
    assert {:msg "assert_failed(12,3467,3612): function does not abort under this condition"}
      !(!$IsEqual'address'($t4, $1_CoreAddresses_$VM_RESERVED_ADDRESS()) && !$1_DiemSystem_spec_is_validator($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#176, $t4));

    // assert Not(Gt(Add(DiemBlock::$get_current_block_height[@177](), 1), 18446744073709551615)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:101:9+74
    assume {:print "$at(12,3774,3848)"} true;
    assert {:msg "assert_failed(12,3774,3848): function does not abort under this condition"}
      !(($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory#177) + 1) > 18446744073709551615);

    // assert Eq<u64>(DiemTimestamp::spec_now_microseconds(), $t2) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:98:9+60
    assume {:print "$at(12,3621,3681)"} true;
    assert {:msg "assert_failed(12,3621,3681): post-condition does not hold"}
      $IsEqual'u64'($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory), $t2);

    // assert Eq<u64>(DiemBlock::$get_current_block_height(), Add(DiemBlock::$get_current_block_height[@177](), 1)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:99:9+74
    assume {:print "$at(12,3690,3764)"} true;
    assert {:msg "assert_failed(12,3690,3764): post-condition does not hold"}
      $IsEqual'u64'($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory), ($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory#177) + 1));

    // assert EventStoreIncludes(ExtendEventStore(EmptyEventStore(), $t10, $t9)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:116:9+20
    assume {:print "$at(12,4313,4333)"} true;
    assert {:msg "assert_failed(12,4313,4333): function does not emit the expected event"}
    ...
    // assert EventStoreIncludedIn(ExtendEventStore(EmptyEventStore(), $t10, $t9)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:93:5+565
    assume {:print "$at(12,3325,3890)"} true;
    assert {:msg "assert_failed(12,3325,3890): emitted event not covered by any of the `emits` clauses"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:93:5+565
    return;

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:92:5+1
    assume {:print "$at(12,3319,3320)"} true;
L7:

    // assert Or(Or(Or(Not(DiemTimestamp::$is_operating[@175]()), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$VM_RESERVED_ADDRESS[]())), And(Neq<address>($t4, CoreAddresses::$VM_RESERVED_ADDRESS[]()), Not(DiemSystem::spec_is_validator[@176]($t4)))), Gt(Add(DiemBlock::$get_current_block_height[@177](), 1), 18446744073709551615)) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:93:5+565
    assume {:print "$at(12,3325,3890)"} true;
    assert {:msg "assert_failed(12,3325,3890): abort not covered by any of the `aborts_if` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#175) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS())) || (!$IsEqual'address'($t4, $1_CoreAddresses_$VM_RESERVED_ADDRESS()) && !$1_DiemSystem_spec_is_validator($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#176, $t4))) || (($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory#177) + 1) > 18446744073709551615));

    // assert Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@175]()), Eq(1, $t12)), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$VM_RESERVED_ADDRESS[]()), Eq(2, $t12))), And(And(Neq<address>($t4, CoreAddresses::$VM_RESERVED_ADDRESS[]()), Not(DiemSystem::spec_is_validator[@176]($t4))), Eq(2, $t12))), And(Gt(Add(DiemBlock::$get_current_block_height[@177](), 1), 18446744073709551615), Eq(-1, $t12))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:93:5+565
    assert {:msg "assert_failed(12,3325,3890): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#175) && $IsEqual'u8'(1, $t12)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS()) && $IsEqual'u8'(2, $t12))) || ((!$IsEqual'address'($t4, $1_CoreAddresses_$VM_RESERVED_ADDRESS()) && !$1_DiemSystem_spec_is_validator($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#176, $t4)) && $IsEqual'u8'(2, $t12))) || ((($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory#177) + 1) > 18446744073709551615) && $IsEqual'num'(-1, $t12)));

    // abort($t12) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:93:5+565
    $abort_code := $t12;
    $abort_flag := true;
    return;
...
// fun DiemBlock::get_current_block_height [verification] at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:120:5+227
procedure {:timeLimit 40} $1_DiemBlock_get_current_block_height$verify() returns ($ret0: int)
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), DiemBlock::$is_initialized()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:120:5+227
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:131:9+61
    assume {:print "$at(12,4382,4609)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory));

    // assume forall $rsc: ResourceDomain<DiemBlock::BlockMetadata>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:120:5+227
    assume (forall $a_0: int :: {$ResourceValue($1_DiemBlock_BlockMetadata_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemBlock_BlockMetadata_$memory, $a_0);
    ($IsValid'$1_DiemBlock_BlockMetadata'($rsc))));

    // $t2 := DiemBlock::is_initialized() on_abort goto L3 with $t3 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:16+16
    assume {:print "$at(12,4465,4481)"} true;
    call $t2 := $1_DiemBlock_is_initialized();
    if ($abort_flag) {
        assume {:print "$at(12,4465,4481)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(31,1):", $t3} $t3 == $t3;
        goto L3;
    }

    // $t4 := 0 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:56+15
    $t4 := 0;
    assume $IsValid'u64'($t4);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:34+38
    // >> opaque call: $t4 := Errors::not_published($t3)

    // $t5 := opaque begin: Errors::not_published($t4) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:34+38

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:34+38
    assume $IsValid'u64'($t5);

    // assume Eq<u64>($t5, 5) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:34+38
    assume $IsEqual'u64'($t5, 5);

    // $t5 := opaque end: Errors::not_published($t4) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:34+38

    // trace_local[tmp#$1]($t5) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:9+64
    assume {:print "$track_local(31,1,1):", $t5} $t5 == $t5;

    // trace_local[tmp#$0]($t2) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:9+64
    assume {:print "$track_local(31,1,0):", $t2} $t2 == $t2;

    // if ($t2) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:9+64
    if ($t2) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:9+64
L1:

    // trace_abort($t5) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:9+64
    assume {:print "$at(12,4458,4522)"} true;
    assume {:print "$track_abort(31,1):", $t5} $t5 == $t5;

    // $t3 := move($t5) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:9+64
    $t3 := $t5;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:121:9+64
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:122:38+34
    assume {:print "$at(12,4561,4595)"} true;
L0:

    // $t6 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L3 with $t3 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:122:38+34
    ...
    // $t7 := get_global<DiemBlock::BlockMetadata>($t6) on_abort goto L3 with $t3 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:122:9+13
    ...
    if ($abort_flag) {
        assume {:print "$at(12,4532,4545)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(31,1):", $t3} $t3 == $t3;
        goto L3;
    }

    // $t8 := get_field<DiemBlock::BlockMetadata>.height($t7) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:122:9+71
    $t8 := $height#$1_DiemBlock_BlockMetadata($t7);

    // trace_return[0]($t8) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:122:9+71
    assume {:print "$track_return(31,1,0):", $t8} $t8 == $t8;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:123:5+1
    assume {:print "$at(12,4608,4609)"} true;
L2:

    // return $t8 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:123:5+1
    $ret0 := $t8;
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:123:5+1
L3:

    // abort($t3) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:123:5+1
    $abort_code := $t3;
    $abort_flag := true;
    return;
...
// fun DiemBlock::initialize_block_metadata [verification] at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:34:5+531
procedure {:timeLimit 40} $1_DiemBlock_initialize_block_metadata$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
    ...
    var $1_DiemBlock_BlockMetadata_$memory#130: $Memory $1_DiemBlock_BlockMetadata;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:34:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(12,1100,1631)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:34:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), And(DiemConfig::spec_is_published<DiemSystem::DiemSystem>(), exists<DiemSystem::CapabilityHolder>(CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:34:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:562:9+176
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> ($1_DiemConfig_spec_is_published'$1_DiemSystem_DiemSystem'($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory) && $ResourceExists($1_DiemSystem_CapabilityHolder_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())));

    // assume Implies(DiemTimestamp::$is_operating(), DiemBlock::$is_initialized()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:34:5+531
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:131:9+61
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:34:5+531
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:34:5+531
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemBlock::BlockMetadata>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:34:5+531
    assume (forall $a_0: int :: {$ResourceValue($1_DiemBlock_BlockMetadata_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemBlock_BlockMetadata_$memory, $a_0);
    ($IsValid'$1_DiemBlock_BlockMetadata'($rsc))));

    // @129 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:34:5+1
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#129 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @130 := save_mem(DiemBlock::BlockMetadata) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:34:5+1
    $1_DiemBlock_BlockMetadata_$memory#130 := $1_DiemBlock_BlockMetadata_$memory;
...
L2:
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@129]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:142:9+51
    assume {:print "$at(17,5802,5853)"} true;
    assert {:msg "assert_failed(17,5802,5853): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#129);
    ...
    // assert Not(DiemBlock::$is_initialized[@130]()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:51:9+58
    assume {:print "$at(12,1780,1838)"} true;
    assert {:msg "assert_failed(12,1780,1838): function does not abort under this condition"}
      !$1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory#130);

    // assert DiemBlock::$is_initialized() at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:52:9+25
    assume {:print "$at(12,1847,1872)"} true;
    assert {:msg "assert_failed(12,1847,1872): post-condition does not hold"}
      $1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory);

    // assert Eq<u64>(DiemBlock::$get_current_block_height(), 0) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:53:9+40
    assume {:print "$at(12,1881,1921)"} true;
    assert {:msg "assert_failed(12,1881,1921): post-condition does not hold"}
      $IsEqual'u64'($1_DiemBlock_$get_current_block_height($1_DiemBlock_BlockMetadata_$memory), 0);

    // return () at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:53:9+40
    return;
...
L3:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_genesis[@129]()), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), DiemBlock::$is_initialized[@130]()) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:48:5+291
    assume {:print "$at(12,1636,1927)"} true;
    assert {:msg "assert_failed(12,1636,1927): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#129) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || $1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory#130));

    // assert Or(Or(And(Not(DiemTimestamp::$is_genesis[@129]()), Eq(1, $t4)), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t4))), And(DiemBlock::$is_initialized[@130](), Eq(6, $t4))) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:48:5+291
    assert {:msg "assert_failed(12,1636,1927): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#129) && $IsEqual'u8'(1, $t4)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t4))) || ($1_DiemBlock_$is_initialized($1_DiemBlock_BlockMetadata_$memory#130) && $IsEqual'u8'(6, $t4)));

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/DiemBlock.move:48:5+291
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
L7:
    ...
    // @158 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@158](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L7:
    ...
    // @152 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@152](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
