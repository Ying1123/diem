...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 78482) (let ((anon46_Else_correct  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 71108) (- 0 80715)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (and (=> (= (ControlFlow 0 71108) (- 0 80726)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) _$t2))) (and (=> (= (ControlFlow 0 71108) (- 0 80737)) (not (not (= (seq.len _$t3) 32)))) (=> (not (not (= (seq.len _$t3) 32))) (and (=> (= (ControlFlow 0 71108) (- 0 80751)) (not (not (exists ((i@@24 Int) ) (!  (and (and (|$IsValid'u64'| i@@24) (and (<= 0 i@@24) (< i@@24 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) i@@24)) _$t2))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
))))) (=> (not (not (exists ((i@@25 Int) ) (!  (and (and (|$IsValid'u64'| i@@25) (and (<= 0 i@@25) (< i@@25 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) i@@25)) _$t2))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
)))) (and (=> (= (ControlFlow 0 71108) (- 0 80763)) (not (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2))))) (=> (not (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2)))) (=> (= (ControlFlow 0 71108) (- 0 80784)) (= (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_52896| $1_DiemAccount_DiemAccount_$memory@1) _$t2)) _$t3)))))))))))))))
(let ((anon47_Else_correct  (=> (and (not $abort_flag@2) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 69972) (- 0 79960)) (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (=> (= (ControlFlow 0 69972) (- 0 79967)) (let (($range_0 ($Range 0 inline$$AddU64$0$dst@2)))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((j@@5 $i_1))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth $t25@0 j@@5)) _$t2))))
 :qid |RecoveryAddressbpl.5353:49|
 :skolemid |178|
)))))))))
(let ((L17_correct  (and (=> (= (ControlFlow 0 69003) (- 0 80562)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) _$t2))) (not (= (seq.len _$t3) 32))) (not (exists ((i@@26 Int) ) (!  (and (and (|$IsValid'u64'| i@@26) (and (<= 0 i@@26) (< i@@26 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) i@@26)) _$t2))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
)))) (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2))))) (=> (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) _$t2))) (not (= (seq.len _$t3) 32))) (not (exists ((i@@27 Int) ) (!  (and (and (|$IsValid'u64'| i@@27) (and (<= 0 i@@27) (< i@@27 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) i@@27)) _$t2))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
)))) (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2)))) (=> (= (ControlFlow 0 69003) (- 0 80614)) (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= 5 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) _$t2)) (= 5 $t17@0))) (and (not (= (seq.len _$t3) 32)) (= 7 $t17@0))) (and (not (exists ((i@@28 Int) ) (!  (and (and (|$IsValid'u64'| i@@28) (and (<= 0 i@@28) (< i@@28 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) i@@28)) _$t2))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
))) (= 7 $t17@0))) (and (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2))) (= 7 $t17@0))))))))
(let ((anon46_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t17@0 $abort_code@5) (= (ControlFlow 0 71122) 69003))) L17_correct)))
...
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1 ($Mutation_54737 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1))) (= $abort_code@4 $abort_code@2)) (and (= $abort_flag@3 $abort_flag@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1))) (and (=> (= (ControlFlow 0 70738) 70940) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct) (=> (= (ControlFlow 0 70738) 70794) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct))))))
...
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 $abort_code@2) (= (ControlFlow 0 71006) 70708))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
...
(let ((anon47_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 69986) 69003))) L17_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 69903) 69986) anon47_Then_correct) (=> (= (ControlFlow 0 69903) 69972) anon47_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t26@0 1) $MAX_U64) (= (ControlFlow 0 69901) 69903)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t26@0 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t26@0 1)) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 69849) 69986) anon47_Then_correct) (=> (= (ControlFlow 0 69849) 69972) anon47_Else_correct))))))
(let ((anon45_Else_correct  (=> (and (not $t31@1) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 69909) 69901) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 69909) 69849) inline$$AddU64$0$anon3_Else_correct)))))
(let ((anon44_Else_correct  (=> (and (not $abort_flag@1) (= $t31@1 (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 _$t2))) (and (=> (= (ControlFlow 0 69742) 71010) anon45_Then_correct) (=> (= (ControlFlow 0 69742) 69909) anon45_Else_correct)))))
(let ((anon44_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 71136) 69003))) L17_correct)))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 69722) 71136) anon44_Then_correct) (=> (= (ControlFlow 0 69722) 69742) anon44_Else_correct))))))
(let ((anon43_Else_correct  (=> (not $abort_flag@1) (=> (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= (ControlFlow 0 69728) 69722)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct))))
(let ((anon43_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 71150) 69003))) L17_correct)))
...
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|  (=> (and (not (and (>= $t26@0 0) (< $t26@0 (seq.len $t25@0)))) (= (ControlFlow 0 69605) 69607)) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|)))
...
(let ((anon42_Then_correct  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 69613) 69605) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 69613) 69555) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|)))))
(let ((anon42_Else_correct  (=> (not inline$$Lt$0$dst@1) (and (=> (= (ControlFlow 0 69468) (- 0 79615)) (= $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (= $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (and (=> (= (ControlFlow 0 69468) (- 0 79622)) (let (($range_0@@0 ($Range 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((j@@6 $i_1@@0))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth $t25@0 j@@6)) _$t2))))
...
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((j@@7 $i_1@@1))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth $t25@0 j@@7)) _$t2))))
 :qid |RecoveryAddressbpl.5312:49|
 :skolemid |177|
))) (=> (and (|$IsValid'u64'| 4) (|$IsValid'u64'| $t35)) (=> (and (and (= $t35 7) (= $t35 $t35)) (and (= $t17@0 $t35) (= (ControlFlow 0 69468) 69003))) L17_correct)))))))))
...
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (= (ControlFlow 0 69377) 69387)) anon41_Else$1_correct)))
...
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((j@@8 $i_1@@2))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth $t25@0 j@@8)) _$t2))))
...
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((j@@10 $i_1@@4))
 ...
 :skolemid |176|
))) (= (ControlFlow 0 69383) 69377)))) inline$$Lt$0$anon0_correct)))))))))
(let ((anon41_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 71164) 69003))) L17_correct)))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| (seq.len $t25@0)) (and (=> (= (ControlFlow 0 69187) 71164) anon41_Then_correct) (=> (= (ControlFlow 0 69187) 69383) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (not $abort_flag@0) (= $t25@0 (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| $t24@1))) (=> (and (and (= $t25@0 $t25@0) (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 69193) 69187))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 71178) 69003))) L17_correct)))
(let ((anon39_Then$1_correct  (=> (= $t24@1 $t24) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 71230) 71178) anon40_Then_correct) (=> (= (ControlFlow 0 71230) 69193) anon40_Else_correct))))))
(let ((anon39_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= (ControlFlow 0 71228) 71230)) anon39_Then$1_correct)))
(let ((anon39_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1) (=> (and (and (= $t24@0 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= $t24@1 $t24@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 69123) 71178) anon40_Then_correct) (=> (= (ControlFlow 0 69123) 69193) anon40_Else_correct))))))
...
(let ((anon38_Else_correct  (=> (and (and (not $t8@0) (= $t23 $t23)) (and (= $t17@0 $t23) (= (ControlFlow 0 69105) 69003))) L17_correct)))
(let ((L5_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t23) (= $t23 7)) (and (= $t23 $t23) (= $t8@0 $t8@0))) (and (=> (= (ControlFlow 0 69089) 69109) anon38_Then_correct) (=> (= (ControlFlow 0 69089) 69105) anon38_Else_correct))))))
(let ((anon37_Else_correct  (=> (not $t19@0) (=> (and (and (= $t21@0 (= $t18 _$t1)) (= $t21@0 $t21@0)) (and (= $t8@0 $t21@0) (= (ControlFlow 0 69055) 69089))) L5_correct))))
(let ((anon37_Then_correct  (=> (and (and $t19@0 (= true true)) (and (= $t8@0 true) (= (ControlFlow 0 71248) 69089))) L5_correct)))
(let ((anon36_Then_correct  (=> $t14@0 (=> (and (and (|$IsValid'address'| $t18) (= $t18 (|$addr#$signer| _$t0))) (and (= $t18 $t18) (= $t19@0 (= $t18 _$t2)))) (and (=> (= (ControlFlow 0 69033) 71248) anon37_Then_correct) (=> (= (ControlFlow 0 69033) 69055) anon37_Else_correct))))))
(let ((anon36_Else_correct  (=> (and (and (not $t14@0) (= $t16 $t16)) (and (= $t17@0 $t16) (= (ControlFlow 0 68827) 69003))) L17_correct)))
(let ((anon0$1_correct  (=> (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr) (or (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr)))) 0) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr)))) 0)) (= addr (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr))) 0)))))))
 :qid |RecoveryAddressbpl.4889:20|
 :skolemid |164|
)) (=> (and (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr@@0) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr@@0) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0)) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0)) (= addr@@0 (|$account_address#$1_DiemAccount_WithdrawCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr@@0))) 0)))))))
 :qid |RecoveryAddressbpl.4893:20|
 :skolemid |165|
)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (= (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_43878| $1_Roles_RoleId_$memory) addr@@1)))
 :qid |RecoveryAddressbpl.4897:20|
 :skolemid |166|
))) (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (= (|Select__T@[Int]Bool_| (|domain#$Memory_53789| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@2)  (and (= addr@@2 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr@@2))))
 :qid |RecoveryAddressbpl.4901:20|
 :skolemid |167|
)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (= (|Select__T@[Int]Bool_| (|domain#$Memory_54124| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@3)  (and (= addr@@3 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr@@3))))
 :qid |RecoveryAddressbpl.4905:20|
 :skolemid |168|
)))) (and (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (= (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_52863| $1_AccountFreezing_FreezingBit_$memory) addr@@4)))
 :qid |RecoveryAddressbpl.4909:20|
 :skolemid |169|
)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_52863| $1_AccountFreezing_FreezingBit_$memory) addr@@5)))
 :qid |RecoveryAddressbpl.4913:20|
 :skolemid |170|
))) (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@6) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@6))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@6)) 0)) addr@@6))))
 :qid |RecoveryAddressbpl.4917:20|
 :skolemid |171|
)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@7) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) addr@@7))))
 :qid |RecoveryAddressbpl.4921:20|
 :skolemid |172|
))))) (=> (and (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'address'| _$t1)) (and (|$IsValid'address'| _$t2) (|$IsValid'vec'u8''| _$t3))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) $a_0)))
 ...
 :skolemid |173|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_52896| $1_DiemAccount_DiemAccount_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@0)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@0))
 :qid |RecoveryAddressbpl.4940:20|
 :skolemid |174|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@0))
))) (and (= _$t0 _$t0) (= _$t1 _$t1)))) (and (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| $t16) (= $t16 5)) (and (= $t16 $t16) (= $t14@0 $t14@0))))) (and (=> (= (ControlFlow 0 68811) 69033) anon36_Then_correct) (=> (= (ControlFlow 0 68811) 68827) anon36_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_28061_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |RecoveryAddressbpl.1832:13|
 :skolemid |49|
))) (= (ControlFlow 0 68366) 68811)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 78482) 68366) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
