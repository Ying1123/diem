...
(assert (= a_40 (store a1 i6 e6)))
(assert (= a_41 (store a_40 i23 e23)))
(assert (= a_42 (store a_41 i5 e5)))
(assert (= a_43 (store a_42 i27 e27)))
(assert (= a_44 (store a_43 i33 e33)))
(assert (= a_45 (store a_44 i25 e25)))
(assert (= a_46 (store a_45 i12 e12)))
(assert (= a_47 (store a_46 i4 e4)))
(assert (= a_48 (store a_47 i34 e34)))
(assert (= a_49 (store a_48 i7 e7)))
(assert (= a_5 (store a_4 i6 e6)))
(assert (= a_50 (store a_49 i35 e35)))
(assert (= a_51 (store a_50 i22 e22)))
(assert (= a_52 (store a_51 i17 e17)))
(assert (= a_53 (store a_52 i37 e37)))
(assert (= a_54 (store a_53 i39 e39)))
(assert (= a_55 (store a_54 i29 e29)))
(assert (= a_56 (store a_55 i15 e15)))
(assert (= a_57 (store a_56 i11 e11)))
(assert (= a_58 (store a_57 i18 e18)))
(assert (= a_59 (store a_58 i38 e38)))
(assert (= a_6 (store a_5 i7 e7)))
(assert (= a_60 (store a_59 i14 e14)))
(assert (= a_61 (store a_60 i1 e1)))
(assert (= a_62 (store a_61 i24 e24)))
(assert (= a_63 (store a_62 i36 e36)))
(assert (= a_64 (store a_63 i21 e21)))
(assert (= a_65 (store a_64 i32 e32)))
(assert (= a_66 (store a_65 i30 e30)))
(assert (= a_67 (store a_66 i3 e3)))
(assert (= a_68 (store a_67 i9 e9)))
(assert (= a_69 (store a_68 i16 e16)))
(assert (= a_7 (store a_6 i8 e8)))
(assert (= a_70 (store a_69 i19 e19)))
(assert (= a_71 (store a_70 i13 e13)))
(assert (= a_72 (store a_71 i20 e20)))
(assert (= a_73 (store a_72 i10 e10)))
(assert (= a_74 (store a_73 i8 e8)))
(assert (= a_75 (store a_74 i40 e40)))
(assert (= a_76 (store a_75 i28 e28)))
(assert (= a_77 (store a_76 i26 e26)))
(assert (= a_78 (store a_77 i31 e31)))
(assert (= a_79 (store a_78 i2 e2)))
