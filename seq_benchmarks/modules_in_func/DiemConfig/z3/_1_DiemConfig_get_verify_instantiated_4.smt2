...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 253262) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t9@0 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'| $t8@1)) (= $t9@0 $t9@0)) (and (=> (= (ControlFlow 0 184025) (- 0 253703)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))) (=> (= (ControlFlow 0 184025) (- 0 253715)) (= $t9@0 (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) addr@@0)))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 183963) (- 0 253654)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (=> (= (ControlFlow 0 183963) (- 0 253661)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (= 5 $t7@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 184039) 183963))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $t8@1 $t8) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 184091) 184039) anon12_Then_correct) (=> (= (ControlFlow 0 184091) 184025) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (= (ControlFlow 0 184089) 184091)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816) (=> (and (and (= $t8@0 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (= $t8@1 $t8@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 183981) 184039) anon12_Then_correct) (=> (= (ControlFlow 0 183981) 184025) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t4@0 (and (=> (= (ControlFlow 0 183967) 184089) anon11_Then_correct) (=> (= (ControlFlow 0 183967) 183981) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t4@0) (= $t6 $t6)) (and (= $t7@0 $t6) (= (ControlFlow 0 183931) 183963))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (and (and (and (and (and (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106393| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address) (= config_address 173345816)))
 ...
 :skolemid |180|
))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) $a_0)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion''| $rsc))
 :qid |DiemConfigbpl.6601:20|
 :skolemid |181|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) $a_0))
))) (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t4@0 (|Select__T@[Int]Bool_| (|domain#$Memory_106525| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t6) (= $t6 5)) (and (= $t6 $t6) (= $t4@0 $t4@0))))) (and (=> (= (ControlFlow 0 183915) 183967) anon10_Then_correct) (=> (= (ControlFlow 0 183915) 183931) anon10_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_77118_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemConfigbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 183675) 183915)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 253262) 183675) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
