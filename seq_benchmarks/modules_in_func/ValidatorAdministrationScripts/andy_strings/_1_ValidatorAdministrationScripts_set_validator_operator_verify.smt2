...
(assert (not
 (=> (= (ControlFlow 0 0) 167208) (let ((inline$$1_ValidatorConfig_set_operator$0$anon21_Then_correct true))
(let ((anon11_Else_correct@@1  (=> (not $abort_flag@1@@1) (and (=> (= (ControlFlow 0 148599) (- 0 169329)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $t5@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $t5@@1))) (and (=> (= (ControlFlow 0 148599) (- 0 169341)) (not (not (= (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)) _$t1@@3)))) (=> (not (not (= (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)) _$t1@@3))) (and (=> (= (ControlFlow 0 148599) (- 0 169355)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3))) (and (=> (= (ControlFlow 0 148599) (- 0 169366)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3))) (and (=> (= (ControlFlow 0 148599) (- 0 169377)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t7@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t7@@2))) (and (=> (= (ControlFlow 0 148599) (- 0 169389)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t7@@2)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t7@@2)) 3))) (and (=> (= (ControlFlow 0 148599) (- 0 169407)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $t6@@3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $t6@@3))) (and (=> (= (ControlFlow 0 148599) (- 0 169419)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t9@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t9@@2))) (and (=> (= (ControlFlow 0 148599) (- 0 169431)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t9@@2)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t9@@2)) 3))) (and (=> (= (ControlFlow 0 148599) (- 0 169449)) (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@1@@1) $t8@@2)))) 0))) (=> (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@1@@1) $t8@@2)))) 0)) (and (=> (= (ControlFlow 0 148599) (- 0 169457)) (= (let ((t_ref@@42 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@1@@1) $t8@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@42)) 0)) _$t2@@3)) (=> (= (let ((t_ref@@43 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@1@@1) $t8@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@43)) 0)) _$t2@@3) (=> (= (ControlFlow 0 148599) (- 0 169468)) (forall ((addr@@145 Int) ) (!  (=> (|$IsValid'address'| addr@@145) (=> (not (= addr@@145 $t8@@2)) (= (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@1@@1) addr@@145)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@145)))))
 :qid |ValidatorAdministrationScriptsbpl.9380:15|
 :skolemid |344|
))))))))))))))))))))))))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon19_Then_correct true))
(let ((L3_correct@@1  (and (=> (= (ControlFlow 0 146971) (- 0 169042)) (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $t5@@1)) (not (= (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)) _$t1@@3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t7@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t7@@2)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $t6@@3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t9@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t9@@2)) 3)))) (=> (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $t5@@1)) (not (= (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)) _$t1@@3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t7@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t7@@2)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $t6@@3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t9@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t9@@2)) 3))) (=> (= (ControlFlow 0 146971) (- 0 169133)) (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $t5@@1)) (= 5 $t12@0)) (and (not (= (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)) _$t1@@3)) (= 0 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)) (= 7 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t7@@2)) (= 5 $t12@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t7@@2)) 3)) (= 3 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $t6@@3)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t9@@2)) (= 5 $t12@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t9@@2)) 3)) (= 3 $t12@0))) (= 0 $t12@0)) (= 7 $t12@0)) (= 5 $t12@0)) (= 3 $t12@0)))))))
(let ((anon11_Then_correct@@1  (=> (and (and $abort_flag@1@@1 (= $abort_code@2@@1 $abort_code@2@@1)) (and (= $t12@0 $abort_code@2@@1) (= (ControlFlow 0 148613) 146971))) L3_correct@@1)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon24_Else_correct  (=> (and (and (and (not $abort_flag@0@@1) (= inline$$1_ValidatorConfig_set_operator$0$$t23@1 ($Mutation_84138 (|l#$Mutation_84098| inline$$1_ValidatorConfig_set_operator$0$$t22@2) (seq.++ (|p#$Mutation_84098| inline$$1_ValidatorConfig_set_operator$0$$t22@2) (seq.unit 1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_84098| inline$$1_ValidatorConfig_set_operator$0$$t22@2))))) (and (= inline$$1_ValidatorConfig_set_operator$0$$t23@2 ($Mutation_84138 (|l#$Mutation_84138| inline$$1_ValidatorConfig_set_operator$0$$t23@1) (|p#$Mutation_84138| inline$$1_ValidatorConfig_set_operator$0$$t23@1) inline$$1_ValidatorConfig_set_operator$0$$t21@0)) (= inline$$1_ValidatorConfig_set_operator$0$$t22@3 ($Mutation_84098 (|l#$Mutation_84098| inline$$1_ValidatorConfig_set_operator$0$$t22@2) (|p#$Mutation_84098| inline$$1_ValidatorConfig_set_operator$0$$t22@2) ($1_ValidatorConfig_ValidatorConfig (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_84098| inline$$1_ValidatorConfig_set_operator$0$$t22@2)) (|v#$Mutation_84138| inline$$1_ValidatorConfig_set_operator$0$$t23@2) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_84098| inline$$1_ValidatorConfig_set_operator$0$$t22@2))))))) (and (and (= $1_ValidatorConfig_ValidatorConfig_$memory@0@@1 ($Memory_83469 (|Store__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_84098| inline$$1_ValidatorConfig_set_operator$0$$t22@3)) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_84098| inline$$1_ValidatorConfig_set_operator$0$$t22@3)) (|v#$Mutation_84098| inline$$1_ValidatorConfig_set_operator$0$$t22@3)))) (= $abort_code@2@@1 $abort_code@1@@1)) (and (= $abort_flag@1@@1 $abort_flag@0@@1) (= $1_ValidatorConfig_ValidatorConfig_$memory@1@@1 $1_ValidatorConfig_ValidatorConfig_$memory@0@@1)))) (and (=> (= (ControlFlow 0 148256) 148613) anon11_Then_correct@@1) (=> (= (ControlFlow 0 148256) 148599) anon11_Else_correct@@1)))))
(let ((inline$$1_ValidatorConfig_set_operator$0$L5_correct  (=> (= $abort_code@2@@1 inline$$1_ValidatorConfig_set_operator$0$$t13@1) (=> (and (= $abort_flag@1@@1 true) (= $1_ValidatorConfig_ValidatorConfig_$memory@1@@1 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (=> (= (ControlFlow 0 147973) 148613) anon11_Then_correct@@1) (=> (= (ControlFlow 0 147973) 148599) anon11_Else_correct@@1))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon24_Then_correct  (=> (and (and $abort_flag@0@@1 (= $abort_code@1@@1 $abort_code@1@@1)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t13@1 $abort_code@1@@1) (= (ControlFlow 0 148270) 147973))) inline$$1_ValidatorConfig_set_operator$0$L5_correct)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon23_Then$1_correct  (=> (= $abort_flag@0@@1 true) (=> (and (= $abort_code@1@@1 $EXEC_FAILURE_CODE) (= inline$$1_ValidatorConfig_set_operator$0$$t22@2 inline$$1_ValidatorConfig_set_operator$0$$t22@0)) (and (=> (= (ControlFlow 0 148322) 148270) inline$$1_ValidatorConfig_set_operator$0$anon24_Then_correct) (=> (= (ControlFlow 0 148322) 148256) inline$$1_ValidatorConfig_set_operator$0$anon24_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon23_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_set_operator$0$$t17@0)) (= (ControlFlow 0 148320) 148322)) inline$$1_ValidatorConfig_set_operator$0$anon23_Then$1_correct)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon23_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_set_operator$0$$t17@0) (=> (and (and (= inline$$1_ValidatorConfig_set_operator$0$$t22@1 ($Mutation_84098 ($Global inline$$1_ValidatorConfig_set_operator$0$$t17@0) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_set_operator$0$$t17@0))) (= $abort_flag@0@@1 false)) (and (= $abort_code@1@@1 $abort_code@0@@1) (= inline$$1_ValidatorConfig_set_operator$0$$t22@2 inline$$1_ValidatorConfig_set_operator$0$$t22@1))) (and (=> (= (ControlFlow 0 148202) 148270) inline$$1_ValidatorConfig_set_operator$0$anon24_Then_correct) (=> (= (ControlFlow 0 148202) 148256) inline$$1_ValidatorConfig_set_operator$0$anon24_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon22_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (=> (and (and (|$IsValid'$1_Option_Option'address''| inline$$1_ValidatorConfig_set_operator$0$$t21@0) (<= (seq.len (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_set_operator$0$$t21@0)) 1)) (= inline$$1_ValidatorConfig_set_operator$0$$t21@0 (|$1_Option_Option'address'| (seq.unit _$t2@@3)))) (and (=> (= (ControlFlow 0 148180) 148320) inline$$1_ValidatorConfig_set_operator$0$anon23_Then_correct) (=> (= (ControlFlow 0 148180) 148202) inline$$1_ValidatorConfig_set_operator$0$anon23_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon22_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= inline$$1_ValidatorConfig_set_operator$0$$t20@0 inline$$1_ValidatorConfig_set_operator$0$$t20@0)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t13@1 inline$$1_ValidatorConfig_set_operator$0$$t20@0) (= (ControlFlow 0 148152) 147973))) inline$$1_ValidatorConfig_set_operator$0$L5_correct)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon21_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_ValidatorConfig_set_operator$0$$t20@0) (= inline$$1_ValidatorConfig_set_operator$0$$t20@0 5)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t20@0 inline$$1_ValidatorConfig_set_operator$0$$t20@0) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 148136) 148180) inline$$1_ValidatorConfig_set_operator$0$anon22_Then_correct) (=> (= (ControlFlow 0 148136) 148152) inline$$1_ValidatorConfig_set_operator$0$anon22_Else_correct))))))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= inline$$1_ValidatorConfig_set_operator$0$$t17@0 inline$$1_ValidatorConfig_set_operator$0$$t17@0) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_set_operator$0$$t17@0)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 148094) 148336) inline$$1_ValidatorConfig_set_operator$0$anon21_Then_correct) (=> (= (ControlFlow 0 148094) 148136) inline$$1_ValidatorConfig_set_operator$0$anon21_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon20_Then_correct  (=> inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 (=> (and (and (|$IsValid'address'| inline$$1_ValidatorConfig_set_operator$0$$t17@0) (= inline$$1_ValidatorConfig_set_operator$0$$t17@0 (|$addr#$signer| _$t0@@3))) (and (= inline$$1_ValidatorConfig_set_operator$0$$t17@0 inline$$1_ValidatorConfig_set_operator$0$$t17@0) (= (ControlFlow 0 148100) 148094))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon20_Else_correct  (=> (and (and (not inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1) (= inline$$1_ValidatorConfig_set_operator$0$$t16@0 inline$$1_ValidatorConfig_set_operator$0$$t16@0)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t13@1 inline$$1_ValidatorConfig_set_operator$0$$t16@0) (= (ControlFlow 0 147967) 147973))) inline$$1_ValidatorConfig_set_operator$0$L5_correct)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon19_Else_correct  (=> (and (not false) (|$IsValid'u64'| 3)) (=> (and (and (|$IsValid'u64'| inline$$1_ValidatorConfig_set_operator$0$$t16@0) (= inline$$1_ValidatorConfig_set_operator$0$$t16@0 7)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t16@0 inline$$1_ValidatorConfig_set_operator$0$$t16@0) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1))) (and (=> (= (ControlFlow 0 147951) 148100) inline$$1_ValidatorConfig_set_operator$0$anon20_Then_correct) (=> (= (ControlFlow 0 147951) 147967) inline$$1_ValidatorConfig_set_operator$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct  (=> (= _$t2@@3 _$t2@@3) (=> (and (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1)) (and (=> (= (ControlFlow 0 147905) 148350) inline$$1_ValidatorConfig_set_operator$0$anon19_Then_correct) (=> (= (ControlFlow 0 147905) 147951) inline$$1_ValidatorConfig_set_operator$0$anon19_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon18_Else_correct  (=> (and (not inline$$1_ValidatorConfig_set_operator$0$$t12@0) (= (ControlFlow 0 147911) 147905)) inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon18_Then_correct  (=> inline$$1_ValidatorConfig_set_operator$0$$t12@0 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) inline$$1_ValidatorConfig_set_operator$0$$t11@0)) (= 5 inline$$1_ValidatorConfig_set_operator$0$$t13@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) inline$$1_ValidatorConfig_set_operator$0$$t11@0)) 3)) (= 3 inline$$1_ValidatorConfig_set_operator$0$$t13@0))) (= inline$$1_ValidatorConfig_set_operator$0$$t13@0 inline$$1_ValidatorConfig_set_operator$0$$t13@0)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t13@1 inline$$1_ValidatorConfig_set_operator$0$$t13@0) (= (ControlFlow 0 148402) 147973))) inline$$1_ValidatorConfig_set_operator$0$L5_correct))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon0_correct  (=> (and (= (seq.len (|p#$Mutation_84098| inline$$1_ValidatorConfig_set_operator$0$$t22@0)) 0) (= (seq.len (|p#$Mutation_84138| inline$$1_ValidatorConfig_set_operator$0$$t23@0)) 0)) (=> (and (and (and (= inline$$1_ValidatorConfig_set_operator$0$$t7@0 (|$addr#$signer| _$t0@@3)) (= inline$$1_ValidatorConfig_set_operator$0$$t8@0 (|$addr#$signer| _$t0@@3))) (and (= inline$$1_ValidatorConfig_set_operator$0$$t9@0 (|$addr#$signer| _$t0@@3)) (= inline$$1_ValidatorConfig_set_operator$0$$t10@0 (|$addr#$signer| _$t0@@3)))) (and (and (= _$t0@@3 _$t0@@3) (= _$t2@@3 _$t2@@3)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t11@0 (|$addr#$signer| _$t0@@3)) (= inline$$1_ValidatorConfig_set_operator$0$$t12@0  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) inline$$1_ValidatorConfig_set_operator$0$$t11@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) inline$$1_ValidatorConfig_set_operator$0$$t11@0)) 3))))))) (and (=> (= (ControlFlow 0 147800) 148402) inline$$1_ValidatorConfig_set_operator$0$anon18_Then_correct) (=> (= (ControlFlow 0 147800) 147911) inline$$1_ValidatorConfig_set_operator$0$anon18_Else_correct))))))
(let ((anon10_Then_correct  (=> (and $t13@0@@1 (= $t15@@2 (|$addr#$signer| _$t0@@3))) (=> (and (and (= $t16@@0 (|$addr#$signer| _$t0@@3)) (= $t17@@0 (|$addr#$signer| _$t0@@3))) (and (= $t18@@2 (|$addr#$signer| _$t0@@3)) (= (ControlFlow 0 148406) 147800))) inline$$1_ValidatorConfig_set_operator$0$anon0_correct))))
(let ((anon10_Else_correct  (=> (not $t13@0@@1) (=> (and (and (|$IsValid'u64'| 0) (= 0 0)) (and (= $t12@0 0) (= (ControlFlow 0 146651) 146971))) L3_correct@@1))))
(let ((anon9_Else_correct  (=> (not $t11@@2) (=> (and (and (|$IsValid'vec'u8''| $t10@@2) (= $t10@@2 (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)))) (and (= $t13@0@@1 (= $t10@@2 _$t1@@3)) (= $t13@0@@1 $t13@0@@1))) (and (=> (= (ControlFlow 0 146629) 148406) anon10_Then_correct) (=> (= (ControlFlow 0 146629) 146651) anon10_Else_correct))))))
(let ((anon9_Then_correct  (=> $t11@@2 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3)) (= 5 $t12@@2)) (= $t12@@2 $t12@@2)) (and (= $t12@0 $t12@@2) (= (ControlFlow 0 148641) 146971))) L3_correct@@1))))
(let ((anon0$1_correct@@3  (=> (and (and (forall ((addr@@146 Int) ) (!  (=> (|$IsValid'address'| addr@@146) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@146)) 0)) (= addr@@146 173345816)))
 :qid |ValidatorAdministrationScriptsbpl.9054:20|
 :skolemid |315|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@147 Int) ) (!  (=> (|$IsValid'address'| addr@@147) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@147)) 1)) (= addr@@147 186537453)))
 :qid |ValidatorAdministrationScriptsbpl.9062:20|
 :skolemid |316|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) 186537453)) 1))))) (=> (and (and (and (forall ((addr@@148 Int) ) (!  (=> (|$IsValid'address'| addr@@148) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@148)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@148)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@148)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@148)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.9070:20|
 :skolemid |317|
)) (forall ((addr@@149 Int) ) (!  (=> (|$IsValid'address'| addr@@149) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@149) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@149)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@149) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@149)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@149) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@149)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@149) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@149)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.9074:20|
 :skolemid |318|
))) (and (forall ((addr@@150 Int) ) (!  (=> (|$IsValid'address'| addr@@150) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@150) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@150)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@150) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@150)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@150) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@150)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@150) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@150)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.9078:20|
 :skolemid |319|
)) (forall ((addr@@151 Int) ) (!  (=> (|$IsValid'address'| addr@@151) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@151) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@151)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@151) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@151)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@151) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@151)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@151) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@151)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.9082:20|
 :skolemid |320|
)))) (and (and (forall ((addr@@152 Int) ) (!  (=> (|$IsValid'address'| addr@@152) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@152) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@152)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@152) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@152)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@152) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@152)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@152) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@152)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.9086:20|
 :skolemid |321|
)) (forall ((addr@@153 Int) ) (!  (=> (|$IsValid'address'| addr@@153) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@153) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@153)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@153) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@153)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@153) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@153)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@153) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@153)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.9090:20|
 :skolemid |322|
))) (and (forall ((addr@@154 Int) ) (!  (=> (|$IsValid'address'| addr@@154) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@154) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@154)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@154) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@154)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@154) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@154)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@154) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@154)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.9094:20|
 :skolemid |323|
)) (forall ((addr@@155 Int) ) (!  (=> (|$IsValid'address'| addr@@155) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@155) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@155) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@155)) 4))))
 :qid |ValidatorAdministrationScriptsbpl.9098:20|
 :skolemid |324|
))))) (=> (and (and (and (and (forall ((addr@@156 Int) ) (!  (=> (|$IsValid'address'| addr@@156) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@156) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@156) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@156)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.9102:20|
 :skolemid |325|
)) (forall ((addr@@157 Int) ) (!  (=> (|$IsValid'address'| addr@@157) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@157) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@157) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@157)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.9106:20|
 :skolemid |326|
))) (and (forall ((addr@@158 Int) ) (!  (=> (|$IsValid'address'| addr@@158) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@158) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@158)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@158) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@158)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.9110:20|
 :skolemid |327|
)) (let (($range_0@@40 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@159 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@159))))))))
(forall (($i_1@@40 Int) ) (!  (=> ($InRange $range_0@@40 $i_1@@40) (let ((i1@@5 $i_1@@40))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@160 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@160)))) i1@@5))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@160 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@160)))) i1@@5)))) 3))))
 :qid |ValidatorAdministrationScriptsbpl.9114:151|
 :skolemid |328|
))))) (and (and (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_97836| $1_DualAttestation_Credential_$memory) addr1@@2) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr1@@2)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr1@@2)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.9119:20|
 :skolemid |329|
)) (forall ((addr@@161 Int) ) (!  (=> (|$IsValid'address'| addr@@161) (= (|Select__T@[Int]Bool_| (|domain#$Memory_99483| $1_DiemAccount_DiemAccount_$memory) addr@@161) (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@161)))
 :qid |ValidatorAdministrationScriptsbpl.9123:20|
 :skolemid |330|
))) (and (forall ((addr@@162 Int) ) (!  (=> (|$IsValid'address'| addr@@162) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97281| $1_VASPDomain_VASPDomainManager_$memory) addr@@162)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@162) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@162)) 1))))
 :qid |ValidatorAdministrationScriptsbpl.9127:20|
 :skolemid |331|
)) (forall ((addr@@163 Int) ) (!  (=> (|$IsValid'address'| addr@@163) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97380| $1_VASPDomain_VASPDomains_$memory) addr@@163)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@163) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@163)) 5))))
 :qid |ValidatorAdministrationScriptsbpl.9131:20|
 :skolemid |332|
))))) (and (and (and (forall ((addr@@164 Int) ) (!  (=> (|$IsValid'address'| addr@@164) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_100248| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@164) (|Select__T@[Int]Bool_| (|domain#$Memory_100339| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@164)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@164) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@164)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@164) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@164)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@164) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@164)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.9135:20|
 :skolemid |333|
)) (forall ((addr@@165 Int) ) (!  (=> (|$IsValid'address'| addr@@165) (= (|Select__T@[Int]Bool_| (|domain#$Memory_98755| $1_DesignatedDealer_Dealer_$memory) addr@@165)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@165) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@165)) 2))))
 :qid |ValidatorAdministrationScriptsbpl.9139:20|
 :skolemid |334|
))) (and (forall ((addr@@166 Int) ) (!  (=> (|$IsValid'address'| addr@@166) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97836| $1_DualAttestation_Credential_$memory) addr@@166)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@166) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@166)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@166) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@166)) 5)))))
 :qid |ValidatorAdministrationScriptsbpl.9143:20|
 :skolemid |335|
)) (forall ((addr@@167 Int) ) (!  (=> (|$IsValid'address'| addr@@167) (= (|Select__T@[Int]Bool_| (|domain#$Memory_85237| $1_SlidingNonce_SlidingNonce_$memory) addr@@167)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@167) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@167)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@167) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@167)) 1)))))
 :qid |ValidatorAdministrationScriptsbpl.9147:20|
 :skolemid |336|
)))) (and (and (forall ((addr@@168 Int) ) (!  (=> (|$IsValid'address'| addr@@168) (= (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@168)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@168) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@168)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.9151:20|
 :skolemid |337|
)) (forall ((addr@@169 Int) ) (!  (=> (|$IsValid'address'| addr@@169) (= (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@169)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@169) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@169)) 4))))
 :qid |ValidatorAdministrationScriptsbpl.9155:20|
 :skolemid |338|
))) (and (forall ((addr@@170 Int) ) (!  (=> (|$IsValid'address'| addr@@170) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97477| $1_VASP_ParentVASP_$memory) addr@@170)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@170) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@170)) 5))))
 :qid |ValidatorAdministrationScriptsbpl.9159:20|
 :skolemid |339|
)) (forall ((addr@@171 Int) ) (!  (=> (|$IsValid'address'| addr@@171) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97413| $1_VASP_ChildVASP_$memory) addr@@171)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@171) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@171)) 6))))
 :qid |ValidatorAdministrationScriptsbpl.9163:20|
 :skolemid |340|
)))))) (=> (and (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@3)) ($1_Signer_is_txn_signer _$t0@@3)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@3))) (|$IsValid'vec'u8''| _$t1@@3)) (and (|$IsValid'address'| _$t2@@3) (forall (($a_0@@23 Int) ) (! (let (($rsc@@23 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $a_0@@23)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@23))
 :qid |ValidatorAdministrationScriptsbpl.9175:20|
 :skolemid |341|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $a_0@@23))
)))) (and (and (forall (($a_0@@24 Int) ) (! (let (($rsc@@24 (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0@@24)))
(|$IsValid'$1_ValidatorOperatorConfig_ValidatorOperatorConfig'| $rsc@@24))
 :qid |ValidatorAdministrationScriptsbpl.9179:20|
 :skolemid |342|
 :pattern ( (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0@@24))
)) (forall (($a_0@@25 Int) ) (! (let (($rsc@@25 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@25)))
 ...
 :qid |ValidatorAdministrationScriptsbpl.9183:20|
 :skolemid |343|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@25))
))) (and (= $t5@@1 (|$addr#$signer| _$t0@@3)) (= $t6@@3 (|$addr#$signer| _$t0@@3))))) (and (and (and (= $t7@@2 (|$addr#$signer| _$t0@@3)) (= $t8@@2 (|$addr#$signer| _$t0@@3))) (and (= $t9@@2 (|$addr#$signer| _$t0@@3)) (let ((addr@@172 (|$addr#$signer| _$t0@@3)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_99483| $1_DiemAccount_DiemAccount_$memory) addr@@172)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_99003| $1_AccountFreezing_FreezingBit_$memory) addr@@172) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_99003| $1_AccountFreezing_FreezingBit_$memory) addr@@172)))))))) (and (and (= _$t0@@3 _$t0@@3) (= _$t1@@3 _$t1@@3)) (and (= _$t2@@3 _$t2@@3) (= $t11@@2  (not (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t2@@3))))))) (and (=> (= (ControlFlow 0 146597) 148641) anon9_Then_correct) (=> (= (ControlFlow 0 146597) 146629) anon9_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@3  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@14 T@$1_Event_EventHandle) ) (! (let ((stream@@16 (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| $es) handle@@14)))
 (and (= (|l#Multiset_54442| stream@@16) 0) (forall ((v@@68 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| stream@@16) v@@68) 0)
 :qid |ValidatorAdministrationScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |ValidatorAdministrationScriptsbpl.2552:13|
 :skolemid |69|
))) (= (ControlFlow 0 145681) 146597)) anon0$1_correct@@3)))
(let ((anon0_correct@@3  (=> (= (ControlFlow 0 167208) 145681) inline$$InitEventStore$0$anon0_correct@@3)))
anon0_correct@@3))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
