...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1087700) (let ((anon15_Else_correct  (=> (not $abort_flag@7) (and (=> (= (ControlFlow 0 727322) (- 0 1091816)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 727322) (- 0 1091829)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))) (and (=> (= (ControlFlow 0 727322) (- 0 1091840)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))) (and (=> (= (ControlFlow 0 727322) (- 0 1091851)) (not (let (($range_0 ($Range 0 (|l#Vec_276448| $t7))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@95 $i_1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t7) i@@95)))) _$t2))))
 :qid |Diembpl.12777:57|
 :skolemid |586|
))))) (=> (not (let (($range_0@@0 ($Range 0 (|l#Vec_276448| $t7))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@96 $i_1@@0))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t7) i@@96)))) _$t2))))
 :qid |Diembpl.12777:57|
 :skolemid |586|
)))) (and (=> (= (ControlFlow 0 727322) (- 0 1091898)) (not (= $t8 0))) (=> (not (= $t8 0)) (and (=> (= (ControlFlow 0 727322) (- 0 1091909)) (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t9) $t8))) (=> (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t9) $t8)) (and (=> (= (ControlFlow 0 727322) (- 0 1091922)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t9) $t8))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t9) $t8)) (and (=> (= (ControlFlow 0 727322) (- 0 1091935)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 727322) (- 0 1091945)) (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t10))))) (=> (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t10)))) (and (=> (= (ControlFlow 0 727322) (- 0 1091968)) (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t10))))) (=> (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t10)))) (and (=> (= (ControlFlow 0 727322) (- 0 1091991)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) _$t1))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) _$t1)) (and (=> (= (ControlFlow 0 727322) (- 0 1092004)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 727322) (- 0 1092024)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@0))))
 ...
 :qid |Diembpl.12823:15|
 :skolemid |587|
)) (and (=> (= (ControlFlow 0 727322) (- 0 1092053)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@2)))
 ...
 :qid |Diembpl.12828:15|
 :skolemid |588|
)) (and (=> (= (ControlFlow 0 727322) (- 0 1092078)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4))))
 ...
 :qid |Diembpl.12833:15|
 :skolemid |589|
)) (and (=> (= (ControlFlow 0 727322) (- 0 1092107)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6)))
 ...
 :qid |Diembpl.12838:15|
 :skolemid |590|
)) (and (=> (= (ControlFlow 0 727322) (- 0 1092132)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 727322) (- 0 1092152)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) addr@@8))))
 ...
 :qid |Diembpl.12848:15|
 :skolemid |591|
)) (and (=> (= (ControlFlow 0 727322) (- 0 1092187)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) addr@@10)))
...
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t13)))
(let ((stream_new (let ((len (|l#Multiset_275813| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@0) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12 _$t1)))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@0) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12 _$t1)) (+ cnt 1)) (+ len 1))))))
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t13)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_275813| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@1) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12 _$t1)))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@1) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12 _$t1)) (+ cnt@@0 1)) (+ len@@0 1))))))
...
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t13)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_275813| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@2) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12 _$t1)))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@2) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12 _$t1)) (+ cnt@@1 1)) (+ len@@1 1))))))
...
(let ((L3_correct  (and (=> (= (ControlFlow 0 722365) (- 0 1091540)) (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))) (let (($range_0@@1 ($Range 0 (|l#Vec_276448| $t7))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@97 $i_1@@1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t7) i@@97)))) _$t2))))
 :qid |Diembpl.12880:283|
 :skolemid |593|
)))) (= $t8 0)) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t9) $t8)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t9) $t8)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))) (let (($range_0@@2 ($Range 0 (|l#Vec_276448| $t7))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@98 $i_1@@2))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t7) i@@98)))) _$t2))))
 :qid |Diembpl.12880:283|
 :skolemid |593|
)))) (= $t8 0)) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t9) $t8)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t9) $t8)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 722365) (- 0 1091643)) (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t18@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)) (= 5 $t18@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)) (= 5 $t18@0))) (and (let (($range_0@@3 ($Range 0 (|l#Vec_276448| $t7))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@99 $i_1@@3))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t7) i@@99)))) _$t2))))
 :qid |Diembpl.12885:368|
 :skolemid |594|
))) (= 1 $t18@0))) (and (= $t8 0) (= 1 $t18@0))) (and (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t9) $t8) (= 8 $t18@0))) (and (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t9) $t8) (= 8 $t18@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t18@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@7 (= $abort_code@8 $abort_code@8)) (and (= $t18@0 $abort_code@8) (= (ControlFlow 0 727336) 722365))) L3_correct)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|  (=> (= $abort_code@8 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1|) (=> (and (and (= $es@5 $es@4) (= |$1_Diem_CurrencyInfo'#0'_$memory@7| |$1_Diem_CurrencyInfo'#0'_$memory@6|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@4| |$1_Diem_PreburnQueue'#0'_$memory@3|) (= $abort_flag@7 true))) (and (=> (= (ControlFlow 0 726680) 727336) anon15_Then_correct) (=> (= (ControlFlow 0 726680) 727322) anon15_Else_correct))))))
...
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon10_Then_correct|  (=> (and (and (and |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0| (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)) (= 5 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)) (and (let ((|inline$$1_Diem_burn_with_capability'#0'$0$$range_0| ($Range 0 (|l#Vec_276448| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|))))
...
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Else_correct|  (=> (not inline$$Not$0$dst@1) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_335624 (|Store__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)))) (= $es@2 $es)) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@4| |$1_Diem_CurrencyInfo'#0'_$memory@1|) (= (ControlFlow 0 726265) 726279))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|))))
...
(let ((|inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| (|v#$Mutation_306796| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1|)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_275813| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@3) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1|))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@3) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1|) (+ cnt@@2 1)) (+ len@@2 1))))))
...
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= $abort_flag@3 $abort_flag@2)) (and (= $abort_code@4 $abort_code@3) (= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|))) (and (=> (= (ControlFlow 0 725659) 726460) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 725659) 725860) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|)))))
...
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|  (=> (and (not $abort_flag@2) (= (ControlFlow 0 725534) 725528)) inline$$Ge$0$anon0_correct)))
...
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 725474) 726474) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 725474) 725534) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|))))))
...
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$CastU128$0$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|))) (and (=> (= (ControlFlow 0 725424) 726474) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 725424) 725534) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|  (=> (and (and (not $abort_flag@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t34@1| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))) (and (=> (= (ControlFlow 0 725480) 725472) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 725480) 725424) inline$$CastU128$0$anon3_Else_correct)))))
...
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then$1_correct|  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0|)) (and (=> (= (ControlFlow 0 726540) 726488) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 726540) 725480) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|))))))
...
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Then_correct|  (=> inline$$Gt$0$dst@1 (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1| ($Mutation_401271 (|l#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (let ((l@@2 (|l#Vec_28308| (|p#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)) l@@2 0) (+ l@@2 1))) (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1| (|v#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2| ($Mutation_401271 (|l#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|) (|p#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|) |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Diem'#0''@1|)) (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)))) (=> (and (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)) (|$IsValid'$1_Diem_Diem'#0''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|)) (and (= (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|) (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1|)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)) 0))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1| ($Mutation_376858 (|l#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (|p#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (|$1_Diem_Preburn'#0'| (|v#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 725293) 726566) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Then_correct|) (=> (= (ControlFlow 0 725293) 725307) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Else_correct|)))))))
...
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else$1_correct|  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| 1)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 725173) 725293) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Then_correct|) (=> (= (ControlFlow 0 725173) 725189) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Else_correct|))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t22@1| 0)) (= (ControlFlow 0 725137) 725173)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else_correct|  (=> (and (and (and (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0|) (|$IsValid'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0|)) (and (|$IsEqual'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0|))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t21@1| (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t22@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t21@1|))) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 725143) 725137)))) inline$$Gt$0$anon0_correct)))
...
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon0_correct|  (=> (and (= (|l#Vec_28308| (|p#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@0|)) 0) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t6@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t7@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t8@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t9@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t10@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t8@0|))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t12@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= _$t1 _$t1))) (and (and (= $t19@1 $t19@1) (= _$t2 _$t2)) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0|  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$$range_0@@0| ($Range 0 (|l#Vec_276448| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|))))
...
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= $t20 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (and (and (and (= $t21 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t22 (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t20))) (and (= $t23 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= $t24 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1))))) (and (and (= $t25 (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t23))) (= $t26 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t27 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= (ControlFlow 0 726791) 723475)))) |inline$$1_Diem_burn_with_capability'#0'$0$anon0_correct|))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t18@0 $abort_code@1) (= (ControlFlow 0 727350) 722365))) L3_correct)))
(let ((anon13_Then$1_correct  (=> (= $t19@1 $t19) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 727402) 727350) anon14_Then_correct) (=> (= (ControlFlow 0 727402) 726791) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t14)) (= (ControlFlow 0 727400) 727402)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t14) (=> (and (and (= $t19@0 (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t14)) (= $t19@1 $t19@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 722385) 727350) anon14_Then_correct) (=> (= (ControlFlow 0 722385) 726791) anon14_Else_correct))))))
(let ((anon12_Then_correct  (=> $t15@0 (and (=> (= (ControlFlow 0 722371) 727400) anon13_Then_correct) (=> (= (ControlFlow 0 722371) 722385) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not $t15@0) (= $t17 $t17)) (and (= $t18@0 $t17) (= (ControlFlow 0 722071) 722365))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 ...
 :skolemid |581|
))) (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (|$IsValid'address'| _$t1))) (and (and (and (|$IsValid'u64'| _$t2) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $a_0)))
...
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@1)))
...
)))) (and (and (= $t6 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= $t7 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1)))) (and (= $t8 (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t6))) (= $t9 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (and (and (and (= $t10 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= $t11 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t12 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t13 (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t11)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= _$t2 _$t2) (|$IsValid'address'| $t14)))) (and (and (and (= $t14 (|$addr#$signer| _$t0)) (= $t14 $t14)) (and (= $t15@0 (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t14)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t17) (= $t17 4)) (and (= $t17 $t17) (= $t15@0 $t15@0)))))) (and (=> (= (ControlFlow 0 722055) 722371) anon12_Then_correct) (=> (= (ControlFlow 0 722055) 722071) anon12_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 721135) 722055)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1087700) 721135) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
