...
(assert (not
 (=> (= (ControlFlow 0 0) 216096) (let ((L2_correct@@0  (and (=> (= (ControlFlow 0 157325) (- 0 216674)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (= (ControlFlow 0 157325) (- 0 216679)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t2@0)))))))
(let ((anon7_Then_correct@@1  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= $t2@0 $abort_code@1@@0) (= (ControlFlow 0 157297) 157325))) L2_correct@@0)))
(let ((anon6_Then_correct@@1  (=> $t1@@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t2)) (= $t2 $t2)) (and (= $t2@0 $t2) (= (ControlFlow 0 157351) 157325))) L2_correct@@0))))
...
(let ((inline$$Div$0$anon3_Then$1_correct  (=> (= $abort_flag@0@@0 true) (=> (and (= $abort_code@1@@0 $EXEC_FAILURE_CODE) (= inline$$Div$0$dst@2 inline$$Div$0$dst@0)) (and (=> (= (ControlFlow 0 157235) 157297) anon7_Then_correct@@1) (=> (= (ControlFlow 0 157235) 157283) anon7_Else_correct@@1))))))
(let ((inline$$Div$0$anon3_Then_correct  (=> (and (= 1000000 0) (= (ControlFlow 0 157233) 157235)) inline$$Div$0$anon3_Then$1_correct)))
(let ((inline$$Div$0$anon3_Else_correct  (=> (not (= 1000000 0)) (=> (and (and (= inline$$Div$0$dst@1 (div $t0@@0 1000000)) (= $abort_flag@0@@0 false)) (and (= $abort_code@1@@0 $abort_code@0@@0) (= inline$$Div$0$dst@2 inline$$Div$0$dst@1))) (and (=> (= (ControlFlow 0 157185) 157297) anon7_Then_correct@@1) (=> (= (ControlFlow 0 157185) 157283) anon7_Else_correct@@1))))))
