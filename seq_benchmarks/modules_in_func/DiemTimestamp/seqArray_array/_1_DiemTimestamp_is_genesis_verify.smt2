...
(assert (not
 (=> (= (ControlFlow 0 0) 215560) (let ((anon0$2_correct  (=> (and (= inline$$Not$0$dst@1@@0 inline$$Not$0$dst@1@@0) (= (ControlFlow 0 156205) (- 0 215676))) (not false))))
(let ((inline$$Not$0$anon0_correct@@0  (=> (and (= inline$$Not$0$dst@1@@0  (not $t1@0)) (= (ControlFlow 0 156183) 156205)) anon0$2_correct)))
(let ((anon0$1_correct@@1  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@1)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@1))
 :qid |DiemTimestampbpl.3711:20|
 :skolemid |123|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@1))
)) (|$IsValid'address'| 173345816)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (ControlFlow 0 156189) 156183))) inline$$Not$0$anon0_correct@@0))))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@3 T@$1_Event_EventHandle) ) (! (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_65544_| (|streams#$EventStore| $es) handle@@3)))
 (and (= (|l#Multiset_65544| stream@@2) 0) (forall ((v@@42 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_65544| stream@@2) v@@42) 0)
 :qid |DiemTimestampbpl.159:13|
 :skolemid |4|
))))
 :qid |DiemTimestampbpl.2406:13|
 :skolemid |84|
))) (= (ControlFlow 0 156091) 156189)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 215560) 156091) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1))))))
))
(check-sat)
(pop 1)
