...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 196169) (let ((anon0$2_correct  (=> (and (= inline$$Not$0$dst@1 inline$$Not$0$dst@1) (= (ControlFlow 0 142437) (- 0 196285))) (not false))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t1@0)) (= (ControlFlow 0 142415) 142437)) anon0$2_correct)))
...
)) (|$IsValid'address'| 173345816)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_91217| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (ControlFlow 0 142421) 142415))) inline$$Not$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_62542_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTimestampbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 142323) 142421)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 196169) 142323) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))
))
(check-sat)
(pop 1)
