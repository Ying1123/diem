...
(assert (not
 (=> (= (ControlFlow 0 0) 308373) (let ((anon12_Else_correct@@5  (=> (not $abort_flag@0@@6) (=> (and (= $t9@0@@0 (|$micro_xdx_limit#$1_DualAttestation_Limit| $t8@1)) (= $t9@0@@0 $t9@0@@0)) (and (=> (= (ControlFlow 0 229230) (- 0 308672)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816))) (=> (= (ControlFlow 0 229230) (- 0 308682)) (= $t9@0@@0 (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816))))))))))
(let ((L3_correct@@5  (and (=> (= (ControlFlow 0 229164) (- 0 308627)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (=> (= (ControlFlow 0 229164) (- 0 308632)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (= 5 $t6@0@@4)))))))
(let ((anon12_Then_correct@@5  (=> (and (and $abort_flag@0@@6 (= $abort_code@1@@6 $abort_code@1@@6)) (and (= $t6@0@@4 $abort_code@1@@6) (= (ControlFlow 0 229244) 229164))) L3_correct@@5)))
(let ((anon11_Then$1_correct@@4  (=> (= $t8@1 $t8@@6) (=> (and (= $abort_flag@0@@6 true) (= $abort_code@1@@6 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 229296) 229244) anon12_Then_correct@@5) (=> (= (ControlFlow 0 229296) 229230) anon12_Else_correct@@5))))))
(let ((anon11_Then_correct@@4  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (= (ControlFlow 0 229294) 229296)) anon11_Then$1_correct@@4)))
(let ((anon11_Else_correct@@4  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816) (=> (and (and (= $t8@0@@7 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (= $t8@1 $t8@0@@7)) (and (= $abort_flag@0@@6 false) (= $abort_code@1@@6 $abort_code@0@@6))) (and (=> (= (ControlFlow 0 229188) 229244) anon12_Then_correct@@5) (=> (= (ControlFlow 0 229188) 229230) anon12_Else_correct@@5))))))
(let ((anon10_Then_correct@@4  (=> (and $t3@0@@7 (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 229174) 229294) anon11_Then_correct@@4) (=> (= (ControlFlow 0 229174) 229188) anon11_Else_correct@@4)))))
(let ((anon10_Else_correct@@4  (=> (and (and (not $t3@0@@7) (= $t5@@5 $t5@@5)) (and (= $t6@0@@4 $t5@@5) (= (ControlFlow 0 229136) 229164))) L3_correct@@5)))
(let ((anon0$1_correct@@15  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (=> (and (and (and (forall (($a_0@@40 Int) ) (! (let (($rsc@@40 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) $a_0@@40)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc@@40))
 :qid |DualAttestationbpl.15220:20|
 :skolemid |340|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) $a_0@@40))
)) (|$IsValid'address'| 173345816)) (and (= $t3@0@@7 (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t5@@5) (= $t5@@5 5)) (and (= $t5@@5 $t5@@5) (= $t3@0@@7 $t3@0@@7)))) (and (=> (= (ControlFlow 0 229120) 229174) anon10_Then_correct@@4) (=> (= (ControlFlow 0 229120) 229136) anon10_Else_correct@@4))))))
(let ((inline$$InitEventStore$0$anon0_correct@@15  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@17 T@$1_Event_EventHandle) ) (! (let ((stream@@16 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@17)))
 (and (= (|l#Multiset_86488| stream@@16) 0) (forall ((v@@59 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@16) v@@59) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 229026) 229120)) anon0$1_correct@@15)))
(let ((anon0_correct@@15  (=> (= (ControlFlow 0 308373) 229026) inline$$InitEventStore$0$anon0_correct@@15)))
anon0_correct@@15))))))))))))
))
(check-sat)
(pop 1)
