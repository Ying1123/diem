...
(declare-fun $t14@1 () T@$Mutation_132213)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t24@1 () T@$Mutation_13929)
(declare-fun _$t2 () Int)
(declare-fun $t14@2 () T@$Mutation_132213)
(declare-fun $1_DiemTimestamp_CurrentTimeMicroseconds_$memory () T@$Memory_131694)
(declare-fun $1_DualAttestation_Limit_$memory () T@$Memory_133171)
(declare-fun $1_DiemTimestamp_CurrentTimeMicroseconds_$memory@0 () T@$Memory_131694)
...
(declare-fun $t14 () T@$Mutation_132213)
(declare-fun $t14@0 () T@$Mutation_132213)
...
(declare-fun $t7 () T@$Mutation_132213)
...
(declare-fun $1_DualAttestation_Credential_$memory () T@$Memory_135596)
(declare-fun $1_Roles_RoleId_$memory@1@@0 () T@$Memory_133552)
(declare-fun _$t0@@1 () T@$signer)
(declare-fun _$t1@@0 () Int)
(declare-fun $t10@0 () Int)
(declare-fun $abort_code@1@@0 () Int)
(declare-fun $1_Roles_RoleId_$memory@0@@0 () T@$Memory_133552)
...
(declare-fun $1_Roles_RoleId_$memory@2@@0 () T@$Memory_133552)
(declare-fun |$temp_0'bool'@0@@0| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@1 () T@$Memory_133552)
(declare-fun $1_Roles_RoleId_$memory@0@@1 () T@$Memory_133552)
...
(declare-fun $1_Roles_RoleId_$memory@2@@1 () T@$Memory_133552)
(declare-fun |$temp_0'bool'@0@@1| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@2 () T@$Memory_133552)
(declare-fun $1_Roles_RoleId_$memory@0@@2 () T@$Memory_133552)
...
(declare-fun $1_Roles_RoleId_$memory@2@@2 () T@$Memory_133552)
(declare-fun |$temp_0'bool'@0@@2| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@3 () T@$Memory_133552)
(declare-fun $1_Roles_RoleId_$memory@0@@3 () T@$Memory_133552)
...
(declare-fun $1_Roles_RoleId_$memory@2@@3 () T@$Memory_133552)
(declare-fun |$temp_0'bool'@0@@3| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@4 () T@$Memory_133552)
(declare-fun $1_Roles_RoleId_$memory@0@@4 () T@$Memory_133552)
...
(declare-fun $1_Roles_RoleId_$memory@2@@4 () T@$Memory_133552)
(declare-fun |$temp_0'bool'@0@@4| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@5 () T@$Memory_133552)
(declare-fun $1_Roles_RoleId_$memory@0@@5 () T@$Memory_133552)
...
(declare-fun $1_Roles_RoleId_$memory@2@@5 () T@$Memory_133552)
(declare-fun |$temp_0'bool'@0@@5| () Bool)
(declare-fun $1_Roles_RoleId_$memory@1@@6 () T@$Memory_133552)
(declare-fun $1_Roles_RoleId_$memory@0@@6 () T@$Memory_133552)
...
(declare-fun $1_DualAttestation_Limit_$memory@1 () T@$Memory_133171)
(declare-fun _$t0@@8 () T@$signer)
(declare-fun $t6@@6 () Int)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory| () T@$Memory_152871)
...
(declare-fun $1_DualAttestation_Limit_$memory@0 () T@$Memory_133171)
...
(declare-fun $1_DiemConfig_Configuration_$memory () T@$Memory_147257)
(declare-fun |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory| () T@$Memory_146867)
(declare-fun |$1_Diem_Preburn'$1_XUS_XUS'_$memory| () T@$Memory_159212)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory| () T@$Memory_152807)
(declare-fun |$1_Diem_Preburn'$1_XDX_XDX'_$memory| () T@$Memory_159293)
(declare-fun |$1_Diem_Preburn'#0'_$memory| () T@$Memory_159374)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory| () T@$Memory_153007)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory| () T@$Memory_159624)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory| () T@$Memory_159741)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory| () T@$Memory_159858)
(declare-fun $1_XDX_Reserve_$memory () T@$Memory_169399)
(declare-fun |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory| () T@$Memory_166895)
; Valid
(declare-fun $abort_flag@0@@2 () Bool)
(declare-fun $t8@0@@0 () T@Vec_29042)
...
(declare-fun $1_VASP_ParentVASP_$memory () T@$Memory_171117)
(declare-fun $1_VASP_ChildVASP_$memory () T@$Memory_171053)
(declare-fun |Select__T@[Int]$1_VASP_ChildVASP_| (|T@[Int]$1_VASP_ChildVASP| Int) T@$1_VASP_ChildVASP)
(declare-fun _$t3 () T@Vec_29042)
...
; Valid
(declare-fun _$t4@@0 () T@Vec_29042)
...
(declare-fun _$t3@@0 () T@Vec_29042)
...
(assert (not
 (=> (= (ControlFlow 0 0) 328886) (let ((L8_correct@@1  (and (=> (= (ControlFlow 0 242975) (- 0 330003)) (or (or (or (or (or (or (and (= (|l#Vec_29042| _$t4@@0) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (and (= (|l#Vec_29042| _$t4@@0) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (= (|l#Vec_29042| _$t4@@0) 0) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) 18446744073709551615))) (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (= (|l#Vec_29042| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0))) (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (= (|l#Vec_29042| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0))) (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (not (let ((payee_compliance_key@@6 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))))
 (and (and (= (|l#Vec_29042| _$t4@@0) 64) (not (= (|l#Vec_29042| payee_compliance_key@@6) 0))) ($1_Signature_$ed25519_verify _$t4@@0 payee_compliance_key@@6 ($1_DualAttestation_spec_dual_attestation_message _$t0@@11 _$t3@@0 _$t2@@1))))))) (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))))) (=> (or (or (or (or (or (or (and (= (|l#Vec_29042| _$t4@@0) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (and (= (|l#Vec_29042| _$t4@@0) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (= (|l#Vec_29042| _$t4@@0) 0) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) 18446744073709551615))) (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (= (|l#Vec_29042| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0))) (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (= (|l#Vec_29042| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0))) (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (not (let ((payee_compliance_key@@7 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))))
 (and (and (= (|l#Vec_29042| _$t4@@0) 64) (not (= (|l#Vec_29042| payee_compliance_key@@7) 0))) ($1_Signature_$ed25519_verify _$t4@@0 payee_compliance_key@@7 ($1_DualAttestation_spec_dual_attestation_message _$t0@@11 _$t3@@0 _$t2@@1))))))) (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8))))) (=> (= (ControlFlow 0 242975) (- 0 330191)) (or (or (or (or (or (or (and (and (= (|l#Vec_29042| _$t4@@0) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (= 5 $t8@0@@2)) (and (and (= (|l#Vec_29042| _$t4@@0) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= 5 $t8@0@@2))) (and (and (= (|l#Vec_29042| _$t4@@0) 0) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) 18446744073709551615)) (= 8 $t8@0@@2))) (and (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (= (|l#Vec_29042| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0)) (= 1 $t8@0@@2))) (and (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (= (|l#Vec_29042| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0)) (= 1 $t8@0@@2))) (and (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (not (let ((payee_compliance_key@@8 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))))
 (and (and (= (|l#Vec_29042| _$t4@@0) 64) (not (= (|l#Vec_29042| payee_compliance_key@@8) 0))) ($1_Signature_$ed25519_verify _$t4@@0 payee_compliance_key@@8 ($1_DualAttestation_spec_dual_attestation_message _$t0@@11 _$t3@@0 _$t2@@1)))))) (= 7 $t8@0@@2))) (and (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) (= 5 $t8@0@@2))))))))
(let ((anon18_Then_correct@@0  (=> $t14@@2 (=> (and (and (or (or (or (and (= (|l#Vec_29042| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0) (= 1 $t8@@6)) (and (= (|l#Vec_29042| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0) (= 1 $t8@@6))) (and (not (let ((payee_compliance_key@@9 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))))
 (and (and (= (|l#Vec_29042| _$t4@@0) 64) (not (= (|l#Vec_29042| payee_compliance_key@@9) 0))) ($1_Signature_$ed25519_verify _$t4@@0 payee_compliance_key@@9 ($1_DualAttestation_spec_dual_attestation_message _$t0@@11 _$t3@@0 _$t2@@1))))) (= 7 $t8@@6))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8))) (= 5 $t8@@6))) (= $t8@@6 $t8@@6)) (and (= $t8@0@@2 $t8@@6) (= (ControlFlow 0 242419) 242975))) L8_correct@@1))))
(let ((anon16_Then_correct@@1  (=> $t13@@0 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (= 5 $t8@@6)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t8@@6))) (and (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t11@@1) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t11@@1) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t11@@1) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) 18446744073709551615) (= 8 $t8@@6))) (= $t8@@6 $t8@@6)) (and (= $t8@0@@2 $t8@@6) (= (ControlFlow 0 243037) 242975))) L8_correct@@1))))
(let ((L6_correct@@0  (and (=> (= (ControlFlow 0 242223) (- 0 329778)) (not (and (= (|l#Vec_29042| _$t4@@0) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))))) (=> (not (and (= (|l#Vec_29042| _$t4@@0) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)))) (and (=> (= (ControlFlow 0 242223) (- 0 329797)) (not (and (= (|l#Vec_29042| _$t4@@0) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (not (and (= (|l#Vec_29042| _$t4@@0) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 242223) (- 0 329816)) (not (and (= (|l#Vec_29042| _$t4@@0) 0) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) 18446744073709551615)))) (=> (not (and (= (|l#Vec_29042| _$t4@@0) 0) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t6@@8) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) 18446744073709551615))) (and (=> (= (ControlFlow 0 242223) (- 0 329839)) (not (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (= (|l#Vec_29042| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0)))) (=> (not (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (= (|l#Vec_29042| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0))) (and (=> (= (ControlFlow 0 242223) (- 0 329876)) (not (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (= (|l#Vec_29042| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0)))) (=> (not (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (= (|l#Vec_29042| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0))) (and (=> (= (ControlFlow 0 242223) (- 0 329913)) (not (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (not (let ((payee_compliance_key@@10 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))))
 (and (and (= (|l#Vec_29042| _$t4@@0) 64) (not (= (|l#Vec_29042| payee_compliance_key@@10) 0))) ($1_Signature_$ed25519_verify _$t4@@0 payee_compliance_key@@10 ($1_DualAttestation_spec_dual_attestation_message _$t0@@11 _$t3@@0 _$t2@@1)))))))) (=> (not (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (not (let ((payee_compliance_key@@11 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))))
 (and (and (= (|l#Vec_29042| _$t4@@0) 64) (not (= (|l#Vec_29042| payee_compliance_key@@11) 0))) ($1_Signature_$ed25519_verify _$t4@@0 payee_compliance_key@@11 ($1_DualAttestation_spec_dual_attestation_message _$t0@@11 _$t3@@0 _$t2@@1))))))) (=> (= (ControlFlow 0 242223) (- 0 329952)) (not (and (or (not (= (|l#Vec_29042| _$t4@@0) 0)) (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8)))))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8))))))))))))))))))))
(let ((anon18_Else_correct@@0  (=> (and (not $t14@@2) (= (ControlFlow 0 242307) 242223)) L6_correct@@0)))
(let ((anon17_Then_correct@@1  (=> (and $t5@0@@0 (= $t14@@2  (or (or (or (= (|l#Vec_29042| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0) (= (|l#Vec_29042| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))) 0)) (not (let ((payee_compliance_key@@12 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))))
 (and (and (= (|l#Vec_29042| _$t4@@0) 64) (not (= (|l#Vec_29042| payee_compliance_key@@12) 0))) ($1_Signature_$ed25519_verify _$t4@@0 payee_compliance_key@@12 ($1_DualAttestation_spec_dual_attestation_message _$t0@@11 _$t3@@0 _$t2@@1)))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) _$t1@@8)))))) (and (=> (= (ControlFlow 0 242299) 242419) anon18_Then_correct@@0) (=> (= (ControlFlow 0 242299) 242307) anon18_Else_correct@@0)))))
(let ((anon17_Else_correct@@1  (=> (and (not $t5@0@@0) (= (ControlFlow 0 241957) 242223)) L6_correct@@0)))
(let ((anon16_Else_correct@@1  (=> (and (and (not $t13@@0) (= $t12@@1  (and (and (>= (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (not (= _$t0@@11 _$t1@@8))) (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))) (not (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@11) _$t0@@11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@11))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t1@@8) _$t1@@8 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t1@@8))))))))) (and (= $t12@@1 $t12@@1) (= $t5@0@@0 $t12@@1))) (and (=> (= (ControlFlow 0 241949) 242299) anon17_Then_correct@@1) (=> (= (ControlFlow 0 241949) 241957) anon17_Else_correct@@1)))))
(let ((anon15_Else_correct@@1  (=> (not inline$$Not$0$dst@1@@2) (=> (and (= $t11@@1 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $t13@@0  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t11@@1) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t11@@1) 1) _$t2@@1 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t11@@1) 2) (div _$t2@@1 2) (+ 18446744073709551615 1)))) 18446744073709551615)))) (and (=> (= (ControlFlow 0 241909) 243037) anon16_Then_correct@@1) (=> (= (ControlFlow 0 241909) 241949) anon16_Else_correct@@1))))))
(let ((anon15_Then_correct@@1  (=> inline$$Not$0$dst@1@@2 (=> (and (= true true) (= $t5@0@@0 true)) (and (=> (= (ControlFlow 0 243055) 242299) anon17_Then_correct@@1) (=> (= (ControlFlow 0 243055) 241957) anon17_Else_correct@@1))))))
(let ((inline$$Not$0$anon0_correct@@2  (=> (= inline$$Not$0$dst@1@@2  (not |inline$$1_Vector_is_empty'u8'$0$b@1@@0|)) (and (=> (= (ControlFlow 0 241853) 243055) anon15_Then_correct@@1) (=> (= (ControlFlow 0 241853) 241909) anon15_Else_correct@@1)))))
(let ((anon14_Else_correct@@2  (=> (and (not false) (= (ControlFlow 0 241859) 241853)) inline$$Not$0$anon0_correct@@2)))
(let ((anon14_Then_correct@@2 true))
(let ((|inline$$1_Vector_is_empty'u8'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_is_empty'u8'$0$b@1@@0| (= (|l#Vec_29042| _$t4@@0) 0)) (and (=> (= (ControlFlow 0 241809) 243069) anon14_Then_correct@@2) (=> (= (ControlFlow 0 241809) 241859) anon14_Else_correct@@2)))))
(let ((anon0$1_correct@@11  (=> (and (and (forall ((addr@@89 Int) ) (!  (=> (|$IsValid'address'| addr@@89) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159212| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@89) (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |DualAttestationbpl.13735:22|
 :skolemid |299|
)) (forall ((addr@@90 Int) ) (!  (=> (|$IsValid'address'| addr@@90) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159293| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@90) (|Select__T@[Int]Bool_| (|domain#$Memory_152871| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |DualAttestationbpl.13735:222|
 :skolemid |300|
))) (forall ((addr@@91 Int) ) (!  (=> (|$IsValid'address'| addr@@91) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159374| |$1_Diem_Preburn'#0'_$memory|) addr@@91) (|Select__T@[Int]Bool_| (|domain#$Memory_153007| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |DualAttestationbpl.13735:423|
 :skolemid |301|
))) (=> (and (and (and (forall ((addr@@92 Int) ) (!  (=> (|$IsValid'address'| addr@@92) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159624| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@92) (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |DualAttestationbpl.13739:22|
 :skolemid |302|
)) (forall ((addr@@93 Int) ) (!  (=> (|$IsValid'address'| addr@@93) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159741| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@93) (|Select__T@[Int]Bool_| (|domain#$Memory_152871| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |DualAttestationbpl.13739:227|
 :skolemid |303|
))) (forall ((addr@@94 Int) ) (!  (=> (|$IsValid'address'| addr@@94) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159858| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@94) (|Select__T@[Int]Bool_| (|domain#$Memory_153007| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |DualAttestationbpl.13739:433|
 :skolemid |304|
))) (and (and (forall ((child_addr@@0 Int) ) (!  (=> (|$IsValid'address'| child_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) child_addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) child_addr@@0)))))
 :qid |DualAttestationbpl.13743:20|
 :skolemid |305|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (and (forall ((addr1@@18 Int) ) (!  (=> (|$IsValid'address'| addr1@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@18) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@18)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@18)) 2)))))
 :qid |DualAttestationbpl.13751:20|
 :skolemid |306|
)) (|$IsValid'address'| _$t0@@11)))) (=> (and (and (and (and (|$IsValid'address'| _$t1@@8) (|$IsValid'u64'| _$t2@@1)) (and (|$IsValid'vec'u8''| _$t3@@0) (|$IsValid'vec'u8''| _$t4@@0))) (and (and (forall (($a_0@@19 Int) ) (! (let (($rsc@@19 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@19)))
 ...
 :qid |DualAttestationbpl.13769:20|
 :skolemid |307|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@19))
)) (forall (($a_0@@20 Int) ) (! (let (($rsc@@20 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) $a_0@@20)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc@@20))
 :qid |DualAttestationbpl.13773:20|
 :skolemid |308|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) $a_0@@20))
))) (and (forall (($a_0@@21 Int) ) (! (let (($rsc@@21 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_171117| $1_VASP_ParentVASP_$memory) $a_0@@21)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@21))
 :qid |DualAttestationbpl.13777:20|
 :skolemid |309|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_171117| $1_VASP_ParentVASP_$memory) $a_0@@21))
)) (forall (($a_0@@22 Int) ) (! (let (($rsc@@22 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) $a_0@@22)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@22))
 :qid |DualAttestationbpl.13781:20|
 :skolemid |310|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) $a_0@@22))
))))) (and (and (and (forall (($a_0@@23 Int) ) (! (let (($rsc@@23 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) $a_0@@23)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc@@23))
 :qid |DualAttestationbpl.13785:20|
 :skolemid |311|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) $a_0@@23))
)) (= $t6@@8 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (= _$t0@@11 _$t0@@11) (= _$t1@@8 _$t1@@8))) (and (and (= _$t2@@1 _$t2@@1) (= _$t3@@0 _$t3@@0)) (and (= _$t4@@0 _$t4@@0) (= (ControlFlow 0 241815) 241809))))) |inline$$1_Vector_is_empty'u8'$0$anon0_correct@@0|)))))
(let ((inline$$InitEventStore$0$anon0_correct@@11  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@13 T@$1_Event_EventHandle) ) (! (let ((stream@@12 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $es) handle@@13)))
 (and (= (|l#Multiset_93630| stream@@12) 0) (forall ((v@@63 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@12) v@@63) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2823:13|
 :skolemid |103|
))) (= (ControlFlow 0 241355) 241815)) anon0$1_correct@@11)))
(let ((anon0_correct@@11  (=> (= (ControlFlow 0 328886) 241355) inline$$InitEventStore$0$anon0_correct@@11)))
anon0_correct@@11))))))))))))))))))
))
(check-sat)
(pop 1)
