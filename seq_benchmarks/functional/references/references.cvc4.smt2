...
(assert (not
 (=> (= (ControlFlow 0 0) 22894) (let ((anon0$1_correct@@0  (=> (= (|l#$Mutation_4535| _$t0@@0) ($Param 0)) (=> (and (and (and (|$IsValid'u64'| (|v#$Mutation_4535| _$t0@@0)) (= |$temp_0'u64'@0@@0| (|v#$Mutation_4535| _$t0@@0))) (and (= |$temp_0'u64'@0@@0| |$temp_0'u64'@0@@0|) (|$IsValid'u64'| 10))) (and (and (= $t0@0@@0 ($Mutation_4535 (|l#$Mutation_4535| _$t0@@0) (|p#$Mutation_4535| _$t0@@0) 10)) (= |$temp_0'u64'@1@@0| (|v#$Mutation_4535| $t0@0@@0))) (and (= |$temp_0'u64'@1@@0| |$temp_0'u64'@1@@0|) (= (ControlFlow 0 19820) (- 0 22998))))) (= (|v#$Mutation_4535| $t0@0@@0) 10)))))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 22894) 19820) anon0$1_correct@@0)))
anon0_correct@@0)))
))
(check-sat)
(pop 1)
...
(let ((anon6_Else_correct  (=> (and (not false) (= $t0@0@@1 (|v#$Mutation_4535| inline$$42_TestReferences_mut_b$0$$t0@1))) (=> (and (and (= $t0@1 (|v#$Mutation_4535| inline$$42_TestReferences_mut_b$0$$t0@1)) (= $t0@1 $t0@1)) (and (|$IsValid'u64'| 10) (= $t7@0  (not (= $t0@1 10))))) (and (=> (= (ControlFlow 0 20119) 20153) anon7_Then_correct) (=> (= (ControlFlow 0 20119) 20133) anon7_Else_correct))))))
...
(let ((anon0$1_correct@@1  (=> (and (|$IsValid'u64'| 20) (= 20 20)) (=> (and (and (= $t3@0 ($Mutation_4535 ($Local 0) (as seq.empty (Seq Int)) 20)) (= |$temp_0'u64'@0@@1| (|v#$Mutation_4535| $t3@0))) (and (= |$temp_0'u64'@0@@1| |$temp_0'u64'@0@@1|) (= (ControlFlow 0 20077) 20071))) inline$$42_TestReferences_mut_b$0$anon0_correct))))
(let ((anon0_correct@@1  (=> (= (seq.len (|p#$Mutation_4535| $t1)) 0) (=> (and (= (seq.len (|p#$Mutation_4535| $t3)) 0) (= (ControlFlow 0 19898) 20077)) anon0$1_correct@@1))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 23014) 19898) anon0_correct@@1)))
...
(assert (not
 (=> (= (ControlFlow 0 0) 23326) (let ((L4_correct@@0  (=> (= (ControlFlow 0 20531) (- 0 23621)) true)))
(let ((anon7_Then_correct@@0  (=> (and (and $t7@0@@0 (|$IsValid'u64'| 1)) (and (= 1 1) (= (ControlFlow 0 20521) 20531))) L4_correct@@0)))
(let ((anon7_Else_correct@@0  (=> (and (not $t7@0@@0) (= (ControlFlow 0 20501) (- 0 23614))) (not true))))
(let ((anon6_Else_correct@@0  (=> (and (not false) (= $t0@0@@2 (|v#$Mutation_4535| inline$$42_TestReferences_mut_b$0$$t0@1@@0))) (=> (and (and (= $t0@1@@0 (|v#$Mutation_4535| inline$$42_TestReferences_mut_b$0$$t0@1@@0)) (= $t0@1@@0 $t0@1@@0)) (and (|$IsValid'u64'| 10) (= $t7@0@@0  (not (= $t0@1@@0 10))))) (and (=> (= (ControlFlow 0 20487) 20521) anon7_Then_correct@@0) (=> (= (ControlFlow 0 20487) 20501) anon7_Else_correct@@0))))))
(let ((anon6_Then_correct@@0 true))
(let ((inline$$42_TestReferences_mut_b$0$anon0_correct@@0  (=> (and (= |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@1@@0| (|v#$Mutation_4535| $t3@0@@0)) (= |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@1@@0| |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@1@@0|)) (=> (and (and (|$IsValid'u64'| 10) (= inline$$42_TestReferences_mut_b$0$$t0@1@@0 ($Mutation_4535 (|l#$Mutation_4535| $t3@0@@0) (|p#$Mutation_4535| $t3@0@@0) 10))) (and (= |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@2@@0| (|v#$Mutation_4535| inline$$42_TestReferences_mut_b$0$$t0@1@@0)) (= |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@2@@0| |inline$$42_TestReferences_mut_b$0$$temp_0'u64'@2@@0|))) (and (=> (= (ControlFlow 0 20439) 20545) anon6_Then_correct@@0) (=> (= (ControlFlow 0 20439) 20487) anon6_Else_correct@@0))))))
(let ((anon0$1_correct@@2  (=> (and (|$IsValid'u64'| 20) (= 20 20)) (=> (and (and (= $t3@0@@0 ($Mutation_4535 ($Local 0) (as seq.empty (Seq Int)) 20)) (= |$temp_0'u64'@0@@2| (|v#$Mutation_4535| $t3@0@@0))) (and (= |$temp_0'u64'@0@@2| |$temp_0'u64'@0@@2|) (= (ControlFlow 0 20445) 20439))) inline$$42_TestReferences_mut_b$0$anon0_correct@@0))))
(let ((anon0_correct@@2  (=> (= (seq.len (|p#$Mutation_4535| $t1@@0)) 0) (=> (and (= (seq.len (|p#$Mutation_4535| $t3@@0)) 0) (= (ControlFlow 0 20266) 20445)) anon0$1_correct@@2))))
(let ((PreconditionGeneratedEntry_correct@@0  (=> (= (ControlFlow 0 23326) 20266) anon0_correct@@2)))
...
(assert (not
 (=> (= (ControlFlow 0 0) 23638) (let ((anon10_Else_correct  (=> (not $abort_flag@0@@0) (=> (and (and (and (= |$temp_0'u64'@0@@3| (|v#$Mutation_4535| |inline$$1_Vector_borrow_mut'u64'$0$dst@2|)) (= |$temp_0'u64'@0@@3| |$temp_0'u64'@0@@3|)) (and (|$IsValid'u64'| 0) (= $t7@0@@1 ($Mutation_4535 (|l#$Mutation_4535| |inline$$1_Vector_borrow_mut'u64'$0$dst@2|) (|p#$Mutation_4535| |inline$$1_Vector_borrow_mut'u64'$0$dst@2|) 0)))) (and (and (= $t5@1 ($Mutation_13863 (|l#$Mutation_13863| |inline$$1_Vector_borrow_mut'u64'$0$m'@1|) (|p#$Mutation_13863| |inline$$1_Vector_borrow_mut'u64'$0$m'@1|) (seq.++ (seq.extract (|v#$Mutation_13863| |inline$$1_Vector_borrow_mut'u64'$0$m'@1|) 0 (- (seq.nth (|p#$Mutation_4535| $t7@0@@1) (seq.len (|p#$Mutation_13863| |inline$$1_Vector_borrow_mut'u64'$0$m'@1|))) 0)) (seq.unit (|v#$Mutation_4535| $t7@0@@1)) (seq.extract (|v#$Mutation_13863| |inline$$1_Vector_borrow_mut'u64'$0$m'@1|) (+ (seq.nth (|p#$Mutation_4535| $t7@0@@1) (seq.len (|p#$Mutation_13863| |inline$$1_Vector_borrow_mut'u64'$0$m'@1|))) 1) (- (seq.len (|v#$Mutation_13863| |inline$$1_Vector_borrow_mut'u64'$0$m'@1|)) (+ (seq.nth (|p#$Mutation_4535| $t7@0@@1) (seq.len (|p#$Mutation_13863| |inline$$1_Vector_borrow_mut'u64'$0$m'@1|))) 1)))))) (= $t1@1 (|v#$Mutation_13863| $t5@1))) (and (= $t1@1 $t1@1) (= (ControlFlow 0 21073) (- 0 24091))))) (= (seq.nth $t1@1 0) 0)))))
...
(let ((anon9_Else_correct  (=> (not false) (=> (and (and (= $t1@0@@0 (|v#$Mutation_13863| |inline$$1_Vector_push_back'u64'$0$m'@1|)) (= $t5@0 ($Mutation_13863 ($Local 1) (as seq.empty (Seq Int)) $t1@0@@0))) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 20985) 20895))) |inline$$1_Vector_borrow_mut'u64'$0$anon0_correct|))))
(let ((anon9_Then_correct true))
(let ((|inline$$1_Vector_push_back'u64'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'u64'$0$m'@1| ($Mutation_13863 (|l#$Mutation_13863| $t3@0@@1) (|p#$Mutation_13863| $t3@0@@1) (seq.++ (|v#$Mutation_13863| $t3@0@@1) (seq.unit 1)))) (and (=> (= (ControlFlow 0 20759) 21107) anon9_Then_correct) (=> (= (ControlFlow 0 20759) 20985) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (not false) (=> (and (and (= |inline$$1_Vector_empty'u64'$0$v@1| |inline$$1_Vector_empty'u64'$0$v@1|) (= $t3@0@@1 ($Mutation_13863 ($Local 1) (as seq.empty (Seq Int)) |inline$$1_Vector_empty'u64'$0$v@1|))) (and (|$IsValid'u64'| 1) (= (ControlFlow 0 20765) 20759))) |inline$$1_Vector_push_back'u64'$0$anon0_correct|))))
...
(let ((anon0$1_correct@@3  (=> (= (ControlFlow 0 20676) 20670) |inline$$1_Vector_empty'u64'$0$anon0_correct|)))
(let ((anon0_correct@@3  (=> (= (seq.len (|p#$Mutation_4535| $t0)) 0) (=> (and (and (= (seq.len (|p#$Mutation_13863| $t3@@1)) 0) (= (seq.len (|p#$Mutation_13863| $t5)) 0)) (and (= (seq.len (|p#$Mutation_4535| $t7)) 0) (= (ControlFlow 0 20646) 20676))) anon0$1_correct@@3))))
(let ((PreconditionGeneratedEntry_correct@@1  (=> (= (ControlFlow 0 23638) 20646) anon0_correct@@3)))
