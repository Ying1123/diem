...
(assert (not
 (=> (= (ControlFlow 0 0) 1176225) (let ((anon11_Else_correct@@22  (=> (not $abort_flag@0@@39) (=> (and (= $t4@0@@17 (|$total_value#$1_Diem_CurrencyInfo'#0'| $t3@1@@6)) (= $t4@0@@17 $t4@0@@17)) (and (=> (= (ControlFlow 0 838988) (- 0 1176688)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 838988) (- 0 1176709)) (forall ((addr@@1195 Int) ) (!  (=> (|$IsValid'address'| addr@@1195) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1195)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1195))))
 :qid |Diembpl.31034:15|
 :skolemid |1633|
))) (=> (forall ((addr@@1196 Int) ) (!  (=> (|$IsValid'address'| addr@@1196) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1196)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1196))))
 :qid |Diembpl.31034:15|
 :skolemid |1633|
)) (and (=> (= (ControlFlow 0 838988) (- 0 1176738)) (forall ((addr@@1197 Int) ) (!  (=> (|$IsValid'address'| addr@@1197) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1197) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1197)))
 :qid |Diembpl.31039:15|
 :skolemid |1634|
))) (=> (forall ((addr@@1198 Int) ) (!  (=> (|$IsValid'address'| addr@@1198) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1198) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1198)))
 :qid |Diembpl.31039:15|
 :skolemid |1634|
)) (and (=> (= (ControlFlow 0 838988) (- 0 1176763)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 838988) (- 0 1176784)) (forall ((addr@@1199 Int) ) (!  (=> (|$IsValid'address'| addr@@1199) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1199)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1199))))
 :qid |Diembpl.31049:15|
 :skolemid |1635|
))) (=> (forall ((addr@@1200 Int) ) (!  (=> (|$IsValid'address'| addr@@1200) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1200)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1200))))
 :qid |Diembpl.31049:15|
 :skolemid |1635|
)) (and (=> (= (ControlFlow 0 838988) (- 0 1176813)) (forall ((addr@@1201 Int) ) (!  (=> (|$IsValid'address'| addr@@1201) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1201) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1201)))
 :qid |Diembpl.31054:15|
 :skolemid |1636|
))) (=> (forall ((addr@@1202 Int) ) (!  (=> (|$IsValid'address'| addr@@1202) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1202) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1202)))
 :qid |Diembpl.31054:15|
 :skolemid |1636|
)) (and (=> (= (ControlFlow 0 838988) (- 0 1176838)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 838988) (- 0 1176859)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 838988) (- 0 1176880)) (forall ((addr@@1203 Int) ) (!  (=> (|$IsValid'address'| addr@@1203) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1203) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@1203))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1203))))
 :qid |Diembpl.31069:15|
 :skolemid |1637|
))) (=> (forall ((addr@@1204 Int) ) (!  (=> (|$IsValid'address'| addr@@1204) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1204) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@1204))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1204))))
 :qid |Diembpl.31069:15|
 :skolemid |1637|
)) (and (=> (= (ControlFlow 0 838988) (- 0 1176916)) (forall ((addr@@1205 Int) ) (!  (=> (|$IsValid'address'| addr@@1205) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1205) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1205)))
 :qid |Diembpl.31074:15|
 :skolemid |1638|
))) (=> (forall ((addr@@1206 Int) ) (!  (=> (|$IsValid'address'| addr@@1206) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1206) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1206)))
 :qid |Diembpl.31074:15|
 :skolemid |1638|
...
(let ((anon10_Then$1_correct@@5  (=> (= $t3@1@@6 $t3@@20) (=> (and (= $abort_flag@0@@39 true) (= $abort_code@1@@39 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 839060) 839002) anon11_Then_correct@@22) (=> (= (ControlFlow 0 839060) 838988) anon11_Else_correct@@22))))))
(let ((anon10_Then_correct@@25  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 839058) 839060)) anon10_Then$1_correct@@5)))
(let ((anon10_Else_correct@@25  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t3@0@@15 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t3@1@@6 $t3@0@@15)) (and (= $abort_flag@0@@39 false) (= $abort_code@1@@39 $abort_code@0@@39))) (and (=> (= (ControlFlow 0 838686) 839002) anon11_Then_correct@@22) (=> (= (ControlFlow 0 838686) 838988) anon11_Else_correct@@22))))))
(let ((anon9_Else_correct@@21  (=> (and (not $t0@@5) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 838672) 839058) anon10_Then_correct@@25) (=> (= (ControlFlow 0 838672) 838686) anon10_Else_correct@@25)))))
(let ((anon9_Then_correct@@21 true))
(let ((anon0$1_correct@@61  (=> (and (and (and (and (forall ((addr3@@233 Int) ) (!  (=> (|$IsValid'address'| addr3@@233) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3@@233) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.30939:22|
 :skolemid |1623|
)) (forall ((addr3@@234 Int) ) (!  (=> (|$IsValid'address'| addr3@@234) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316220| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@234) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |Diembpl.30939:261|
 :skolemid |1624|
))) (forall ((addr3@@235 Int) ) (!  (=> (|$IsValid'address'| addr3@@235) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr3@@235) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |Diembpl.30939:501|
 :skolemid |1625|
))) (and (and (forall ((addr@@1207 Int) ) (!  (=> (|$IsValid'address'| addr@@1207) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@1207) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.30943:22|
 :skolemid |1626|
)) (forall ((addr@@1208 Int) ) (!  (=> (|$IsValid'address'| addr@@1208) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@1208) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.30943:222|
 :skolemid |1627|
))) (forall ((addr@@1209 Int) ) (!  (=> (|$IsValid'address'| addr@@1209) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@1209) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.30943:423|
 :skolemid |1628|
)))) (and (and (and (forall ((addr@@1210 Int) ) (!  (=> (|$IsValid'address'| addr@@1210) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@1210) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.30947:22|
 :skolemid |1629|
)) (forall ((addr@@1211 Int) ) (!  (=> (|$IsValid'address'| addr@@1211) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@1211) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.30947:227|
 :skolemid |1630|
))) (forall ((addr@@1212 Int) ) (!  (=> (|$IsValid'address'| addr@@1212) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1212) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.30947:433|
 :skolemid |1631|
))) (and (forall (($a_0@@83 Int) ) (! (let (($rsc@@83 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@83)))
 (and (|$IsValid'$1_Diem_CurrencyInfo'#0''| $rsc@@83) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@83)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@83) 10000000000))))
 :qid |Diembpl.30950:20|
 :skolemid |1632|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@83))
)) (= $t0@@5  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 838658) 839086) anon9_Then_correct@@21) (=> (= (ControlFlow 0 838658) 838672) anon9_Else_correct@@21)))))
(let ((inline$$InitEventStore$0$anon0_correct@@61  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@123 T@$1_Event_EventHandle) ) (! (let ((stream@@152 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@123)))
 (and (= (|l#Multiset_275813| stream@@152) 0) (forall ((v@@170 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@152) v@@170) 0)
 :qid |Diembpl.159:13|
 :skolemid |4|
))))
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 838379) 838658)) anon0$1_correct@@61)))
(let ((anon0_correct@@61  (=> (= (ControlFlow 0 1176225) 838379) inline$$InitEventStore$0$anon0_correct@@61)))
anon0_correct@@61)))))))))))
))
(check-sat)
(pop 1)
