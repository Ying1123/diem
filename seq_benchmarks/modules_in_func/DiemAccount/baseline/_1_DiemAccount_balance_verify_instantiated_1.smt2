...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2005887) (let ((anon15_Else_correct  (=> (and (not $abort_flag@1) (= |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$ret0@1|)) (and (=> (= (ControlFlow 0 1242178) (- 0 2006453)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 1242178) (- 0 2006464)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)))))
 :qid |DiemAccountbpl.44318:15|
 :skolemid |1250|
 ...
 :qid |DiemAccountbpl.44318:15|
 :skolemid |1250|
)) (=> (= (ControlFlow 0 1242178) (- 0 2006500)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@2) (>= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$coin#$1_DiemAccount_Balance'$1_XDX_XDX'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@2))) (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$coin#$1_DiemAccount_Balance'$1_XDX_XDX'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@2))))))
 :qid |DiemAccountbpl.44323:15|
 :skolemid |1251|
))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 1241757) (- 0 2006415)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)) (=> (= (ControlFlow 0 1241757) (- 0 2006421)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)) (= 5 $t6@0)))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 1242192) 1241757))) L3_correct)))
(let ((|inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon3_Else_correct|  (=> (and (and (not $abort_flag@0) (= |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1|)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1242046) 1242192) anon15_Then_correct) (=> (= (ControlFlow 0 1242046) 1242178) anon15_Else_correct)))))
(let ((|inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon3_Then_correct|  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $abort_flag@1 true) (= |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 1242064) 1242192) anon15_Then_correct) (=> (= (ControlFlow 0 1242064) 1242178) anon15_Else_correct)))))
(let ((|inline$$1_Diem_value'$1_XDX_XDX'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$t1@1| |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$t1@1|) (=> (and (= |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1| (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$t1@1|)) (= |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1242022) 1242064) |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1242022) 1242046) |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon3_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon0_correct|  (=> (= $t7@1 $t7@1) (=> (and (= |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$t1@1| (|$coin#$1_DiemAccount_Balance'$1_XDX_XDX'| $t7@1)) (= (ControlFlow 0 1242028) 1242022)) |inline$$1_Diem_value'$1_XDX_XDX'$0$anon0_correct|))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 1242070) 1242028)) |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon0_correct|)))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 1242206) 1241757))) L3_correct)))
(let ((anon13_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1242258) 1242206) anon14_Then_correct) (=> (= (ControlFlow 0 1242258) 1242070) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)) (= (ControlFlow 0 1242256) 1242258)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1241775) 1242206) anon14_Then_correct) (=> (= (ControlFlow 0 1241775) 1242070) anon14_Else_correct))))))
(let ((anon12_Then_correct  (=> $t3@0 (and (=> (= (ControlFlow 0 1241761) 1242256) anon13_Then_correct) (=> (= (ControlFlow 0 1241761) 1241775) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not $t3@0) (= $t5 $t5)) (and (= $t6@0 $t5) (= (ControlFlow 0 1241725) 1241757))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_468892| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@3)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@3)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@3)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@3)) 2)))))
 ...
 :qid |DiemAccountbpl.44216:415|
 :skolemid |1248|
))) (|$IsValid'address'| _$t0)) (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) $a_0)))
(|$IsValid'$1_DiemAccount_Balance'$1_XDX_XDX''| $rsc))
 :qid |DiemAccountbpl.44222:20|
 :skolemid |1249|
...
)) (= _$t0 _$t0)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)) (|$IsValid'u64'| 19))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0))))) (and (=> (= (ControlFlow 0 1241709) 1241761) anon12_Then_correct) (=> (= (ControlFlow 0 1241709) 1241725) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1241519) 1241709)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2005887) 1241519) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))
))
(check-sat)
(pop 1)
