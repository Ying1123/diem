...
(assert (forall ((v@@20 (Seq (Seq Int))) ) (! (= (|$IsValid'vec'vec'u8'''| v@@20)  (and (|$IsValid'u64'| (seq.len v@@20)) (forall ((i@@24 Int) ) (!  (=> (and (>= i@@24 0) (< i@@24 (seq.len v@@20))) (|$IsValid'vec'u8''| (seq.nth v@@20 i@@24)))
 :qid |DiemIdbpl.2035:13|
 :skolemid |55|
))))
 :qid |DiemIdbpl.2033:33|
 :skolemid |56|
...
(ite  (not (exists ((i@@26 Int) ) (!  (and (and (|$IsValid'u64'| i@@26) (and (>= i@@26 0) (< i@@26 (seq.len v@@21)))) (= (seq.nth v@@21 i@@26) e@@7))
 :qid |DiemIdbpl.2040:13|
 :skolemid |57|
))) (= i@@25 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@25) (and (>= i@@25 0) (< i@@25 (seq.len v@@21)))) (= (seq.nth v@@21 i@@25) e@@7)) (forall ((j@@7 Int) ) (!  (=> (and (and (|$IsValid'u64'| j@@7) (>= j@@7 0)) (< j@@7 i@@25)) (not (= (seq.nth v@@21 j@@7) e@@7)))
 :qid |DiemIdbpl.2048:17|
 :skolemid |58|
)))))
 :qid |DiemIdbpl.2044:15|
 :skolemid |59|
...
(assert (forall ((v@@22 (Seq Int)) ) (! (= (|$IsValid'vec'address''| v@@22)  (and (|$IsValid'u64'| (seq.len v@@22)) (forall ((i@@27 Int) ) (!  (=> (and (>= i@@27 0) (< i@@27 (seq.len v@@22))) (|$IsValid'address'| (seq.nth v@@22 i@@27)))
 :qid |DiemIdbpl.2215:13|
 :skolemid |60|
))))
 :qid |DiemIdbpl.2213:33|
 :skolemid |61|
...
(ite  (not (exists ((i@@29 Int) ) (!  (and (and (|$IsValid'u64'| i@@29) (and (>= i@@29 0) (< i@@29 (seq.len v@@23)))) (= (seq.nth v@@23 i@@29) e@@8))
 :qid |DiemIdbpl.2220:13|
 :skolemid |62|
))) (= i@@28 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@28) (and (>= i@@28 0) (< i@@28 (seq.len v@@23)))) (= (seq.nth v@@23 i@@28) e@@8)) (forall ((j@@8 Int) ) (!  (=> (and (and (|$IsValid'u64'| j@@8) (>= j@@8 0)) (< j@@8 i@@28)) (not (= (seq.nth v@@23 j@@8) e@@8)))
 :qid |DiemIdbpl.2228:17|
 :skolemid |63|
)))))
 :qid |DiemIdbpl.2224:15|
 :skolemid |64|
...
(assert (not
 (=> (= (ControlFlow 0 0) 224033) (let ((anon18_Else_correct  (=> (and (not $abort_flag@1@@0) (= |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1@@0| |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1@@0|)) (and (=> (= (ControlFlow 0 164412) (- 0 224856)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@1))) (and (=> (= (ControlFlow 0 164412) (- 0 224867)) (not (> (seq.len _$t1@@0) 63))) (=> (not (> (seq.len _$t1@@0) 63)) (=> (= (ControlFlow 0 164412) (- 0 224879)) (= |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1@@0| (exists ((i@@62 Int) ) (!  (and (and (|$IsValid'u64'| i@@62) (and (>= i@@62 0) (< i@@62 (seq.len (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)))))) (= (seq.nth (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) i@@62) $t6))
 :qid |DiemIdbpl.1140:13|
 :skolemid |32|
)))))))))))
(let ((L3_correct@@0  (and (=> (= (ControlFlow 0 163838) (- 0 224793)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (> (seq.len _$t1@@0) 63))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (> (seq.len _$t1@@0) 63)) (=> (= (ControlFlow 0 163838) (- 0 224808)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (= 5 $t10@0)) (and (> (seq.len _$t1@@0) 63) (= 7 $t10@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@1@@0 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= $t10@0 $abort_code@2@@0) (= (ControlFlow 0 164426) 163838))) L3_correct@@0)))
(let ((|inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1@@0| (exists ((i@@63 Int) ) (!  (and (and (|$IsValid'u64'| i@@63) (and (>= i@@63 0) (< i@@63 (seq.len $t13@0)))) (= (seq.nth $t13@0 i@@63) inline$$1_DiemId_create_diem_id_domain$0$$ret0@1@@0))
 :qid |DiemIdbpl.1140:13|
 :skolemid |32|
))) (and (=> (= (ControlFlow 0 164346) 164426) anon18_Then_correct) (=> (= (ControlFlow 0 164346) 164412) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (and (not $abort_flag@1@@0) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1@@0 inline$$1_DiemId_create_diem_id_domain$0$$ret0@1@@0)) (and (= $t13@0 (|$domains#$1_DiemId_DiemIdDomains| $t11@1)) (= (ControlFlow 0 164352) 164346))) |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$anon0_correct@@0|)))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@1@@0 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= $t10@0 $abort_code@2@@0) (= (ControlFlow 0 164440) 163838))) L3_correct@@0)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$L3_correct@@0  (=> (= $abort_flag@1@@0 true) (=> (and (= $abort_code@2@@0 inline$$1_DiemId_create_diem_id_domain$0$$t4@1@@0) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1@@0 inline$$1_DiemId_create_diem_id_domain$0$$ret0@0@@0)) (and (=> (= (ControlFlow 0 164248) 164440) anon17_Then_correct) (=> (= (ControlFlow 0 164248) 164352) anon17_Else_correct))))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon7_Else_correct@@0  (=> (and (and (not inline$$Le$0$dst@1@@1) (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t4@1@@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0) (= (ControlFlow 0 164242) 164248))) inline$$1_DiemId_create_diem_id_domain$0$L3_correct@@0)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Then_correct@@0  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t4@1@@0 $abort_code@1@@0) (= (ControlFlow 0 164280) 164248))) inline$$1_DiemId_create_diem_id_domain$0$L3_correct@@0)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon7_Then_correct@@0  (=> (and inline$$Le$0$dst@1@@1 (= inline$$1_DiemId_create_diem_id_domain$0$$t9@1@@0 ($1_DiemId_DiemIdDomain _$t1@@0))) (=> (and (and (= inline$$1_DiemId_create_diem_id_domain$0$$t9@1@@0 inline$$1_DiemId_create_diem_id_domain$0$$t9@1@@0) (= $abort_flag@1@@0 $abort_flag@0@@0)) (and (= $abort_code@2@@0 $abort_code@1@@0) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1@@0 inline$$1_DiemId_create_diem_id_domain$0$$t9@1@@0))) (and (=> (= (ControlFlow 0 164266) 164440) anon17_Then_correct) (=> (= (ControlFlow 0 164266) 164352) anon17_Else_correct))))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Else$1_correct@@0  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0) (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0 7)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0) (= inline$$Le$0$dst@1@@1 inline$$Le$0$dst@1@@1))) (and (=> (= (ControlFlow 0 164226) 164266) inline$$1_DiemId_create_diem_id_domain$0$anon7_Then_correct@@0) (=> (= (ControlFlow 0 164226) 164242) inline$$1_DiemId_create_diem_id_domain$0$anon7_Else_correct@@0))))))
(let ((inline$$Le$0$anon0_correct@@1  (=> (and (= inline$$Le$0$dst@1@@1 (<= |inline$$1_Vector_length'u8'$0$l@1@@1| 63)) (= (ControlFlow 0 164190) 164226)) inline$$1_DiemId_create_diem_id_domain$0$anon6_Else$1_correct@@0)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Else_correct@@0  (=> (not $abort_flag@0@@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 164196) 164190)) inline$$Le$0$anon0_correct@@1))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct@@1|  (=> (= |inline$$1_Vector_length'u8'$0$l@1@@1| (seq.len _$t1@@0)) (and (=> (= (ControlFlow 0 164130) 164280) inline$$1_DiemId_create_diem_id_domain$0$anon6_Then_correct@@0) (=> (= (ControlFlow 0 164130) 164196) inline$$1_DiemId_create_diem_id_domain$0$anon6_Else_correct@@0)))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon0_correct@@0  (=> (and (= _$t1@@0 _$t1@@0) (= (ControlFlow 0 164136) 164130)) |inline$$1_Vector_length'u8'$0$anon0_correct@@1|)))
(let ((anon16_Else_correct  (=> (not $abort_flag@0@@0) (=> (and (= $t11@1 $t11@1) (= (ControlFlow 0 164286) 164136)) inline$$1_DiemId_create_diem_id_domain$0$anon0_correct@@0))))
(let ((anon16_Then_correct  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= $t10@0 $abort_code@1@@0) (= (ControlFlow 0 164454) 163838))) L3_correct@@0)))
(let ((anon15_Then$1_correct  (=> (= $t11@1 $t11@@0) (=> (and (= $abort_flag@0@@0 true) (= $abort_code@1@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 164506) 164454) anon16_Then_correct) (=> (= (ControlFlow 0 164506) 164286) anon16_Else_correct))))))
(let ((anon15_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (= (ControlFlow 0 164504) 164506)) anon15_Then$1_correct)))
(let ((anon15_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@1) (=> (and (and (= $t11@0 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (= $t11@1 $t11@0)) (and (= $abort_flag@0@@0 false) (= $abort_code@1@@0 $abort_code@0@@0))) (and (=> (= (ControlFlow 0 163856) 164454) anon16_Then_correct) (=> (= (ControlFlow 0 163856) 164286) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7@0 (and (=> (= (ControlFlow 0 163842) 164504) anon15_Then_correct) (=> (= (ControlFlow 0 163842) 163856) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (and (not $t7@0) (= $t9@@0 $t9@@0)) (and (= $t10@0 $t9@@0) (= (ControlFlow 0 163778) 163838))) L3_correct@@0)))
(let ((anon0$1_correct@@2  (=> (and (and (|$IsValid'address'| _$t0@@1) (|$IsValid'vec'u8''| _$t1@@0)) (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $a_0@@3)))
...
(forall (($i_6@@0 Int) ) (!  (=> ($InRange $range_5@@0 $i_6@@0) (let ((j@@15 $i_6@@0))
 ...
 :qid |DiemIdbpl.12899:96|
 :skolemid |221|
)))))
 :qid |DiemIdbpl.12898:196|
 :skolemid |222|
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| $elem@@4)) 63)))
 :qid |DiemIdbpl.12900:221|
 :skolemid |223|
))))))
 :qid |DiemIdbpl.12896:20|
 :skolemid |224|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $a_0@@3))
)) (= $t6 ($1_DiemId_DiemIdDomain _$t1@@0)))) (=> (and (and (and (= _$t0@@1 _$t0@@1) (= _$t1@@0 _$t1@@0)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (|$IsValid'u64'| 4))) (and (and (|$IsValid'u64'| $t9@@0) (= $t9@@0 5)) (and (= $t9@@0 $t9@@0) (= $t7@0 $t7@0)))) (and (=> (= (ControlFlow 0 163762) 163842) anon14_Then_correct) (=> (= (ControlFlow 0 163762) 163778) anon14_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@7 T@$1_Event_EventHandle) ) (! (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_69963_| (|streams#$EventStore| $es) handle@@7)))
 (and (= (|l#Multiset_69963| stream@@7) 0) (forall ((v@@44 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_69963| stream@@7) v@@44) 0)
 :qid |DiemIdbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemIdbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 163490) 163762)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 224033) 163490) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
