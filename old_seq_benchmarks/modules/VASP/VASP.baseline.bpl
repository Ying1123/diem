...
L7:
    ...
    // @191 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@191](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
L6:
    ...
    // @163 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@163](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
// fun VASP::has_account_limits [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:117:5+170
procedure {:timeLimit 40} $1_VASP_has_account_limits$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:117:5+170
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume {:print "$at(33,5441,5611)"} true;
    ...
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:117:5+170
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<AccountLimits::Window<#0>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:117:5+170
    ...
    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:117:5+170
    ...
    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:117:5+170
    ...
    // @107 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:117:5+1
...
L1:
    ...
    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@107]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:254:9+78
    assume {:print "$at(33,10484,10562)"} true;
    assert {:msg "assert_failed(33,10484,10562): post-condition does not hold"}
    ...
    // return $t4 at /home/ying/diem/language/diem-framework/modules/VASP.move:254:9+78
    $ret0 := $t4;
    return;
...
// fun VASP::is_child [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:166:5+80
procedure {:timeLimit 40} $1_VASP_is_child$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_VASP_ChildVASP_$memory#92: $Memory $1_VASP_ChildVASP;
    var $1_VASP_ParentVASP_$memory#93: $Memory $1_VASP_ParentVASP;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:166:5+80
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume {:print "$at(33,7223,7303)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:172:17+6
    assume {:print "$at(33,7395,7401)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:172:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // @92 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:166:5+1
    assume {:print "$at(33,7223,7224)"} true;
    $1_VASP_ChildVASP_$memory#92 := $1_VASP_ChildVASP_$memory;

    // @93 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:166:5+1
    $1_VASP_ParentVASP_$memory#93 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:166:5+1
    assume {:print "$track_local(20,1,0):", $t0} $t0 == $t0;

    // $t1 := exists<VASP::ChildVASP>($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:167:9+6
    assume {:print "$at(33,7274,7280)"} true;
    $t1 := $ResourceExists($1_VASP_ChildVASP_$memory, $t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:167:9+23
    assume {:print "$track_return(20,1,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:168:5+1
    assume {:print "$at(33,7302,7303)"} true;
L1:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/VASP.move:171:9+16
    assume {:print "$at(33,7362,7378)"} true;
    assert {:msg "assert_failed(33,7362,7378): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, VASP::$is_child($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:172:9+33
    assume {:print "$at(33,7387,7420)"} true;
    assert {:msg "assert_failed(33,7387,7420): post-condition does not hold"}
      $IsEqual'bool'($t1, $1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0));

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@92]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:254:9+78
    assume {:print "$at(33,10484,10562)"} true;
    assert {:msg "assert_failed(33,10484,10562): post-condition does not hold"}
      (forall a: int :: $IsValid'address'(a) ==> ($IsEqual'bool'($ResourceExists($1_VASP_ChildVASP_$memory, a), $ResourceExists($1_VASP_ChildVASP_$memory#92, a))));

    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@93](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@93](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    assume {:print "$at(33,10619,10768)"} true;
    assert {:msg "assert_failed(33,10619,10768): post-condition does not hold"}
      (forall parent: int :: $IsValid'address'(parent) ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory#93, parent))  ==> ($IsEqual'u64'($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory, parent), $1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#93, parent))));

    // return $t1 at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    $ret0 := $t1;
    return;

}

// fun VASP::is_parent [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:156:5+82
procedure {:timeLimit 40} $1_VASP_is_parent$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_VASP_ChildVASP_$memory#90: $Memory $1_VASP_ChildVASP;
    var $1_VASP_ParentVASP_$memory#91: $Memory $1_VASP_ParentVASP;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:156:5+82
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume {:print "$at(33,6962,7044)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:162:17+6
    assume {:print "$at(33,7137,7143)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:162:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // @90 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:156:5+1
    assume {:print "$at(33,6962,6963)"} true;
    $1_VASP_ChildVASP_$memory#90 := $1_VASP_ChildVASP_$memory;

    // @91 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:156:5+1
    $1_VASP_ParentVASP_$memory#91 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:156:5+1
    assume {:print "$track_local(20,2,0):", $t0} $t0 == $t0;

    // $t1 := exists<VASP::ParentVASP>($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:157:9+6
    assume {:print "$at(33,7014,7020)"} true;
    $t1 := $ResourceExists($1_VASP_ParentVASP_$memory, $t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:157:9+24
    assume {:print "$track_return(20,2,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:158:5+1
    assume {:print "$at(33,7043,7044)"} true;
L1:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/VASP.move:161:9+16
    assume {:print "$at(33,7104,7120)"} true;
    assert {:msg "assert_failed(33,7104,7120): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, VASP::$is_parent($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:162:9+34
    assume {:print "$at(33,7129,7163)"} true;
    assert {:msg "assert_failed(33,7129,7163): post-condition does not hold"}
      $IsEqual'bool'($t1, $1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0));

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@90]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:254:9+78
    assume {:print "$at(33,10484,10562)"} true;
    assert {:msg "assert_failed(33,10484,10562): post-condition does not hold"}
      (forall a: int :: $IsValid'address'(a) ==> ($IsEqual'bool'($ResourceExists($1_VASP_ChildVASP_$memory, a), $ResourceExists($1_VASP_ChildVASP_$memory#90, a))));

    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@91](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@91](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    assume {:print "$at(33,10619,10768)"} true;
    assert {:msg "assert_failed(33,10619,10768): post-condition does not hold"}
      (forall parent: int :: $IsValid'address'(parent) ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory#91, parent))  ==> ($IsEqual'u64'($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory, parent), $1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#91, parent))));
...
// fun VASP::is_same_vasp [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:190:5+179
procedure {:timeLimit 40} $1_VASP_is_same_vasp$verify(_$t0: int, _$t1: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:190:5+179
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume {:print "$at(33,7875,8054)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:196:17+6
    assume {:print "$at(33,8150,8156)"} true;
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:196:17+6
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:196:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:196:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // @113 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:190:5+1
    assume {:print "$at(33,7875,7876)"} true;
    $1_VASP_ChildVASP_$memory#113 := $1_VASP_ChildVASP_$memory;

    // @114 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:190:5+1
    $1_VASP_ParentVASP_$memory#114 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr1]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:190:5+1
    assume {:print "$track_local(20,3,0):", $t0} $t0 == $t0;

    // trace_local[addr2]($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:190:5+1
    assume {:print "$track_local(20,3,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+14
    // >> opaque call: $t4 := VASP::is_vasp($t0)
    assume {:print "$at(33,7966,7980)"} true;

    // $t4 := opaque begin: VASP::is_vasp($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+14

    // assume WellFormed($t4) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+14
    assume $IsValid'bool'($t4);

    // assume Eq<bool>($t4, VASP::$is_vasp($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+14
    assume $IsEqual'bool'($t4, $1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0));

    // $t4 := opaque end: VASP::is_vasp($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+14

    // if ($t4) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+32
    if ($t4) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+32
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+32
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:35+5
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:191:27+14
    // >> opaque call: $t5 := VASP::is_vasp($t1)

    // $t5 := opaque begin: VASP::is_vasp($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:27+14

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:27+14
    assume $IsValid'bool'($t5);

    // assume Eq<bool>($t5, VASP::$is_vasp($t1)) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:27+14
    assume $IsEqual'bool'($t5, $1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t1));

    // $t5 := opaque end: VASP::is_vasp($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:27+14

    // $t2 := $t5 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+32
    $t2 := $t5;

    // trace_local[tmp#$2]($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+32
    assume {:print "$track_local(20,3,2):", $t5} $t5 == $t5;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+32
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+32
L2:

    // $t6 := false at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+32
    $t6 := false;
    assume $IsValid'bool'($t6);

    // $t2 := $t6 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+32
    $t2 := $t6;

    // trace_local[tmp#$2]($t6) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+32
    assume {:print "$track_local(20,3,2):", $t6} $t6 == $t6;

    // label L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+32
L3:

    // if ($t2) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
    if ($t2) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
L5:

    // goto L6 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
    goto L6;

    // label L4 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:60+5
L4:

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21
    // >> opaque call: $t7 := VASP::parent_address($t0)

    // $t7 := opaque begin: VASP::parent_address($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21

    // assume Identical($t8, And(Not(VASP::$is_parent($t0)), Not(VASP::$is_child($t0)))) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21
    assume ($t8 == (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0)));

    // if ($t8) goto L11 else goto L10 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21
    if ($t8) { goto L11; } else { goto L10; }

    // label L11 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21
L11:

    // assume And(And(Not(VASP::$is_parent($t0)), Not(VASP::$is_child($t0))), Eq(7, $t9)) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21
    assume ((!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0)) && $IsEqual'u8'(7, $t9));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21
    assume {:print "$at(33,8002,8023)"} true;
    assume {:print "$track_abort(20,3):", $t9} $t9 == $t9;

    // goto L9 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21
    goto L9;

    // label L10 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21
L10:

    // assume WellFormed($t7) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21
    assume $IsValid'address'($t7);

    // assume Eq<address>($t7, VASP::spec_parent_address($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21
    assume $IsEqual'address'($t7, $1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0));

    // $t7 := opaque end: VASP::parent_address($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:45+21

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21
    // >> opaque call: $t8 := VASP::parent_address($t1)

    // $t10 := opaque begin: VASP::parent_address($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21

    // assume Identical($t11, And(Not(VASP::$is_parent($t1)), Not(VASP::$is_child($t1)))) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21
    assume ($t11 == (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t1) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t1)));

    // if ($t11) goto L13 else goto L12 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21
    if ($t11) { goto L13; } else { goto L12; }

    // label L13 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21
L13:

    // assume And(And(Not(VASP::$is_parent($t1)), Not(VASP::$is_child($t1))), Eq(7, $t9)) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21
    assume ((!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t1) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t1)) && $IsEqual'u8'(7, $t9));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21
    assume {:print "$at(33,8027,8048)"} true;
    assume {:print "$track_abort(20,3):", $t9} $t9 == $t9;

    // goto L9 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21
    goto L9;

    // label L12 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21
L12:

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21
    assume $IsValid'address'($t10);

    // assume Eq<address>($t10, VASP::spec_parent_address($t1)) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21
    assume $IsEqual'address'($t10, $1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t1));

    // $t10 := opaque end: VASP::parent_address($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:70+21

    // $t12 := ==($t7, $t10) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:67+2
    $t12 := $IsEqual'address'($t7, $t10);

    // $t3 := $t12 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
    $t3 := $t12;

    // trace_local[tmp#$3]($t12) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
    assume {:print "$track_local(20,3,3):", $t12} $t12 == $t12;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
    goto L7;

    // label L6 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
L6:

    // $t13 := false at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
    $t13 := false;
    assume $IsValid'bool'($t13);

    // $t3 := $t13 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
    $t3 := $t13;

    // trace_local[tmp#$3]($t13) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
    assume {:print "$track_local(20,3,3):", $t13} $t13 == $t13;

    // label L7 at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
L7:

    // trace_return[0]($t3) at /home/ying/diem/language/diem-framework/modules/VASP.move:191:9+82
    assume {:print "$track_return(20,3,0):", $t3} $t3 == $t3;

    // label L8 at /home/ying/diem/language/diem-framework/modules/VASP.move:192:5+1
    assume {:print "$at(33,8053,8054)"} true;
L8:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/VASP.move:195:9+16
    assume {:print "$at(33,8117,8133)"} true;
    assert {:msg "assert_failed(33,8117,8133): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t3, VASP::spec_is_same_vasp($t0, $t1)) at /home/ying/diem/language/diem-framework/modules/VASP.move:196:9+50
    assume {:print "$at(33,8142,8192)"} true;
    assert {:msg "assert_failed(33,8142,8192): post-condition does not hold"}
      $IsEqual'bool'($t3, $1_VASP_spec_is_same_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0, $t1));

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@113]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:254:9+78
    assume {:print "$at(33,10484,10562)"} true;
    assert {:msg "assert_failed(33,10484,10562): post-condition does not hold"}
    ...
    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@114](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@114](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    assume {:print "$at(33,10619,10768)"} true;
    assert {:msg "assert_failed(33,10619,10768): post-condition does not hold"}
    ...
    // return $t3 at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    $ret0 := $t3;
    return;

    // label L9 at /home/ying/diem/language/diem-framework/modules/VASP.move:192:5+1
    assume {:print "$at(33,8053,8054)"} true;
L9:

    // assert false at /home/ying/diem/language/diem-framework/modules/VASP.move:193:5+139
    assume {:print "$at(33,8059,8198)"} true;
    assert {:msg "assert_failed(33,8059,8198): abort not covered by any of the `aborts_if` clauses"}
      false;

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:193:5+139
    $abort_code := $t9;
    $abort_flag := true;
    return;
...
// fun VASP::is_vasp [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:176:5+89
procedure {:timeLimit 40} $1_VASP_is_vasp$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_VASP_ChildVASP_$memory#94: $Memory $1_VASP_ChildVASP;
    var $1_VASP_ParentVASP_$memory#95: $Memory $1_VASP_ParentVASP;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:176:5+89
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume {:print "$at(33,7474,7563)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:182:17+6
    assume {:print "$at(33,7654,7660)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:182:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:182:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // @94 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:176:5+1
    assume {:print "$at(33,7474,7475)"} true;
    $1_VASP_ChildVASP_$memory#94 := $1_VASP_ChildVASP_$memory;

    // @95 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:176:5+1
    $1_VASP_ParentVASP_$memory#95 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:176:5+1
    assume {:print "$track_local(20,4,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+15
    // >> opaque call: $t2 := VASP::is_parent($t0)
    assume {:print "$at(33,7524,7539)"} true;

    // $t2 := opaque begin: VASP::is_parent($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+15

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+15
    assume $IsValid'bool'($t2);

    // assume Eq<bool>($t2, VASP::$is_parent($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+15
    assume $IsEqual'bool'($t2, $1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0));

    // $t2 := opaque end: VASP::is_parent($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+15

    // if ($t2) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
    if ($t2) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
L0:

    // $t3 := true at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
    $t3 := true;
    assume $IsValid'bool'($t3);

    // $t1 := $t3 at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
    $t1 := $t3;

    // trace_local[tmp#$1]($t3) at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
    assume {:print "$track_local(20,4,1):", $t3} $t3 == $t3;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:177:37+4
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:177:28+14
    // >> opaque call: $t4 := VASP::is_child($t0)

    // $t4 := opaque begin: VASP::is_child($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:177:28+14

    // assume WellFormed($t4) at /home/ying/diem/language/diem-framework/modules/VASP.move:177:28+14
    assume $IsValid'bool'($t4);

    // assume Eq<bool>($t4, VASP::$is_child($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:177:28+14
    assume $IsEqual'bool'($t4, $1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0));

    // $t4 := opaque end: VASP::is_child($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:177:28+14

    // $t1 := $t4 at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
    $t1 := $t4;

    // trace_local[tmp#$1]($t4) at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
    assume {:print "$track_local(20,4,1):", $t4} $t4 == $t4;

    // label L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
L3:

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:177:9+33
    assume {:print "$track_return(20,4,0):", $t1} $t1 == $t1;

    // label L4 at /home/ying/diem/language/diem-framework/modules/VASP.move:178:5+1
    assume {:print "$at(33,7562,7563)"} true;
L4:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/VASP.move:181:9+16
    assume {:print "$at(33,7621,7637)"} true;
    assert {:msg "assert_failed(33,7621,7637): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, VASP::$is_vasp($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:182:9+32
    assume {:print "$at(33,7646,7678)"} true;
    assert {:msg "assert_failed(33,7646,7678): post-condition does not hold"}
      $IsEqual'bool'($t1, $1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0));

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@94]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:254:9+78
    assume {:print "$at(33,10484,10562)"} true;
    assert {:msg "assert_failed(33,10484,10562): post-condition does not hold"}
      (forall a: int :: $IsValid'address'(a) ==> ($IsEqual'bool'($ResourceExists($1_VASP_ChildVASP_$memory, a), $ResourceExists($1_VASP_ChildVASP_$memory#94, a))));

    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@95](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@95](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    assume {:print "$at(33,10619,10768)"} true;
    assert {:msg "assert_failed(33,10619,10768): post-condition does not hold"}
      (forall parent: int :: $IsValid'address'(parent) ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory#95, parent))  ==> ($IsEqual'u64'($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory, parent), $1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#95, parent))));
...
// fun VASP::num_children [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:208:5+225
procedure {:timeLimit 40} $1_VASP_num_children$verify(_$t0: int) returns ($ret0: int)
{
    ...
    var $temp_0'address': int;
    var $temp_0'u64': int;
    var $1_VASP_ChildVASP_$memory#100: $Memory $1_VASP_ChildVASP;
    var $1_VASP_ParentVASP_$memory#101: $Memory $1_VASP_ParentVASP;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:208:5+225
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume {:print "$at(33,8741,8966)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:208:5+225
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:208:5+225
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:208:5+225
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // @100 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:208:5+1
    $1_VASP_ChildVASP_$memory#100 := $1_VASP_ChildVASP_$memory;

    // @101 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:208:5+1
    $1_VASP_ParentVASP_$memory#101 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:208:5+1
    assume {:print "$track_local(20,5,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20
    // >> opaque call: $t1 := VASP::parent_address($t0)
    assume {:print "$at(33,8926,8946)"} true;

    // $t1 := opaque begin: VASP::parent_address($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20

    // assume Identical($t2, And(Not(VASP::$is_parent($t0)), Not(VASP::$is_child($t0)))) at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20
    assume ($t2 == (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0)));

    // if ($t2) goto L4 else goto L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20
    if ($t2) { goto L4; } else { goto L3; }

    // label L4 at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20
L4:

    // assume And(And(Not(VASP::$is_parent($t0)), Not(VASP::$is_child($t0))), Eq(7, $t3)) at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20
    assume ((!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0)) && $IsEqual'u8'(7, $t3));

    // trace_abort($t3) at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20
    assume {:print "$at(33,8926,8946)"} true;
    assume {:print "$track_abort(20,5):", $t3} $t3 == $t3;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20
    goto L2;

    // label L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20
L3:

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20
    assume $IsValid'address'($t1);

    // assume Eq<address>($t1, VASP::spec_parent_address($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20
    assume $IsEqual'address'($t1, $1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0));

    // $t1 := opaque end: VASP::parent_address($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:210:37+20

    // $t4 := get_global<VASP::ParentVASP>($t1) on_abort goto L2 with $t3 at /home/ying/diem/language/diem-framework/modules/VASP.move:210:11+13
    ...
    if ($abort_flag) {
        assume {:print "$at(33,8900,8913)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(20,5):", $t3} $t3 == $t3;
        goto L2;
    }

    // $t5 := get_field<VASP::ParentVASP>.num_children($t4) at /home/ying/diem/language/diem-framework/modules/VASP.move:210:10+61
    $t5 := $num_children#$1_VASP_ParentVASP($t4);

    // trace_return[0]($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:210:9+62
    assume {:print "$track_return(20,5,0):", $t5} $t5 == $t5;

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:211:5+1
    assume {:print "$at(33,8965,8966)"} true;
L1:

    // assert Not(Not(VASP::$is_vasp[@100, @101]($t0))) at /home/ying/diem/language/diem-framework/modules/VASP.move:213:9+55
    assume {:print "$at(33,8999,9054)"} true;
    assert {:msg "assert_failed(33,8999,9054): function does not abort under this condition"}
      !!$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#100, $1_VASP_ParentVASP_$memory#101, $t0);

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@100]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:254:9+78
    assume {:print "$at(33,10484,10562)"} true;
    assert {:msg "assert_failed(33,10484,10562): post-condition does not hold"}
      (forall a: int :: $IsValid'address'(a) ==> ($IsEqual'bool'($ResourceExists($1_VASP_ChildVASP_$memory, a), $ResourceExists($1_VASP_ChildVASP_$memory#100, a))));

    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@101](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@101](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    assume {:print "$at(33,10619,10768)"} true;
    assert {:msg "assert_failed(33,10619,10768): post-condition does not hold"}
      (forall parent: int :: $IsValid'address'(parent) ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory#101, parent))  ==> ($IsEqual'u64'($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory, parent), $1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#101, parent))));

    // return $t5 at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    $ret0 := $t5;
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:211:5+1
    assume {:print "$at(33,8965,8966)"} true;
L2:

    // assert Not(VASP::$is_vasp[@100, @101]($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:212:5+89
    assume {:print "$at(33,8971,9060)"} true;
    assert {:msg "assert_failed(33,8971,9060): abort not covered by any of the `aborts_if` clauses"}
      !$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#100, $1_VASP_ParentVASP_$memory#101, $t0);

    // assert And(Not(VASP::$is_vasp[@100, @101]($t0)), Eq(7, $t3)) at /home/ying/diem/language/diem-framework/modules/VASP.move:212:5+89
    assert {:msg "assert_failed(33,8971,9060): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#100, $1_VASP_ParentVASP_$memory#101, $t0) && $IsEqual'u8'(7, $t3));

    // abort($t3) at /home/ying/diem/language/diem-framework/modules/VASP.move:212:5+89
    $abort_code := $t3;
    $abort_flag := true;
    return;
...
// fun VASP::parent_address [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:127:5+334
procedure {:timeLimit 40} $1_VASP_parent_address$verify(_$t0: int) returns ($ret0: int)
{
    ...
    var $t0: int;
    var $temp_0'address': int;
    var $1_VASP_ParentVASP_$memory#96: $Memory $1_VASP_ParentVASP;
    var $1_VASP_ChildVASP_$memory#97: $Memory $1_VASP_ChildVASP;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:127:5+334
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume {:print "$at(33,5930,6264)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:139:17+6
    assume {:print "$at(33,6415,6421)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:139:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:139:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // @97 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:127:5+1
    assume {:print "$at(33,5930,5931)"} true;
    $1_VASP_ChildVASP_$memory#97 := $1_VASP_ChildVASP_$memory;

    // @96 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:127:5+1
    $1_VASP_ParentVASP_$memory#96 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:127:5+1
    assume {:print "$track_local(20,6,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:128:13+15
    // >> opaque call: $t3 := VASP::is_parent($t0)
    assume {:print "$at(33,6013,6028)"} true;

    // $t3 := opaque begin: VASP::is_parent($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:128:13+15

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/VASP.move:128:13+15
    assume $IsValid'bool'($t3);

    // assume Eq<bool>($t3, VASP::$is_parent($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:128:13+15
    assume $IsEqual'bool'($t3, $1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0));

    // $t3 := opaque end: VASP::is_parent($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:128:13+15

    // if ($t3) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:128:9+249
    if ($t3) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:128:9+249
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:128:9+249
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/VASP.move:129:13+4
    assume {:print "$at(33,6044,6048)"} true;
L0:

    // $t2 := $t0 at /home/ying/diem/language/diem-framework/modules/VASP.move:128:9+249
    assume {:print "$at(33,6009,6258)"} true;
    $t2 := $t0;

    // trace_local[tmp#$2]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:128:9+249
    assume {:print "$track_local(20,6,2):", $t0} $t0 == $t0;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:128:9+249
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:130:29+4
    assume {:print "$at(33,6077,6081)"} true;
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:130:20+14
    // >> opaque call: $t4 := VASP::is_child($t0)

    // $t4 := opaque begin: VASP::is_child($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:130:20+14

    // assume WellFormed($t4) at /home/ying/diem/language/diem-framework/modules/VASP.move:130:20+14
    assume $IsValid'bool'($t4);

    // assume Eq<bool>($t4, VASP::$is_child($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:130:20+14
    assume $IsEqual'bool'($t4, $1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0));

    // $t4 := opaque end: VASP::is_child($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:130:20+14

    // if ($t4) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/VASP.move:130:16+194
    if ($t4) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/VASP.move:133:44+11
    assume {:print "$at(33,6235,6246)"} true;
L5:

    // $t5 := 2 at /home/ying/diem/language/diem-framework/modules/VASP.move:133:44+11
    $t5 := 2;
    assume $IsValid'u64'($t5);

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:133:18+39
    // >> opaque call: $t6 := Errors::invalid_argument($t5)

    // $t6 := opaque begin: Errors::invalid_argument($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:133:18+39

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/VASP.move:133:18+39
    assume $IsValid'u64'($t6);

    // assume Eq<u64>($t6, 7) at /home/ying/diem/language/diem-framework/modules/VASP.move:133:18+39
    assume $IsEqual'u64'($t6, 7);

    // $t6 := opaque end: Errors::invalid_argument($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:133:18+39

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/VASP.move:133:13+44
    assume {:print "$at(33,6204,6248)"} true;
    assume {:print "$track_abort(20,6):", $t6} $t6 == $t6;

    // $t7 := move($t6) at /home/ying/diem/language/diem-framework/modules/VASP.move:133:13+44
    $t7 := $t6;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/VASP.move:133:13+44
    goto L7;

    // label L4 at /home/ying/diem/language/diem-framework/modules/VASP.move:131:38+4
    assume {:print "$at(33,6123,6127)"} true;
L4:

    // $t8 := get_global<VASP::ChildVASP>($t0) on_abort goto L7 with $t7 at /home/ying/diem/language/diem-framework/modules/VASP.move:131:13+13
    ...
    if ($abort_flag) {
        assume {:print "$at(33,6098,6111)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(20,6):", $t7} $t7 == $t7;
        goto L7;
    }

    // $t9 := get_field<VASP::ChildVASP>.parent_vasp_addr($t8) at /home/ying/diem/language/diem-framework/modules/VASP.move:131:13+47
    $t9 := $parent_vasp_addr#$1_VASP_ChildVASP($t8);

    // trace_local[tmp#$1]($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:130:16+194
    assume {:print "$at(33,6064,6258)"} true;
    assume {:print "$track_local(20,6,1):", $t9} $t9 == $t9;

    // $t2 := $t9 at /home/ying/diem/language/diem-framework/modules/VASP.move:128:9+249
    assume {:print "$at(33,6009,6258)"} true;
    $t2 := $t9;

    // trace_local[tmp#$2]($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:128:9+249
    assume {:print "$track_local(20,6,2):", $t9} $t9 == $t9;

    // label L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:128:9+249
L3:

    // trace_return[0]($t2) at /home/ying/diem/language/diem-framework/modules/VASP.move:128:9+249
    assume {:print "$track_return(20,6,0):", $t2} $t2 == $t2;

    // label L6 at /home/ying/diem/language/diem-framework/modules/VASP.move:135:5+1
    assume {:print "$at(33,6263,6264)"} true;
L6:

    // assert Not(And(Not(VASP::$is_parent[@96]($t0)), Not(VASP::$is_child[@97]($t0)))) at /home/ying/diem/language/diem-framework/modules/VASP.move:138:9+76
    assume {:print "$at(33,6322,6398)"} true;
    assert {:msg "assert_failed(33,6322,6398): function does not abort under this condition"}
      !(!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#96, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory#97, $t0));

    // assert Eq<address>($t2, VASP::spec_parent_address($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:139:9+44
    assume {:print "$at(33,6407,6451)"} true;
    assert {:msg "assert_failed(33,6407,6451): post-condition does not hold"}
      $IsEqual'address'($t2, $1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0));

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@97]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:254:9+78
    assume {:print "$at(33,10484,10562)"} true;
    assert {:msg "assert_failed(33,10484,10562): post-condition does not hold"}
      (forall a: int :: $IsValid'address'(a) ==> ($IsEqual'bool'($ResourceExists($1_VASP_ChildVASP_$memory, a), $ResourceExists($1_VASP_ChildVASP_$memory#97, a))));

    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@96](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@96](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    assume {:print "$at(33,10619,10768)"} true;
    assert {:msg "assert_failed(33,10619,10768): post-condition does not hold"}
      (forall parent: int :: $IsValid'address'(parent) ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory#96, parent))  ==> ($IsEqual'u64'($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory, parent), $1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#96, parent))));

    // return $t2 at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    $ret0 := $t2;
    return;

    // label L7 at /home/ying/diem/language/diem-framework/modules/VASP.move:135:5+1
    assume {:print "$at(33,6263,6264)"} true;
L7:

    // assert And(Not(VASP::$is_parent[@96]($t0)), Not(VASP::$is_child[@97]($t0))) at /home/ying/diem/language/diem-framework/modules/VASP.move:136:5+188
    assume {:print "$at(33,6269,6457)"} true;
    assert {:msg "assert_failed(33,6269,6457): abort not covered by any of the `aborts_if` clauses"}
      (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#96, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory#97, $t0));

    // assert And(And(Not(VASP::$is_parent[@96]($t0)), Not(VASP::$is_child[@97]($t0))), Eq(7, $t7)) at /home/ying/diem/language/diem-framework/modules/VASP.move:136:5+188
    assert {:msg "assert_failed(33,6269,6457): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#96, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory#97, $t0)) && $IsEqual'u8'(7, $t7));

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/VASP.move:136:5+188
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun VASP::publish_child_vasp_credential [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+896
procedure {:timeLimit 40} $1_VASP_publish_child_vasp_credential$verify(_$t0: int, _$t1: int) returns ()
{
    // declare local variables
    var $t2: int;
    var $t3: $Mutation (int);
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_VASP_ChildVASP_$memory#118: $Memory $1_VASP_ChildVASP;
    var $1_VASP_ParentVASP_$memory#119: $Memory $1_VASP_ParentVASP;
    var $1_Roles_RoleId_$memory#120: $Memory $1_Roles_RoleId;
    var $1_VASP_ParentVASP_$memory#243: $Memory $1_VASP_ParentVASP;
    var $1_VASP_ChildVASP_$memory#244: $Memory $1_VASP_ChildVASP;
    ...
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+896
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+896
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+896
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+896
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+896
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+896
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));
    ...
    // @120 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+1
    assume {:print "$at(33,3032,3033)"} true;
    $1_Roles_RoleId_$memory#120 := $1_Roles_RoleId_$memory;

    // @118 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+1
    $1_VASP_ChildVASP_$memory#118 := $1_VASP_ChildVASP_$memory;

    // @119 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+1
    $1_VASP_ParentVASP_$memory#119 := $1_VASP_ParentVASP_$memory;
...
L4:
    ...
    // @244 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+896
    // state save for global update invariants
    assume {:print "$at(33,3032,3928)"} true;
    $1_VASP_ChildVASP_$memory#244 := $1_VASP_ChildVASP_$memory;

    // @243 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:71:5+896
    $1_VASP_ParentVASP_$memory#243 := $1_VASP_ParentVASP_$memory;

    // write_back[VASP::ParentVASP@]($t27) at /home/ying/diem/language/diem-framework/modules/VASP.move:84:9+33
    assume {:print "$at(33,3832,3865)"} true;
    $1_VASP_ParentVASP_$memory := $ResourceUpdate($1_VASP_ParentVASP_$memory, $GlobalLocationAddress($t27),
        $Dereference($t27));

    // assert forall addr: TypeDomain<address>() where VASP::$is_parent[@243](addr): VASP::$is_parent(addr) at /home/ying/diem/language/diem-framework/modules/VASP.move:225:9+94
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:225:9+94
    assume {:print "$at(33,9420,9514)"} true;
    assert {:msg "assert_failed(33,9420,9514): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory#243, addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, addr)));

    // assert forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume {:print "$at(33,9681,9832)"} true;
    assert {:msg "assert_failed(33,9681,9832): global memory invariant does not hold"}
    ...
    // assert forall a: TypeDomain<address>() where VASP::$is_child[@244](a): Eq<address>(VASP::spec_parent_address(a), VASP::spec_parent_address[@244, @243](a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:267:9+125
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:267:9+125
    assume {:print "$at(33,10919,11044)"} true;
    assert {:msg "assert_failed(33,10919,11044): global memory invariant does not hold"}
      (forall a: int :: $IsValid'address'(a) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory#244, a))  ==> ($IsEqual'address'($1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, a), $1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory#244, $1_VASP_ParentVASP_$memory#243, a))));
    ...
    // @245 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:267:9+125
    // state save for global update invariants
    assume {:print "$at(33,10919,11044)"} true;
    $1_VASP_ChildVASP_$memory#245 := $1_VASP_ChildVASP_$memory;

    // @246 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:267:9+125
    ...
    // assert forall addr: TypeDomain<address>() where VASP::$is_child[@245](addr): VASP::$is_child(addr) at /home/ying/diem/language/diem-framework/modules/VASP.move:228:9+92
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:228:9+92
    assume {:print "$at(33,9524,9616)"} true;
    assert {:msg "assert_failed(33,9524,9616): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory#245, addr))  ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, addr)));
    ...
    // assert forall a: TypeDomain<address>() where VASP::$is_child[@245](a): Eq<address>(VASP::spec_parent_address(a), VASP::spec_parent_address[@245, @246](a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:267:9+125
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:267:9+125
    assume {:print "$at(33,10919,11044)"} true;
    assert {:msg "assert_failed(33,10919,11044): global memory invariant does not hold"}
      (forall a: int :: $IsValid'address'(a) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory#245, a))  ==> ($IsEqual'address'($1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, a), $1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory#245, $1_VASP_ParentVASP_$memory#246, a))));

    // label L6 at /home/ying/diem/language/diem-framework/modules/VASP.move:86:5+1
    assume {:print "$at(33,3927,3928)"} true;
L6:

    // assert Not(VASP::$is_vasp[@118, @119]($t11)) at /home/ying/diem/language/diem-framework/modules/VASP.move:101:9+61
    assume {:print "$at(33,4712,4773)"} true;
    assert {:msg "assert_failed(33,4712,4773): function does not abort under this condition"}
      !$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#118, $1_VASP_ParentVASP_$memory#119, $t11);

    // assert Not(Not(VASP::$is_parent[@119]($t12))) at /home/ying/diem/language/diem-framework/modules/VASP.move:102:9+64
    assume {:print "$at(33,4782,4846)"} true;
    assert {:msg "assert_failed(33,4782,4846): function does not abort under this condition"}
      !!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#119, $t12);

    // assert Not(Gt(Add(VASP::spec_num_children[@119]($t12), 1), 65536)) at /home/ying/diem/language/diem-framework/modules/VASP.move:103:9+94
    assume {:print "$at(33,4855,4949)"} true;
    assert {:msg "assert_failed(33,4855,4949): function does not abort under this condition"}
      !(($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#119, $t12) + 1) > 65536);

    // assert Not(Not(exists[@120]<Roles::RoleId>($t13))) at /home/ying/diem/language/diem-framework/modules/Roles.move:543:9+59
    assume {:print "$at(26,24362,24421)"} true;
    assert {:msg "assert_failed(26,24362,24421): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#120, $t13);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@120]<Roles::RoleId>($t13)), 5)) at /home/ying/diem/language/diem-framework/modules/Roles.move:544:9+89
    assume {:print "$at(26,24430,24519)"} true;
    assert {:msg "assert_failed(26,24430,24519): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#120, $t13)), 5);

    // assert Not(Not(exists[@120]<Roles::RoleId>($t11))) at /home/ying/diem/language/diem-framework/modules/Roles.move:549:9+62
    assume {:print "$at(26,24600,24662)"} true;
    assert {:msg "assert_failed(26,24600,24662): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#120, $t11);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@120]<Roles::RoleId>($t11)), 6)) at /home/ying/diem/language/diem-framework/modules/Roles.move:550:9+91
    assume {:print "$at(26,24671,24762)"} true;
    assert {:msg "assert_failed(26,24671,24762): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#120, $t11)), 6);

    // assert Eq<u64>(VASP::spec_num_children(Signer::spec_address_of($t0)), Add(VASP::spec_num_children[@119](Signer::spec_address_of[]($t0)), 1)) at /home/ying/diem/language/diem-framework/modules/VASP.move:109:9+82
    assume {:print "$at(33,5066,5148)"} true;
    assert {:msg "assert_failed(33,5066,5148): post-condition does not hold"}
      $IsEqual'u64'($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory, $1_Signer_spec_address_of($t0)), ($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#119, $1_Signer_spec_address_of($t0)) + 1));

    // assert VASP::$is_child($t11) at /home/ying/diem/language/diem-framework/modules/VASP.move:110:9+29
    ...
    // assert Eq<address>(VASP::spec_parent_address($t11), Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:111:9+55
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/VASP.move:111:9+55
    return;
...
L7:
    ...
    // assert Or(Or(Or(Or(Or(Or(VASP::$is_vasp[@118, @119]($t11), Not(VASP::$is_parent[@119]($t12))), Gt(Add(VASP::spec_num_children[@119]($t12), 1), 65536)), Not(exists[@120]<Roles::RoleId>($t13))), Neq<u64>(select Roles::RoleId.role_id(global[@120]<Roles::RoleId>($t13)), 5)), Not(exists[@120]<Roles::RoleId>($t11))), Neq<u64>(select Roles::RoleId.role_id(global[@120]<Roles::RoleId>($t11)), 6)) at /home/ying/diem/language/diem-framework/modules/VASP.move:87:5+551
    assume {:print "$at(33,3933,4484)"} true;
    assert {:msg "assert_failed(33,3933,4484): abort not covered by any of the `aborts_if` clauses"}
      (((((($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#118, $1_VASP_ParentVASP_$memory#119, $t11) || !$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#119, $t12)) || (($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#119, $t12) + 1) > 65536)) || !$ResourceExists($1_Roles_RoleId_$memory#120, $t13)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#120, $t13)), 5)) || !$ResourceExists($1_Roles_RoleId_$memory#120, $t11)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#120, $t11)), 6));

    // assert Or(Or(Or(Or(Or(Or(And(VASP::$is_vasp[@118, @119]($t11), Eq(6, $t16)), And(Not(VASP::$is_parent[@119]($t12)), Eq(7, $t16))), And(Gt(Add(VASP::spec_num_children[@119]($t12), 1), 65536), Eq(8, $t16))), And(Not(exists[@120]<Roles::RoleId>($t13)), Eq(5, $t16))), And(Neq<u64>(select Roles::RoleId.role_id(global[@120]<Roles::RoleId>($t13)), 5), Eq(3, $t16))), And(Not(exists[@120]<Roles::RoleId>($t11)), Eq(5, $t16))), And(Neq<u64>(select Roles::RoleId.role_id(global[@120]<Roles::RoleId>($t11)), 6), Eq(3, $t16))) at /home/ying/diem/language/diem-framework/modules/VASP.move:87:5+551
    assert {:msg "assert_failed(33,3933,4484): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#118, $1_VASP_ParentVASP_$memory#119, $t11) && $IsEqual'u8'(6, $t16)) || (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#119, $t12) && $IsEqual'u8'(7, $t16))) || ((($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#119, $t12) + 1) > 65536) && $IsEqual'u8'(8, $t16))) || (!$ResourceExists($1_Roles_RoleId_$memory#120, $t13) && $IsEqual'u8'(5, $t16))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#120, $t13)), 5) && $IsEqual'u8'(3, $t16))) || (!$ResourceExists($1_Roles_RoleId_$memory#120, $t11) && $IsEqual'u8'(5, $t16))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#120, $t11)), 6) && $IsEqual'u8'(3, $t16)));

    // abort($t16) at /home/ying/diem/language/diem-framework/modules/VASP.move:87:5+551
    $abort_code := $t16;
    $abort_flag := true;
    return;
...
// fun VASP::publish_parent_vasp_credential [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
procedure {:timeLimit 40} $1_VASP_publish_parent_vasp_credential$verify(_$t0: int, _$t1: int) returns ()
{
    // declare local variables
    var $t2: bool;
    var $t3: int;
    ...
    var $1_VASP_ParentVASP_$memory#247: $Memory $1_VASP_ParentVASP;
    var $1_VASP_ChildVASP_$memory#248: $Memory $1_VASP_ChildVASP;
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(33,1911,2332)"} true;
    ...
    // assume forall addr: TypeDomain<address>() where exists<AccountLimits::Window<#0>>(addr): And(exists<Roles::RoleId>(addr), Or(Eq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(addr)), 5), Eq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(addr)), 6))) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:552:9+318
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_AccountLimits_Window'#0'_$memory, addr))  ==> (($ResourceExists($1_Roles_RoleId_$memory, addr) && ($IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, addr)), 5) || $IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, addr)), 6)))));

    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:234:9+151
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    ...
    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));
    ...
    // @137 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+1
    ...
    // @138 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+1
    $1_Roles_RoleId_$memory#138 := $1_Roles_RoleId_$memory;

    // @139 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+1
    $1_VASP_ChildVASP_$memory#139 := $1_VASP_ChildVASP_$memory;

    // @140 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+1
...
L0:
    ...
    // @248 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    // state save for global update invariants
    assume {:print "$at(33,1911,2332)"} true;
    $1_VASP_ChildVASP_$memory#248 := $1_VASP_ChildVASP_$memory;

    // @247 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:45:5+421
    $1_VASP_ParentVASP_$memory#247 := $1_VASP_ParentVASP_$memory;
    ...
    // assert forall addr: TypeDomain<address>() where VASP::$is_parent[@247](addr): VASP::$is_parent(addr) at /home/ying/diem/language/diem-framework/modules/VASP.move:225:9+94
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:225:9+94
    assume {:print "$at(33,9420,9514)"} true;
    assert {:msg "assert_failed(33,9420,9514): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory#247, addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, addr)));
    ...
    // assert forall a: TypeDomain<address>() where VASP::$is_child[@248](a): Eq<address>(VASP::spec_parent_address(a), VASP::spec_parent_address[@248, @247](a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:267:9+125
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:267:9+125
    assume {:print "$at(33,10919,11044)"} true;
    assert {:msg "assert_failed(33,10919,11044): global memory invariant does not hold"}
      (forall a: int :: $IsValid'address'(a) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory#248, a))  ==> ($IsEqual'address'($1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, a), $1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory#248, $1_VASP_ParentVASP_$memory#247, a))));

    // label L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:52:5+1
    assume {:print "$at(33,2331,2332)"} true;
L2:

    // assert Not(Not(DiemTimestamp::$is_operating[@137]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    ...
    // assert Not(Not(exists[@138]<Roles::RoleId>($t6))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t6)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    ...
    // assert Not(Not(exists[@138]<Roles::RoleId>($t7))) at /home/ying/diem/language/diem-framework/modules/Roles.move:543:9+59
    assume {:print "$at(26,24362,24421)"} true;
    assert {:msg "assert_failed(26,24362,24421): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#138, $t7);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t7)), 5)) at /home/ying/diem/language/diem-framework/modules/Roles.move:544:9+89
    assume {:print "$at(26,24430,24519)"} true;
    assert {:msg "assert_failed(26,24430,24519): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t7)), 5);

    // assert Not(VASP::$is_vasp[@139, @140]($t5)) at /home/ying/diem/language/diem-framework/modules/VASP.move:59:9+60
    assume {:print "$at(33,2628,2688)"} true;
    assert {:msg "assert_failed(33,2628,2688): function does not abort under this condition"}
      !$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#139, $1_VASP_ParentVASP_$memory#140, $t5);

    // assert VASP::$is_parent($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:65:9+29
    ...
    // assert Eq<u64>(VASP::spec_num_children($t5), 0) at /home/ying/diem/language/diem-framework/modules/VASP.move:66:9+42
    ...
    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@139]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:254:9+78
    assume {:print "$at(33,10484,10562)"} true;
    assert {:msg "assert_failed(33,10484,10562): post-condition does not hold"}
      (forall a: int :: $IsValid'address'(a) ==> ($IsEqual'bool'($ResourceExists($1_VASP_ChildVASP_$memory, a), $ResourceExists($1_VASP_ChildVASP_$memory#139, a))));

    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@140](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@140](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    assume {:print "$at(33,10619,10768)"} true;
    assert {:msg "assert_failed(33,10619,10768): post-condition does not hold"}
      (forall parent: int :: $IsValid'address'(parent) ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory#140, parent))  ==> ($IsEqual'u64'($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory, parent), $1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#140, parent))));

    // return () at /home/ying/diem/language/diem-framework/modules/VASP.move:258:9+149
    return;
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_operating[@137]()), Not(exists[@138]<Roles::RoleId>($t6))), Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t6)), 1)), Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), Not(exists[@138]<Roles::RoleId>($t7))), Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t7)), 5)), VASP::$is_vasp[@139, @140]($t5)) at /home/ying/diem/language/diem-framework/modules/VASP.move:54:5+420
    assume {:print "$at(33,2338,2758)"} true;
    assert {:msg "assert_failed(33,2338,2758): abort not covered by any of the `aborts_if` clauses"}
      ((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#137) || !$ResourceExists($1_Roles_RoleId_$memory#138, $t6)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t6)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || !$ResourceExists($1_Roles_RoleId_$memory#138, $t7)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t7)), 5)) || $1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#139, $1_VASP_ParentVASP_$memory#140, $t5));

    // assert Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@137]()), Eq(1, $t9)), And(Not(exists[@138]<Roles::RoleId>($t6)), Eq(5, $t9))), And(Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t6)), 1), Eq(3, $t9))), And(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t9))), And(Not(exists[@138]<Roles::RoleId>($t7)), Eq(5, $t9))), And(Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t7)), 5), Eq(3, $t9))), And(VASP::$is_vasp[@139, @140]($t5), Eq(6, $t9))) at /home/ying/diem/language/diem-framework/modules/VASP.move:54:5+420
    assert {:msg "assert_failed(33,2338,2758): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#137) && $IsEqual'u8'(1, $t9)) || (!$ResourceExists($1_Roles_RoleId_$memory#138, $t6) && $IsEqual'u8'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t6)), 1) && $IsEqual'u8'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t9))) || (!$ResourceExists($1_Roles_RoleId_$memory#138, $t7) && $IsEqual'u8'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t7)), 5) && $IsEqual'u8'(3, $t9))) || ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#139, $1_VASP_ParentVASP_$memory#140, $t5) && $IsEqual'u8'(6, $t9)));

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:54:5+420
    $abort_code := $t9;
    $abort_flag := true;
    return;
...
L7:
    ...
    // @181 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@181](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
L8:
    ...
    // @157 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@157](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
...
L7:
    ...
    // @175 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@175](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L7:
    ...
    // @169 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@169](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
