...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |existsinvectorSmtSeqcvc4bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |existsinvectorSmtSeqcvc4bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |existsinvectorSmtSeqcvc4bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |existsinvectorSmtSeqcvc4bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |existsinvectorSmtSeqcvc4bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |existsinvectorSmtSeqcvc4bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |existsinvectorSmtSeqcvc4bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |existsinvectorSmtSeqcvc4bpl.461:15|
 :skolemid |14|
...
(assert (forall ((v@@4 (Seq Int)) ) (! (= (|$IsValid'vec'u64''| v@@4)  (and (|$IsValid'u64'| (seq.len v@@4)) (forall ((i@@0 Int) ) (!  (=> (and (>= i@@0 0) (< i@@0 (seq.len v@@4))) (|$IsValid'u64'| (seq.nth v@@4 i@@0)))
 :qid |existsinvectorSmtSeqcvc4bpl.590:13|
 :skolemid |15|
))))
 :qid |existsinvectorSmtSeqcvc4bpl.588:29|
 :skolemid |16|
 :pattern ( (|$IsValid'vec'u64''| v@@4))
)))
(assert (forall ((v@@5 (Seq Int)) (e Int) ) (! (let ((i@@1 (|$IndexOfVec'u64'| v@@5 e)))
(ite  (not (exists ((i@@2 Int) ) (!  (and (and (|$IsValid'u64'| i@@2) (and (>= i@@2 0) (< i@@2 (seq.len v@@5)))) (= (seq.nth v@@5 i@@2) e))
 :qid |existsinvectorSmtSeqcvc4bpl.595:13|
 :skolemid |17|
))) (= i@@1 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@1) (and (>= i@@1 0) (< i@@1 (seq.len v@@5)))) (= (seq.nth v@@5 i@@1) e)) (forall ((j Int) ) (!  (=> (and (and (|$IsValid'u64'| j) (>= j 0)) (< j i@@1)) (not (= (seq.nth v@@5 j) e)))
 :qid |existsinvectorSmtSeqcvc4bpl.603:17|
 :skolemid |18|
)))))
 :qid |existsinvectorSmtSeqcvc4bpl.599:15|
 :skolemid |19|
...
(assert (forall ((v@@6 (Seq Int)) ) (! (= (|$IsValid'vec'u8''| v@@6)  (and (|$IsValid'u64'| (seq.len v@@6)) (forall ((i@@3 Int) ) (!  (=> (and (>= i@@3 0) (< i@@3 (seq.len v@@6))) (|$IsValid'u8'| (seq.nth v@@6 i@@3)))
 :qid |existsinvectorSmtSeqcvc4bpl.770:13|
 :skolemid |20|
))))
 :qid |existsinvectorSmtSeqcvc4bpl.768:28|
 :skolemid |21|
 :pattern ( (|$IsValid'vec'u8''| v@@6))
)))
(assert (forall ((v@@7 (Seq Int)) (e@@0 Int) ) (! (let ((i@@4 (|$IndexOfVec'u8'| v@@7 e@@0)))
(ite  (not (exists ((i@@5 Int) ) (!  (and (and (|$IsValid'u64'| i@@5) (and (>= i@@5 0) (< i@@5 (seq.len v@@7)))) (= (seq.nth v@@7 i@@5) e@@0))
 :qid |existsinvectorSmtSeqcvc4bpl.775:13|
 :skolemid |22|
))) (= i@@4 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@4) (and (>= i@@4 0) (< i@@4 (seq.len v@@7)))) (= (seq.nth v@@7 i@@4) e@@0)) (forall ((j@@0 Int) ) (!  (=> (and (and (|$IsValid'u64'| j@@0) (>= j@@0 0)) (< j@@0 i@@4)) (not (= (seq.nth v@@7 j@@0) e@@0)))
 :qid |existsinvectorSmtSeqcvc4bpl.783:17|
 :skolemid |23|
)))))
 :qid |existsinvectorSmtSeqcvc4bpl.779:15|
 :skolemid |24|
 :pattern ( (|$IndexOfVec'u8'| v@@7 e@@0))
)))
(assert (forall ((v1 (Seq Int)) (v2 (Seq Int)) ) (! (= (= v1 v2) (= ($1_Hash_sha2 v1) ($1_Hash_sha2 v2)))
 :qid |existsinvectorSmtSeqcvc4bpl.956:15|
 :skolemid |25|
 :pattern ( ($1_Hash_sha2 v1) ($1_Hash_sha2 v2))
)))
(assert (forall ((v1@@0 (Seq Int)) (v2@@0 (Seq Int)) ) (! (= (= v1@@0 v2@@0) (= ($1_Hash_sha3 v1@@0) ($1_Hash_sha3 v2@@0)))
 :qid |existsinvectorSmtSeqcvc4bpl.972:15|
 :skolemid |26|
 :pattern ( ($1_Hash_sha3 v1@@0) ($1_Hash_sha3 v2@@0))
)))
(assert (forall ((k1 (Seq Int)) (k2 (Seq Int)) ) (!  (=> (= k1 k2) (= ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2)))
 :qid |existsinvectorSmtSeqcvc4bpl.1019:15|
 :skolemid |27|
 :pattern ( ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2))
)))
(assert (forall ((s1 (Seq Int)) (s2 (Seq Int)) (k1@@0 (Seq Int)) (k2@@0 (Seq Int)) (m1 (Seq Int)) (m2 (Seq Int)) ) (!  (=> (and (and (= s1 s2) (= k1@@0 k2@@0)) (= m1 m2)) (= ($1_Signature_$ed25519_verify s1 k1@@0 m1) ($1_Signature_$ed25519_verify s2 k2@@0 m2)))
 :qid |existsinvectorSmtSeqcvc4bpl.1022:15|
 :skolemid |28|
...
(assert (not
 ...
 :qid |existsinvectorSmtSeqcvc4bpl.1128:15|
 :skolemid |32|
 ...
 :qid |existsinvectorSmtSeqcvc4bpl.1133:15|
 :skolemid |33|
...
(= x 0)))
 :qid |existsinvectorSmtSeqcvc4bpl.1077:33|
 :skolemid |29|
))) (let (($range_0@@0 _$t0))
...
(= (seq.nth _$t0 i@@8) 0)))
 :qid |existsinvectorSmtSeqcvc4bpl.1083:52|
 :skolemid |30|
...
(= (seq.nth _$t0 i@@9) 0)))
 ...
 :qid |existsinvectorSmtSeqcvc4bpl.1089:13|
 :skolemid |31|
...
(= x@@2 e@@1)))
 ...
 :qid |existsinvectorSmtSeqcvc4bpl.1153:15|
 :skolemid |34|
...
(= (seq.nth _$t0 i@@15) e@@3)))
 ...
 :qid |existsinvectorSmtSeqcvc4bpl.1158:15|
 :skolemid |35|
...
(= (seq.nth _$t0 i@@15) e@@4)))
 ...
 :qid |existsinvectorSmtSeqcvc4bpl.1163:15|
 :skolemid |36|
))))))))))))))))))))))))
...
(pop 1)
; Valid
(declare-fun _$t0@@0 () T@$Mutation_8473)
...
(assert (not
 (=> (= (ControlFlow 0 0) 13251) (let ((anon0$1_correct@@0  (=> (= (|l#$Mutation_8473| _$t0@@0) ($Param 0)) (=> (and (|$IsValid'vec'u64''| (|v#$Mutation_8473| _$t0@@0)) (= $t1@0 (|v#$Mutation_8473| _$t0@@0))) (=> (and (and (= |$temp_0'vec'u64''@0| (|v#$Mutation_8473| _$t0@@0)) (= |$temp_0'vec'u64''@0| |$temp_0'vec'u64''@0|)) (and (= |$temp_0'vec'u64''@1| (|v#$Mutation_8473| _$t0@@0)) (= |$temp_0'vec'u64''@1| |$temp_0'vec'u64''@1|))) (and (=> (= (ControlFlow 0 12928) (- 0 13343)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 12928) (- 0 13350)) (= $t1@0 (|v#$Mutation_8473| _$t0@@0))) (=> (= $t1@0 (|v#$Mutation_8473| _$t0@@0)) (and (=> (= (ControlFlow 0 12928) (- 0 13359)) (exists ((l@@3 Int) ) (!  (and (|$IsValid'u64'| l@@3) (= l@@3 (seq.len $t1@0)))
 :qid |existsinvectorSmtSeqcvc4bpl.1216:15|
 :skolemid |37|
))) (=> (exists ((l@@4 Int) ) (!  (and (|$IsValid'u64'| l@@4) (= l@@4 (seq.len $t1@0)))
 :qid |existsinvectorSmtSeqcvc4bpl.1216:15|
 :skolemid |37|
)) (and (=> (= (ControlFlow 0 12928) (- 0 13378)) (exists ((l@@5 Int) ) (!  (and (|$IsValid'u64'| l@@5) (= l@@5 (seq.len (|v#$Mutation_8473| _$t0@@0))))
 :qid |existsinvectorSmtSeqcvc4bpl.1221:15|
 :skolemid |38|
))) (=> (exists ((l@@6 Int) ) (!  (and (|$IsValid'u64'| l@@6) (= l@@6 (seq.len (|v#$Mutation_8473| _$t0@@0))))
 :qid |existsinvectorSmtSeqcvc4bpl.1221:15|
 :skolemid |38|
)) (and (=> (= (ControlFlow 0 12928) (- 0 13399)) (exists ((l@@7 Int) ) (!  (and (and (|$IsValid'u64'| l@@7) (= l@@7 (seq.len $t1@0))) (= l@@7 (seq.len (|v#$Mutation_8473| _$t0@@0))))
 :qid |existsinvectorSmtSeqcvc4bpl.1226:15|
 :skolemid |39|
))) (=> (exists ((l@@8 Int) ) (!  (and (and (|$IsValid'u64'| l@@8) (= l@@8 (seq.len $t1@0))) (= l@@8 (seq.len (|v#$Mutation_8473| _$t0@@0))))
 :qid |existsinvectorSmtSeqcvc4bpl.1226:15|
 :skolemid |39|
)) (and (=> (= (ControlFlow 0 12928) (- 0 13429)) (=> (let (($range_0@@3 $t1@0))
(exists (($i_1@@7 Int) ) (!  (and (and (>= $i_1@@7 0) (< $i_1@@7 (seq.len $range_0@@3))) (let ((x@@3 (seq.nth $range_0@@3 $i_1@@7)))
(= x@@3 0)))
 :qid |existsinvectorSmtSeqcvc4bpl.1077:33|
 :skolemid |29|
))) (let (($range_0@@4 (|v#$Mutation_8473| _$t0@@0)))
...
(= x@@4 0)))
 :qid |existsinvectorSmtSeqcvc4bpl.1077:33|
 :skolemid |29|
)))) (and (=> (= (ControlFlow 0 12928) (- 0 13446)) (=> (let (($range_2@@3 ($Range 0 (seq.len $t1@0))))
(exists (($i_3@@7 Int) ) (!  (and ($InRange $range_2@@3 $i_3@@7) (let ((i@@18 $i_3@@7))
(= (seq.nth $t1@0 i@@18) 0)))
 :qid |existsinvectorSmtSeqcvc4bpl.1083:52|
 :skolemid |30|
))) (let (($range_2@@4 ($Range 0 (seq.len (|v#$Mutation_8473| _$t0@@0)))))
(exists (($i_3@@8 Int) ) (!  (and ($InRange $range_2@@4 $i_3@@8) (let ((i@@19 $i_3@@8))
(= (seq.nth (|v#$Mutation_8473| _$t0@@0) i@@19) 0)))
 :qid |existsinvectorSmtSeqcvc4bpl.1083:52|
 :skolemid |30|
...
(= (seq.nth (|v#$Mutation_8473| _$t0@@0) i@@19) 0)))
 :qid |existsinvectorSmtSeqcvc4bpl.1083:52|
 :skolemid |30|
)))) (and (=> (= (ControlFlow 0 12928) (- 0 13463)) (=> (exists ((i@@20 Int) ) (!  (and (and (|$IsValid'u64'| i@@20) (and (<= 0 i@@20) (< i@@20 (seq.len $t1@0)))) (= (seq.nth $t1@0 i@@20) 0))
 :qid |existsinvectorSmtSeqcvc4bpl.1089:13|
 :skolemid |31|
)) (exists ((i@@21 Int) ) (!  (and (and (|$IsValid'u64'| i@@21) (and (<= 0 i@@21) (< i@@21 (seq.len (|v#$Mutation_8473| _$t0@@0))))) (= (seq.nth (|v#$Mutation_8473| _$t0@@0) i@@21) 0))
 :qid |existsinvectorSmtSeqcvc4bpl.1089:13|
 :skolemid |31|
)))) (=> (=> (exists ((i@@22 Int) ) (!  (and (and (|$IsValid'u64'| i@@22) (and (<= 0 i@@22) (< i@@22 (seq.len $t1@0)))) (= (seq.nth $t1@0 i@@22) 0))
 :qid |existsinvectorSmtSeqcvc4bpl.1089:13|
 :skolemid |31|
)) (exists ((i@@23 Int) ) (!  (and (and (|$IsValid'u64'| i@@23) (and (<= 0 i@@23) (< i@@23 (seq.len (|v#$Mutation_8473| _$t0@@0))))) (= (seq.nth (|v#$Mutation_8473| _$t0@@0) i@@23) 0))
 :qid |existsinvectorSmtSeqcvc4bpl.1089:13|
 :skolemid |31|
))) (and (=> (= (ControlFlow 0 12928) (- 0 13480)) (forall ((e@@6 Int) ) (!  (=> (|$IsValid'u64'| e@@6) (=> (let (($range_0@@5 $t1@0))
(exists (($i_1@@11 Int) ) (!  (and (and (>= $i_1@@11 0) (< $i_1@@11 (seq.len $range_0@@5))) (let ((x@@5 (seq.nth $range_0@@5 $i_1@@11)))
(= x@@5 e@@6)))
 :qid |existsinvectorSmtSeqcvc4bpl.1077:33|
 :skolemid |29|
))) (let (($range_0@@6 (|v#$Mutation_8473| _$t0@@0)))
(exists (($i_1@@12 Int) ) (!  (and (and (>= $i_1@@12 0) (< $i_1@@12 (seq.len $range_0@@6))) (let ((x@@6 (seq.nth $range_0@@6 $i_1@@12)))
(= x@@6 e@@6)))
 :qid |existsinvectorSmtSeqcvc4bpl.1077:33|
 :skolemid |29|
)))))
 :qid |existsinvectorSmtSeqcvc4bpl.1246:15|
 :skolemid |40|
...
(= x@@6 e@@7)))
 ...
 :qid |existsinvectorSmtSeqcvc4bpl.1246:15|
 :skolemid |40|
)) (and (=> (= (ControlFlow 0 12928) (- 0 13506)) (forall ((e@@8 Int) ) (!  (=> (|$IsValid'u64'| e@@8) (=> (let (($range_2@@5 ($Range 0 (seq.len $t1@0))))
(exists (($i_3@@11 Int) ) (!  (and ($InRange $range_2@@5 $i_3@@11) (let ((i@@24 $i_3@@11))
(= (seq.nth $t1@0 i@@24) e@@8)))
 :qid |existsinvectorSmtSeqcvc4bpl.1083:52|
 :skolemid |30|
))) (let (($range_2@@6 ($Range 0 (seq.len (|v#$Mutation_8473| _$t0@@0)))))
(exists (($i_3@@12 Int) ) (!  (and ($InRange $range_2@@6 $i_3@@12) (let ((i@@25 $i_3@@12))
(= (seq.nth (|v#$Mutation_8473| _$t0@@0) i@@25) e@@8)))
 :qid |existsinvectorSmtSeqcvc4bpl.1083:52|
 :skolemid |30|
)))))
 :qid |existsinvectorSmtSeqcvc4bpl.1251:15|
 :skolemid |41|
...
(= (seq.nth (|v#$Mutation_8473| _$t0@@0) i@@25) e@@9)))
 :qid |existsinvectorSmtSeqcvc4bpl.1083:52|
 :skolemid |30|
)))))
 :qid |existsinvectorSmtSeqcvc4bpl.1251:15|
 :skolemid |41|
)) (=> (= (ControlFlow 0 12928) (- 0 13532)) (forall ((e@@10 Int) ) (!  (=> (|$IsValid'u64'| e@@10) (=> (exists ((i@@26 Int) ) (!  (and (and (|$IsValid'u64'| i@@26) (and (<= 0 i@@26) (< i@@26 (seq.len $t1@0)))) (= (seq.nth $t1@0 i@@26) e@@10))
 :qid |existsinvectorSmtSeqcvc4bpl.1089:13|
 :skolemid |31|
)) (exists ((i@@27 Int) ) (!  (and (and (|$IsValid'u64'| i@@27) (and (<= 0 i@@27) (< i@@27 (seq.len (|v#$Mutation_8473| _$t0@@0))))) (= (seq.nth (|v#$Mutation_8473| _$t0@@0) i@@27) e@@10))
 :qid |existsinvectorSmtSeqcvc4bpl.1089:13|
 :skolemid |31|
))))
 :qid |existsinvectorSmtSeqcvc4bpl.1256:15|
 :skolemid |42|
))))))))))))))))))))))))))))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 13251) 12928) anon0$1_correct@@0)))
anon0_correct@@0)))
))
(check-sat)
(pop 1)
