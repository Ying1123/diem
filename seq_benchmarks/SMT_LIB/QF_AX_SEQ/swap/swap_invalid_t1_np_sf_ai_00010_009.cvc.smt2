...
(assert (= a_11 (seq.update a_9 i4 (seq.unit e_10))))
(assert (= a_13 (seq.update a_11 i5 (seq.unit e_12))))
(assert (= a_15 (seq.update a_13 i2 (seq.unit e_14))))
(assert (= a_17 (seq.update a_15 i7 (seq.unit e_16))))
(assert (= a_19 (seq.update a_17 i1 (seq.unit e_18))))
(assert (= a_21 (seq.update a_19 i9 (seq.unit e_20))))
(assert (= a_23 (seq.update a_21 i7 (seq.unit e_22))))
(assert (= a_25 (seq.update a_23 i6 (seq.unit e_24))))
(assert (= a_27 (seq.update a_25 i0 (seq.unit e_26))))
(assert (= a_29 (seq.update a_27 i7 (seq.unit e_28))))
(assert (= a_3 (seq.update a_1 i4 (seq.unit e_2))))
(assert (= a_31 (seq.update a_29 i6 (seq.unit e_30))))
(assert (= a_33 (seq.update a_31 i7 (seq.unit e_32))))
(assert (= a_35 (seq.update a_33 i2 (seq.unit e_34))))
(assert (= a_37 (seq.update a_35 i3 (seq.unit e_36))))
(assert (= a_39 (seq.update a_37 i0 (seq.unit e_38))))
(assert (= a_40 (seq.update a_3 i3 (seq.unit e_6))))
(assert (= a_41 (seq.update a_40 i5 (seq.unit e_4))))
(assert (= a_43 (seq.update a_41 i4 (seq.unit e_42))))
(assert (= a_45 (seq.update a_43 i8 (seq.unit e_44))))
(assert (= a_47 (seq.update a_45 i2 (seq.unit e_46))))
...
(assert (= a_53 (seq.update a_51 i7 (seq.unit e_52))))
(assert (= a_55 (seq.update a_53 i7 (seq.unit e_54))))
(assert (= a_57 (seq.update a_55 i9 (seq.unit e_56))))
(assert (= a_59 (seq.update a_57 i6 (seq.unit e_58))))
(assert (= a_61 (seq.update a_59 i0 (seq.unit e_60))))
(assert (= a_63 (seq.update a_61 i7 (seq.unit e_62))))
(assert (= a_65 (seq.update a_63 i6 (seq.unit e_64))))
(assert (= a_67 (seq.update a_65 i2 (seq.unit e_66))))
(assert (= a_69 (seq.update a_67 i7 (seq.unit e_68))))
(assert (= a_7 (seq.update a_5 i3 (seq.unit e_6))))
(assert (= a_71 (seq.update a_69 i4 (seq.unit e_70))))
(assert (= a_73 (seq.update a_71 i0 (seq.unit e_72))))
(assert (= a_9 (seq.update a_7 i8 (seq.unit e_8))))
(assert (= e_0 (seq.nth a1 i4)))
(assert (= e_10 (seq.nth a_7 i8)))
(assert (= e_12 (seq.nth a_11 i2)))
(assert (= e_14 (seq.nth a_11 i5)))
(assert (= e_16 (seq.nth a_15 i1)))
(assert (= e_18 (seq.nth a_15 i7)))
(assert (= e_2 (seq.nth a1 i0)))
(assert (= e_20 (seq.nth a_19 i7)))
(assert (= e_22 (seq.nth a_19 i9)))
(assert (= e_24 (seq.nth a_23 i0)))
(assert (= e_26 (seq.nth a_23 i6)))
(assert (= e_28 (seq.nth a_27 i6)))
(assert (= e_30 (seq.nth a_27 i7)))
(assert (= e_32 (seq.nth a_31 i2)))
(assert (= e_34 (seq.nth a_31 i7)))
(assert (= e_36 (seq.nth a_35 i0)))
(assert (= e_38 (seq.nth a_35 i3)))
(assert (= e_4 (seq.nth a_3 i3)))
(assert (= e_42 (seq.nth a_41 i8)))
(assert (= e_44 (seq.nth a_41 i4)))
(assert (= e_46 (seq.nth a_45 i5)))
(assert (= e_48 (seq.nth a_45 i2)))
(assert (= e_50 (seq.nth a_49 i7)))
(assert (= e_52 (seq.nth a_49 i1)))
(assert (= e_54 (seq.nth a_53 i9)))
(assert (= e_56 (seq.nth a_53 i7)))
(assert (= e_58 (seq.nth a_57 i0)))
(assert (= e_6 (seq.nth a_3 i5)))
(assert (= e_60 (seq.nth a_57 i6)))
(assert (= e_62 (seq.nth a_61 i6)))
(assert (= e_64 (seq.nth a_61 i7)))
(assert (= e_66 (seq.nth a_65 i7)))
(assert (= e_68 (seq.nth a_65 i2)))
(assert (= e_70 (seq.nth a_69 i0)))
(assert (= e_72 (seq.nth a_69 i4)))
(assert (= e_8 (seq.nth a_7 i4)))
(assert (not (= a_39 a_73)))
(check-sat)
(exit)
