...
(declare-fun $t13 () T@$Mutation_202050)
(declare-fun $t13@0 () T@$Mutation_202050)
...
(Vec_29042 (|Store__T@[Int]Int_| (|v#Vec_29042| (|p#$Mutation_202050| $t13@1)) l 0) (+ l 1))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|v#$Mutation_202050| $t13@1)))) (= $t14@1 ($Mutation_13929 (|l#$Mutation_13929| $t14@0) (|p#$Mutation_13929| $t14@0) _$t1))) (and (= $t13@2 ($Mutation_202050 (|l#$Mutation_202050| $t13@1) (|p#$Mutation_202050| $t13@1) ($1_DualAttestation_Limit (|v#$Mutation_13929| $t14@1)))) (= $1_DualAttestation_Limit_$memory@0 ($Memory_133171 (|Store__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) (|a#$Global| (|l#$Mutation_202050| $t13@2)) true) (|Store__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) (|a#$Global| (|l#$Mutation_202050| $t13@2)) (|v#$Mutation_202050| $t13@2)))))) (and (=> (= (ControlFlow 0 259507) (- 0 344548)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory@0) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory@0) 173345816)) (and (=> (= (ControlFlow 0 259507) (- 0 344563)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 259507) (- 0 344575)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) $t4)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) $t4)) 1))) (and (=> (= (ControlFlow 0 259507) (- 0 344593)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 259507) (- 0 344607)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (and (=> (= (ControlFlow 0 259507) (- 0 344617)) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory@0) 173345816)) _$t1)) (=> (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory@0) 173345816)) _$t1) (and (=> (= (ControlFlow 0 259507) (- 0 344630)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1) (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1)))
 ...
 :qid |DualAttestationbpl.18983:15|
 :skolemid |439|
)) (and (=> (= (ControlFlow 0 259507) (- 0 344655)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@1))))
 ...
 :qid |DualAttestationbpl.18993:15|
 :skolemid |441|
)) (=> (= (ControlFlow 0 259507) (- 0 344720)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@5) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@5)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@5)))))
 :qid |DualAttestationbpl.18998:15|
 :skolemid |442|
)))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 259213) (- 0 344370)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (=> (= (ControlFlow 0 259213) (- 0 344410)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t7@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (= 5 $t7@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 259521) 259213))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= $t13@1 $t13) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 259573) 259521) anon15_Then_correct) (=> (= (ControlFlow 0 259573) 259507) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (= (ControlFlow 0 259571) 259573)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816) (=> (and (and (= $t13@0 ($Mutation_202050 ($Global 173345816) (Vec_29042 (MapConstVec_13534 DefaultVecElem_13534) 0) (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))) (= $t13@1 $t13@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 259245) 259521) anon15_Then_correct) (=> (= (ControlFlow 0 259245) 259507) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and $t9@0 (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 259223) 259571) anon14_Then_correct) (=> (= (ControlFlow 0 259223) 259245) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (and (not $t9@0) (= $t11 $t11)) (and (= $t7@0 $t11) (= (ControlFlow 0 259085) 259213))) L3_correct)))
(let ((anon12_Else_correct  (=> (and (and (and (not $t6) (|$IsValid'address'| 173345816)) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t11) (= $t11 5)) (and (= $t11 $t11) (= $t9@0 $t9@0)))) (and (=> (= (ControlFlow 0 259069) 259223) anon13_Then_correct) (=> (= (ControlFlow 0 259069) 259085) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> $t6 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) $t5)) 1)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 259645) 259213))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((mint_cap_owner Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_158958| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner) (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) mint_cap_owner) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) mint_cap_owner)) 1))))
 ...
 :skolemid |436|
)) (|$IsValid'address'| (|$addr#$signer| _$t0)))) (and (and (and (|$IsValid'u64'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) $a_0)))
...
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) $a_0@@0)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc@@0))
 :qid |DualAttestationbpl.18806:20|
 :skolemid |438|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) $a_0@@0))
)) (= $t4 (|$addr#$signer| _$t0)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) $t5)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))))))) (and (=> (= (ControlFlow 0 259021) 259645) anon12_Then_correct) (=> (= (ControlFlow 0 259021) 259069) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2823:13|
 :skolemid |103|
))) (= (ControlFlow 0 258668) 259021)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_29042| (|p#$Mutation_202050| $t13)) 0) (=> (and (= (|l#Vec_29042| (|p#$Mutation_13929| $t14)) 0) (= (ControlFlow 0 258678) 258668)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 343701) 258678) anon0_correct)))
