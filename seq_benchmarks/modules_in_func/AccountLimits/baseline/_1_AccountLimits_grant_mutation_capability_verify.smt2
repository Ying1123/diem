...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 413505) (let ((L2_correct  (and (=> (= (ControlFlow 0 301208) (- 0 414078)) (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t1)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t1)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (=> (= (ControlFlow 0 301208) (- 0 414118)) (or (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t3)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t1)) (= 5 $t3))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t1)) 0)) (= 3 $t3))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t3))))))))
(let ((anon7_Then_correct  (=> (and (and $t5 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t3)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t4)) (= 5 $t3))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t3))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t3)))) (and (= $t3 $t3) (= (ControlFlow 0 301080) 301208))) L2_correct)))
(let ((anon6_Then_correct  (=> $t2 (=> (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t3)) (and (= $t3 $t3) (= (ControlFlow 0 301234) 301208))) L2_correct))))
(let ((anon7_Else_correct  (=> (not $t5) (=> (and (= $t7@0 ($1_AccountLimits_AccountLimitMutationCapability false)) (= $t7@0 $t7@0)) (and (=> (= (ControlFlow 0 300988) (- 0 414022)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 300988) (- 0 414032)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t1))) (and (=> (= (ControlFlow 0 300988) (- 0 414044)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t1)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t1)) 0))) (=> (= (ControlFlow 0 300988) (- 0 414062)) (not (not (= (|$addr#$signer| _$t0) 173345816))))))))))))))
(let ((anon6_Else_correct  (=> (not $t2) (=> (and (= $t4 (|$addr#$signer| _$t0)) (= $t5  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t4))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))))) (and (=> (= (ControlFlow 0 300906) 301080) anon7_Then_correct) (=> (= (ControlFlow 0 300906) 300988) anon7_Else_correct))))))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (and (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@0) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@0)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@0)) 6)))))
 ...
 :skolemid |274|
))) (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
...
)))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $a_0@@0)))
...
)) (= $t1 (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (= $t2  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 300834) 301234) anon6_Then_correct) (=> (= (ControlFlow 0 300834) 300906) anon6_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_112887_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 300569) 300834)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 413505) 300569) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))
))
(check-sat)
(pop 1)
