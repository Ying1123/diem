...
L5:
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<RegisteredCurrencies::RegisteredCurrencies>()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assert Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<RegisteredCurrencies::RegisteredCurrencies>()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:93:9+98
    // global invariant at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:93:9+98
    assume {:print "$at(25,3506,3604)"} true;
    assert {:msg "assert_failed(25,3506,3604): global memory invariant does not hold"}
...
// fun RegisteredCurrencies::initialize [verification] at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+280
procedure {:timeLimit 40} $1_RegisteredCurrencies_initialize$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: int;
    var $t2: int;
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#173: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_Roles_RoleId_$memory#174: $Memory $1_Roles_RoleId;
    var $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#175: $Memory $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies';
    var $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#176: $Memory $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies';
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+280
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(25,817,1097)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+280
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<RegisteredCurrencies::RegisteredCurrencies>()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+280
    // global invariant at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:93:9+98
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+280
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+280
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+280
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+280
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+280
    ...
    // @173 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+1
    assume {:print "$at(25,817,818)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#173 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @174 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+1
    $1_Roles_RoleId_$memory#174 := $1_Roles_RoleId_$memory;

    // @177 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+1
    $1_DiemConfig_Configuration_$memory#177 := $1_DiemConfig_Configuration_$memory;

    // @175 := save_mem(DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+1
    $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#175 := $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory;

    // @176 := save_mem(DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:24:5+1
    $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#176 := $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory;
...
L7:
    ...
    // @178 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@178](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
L1:
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@173]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:142:9+51
    assume {:print "$at(17,5802,5853)"} true;
    assert {:msg "assert_failed(17,5802,5853): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#173);

    // assert Not(Not(exists[@174]<Roles::RoleId>($t1))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#174, $t1);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t1)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#174, $t1)), 0);
    ...
    // assert Not(DiemConfig::spec_is_published[@175]<RegisteredCurrencies::RegisteredCurrencies>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:260:9+38
    assume {:print "$at(13,11170,11208)"} true;
    assert {:msg "assert_failed(13,11170,11208): function does not abort under this condition"}
      !$1_DiemConfig_spec_is_published'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#175);

    // assert Not(exists[@176]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:261:9+86
    assume {:print "$at(13,11217,11303)"} true;
    assert {:msg "assert_failed(13,11217,11303): function does not abort under this condition"}
      !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#176, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@174]<Roles::RoleId>($t2))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#174, $t2);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t2)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#174, $t2)), 0);
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@177](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:147:9+52
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_genesis[@173]()), Not(exists[@174]<Roles::RoleId>($t1))), Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t1)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), DiemConfig::spec_is_published[@175]<RegisteredCurrencies::RegisteredCurrencies>()), exists[@176]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))), Not(exists[@174]<Roles::RoleId>($t2))), Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t2)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:32:5+94
    assume {:print "$at(25,1102,1196)"} true;
    assert {:msg "assert_failed(25,1102,1196): abort not covered by any of the `aborts_if` clauses"}
      ((((((((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#173) || !$ResourceExists($1_Roles_RoleId_$memory#174, $t1)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#174, $t1)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || $1_DiemConfig_spec_is_published'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#175)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#176, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#174, $t2)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#174, $t2)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_genesis[@173]()), Eq(1, $t4)), And(Not(exists[@174]<Roles::RoleId>($t1)), Eq(5, $t4))), And(Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t1)), 0), Eq(3, $t4))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t4))), DiemConfig::spec_is_published[@175]<RegisteredCurrencies::RegisteredCurrencies>()), exists[@176]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))), And(Not(exists[@174]<Roles::RoleId>($t2)), Eq(5, $t4))), And(Neq<u64>(select Roles::RoleId.role_id(global[@174]<Roles::RoleId>($t2)), 0), Eq(3, $t4))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t4))) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:32:5+94
    assert {:msg "assert_failed(25,1102,1196): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#173) && $IsEqual'u8'(1, $t4)) || (!$ResourceExists($1_Roles_RoleId_$memory#174, $t1) && $IsEqual'u8'(5, $t4))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#174, $t1)), 0) && $IsEqual'u8'(3, $t4))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t4))) || $1_DiemConfig_spec_is_published'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#175)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#176, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory#174, $t2) && $IsEqual'u8'(5, $t4))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#174, $t2)), 0) && $IsEqual'u8'(3, $t4))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t4)));

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:32:5+94
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
L6:
    ...
    // @150 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@150](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
// fun RegisteredCurrencies::add_currency_code [verification] at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+449
procedure {:timeLimit 40} $1_RegisteredCurrencies_add_currency_code$verify(_$t0: int, _$t1: Vec (int)) returns ()
{
    // declare local variables
    var $t2: $1_RegisteredCurrencies_RegisteredCurrencies;
    var $t3: bool;
    ...
    var $temp_0'u64': int;
    var $temp_0'vec'u8'': Vec (int);
    var $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139: $Memory $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies';
    var $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#140: $Memory $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies';
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_DiemConfig_DisableReconfiguration_$memory#142: $Memory $1_DiemConfig_DisableReconfiguration;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+449
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(25,1792,2241)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+449
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<RegisteredCurrencies::RegisteredCurrencies>()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+449
    // global invariant at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:93:9+98
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+449
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+449
    assume $IsValid'vec'u8''($t1);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+449
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+449
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+449
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+449
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies''($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+449
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies''($rsc))));
    ...
    // @141 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+1
    assume {:print "$at(25,1792,1793)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @143 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+1
    $1_DiemConfig_Configuration_$memory#143 := $1_DiemConfig_Configuration_$memory;

    // @142 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#142 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @139 := save_mem(DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+1
    $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139 := $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory;

    // @140 := save_mem(DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:51:5+1
    $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#140 := $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory;
...
L2:
    ...
    // assert Not(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@139]<RegisteredCurrencies::RegisteredCurrencies>()), $t1)) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:72:9+154
    assume {:print "$at(25,2617,2771)"} true;
    assert {:msg "assert_failed(25,2617,2771): function does not abort under this condition"}
      !$ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139)), $t1);

    // assert Not(Not(exists[@140]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:140:9+129
    assume {:print "$at(13,5612,5741)"} true;
    assert {:msg "assert_failed(13,5612,5741): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#140, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@139]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:104:9+101
    assume {:print "$at(13,3930,4031)"} true;
    assert {:msg "assert_failed(13,3930,4031): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());

    // assert Not(And(And(And(And(DiemTimestamp::$is_operating[@141](), DiemConfig::$reconfiguration_enabled[@142]()), Gt(DiemTimestamp::spec_now_microseconds[@141](), 0)), Lt(select DiemConfig::Configuration.epoch($t5), 18446744073709551615)), Lt($t6, select DiemConfig::Configuration.last_reconfiguration_time($t5)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:362:9+283
    assume {:print "$at(13,16092,16375)"} true;
    assert {:msg "assert_failed(13,16092,16375): function does not abort under this condition"}
      !(((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#142)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141) > 0)) && ($epoch#$1_DiemConfig_Configuration($t5) < 18446744073709551615)) && ($t6 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t5)));

    // assert Vector::eq_push_back<vector<u8>>(RegisteredCurrencies::get_currency_codes(), RegisteredCurrencies::get_currency_codes[@139](), $t1) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:80:9+93
    assume {:print "$at(25,2980,3073)"} true;
    assert {:msg "assert_failed(25,2980,3073): post-condition does not hold"}
      $1_Vector_eq_push_back'vec'u8''($1_RegisteredCurrencies_get_currency_codes($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory), $1_RegisteredCurrencies_get_currency_codes($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139), $t1);
    ...
    // assert Eq<RegisteredCurrencies::RegisteredCurrencies>(DiemConfig::$get<RegisteredCurrencies::RegisteredCurrencies>(), DiemConfig::$get<RegisteredCurrencies::RegisteredCurrencies>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:146:9+33
    assume {:print "$at(13,5863,5896)"} true;
    assert {:msg "assert_failed(13,5863,5896): post-condition does not hold"}
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@143](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:147:9+52
    assume {:print "$at(13,5905,5957)"} true;
    assert {:msg "assert_failed(13,5905,5957): post-condition does not hold"}
      $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#143), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L3:
    ...
    // assert Or(Or(Or(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@139]<RegisteredCurrencies::RegisteredCurrencies>()), $t1), Not(exists[@140]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))), Not(exists[@139]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))), And(And(And(And(DiemTimestamp::$is_operating[@141](), DiemConfig::$reconfiguration_enabled[@142]()), Gt(DiemTimestamp::spec_now_microseconds[@141](), 0)), Lt(select DiemConfig::Configuration.epoch($t5), 18446744073709551615)), Lt($t6, select DiemConfig::Configuration.last_reconfiguration_time($t5)))) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:63:5+111
    assume {:print "$at(25,2246,2357)"} true;
    assert {:msg "assert_failed(25,2246,2357): abort not covered by any of the `aborts_if` clauses"}
      ((($ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139)), $t1) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#140, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#142)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141) > 0)) && ($epoch#$1_DiemConfig_Configuration($t5) < 18446744073709551615)) && ($t6 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t5))));

    // assert Or(Or(Or(And(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@139]<RegisteredCurrencies::RegisteredCurrencies>()), $t1), Eq(7, $t8)), And(Not(exists[@140]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))), Eq(4, $t8))), And(Not(exists[@139]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Eq(5, $t8))), And(And(And(And(And(DiemTimestamp::$is_operating[@141](), DiemConfig::$reconfiguration_enabled[@142]()), Gt(DiemTimestamp::spec_now_microseconds[@141](), 0)), Lt(select DiemConfig::Configuration.epoch($t5), 18446744073709551615)), Lt($t6, select DiemConfig::Configuration.last_reconfiguration_time($t5))), Eq(1, $t8))) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:63:5+111
    assert {:msg "assert_failed(25,2246,2357): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((($ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139)), $t1) && $IsEqual'u8'(7, $t8)) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#140, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t8))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#139, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t8))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#142)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#141) > 0)) && ($epoch#$1_DiemConfig_Configuration($t5) < 18446744073709551615)) && ($t6 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t5))) && $IsEqual'u8'(1, $t8)));

    // abort($t8) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:63:5+111
    $abort_code := $t8;
    $abort_flag := true;
    return;
...
L7:
    ...
    // @168 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@168](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
