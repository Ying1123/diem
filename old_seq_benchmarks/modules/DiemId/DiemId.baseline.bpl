...
L7:
    ...
    assert {:msg "assert_failed(15,6956,7106): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$ResourceExists($1_DiemId_DiemIdDomains_$memory#120, $t1) && $IsEqual'num'(5, $t17)) || (!$1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#121) && $IsEqual'num'(5, $t17))) || ($ContainsVec'$1_DiemId_DiemIdDomain'($t11, $1_DiemId_DiemIdDomain($t2)) && $IsEqual'num'(7, $t17))) || (!$ResourceExists($1_Roles_RoleId_$memory#122, $t12) && $IsEqual'num'(5, $t17))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t12)), 1) && $IsEqual'num'(3, $t17))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'num'(2, $t17))) || (($1_Vector_$length'u8'($t2) > 63) && $IsEqual'num'(7, $t17)));
...
L3:
    ...
    assert {:msg "assert_failed(15,11272,11477): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$ResourceExists($1_DiemId_DiemIdDomains_$memory#104, $t0) && $IsEqual'num'(5, $t10)) || (($1_Vector_$length'u8'($t1) > 63) && $IsEqual'num'(7, $t10)));
...
L3:
    ...
    assert {:msg "assert_failed(15,3488,3747): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$ResourceExists($1_Roles_RoleId_$memory#105, $t4) && $IsEqual'num'(5, $t7)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#105, $t4)), 5) && $IsEqual'num'(3, $t7))) || ($1_DiemId_$has_diem_id_domains($1_DiemId_DiemIdDomains_$memory#106, $t3) && $IsEqual'num'(6, $t7)));
