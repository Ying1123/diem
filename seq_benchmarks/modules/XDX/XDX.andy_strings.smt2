...
(pop 1)
; Valid
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory| () T@$Memory_99616)
...
(declare-fun |inline$$1_Diem_is_currency'#0'$0$$ret0@1| () Bool)
(declare-fun |inline$$1_Diem_is_currency'#0'$0$$t2@1| () Bool)
(push 1)
(set-info :boogie-vc-id $1_XDX_is_xdx$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 211203) (let ((L5_correct@@0  (and (=> (= (ControlFlow 0 156537) (- 0 211706)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 156537) (- 0 211716)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= 5 $t2@0)))))))
(let ((anon14_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2)) (= $t2 $t2)) (and (= $t2@0 $t2) (= (ControlFlow 0 156497) 156537))) L5_correct@@0))))
(let ((anon13_Then_correct  (=> $t4 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t2)) (= $t2 $t2)) (and (= $t2@0 $t2) (= (ControlFlow 0 156563) 156537))) L5_correct@@0))))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@0@@1 (= $abort_code@0@@1 $abort_code@0@@1)) (and (= $t2@0 $abort_code@0@@1) (= (ControlFlow 0 156577) 156537))) L5_correct@@0)))
(let ((L3_correct@@0  (=> (= $t0@0 $t0@0) (and (=> (= (ControlFlow 0 156395) (- 0 211663)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (= (ControlFlow 0 156395) (- 0 211678)) (= $t0@0  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))
(let ((anon14_Else_correct  (=> (not $t6) (=> (and (|$IsValid'vec'u8''| $t5) (= $t5 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (= $t7@0 (= $t3@@0 $t5)) (= $t7@0 $t7@0)) (and (= $t0@0 $t7@0) (= (ControlFlow 0 156471) 156395))) L3_correct@@0)))))
(let ((anon13_Else_correct  (=> (and (and (not $t4) (|$IsValid'vec'u8''| $t3@@0)) (and (= $t3@@0 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 156437) 156497) anon14_Then_correct) (=> (= (ControlFlow 0 156437) 156471) anon14_Else_correct)))))
(let ((anon12_Then_correct  (=> (and |inline$$1_Diem_is_currency'#0'$0$$ret0@1| (= $t4  (not (|Select__T@[Int]Bool_| (|domain#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 156409) 156563) anon13_Then_correct) (=> (= (ControlFlow 0 156409) 156437) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not |inline$$1_Diem_is_currency'#0'$0$$ret0@1|) (= false false)) (and (= $t0@0 false) (= (ControlFlow 0 156355) 156395))) L3_correct@@0)))
(let ((anon11_Else_correct  (=> (not $abort_flag@0@@1) (and (=> (= (ControlFlow 0 156335) 156409) anon12_Then_correct) (=> (= (ControlFlow 0 156335) 156355) anon12_Else_correct)))))
(let ((|inline$$1_Diem_is_currency'#0'$0$anon3_Else_correct|  (=> (not false) (=> (and (and (= |inline$$1_Diem_is_currency'#0'$0$$t2@1| (|Select__T@[Int]Bool_| (|domain#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'#0'$0$$t2@1| |inline$$1_Diem_is_currency'#0'$0$$t2@1|)) (and (= $abort_flag@0@@1 false) (= |inline$$1_Diem_is_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_currency'#0'$0$$t2@1|))) (and (=> (= (ControlFlow 0 156303) 156577) anon11_Then_correct) (=> (= (ControlFlow 0 156303) 156335) anon11_Else_correct))))))
(let ((|inline$$1_Diem_is_currency'#0'$0$anon3_Then_correct| true))
(let ((inline$$1_CoreAddresses_CURRENCY_INFO_ADDRESS$0$anon0_correct@@0  (=> (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (=> (= (ControlFlow 0 156273) 156321) |inline$$1_Diem_is_currency'#0'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 156273) 156303) |inline$$1_Diem_is_currency'#0'$0$anon3_Else_correct|)))))
(let ((|inline$$1_Diem_is_currency'#0'$0$anon0_correct|  (=> (= (ControlFlow 0 156279) 156273) inline$$1_CoreAddresses_CURRENCY_INFO_ADDRESS$0$anon0_correct@@0)))
(let ((anon0$1_correct@@1  (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_92885| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (forall (($a_0@@9 Int) ) (! (let (($rsc@@9 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@9)))
 ...
 :qid |XDXandybpl.9676:20|
 :skolemid |166|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_94416| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@9))
))) (and (forall (($a_0@@10 Int) ) (! (let (($rsc@@10 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@10)))
 ...
 :qid |XDXandybpl.9680:20|
 :skolemid |167|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_99616| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@10))
)) (= (ControlFlow 0 156327) 156279))) |inline$$1_Diem_is_currency'#0'$0$anon0_correct|)))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@3 T@$1_Event_EventHandle) ) (! (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_63926_| (|streams#$EventStore| $es) handle@@3)))
 (and (= (|l#Multiset_63926| stream@@2) 0) (forall ((v@@37 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_63926| stream@@2) v@@37) 0)
 :qid |XDXandybpl.129:13|
 :skolemid |2|
))))
 :qid |XDXandybpl.2538:13|
 :skolemid |69|
))) (= (ControlFlow 0 155984) 156327)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 211203) 155984) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1))))))))))))))))))
))
(check-sat)
(pop 1)
