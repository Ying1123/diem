...
procedure {:inline 1} $1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'(_$t0: $1_DiemAccount_KeyRotationCapability) returns ($ret0: Vec ($1_DiemAccount_KeyRotationCapability))
{
    ...
    assume {:print "$at(47,2067,2068)"} true;
    ...
    assume {:print "$at(47,2144,2151)"} true;
    ...
    assume {:print "$at(47,2171,2177)"} true;
    ...
    if ($abort_flag) {
        assume {:print "$at(47,2161,2181)"} true;
        $t2 := $abort_code;
        assume {:print "$track_abort(6,13):", $t2} $t2 == $t2;
        goto L2;
    }
    ...
    assume {:print "$at(47,2191,2192)"} true;
    $t4 := $t1;
    ...
    assume {:print "$at(47,2197,2198)"} true;
L1:
...
L8:
    ...
    // @159 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@159](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
...
procedure {:inline 1} $1_RegisteredCurrencies_initialize(_$t0: int) returns ()
{
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_DiemConfig_Configuration_$memory#193: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
...
L7:
    ...
    // @193 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    $1_DiemConfig_Configuration_$memory#193 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@193](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#193), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L6:
    ...
    // @165 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@165](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
...
procedure {:timeLimit 40} $1_VASP_publish_child_vasp_credential$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_VASP_ChildVASP_$memory#117: $Memory $1_VASP_ChildVASP;
    var $1_VASP_ParentVASP_$memory#118: $Memory $1_VASP_ParentVASP;
    var $1_Roles_RoleId_$memory#119: $Memory $1_Roles_RoleId;
    $t0 := _$t0;
    $t1 := _$t1;
    assume IsEmptyVec(p#$Mutation($t3));
    ...
    // bytecode translation starts here
    // assume true at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+896
    ...
    // @119 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+1
    assume {:print "$at(33,3061,3062)"} true;
    $1_Roles_RoleId_$memory#119 := $1_Roles_RoleId_$memory;

    // @117 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+1
    $1_VASP_ChildVASP_$memory#117 := $1_VASP_ChildVASP_$memory;

    // @118 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+1
    $1_VASP_ParentVASP_$memory#118 := $1_VASP_ParentVASP_$memory;
...
L4:
    ...
    // assume forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+896
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:235:9+163
    assume {:print "$at(33,3061,3957)"} true;
    assume (forall recovery_addr: int :: $IsValid'address'(recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr))  ==> ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, recovery_addr)));
    ...
    // assert forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:235:9+163
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:235:9+163
    assume {:print "$at(24,10911,11074)"} true;
    assert {:msg "assert_failed(24,10911,11074): global memory invariant does not hold"}
      (forall recovery_addr: int :: $IsValid'address'(recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr))  ==> ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, recovery_addr)));
    ...
    // assume forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:235:9+163
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:235:9+163
    assume {:print "$at(24,10911,11074)"} true;
    assume (forall recovery_addr: int :: $IsValid'address'(recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr))  ==> ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, recovery_addr)));
...
L6:
    ...
    // assert Not(VASP::$is_vasp[@117, @118]($t11)) at /home/ying/diem/language/diem-framework/modules/VASP.move:98:9+61
    assume {:print "$at(33,4741,4802)"} true;
    assert {:msg "assert_failed(33,4741,4802): function does not abort under this condition"}
      !$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#117, $1_VASP_ParentVASP_$memory#118, $t11);

    // assert Not(Not(VASP::$is_parent[@118]($t12))) at /home/ying/diem/language/diem-framework/modules/VASP.move:99:9+64
    assume {:print "$at(33,4811,4875)"} true;
    assert {:msg "assert_failed(33,4811,4875): function does not abort under this condition"}
      !!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#118, $t12);

    // assert Not(Gt(Add(VASP::spec_num_children[@118]($t12), 1), 65536)) at /home/ying/diem/language/diem-framework/modules/VASP.move:100:9+94
    assume {:print "$at(33,4884,4978)"} true;
    assert {:msg "assert_failed(33,4884,4978): function does not abort under this condition"}
      !(($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#118, $t12) + 1) > 65536);

    // assert Not(Not(exists[@119]<Roles::RoleId>($t13))) at /home/ying/diem/language/diem-framework/modules/Roles.move:541:9+59
    assume {:print "$at(26,24232,24291)"} true;
    assert {:msg "assert_failed(26,24232,24291): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#119, $t13);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@119]<Roles::RoleId>($t13)), 5)) at /home/ying/diem/language/diem-framework/modules/Roles.move:542:9+89
    assume {:print "$at(26,24300,24389)"} true;
    assert {:msg "assert_failed(26,24300,24389): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#119, $t13)), 5);

    // assert Not(Not(exists[@119]<Roles::RoleId>($t11))) at /home/ying/diem/language/diem-framework/modules/Roles.move:547:9+62
    assume {:print "$at(26,24470,24532)"} true;
    assert {:msg "assert_failed(26,24470,24532): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#119, $t11);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@119]<Roles::RoleId>($t11)), 6)) at /home/ying/diem/language/diem-framework/modules/Roles.move:548:9+91
    assume {:print "$at(26,24541,24632)"} true;
    assert {:msg "assert_failed(26,24541,24632): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#119, $t11)), 6);

    // assert Eq<u64>(VASP::spec_num_children(Signer::spec_address_of($t0)), Add(VASP::spec_num_children[@118](Signer::spec_address_of[]($t0)), 1)) at /home/ying/diem/language/diem-framework/modules/VASP.move:106:9+82
    assume {:print "$at(33,5095,5177)"} true;
    assert {:msg "assert_failed(33,5095,5177): post-condition does not hold"}
      $IsEqual'u64'($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory, $1_Signer_spec_address_of($t0)), ($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#118, $1_Signer_spec_address_of($t0)) + 1));
...
L7:
    ...
    // assert Or(Or(Or(Or(Or(Or(VASP::$is_vasp[@117, @118]($t11), Not(VASP::$is_parent[@118]($t12))), Gt(Add(VASP::spec_num_children[@118]($t12), 1), 65536)), Not(exists[@119]<Roles::RoleId>($t13))), Neq<u64>(select Roles::RoleId.role_id(global[@119]<Roles::RoleId>($t13)), 5)), Not(exists[@119]<Roles::RoleId>($t11))), Neq<u64>(select Roles::RoleId.role_id(global[@119]<Roles::RoleId>($t11)), 6)) at /home/ying/diem/language/diem-framework/modules/VASP.move:84:5+551
    assume {:print "$at(33,3962,4513)"} true;
    assert {:msg "assert_failed(33,3962,4513): abort not covered by any of the `aborts_if` clauses"}
      (((((($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#117, $1_VASP_ParentVASP_$memory#118, $t11) || !$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#118, $t12)) || (($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#118, $t12) + 1) > 65536)) || !$ResourceExists($1_Roles_RoleId_$memory#119, $t13)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#119, $t13)), 5)) || !$ResourceExists($1_Roles_RoleId_$memory#119, $t11)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#119, $t11)), 6));

    // assert Or(Or(Or(Or(Or(Or(And(VASP::$is_vasp[@117, @118]($t11), Eq(6, $t16)), And(Not(VASP::$is_parent[@118]($t12)), Eq(7, $t16))), And(Gt(Add(VASP::spec_num_children[@118]($t12), 1), 65536), Eq(8, $t16))), And(Not(exists[@119]<Roles::RoleId>($t13)), Eq(5, $t16))), And(Neq<u64>(select Roles::RoleId.role_id(global[@119]<Roles::RoleId>($t13)), 5), Eq(3, $t16))), And(Not(exists[@119]<Roles::RoleId>($t11)), Eq(5, $t16))), And(Neq<u64>(select Roles::RoleId.role_id(global[@119]<Roles::RoleId>($t11)), 6), Eq(3, $t16))) at /home/ying/diem/language/diem-framework/modules/VASP.move:84:5+551
    assert {:msg "assert_failed(33,3962,4513): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#117, $1_VASP_ParentVASP_$memory#118, $t11) && $IsEqual'u8'(6, $t16)) || (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#118, $t12) && $IsEqual'u8'(7, $t16))) || ((($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#118, $t12) + 1) > 65536) && $IsEqual'u8'(8, $t16))) || (!$ResourceExists($1_Roles_RoleId_$memory#119, $t13) && $IsEqual'u8'(5, $t16))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#119, $t13)), 5) && $IsEqual'u8'(3, $t16))) || (!$ResourceExists($1_Roles_RoleId_$memory#119, $t11) && $IsEqual'u8'(5, $t16))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#119, $t11)), 6) && $IsEqual'u8'(3, $t16)));
...
procedure {:timeLimit 40} $1_VASP_publish_parent_vasp_credential$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    var $1_VASP_ParentVASP_$memory#142: $Memory $1_VASP_ParentVASP;
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // assume true at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:549:9+318
    assume true;
    ...
    // @139 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+1
    ...
    // @140 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+1
    $1_Roles_RoleId_$memory#140 := $1_Roles_RoleId_$memory;

    // @141 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+1
    $1_VASP_ChildVASP_$memory#141 := $1_VASP_ChildVASP_$memory;

    // @142 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+1
    $1_VASP_ParentVASP_$memory#142 := $1_VASP_ParentVASP_$memory;
...
L0:
    ...
    // assume forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:235:9+163
    assume {:print "$at(33,1940,2361)"} true;
    assume (forall recovery_addr: int :: $IsValid'address'(recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr))  ==> ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, recovery_addr)));
...
L2:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@139]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
    assume {:print "$at(17,6375,6428)"} true;
    assert {:msg "assert_failed(17,6375,6428): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139);

    // assert Not(Not(exists[@140]<Roles::RoleId>($t6))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    assume {:print "$at(26,23933,23992)"} true;
    assert {:msg "assert_failed(26,23933,23992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#140, $t6);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t6)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    assume {:print "$at(26,24001,24098)"} true;
    assert {:msg "assert_failed(26,24001,24098): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#140, $t6)), 1);
    ...
    // assert Not(Not(exists[@140]<Roles::RoleId>($t7))) at /home/ying/diem/language/diem-framework/modules/Roles.move:541:9+59
    assume {:print "$at(26,24232,24291)"} true;
    assert {:msg "assert_failed(26,24232,24291): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#140, $t7);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t7)), 5)) at /home/ying/diem/language/diem-framework/modules/Roles.move:542:9+89
    assume {:print "$at(26,24300,24389)"} true;
    assert {:msg "assert_failed(26,24300,24389): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#140, $t7)), 5);

    // assert Not(VASP::$is_vasp[@141, @142]($t5)) at /home/ying/diem/language/diem-framework/modules/VASP.move:56:9+60
    assume {:print "$at(33,2657,2717)"} true;
    assert {:msg "assert_failed(33,2657,2717): function does not abort under this condition"}
      !$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#141, $1_VASP_ParentVASP_$memory#142, $t5);
    ...
    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@141]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:251:9+78
    assume {:print "$at(33,10513,10591)"} true;
    assert {:msg "assert_failed(33,10513,10591): post-condition does not hold"}
      (forall a: int :: $IsValid'address'(a) ==> ($IsEqual'bool'($ResourceExists($1_VASP_ChildVASP_$memory, a), $ResourceExists($1_VASP_ChildVASP_$memory#141, a))));

    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@142](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@142](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    assume {:print "$at(33,10648,10797)"} true;
    assert {:msg "assert_failed(33,10648,10797): post-condition does not hold"}
      (forall parent: int :: $IsValid'address'(parent) ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory#142, parent))  ==> ($IsEqual'u64'($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory, parent), $1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#142, parent))));
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_operating[@139]()), Not(exists[@140]<Roles::RoleId>($t6))), Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t6)), 1)), Neq<address>(Signer::spec_address_of[]($t1), b1e55ed)), Not(exists[@140]<Roles::RoleId>($t7))), Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t7)), 5)), VASP::$is_vasp[@141, @142]($t5)) at /home/ying/diem/language/diem-framework/modules/VASP.move:51:5+420
    assume {:print "$at(33,2367,2787)"} true;
    assert {:msg "assert_failed(33,2367,2787): abort not covered by any of the `aborts_if` clauses"}
      ((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139) || !$ResourceExists($1_Roles_RoleId_$memory#140, $t6)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#140, $t6)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453)) || !$ResourceExists($1_Roles_RoleId_$memory#140, $t7)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#140, $t7)), 5)) || $1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#141, $1_VASP_ParentVASP_$memory#142, $t5));

    // assert Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@139]()), Eq(1, $t9)), And(Not(exists[@140]<Roles::RoleId>($t6)), Eq(5, $t9))), And(Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t6)), 1), Eq(3, $t9))), And(Neq<address>(Signer::spec_address_of[]($t1), b1e55ed), Eq(2, $t9))), And(Not(exists[@140]<Roles::RoleId>($t7)), Eq(5, $t9))), And(Neq<u64>(select Roles::RoleId.role_id(global[@140]<Roles::RoleId>($t7)), 5), Eq(3, $t9))), And(VASP::$is_vasp[@141, @142]($t5), Eq(6, $t9))) at /home/ying/diem/language/diem-framework/modules/VASP.move:51:5+420
    assert {:msg "assert_failed(33,2367,2787): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139) && $IsEqual'u8'(1, $t9)) || (!$ResourceExists($1_Roles_RoleId_$memory#140, $t6) && $IsEqual'u8'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#140, $t6)), 1) && $IsEqual'u8'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453) && $IsEqual'u8'(2, $t9))) || (!$ResourceExists($1_Roles_RoleId_$memory#140, $t7) && $IsEqual'u8'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#140, $t7)), 5) && $IsEqual'u8'(3, $t9))) || ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#141, $1_VASP_ParentVASP_$memory#142, $t5) && $IsEqual'u8'(6, $t9)));
...
procedure {:inline 1} $1_DiemTransactionPublishingOption_initialize(_$t0: int, _$t1: Vec (Vec (int)), _$t2: bool) returns ()
{
    ...
    var $1_DiemConfig_Configuration_$memory#183: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
...
L7:
    ...
    // @183 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    $1_DiemConfig_Configuration_$memory#183 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@183](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#183), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
// spec fun at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:1563:5+213
...
// spec fun at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:1588:5+118
...
L2:
    ...
    // trace_local[account#1817]($t17) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:955:13+7
...
// fun DiemAccount::key_rotation_capability_address [baseline] at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:1588:5+118
procedure {:inline 1} $1_DiemAccount_key_rotation_capability_address(_$t0: $1_DiemAccount_KeyRotationCapability) returns ($ret0: int)
{
    ...
    assume {:print "$at(11,72842,72843)"} true;
...
L1:
    ...
    // return $t1 at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:1590:5+1
    $ret0 := $t1;
    return;
...
procedure {:timeLimit 40} $1_RecoveryAddress_publish$verify(_$t0: int, _$t1: $1_DiemAccount_KeyRotationCapability) returns ()
{
    // declare local variables
    var $t2: int;
    var $t3: bool;
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_VASP_ChildVASP_$memory#98: $Memory $1_VASP_ChildVASP;
    var $1_VASP_ParentVASP_$memory#99: $Memory $1_VASP_ParentVASP;
    var $1_RecoveryAddress_RecoveryAddress_$memory#100: $Memory $1_RecoveryAddress_RecoveryAddress;
    var $1_RecoveryAddress_RecoveryAddress_$memory#245: $Memory $1_RecoveryAddress_RecoveryAddress;
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume {:print "$at(24,2276,3288)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));
    ...
    assume {:print "$at(24,3500,3553)"} true;
    assume ($t9 == $1_Signer_spec_address_of($t0));
    ...
    assume {:print "$at(24,3959,4012)"} true;
    assume ($t10 == $1_Signer_spec_address_of($t0));

    // @98 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:43:5+1
    assume {:print "$at(24,2276,2277)"} true;
    $1_VASP_ChildVASP_$memory#98 := $1_VASP_ChildVASP_$memory;

    // @99 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:43:5+1
    $1_VASP_ParentVASP_$memory#99 := $1_VASP_ParentVASP_$memory;

    // @100 := save_mem(RecoveryAddress::RecoveryAddress) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:43:5+1
    $1_RecoveryAddress_RecoveryAddress_$memory#100 := $1_RecoveryAddress_RecoveryAddress_$memory;

    // trace_local[recovery_account]($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:43:5+1
    assume {:print "$track_local(31,1,0):", $t0} $t0 == $t0;

    // trace_local[rotation_cap]($t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:43:5+1
    assume {:print "$track_local(31,1,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:44:20+36
    // >> opaque call: $t9 := Signer::address_of($t0)
    assume {:print "$at(24,2380,2416)"} true;
    ...
    assume {:print "$track_local(31,1,2):", $t11} $t11 == $t11;

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:46:16+19
    // >> opaque call: $t10 := VASP::is_vasp($t9)
    assume {:print "$at(24,2485,2504)"} true;
    ...
    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:46:37+37
    ...
    // trace_local[tmp#$4]($t14) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:46:9+66
    assume {:print "$track_local(31,1,4):", $t14} $t14 == $t14;

    // trace_local[tmp#$3]($t12) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:46:9+66
    assume {:print "$track_local(31,1,3):", $t12} $t12 == $t12;
...
L1:
    ...
    assume {:print "$at(24,2478,2544)"} true;
    assume {:print "$track_abort(31,1):", $t14} $t14 == $t14;
    ...
    assume {:print "$at(24,2948,2961)"} true;
L0:
    ...
    if ($abort_flag) {
        assume {:print "$at(24,2903,2962)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(31,1):", $t15} $t15 == $t15;
        goto L7;
    }
    ...
    assume {:print "$at(24,3010,3040)"} true;
    $t18 := 1;
    assume $IsValid'u64'($t18);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:54:14+56
    ...
    // trace_local[tmp#$6]($t19) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:52:9+169
    assume {:print "$at(24,2882,3051)"} true;
    assume {:print "$track_local(31,1,6):", $t19} $t19 == $t19;

    // trace_local[tmp#$5]($t17) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:52:9+169
    assume {:print "$track_local(31,1,5):", $t17} $t17 == $t17;
...
L3:
    ...
    assume {:print "$at(24,2882,3051)"} true;
    assume {:print "$track_abort(31,1):", $t19} $t19 == $t19;
    ...
    assume {:print "$at(24,3093,3097)"} true;
L2:
    ...
    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:56:48+44
    ...
    // trace_local[tmp#$8]($t23) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:56:9+84
    assume {:print "$track_local(31,1,8):", $t23} $t23 == $t23;

    // trace_local[tmp#$7]($t21) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:56:9+84
    assume {:print "$track_local(31,1,7):", $t21} $t21 == $t21;
...
L5:
    ...
    assume {:print "$at(24,3061,3145)"} true;
    assume {:print "$track_abort(31,1):", $t23} $t23 == $t23;
    ...
    assume {:print "$at(24,3176,3192)"} true;
L4:
    ...
    assume {:print "$at(24,3239,3270)"} true;
    ...
    // assume forall addr1: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(addr1): And(Gt(Len<DiemAccount::KeyRotationCapability>(RecoveryAddress::spec_get_rotation_caps(addr1)), 0), Eq<address>(select DiemAccount::KeyRotationCapability.account_address(Index(RecoveryAddress::spec_get_rotation_caps(addr1), 0)), addr1)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:43:5+1012
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:200:9+234
    assume {:print "$at(24,2276,3288)"} true;
    assume (forall addr1: int :: $IsValid'address'(addr1) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, addr1))  ==> (((LenVec($1_RecoveryAddress_spec_get_rotation_caps($1_RecoveryAddress_RecoveryAddress_$memory, addr1)) > 0) && $IsEqual'address'($account_address#$1_DiemAccount_KeyRotationCapability(ReadVec($1_RecoveryAddress_spec_get_rotation_caps($1_RecoveryAddress_RecoveryAddress_$memory, addr1), 0)), addr1))));

    // assume forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:43:5+1012
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:235:9+163
    assume (forall recovery_addr: int :: $IsValid'address'(recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr))  ==> ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, recovery_addr)));

    // @245 := save_mem(RecoveryAddress::RecoveryAddress) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:43:5+1012
    // state save for global update invariants
    $1_RecoveryAddress_RecoveryAddress_$memory#245 := $1_RecoveryAddress_RecoveryAddress_$memory;
    ...
    assume {:print "$at(24,3155,3162)"} true;
    if ($ResourceExists($1_RecoveryAddress_RecoveryAddress_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
        $1_RecoveryAddress_RecoveryAddress_$memory := $ResourceUpdate($1_RecoveryAddress_RecoveryAddress_$memory, $t0, $t25);
    }
    if ($abort_flag) {
        assume {:print "$at(24,3155,3162)"} true;
        $t15 := $abort_code;
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:200:9+234
    assume {:print "$at(24,9571,9805)"} true;
    assert {:msg "assert_failed(24,9571,9805): global memory invariant does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, addr1))  ==> (((LenVec($1_RecoveryAddress_spec_get_rotation_caps($1_RecoveryAddress_RecoveryAddress_$memory, addr1)) > 0) && $IsEqual'address'($account_address#$1_DiemAccount_KeyRotationCapability(ReadVec($1_RecoveryAddress_spec_get_rotation_caps($1_RecoveryAddress_RecoveryAddress_$memory, addr1), 0)), addr1))));

    // assert forall addr: TypeDomain<address>(): Implies(RecoveryAddress::spec_is_recovery_address[@245](addr), RecoveryAddress::spec_is_recovery_address(addr)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:209:9+136
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:209:9+136
    assume {:print "$at(24,9874,10010)"} true;
    assert {:msg "assert_failed(24,9874,10010): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> (($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#245, addr) ==> $1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, addr))));

    // assert forall addr: TypeDomain<address>() where exists[@245]<RecoveryAddress::RecoveryAddress>(addr): exists<RecoveryAddress::RecoveryAddress>(addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:218:9+122
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:218:9+122
    assume {:print "$at(24,10131,10253)"} true;
    assert {:msg "assert_failed(24,10131,10253): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_RecoveryAddress_RecoveryAddress_$memory#245, addr))  ==> ($ResourceExists($1_RecoveryAddress_RecoveryAddress_$memory, addr)));

    // assert forall recovery_addr: TypeDomain<address>(), to_recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address[@245](recovery_addr): Implies(RecoveryAddress::spec_holds_key_rotation_cap_for[@245](recovery_addr, to_recovery_addr), RecoveryAddress::spec_holds_key_rotation_cap_for(recovery_addr, to_recovery_addr)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:223:9+321
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:223:9+321
    assume {:print "$at(24,10444,10765)"} true;
    assert {:msg "assert_failed(24,10444,10765): global memory invariant does not hold"}
      (forall recovery_addr: int, to_recovery_addr: int :: $IsValid'address'(recovery_addr) ==> $IsValid'address'(to_recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#245, recovery_addr))  ==> (($1_RecoveryAddress_spec_holds_key_rotation_cap_for($1_RecoveryAddress_RecoveryAddress_$memory#245, recovery_addr, to_recovery_addr) ==> $1_RecoveryAddress_spec_holds_key_rotation_cap_for($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr, to_recovery_addr))));
    ...
    assume {:print "$at(24,3287,3288)"} true;
L6:

    // assert Not(Not(VASP::$is_vasp[@98, @99]($t9))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:70:9+61
    assume {:print "$at(24,3562,3623)"} true;
    assert {:msg "assert_failed(24,3562,3623): function does not abort under this condition"}
      !!$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#98, $1_VASP_ParentVASP_$memory#99, $t9);

    // assert Not(RecoveryAddress::spec_is_recovery_address[@100]($t9)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:71:9+72
    assume {:print "$at(24,3632,3704)"} true;
    assert {:msg "assert_failed(24,3632,3704): function does not abort under this condition"}
      !$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#100, $t9);
    ...
    assume {:print "$at(24,3713,3832)"} true;
    assert {:msg "assert_failed(24,3713,3832): function does not abort under this condition"}
    ...
    assume {:print "$at(24,4021,4060)"} true;
    assert {:msg "assert_failed(24,4021,4060): post-condition does not hold"}
    ...
    assume {:print "$at(24,4069,4116)"} true;
    assert {:msg "assert_failed(24,4069,4116): post-condition does not hold"}
    ...
    assume {:print "$at(24,4125,4181)"} true;
    assert {:msg "assert_failed(24,4125,4181): post-condition does not hold"}
...
L7:
    ...
    // assert Or(Or(Not(VASP::$is_vasp[@98, @99]($t9)), RecoveryAddress::spec_is_recovery_address[@100]($t9)), Neq<address>(DiemAccount::$key_rotation_capability_address[]($t1), $t9)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:62:5+85
    assume {:print "$at(24,3293,3378)"} true;
    assert {:msg "assert_failed(24,3293,3378): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#98, $1_VASP_ParentVASP_$memory#99, $t9) || $1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#100, $t9)) || !$IsEqual'address'($1_DiemAccount_$key_rotation_capability_address($t1), $t9));

    // assert Or(Or(And(Not(VASP::$is_vasp[@98, @99]($t9)), Eq(7, $t15)), And(RecoveryAddress::spec_is_recovery_address[@100]($t9), Eq(6, $t15))), And(Neq<address>(DiemAccount::$key_rotation_capability_address[]($t1), $t9), Eq(7, $t15))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:62:5+85
    assert {:msg "assert_failed(24,3293,3378): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#98, $1_VASP_ParentVASP_$memory#99, $t9) && $IsEqual'u8'(7, $t15)) || ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#100, $t9) && $IsEqual'u8'(6, $t15))) || (!$IsEqual'address'($1_DiemAccount_$key_rotation_capability_address($t1), $t9) && $IsEqual'u8'(7, $t15)));
...
// fun RecoveryAddress::rotate_authentication_key [verification] at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1642
procedure {:timeLimit 40} $1_RecoveryAddress_rotate_authentication_key$verify(_$t0: int, _$t1: int, _$t2: int, _$t3: Vec (int)) returns ()
{
    // declare local variables
    var $t4: $1_DiemAccount_KeyRotationCapability;
    var $t5: Vec ($1_DiemAccount_KeyRotationCapability);
    var $t6: int;
    var $t7: int;
    var $t8: int;
    var $t9: bool;
    ...
    var $temp_0'vec'$1_DiemAccount_KeyRotationCapability'': Vec ($1_DiemAccount_KeyRotationCapability);
    var $temp_0'vec'u8'': Vec (int);
    var $1_RecoveryAddress_RecoveryAddress_$memory#113: $Memory $1_RecoveryAddress_RecoveryAddress;
    var $1_DiemAccount_DiemAccount_$memory#114: $Memory $1_DiemAccount_DiemAccount;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    $t3 := _$t3;
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): Or(DiemAccount::$delegated_key_rotation_capability(addr), DiemAccount::spec_holds_own_key_rotation_cap(addr)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1642
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2203:9+147
    assume {:print "$at(24,4427,6069)"} true;
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): Or(DiemAccount::spec_holds_delegated_withdraw_capability(addr), DiemAccount::spec_holds_own_withdraw_cap(addr)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1642
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<Roles::RoleId>(addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1642
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1642
    ...
    // assume true at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1642
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2327:9+115
    assume true;

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1642
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1642
    assume $IsValid'address'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1642
    assume $IsValid'address'($t2);

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1642
    ...
    // assume forall $rsc: ResourceDomain<RecoveryAddress::RecoveryAddress>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1642
    assume (forall $a_0: int :: {$ResourceValue($1_RecoveryAddress_RecoveryAddress_$memory, $a_0)}(var $rsc := $ResourceValue($1_RecoveryAddress_RecoveryAddress_$memory, $a_0);
    ($IsValid'$1_RecoveryAddress_RecoveryAddress'($rsc))));

    // @114 := save_mem(DiemAccount::DiemAccount) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1
    $1_DiemAccount_DiemAccount_$memory#114 := $1_DiemAccount_DiemAccount_$memory;

    // @113 := save_mem(RecoveryAddress::RecoveryAddress) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:87:5+1
    $1_RecoveryAddress_RecoveryAddress_$memory#113 := $1_RecoveryAddress_RecoveryAddress_$memory;
    ...
    assume {:print "$at(24,4705,4711)"} true;
    ...
    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:94:59+40
    ...
    // trace_local[tmp#$10]($t16) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:94:9+91
    assume {:print "$track_local(31,2,10):", $t16} $t16 == $t16;

    // trace_local[tmp#$9]($t14) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:94:9+91
    assume {:print "$track_local(31,2,9):", $t14} $t14 == $t14;
...
L1:
    ...
    assume {:print "$at(24,4698,4789)"} true;
    assume {:print "$track_abort(31,2):", $t16} $t16 == $t16;
    ...
    assume {:print "$at(24,4831,4838)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:95:22+27
    // >> opaque call: $t17 := Signer::address_of($t0)
...
L2:
    ...
    // $t13 := $t20 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:98:13+140
    $t13 := $t20;

    // trace_local[tmp#$13]($t20) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:98:13+140
    assume {:print "$track_local(31,2,13):", $t20} $t20 == $t20;
    ...
    assume {:print "$at(24,5069,5075)"} true;
L4:

    // $t21 := ==($t18, $t1) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:100:20+2
    $t21 := $IsEqual'address'($t18, $t1);

    // $t13 := $t21 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:98:13+140
    assume {:print "$at(24,4955,5095)"} true;
    $t13 := $t21;

    // trace_local[tmp#$13]($t21) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:98:13+140
    assume {:print "$track_local(31,2,13):", $t21} $t21 == $t21;
...
L5:
    ...
    assume {:print "$at(24,5134,5152)"} true;
    $t22 := 2;
    assume $IsValid'u64'($t22);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:101:13+44
    // >> opaque call: $t22 := Errors::invalid_argument($t21)
    ...
    // trace_local[tmp#$12]($t23) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:9+314
    assume {:print "$at(24,4849,5163)"} true;
    assume {:print "$track_local(31,2,12):", $t23} $t23 == $t23;

    // trace_local[tmp#$11]($t13) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:9+314
    assume {:print "$track_local(31,2,11):", $t13} $t13 == $t13;

    // if ($t13) goto L6 else goto L7 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:96:9+314
...
L7:
    ...
    assume {:print "$at(24,4849,5163)"} true;
    assume {:print "$track_abort(31,2):", $t23} $t23 == $t23;
    ...
    assume {:print "$at(24,5217,5233)"} true;
L6:
    ...
    if ($abort_flag) {
        assume {:print "$at(24,5186,5199)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(31,2):", $t17} $t17 == $t17;
        goto L17;
    }
    ...
    assume {:print "$at(24,5287,5307)"} true;
    ...
    assume {:print "$track_local(31,2,7):", $t27} $t27 == $t27;

    // label L14 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:108:13+133
    assume {:print "$at(24,5338,5471)"} true;
L14:

    // assert Le($t26, $t27) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:109:17+16
    assume {:print "$at(24,5361,5377)"} true;
    assert {:msg "assert_failed(24,5361,5377): base case of the loop invariant does not hold"}
      ($t26 <= $t27);

    // assert forall j: Range(0, $t26): Neq<address>(select DiemAccount::KeyRotationCapability.account_address(Index($t25, j)), $t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    assume {:print "$at(24,5394,5457)"} true;
    assert {:msg "assert_failed(24,5394,5457): base case of the loop invariant does not hold"}
    ...
    // havoc[val]($t26) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    havoc $t26;
    assume $IsValid'u64'($t26);

    // havoc[val]($t28) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    havoc $t28;
    assume $IsValid'bool'($t28);

    // havoc[val]($t29) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    havoc $t29;
    assume $IsValid'$1_DiemAccount_KeyRotationCapability'($t29);

    // havoc[val]($t30) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    havoc $t30;
    assume $IsValid'address'($t30);

    // havoc[val]($t31) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    havoc $t31;
    assume $IsValid'bool'($t31);

    // havoc[val]($t32) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    havoc $t32;
    assume $IsValid'u64'($t32);

    // havoc[val]($t33) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    havoc $t33;
    assume $IsValid'u64'($t33);

    // assume Not(AbortFlag()) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    assume !$abort_flag;

    // assume Le($t26, $t27) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:109:17+16
    assume {:print "$at(24,5361,5377)"} true;
    assume ($t26 <= $t27);

    // assume forall j: Range(0, $t26): Neq<address>(select DiemAccount::KeyRotationCapability.account_address(Index($t25, j)), $t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    assume {:print "$at(24,5394,5457)"} true;
    ...
    assume {:print "$at(24,5488,5489)"} true;
    call $t28 := $Lt($t26, $t27);

    // if ($t28) goto L8 else goto L9 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:107:9+469
    assume {:print "$at(24,5317,5786)"} true;
    if ($t28) { goto L8; } else { goto L9; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:107:9+469
L9:

    // goto L10 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:107:9+469
    goto L10;

    // label L8 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:115:38+4
    assume {:print "$at(24,5553,5557)"} true;
L8:
    ...
    if ($abort_flag) {
        assume {:print "$at(24,5538,5561)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(31,2):", $t17} $t17 == $t17;
        goto L17;
    }
    ...
    assume {:print "$track_local(31,2,4):", $t29} $t29 == $t29;
    ...
    assume {:print "$at(24,5579,5628)"} true;
...
L12:
    ...
    assume {:print "$at(24,5663,5715)"} true;
L11:
...
L13:
    ...
    assume {:print "$at(24,5775,5776)"} true;
    $t32 := 1;
    assume $IsValid'u64'($t32);
    ...
    if ($abort_flag) {
        assume {:print "$at(24,5773,5774)"} true;
        $t17 := $abort_code;
        assume {:print "$track_abort(31,2):", $t17} $t17 == $t17;
        goto L17;
    }
    ...
    assume {:print "$track_local(31,2,6):", $t33} $t33 == $t33;
    ...
    assume {:print "$at(24,5796,5919)"} true;
L10:

    // assert Eq<u64>($t26, $t27) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:123:13+16
    assume {:print "$at(24,5815,5831)"} true;
    assert {:msg "assert_failed(24,5815,5831): unknown assertion failed"}
      $IsEqual'u64'($t26, $t27);
    ...
    assume {:print "$at(24,5844,5909)"} true;
    assert {:msg "assert_failed(24,5844,5909): unknown assertion failed"}
    ...
    assume {:print "$at(24,6038,6062)"} true;
    $t34 := 4;
    assume $IsValid'u64'($t34);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:127:15+50
    // >> opaque call: $t34 := Errors::invalid_argument($t33)
    ...
    assume {:print "$at(24,6007,6063)"} true;
    assume {:print "$track_abort(31,2):", $t35} $t35 == $t35;
...
L15:
    ...
    // assert Le($t33, $t27) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:109:17+16
    assume {:print "$at(24,5361,5377)"} true;
    assert {:msg "assert_failed(24,5361,5377): induction case of the loop invariant does not hold"}
      ($t33 <= $t27);

    // assert forall j: Range(0, $t33): Neq<address>(select DiemAccount::KeyRotationCapability.account_address(Index($t25, j)), $t2) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    assume {:print "$at(24,5394,5457)"} true;
    assert {:msg "assert_failed(24,5394,5457): induction case of the loop invariant does not hold"}
      (var $range_0 := $Range(0, $t33); (forall $i_1: int :: $InRange($range_0, $i_1) ==> (var j := $i_1;
    (!$IsEqual'address'($account_address#$1_DiemAccount_KeyRotationCapability(ReadVec($t25, j)), $t2)))));

    // stop() at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:110:17+63
    assume false;
    return;

    // label L16 at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:128:5+1
    assume {:print "$at(24,6068,6069)"} true;
L16:

    // assert Not(Not(RecoveryAddress::spec_is_recovery_address[@113]($t1))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:138:9+81
    assume {:print "$at(24,6386,6467)"} true;
    assert {:msg "assert_failed(24,6386,6467): function does not abort under this condition"}
      !!$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#113, $t1);

    // assert Not(Not(DiemAccount::$exists_at[@114]($t2))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:139:9+73
    assume {:print "$at(24,6476,6549)"} true;
    assert {:msg "assert_failed(24,6476,6549): function does not abort under this condition"}
      !!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#114, $t2);

    // assert Not(Neq<num>(Len<u8>($t3), 32)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:140:9+59
    assume {:print "$at(24,6558,6617)"} true;
    assert {:msg "assert_failed(24,6558,6617): function does not abort under this condition"}
      !!$IsEqual'num'(LenVec($t3), 32);

    // assert Not(Not(RecoveryAddress::spec_holds_key_rotation_cap_for[@113]($t1, $t2))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:141:9+103
    assume {:print "$at(24,6626,6729)"} true;
    assert {:msg "assert_failed(24,6626,6729): function does not abort under this condition"}
      !!$1_RecoveryAddress_spec_holds_key_rotation_cap_for($1_RecoveryAddress_RecoveryAddress_$memory#113, $t1, $t2);
    ...
    assume {:print "$at(24,6738,6904)"} true;
    assert {:msg "assert_failed(24,6738,6904): function does not abort under this condition"}
    ...
    assume {:print "$at(24,7026,7089)"} true;
    assert {:msg "assert_failed(24,7026,7089): post-condition does not hold"}
...
L17:
    ...
    // assert Or(Or(Or(Or(Not(RecoveryAddress::spec_is_recovery_address[@113]($t1)), Not(DiemAccount::$exists_at[@114]($t2))), Neq<num>(Len<u8>($t3), 32)), Not(RecoveryAddress::spec_holds_key_rotation_cap_for[@113]($t1, $t2))), Not(Or(Eq<address>(Signer::spec_address_of[]($t0), $t1), Eq<address>(Signer::spec_address_of[]($t0), $t2)))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:129:5+135
    assume {:print "$at(24,6074,6209)"} true;
    assert {:msg "assert_failed(24,6074,6209): abort not covered by any of the `aborts_if` clauses"}
      ((((!$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#113, $t1) || !$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#114, $t2)) || !$IsEqual'num'(LenVec($t3), 32)) || !$1_RecoveryAddress_spec_holds_key_rotation_cap_for($1_RecoveryAddress_RecoveryAddress_$memory#113, $t1, $t2)) || !($IsEqual'address'($1_Signer_spec_address_of($t0), $t1) || $IsEqual'address'($1_Signer_spec_address_of($t0), $t2)));

    // assert Or(Or(Or(Or(And(Not(RecoveryAddress::spec_is_recovery_address[@113]($t1)), Eq(5, $t17)), And(Not(DiemAccount::$exists_at[@114]($t2)), Eq(5, $t17))), And(Neq<num>(Len<u8>($t3), 32), Eq(7, $t17))), And(Not(RecoveryAddress::spec_holds_key_rotation_cap_for[@113]($t1, $t2)), Eq(7, $t17))), And(Not(Or(Eq<address>(Signer::spec_address_of[]($t0), $t1), Eq<address>(Signer::spec_address_of[]($t0), $t2))), Eq(7, $t17))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:129:5+135
    assert {:msg "assert_failed(24,6074,6209): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((!$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#113, $t1) && $IsEqual'u8'(5, $t17)) || (!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#114, $t2) && $IsEqual'u8'(5, $t17))) || (!$IsEqual'num'(LenVec($t3), 32) && $IsEqual'u8'(7, $t17))) || (!$1_RecoveryAddress_spec_holds_key_rotation_cap_for($1_RecoveryAddress_RecoveryAddress_$memory#113, $t1, $t2) && $IsEqual'u8'(7, $t17))) || (!($IsEqual'address'($1_Signer_spec_address_of($t0), $t1) || $IsEqual'address'($1_Signer_spec_address_of($t0), $t2)) && $IsEqual'u8'(7, $t17)));
...
{
    // declare local variables
    var $t2: $Mutation (Vec ($1_DiemAccount_KeyRotationCapability));
    var $t3: bool;
    var $t4: int;
    var $t5: bool;
    var $t6: int;
    ...
    var $temp_0'u64': int;
    var $temp_0'vec'$1_DiemAccount_KeyRotationCapability'': Vec ($1_DiemAccount_KeyRotationCapability);
    var $1_RecoveryAddress_RecoveryAddress_$memory#120: $Memory $1_RecoveryAddress_RecoveryAddress;
    var $1_VASP_ChildVASP_$memory#121: $Memory $1_VASP_ChildVASP;
    var $1_VASP_ParentVASP_$memory#122: $Memory $1_VASP_ParentVASP;
    var $1_RecoveryAddress_RecoveryAddress_$memory#246: $Memory $1_RecoveryAddress_RecoveryAddress;
    $t0 := _$t0;
    $t1 := _$t1;
    assume IsEmptyVec(p#$Mutation($t2));
    assume IsEmptyVec(p#$Mutation($t19));
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume {:print "$at(24,7352,8315)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));
    ...
    assume {:print "$at(24,8805,8887)"} true;
    assume ($t10 == $1_DiemAccount_$key_rotation_capability_address($t0));

    // @121 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:154:5+1
    assume {:print "$at(24,7352,7353)"} true;
    $1_VASP_ChildVASP_$memory#121 := $1_VASP_ChildVASP_$memory;

    // @122 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:154:5+1
    $1_VASP_ParentVASP_$memory#122 := $1_VASP_ParentVASP_$memory;

    // @120 := save_mem(RecoveryAddress::RecoveryAddress) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:154:5+1
    $1_RecoveryAddress_RecoveryAddress_$memory#120 := $1_RecoveryAddress_RecoveryAddress_$memory;
    ...
    assume {:print "$at(24,7569,7575)"} true;
    ...
    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:157:59+40
    // >> opaque call: $t12 := Errors::not_published($t11)
    ...
    // trace_local[tmp#$4]($t13) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:157:9+91
    assume {:print "$track_local(31,0,4):", $t13} $t13 == $t13;

    // trace_local[tmp#$3]($t11) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:157:9+91
    assume {:print "$track_local(31,0,3):", $t11} $t11 == $t11;
...
L1:
    ...
    assume {:print "$at(24,7562,7653)"} true;
    assume {:print "$track_abort(31,0):", $t13} $t13 == $t13;
    ...
    assume {:print "$at(24,7822,7833)"} true;
L0:
    ...
    if ($abort_flag) {
        assume {:print "$at(24,7777,7834)"} true;
        $t14 := $abort_code;
        assume {:print "$track_abort(31,0):", $t14} $t14 == $t14;
        goto L7;
    }

    // trace_local[to_recover_address]($t15) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:159:13+18
    assume {:print "$track_local(31,0,9):", $t15} $t15 == $t15;

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:161:13+56
    // >> opaque call: $t14 := VASP::is_same_vasp($t1, $t13)
    assume {:print "$at(24,7864,7920)"} true;
    ...
    assume {:print "$at(24,7959,7991)"} true;
    $t17 := 3;
    assume $IsValid'u64'($t17);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:162:13+58
    // >> opaque call: $t16 := Errors::invalid_argument($t15)
    ...
    // trace_local[tmp#$6]($t18) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:160:9+158
    assume {:print "$at(24,7844,8002)"} true;
    assume {:print "$track_local(31,0,6):", $t18} $t18 == $t18;

    // trace_local[tmp#$5]($t16) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:160:9+158
    assume {:print "$track_local(31,0,5):", $t16} $t16 == $t16;
...
L3:
    ...
    assume {:print "$at(24,7844,8002)"} true;
    assume {:print "$track_abort(31,0):", $t18} $t18 == $t18;
    ...
    assume {:print "$at(24,8073,8089)"} true;
L2:
    ...
    if ($abort_flag) {
        assume {:print "$at(24,8038,8055)"} true;
        $t14 := $abort_code;
        assume {:print "$track_abort(31,0):", $t14} $t14 == $t14;
        goto L7;
    }
    ...
    assume {:print "$track_local(31,0,2):", $temp_0'vec'$1_DiemAccount_KeyRotationCapability''} $temp_0'vec'$1_DiemAccount_KeyRotationCapability'' == $temp_0'vec'$1_DiemAccount_KeyRotationCapability'';

    // $t21 := read_ref($t20) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:167:28+13
    assume {:print "$at(24,8149,8162)"} true;
    $t21 := $Dereference($t20);
    ...
    if ($abort_flag) {
        assume {:print "$at(24,8134,8163)"} true;
        $t14 := $abort_code;
        assume {:print "$track_abort(31,0):", $t14} $t14 == $t14;
        goto L7;
    }
    ...
    assume {:print "$at(24,8222,8242)"} true;
    $t25 := 6;
    assume $IsValid'u64'($t25);

    // nop at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:168:13+44
    ...
    // trace_local[tmp#$8]($t26) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:166:9+139
    assume {:print "$at(24,8114,8253)"} true;
    assume {:print "$track_local(31,0,8):", $t26} $t26 == $t26;

    // trace_local[tmp#$7]($t24) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:166:9+139
    assume {:print "$track_local(31,0,7):", $t24} $t24 == $t24;
...
L5:
    ...
    assume {:print "$at(24,8114,8253)"} true;
    assume {:print "$track_abort(31,0):", $t26} $t26 == $t26;
    ...
    assume {:print "$at(24,8282,8295)"} true;
L4:
    ...
    if ($abort_flag) {
        assume {:print "$at(24,8264,8308)"} true;
        $t14 := $abort_code;
        assume {:print "$track_abort(31,0):", $t14} $t14 == $t14;
        goto L7;
    }
    ...
    // assume forall recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address(recovery_addr): VASP::$is_vasp(recovery_addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:154:5+963
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:235:9+163
    assume (forall recovery_addr: int :: $IsValid'address'(recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr))  ==> ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, recovery_addr)));

    // @246 := save_mem(RecoveryAddress::RecoveryAddress) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:154:5+963
    // state save for global update invariants
    $1_RecoveryAddress_RecoveryAddress_$memory#246 := $1_RecoveryAddress_RecoveryAddress_$memory;
    ...
    // assert forall addr: TypeDomain<address>(): Implies(RecoveryAddress::spec_is_recovery_address[@246](addr), RecoveryAddress::spec_is_recovery_address(addr)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:209:9+136
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:209:9+136
    assume {:print "$at(24,9874,10010)"} true;
    assert {:msg "assert_failed(24,9874,10010): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> (($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#246, addr) ==> $1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory, addr))));

    // assert forall addr: TypeDomain<address>() where exists[@246]<RecoveryAddress::RecoveryAddress>(addr): exists<RecoveryAddress::RecoveryAddress>(addr) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:218:9+122
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:218:9+122
    assume {:print "$at(24,10131,10253)"} true;
    assert {:msg "assert_failed(24,10131,10253): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_RecoveryAddress_RecoveryAddress_$memory#246, addr))  ==> ($ResourceExists($1_RecoveryAddress_RecoveryAddress_$memory, addr)));

    // assert forall recovery_addr: TypeDomain<address>(), to_recovery_addr: TypeDomain<address>() where RecoveryAddress::spec_is_recovery_address[@246](recovery_addr): Implies(RecoveryAddress::spec_holds_key_rotation_cap_for[@246](recovery_addr, to_recovery_addr), RecoveryAddress::spec_holds_key_rotation_cap_for(recovery_addr, to_recovery_addr)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:223:9+321
    // global invariant at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:223:9+321
    assume {:print "$at(24,10444,10765)"} true;
    assert {:msg "assert_failed(24,10444,10765): global memory invariant does not hold"}
      (forall recovery_addr: int, to_recovery_addr: int :: $IsValid'address'(recovery_addr) ==> $IsValid'address'(to_recovery_addr) ==> ($1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#246, recovery_addr))  ==> (($1_RecoveryAddress_spec_holds_key_rotation_cap_for($1_RecoveryAddress_RecoveryAddress_$memory#246, recovery_addr, to_recovery_addr) ==> $1_RecoveryAddress_spec_holds_key_rotation_cap_for($1_RecoveryAddress_RecoveryAddress_$memory, recovery_addr, to_recovery_addr))));
    ...
    assume {:print "$at(24,8314,8315)"} true;
L6:
    ...
    assume {:print "$at(24,9139,9214)"} true;
    assume ($t27 == LenVec($1_RecoveryAddress_spec_get_rotation_caps($1_RecoveryAddress_RecoveryAddress_$memory, $t1)));

    // assert Not(Not(RecoveryAddress::spec_is_recovery_address[@120]($t1))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:180:9+81
    assume {:print "$at(24,8584,8665)"} true;
    assert {:msg "assert_failed(24,8584,8665): function does not abort under this condition"}
      !!$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#120, $t1);

    // assert Not(Ge(Len<DiemAccount::KeyRotationCapability>(select RecoveryAddress::RecoveryAddress.rotation_caps(global[@120]<RecoveryAddress::RecoveryAddress>($t1))), 256)) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:181:9+122
    assume {:print "$at(24,8674,8796)"} true;
    assert {:msg "assert_failed(24,8674,8796): function does not abort under this condition"}
      !(LenVec($rotation_caps#$1_RecoveryAddress_RecoveryAddress($ResourceValue($1_RecoveryAddress_RecoveryAddress_$memory#120, $t1))) >= 256);

    // assert Not(Not(VASP::spec_is_same_vasp[@121, @122]($t1, $t10))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:183:9+103
    assume {:print "$at(24,8896,8999)"} true;
    assert {:msg "assert_failed(24,8896,8999): function does not abort under this condition"}
      !!$1_VASP_spec_is_same_vasp($1_VASP_ChildVASP_$memory#121, $1_VASP_ParentVASP_$memory#122, $t1, $t10);
    ...
    assume {:print "$at(24,9223,9309)"} true;
    assert {:msg "assert_failed(24,9223,9309): post-condition does not hold"}
...
L7:
    ...
    // assert Or(Or(Not(RecoveryAddress::spec_is_recovery_address[@120]($t1)), Ge(Len<DiemAccount::KeyRotationCapability>(select RecoveryAddress::RecoveryAddress.rotation_caps(global[@120]<RecoveryAddress::RecoveryAddress>($t1))), 256)), Not(VASP::spec_is_same_vasp[@121, @122]($t1, $t10))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:173:5+129
    assume {:print "$at(24,8320,8449)"} true;
    assert {:msg "assert_failed(24,8320,8449): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#120, $t1) || (LenVec($rotation_caps#$1_RecoveryAddress_RecoveryAddress($ResourceValue($1_RecoveryAddress_RecoveryAddress_$memory#120, $t1))) >= 256)) || !$1_VASP_spec_is_same_vasp($1_VASP_ChildVASP_$memory#121, $1_VASP_ParentVASP_$memory#122, $t1, $t10));

    // assert Or(Or(And(Not(RecoveryAddress::spec_is_recovery_address[@120]($t1)), Eq(5, $t14)), And(Ge(Len<DiemAccount::KeyRotationCapability>(select RecoveryAddress::RecoveryAddress.rotation_caps(global[@120]<RecoveryAddress::RecoveryAddress>($t1))), 256), Eq(8, $t14))), And(Not(VASP::spec_is_same_vasp[@121, @122]($t1, $t10)), Eq(7, $t14))) at /home/ying/diem/language/diem-framework/modules/RecoveryAddress.move:173:5+129
    assert {:msg "assert_failed(24,8320,8449): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_RecoveryAddress_spec_is_recovery_address($1_RecoveryAddress_RecoveryAddress_$memory#120, $t1) && $IsEqual'u8'(5, $t14)) || ((LenVec($rotation_caps#$1_RecoveryAddress_RecoveryAddress($ResourceValue($1_RecoveryAddress_RecoveryAddress_$memory#120, $t1))) >= 256) && $IsEqual'u8'(8, $t14))) || (!$1_VASP_spec_is_same_vasp($1_VASP_ChildVASP_$memory#121, $1_VASP_ParentVASP_$memory#122, $t1, $t10) && $IsEqual'u8'(7, $t14)));
...
L5:
    ...
    assume {:print "$at(12,1195,1226)"} true;
    assume {:print "$track_abort(32,2):", $t4} $t4 == $t4;
...
L7:
    ...
    // @177 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@177](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
...
L7:
    ...
    // @171 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@171](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
...
procedure {:timeLimit 40} $1_Genesis_initialize$verify(_$t0: int, _$t1: int, _$t2: Vec (int), _$t3: Vec (int), _$t4: Vec (Vec (int)), _$t5: bool, _$t6: Vec (int), _$t7: Vec (int), _$t8: int, _$t9: int) returns ()
{
    ...
    // trace_local[dr_account#2040]($t0) at /home/ying/diem/language/diem-framework/modules/Genesis.move:40:13+10
    assume {:print "$at(22,1422,1432)"} true;
    assume {:print "$track_local(35,1,10):", $t0} $t0 == $t0;

    // trace_local[tc_account#2041]($t1) at /home/ying/diem/language/diem-framework/modules/Genesis.move:41:13+10
