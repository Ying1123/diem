...
(assert (not
 (=> (= (ControlFlow 0 0) 1210566) (let ((anon11_Else_correct@@25  (=> (not $abort_flag@0@@51) (=> (and (= $t4@0@@23 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t3@1@@9)) (= $t4@0@@23 $t4@0@@23)) (and (=> (= (ControlFlow 0 884300) (- 0 1211029)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 884300) (- 0 1211050)) (forall ((addr@@1483 Int) ) (!  (=> (|$IsValid'address'| addr@@1483) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1483)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1483))))
 :qid |Diembpl.36995:15|
 :skolemid |2002|
))) (=> (forall ((addr@@1484 Int) ) (!  (=> (|$IsValid'address'| addr@@1484) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1484)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1484))))
 :qid |Diembpl.36995:15|
 :skolemid |2002|
)) (and (=> (= (ControlFlow 0 884300) (- 0 1211079)) (forall ((addr@@1485 Int) ) (!  (=> (|$IsValid'address'| addr@@1485) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1485) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1485)))
 :qid |Diembpl.37000:15|
 :skolemid |2003|
))) (=> (forall ((addr@@1486 Int) ) (!  (=> (|$IsValid'address'| addr@@1486) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1486) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@1486)))
 :qid |Diembpl.37000:15|
 :skolemid |2003|
)) (and (=> (= (ControlFlow 0 884300) (- 0 1211104)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 884300) (- 0 1211125)) (forall ((addr@@1487 Int) ) (!  (=> (|$IsValid'address'| addr@@1487) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1487)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1487))))
 :qid |Diembpl.37010:15|
 :skolemid |2004|
))) (=> (forall ((addr@@1488 Int) ) (!  (=> (|$IsValid'address'| addr@@1488) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1488)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1488))))
 :qid |Diembpl.37010:15|
 :skolemid |2004|
)) (and (=> (= (ControlFlow 0 884300) (- 0 1211154)) (forall ((addr@@1489 Int) ) (!  (=> (|$IsValid'address'| addr@@1489) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1489) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1489)))
 :qid |Diembpl.37015:15|
 :skolemid |2005|
))) (=> (forall ((addr@@1490 Int) ) (!  (=> (|$IsValid'address'| addr@@1490) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1490) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@1490)))
 :qid |Diembpl.37015:15|
 :skolemid |2005|
)) (and (=> (= (ControlFlow 0 884300) (- 0 1211179)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 884300) (- 0 1211200)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 884300) (- 0 1211221)) (forall ((addr@@1491 Int) ) (!  (=> (|$IsValid'address'| addr@@1491) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1491) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@1491))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1491))))
 :qid |Diembpl.37030:15|
 :skolemid |2006|
))) (=> (forall ((addr@@1492 Int) ) (!  (=> (|$IsValid'address'| addr@@1492) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1492) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@1492))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1492))))
 :qid |Diembpl.37030:15|
 :skolemid |2006|
)) (and (=> (= (ControlFlow 0 884300) (- 0 1211257)) (forall ((addr@@1493 Int) ) (!  (=> (|$IsValid'address'| addr@@1493) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1493) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1493)))
 :qid |Diembpl.37035:15|
 :skolemid |2007|
))) (=> (forall ((addr@@1494 Int) ) (!  (=> (|$IsValid'address'| addr@@1494) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1494) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1494)))
 :qid |Diembpl.37035:15|
 :skolemid |2007|
)) (=> (= (ControlFlow 0 884300) (- 0 1211282)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))))))))))))))))))))))))))
(let ((anon11_Then_correct@@25 true))
(let ((anon10_Then$1_correct@@8  (=> (= $t3@1@@9 $t3@@23) (=> (and (= $abort_flag@0@@51 true) (= $abort_code@1@@51 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 884372) 884314) anon11_Then_correct@@25) (=> (= (ControlFlow 0 884372) 884300) anon11_Else_correct@@25))))))
(let ((anon10_Then_correct@@28  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 884370) 884372)) anon10_Then$1_correct@@8)))
(let ((anon10_Else_correct@@28  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t3@0@@18 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t3@1@@9 $t3@0@@18)) (and (= $abort_flag@0@@51 false) (= $abort_code@1@@51 $abort_code@0@@51))) (and (=> (= (ControlFlow 0 883998) 884314) anon11_Then_correct@@25) (=> (= (ControlFlow 0 883998) 884300) anon11_Else_correct@@25))))))
(let ((anon9_Else_correct@@24  (=> (and (not $t0@@8) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 883984) 884370) anon10_Then_correct@@28) (=> (= (ControlFlow 0 883984) 883998) anon10_Else_correct@@28)))))
(let ((anon9_Then_correct@@24 true))
(let ((anon0$1_correct@@73  (=> (and (and (and (and (forall ((addr3@@305 Int) ) (!  (=> (|$IsValid'address'| addr3@@305) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3@@305) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.36900:22|
 :skolemid |1992|
)) (forall ((addr3@@306 Int) ) (!  (=> (|$IsValid'address'| addr3@@306) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316220| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@306) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |Diembpl.36900:261|
 :skolemid |1993|
))) (forall ((addr3@@307 Int) ) (!  (=> (|$IsValid'address'| addr3@@307) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr3@@307) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |Diembpl.36900:501|
 :skolemid |1994|
))) (and (and (forall ((addr@@1495 Int) ) (!  (=> (|$IsValid'address'| addr@@1495) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@1495) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.36904:22|
 :skolemid |1995|
)) (forall ((addr@@1496 Int) ) (!  (=> (|$IsValid'address'| addr@@1496) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@1496) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.36904:222|
 :skolemid |1996|
))) (forall ((addr@@1497 Int) ) (!  (=> (|$IsValid'address'| addr@@1497) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@1497) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.36904:423|
 :skolemid |1997|
)))) (and (and (and (forall ((addr@@1498 Int) ) (!  (=> (|$IsValid'address'| addr@@1498) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@1498) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.36908:22|
 :skolemid |1998|
)) (forall ((addr@@1499 Int) ) (!  (=> (|$IsValid'address'| addr@@1499) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@1499) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.36908:227|
 :skolemid |1999|
))) (forall ((addr@@1500 Int) ) (!  (=> (|$IsValid'address'| addr@@1500) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@1500) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.36908:433|
 :skolemid |2000|
))) (and (forall (($a_0@@107 Int) ) (! (let (($rsc@@107 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@107)))
 (and (|$IsValid'$1_Diem_CurrencyInfo'#0''| $rsc@@107) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@107)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@107) 10000000000))))
 :qid |Diembpl.36911:20|
 :skolemid |2001|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@107))
)) (= $t0@@8  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 883970) 884398) anon9_Then_correct@@24) (=> (= (ControlFlow 0 883970) 883984) anon9_Else_correct@@24)))))
(let ((inline$$InitEventStore$0$anon0_correct@@73  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@153 T@$1_Event_EventHandle) ) (! (let ((stream@@191 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@153)))
 (and (= (|l#Multiset_275813| stream@@191) 0) (forall ((v@@200 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@191) v@@200) 0)
 :qid |Diembpl.159:13|
 :skolemid |4|
))))
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 883691) 883970)) anon0$1_correct@@73)))
(let ((anon0_correct@@73  (=> (= (ControlFlow 0 1210566) 883691) inline$$InitEventStore$0$anon0_correct@@73)))
anon0_correct@@73)))))))))))
))
(check-sat)
(pop 1)
