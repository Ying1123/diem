...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1054813) (let ((L2_correct  (and (=> (= (ControlFlow 0 691520) (- 0 1055588)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (=> (= (ControlFlow 0 691520) (- 0 1055593)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t1@0)))))))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t1@0 $abort_code@1) (= (ControlFlow 0 691492) 691520))) L2_correct)))
(let ((anon9_Then_correct  (=> $t0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t1)) (= $t1 $t1)) (and (= $t1@0 $t1) (= (ControlFlow 0 691598) 691520))) L2_correct))))
(let ((anon11_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t4@0 (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t3@1)) (= $t4@0 $t4@0)) (and (=> (= (ControlFlow 0 691478) (- 0 1055282)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 691478) (- 0 1055292)) (= $t4@0 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (= $t4@0 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 691478) (- 0 1055302)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 691478) (- 0 1055323)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@0))))
 :qid |Diembpl.8823:15|
 :skolemid |270|
 ...
 :qid |Diembpl.8823:15|
 :skolemid |270|
)) (and (=> (= (ControlFlow 0 691478) (- 0 1055352)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_307639| |$1_Diem_MintCapability'#0'_$memory|) addr@@2)))
 :qid |Diembpl.8828:15|
 :skolemid |271|
 ...
 :qid |Diembpl.8828:15|
 :skolemid |271|
)) (and (=> (= (ControlFlow 0 691478) (- 0 1055377)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 691478) (- 0 1055398)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4))))
 :qid |Diembpl.8838:15|
 :skolemid |272|
 ...
 :qid |Diembpl.8838:15|
 :skolemid |272|
)) (and (=> (= (ControlFlow 0 691478) (- 0 1055427)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_307898| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6)))
 :qid |Diembpl.8843:15|
 :skolemid |273|
 ...
 :qid |Diembpl.8858:15|
 :skolemid |274|
)) (and (=> (= (ControlFlow 0 691478) (- 0 1055530)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_308283| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10)))
 :qid |Diembpl.8863:15|
 :skolemid |275|
...
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 691572) 691492) anon11_Then_correct) (=> (= (ControlFlow 0 691572) 691478) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 691570) 691572)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t3@1 $t3@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 691156) 691492) anon11_Then_correct) (=> (= (ControlFlow 0 691156) 691478) anon11_Else_correct))))))
(let ((anon9_Else_correct  (=> (and (not $t0) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 691142) 691570) anon10_Then_correct) (=> (= (ControlFlow 0 691142) 691156) anon10_Else_correct)))))
...
)) (= $t0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_326137| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 691128) 691598) anon9_Then_correct) (=> (= (ControlFlow 0 691128) 691142) anon9_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_274042_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 690845) 691128)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1054813) 690845) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
