...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2039294) (let ((anon0$1_correct  (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_468892| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@0)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0)) 2)))))
 :qid |DiemAccountbpl.49997:20|
 :skolemid |1618|
)) (=> (and (and (and (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468892| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@1)))
 :qid |DiemAccountbpl.50001:22|
 :skolemid |1619|
)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@2)))
 :qid |DiemAccountbpl.50001:218|
 :skolemid |1620|
))) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@3)))
 :qid |DiemAccountbpl.50001:415|
 :skolemid |1621|
))) (|$IsValid'address'| _$t0)) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) $a_0)))
(|$IsValid'$1_DiemAccount_Balance'$1_XDX_XDX''| $rsc))
 :qid |DiemAccountbpl.50007:20|
 :skolemid |1622|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) $a_0))
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)) (= $t1@0 $t1@0)))) (and (=> (= (ControlFlow 0 1283646) (- 0 2039498)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4)))))
 :qid |DiemAccountbpl.50033:15|
 :skolemid |1623|
 ...
 :qid |DiemAccountbpl.50033:15|
 :skolemid |1623|
)) (=> (= (ControlFlow 0 1283646) (- 0 2039534)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@6) (>= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$coin#$1_DiemAccount_Balance'$1_XDX_XDX'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@6))) (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$coin#$1_DiemAccount_Balance'$1_XDX_XDX'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_468952| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@6))))))
 :qid |DiemAccountbpl.50038:15|
 :skolemid |1624|
)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1283396) 1283646)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2039294) 1283396) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
