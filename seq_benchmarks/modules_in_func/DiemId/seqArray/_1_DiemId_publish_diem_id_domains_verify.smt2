...
(declare-fun $1_DiemId_DiemIdDomainManager_$memory@1 () T@$Memory_134529)
(declare-fun $t6@0 () Int)
(declare-fun $abort_code@1@@1 () Int)
(declare-fun $1_DiemId_DiemIdDomainManager_$memory@0 () T@$Memory_134529)
...
(declare-fun $1_DiemId_DiemIdDomains_$memory@1 () T@$Memory_134465)
(declare-fun $t7@0@@0 () Int)
(declare-fun $abort_code@1@@2 () Int)
(declare-fun _$t0@@4 () T@$signer)
(declare-fun $1_DiemId_DiemIdDomains_$memory@0@@0 () T@$Memory_134465)
...
(assert (not
 (=> (= (ControlFlow 0 0) 225913) (let ((anon18_Else_correct@@1  (=> (not $abort_flag@0@@2) (and (=> (= (ControlFlow 0 166632) (- 0 226777)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4@@0))) (and (=> (= (ControlFlow 0 166632) (- 0 226789)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4@@0)) 5)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4@@0)) 5))) (and (=> (= (ControlFlow 0 166632) (- 0 226807)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t3@@0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t3@@0)) (and (=> (= (ControlFlow 0 166632) (- 0 226817)) (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory@1) $t3@@0)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory@1) $t3@@0) (=> (= (ControlFlow 0 166632) (- 0 226825)) (= (seq.len (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory@1) $t3@@0))) 0)))))))))))))
(let ((anon16_Then_correct@@1 true))
(let ((L3_correct@@2  (and (=> (= (ControlFlow 0 166367) (- 0 226684)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4@@0)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t3@@0))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4@@0)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t3@@0)) (=> (= (ControlFlow 0 166367) (- 0 226713)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4@@0)) (= 5 $t7@0@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4@@0)) 5)) (= 3 $t7@0@@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t3@@0) (= 6 $t7@0@@0))))))))
(let ((anon18_Then_correct@@1  (=> (and (and $abort_flag@0@@2 (= $abort_code@1@@2 $abort_code@1@@2)) (and (= $t7@0@@0 $abort_code@1@@2) (= (ControlFlow 0 166646) 166367))) L3_correct@@2)))
(let ((anon17_Then$1_correct@@0  (=> (= $1_DiemId_DiemIdDomains_$memory@1 $1_DiemId_DiemIdDomains_$memory) (=> (and (= $abort_flag@0@@2 true) (= $abort_code@1@@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 166698) 166646) anon18_Then_correct@@1) (=> (= (ControlFlow 0 166698) 166632) anon18_Else_correct@@1))))))
(let ((anon17_Then_correct@@1  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0@@4)) (= (ControlFlow 0 166696) 166698)) anon17_Then$1_correct@@0)))
(let ((anon17_Else_correct@@1  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0@@4))) (=> (and (and (= $1_DiemId_DiemIdDomains_$memory@0@@0 ($Memory_134465 (|Store__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0@@4) true) (|Store__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0@@4) $t14@0))) (= $1_DiemId_DiemIdDomains_$memory@1 $1_DiemId_DiemIdDomains_$memory@0@@0)) (and (= $abort_flag@0@@2 false) (= $abort_code@1@@2 $abort_code@0@@2))) (and (=> (= (ControlFlow 0 166562) 166646) anon18_Then_correct@@1) (=> (= (ControlFlow 0 166562) 166632) anon18_Else_correct@@1))))))
(let ((anon16_Else_correct@@1  (=> (and (not false) (= $t14@0 ($1_DiemId_DiemIdDomains |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1|))) (and (=> (= (ControlFlow 0 166540) (- 0 226465)) (let (($range_0@@11 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) i@@69))) 63)))
 :qid |DiemIdbpl.13541:91|
 :skolemid |238|
))) (and (=> (= (ControlFlow 0 166540) (- 0 226509)) (let (($range_0@@13 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
...
(forall (($i_3@@3 Int) ) (!  (=> ($InRange $range_2@@3 $i_3@@3) (let ((j@@17 $i_3@@3))
 ...
 :qid |DiemIdbpl.13549:96|
 :skolemid |239|
)))))
 :qid |DiemIdbpl.13548:91|
 :skolemid |240|
...
(forall (($i_3@@4 Int) ) (!  (=> ($InRange $range_2@@4 $i_3@@4) (let ((j@@18 $i_3@@4))
 ...
 :qid |DiemIdbpl.13548:91|
 :skolemid |240|
))) (and (=> (= (ControlFlow 0 166540) 166696) anon17_Then_correct@@1) (=> (= (ControlFlow 0 166540) 166562) anon17_Else_correct@@1)))))))))
(let ((|inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1| (as seq.empty (Seq T@$1_DiemId_DiemIdDomain))) (and (=> (= (ControlFlow 0 166393) 166712) anon16_Then_correct@@1) (=> (= (ControlFlow 0 166393) 166540) anon16_Else_correct@@1)))))
(let ((anon15_Then_correct@@1  (=> (and inline$$Not$0$dst@1@@1 (= (ControlFlow 0 166399) 166393)) |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$anon0_correct|)))
(let ((anon15_Else_correct@@1  (=> (and (and (not inline$$Not$0$dst@1@@1) (= $t12@@0 $t12@@0)) (and (= $t7@0@@0 $t12@@0) (= (ControlFlow 0 166271) 166367))) L3_correct@@2)))
(let ((anon14_Else$1_correct@@0  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t12@@0) (= $t12@@0 6)) (and (= $t12@@0 $t12@@0) (= inline$$Not$0$dst@1@@1 inline$$Not$0$dst@1@@1))) (and (=> (= (ControlFlow 0 166255) 166399) anon15_Then_correct@@1) (=> (= (ControlFlow 0 166255) 166271) anon15_Else_correct@@1))))))
(let ((inline$$Not$0$anon0_correct@@1  (=> (and (= inline$$Not$0$dst@1@@1  (not $t9@0@@0)) (= (ControlFlow 0 166215) 166255)) anon14_Else$1_correct@@0)))
(let ((anon14_Else_correct@@1  (=> (not $t6@@1) (=> (and (and (|$IsValid'address'| $t8@@0) (= $t8@@0 (|$addr#$signer| _$t0@@4))) (and (= $t9@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t8@@0)) (= (ControlFlow 0 166221) 166215))) inline$$Not$0$anon0_correct@@1))))
(let ((anon14_Then_correct@@1  (=> $t6@@1 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t5@@0)) (= 5 $t7@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t5@@0)) 5)) (= 3 $t7@@0))) (= $t7@@0 $t7@@0)) (and (= $t7@0@@0 $t7@@0) (= (ControlFlow 0 166764) 166367))) L3_correct@@2))))
(let ((anon0$1_correct@@5  (=> (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@4)) (forall (($a_0@@7 Int) ) (! (let (($rsc@@7 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $a_0@@7)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@7))
 :qid |DiemIdbpl.13392:20|
 :skolemid |232|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $a_0@@7))
))) (and (forall (($a_0@@8 Int) ) (! (let (($rsc@@8 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $a_0@@8)))
...
(forall (($i_6@@2 Int) ) (!  (=> ($InRange $range_5@@2 $i_6@@2) (let ((j@@19 $i_6@@2))
 ...
 :qid |DiemIdbpl.13399:96|
 :skolemid |234|
)))))
 :qid |DiemIdbpl.13398:196|
 :skolemid |235|
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| $elem@@6)) 63)))
 :qid |DiemIdbpl.13400:221|
 :skolemid |236|
))))))
 :qid |DiemIdbpl.13396:20|
 :skolemid |237|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $a_0@@8))
)) (= $t3@@0 (|$addr#$signer| _$t0@@4)))) (and (and (= $t4@@0 (|$addr#$signer| _$t0@@4)) (= _$t0@@4 _$t0@@4)) (and (= $t5@@0 (|$addr#$signer| _$t0@@4)) (= $t6@@1  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t5@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t5@@0)) 5))))))) (and (=> (= (ControlFlow 0 166159) 166764) anon14_Then_correct@@1) (=> (= (ControlFlow 0 166159) 166221) anon14_Else_correct@@1)))))
(let ((inline$$InitEventStore$0$anon0_correct@@5  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@10 T@$1_Event_EventHandle) ) (! (let ((stream@@10 (|Select__T@[$1_Event_EventHandle]Multiset_69963_| (|streams#$EventStore| $es) handle@@10)))
 (and (= (|l#Multiset_69963| stream@@10) 0) (forall ((v@@47 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_69963| stream@@10) v@@47) 0)
 :qid |DiemIdbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemIdbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 165861) 166159)) anon0$1_correct@@5)))
(let ((anon0_correct@@5  (=> (= (ControlFlow 0 225913) 165861) inline$$InitEventStore$0$anon0_correct@@5)))
anon0_correct@@5)))))))))))))))))))
))
(check-sat)
(pop 1)
