...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 53738) (let ((L3_correct  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 46309) (- 0 53977)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 46309) (- 0 53984)) (= $t1@0  (or (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0)))) (=> (= $t1@0  (or (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0))) (and (=> (= (ControlFlow 0 46309) (- 0 53997)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (= (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) a)))
 :qid |VASPbpl.2721:15|
 :skolemid |92|
 ...
 :qid |VASPbpl.2721:15|
 :skolemid |92|
)) (=> (= (ControlFlow 0 46309) (- 0 54022)) (forall ((parent Int) ) (!  (=> (|$IsValid'address'| parent) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) parent) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_32262| $1_VASP_ParentVASP_$memory) parent)) (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_32262| $1_VASP_ParentVASP_$memory) parent)))))
 :qid |VASPbpl.2726:15|
 :skolemid |93|
))))))))))))
(let ((anon3_Else_correct  (=> (not $t2) (=> (and (and (= $t4 (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) _$t0)) (= $t4 $t4)) (and (= $t1@0 $t4) (= (ControlFlow 0 46219) 46309))) L3_correct))))
(let ((anon3_Then_correct  (=> (and (and $t2 (= true true)) (and (= $t1@0 true) (= (ControlFlow 0 46327) 46309))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_32198| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |VASPbpl.2615:20|
 :skolemid |88|
)) (=> (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_32984| $1_RecoveryAddress_RecoveryAddress_$memory) addr) (or (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_32198| $1_VASP_ChildVASP_$memory) addr))))
 :qid |VASPbpl.2619:20|
 :skolemid |89|
...
))) (and (= _$t0 _$t0) (= $t2 (|Select__T@[Int]Bool_| (|domain#$Memory_32262| $1_VASP_ParentVASP_$memory) _$t0)))) (and (=> (= (ControlFlow 0 46191) 46327) anon3_Then_correct) (=> (= (ControlFlow 0 46191) 46219) anon3_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_20373_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPbpl.1472:13|
 :skolemid |39|
))) (= (ControlFlow 0 46045) 46191)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 53738) 46045) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))
))
(check-sat)
(pop 1)
