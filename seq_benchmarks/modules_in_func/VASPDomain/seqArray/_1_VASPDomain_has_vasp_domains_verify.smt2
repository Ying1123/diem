...
(assert (not
 (=> (= (ControlFlow 0 0) 223345) (let ((anon0$1_correct@@2  (=> (|$IsValid'address'| _$t0@@2) (=> (and (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) $a_0@@3)))
...
(forall (($i_6@@1 Int) ) (!  (=> ($InRange $range_5@@1 $i_6@@1) (let ((j@@16 $i_6@@1))
 ...
 :qid |VASPDomainbpl.10144:98|
 :skolemid |192|
)))))
 :qid |VASPDomainbpl.10143:202|
 :skolemid |193|
...
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $elem@@5)) 63)))
 :qid |VASPDomainbpl.10145:229|
 :skolemid |194|
))))))
 :qid |VASPDomainbpl.10141:20|
 :skolemid |195|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) $a_0@@3))
)) (= _$t0@@2 _$t0@@2)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0@@2)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 163330) (- 0 223600)) (not false)) (=> (not false) (=> (= (ControlFlow 0 163330) (- 0 223607)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0@@2)))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@7 T@$1_Event_EventHandle) ) (! (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_69290_| (|streams#$EventStore| $es) handle@@7)))
 (and (= (|l#Multiset_69290| stream@@7) 0) (forall ((v@@44 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_69290| stream@@7) v@@44) 0)
 :qid |VASPDomainbpl.134:13|
 :skolemid |2|
))))
 :qid |VASPDomainbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 163084) 163330)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 223345) 163084) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2))))
))
(check-sat)
(pop 1)
