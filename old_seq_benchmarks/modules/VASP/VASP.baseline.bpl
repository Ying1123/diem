...
L2:
    ...
    assert {:msg "assert_failed(33,9000,9089): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#100, $1_VASP_ParentVASP_$memory#101, $t0) && $IsEqual'num'(7, $t3));
...
L7:
    ...
    assert {:msg "assert_failed(33,6298,6486): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#96, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory#97, $t0)) && $IsEqual'num'(7, $t7));
...
L7:
    ...
    assert {:msg "assert_failed(33,3962,4513): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#118, $1_VASP_ParentVASP_$memory#119, $t11) && $IsEqual'num'(6, $t16)) || (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#119, $t12) && $IsEqual'num'(7, $t16))) || ((($1_VASP_spec_num_children($1_VASP_ParentVASP_$memory#119, $t12) + 1) > 65536) && $IsEqual'num'(8, $t16))) || (!$ResourceExists($1_Roles_RoleId_$memory#120, $t13) && $IsEqual'num'(5, $t16))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#120, $t13)), 5) && $IsEqual'num'(3, $t16))) || (!$ResourceExists($1_Roles_RoleId_$memory#120, $t11) && $IsEqual'num'(5, $t16))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#120, $t11)), 6) && $IsEqual'num'(3, $t16)));
...
L3:
    ...
    assert {:msg "assert_failed(33,2367,2787): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#137) && $IsEqual'num'(1, $t9)) || (!$ResourceExists($1_Roles_RoleId_$memory#138, $t6) && $IsEqual'num'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t6)), 1) && $IsEqual'num'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453) && $IsEqual'num'(2, $t9))) || (!$ResourceExists($1_Roles_RoleId_$memory#138, $t7) && $IsEqual'num'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t7)), 5) && $IsEqual'num'(3, $t9))) || ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#139, $1_VASP_ParentVASP_$memory#140, $t5) && $IsEqual'num'(6, $t9)));
