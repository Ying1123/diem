...
(let ((anon35_Then_correct  (=> (and (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (and (= $t8@0 $abort_code@6) (= (ControlFlow 0 238505) 237111))) L5_correct@@0)))
...
(let ((anon34_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= $t23@@0 $t23@@0)) (and (= $t8@0 $t23@@0) (= (ControlFlow 0 238034) 237111))) L5_correct@@0)))
(let ((anon33_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t23@@0) (= $t23@@0 8)) (and (= $t23@@0 $t23@@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 238018) 238165) anon34_Then_correct) (=> (= (ControlFlow 0 238018) 238034) anon34_Else_correct))))))
...
(let ((anon33_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t8@0 $abort_code@5) (= (ControlFlow 0 238519) 237111))) L5_correct@@0)))
...
(let ((anon32_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t8@0 $abort_code@4) (= (ControlFlow 0 238533) 237111))) L5_correct@@0)))
...
(let ((anon31_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t8@0 $abort_code@3) (= (ControlFlow 0 238547) 237111))) L5_correct@@0)))
...
(let ((anon30_Else_correct  (=> (and (not $abort_flag@0@@1) (= (ControlFlow 0 237626) 237472)) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon0_correct|)))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@0@@1 (= $abort_code@1@@1 $abort_code@1@@1)) (and (= $t8@0 $abort_code@1@@1) (= (ControlFlow 0 238561) 237111))) L5_correct@@0)))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_flag@0@@1 true) (=> (and (= $abort_code@1@@1 $EXEC_FAILURE_CODE) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 237240) 238561) anon30_Then_correct) (=> (= (ControlFlow 0 237240) 237626) anon30_Else_correct))))))
...
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 1000) (= $abort_flag@0@@1 false)) (and (= $abort_code@1@@1 $abort_code@0@@1) (= inline$$CastU128$0$dst@1 1000))) (and (=> (= (ControlFlow 0 237190) 238561) anon30_Then_correct) (=> (= (ControlFlow 0 237190) 237626) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (and inline$$Not$0$dst@1@@0 (|$IsValid'u64'| 1000)) (and (=> (= (ControlFlow 0 237246) 237238) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 237246) 237190) inline$$CastU128$0$anon3_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (and (not inline$$Not$0$dst@1@@0) (= $t14@@0 $t14@@0)) (and (= $t8@0 $t14@@0) (= (ControlFlow 0 236979) 237111))) L5_correct@@0)))
(let ((anon28_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t14@@0) (= $t14@@0 6)) (and (= $t14@@0 $t14@@0) (= inline$$Not$0$dst@1@@0 inline$$Not$0$dst@1@@0))) (and (=> (= (ControlFlow 0 236963) 237246) anon29_Then_correct) (=> (= (ControlFlow 0 236963) 236979) anon29_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@0  (=> (and (= inline$$Not$0$dst@1@@0  (not $t11@0@@1)) (= (ControlFlow 0 236927) 236963)) anon28_Else$1_correct)))
(let ((anon28_Else_correct  (=> (and (and (not $t9@@7) (|$IsValid'address'| 173345816)) (and (= $t11@0@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (= (ControlFlow 0 236933) 236927))) inline$$Not$0$anon0_correct@@0)))
(let ((anon28_Then_correct  (=> $t9@@7 (=> (and (and (and (not (= (|$addr#$signer| _$t0@@8) 173345816)) (= 2 $t8@@4)) (= $t8@@4 $t8@@4)) (and (= $t8@0 $t8@@4) (= (ControlFlow 0 238591) 237111))) L5_correct@@0))))
(let ((anon27_Else_correct  (=> (and (not $t7@@1) (= $t9@@7  (not (= (|$addr#$signer| _$t0@@8) 173345816)))) (and (=> (= (ControlFlow 0 236877) 238591) anon28_Then_correct) (=> (= (ControlFlow 0 236877) 236933) anon28_Else_correct)))))
(let ((anon27_Then_correct  (=> $t7@@1 (=> (and (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t8@@4)) (= $t8@@4 $t8@@4)) (and (= $t8@0 $t8@@4) (= (ControlFlow 0 238617) 237111))) L5_correct@@0))))
(let ((anon0$1_correct@@8  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_147257| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_146867| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (=> (and (and (forall ((addr@@77 Int) ) (!  (=> (|$IsValid'address'| addr@@77) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159212| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@77) (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |DualAttestationbpl.12797:22|
 :skolemid |267|
)) (forall ((addr@@78 Int) ) (!  (=> (|$IsValid'address'| addr@@78) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159293| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@78) (|Select__T@[Int]Bool_| (|domain#$Memory_152871| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |DualAttestationbpl.12797:222|
 :skolemid |268|
))) (forall ((addr@@79 Int) ) (!  (=> (|$IsValid'address'| addr@@79) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159374| |$1_Diem_Preburn'#0'_$memory|) addr@@79) (|Select__T@[Int]Bool_| (|domain#$Memory_153007| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |DualAttestationbpl.12797:423|
 :skolemid |269|
))) (=> (and (and (and (and (and (forall ((addr@@80 Int) ) (!  (=> (|$IsValid'address'| addr@@80) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159624| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@80) (|Select__T@[Int]Bool_| (|domain#$Memory_152807| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |DualAttestationbpl.12801:22|
 :skolemid |270|
)) (forall ((addr@@81 Int) ) (!  (=> (|$IsValid'address'| addr@@81) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159741| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@81) (|Select__T@[Int]Bool_| (|domain#$Memory_152871| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |DualAttestationbpl.12801:227|
 :skolemid |271|
))) (forall ((addr@@82 Int) ) (!  (=> (|$IsValid'address'| addr@@82) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_159858| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@82) (|Select__T@[Int]Bool_| (|domain#$Memory_153007| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
...
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@10))
 ...
 :skolemid |273|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@10))
)) (forall (($a_0@@11 Int) ) (! (let (($rsc@@11 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_152871| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@11)))
 ...
 :skolemid |274|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_152871| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@11))
)))) (and (and (forall (($a_0@@12 Int) ) (! (let (($rsc@@12 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) $a_0@@12)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc@@12))
 :qid |DualAttestationbpl.12831:20|
 :skolemid |275|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) $a_0@@12))
)) (= $t6@@6 (* 1000 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_152871| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (= _$t0@@8 _$t0@@8) (= $t7@@1  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 236855) 238617) anon27_Then_correct) (=> (= (ControlFlow 0 236855) 236877) anon27_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@8  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@10 T@$1_Event_EventHandle) ) (! (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $es) handle@@10)))
 (and (= (|l#Multiset_93630| stream@@9) 0) (forall ((v@@60 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@9) v@@60) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2823:13|
 :skolemid |103|
))) (= (ControlFlow 0 236499) 236855)) anon0$1_correct@@8)))
(let ((anon0_correct@@8  (=> (= (ControlFlow 0 325029) 236499) inline$$InitEventStore$0$anon0_correct@@8)))
anon0_correct@@8)))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
