...
(assert (not
 (=> (= (ControlFlow 0 0) 1077352) (let ((anon7_Else_correct  (=> (and (and (not $t6@@7) (|$IsValid'u64'| $t5@@8)) (and (= $t5@@8 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) 1) |inline$$1_Diem_value'#0'$0$$t1@1@@0| (ite (= (|$value#$1_FixedPoint32_FixedPoint32| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) 2) (div |inline$$1_Diem_value'#0'$0$$t1@1@@0| 2) (+ 18446744073709551615 1))))) (= $t5@@8 $t5@@8))) (and (=> (= (ControlFlow 0 709476) (- 0 1077857)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 709476) (- 0 1077878)) (forall ((addr@@169 Int) ) (!  (=> (|$IsValid'address'| addr@@169) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@169)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@169))))
 :qid |Diembpl.10044:15|
 :skolemid |379|
))) (=> (forall ((addr@@170 Int) ) (!  (=> (|$IsValid'address'| addr@@170) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@170)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@170))))
 :qid |Diembpl.10044:15|
 :skolemid |379|
)) (and (=> (= (ControlFlow 0 709476) (- 0 1077907)) (forall ((addr@@171 Int) ) (!  (=> (|$IsValid'address'| addr@@171) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@171) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@171)))
 :qid |Diembpl.10049:15|
 :skolemid |380|
))) (=> (forall ((addr@@172 Int) ) (!  (=> (|$IsValid'address'| addr@@172) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@172) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@172)))
 :qid |Diembpl.10049:15|
 :skolemid |380|
)) (and (=> (= (ControlFlow 0 709476) (- 0 1077932)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 709476) (- 0 1077953)) (forall ((addr@@173 Int) ) (!  (=> (|$IsValid'address'| addr@@173) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@173)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@173))))
 :qid |Diembpl.10059:15|
 :skolemid |381|
))) (=> (forall ((addr@@174 Int) ) (!  (=> (|$IsValid'address'| addr@@174) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@174)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@174))))
 :qid |Diembpl.10059:15|
 :skolemid |381|
)) (and (=> (= (ControlFlow 0 709476) (- 0 1077982)) (forall ((addr@@175 Int) ) (!  (=> (|$IsValid'address'| addr@@175) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@175) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@175)))
 :qid |Diembpl.10064:15|
 :skolemid |382|
))) (=> (forall ((addr@@176 Int) ) (!  (=> (|$IsValid'address'| addr@@176) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@176) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@176)))
 :qid |Diembpl.10064:15|
 :skolemid |382|
)) (and (=> (= (ControlFlow 0 709476) (- 0 1078007)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 709476) (- 0 1078028)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 709476) (- 0 1078049)) (forall ((addr@@177 Int) ) (!  (=> (|$IsValid'address'| addr@@177) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@177) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@177))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@177))))
 :qid |Diembpl.10079:15|
 :skolemid |383|
))) (=> (forall ((addr@@178 Int) ) (!  (=> (|$IsValid'address'| addr@@178) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@178) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@178))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@178))))
 :qid |Diembpl.10079:15|
 :skolemid |383|
)) (and (=> (= (ControlFlow 0 709476) (- 0 1078085)) (forall ((addr@@179 Int) ) (!  (=> (|$IsValid'address'| addr@@179) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@179) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@179)))
 :qid |Diembpl.10084:15|
 :skolemid |384|
))) (=> (forall ((addr@@180 Int) ) (!  (=> (|$IsValid'address'| addr@@180) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@180) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@180)))
 :qid |Diembpl.10084:15|
 :skolemid |384|
)) (=> (= (ControlFlow 0 709476) (- 0 1078110)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))))))))))))))))))))))))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (and (and (not false) (= |inline$$1_Diem_value'#0'$0$$t1@1@@0| |inline$$1_Diem_value'#0'$0$$t1@1@@0|)) (and (= $t4@@7 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t6@@7  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4@@7) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4@@7) 1) |inline$$1_Diem_value'#0'$0$$t1@1@@0| (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4@@7) 2) (div |inline$$1_Diem_value'#0'$0$$t1@1@@0| 2) (+ 18446744073709551615 1)))) 18446744073709551615))))) (and (=> (= (ControlFlow 0 709166) 709522) anon7_Then_correct) (=> (= (ControlFlow 0 709166) 709476) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((|inline$$1_Diem_value'#0'$0$anon0_correct@@0|  (=> (= _$t0@@10 _$t0@@10) (=> (and (= |inline$$1_Diem_value'#0'$0$$t1@1@@0| (|$value#$1_Diem_Diem'#0'| _$t0@@10)) (= |inline$$1_Diem_value'#0'$0$$t1@1@@0| |inline$$1_Diem_value'#0'$0$$t1@1@@0|)) (and (=> (= (ControlFlow 0 709110) 709542) anon6_Then_correct) (=> (= (ControlFlow 0 709110) 709166) anon6_Else_correct))))))
(let ((anon0$1_correct@@13  (=> (and (and (and (and (forall ((addr3@@8 Int) ) (!  (=> (|$IsValid'address'| addr3@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.9940:22|
 :skolemid |369|
 ...
 :qid |Diembpl.9940:501|
 :skolemid |371|
))) (and (and (forall ((addr@@181 Int) ) (!  (=> (|$IsValid'address'| addr@@181) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@181) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.9944:22|
 :skolemid |372|
)) (forall ((addr@@182 Int) ) (!  (=> (|$IsValid'address'| addr@@182) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@182) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.9944:222|
 :skolemid |373|
))) (forall ((addr@@183 Int) ) (!  (=> (|$IsValid'address'| addr@@183) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@183) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.9944:423|
 :skolemid |374|
)))) (and (and (and (forall ((addr@@184 Int) ) (!  (=> (|$IsValid'address'| addr@@184) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@184) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.9948:22|
 :skolemid |375|
)) (forall ((addr@@185 Int) ) (!  (=> (|$IsValid'address'| addr@@185) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@185) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.9948:227|
 :skolemid |376|
))) (forall ((addr@@186 Int) ) (!  (=> (|$IsValid'address'| addr@@186) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@186) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.9948:433|
 :skolemid |377|
))) (and (and (|$IsValid'$1_Diem_Diem'#0''| _$t0@@10) (forall (($a_0@@17 Int) ) (! (let (($rsc@@17 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@17)))
 ...
 :qid |Diembpl.9954:20|
 :skolemid |378|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@17))
))) (and (= _$t0@@10 _$t0@@10) (= (ControlFlow 0 709116) 709110))))) |inline$$1_Diem_value'#0'$0$anon0_correct@@0|)))
(let ((inline$$InitEventStore$0$anon0_correct@@13  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@15 T@$1_Event_EventHandle) ) (! (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@15)))
 (and (= (|l#Multiset_275813| stream@@14) 0) (forall ((v@@62 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@14) v@@62) 0)
 :qid |Diembpl.159:13|
 :skolemid |4|
))))
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 708738) 709116)) anon0$1_correct@@13)))
(let ((anon0_correct@@13  (=> (= (ControlFlow 0 1077352) 708738) inline$$InitEventStore$0$anon0_correct@@13)))
anon0_correct@@13)))))))))
))
(check-sat)
(pop 1)
