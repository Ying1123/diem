...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 254357) (let ((anon22_Else_correct  (=> (and (and (not $t16) (|$IsValid'$1_ValidatorConfig_Config'| $t15)) (and (= $t15 (seq.nth (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t11@0) 0)) (= $t15 $t15))) (and (=> (= (ControlFlow 0 187309) (- 0 254958)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0))) (and (=> (= (ControlFlow 0 187309) (- 0 254969)) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))) (=> (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0)) (and (=> (= (ControlFlow 0 187309) (- 0 254982)) (= $t15 (seq.nth (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0))) 0))) (=> (= $t15 (seq.nth (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0))) 0)) (=> (= (ControlFlow 0 187309) (- 0 254994)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1) (= (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1)))))
 :qid |ValidatorConfigbpl.7066:15|
 :skolemid |200|
))))))))))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 187100) (- 0 254879)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0)) (=> (= (ControlFlow 0 187100) (- 0 254895)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= 5 $t7@0)) (and (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0) (= 7 $t7@0))))))))
(let ((anon22_Then_correct  (=> $t16 (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t11@0)) 0) (= 7 $t7)) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 187333) 187100))) L5_correct))))
(let ((anon21_Then_correct  (=> (and $t12 (= $t16 (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t11@0)) 0))) (and (=> (= (ControlFlow 0 187206) 187333) anon22_Then_correct) (=> (= (ControlFlow 0 187206) 187309) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (and (not $t12) (= $t14 $t14)) (and (= $t7@0 $t14) (= (ControlFlow 0 187194) 187100))) L5_correct)))
(let ((anon20_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= $t11@0 (|$config#$1_ValidatorConfig_ValidatorConfig| $t10@1)) (= $t11@0 $t11@0)) (and (= $t12  (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t11@0)) 0))) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14) (= $t14 7)) (and (= $t14 $t14) (= $t12 $t12)))) (and (=> (= (ControlFlow 0 187178) 187206) anon21_Then_correct) (=> (= (ControlFlow 0 187178) 187194) anon21_Else_correct))))))
(let ((anon20_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 187347) 187100))) L5_correct)))
(let ((anon19_Then$1_correct  (=> (= $t10@1 $t10) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 187399) 187347) anon20_Then_correct) (=> (= (ControlFlow 0 187399) 187178) anon20_Else_correct))))))
(let ((anon19_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (ControlFlow 0 187397) 187399)) anon19_Then$1_correct)))
(let ((anon19_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (=> (and (and (= $t10@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= $t10@1 $t10@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 187118) 187347) anon20_Then_correct) (=> (= (ControlFlow 0 187118) 187178) anon20_Else_correct))))))
(let ((anon18_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (and (=> (= (ControlFlow 0 187104) 187397) anon19_Then_correct) (=> (= (ControlFlow 0 187104) 187118) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= $t9 $t9)) (and (= $t7@0 $t9) (= (ControlFlow 0 187036) 187100))) L5_correct)))
(let ((anon17_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 187020) 187104) anon18_Then_correct) (=> (= (ControlFlow 0 187020) 187036) anon18_Else_correct))))))
(let ((anon17_Then_correct true))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 186978) 187413) anon17_Then_correct) (=> (= (ControlFlow 0 186978) 187020) anon17_Else_correct))))))
(let ((anon0$1_correct  (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105364| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105364| $1_Roles_RoleId_$memory) addr@@0)) 3))))
 :qid |ValidatorConfigbpl.6850:20|
 :skolemid |196|
)) (=> (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105364| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105364| $1_Roles_RoleId_$memory) addr@@1)) 3))))
 :qid |ValidatorConfigbpl.6854:20|
 :skolemid |197|
)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@2) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@2)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105364| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105364| $1_Roles_RoleId_$memory) addr@@2)) 3))))
 :qid |ValidatorConfigbpl.6858:20|
 :skolemid |198|
))) (=> (and (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0)))
 ...
 :qid |ValidatorConfigbpl.6865:20|
 :skolemid |199|
...
))) (and (= _$t0 _$t0) (= (ControlFlow 0 186984) 186978))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_76195_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 186730) 186984)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 254357) 186730) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
