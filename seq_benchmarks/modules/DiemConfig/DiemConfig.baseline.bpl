...
// fun DiemTimestamp::is_genesis [baseline] at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:127:5+114
procedure {:inline 1} $1_DiemTimestamp_is_genesis() returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // $t0 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L2 with $t1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:128:42+34
    assume {:print "$at(17,5384,5418)"} true;
    call $t0 := $1_CoreAddresses_DIEM_ROOT_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(17,5384,5418)"} true;
        $t1 := $abort_code;
        assume {:print "$track_abort(3,2):", $t1} $t1 == $t1;
        goto L2;
    }

    // $t2 := exists<DiemTimestamp::CurrentTimeMicroseconds>($t0) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:128:10+6
    $t2 := $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $t0);

    // $t3 := !($t2) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:128:9+1
    call $t3 := $Not($t2);

    // trace_return[0]($t3) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:128:9+68
    assume {:print "$track_return(3,2,0):", $t3} $t3 == $t3;

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:129:5+1
    assume {:print "$at(17,5424,5425)"} true;
L1:

    // return $t3 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:129:5+1
    $ret0 := $t3;
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:129:5+1
L2:

    // abort($t1) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:129:5+1
    $abort_code := $t1;
    $abort_flag := true;
    return;
...
procedure {:timeLimit 40} $1_DiemTimestamp_update_global_time$verify(_$t0: int, _$t1: int, _$t2: int) returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#106: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#239: $Memory $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies';
    var $1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory#239: $Memory $1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption';
    var $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#239: $Memory $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem';
    var $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#239: $Memory $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig';
    var $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#239: $Memory $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion';
    var $1_DiemConfig_DiemConfig'#0'_$memory#239: $Memory $1_DiemConfig_DiemConfig'#0';
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    ...
    // @106 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:78:9+77
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#106 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;
...
L5:
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // @239 := save_mem(DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    // state save for global update invariants
    $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#239 := $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory;

    // @239 := save_mem(DiemConfig::DiemConfig<DiemTransactionPublishingOption::DiemTransactionPublishingOption>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    // state save for global update invariants
    $1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory#239 := $1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory;

    // @239 := save_mem(DiemConfig::DiemConfig<DiemSystem::DiemSystem>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    // state save for global update invariants
    $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#239 := $1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory;

    // @239 := save_mem(DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    // state save for global update invariants
    $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#239 := $1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory;

    // @239 := save_mem(DiemConfig::DiemConfig<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    // state save for global update invariants
    $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#239 := $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory;

    // @239 := save_mem(DiemConfig::DiemConfig<#0>) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    // state save for global update invariants
    $1_DiemConfig_DiemConfig'#0'_$memory#239 := $1_DiemConfig_DiemConfig'#0'_$memory;
    ...
    // assert Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume {:print "$at(13,18215,18277)"} true;
    assert {:msg "assert_failed(13,18215,18277): global memory invariant does not hold"}
    ...
    // assert Implies(DiemTimestamp::$is_operating(), And(And(And(And(And(Implies(DiemConfig::spec_is_published<RegisteredCurrencies::RegisteredCurrencies>(), DiemConfig::spec_is_published[@239]<RegisteredCurrencies::RegisteredCurrencies>()), Implies(DiemConfig::spec_is_published<DiemTransactionPublishingOption::DiemTransactionPublishingOption>(), DiemConfig::spec_is_published[@239]<DiemTransactionPublishingOption::DiemTransactionPublishingOption>())), Implies(DiemConfig::spec_is_published<DiemSystem::DiemSystem>(), DiemConfig::spec_is_published[@239]<DiemSystem::DiemSystem>())), Implies(DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>(), DiemConfig::spec_is_published[@239]<DiemVMConfig::DiemVMConfig>())), Implies(DiemConfig::spec_is_published<DiemVersion::DiemVersion>(), DiemConfig::spec_is_published[@239]<DiemVersion::DiemVersion>())), Implies(DiemConfig::spec_is_published<#0>(), DiemConfig::spec_is_published[@239]<#0>()))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:423:9+184
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:423:9+184
    assume {:print "$at(13,18667,18851)"} true;
    assert {:msg "assert_failed(13,18667,18851): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> (((((($1_DiemConfig_spec_is_published'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory) ==> $1_DiemConfig_spec_is_published'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#239)) && ($1_DiemConfig_spec_is_published'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'($1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'($1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory#239))) && ($1_DiemConfig_spec_is_published'$1_DiemSystem_DiemSystem'($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemSystem_DiemSystem'($1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory#239))) && ($1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#239))) && ($1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#239))) && ($1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory) ==> $1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory#239))));
...
L7:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@106]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#106);
...
L8:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_operating[@106]()), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$VM_RESERVED_ADDRESS[]())), (if Eq<address>($t1, CoreAddresses::$VM_RESERVED_ADDRESS[]()) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}})) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:5+795
    assume {:print "$at(17,3408,4203)"} true;
    assert {:msg "assert_failed(17,3408,4203): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#106) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS())) || if ($IsEqual'address'($t1, $1_CoreAddresses_$VM_RESERVED_ADDRESS())) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)));

    // assert Or(Or(And(Not(DiemTimestamp::$is_operating[@106]()), Eq(1, $t11)), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$VM_RESERVED_ADDRESS[]()), Eq(2, $t11))), And((if Eq<address>($t1, CoreAddresses::$VM_RESERVED_ADDRESS[]()) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}}), Eq(7, $t11))) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:5+795
    assert {:msg "assert_failed(17,3408,4203): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#106) && $IsEqual'u8'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS()) && $IsEqual'u8'(2, $t11))) || (if ($IsEqual'address'($t1, $1_CoreAddresses_$VM_RESERVED_ADDRESS())) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'u8'(7, $t11)));
...
// spec fun at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:5+285
function {:inline} $1_DiemConfig_$get'#0'($1_DiemConfig_DiemConfig'#0'_$memory: $Memory $1_DiemConfig_DiemConfig'#0'): #0 {
    (var addr := $1_CoreAddresses_$DIEM_ROOT_ADDRESS(); $payload#$1_DiemConfig_DiemConfig'#0'($ResourceValue($1_DiemConfig_DiemConfig'#0'_$memory, addr)))
}
...
// spec fun at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:322:10+156
...
// spec fun at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:443:9+124
function {:inline} $1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory: $Memory $1_DiemConfig_DiemConfig'#0'): bool {
    $ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())
}
...
// struct DiemConfig::DiemConfig<#0> at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:15:5+156
type {:datatype} $1_DiemConfig_DiemConfig'#0';
function {:constructor} $1_DiemConfig_DiemConfig'#0'($payload: #0): $1_DiemConfig_DiemConfig'#0';
function {:inline} $Update'$1_DiemConfig_DiemConfig'#0''_payload(s: $1_DiemConfig_DiemConfig'#0', x: #0): $1_DiemConfig_DiemConfig'#0' {
    $1_DiemConfig_DiemConfig'#0'(x)
}
function $IsValid'$1_DiemConfig_DiemConfig'#0''(s: $1_DiemConfig_DiemConfig'#0'): bool {
    $IsValid'#0'($payload#$1_DiemConfig_DiemConfig'#0'(s))
}
function {:inline} $IsEqual'$1_DiemConfig_DiemConfig'#0''(s1: $1_DiemConfig_DiemConfig'#0', s2: $1_DiemConfig_DiemConfig'#0'): bool {
    s1 == s2
}
var $1_DiemConfig_DiemConfig'#0'_$memory: $Memory $1_DiemConfig_DiemConfig'#0';
...
// struct DiemConfig::ModifyConfigCapability<#0> at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:38:5+57
type {:datatype} $1_DiemConfig_ModifyConfigCapability'#0';
function {:constructor} $1_DiemConfig_ModifyConfigCapability'#0'($dummy_field: bool): $1_DiemConfig_ModifyConfigCapability'#0';
function {:inline} $Update'$1_DiemConfig_ModifyConfigCapability'#0''_dummy_field(s: $1_DiemConfig_ModifyConfigCapability'#0', x: bool): $1_DiemConfig_ModifyConfigCapability'#0' {
    $1_DiemConfig_ModifyConfigCapability'#0'(x)
}
function $IsValid'$1_DiemConfig_ModifyConfigCapability'#0''(s: $1_DiemConfig_ModifyConfigCapability'#0'): bool {
    $IsValid'bool'($dummy_field#$1_DiemConfig_ModifyConfigCapability'#0'(s))
}
function {:inline} $IsEqual'$1_DiemConfig_ModifyConfigCapability'#0''(s1: $1_DiemConfig_ModifyConfigCapability'#0', s2: $1_DiemConfig_ModifyConfigCapability'#0'): bool {
    s1 == s2
}
var $1_DiemConfig_ModifyConfigCapability'#0'_$memory: $Memory $1_DiemConfig_ModifyConfigCapability'#0';
...
// fun DiemConfig::initialize [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:5+535
procedure {:timeLimit 40} $1_DiemConfig_initialize$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
    ...
    var $t11: int;
    var $t12: int;
    var $t13: $1_Event_EventHandle'$1_DiemConfig_NewEpochEvent';
    var $t14: $1_DiemConfig_Configuration;
    var $t15: $1_DiemConfig_Configuration;
    var $t0: int;
    var $1_Event_EventHandleGenerator_$modifies: [int]bool;
    var $1_DiemConfig_Configuration_$modifies: [int]bool;
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemConfig_Configuration_$memory#138: $Memory $1_DiemConfig_Configuration;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:5+535
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(13,2035,2570)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:5+535
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:5+535
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:5+535
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:5+535
    ...
    // assume CanModify<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:74:9+67
    assume {:print "$at(13,2695,2762)"} true;
    assume $1_DiemConfig_Configuration_$modifies[$1_CoreAddresses_$DIEM_ROOT_ADDRESS()];

    // assume CanModify<Event::EventHandleGenerator>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:75:9+82
    assume {:print "$at(13,2771,2853)"} true;
    assume $1_Event_EventHandleGenerator_$modifies[$1_Signer_spec_address_of($t0)];

    // @139 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:75:9+82
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @138 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:75:9+82
    $1_DiemConfig_Configuration_$memory#138 := $1_DiemConfig_Configuration_$memory;

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:55:5+1
    assume {:print "$at(13,2035,2036)"} true;
    assume {:print "$track_local(11,4,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+31
    // >> opaque call: DiemTimestamp::assert_genesis()
    assume {:print "$at(13,2103,2134)"} true;

    // opaque begin: DiemTimestamp::assert_genesis() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+31

    // assume Identical($t3, Not(DiemTimestamp::$is_genesis())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+31
    assume ($t3 == !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t3) goto L5 else goto L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+31
    if ($t3) { goto L5; } else { goto L4; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+31
L5:

    // assume And(Not(DiemTimestamp::$is_genesis()), Eq(1, $t4)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+31
    assume (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t4));

    // trace_abort($t4) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+31
    assume {:print "$at(13,2103,2134)"} true;
    assume {:print "$track_abort(11,4):", $t4} $t4 == $t4;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+31
    goto L3;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+31
L4:

    // opaque end: DiemTimestamp::assert_genesis() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:58:9+31

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:59:9+43
    // >> opaque call: CoreAddresses::assert_diem_root($t0)
    assume {:print "$at(13,2144,2187)"} true;

    // opaque begin: CoreAddresses::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:59:9+43

    // assume Identical($t5, Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:59:9+43
    assume ($t5 == !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // if ($t5) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:59:9+43
    if ($t5) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:59:9+43
L7:

    // assume And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t4)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:59:9+43
    assume (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t4));

    // trace_abort($t4) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:59:9+43
    assume {:print "$at(13,2144,2187)"} true;
    assume {:print "$track_abort(11,4):", $t4} $t4 == $t4;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:59:9+43
    goto L3;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:59:9+43
L6:

    // opaque end: CoreAddresses::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:59:9+43

    // $t6 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:39+34
    assume {:print "$at(13,2227,2261)"} true;
    call $t6 := $1_CoreAddresses_DIEM_ROOT_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(13,2227,2261)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(11,4):", $t4} $t4 == $t4;
    ...
    // $t7 := exists<DiemConfig::Configuration>($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:17+6
    $t7 := $ResourceExists($1_DiemConfig_Configuration_$memory, $t6);

    // $t8 := !($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:16+1
    call $t8 := $Not($t7);

    // $t9 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:102+14
    $t9 := 0;
    assume $IsValid'u64'($t9);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:76+41
    // >> opaque call: $t7 := Errors::already_published($t6)

    // $t10 := opaque begin: Errors::already_published($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:76+41

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:76+41
    assume $IsValid'u64'($t10);

    // assume Eq<u64>($t10, 6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:76+41
    assume $IsEqual'u64'($t10, 6);

    // $t10 := opaque end: Errors::already_published($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:76+41

    // trace_local[tmp#$2]($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:9+109
    assume {:print "$track_local(11,4,2):", $t10} $t10 == $t10;

    // trace_local[tmp#$1]($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:9+109
    assume {:print "$track_local(11,4,1):", $t8} $t8 == $t8;

    // if ($t8) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:9+109
    if ($t8) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:9+109
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:9+109

    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:9+109
    assume {:print "$at(13,2197,2306)"} true;
    assume {:print "$track_abort(11,4):", $t10} $t10 == $t10;

    // $t4 := move($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:9+109
    $t4 := $t10;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:60:9+109
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:62:13+10
    assume {:print "$at(13,2352,2362)"} true;
L0:

    // $t11 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:64:24+1
    assume {:print "$at(13,2415,2416)"} true;
    $t11 := 0;
    assume $IsValid'u64'($t11);

    // $t12 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:65:44+1
    assume {:print "$at(13,2461,2462)"} true;
    $t12 := 0;
    assume $IsValid'u64'($t12);

    // $t13 := Event::new_event_handle<DiemConfig::NewEpochEvent>($t0) on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:66:25+50
    assume {:print "$at(13,2488,2538)"} true;
    call $t13 := $1_Event_new_event_handle'$1_DiemConfig_NewEpochEvent'($t0);
    if ($abort_flag) {
        assume {:print "$at(13,2488,2538)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(11,4):", $t4} $t4 == $t4;
    ...
    // $t14 := pack DiemConfig::Configuration($t11, $t12, $t13) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:63:13+177
    assume {:print "$at(13,2376,2553)"} true;
    $t14 := $1_DiemConfig_Configuration($t11, $t12, $t13);

    // assert CanModify<DiemConfig::Configuration>($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:61:9+7
    assume {:print "$at(13,2316,2323)"} true;
    assert {:msg "assert_failed(13,2316,2323): caller does not have permission to modify `DiemConfig::Configuration` at given address"}
      $1_DiemConfig_Configuration_$modifies[$t0];

    // move_to<DiemConfig::Configuration>($t14, $t0) on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:61:9+7
    if ($ResourceExists($1_DiemConfig_Configuration_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
        $1_DiemConfig_Configuration_$memory := $ResourceUpdate($1_DiemConfig_Configuration_$memory, $t0, $t14);
    }
    if ($abort_flag) {
        assume {:print "$at(13,2316,2323)"} true;
        $t4 := $abort_code;
    ...
    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:69:5+1
    assume {:print "$at(13,2569,2570)"} true;
L2:

    // assume Identical($t15, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:85:9+81
    assume {:print "$at(13,3202,3283)"} true;
    assume ($t15 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assert Not(DiemConfig::spec_has_config[@138]()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:81:9+59
    assume {:print "$at(13,3057,3116)"} true;
    assert {:msg "assert_failed(13,3057,3116): function does not abort under this condition"}
      !$1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#138);

    // assert Not(Not(DiemTimestamp::$is_genesis[@139]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:142:9+51
    assume {:print "$at(17,5802,5853)"} true;
    assert {:msg "assert_failed(17,5802,5853): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139);
    ...
    // assert DiemConfig::spec_has_config() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:84:9+26
    assume {:print "$at(13,3167,3193)"} true;
    assert {:msg "assert_failed(13,3167,3193): post-condition does not hold"}
      $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory);

    // assert Eq<u64>(select DiemConfig::Configuration.epoch($t15), 0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:86:9+31
    assume {:print "$at(13,3292,3323)"} true;
    assert {:msg "assert_failed(13,3292,3323): post-condition does not hold"}
      $IsEqual'u64'($epoch#$1_DiemConfig_Configuration($t15), 0);

    // assert Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t15), 0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:87:9+51
    assume {:print "$at(13,3332,3383)"} true;
    assert {:msg "assert_failed(13,3332,3383): post-condition does not hold"}
      $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t15), 0);

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:87:9+51
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:69:5+1
    assume {:print "$at(13,2569,2570)"} true;
L3:

    // assert Or(Or(DiemConfig::spec_has_config[@138](), Not(DiemTimestamp::$is_genesis[@139]())), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:70:5+284
    assume {:print "$at(13,2575,2859)"} true;
    assert {:msg "assert_failed(13,2575,2859): abort not covered by any of the `aborts_if` clauses"}
      (($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#138) || !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assert Or(Or(And(DiemConfig::spec_has_config[@138](), Eq(6, $t4)), And(Not(DiemTimestamp::$is_genesis[@139]()), Eq(1, $t4))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t4))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:70:5+284
    assert {:msg "assert_failed(13,2575,2859): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#138) && $IsEqual'u8'(6, $t4)) || (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#139) && $IsEqual'u8'(1, $t4))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t4)));

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:70:5+284
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun DiemConfig::disable_reconfiguration [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:180:5+399
procedure {:timeLimit 40} $1_DiemConfig_disable_reconfiguration$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
    ...
    var $t15: int;
    var $t16: bool;
    var $t17: $1_DiemConfig_DisableReconfiguration;
    var $t0: int;
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:180:5+399
    assume {:print "$at(13,7581,7980)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:180:5+399
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:180:5+399
    ...
    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:180:5+1
    assume {:print "$track_local(11,0,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:13+30
    // >> opaque call: $t5 := Signer::address_of($t0)
    assume {:print "$at(13,7660,7690)"} true;

    // $t5 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:13+30

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:13+30
    assume $IsValid'address'($t5);

    // assume Eq<address>($t5, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:13+30
    assume $IsEqual'address'($t5, $1_Signer_spec_address_of($t0));

    // $t5 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:13+30

    // $t6 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L5 with $t7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:47+34
    call $t6 := $1_CoreAddresses_DIEM_ROOT_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(13,7694,7728)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(11,0):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t8 := ==($t5, $t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:182:44+2
    $t8 := $IsEqual'address'($t5, $t6);

    // $t9 := 1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:38+12
    assume {:print "$at(13,7767,7779)"} true;
    $t9 := 1;
    assume $IsValid'u64'($t9);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:13+38
    // >> opaque call: $t9 := Errors::requires_address($t8)

    // $t10 := opaque begin: Errors::requires_address($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:13+38

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:13+38
    assume $IsValid'u64'($t10);

    // assume Eq<u64>($t10, 2) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:13+38
    assume $IsEqual'u64'($t10, 2);

    // $t10 := opaque end: Errors::requires_address($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:183:13+38

    // trace_local[tmp#$2]($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:181:9+150
    assume {:print "$at(13,7640,7790)"} true;
    assume {:print "$track_local(11,0,2):", $t10} $t10 == $t10;

    // trace_local[tmp#$1]($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:181:9+150
    assume {:print "$track_local(11,0,1):", $t8} $t8 == $t8;

    // if ($t8) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:181:9+150
    if ($t8) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:181:9+150
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:181:9+150

    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:181:9+150
    assume {:print "$at(13,7640,7790)"} true;
    assume {:print "$track_abort(11,0):", $t10} $t10 == $t10;

    // $t7 := move($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:181:9+150
    $t7 := $t10;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:181:9+150
    goto L5;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:33+10
    assume {:print "$at(13,7824,7834)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:9+35
    ...
    // if ($t12) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:9+35
    if ($t12) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:9+35
L7:

    // assume Or(Or(Or(And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t7)), And(Not(exists<Roles::RoleId>($t11)), Eq(5, $t7))), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t11)), 0), Eq(3, $t7))), And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t7))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:9+35
    assume ((((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t7)) || (!$ResourceExists($1_Roles_RoleId_$memory, $t11) && $IsEqual'u8'(5, $t7))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t11)), 0) && $IsEqual'u8'(3, $t7))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t7)));

    // trace_abort($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:9+35
    assume {:print "$at(13,7800,7835)"} true;
    assume {:print "$track_abort(11,0):", $t7} $t7 == $t7;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:9+35
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:9+35
L6:

    // opaque end: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:185:9+35

    // $t13 := DiemConfig::reconfiguration_enabled() on_abort goto L5 with $t7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:16+25
    assume {:print "$at(13,7852,7877)"} true;
    call $t13 := $1_DiemConfig_reconfiguration_enabled();
    if ($abort_flag) {
        assume {:print "$at(13,7852,7877)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(11,0):", $t7} $t7 == $t7;
    ...
    // $t14 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:65+14
    $t14 := 0;
    assume $IsValid'u64'($t14);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:43+37
    // >> opaque call: $t12 := Errors::invalid_state($t11)

    // $t15 := opaque begin: Errors::invalid_state($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:43+37

    // assume WellFormed($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:43+37
    assume $IsValid'u64'($t15);

    // assume Eq<u64>($t15, 1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:43+37
    assume $IsEqual'u64'($t15, 1);

    // $t15 := opaque end: Errors::invalid_state($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:43+37

    // trace_local[tmp#$4]($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:9+72
    assume {:print "$track_local(11,0,4):", $t15} $t15 == $t15;

    // trace_local[tmp#$3]($t13) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:9+72
    assume {:print "$track_local(11,0,3):", $t13} $t13 == $t13;

    // if ($t13) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:9+72
    if ($t13) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:9+72
L3:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:9+72

    // trace_abort($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:9+72
    assume {:print "$at(13,7845,7917)"} true;
    assume {:print "$track_abort(11,0):", $t15} $t15 == $t15;

    // $t7 := move($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:9+72
    $t7 := $t15;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:186:9+72
    goto L5;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:187:17+10
    assume {:print "$at(13,7935,7945)"} true;
L2:

    // $t16 := false at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:187:29+25
    $t16 := false;
    assume $IsValid'bool'($t16);

    // $t17 := pack DiemConfig::DisableReconfiguration($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:187:29+25
    $t17 := $1_DiemConfig_DisableReconfiguration($t16);

    // move_to<DiemConfig::DisableReconfiguration>($t17, $t0) on_abort goto L5 with $t7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:187:9+7
    if ($ResourceExists($1_DiemConfig_DisableReconfiguration_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
        $1_DiemConfig_DisableReconfiguration_$memory := $ResourceUpdate($1_DiemConfig_DisableReconfiguration_$memory, $t0, $t17);
    }
    if ($abort_flag) {
        assume {:print "$at(13,7927,7934)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(11,0):", $t7} $t7 == $t7;
        goto L5;
    }

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:188:5+1
    assume {:print "$at(13,7979,7980)"} true;
L4:

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:188:5+1
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:188:5+1
L5:

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:188:5+1
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun DiemConfig::emit_genesis_reconfiguration_event [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:5+607
procedure {:timeLimit 40} $1_DiemConfig_emit_genesis_reconfiguration_event$verify() returns ()
{
    // declare local variables
    var $t0: $Mutation ($1_DiemConfig_Configuration);
    var $t1: bool;
    var $t2: int;
    var $t3: bool;
    var $t4: int;
    ...
    var $t10: int;
    var $t11: int;
    var $t12: $Mutation ($1_DiemConfig_Configuration);
    var $t13: int;
    var $t14: int;
    var $t15: bool;
    var $t16: int;
    ...
    var $t24: $Mutation ($1_Event_EventHandle'$1_DiemConfig_NewEpochEvent');
    var $t25: int;
    var $t26: $1_DiemConfig_NewEpochEvent;
    var $t27: $1_DiemConfig_Configuration;
    var $t28: $1_Event_EventHandle'$1_DiemConfig_NewEpochEvent';
    var $t29: $1_DiemConfig_NewEpochEvent;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:5+607
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume {:print "$at(13,17036,17643)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:382:5+607
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_Configuration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_Configuration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_Configuration'($rsc))));

    // $t6 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L9 with $t7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:38+34
    assume {:print "$at(13,17139,17173)"} true;
    call $t6 := $1_CoreAddresses_DIEM_ROOT_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(13,17139,17173)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(11,1):", $t7} $t7 == $t7;
        goto L9;
    }

    // $t8 := exists<DiemConfig::Configuration>($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:16+6
    $t8 := $ResourceExists($1_DiemConfig_Configuration_$memory, $t6);

    // $t9 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:97+14
    $t9 := 0;
    assume $IsValid'u64'($t9);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:75+37
    // >> opaque call: $t9 := Errors::not_published($t8)

    // $t10 := opaque begin: Errors::not_published($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:75+37

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:75+37
    assume $IsValid'u64'($t10);

    // assume Eq<u64>($t10, 5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:75+37
    assume $IsEqual'u64'($t10, 5);

    // $t10 := opaque end: Errors::not_published($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:75+37

    // trace_local[tmp#$2]($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:9+104
    assume {:print "$track_local(11,1,2):", $t10} $t10 == $t10;

    // trace_local[tmp#$1]($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:9+104
    assume {:print "$track_local(11,1,1):", $t8} $t8 == $t8;

    // if ($t8) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:9+104
    if ($t8) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:9+104
L1:

    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:9+104
    assume {:print "$at(13,17110,17214)"} true;
    assume {:print "$track_abort(11,1):", $t10} $t10 == $t10;

    // $t7 := move($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:9+104
    $t7 := $t10;

    // goto L9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:383:9+104
    goto L9;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:384:59+34
    assume {:print "$at(13,17274,17308)"} true;
L0:

    // $t11 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L9 with $t7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:384:59+34
    ...
    // $t12 := borrow_global<DiemConfig::Configuration>($t11) on_abort goto L9 with $t7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:384:26+17
    if (!$ResourceExists($1_DiemConfig_Configuration_$memory, $t11)) {
        call $ExecFailureAbort();
    } else {
        $t12 := $Mutation($Global($t11), EmptyVec(), $ResourceValue($1_DiemConfig_Configuration_$memory, $t11));
    }
    if ($abort_flag) {
        assume {:print "$at(13,17241,17258)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(11,1):", $t7} $t7 == $t7;
        goto L9;
    }

    // trace_local[config_ref]($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:384:13+10
    $temp_0'$1_DiemConfig_Configuration' := $Dereference($t12);
    assume {:print "$track_local(11,1,0):", $temp_0'$1_DiemConfig_Configuration'} $temp_0'$1_DiemConfig_Configuration' == $temp_0'$1_DiemConfig_Configuration';

    // $t13 := get_field<DiemConfig::Configuration>.epoch($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+16
    assume {:print "$at(13,17326,17342)"} true;
    $t13 := $epoch#$1_DiemConfig_Configuration($Dereference($t12));

    // $t14 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:36+1
    $t14 := 0;
    assume $IsValid'u64'($t14);

    // $t15 := ==($t13, $t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:33+2
    $t15 := $IsEqual'u64'($t13, $t14);

    // if ($t15) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+66
    if ($t15) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+66
L3:

    // goto L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+66
    goto L4;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:41+10
L2:

    // $t16 := get_field<DiemConfig::Configuration>.last_reconfiguration_time($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:41+36
    $t16 := $last_reconfiguration_time#$1_DiemConfig_Configuration($Dereference($t12));

    // $t17 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:81+1
    $t17 := 0;
    assume $IsValid'u64'($t17);

    // $t18 := ==($t16, $t17) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:78+2
    $t18 := $IsEqual'u64'($t16, $t17);

    // $t5 := $t18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+66
    $t5 := $t18;

    // trace_local[tmp#$5]($t18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+66
    assume {:print "$track_local(11,1,5):", $t18} $t18 == $t18;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+66
    goto L5;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+66
L4:

    // $t19 := false at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+66
    $t19 := false;
    assume $IsValid'bool'($t19);

    // $t5 := $t19 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+66
    $t5 := $t19;

    // trace_local[tmp#$5]($t19) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+66
    assume {:print "$track_local(11,1,5):", $t19} $t19 == $t19;

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:16+66
L5:

    // $t20 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:106+14
    $t20 := 0;
    assume $IsValid'u64'($t20);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:84+37
    // >> opaque call: $t20 := Errors::invalid_state($t19)

    // $t21 := opaque begin: Errors::invalid_state($t20) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:84+37

    // assume WellFormed($t21) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:84+37
    assume $IsValid'u64'($t21);

    // assume Eq<u64>($t21, 1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:84+37
    assume $IsEqual'u64'($t21, 1);

    // $t21 := opaque end: Errors::invalid_state($t20) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:84+37

    // trace_local[tmp#$4]($t21) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:9+113
    assume {:print "$track_local(11,1,4):", $t21} $t21 == $t21;

    // trace_local[tmp#$3]($t5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:9+113
    assume {:print "$track_local(11,1,3):", $t5} $t5 == $t5;

    // if ($t5) goto L6 else goto L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:9+113
    if ($t5) { goto L6; } else { goto L7; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:9+113
L7:

    // destroy($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:9+113

    // trace_abort($t21) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:9+113
    assume {:print "$at(13,17319,17432)"} true;
    assume {:print "$track_abort(11,1):", $t21} $t21 == $t21;

    // $t7 := move($t21) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:9+113
    $t7 := $t21;

    // goto L9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:385:9+113
    goto L9;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:386:28+1
    assume {:print "$at(13,17461,17462)"} true;
L6:

    // $t22 := 1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:386:28+1
    $t22 := 1;
    assume $IsValid'u64'($t22);

    // $t23 := borrow_field<DiemConfig::Configuration>.epoch($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:386:9+16
    $t23 := $ChildMutation($t12, 0, $epoch#$1_DiemConfig_Configuration($Dereference($t12)));

    // write_ref($t23, $t22) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:386:9+20
    $t23 := $UpdateMutation($t23, $t22);

    // write_back[Reference($t12).epoch]($t23) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:386:9+20
    $t12 := $UpdateMutation($t12, $Update'$1_DiemConfig_Configuration'_epoch($Dereference($t12), $Dereference($t23)));

    // $t24 := borrow_field<DiemConfig::Configuration>.events($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:389:13+22
    assume {:print "$at(13,17519,17541)"} true;
    $t24 := $ChildMutation($t12, 2, $events#$1_DiemConfig_Configuration($Dereference($t12)));

    // $t25 := get_field<DiemConfig::Configuration>.epoch($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:391:24+16
    assume {:print "$at(13,17594,17610)"} true;
    $t25 := $epoch#$1_DiemConfig_Configuration($Dereference($t12));

    // $t26 := pack DiemConfig::NewEpochEvent($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:390:13+70
    assume {:print "$at(13,17555,17625)"} true;
    $t26 := $1_DiemConfig_NewEpochEvent($t25);

    // Event::emit_event<DiemConfig::NewEpochEvent>($t24, $t26) on_abort goto L9 with $t7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:388:9+163
    assume {:print "$at(13,17473,17636)"} true;
    call $t24 := $1_Event_emit_event'$1_DiemConfig_NewEpochEvent'($t24, $t26);
    if ($abort_flag) {
        assume {:print "$at(13,17473,17636)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(11,1):", $t7} $t7 == $t7;
    ...
    // write_back[DiemConfig::Configuration@]($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:388:9+163
    $1_DiemConfig_Configuration_$memory := $ResourceUpdate($1_DiemConfig_Configuration_$memory, $GlobalLocationAddress($t12),
        $Dereference($t12));
    ...
    // label L8 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:394:5+1
    assume {:print "$at(13,17642,17643)"} true;
L8:

    // assume Identical($t27, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:396:9+76
    assume {:print "$at(13,17698,17774)"} true;
    assume ($t27 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t28, select DiemConfig::Configuration.events($t27)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:397:9+32
    assume {:print "$at(13,17783,17815)"} true;
    assume ($t28 == $events#$1_DiemConfig_Configuration($t27));

    // assume Identical($t29, pack DiemConfig::NewEpochEvent(select DiemConfig::Configuration.epoch($t27))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:398:9+78
    assume {:print "$at(13,17824,17902)"} true;
    assume ($t29 == $1_DiemConfig_NewEpochEvent($epoch#$1_DiemConfig_Configuration($t27)));

    // assert EventStoreIncludes(ExtendEventStore(EmptyEventStore(), $t29, $t28)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:401:9+20
    assume {:print "$at(13,17911,17931)"} true;
    assert {:msg "assert_failed(13,17911,17931): function does not emit the expected event"}
      (var actual := $EventStore__subtract($es, old($es)); (var expected := $ExtendEventStore'$1_DiemConfig_NewEpochEvent'($EmptyEventStore, $t28, $t29); $EventStore__is_subset(expected, actual)));

    // assert EventStoreIncludedIn(ExtendEventStore(EmptyEventStore(), $t29, $t28)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:395:5+289
    assume {:print "$at(13,17648,17937)"} true;
    assert {:msg "assert_failed(13,17648,17937): emitted event not covered by any of the `emits` clauses"}
      (var actual := $EventStore__subtract($es, old($es)); (var expected := $ExtendEventStore'$1_DiemConfig_NewEpochEvent'($EmptyEventStore, $t28, $t29); $EventStore__is_subset(actual, expected)));

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:395:5+289
    return;

    // label L9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:394:5+1
    assume {:print "$at(13,17642,17643)"} true;
L9:

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:394:5+1
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun DiemConfig::enable_reconfiguration [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:192:5+479
procedure {:timeLimit 40} $1_DiemConfig_enable_reconfiguration$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
    ...
    var $t16: int;
    var $t17: int;
    var $t18: $1_DiemConfig_DisableReconfiguration;
    var $t19: bool;
    var $t0: int;
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:192:5+479
    assume {:print "$at(13,8158,8637)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:192:5+479
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:192:5+479
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DisableReconfiguration'($rsc))));

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:192:5+1
    assume {:print "$track_local(11,2,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:13+30
    // >> opaque call: $t5 := Signer::address_of($t0)
    assume {:print "$at(13,8268,8298)"} true;

    // $t5 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:13+30

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:13+30
    assume $IsValid'address'($t5);

    // assume Eq<address>($t5, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:13+30
    assume $IsEqual'address'($t5, $1_Signer_spec_address_of($t0));

    // $t5 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:13+30

    // $t6 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L5 with $t7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:47+34
    call $t6 := $1_CoreAddresses_DIEM_ROOT_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(13,8302,8336)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(11,2):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t8 := ==($t5, $t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:194:44+2
    $t8 := $IsEqual'address'($t5, $t6);

    // $t9 := 1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:195:38+12
    assume {:print "$at(13,8375,8387)"} true;
    $t9 := 1;
    assume $IsValid'u64'($t9);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:195:13+38
    // >> opaque call: $t9 := Errors::requires_address($t8)

    // $t10 := opaque begin: Errors::requires_address($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:195:13+38

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:195:13+38
    assume $IsValid'u64'($t10);

    // assume Eq<u64>($t10, 2) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:195:13+38
    assume $IsEqual'u64'($t10, 2);

    // $t10 := opaque end: Errors::requires_address($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:195:13+38

    // trace_local[tmp#$2]($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:193:9+150
    assume {:print "$at(13,8248,8398)"} true;
    assume {:print "$track_local(11,2,2):", $t10} $t10 == $t10;

    // trace_local[tmp#$1]($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:193:9+150
    assume {:print "$track_local(11,2,1):", $t8} $t8 == $t8;

    // if ($t8) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:193:9+150
    if ($t8) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:193:9+150
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:193:9+150

    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:193:9+150
    assume {:print "$at(13,8248,8398)"} true;
    assume {:print "$track_abort(11,2):", $t10} $t10 == $t10;

    // $t7 := move($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:193:9+150
    $t7 := $t10;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:193:9+150
    goto L5;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:33+10
    assume {:print "$at(13,8432,8442)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+35
    // >> opaque call: Roles::assert_diem_root($t0)
    ...
    // opaque begin: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+35
    assume {:print "$at(13,8408,8443)"} true;

    // assume Identical($t12, Or(Or(Or(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Not(exists<Roles::RoleId>($t11))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t11)), 0)), Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+35
    assume ($t12 == (((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) || !$ResourceExists($1_Roles_RoleId_$memory, $t11)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t11)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())));

    // if ($t12) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+35
    if ($t12) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+35
L7:

    // assume Or(Or(Or(And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t7)), And(Not(exists<Roles::RoleId>($t11)), Eq(5, $t7))), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t11)), 0), Eq(3, $t7))), And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t7))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+35
    assume ((((!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t7)) || (!$ResourceExists($1_Roles_RoleId_$memory, $t11) && $IsEqual'u8'(5, $t7))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t11)), 0) && $IsEqual'u8'(3, $t7))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t7)));

    // trace_abort($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+35
    assume {:print "$at(13,8408,8443)"} true;
    assume {:print "$track_abort(11,2):", $t7} $t7 == $t7;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+35
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+35
L6:

    // opaque end: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:197:9+35

    // $t13 := DiemConfig::reconfiguration_enabled() on_abort goto L5 with $t7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:17+25
    assume {:print "$at(13,8462,8487)"} true;
    call $t13 := $1_DiemConfig_reconfiguration_enabled();
    if ($abort_flag) {
        assume {:print "$at(13,8462,8487)"} true;
        $t7 := $abort_code;
    ...
    // $t14 := !($t13) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:16+1
    call $t14 := $Not($t13);

    // $t15 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:66+14
    $t15 := 0;
    assume $IsValid'u64'($t15);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:44+37
    // >> opaque call: $t13 := Errors::invalid_state($t12)

    // $t16 := opaque begin: Errors::invalid_state($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:44+37

    // assume WellFormed($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:44+37
    assume $IsValid'u64'($t16);

    // assume Eq<u64>($t16, 1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:44+37
    assume $IsEqual'u64'($t16, 1);

    // $t16 := opaque end: Errors::invalid_state($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:44+37

    // trace_local[tmp#$4]($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:9+73
    assume {:print "$track_local(11,2,4):", $t16} $t16 == $t16;

    // trace_local[tmp#$3]($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:9+73
    assume {:print "$track_local(11,2,3):", $t14} $t14 == $t14;

    // if ($t14) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:9+73
    if ($t14) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:9+73
L3:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:9+73

    // trace_abort($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:9+73
    assume {:print "$at(13,8454,8527)"} true;
    assume {:print "$track_abort(11,2):", $t16} $t16 == $t16;

    // $t7 := move($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:9+73
    $t7 := $t16;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:199:9+73
    goto L5;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:90+10
    assume {:print "$at(13,8618,8628)"} true;
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:71+30
    // >> opaque call: $t14 := Signer::address_of($t0)

    // $t17 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:71+30

    // assume WellFormed($t17) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:71+30
    assume $IsValid'address'($t17);

    // assume Eq<address>($t17, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:71+30
    assume $IsEqual'address'($t17, $1_Signer_spec_address_of($t0));

    // $t17 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:71+30

    // $t18 := move_from<DiemConfig::DisableReconfiguration>($t17) on_abort goto L5 with $t7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:37+9
    if (!$ResourceExists($1_DiemConfig_DisableReconfiguration_$memory, $t17)) {
        call $ExecFailureAbort();
    } else {
        $t18 := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $t17);
        $1_DiemConfig_DisableReconfiguration_$memory := $ResourceRemove($1_DiemConfig_DisableReconfiguration_$memory, $t17);
    }
    if ($abort_flag) {
        assume {:print "$at(13,8565,8574)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(11,2):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t19 := unpack DiemConfig::DisableReconfiguration($t18) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:9+25
    $t19 := $dummy_field#$1_DiemConfig_DisableReconfiguration($t18);

    // destroy($t19) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:200:9+25

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:201:5+1
    assume {:print "$at(13,8636,8637)"} true;
L4:

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:201:5+1
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:201:5+1
L5:

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:201:5+1
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun DiemConfig::get [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:5+285
procedure {:timeLimit 40} $1_DiemConfig_get$verify() returns ($ret0: #0)
{
    // declare local variables
    var $t0: int;
    var $t1: bool;
    ...
    var $t6: int;
    var $t7: int;
    var $t8: $1_DiemConfig_DiemConfig'#0';
    var $t9: #0;
    var $temp_0'#0': #0;
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemConfig_DiemConfig'#0'_$memory#90: $Memory $1_DiemConfig_DiemConfig'#0';

    // verification entrypoint assumptions
    call $InitVerification();

    // bytecode translation starts here
    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<#0>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:101:17+6
    assume {:print "$at(13,3844,3850)"} true;
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DiemConfig'#0'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DiemConfig'#0'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DiemConfig'#0''($rsc))));

    // @90 := save_mem(DiemConfig::DiemConfig<#0>) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:92:5+1
    assume {:print "$at(13,3458,3459)"} true;
    $1_DiemConfig_DiemConfig'#0'_$memory#90 := $1_DiemConfig_DiemConfig'#0'_$memory;

    // $t3 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:94:20+34
    assume {:print "$at(13,3557,3591)"} true;
    call $t3 := $1_CoreAddresses_DIEM_ROOT_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(13,3557,3591)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(11,3):", $t4} $t4 == $t4;
        goto L3;
    }

    // trace_local[addr]($t3) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:94:13+4
    assume {:print "$track_local(11,3,0):", $t3} $t3 == $t3;

    // $t5 := exists<DiemConfig::DiemConfig<#0>>($t3) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:16+6
    assume {:print "$at(13,3608,3614)"} true;
    $t5 := $ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory, $t3);

    // $t6 := 1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:72+12
    $t6 := 1;
    assume $IsValid'u64'($t6);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:50+35
    // >> opaque call: $t6 := Errors::not_published($t5)

    // $t7 := opaque begin: Errors::not_published($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:50+35

    // assume WellFormed($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:50+35
    assume $IsValid'u64'($t7);

    // assume Eq<u64>($t7, 5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:50+35
    assume $IsEqual'u64'($t7, 5);

    // $t7 := opaque end: Errors::not_published($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:50+35

    // trace_local[tmp#$2]($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:9+77
    assume {:print "$track_local(11,3,2):", $t7} $t7 == $t7;

    // trace_local[tmp#$1]($t5) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:9+77
    assume {:print "$track_local(11,3,1):", $t5} $t5 == $t5;

    // if ($t5) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:9+77
    if ($t5) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:9+77
L1:

    // trace_abort($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:9+77
    assume {:print "$at(13,3601,3678)"} true;
    assume {:print "$track_abort(11,3):", $t7} $t7 == $t7;

    // $t4 := move($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:9+77
    $t4 := $t7;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:95:9+77
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:96:45+4
    assume {:print "$at(13,3724,3728)"} true;
L0:

    // $t8 := get_global<DiemConfig::DiemConfig<#0>>($t3) on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:96:11+13
    if (!$ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory, $t3)) {
        call $ExecFailureAbort();
    } else {
        $t8 := $ResourceValue($1_DiemConfig_DiemConfig'#0'_$memory, $t3);
    }
    if ($abort_flag) {
        assume {:print "$at(13,3690,3703)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(11,3):", $t4} $t4 == $t4;
        goto L3;
    }

    // $t9 := get_field<DiemConfig::DiemConfig<#0>>.payload($t8) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:96:10+48
    $t9 := $payload#$1_DiemConfig_DiemConfig'#0'($t8);

    // trace_return[0]($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:96:9+49
    assume {:print "$track_return(11,3,0):", $t9} $t9 == $t9;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:97:5+1
    assume {:print "$at(13,3742,3743)"} true;
L2:

    // assert Not(Not(exists[@90]<DiemConfig::DiemConfig<#0>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:104:9+101
    assume {:print "$at(13,3930,4031)"} true;
    assert {:msg "assert_failed(13,3930,4031): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory#90, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());

    // assert Eq<#0>($t9, DiemConfig::$get<#0>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:101:9+32
    assume {:print "$at(13,3836,3868)"} true;
    assert {:msg "assert_failed(13,3836,3868): post-condition does not hold"}
      $IsEqual'#0'($t9, $1_DiemConfig_$get'#0'($1_DiemConfig_DiemConfig'#0'_$memory));

    // return $t9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:101:9+32
    $ret0 := $t9;
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:97:5+1
    assume {:print "$at(13,3742,3743)"} true;
L3:

    // assert Not(exists[@90]<DiemConfig::DiemConfig<#0>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:98:5+126
    assume {:print "$at(13,3748,3874)"} true;
    assert {:msg "assert_failed(13,3748,3874): abort not covered by any of the `aborts_if` clauses"}
      !$ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory#90, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());

    // assert And(Not(exists[@90]<DiemConfig::DiemConfig<#0>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Eq(5, $t4)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:98:5+126
    assert {:msg "assert_failed(13,3748,3874): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory#90, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t4));

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:98:5+126
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun DiemConfig::publish_new_config [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:239:5+430
procedure {:timeLimit 40} $1_DiemConfig_publish_new_config$verify(_$t0: int, _$t1: #0) returns ()
{
    // declare local variables
    var $t2: $1_DiemConfig_ModifyConfigCapability'#0';
    var $t3: bool;
    var $t4: int;
    var $t5: int;
    var $t6: int;
    var $t7: $1_DiemConfig_ModifyConfigCapability'#0';
    var $t8: bool;
    var $t9: int;
    var $t10: int;
    var $t11: bool;
    ...
    var $t0: int;
    var $t1: #0;
    var $1_DiemConfig_DiemConfig'#0'_$modifies: [int]bool;
    var $1_DiemConfig_ModifyConfigCapability'#0'_$modifies: [int]bool;
    var $temp_0'#0': #0;
    var $temp_0'$1_DiemConfig_DiemConfig'#0'': $1_DiemConfig_DiemConfig'#0';
    var $temp_0'$1_DiemConfig_ModifyConfigCapability'#0'': $1_DiemConfig_ModifyConfigCapability'#0';
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemConfig_DiemConfig'#0'_$memory#133: $Memory $1_DiemConfig_DiemConfig'#0';
    var $1_DiemConfig_ModifyConfigCapability'#0'_$memory#134: $Memory $1_DiemConfig_ModifyConfigCapability'#0';
    var $1_Roles_RoleId_$memory#135: $Memory $1_Roles_RoleId;
    var $1_DiemConfig_Configuration_$memory#136: $Memory $1_DiemConfig_Configuration;
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:239:5+430
    assume {:print "$at(13,10255,10685)"} true;
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:239:5+430
    assume $IsValid'#0'($t1);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:239:5+430
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<#0>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:239:5+430
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DiemConfig'#0'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DiemConfig'#0'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DiemConfig'#0''($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<#0>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:239:5+430
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_ModifyConfigCapability'#0'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_ModifyConfigCapability'#0'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_ModifyConfigCapability'#0''($rsc))));
    ...
    // assume CanModify<DiemConfig::DiemConfig<#0>>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:252:9+72
    assume {:print "$at(13,10747,10819)"} true;
    assume $1_DiemConfig_DiemConfig'#0'_$modifies[$1_CoreAddresses_$DIEM_ROOT_ADDRESS()];

    // assume CanModify<DiemConfig::ModifyConfigCapability<#0>>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:253:9+84
    assume {:print "$at(13,10828,10912)"} true;
    assume $1_DiemConfig_ModifyConfigCapability'#0'_$modifies[$1_CoreAddresses_$DIEM_ROOT_ADDRESS()];

    // @135 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:253:9+84
    $1_Roles_RoleId_$memory#135 := $1_Roles_RoleId_$memory;

    // @136 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:253:9+84
    $1_DiemConfig_Configuration_$memory#136 := $1_DiemConfig_Configuration_$memory;

    // @133 := save_mem(DiemConfig::DiemConfig<#0>) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:253:9+84
    $1_DiemConfig_DiemConfig'#0'_$memory#133 := $1_DiemConfig_DiemConfig'#0'_$memory;

    // @134 := save_mem(DiemConfig::ModifyConfigCapability<#0>) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:253:9+84
    $1_DiemConfig_ModifyConfigCapability'#0'_$memory#134 := $1_DiemConfig_ModifyConfigCapability'#0'_$memory;

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:239:5+1
    assume {:print "$at(13,10255,10256)"} true;
    assume {:print "$track_local(11,5,0):", $t0} $t0 == $t0;

    // trace_local[payload]($t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:239:5+1
    assume {:print "$track_local(11,5,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    // >> opaque call: $t5 := DiemConfig::publish_new_config_and_get_capability<#0>($t0, $t1)
    assume {:print "$at(13,10401,10467)"} true;
    ...
    // assert CanModify<DiemConfig::DiemConfig<#0>>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    assume {:print "$at(13,10401,10467)"} true;
    assert {:msg "assert_failed(13,10401,10467): caller does not have permission to modify `DiemConfig::DiemConfig<#0>` at given address"}
      $1_DiemConfig_DiemConfig'#0'_$modifies[$1_CoreAddresses_$DIEM_ROOT_ADDRESS()];

    // $t7 := opaque begin: DiemConfig::publish_new_config_and_get_capability<#0>($t0, $t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66

    // assume Identical($t8, Or(Or(Or(Not(exists<Roles::RoleId>($t6)), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t6)), 0)), Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS())), exists<DiemConfig::DiemConfig<#0>>(CoreAddresses::$DIEM_ROOT_ADDRESS()))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    assume ($t8 == (((!$ResourceExists($1_Roles_RoleId_$memory, $t6) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t6)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || $ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())));

    // if ($t8) goto L5 else goto L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    if ($t8) { goto L5; } else { goto L4; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
L5:

    // assume Or(Or(Or(And(Not(exists<Roles::RoleId>($t6)), Eq(5, $t9)), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>($t6)), 0), Eq(3, $t9))), And(Neq<address>(Signer::spec_address_of($t0), CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(2, $t9))), And(exists<DiemConfig::DiemConfig<#0>>(CoreAddresses::$DIEM_ROOT_ADDRESS()), Eq(6, $t9))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    assume ((((!$ResourceExists($1_Roles_RoleId_$memory, $t6) && $IsEqual'u8'(5, $t9)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t6)), 0) && $IsEqual'u8'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t9))) || ($ResourceExists($1_DiemConfig_DiemConfig'#0'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(6, $t9)));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    assume {:print "$at(13,10401,10467)"} true;
    assume {:print "$track_abort(11,5):", $t9} $t9 == $t9;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    goto L3;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
L4:

    // @137 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    $1_DiemConfig_Configuration_$memory#137 := $1_DiemConfig_Configuration_$memory;

    // modifies global<DiemConfig::DiemConfig<#0>>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    havoc $temp_0'bool';
    if ($temp_0'bool') {
        havoc $temp_0'$1_DiemConfig_DiemConfig'#0'';
        $1_DiemConfig_DiemConfig'#0'_$memory := $ResourceUpdate($1_DiemConfig_DiemConfig'#0'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS(), $temp_0'$1_DiemConfig_DiemConfig'#0'');
    } else {
        $1_DiemConfig_DiemConfig'#0'_$memory := $ResourceRemove($1_DiemConfig_DiemConfig'#0'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());
    }

    // assume WellFormed($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    assume $IsValid'$1_DiemConfig_ModifyConfigCapability'#0''($t7);

    // assume DiemConfig::spec_is_published<#0>() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    assume $1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory);

    // assume Eq<#0>(DiemConfig::$get<#0>(), $t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    assume $IsEqual'#0'($1_DiemConfig_$get'#0'($1_DiemConfig_DiemConfig'#0'_$memory), $t1);

    // assume Eq<bool>(DiemConfig::spec_has_config[@137](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66
    ...
    // $t7 := opaque end: DiemConfig::publish_new_config_and_get_capability<#0>($t0, $t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:26+66

    // trace_local[capability]($t7) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:243:13+10
    assume {:print "$track_local(11,5,2):", $t7} $t7 == $t7;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:245:53+30
    // >> opaque call: $t6 := Signer::address_of($t0)
    assume {:print "$at(13,10537,10567)"} true;

    // $t10 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:245:53+30

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:245:53+30
    assume $IsValid'address'($t10);

    // assume Eq<address>($t10, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:245:53+30
    assume $IsEqual'address'($t10, $1_Signer_spec_address_of($t0));

    // $t10 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:245:53+30

    // $t11 := exists<DiemConfig::ModifyConfigCapability<#0>>($t10) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:245:14+6
    $t11 := $ResourceExists($1_DiemConfig_ModifyConfigCapability'#0'_$memory, $t10);

    // $t12 := !($t11) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:245:13+1
    call $t12 := $Not($t11);

    // $t13 := 2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:246:39+18
    assume {:print "$at(13,10608,10626)"} true;
    $t13 := 2;
    assume $IsValid'u64'($t13);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:246:13+45
    // >> opaque call: $t10 := Errors::already_published($t9)

    // $t14 := opaque begin: Errors::already_published($t13) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:246:13+45

    // assume WellFormed($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:246:13+45
    assume $IsValid'u64'($t14);

    // assume Eq<u64>($t14, 6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:246:13+45
    assume $IsEqual'u64'($t14, 6);

    // $t14 := opaque end: Errors::already_published($t13) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:246:13+45

    // trace_local[tmp#$4]($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:244:9+160
    assume {:print "$at(13,10477,10637)"} true;
    assume {:print "$track_local(11,5,4):", $t14} $t14 == $t14;

    // trace_local[tmp#$3]($t12) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:244:9+160
    assume {:print "$track_local(11,5,3):", $t12} $t12 == $t12;

    // if ($t12) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:244:9+160
    if ($t12) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:244:9+160
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:244:9+160

    // trace_abort($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:244:9+160
    assume {:print "$at(13,10477,10637)"} true;
    assume {:print "$track_abort(11,5):", $t14} $t14 == $t14;

    // $t9 := move($t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:244:9+160
    $t9 := $t14;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:244:9+160
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:248:17+10
    assume {:print "$at(13,10655,10665)"} true;
L0:

    // assert CanModify<DiemConfig::ModifyConfigCapability<#0>>($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:248:9+7
    assert {:msg "assert_failed(13,10647,10654): caller does not have permission to modify `DiemConfig::ModifyConfigCapability<#0>` at given address"}
      $1_DiemConfig_ModifyConfigCapability'#0'_$modifies[$t0];

    // move_to<DiemConfig::ModifyConfigCapability<#0>>($t7, $t0) on_abort goto L3 with $t9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:248:9+7
    if ($ResourceExists($1_DiemConfig_ModifyConfigCapability'#0'_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
        $1_DiemConfig_ModifyConfigCapability'#0'_$memory := $ResourceUpdate($1_DiemConfig_ModifyConfigCapability'#0'_$memory, $t0, $t7);
    }
    if ($abort_flag) {
        assume {:print "$at(13,10647,10654)"} true;
        $t9 := $abort_code;
        assume {:print "$track_abort(11,5):", $t9} $t9 == $t9;
        goto L3;
    }

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:249:5+1
    assume {:print "$at(13,10684,10685)"} true;
L2:

    // assert Not(DiemConfig::spec_is_published[@133]<#0>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:260:9+38
    assume {:print "$at(13,11170,11208)"} true;
    assert {:msg "assert_failed(13,11170,11208): function does not abort under this condition"}
      !$1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory#133);

    // assert Not(exists[@134]<DiemConfig::ModifyConfigCapability<#0>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:261:9+86
    assume {:print "$at(13,11217,11303)"} true;
    assert {:msg "assert_failed(13,11217,11303): function does not abort under this condition"}
      !$ResourceExists($1_DiemConfig_ModifyConfigCapability'#0'_$memory#134, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@135]<Roles::RoleId>($t5))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@135]<Roles::RoleId>($t5)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#135, $t5)), 0);
    ...
    // assert exists<DiemConfig::ModifyConfigCapability<#0>>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:267:9+84
    assume {:print "$at(13,11457,11541)"} true;
    assert {:msg "assert_failed(13,11457,11541): post-condition does not hold"}
      $ResourceExists($1_DiemConfig_ModifyConfigCapability'#0'_$memory, $1_Signer_spec_address_of($t0));

    // assert DiemConfig::spec_is_published<#0>() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:145:9+36
    assume {:print "$at(13,5818,5854)"} true;
    assert {:msg "assert_failed(13,5818,5854): post-condition does not hold"}
      $1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory);

    // assert Eq<#0>(DiemConfig::$get<#0>(), $t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:146:9+33
    assume {:print "$at(13,5863,5896)"} true;
    assert {:msg "assert_failed(13,5863,5896): post-condition does not hold"}
      $IsEqual'#0'($1_DiemConfig_$get'#0'($1_DiemConfig_DiemConfig'#0'_$memory), $t1);

    // assert Eq<bool>(DiemConfig::spec_has_config[@136](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:147:9+52
    assume {:print "$at(13,5905,5957)"} true;
    assert {:msg "assert_failed(13,5905,5957): post-condition does not hold"}
      $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#136), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:147:9+52
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:249:5+1
    assume {:print "$at(13,10684,10685)"} true;
L3:

    // assert Or(Or(Or(Or(DiemConfig::spec_is_published[@133]<#0>(), exists[@134]<DiemConfig::ModifyConfigCapability<#0>>(Signer::spec_address_of[]($t0))), Not(exists[@135]<Roles::RoleId>($t5))), Neq<u64>(select Roles::RoleId.role_id(global[@135]<Roles::RoleId>($t5)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:250:5+327
    assume {:print "$at(13,10690,11017)"} true;
    assert {:msg "assert_failed(13,10690,11017): abort not covered by any of the `aborts_if` clauses"}
      (((($1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory#133) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'#0'_$memory#134, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#135, $t5)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#135, $t5)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assert Or(Or(Or(Or(DiemConfig::spec_is_published[@133]<#0>(), exists[@134]<DiemConfig::ModifyConfigCapability<#0>>(Signer::spec_address_of[]($t0))), And(Not(exists[@135]<Roles::RoleId>($t5)), Eq(5, $t9))), And(Neq<u64>(select Roles::RoleId.role_id(global[@135]<Roles::RoleId>($t5)), 0), Eq(3, $t9))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t9))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:250:5+327
    assert {:msg "assert_failed(13,10690,11017): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((($1_DiemConfig_spec_is_published'#0'($1_DiemConfig_DiemConfig'#0'_$memory#133) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'#0'_$memory#134, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory#135, $t5) && $IsEqual'u8'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#135, $t5)), 0) && $IsEqual'u8'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t9)));

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:250:5+327
    $abort_code := $t9;
    $abort_flag := true;
    return;
...
// fun DiemConfig::reconfiguration_enabled [baseline] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:203:5+119
procedure {:inline 1} $1_DiemConfig_reconfiguration_enabled() returns ($ret0: bool)
{
    // declare local variables
    var $t0: int;
    var $t1: int;
    ...
    // bytecode translation starts here
    // $t0 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L2 with $t1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:204:41+34
    assume {:print "$at(13,8721,8755)"} true;
    call $t0 := $1_CoreAddresses_DIEM_ROOT_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(13,8721,8755)"} true;
        $t1 := $abort_code;
        assume {:print "$track_abort(11,7):", $t1} $t1 == $t1;
        goto L2;
    }

    // $t2 := exists<DiemConfig::DisableReconfiguration>($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:204:10+6
    $t2 := $ResourceExists($1_DiemConfig_DisableReconfiguration_$memory, $t0);

    // $t3 := !($t2) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:204:9+1
    call $t3 := $Not($t2);

    // trace_return[0]($t3) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:204:9+67
    assume {:print "$track_return(11,7,0):", $t3} $t3 == $t3;

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:205:5+1
    assume {:print "$at(13,8761,8762)"} true;
L1:

    // return $t3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:205:5+1
    $ret0 := $t3;
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:205:5+1
L2:

    // abort($t1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:205:5+1
    $abort_code := $t1;
    $abort_flag := true;
    return;
...
// fun DiemConfig::reconfiguration_enabled [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:203:5+119
procedure {:timeLimit 40} $1_DiemConfig_reconfiguration_enabled$verify() returns ($ret0: bool)
{
    // declare local variables
    var $t0: int;
    var $t1: int;
    ...
    // bytecode translation starts here
    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:203:5+119
    assume {:print "$at(13,8643,8762)"} true;
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DisableReconfiguration'($rsc))));
...
// fun DiemConfig::reconfigure [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:5+158
procedure {:timeLimit 40} $1_DiemConfig_reconfigure$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: int;
    var $t2: $1_DiemConfig_Configuration;
    var $t3: int;
    var $t4: int;
    var $t5: bool;
    var $t6: int;
    ...
    var $t19: int;
    var $t20: $1_DiemConfig_NewEpochEvent;
    var $t21: $1_DiemConfig_NewEpochEvent;
    var $t22: $1_Event_EventHandle'$1_DiemConfig_NewEpochEvent';
    var $t23: bool;
    var $t0: int;
    var $1_DiemConfig_Configuration_$modifies: [int]bool;
    var $temp_0'$1_DiemConfig_Configuration': $1_DiemConfig_Configuration;
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_Roles_RoleId_$memory#145: $Memory $1_Roles_RoleId;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_DiemConfig_DisableReconfiguration_$memory#147: $Memory $1_DiemConfig_DisableReconfiguration;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:5+158
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(13,11642,11800)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:5+158
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:5+158
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:5+158
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:5+158
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:5+158
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_Configuration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_Configuration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_Configuration'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:5+158
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DisableReconfiguration'($rsc))));
    ...
    // assume Identical($t2, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:360:9+71
    assume {:print "$at(13,15945,16016)"} true;
    assume ($t2 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t3, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:361:9+58
    assume {:print "$at(13,16025,16083)"} true;
    assume ($t3 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume CanModify<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:279:9+67
    assume {:print "$at(13,11855,11922)"} true;
    assume $1_DiemConfig_Configuration_$modifies[$1_CoreAddresses_$DIEM_ROOT_ADDRESS()];

    // @146 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:279:9+67
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @145 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:279:9+67
    $1_Roles_RoleId_$memory#145 := $1_Roles_RoleId_$memory;

    // @147 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:279:9+67
    $1_DiemConfig_DisableReconfiguration_$memory#147 := $1_DiemConfig_DisableReconfiguration_$memory;

    // trace_local[dr_account]($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:271:5+1
    assume {:print "$at(13,11642,11643)"} true;
    assume {:print "$track_local(11,8,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:274:9+35
    // >> opaque call: Roles::assert_diem_root($t0)
    assume {:print "$at(13,11734,11769)"} true;
    ...
    // if ($t5) goto L4 else goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:274:9+35
    if ($t5) { goto L4; } else { goto L3; }

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:274:9+35
L4:
    ...
    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:274:9+35
    assume {:print "$at(13,11734,11769)"} true;
    assume {:print "$track_abort(11,8):", $t6} $t6 == $t6;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:274:9+35
    goto L2;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:274:9+35
L3:

    // opaque end: Roles::assert_diem_root($t0) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:274:9+35

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
    // >> opaque call: DiemConfig::reconfigure_()
    assume {:print "$at(13,11779,11793)"} true;

    // assume Identical($t7, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:329:9+71
    assume {:print "$at(13,14156,14227)"} true;
    assume ($t7 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t8, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:331:9+49
    assume {:print "$at(13,14326,14375)"} true;
    assume ($t8 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t9, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:352:9+71
    assume {:print "$at(13,15446,15517)"} true;
    assume ($t9 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t10, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:353:9+58
    assume {:print "$at(13,15526,15584)"} true;
    assume ($t10 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t11, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:360:9+71
    assume {:print "$at(13,15945,16016)"} true;
    assume ($t11 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t12, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:361:9+58
    assume {:print "$at(13,16025,16083)"} true;
    assume ($t12 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t13, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:370:9+71
    assume {:print "$at(13,16425,16496)"} true;
    assume ($t13 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t14, select DiemConfig::Configuration.events($t13)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:376:9+27
    assume {:print "$at(13,16746,16773)"} true;
    assume ($t14 == $events#$1_DiemConfig_Configuration($t13));

    // assert CanModify<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
    assume {:print "$at(13,11779,11793)"} true;
    assert {:msg "assert_failed(13,11779,11793): caller does not have permission to modify `DiemConfig::Configuration` at given address"}
      $1_DiemConfig_Configuration_$modifies[$1_CoreAddresses_$DIEM_ROOT_ADDRESS()];

    // opaque begin: DiemConfig::reconfigure_() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14

    // assume Identical($t15, And(Or(Not(DiemConfig::spec_reconfigure_omitted()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t11), $t8)), And(And(And(And(DiemTimestamp::$is_operating(), DiemConfig::$reconfiguration_enabled()), Gt(DiemTimestamp::spec_now_microseconds(), 0)), Lt(select DiemConfig::Configuration.epoch($t11), 18446744073709551615)), Lt($t12, select DiemConfig::Configuration.last_reconfiguration_time($t11))))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
    assume ($t15 == ((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_DiemConfig_DisableReconfiguration_$memory) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t11), $t8)) && (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) > 0)) && ($epoch#$1_DiemConfig_Configuration($t11) < 18446744073709551615)) && ($t12 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t11)))));

    // if ($t15) goto L6 else goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
    if ($t15) { goto L6; } else { goto L5; }

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
L6:

    // assume And(And(Or(Not(DiemConfig::spec_reconfigure_omitted()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t11), $t8)), And(And(And(And(DiemTimestamp::$is_operating(), DiemConfig::$reconfiguration_enabled()), Gt(DiemTimestamp::spec_now_microseconds(), 0)), Lt(select DiemConfig::Configuration.epoch($t11), 18446744073709551615)), Lt($t12, select DiemConfig::Configuration.last_reconfiguration_time($t11)))), Eq(1, $t6)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
    assume (((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_DiemConfig_DisableReconfiguration_$memory) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t11), $t8)) && (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) > 0)) && ($epoch#$1_DiemConfig_Configuration($t11) < 18446744073709551615)) && ($t12 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t11)))) && $IsEqual'u8'(1, $t6));

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
    assume {:print "$at(13,11779,11793)"} true;
    assume {:print "$track_abort(11,8):", $t6} $t6 == $t6;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
    goto L2;

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
L5:

    // @148 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
    $1_DiemConfig_Configuration_$memory#148 := $1_DiemConfig_Configuration_$memory;

    // modifies global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
    havoc $temp_0'bool';
    if ($temp_0'bool') {
    ...
    // assume Identical($t16, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:330:9+81
    assume {:print "$at(13,14236,14317)"} true;
    assume ($t16 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t17, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:332:9+59
    assume {:print "$at(13,14384,14443)"} true;
    assume ($t17 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t18, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:371:9+81
    assume {:print "$at(13,16505,16586)"} true;
    assume ($t18 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t19, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:372:9+54
    assume {:print "$at(13,16595,16649)"} true;
    assume ($t19 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t20, pack DiemConfig::NewEpochEvent(select DiemConfig::Configuration.epoch($t18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:373:9+79
    assume {:print "$at(13,16658,16737)"} true;
    assume ($t20 == $1_DiemConfig_NewEpochEvent($epoch#$1_DiemConfig_Configuration($t18)));

    // assume Eq<bool>(DiemConfig::spec_has_config[@148](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:373:9+79
    ...
    // assume Implies(Or(DiemConfig::spec_reconfigure_omitted(), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t7), $t8)), Eq<DiemConfig::Configuration>($t16, $t7)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:373:9+79
    assume (($1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_DiemConfig_DisableReconfiguration_$memory) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t7), $t8)) ==> $IsEqual'$1_DiemConfig_Configuration'($t16, $t7));

    // assume Implies(Not(Or(DiemConfig::spec_reconfigure_omitted(), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t7), $t8))), Eq<DiemConfig::Configuration>($t16, update DiemConfig::Configuration.last_reconfiguration_time<DiemConfig::Configuration>(update DiemConfig::Configuration.epoch<DiemConfig::Configuration>($t7, Add(select DiemConfig::Configuration.epoch($t7), 1)), $t17))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:373:9+79
    assume (!($1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_DiemConfig_DisableReconfiguration_$memory) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t7), $t8)) ==> $IsEqual'$1_DiemConfig_Configuration'($t16, $Update'$1_DiemConfig_Configuration'_last_reconfiguration_time($Update'$1_DiemConfig_Configuration'_epoch($t7, ($epoch#$1_DiemConfig_Configuration($t7) + 1)), $t17)));

    // assume Identical($t21, $t20) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:373:9+79
    assume ($t21 == $t20);

    // assume Identical($t22, $t14) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:373:9+79
    assume ($t22 == $t14);

    // assume Identical($t23, And(Not(DiemConfig::spec_reconfigure_omitted()), Neq<u64>($t19, select DiemConfig::Configuration.last_reconfiguration_time($t13)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:373:9+79
    assume ($t23 == (!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_DiemConfig_DisableReconfiguration_$memory) && !$IsEqual'u64'($t19, $last_reconfiguration_time#$1_DiemConfig_Configuration($t13))));

    // emit_event($t21, $t22, $t23) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:275:9+14
    assume {:print "$at(13,11779,11793)"} true;
    $es := $CondExtendEventStore'$1_DiemConfig_NewEpochEvent'($es, $t22, $t21, $t23);

    // opaque end: DiemConfig::reconfigure_() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:373:9+79
    assume {:print "$at(13,16658,16737)"} true;

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:276:5+1
    assume {:print "$at(13,11799,11800)"} true;
L1:

    // assert Not(Not(exists[@145]<Roles::RoleId>($t1))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#145, $t1);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t1)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t1)), 0);
    ...
    // assert Not(And(And(And(And(DiemTimestamp::$is_operating[@146](), DiemConfig::$reconfiguration_enabled[@147]()), Gt(DiemTimestamp::spec_now_microseconds[@146](), 0)), Lt(select DiemConfig::Configuration.epoch($t2), 18446744073709551615)), Lt($t3, select DiemConfig::Configuration.last_reconfiguration_time($t2)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:362:9+283
    assume {:print "$at(13,16092,16375)"} true;
    assert {:msg "assert_failed(13,16092,16375): function does not abort under this condition"}
      !(((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#147)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) > 0)) && ($epoch#$1_DiemConfig_Configuration($t2) < 18446744073709551615)) && ($t3 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t2)));

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:362:9+283
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:276:5+1
    assume {:print "$at(13,11799,11800)"} true;
L2:

    // assert Or(Or(Or(Not(exists[@145]<Roles::RoleId>($t1)), Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t1)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), And(And(And(And(DiemTimestamp::$is_operating[@146](), DiemConfig::$reconfiguration_enabled[@147]()), Gt(DiemTimestamp::spec_now_microseconds[@146](), 0)), Lt(select DiemConfig::Configuration.epoch($t2), 18446744073709551615)), Lt($t3, select DiemConfig::Configuration.last_reconfiguration_time($t2)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:277:5+225
    assume {:print "$at(13,11805,12030)"} true;
    assert {:msg "assert_failed(13,11805,12030): abort not covered by any of the `aborts_if` clauses"}
      (((!$ResourceExists($1_Roles_RoleId_$memory#145, $t1) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t1)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#147)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) > 0)) && ($epoch#$1_DiemConfig_Configuration($t2) < 18446744073709551615)) && ($t3 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t2))));

    // assert Or(Or(Or(And(Not(exists[@145]<Roles::RoleId>($t1)), Eq(5, $t6)), And(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t1)), 0), Eq(3, $t6))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t6))), And(And(And(And(And(DiemTimestamp::$is_operating[@146](), DiemConfig::$reconfiguration_enabled[@147]()), Gt(DiemTimestamp::spec_now_microseconds[@146](), 0)), Lt(select DiemConfig::Configuration.epoch($t2), 18446744073709551615)), Lt($t3, select DiemConfig::Configuration.last_reconfiguration_time($t2))), Eq(1, $t6))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:277:5+225
    assert {:msg "assert_failed(13,11805,12030): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((!$ResourceExists($1_Roles_RoleId_$memory#145, $t1) && $IsEqual'u8'(5, $t6)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t1)), 0) && $IsEqual'u8'(3, $t6))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t6))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#147)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) > 0)) && ($epoch#$1_DiemConfig_Configuration($t2) < 18446744073709551615)) && ($t3 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t2))) && $IsEqual'u8'(1, $t6)));

    // abort($t6) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:277:5+225
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
// fun DiemConfig::reconfigure_ [verification] at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:286:5+1620
procedure {:timeLimit 40} $1_DiemConfig_reconfigure_$verify() returns ()
{
    // declare local variables
    var $t0: $Mutation ($1_DiemConfig_Configuration);
    var $t1: int;
    ...
    var $t23: bool;
    var $t24: int;
    var $t25: $Mutation ($1_DiemConfig_Configuration);
    var $t26: int;
    var $t27: bool;
    var $t28: int;
    var $t29: bool;
    ...
    var $t39: $Mutation ($1_Event_EventHandle'$1_DiemConfig_NewEpochEvent');
    var $t40: int;
    var $t41: $1_DiemConfig_NewEpochEvent;
    var $t42: $1_DiemConfig_Configuration;
    var $t43: int;
    var $t44: $1_DiemConfig_Configuration;
    var $t45: int;
    var $t46: $1_DiemConfig_NewEpochEvent;
    var $1_DiemConfig_Configuration_$modifies: [int]bool;
    var $temp_0'$1_DiemConfig_Configuration': $1_DiemConfig_Configuration;
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_DiemConfig_DisableReconfiguration_$memory#108: $Memory $1_DiemConfig_DisableReconfiguration;
    var $1_DiemConfig_Configuration_$memory#109: $Memory $1_DiemConfig_Configuration;
    assume IsEmptyVec(p#$Mutation($t0));
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:286:5+1620
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(13,12177,13797)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:286:5+1620
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:286:5+1620
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:286:5+1620
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_Configuration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_Configuration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_Configuration'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:286:5+1620
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DisableReconfiguration_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DisableReconfiguration'($rsc))));

    // assume Identical($t6, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:329:9+71
    assume {:print "$at(13,14156,14227)"} true;
    assume ($t6 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t7, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:331:9+49
    assume {:print "$at(13,14326,14375)"} true;
    assume ($t7 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t8, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:352:9+71
    assume {:print "$at(13,15446,15517)"} true;
    assume ($t8 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t9, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:353:9+58
    assume {:print "$at(13,15526,15584)"} true;
    assume ($t9 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t10, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:360:9+71
    assume {:print "$at(13,15945,16016)"} true;
    assume ($t10 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t11, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:361:9+58
    assume {:print "$at(13,16025,16083)"} true;
    assume ($t11 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t12, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:370:9+71
    assume {:print "$at(13,16425,16496)"} true;
    assume ($t12 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t13, select DiemConfig::Configuration.events($t12)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:376:9+27
    assume {:print "$at(13,16746,16773)"} true;
    assume ($t13 == $events#$1_DiemConfig_Configuration($t12));

    // assume CanModify<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:327:9+67
    assume {:print "$at(13,14019,14086)"} true;
    assume $1_DiemConfig_Configuration_$modifies[$1_CoreAddresses_$DIEM_ROOT_ADDRESS()];

    // @107 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:327:9+67
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @109 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:327:9+67
    $1_DiemConfig_Configuration_$memory#109 := $1_DiemConfig_Configuration_$memory;

    // @108 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:327:9+67
    $1_DiemConfig_DisableReconfiguration_$memory#108 := $1_DiemConfig_DisableReconfiguration_$memory;

    // $t14 := DiemTimestamp::is_genesis() on_abort goto L17 with $t15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+27
    assume {:print "$at(13,12292,12319)"} true;
    call $t14 := $1_DiemTimestamp_is_genesis();
    if ($abort_flag) {
        assume {:print "$at(13,12292,12319)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(11,9):", $t15} $t15 == $t15;
        goto L17;
    }

    // if ($t14) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+69
    if ($t14) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+69
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+69
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+69
L0:

    // $t16 := true at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+69
    $t16 := true;
    assume $IsValid'bool'($t16);

    // $t2 := $t16 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+69
    $t2 := $t16;

    // trace_local[tmp#$2]($t16) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+69
    assume {:print "$track_local(11,9,2):", $t16} $t16 == $t16;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+69
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33
    // >> opaque call: $t8 := DiemTimestamp::now_microseconds()

    // $t17 := opaque begin: DiemTimestamp::now_microseconds() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33

    // assume Identical($t18, Not(DiemTimestamp::$is_operating())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33
    assume ($t18 == !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t18) goto L19 else goto L18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33
    if ($t18) { goto L19; } else { goto L18; }

    // label L19 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33
L19:

    // assume And(Not(DiemTimestamp::$is_operating()), Eq(1, $t15)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33
    assume (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t15));

    // trace_abort($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33
    assume {:print "$at(13,12323,12356)"} true;
    assume {:print "$track_abort(11,9):", $t15} $t15 == $t15;

    // goto L17 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33
    goto L17;

    // label L18 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33
L18:

    // assume WellFormed($t17) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33
    assume $IsValid'u64'($t17);

    // assume Eq<u64>($t17, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33
    assume $IsEqual'u64'($t17, $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // $t17 := opaque end: DiemTimestamp::now_microseconds() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:44+33

    // $t19 := 0 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:81+1
    $t19 := 0;
    assume $IsValid'u64'($t19);

    // $t20 := ==($t17, $t19) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:78+2
    $t20 := $IsEqual'u64'($t17, $t19);

    // $t2 := $t20 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+69
    $t2 := $t20;

    // trace_local[tmp#$2]($t20) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+69
    assume {:print "$track_local(11,9,2):", $t20} $t20 == $t20;

    // label L3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+69
L3:

    // if ($t2) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+99
    if ($t2) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+99
L5:

    // goto L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+99
    goto L6;

    // label L4 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+99
L4:

    // $t21 := true at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+99
    $t21 := true;
    assume $IsValid'bool'($t21);

    // $t3 := $t21 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+99
    $t3 := $t21;

    // trace_local[tmp#$3]($t21) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+99
    assume {:print "$track_local(11,9,3):", $t21} $t21 == $t21;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+99
    goto L7;

    // label L6 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:87+25
L6:

    // $t22 := DiemConfig::reconfiguration_enabled() on_abort goto L17 with $t15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:87+25
    call $t22 := $1_DiemConfig_reconfiguration_enabled();
    if ($abort_flag) {
        assume {:print "$at(13,12366,12391)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(11,9):", $t15} $t15 == $t15;
        goto L17;
    }

    // $t23 := !($t22) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:86+1
    call $t23 := $Not($t22);

    // $t3 := $t23 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+99
    $t3 := $t23;

    // trace_local[tmp#$3]($t23) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+99
    assume {:print "$track_local(11,9,3):", $t23} $t23 == $t23;

    // label L7 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:13+99
L7:

    // if ($t3) goto L8 else goto L9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:9+138
    if ($t3) { goto L8; } else { goto L9; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:9+138
L9:

    // goto L10 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:288:9+138
    goto L10;

    // label L8 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:289:13+9
    assume {:print "$at(13,12407,12416)"} true;
L8:

    // goto L16 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:289:13+9
    goto L16;

    // label L10 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:292:59+34
    assume {:print "$at(13,12487,12521)"} true;
L10:

    // $t24 := CoreAddresses::DIEM_ROOT_ADDRESS() on_abort goto L17 with $t15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:292:59+34
    call $t24 := $1_CoreAddresses_DIEM_ROOT_ADDRESS();
    if ($abort_flag) {
        assume {:print "$at(13,12487,12521)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(11,9):", $t15} $t15 == $t15;
    ...
    // assert CanModify<DiemConfig::Configuration>($t24) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:292:26+17
    assert {:msg "assert_failed(13,12454,12471): caller does not have permission to modify `DiemConfig::Configuration` at given address"}
      $1_DiemConfig_Configuration_$modifies[$t24];

    // $t25 := borrow_global<DiemConfig::Configuration>($t24) on_abort goto L17 with $t15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:292:26+17
    if (!$ResourceExists($1_DiemConfig_Configuration_$memory, $t24)) {
        call $ExecFailureAbort();
    } else {
        $t25 := $Mutation($Global($t24), EmptyVec(), $ResourceValue($1_DiemConfig_Configuration_$memory, $t24));
    }
    if ($abort_flag) {
        assume {:print "$at(13,12454,12471)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(11,9):", $t15} $t15 == $t15;
        goto L17;
    }

    // trace_local[config_ref]($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:292:13+10
    $temp_0'$1_DiemConfig_Configuration' := $Dereference($t25);
    assume {:print "$track_local(11,9,0):", $temp_0'$1_DiemConfig_Configuration'} $temp_0'$1_DiemConfig_Configuration' == $temp_0'$1_DiemConfig_Configuration';

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33
    // >> opaque call: $t16 := DiemTimestamp::now_microseconds()
    assume {:print "$at(13,12551,12584)"} true;

    // $t26 := opaque begin: DiemTimestamp::now_microseconds() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33

    // assume Identical($t27, Not(DiemTimestamp::$is_operating())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33
    assume ($t27 == !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // if ($t27) goto L22 else goto L20 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33
    if ($t27) { goto L22; } else { goto L20; }

    // label L21 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33
L21:

    // assume And(Not(DiemTimestamp::$is_operating()), Eq(1, $t15)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33
    assume (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) && $IsEqual'u8'(1, $t15));

    // trace_abort($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33
    assume {:print "$at(13,12551,12584)"} true;
    assume {:print "$track_abort(11,9):", $t15} $t15 == $t15;

    // goto L17 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33
    goto L17;

    // label L20 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33
L20:

    // assume WellFormed($t26) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33
    assume $IsValid'u64'($t26);

    // assume Eq<u64>($t26, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33
    assume $IsEqual'u64'($t26, $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // $t26 := opaque end: DiemTimestamp::now_microseconds() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:28+33

    // trace_local[current_time]($t26) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:293:13+12
    assume {:print "$track_local(11,9,1):", $t26} $t26 == $t26;

    // $t28 := get_field<DiemConfig::Configuration>.last_reconfiguration_time($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:307:29+36
    assume {:print "$at(13,13324,13360)"} true;
    $t28 := $last_reconfiguration_time#$1_DiemConfig_Configuration($Dereference($t25));

    // $t29 := ==($t26, $t28) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:307:26+2
    $t29 := $IsEqual'u64'($t26, $t28);

    // if ($t29) goto L11 else goto L12 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:307:9+88
    if ($t29) { goto L11; } else { goto L12; }

    // label L12 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:307:9+88
L12:

    // goto L13 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:307:9+88
    goto L13;

    // label L11 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:13+6
    assume {:print "$at(13,13376,13382)"} true;
L11:

    // destroy($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:13+6

    // goto L16 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:308:13+6
    goto L16;

    // label L13 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:16+12
    assume {:print "$at(13,13410,13422)"} true;
L13:

    // $t30 := get_field<DiemConfig::Configuration>.last_reconfiguration_time($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:31+36
    $t30 := $last_reconfiguration_time#$1_DiemConfig_Configuration($Dereference($t25));

    // $t31 := >($t26, $t30) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:29+1
    call $t31 := $Gt($t26, $t30);

    // $t32 := 3 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:91+19
    $t32 := 3;
    assume $IsValid'u64'($t32);

    // nop at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:69+42
    // >> opaque call: $t22 := Errors::invalid_state($t21)

    // $t33 := opaque begin: Errors::invalid_state($t32) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:69+42

    // assume WellFormed($t33) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:69+42
    assume $IsValid'u64'($t33);

    // assume Eq<u64>($t33, 1) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:69+42
    assume $IsEqual'u64'($t33, 1);

    // $t33 := opaque end: Errors::invalid_state($t32) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:69+42

    // trace_local[tmp#$5]($t33) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:9+103
    assume {:print "$track_local(11,9,5):", $t33} $t33 == $t33;

    // trace_local[tmp#$4]($t31) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:9+103
    assume {:print "$track_local(11,9,4):", $t31} $t31 == $t31;

    // if ($t31) goto L14 else goto L15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:9+103
    if ($t31) { goto L14; } else { goto L15; }

    // label L15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:9+103
L15:

    // destroy($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:9+103

    // trace_abort($t33) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:9+103
    assume {:print "$at(13,13403,13506)"} true;
    assume {:print "$track_abort(11,9):", $t33} $t33 == $t33;

    // $t15 := move($t33) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:9+103
    $t15 := $t33;

    // goto L17 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:311:9+103
    goto L17;

    // label L14 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:312:48+12
    assume {:print "$at(13,13555,13567)"} true;
L14:

    // $t34 := borrow_field<DiemConfig::Configuration>.last_reconfiguration_time($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:312:9+36
    $t34 := $ChildMutation($t25, 1, $last_reconfiguration_time#$1_DiemConfig_Configuration($Dereference($t25)));

    // write_ref($t34, $t26) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:312:9+51
    $t34 := $UpdateMutation($t34, $t26);

    // write_back[Reference($t25).last_reconfiguration_time]($t34) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:312:9+51
    $t25 := $UpdateMutation($t25, $Update'$1_DiemConfig_Configuration'_last_reconfiguration_time($Dereference($t25), $Dereference($t34)));

    // $t35 := get_field<DiemConfig::Configuration>.epoch($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:313:28+16
    assume {:print "$at(13,13596,13612)"} true;
    $t35 := $epoch#$1_DiemConfig_Configuration($Dereference($t25));

    // $t36 := 1 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:313:47+1
    $t36 := 1;
    assume $IsValid'u64'($t36);

    // $t37 := +($t35, $t36) on_abort goto L17 with $t15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:313:45+1
    call $t37 := $AddU64($t35, $t36);
    if ($abort_flag) {
        assume {:print "$at(13,13613,13614)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(11,9):", $t15} $t15 == $t15;
        goto L17;
    }

    // $t38 := borrow_field<DiemConfig::Configuration>.epoch($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:313:9+16
    $t38 := $ChildMutation($t25, 0, $epoch#$1_DiemConfig_Configuration($Dereference($t25)));

    // write_ref($t38, $t37) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:313:9+39
    $t38 := $UpdateMutation($t38, $t37);

    // write_back[Reference($t25).epoch]($t38) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:313:9+39
    $t25 := $UpdateMutation($t25, $Update'$1_DiemConfig_Configuration'_epoch($Dereference($t25), $Dereference($t38)));

    // $t39 := borrow_field<DiemConfig::Configuration>.events($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:316:13+22
    assume {:print "$at(13,13673,13695)"} true;
    $t39 := $ChildMutation($t25, 2, $events#$1_DiemConfig_Configuration($Dereference($t25)));

    // $t40 := get_field<DiemConfig::Configuration>.epoch($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:318:24+16
    assume {:print "$at(13,13748,13764)"} true;
    $t40 := $epoch#$1_DiemConfig_Configuration($Dereference($t25));

    // $t41 := pack DiemConfig::NewEpochEvent($t40) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:317:13+70
    assume {:print "$at(13,13709,13779)"} true;
    $t41 := $1_DiemConfig_NewEpochEvent($t40);

    // Event::emit_event<DiemConfig::NewEpochEvent>($t39, $t41) on_abort goto L17 with $t15 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:315:9+163
    assume {:print "$at(13,13627,13790)"} true;
    call $t39 := $1_Event_emit_event'$1_DiemConfig_NewEpochEvent'($t39, $t41);
    if ($abort_flag) {
        assume {:print "$at(13,13627,13790)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(11,9):", $t15} $t15 == $t15;
    ...
    // write_back[DiemConfig::Configuration@]($t25) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:315:9+163
    $1_DiemConfig_Configuration_$memory := $ResourceUpdate($1_DiemConfig_Configuration_$memory, $GlobalLocationAddress($t25),
        $Dereference($t25));
    ...
    // label L16 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:321:5+1
    assume {:print "$at(13,13796,13797)"} true;
L16:

    // assume Identical($t42, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:330:9+81
    assume {:print "$at(13,14236,14317)"} true;
    assume ($t42 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t43, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:332:9+59
    assume {:print "$at(13,14384,14443)"} true;
    assume ($t43 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t44, global<DiemConfig::Configuration>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:371:9+81
    assume {:print "$at(13,16505,16586)"} true;
    assume ($t44 == $ResourceValue($1_DiemConfig_Configuration_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Identical($t45, DiemTimestamp::spec_now_microseconds()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:372:9+54
    assume {:print "$at(13,16595,16649)"} true;
    assume ($t45 == $1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory));

    // assume Identical($t46, pack DiemConfig::NewEpochEvent(select DiemConfig::Configuration.epoch($t44))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:373:9+79
    assume {:print "$at(13,16658,16737)"} true;
    assume ($t46 == $1_DiemConfig_NewEpochEvent($epoch#$1_DiemConfig_Configuration($t44)));

    // assert Not(And(Or(Not(DiemConfig::spec_reconfigure_omitted[@107, @108]()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t8), $t7)), Lt($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:354:9+96
    assume {:print "$at(13,15593,15689)"} true;
    assert {:msg "assert_failed(13,15593,15689): function does not abort under this condition"}
      !((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t8), $t7)) && ($t9 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t8)));

    // assert Not(And(Or(Not(DiemConfig::spec_reconfigure_omitted[@107, @108]()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t8), $t7)), And(Eq<u64>(select DiemConfig::Configuration.epoch($t8), 18446744073709551615), Neq<u64>($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8))))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:355:9+132
    assume {:print "$at(13,15698,15830)"} true;
    assert {:msg "assert_failed(13,15698,15830): function does not abort under this condition"}
      !((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t8), $t7)) && ($IsEqual'u64'($epoch#$1_DiemConfig_Configuration($t8), 18446744073709551615) && !$IsEqual'u64'($t9, $last_reconfiguration_time#$1_DiemConfig_Configuration($t8))));

    // assert Not(And(Or(Not(DiemConfig::spec_reconfigure_omitted[@107, @108]()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t10), $t7)), And(And(And(And(DiemTimestamp::$is_operating[@107](), DiemConfig::$reconfiguration_enabled[@108]()), Gt(DiemTimestamp::spec_now_microseconds[@107](), 0)), Lt(select DiemConfig::Configuration.epoch($t10), 18446744073709551615)), Lt($t11, select DiemConfig::Configuration.last_reconfiguration_time($t10))))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:362:9+283
    assume {:print "$at(13,16092,16375)"} true;
    assert {:msg "assert_failed(13,16092,16375): function does not abort under this condition"}
      !((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t10), $t7)) && (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#108)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107) > 0)) && ($epoch#$1_DiemConfig_Configuration($t10) < 18446744073709551615)) && ($t11 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t10))));

    // assert Eq<bool>(DiemConfig::spec_has_config[@109](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:328:9+52
    assume {:print "$at(13,14095,14147)"} true;
    assert {:msg "assert_failed(13,14095,14147): post-condition does not hold"}
      $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#109), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assert Implies(Or(DiemConfig::spec_reconfigure_omitted(), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t6), $t7)), Eq<DiemConfig::Configuration>($t42, $t6)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:337:9+118
    assume {:print "$at(13,14611,14729)"} true;
    assert {:msg "assert_failed(13,14611,14729): post-condition does not hold"}
      (($1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_DiemConfig_DisableReconfiguration_$memory) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t6), $t7)) ==> $IsEqual'$1_DiemConfig_Configuration'($t42, $t6));

    // assert Implies(Not(Or(DiemConfig::spec_reconfigure_omitted(), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t6), $t7))), Eq<DiemConfig::Configuration>($t42, update DiemConfig::Configuration.last_reconfiguration_time<DiemConfig::Configuration>(update DiemConfig::Configuration.epoch<DiemConfig::Configuration>($t6, Add(select DiemConfig::Configuration.epoch($t6), 1)), $t43))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:340:9+284
    assume {:print "$at(13,14739,15023)"} true;
    assert {:msg "assert_failed(13,14739,15023): post-condition does not hold"}
      (!($1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_DiemConfig_DisableReconfiguration_$memory) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t6), $t7)) ==> $IsEqual'$1_DiemConfig_Configuration'($t42, $Update'$1_DiemConfig_Configuration'_last_reconfiguration_time($Update'$1_DiemConfig_Configuration'_epoch($t6, ($epoch#$1_DiemConfig_Configuration($t6) + 1)), $t43)));

    // assert EventStoreIncludes(ExtendEventStore(EmptyEventStore(), $t46, $t13, And(Not(DiemConfig::spec_reconfigure_omitted()), Neq<u64>($t45, select DiemConfig::Configuration.last_reconfiguration_time($t12))))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:377:9+96
    assume {:print "$at(13,16782,16878)"} true;
    assert {:msg "assert_failed(13,16782,16878): function does not emit the expected event"}
      (var actual := $EventStore__subtract($es, old($es)); (var expected := $CondExtendEventStore'$1_DiemConfig_NewEpochEvent'($EmptyEventStore, $t13, $t46, (!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_DiemConfig_DisableReconfiguration_$memory) && !$IsEqual'u64'($t45, $last_reconfiguration_time#$1_DiemConfig_Configuration($t12)))); $EventStore__is_subset(expected, actual)));

    // assert EventStoreIncludedIn(ExtendEventStore(EmptyEventStore(), $t46, $t13, And(Not(DiemConfig::spec_reconfigure_omitted()), Neq<u64>($t45, select DiemConfig::Configuration.last_reconfiguration_time($t12))))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:325:5+1095
    assume {:print "$at(13,13968,15063)"} true;
    assert {:msg "assert_failed(13,13968,15063): emitted event not covered by any of the `emits` clauses"}
      (var actual := $EventStore__subtract($es, old($es)); (var expected := $CondExtendEventStore'$1_DiemConfig_NewEpochEvent'($EmptyEventStore, $t13, $t46, (!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_DiemConfig_DisableReconfiguration_$memory) && !$IsEqual'u64'($t45, $last_reconfiguration_time#$1_DiemConfig_Configuration($t12)))); $EventStore__is_subset(actual, expected)));

    // return () at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:325:5+1095
    return;

    // label L17 at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:321:5+1
    assume {:print "$at(13,13796,13797)"} true;
L17:

    // assert Or(Or(And(Or(Not(DiemConfig::spec_reconfigure_omitted[@107, @108]()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t8), $t7)), Lt($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8))), And(Or(Not(DiemConfig::spec_reconfigure_omitted[@107, @108]()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t8), $t7)), And(Eq<u64>(select DiemConfig::Configuration.epoch($t8), 18446744073709551615), Neq<u64>($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8))))), And(Or(Not(DiemConfig::spec_reconfigure_omitted[@107, @108]()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t10), $t7)), And(And(And(And(DiemTimestamp::$is_operating[@107](), DiemConfig::$reconfiguration_enabled[@108]()), Gt(DiemTimestamp::spec_now_microseconds[@107](), 0)), Lt(select DiemConfig::Configuration.epoch($t10), 18446744073709551615)), Lt($t11, select DiemConfig::Configuration.last_reconfiguration_time($t10))))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:325:5+1095
    assume {:print "$at(13,13968,15063)"} true;
    assert {:msg "assert_failed(13,13968,15063): abort not covered by any of the `aborts_if` clauses"}
      ((((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t8), $t7)) && ($t9 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t8))) || ((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t8), $t7)) && ($IsEqual'u64'($epoch#$1_DiemConfig_Configuration($t8), 18446744073709551615) && !$IsEqual'u64'($t9, $last_reconfiguration_time#$1_DiemConfig_Configuration($t8))))) || ((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t10), $t7)) && (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#108)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107) > 0)) && ($epoch#$1_DiemConfig_Configuration($t10) < 18446744073709551615)) && ($t11 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t10)))));

    // assert Or(Or(And(And(Or(Not(DiemConfig::spec_reconfigure_omitted[@107, @108]()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t8), $t7)), Lt($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8))), Eq(1, $t15)), And(And(Or(Not(DiemConfig::spec_reconfigure_omitted[@107, @108]()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t8), $t7)), And(Eq<u64>(select DiemConfig::Configuration.epoch($t8), 18446744073709551615), Neq<u64>($t9, select DiemConfig::Configuration.last_reconfiguration_time($t8)))), Eq(-1, $t15))), And(And(Or(Not(DiemConfig::spec_reconfigure_omitted[@107, @108]()), Eq<u64>(select DiemConfig::Configuration.last_reconfiguration_time($t10), $t7)), And(And(And(And(DiemTimestamp::$is_operating[@107](), DiemConfig::$reconfiguration_enabled[@108]()), Gt(DiemTimestamp::spec_now_microseconds[@107](), 0)), Lt(select DiemConfig::Configuration.epoch($t10), 18446744073709551615)), Lt($t11, select DiemConfig::Configuration.last_reconfiguration_time($t10)))), Eq(1, $t15))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:325:5+1095
    assert {:msg "assert_failed(13,13968,15063): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t8), $t7)) && ($t9 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t8))) && $IsEqual'u8'(1, $t15)) || (((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t8), $t7)) && ($IsEqual'u64'($epoch#$1_DiemConfig_Configuration($t8), 18446744073709551615) && !$IsEqual'u64'($t9, $last_reconfiguration_time#$1_DiemConfig_Configuration($t8)))) && $IsEqual'num'(-1, $t15))) || (((!$1_DiemConfig_spec_reconfigure_omitted($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107, $1_DiemConfig_DisableReconfiguration_$memory#108) || $IsEqual'u64'($last_reconfiguration_time#$1_DiemConfig_Configuration($t10), $t7)) && (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#108)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#107) > 0)) && ($epoch#$1_DiemConfig_Configuration($t10) < 18446744073709551615)) && ($t11 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t10)))) && $IsEqual'u8'(1, $t15)));

    // abort($t15) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:325:5+1095
    $abort_code := $t15;
    $abort_flag := true;
    return;
...
L7:
    ...
    // @187 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@187](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
procedure {:inline 1} $1_RegisteredCurrencies_add_currency_code(_$t0: int, _$t1: Vec (int)) returns ()
{
    ...
    var $1_DiemConfig_Configuration_$memory#159: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
    $t1 := _$t1;
...
L6:
    ...
    // @159 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    $1_DiemConfig_Configuration_$memory#159 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@159](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#159), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L7:
    ...
    // @177 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@177](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#177), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
procedure {:inline 1} $1_DiemSystem_initialize_validator_set(_$t0: int) returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemConfig_Configuration_$memory#153: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
...
L8:
    ...
    // @153 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    $1_DiemConfig_Configuration_$memory#153 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@153](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#153), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L7:
    ...
    // @171 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@171](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
procedure {:inline 1} $1_DiemVersion_initialize(_$t0: int, _$t1: int) returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_DiemConfig_Configuration_$memory#165: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
    $t1 := _$t1;
...
L7:
    ...
    // @165 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    $1_DiemConfig_Configuration_$memory#165 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@165](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#165), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
