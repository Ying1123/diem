...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2067778) (let ((anon4_Else_correct  (=> (and (not false) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1327885) (- 0 2067934)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)))))
 :qid |DiemAccountbpl.52275:15|
 :skolemid |1784|
 ...
 :qid |DiemAccountbpl.52275:15|
 :skolemid |1784|
)) (=> (= (ControlFlow 0 1327885) (- 0 2067970)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2) (>= (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2))) (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2))))))
 :qid |DiemAccountbpl.52280:15|
 :skolemid |1785|
))))))))
(let ((anon4_Then_correct true))
(let ((|inline$$1_Diem_value'#0'$0$anon0_correct|  (=> (= $t1@0 $t1@0) (=> (and (= |inline$$1_Diem_value'#0'$0$$t1@1| (|$value#$1_Diem_Diem'#0'| $t1@0)) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1327783) 1327903) anon4_Then_correct) (=> (= (ControlFlow 0 1327783) 1327885) anon4_Else_correct))))))
(let ((anon0$1_correct  (=> (and (and (|$IsValid'$1_DiemAccount_Balance'#0''| _$t0) (= _$t0 _$t0)) (and (= $t1@0 (|$coin#$1_DiemAccount_Balance'#0'| _$t0)) (= (ControlFlow 0 1327789) 1327783))) |inline$$1_Diem_value'#0'$0$anon0_correct|)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1327656) 1327789)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2067778) 1327656) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))
))
(check-sat)
(pop 1)
