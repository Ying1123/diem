...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 211069) (let ((anon0$1_correct  (=> (and (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_118987| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |VASPbpl.9291:20|
 :skolemid |182|
)) (|$IsValid'address'| _$t0)) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_119051| $1_VASP_ParentVASP_$memory) $a_0)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc))
 :qid |VASPbpl.9298:20|
 :skolemid |183|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_119051| $1_VASP_ParentVASP_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 153425) (- 0 211204)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 153425) (- 0 211211)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) _$t0))) (=> (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) _$t0)) (and (=> (= (ControlFlow 0 153425) (- 0 211222)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (= (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_118987| $1_VASP_ChildVASP_$memory) a)))
 :qid |VASPbpl.9335:15|
 :skolemid |184|
 ...
 :qid |VASPbpl.9335:15|
 :skolemid |184|
)) (=> (= (ControlFlow 0 153425) (- 0 211247)) (forall ((parent Int) ) (!  (=> (|$IsValid'address'| parent) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_119051| $1_VASP_ParentVASP_$memory) parent) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_119051| $1_VASP_ParentVASP_$memory) parent)) (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_119051| $1_VASP_ParentVASP_$memory) parent)))))
 :qid |VASPbpl.9340:15|
 :skolemid |185|
)))))))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_66806_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 153248) 153425)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 211069) 153248) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
