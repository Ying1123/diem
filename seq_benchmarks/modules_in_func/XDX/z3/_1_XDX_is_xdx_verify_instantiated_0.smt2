...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 230200) (let ((L5_correct  (and (=> (= (ControlFlow 0 170058) (- 0 230760)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 170058) (- 0 230770)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= 5 $t2@0)))))))
(let ((anon14_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2)) (= $t2 $t2)) (and (= $t2@0 $t2) (= (ControlFlow 0 170018) 170058))) L5_correct))))
(let ((anon13_Then_correct  (=> $t4 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t2)) (= $t2 $t2)) (and (= $t2@0 $t2) (= (ControlFlow 0 170084) 170058))) L5_correct))))
(let ((L3_correct  (=> (= $t0@0 $t0@0) (and (=> (= (ControlFlow 0 169916) (- 0 230717)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (= (ControlFlow 0 169916) (- 0 230732)) (= $t0@0  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))
(let ((anon14_Else_correct  (=> (not $t6) (=> (and (|$IsValid'vec'u8''| $t5) (= $t5 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (= $t7@0 (= $t3 $t5)) (= $t7@0 $t7@0)) (and (= $t0@0 $t7@0) (= (ControlFlow 0 169992) 169916))) L3_correct)))))
(let ((anon13_Else_correct  (=> (and (and (not $t4) (|$IsValid'vec'u8''| $t3)) (and (= $t3 (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 169958) 170018) anon14_Then_correct) (=> (= (ControlFlow 0 169958) 169992) anon14_Else_correct)))))
(let ((anon12_Then_correct  (=> (and |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1| (= $t4  (not (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 169930) 170084) anon13_Then_correct) (=> (= (ControlFlow 0 169930) 169958) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1|) (= false false)) (and (= $t0@0 false) (= (ControlFlow 0 169876) 169916))) L3_correct)))
(let ((anon11_Else_correct  (=> (not false) (and (=> (= (ControlFlow 0 169856) 169930) anon12_Then_correct) (=> (= (ControlFlow 0 169856) 169876) anon12_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((|inline$$1_Diem_is_currency'$1_XUS_XUS'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1| |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1|)) (and (=> (= (ControlFlow 0 169842) 170098) anon11_Then_correct) (=> (= (ControlFlow 0 169842) 169856) anon11_Else_correct))))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114469| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
...
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@0)))
 ...
 :qid |XDXbpl.10677:20|
 :skolemid |217|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@0))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_68954_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |XDXbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 169509) 169848)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 230200) 169509) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))
))
(check-sat)
(pop 1)
