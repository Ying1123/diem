...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 237118) (let ((anon0$1_correct  (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) $a_0)))
(|$IsValid'$1_DiemId_DiemIdDomainManager'| $rsc))
 :qid |DiemIdbpl.12092:20|
 :skolemid |228|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) $a_0))
)) (|$IsValid'address'| 186537453)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 171040) (- 0 237203)) (not false)) (=> (not false) (=> (= (ControlFlow 0 171040) (- 0 237210)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) 186537453))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemIdbpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 170962) 171040)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 237118) 170962) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
