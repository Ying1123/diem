...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 225913) (let ((anon18_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 166632) (- 0 226777)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 166632) (- 0 226789)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) 5)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) 5))) (and (=> (= (ControlFlow 0 166632) (- 0 226807)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t3))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t3)) (and (=> (= (ControlFlow 0 166632) (- 0 226817)) (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory@1) $t3)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory@1) $t3) (=> (= (ControlFlow 0 166632) (- 0 226825)) (= (seq.len (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory@1) $t3))) 0)))))))))))))
(let ((anon16_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 166367) (- 0 226684)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t3))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t3)) (=> (= (ControlFlow 0 166367) (- 0 226713)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t4)) 5)) (= 3 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t3) (= 6 $t7@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 166646) 166367))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $1_DiemId_DiemIdDomains_$memory@1 $1_DiemId_DiemIdDomains_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 166698) 166646) anon18_Then_correct) (=> (= (ControlFlow 0 166698) 166632) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 166696) 166698)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_DiemId_DiemIdDomains_$memory@0 ($Memory_134465 (|Store__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0) $t14@0))) (= $1_DiemId_DiemIdDomains_$memory@1 $1_DiemId_DiemIdDomains_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 166562) 166646) anon18_Then_correct) (=> (= (ControlFlow 0 166562) 166632) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not false) (= $t14@0 ($1_DiemId_DiemIdDomains |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1|))) (and (=> (= (ControlFlow 0 166540) (- 0 226465)) (let (($range_0 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@44 $i_1))
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) i@@44))) 63)))
 :qid |DiemIdbpl.13541:91|
 :skolemid |238|
)))) (=> (let (($range_0@@0 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@45 $i_1@@0))
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) i@@45))) 63)))
 :qid |DiemIdbpl.13541:91|
 :skolemid |238|
))) (and (=> (= (ControlFlow 0 166540) (- 0 226509)) (let (($range_0@@1 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@46 $i_1@@1))
(let (($range_2 ($Range (+ i@@46 1) (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_3 Int) ) (!  (=> ($InRange $range_2 $i_3) (let ((j@@10 $i_3))
 (not (= (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) i@@46) (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) j@@10)))))
 :qid |DiemIdbpl.13549:96|
 :skolemid |239|
)))))
 :qid |DiemIdbpl.13548:91|
 :skolemid |240|
)))) (=> (let (($range_0@@2 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@47 $i_1@@2))
(let (($range_2@@0 ($Range (+ i@@47 1) (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_3@@0 Int) ) (!  (=> ($InRange $range_2@@0 $i_3@@0) (let ((j@@11 $i_3@@0))
 (not (= (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) i@@47) (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) j@@11)))))
 :qid |DiemIdbpl.13549:96|
 :skolemid |239|
)))))
 :qid |DiemIdbpl.13548:91|
 :skolemid |240|
))) (and (=> (= (ControlFlow 0 166540) 166696) anon17_Then_correct) (=> (= (ControlFlow 0 166540) 166562) anon17_Else_correct)))))))))
(let ((|inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1| (as seq.empty (Seq T@$1_DiemId_DiemIdDomain))) (and (=> (= (ControlFlow 0 166393) 166712) anon16_Then_correct) (=> (= (ControlFlow 0 166393) 166540) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 166399) 166393)) |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$anon0_correct|)))
(let ((anon15_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 166271) 166367))) L3_correct)))
(let ((anon14_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 166255) 166399) anon15_Then_correct) (=> (= (ControlFlow 0 166255) 166271) anon15_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 166215) 166255)) anon14_Else$1_correct)))
(let ((anon14_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $t8)) (= (ControlFlow 0 166221) 166215))) inline$$Not$0$anon0_correct))))
(let ((anon14_Then_correct  (=> $t6 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t5)) 5)) (= 3 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 166764) 166367))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemIdbpl.13392:20|
 :skolemid |232|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $a_0@@0)))
 (and (|$IsValid'$1_DiemId_DiemIdDomains'| $rsc@@0) (and (and (let (($range_1 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@48 $i_2))
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0) i@@48))) 63)))
 :qid |DiemIdbpl.13397:136|
 :skolemid |233|
))) (let (($range_3 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@49 $i_4))
(let (($range_5 ($Range (+ i@@49 1) (seq.len (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@12 $i_6))
 (not (= (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0) i@@49) (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0) j@@12)))))
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| $elem)) 63)))
 ...
 :skolemid |237|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0)))) (and (and (= $t4 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t5)) 5))))))) (and (=> (= (ControlFlow 0 166159) 166764) anon14_Then_correct) (=> (= (ControlFlow 0 166159) 166221) anon14_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_69963_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemIdbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 165861) 166159)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 225913) 165861) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
