...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 886811) (let ((anon15_Then_correct true))
(let ((L3_correct  (=> (= $t0@0 $t0@0) (and (=> (= (ControlFlow 0 649926) (- 0 887254)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 649926) (- 0 887275)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr))))
 ...
 :qid |Diembpl.26179:15|
 :skolemid |931|
)) (and (=> (= (ControlFlow 0 649926) (- 0 887304)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1)))
 ...
 :qid |Diembpl.26194:15|
 :skolemid |933|
)) (and (=> (= (ControlFlow 0 649926) (- 0 887379)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256783| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_256783| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5)))
 ...
 :qid |Diembpl.26214:15|
 :skolemid |935|
)) (=> (= (ControlFlow 0 649926) (- 0 887482)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262271| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_262271| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9)))
 :qid |Diembpl.26219:15|
 :skolemid |936|
))))))))))))))))))))))))
(let ((anon15_Else$1_correct  (=> (= inline$$Not$0$dst@1 inline$$Not$0$dst@1) (=> (and (= $t0@0 inline$$Not$0$dst@1) (= (ControlFlow 0 650010) 649926)) L3_correct))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t5@0)) (= (ControlFlow 0 649992) 650010)) anon15_Else$1_correct)))
(let ((anon15_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t5@0 (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t4@1)) (= (ControlFlow 0 649998) 649992)) inline$$Not$0$anon0_correct))))
(let ((anon14_Then$1_correct  (=> (= $t4@1 $t4) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 650082) 650024) anon15_Then_correct) (=> (= (ControlFlow 0 650082) 649998) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 650080) 650082)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= $t4@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= $t4@1 $t4@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 649950) 650024) anon15_Then_correct) (=> (= (ControlFlow 0 649950) 649998) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 649936) 650080) anon14_Then_correct) (=> (= (ControlFlow 0 649936) 649950) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (and (not |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|) (= false false)) (and (= $t0@0 false) (= (ControlFlow 0 649656) 649926))) L3_correct)))
(let ((anon12_Else_correct  (=> (not false) (and (=> (= (ControlFlow 0 649636) 649936) anon13_Then_correct) (=> (= (ControlFlow 0 649636) 649656) anon13_Else_correct)))))
(let ((anon12_Then_correct true))
(let ((|inline$$1_Diem_is_currency'$1_XDX_XDX'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|)) (and (=> (= (ControlFlow 0 649622) 650096) anon12_Then_correct) (=> (= (ControlFlow 0 649622) 649636) anon12_Else_correct))))))
(let ((anon0$1_correct  (=> (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 ...
 :skolemid |928|
))) (=> (and (and (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261854| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.26067:20|
 :skolemid |929|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246820| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0)))
...
)) (= (ControlFlow 0 649628) 649622))) |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 649380) 649628)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 886811) 649380) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))
))
(check-sat)
(pop 1)
