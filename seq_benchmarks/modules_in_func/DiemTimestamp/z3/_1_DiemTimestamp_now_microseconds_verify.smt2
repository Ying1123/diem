...
(let ((anon11_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t1@0 $abort_code@1) (= (ControlFlow 0 147264) 147292))) L2_correct)))
(let ((anon9_Then_correct  (=> $t0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t1)) (= $t1 $t1)) (and (= $t1@0 $t1) (= (ControlFlow 0 147370) 147292))) L2_correct))))
...
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= $t3@1 $t3@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 147208) 147264) anon11_Then_correct) (=> (= (ControlFlow 0 147208) 147250) anon11_Else_correct))))))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_64028_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTimestampbpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 147114) 147180)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 202340) 147114) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
