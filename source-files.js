...
sourcesIndex["diem_genesis_tool"] = {"name":"","files":["builder.rs","command.rs","config_builder.rs","genesis.rs","key.rs","layout.rs","lib.rs","swarm_config.rs","validator_builder.rs","validator_config.rs","validator_operator.rs","verify.rs","waypoint.rs"]};
...
sourcesIndex["diem_read_write_set"] = {"name":"","files":["lib.rs"]};
...
sourcesIndex["forge"] = {"name":"","dirs":[{"name":"backend","dirs":[{"name":"local","files":["mod.rs","node.rs","swarm.rs"]}],"files":["k8s.rs","mod.rs"]},{"name":"interface","files":["admin.rs","chain_info.rs","factory.rs","mod.rs","network.rs","node.rs","public.rs","swarm.rs","test.rs"]},{"name":"txn_emitter","files":["atomic_histogram.rs","mod.rs"]}],"files":["lib.rs","runner.rs"]};
...
sourcesIndex["move_cli"] = {"name":"","dirs":[{"name":"base","dirs":[{"name":"commands","files":["check.rs","compile.rs","mod.rs"]}],"files":["mod.rs"]},{"name":"experimental","dirs":[{"name":"commands","files":["mod.rs","read_writeset_analysis.rs"]}],"files":["mod.rs"]},{"name":"sandbox","dirs":[{"name":"commands","files":["doctor.rs","mod.rs","publish.rs","run.rs","test.rs","view.rs"]},{"name":"utils","files":["mod.rs","mode.rs","on_disk_state_view.rs","package.rs"]}],"files":["mod.rs"]}],"files":["lib.rs"]};
sourcesIndex["move_core_types"] = {"name":"","files":["account_address.rs","effects.rs","errmap.rs","gas_schedule.rs","identifier.rs","language_storage.rs","lib.rs","move_resource.rs","parser.rs","proptest_types.rs","transaction_argument.rs","value.rs","vm_status.rs"]};
...
sourcesIndex["move_vm_natives"] = {"name":"","files":["account.rs","bcs.rs","debug.rs","event.rs","hash.rs","lib.rs","signature.rs","signer.rs","unit_test.rs","vector.rs"]};
...
sourcesIndex["read_write_set"] = {"name":"","files":["dynamic_analysis.rs","lib.rs"]};
