...
L3:
    ...
    assert {:msg "assert_failed(9,4602,5025): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((((!$ResourceExists($1_Roles_RoleId_$memory#138, $t6) && $IsEqual'num'(5, $t10)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t6)), 1) && $IsEqual'num'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453) && $IsEqual'num'(2, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#138, $t7) && $IsEqual'num'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t7)), 2) && $IsEqual'num'(3, $t10))) || (!$ResourceExists($1_DesignatedDealer_Dealer_$memory#139, $t5) && $IsEqual'num'(5, $t10))) || ($1_Diem_$is_synthetic_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#140) && $IsEqual'num'(7, $t10))) || ($ResourceExists($1_Diem_PreburnQueue'#0'_$memory#141, $t5) && $IsEqual'num'(6, $t10))) || ($ResourceExists($1_Diem_Preburn'#0'_$memory#142, $t5) && $IsEqual'num'(1, $t10))) || (!$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#140) && $IsEqual'num'(5, $t10)));
...
L7:
    ...
    assert {:msg "assert_failed(9,3029,3791): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((((((((!$ResourceExists($1_Roles_RoleId_$memory#186, $t6) && $IsEqual'num'(5, $t10)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#186, $t6)), 1) && $IsEqual'num'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453) && $IsEqual'num'(2, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#186, $t7) && $IsEqual'num'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#186, $t7)), 2) && $IsEqual'num'(3, $t10))) || ($ResourceExists($1_DesignatedDealer_Dealer_$memory#187, $t5) && $IsEqual'num'(6, $t10))) || (($t2 && $1_Diem_$is_synthetic_currency'$1_XUS_XUS'($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#188)) && $IsEqual'num'(7, $t10))) || (($t2 && $ResourceExists($1_Diem_PreburnQueue'$1_XUS_XUS'_$memory#189, $t5)) && $IsEqual'num'(6, $t10))) || (($t2 && $ResourceExists($1_Diem_Preburn'$1_XUS_XUS'_$memory#190, $t5)) && $IsEqual'num'(1, $t10))) || (($t2 && !$1_Diem_spec_is_currency'$1_XUS_XUS'($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#188)) && $IsEqual'num'(5, $t10))) || ((!$t2 && $1_Diem_$is_synthetic_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#191)) && $IsEqual'num'(7, $t10))) || ((!$t2 && $ResourceExists($1_Diem_PreburnQueue'#0'_$memory#192, $t5)) && $IsEqual'num'(6, $t10))) || ((!$t2 && $ResourceExists($1_Diem_Preburn'#0'_$memory#193, $t5)) && $IsEqual'num'(1, $t10))) || ((!$t2 && !$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#191)) && $IsEqual'num'(5, $t10)));
...
L8:
    ...
    assert {:msg "assert_failed(9,6686,7398): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((($IsEqual'u64'($t1, 0) && $IsEqual'num'(7, $t12)) || (!$ResourceExists($1_Diem_MintCapability'#0'_$memory#182, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(4, $t12))) || (!$ResourceExists($1_Roles_RoleId_$memory#183, $t9) && $IsEqual'num'(5, $t12))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#183, $t9)), 1) && $IsEqual'num'(3, $t12))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'num'(2, $t12))) || (!$ResourceExists($1_DesignatedDealer_Dealer_$memory#184, $t2) && $IsEqual'num'(5, $t12))) || (!$can_mint#$1_Diem_CurrencyInfo'#0'($1_Diem_spec_currency_info'#0'($1_Diem_CurrencyInfo'#0'_$memory#185)) && $IsEqual'num'(1, $t12))) || ((($total_value#$1_Diem_CurrencyInfo'#0'($1_Diem_spec_currency_info'#0'($1_Diem_CurrencyInfo'#0'_$memory#185)) + $t1) > $MAX_U128) && $IsEqual'num'(8, $t12))) || (!$1_Diem_spec_is_currency'#0'($1_Diem_CurrencyInfo'#0'_$memory#185) && $IsEqual'num'(5, $t12)));
