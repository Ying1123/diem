...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 400080) (let ((anon0$1_correct  (=> (and (and (forall ((window_addr Int) ) (!  (=> (|$IsValid'address'| window_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142572| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_170725| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_142572| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr)))))
 ...
 :skolemid |272|
))) (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) $a_0)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc))
 :qid |AccountLimitsbpl.14162:20|
 :skolemid |273|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) $a_0))
)))) (and (and (= _$t0 _$t0) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) _$t0))) (and (= $t1@0 $t1@0) (= (ControlFlow 0 292374) (- 0 400424))))) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_142834| |$1_AccountLimits_Window'#0'_$memory|) _$t0))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_111298_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 292046) 292374)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 400080) 292046) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
