...
L8:
    ...
    // @157 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@157](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
...
// fun VASP::has_account_limits [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:114:5+170
procedure {:timeLimit 40} $1_VASP_has_account_limits$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_VASP_ChildVASP_$memory#112: $Memory $1_VASP_ChildVASP;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:114:5+170
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume {:print "$at(33,5470,5640)"} true;
    ...
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:114:5+170
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<AccountLimits::Window<#0>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:114:5+170
    ...
    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:114:5+170
    ...
    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:114:5+170
    ...
    // @112 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:114:5+1
    $1_VASP_ChildVASP_$memory#112 := $1_VASP_ChildVASP_$memory;
...
L1:
    ...
    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@112]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:251:9+78
    assume {:print "$at(33,10513,10591)"} true;
    assert {:msg "assert_failed(33,10513,10591): post-condition does not hold"}
      (forall a: int :: $IsValid'address'(a) ==> ($IsEqual'bool'($ResourceExists($1_VASP_ChildVASP_$memory, a), $ResourceExists($1_VASP_ChildVASP_$memory#112, a))));

    // return $t4 at /home/ying/diem/language/diem-framework/modules/VASP.move:251:9+78
    $ret0 := $t4;
    return;
...
// fun VASP::is_child [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:163:5+80
procedure {:timeLimit 40} $1_VASP_is_child$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:163:5+80
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume {:print "$at(33,7252,7332)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:169:17+6
    assume {:print "$at(33,7424,7430)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:169:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // @92 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:163:5+1
    assume {:print "$at(33,7252,7253)"} true;
    $1_VASP_ChildVASP_$memory#92 := $1_VASP_ChildVASP_$memory;

    // @93 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:163:5+1
    $1_VASP_ParentVASP_$memory#93 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:163:5+1
    assume {:print "$track_local(23,1,0):", $t0} $t0 == $t0;

    // $t1 := exists<VASP::ChildVASP>($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:164:9+6
    assume {:print "$at(33,7303,7309)"} true;
    $t1 := $ResourceExists($1_VASP_ChildVASP_$memory, $t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:164:9+23
    assume {:print "$track_return(23,1,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:165:5+1
    assume {:print "$at(33,7331,7332)"} true;
L1:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/VASP.move:168:9+16
    assume {:print "$at(33,7391,7407)"} true;
    assert {:msg "assert_failed(33,7391,7407): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, VASP::$is_child($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:169:9+33
    assume {:print "$at(33,7416,7449)"} true;
    assert {:msg "assert_failed(33,7416,7449): post-condition does not hold"}
      $IsEqual'bool'($t1, $1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0));

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@92]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:251:9+78
    assume {:print "$at(33,10513,10591)"} true;
    assert {:msg "assert_failed(33,10513,10591): post-condition does not hold"}
    ...
    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@93](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@93](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    assume {:print "$at(33,10648,10797)"} true;
    assert {:msg "assert_failed(33,10648,10797): post-condition does not hold"}
    ...
    // return $t1 at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    $ret0 := $t1;
    return;

}

// fun VASP::is_parent [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:153:5+82
procedure {:timeLimit 40} $1_VASP_is_parent$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:153:5+82
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume {:print "$at(33,6991,7073)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:159:17+6
    assume {:print "$at(33,7166,7172)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:159:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // @90 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:153:5+1
    assume {:print "$at(33,6991,6992)"} true;
    $1_VASP_ChildVASP_$memory#90 := $1_VASP_ChildVASP_$memory;

    // @91 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:153:5+1
    $1_VASP_ParentVASP_$memory#91 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:153:5+1
    assume {:print "$track_local(23,2,0):", $t0} $t0 == $t0;

    // $t1 := exists<VASP::ParentVASP>($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:154:9+6
    assume {:print "$at(33,7043,7049)"} true;
    $t1 := $ResourceExists($1_VASP_ParentVASP_$memory, $t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:154:9+24
    assume {:print "$track_return(23,2,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:155:5+1
    assume {:print "$at(33,7072,7073)"} true;
L1:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/VASP.move:158:9+16
    assume {:print "$at(33,7133,7149)"} true;
    assert {:msg "assert_failed(33,7133,7149): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, VASP::$is_parent($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:159:9+34
    assume {:print "$at(33,7158,7192)"} true;
    assert {:msg "assert_failed(33,7158,7192): post-condition does not hold"}
      $IsEqual'bool'($t1, $1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0));

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@90]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:251:9+78
    assume {:print "$at(33,10513,10591)"} true;
    assert {:msg "assert_failed(33,10513,10591): post-condition does not hold"}
    ...
    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@91](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@91](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    assume {:print "$at(33,10648,10797)"} true;
    assert {:msg "assert_failed(33,10648,10797): post-condition does not hold"}
...
// fun VASP::is_same_vasp [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:187:5+179
procedure {:timeLimit 40} $1_VASP_is_same_vasp$verify(_$t0: int, _$t1: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:187:5+179
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume {:print "$at(33,7904,8083)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:193:17+6
    assume {:print "$at(33,8179,8185)"} true;
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:193:17+6
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:193:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:193:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // @113 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:187:5+1
    assume {:print "$at(33,7904,7905)"} true;
    $1_VASP_ChildVASP_$memory#113 := $1_VASP_ChildVASP_$memory;

    // @114 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:187:5+1
    $1_VASP_ParentVASP_$memory#114 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr1]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:187:5+1
    assume {:print "$track_local(23,3,0):", $t0} $t0 == $t0;

    // trace_local[addr2]($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:187:5+1
    assume {:print "$track_local(23,3,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+14
    // >> opaque call: $t4 := VASP::is_vasp($t0)
    assume {:print "$at(33,7995,8009)"} true;

    // $t4 := opaque begin: VASP::is_vasp($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+14

    // assume WellFormed($t4) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+14
    assume $IsValid'bool'($t4);

    // assume Eq<bool>($t4, VASP::$is_vasp($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+14
    assume $IsEqual'bool'($t4, $1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0));

    // $t4 := opaque end: VASP::is_vasp($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+14

    // if ($t4) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+32
    if ($t4) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+32
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+32
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:35+5
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:188:27+14
    // >> opaque call: $t5 := VASP::is_vasp($t1)

    // $t5 := opaque begin: VASP::is_vasp($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:27+14

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:27+14
    assume $IsValid'bool'($t5);

    // assume Eq<bool>($t5, VASP::$is_vasp($t1)) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:27+14
    assume $IsEqual'bool'($t5, $1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t1));

    // $t5 := opaque end: VASP::is_vasp($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:27+14

    // $t2 := $t5 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+32
    $t2 := $t5;

    // trace_local[tmp#$2]($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+32
    assume {:print "$track_local(23,3,2):", $t5} $t5 == $t5;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+32
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+32
L2:

    // $t6 := false at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+32
    $t6 := false;
    assume $IsValid'bool'($t6);

    // $t2 := $t6 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+32
    $t2 := $t6;

    // trace_local[tmp#$2]($t6) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+32
    assume {:print "$track_local(23,3,2):", $t6} $t6 == $t6;

    // label L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+32
L3:

    // if ($t2) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
    if ($t2) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
L5:

    // goto L6 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
    goto L6;

    // label L4 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:60+5
L4:

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21
    // >> opaque call: $t7 := VASP::parent_address($t0)

    // $t7 := opaque begin: VASP::parent_address($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21

    // assume Identical($t8, And(Not(VASP::$is_parent($t0)), Not(VASP::$is_child($t0)))) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21
    assume ($t8 == (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0)));

    // if ($t8) goto L11 else goto L10 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21
    if ($t8) { goto L11; } else { goto L10; }

    // label L11 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21
L11:

    // assume And(And(Not(VASP::$is_parent($t0)), Not(VASP::$is_child($t0))), Eq(7, $t9)) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21
    assume ((!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0)) && $IsEqual'u8'(7, $t9));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21
    assume {:print "$at(33,8031,8052)"} true;
    assume {:print "$track_abort(23,3):", $t9} $t9 == $t9;

    // goto L9 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21
    goto L9;

    // label L10 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21
L10:

    // assume WellFormed($t7) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21
    assume $IsValid'address'($t7);

    // assume Eq<address>($t7, VASP::spec_parent_address($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21
    assume $IsEqual'address'($t7, $1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0));

    // $t7 := opaque end: VASP::parent_address($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:45+21

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21
    // >> opaque call: $t8 := VASP::parent_address($t1)

    // $t10 := opaque begin: VASP::parent_address($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21

    // assume Identical($t11, And(Not(VASP::$is_parent($t1)), Not(VASP::$is_child($t1)))) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21
    assume ($t11 == (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t1) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t1)));

    // if ($t11) goto L13 else goto L12 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21
    if ($t11) { goto L13; } else { goto L12; }

    // label L13 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21
L13:

    // assume And(And(Not(VASP::$is_parent($t1)), Not(VASP::$is_child($t1))), Eq(7, $t9)) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21
    assume ((!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t1) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t1)) && $IsEqual'u8'(7, $t9));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21
    assume {:print "$at(33,8056,8077)"} true;
    assume {:print "$track_abort(23,3):", $t9} $t9 == $t9;

    // goto L9 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21
    goto L9;

    // label L12 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21
L12:

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21
    assume $IsValid'address'($t10);

    // assume Eq<address>($t10, VASP::spec_parent_address($t1)) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21
    assume $IsEqual'address'($t10, $1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t1));

    // $t10 := opaque end: VASP::parent_address($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:70+21

    // $t12 := ==($t7, $t10) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:67+2
    $t12 := $IsEqual'address'($t7, $t10);

    // $t3 := $t12 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
    $t3 := $t12;

    // trace_local[tmp#$3]($t12) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
    assume {:print "$track_local(23,3,3):", $t12} $t12 == $t12;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
    goto L7;

    // label L6 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
L6:

    // $t13 := false at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
    $t13 := false;
    assume $IsValid'bool'($t13);

    // $t3 := $t13 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
    $t3 := $t13;

    // trace_local[tmp#$3]($t13) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
    assume {:print "$track_local(23,3,3):", $t13} $t13 == $t13;

    // label L7 at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
L7:

    // trace_return[0]($t3) at /home/ying/diem/language/diem-framework/modules/VASP.move:188:9+82
    assume {:print "$track_return(23,3,0):", $t3} $t3 == $t3;

    // label L8 at /home/ying/diem/language/diem-framework/modules/VASP.move:189:5+1
    assume {:print "$at(33,8082,8083)"} true;
L8:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/VASP.move:192:9+16
    assume {:print "$at(33,8146,8162)"} true;
    assert {:msg "assert_failed(33,8146,8162): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t3, VASP::spec_is_same_vasp($t0, $t1)) at /home/ying/diem/language/diem-framework/modules/VASP.move:193:9+50
    assume {:print "$at(33,8171,8221)"} true;
    assert {:msg "assert_failed(33,8171,8221): post-condition does not hold"}
      $IsEqual'bool'($t3, $1_VASP_spec_is_same_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0, $t1));

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@113]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:251:9+78
    assume {:print "$at(33,10513,10591)"} true;
    assert {:msg "assert_failed(33,10513,10591): post-condition does not hold"}
    ...
    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@114](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@114](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    assume {:print "$at(33,10648,10797)"} true;
    assert {:msg "assert_failed(33,10648,10797): post-condition does not hold"}
    ...
    // return $t3 at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    $ret0 := $t3;
    return;

    // label L9 at /home/ying/diem/language/diem-framework/modules/VASP.move:189:5+1
    assume {:print "$at(33,8082,8083)"} true;
L9:

    // assert false at /home/ying/diem/language/diem-framework/modules/VASP.move:190:5+139
    assume {:print "$at(33,8088,8227)"} true;
    assert {:msg "assert_failed(33,8088,8227): abort not covered by any of the `aborts_if` clauses"}
      false;

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:190:5+139
    $abort_code := $t9;
    $abort_flag := true;
    return;
...
// fun VASP::is_vasp [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:173:5+89
procedure {:timeLimit 40} $1_VASP_is_vasp$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:173:5+89
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume {:print "$at(33,7503,7592)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:179:17+6
    assume {:print "$at(33,7683,7689)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:179:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:179:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // @94 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:173:5+1
    assume {:print "$at(33,7503,7504)"} true;
    $1_VASP_ChildVASP_$memory#94 := $1_VASP_ChildVASP_$memory;

    // @95 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:173:5+1
    $1_VASP_ParentVASP_$memory#95 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:173:5+1
    assume {:print "$track_local(23,4,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+15
    // >> opaque call: $t2 := VASP::is_parent($t0)
    assume {:print "$at(33,7553,7568)"} true;

    // $t2 := opaque begin: VASP::is_parent($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+15

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+15
    assume $IsValid'bool'($t2);

    // assume Eq<bool>($t2, VASP::$is_parent($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+15
    assume $IsEqual'bool'($t2, $1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0));

    // $t2 := opaque end: VASP::is_parent($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+15

    // if ($t2) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
    if ($t2) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
L0:

    // $t3 := true at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
    $t3 := true;
    assume $IsValid'bool'($t3);

    // $t1 := $t3 at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
    $t1 := $t3;

    // trace_local[tmp#$1]($t3) at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
    assume {:print "$track_local(23,4,1):", $t3} $t3 == $t3;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:174:37+4
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:174:28+14
    // >> opaque call: $t4 := VASP::is_child($t0)

    // $t4 := opaque begin: VASP::is_child($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:174:28+14

    // assume WellFormed($t4) at /home/ying/diem/language/diem-framework/modules/VASP.move:174:28+14
    assume $IsValid'bool'($t4);

    // assume Eq<bool>($t4, VASP::$is_child($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:174:28+14
    assume $IsEqual'bool'($t4, $1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0));

    // $t4 := opaque end: VASP::is_child($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:174:28+14

    // $t1 := $t4 at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
    $t1 := $t4;

    // trace_local[tmp#$1]($t4) at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
    assume {:print "$track_local(23,4,1):", $t4} $t4 == $t4;

    // label L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
L3:

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:174:9+33
    assume {:print "$track_return(23,4,0):", $t1} $t1 == $t1;

    // label L4 at /home/ying/diem/language/diem-framework/modules/VASP.move:175:5+1
    assume {:print "$at(33,7591,7592)"} true;
L4:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/VASP.move:178:9+16
    assume {:print "$at(33,7650,7666)"} true;
    assert {:msg "assert_failed(33,7650,7666): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, VASP::$is_vasp($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:179:9+32
    assume {:print "$at(33,7675,7707)"} true;
    assert {:msg "assert_failed(33,7675,7707): post-condition does not hold"}
      $IsEqual'bool'($t1, $1_VASP_$is_vasp($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0));

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@94]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:251:9+78
    assume {:print "$at(33,10513,10591)"} true;
    assert {:msg "assert_failed(33,10513,10591): post-condition does not hold"}
    ...
    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@95](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@95](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    assume {:print "$at(33,10648,10797)"} true;
    assert {:msg "assert_failed(33,10648,10797): post-condition does not hold"}
...
// fun VASP::num_children [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:205:5+225
procedure {:timeLimit 40} $1_VASP_num_children$verify(_$t0: int) returns ($ret0: int)
{
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:205:5+225
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume {:print "$at(33,8770,8995)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:205:5+225
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:205:5+225
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:205:5+225
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // @100 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:205:5+1
    $1_VASP_ChildVASP_$memory#100 := $1_VASP_ChildVASP_$memory;

    // @101 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:205:5+1
    $1_VASP_ParentVASP_$memory#101 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:205:5+1
    assume {:print "$track_local(23,5,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20
    // >> opaque call: $t1 := VASP::parent_address($t0)
    assume {:print "$at(33,8955,8975)"} true;

    // $t1 := opaque begin: VASP::parent_address($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20

    // assume Identical($t2, And(Not(VASP::$is_parent($t0)), Not(VASP::$is_child($t0)))) at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20
    assume ($t2 == (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0)));

    // if ($t2) goto L4 else goto L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20
    if ($t2) { goto L4; } else { goto L3; }

    // label L4 at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20
L4:

    // assume And(And(Not(VASP::$is_parent($t0)), Not(VASP::$is_child($t0))), Eq(7, $t3)) at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20
    assume ((!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0)) && $IsEqual'u8'(7, $t3));

    // trace_abort($t3) at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20
    assume {:print "$at(33,8955,8975)"} true;
    assume {:print "$track_abort(23,5):", $t3} $t3 == $t3;

    // goto L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20
    goto L2;

    // label L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20
L3:

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20
    assume $IsValid'address'($t1);

    // assume Eq<address>($t1, VASP::spec_parent_address($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20
    assume $IsEqual'address'($t1, $1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0));

    // $t1 := opaque end: VASP::parent_address($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:207:37+20

    // $t4 := get_global<VASP::ParentVASP>($t1) on_abort goto L2 with $t3 at /home/ying/diem/language/diem-framework/modules/VASP.move:207:11+13
    ...
    if ($abort_flag) {
        assume {:print "$at(33,8929,8942)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(23,5):", $t3} $t3 == $t3;
        goto L2;
    }

    // $t5 := get_field<VASP::ParentVASP>.num_children($t4) at /home/ying/diem/language/diem-framework/modules/VASP.move:207:10+61
    $t5 := $num_children#$1_VASP_ParentVASP($t4);

    // trace_return[0]($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:207:9+62
    assume {:print "$track_return(23,5,0):", $t5} $t5 == $t5;

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:208:5+1
    assume {:print "$at(33,8994,8995)"} true;
L1:

    // assert Not(Not(VASP::$is_vasp[@100, @101]($t0))) at /home/ying/diem/language/diem-framework/modules/VASP.move:210:9+55
    assume {:print "$at(33,9028,9083)"} true;
    assert {:msg "assert_failed(33,9028,9083): function does not abort under this condition"}
      !!$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#100, $1_VASP_ParentVASP_$memory#101, $t0);

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@100]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:251:9+78
    assume {:print "$at(33,10513,10591)"} true;
    assert {:msg "assert_failed(33,10513,10591): post-condition does not hold"}
    ...
    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@101](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@101](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    assume {:print "$at(33,10648,10797)"} true;
    assert {:msg "assert_failed(33,10648,10797): post-condition does not hold"}
    ...
    // return $t5 at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    $ret0 := $t5;
    return;

    // label L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:208:5+1
    assume {:print "$at(33,8994,8995)"} true;
L2:

    // assert Not(VASP::$is_vasp[@100, @101]($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:209:5+89
    assume {:print "$at(33,9000,9089)"} true;
    assert {:msg "assert_failed(33,9000,9089): abort not covered by any of the `aborts_if` clauses"}
      !$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#100, $1_VASP_ParentVASP_$memory#101, $t0);

    // assert And(Not(VASP::$is_vasp[@100, @101]($t0)), Eq(7, $t3)) at /home/ying/diem/language/diem-framework/modules/VASP.move:209:5+89
    assert {:msg "assert_failed(33,9000,9089): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#100, $1_VASP_ParentVASP_$memory#101, $t0) && $IsEqual'u8'(7, $t3));

    // abort($t3) at /home/ying/diem/language/diem-framework/modules/VASP.move:209:5+89
    $abort_code := $t3;
    $abort_flag := true;
    return;
...
// fun VASP::parent_address [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:124:5+334
procedure {:timeLimit 40} $1_VASP_parent_address$verify(_$t0: int) returns ($ret0: int)
{
    ...
    // bytecode translation starts here
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:124:5+334
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume {:print "$at(33,5959,6293)"} true;
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:136:17+6
    assume {:print "$at(33,6444,6450)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:136:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:136:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));

    // @97 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:124:5+1
    assume {:print "$at(33,5959,5960)"} true;
    $1_VASP_ChildVASP_$memory#97 := $1_VASP_ChildVASP_$memory;

    // @96 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:124:5+1
    $1_VASP_ParentVASP_$memory#96 := $1_VASP_ParentVASP_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:124:5+1
    assume {:print "$track_local(23,6,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:125:13+15
    // >> opaque call: $t3 := VASP::is_parent($t0)
    assume {:print "$at(33,6042,6057)"} true;

    // $t3 := opaque begin: VASP::is_parent($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:125:13+15

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/VASP.move:125:13+15
    assume $IsValid'bool'($t3);

    // assume Eq<bool>($t3, VASP::$is_parent($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:125:13+15
    assume $IsEqual'bool'($t3, $1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $t0));

    // $t3 := opaque end: VASP::is_parent($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:125:13+15

    // if ($t3) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:125:9+249
    if ($t3) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/VASP.move:125:9+249
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:125:9+249
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/VASP.move:126:13+4
    assume {:print "$at(33,6073,6077)"} true;
L0:

    // $t2 := $t0 at /home/ying/diem/language/diem-framework/modules/VASP.move:125:9+249
    assume {:print "$at(33,6038,6287)"} true;
    $t2 := $t0;

    // trace_local[tmp#$2]($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:125:9+249
    assume {:print "$track_local(23,6,2):", $t0} $t0 == $t0;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:125:9+249
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/VASP.move:127:29+4
    assume {:print "$at(33,6106,6110)"} true;
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:127:20+14
    // >> opaque call: $t4 := VASP::is_child($t0)

    // $t4 := opaque begin: VASP::is_child($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:127:20+14

    // assume WellFormed($t4) at /home/ying/diem/language/diem-framework/modules/VASP.move:127:20+14
    assume $IsValid'bool'($t4);

    // assume Eq<bool>($t4, VASP::$is_child($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:127:20+14
    assume $IsEqual'bool'($t4, $1_VASP_$is_child($1_VASP_ChildVASP_$memory, $t0));

    // $t4 := opaque end: VASP::is_child($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:127:20+14

    // if ($t4) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/VASP.move:127:16+194
    if ($t4) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/VASP.move:130:44+11
    assume {:print "$at(33,6264,6275)"} true;
L5:

    // $t5 := 2 at /home/ying/diem/language/diem-framework/modules/VASP.move:130:44+11
    $t5 := 2;
    assume $IsValid'u64'($t5);

    // nop at /home/ying/diem/language/diem-framework/modules/VASP.move:130:18+39
    // >> opaque call: $t6 := Errors::invalid_argument($t5)

    // $t6 := opaque begin: Errors::invalid_argument($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:130:18+39

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/VASP.move:130:18+39
    assume $IsValid'u64'($t6);

    // assume Eq<u64>($t6, 7) at /home/ying/diem/language/diem-framework/modules/VASP.move:130:18+39
    assume $IsEqual'u64'($t6, 7);

    // $t6 := opaque end: Errors::invalid_argument($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:130:18+39

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/VASP.move:130:13+44
    assume {:print "$at(33,6233,6277)"} true;
    assume {:print "$track_abort(23,6):", $t6} $t6 == $t6;

    // $t7 := move($t6) at /home/ying/diem/language/diem-framework/modules/VASP.move:130:13+44
    $t7 := $t6;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/VASP.move:130:13+44
    goto L7;

    // label L4 at /home/ying/diem/language/diem-framework/modules/VASP.move:128:38+4
    assume {:print "$at(33,6152,6156)"} true;
L4:

    // $t8 := get_global<VASP::ChildVASP>($t0) on_abort goto L7 with $t7 at /home/ying/diem/language/diem-framework/modules/VASP.move:128:13+13
    ...
    if ($abort_flag) {
        assume {:print "$at(33,6127,6140)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(23,6):", $t7} $t7 == $t7;
        goto L7;
    }

    // $t9 := get_field<VASP::ChildVASP>.parent_vasp_addr($t8) at /home/ying/diem/language/diem-framework/modules/VASP.move:128:13+47
    $t9 := $parent_vasp_addr#$1_VASP_ChildVASP($t8);

    // trace_local[tmp#$1]($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:127:16+194
    assume {:print "$at(33,6093,6287)"} true;
    assume {:print "$track_local(23,6,1):", $t9} $t9 == $t9;

    // $t2 := $t9 at /home/ying/diem/language/diem-framework/modules/VASP.move:125:9+249
    assume {:print "$at(33,6038,6287)"} true;
    $t2 := $t9;

    // trace_local[tmp#$2]($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:125:9+249
    assume {:print "$track_local(23,6,2):", $t9} $t9 == $t9;

    // label L3 at /home/ying/diem/language/diem-framework/modules/VASP.move:125:9+249
L3:

    // trace_return[0]($t2) at /home/ying/diem/language/diem-framework/modules/VASP.move:125:9+249
    assume {:print "$track_return(23,6,0):", $t2} $t2 == $t2;

    // label L6 at /home/ying/diem/language/diem-framework/modules/VASP.move:132:5+1
    assume {:print "$at(33,6292,6293)"} true;
L6:

    // assert Not(And(Not(VASP::$is_parent[@96]($t0)), Not(VASP::$is_child[@97]($t0)))) at /home/ying/diem/language/diem-framework/modules/VASP.move:135:9+76
    assume {:print "$at(33,6351,6427)"} true;
    assert {:msg "assert_failed(33,6351,6427): function does not abort under this condition"}
      !(!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#96, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory#97, $t0));

    // assert Eq<address>($t2, VASP::spec_parent_address($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:136:9+44
    assume {:print "$at(33,6436,6480)"} true;
    assert {:msg "assert_failed(33,6436,6480): post-condition does not hold"}
      $IsEqual'address'($t2, $1_VASP_spec_parent_address($1_VASP_ChildVASP_$memory, $1_VASP_ParentVASP_$memory, $t0));

    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@97]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:251:9+78
    assume {:print "$at(33,10513,10591)"} true;
    assert {:msg "assert_failed(33,10513,10591): post-condition does not hold"}
    ...
    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@96](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@96](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    assume {:print "$at(33,10648,10797)"} true;
    assert {:msg "assert_failed(33,10648,10797): post-condition does not hold"}
    ...
    // return $t2 at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    $ret0 := $t2;
    return;

    // label L7 at /home/ying/diem/language/diem-framework/modules/VASP.move:132:5+1
    assume {:print "$at(33,6292,6293)"} true;
L7:

    // assert And(Not(VASP::$is_parent[@96]($t0)), Not(VASP::$is_child[@97]($t0))) at /home/ying/diem/language/diem-framework/modules/VASP.move:133:5+188
    assume {:print "$at(33,6298,6486)"} true;
    assert {:msg "assert_failed(33,6298,6486): abort not covered by any of the `aborts_if` clauses"}
      (!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#96, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory#97, $t0));

    // assert And(And(Not(VASP::$is_parent[@96]($t0)), Not(VASP::$is_child[@97]($t0))), Eq(7, $t7)) at /home/ying/diem/language/diem-framework/modules/VASP.move:133:5+188
    assert {:msg "assert_failed(33,6298,6486): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$1_VASP_$is_parent($1_VASP_ParentVASP_$memory#96, $t0) && !$1_VASP_$is_child($1_VASP_ChildVASP_$memory#97, $t0)) && $IsEqual'u8'(7, $t7));

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/VASP.move:133:5+188
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun VASP::publish_child_vasp_credential [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+896
procedure {:timeLimit 40} $1_VASP_publish_child_vasp_credential$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+896
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+896
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+896
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+896
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+896
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+896
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));
    ...
    // @120 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+1
    assume {:print "$at(33,3061,3062)"} true;
    $1_Roles_RoleId_$memory#120 := $1_Roles_RoleId_$memory;

    // @118 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+1
    $1_VASP_ChildVASP_$memory#118 := $1_VASP_ChildVASP_$memory;

    // @119 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+1
...
L4:
    ...
    // @244 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+896
    // state save for global update invariants
    assume {:print "$at(33,3061,3957)"} true;
    $1_VASP_ChildVASP_$memory#244 := $1_VASP_ChildVASP_$memory;

    // @243 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:68:5+896
    ...
    assume {:print "$at(33,3861,3894)"} true;
    $1_VASP_ParentVASP_$memory := $ResourceUpdate($1_VASP_ParentVASP_$memory, $GlobalLocationAddress($t27),
        $Dereference($t27));

    // assert forall addr: TypeDomain<address>() where VASP::$is_parent[@243](addr): VASP::$is_parent(addr) at /home/ying/diem/language/diem-framework/modules/VASP.move:222:9+94
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:222:9+94
    assume {:print "$at(33,9449,9543)"} true;
    assert {:msg "assert_failed(33,9449,9543): global memory invariant does not hold"}
    ...
    // assert forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume {:print "$at(33,9710,9861)"} true;
    assert {:msg "assert_failed(33,9710,9861): global memory invariant does not hold"}
    ...
    // assert forall a: TypeDomain<address>() where VASP::$is_child[@244](a): Eq<address>(VASP::spec_parent_address(a), VASP::spec_parent_address[@244, @243](a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:264:9+125
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:264:9+125
    assume {:print "$at(33,10948,11073)"} true;
    assert {:msg "assert_failed(33,10948,11073): global memory invariant does not hold"}
    ...
    // @245 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:264:9+125
    // state save for global update invariants
    assume {:print "$at(33,10948,11073)"} true;
    $1_VASP_ChildVASP_$memory#245 := $1_VASP_ChildVASP_$memory;

    // @246 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:264:9+125
    ...
    // assert forall addr: TypeDomain<address>() where VASP::$is_child[@245](addr): VASP::$is_child(addr) at /home/ying/diem/language/diem-framework/modules/VASP.move:225:9+92
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:225:9+92
    assume {:print "$at(33,9553,9645)"} true;
    assert {:msg "assert_failed(33,9553,9645): global memory invariant does not hold"}
    ...
    // assert forall a: TypeDomain<address>() where VASP::$is_child[@245](a): Eq<address>(VASP::spec_parent_address(a), VASP::spec_parent_address[@245, @246](a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:264:9+125
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:264:9+125
    assume {:print "$at(33,10948,11073)"} true;
    assert {:msg "assert_failed(33,10948,11073): global memory invariant does not hold"}
...
L6:
    ...
    // assert Not(VASP::$is_vasp[@118, @119]($t11)) at /home/ying/diem/language/diem-framework/modules/VASP.move:98:9+61
    ...
    // assert Not(Not(VASP::$is_parent[@119]($t12))) at /home/ying/diem/language/diem-framework/modules/VASP.move:99:9+64
    ...
    // assert Not(Gt(Add(VASP::spec_num_children[@119]($t12), 1), 65536)) at /home/ying/diem/language/diem-framework/modules/VASP.move:100:9+94
    ...
    // assert Not(Not(exists[@120]<Roles::RoleId>($t13))) at /home/ying/diem/language/diem-framework/modules/Roles.move:541:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@120]<Roles::RoleId>($t13)), 5)) at /home/ying/diem/language/diem-framework/modules/Roles.move:542:9+89
    ...
    // assert Not(Not(exists[@120]<Roles::RoleId>($t11))) at /home/ying/diem/language/diem-framework/modules/Roles.move:547:9+62
    assume {:print "$at(26,24470,24532)"} true;
    assert {:msg "assert_failed(26,24470,24532): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#120, $t11);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@120]<Roles::RoleId>($t11)), 6)) at /home/ying/diem/language/diem-framework/modules/Roles.move:548:9+91
    assume {:print "$at(26,24541,24632)"} true;
    assert {:msg "assert_failed(26,24541,24632): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#120, $t11)), 6);

    // assert Eq<u64>(VASP::spec_num_children(Signer::spec_address_of($t0)), Add(VASP::spec_num_children[@119](Signer::spec_address_of[]($t0)), 1)) at /home/ying/diem/language/diem-framework/modules/VASP.move:106:9+82
    ...
    // assert VASP::$is_child($t11) at /home/ying/diem/language/diem-framework/modules/VASP.move:107:9+29
    ...
    // assert Eq<address>(VASP::spec_parent_address($t11), Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/VASP.move:108:9+55
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/VASP.move:108:9+55
    return;
...
L7:
    ...
    assert {:msg "assert_failed(33,3962,4513): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t16) at /home/ying/diem/language/diem-framework/modules/VASP.move:84:5+551
    $abort_code := $t16;
    $abort_flag := true;
    return;
...
// fun VASP::publish_parent_vasp_credential [verification] at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
procedure {:timeLimit 40} $1_VASP_publish_parent_vasp_credential$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(a550c18)) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(33,1940,2361)"} true;
    ...
    // assume forall addr: TypeDomain<address>() where exists<AccountLimits::Window<#0>>(addr): And(exists<Roles::RoleId>(addr), Or(Eq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(addr)), 5), Eq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(addr)), 6))) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:549:9+318
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_AccountLimits_Window'#0'_$memory, addr))  ==> (($ResourceExists($1_Roles_RoleId_$memory, addr) && ($IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, addr)), 5) || $IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, addr)), 6)))));

    // assume forall child_addr: TypeDomain<address>() where VASP::$is_child(child_addr): VASP::$is_parent(select VASP::ChildVASP.parent_vasp_addr(global<VASP::ChildVASP>(child_addr))) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:231:9+151
    assume (forall child_addr: int :: $IsValid'address'(child_addr) ==> ($1_VASP_$is_child($1_VASP_ChildVASP_$memory, child_addr))  ==> ($1_VASP_$is_parent($1_VASP_ParentVASP_$memory, $parent_vasp_addr#$1_VASP_ChildVASP($ResourceValue($1_VASP_ChildVASP_$memory, child_addr)))));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    ...
    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ChildVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ChildVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ChildVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ChildVASP'($rsc))));

    // assume forall $rsc: ResourceDomain<VASP::ParentVASP>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    assume (forall $a_0: int :: {$ResourceValue($1_VASP_ParentVASP_$memory, $a_0)}(var $rsc := $ResourceValue($1_VASP_ParentVASP_$memory, $a_0);
    ($IsValid'$1_VASP_ParentVASP'($rsc))));
    ...
    // @137 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+1
    ...
    // @138 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+1
    $1_Roles_RoleId_$memory#138 := $1_Roles_RoleId_$memory;

    // @139 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+1
    $1_VASP_ChildVASP_$memory#139 := $1_VASP_ChildVASP_$memory;

    // @140 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+1
...
L7:
    ...
    assume (((!$ResourceExists($1_Roles_RoleId_$memory, $t10) && $IsEqual'u8'(5, $t9)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t10)), 1) && $IsEqual'u8'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453) && $IsEqual'u8'(2, $t9)));
...
L0:
    ...
    // @248 := save_mem(VASP::ChildVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    // state save for global update invariants
    assume {:print "$at(33,1940,2361)"} true;
    $1_VASP_ChildVASP_$memory#248 := $1_VASP_ChildVASP_$memory;

    // @247 := save_mem(VASP::ParentVASP) at /home/ying/diem/language/diem-framework/modules/VASP.move:42:5+421
    ...
    // assert forall addr: TypeDomain<address>() where VASP::$is_parent[@247](addr): VASP::$is_parent(addr) at /home/ying/diem/language/diem-framework/modules/VASP.move:222:9+94
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:222:9+94
    assume {:print "$at(33,9449,9543)"} true;
    assert {:msg "assert_failed(33,9449,9543): global memory invariant does not hold"}
    ...
    // assert forall a: TypeDomain<address>() where VASP::$is_child[@248](a): Eq<address>(VASP::spec_parent_address(a), VASP::spec_parent_address[@248, @247](a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:264:9+125
    // global invariant at /home/ying/diem/language/diem-framework/modules/VASP.move:264:9+125
    assume {:print "$at(33,10948,11073)"} true;
    assert {:msg "assert_failed(33,10948,11073): global memory invariant does not hold"}
...
L2:
    ...
    // assert Not(Not(exists[@138]<Roles::RoleId>($t6))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t6)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    ...
    // assert Not(Not(exists[@138]<Roles::RoleId>($t7))) at /home/ying/diem/language/diem-framework/modules/Roles.move:541:9+59
    assume {:print "$at(26,24232,24291)"} true;
    assert {:msg "assert_failed(26,24232,24291): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#138, $t7);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t7)), 5)) at /home/ying/diem/language/diem-framework/modules/Roles.move:542:9+89
    assume {:print "$at(26,24300,24389)"} true;
    assert {:msg "assert_failed(26,24300,24389): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t7)), 5);

    // assert Not(VASP::$is_vasp[@139, @140]($t5)) at /home/ying/diem/language/diem-framework/modules/VASP.move:56:9+60
    assume {:print "$at(33,2657,2717)"} true;
    assert {:msg "assert_failed(33,2657,2717): function does not abort under this condition"}
      !$1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#139, $1_VASP_ParentVASP_$memory#140, $t5);

    // assert VASP::$is_parent($t5) at /home/ying/diem/language/diem-framework/modules/VASP.move:62:9+29
    ...
    // assert Eq<u64>(VASP::spec_num_children($t5), 0) at /home/ying/diem/language/diem-framework/modules/VASP.move:63:9+42
    ...
    // assert forall a: TypeDomain<address>(): Eq<bool>(exists<VASP::ChildVASP>(a), exists[@139]<VASP::ChildVASP>(a)) at /home/ying/diem/language/diem-framework/modules/VASP.move:251:9+78
    assume {:print "$at(33,10513,10591)"} true;
    assert {:msg "assert_failed(33,10513,10591): post-condition does not hold"}
    ...
    // assert forall parent: TypeDomain<address>() where VASP::$is_parent[@140](parent): Eq<u64>(VASP::spec_num_children(parent), VASP::spec_num_children[@140](parent)) at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    assume {:print "$at(33,10648,10797)"} true;
    assert {:msg "assert_failed(33,10648,10797): post-condition does not hold"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/VASP.move:255:9+149
    return;
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_operating[@137]()), Not(exists[@138]<Roles::RoleId>($t6))), Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t6)), 1)), Neq<address>(Signer::spec_address_of[]($t1), b1e55ed)), Not(exists[@138]<Roles::RoleId>($t7))), Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t7)), 5)), VASP::$is_vasp[@139, @140]($t5)) at /home/ying/diem/language/diem-framework/modules/VASP.move:51:5+420
    assume {:print "$at(33,2367,2787)"} true;
    assert {:msg "assert_failed(33,2367,2787): abort not covered by any of the `aborts_if` clauses"}
      ((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#137) || !$ResourceExists($1_Roles_RoleId_$memory#138, $t6)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t6)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453)) || !$ResourceExists($1_Roles_RoleId_$memory#138, $t7)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t7)), 5)) || $1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#139, $1_VASP_ParentVASP_$memory#140, $t5));

    // assert Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@137]()), Eq(1, $t9)), And(Not(exists[@138]<Roles::RoleId>($t6)), Eq(5, $t9))), And(Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t6)), 1), Eq(3, $t9))), And(Neq<address>(Signer::spec_address_of[]($t1), b1e55ed), Eq(2, $t9))), And(Not(exists[@138]<Roles::RoleId>($t7)), Eq(5, $t9))), And(Neq<u64>(select Roles::RoleId.role_id(global[@138]<Roles::RoleId>($t7)), 5), Eq(3, $t9))), And(VASP::$is_vasp[@139, @140]($t5), Eq(6, $t9))) at /home/ying/diem/language/diem-framework/modules/VASP.move:51:5+420
    assert {:msg "assert_failed(33,2367,2787): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#137) && $IsEqual'u8'(1, $t9)) || (!$ResourceExists($1_Roles_RoleId_$memory#138, $t6) && $IsEqual'u8'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t6)), 1) && $IsEqual'u8'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453) && $IsEqual'u8'(2, $t9))) || (!$ResourceExists($1_Roles_RoleId_$memory#138, $t7) && $IsEqual'u8'(5, $t9))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#138, $t7)), 5) && $IsEqual'u8'(3, $t9))) || ($1_VASP_$is_vasp($1_VASP_ChildVASP_$memory#139, $1_VASP_ParentVASP_$memory#140, $t5) && $IsEqual'u8'(6, $t9)));

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/VASP.move:51:5+420
    $abort_code := $t9;
    $abort_flag := true;
    return;
