...
(assert (not
 ...
 :qid |Diembpl.33554:15|
 :skolemid |1236|
)) (and (=> (= (ControlFlow 0 696250) (- 0 922309)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1)))
 ...
 :qid |Diembpl.33569:15|
 :skolemid |1238|
)) (and (=> (= (ControlFlow 0 696250) (- 0 922384)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256783| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_256783| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5)))
 ...
 :qid |Diembpl.33589:15|
 :skolemid |1240|
)) (=> (= (ControlFlow 0 696250) (- 0 922487)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262271| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_262271| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9)))
 :qid |Diembpl.33594:15|
 :skolemid |1241|
)))))))))))))))))))))))))
(let ((anon11_Then_correct true))
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 696322) 696264) anon11_Then_correct) (=> (= (ControlFlow 0 696322) 696250) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 696320) 696322)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= $t3@1 $t3@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 695970) 696264) anon11_Then_correct) (=> (= (ControlFlow 0 695970) 696250) anon11_Else_correct))))))
(let ((anon9_Else_correct  (=> (and (not $t0) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 695956) 696320) anon10_Then_correct) (=> (= (ControlFlow 0 695956) 695970) anon10_Else_correct)))))
...
)) (= $t0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 695942) 696348) anon9_Then_correct) (=> (= (ControlFlow 0 695942) 695956) anon9_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 695769) 695942)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 921902) 695769) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))
))
(check-sat)
(pop 1)
