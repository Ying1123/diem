...
(assert (not
 (=> (= (ControlFlow 0 0) 877638) (let ((anon0$1_correct@@30  (=> (|$IsValid'address'| _$t0@@29) (=> (and (and (|$IsValid'vec'$1_DiemSystem_ValidatorInfo''| _$t1@@24) (= _$t0@@29 _$t0@@29)) (and (= _$t1@@24 _$t1@@24) (= $t3@@0 (seq.len _$t1@@24)))) (=> (and (and (and (|$IsValid'$1_Option_Option'u64''| $t4@@9) (<= (seq.len (|$vec#$1_Option_Option'u64'| $t4@@9)) 1)) (=> (let (($range_0@@70 ($Range 0 $t3@@0)))
(forall (($i_1@@61 Int) ) (!  (=> ($InRange $range_0@@70 $i_1@@61) (let ((i@@93 $i_1@@61))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t1@@24 i@@93)) _$t0@@29))))
 :qid |DiemSystembpl.21380:54|
 :skolemid |674|
))) (= (seq.len (|$vec#$1_Option_Option'u64'| $t4@@9)) 0))) (and (and (=> (let (($range_0@@71 ($Range 0 $t3@@0)))
(exists (($i_1@@62 Int) ) (!  (and ($InRange $range_0@@71 $i_1@@62) (let ((i@@94 $i_1@@62))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t1@@24 i@@94)) _$t0@@29)))
 :qid |DiemSystembpl.21384:54|
 :skolemid |675|
))) (and (not (= (seq.len (|$vec#$1_Option_Option'u64'| $t4@@9)) 0)) (let ((at@@2 (seq.nth (|$vec#$1_Option_Option'u64'| $t4@@9) 0)))
(= at@@2 ($choice_0 _$t1@@24 _$t0@@29))))) (= $t4@@9 $t4@@9)) (and (= $t5@@20  (not (= (seq.len (|$vec#$1_Option_Option'u64'| $t4@@9)) 0))) (= $t5@@20 $t5@@20)))) (and (=> (= (ControlFlow 0 551466) (- 0 877857)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 551466) (- 0 877864)) (= $t5@@20 (let (($range_0@@72 _$t1@@24))
(exists (($i_1@@63 Int) ) (!  (and (and (>= $i_1@@63 0) (< $i_1@@63 (seq.len $range_0@@72))) (let ((v@@114 (seq.nth $range_0@@72 $i_1@@63)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@114) _$t0@@29)))
 :qid |DiemSystembpl.21417:57|
 :skolemid |676|
))))) (=> (= $t5@@20 (let (($range_0@@73 _$t1@@24))
(exists (($i_1@@64 Int) ) (!  (and (and (>= $i_1@@64 0) (< $i_1@@64 (seq.len $range_0@@73))) (let ((v@@115 (seq.nth $range_0@@73 $i_1@@64)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@115) _$t0@@29)))
 :qid |DiemSystembpl.21417:57|
 :skolemid |676|
)))) (=> (= (ControlFlow 0 551466) (- 0 877900)) (= (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@547 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@547)))) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@548 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@548)))))))))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@30  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@50 T@$1_Event_EventHandle) ) (! (let ((stream@@60 (|Select__T@[$1_Event_EventHandle]Multiset_200533_| (|streams#$EventStore| $es) handle@@50)))
 (and (= (|l#Multiset_200533| stream@@60) 0) (forall ((v@@116 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_200533| stream@@60) v@@116) 0)
 :qid |DiemSystembpl.134:13|
 :skolemid |2|
))))
 :qid |DiemSystembpl.3452:13|
 :skolemid |94|
))) (= (ControlFlow 0 551215) 551466)) anon0$1_correct@@30)))
(let ((anon0_correct@@30  (=> (= (ControlFlow 0 877638) 551215) inline$$InitEventStore$0$anon0_correct@@30)))
anon0_correct@@30))))
))
(check-sat)
(pop 1)
