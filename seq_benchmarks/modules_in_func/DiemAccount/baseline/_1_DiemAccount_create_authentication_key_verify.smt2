...
(declare-fun $t14 () Int)
(declare-fun |inline$$1_Vector_append'u8'$0$m'@1| () T@$Mutation_449654)
(declare-fun $t5@0 () T@$Mutation_449654)
...
(declare-fun $t5 () T@$Mutation_449654)
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_create_authentication_key$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2068020) (let ((anon17_Else_correct true))
(let ((anon17_Then_correct  (=> (and $t12@0 (= $t4@0 $t4@0)) (and (=> (= (ControlFlow 0 1328447) (- 0 2068393)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (not (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0)))) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (not (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0))))))
 :qid |DiemAccountbpl.52466:15|
 :skolemid |1786|
 ...
 :qid |DiemAccountbpl.52466:15|
 :skolemid |1786|
)) (and (=> (= (ControlFlow 0 1328447) (- 0 2068441)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@2)) (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@2)))) 0)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@2)) (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@2)))) 0))))
 :qid |DiemAccountbpl.52471:15|
 :skolemid |1787|
 ...
 :qid |DiemAccountbpl.52471:15|
 :skolemid |1787|
)) (=> (= (ControlFlow 0 1328447) (- 0 2068493)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@4)))))
 :qid |DiemAccountbpl.52476:15|
 :skolemid |1788|
))))))))))
(let ((anon16_Else_correct  (=> (and (and (and (not false) (|$IsValid'u64'| 32)) (and (= $t12@0 (= |inline$$1_Vector_length'u8'$0$l@1| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| $t14) (= $t14 7)) (and (= $t14 $t14) (= $t12@0 $t12@0)))) (and (=> (= (ControlFlow 0 1328270) 1328447) anon17_Then_correct) (=> (= (ControlFlow 0 1328270) 1328286) anon17_Else_correct)))))
(let ((anon16_Then_correct true))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (|l#Vec_37831| $t4@0)) (and (=> (= (ControlFlow 0 1328212) 1328461) anon16_Then_correct) (=> (= (ControlFlow 0 1328212) 1328270) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (not false) (=> (and (= $t4@0 (|v#$Mutation_449654| |inline$$1_Vector_append'u8'$0$m'@1|)) (= (ControlFlow 0 1328218) 1328212)) |inline$$1_Vector_length'u8'$0$anon0_correct|))))
(let ((anon15_Then_correct true))
(let ((|inline$$1_Vector_append'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_append'u8'$0$m'@1| ($Mutation_449654 (|l#$Mutation_449654| $t5@0) (|p#$Mutation_449654| $t5@0) (let ((m2@@0 (|v#Vec_37831| call1formal@res@0)))
(let ((l2 (|l#Vec_37831| call1formal@res@0)))
(let ((m1@@0 (|v#Vec_37831| (|v#$Mutation_449654| $t5@0))))
(let ((l1 (|l#Vec_37831| (|v#$Mutation_449654| $t5@0))))
(Vec_37831 (|lambda#39| 0 (+ l1 l2) l1 m1@@0 m2@@0 l1 DefaultVecElem_16957) (+ l1 l2)))))))) (and (=> (= (ControlFlow 0 1328160) 1328475) anon15_Then_correct) (=> (= (ControlFlow 0 1328160) 1328218) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not false) (= (ControlFlow 0 1328166) 1328160)) |inline$$1_Vector_append'u8'$0$anon0_correct|)))
(let ((anon14_Then_correct true))
(let ((anon13_Else_correct  (=> (and (not false) (= call1formal@res@0 (|$1_BCS_serialize'address'| inline$$1_Signer_borrow_address$0$res@1))) (and (=> (= (ControlFlow 0 1328101) 1328489) anon14_Then_correct) (=> (= (ControlFlow 0 1328101) 1328166) anon14_Else_correct)))))
(let ((anon13_Then_correct true))
(let ((inline$$1_Signer_borrow_address$0$anon0_correct  (=> (= inline$$1_Signer_borrow_address$0$res@1 (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 1328087) 1328503) anon13_Then_correct) (=> (= (ControlFlow 0 1328087) 1328101) anon13_Else_correct)))))
(let ((anon0$1_correct  (=> (|$IsValid'address'| (|$addr#$signer| _$t0)) (=> (and (|$IsValid'vec'u8''| _$t1) (= _$t0 _$t0)) (=> (and (and (= _$t1 _$t1) (= _$t1 _$t1)) (and (= $t5@0 ($Mutation_449654 ($Local 4) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) _$t1)) (= (ControlFlow 0 1328093) 1328087))) inline$$1_Signer_borrow_address$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1327999) 1328093)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (|l#Vec_37831| (|p#$Mutation_449654| $t5)) 0) (= (ControlFlow 0 1328009) 1327999)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 2068020) 1328009) anon0_correct)))
