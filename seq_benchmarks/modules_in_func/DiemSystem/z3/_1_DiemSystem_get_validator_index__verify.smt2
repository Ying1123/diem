...
(assert (not
 (=> (= (ControlFlow 0 0) 873354) (let ((L9_correct  (=> (= (ControlFlow 0 547205) (- 0 874240)) false)))
(let ((anon22_Then_correct  (=> $abort_flag@1 (=> (and (= $abort_code@2 $abort_code@2) (= (ControlFlow 0 547195) 547205)) L9_correct))))
(let ((anon20_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 547271) 547205)) L9_correct))))
(let ((anon22_Else_correct  (=> (and (not $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 547181) (- 0 874194)) (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (=> (= (ControlFlow 0 547181) (- 0 874201)) (let (($range_0 ($Range 0 inline$$AddU64$0$dst@2)))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((j@@14 $i_1))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@14)) _$t1))))
 :qid |DiemSystembpl.20173:49|
 :skolemid |621|
)))))))))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 547112) 547195) anon22_Then_correct) (=> (= (ControlFlow 0 547112) 547181) anon22_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t8@0 1) $MAX_U64) (= (ControlFlow 0 547110) 547112)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t8@0 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t8@0 1)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 547058) 547195) anon22_Then_correct) (=> (= (ControlFlow 0 547058) 547181) anon22_Else_correct))))))
(let ((anon21_Else_correct  (=> (and (not $t12@1) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 547118) 547110) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 547118) 547058) inline$$AddU64$0$anon3_Else_correct)))))
(let ((L8_correct  (and (=> (= (ControlFlow 0 546782) (- 0 873970)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 546782) (- 0 873977)) (=> (let (($range_0@@0 ($Range 0 $t5)))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@62 $i_1@@0))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 i@@62)) _$t1))))
 :qid |DiemSystembpl.20192:49|
 :skolemid |622|
))) (= (seq.len (|$vec#$1_Option_Option'u64'| $t16@0)) 0))) (=> (=> (let (($range_0@@1 ($Range 0 $t5)))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@63 $i_1@@1))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 i@@63)) _$t1))))
 :qid |DiemSystembpl.20192:49|
 :skolemid |622|
))) (= (seq.len (|$vec#$1_Option_Option'u64'| $t16@0)) 0)) (and (=> (= (ControlFlow 0 546782) (- 0 874020)) (=> (let (($range_0@@2 ($Range 0 $t5)))
(exists (($i_1@@2 Int) ) (!  (and ($InRange $range_0@@2 $i_1@@2) (let ((i@@64 $i_1@@2))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 i@@64)) _$t1)))
 :qid |DiemSystembpl.20198:49|
 :skolemid |623|
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 i@@65)) _$t1)))
 :qid |DiemSystembpl.20198:49|
 :skolemid |623|
))) (and (not (= (seq.len (|$vec#$1_Option_Option'u64'| $t16@0)) 0)) (let ((at@@0 (seq.nth (|$vec#$1_Option_Option'u64'| $t16@0) 0)))
(= at@@0 ($choice_0 _$t0 _$t1))))) (=> (= (ControlFlow 0 546782) (- 0 874076)) (= (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@0)))) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@1))))))))))))))
(let ((anon21_Then_correct  (=> $t12@1 (and (=> (= (ControlFlow 0 547257) (- 0 873913)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 $t8@0)) _$t1)) (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 $t8@0)) _$t1) (=> (and (|$IsValid'$1_Option_Option'u64''| $t15) (<= (seq.len (|$vec#$1_Option_Option'u64'| $t15)) 1)) (=> (and (and (= $t15 (|$1_Option_Option'u64'| (seq.unit $t8@0))) (= $t15 $t15)) (and (= $t16@0 $t15) (= (ControlFlow 0 547257) 546782))) L8_correct)))))))
(let ((anon20_Else_correct  (=> (and (and (not $abort_flag@0) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (and (= $t11@1 (|$addr#$1_DiemSystem_ValidatorInfo| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (= $t12@1 (= $t11@1 _$t1)))) (and (=> (= (ControlFlow 0 546953) 547257) anon21_Then_correct) (=> (= (ControlFlow 0 546953) 547118) anon21_Else_correct)))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@0|)) (and (=> (= (ControlFlow 0 546921) 547271) anon20_Then_correct) (=> (= (ControlFlow 0 546921) 546953) anon20_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|  (=> (and (not (and (>= $t8@0 0) (< $t8@0 (seq.len _$t0)))) (= (ControlFlow 0 546919) 546921)) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|  (=> (and (>= $t8@0 0) (< $t8@0 (seq.len _$t0))) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1| (seq.nth _$t0 $t8@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1|))) (and (=> (= (ControlFlow 0 546869) 547271) anon20_Then_correct) (=> (= (ControlFlow 0 546869) 546953) anon20_Else_correct))))))
(let ((anon19_Then_correct  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 546927) 546919) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 546927) 546869) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|)))))
(let ((anon19_Else_correct  (=> (not inline$$Lt$0$dst@1) (and (=> (= (ControlFlow 0 546654) (- 0 873722)) (= $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (= $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (and (=> (= (ControlFlow 0 546654) (- 0 873729)) (let (($range_0@@4 ($Range 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((j@@15 $i_1@@4))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@15)) _$t1))))
 :qid |DiemSystembpl.20137:48|
 :skolemid |620|
)))) (=> (let (($range_0@@5 ($Range 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((j@@16 $i_1@@5))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@16)) _$t1))))
 :qid |DiemSystembpl.20137:48|
 :skolemid |620|
))) (=> (and (|$IsValid'$1_Option_Option'u64''| $t17) (<= (seq.len (|$vec#$1_Option_Option'u64'| $t17)) 1)) (=> (and (and (= $t17 (|$1_Option_Option'u64'| (as seq.empty (Seq Int)))) (= $t17 $t17)) (and (= $t16@0 $t17) (= (ControlFlow 0 546654) 546782))) L8_correct)))))))))
(let ((anon18_Else$1_correct  (and (=> (= (ControlFlow 0 546569) 546927) anon19_Then_correct) (=> (= (ControlFlow 0 546569) 546654) anon19_Else_correct))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (= (ControlFlow 0 546559) 546569)) anon18_Else$1_correct)))
(let ((anon18_Else_correct  (=> (and (and (not false) (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (and (|$IsValid'u64'| 0) (= 0 0))) (and (=> (= (ControlFlow 0 546565) (- 0 873560)) (<= 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (<= 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (and (=> (= (ControlFlow 0 546565) (- 0 873567)) (let (($range_0@@6 ($Range 0 0)))
(forall (($i_1@@6 Int) ) (!  (=> ($InRange $range_0@@6 $i_1@@6) (let ((j@@17 $i_1@@6))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@17)) _$t1))))
 :qid |DiemSystembpl.19984:48|
 :skolemid |618|
)))) (=> (let (($range_0@@7 ($Range 0 0)))
(forall (($i_1@@7 Int) ) (!  (=> ($InRange $range_0@@7 $i_1@@7) (let ((j@@18 $i_1@@7))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@18)) _$t1))))
 :qid |DiemSystembpl.19984:48|
 :skolemid |618|
...
(forall (($i_1@@8 Int) ) (!  (=> ($InRange $range_0@@8 $i_1@@8) (let ((j@@19 $i_1@@8))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0 j@@19)) _$t1))))
 :qid |DiemSystembpl.20024:53|
 :skolemid |619|
))) (= (ControlFlow 0 546565) 546559)))) inline$$Lt$0$anon0_correct)))))))))
(let ((anon18_Then_correct true))
(let ((|inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| (seq.len _$t0)) (and (=> (= (ControlFlow 0 546355) 547285) anon18_Then_correct) (=> (= (ControlFlow 0 546355) 546565) anon18_Else_correct)))))
(let ((anon0$1_correct  (=> (and (|$IsValid'vec'$1_DiemSystem_ValidatorInfo''| _$t0) (|$IsValid'address'| _$t1)) (=> (and (and (= $t5 (seq.len _$t0)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= (ControlFlow 0 546361) 546355))) |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_200533_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemSystembpl.3452:13|
 :skolemid |94|
))) (= (ControlFlow 0 546275) 546361)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 873354) 546275) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))
))
(check-sat)
