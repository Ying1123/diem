...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 400439) (let ((L11_correct  (=> (= $t3@0 $t3@0) (and (=> (= (ControlFlow 0 292631) (- 0 400783)) (not false)) (=> (not false) (=> (= (ControlFlow 0 292631) (- 0 400790)) (= $t3@0  (and (and (and (= (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0) $MAX_U64) (= (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0) $MAX_U64)) (= (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| _$t0) $MAX_U64)) (= (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t0) 86400000000)))))))))
(let ((anon12_Else_correct  (=> (and (and (not $t2@0) (= false false)) (and (= $t3@0 false) (= (ControlFlow 0 292603) 292631))) L11_correct)))
(let ((anon12_Then_correct  (=> $t2@0 (=> (and (= $t15@0 (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t0)) (|$IsValid'u64'| 86400000000)) (=> (and (and (= $t17@0 (= $t15@0 86400000000)) (= $t17@0 $t17@0)) (and (= $t3@0 $t17@0) (= (ControlFlow 0 292661) 292631))) L11_correct)))))
(let ((anon11_Else_correct  (=> (not $t1@0) (=> (and (= false false) (= $t2@0 false)) (and (=> (= (ControlFlow 0 292581) 292661) anon12_Then_correct) (=> (= (ControlFlow 0 292581) 292603) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and $t1@0 (= $t11@0 (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| _$t0))) (=> (and (and (|$IsValid'u64'| 18446744073709551615) (= $t13@0 (= $t11@0 18446744073709551615))) (and (= $t13@0 $t13@0) (= $t2@0 $t13@0))) (and (=> (= (ControlFlow 0 292691) 292661) anon12_Then_correct) (=> (= (ControlFlow 0 292691) 292603) anon12_Else_correct))))))
(let ((anon10_Else_correct  (=> (not $t6@0) (=> (and (= false false) (= $t1@0 false)) (and (=> (= (ControlFlow 0 292559) 292691) anon11_Then_correct) (=> (= (ControlFlow 0 292559) 292581) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and $t6@0 (= $t7@0 (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0))) (=> (and (and (|$IsValid'u64'| 18446744073709551615) (= $t9@0 (= $t7@0 18446744073709551615))) (and (= $t9@0 $t9@0) (= $t1@0 $t9@0))) (and (=> (= (ControlFlow 0 292721) 292691) anon11_Then_correct) (=> (= (ControlFlow 0 292721) 292581) anon11_Else_correct))))))
(let ((anon0$1_correct  (=> (and (|$IsValid'$1_AccountLimits_LimitsDefinition'#0''| _$t0) (and (and (and (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0) 0) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0) 0)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t0) 0)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| _$t0) 0))) (=> (and (and (= _$t0 _$t0) (= $t4@0 (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0))) (and (|$IsValid'u64'| 18446744073709551615) (= $t6@0 (= $t4@0 18446744073709551615)))) (and (=> (= (ControlFlow 0 292539) 292721) anon10_Then_correct) (=> (= (ControlFlow 0 292539) 292559) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_111298_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 292455) 292539)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 400439) 292455) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))
))
(check-sat)
(pop 1)
