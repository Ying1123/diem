...
(assert (forall ((k1 (Seq Int)) (k2 (Seq Int)) ) (!  (=> (= k1 k2) (= ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2)))
 :qid |loopswithmemoryopsandybpl.1019:15|
 :skolemid |27|
 :pattern ( ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2))
)))
(assert (forall ((s1 (Seq Int)) (s2 (Seq Int)) (k1@@0 (Seq Int)) (k2@@0 (Seq Int)) (m1 (Seq Int)) (m2 (Seq Int)) ) (!  (=> (and (and (= s1 s2) (= k1@@0 k2@@0)) (= m1 m2)) (= ($1_Signature_$ed25519_verify s1 k1@@0 m1) ($1_Signature_$ed25519_verify s2 k2@@0 m2)))
 :qid |loopswithmemoryopsandybpl.1022:15|
 :skolemid |28|
...
(= (seq.nth (|v#$Mutation_11017| $t0@1) n) (seq.nth (|v#$Mutation_11017| $t1@1) n))))
 :qid |loopswithmemoryopsandybpl.1589:48|
 :skolemid |32|
))))))))))))))
...
(= (seq.nth (|v#$Mutation_11017| $t0@0) m) (seq.nth (|v#$Mutation_11017| $t1@0) m))))
 :qid |loopswithmemoryopsandybpl.1535:48|
 :skolemid |31|
...
(= (seq.nth (|v#$Mutation_11017| _$t0) n@@0) (seq.nth (|v#$Mutation_11017| _$t1) n@@0))))
 :qid |loopswithmemoryopsandybpl.1188:48|
 :skolemid |29|
...
(= (seq.nth (|v#$Mutation_11017| $t0@0) n@@1) (seq.nth (|v#$Mutation_11017| $t1@0) n@@1))))
 :qid |loopswithmemoryopsandybpl.1278:53|
 :skolemid |30|
