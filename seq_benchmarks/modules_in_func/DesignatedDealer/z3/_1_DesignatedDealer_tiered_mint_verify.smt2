...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 298754) (let ((anon40_Else_correct  (=> (not $abort_flag@4) (=> (and (= |inline$$1_Diem_mint'#0'$0$$ret0@1| |inline$$1_Diem_mint'#0'$0$$ret0@1|) (= $t37 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816))) (and (=> (= (ControlFlow 0 224150) (- 0 301186)) (not (= _$t1 0))) (=> (not (= _$t1 0)) (and (=> (= (ControlFlow 0 224150) (- 0 301196)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_132610| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_132610| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 224150) (- 0 301209)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119905| $1_Roles_RoleId_$memory) $t9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119905| $1_Roles_RoleId_$memory) $t9))) (and (=> (= (ControlFlow 0 224150) (- 0 301221)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119905| $1_Roles_RoleId_$memory) $t9)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119905| $1_Roles_RoleId_$memory) $t9)) 1))) (and (=> (= (ControlFlow 0 224150) (- 0 301239)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 224150) (- 0 301253)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t2))) (and (=> (= (ControlFlow 0 224150) (- 0 301264)) (not (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (not (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 224150) (- 0 301276)) (not (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128))) (=> (not (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128)) (and (=> (= (ControlFlow 0 224150) (- 0 301293)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 224150) (- 0 301303)) (|Select__T@[Int]Bool_| (|domain#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816) (and (=> (= (ControlFlow 0 224150) (- 0 301311)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_151526| |$1_DesignatedDealer_TierInfo'#0'_$memory@2|) _$t2))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_151526| |$1_DesignatedDealer_TierInfo'#0'_$memory@2|) _$t2)) (and (=> (= (ControlFlow 0 224150) (- 0 301320)) (= (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_mint'#0'$0$$ret0@1|) _$t1)) (=> (= (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_mint'#0'$0$$ret0@1|) _$t1) (and (=> (= (ControlFlow 0 224150) (- 0 301329)) (= $t37 (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8)))) (=> (= $t37 (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))) (and (=> (= (ControlFlow 0 224150) (- 0 301347)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
...
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t12)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_87373_| (|streams#$EventStore| (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_87373_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
(let ((expected@@2 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t12)) (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_87373_| (|streams#$EventStore| (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_87373_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
(let ((expected@@3 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t12)) (let ((stream@@6 (|Select__T@[$1_Event_EventHandle]Multiset_87373_| (|streams#$EventStore| (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_87373_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
(let ((L8_correct  (and (=> (= (ControlFlow 0 222412) (- 0 300916)) (or (or (or (or (or (or (or (or (= _$t1 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_132610| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_119905| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119905| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t2))) (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (or (or (or (or (or (or (= _$t1 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_132610| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_119905| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119905| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t2))) (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 222412) (- 0 301004)) (or (or (or (or (or (or (or (or (and (= _$t1 0) (= 7 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_132610| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119905| $1_Roles_RoleId_$memory) $t9)) (= 5 $t17@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119905| $1_Roles_RoleId_$memory) $t9)) 1)) (= 3 $t17@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t2)) (= 5 $t17@0))) (and (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= 1 $t17@0))) (and (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128) (= 8 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17@0))))))))
(let ((anon35_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 224336) 222412))) L8_correct)))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t17@0 $abort_code@5) (= (ControlFlow 0 224164) 222412))) L8_correct)))
(let ((|inline$$1_Diem_mint'#0'$0$anon13_correct|  (=> (and (and (and (and (|$IsValid'$1_Diem_Diem'#0''| |inline$$1_Diem_mint'#0'$0$$t16@0|) (= |inline$$1_Diem_mint'#0'$0$$t18@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816))) (and (and (= |inline$$1_Diem_mint'#0'$0$$t18@0| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))) (= (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_mint'#0'$0$$t16@0|) _$t1)) (and (= |inline$$1_Diem_mint'#0'$0$$t19@0| |inline$$1_Diem_mint'#0'$0$$t15@0|) (= |inline$$1_Diem_mint'#0'$0$$t20@0| |inline$$1_Diem_mint'#0'$0$$t14@0|)))) (and (and (and (= |inline$$1_Diem_mint'#0'$0$$t21@0|  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t13@0|))) (= $es@1 (ite |inline$$1_Diem_mint'#0'$0$$t21@0| (let ((stream@@8 (|Select__T@[$1_Event_EventHandle]Multiset_87373_| (|streams#$EventStore| $es@0) |inline$$1_Diem_mint'#0'$0$$t20@0|)))
(let ((stream_new@@7 (let ((len@@7 (|l#Multiset_87373| stream@@8)))
(let ((cnt@@7 (|Select__T@[$EventRep]Int_| (|v#Multiset_87373| stream@@8) (|$ToEventRep'$1_Diem_MintEvent'| |inline$$1_Diem_mint'#0'$0$$t19@0|))))
(Multiset_87373 (|Store__T@[$EventRep]Int_| (|v#Multiset_87373| stream@@8) (|$ToEventRep'$1_Diem_MintEvent'| |inline$$1_Diem_mint'#0'$0$$t19@0|) (+ cnt@@7 1)) (+ len@@7 1))))))
($EventStore (+ (|counter#$EventStore| $es@0) 1) (|Store__T@[$1_Event_EventHandle]Multiset_87373_| (|streams#$EventStore| $es@0) |inline$$1_Diem_mint'#0'$0$$t20@0| stream_new@@7)))) $es@0))) (and (= |inline$$1_Diem_mint'#0'$0$$t16@0| |inline$$1_Diem_mint'#0'$0$$t16@0|) (= $abort_code@5 $abort_code@4))) (and (and (= $es@2 $es@1) (= $abort_flag@4 $abort_flag@3)) (and (= |inline$$1_Diem_mint'#0'$0$$ret0@1| |inline$$1_Diem_mint'#0'$0$$t16@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@3| |$1_Diem_CurrencyInfo'#0'_$memory@2|))))) (and (=> (= (ControlFlow 0 223694) 224164) anon40_Then_correct) (=> (= (ControlFlow 0 223694) 224150) anon40_Else_correct)))))
...
(let ((anon39_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 224178) 222412))) L8_correct)))
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_87373_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DesignatedDealer_ReceivedMintEvent'$0$handle@1| stream_new@@8)))))) (and (=> (= (ControlFlow 0 222651) 224178) anon39_Then_correct) (=> (= (ControlFlow 0 222651) 223846) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (not $t33) (=> (and (and (|$IsValid'vec'u8''| $t32) (= $t32 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t34@0 ($1_DesignatedDealer_ReceivedMintEvent $t32 _$t2 _$t1)) (= (ControlFlow 0 222657) 222651))) |inline$$1_Event_emit_event'$1_DesignatedDealer_ReceivedMintEvent'$0$anon0_correct|))))
(let ((anon38_Then_correct  (=> $t33 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17)) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 224204) 222412))) L8_correct))))
(let ((anon37_Else_correct  (=> (not $abort_flag@2) (=> (and (= $t31@0 ($Mutation_113195 (|l#$Mutation_174559| $t30@1) (seq.++ (|p#$Mutation_174559| $t30@1) (seq.unit 0)) (|$mint_event_handle#$1_DesignatedDealer_Dealer| (|v#$Mutation_174559| $t30@1)))) (= $t33  (not (|Select__T@[Int]Bool_| (|domain#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 222552) 224204) anon38_Then_correct) (=> (= (ControlFlow 0 222552) 222657) anon38_Else_correct))))))
(let ((anon37_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 224218) 222412))) L8_correct)))
(let ((anon36_Then$1_correct  (=> (= $t30@1 $t30) (=> (and (= $abort_flag@2 true) (= $abort_code@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 224270) 224218) anon37_Then_correct) (=> (= (ControlFlow 0 224270) 222552) anon37_Else_correct))))))
(let ((anon36_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t2)) (= (ControlFlow 0 224268) 224270)) anon36_Then$1_correct)))
(let ((anon36_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t2) (=> (and (and (= $t30@0 ($Mutation_174559 ($Global _$t2) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t2))) (= $t30@1 $t30@0)) (and (= $abort_flag@2 $abort_flag@1) (= $abort_code@3 $abort_code@2))) (and (=> (= (ControlFlow 0 222520) 224218) anon37_Then_correct) (=> (= (ControlFlow 0 222520) 222552) anon37_Else_correct))))))
(let ((L6_correct  (and (=> (= (ControlFlow 0 222498) (- 0 300031)) (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies _$t2)) (=> (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies _$t2) (and (=> (= (ControlFlow 0 222498) 224268) anon36_Then_correct) (=> (= (ControlFlow 0 222498) 222520) anon36_Else_correct))))))
(let ((anon35_Else_correct  (=> (and (and (and (not $abort_flag@0) (= $t27@0 (|$window_start#$1_DesignatedDealer_TierInfo'#0'| $t26))) (and (= $t28@0 (|$window_inflow#$1_DesignatedDealer_TierInfo'#0'| $t26)) (= $t29@0 (|$tiers#$1_DesignatedDealer_TierInfo'#0'| $t26)))) (and (and (= $abort_flag@1 $abort_flag@0) (= |$1_DesignatedDealer_TierInfo'#0'_$memory@2| |$1_DesignatedDealer_TierInfo'#0'_$memory@1|)) (and (= $abort_code@2 $abort_code@1) (= (ControlFlow 0 224322) 222498)))) L6_correct)))
(let ((anon34_Then$1_correct  (=> (= |$1_DesignatedDealer_TierInfo'#0'_$memory@1| |$1_DesignatedDealer_TierInfo'#0'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 224388) 224336) anon35_Then_correct) (=> (= (ControlFlow 0 224388) 224322) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_151526| |$1_DesignatedDealer_TierInfo'#0'_$memory|) _$t2)) (= (ControlFlow 0 224386) 224388)) anon34_Then$1_correct)))
(let ((anon34_Else_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_151526| |$1_DesignatedDealer_TierInfo'#0'_$memory|) _$t2) (= $t26@0 (|Select__T@[Int]$1_DesignatedDealer_TierInfo'#0'_| (|contents#$Memory_151526| |$1_DesignatedDealer_TierInfo'#0'_$memory|) _$t2))) (=> (and (and (= |$1_DesignatedDealer_TierInfo'#0'_$memory@0| ($Memory_151526 (|Store__T@[Int]Bool_| (|domain#$Memory_151526| |$1_DesignatedDealer_TierInfo'#0'_$memory|) _$t2 false) (|contents#$Memory_151526| |$1_DesignatedDealer_TierInfo'#0'_$memory|))) (= |$1_DesignatedDealer_TierInfo'#0'_$memory@1| |$1_DesignatedDealer_TierInfo'#0'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 224300) 224336) anon35_Then_correct) (=> (= (ControlFlow 0 224300) 224322) anon35_Else_correct))))))
(let ((anon33_Then_correct  (=> $t25@0 (and (=> (= (ControlFlow 0 224280) (- 0 299876)) (|Select__T@[Int]Bool_| |$1_DesignatedDealer_TierInfo'#0'_$modifies| _$t2)) (=> (|Select__T@[Int]Bool_| |$1_DesignatedDealer_TierInfo'#0'_$modifies| _$t2) (and (=> (= (ControlFlow 0 224280) 224386) anon34_Then_correct) (=> (= (ControlFlow 0 224280) 224300) anon34_Else_correct)))))))
(let ((anon33_Else_correct  (=> (not $t25@0) (=> (and (and (= $abort_flag@1 false) (= |$1_DesignatedDealer_TierInfo'#0'_$memory@2| |$1_DesignatedDealer_TierInfo'#0'_$memory|)) (and (= $abort_code@2 $abort_code@0) (= (ControlFlow 0 222490) 222498))) L6_correct))))
(let ((anon32_Then_correct  (=> (and $t22 (= $t25@0 (|Select__T@[Int]Bool_| (|domain#$Memory_151526| |$1_DesignatedDealer_TierInfo'#0'_$memory|) _$t2))) (and (=> (= (ControlFlow 0 222484) 224280) anon33_Then_correct) (=> (= (ControlFlow 0 222484) 222490) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (and (not $t22) (= $t24 $t24)) (and (= $t17@0 $t24) (= (ControlFlow 0 222474) 222412))) L8_correct)))
(let ((anon31_Then_correct  (=> inline$$Gt$0$dst@1 (=> (and (= $t22 (|Select__T@[Int]Bool_| (|domain#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t2)) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t24) (= $t24 5)) (and (= $t24 $t24) (= $t22 $t22))) (and (=> (= (ControlFlow 0 222458) 222484) anon32_Then_correct) (=> (= (ControlFlow 0 222458) 222474) anon32_Else_correct)))))))
(let ((anon31_Else_correct  (=> (and (and (not inline$$Gt$0$dst@1) (= $t21 $t21)) (and (= $t17@0 $t21) (= (ControlFlow 0 222132) 222412))) L8_correct)))
(let ((anon30_Else$1_correct  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| $t21) (= $t21 7)) (and (= $t21 $t21) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 222116) 222458) anon31_Then_correct) (=> (= (ControlFlow 0 222116) 222132) anon31_Else_correct))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> _$t1 0)) (= (ControlFlow 0 222080) 222116)) anon30_Else$1_correct)))
(let ((anon30_Else_correct  (=> (not $t16) (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 222086) 222080)) inline$$Gt$0$anon0_correct))))
(let ((anon30_Then_correct  (=> $t16 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119905| $1_Roles_RoleId_$memory) $t15)) (= 5 $t17)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119905| $1_Roles_RoleId_$memory) $t15)) 1)) (= 3 $t17))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t17))) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 224460) 222412))) L8_correct))))
...
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Diem_MintCapability'#0'_| (|contents#$Memory_132610| |$1_Diem_MintCapability'#0'_$memory|) $a_0@@1)))
(|$IsValid'$1_Diem_MintCapability'#0''| $rsc@@1))
 :qid |DesignatedDealerbpl.14596:20|
 :skolemid |382|
 :pattern ( (|Select__T@[Int]$1_Diem_MintCapability'#0'_| (|contents#$Memory_132610| |$1_Diem_MintCapability'#0'_$memory|) $a_0@@1))
...
)) (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DesignatedDealer_TierInfo'#0'_| (|contents#$Memory_151526| |$1_DesignatedDealer_TierInfo'#0'_$memory|) $a_0@@3)))
(|$IsValid'$1_DesignatedDealer_TierInfo'#0''| $rsc@@3))
 :qid |DesignatedDealerbpl.14604:20|
 :skolemid |384|
 :pattern ( (|Select__T@[Int]$1_DesignatedDealer_TierInfo'#0'_| (|contents#$Memory_151526| |$1_DesignatedDealer_TierInfo'#0'_$memory|) $a_0@@3))
)))))) (and (and (and (and (= $t8 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t9 (|$addr#$signer| _$t0))) (and (= $t10 (|$mint_event_handle#$1_DesignatedDealer_Dealer| (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t2))) (= $t11 ($1_DesignatedDealer_ReceivedMintEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t2 _$t1)))) (and (and (= $t12 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_127208| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t13 (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t12))) (and (= $t14 ($1_Diem_MintEvent _$t1 (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t12))) (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies _$t2)))) (and (and (and (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (|Select__T@[Int]Bool_| |$1_DesignatedDealer_TierInfo'#0'_$modifies| _$t2)) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= $t15 (|$addr#$signer| _$t0)) (= $t16  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_119905| $1_Roles_RoleId_$memory) $t15)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119905| $1_Roles_RoleId_$memory) $t15)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))))) (and (=> (= (ControlFlow 0 222026) 224460) anon30_Then_correct) (=> (= (ControlFlow 0 222026) 222086) anon30_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@6 T@$1_Event_EventHandle) ) (! (let ((stream@@10 (|Select__T@[$1_Event_EventHandle]Multiset_87373_| (|streams#$EventStore| $es) handle@@6)))
 ...
 :qid |DesignatedDealerbpl.2908:13|
 :skolemid |79|
))) (= (ControlFlow 0 221308) 222026)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (seq.len (|p#$Mutation_174559| $t30)) 0) (=> (and (= (seq.len (|p#$Mutation_113195| $t31)) 0) (= (ControlFlow 0 221318) 221308)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 298754) 221318) anon0_correct)))
