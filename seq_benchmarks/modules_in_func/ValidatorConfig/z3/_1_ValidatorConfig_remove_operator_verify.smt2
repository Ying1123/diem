...
(declare-fun $t14 () T@$Mutation_63302)
(declare-fun $t9 () Int)
...
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0)) 0)) a@@2)))
 ...
 :qid |ValidatorConfigbpl.5118:15|
 :skolemid |202|
)) (and (=> (= (ControlFlow 0 84666) (- 0 96827)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_53807| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_53807| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 84666) (- 0 96839)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53807| $1_Roles_RoleId_$memory) $t5)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53807| $1_Roles_RoleId_$memory) $t5)) 3))) (and (=> (= (ControlFlow 0 84666) (- 0 96857)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) $t4))) (and (=> (= (ControlFlow 0 84666) (- 0 96869)) (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory@0) (|$addr#$signer| _$t0))))) 0)))) (=> (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory@0) (|$addr#$signer| _$t0))))) 0))) (=> (= (ControlFlow 0 84666) (- 0 96880)) (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (not (= addr@@21 $t4)) (= (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@21)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@21)))))
 :qid |ValidatorConfigbpl.5147:15|
 :skolemid |203|
)))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 84102) (- 0 96306)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53807| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53807| $1_Roles_RoleId_$memory) $t5)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53807| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53807| $1_Roles_RoleId_$memory) $t5)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) $t4))) (=> (= (ControlFlow 0 84102) (- 0 96337)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_53807| $1_Roles_RoleId_$memory) $t5)) (= 5 $t8@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53807| $1_Roles_RoleId_$memory) $t5)) 3)) (= 3 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)) (= 5 $t8@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 84680) 84102))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $t14@1 $t14) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 84732) 84680) anon18_Then_correct) (=> (= (ControlFlow 0 84732) 84666) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) $t9)) (= (ControlFlow 0 84730) 84732)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) $t9) (=> (and (and (= $t14@0 ($Mutation_63302 ($Global $t9) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) $t9))) (= $t14@1 $t14@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 84150) 84680) anon18_Then_correct) (=> (= (ControlFlow 0 84150) 84666) anon18_Else_correct))))))
(let ((anon16_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (=> (and (and (|$IsValid'$1_Option_Option'address''| $t13) (<= (seq.len (|$vec#$1_Option_Option'address'| $t13)) 1)) (= $t13 (|$1_Option_Option'address'| (as seq.empty (Seq Int))))) (and (=> (= (ControlFlow 0 84128) 84730) anon17_Then_correct) (=> (= (ControlFlow 0 84128) 84150) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= $t12 $t12)) (and (= $t8@0 $t12) (= (ControlFlow 0 84002) 84102))) L3_correct)))
(let ((anon15_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 5)) (and (= $t12 $t12) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 83986) 84128) anon16_Then_correct) (=> (= (ControlFlow 0 83986) 84002) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_53807| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53807| $1_Roles_RoleId_$memory) $t6)) 3)) (= 3 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 84798) 84102))) L3_correct))))
(let ((anon15_Then_correct true))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= $t9 $t9) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) $t9)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 83944) 84746) anon15_Then_correct) (=> (= (ControlFlow 0 83944) 83986) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (not $t7) (=> (and (and (|$IsValid'address'| $t9) (= $t9 (|$addr#$signer| _$t0))) (and (= $t9 $t9) (= (ControlFlow 0 83950) 83944))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_63396| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@36)))) i1)))) 3))))
 ...
 :skolemid |191|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53807| $1_Roles_RoleId_$memory) $a_0)))
...
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54180| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@0)))
...
)) (= $t4 (|$addr#$signer| _$t0)))) (and (and (= $t5 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= $t6 (|$addr#$signer| _$t0)) (= $t7  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53807| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53807| $1_Roles_RoleId_$memory) $t6)) 3))))))) (and (=> (= (ControlFlow 0 83819) 84798) anon14_Then_correct) (=> (= (ControlFlow 0 83819) 83950) anon14_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_33654_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 82963) 83819)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (seq.len (|p#$Mutation_63302| $t14)) 0) (=> (and (= (seq.len (|p#$Mutation_63342| $t15)) 0) (= (ControlFlow 0 82973) 82963)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 95062) 82973) anon0_correct)))
