...
(assert (not
 (=> (= (ControlFlow 0 0) 269912) (let ((anon0$1_correct@@11  (=> (and (and (|$IsValid'$1_ValidatorConfig_Config'| _$t0@@11) (= _$t0@@11 _$t0@@11)) (and (= $t1@0@@0 (|$consensus_pubkey#$1_ValidatorConfig_Config| _$t0@@11)) (= $t1@0@@0 $t1@0@@0))) (and (=> (= (ControlFlow 0 197792) (- 0 269980)) (not false)) (=> (not false) (=> (= (ControlFlow 0 197792) (- 0 269987)) (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@3) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@3))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@3))))))
 :qid |ValidatorConfigbpl.7167:15|
 :skolemid |223|
))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@11  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@13 T@$1_Event_EventHandle) ) (! (let ((stream@@12 (|Select__T@[$1_Event_EventHandle]Multiset_77784_| (|streams#$EventStore| $es) handle@@13)))
 (and (= (|l#Multiset_77784| stream@@12) 0) (forall ((v@@56 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_77784| stream@@12) v@@56) 0)
 :qid |ValidatorConfigbpl.159:13|
 :skolemid |4|
))))
 :qid |ValidatorConfigbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 197709) 197792)) anon0$1_correct@@11)))
(let ((anon0_correct@@11  (=> (= (ControlFlow 0 269912) 197709) inline$$InitEventStore$0$anon0_correct@@11)))
anon0_correct@@11))))
))
(check-sat)
(pop 1)
