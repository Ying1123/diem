...
L5:
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/XUS.move:56:9+69
    assume {:print "$at(39,2293,2362)"} true;
    assert {:msg "assert_failed(39,2293,2362): global memory invariant does not hold"}
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/XUS.move:61:9+112
    assume {:print "$at(39,2639,2751)"} true;
    assert {:msg "assert_failed(39,2639,2751): global memory invariant does not hold"}
...
L7:
    ...
    // @172 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@172](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
...
procedure {:timeLimit 40} $1_XUS_initialize$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(39,439,1034)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));
    ...
    // @214 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/XUS.move:13:5+1
    assume {:print "$at(39,439,440)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @210 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/XUS.move:13:5+1
    $1_Roles_RoleId_$memory#210 := $1_Roles_RoleId_$memory;

    // @215 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/XUS.move:13:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#215 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @212 := save_mem(DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/XUS.move:13:5+1
    ...
    // @213 := save_mem(DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/XUS.move:13:5+1
    ...
    // @216 := save_mem(Diem::BurnCapability<XUS::XUS>) at /home/ying/diem/language/diem-framework/modules/XUS.move:13:5+1
    $1_Diem_BurnCapability'$1_XUS_XUS'_$memory#216 := $1_Diem_BurnCapability'$1_XUS_XUS'_$memory;

    // @211 := save_mem(Diem::CurrencyInfo<XUS::XUS>) at /home/ying/diem/language/diem-framework/modules/XUS.move:13:5+1
    $1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#211 := $1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory;

    // @209 := save_mem(Diem::MintCapability<XUS::XUS>) at /home/ying/diem/language/diem-framework/modules/XUS.move:13:5+1
    $1_Diem_MintCapability'$1_XUS_XUS'_$memory#209 := $1_Diem_MintCapability'$1_XUS_XUS'_$memory;

    // @217 := save_mem(AccountLimits::LimitsDefinition<XUS::XUS>) at /home/ying/diem/language/diem-framework/modules/XUS.move:13:5+1
...
L1:
    ...
    // assert Not(exists[@209]<Diem::MintCapability<XUS::XUS>>(Signer::spec_address_of[]($t1))) at /home/ying/diem/language/diem-framework/modules/Diem.move:1339:9+111
    ...
    // assert Not(Not(exists[@210]<Roles::RoleId>($t2))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t2)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    ...
    // assert Not(exists[@211]<Diem::CurrencyInfo<XUS::XUS>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/Diem.move:1281:9+121
    ...
    // assert Not(Not(exists[@210]<Roles::RoleId>($t3))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t3)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    ...
    // assert Not(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@212]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 85, 83])) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:70:9+154
    ...
    // assert Not(Not(exists[@213]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:137:9+129
    ...
    // assert Not(Not(exists[@212]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:101:9+76
    assume {:print "$at(13,3859,3935)"} true;
    assert {:msg "assert_failed(13,3859,3935): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212, 173345816);
    ...
    // assert Not(exists[@216]<Diem::BurnCapability<XUS::XUS>>(Signer::spec_address_of[]($t1))) at /home/ying/diem/language/diem-framework/modules/Diem.move:284:9+111
    ...
    // assert Not(Not(exists[@210]<Roles::RoleId>($t6))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    assume {:print "$at(26,23933,23992)"} true;
    assert {:msg "assert_failed(26,23933,23992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#210, $t6);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t6)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    assume {:print "$at(26,24001,24098)"} true;
    assert {:msg "assert_failed(26,24001,24098): function does not abort under this condition"}
    ...
    // assert Not(exists[@217]<AccountLimits::LimitsDefinition<XUS::XUS>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:208:9+130
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@214]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:140:9+51
    ...
    // assert Not(Not(exists[@210]<Roles::RoleId>($t8))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    assume {:print "$at(26,23933,23992)"} true;
    assert {:msg "assert_failed(26,23933,23992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#210, $t8);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t8)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    assume {:print "$at(26,24001,24098)"} true;
    assert {:msg "assert_failed(26,24001,24098): function does not abort under this condition"}
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(exists[@209]<Diem::MintCapability<XUS::XUS>>(Signer::spec_address_of[]($t1)), Not(exists[@210]<Roles::RoleId>($t2))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t2)), 1)), Neq<address>(Signer::spec_address_of[]($t1), b1e55ed)), Or(Eq<u64>(1000000, 0), Gt(1000000, 10000000000))), exists[@211]<Diem::CurrencyInfo<XUS::XUS>>(Signer::spec_address_of[]($t0))), Not(exists[@210]<Roles::RoleId>($t3))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t3)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@212]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 85, 83])), Not(exists[@213]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))), Not(exists[@212]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(a550c18))), And(And(And(And(DiemTimestamp::$is_operating[@214](), DiemConfig::$reconfiguration_enabled[@215]()), Gt(DiemTimestamp::spec_now_microseconds[@214](), 0)), Lt(select DiemConfig::Configuration.epoch($t4), 18446744073709551615)), Lt($t5, select DiemConfig::Configuration.last_reconfiguration_time($t4)))), exists[@216]<Diem::BurnCapability<XUS::XUS>>(Signer::spec_address_of[]($t1))), Not(exists[@210]<Roles::RoleId>($t6))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t6)), 1)), Neq<address>(Signer::spec_address_of[]($t1), b1e55ed)), exists[@217]<AccountLimits::LimitsDefinition<XUS::XUS>>(Signer::spec_address_of[]($t0))), Not(DiemTimestamp::$is_genesis[@214]())), Not(exists[@210]<Roles::RoleId>($t7))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t7)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), Not(exists[@210]<Roles::RoleId>($t8))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t8)), 1)), Neq<address>(Signer::spec_address_of[]($t1), b1e55ed)) at /home/ying/diem/language/diem-framework/modules/XUS.move:30:5+981
    assume {:print "$at(39,1039,2020)"} true;
    assert {:msg "assert_failed(39,1039,2020): abort not covered by any of the `aborts_if` clauses"}
      ((((((((((((((((((((((((($ResourceExists($1_Diem_MintCapability'$1_XUS_XUS'_$memory#209, $1_Signer_spec_address_of($t1)) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t2)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t2)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453)) || ($IsEqual'num'(1000000, 0) || (1000000 > 10000000000))) || $ResourceExists($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#211, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t3)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t3)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || $ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212)), MakeVec3(88, 85, 83))) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#213, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212, 173345816)) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#215)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) > 0)) && ($epoch#$1_DiemConfig_Configuration($t4) < 18446744073709551615)) && ($t5 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t4)))) || $ResourceExists($1_Diem_BurnCapability'$1_XUS_XUS'_$memory#216, $1_Signer_spec_address_of($t1))) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t6)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t6)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453)) || $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory#217, $1_Signer_spec_address_of($t0))) || !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214)) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t7)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t7)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t8)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t8)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(And(exists[@209]<Diem::MintCapability<XUS::XUS>>(Signer::spec_address_of[]($t1)), Eq(6, $t10)), And(Not(exists[@210]<Roles::RoleId>($t2)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t2)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t1), b1e55ed), Eq(2, $t10))), And(Or(Eq<u64>(1000000, 0), Gt(1000000, 10000000000)), Eq(7, $t10))), And(exists[@211]<Diem::CurrencyInfo<XUS::XUS>>(Signer::spec_address_of[]($t0)), Eq(6, $t10))), And(Not(exists[@210]<Roles::RoleId>($t3)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t3)), 0), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t10))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t10))), And(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@212]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 85, 83]), Eq(7, $t10))), And(Not(exists[@213]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))), Eq(4, $t10))), And(Not(exists[@212]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(a550c18)), Eq(5, $t10))), And(And(And(And(And(DiemTimestamp::$is_operating[@214](), DiemConfig::$reconfiguration_enabled[@215]()), Gt(DiemTimestamp::spec_now_microseconds[@214](), 0)), Lt(select DiemConfig::Configuration.epoch($t4), 18446744073709551615)), Lt($t5, select DiemConfig::Configuration.last_reconfiguration_time($t4))), Eq(1, $t10))), And(exists[@216]<Diem::BurnCapability<XUS::XUS>>(Signer::spec_address_of[]($t1)), Eq(6, $t10))), And(Not(exists[@210]<Roles::RoleId>($t6)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t6)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t1), b1e55ed), Eq(2, $t10))), And(exists[@217]<AccountLimits::LimitsDefinition<XUS::XUS>>(Signer::spec_address_of[]($t0)), Eq(6, $t10))), And(Not(DiemTimestamp::$is_genesis[@214]()), Eq(1, $t10))), And(Not(exists[@210]<Roles::RoleId>($t7)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t7)), 0), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t10))), And(Not(exists[@210]<Roles::RoleId>($t8)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t8)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t1), b1e55ed), Eq(2, $t10))) at /home/ying/diem/language/diem-framework/modules/XUS.move:30:5+981
    assert {:msg "assert_failed(39,1039,2020): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((((((((((((((((((((($ResourceExists($1_Diem_MintCapability'$1_XUS_XUS'_$memory#209, $1_Signer_spec_address_of($t1)) && $IsEqual'num'(6, $t10)) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t2) && $IsEqual'num'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t2)), 1) && $IsEqual'num'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453) && $IsEqual'num'(2, $t10))) || (($IsEqual'num'(1000000, 0) || (1000000 > 10000000000)) && $IsEqual'num'(7, $t10))) || ($ResourceExists($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#211, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(6, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t3) && $IsEqual'num'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t3)), 0) && $IsEqual'num'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t10))) || ($ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212)), MakeVec3(88, 85, 83)) && $IsEqual'num'(7, $t10))) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#213, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(4, $t10))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212, 173345816) && $IsEqual'num'(5, $t10))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#215)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) > 0)) && ($epoch#$1_DiemConfig_Configuration($t4) < 18446744073709551615)) && ($t5 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t4))) && $IsEqual'num'(1, $t10))) || ($ResourceExists($1_Diem_BurnCapability'$1_XUS_XUS'_$memory#216, $1_Signer_spec_address_of($t1)) && $IsEqual'num'(6, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t6) && $IsEqual'num'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t6)), 1) && $IsEqual'num'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453) && $IsEqual'num'(2, $t10))) || ($ResourceExists($1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory#217, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(6, $t10))) || (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) && $IsEqual'num'(1, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t7) && $IsEqual'num'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t7)), 0) && $IsEqual'num'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t8) && $IsEqual'num'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t8)), 1) && $IsEqual'num'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 186537453) && $IsEqual'num'(2, $t10)));
...
L7:
    ...
    // @162 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@162](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
