...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |bubblesortcvc4bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |bubblesortcvc4bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |bubblesortcvc4bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |bubblesortcvc4bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |bubblesortcvc4bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |bubblesortcvc4bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |bubblesortcvc4bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |bubblesortcvc4bpl.461:15|
 :skolemid |14|
...
(assert (forall ((v@@4 (Seq Int)) ) (! (= (|$IsValid'vec'u64''| v@@4)  (and (|$IsValid'u64'| (seq.len v@@4)) (forall ((i@@0 Int) ) (!  (=> (and (>= i@@0 0) (< i@@0 (seq.len v@@4))) (|$IsValid'u64'| (seq.nth v@@4 i@@0)))
 :qid |bubblesortcvc4bpl.590:13|
 :skolemid |15|
))))
 :qid |bubblesortcvc4bpl.588:29|
 :skolemid |16|
 :pattern ( (|$IsValid'vec'u64''| v@@4))
)))
(assert (forall ((v@@5 (Seq Int)) (e Int) ) (! (let ((i@@1 (|$IndexOfVec'u64'| v@@5 e)))
(ite  (not (exists ((i@@2 Int) ) (!  (and (and (|$IsValid'u64'| i@@2) (and (>= i@@2 0) (< i@@2 (seq.len v@@5)))) (= (seq.nth v@@5 i@@2) e))
 :qid |bubblesortcvc4bpl.595:13|
 :skolemid |17|
))) (= i@@1 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@1) (and (>= i@@1 0) (< i@@1 (seq.len v@@5)))) (= (seq.nth v@@5 i@@1) e)) (forall ((j Int) ) (!  (=> (and (and (|$IsValid'u64'| j) (>= j 0)) (< j i@@1)) (not (= (seq.nth v@@5 j) e)))
 :qid |bubblesortcvc4bpl.603:17|
 :skolemid |18|
)))))
 :qid |bubblesortcvc4bpl.599:15|
 :skolemid |19|
...
(<= (seq.nth (|v#$Mutation_11578| $t0@3) i@@8) (seq.nth (|v#$Mutation_11578| $t0@3) j@@1))))
 :qid |bubblesortcvc4bpl.2020:75|
 :skolemid |71|
)))))
 :qid |bubblesortcvc4bpl.2019:76|
 :skolemid |72|
...
(forall (($i_3@@1 Int) ) (!  (=> ($InRange $range_2@@0 $i_3@@1) (let ((l $i_3@@1))
 ...
 :qid |bubblesortcvc4bpl.2033:75|
 :skolemid |74|
)))))
 :qid |bubblesortcvc4bpl.2032:76|
 :skolemid |75|
...
(<= (seq.nth (|v#$Mutation_11578| $t0@2) l@@0) (seq.nth (|v#$Mutation_11578| $t0@2) k@@3))))
 :qid |bubblesortcvc4bpl.1931:45|
 :skolemid |58|
)))))
 :qid |bubblesortcvc4bpl.1930:58|
 :skolemid |59|
...
(forall (($i_3@@5 Int) ) (!  (=> ($InRange $range_2@@2 $i_3@@5) (let ((l@@1 $i_3@@5))
 ...
 :qid |bubblesortcvc4bpl.1944:54|
 :skolemid |61|
)))))
 :qid |bubblesortcvc4bpl.1943:55|
 :skolemid |62|
...
(<= (seq.nth (|v#$Mutation_11578| $t0@1) l@@2) (seq.nth (|v#$Mutation_11578| $t0@1) k@@8))))
 :qid |bubblesortcvc4bpl.1976:45|
 :skolemid |65|
)))))
 :qid |bubblesortcvc4bpl.1975:52|
 :skolemid |66|
...
(forall (($i_3@@9 Int) ) (!  (=> ($InRange $range_2@@4 $i_3@@9) (let ((l@@3 $i_3@@9))
 ...
 :qid |bubblesortcvc4bpl.1989:54|
 :skolemid |68|
)))))
 :qid |bubblesortcvc4bpl.1988:55|
 :skolemid |69|
...
(<= (seq.nth (|v#$Mutation_11578| $t0@0) l@@4) (seq.nth (|v#$Mutation_11578| $t0@0) k@@12))))
 :qid |bubblesortcvc4bpl.1607:45|
 :skolemid |43|
)))))
 :qid |bubblesortcvc4bpl.1606:58|
 :skolemid |44|
...
(forall (($i_3@@13 Int) ) (!  (=> ($InRange $range_2@@6 $i_3@@13) (let ((l@@5 $i_3@@13))
 ...
 :qid |bubblesortcvc4bpl.1620:54|
 :skolemid |46|
)))))
 :qid |bubblesortcvc4bpl.1619:55|
 :skolemid |47|
...
(<= (seq.nth (|v#$Mutation_11578| $t0@1) l@@6) (seq.nth (|v#$Mutation_11578| $t0@1) k@@17))))
 :qid |bubblesortcvc4bpl.1715:45|
 :skolemid |50|
)))))
 :qid |bubblesortcvc4bpl.1714:63|
 :skolemid |51|
...
(forall (($i_3@@16 Int) ) (!  (=> ($InRange $range_2@@8 $i_3@@16) (let ((l@@7 $i_3@@16))
 ...
 :qid |bubblesortcvc4bpl.1726:54|
 :skolemid |53|
)))))
 :qid |bubblesortcvc4bpl.1725:60|
 :skolemid |54|
...
(<= (seq.nth (|v#$Mutation_11578| _$t0) l@@8) (seq.nth (|v#$Mutation_11578| _$t0) k@@22))))
 :qid |bubblesortcvc4bpl.1379:45|
 :skolemid |31|
)))))
 :qid |bubblesortcvc4bpl.1378:52|
 :skolemid |32|
...
(forall (($i_3@@19 Int) ) (!  (=> ($InRange $range_2@@10 $i_3@@19) (let ((l@@9 $i_3@@19))
 ...
 :qid |bubblesortcvc4bpl.1392:54|
 :skolemid |34|
)))))
 :qid |bubblesortcvc4bpl.1391:55|
 :skolemid |35|
...
(<= (seq.nth (|v#$Mutation_11578| $t0@0) l@@10) (seq.nth (|v#$Mutation_11578| $t0@0) k@@26))))
 :qid |bubblesortcvc4bpl.1505:45|
 :skolemid |37|
)))))
 :qid |bubblesortcvc4bpl.1504:57|
 :skolemid |38|
...
(forall (($i_3@@22 Int) ) (!  (=> ($InRange $range_2@@12 $i_3@@22) (let ((l@@11 $i_3@@22))
 ...
 :qid |bubblesortcvc4bpl.1516:54|
 :skolemid |40|
)))))
 :qid |bubblesortcvc4bpl.1515:60|
 :skolemid |41|
