...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |modulelevelspecSmtSeqcvc4bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |modulelevelspecSmtSeqcvc4bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |modulelevelspecSmtSeqcvc4bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |modulelevelspecSmtSeqcvc4bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |modulelevelspecSmtSeqcvc4bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |modulelevelspecSmtSeqcvc4bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |modulelevelspecSmtSeqcvc4bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |modulelevelspecSmtSeqcvc4bpl.461:15|
 :skolemid |14|
...
(assert (not
 ...
 :qid |modulelevelspecSmtSeqcvc4bpl.978:15|
 :skolemid |27|
...
(let ((anon0$1_correct  (=> (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_8768| $42_TestModule_R_$memory) addr@@1) (> (|$value#$42_TestModule_R| (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8768| $42_TestModule_R_$memory) addr@@1)) 0)))
 :qid |modulelevelspecSmtSeqcvc4bpl.930:20|
 :skolemid |25|
...
(|$IsValid'$42_TestModule_R'| $rsc))
 :qid |modulelevelspecSmtSeqcvc4bpl.939:20|
 :skolemid |26|
...
(declare-fun $42_TestModule_R_$memory@1@@0 () T@$Memory_8768)
(declare-fun $t2@@0 () Int)
(declare-fun _$t1@@0 () Int)
(declare-fun $abort_code@1@@0 () Int)
(declare-fun _$t0@@0 () Int)
(declare-fun $42_TestModule_R_$memory@0@@0 () T@$Memory_8768)
(declare-fun $t3@0@@0 () T@$42_TestModule_R)
(declare-fun $abort_code@0@@0 () Int)
(push 1)
(set-info :boogie-vc-id $42_TestModule_store_incorrect$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 10719) (let ((anon8_Else_correct@@0  (=> (not $abort_flag@0@@0) (and (=> (= (ControlFlow 0 10272) (- 0 10945)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_8768| $42_TestModule_R_$memory@1@@0) addr@@2) (> (|$value#$42_TestModule_R| (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8768| $42_TestModule_R_$memory@1@@0) addr@@2)) 0)))
 :qid |modulelevelspecSmtSeqcvc4bpl.1073:15|
 :skolemid |30|
))) (=> (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_8768| $42_TestModule_R_$memory@1@@0) addr@@3) (> (|$value#$42_TestModule_R| (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8768| $42_TestModule_R_$memory@1@@0) addr@@3)) 0)))
 :qid |modulelevelspecSmtSeqcvc4bpl.1073:15|
 :skolemid |30|
)) (and (=> (= (ControlFlow 0 10272) (- 0 10978)) (|Select__T@[Int]Bool_| (|domain#$Memory_8768| $42_TestModule_R_$memory@1@@0) $t2@@0)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_8768| $42_TestModule_R_$memory@1@@0) $t2@@0) (=> (= (ControlFlow 0 10272) (- 0 10986)) (= (|$value#$42_TestModule_R| (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8768| $42_TestModule_R_$memory@1@@0) $t2@@0)) _$t1@@0)))))))))
(let ((anon8_Then_correct@@0 true))
(let ((anon7_Then$1_correct@@0  (=> (= $42_TestModule_R_$memory@1@@0 $42_TestModule_R_$memory) (=> (and (= $abort_flag@0@@0 true) (= $abort_code@1@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 10340) 10290) anon8_Then_correct@@0) (=> (= (ControlFlow 0 10340) 10272) anon8_Else_correct@@0))))))
(let ((anon7_Then_correct@@0  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_8768| $42_TestModule_R_$memory) _$t0@@0) (= (ControlFlow 0 10338) 10340)) anon7_Then$1_correct@@0)))
(let ((anon7_Else_correct@@0  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_8768| $42_TestModule_R_$memory) _$t0@@0)) (=> (and (and (= $42_TestModule_R_$memory@0@@0 ($Memory_8768 (|Store__T@[Int]Bool_| (|domain#$Memory_8768| $42_TestModule_R_$memory) _$t0@@0 true) (|Store__T@[Int]$42_TestModule_R_| (|contents#$Memory_8768| $42_TestModule_R_$memory) _$t0@@0 $t3@0@@0))) (= $42_TestModule_R_$memory@1@@0 $42_TestModule_R_$memory@0@@0)) (and (= $abort_flag@0@@0 false) (= $abort_code@1@@0 $abort_code@0@@0))) (and (=> (= (ControlFlow 0 10209) 10290) anon8_Then_correct@@0) (=> (= (ControlFlow 0 10209) 10272) anon8_Else_correct@@0))))))
(let ((anon0$1_correct@@0  (=> (and (and (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_8768| $42_TestModule_R_$memory) addr@@4) (> (|$value#$42_TestModule_R| (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8768| $42_TestModule_R_$memory) addr@@4)) 0)))
 :qid |modulelevelspecSmtSeqcvc4bpl.1029:20|
 :skolemid |28|
)) (|$IsValid'address'| _$t0@@0)) (and (|$IsValid'u64'| _$t1@@0) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8768| $42_TestModule_R_$memory) $a_0@@0)))
(|$IsValid'$42_TestModule_R'| $rsc@@0))
 :qid |modulelevelspecSmtSeqcvc4bpl.1038:20|
 :skolemid |29|
 :pattern ( (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8768| $42_TestModule_R_$memory) $a_0@@0))
)))) (and (and (= $t2@@0 _$t0@@0) (= _$t0@@0 _$t0@@0)) (and (= _$t1@@0 _$t1@@0) (= $t3@0@@0 ($42_TestModule_R _$t1@@0))))) (and (=> (= (ControlFlow 0 10191) 10338) anon7_Then_correct@@0) (=> (= (ControlFlow 0 10191) 10209) anon7_Else_correct@@0)))))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 10719) 10191) anon0$1_correct@@0)))
anon0_correct@@0))))))))
))
(check-sat)
