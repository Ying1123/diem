...
(let ((L3_correct  (and (=> (= (ControlFlow 0 194855) (- 0 267530)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (=> (= (ControlFlow 0 194855) (- 0 267536)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= 5 $t7@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 194978) 194855))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $t8@1 $t8) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 195030) 194978) anon12_Then_correct) (=> (= (ControlFlow 0 195030) 194964) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (ControlFlow 0 195028) 195030)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (=> (and (and (= $t8@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= $t8@1 $t8@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 194873) 194978) anon12_Then_correct) (=> (= (ControlFlow 0 194873) 194964) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t4@0 (and (=> (= (ControlFlow 0 194859) 195028) anon11_Then_correct) (=> (= (ControlFlow 0 194859) 194873) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t4@0) (= $t6 $t6)) (and (= $t7@0 $t6) (= (ControlFlow 0 194823) 194855))) L3_correct)))
...
)) (= _$t0 _$t0)) (and (= $t4@0 (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t6) (= $t6 5)) (and (= $t6 $t6) (= $t4@0 $t4@0)))) (and (=> (= (ControlFlow 0 194807) 194859) anon10_Then_correct) (=> (= (ControlFlow 0 194807) 194823) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_77784_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 194622) 194807)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 267192) 194622) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
