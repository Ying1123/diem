...
(declare-fun $t9@1 () T@$Mutation_399071)
...
(declare-fun $t9@2 () T@$Mutation_399071)
...
(declare-fun $t9@0 () T@$Mutation_399071)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1285406) (let ((L2_correct  (and (=> (= (ControlFlow 0 979638) (- 0 1287340)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 979638) (- 0 1287380)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6@0))))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 979510) 979638))) L2_correct)))
(let ((anon12_Then_correct  (=> $t7 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 979716) 979638))) L2_correct))))
(let ((anon11_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6))) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 979788) 979638))) L2_correct))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0| (|v#$Mutation_399071| $t9@1))) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0| |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0|) (= $t10@0 ($Mutation_197257 (|l#$Mutation_399071| $t9@1) (let ((l (|l#Vec_28308| (|p#$Mutation_399071| $t9@1))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_399071| $t9@1)) l 7) (+ l 1))) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1))))) (and (= $t10@1 ($Mutation_197257 (|l#$Mutation_197257| $t10@0) (|p#$Mutation_197257| $t10@0) _$t1)) (= $t9@2 ($Mutation_399071 (|l#$Mutation_399071| $t9@1) (|p#$Mutation_399071| $t9@1) (|$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1)) (|v#$Mutation_197257| $t10@1) (|$mint_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@1))))))) (and (=> (= (ControlFlow 0 979496) (- 0 1286388)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_399071| $t9@2)) 10000000000)) (=> (and (and (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |Diembpl.54989:106|
 :skolemid |3068|
 ...
 :qid |Diembpl.54989:973|
 :skolemid |3070|
)))) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0| ($Memory_335505 (|Store__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_399071| $t9@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_399071| $t9@2)) (|v#$Mutation_399071| $t9@2))))) (and (=> (= (ControlFlow 0 979496) (- 0 1286575)) (and (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@2 Int) (mint_cap_owner2@@2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@2) (=> (|$IsValid'address'| mint_cap_owner2@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner1@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner2@@2)) (= mint_cap_owner1@@2 mint_cap_owner2@@2))))
 :qid |Diembpl.55012:101|
 :skolemid |3071|
 ...
 :qid |Diembpl.55012:968|
 :skolemid |3073|
)))) (and (=> (= (ControlFlow 0 979496) (- 0 1286710)) (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.55018:17|
 :skolemid |3074|
 ...
 :qid |Diembpl.55018:496|
 :skolemid |3076|
))) (and (=> (= (ControlFlow 0 979496) (- 0 1286779)) (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.55024:17|
 :skolemid |3077|
 ...
 :qid |Diembpl.55024:418|
 :skolemid |3079|
))) (and (=> (= (ControlFlow 0 979496) (- 0 1286848)) (and (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.55030:17|
 :skolemid |3080|
 ...
 :qid |Diembpl.55030:428|
 :skolemid |3082|
))) (and (=> (= (ControlFlow 0 979496) (- 0 1286917)) (and (and (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr)))
 :qid |Diembpl.55036:17|
 :skolemid |3083|
 ...
 :qid |Diembpl.55036:430|
 :skolemid |3085|
))) (and (=> (= (ControlFlow 0 979496) (- 0 1286992)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 979496) (- 0 1287002)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 979496) (- 0 1287014)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 979496) (- 0 1287032)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 979496) (- 0 1287046)) (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) _$t1)) (=> (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) _$t1) (and (=> (= (ControlFlow 0 979496) (- 0 1287057)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 979496) (- 0 1287077)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316220| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@12)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316220| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@12))))
 :qid |Diembpl.55075:15|
 :skolemid |3086|
 ...
 :qid |Diembpl.55075:15|
 :skolemid |3086|
)) (and (=> (= (ControlFlow 0 979496) (- 0 1287106)) (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316220| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_316220| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@14)))
 :qid |Diembpl.55080:15|
 :skolemid |3087|
 ...
 :qid |Diembpl.55080:15|
 :skolemid |3087|
)) (and (=> (= (ControlFlow 0 979496) (- 0 1287131)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 979496) (- 0 1287151)) (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316479| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@16)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316479| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@16))))
 :qid |Diembpl.55090:15|
 :skolemid |3088|
 ...
 :qid |Diembpl.55090:15|
 :skolemid |3088|
)) (and (=> (= (ControlFlow 0 979496) (- 0 1287180)) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316479| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_316479| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@18)))
 :qid |Diembpl.55095:15|
 :skolemid |3089|
 ...
 :qid |Diembpl.55095:15|
 :skolemid |3089|
)) (and (=> (= (ControlFlow 0 979496) (- 0 1287205)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 979496) (- 0 1287225)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 979496) (- 0 1287245)) (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@20) (|Select__T@[Int]Bool_| (|domain#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@20))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@20))))
 :qid |Diembpl.55110:15|
 :skolemid |3090|
 ...
 :qid |Diembpl.55110:15|
 :skolemid |3090|
)) (and (=> (= (ControlFlow 0 979496) (- 0 1287281)) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@22) (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@22)))
 :qid |Diembpl.55115:15|
 :skolemid |3091|
 ...
 :qid |Diembpl.55115:15|
 :skolemid |3091|
)) (=> (= (ControlFlow 0 979496) (- 0 1287306)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon13_Then$1_correct  (=> (= $t9@1 $t9) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 979690) 979510) anon14_Then_correct) (=> (= (ControlFlow 0 979690) 979496) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 979688) 979690)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= $t9@0 ($Mutation_399071 ($Global 173345816) (Vec_28308 (MapConstVec_13534 DefaultVecElem_13534) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t9@1 $t9@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 978500) 979510) anon14_Then_correct) (=> (= (ControlFlow 0 978500) 979496) anon14_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (not $t7) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 978478) 979688) anon13_Then_correct) (=> (= (ControlFlow 0 978478) 978500) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not $t5) (= $t7  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 978464) 979716) anon12_Then_correct) (=> (= (ControlFlow 0 978464) 978478) anon12_Else_correct)))))
...
)) (= $t3 (|$addr#$signer| _$t0)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t4 (|$addr#$signer| _$t0)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))))) (and (=> (= (ControlFlow 0 978446) 979788) anon11_Then_correct) (=> (= (ControlFlow 0 978446) 978464) anon11_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 977826) 978446)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_28308| (|p#$Mutation_399071| $t2)) 0) (= (|l#Vec_28308| (|p#$Mutation_399071| $t9)) 0)) (and (= (|l#Vec_28308| (|p#$Mutation_197257| $t10)) 0) (= (ControlFlow 0 977836) 977826))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 1285406) 977836) anon0_correct)))
