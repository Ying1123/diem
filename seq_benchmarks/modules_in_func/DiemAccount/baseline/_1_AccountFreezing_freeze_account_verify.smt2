...
(declare-fun $t30@0 () T@$Mutation_65773)
(declare-fun $t29@1 () T@$Mutation_592036)
(declare-fun $t30@1 () T@$Mutation_65773)
(declare-fun $t29@2 () T@$Mutation_592036)
...
(declare-fun $t29 () T@$Mutation_592036)
(declare-fun $t29@0 () T@$Mutation_592036)
...
(declare-fun $t30 () T@$Mutation_65773)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1931470) (let ((anon36_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 1144993) (- 0 1932893)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1144993) (- 0 1932903)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t9))) (and (=> (= (ControlFlow 0 1144993) (- 0 1932915)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t9)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t9)) 1))) (and (=> (= (ControlFlow 0 1144993) (- 0 1932933)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 1144993) (- 0 1932947)) (not (= _$t1 173345816))) (=> (not (= _$t1 173345816)) (and (=> (= (ControlFlow 0 1144993) (- 0 1932957)) (not (= _$t1 186537453))) (=> (not (= _$t1 186537453)) (and (=> (= (ControlFlow 0 1144993) (- 0 1932967)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (and (=> (= (ControlFlow 0 1144993) (- 0 1932978)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t12))) (and (=> (= (ControlFlow 0 1144993) (- 0 1932990)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t12)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t12)) 1))) (and (=> (= (ControlFlow 0 1144993) (- 0 1933008)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 1144993) (- 0 1933022)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@0) _$t1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@0) _$t1)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@0) _$t1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@0) _$t1))) (and (=> (= (ControlFlow 0 1144993) (- 0 1933029)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11) (+ cnt 1)) (+ len 1))))))
...
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@0))))))
 ...
 :qid |DiemAccountbpl.3536:13|
 :skolemid |130|
))))) (=> (= (ControlFlow 0 1144993) (- 0 1933054)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_416285| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@2) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@2) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11) (+ cnt@@1 1)) (+ len@@1 1))))))
...
(let ((L7_correct  (and (=> (= (ControlFlow 0 1144382) (- 0 1932615)) (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (= _$t1 173345816)) (= _$t1 186537453)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t12)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (= _$t1 173345816)) (= _$t1 186537453)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t12)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 1144382) (- 0 1932712)) (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t14@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t9)) (= 5 $t14@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t9)) 1)) (= 3 $t14@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t14@0))) (and (= _$t1 173345816) (= 7 $t14@0))) (and (= _$t1 186537453) (= 7 $t14@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (= 5 $t14@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t12)) (= 5 $t14@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t12)) 1)) (= 3 $t14@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t14@0))))))))
(let ((anon36_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t14@0 $abort_code@2) (= (ControlFlow 0 1145007) 1144382))) L7_correct)))
(let ((|inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1| (|v#$Mutation_456960| $t34@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_416285| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@3) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t35@0))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@3) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t35@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 1144783) 1145007) anon36_Then_correct) (=> (= (ControlFlow 0 1144783) 1144993) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (and (not $abort_flag@1) (= $t34@0 ($Mutation_456960 (|l#$Mutation_592079| $t33@1) (let ((l (|l#Vec_37831| (|p#$Mutation_592079| $t33@1))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_592079| $t33@1)) l 0) (+ l 1))) (|$freeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|v#$Mutation_592079| $t33@1))))) (and (= $t35@0 ($1_AccountFreezing_FreezeAccountEvent $t31 _$t1)) (= (ControlFlow 0 1144789) 1144783))) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$anon0_correct|)))
(let ((anon35_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t14@0 $abort_code@2) (= (ControlFlow 0 1145021) 1144382))) L7_correct)))
(let ((anon34_Then$1_correct  (=> (= $t33@1 $t33) (=> (and (= $abort_flag@1 true) (= $abort_code@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1145073) 1145021) anon35_Then_correct) (=> (= (ControlFlow 0 1145073) 1144789) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (= (ControlFlow 0 1145071) 1145073)) anon34_Then$1_correct)))
(let ((anon34_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816) (=> (and (and (= $t33@0 ($Mutation_592079 ($Global 173345816) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (= $t33@1 $t33@0)) (and (= $abort_flag@1 $abort_flag@0) (= $abort_code@2 $abort_code@1))) (and (=> (= (ControlFlow 0 1144684) 1145021) anon35_Then_correct) (=> (= (ControlFlow 0 1144684) 1144789) anon35_Else_correct))))))
(let ((anon33_Else_correct  (=> (and (not $abort_flag@0) (= $t30@0 ($Mutation_65773 (|l#$Mutation_592036| $t29@1) (let ((l@@0 (|l#Vec_37831| (|p#$Mutation_592036| $t29@1))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_592036| $t29@1)) l@@0 0) (+ l@@0 1))) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|v#$Mutation_592036| $t29@1))))) (=> (and (and (= $t30@1 ($Mutation_65773 (|l#$Mutation_65773| $t30@0) (|p#$Mutation_65773| $t30@0) true)) (= $t29@2 ($Mutation_592036 (|l#$Mutation_592036| $t29@1) (|p#$Mutation_592036| $t29@1) ($1_AccountFreezing_FreezingBit (|v#$Mutation_65773| $t30@1))))) (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) addr@@0)))
 :qid |DiemAccountbpl.32649:20|
 :skolemid |656|
)) (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_590069 (|Store__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_592036| $t29@2)) true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_592036| $t29@2)) (|v#$Mutation_592036| $t29@2)))))) (and (=> (= (ControlFlow 0 1144662) (- 0 1932367)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@0) addr@@1)))
 :qid |DiemAccountbpl.32660:15|
 :skolemid |657|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@0) addr@@2)))
 :qid |DiemAccountbpl.32660:15|
 :skolemid |657|
)) (=> (and (and (|$IsValid'address'| $t31) (= $t31 (|$addr#$signer| _$t0))) (and (= $t31 $t31) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 1144662) 1145071) anon34_Then_correct) (=> (= (ControlFlow 0 1144662) 1144684) anon34_Else_correct)))))))))
(let ((anon33_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 1145087) 1144382))) L7_correct)))
(let ((anon32_Then$1_correct  (=> (= $t29@1 $t29) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1145139) 1145087) anon33_Then_correct) (=> (= (ControlFlow 0 1145139) 1144662) anon33_Else_correct))))))
(let ((anon32_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (= (ControlFlow 0 1145137) 1145139)) anon32_Then$1_correct)))
(let ((anon32_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1) (=> (and (and (= $t29@0 ($Mutation_592036 ($Global _$t1) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (= $t29@1 $t29@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1144530) 1145087) anon33_Then_correct) (=> (= (ControlFlow 0 1144530) 1144662) anon33_Else_correct))))))
(let ((anon31_Then_correct  (=> $t25@0 (and (=> (= (ControlFlow 0 1144508) 1145137) anon32_Then_correct) (=> (= (ControlFlow 0 1144508) 1144530) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (and (not $t25@0) (= $t27 $t27)) (and (= $t14@0 $t27) (= (ControlFlow 0 1144498) 1144382))) L7_correct)))
(let ((anon30_Then_correct  (=> $t22@0 (=> (and (= $t25@0 (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t27) (= $t27 5)) (and (= $t27 $t27) (= $t25@0 $t25@0))) (and (=> (= (ControlFlow 0 1144482) 1144508) anon31_Then_correct) (=> (= (ControlFlow 0 1144482) 1144498) anon31_Else_correct)))))))
(let ((anon30_Else_correct  (=> (and (and (not $t22@0) (= $t24 $t24)) (and (= $t14@0 $t24) (= (ControlFlow 0 1144444) 1144382))) L7_correct)))
(let ((anon29_Then_correct  (=> (and (and (and $t18@0 (|$IsValid'address'| 186537453)) (and (= $t22@0  (not (= _$t1 186537453))) (|$IsValid'u64'| 4))) (and (and (|$IsValid'u64'| $t24) (= $t24 7)) (and (= $t24 $t24) (= $t22@0 $t22@0)))) (and (=> (= (ControlFlow 0 1144428) 1144482) anon30_Then_correct) (=> (= (ControlFlow 0 1144428) 1144444) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (and (not $t18@0) (= $t20 $t20)) (and (= $t14@0 $t20) (= (ControlFlow 0 1144078) 1144382))) L7_correct)))
(let ((anon28_Else_correct  (=> (and (and (and (not $t16) (|$IsValid'address'| 173345816)) (and (= $t18@0  (not (= _$t1 173345816))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t20) (= $t20 7)) (and (= $t20 $t20) (= $t18@0 $t18@0)))) (and (=> (= (ControlFlow 0 1144062) 1144428) anon29_Then_correct) (=> (= (ControlFlow 0 1144062) 1144078) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> $t16 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t15)) (= 5 $t14)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t15)) 1)) (= 3 $t14))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t14))) (= $t14 $t14)) (and (= $t14@0 $t14) (= (ControlFlow 0 1145211) 1144382))) L7_correct))))
(let ((anon27_Else_correct  (=> (not $t13) (=> (and (= $t15 (|$addr#$signer| _$t0)) (= $t16  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t15)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t15)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))) (and (=> (= (ControlFlow 0 1144012) 1145211) anon28_Then_correct) (=> (= (ControlFlow 0 1144012) 1144062) anon28_Else_correct))))))
(let ((anon27_Then_correct  (=> $t13 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t14)) (= $t14 $t14)) (and (= $t14@0 $t14) (= (ControlFlow 0 1145237) 1144382))) L7_correct))))
...
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |DiemAccountbpl.32359:20|
 :skolemid |653|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0@@0))
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@1)))
(|$IsValid'$1_AccountFreezing_FreezeEventsHolder'| $rsc@@1))
 :qid |DiemAccountbpl.32363:20|
 :skolemid |654|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@1))
))))) (and (and (and (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@2))
 :qid |DiemAccountbpl.32367:20|
 :skolemid |655|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2))
)) (= $t9 (|$addr#$signer| _$t0))) (and (= $t10 (|$freeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_590447| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (= $t11 ($1_AccountFreezing_FreezeAccountEvent (|$addr#$signer| _$t0) _$t1)))) (and (and (= $t12 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t13  (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 1143952) 1145237) anon27_Then_correct) (=> (= (ControlFlow 0 1143952) 1144012) anon27_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1143714) 1143952)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_37831| (|p#$Mutation_592036| $t29)) 0) (=> (and (and (= (|l#Vec_37831| (|p#$Mutation_65773| $t30)) 0) (= (|l#Vec_37831| (|p#$Mutation_592079| $t33)) 0)) (and (= (|l#Vec_37831| (|p#$Mutation_456960| $t34)) 0) (= (ControlFlow 0 1143724) 1143714))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 1931470) 1143724) anon0_correct)))
