...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) $t20 stream_new)))) $es))) (and (= $t16 $t16) (= $t22 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816))))) (and (=> (= (ControlFlow 0 655226) (- 0 891999)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 655226) (- 0 892012)) (not (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (not (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 655226) (- 0 892024)) (not (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128))) (=> (not (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128)) (and (=> (= (ControlFlow 0 655226) (- 0 892041)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 655226) (- 0 892051)) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816) (and (=> (= (ControlFlow 0 655226) (- 0 892059)) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816) (and (=> (= (ControlFlow 0 655226) (- 0 892067)) (= $t22 (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t5) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t5) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t5) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t5) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t5) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t5) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t5) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t5) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t5) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t5) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t5) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t5) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t5)))) (=> (= $t22 (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t5) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t5) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t5) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t5) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t5) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t5) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t5) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t5) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t5) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t5) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t5) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t5) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t5))) (and (=> (= (ControlFlow 0 655226) (- 0 892085)) (= (|$value#$1_Diem_Diem'#0'| $t16) _$t1)) (=> (= (|$value#$1_Diem_Diem'#0'| $t16) _$t1) (and (=> (= (ControlFlow 0 655226) (- 0 892095)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr))))
 ...
 :qid |Diembpl.27797:15|
 :skolemid |999|
)) (and (=> (= (ControlFlow 0 655226) (- 0 892124)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)))
 ...
 :qid |Diembpl.27802:15|
 :skolemid |1000|
)) (and (=> (= (ControlFlow 0 655226) (- 0 892149)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 655226) (- 0 892169)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3))))
 ...
 :qid |Diembpl.27812:15|
 :skolemid |1001|
)) (and (=> (= (ControlFlow 0 655226) (- 0 892198)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)))
 ...
 :qid |Diembpl.27817:15|
 :skolemid |1002|
)) (and (=> (= (ControlFlow 0 655226) (- 0 892223)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 655226) (- 0 892243)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 655226) (- 0 892263)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7))))
 ...
 :qid |Diembpl.27832:15|
 :skolemid |1003|
)) (=> (= (ControlFlow 0 655226) (- 0 892299)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9)))
 :qid |Diembpl.27837:15|
 :skolemid |1004|
)))))))))))))))))))))))))))))))))))))))
(let ((anon19_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_255740 (|Store__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816 false) (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|)))) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@1|) (= (ControlFlow 0 654778) 655226))) anon13_correct)))
(let ((anon19_Then_correct  (=> (and (and |$temp_0'bool'@0| (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_255740 (|Store__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816 true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816 |$temp_0'$1_Diem_CurrencyInfo'#0''@0|)))) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@0|) (= (ControlFlow 0 655238) 655226))) anon13_correct)))
(let ((anon18_Else_correct  (=> (not $t17) (and (=> (= (ControlFlow 0 654766) 655238) anon19_Then_correct) (=> (= (ControlFlow 0 654766) 654778) anon19_Else_correct)))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 654640) (- 0 891722)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 654640) (- 0 891760)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t10@0)) (and (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= 1 $t10@0))) (and (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128) (= 8 $t10@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t10@0))))))))
(let ((anon18_Then_correct  (=> $t17 (=> (and (and (or (or (and (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= 1 $t10)) (and (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128) (= 8 $t10))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t10))) (= $t10 $t10)) (and (= $t10@0 $t10) (= (ControlFlow 0 655306) 654640))) L3_correct))))
(let ((anon17_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t12 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t13 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t14 (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t13)) (= $t15 ($1_Diem_MintEvent _$t1 (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t13))))) (and (=> (= (ControlFlow 0 654760) (- 0 891598)) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (=> (= $t17  (or (or (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 654760) 655306) anon18_Then_correct) (=> (= (ControlFlow 0 654760) 654766) anon18_Else_correct)))))))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 655320) 654640))) L3_correct)))
(let ((anon16_Then$1_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 655372) 655320) anon17_Then_correct) (=> (= (ControlFlow 0 655372) 654760) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) $t6)) (= (ControlFlow 0 655370) 655372)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) $t6) (= $t11@0 (|Select__T@[Int]$1_Diem_MintCapability'#0'_| (|contents#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) $t6))) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 654660) 655320) anon17_Then_correct) (=> (= (ControlFlow 0 654660) 654760) anon17_Else_correct)))))
(let ((anon15_Then_correct  (=> $t7@0 (and (=> (= (ControlFlow 0 654646) 655370) anon16_Then_correct) (=> (= (ControlFlow 0 654646) 654660) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not $t7@0) (= $t9 $t9)) (and (= $t10@0 $t9) (= (ControlFlow 0 654512) 654640))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (and (forall ((mint_cap_owner Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) mint_cap_owner) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) mint_cap_owner)) 1))))
 ...
 :skolemid |996|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0)))) (=> (and (and (and (and (|$IsValid'u64'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0)))
...
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_MintCapability'#0'_| (|contents#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) $a_0@@0)))
(|$IsValid'$1_Diem_MintCapability'#0''| $rsc@@0))
 :qid |Diembpl.27548:20|
 :skolemid |998|
 :pattern ( (|Select__T@[Int]$1_Diem_MintCapability'#0'_| (|contents#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) $a_0@@0))
)) (= $t5 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (and (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| $t6)))) (and (and (and (= $t6 (|$addr#$signer| _$t0)) (= $t6 $t6)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) $t6)) (|$IsValid'u64'| 9))) (and (and (|$IsValid'u64'| $t9) (= $t9 4)) (and (= $t9 $t9) (= $t7@0 $t7@0))))) (and (=> (= (ControlFlow 0 654496) 654646) anon15_Then_correct) (=> (= (ControlFlow 0 654496) 654512) anon15_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 654186) 654496)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 891073) 654186) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))
))
(check-sat)
(pop 1)
