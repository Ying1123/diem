...
(assert (not
 ...
 :qid |ValidatorConfigbpl.6661:15|
 :skolemid |209|
)) (and (=> (= (ControlFlow 0 196204) (- 0 268797)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory@1) addr@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@2)) 3))))
 :qid |ValidatorConfigbpl.6667:15|
 :skolemid |210|
))) (=> (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory@1) addr@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@3)) 3))))
 :qid |ValidatorConfigbpl.6667:15|
 :skolemid |210|
)) (and (=> (= (ControlFlow 0 196204) (- 0 268822)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory@1) addr@@4) (not (= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory@1) addr@@4)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@4)) 3))))
 :qid |ValidatorConfigbpl.6673:15|
 :skolemid |211|
))) (=> (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory@1) addr@@5) (not (= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory@1) addr@@5)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@5)) 3))))
 :qid |ValidatorConfigbpl.6673:15|
 :skolemid |211|
)) (and (=> (= (ControlFlow 0 196204) (- 0 268850)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0))) (and (=> (= (ControlFlow 0 196204) (- 0 268861)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_112774| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_112774| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 196204) (- 0 268871)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 196204) (- 0 268883)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) $t5)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) $t5)) 0))) (and (=> (= (ControlFlow 0 196204) (- 0 268901)) (not (not (= (|$addr#$signer| _$t1) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t1) 173345816))) (and (=> (= (ControlFlow 0 196204) (- 0 268915)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 196204) (- 0 268928)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3))) (and (=> (= (ControlFlow 0 196204) (- 0 268947)) (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory@1) (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory@1) (|$addr#$signer| _$t0)) (=> (= (ControlFlow 0 196204) (- 0 268956)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory@1) addr1))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1))))))
 :qid |ValidatorConfigbpl.6722:15|
 :skolemid |212|
))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 195857) (- 0 268540)) (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_112774| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t1) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0)))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3)))) (=> (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_112774| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t1) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0)))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3))) (=> (= (ControlFlow 0 195857) (- 0 268614)) (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0)) (= 6 $t7@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_112774| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t7@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t1) 173345816)) (= 2 $t7@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (= 5 $t7@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3)) (= 3 $t7@0))))))))
(let ((anon21_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 196218) 195857))) L3_correct)))
(let ((anon20_Then$1_correct  (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 196270) 196218) anon21_Then_correct) (=> (= (ControlFlow 0 196270) 196204) anon21_Else_correct))))))
(let ((anon20_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 196268) 196270)) anon20_Then$1_correct)))
(let ((anon20_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_115312 (|Store__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0) $t18@0))) (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 195947) 196218) anon21_Then_correct) (=> (= (ControlFlow 0 195947) 196204) anon21_Else_correct))))))
(let ((anon19_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (and (and (|$IsValid'$1_Option_Option'$1_ValidatorConfig_Config''| $t16) (<= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t16)) 1)) (|$IsEqual'vec'$1_ValidatorConfig_Config''| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t16) (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_77870 (MapConstVec_70239 DefaultVecElem_70239) 0))))) (and (and (|$IsValid'$1_Option_Option'address''| $t17) (<= (|l#Vec_26921| (|$vec#$1_Option_Option'address'| $t17)) 1)) (and (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| $t17) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_26921 (MapConstVec_12393 DefaultVecElem_12393) 0)))) (= $t18@0 ($1_ValidatorConfig_ValidatorConfig $t16 $t17 _$t2))))) (and (=> (= (ControlFlow 0 195925) 196268) anon20_Then_correct) (=> (= (ControlFlow 0 195925) 195947) anon20_Else_correct))))))
(let ((anon19_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t15 $t15)) (and (= $t7@0 $t15) (= (ControlFlow 0 195625) 195857))) L3_correct)))
(let ((anon18_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t15) (= $t15 6)) (and (= $t15 $t15) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 195609) 195925) anon19_Then_correct) (=> (= (ControlFlow 0 195609) 195625) anon19_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t12@0)) (= (ControlFlow 0 195569) 195609)) anon18_Else$1_correct)))
(let ((anon18_Else_correct  (=> (not $t10) (=> (and (and (|$IsValid'address'| $t11) (= $t11 (|$addr#$signer| _$t0))) (and (= $t12@0 (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) $t11)) (= (ControlFlow 0 195575) 195569))) inline$$Not$0$anon0_correct))))
(let ((anon18_Then_correct  (=> $t10 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (= 5 $t7)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3)) (= 3 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 196326) 195857))) L3_correct))))
(let ((anon17_Else_correct  (=> (and (not $t9) (= $t10  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 3))))) (and (=> (= (ControlFlow 0 195513) 196326) anon18_Then_correct) (=> (= (ControlFlow 0 195513) 195575) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> $t9 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t1) 173345816)) (= 2 $t7)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) $t8)) (= 5 $t7))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) $t8)) 0)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t1) 173345816)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 196418) 195857))) L3_correct))))
(let ((anon16_Else_correct  (=> (not $t6) (=> (and (= $t8 (|$addr#$signer| _$t1)) (= $t9  (or (or (or (not (= (|$addr#$signer| _$t1) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) $t8))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) $t8)) 0))) (not (= (|$addr#$signer| _$t1) 173345816))))) (and (=> (= (ControlFlow 0 195473) 196418) anon17_Then_correct) (=> (= (ControlFlow 0 195473) 195513) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_112774| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t7)) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 196444) 195857))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112774| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_112774| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_125443| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@6) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@6)) 4))))
 ...
 :skolemid |203|
)))) (and (and (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@9) (not (= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@9)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@9)) 3))))
 :qid |ValidatorConfigbpl.6392:20|
 :skolemid |204|
)) (|$IsValid'address'| (|$addr#$signer| _$t0))) (and (|$IsValid'address'| (|$addr#$signer| _$t1)) (|$IsValid'vec'u8''| _$t2)))) (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_112774| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |ValidatorConfigbpl.6404:20|
 :skolemid |205|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_112774| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) $a_0@@0)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |ValidatorConfigbpl.6408:20|
 :skolemid |206|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1)))
...
)) (= $t5 (|$addr#$signer| _$t1)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= _$t2 _$t2) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_112774| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 195401) 196444) anon16_Then_correct) (=> (= (ControlFlow 0 195401) 195473) anon16_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_77784_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 195129) 195401)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 267652) 195129) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))
))
(check-sat)
(pop 1)
