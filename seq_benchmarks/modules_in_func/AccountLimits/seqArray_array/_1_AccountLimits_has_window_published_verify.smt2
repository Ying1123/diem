...
(assert (not
 (=> (= (ControlFlow 0 0) 414876) (let ((anon0$1_correct@@14  (=> (and (and (forall ((window_addr@@17 Int) ) (!  (=> (|$IsValid'address'| window_addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@17) (|Select__T@[Int]Bool_| (|domain#$Memory_179731| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@17)))))
 :qid |AccountLimitsbpl.14204:22|
 :skolemid |289|
 ...
 :qid |AccountLimitsbpl.14204:369|
 :skolemid |290|
 ...
 :qid |AccountLimitsbpl.14204:717|
 :skolemid |291|
))) (=> (and (and (and (and (forall ((addr@@89 Int) ) (!  (=> (|$IsValid'address'| addr@@89) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@89) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@89) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@89)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@89)) 6)))))
 :qid |AccountLimitsbpl.14208:22|
 :skolemid |292|
)) (forall ((addr@@90 Int) ) (!  (=> (|$IsValid'address'| addr@@90) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@90) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@90) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@90)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@90)) 6)))))
 :qid |AccountLimitsbpl.14208:388|
 :skolemid |293|
))) (forall ((addr@@91 Int) ) (!  (=> (|$IsValid'address'| addr@@91) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) addr@@91) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@91) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@91)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@91)) 6)))))
 :qid |AccountLimitsbpl.14208:755|
 :skolemid |294|
))) (and (|$IsValid'address'| _$t0@@14) (forall (($a_0@@23 Int) ) (! (let (($rsc@@23 (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@23)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc@@23))
 :qid |AccountLimitsbpl.14215:20|
 :skolemid |295|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@23))
)))) (and (and (= _$t0@@14 _$t0@@14) (= $t1@0@@5 (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) _$t0@@14))) (and (= $t1@0@@5 $t1@0@@5) (= (ControlFlow 0 302485) (- 0 415220))))) (= $t1@0@@5 (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) _$t0@@14))))))
(let ((inline$$InitEventStore$0$anon0_correct@@14  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@16 T@$1_Event_EventHandle) ) (! (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_112887_| (|streams#$EventStore| $es) handle@@16)))
 (and (= (|l#Multiset_112887| stream@@15) 0) (forall ((v@@59 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_112887| stream@@15) v@@59) 0)
 :qid |AccountLimitsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountLimitsbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 302157) 302485)) anon0$1_correct@@14)))
(let ((anon0_correct@@14  (=> (= (ControlFlow 0 414876) 302157) inline$$InitEventStore$0$anon0_correct@@14)))
anon0_correct@@14))))
))
(check-sat)
(pop 1)
