...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14999) (let ((anon7_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 13261) (- 0 15212)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory@1) a) (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) a)))
 :qid |globalinvariantsz3bpl.1119:15|
 :skolemid |34|
))) (=> (forall ((a@@0 Int) ) (!  (=> (|$IsValid'address'| a@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory@1) a@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) a@@0)))
 :qid |globalinvariantsz3bpl.1119:15|
 :skolemid |34|
)) (=> (= (ControlFlow 0 13261) (- 0 15237)) (forall ((a@@1 Int) ) (!  (=> (|$IsValid'address'| a@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) a@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory@1) a@@1)))
 :qid |globalinvariantsz3bpl.1125:15|
 :skolemid |35|
))))))))
(let ((anon7_Then_correct true))
(let ((anon6_Then$1_correct  (=> (= $42_TestGlobalInvariants_R_$memory@1 $42_TestGlobalInvariants_R_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 13329) 13279) anon7_Then_correct) (=> (= (ControlFlow 0 13329) 13261) anon7_Else_correct))))))
(let ((anon6_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) _$t0) (= (ControlFlow 0 13327) 13329)) anon6_Then$1_correct)))
(let ((anon6_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) _$t0)) (=> (and (and (= $42_TestGlobalInvariants_R_$memory@0 ($Memory_9970 (|Store__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) _$t0 true) (|Store__T@[Int]$42_TestGlobalInvariants_R_| (|contents#$Memory_9970| $42_TestGlobalInvariants_R_$memory) _$t0 $t2@0))) (= $42_TestGlobalInvariants_R_$memory@1 $42_TestGlobalInvariants_R_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 13201) 13279) anon7_Then_correct) (=> (= (ControlFlow 0 13201) 13261) anon7_Else_correct))))))
(let ((anon0$1_correct  (=> (and (forall ((a@@2 Int) ) (!  (=> (|$IsValid'address'| a@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) a@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) a@@2)))
 :qid |globalinvariantsz3bpl.1076:20|
 :skolemid |32|
)) (|$IsValid'address'| _$t0)) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$42_TestGlobalInvariants_R_| (|contents#$Memory_9970| $42_TestGlobalInvariants_R_$memory) $a_0)))
(|$IsValid'$42_TestGlobalInvariants_R'| $rsc))
 :qid |globalinvariantsz3bpl.1082:20|
 :skolemid |33|
 :pattern ( (|Select__T@[Int]$42_TestGlobalInvariants_R_| (|contents#$Memory_9970| $42_TestGlobalInvariants_R_$memory) $a_0))
)) (= _$t0 _$t0)) (and (|$IsValid'u64'| 0) (= $t2@0 ($42_TestGlobalInvariants_R 0)))) (and (=> (= (ControlFlow 0 13183) 13327) anon6_Then_correct) (=> (= (ControlFlow 0 13183) 13201) anon6_Else_correct))))))
(let ((anon0_correct  (=> (= (ControlFlow 0 14999) 13183) anon0$1_correct)))
anon0_correct))))))))
))
(check-sat)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15270) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t9@0 (|$x#$42_TestGlobalInvariants_S| $t8@1)) (= $t9@0 $t9@0)) (and (=> (= (ControlFlow 0 13638) (- 0 15586)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) _$t0))) (=> (= (ControlFlow 0 13638) (- 0 15599)) (= $t9@0 (|$x#$42_TestGlobalInvariants_S| (|Select__T@[Int]$42_TestGlobalInvariants_S_| (|contents#$Memory_10144| $42_TestGlobalInvariants_S_$memory) _$t0))))))))))
(let ((L3_correct  (=> (= (ControlFlow 0 13556) (- 0 15549)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) _$t0)))))
(let ((anon12_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 13652) 13556)) L3_correct))))
(let ((anon11_Then$1_correct  (=> (= $t8@1 $t8) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 13704) 13652) anon12_Then_correct) (=> (= (ControlFlow 0 13704) 13638) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) $t7)) (= (ControlFlow 0 13702) 13704)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) $t7) (=> (and (and (= $t8@0 (|Select__T@[Int]$42_TestGlobalInvariants_S_| (|contents#$Memory_10144| $42_TestGlobalInvariants_S_$memory) $t7)) (= $t8@1 $t8@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 13586) 13652) anon12_Then_correct) (=> (= (ControlFlow 0 13586) 13638) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t4@0 (=> (and (|$IsValid'address'| $t7) (= $t7 _$t0)) (and (=> (= (ControlFlow 0 13572) 13702) anon11_Then_correct) (=> (= (ControlFlow 0 13572) 13586) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (and (not $t4@0) (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 13538) 13556))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) a)))
...
(|$IsValid'$42_TestGlobalInvariants_S'| $rsc@@0))
 ...
 :skolemid |38|
 :pattern ( (|Select__T@[Int]$42_TestGlobalInvariants_S_| (|contents#$Memory_10144| $42_TestGlobalInvariants_S_$memory) $a_0@@0))
)) (= _$t0 _$t0))) (and (and (|$IsValid'address'| $t3) (= $t3 _$t0)) (and (= $t4@0 (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) $t3)) (= $t4@0 $t4@0)))) (and (=> (= (ControlFlow 0 13516) 13572) anon10_Then_correct) (=> (= (ControlFlow 0 13516) 13538) anon10_Else_correct))))))
(let ((anon0_correct  (=> (= (ControlFlow 0 15270) 13516) anon0$1_correct)))
anon0_correct)))))))))))
))
(check-sat)
(pop 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15621) (let ((anon11_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 14002) (- 0 15899)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory@1) a) (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) a)))
 :qid |globalinvariantsz3bpl.1425:15|
 :skolemid |41|
))) (=> (forall ((a@@0 Int) ) (!  (=> (|$IsValid'address'| a@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory@1) a@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) a@@0)))
 :qid |globalinvariantsz3bpl.1425:15|
 :skolemid |41|
)) (=> (= (ControlFlow 0 14002) (- 0 15924)) (forall ((a@@1 Int) ) (!  (=> (|$IsValid'address'| a@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) a@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory@1) a@@1)))
 :qid |globalinvariantsz3bpl.1431:15|
 :skolemid |42|
))))))))
(let ((anon11_Then_correct true))
(let ((anon10_Then$1_correct  (=> (= $42_TestGlobalInvariants_R_$memory@1 $42_TestGlobalInvariants_R_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 14068) 14016) anon11_Then_correct) (=> (= (ControlFlow 0 14068) 14002) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) $t7)) (= (ControlFlow 0 14066) 14068)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) $t7) (= $t8@0 (|Select__T@[Int]$42_TestGlobalInvariants_R_| (|contents#$Memory_9970| $42_TestGlobalInvariants_R_$memory) $t7))) (=> (and (and (= $42_TestGlobalInvariants_R_$memory@0 ($Memory_9970 (|Store__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) $t7 false) (|contents#$Memory_9970| $42_TestGlobalInvariants_R_$memory))) (= $42_TestGlobalInvariants_R_$memory@1 $42_TestGlobalInvariants_R_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 13936) 14016) anon11_Then_correct) (=> (= (ControlFlow 0 13936) 14002) anon11_Else_correct))))))
(let ((anon9_Then_correct  (=> $t4@0 (=> (and (|$IsValid'address'| $t7) (= $t7 _$t0)) (and (=> (= (ControlFlow 0 13916) 14066) anon10_Then_correct) (=> (= (ControlFlow 0 13916) 13936) anon10_Else_correct))))))
(let ((anon9_Else_correct true))
(let ((anon0$1_correct  (=> (and (and (and (forall ((a@@2 Int) ) (!  (=> (|$IsValid'address'| a@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) a@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) a@@2)))
 :qid |globalinvariantsz3bpl.1330:20|
 :skolemid |39|
)) (|$IsValid'address'| _$t0)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$42_TestGlobalInvariants_R_| (|contents#$Memory_9970| $42_TestGlobalInvariants_R_$memory) $a_0)))
(|$IsValid'$42_TestGlobalInvariants_R'| $rsc))
 :qid |globalinvariantsz3bpl.1336:20|
 :skolemid |40|
 :pattern ( (|Select__T@[Int]$42_TestGlobalInvariants_R_| (|contents#$Memory_9970| $42_TestGlobalInvariants_R_$memory) $a_0))
)) (= _$t0 _$t0))) (and (and (|$IsValid'address'| $t3) (= $t3 _$t0)) (and (= $t4@0 (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) $t3)) (= $t4@0 $t4@0)))) (and (=> (= (ControlFlow 0 13866) 13916) anon9_Then_correct) (=> (= (ControlFlow 0 13866) 13888) anon9_Else_correct)))))
(let ((anon0_correct  (=> (= (ControlFlow 0 15621) 13866) anon0$1_correct)))
anon0_correct))))))))))
))
(check-sat)
(get-info :reason-unknown)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15969) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 14384) (- 0 16274)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory@1) a)))
 :qid |globalinvariantsz3bpl.1578:15|
 :skolemid |46|
))) (=> (forall ((a@@0 Int) ) (!  (=> (|$IsValid'address'| a@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) a@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory@1) a@@0)))
 :qid |globalinvariantsz3bpl.1578:15|
 :skolemid |46|
)) (=> (and (= $t9@0 (|$x#$42_TestGlobalInvariants_S| $t8)) (= (ControlFlow 0 14384) (- 0 16315))) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) _$t0)))))))))
(let ((L3_correct  (=> (= (ControlFlow 0 14293) (- 0 16254)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) _$t0)))))
(let ((anon12_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 14398) 14293)) L3_correct))))
(let ((anon11_Then$1_correct  (=> (= $42_TestGlobalInvariants_S_$memory@1 $42_TestGlobalInvariants_S_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 14450) 14398) anon12_Then_correct) (=> (= (ControlFlow 0 14450) 14384) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) $t7)) (= (ControlFlow 0 14448) 14450)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) $t7) (= $t8@0 (|Select__T@[Int]$42_TestGlobalInvariants_S_| (|contents#$Memory_10144| $42_TestGlobalInvariants_S_$memory) $t7))) (=> (and (and (= $42_TestGlobalInvariants_S_$memory@0 ($Memory_10144 (|Store__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) $t7 false) (|contents#$Memory_10144| $42_TestGlobalInvariants_S_$memory))) (= $42_TestGlobalInvariants_S_$memory@1 $42_TestGlobalInvariants_S_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 14329) 14398) anon12_Then_correct) (=> (= (ControlFlow 0 14329) 14384) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t4@0 (=> (and (|$IsValid'address'| $t7) (= $t7 _$t0)) (and (=> (= (ControlFlow 0 14309) 14448) anon11_Then_correct) (=> (= (ControlFlow 0 14309) 14329) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (and (not $t4@0) (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 14275) 14293))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((a@@1 Int) ) (!  (=> (|$IsValid'address'| a@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) a@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_10144| $42_TestGlobalInvariants_S_$memory) a@@1)))
...
(|$IsValid'$42_TestGlobalInvariants_S'| $rsc@@0))
 ...
 :skolemid |45|
 :pattern ( (|Select__T@[Int]$42_TestGlobalInvariants_S_| (|contents#$Memory_10144| $42_TestGlobalInvariants_S_$memory) $a_0@@0))
)) (= _$t0 _$t0))) (and (and (|$IsValid'address'| $t3) (= $t3 _$t0)) (and (= $t4@0 (|Select__T@[Int]Bool_| (|domain#$Memory_9970| $42_TestGlobalInvariants_R_$memory) $t3)) (= $t4@0 $t4@0)))) (and (=> (= (ControlFlow 0 14253) 14309) anon10_Then_correct) (=> (= (ControlFlow 0 14253) 14275) anon10_Else_correct))))))
(let ((anon0_correct  (=> (= (ControlFlow 0 15969) 14253) anon0$1_correct)))
anon0_correct)))))))))))
))
(check-sat)
(get-info :reason-unknown)
