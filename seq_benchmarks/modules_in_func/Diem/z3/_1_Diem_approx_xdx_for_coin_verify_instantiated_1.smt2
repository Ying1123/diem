...
(assert (not
 ...
 :qid |Diembpl.8121:15|
 :skolemid |306|
)) (and (=> (= (ControlFlow 0 542243) (- 0 808410)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1)))
 :qid |Diembpl.8126:15|
 :skolemid |307|
 ...
 :qid |Diembpl.8126:15|
 :skolemid |307|
)) (and (=> (= (ControlFlow 0 542243) (- 0 808435)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 542243) (- 0 808456)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256783| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256783| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@3))))
 :qid |Diembpl.8136:15|
 :skolemid |308|
 ...
 :qid |Diembpl.8136:15|
 :skolemid |308|
)) (and (=> (= (ControlFlow 0 542243) (- 0 808485)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256783| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_256783| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5)))
 :qid |Diembpl.8141:15|
 :skolemid |309|
 ...
 :qid |Diembpl.8156:15|
 :skolemid |310|
)) (=> (= (ControlFlow 0 542243) (- 0 808588)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262271| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_262271| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9)))
 :qid |Diembpl.8161:15|
 :skolemid |311|
))))))))))))))))))))))))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (and (and (not false) (= |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1|)) (and (= $t4 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t6  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (> (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4) 0) 0 (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4) 1) |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1| (ite (= (|$value#$1_FixedPoint32_FixedPoint32| $t4) 2) (div |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1| 2) (+ 18446744073709551615 1)))) 18446744073709551615))))) (and (=> (= (ControlFlow 0 541955) 542289) anon7_Then_correct) (=> (= (ControlFlow 0 541955) 542243) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((|inline$$1_Diem_value'$1_XDX_XDX'$0$anon0_correct|  (=> (= _$t0 _$t0) (=> (and (= |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1| (|$value#$1_Diem_Diem'$1_XDX_XDX'| _$t0)) (= |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1|)) (and (=> (= (ControlFlow 0 541901) 542309) anon6_Then_correct) (=> (= (ControlFlow 0 541901) 541955) anon6_Else_correct))))))
(let ((anon0$1_correct  (=> (and (and (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_256313| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 ...
 :qid |Diembpl.8025:20|
 :skolemid |304|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246820| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (|$IsValid'$1_Diem_Diem'$1_XDX_XDX''| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_255621| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0)))
...
))) (and (= _$t0 _$t0) (= (ControlFlow 0 541907) 541901)))) |inline$$1_Diem_value'$1_XDX_XDX'$0$anon0_correct|)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 541635) 541907)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 807964) 541635) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))
))
(check-sat)
(pop 1)
