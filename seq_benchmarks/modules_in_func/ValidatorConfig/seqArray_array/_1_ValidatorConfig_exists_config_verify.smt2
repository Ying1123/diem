...
(assert (not
 (=> (= (ControlFlow 0 0) 103249) (let ((anon0$1_correct@@2  (=> (and (forall ((addr@@69 Int) ) (!  (=> (|$IsValid'address'| addr@@69) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@69) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@69) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@69)) 3))))
 :qid |ValidatorConfigbpl.3968:20|
 :skolemid |164|
)) (forall ((addr@@70 Int) ) (!  (=> (|$IsValid'address'| addr@@70) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@70) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@70) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@70)) 3))))
 :qid |ValidatorConfigbpl.3972:20|
 :skolemid |165|
))) (=> (and (and (and (forall ((addr@@71 Int) ) (!  (=> (|$IsValid'address'| addr@@71) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@71) (not (= (|l#Vec_34709| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@71)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@71) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@71)) 3))))
 :qid |ValidatorConfigbpl.3976:20|
 :skolemid |166|
)) (forall ((addr@@72 Int) ) (!  (=> (|$IsValid'address'| addr@@72) (= (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@72)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@72) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@72)) 3))))
 :qid |ValidatorConfigbpl.3980:20|
 :skolemid |167|
))) (and (|$IsValid'address'| _$t0@@2) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@4)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@4) (and (<= (|l#Vec_34709| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@4))) 1) (<= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@4))) 1))))
 :qid |ValidatorConfigbpl.3986:20|
 :skolemid |168|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@4))
)))) (and (and (= _$t0@@2 _$t0@@2) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@2))) (and (= $t1@0 $t1@0) (= (ControlFlow 0 87356) (- 0 103456))))) (not false)))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_34623_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_34623| stream@@3) 0) (forall ((v@@39 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_34623| stream@@3) v@@39) 0)
 :qid |ValidatorConfigbpl.159:13|
 :skolemid |4|
))))
 :qid |ValidatorConfigbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 87168) 87356)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 103249) 87168) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2))))
))
(check-sat)
(pop 1)
