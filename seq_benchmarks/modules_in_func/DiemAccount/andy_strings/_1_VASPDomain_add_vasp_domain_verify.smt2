...
(get-value ((ControlFlow 0 2045406)))
(get-value ((ControlFlow 0 1099800)))
(get-value ((ControlFlow 0 1099790)))
(get-value ((ControlFlow 0 1100870)))
(get-value ((ControlFlow 0 1100963)))
(get-value ((ControlFlow 0 1100957)))
(get-value ((ControlFlow 0 1100999)))
(get-value ((ControlFlow 0 1101269)))
(get-value ((ControlFlow 0 1101289)))
(get-value ((ControlFlow 0 1101311)))
(get-value ((ControlFlow 0 1101745)))
(get-value ((ControlFlow 0 1101595)))
(get-value ((ControlFlow 0 1101589)))
(get-value ((ControlFlow 0 1101655)))
(get-value ((ControlFlow 0 1101649)))
(get-value ((ControlFlow 0 1101685)))
(get-value ((ControlFlow 0 1101725)))
(get-value ((ControlFlow 0 1101813)))
(get-value ((ControlFlow 0 1101807)))
(get-value ((ControlFlow 0 1101857)))
(get-value ((ControlFlow 0 1101851)))
(get-value ((ControlFlow 0 1101891)))
(get-value ((ControlFlow 0 1102158)))
(get-value ((ControlFlow 0 1102152)))
(get-value ((ControlFlow 0 1102403)))
(assert (not (= (ControlFlow 0 1102403) (- 2047621))))
(check-sat)
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 2045406)))
...
(get-value ((ControlFlow 0 1102152)))
(get-value ((ControlFlow 0 1102403)))
(assert (not (= (ControlFlow 0 1102403) (- 2047669))))
(check-sat)
(pop 1)
; Invalid
