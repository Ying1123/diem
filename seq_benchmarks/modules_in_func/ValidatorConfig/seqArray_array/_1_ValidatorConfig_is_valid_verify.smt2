...
(assert (not
 (=> (= (ControlFlow 0 0) 270770) (let ((anon11_Then_correct@@7  (=> $abort_flag@0@@4 (=> (and (= $abort_code@1@@4 $abort_code@1@@4) (= (ControlFlow 0 199005) (- 0 271073))) false))))
(let ((L3_correct@@2  (=> (= $t1@0@@2 $t1@0@@2) (and (=> (= (ControlFlow 0 198933) (- 0 271133)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 198933) (- 0 271140)) (= $t1@0@@2  (and (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@14) (not (= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@14)))) 0))))) (=> (= $t1@0@@2  (and (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@14) (not (= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@14)))) 0)))) (=> (= (ControlFlow 0 198933) (- 0 271151)) (forall ((addr1@@6 Int) ) (!  (=> (|$IsValid'address'| addr1@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@6) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@6))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@6))))))
 :qid |ValidatorConfigbpl.7640:15|
 :skolemid |234|
))))))))))
(let ((anon11_Else_correct@@7  (=> (and (not $abort_flag@0@@4) (= $t5@0 (|$config#$1_ValidatorConfig_ValidatorConfig| $t3@1))) (=> (and (and (= $t6@@8  (not (= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t5@0)) 0))) (= $t6@@8 $t6@@8)) (and (= $t1@0@@2 $t6@@8) (= (ControlFlow 0 198983) 198933))) L3_correct@@2))))
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3@@6) (=> (and (= $abort_flag@0@@4 true) (= $abort_code@1@@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 199057) 199005) anon11_Then_correct@@7) (=> (= (ControlFlow 0 199057) 198983) anon11_Else_correct@@7))))))
(let ((anon10_Then_correct@@6  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@14)) (= (ControlFlow 0 199055) 199057)) anon10_Then$1_correct)))
(let ((anon10_Else_correct@@6  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@14) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@14)) (= $t3@1 $t3@0)) (and (= $abort_flag@0@@4 false) (= $abort_code@1@@4 $abort_code@0@@4))) (and (=> (= (ControlFlow 0 198951) 199005) anon11_Then_correct@@7) (=> (= (ControlFlow 0 198951) 198983) anon11_Else_correct@@7))))))
(let ((anon9_Then_correct@@4  (=> $t2@0 (and (=> (= (ControlFlow 0 198937) 199055) anon10_Then_correct@@6) (=> (= (ControlFlow 0 198937) 198951) anon10_Else_correct@@6)))))
(let ((anon9_Else_correct@@4  (=> (and (and (not $t2@0) (= false false)) (and (= $t1@0@@2 false) (= (ControlFlow 0 198866) 198933))) L3_correct@@2)))
(let ((anon0$1_correct@@14  (=> (forall ((addr@@108 Int) ) (!  (=> (|$IsValid'address'| addr@@108) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@108) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@108) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@108)) 3))))
 :qid |ValidatorConfigbpl.7525:20|
 :skolemid |230|
)) (=> (and (forall ((addr@@109 Int) ) (!  (=> (|$IsValid'address'| addr@@109) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@109) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@109) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@109)) 3))))
 :qid |ValidatorConfigbpl.7529:20|
 :skolemid |231|
)) (forall ((addr@@110 Int) ) (!  (=> (|$IsValid'address'| addr@@110) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@110) (not (= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@110)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@110) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@110)) 3))))
 :qid |ValidatorConfigbpl.7533:20|
 :skolemid |232|
))) (=> (and (and (|$IsValid'address'| _$t0@@14) (forall (($a_0@@16 Int) ) (! (let (($rsc@@16 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@16)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@16) (and (<= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@16))) 1) (<= (|l#Vec_26921| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@16))) 1))))
 :qid |ValidatorConfigbpl.7540:20|
 :skolemid |233|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@16))
))) (and (= _$t0@@14 _$t0@@14) (= $t2@0 (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@14)))) (and (=> (= (ControlFlow 0 198846) 198937) anon9_Then_correct@@4) (=> (= (ControlFlow 0 198846) 198866) anon9_Else_correct@@4)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@14  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@16 T@$1_Event_EventHandle) ) (! (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_77784_| (|streams#$EventStore| $es) handle@@16)))
 (and (= (|l#Multiset_77784| stream@@15) 0) (forall ((v@@59 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_77784| stream@@15) v@@59) 0)
 :qid |ValidatorConfigbpl.159:13|
 :skolemid |4|
))))
 :qid |ValidatorConfigbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 198689) 198846)) anon0$1_correct@@14)))
(let ((anon0_correct@@14  (=> (= (ControlFlow 0 270770) 198689) inline$$InitEventStore$0$anon0_correct@@14)))
anon0_correct@@14))))))))))))
))
(check-sat)
(pop 1)
