...
function {:inline} $Update'$42_TestInvariants_R'#0''_x(s: $42_TestInvariants_R'#0', x: int): $42_TestInvariants_R'#0' {
    $42_TestInvariants_R'#0'(x, $t#$42_TestInvariants_R'#0'(s))
}
function {:inline} $Update'$42_TestInvariants_R'#0''_t(s: $42_TestInvariants_R'#0', x: #0): $42_TestInvariants_R'#0' {
    $42_TestInvariants_R'#0'($x#$42_TestInvariants_R'#0'(s), x)
}
function $IsValid'$42_TestInvariants_R'#0''(s: $42_TestInvariants_R'#0'): bool {
    $IsValid'u64'($x#$42_TestInvariants_R'#0'(s))
      && $IsValid'#0'($t#$42_TestInvariants_R'#0'(s))
}
function {:inline} $IsEqual'$42_TestInvariants_R'#0''(s1: $42_TestInvariants_R'#0', s2: $42_TestInvariants_R'#0'): bool {
    s1 == s2
}
...
procedure {:timeLimit 40} $42_TestInvariants_get$verify(_$t0: int) returns ($ret0: int)
{
    ...
    if (!$ResourceExists($42_TestInvariants_R'#0'_$memory, $t0)) {
        ...
        $t1 := $ResourceValue($42_TestInvariants_R'#0'_$memory, $t0);
    }
    if ($abort_flag) {
        assume {:print "$at(2,457,470)"} true;
        $t2 := $abort_code;
