...
procedure {:inline 1} $1_RegisteredCurrencies_initialize(_$t0: int) returns ()
{
    ...
    var $1_DiemConfig_Configuration_$memory#180: $Memory $1_DiemConfig_Configuration;
    $t0 := _$t0;
...
L7:
    ...
    // @180 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    $1_DiemConfig_Configuration_$memory#180 := $1_DiemConfig_Configuration_$memory;
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@180](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    assume $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#180), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));
...
L6:
    ...
    // @152 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@152](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
L7:
    ...
    // @170 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@170](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
L2:
    ...
    // trace_local[account#1844]($t17) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:957:13+7
...
// spec fun at /home/ying/diem/language/diem-framework/modules/Authenticator.move:71:10+72
...
// spec fun at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:136:5+94
...
// struct SharedEd25519PublicKey::SharedEd25519PublicKey at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:15:5+268
...
// fun SharedEd25519PublicKey::publish [verification] at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:32:5+375
procedure {:timeLimit 40} $1_SharedEd25519PublicKey_publish$verify(_$t0: int, _$t1: Vec (int)) returns ()
{
    // declare local variables
    var $t2: $1_SharedEd25519PublicKey_SharedEd25519PublicKey;
    var $t3: bool;
    var $t4: int;
    var $t5: int;
    var $t6: int;
    ...
    var $temp_0'u64': int;
    var $temp_0'vec'u8'': Vec (int);
    var $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#140: $Memory $1_SharedEd25519PublicKey_SharedEd25519PublicKey;
    var $1_DiemAccount_DiemAccount_$memory#141: $Memory $1_DiemAccount_DiemAccount;
    var $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#233: $Memory $1_SharedEd25519PublicKey_SharedEd25519PublicKey;
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): Or(DiemAccount::$delegated_key_rotation_capability(addr), DiemAccount::spec_holds_own_key_rotation_cap(addr)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:32:5+375
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2205:9+147
    assume {:print "$at(27,1403,1778)"} true;
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): Or(DiemAccount::spec_holds_delegated_withdraw_capability(addr), DiemAccount::spec_holds_own_withdraw_cap(addr)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:32:5+375
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<Roles::RoleId>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:32:5+375
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:32:5+375
    ...
    // assume forall $rsc: ResourceDomain<SharedEd25519PublicKey::SharedEd25519PublicKey>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:32:5+375
    ...
    // assume Identical($t5, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:48:9+44
    assume {:print "$at(27,1961,2005)"} true;
    assume ($t5 == $1_Signer_spec_address_of($t0));

    // assume Identical($t6, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:966:9+52
    assume {:print "$at(11,43116,43168)"} true;
    assume ($t6 == $1_Signer_spec_address_of($t0));

    // assume Identical($t7, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:62:9+44
    assume {:print "$at(27,2501,2545)"} true;
    assume ($t7 == $1_Signer_spec_address_of($t0));

    // @141 := save_mem(DiemAccount::DiemAccount) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:32:5+1
    assume {:print "$at(27,1403,1404)"} true;
    $1_DiemAccount_DiemAccount_$memory#141 := $1_DiemAccount_DiemAccount_$memory;

    // @140 := save_mem(SharedEd25519PublicKey::SharedEd25519PublicKey) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:32:5+1
    $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#140 := $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory;

    // trace_local[account]($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:32:5+1
    assume {:print "$track_local(31,2,0):", $t0} $t0 == $t0;

    // trace_local[key]($t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:32:5+1
    assume {:print "$track_local(31,2,1):", $t1} $t1 == $t1;

    // $t8 := [] at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:34:18+3
    assume {:print "$at(27,1517,1520)"} true;
    $t8 := $EmptyVec'u8'();
    assume $IsValid'vec'u8''($t8);

    // assume Identical($t9, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:966:9+52
    assume {:print "$at(11,43116,43168)"} true;
    assume ($t9 == $1_Signer_spec_address_of($t0));

    // $t10 := DiemAccount::extract_key_rotation_capability($t0) on_abort goto L3 with $t11 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:35:27+53
    assume {:print "$at(27,1548,1601)"} true;
    call $t10 := $1_DiemAccount_extract_key_rotation_capability($t0);
    if ($abort_flag) {
        assume {:print "$at(27,1548,1601)"} true;
        $t11 := $abort_code;
        assume {:print "$track_abort(31,2):", $t11} $t11 == $t11;
        goto L3;
    }

    // $t2 := pack SharedEd25519PublicKey::SharedEd25519PublicKey($t8, $t10) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:33:17+136
    assume {:print "$at(27,1475,1611)"} true;
    $t2 := $1_SharedEd25519PublicKey_SharedEd25519PublicKey($t8, $t10);

    // trace_local[t]($t2) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:33:13+1
    assume {:print "$track_local(31,2,2):", $t2} $t2 == $t2;

    // $t12 := borrow_local($t2) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:37:21+6
    assume {:print "$at(27,1633,1639)"} true;
    $t12 := $Mutation($Local(2), EmptyVec(), $t2);

    // SharedEd25519PublicKey::rotate_key_($t12, $t1) on_abort goto L3 with $t11 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:37:9+24
    call $t12 := $1_SharedEd25519PublicKey_rotate_key_($t12, $t1);
    if ($abort_flag) {
        assume {:print "$at(27,1621,1645)"} true;
        $t11 := $abort_code;
        assume {:print "$track_abort(31,2):", $t11} $t11 == $t11;
        goto L3;
    }

    // write_back[LocalRoot($t2)@]($t12) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:37:9+24
    $t2 := $Dereference($t12);

    // nop at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:27+27
    // >> opaque call: $t8 := Signer::address_of($t0)
    assume {:print "$at(27,1673,1700)"} true;

    // $t13 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:27+27

    // assume WellFormed($t13) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:27+27
    assume $IsValid'address'($t13);

    // assume Eq<address>($t13, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:27+27
    assume $IsEqual'address'($t13, $1_Signer_spec_address_of($t0));

    // $t13 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:27+27

    // $t14 := SharedEd25519PublicKey::exists_at($t13) on_abort goto L3 with $t11 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:17+38
    call $t14 := $1_SharedEd25519PublicKey_exists_at($t13);
    if ($abort_flag) {
        assume {:print "$at(27,1663,1701)"} true;
        $t11 := $abort_code;
        assume {:print "$track_abort(31,2):", $t11} $t11 == $t11;
        goto L3;
    }

    // $t15 := !($t14) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:16+1
    call $t15 := $Not($t14);

    // $t16 := 1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:83+11
    $t16 := 1;
    assume $IsValid'u64'($t16);

    // nop at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:57+38
    // >> opaque call: $t12 := Errors::already_published($t11)

    // $t17 := opaque begin: Errors::already_published($t16) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:57+38

    // assume WellFormed($t17) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:57+38
    assume $IsValid'u64'($t17);

    // assume Eq<u64>($t17, 6) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:57+38
    assume $IsEqual'u64'($t17, 6);

    // $t17 := opaque end: Errors::already_published($t16) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:57+38

    // trace_local[tmp#$4]($t17) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:9+87
    assume {:print "$track_local(31,2,4):", $t17} $t17 == $t17;

    // trace_local[tmp#$3]($t15) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:9+87
    assume {:print "$track_local(31,2,3):", $t15} $t15 == $t15;

    // if ($t15) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:9+87
    if ($t15) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:9+87
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:9+87

    // trace_abort($t17) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:9+87
    assume {:print "$at(27,1655,1742)"} true;
    assume {:print "$track_abort(31,2):", $t17} $t17 == $t17;

    // $t11 := move($t17) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:9+87
    $t11 := $t17;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:38:9+87
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:39:17+7
    assume {:print "$at(27,1760,1767)"} true;
L0:

    // $t18 := move($t2) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:39:26+1
    $t18 := $t2;

    // @233 := save_mem(SharedEd25519PublicKey::SharedEd25519PublicKey) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:32:5+375
    // state save for global update invariants
    assume {:print "$at(27,1403,1778)"} true;
    $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#233 := $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory;

    // move_to<SharedEd25519PublicKey::SharedEd25519PublicKey>($t18, $t0) on_abort goto L3 with $t11 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:39:9+7
    assume {:print "$at(27,1752,1759)"} true;
    if ($ResourceExists($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
        $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory := $ResourceUpdate($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, $t0, $t18);
    }
    if ($abort_flag) {
        assume {:print "$at(27,1752,1759)"} true;
        $t11 := $abort_code;
    ...
    // assert forall addr: TypeDomain<address>() where exists[@233]<SharedEd25519PublicKey::SharedEd25519PublicKey>(addr): exists<SharedEd25519PublicKey::SharedEd25519PublicKey>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:147:9+136
    // global invariant at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:147:9+136
    assume {:print "$at(27,6036,6172)"} true;
    assert {:msg "assert_failed(27,6036,6172): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#233, addr))  ==> ($ResourceExists($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, addr)));

    // label L2 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:40:5+1
    assume {:print "$at(27,1777,1778)"} true;
L2:

    // assert Not(SharedEd25519PublicKey::$exists_at[@140]($t5)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:57:9+57
    assume {:print "$at(27,2346,2403)"} true;
    assert {:msg "assert_failed(27,2346,2403): function does not abort under this condition"}
      !$1_SharedEd25519PublicKey_$exists_at($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#140, $t5);

    // assert Not(Not(DiemAccount::$exists_at[@141]($t6))) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:967:9+62
    assume {:print "$at(11,43177,43239)"} true;
    assert {:msg "assert_failed(11,43177,43239): function does not abort under this condition"}
      !!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#141, $t6);

    // assert Not(DiemAccount::$delegated_key_rotation_capability[@141](Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:972:9+105
    assume {:print "$at(11,43392,43497)"} true;
    assert {:msg "assert_failed(11,43392,43497): function does not abort under this condition"}
      !$1_DiemAccount_$delegated_key_rotation_capability($1_DiemAccount_DiemAccount_$memory#141, $1_Signer_spec_address_of($t0));

    // assert Not(Not(Signature::$ed25519_validate_pubkey[]($t1))) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:87:9+92
    assume {:print "$at(27,3440,3532)"} true;
    assert {:msg "assert_failed(27,3440,3532): function does not abort under this condition"}
      !!$1_Signature_$ed25519_validate_pubkey($t1);

    // assert Not(Not(DiemAccount::$exists_at[@141](select DiemAccount::KeyRotationCapability.account_address(select SharedEd25519PublicKey::SharedEd25519PublicKey.rotation_cap(pack SharedEd25519PublicKey::SharedEd25519PublicKey([], DiemAccount::spec_get_key_rotation_cap[@141]($t5))))))) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:930:9+69
    assume {:print "$at(11,41337,41406)"} true;
    assert {:msg "assert_failed(11,41337,41406): function does not abort under this condition"}
      !!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#141, $account_address#$1_DiemAccount_KeyRotationCapability($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($1_SharedEd25519PublicKey_SharedEd25519PublicKey($EmptyVec'u8'(), $1_DiemAccount_spec_get_key_rotation_cap($1_DiemAccount_DiemAccount_$memory#141, $t5)))));

    // assert Not(Neq<num>(Len<u8>(Authenticator::spec_ed25519_authentication_key[]($t1)), 32)) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:931:9+74
    ...
    // assert SharedEd25519PublicKey::$exists_at($t7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:64:9+24
    assume {:print "$at(27,2555,2579)"} true;
    assert {:msg "assert_failed(27,2555,2579): post-condition does not hold"}
      $1_SharedEd25519PublicKey_$exists_at($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, $t7);

    // assert Eq<vector<u8>>(select SharedEd25519PublicKey::SharedEd25519PublicKey.key(global<SharedEd25519PublicKey::SharedEd25519PublicKey>($t7)), $t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:96:9+41
    assume {:print "$at(27,3878,3919)"} true;
    assert {:msg "assert_failed(27,3878,3919): post-condition does not hold"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:96:9+41
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:40:5+1
    assume {:print "$at(27,1777,1778)"} true;
L3:

    // assert Or(Or(Or(Or(Or(SharedEd25519PublicKey::$exists_at[@140]($t5), Not(DiemAccount::$exists_at[@141]($t6))), DiemAccount::$delegated_key_rotation_capability[@141](Signer::spec_address_of[]($t0))), Not(Signature::$ed25519_validate_pubkey[]($t1))), Not(DiemAccount::$exists_at[@141](select DiemAccount::KeyRotationCapability.account_address(select SharedEd25519PublicKey::SharedEd25519PublicKey.rotation_cap(pack SharedEd25519PublicKey::SharedEd25519PublicKey([], DiemAccount::spec_get_key_rotation_cap[@141]($t5))))))), Neq<num>(Len<u8>(Authenticator::spec_ed25519_authentication_key[]($t1)), 32)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:41:5+85
    assume {:print "$at(27,1783,1868)"} true;
    assert {:msg "assert_failed(27,1783,1868): abort not covered by any of the `aborts_if` clauses"}
      ((((($1_SharedEd25519PublicKey_$exists_at($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#140, $t5) || !$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#141, $t6)) || $1_DiemAccount_$delegated_key_rotation_capability($1_DiemAccount_DiemAccount_$memory#141, $1_Signer_spec_address_of($t0))) || !$1_Signature_$ed25519_validate_pubkey($t1)) || !$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#141, $account_address#$1_DiemAccount_KeyRotationCapability($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($1_SharedEd25519PublicKey_SharedEd25519PublicKey($EmptyVec'u8'(), $1_DiemAccount_spec_get_key_rotation_cap($1_DiemAccount_DiemAccount_$memory#141, $t5)))))) || !$IsEqual'num'(LenVec($1_Authenticator_spec_ed25519_authentication_key($t1)), 32));

    // assert Or(Or(Or(Or(Or(And(SharedEd25519PublicKey::$exists_at[@140]($t5), Eq(6, $t11)), And(Not(DiemAccount::$exists_at[@141]($t6)), Eq(5, $t11))), And(DiemAccount::$delegated_key_rotation_capability[@141](Signer::spec_address_of[]($t0)), Eq(1, $t11))), And(Not(Signature::$ed25519_validate_pubkey[]($t1)), Eq(7, $t11))), And(Not(DiemAccount::$exists_at[@141](select DiemAccount::KeyRotationCapability.account_address(select SharedEd25519PublicKey::SharedEd25519PublicKey.rotation_cap(pack SharedEd25519PublicKey::SharedEd25519PublicKey([], DiemAccount::spec_get_key_rotation_cap[@141]($t5)))))), Eq(5, $t11))), And(Neq<num>(Len<u8>(Authenticator::spec_ed25519_authentication_key[]($t1)), 32), Eq(7, $t11))) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:41:5+85
    assert {:msg "assert_failed(27,1783,1868): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((($1_SharedEd25519PublicKey_$exists_at($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#140, $t5) && $IsEqual'u8'(6, $t11)) || (!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#141, $t6) && $IsEqual'u8'(5, $t11))) || ($1_DiemAccount_$delegated_key_rotation_capability($1_DiemAccount_DiemAccount_$memory#141, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(1, $t11))) || (!$1_Signature_$ed25519_validate_pubkey($t1) && $IsEqual'u8'(7, $t11))) || (!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#141, $account_address#$1_DiemAccount_KeyRotationCapability($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($1_SharedEd25519PublicKey_SharedEd25519PublicKey($EmptyVec'u8'(), $1_DiemAccount_spec_get_key_rotation_cap($1_DiemAccount_DiemAccount_$memory#141, $t5))))) && $IsEqual'u8'(5, $t11))) || (!$IsEqual'num'(LenVec($1_Authenticator_spec_ed25519_authentication_key($t1)), 32) && $IsEqual'u8'(7, $t11)));

    // abort($t11) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:41:5+85
    $abort_code := $t11;
    $abort_flag := true;
    return;
...
// fun SharedEd25519PublicKey::exists_at [baseline] at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:136:5+94
procedure {:inline 1} $1_SharedEd25519PublicKey_exists_at(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:136:5+1
    assume {:print "$at(27,5728,5729)"} true;
    assume {:print "$track_local(31,0,0):", $t0} $t0 == $t0;

    // $t1 := exists<SharedEd25519PublicKey::SharedEd25519PublicKey>($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:137:9+6
    assume {:print "$at(27,5780,5786)"} true;
    $t1 := $ResourceExists($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, $t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:137:9+36
    assume {:print "$track_return(31,0,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:138:5+1
    assume {:print "$at(27,5821,5822)"} true;
L1:

    // return $t1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:138:5+1
    $ret0 := $t1;
    return;

}

// fun SharedEd25519PublicKey::exists_at [verification] at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:136:5+94
procedure {:timeLimit 40} $1_SharedEd25519PublicKey_exists_at$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:136:5+94
    assume {:print "$at(27,5728,5822)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<SharedEd25519PublicKey::SharedEd25519PublicKey>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:136:5+94
    assume (forall $a_0: int :: {$ResourceValue($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, $a_0)}(var $rsc := $ResourceValue($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, $a_0);
    ($IsValid'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'($rsc))));
...
// fun SharedEd25519PublicKey::key [verification] at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:130:5+208
procedure {:timeLimit 40} $1_SharedEd25519PublicKey_key$verify(_$t0: int) returns ($ret0: Vec (int))
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:130:5+208
    assume {:print "$at(27,5440,5648)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<SharedEd25519PublicKey::SharedEd25519PublicKey>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:130:5+208
    assume (forall $a_0: int :: {$ResourceValue($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, $a_0)}(var $rsc := $ResourceValue($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, $a_0);
    ($IsValid'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'($rsc))));

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:130:5+1
    assume {:print "$track_local(31,1,0):", $t0} $t0 == $t0;

    // $t3 := SharedEd25519PublicKey::exists_at($t0) on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:16+15
    assume {:print "$at(27,5531,5546)"} true;
    call $t3 := $1_SharedEd25519PublicKey_exists_at($t0);
    if ($abort_flag) {
        assume {:print "$at(27,5531,5546)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(31,1):", $t4} $t4 == $t4;
        goto L3;
    }

    // $t5 := 1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:55+11
    $t5 := 1;
    assume $IsValid'u64'($t5);

    // nop at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:33+34
    // >> opaque call: $t5 := Errors::not_published($t4)

    // $t6 := opaque begin: Errors::not_published($t5) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:33+34

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:33+34
    assume $IsValid'u64'($t6);

    // assume Eq<u64>($t6, 5) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:33+34
    assume $IsEqual'u64'($t6, 5);

    // $t6 := opaque end: Errors::not_published($t5) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:33+34

    // trace_local[tmp#$2]($t6) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:9+59
    assume {:print "$track_local(31,1,2):", $t6} $t6 == $t6;

    // trace_local[tmp#$1]($t3) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:9+59
    assume {:print "$track_local(31,1,1):", $t3} $t3 == $t3;

    // if ($t3) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:9+59
    if ($t3) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:9+59
L1:

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:9+59
    assume {:print "$at(27,5524,5583)"} true;
    assume {:print "$track_abort(31,1):", $t6} $t6 == $t6;

    // $t4 := move($t6) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:9+59
    $t4 := $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:131:9+59
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:132:49+4
    assume {:print "$at(27,5633,5637)"} true;
L0:

    // $t7 := get_global<SharedEd25519PublicKey::SharedEd25519PublicKey>($t0) on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:132:11+13
    if (!$ResourceExists($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
    ...
    if ($abort_flag) {
        assume {:print "$at(27,5595,5608)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(31,1):", $t4} $t4 == $t4;
        goto L3;
    }

    // $t8 := get_field<SharedEd25519PublicKey::SharedEd25519PublicKey>.key($t7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:132:10+48
    $t8 := $key#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($t7);

    // trace_return[0]($t8) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:132:9+49
    assume {:print "$track_return(31,1,0):", $t8} $t8 == $t8;

    // label L2 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:133:5+1
    assume {:print "$at(27,5647,5648)"} true;
L2:

    // return $t8 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:133:5+1
    $ret0 := $t8;
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:133:5+1
L3:

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:133:5+1
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun SharedEd25519PublicKey::rotate_key [verification] at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+310
procedure {:timeLimit 40} $1_SharedEd25519PublicKey_rotate_key$verify(_$t0: int, _$t1: Vec (int)) returns ()
{
    // declare local variables
    var $t2: int;
    var $t3: bool;
    ...
    var $temp_0'u64': int;
    var $temp_0'vec'u8'': Vec (int);
    var $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#110: $Memory $1_SharedEd25519PublicKey_SharedEd25519PublicKey;
    var $1_DiemAccount_DiemAccount_$memory#111: $Memory $1_DiemAccount_DiemAccount;
    var $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#232: $Memory $1_SharedEd25519PublicKey_SharedEd25519PublicKey;
    $t0 := _$t0;
    $t1 := _$t1;
    assume IsEmptyVec(p#$Mutation($t12));
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): Or(DiemAccount::$delegated_key_rotation_capability(addr), DiemAccount::spec_holds_own_key_rotation_cap(addr)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+310
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2205:9+147
    assume {:print "$at(27,4353,4663)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> (($1_DiemAccount_$delegated_key_rotation_capability($1_DiemAccount_DiemAccount_$memory, addr) || $1_DiemAccount_spec_holds_own_key_rotation_cap($1_DiemAccount_DiemAccount_$memory, addr))));

    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): Or(DiemAccount::spec_holds_delegated_withdraw_capability(addr), DiemAccount::spec_holds_own_withdraw_cap(addr)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+310
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2235:9+150
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> (($1_DiemAccount_spec_holds_delegated_withdraw_capability($1_DiemAccount_DiemAccount_$memory, addr) || $1_DiemAccount_spec_holds_own_withdraw_cap($1_DiemAccount_DiemAccount_$memory, addr))));

    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<Roles::RoleId>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+310
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2310:9+82
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> ($ResourceExists($1_Roles_RoleId_$memory, addr)));

    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+310
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2329:9+97
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory, addr)));

    // assume true at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+310
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2332:9+115
    assume true;

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+310
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+310
    assume $IsValid'vec'u8''($t1);

    // assume forall $rsc: ResourceDomain<DiemAccount::DiemAccount>(): And(WellFormed($rsc), And(Le(Len<DiemAccount::WithdrawCapability>(select Option::Option.vec(select DiemAccount::DiemAccount.withdraw_capability($rsc))), 1), Le(Len<DiemAccount::KeyRotationCapability>(select Option::Option.vec(select DiemAccount::DiemAccount.key_rotation_capability($rsc))), 1))) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+310
    assume (forall $a_0: int :: {$ResourceValue($1_DiemAccount_DiemAccount_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemAccount_DiemAccount_$memory, $a_0);
    (($IsValid'$1_DiemAccount_DiemAccount'($rsc) && ((LenVec($vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'($withdraw_capability#$1_DiemAccount_DiemAccount($rsc))) <= 1) && (LenVec($vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'($key_rotation_capability#$1_DiemAccount_DiemAccount($rsc))) <= 1))))));

    // assume forall $rsc: ResourceDomain<SharedEd25519PublicKey::SharedEd25519PublicKey>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+310
    assume (forall $a_0: int :: {$ResourceValue($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, $a_0)}(var $rsc := $ResourceValue($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, $a_0);
    ($IsValid'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'($rsc))));

    // assume Identical($t5, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:117:9+44
    assume {:print "$at(27,4866,4910)"} true;
    assume ($t5 == $1_Signer_spec_address_of($t0));

    // assume Identical($t6, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:124:9+44
    assume {:print "$at(27,5171,5215)"} true;
    assume ($t6 == $1_Signer_spec_address_of($t0));

    // @111 := save_mem(DiemAccount::DiemAccount) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+1
    assume {:print "$at(27,4353,4354)"} true;
    $1_DiemAccount_DiemAccount_$memory#111 := $1_DiemAccount_DiemAccount_$memory;

    // @110 := save_mem(SharedEd25519PublicKey::SharedEd25519PublicKey) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+1
    $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#110 := $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory;

    // trace_local[account]($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+1
    assume {:print "$track_local(31,3,0):", $t0} $t0 == $t0;

    // trace_local[new_public_key]($t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+1
    assume {:print "$track_local(31,3,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:106:20+27
    // >> opaque call: $t5 := Signer::address_of($t0)
    assume {:print "$at(27,4474,4501)"} true;

    // $t7 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:106:20+27

    // assume WellFormed($t7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:106:20+27
    assume $IsValid'address'($t7);

    // assume Eq<address>($t7, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:106:20+27
    assume $IsEqual'address'($t7, $1_Signer_spec_address_of($t0));

    // $t7 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:106:20+27

    // trace_local[addr]($t7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:106:13+4
    assume {:print "$track_local(31,3,2):", $t7} $t7 == $t7;

    // $t8 := SharedEd25519PublicKey::exists_at($t7) on_abort goto L3 with $t9 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:16+15
    assume {:print "$at(27,4518,4533)"} true;
    call $t8 := $1_SharedEd25519PublicKey_exists_at($t7);
    if ($abort_flag) {
        assume {:print "$at(27,4518,4533)"} true;
        $t9 := $abort_code;
        assume {:print "$track_abort(31,3):", $t9} $t9 == $t9;
        goto L3;
    }

    // $t10 := 1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:55+11
    $t10 := 1;
    assume $IsValid'u64'($t10);

    // nop at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:33+34
    // >> opaque call: $t8 := Errors::not_published($t7)

    // $t11 := opaque begin: Errors::not_published($t10) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:33+34

    // assume WellFormed($t11) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:33+34
    assume $IsValid'u64'($t11);

    // assume Eq<u64>($t11, 5) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:33+34
    assume $IsEqual'u64'($t11, 5);

    // $t11 := opaque end: Errors::not_published($t10) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:33+34

    // trace_local[tmp#$4]($t11) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:9+59
    assume {:print "$track_local(31,3,4):", $t11} $t11 == $t11;

    // trace_local[tmp#$3]($t8) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:9+59
    assume {:print "$track_local(31,3,3):", $t8} $t8 == $t8;

    // if ($t8) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:9+59
    if ($t8) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:9+59
L1:

    // trace_abort($t11) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:9+59
    assume {:print "$at(27,4511,4570)"} true;
    assume {:print "$track_abort(31,3):", $t11} $t11 == $t11;

    // $t9 := move($t11) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:9+59
    $t9 := $t11;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:107:9+59
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:108:63+4
    assume {:print "$at(27,4634,4638)"} true;
L0:

    // $t12 := borrow_global<SharedEd25519PublicKey::SharedEd25519PublicKey>($t7) on_abort goto L3 with $t9 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:108:21+17
    ...
    if ($abort_flag) {
        assume {:print "$at(27,4592,4609)"} true;
        $t9 := $abort_code;
        assume {:print "$track_abort(31,3):", $t9} $t9 == $t9;
        goto L3;
    }

    // SharedEd25519PublicKey::rotate_key_($t12, $t1) on_abort goto L3 with $t9 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:108:9+76
    call $t12 := $1_SharedEd25519PublicKey_rotate_key_($t12, $t1);
    if ($abort_flag) {
        assume {:print "$at(27,4580,4656)"} true;
        $t9 := $abort_code;
        assume {:print "$track_abort(31,3):", $t9} $t9 == $t9;
        goto L3;
    }

    // @232 := save_mem(SharedEd25519PublicKey::SharedEd25519PublicKey) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:5+310
    // state save for global update invariants
    assume {:print "$at(27,4353,4663)"} true;
    $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#232 := $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory;

    // write_back[SharedEd25519PublicKey::SharedEd25519PublicKey@]($t12) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:108:9+76
    assume {:print "$at(27,4580,4656)"} true;
    ...
    // assert forall addr: TypeDomain<address>() where exists[@232]<SharedEd25519PublicKey::SharedEd25519PublicKey>(addr): exists<SharedEd25519PublicKey::SharedEd25519PublicKey>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:147:9+136
    // global invariant at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:147:9+136
    assume {:print "$at(27,6036,6172)"} true;
    assert {:msg "assert_failed(27,6036,6172): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#232, addr))  ==> ($ResourceExists($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory, addr)));

    // label L2 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:109:5+1
    assume {:print "$at(27,4662,4663)"} true;
L2:

    // assert Not(Not(SharedEd25519PublicKey::$exists_at[@110]($t5))) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:118:9+54
    assume {:print "$at(27,4919,4973)"} true;
    assert {:msg "assert_failed(27,4919,4973): function does not abort under this condition"}
      !!$1_SharedEd25519PublicKey_$exists_at($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#110, $t5);
    ...
    // assert Not(Not(DiemAccount::$exists_at[@111](select DiemAccount::KeyRotationCapability.account_address(select SharedEd25519PublicKey::SharedEd25519PublicKey.rotation_cap(global[@110]<SharedEd25519PublicKey::SharedEd25519PublicKey>($t5)))))) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:930:9+69
    assume {:print "$at(11,41337,41406)"} true;
    assert {:msg "assert_failed(11,41337,41406): function does not abort under this condition"}
      !!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#111, $account_address#$1_DiemAccount_KeyRotationCapability($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($ResourceValue($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#110, $t5))));
    ...
    // assert Eq<vector<u8>>(select SharedEd25519PublicKey::SharedEd25519PublicKey.key(global<SharedEd25519PublicKey::SharedEd25519PublicKey>($t6)), $t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:96:9+41
    assume {:print "$at(27,3878,3919)"} true;
    assert {:msg "assert_failed(27,3878,3919): post-condition does not hold"}
    ...
    // label L3 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:109:5+1
    assume {:print "$at(27,4662,4663)"} true;
L3:

    // assert Or(Or(Or(Not(SharedEd25519PublicKey::$exists_at[@110]($t5)), Not(Signature::$ed25519_validate_pubkey[]($t1))), Not(DiemAccount::$exists_at[@111](select DiemAccount::KeyRotationCapability.account_address(select SharedEd25519PublicKey::SharedEd25519PublicKey.rotation_cap(global[@110]<SharedEd25519PublicKey::SharedEd25519PublicKey>($t5)))))), Neq<num>(Len<u8>(Authenticator::spec_ed25519_authentication_key[]($t1)), 32)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:110:5+92
    assume {:print "$at(27,4668,4760)"} true;
    assert {:msg "assert_failed(27,4668,4760): abort not covered by any of the `aborts_if` clauses"}
      (((!$1_SharedEd25519PublicKey_$exists_at($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#110, $t5) || !$1_Signature_$ed25519_validate_pubkey($t1)) || !$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#111, $account_address#$1_DiemAccount_KeyRotationCapability($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($ResourceValue($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#110, $t5))))) || !$IsEqual'num'(LenVec($1_Authenticator_spec_ed25519_authentication_key($t1)), 32));

    // assert Or(Or(Or(And(Not(SharedEd25519PublicKey::$exists_at[@110]($t5)), Eq(5, $t9)), And(Not(Signature::$ed25519_validate_pubkey[]($t1)), Eq(7, $t9))), And(Not(DiemAccount::$exists_at[@111](select DiemAccount::KeyRotationCapability.account_address(select SharedEd25519PublicKey::SharedEd25519PublicKey.rotation_cap(global[@110]<SharedEd25519PublicKey::SharedEd25519PublicKey>($t5))))), Eq(5, $t9))), And(Neq<num>(Len<u8>(Authenticator::spec_ed25519_authentication_key[]($t1)), 32), Eq(7, $t9))) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:110:5+92
    assert {:msg "assert_failed(27,4668,4760): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((!$1_SharedEd25519PublicKey_$exists_at($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#110, $t5) && $IsEqual'u8'(5, $t9)) || (!$1_Signature_$ed25519_validate_pubkey($t1) && $IsEqual'u8'(7, $t9))) || (!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#111, $account_address#$1_DiemAccount_KeyRotationCapability($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($ResourceValue($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#110, $t5)))) && $IsEqual'u8'(5, $t9))) || (!$IsEqual'num'(LenVec($1_Authenticator_spec_ed25519_authentication_key($t1)), 32) && $IsEqual'u8'(7, $t9)));

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:110:5+92
    $abort_code := $t9;
    $abort_flag := true;
    return;
...
// fun SharedEd25519PublicKey::rotate_key_ [baseline] at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+515
procedure {:inline 1} $1_SharedEd25519PublicKey_rotate_key_(_$t0: $Mutation ($1_SharedEd25519PublicKey_SharedEd25519PublicKey), _$t1: Vec (int)) returns ($ret0: $Mutation ($1_SharedEd25519PublicKey_SharedEd25519PublicKey))
{
    ...
    // bytecode translation starts here
    // trace_local[shared_key]($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+1
    assume {:print "$at(27,2699,2700)"} true;
    $temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey' := $Dereference($t0);
    assume {:print "$track_local(31,4,0):", $temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'} $temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey' == $temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey';

    // trace_local[new_public_key]($t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+1
    assume {:print "$track_local(31,4,1):", $t1} $t1 == $t1;

    // $t4 := Signature::ed25519_validate_pubkey($t1) on_abort goto L3 with $t5 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:71:13+55
    assume {:print "$at(27,2868,2923)"} true;
    ...
    // $t6 := 0 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:72:38+21
    assume {:print "$at(27,2962,2983)"} true;
    $t6 := 0;
    assume $IsValid'u64'($t6);

    // nop at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:72:13+47
    // >> opaque call: $t6 := Errors::invalid_argument($t5)

    // $t7 := opaque begin: Errors::invalid_argument($t6) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:72:13+47

    // assume WellFormed($t7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:72:13+47
    assume $IsValid'u64'($t7);

    // assume Eq<u64>($t7, 7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:72:13+47
    assume $IsEqual'u64'($t7, 7);

    // $t7 := opaque end: Errors::invalid_argument($t6) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:72:13+47

    // trace_local[tmp#$3]($t7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
    assume {:print "$at(27,2848,2994)"} true;
    assume {:print "$track_local(31,4,3):", $t7} $t7 == $t7;

    // trace_local[tmp#$2]($t4) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
    assume {:print "$track_local(31,4,2):", $t4} $t4 == $t4;

    // if ($t4) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
    if ($t4) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146

    // trace_abort($t7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
    assume {:print "$at(27,2848,2994)"} true;
    assume {:print "$track_abort(31,4):", $t7} $t7 == $t7;

    // $t5 := move($t7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
    $t5 := $t7;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:75:14+10
    assume {:print "$at(27,3057,3067)"} true;
L0:

    // $t8 := get_field<SharedEd25519PublicKey::SharedEd25519PublicKey>.rotation_cap($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:75:13+24
    $t8 := $rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($Dereference($t0));

    // nop at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:76:13+62
    // >> opaque call: $t8 := Authenticator::ed25519_authentication_key($t1)
    assume {:print "$at(27,3094,3156)"} true;

    // $t9 := opaque begin: Authenticator::ed25519_authentication_key($t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:76:13+62

    // assume WellFormed($t9) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:76:13+62
    assume $IsValid'vec'u8''($t9);

    // assume Eq<vector<u8>>($t9, Authenticator::spec_ed25519_authentication_key($t1)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:76:13+62
    assume $IsEqual'vec'u8''($t9, $1_Authenticator_spec_ed25519_authentication_key($t1));

    // $t9 := opaque end: Authenticator::ed25519_authentication_key($t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:76:13+62

    // DiemAccount::rotate_authentication_key($t8, $t9) on_abort goto L3 with $t5 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:74:9+162
    assume {:print "$at(27,3004,3166)"} true;
    ...
    // $t10 := borrow_field<SharedEd25519PublicKey::SharedEd25519PublicKey>.key($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:78:9+14
    assume {:print "$at(27,3176,3190)"} true;
    $t10 := $ChildMutation($t0, 0, $key#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($Dereference($t0)));

    // write_ref($t10, $t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:78:9+31
    $t10 := $UpdateMutation($t10, $t1);

    // write_back[Reference($t0).key]($t10) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:78:9+31
    $t0 := $UpdateMutation($t0, $Update'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'_key($Dereference($t0), $Dereference($t10)));

    // trace_local[shared_key]($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:78:40+1
    $temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey' := $Dereference($t0);
    assume {:print "$track_local(31,4,0):", $temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'} $temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey' == $temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey';

    // label L2 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:79:5+1
    assume {:print "$at(27,3213,3214)"} true;
L2:

    // return () at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:79:5+1
    $ret0 := $t0;
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:79:5+1
L3:

    // abort($t5) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:79:5+1
    $abort_code := $t5;
    $abort_flag := true;
    return;
...
// fun SharedEd25519PublicKey::rotate_key_ [verification] at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+515
procedure {:timeLimit 40} $1_SharedEd25519PublicKey_rotate_key_$verify(_$t0: $Mutation ($1_SharedEd25519PublicKey_SharedEd25519PublicKey), _$t1: Vec (int)) returns ($ret0: $Mutation ($1_SharedEd25519PublicKey_SharedEd25519PublicKey))
{
    ...
    var $temp_0'u64': int;
    var $temp_0'vec'u8'': Vec (int);
    var $1_DiemAccount_DiemAccount_$memory#105: $Memory $1_DiemAccount_DiemAccount;
    $t0 := _$t0;
    $t1 := _$t1;
    assume IsEmptyVec(p#$Mutation($t11));
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): Or(DiemAccount::$delegated_key_rotation_capability(addr), DiemAccount::spec_holds_own_key_rotation_cap(addr)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+515
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2205:9+147
    assume {:print "$at(27,2699,3214)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> (($1_DiemAccount_$delegated_key_rotation_capability($1_DiemAccount_DiemAccount_$memory, addr) || $1_DiemAccount_spec_holds_own_key_rotation_cap($1_DiemAccount_DiemAccount_$memory, addr))));

    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): Or(DiemAccount::spec_holds_delegated_withdraw_capability(addr), DiemAccount::spec_holds_own_withdraw_cap(addr)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+515
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2235:9+150
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> (($1_DiemAccount_spec_holds_delegated_withdraw_capability($1_DiemAccount_DiemAccount_$memory, addr) || $1_DiemAccount_spec_holds_own_withdraw_cap($1_DiemAccount_DiemAccount_$memory, addr))));

    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<Roles::RoleId>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+515
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2310:9+82
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> ($ResourceExists($1_Roles_RoleId_$memory, addr)));

    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+515
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2329:9+97
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory, addr)));

    // assume true at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+515
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2332:9+115
    assume true;

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+515
    assume $IsValid'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'($Dereference($t0));

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+515
    assume $IsValid'vec'u8''($t1);

    // assume forall $rsc: ResourceDomain<DiemAccount::DiemAccount>(): And(WellFormed($rsc), And(Le(Len<DiemAccount::WithdrawCapability>(select Option::Option.vec(select DiemAccount::DiemAccount.withdraw_capability($rsc))), 1), Le(Len<DiemAccount::KeyRotationCapability>(select Option::Option.vec(select DiemAccount::DiemAccount.key_rotation_capability($rsc))), 1))) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+515
    assume (forall $a_0: int :: {$ResourceValue($1_DiemAccount_DiemAccount_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemAccount_DiemAccount_$memory, $a_0);
    (($IsValid'$1_DiemAccount_DiemAccount'($rsc) && ((LenVec($vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'($withdraw_capability#$1_DiemAccount_DiemAccount($rsc))) <= 1) && (LenVec($vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'($key_rotation_capability#$1_DiemAccount_DiemAccount($rsc))) <= 1))))));

    // @105 := save_mem(DiemAccount::DiemAccount) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+1
    $1_DiemAccount_DiemAccount_$memory#105 := $1_DiemAccount_DiemAccount_$memory;

    // $t4 := read_ref($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:68:5+1
    $t4 := $Dereference($t0);
    ...
    // $t5 := Signature::ed25519_validate_pubkey($t1) on_abort goto L3 with $t6 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:71:13+55
    assume {:print "$at(27,2868,2923)"} true;
    call $t5 := $1_Signature_ed25519_validate_pubkey($t1);
    if ($abort_flag) {
        assume {:print "$at(27,2868,2923)"} true;
        $t6 := $abort_code;
        assume {:print "$track_abort(31,4):", $t6} $t6 == $t6;
        goto L3;
    }

    // $t7 := 0 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:72:38+21
    assume {:print "$at(27,2962,2983)"} true;
    $t7 := 0;
    assume $IsValid'u64'($t7);
    ...
    // $t8 := opaque begin: Errors::invalid_argument($t7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:72:13+47

    // assume WellFormed($t8) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:72:13+47
    assume $IsValid'u64'($t8);

    // assume Eq<u64>($t8, 7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:72:13+47
    assume $IsEqual'u64'($t8, 7);

    // $t8 := opaque end: Errors::invalid_argument($t7) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:72:13+47

    // trace_local[tmp#$3]($t8) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
    assume {:print "$at(27,2848,2994)"} true;
    assume {:print "$track_local(31,4,3):", $t8} $t8 == $t8;

    // trace_local[tmp#$2]($t5) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
    assume {:print "$track_local(31,4,2):", $t5} $t5 == $t5;

    // if ($t5) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
    if ($t5) { goto L0; } else { goto L1; }
...
L1:
    ...
    // trace_abort($t8) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
    assume {:print "$at(27,2848,2994)"} true;
    assume {:print "$track_abort(31,4):", $t8} $t8 == $t8;

    // $t6 := move($t8) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:70:9+146
    $t6 := $t8;
...
L0:
    ...
    // $t9 := get_field<SharedEd25519PublicKey::SharedEd25519PublicKey>.rotation_cap($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:75:13+24
    ...
    // $t10 := opaque begin: Authenticator::ed25519_authentication_key($t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:76:13+62

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:76:13+62
    assume $IsValid'vec'u8''($t10);

    // assume Eq<vector<u8>>($t10, Authenticator::spec_ed25519_authentication_key($t1)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:76:13+62
    assume $IsEqual'vec'u8''($t10, $1_Authenticator_spec_ed25519_authentication_key($t1));

    // $t10 := opaque end: Authenticator::ed25519_authentication_key($t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:76:13+62

    // DiemAccount::rotate_authentication_key($t9, $t10) on_abort goto L3 with $t6 at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:74:9+162
    assume {:print "$at(27,3004,3166)"} true;
    ...
    // $t11 := borrow_field<SharedEd25519PublicKey::SharedEd25519PublicKey>.key($t0) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:78:9+14
    assume {:print "$at(27,3176,3190)"} true;
    $t11 := $ChildMutation($t0, 0, $key#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($Dereference($t0)));

    // write_ref($t11, $t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:78:9+31
    $t11 := $UpdateMutation($t11, $t1);

    // write_back[Reference($t0).key]($t11) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:78:9+31
...
L2:
    ...
    // assert Not(Not(DiemAccount::$exists_at[@105](select DiemAccount::KeyRotationCapability.account_address(select SharedEd25519PublicKey::SharedEd25519PublicKey.rotation_cap($t4))))) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:930:9+69
    assume {:print "$at(11,41337,41406)"} true;
    assert {:msg "assert_failed(11,41337,41406): function does not abort under this condition"}
      !!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#105, $account_address#$1_DiemAccount_KeyRotationCapability($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($t4)));
    ...
    // assert Eq<vector<u8>>(select SharedEd25519PublicKey::SharedEd25519PublicKey.key($t0), $t1) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:96:9+41
    assume {:print "$at(27,3878,3919)"} true;
    assert {:msg "assert_failed(27,3878,3919): post-condition does not hold"}
...
L3:
    ...
    // assert Or(Or(Not(Signature::$ed25519_validate_pubkey[]($t1)), Not(DiemAccount::$exists_at[@105](select DiemAccount::KeyRotationCapability.account_address(select SharedEd25519PublicKey::SharedEd25519PublicKey.rotation_cap($t4))))), Neq<num>(Len<u8>(Authenticator::spec_ed25519_authentication_key[]($t1)), 32)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:80:5+95
    assume {:print "$at(27,3219,3314)"} true;
    assert {:msg "assert_failed(27,3219,3314): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_Signature_$ed25519_validate_pubkey($t1) || !$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#105, $account_address#$1_DiemAccount_KeyRotationCapability($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($t4)))) || !$IsEqual'num'(LenVec($1_Authenticator_spec_ed25519_authentication_key($t1)), 32));

    // assert Or(Or(And(Not(Signature::$ed25519_validate_pubkey[]($t1)), Eq(7, $t6)), And(Not(DiemAccount::$exists_at[@105](select DiemAccount::KeyRotationCapability.account_address(select SharedEd25519PublicKey::SharedEd25519PublicKey.rotation_cap($t4)))), Eq(5, $t6))), And(Neq<num>(Len<u8>(Authenticator::spec_ed25519_authentication_key[]($t1)), 32), Eq(7, $t6))) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:80:5+95
    assert {:msg "assert_failed(27,3219,3314): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_Signature_$ed25519_validate_pubkey($t1) && $IsEqual'u8'(7, $t6)) || (!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#105, $account_address#$1_DiemAccount_KeyRotationCapability($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($t4))) && $IsEqual'u8'(5, $t6))) || (!$IsEqual'num'(LenVec($1_Authenticator_spec_ed25519_authentication_key($t1)), 32) && $IsEqual'u8'(7, $t6)));

    // abort($t6) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:80:5+95
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
L8:
    ...
    // @146 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@146](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    ...
    assume {:print "$track_local(32,5,1):", $t14} $t14 == $t14;
...
L1:
    ...
    assume {:print "$at(16,4819,4969)"} true;
    assume {:print "$track_abort(32,5):", $t20} $t20 == $t20;
...
procedure {:inline 1} $1_DiemBlock_is_initialized() returns ($ret0: bool)
{
    ...
    if ($abort_flag) {
        assume {:print "$at(12,2071,2105)"} true;
        $t1 := $abort_code;
        assume {:print "$track_abort(33,3):", $t1} $t1 == $t1;
        goto L2;
    }
    ...
    assume {:print "$track_return(33,3,0):", $t2} $t2 == $t2;
...
L5:
    ...
    assume {:print "$at(12,1165,1196)"} true;
    assume {:print "$track_abort(33,2):", $t4} $t4 == $t4;
...
L1:
    ...
    assume {:print "$track_abort(33,2):", $t9} $t9 == $t9;
...
procedure {:inline 1} $1_DiemVMConfig_initialize(_$t0: int, _$t1: Vec (int), _$t2: Vec (int)) returns ()
{
    ...
    assume {:print "$track_local(34,0,2):", $t2} $t2 == $t2;
...
L4:
    ...
    assume {:print "$at(19,3563,3594)"} true;
    assume {:print "$track_abort(34,0):", $t8} $t8 == $t8;
...
L7:
    ...
    // @164 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@164](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L4:
    ...
    assume {:print "$at(20,690,721)"} true;
    assume {:print "$track_abort(35,0):", $t5} $t5 == $t5;
...
L7:
    ...
    // @158 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@158](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
...
procedure {:timeLimit 40} $1_Genesis_initialize$verify(_$t0: int, _$t1: int, _$t2: Vec (int), _$t3: Vec (int), _$t4: Vec (Vec (int)), _$t5: bool, _$t6: Vec (int), _$t7: Vec (int), _$t8: int, _$t9: int) returns ()
{
    ...
    // trace_local[dr_account#2102]($t0) at /home/ying/diem/language/diem-framework/modules/Genesis.move:42:13+10
    assume {:print "$at(22,1252,1262)"} true;
    assume {:print "$track_local(36,1,10):", $t0} $t0 == $t0;

    // trace_local[tc_account#2103]($t1) at /home/ying/diem/language/diem-framework/modules/Genesis.move:43:13+10
    assume {:print "$at(22,1290,1300)"} true;
    assume {:print "$track_local(36,1,12):", $t1} $t1 == $t1;
...
L4:
    ...
    assume {:print "$at(22,1325,1397)"} true;
    assume {:print "$track_abort(36,1):", $t20} $t20 == $t20;
...
L7:
    ...
    assume {:print "$track_local(36,1,11):", $t47} $t47 == $t47;
    ...
    assume {:print "$track_local(36,1,13):", $t49} $t49 == $t49;
