...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 279484) (let ((anon15_Then_correct  (=> $t15@0 (and (=> (= (ControlFlow 0 199142) (- 0 279820)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6))) (and (=> (= (ControlFlow 0 199142) (- 0 279832)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) 5)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) 5))) (and (=> (= (ControlFlow 0 199142) (- 0 279850)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0))))
 :qid |Rolesbpl.6034:15|
 :skolemid |159|
 ...
 :qid |Rolesbpl.6054:15|
 :skolemid |164|
)) (=> (= (ControlFlow 0 199142) (- 0 280144)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6))))
 :qid |Rolesbpl.6058:15|
 :skolemid |165|
))))))))))))))))))))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 198657) (- 0 280224)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) 5)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) 5))) (=> (= (ControlFlow 0 198657) (- 0 280246)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) (= 5 $t11@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t6)) 5)) (= 3 $t11@0))))))))
(let ((anon15_Else_correct  (=> (and (and (not $t15@0) (= $t17 $t17)) (and (= $t11@0 $t17) (= (ControlFlow 0 198747) 198657))) L5_correct)))
(let ((anon14_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= $t13@0 (|$role_id#$1_Roles_RoleId| $t12@1)) (|$IsValid'u64'| 5)) (and (= $t15@0 (= $t13@0 5)) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t17) (= $t17 3)) (and (= $t17 $t17) (= $t15@0 $t15@0)))) (and (=> (= (ControlFlow 0 198731) 199142) anon15_Then_correct) (=> (= (ControlFlow 0 198731) 198747) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t11@0 $abort_code@1) (= (ControlFlow 0 199156) 198657))) L5_correct)))
(let ((anon13_Then$1_correct  (=> (= $t12@1 $t12) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 199208) 199156) anon14_Then_correct) (=> (= (ControlFlow 0 199208) 198731) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t7)) (= (ControlFlow 0 199206) 199208)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t7) (=> (and (and (= $t12@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t7)) (= $t12@1 $t12@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 198675) 199156) anon14_Then_correct) (=> (= (ControlFlow 0 198675) 198731) anon14_Else_correct))))))
(let ((anon12_Then_correct  (=> $t8@0 (and (=> (= (ControlFlow 0 198661) 199206) anon13_Then_correct) (=> (= (ControlFlow 0 198661) 198675) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not $t8@0) (= $t10 $t10)) (and (= $t11@0 $t10) (= (ControlFlow 0 198585) 198657))) L5_correct)))
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Rolesbpl.5872:20|
 :skolemid |158|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $a_0))
)) (= $t6 (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (|$IsValid'address'| $t7))) (=> (and (and (and (= $t7 (|$addr#$signer| _$t0)) (= $t7 $t7)) (and (= $t8@0 (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t7)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t10) (= $t10 5)) (and (= $t10 $t10) (= $t8@0 $t8@0)))) (and (=> (= (ControlFlow 0 198569) 198661) anon12_Then_correct) (=> (= (ControlFlow 0 198569) 198585) anon12_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_83264_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 198453) 198569)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 279484) 198453) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))
))
(check-sat)
(pop 1)
