...
(declare-fun $t34 () T@$Mutation_135134)
...
(declare-fun $t15 () Int)
(declare-fun $t17 () Int)
(declare-fun $t7 () T@$Mutation_135073)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 226845) (let ((anon46_Else_correct  (=> (and (not $abort_flag@3) (= $t38 (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory@0) _$t1)))) (and (=> (= (ControlFlow 0 169315) (- 0 229111)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t1))) (and (=> (= (ControlFlow 0 169315) (- 0 229122)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (and (=> (= (ControlFlow 0 169315) (- 0 229132)) (not (not (exists ((i@@44 Int) ) (!  (and (and (|$IsValid'u64'| i@@44) (and (>= i@@44 0) (< i@@44 (seq.len $t11)))) (= (seq.nth $t11 i@@44) ($1_DiemId_DiemIdDomain _$t2)))
 :qid |DiemIdbpl.1140:13|
 :skolemid |32|
))))) (=> (not (not (exists ((i@@45 Int) ) (!  (and (and (|$IsValid'u64'| i@@45) (and (>= i@@45 0) (< i@@45 (seq.len $t11)))) (= (seq.nth $t11 i@@45) ($1_DiemId_DiemIdDomain _$t2)))
 :qid |DiemIdbpl.1140:13|
 :skolemid |32|
)))) (and (=> (= (ControlFlow 0 169315) (- 0 229146)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t12))) (and (=> (= (ControlFlow 0 169315) (- 0 229158)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t12)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t12)) 1))) (and (=> (= (ControlFlow 0 169315) (- 0 229176)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 169315) (- 0 229190)) (not (> (seq.len _$t2) 63))) (=> (not (> (seq.len _$t2) 63)) (and (=> (= (ControlFlow 0 169315) (- 0 229202)) (not (exists ((i@@46 Int) ) (!  (and (and (|$IsValid'u64'| i@@46) (and (>= i@@46 0) (< i@@46 (seq.len $t38)))) (= (seq.nth $t38 i@@46) ($1_DiemId_DiemIdDomain _$t2)))
 :qid |DiemIdbpl.1140:13|
 :skolemid |32|
)))) (=> (not (exists ((i@@47 Int) ) (!  (and (and (|$IsValid'u64'| i@@47) (and (>= i@@47 0) (< i@@47 (seq.len $t38)))) (= (seq.nth $t38 i@@47) ($1_DiemId_DiemIdDomain _$t2)))
 :qid |DiemIdbpl.1140:13|
 :skolemid |32|
))) (and (=> (= (ControlFlow 0 169315) (- 0 229214)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_69963_| (|streams#$EventStore| $EmptyEventStore) $t13 stream_new@@0))))))
 ...
 :qid |DiemIdbpl.2744:13|
 :skolemid |75|
))))) (=> (= (ControlFlow 0 169315) (- 0 229239)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
(let ((anon46_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t17@0 $abort_code@4) (= (ControlFlow 0 169329) 167700))) L7_correct)))
(let ((|inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$handle@1| (|v#$Mutation_94598| $t35@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_69963_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_69963| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_69963| stream@@3) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t37@0))))
(Multiset_69963 (|Store__T@[$EventRep]Int_| (|v#Multiset_69963| stream@@3) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t37@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_69963_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 169125) 169329) anon46_Then_correct) (=> (= (ControlFlow 0 169125) 169315) anon46_Else_correct)))))
(let ((anon45_Else_correct  (=> (and (and (not $abort_flag@3) (= $t35@0 ($Mutation_94598 (|l#$Mutation_135134| $t34@1) (seq.++ (|p#$Mutation_135134| $t34@1) (seq.unit 0)) (|$diem_id_domain_events#$1_DiemId_DiemIdDomainManager| (|v#$Mutation_135134| $t34@1))))) (and (= $t37@0 ($1_DiemId_DiemIdDomainEvent true inline$$1_DiemId_create_diem_id_domain$0$$ret0@1 _$t1)) (= (ControlFlow 0 169131) 169125))) |inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|)))
(let ((anon45_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t17@0 $abort_code@4) (= (ControlFlow 0 169343) 167700))) L7_correct)))
(let ((anon44_Then$1_correct  (=> (= $t34@1 $t34) (=> (and (= $abort_flag@3 true) (= $abort_code@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 169395) 169343) anon45_Then_correct) (=> (= (ControlFlow 0 169395) 169131) anon45_Else_correct))))))
(let ((anon44_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (= (ControlFlow 0 169393) 169395)) anon44_Then$1_correct)))
(let ((anon44_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) 186537453) (=> (and (and (= $t34@0 ($Mutation_135134 ($Global 186537453) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (= $t34@1 $t34@0)) (and (= $abort_flag@3 $abort_flag@2) (= $abort_code@4 $abort_code@3))) (and (=> (= (ControlFlow 0 169016) 169343) anon45_Then_correct) (=> (= (ControlFlow 0 169016) 169131) anon45_Else_correct))))))
(let ((anon43_Else_correct  (=> (and (not $abort_flag@2) (= $t24@2 ($Mutation_135073 (|l#$Mutation_135073| $t24@1) (|p#$Mutation_135073| $t24@1) ($1_DiemId_DiemIdDomains (|v#$Mutation_78479| |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@2|))))) (and (=> (= (ControlFlow 0 168994) (- 0 228489)) (let (($range_0 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_135073| $t24@2))))))
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| (seq.nth (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_135073| $t24@2)) i@@52))) 63)))
 :qid |DiemIdbpl.14013:105|
 :skolemid |252|
))) (and (=> (= (ControlFlow 0 168994) (- 0 228537)) (let (($range_0@@1 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_135073| $t24@2))))))
...
(forall (($i_3@@0 Int) ) (!  (=> ($InRange $range_2@@0 $i_3@@0) (let ((j@@11 $i_3@@0))
 ...
 :qid |DiemIdbpl.14020:105|
 :skolemid |254|
))) (and (=> (= (ControlFlow 0 168994) (- 0 228622)) (let (($range_0@@3 (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_135073| $t24@2))))
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| $elem@@0)) 63)))
 :qid |DiemIdbpl.14028:86|
 :skolemid |255|
))) (=> (and (= $1_DiemId_DiemIdDomains_$memory@0 ($Memory_134465 (|Store__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) (|a#$Global| (|l#$Mutation_135073| $t24@2)) true) (|Store__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) (|a#$Global| (|l#$Mutation_135073| $t24@2)) (|v#$Mutation_135073| $t24@2)))) (|$IsValid'address'| 186537453)) (and (=> (= (ControlFlow 0 168994) 169393) anon44_Then_correct) (=> (= (ControlFlow 0 168994) 169016) anon44_Else_correct))))))))))))
(let ((anon43_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 169409) 167700))) L7_correct)))
(let ((|inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon3_Then$1_correct|  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@2| |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@0|)) (and (=> (= (ControlFlow 0 168766) 169409) anon43_Then_correct) (=> (= (ControlFlow 0 168766) 168994) anon43_Else_correct))))))
...
(let ((|inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon3_Else_correct|  (=> (and (and (and (>= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| 0) (< |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| (seq.len |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1|))) (= |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$e@1| (seq.nth |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1| |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2|))) (and (and (= |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@1| ($Mutation_78479 (|l#$Mutation_78479| $t31@0) (|p#$Mutation_78479| $t31@0) (seq.++ (seq.extract |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1| 0 (- |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| 0)) (seq.extract |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1| (+ |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| 1) (- (seq.len |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1|) (+ |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| 1)))))) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@2| |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@1|)))) (and (=> (= (ControlFlow 0 168714) 169409) anon43_Then_correct) (=> (= (ControlFlow 0 168714) 168994) anon43_Else_correct)))))
(let ((|inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1| (|v#$Mutation_78479| $t31@0)) (and (=> (= (ControlFlow 0 168690) 168764) |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 168690) 168714) |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon3_Else_correct|)))))
(let ((anon42_Then_correct  (=> |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1| (=> (and (= $t31@0 ($Mutation_78479 (|l#$Mutation_135073| $t24@1) (seq.++ (|p#$Mutation_135073| $t24@1) (seq.unit 0)) (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_135073| $t24@1)))) (= (ControlFlow 0 168774) 168690)) |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon0_correct|))))
(let ((anon42_Else_correct  (=> (not |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1|) (and (=> (= (ControlFlow 0 168579) (- 0 228153)) (let (($range_0@@5 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_135073| $t24@1))))))
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| (seq.nth (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_135073| $t24@1)) i@@56))) 63)))
 :qid |DiemIdbpl.13942:105|
 :skolemid |248|
))) (and (=> (= (ControlFlow 0 168579) (- 0 228201)) (let (($range_0@@7 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_135073| $t24@1))))))
...
(forall (($i_3@@2 Int) ) (!  (=> ($InRange $range_2@@2 $i_3@@2) (let ((j@@13 $i_3@@2))
 ...
 :qid |DiemIdbpl.13949:105|
 :skolemid |250|
))) (and (=> (= (ControlFlow 0 168579) (- 0 228286)) (let (($range_0@@9 (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_135073| $t24@1))))
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| $elem@@2)) 63)))
 :qid |DiemIdbpl.13957:86|
 :skolemid |251|
))) (=> (and (|$IsValid'u64'| 2) (|$IsValid'u64'| $t30)) (=> (and (and (= $t30 7) (= $t30 $t30)) (and (= $t17@0 $t30) (= (ControlFlow 0 168579) 167700))) L7_correct)))))))))))
(let ((anon41_Else_correct  (=> (not $abort_flag@1) (=> (and (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2|) (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1| |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1|)) (and (=> (= (ControlFlow 0 168369) 168774) anon42_Then_correct) (=> (= (ControlFlow 0 168369) 168579) anon42_Else_correct))))))
(let ((anon41_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 169423) 167700))) L7_correct)))
(let ((|inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon3_Else_correct|  (=> (> 0 |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@1|) (=> (and (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1| false) (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| 0)) (and (=> (= (ControlFlow 0 168329) 169423) anon41_Then_correct) (=> (= (ControlFlow 0 168329) 168369) anon41_Else_correct))))))
(let ((|inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon3_Then_correct|  (=> (>= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@1| 0) (=> (and (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1| true) (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@1|)) (and (=> (= (ControlFlow 0 168339) 169423) anon41_Then_correct) (=> (= (ControlFlow 0 168339) 168369) anon41_Else_correct))))))
(let ((|inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@1| (|$IndexOfVec'$1_DiemId_DiemIdDomain'| $t26@0 inline$$1_DiemId_create_diem_id_domain$0$$ret0@1)) (and (=> (= (ControlFlow 0 168317) 168339) |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 168317) 168329) |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon3_Else_correct|)))))
(let ((anon40_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1 inline$$1_DiemId_create_diem_id_domain$0$$ret0@1)) (and (= $t26@0 (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_135073| $t24@1))) (= (ControlFlow 0 168347) 168317))) |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon0_correct|)))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 169437) 167700))) L7_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$L3_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 inline$$1_DiemId_create_diem_id_domain$0$$t4@1) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1 inline$$1_DiemId_create_diem_id_domain$0$$ret0@0)) (and (=> (= (ControlFlow 0 168180) 169437) anon40_Then_correct) (=> (= (ControlFlow 0 168180) 168347) anon40_Else_correct))))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon7_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t4@1 inline$$1_DiemId_create_diem_id_domain$0$$t8@0) (= (ControlFlow 0 168174) 168180))) inline$$1_DiemId_create_diem_id_domain$0$L3_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t4@1 $abort_code@1) (= (ControlFlow 0 168212) 168180))) inline$$1_DiemId_create_diem_id_domain$0$L3_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon7_Then_correct  (=> (and inline$$Le$0$dst@1 (= inline$$1_DiemId_create_diem_id_domain$0$$t9@1 ($1_DiemId_DiemIdDomain _$t2))) (=> (and (and (= inline$$1_DiemId_create_diem_id_domain$0$$t9@1 inline$$1_DiemId_create_diem_id_domain$0$$t9@1) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1 inline$$1_DiemId_create_diem_id_domain$0$$t9@1))) (and (=> (= (ControlFlow 0 168198) 169437) anon40_Then_correct) (=> (= (ControlFlow 0 168198) 168347) anon40_Else_correct))))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_DiemId_create_diem_id_domain$0$$t8@0) (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0 7)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 168158) 168198) inline$$1_DiemId_create_diem_id_domain$0$anon7_Then_correct) (=> (= (ControlFlow 0 168158) 168174) inline$$1_DiemId_create_diem_id_domain$0$anon7_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 168122) 168158)) inline$$1_DiemId_create_diem_id_domain$0$anon6_Else$1_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 168128) 168122)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (seq.len _$t2)) (and (=> (= (ControlFlow 0 168062) 168212) inline$$1_DiemId_create_diem_id_domain$0$anon6_Then_correct) (=> (= (ControlFlow 0 168062) 168128) inline$$1_DiemId_create_diem_id_domain$0$anon6_Else_correct)))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon0_correct  (=> (and (= _$t2 _$t2) (= (ControlFlow 0 168068) 168062)) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((anon39_Else_correct  (=> (and (and (not $abort_flag@0) (= |$temp_0'$1_DiemId_DiemIdDomains'@0| (|v#$Mutation_135073| $t24@1))) (and (= |$temp_0'$1_DiemId_DiemIdDomains'@0| |$temp_0'$1_DiemId_DiemIdDomains'@0|) (= (ControlFlow 0 168218) 168068))) inline$$1_DiemId_create_diem_id_domain$0$anon0_correct)))
(let ((anon39_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 169451) 167700))) L7_correct)))
(let ((anon38_Then$1_correct  (=> (= $t24@1 $t24) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 169503) 169451) anon39_Then_correct) (=> (= (ControlFlow 0 169503) 168218) anon39_Else_correct))))))
(let ((anon38_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t1)) (= (ControlFlow 0 169501) 169503)) anon38_Then$1_correct)))
(let ((anon38_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t1) (=> (and (and (= $t24@0 ($Mutation_135073 ($Global _$t1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t1))) (= $t24@1 $t24@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 167784) 169451) anon39_Then_correct) (=> (= (ControlFlow 0 167784) 168218) anon39_Else_correct))))))
(let ((anon37_Then_correct  (=> $t21@0 (and (=> (= (ControlFlow 0 167762) 169501) anon38_Then_correct) (=> (= (ControlFlow 0 167762) 167784) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (and (not $t21@0) (= $t23 $t23)) (and (= $t17@0 $t23) (= (ControlFlow 0 167758) 167700))) L7_correct)))
(let ((anon36_Then_correct  (=> inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1 (=> (and (= $t21@0 (|Select__T@[Int]Bool_| (|domain#$Memory_134465| $1_DiemId_DiemIdDomains_$memory) _$t1)) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| $t23) (= $t23 5)) (and (= $t23 $t23) (= $t21@0 $t21@0))) (and (=> (= (ControlFlow 0 167742) 167762) anon37_Then_correct) (=> (= (ControlFlow 0 167742) 167758) anon37_Else_correct)))))))
(let ((anon36_Else_correct  (=> (and (and (not inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1) (= $t20 $t20)) (and (= $t17@0 $t20) (= (ControlFlow 0 167484) 167700))) L7_correct)))
(let ((anon35_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t20) (= $t20 5)) (and (= $t20 $t20) (= inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1 inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1))) (and (=> (= (ControlFlow 0 167468) 167742) anon36_Then_correct) (=> (= (ControlFlow 0 167468) 167484) anon36_Else_correct))))))
(let ((anon34_Then_correct  (=> $t16 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101672| $1_Roles_RoleId_$memory) $t15)) (= 5 $t17)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_101672| $1_Roles_RoleId_$memory) $t15)) 1)) (= 3 $t17))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t17))) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 169589) 167700))) L7_correct))))
(let ((anon35_Then_correct true))
(let ((inline$$1_DiemId_tc_domain_manager_exists$0$anon0_correct  (=> (|$IsValid'address'| 186537453) (=> (and (= inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_134529| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (= inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1 inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1)) (and (=> (= (ControlFlow 0 167426) 169517) anon35_Then_correct) (=> (= (ControlFlow 0 167426) 167468) anon35_Else_correct))))))
(let ((anon34_Else_correct  (=> (and (not $t16) (= (ControlFlow 0 167432) 167426)) inline$$1_DiemId_tc_domain_manager_exists$0$anon0_correct)))
...
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@14 $i_6))
 (not (= (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc@@1) i@@60) (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc@@1) j@@14)))))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_69963_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemIdbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 166951) 167339)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (seq.len (|p#$Mutation_135073| $t7)) 0) (= (seq.len (|p#$Mutation_135073| $t24)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_78479| $t31)) 0) (= (seq.len (|p#$Mutation_135134| $t34)) 0)) (and (= (seq.len (|p#$Mutation_94598| $t35)) 0) (= (ControlFlow 0 166961) 166951))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 226845) 166961) anon0_correct)))
