...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 322421) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t9@0 (|$micro_xdx_limit#$1_DualAttestation_Limit| $t8@1)) (= $t9@0 $t9@0)) (and (=> (= (ControlFlow 0 242279) (- 0 322725)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816))) (and (=> (= (ControlFlow 0 242279) (- 0 322735)) (= $t9@0 (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (= $t9@0 (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816))) (and (=> (= (ControlFlow 0 242279) (- 0 322745)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1) (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1)))
 ...
 :qid |DualAttestationbpl.17400:15|
 :skolemid |373|
)) (and (=> (= (ControlFlow 0 242279) (- 0 322770)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1))))
 ...
 :qid |DualAttestationbpl.17415:15|
 :skolemid |375|
)) (=> (= (ControlFlow 0 242279) (- 0 322852)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5) (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)))))
 :qid |DualAttestationbpl.17420:15|
 :skolemid |376|
)))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 242067) (- 0 322680)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (=> (= (ControlFlow 0 242067) (- 0 322685)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (= 5 $t6@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 242293) 242067))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $t8@1 $t8) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 242345) 242293) anon12_Then_correct) (=> (= (ControlFlow 0 242345) 242279) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (= (ControlFlow 0 242343) 242345)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816) (=> (and (and (= $t8@0 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (= $t8@1 $t8@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 242091) 242293) anon12_Then_correct) (=> (= (ControlFlow 0 242091) 242279) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> (and $t3@0 (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 242077) 242343) anon11_Then_correct) (=> (= (ControlFlow 0 242077) 242091) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t3@0) (= $t5 $t5)) (and (= $t6@0 $t5) (= (ControlFlow 0 242039) 242067))) L3_correct)))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) $a_0)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc))
 :qid |DualAttestationbpl.17299:20|
 :skolemid |372|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) $a_0))
)) (|$IsValid'address'| 173345816)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 242023) 242077) anon10_Then_correct) (=> (= (ControlFlow 0 242023) 242039) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2787:13|
 :skolemid |79|
))) (= (ControlFlow 0 241927) 242023)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 322421) 241927) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
