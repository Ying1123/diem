...
(declare-fun $t3 () Int)
(declare-fun $1_DiemId_DiemIdDomains_$memory@1 () T@$Memory_144633)
...
(declare-fun |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1| () T@Vec_72549)
(declare-fun MapConstVec_63788 (T@$1_DiemId_DiemIdDomain) |T@[Int]$1_DiemId_DiemIdDomain|)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 241887) (let ((anon18_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 177435) (- 0 242751)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 177435) (- 0 242763)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t4)) 5)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t4)) 5))) (and (=> (= (ControlFlow 0 177435) (- 0 242781)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) $t3))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) $t3)) (and (=> (= (ControlFlow 0 177435) (- 0 242791)) (|Select__T@[Int]Bool_| (|domain#$Memory_144633| $1_DiemId_DiemIdDomains_$memory@1) $t3)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_144633| $1_DiemId_DiemIdDomains_$memory@1) $t3) (=> (= (ControlFlow 0 177435) (- 0 242799)) (= (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_144633| $1_DiemId_DiemIdDomains_$memory@1) $t3))) 0)))))))))))))
(let ((anon16_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 177170) (- 0 242658)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t4)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) $t3))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t4)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) $t3)) (=> (= (ControlFlow 0 177170) (- 0 242687)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t4)) 5)) (= 3 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) $t3) (= 6 $t7@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 177449) 177170))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $1_DiemId_DiemIdDomains_$memory@1 $1_DiemId_DiemIdDomains_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 177501) 177449) anon18_Then_correct) (=> (= (ControlFlow 0 177501) 177435) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 177499) 177501)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_DiemId_DiemIdDomains_$memory@0 ($Memory_144633 (|Store__T@[Int]Bool_| (|domain#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0) $t14@0))) (= $1_DiemId_DiemIdDomains_$memory@1 $1_DiemId_DiemIdDomains_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 177365) 177449) anon18_Then_correct) (=> (= (ControlFlow 0 177365) 177435) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not false) (= $t14@0 ($1_DiemId_DiemIdDomains |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1|))) (and (=> (= (ControlFlow 0 177343) (- 0 242439)) (let (($range_0 ($Range 0 (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@95 $i_1))
(<= (|l#Vec_21250| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) i@@95))) 63)))
 :qid |DiemIdbpl.13605:91|
 :skolemid |262|
)))) (=> (let (($range_0@@0 ($Range 0 (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@96 $i_1@@0))
(<= (|l#Vec_21250| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) i@@96))) 63)))
 :qid |DiemIdbpl.13605:91|
 :skolemid |262|
))) (and (=> (= (ControlFlow 0 177343) (- 0 242483)) (let (($range_0@@1 ($Range 0 (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@97 $i_1@@1))
(let (($range_2 ($Range (+ i@@97 1) (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_3 Int) ) (!  (=> ($InRange $range_2 $i_3) (let ((j@@30 $i_3))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) i@@97)) (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) j@@30))))))
 :qid |DiemIdbpl.13613:96|
 :skolemid |263|
)))))
 :qid |DiemIdbpl.13612:91|
 :skolemid |264|
)))) (=> (let (($range_0@@2 ($Range 0 (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@98 $i_1@@2))
(let (($range_2@@0 ($Range (+ i@@98 1) (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_3@@0 Int) ) (!  (=> ($InRange $range_2@@0 $i_3@@0) (let ((j@@31 $i_3@@0))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) i@@98)) (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) j@@31))))))
 :qid |DiemIdbpl.13613:96|
 :skolemid |263|
)))))
 :qid |DiemIdbpl.13612:91|
 :skolemid |264|
))) (and (=> (= (ControlFlow 0 177343) 177499) anon17_Then_correct) (=> (= (ControlFlow 0 177343) 177365) anon17_Else_correct)))))))))
(let ((|inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1| (Vec_72549 (MapConstVec_63788 DefaultVecElem_63788) 0)) (and (=> (= (ControlFlow 0 177196) 177515) anon16_Then_correct) (=> (= (ControlFlow 0 177196) 177343) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 177202) 177196)) |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$anon0_correct|)))
(let ((anon15_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 177074) 177170))) L3_correct)))
(let ((anon14_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 177058) 177202) anon15_Then_correct) (=> (= (ControlFlow 0 177058) 177074) anon15_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 177018) 177058)) anon14_Else$1_correct)))
(let ((anon14_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) $t8)) (= (ControlFlow 0 177024) 177018))) inline$$Not$0$anon0_correct))))
(let ((anon14_Then_correct  (=> $t6 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t5)) 5)) (= 3 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 177567) 177170))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemIdbpl.13456:20|
 :skolemid |256|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) $a_0@@0)))
 (and (|$IsValid'$1_DiemId_DiemIdDomains'| $rsc@@0) (and (and (let (($range_1 ($Range 0 (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@99 $i_2))
(<= (|l#Vec_21250| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)) i@@99))) 63)))
 :qid |DiemIdbpl.13461:136|
 :skolemid |257|
))) (let (($range_3 ($Range 0 (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@100 $i_4))
(let (($range_5 ($Range (+ i@@100 1) (|l#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@32 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)) i@@100)) (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_72549| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)) j@@32))))))
 :qid |DiemIdbpl.13463:96|
 :skolemid |258|
)))))
 :qid |DiemIdbpl.13462:196|
 :skolemid |259|
...
(<= (|l#Vec_21250| (|$domain#$1_DiemId_DiemIdDomain| $elem)) 63)))
 :qid |DiemIdbpl.13464:221|
 :skolemid |260|
))))))
 :qid |DiemIdbpl.13460:20|
 :skolemid |261|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_144633| $1_DiemId_DiemIdDomains_$memory) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0)))) (and (and (= $t4 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t5)) 5))))))) (and (=> (= (ControlFlow 0 176962) 177567) anon14_Then_correct) (=> (= (ControlFlow 0 176962) 177024) anon14_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemIdbpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 176664) 176962)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 241887) 176664) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
