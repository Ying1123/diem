...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@0 () T@$Memory_10531)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@0 () T@$Memory_10531)
...
(assert (not
 (=> (= (ControlFlow 0 0) 13929) (let ((L3_correct@@0  (and (=> (= (ControlFlow 0 12774) (- 0 14250)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@0 _$t1) 0)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@0 _$t1) 0))) (=> (= (ControlFlow 0 12774) (- 0 14270)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0))) (= 5 $t7@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@0 _$t1) 0)) (= 7 $t7@0))))))))
(let ((anon11_Else_correct@@0  (=> (and (and (not $t9@0) (= $t10 $t10)) (and (= $t7@0 $t10) (= (ControlFlow 0 12702) 12774))) L3_correct@@0)))
(let ((anon9_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0))) (= 5 $t7@@0)) (= $t7@@0 $t7@@0)) (and (= $t7@0 $t7@@0) (= (ControlFlow 0 12854) 12774))) L3_correct@@0))))
(let ((anon11_Then_correct@@0  (=> $t9@0 (and (=> (= (ControlFlow 0 12810) (- 0 14196)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0)))) (=> (= (ControlFlow 0 12810) (- 0 14209)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@0 _$t1) 0)))))))))
(let ((anon5_correct  (=> (|$IsValid'u64'| $t5) (=> (and (and (and (= $t5 ($1_SlidingNonce_spec_try_record_nonce _$t0@@0 _$t1)) (= $t5 $t5)) (and (|$IsValid'u64'| 0) (= $t9@0 (= $t5 0)))) (and (and (|$IsValid'u64'| $t10) (= $t10 7)) (and (= $t10 $t10) (= $t9@0 $t9@0)))) (and (=> (= (ControlFlow 0 12686) 12810) anon11_Then_correct@@0) (=> (= (ControlFlow 0 12686) 12702) anon11_Else_correct@@0))))))
(let ((anon10_Else_correct@@0  (=> (not |$temp_0'bool'@0|) (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@1@@0 ($Memory_10531 (|Store__T@[Int]Bool_| (|domain#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0) false) (|contents#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory))) (= (ControlFlow 0 12628) 12686)) anon5_correct))))
(let ((anon10_Then_correct@@0  (=> |$temp_0'bool'@0| (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@0@@0 ($Memory_10531 (|Store__T@[Int]Bool_| (|domain#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0) |$temp_0'$1_SlidingNonce_SlidingNonce'@0|))) (= (ControlFlow 0 12824) 12686)) anon5_correct))))
(let ((anon9_Else_correct  (=> (not $t6) (and (=> (= (ControlFlow 0 12614) 12824) anon10_Then_correct@@0) (=> (= (ControlFlow 0 12614) 12628) anon10_Else_correct@@0)))))
(let ((anon0$1_correct@@0  (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_10297| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_10297| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) 186537453))) (and (|$IsValid'address'| (|$addr#$signer| _$t0@@0)) (|$IsValid'u64'| _$t1))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@0)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@0))
 :qid |SlidingNoncebpl.1222:20|
 :skolemid |34|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@0))
)) (= _$t0@@0 _$t0@@0)) (and (= _$t1 _$t1) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_10531| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0))))))) (and (=> (= (ControlFlow 0 12608) 12854) anon9_Then_correct) (=> (= (ControlFlow 0 12608) 12614) anon9_Else_correct)))))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 13929) 12608) anon0$1_correct@@0)))
anon0_correct@@0)))))))))))
))
(check-sat)
(pop 1)
