...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@1@@3| () T@$Memory_228213)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@0@@3| () T@$Memory_228213)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@3| () T@$Mutation_247003)
(declare-fun |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t14@1| () T@$Mutation_213547)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t18@1| () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1| () (Seq Int))
...
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2| () T@$Mutation_247003)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@1| () T@$Mutation_268309)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@2| () T@$Mutation_268309)
(declare-fun $t20@@11 () T@$1_FixedPoint32_FixedPoint32)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@0| () T@$Mutation_247003)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@1| () T@$Mutation_247003)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t2@0| () T@$Mutation_247003)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@0| () T@$Mutation_268309)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t14@0| () T@$Mutation_213547)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@5 () T@$Memory_221725)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@5 () T@$Memory_221725)
...
(assert (not
 (=> (= (ControlFlow 0 0) 844940) (let ((L2_correct@@8  (and (=> (= (ControlFlow 0 689969) (- 0 847788)) (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13) 0))) (= $t7@@12 0)) (and (= $t8@@12 0) (not (= $t6@@13 0)))) (> $t8@@12 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t9@@12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t9@@12)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t12@@9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t12@@9)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453)))) (=> (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13) 0))) (= $t7@@12 0)) (and (= $t8@@12 0) (not (= $t6@@13 0)))) (> $t8@@12 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t9@@12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t9@@12)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t12@@9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t12@@9)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453))) (=> (= (ControlFlow 0 689969) (- 0 847919)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))) (= 5 $t13@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13) 0)) (= 7 $t13@0))) (and (= $t7@@12 0) (= 7 $t13@0))) (and (and (= $t8@@12 0) (not (= $t6@@13 0))) (= 7 $t13@0))) (and (> $t8@@12 18446744073709551615) (= 8 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t9@@12)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t9@@12)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0@@13) 186537453)) (= 2 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t12@@9)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t12@@9)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0@@13) 186537453)) (= 2 $t13@0))) (= 7 $t13@0)) (= 2 $t13@0)) (= 8 $t13@0)) (= 3 $t13@0)) (= 5 $t13@0)))))))
(let ((anon10_Then_correct  (=> (and (and $abort_flag@2@@7 (= $abort_code@3@@7 $abort_code@3@@7)) (and (= $t13@0 $abort_code@3@@7) (= (ControlFlow 0 689541) 689969))) L2_correct@@8)))
(let ((anon9_Then_correct  (=> $t21@@5 (=> (and (and (or (or (and (= $t18@@11 0) (= 7 $t13@@11)) (and (and (= $t19@@11 0) (not (= $t17@@11 0))) (= 7 $t13@@11))) (and (> $t19@@11 18446744073709551615) (= 8 $t13@@11))) (= $t13@@11 $t13@@11)) (and (= $t13@0 $t13@@11) (= (ControlFlow 0 690037) 689969))) L2_correct@@8))))
(let ((anon8_Then_correct  (=> (and (and $abort_flag@0@@10 (= $abort_code@1@@10 $abort_code@1@@10)) (and (= $t13@0 $abort_code@1@@10) (= (ControlFlow 0 690051) 689969))) L2_correct@@8)))
(let ((anon10_Else_correct  (=> (not $abort_flag@2@@7) (and (=> (= (ControlFlow 0 689527) (- 0 847544)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13)))) (and (=> (= (ControlFlow 0 689527) (- 0 847557)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13) 0))) (and (=> (= (ControlFlow 0 689527) (- 0 847572)) (not (= $t7@@12 0))) (=> (not (= $t7@@12 0)) (and (=> (= (ControlFlow 0 689527) (- 0 847583)) (not (and (= $t8@@12 0) (not (= $t6@@13 0))))) (=> (not (and (= $t8@@12 0) (not (= $t6@@13 0)))) (and (=> (= (ControlFlow 0 689527) (- 0 847604)) (not (> $t8@@12 18446744073709551615))) (=> (not (> $t8@@12 18446744073709551615)) (and (=> (= (ControlFlow 0 689527) (- 0 847615)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t9@@12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t9@@12))) (and (=> (= (ControlFlow 0 689527) (- 0 847627)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t9@@12)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t9@@12)) 1))) (and (=> (= (ControlFlow 0 689527) (- 0 847645)) (not (not (= (|$addr#$signer| _$t0@@13) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@13) 186537453))) (and (=> (= (ControlFlow 0 689527) (- 0 847659)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 689527) (- 0 847669)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t12@@9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t12@@9))) (and (=> (= (ControlFlow 0 689527) (- 0 847681)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t12@@9)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t12@@9)) 1))) (and (=> (= (ControlFlow 0 689527) (- 0 847699)) (not (not (= (|$addr#$signer| _$t0@@13) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@13) 186537453))) (and (=> (= (ControlFlow 0 689527) (- 0 847713)) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) $t5@@13)) (=> (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) $t5@@13) (and (=> (= (ControlFlow 0 689527) (- 0 847725)) (let ((actual@@62 ($EventStore (- (|counter#$EventStore| $es@2@@9) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2@@9) (|streams#$EventStore| $es)))))
(let ((expected@@62 (let ((stream@@145 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t10@@12)))
(let ((stream_new@@130 (let ((len@@130 (|l#Multiset_181229| stream@@145)))
(let ((cnt@@130 (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@145) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@145) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11) (+ cnt@@130 1)) (+ len@@130 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t10@@12 stream_new@@130))))))
 (and (<= (|counter#$EventStore| expected@@62) (|counter#$EventStore| actual@@62)) (forall ((handle@@78 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@62) handle@@78)) (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@62) handle@@78))) (forall ((v@@126 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@62) handle@@78)) v@@126) (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@62) handle@@78)) v@@126))
...
(let ((expected@@63 (let ((stream@@146 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t10@@12)))
(let ((stream_new@@131 (let ((len@@131 (|l#Multiset_181229| stream@@146)))
(let ((cnt@@131 (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@146) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@146) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11) (+ cnt@@131 1)) (+ len@@131 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t10@@12 stream_new@@131))))))
 (and (<= (|counter#$EventStore| expected@@63) (|counter#$EventStore| actual@@63)) (forall ((handle@@79 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@63) handle@@79)) (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@63) handle@@79))) (forall ((v@@127 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@63) handle@@79)) v@@127) (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@63) handle@@79)) v@@127))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3464:13|
 :skolemid |95|
))))) (=> (= (ControlFlow 0 689527) (- 0 847750)) (let ((actual@@64 ($EventStore (- (|counter#$EventStore| $es@2@@9) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2@@9) (|streams#$EventStore| $es)))))
(let ((expected@@64 (let ((stream@@147 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t10@@12)))
(let ((stream_new@@132 (let ((len@@132 (|l#Multiset_181229| stream@@147)))
(let ((cnt@@132 (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@147) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@147) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11) (+ cnt@@132 1)) (+ len@@132 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t10@@12 stream_new@@132))))))
 (and (<= (|counter#$EventStore| actual@@64) (|counter#$EventStore| expected@@64)) (forall ((handle@@80 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@64) handle@@80)) (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@64) handle@@80))) (forall ((v@@128 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@64) handle@@80)) v@@128) (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@64) handle@@80)) v@@128))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3464:13|
...
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|  (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1@@3| |$1_Diem_CurrencyInfo'#0'_$memory|) (= $abort_code@3@@7 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@1|)) (and (= $es@2@@9 $es@1@@12) (= $abort_flag@2@@7 true))) (and (=> (= (ControlFlow 0 689099) 689541) anon10_Then_correct) (=> (= (ControlFlow 0 689099) 689527) anon10_Else_correct)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Then_correct|  (=> $abort_flag@1@@7 (=> (and (and (= $abort_code@2@@7 $abort_code@2@@7) (= $es@1@@12 $es@0@@13)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@1| $abort_code@2@@7) (= (ControlFlow 0 689093) 689099))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Then_correct|  (=> $abort_flag@1@@7 (=> (and (and (= $abort_code@2@@7 $abort_code@2@@7) (= $es@1@@12 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@1| $abort_code@2@@7) (= (ControlFlow 0 689113) 689099))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Then_correct|  (=> $abort_flag@1@@7 (=> (and (and (= $abort_code@2@@7 $abort_code@2@@7) (= $es@1@@12 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@1| $abort_code@2@@7) (= (ControlFlow 0 689127) 689099))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Then_correct|  (=> |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t10@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|)) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|) (= $es@1@@12 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|) (= (ControlFlow 0 689205) 689099))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Then_correct|  (=> (and |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0| (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0|)) (= 5 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0|)) 1)) (= 3 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|))) (and (not (= (|$addr#$signer| _$t0@@13) 186537453)) (= 2 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|)))) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|) (= $es@1@@12 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|) (= (ControlFlow 0 689277) 689099))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Else_correct|  (=> (and (not $abort_flag@1@@7) (= |$1_Diem_CurrencyInfo'#0'_$memory@0@@3| ($Memory_228213 (|Store__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@3|)) (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@3|))))) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1@@3| |$1_Diem_CurrencyInfo'#0'_$memory@0@@3|) (= $abort_code@3@@7 $abort_code@2@@7)) (and (= $es@2@@9 $es@0@@13) (= $abort_flag@2@@7 $abort_flag@1@@7))) (and (=> (= (ControlFlow 0 689079) 689541) anon10_Then_correct) (=> (= (ControlFlow 0 689079) 689527) anon10_Else_correct))))))
(let ((|inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| (|v#$Mutation_213547| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t14@1|)) (= $es@0@@13 (let ((stream@@148 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1|)))
(let ((stream_new@@133 (let ((len@@133 (|l#Multiset_181229| stream@@148)))
(let ((cnt@@133 (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@148) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t18@1|))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@148) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t18@1|) (+ cnt@@133 1)) (+ len@@133 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| stream_new@@133)))))) (and (=> (= (ControlFlow 0 689051) 689093) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Then_correct|) (=> (= (ControlFlow 0 689051) 689079) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Else_correct|  (=> (not $abort_flag@1@@7) (=> (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t18@1| ($1_Diem_ToXDXExchangeRateUpdateEvent |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1| inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (= (ControlFlow 0 689057) 689051)) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|))))
(let ((inline$$1_FixedPoint32_get_raw_value$0$anon0_correct  (=> (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t16@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t16@1|) (=> (and (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 (|$value#$1_FixedPoint32_FixedPoint32| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t16@1|)) (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (and (=> (= (ControlFlow 0 688958) 689113) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Then_correct|) (=> (= (ControlFlow 0 688958) 689057) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Else_correct|  (=> (and (not $abort_flag@1@@7) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|))) (=> (and (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1|) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@1| ($Mutation_268309 (|l#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|) (seq.++ (|p#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|) (seq.unit 2)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|))))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@2| ($Mutation_268309 (|l#$Mutation_268309| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@1|) (|p#$Mutation_268309| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@1|) $t20@@11)) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@3| ($Mutation_247003 (|l#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|) (|p#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|)) (|v#$Mutation_268309| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@2|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|))))))) (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t14@1| ($Mutation_213547 (|l#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@3|) (seq.++ (|p#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@3|) (seq.unit 12)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@3|)))) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@3|)))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t16@1| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@3|))) (= (ControlFlow 0 688964) 688958)))) inline$$1_FixedPoint32_get_raw_value$0$anon0_correct))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then$1_correct|  (=> (= $abort_code@2@@7 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@7 true) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@0|)) (and (=> (= (ControlFlow 0 689179) 689127) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 689179) 688964) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 689177) 689179)) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then$1_correct|)))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@1| ($Mutation_247003 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $abort_code@2@@7 $abort_code@1@@10)) (and (= $abort_flag@1@@7 $abort_flag@0@@10) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@1|))) (and (=> (= (ControlFlow 0 688783) 689127) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 688783) 688964) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Else_correct|  (=> (and (not |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t10@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 688761) 689177) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then_correct|) (=> (= (ControlFlow 0 688761) 688783) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Else_correct|  (=> (and (not |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t10@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 688747) 689205) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Then_correct|) (=> (= (ControlFlow 0 688747) 688761) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon0_correct|  (=> (and (and (= (seq.len (|p#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t2@0|)) 0) (= (seq.len (|p#$Mutation_247003| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@0|)) 0)) (and (= (seq.len (|p#$Mutation_268309| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@0|)) 0) (= (seq.len (|p#$Mutation_213547| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t14@0|)) 0))) (=> (and (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t3@0| (|$addr#$signer| _$t0@@13)) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t4@0| (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t5@0| ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t20@@11))) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0| (|$addr#$signer| _$t0@@13)))) (and (and (= _$t0@@13 _$t0@@13) (= $t20@@11 $t20@@11)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0| (|$addr#$signer| _$t0@@13)) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0|)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0|)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453))))))) (and (=> (= (ControlFlow 0 688729) 689277) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 688729) 688747) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Else_correct|))))))
(let ((anon9_Else_correct  (=> (not $t21@@5) (=> (and (and (and (|$IsValid'$1_FixedPoint32_FixedPoint32'| $t20@@11) (= $t20@@11 (ite (= _$t2@@10 _$t3@@5) ($1_FixedPoint32_FixedPoint32 1) ($1_FixedPoint32_FixedPoint32 2)))) (and (= $t20@@11 $t20@@11) (= $t22@@8 (|$addr#$signer| _$t0@@13)))) (and (and (= $t23@@8 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t24@@8 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t20@@11)))) (and (= $t25@@5 (|$addr#$signer| _$t0@@13)) (= (ControlFlow 0 689281) 688729)))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon0_correct|))))
(let ((anon8_Else_correct  (=> (and (and (and (not $abort_flag@0@@10) (= $t14@@11 ($shl _$t2@@10 64))) (and (= $t15@@11 ($shl _$t3@@5 32)) (= $t16@@11 (div $t14@@11 $t15@@11)))) (and (and (= $t17@@11 ($shl _$t2@@10 64)) (= $t18@@11 ($shl _$t3@@5 32))) (and (= $t19@@11 (div $t17@@11 $t18@@11)) (= $t21@@5  (or (or (= $t18@@11 0) (and (= $t19@@11 0) (not (= $t17@@11 0)))) (> $t19@@11 18446744073709551615)))))) (and (=> (= (ControlFlow 0 687792) 690037) anon9_Then_correct) (=> (= (ControlFlow 0 687792) 689281) anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@5  (=> (and (= $abort_flag@0@@10 true) (= $abort_code@1@@10 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@5)) (and (=> (= (ControlFlow 0 687618) 690051) anon8_Then_correct) (=> (= (ControlFlow 0 687618) 687792) anon8_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@5  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@5) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5) (= (ControlFlow 0 687612) 687618))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@5)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@5  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@5 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@5)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@5)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@5) (= (ControlFlow 0 687668) 687618))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@5))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@5  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@5 (=> (and (= $abort_flag@0@@10 false) (= $abort_code@1@@10 $abort_code@0@@10)) (and (=> (= (ControlFlow 0 687624) 690051) anon8_Then_correct) (=> (= (ControlFlow 0 687624) 687792) anon8_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@5  (=> (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@5) (=> (and (and (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@5 ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@5)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@5 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@5 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@5)))) (and (=> (= (ControlFlow 0 687596) 687624) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@5) (=> (= (ControlFlow 0 687596) 687612) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@5))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@5  (=> (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@5|) (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@1@@5 ($Memory_221725 (|Store__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13) false) (|contents#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory))) (= (ControlFlow 0 687538) 687596)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@5))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@5  (=> |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@5| (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@0@@5 ($Memory_221725 (|Store__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1@@5|))) (= (ControlFlow 0 687638) 687596)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@5))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@5  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@5) (and (=> (= (ControlFlow 0 687524) 687638) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@5) (=> (= (ControlFlow 0 687524) 687538) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@5)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@5  (=> (= _$t0@@13 _$t0@@13) (=> (and (= _$t1@@13 _$t1@@13) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@5  (not (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))))) (and (=> (= (ControlFlow 0 687518) 687668) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@5) (=> (= (ControlFlow 0 687518) 687524) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@5))))))
(let ((anon0$1_correct@@13  (=> (and (forall ((addr@@305 Int) ) (!  (=> (|$IsValid'address'| addr@@305) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_220584| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@305) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@305) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@305)) 4))))
 :qid |TreasuryComplianceScriptsbpl.39483:20|
 :skolemid |1332|
)) (forall ((addr@@306 Int) ) (!  (=> (|$IsValid'address'| addr@@306) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221188| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@306) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@306) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@306)) 3))))
 :qid |TreasuryComplianceScriptsbpl.39487:20|
 :skolemid |1333|
))) (=> (and (and (and (forall ((addr@@307 Int) ) (!  (=> (|$IsValid'address'| addr@@307) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221188| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@307) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@307) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@307)) 3))))
 :qid |TreasuryComplianceScriptsbpl.39491:20|
 :skolemid |1334|
)) (forall ((addr@@308 Int) ) (!  (=> (|$IsValid'address'| addr@@308) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221188| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@308) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_221188| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@308)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@308) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@308)) 3))))
 :qid |TreasuryComplianceScriptsbpl.39495:20|
 :skolemid |1335|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_219763| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_219763| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) 186537453)))) (and (and (forall ((mint_cap_owner@@23 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233559| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner@@23) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) mint_cap_owner@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) mint_cap_owner@@23)) 1))))
 :qid |TreasuryComplianceScriptsbpl.39507:22|
 :skolemid |1336|
)) (forall ((mint_cap_owner@@24 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@24) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233646| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner@@24) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) mint_cap_owner@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) mint_cap_owner@@24)) 1))))
 :qid |TreasuryComplianceScriptsbpl.39507:269|
 :skolemid |1337|
))) (forall ((mint_cap_owner@@25 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@25) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233733| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner@@25) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) mint_cap_owner@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) mint_cap_owner@@25)) 1))))
 :qid |TreasuryComplianceScriptsbpl.39507:517|
 :skolemid |1338|
)))) (=> (and (and (and (and (forall ((addr1@@94 Int) ) (!  (=> (|$IsValid'address'| addr1@@94) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_228752| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1@@94) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@94) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@94)) 1))))
 :qid |TreasuryComplianceScriptsbpl.39515:22|
 :skolemid |1339|
)) (forall ((addr1@@95 Int) ) (!  (=> (|$IsValid'address'| addr1@@95) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_228839| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr1@@95) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@95) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@95)) 1))))
 :qid |TreasuryComplianceScriptsbpl.39515:232|
 :skolemid |1340|
))) (forall ((addr1@@96 Int) ) (!  (=> (|$IsValid'address'| addr1@@96) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_228926| |$1_Diem_BurnCapability'#0'_$memory|) addr1@@96) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@96) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@96)) 1))))
 :qid |TreasuryComplianceScriptsbpl.39515:443|
 :skolemid |1341|
))) (and (and (forall ((addr1@@97 Int) ) (!  (=> (|$IsValid'address'| addr1@@97) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_234315| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1@@97) (|Select__T@[Int]Bool_| (|domain#$Memory_233906| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1@@97)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@97) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@97)) 2))))
 :qid |TreasuryComplianceScriptsbpl.39519:22|
 :skolemid |1342|
)) (forall ((addr1@@98 Int) ) (!  (=> (|$IsValid'address'| addr1@@98) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_234414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr1@@98) (|Select__T@[Int]Bool_| (|domain#$Memory_233997| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr1@@98)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@98) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@98)) 2))))
 :qid |TreasuryComplianceScriptsbpl.39519:293|
 :skolemid |1343|
))) (forall ((addr1@@99 Int) ) (!  (=> (|$IsValid'address'| addr1@@99) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) addr1@@99) (|Select__T@[Int]Bool_| (|domain#$Memory_234088| |$1_Diem_Preburn'#0'_$memory|) addr1@@99)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@99) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@99)) 2))))
 :qid |TreasuryComplianceScriptsbpl.39519:565|
 :skolemid |1344|
)))) (and (and (and (forall ((addr@@309 Int) ) (!  (=> (|$IsValid'address'| addr@@309) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233906| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@309) (|Select__T@[Int]Bool_| (|domain#$Memory_227922| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.39523:22|
 :skolemid |1345|
)) (forall ((addr@@310 Int) ) (!  (=> (|$IsValid'address'| addr@@310) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233997| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@310) (|Select__T@[Int]Bool_| (|domain#$Memory_227986| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.39523:222|
 :skolemid |1346|
))) (forall ((addr@@311 Int) ) (!  (=> (|$IsValid'address'| addr@@311) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234088| |$1_Diem_Preburn'#0'_$memory|) addr@@311) (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.39523:423|
 :skolemid |1347|
))) (and (and (forall ((addr@@312 Int) ) (!  (=> (|$IsValid'address'| addr@@312) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234315| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@312) (|Select__T@[Int]Bool_| (|domain#$Memory_227922| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.39527:22|
 :skolemid |1348|
)) (forall ((addr@@313 Int) ) (!  (=> (|$IsValid'address'| addr@@313) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@313) (|Select__T@[Int]Bool_| (|domain#$Memory_227986| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.39527:227|
 :skolemid |1349|
))) (forall ((addr@@314 Int) ) (!  (=> (|$IsValid'address'| addr@@314) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234513| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@314) (|Select__T@[Int]Bool_| (|domain#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.39527:433|
 :skolemid |1350|
))))) (=> (and (and (and (and (and (and (and (forall ((addr@@315 Int) ) (!  (=> (|$IsValid'address'| addr@@315) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_271409| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@315) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@315) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@315)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@315)) 6)))))
 :qid |TreasuryComplianceScriptsbpl.39531:22|
 :skolemid |1351|
)) (forall ((addr@@316 Int) ) (!  (=> (|$IsValid'address'| addr@@316) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_271473| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@316) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@316) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@316)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@316)) 6)))))
 :qid |TreasuryComplianceScriptsbpl.39531:388|
 :skolemid |1352|
))) (forall ((addr@@317 Int) ) (!  (=> (|$IsValid'address'| addr@@317) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_271537| |$1_AccountLimits_Window'#0'_$memory|) addr@@317) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@317) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@317)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@317)) 6)))))
 :qid |TreasuryComplianceScriptsbpl.39531:755|
 :skolemid |1353|
))) (forall ((addr1@@100 Int) ) (!  (=> (|$IsValid'address'| addr1@@100) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_288663| $1_DualAttestation_Credential_$memory) addr1@@100) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@100) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@100)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@100) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@100)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.39535:20|
 :skolemid |1354|
))) (and (forall ((addr@@318 Int) ) (!  (=> (|$IsValid'address'| addr@@318) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_296946| $1_DiemAccount_DiemAccount_$memory) addr@@318) (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@318)))
 :qid |TreasuryComplianceScriptsbpl.39539:20|
 :skolemid |1355|
)) (forall ((addr@@319 Int) ) (!  (=> (|$IsValid'address'| addr@@319) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) addr@@319) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@319) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@319)) 1))))
 :qid |TreasuryComplianceScriptsbpl.39543:20|
 :skolemid |1356|
)))) (and (and (forall ((addr@@320 Int) ) (!  (=> (|$IsValid'address'| addr@@320) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_296697| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@320) (|Select__T@[Int]Bool_| (|domain#$Memory_296780| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@320)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@320) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@320)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@320) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@320)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@320) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@320)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.39547:20|
 :skolemid |1357|
)) (forall ((addr@@321 Int) ) (!  (=> (|$IsValid'address'| addr@@321) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_292558| $1_DesignatedDealer_Dealer_$memory) addr@@321) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@321) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@321)) 2))))
 :qid |TreasuryComplianceScriptsbpl.39551:20|
 :skolemid |1358|
))) (and (forall ((addr@@322 Int) ) (!  (=> (|$IsValid'address'| addr@@322) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_288663| $1_DualAttestation_Credential_$memory) addr@@322) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@322) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@322)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@322) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@322)) 5)))))
 :qid |TreasuryComplianceScriptsbpl.39555:20|
 :skolemid |1359|
)) (forall ((addr@@323 Int) ) (!  (=> (|$IsValid'address'| addr@@323) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221188| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@323) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@323) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@323)) 3))))
 :qid |TreasuryComplianceScriptsbpl.39559:20|
 :skolemid |1360|
))))) (and (and (and (forall ((addr@@324 Int) ) (!  (=> (|$IsValid'address'| addr@@324) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_220584| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@324) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@324) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@324)) 4))))
 :qid |TreasuryComplianceScriptsbpl.39563:20|
 :skolemid |1361|
)) (forall ((addr@@325 Int) ) (!  (=> (|$IsValid'address'| addr@@325) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_281718| $1_VASP_ParentVASP_$memory) addr@@325) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@325) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@325)) 5))))
 :qid |TreasuryComplianceScriptsbpl.39567:20|
 :skolemid |1362|
))) (and (forall ((addr@@326 Int) ) (!  (=> (|$IsValid'address'| addr@@326) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_281654| $1_VASP_ChildVASP_$memory) addr@@326) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@326) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@326)) 6))))
 :qid |TreasuryComplianceScriptsbpl.39571:20|
 :skolemid |1363|
)) (|$IsValid'address'| (|$addr#$signer| _$t0@@13)))) (and (and (|$IsValid'u64'| _$t1@@13) (|$IsValid'u64'| _$t2@@10)) (and (|$IsValid'u64'| _$t3@@5) (forall (($a_0@@149 Int) ) (! (let (($rsc@@149 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $a_0@@149)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@149))
 :qid |TreasuryComplianceScriptsbpl.39586:20|
 :skolemid |1364|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $a_0@@149))
)))))) (and (and (and (and (forall (($a_0@@150 Int) ) (! (let (($rsc@@150 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@150)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@150))
 :qid |TreasuryComplianceScriptsbpl.39590:20|
 :skolemid |1365|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_221725| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@150))
)) (forall (($a_0@@151 Int) ) (! (let (($rsc@@151 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@151)))
 ...
 :qid |TreasuryComplianceScriptsbpl.39594:20|
 :skolemid |1366|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@151))
))) (and (= $t5@@13 (ite (= _$t2@@10 _$t3@@5) ($1_FixedPoint32_FixedPoint32 1) ($1_FixedPoint32_FixedPoint32 2))) (= $t6@@13 ($shl _$t2@@10 64)))) (and (and (= $t7@@12 ($shl _$t3@@5 32)) (= $t8@@12 (div $t6@@13 $t7@@12))) (and (= $t9@@12 (|$addr#$signer| _$t0@@13)) (= $t10@@12 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (and (and (= $t11@@11 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_228213| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t5@@13))) (= $t12@@9 (|$addr#$signer| _$t0@@13))) (and (let ((addr@@327 (|$addr#$signer| _$t0@@13)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_219763| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_296946| $1_DiemAccount_DiemAccount_$memory) addr@@327)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_293319| $1_AccountFreezing_FreezingBit_$memory) addr@@327) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_293319| $1_AccountFreezing_FreezingBit_$memory) addr@@327)))))) (= _$t0@@13 _$t0@@13))) (and (and (= _$t1@@13 _$t1@@13) (= _$t2@@10 _$t2@@10)) (and (= _$t3@@5 _$t3@@5) (= (ControlFlow 0 687672) 687518)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@5))))))
(let ((inline$$InitEventStore$0$anon0_correct@@13  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@81 T@$1_Event_EventHandle) ) (! (let ((stream@@149 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $es) handle@@81)))
 (and (= (|l#Multiset_181229| stream@@149) 0) (forall ((v@@129 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@149) v@@129) 0)
 :qid |TreasuryComplianceScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |TreasuryComplianceScriptsbpl.3448:13|
 :skolemid |94|
))) (= (ControlFlow 0 686008) 687672)) anon0$1_correct@@13)))
(let ((anon0_correct@@13  (=> (= (ControlFlow 0 844940) 686008) inline$$InitEventStore$0$anon0_correct@@13)))
anon0_correct@@13)))))))))))))))))))))))))))))))))))))
))
(check-sat)
