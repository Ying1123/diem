...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 208891) (let ((anon20_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@2|) 173345816) (=> (and (= (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@2|) addr@@0))) $t16@0) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97907| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_97907| $1_DiemConfig_Configuration_$memory@2) 173345816))) (and (=> (= (ControlFlow 0 154515) (- 0 211299)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_94211| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_94211| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 154515) (- 0 211309)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_96036| $1_Roles_RoleId_$memory) $t19)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_96036| $1_Roles_RoleId_$memory) $t19))) (and (=> (= (ControlFlow 0 154515) (- 0 211321)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_96036| $1_Roles_RoleId_$memory) $t19)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_96036| $1_Roles_RoleId_$memory) $t19)) 0))) (and (=> (= (ControlFlow 0 154515) (- 0 211339)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 154515) (- 0 211353)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_98964| |$1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_98964| |$1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 154515) (- 0 211366)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 154515) (- 0 211378)) (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_94211| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_97841| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_94211| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t20) 18446744073709551615)) (< $t21 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t20))))) (=> (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_94211| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_97841| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_94211| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t20) 18446744073709551615)) (< $t21 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t20)))) (and (=> (= (ControlFlow 0 154515) (- 0 211420)) (not (> _$t7 _$t8))) (=> (not (> _$t7 _$t8)) (and (=> (= (ControlFlow 0 154515) (- 0 211429)) (not (> _$t3 _$t6))) (=> (not (> _$t3 _$t6)) (and (=> (= (ControlFlow 0 154515) (- 0 211438)) (|Select__T@[Int]Bool_| (|domain#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@2|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@2|) 173345816) (and (=> (= (ControlFlow 0 154515) (- 0 211444)) (= (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@2|) addr@@1))) ($1_DiemVMConfig_DiemVMConfig ($1_DiemVMConfig_GasSchedule (|$instruction_schedule#$1_DiemVMConfig_GasSchedule| (|$gas_schedule#$1_DiemVMConfig_DiemVMConfig| $t18)) (|$native_schedule#$1_DiemVMConfig_GasSchedule| (|$gas_schedule#$1_DiemVMConfig_DiemVMConfig| $t18)) ($1_DiemVMConfig_GasConstants _$t1 _$t2 _$t3 _$t4 _$t5 _$t6 _$t7 _$t8 _$t9 _$t10 _$t11))))) (=> (= (let ((addr@@2 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@2|) addr@@2))) ($1_DiemVMConfig_DiemVMConfig ($1_DiemVMConfig_GasSchedule (|$instruction_schedule#$1_DiemVMConfig_GasSchedule| (|$gas_schedule#$1_DiemVMConfig_DiemVMConfig| $t18)) (|$native_schedule#$1_DiemVMConfig_GasSchedule| (|$gas_schedule#$1_DiemVMConfig_DiemVMConfig| $t18)) ($1_DiemVMConfig_GasConstants _$t1 _$t2 _$t3 _$t4 _$t5 _$t6 _$t7 _$t8 _$t9 _$t10 _$t11)))) (=> (= (ControlFlow 0 154515) (- 0 211481)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97907| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_97907| $1_DiemConfig_Configuration_$memory@2) 173345816)))))))))))))))))))))))))))))
(let ((anon29_Else_correct  (=> (and (and (not |$temp_0'bool'@1|) (= |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@1| ($Memory_95655 (|Store__T@[Int]Bool_| (|domain#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816 false) (|contents#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|)))) (and (= |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@2| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@1|) (= (ControlFlow 0 154279) 154515))) anon20_correct)))
(let ((anon29_Then_correct  (=> (and (and |$temp_0'bool'@1| (= |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@0| ($Memory_95655 (|Store__T@[Int]Bool_| (|domain#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816 true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816 |$temp_0'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig''@0|)))) (and (= |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@2| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@0|) (= (ControlFlow 0 154527) 154515))) anon20_correct)))
(let ((anon28_Else_correct  (=> (not |$temp_0'bool'@0|) (=> (and (= $1_DiemConfig_Configuration_$memory@1 ($Memory_97907 (|Store__T@[Int]Bool_| (|domain#$Memory_97907| $1_DiemConfig_Configuration_$memory) 173345816 false) (|contents#$Memory_97907| $1_DiemConfig_Configuration_$memory))) (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@1)) (and (=> (= (ControlFlow 0 154265) 154527) anon29_Then_correct) (=> (= (ControlFlow 0 154265) 154279) anon29_Else_correct))))))
(let ((anon28_Then_correct  (=> |$temp_0'bool'@0| (=> (and (= $1_DiemConfig_Configuration_$memory@0 ($Memory_97907 (|Store__T@[Int]Bool_| (|domain#$Memory_97907| $1_DiemConfig_Configuration_$memory) 173345816 true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_97907| $1_DiemConfig_Configuration_$memory) 173345816 |$temp_0'$1_DiemConfig_Configuration'@0|))) (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@0)) (and (=> (= (ControlFlow 0 154539) 154527) anon29_Then_correct) (=> (= (ControlFlow 0 154539) 154279) anon29_Else_correct))))))
...
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_96036| $1_Roles_RoleId_$memory) $a_0@@0)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |DiemVMConfigbpl.13006:20|
 :skolemid |212|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_96036| $1_Roles_RoleId_$memory) $a_0@@0))
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_97907| $1_DiemConfig_Configuration_$memory) $a_0@@1)))
(|$IsValid'$1_DiemConfig_Configuration'| $rsc@@1))
 :qid |DiemVMConfigbpl.13010:20|
 :skolemid |213|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_97907| $1_DiemConfig_Configuration_$memory) $a_0@@1))
)))) (and (and (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_97841| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@2)))
(|$IsValid'$1_DiemConfig_DisableReconfiguration'| $rsc@@2))
 :qid |DiemVMConfigbpl.13014:20|
 :skolemid |214|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_97841| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@2))
)) (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) $a_0@@3)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig''| $rsc@@3))
 :qid |DiemVMConfigbpl.13018:20|
 :skolemid |215|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) $a_0@@3))
))) (and (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_98964| |$1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory|) $a_0@@4)))
(|$IsValid'$1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig''| $rsc@@4))
 :qid |DiemVMConfigbpl.13022:20|
 :skolemid |216|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_98964| |$1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory|) $a_0@@4))
)) (= $t18 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_95655| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816))))))) (and (and (and (and (= $t19 (|$addr#$signer| _$t0)) (= $t20 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_97907| $1_DiemConfig_Configuration_$memory) 173345816))) (and (= $t21 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_94211| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= _$t4 _$t4)))) (and (and (and (= _$t5 _$t5) (= _$t6 _$t6)) (and (= _$t7 _$t7) (= _$t8 _$t8))) (and (and (= _$t9 _$t9) (= _$t10 _$t10)) (and (= _$t11 _$t11) (= $t22  (not (|Select__T@[Int]Bool_| (|domain#$Memory_94211| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))))) (and (=> (= (ControlFlow 0 153055) 154783) anon22_Then_correct) (=> (= (ControlFlow 0 153055) 153127) anon22_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_65536_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemVMConfigbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 152566) 153055)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (and (and (= (seq.len (|p#$Mutation_133335| $t17)) 0) (= (seq.len (|p#$Mutation_133377| $t33)) 0)) (and (= (seq.len (|p#$Mutation_133417| $t34)) 0) (= (seq.len (|p#$Mutation_133335| $t35)) 0))) (and (and (= (seq.len (|p#$Mutation_12338| $t36)) 0) (= (seq.len (|p#$Mutation_12338| $t37)) 0)) (and (= (seq.len (|p#$Mutation_12338| $t38)) 0) (= (seq.len (|p#$Mutation_12338| $t39)) 0)))) (and (and (and (= (seq.len (|p#$Mutation_12338| $t40)) 0) (= (seq.len (|p#$Mutation_12338| $t41)) 0)) (and (= (seq.len (|p#$Mutation_12338| $t42)) 0) (= (seq.len (|p#$Mutation_12338| $t43)) 0))) (and (and (= (seq.len (|p#$Mutation_12338| $t44)) 0) (= (seq.len (|p#$Mutation_12338| $t45)) 0)) (and (= (seq.len (|p#$Mutation_12338| $t46)) 0) (= (ControlFlow 0 152576) 152566))))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 208891) 152576) anon0_correct)))
