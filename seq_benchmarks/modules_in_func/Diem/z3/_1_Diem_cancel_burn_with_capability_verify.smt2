...
(declare-fun $t24 () T@$Mutation_312314)
...
(declare-fun $t14 () (Seq |T@$1_Diem_PreburnWithMetadata'#0'|))
...
(declare-fun $t6 () T@$Mutation_312314)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 869234) (let ((L5_correct  (=> (and (= $t20@0 $t20@0) (= $t36 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816))) (and (=> (= (ControlFlow 0 631214) (- 0 871361)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2)) (and (=> (= (ControlFlow 0 631214) (- 0 871373)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 631214) (- 0 871383)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 631214) (- 0 871394)) (not (let (($range_0 ($Range 0 (seq.len $t9))))
...
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@45 $i_1@@0))
 ...
 :qid |Diembpl.21727:57|
 :skolemid |689|
)))) (and (=> (= (ControlFlow 0 631214) (- 0 871441)) (= $t36 (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10)))) (=> (= $t36 (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))) (and (=> (= (ControlFlow 0 631214) (- 0 871459)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t0))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t0)) (and (=> (= (ControlFlow 0 631214) (- 0 871472)) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816) (and (=> (= (ControlFlow 0 631214) (- 0 871480)) (= (|$value#$1_Diem_Diem'#0'| $t20@0) _$t2)) (=> (= (|$value#$1_Diem_Diem'#0'| $t20@0) _$t2) (and (=> (= (ControlFlow 0 631214) (- 0 871489)) (> (|$value#$1_Diem_Diem'#0'| $t20@0) 0)) (=> (> (|$value#$1_Diem_Diem'#0'| $t20@0) 0) (and (=> (= (ControlFlow 0 631214) (- 0 871499)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 631214) (- 0 871519)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr))))
 ...
 :qid |Diembpl.21763:15|
 :skolemid |690|
)) (and (=> (= (ControlFlow 0 631214) (- 0 871548)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)))
 ...
 :qid |Diembpl.21768:15|
 :skolemid |691|
)) (and (=> (= (ControlFlow 0 631214) (- 0 871573)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 631214) (- 0 871593)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3))))
 ...
 :qid |Diembpl.21778:15|
 :skolemid |692|
)) (and (=> (= (ControlFlow 0 631214) (- 0 871622)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)))
 ...
 :qid |Diembpl.21783:15|
 :skolemid |693|
)) (and (=> (= (ControlFlow 0 631214) (- 0 871647)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 631214) (- 0 871667)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@7))))
 ...
 :qid |Diembpl.21793:15|
 :skolemid |694|
)) (and (=> (= (ControlFlow 0 631214) (- 0 871702)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@9)))
 ...
 :qid |Diembpl.21798:15|
 :skolemid |695|
)) (and (=> (= (ControlFlow 0 631214) (- 0 871726)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $EmptyEventStore) $t13 stream_new@@0)))) $EmptyEventStore)))
 ...
 :qid |Diembpl.2748:13|
 :skolemid |75|
))))) (=> (= (ControlFlow 0 631214) (- 0 871761)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
...
(let ((anon33_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 631557) (- 0 871089)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_255740 (|Store__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_312314| $t24@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_312314| $t24@2)) (|v#$Mutation_312314| $t24@2)))) (and (=> (= (ControlFlow 0 631557) (- 0 871137)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 ...
 :qid |Diembpl.21593:15|
 :skolemid |682|
)) (and (=> (= (ControlFlow 0 631557) (- 0 871205)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 ...
 :qid |Diembpl.21599:15|
 :skolemid |683|
)) (and (=> (= (ControlFlow 0 631557) (- 0 871228)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) dr_addr)))
 ...
 :qid |Diembpl.21605:15|
 :skolemid |684|
)) (and (=> (= (ControlFlow 0 631557) (- 0 871252)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |Diembpl.3809:13|
 :skolemid |111|
 ...
 :qid |Diembpl.3809:13|
 :skolemid |111|
)))) (and (=> (= (ControlFlow 0 631557) (- 0 871276)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |Diembpl.3809:13|
 :skolemid |111|
 ...
 :qid |Diembpl.3809:13|
 :skolemid |111|
)))) (and (=> (= (ControlFlow 0 631557) (- 0 871300)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |Diembpl.3814:13|
 :skolemid |112|
 ...
 :qid |Diembpl.3814:13|
 :skolemid |112|
))) (=> (= $es@1 $es@0) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@1|) (= (ControlFlow 0 631557) 631214)) L5_correct))))))))))))))))))))))
(let ((anon32_Else_correct  (=> (not inline$$Not$0$dst@1) (and (=> (= (ControlFlow 0 630731) (- 0 870610)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_255740 (|Store__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_312314| $t24@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_312314| $t24@2)) (|v#$Mutation_312314| $t24@2)))) (and (=> (= (ControlFlow 0 630731) (- 0 870658)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1@@1 Int) (mint_cap_owner2@@1 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@1) (=> (|$IsValid'address'| mint_cap_owner2@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@1)) (= mint_cap_owner1@@1 mint_cap_owner2@@1))))
 ...
 :qid |Diembpl.21659:15|
 :skolemid |686|
)) (and (=> (= (ControlFlow 0 630731) (- 0 870726)) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@13) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 ...
 :qid |Diembpl.21665:15|
 :skolemid |687|
)) (and (=> (= (ControlFlow 0 630731) (- 0 870749)) (forall ((dr_addr@@1 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@1)))
 ...
 :qid |Diembpl.21671:15|
 :skolemid |688|
)) (and (=> (= (ControlFlow 0 630731) (- 0 870773)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@5 Int) ) (!  (and (|$IsValid'address'| a@@5) (and ($1_Signer_is_txn_signer_addr a@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a@@5)) 1))))
 :qid |Diembpl.3809:13|
 :skolemid |111|
 ...
 :qid |Diembpl.3809:13|
 :skolemid |111|
)))) (and (=> (= (ControlFlow 0 630731) (- 0 870797)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@7 Int) ) (!  (and (|$IsValid'address'| a@@7) (and ($1_Signer_is_txn_signer_addr a@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a@@7)) 1))))
 :qid |Diembpl.3809:13|
 :skolemid |111|
 ...
 :qid |Diembpl.3809:13|
 :skolemid |111|
)))) (and (=> (= (ControlFlow 0 630731) (- 0 870821)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (exists ((a@@9 Int) ) (!  (and (|$IsValid'address'| a@@9) (and ($1_Signer_is_txn_signer_addr a@@9) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a@@9)) 0))))
 :qid |Diembpl.3814:13|
 :skolemid |112|
 ...
 :qid |Diembpl.3814:13|
 :skolemid |112|
))) (=> (= $es@1 $es) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@0|) (= (ControlFlow 0 630731) 631214)) L5_correct))))))))))))))))))))))
(let ((L7_correct  (and (=> (= (ControlFlow 0 630258) (- 0 870918)) (or (or (or (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0))) (let (($range_0@@1 ($Range 0 (seq.len $t9))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@46 $i_1@@1))
 ...
 :skolemid |696|
))))) (=> (or (or (or (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0))) (let (($range_0@@2 ($Range 0 (seq.len $t9))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@47 $i_1@@2))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t9 i@@47)))) _$t2))))
 :qid |Diembpl.21821:251|
 :skolemid |696|
)))) (=> (= (ControlFlow 0 630258) (- 0 870984)) (or (or (or (and (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2) (= 8 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)) (= 5 $t17@0))) (and (let (($range_0@@3 ($Range 0 (seq.len $t9))))
...
(let ((anon33_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 631571) 630258))) L7_correct)))
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 631311) 631571) anon33_Then_correct) (=> (= (ControlFlow 0 631311) 631557) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (and (and inline$$Not$0$dst@1 (= $t34@0 ($Mutation_240633 (|l#$Mutation_312314| $t24@2) (seq.++ (|p#$Mutation_312314| $t24@2) (seq.unit 11)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@2))))) (and (= $t35@0 ($1_Diem_CancelBurnEvent _$t2 $t21 _$t0)) (= (ControlFlow 0 631317) 631311))) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not $t32@0)) (and (=> (= (ControlFlow 0 630483) 631317) anon32_Then_correct) (=> (= (ControlFlow 0 630483) 630731) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (not $abort_flag@1) (= $t31@0 ($Mutation_13443 (|l#$Mutation_312314| $t24@1) (seq.++ (|p#$Mutation_312314| $t24@1) (seq.unit 1)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1))))) (=> (and (and (= $t31@1 ($Mutation_13443 (|l#$Mutation_13443| $t31@0) (|p#$Mutation_13443| $t31@0) inline$$Sub$0$dst@2)) (= $t24@2 ($Mutation_312314 (|l#$Mutation_312314| $t24@1) (|p#$Mutation_312314| $t24@1) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) (|v#$Mutation_13443| $t31@1) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)))))) (and (= $t32@0 (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@2))) (= (ControlFlow 0 630489) 630483))) inline$$Not$0$anon0_correct))))
(let ((anon31_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 631585) 630258))) L7_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 630399) 631585) anon31_Then_correct) (=> (= (ControlFlow 0 630399) 630489) anon31_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< $t29@0 _$t2) (= (ControlFlow 0 630397) 630399)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= _$t2 $t29@0) (=> (and (and (= inline$$Sub$0$dst@1 (- $t29@0 _$t2)) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 630349) 631585) anon31_Then_correct) (=> (= (ControlFlow 0 630349) 630489) anon31_Else_correct))))))
(let ((anon30_Then_correct  (=> (and inline$$Ge$0$dst@1 (= $t29@0 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)))) (and (=> (= (ControlFlow 0 630405) 630397) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 630405) 630349) inline$$Sub$0$anon3_Else_correct)))))
(let ((anon30_Else_correct  (=> (not inline$$Ge$0$dst@1) (and (=> (= (ControlFlow 0 630076) (- 0 870378)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1)) 10000000000)) (=> (= $t28 $t28) (=> (and (= $t17@0 $t28) (= (ControlFlow 0 630076) 630258)) L7_correct)))))))
(let ((anon29_Else$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t28) (= $t28 8)) (and (= $t28 $t28) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 630034) 630405) anon30_Then_correct) (=> (= (ControlFlow 0 630034) 630076) anon30_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= $t25@0 _$t2)) (= (ControlFlow 0 629998) 630034)) anon29_Else$1_correct)))
(let ((anon29_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| (|v#$Mutation_312314| $t24@1)) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| |$temp_0'$1_Diem_CurrencyInfo'#0''@0|)) (and (= $t25@0 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t24@1))) (= (ControlFlow 0 630004) 629998))) inline$$Ge$0$anon0_correct))))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 631599) 630258))) L7_correct)))
(let ((anon28_Then$1_correct  (=> (= $t24@1 $t24) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 631651) 631599) anon29_Then_correct) (=> (= (ControlFlow 0 631651) 630004) anon29_Else_correct))))))
(let ((anon28_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 631649) 631651)) anon28_Then$1_correct)))
(let ((anon28_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t24@0 ($Mutation_312314 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t24@1 $t24@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 629932) 631599) anon29_Then_correct) (=> (= (ControlFlow 0 629932) 630004) anon29_Else_correct))))))
(let ((anon27_Else_correct  (=> (not $t22) (=> (and (and (|$IsValid'vec'u8''| $t21) (= $t21 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t21 $t21) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 629910) (- 0 870198)) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (and (=> (= (ControlFlow 0 629910) 631649) anon28_Then_correct) (=> (= (ControlFlow 0 629910) 629932) anon28_Else_correct))))))))
(let ((anon27_Then_correct  (=> $t22 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17)) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 631677) 630258))) L7_correct))))
(let ((anon5_correct  (=> (and (and (and (|$IsValid'$1_Diem_PreburnWithMetadata'#0''| $t15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t0))) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| $t15))) _$t2) (= $t18@0 (|$preburn#$1_Diem_PreburnWithMetadata'#0'| $t15)))) (and (and (= $t19@0 (|$metadata#$1_Diem_PreburnWithMetadata'#0'| $t15)) (= $t20@0 (|$to_burn#$1_Diem_Preburn'#0'| $t18@0))) (and (= $t20@0 $t20@0) (= $t22  (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 629872) 631677) anon27_Then_correct) (=> (= (ControlFlow 0 629872) 629910) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= |$1_Diem_PreburnQueue'#0'_$memory@1| ($Memory_262370 (|Store__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0 false) (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@1|) (= (ControlFlow 0 629810) 629872))) anon5_correct)))
(let ((anon26_Then_correct  (=> (and (and |$temp_0'bool'@0| (= |$1_Diem_PreburnQueue'#0'_$memory@0| ($Memory_262370 (|Store__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0 true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0 |$temp_0'$1_Diem_PreburnQueue'#0''@0|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@0|) (= (ControlFlow 0 631689) 629872))) anon5_correct)))
(let ((anon25_Else_correct  (=> (not $t16) (and (=> (= (ControlFlow 0 629798) 631689) anon26_Then_correct) (=> (= (ControlFlow 0 629798) 629810) anon26_Else_correct)))))
(let ((anon25_Then_correct  (=> $t16 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)) (= 5 $t17)) (and (let (($range_0@@4 ($Range 0 (seq.len $t14))))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((i@@49 $i_1@@4))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t14 i@@49)))) _$t2))))
 :qid |Diembpl.21343:151|
 :skolemid |680|
))) (= 1 $t17))) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 631770) 630258))) L7_correct))))
(let ((anon0$1_correct  (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@3 Int) (mint_cap_owner2@@3 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@3) (=> (|$IsValid'address'| mint_cap_owner2@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@3)) (= mint_cap_owner1@@3 mint_cap_owner2@@3))))
 ...
 :skolemid |671|
)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr1) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr1)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) addr1)) 2))))
 :qid |Diembpl.21231:20|
 :skolemid |672|
))) (=> (and (and (forall ((dd_addr Int) ) (!  (=> (|$IsValid'address'| dd_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr)))))
 :qid |Diembpl.21235:20|
 :skolemid |673|
)) (forall ((dd_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@0))))
 :qid |Diembpl.21239:20|
 :skolemid |674|
))) (and (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.21243:20|
 :skolemid |675|
)) (|$IsValid'address'| _$t0))) (=> (and (and (and (and (|$IsValid'$1_Diem_BurnCapability'#0''| _$t1) (|$IsValid'u64'| _$t2)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0)))
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@0)))
...
)))) (and (and (= $t8 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t9 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)))) (and (= $t10 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t11 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= $t12 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t13 (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t11))) (and (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= _$t2 _$t2) (= $t14 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0))))))) (and (=> (= (ControlFlow 0 629790) (- 0 869880)) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0)) (=> (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0) (=> (= $t16  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)) (let (($range_0@@5 ($Range 0 (seq.len $t14))))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((i@@51 $i_1@@5))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t14 i@@51)))) _$t2))))
 :qid |Diembpl.21333:131|
 :skolemid |679|
))))) (and (=> (= (ControlFlow 0 629790) 631770) anon25_Then_correct) (=> (= (ControlFlow 0 629790) 629798) anon25_Else_correct)))))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 629264) 629790)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (seq.len (|p#$Mutation_312314| $t6)) 0) (=> (and (and (= (seq.len (|p#$Mutation_312314| $t24)) 0) (= (seq.len (|p#$Mutation_13443| $t31)) 0)) (and (= (seq.len (|p#$Mutation_240633| $t34)) 0) (= (ControlFlow 0 629274) 629264))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 869234) 629274) anon0_correct)))
