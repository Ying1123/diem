...
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@52))
 ...
 :skolemid |601|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'#0'_| (|contents#$Memory_122943| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $a_0@@53))
)) (forall (($a_0@@54 Int) ) (! (let (($rsc@@54 (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@54)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc@@54))
 :qid |AccountLimitsbpl.16573:20|
 :skolemid |602|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@54))
))) (and (|Select__T@[Int]Bool_| |$1_AccountLimits_Window'#0'_$modifies@@0| _$t1@@19) (= _$t0@@22 _$t0@@22)))) (and (and (and (= _$t1@@19 _$t1@@19) (= _$t2@@11 _$t2@@11)) (and (= $t5@0@@3 (|Select__T@[Int]Bool_| (|domain#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory|) _$t1@@19)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t7@@9) (= $t7@@9 5)) (and (= $t7@@9 $t7@@9) (= $t5@0@@3 $t5@0@@3)))))) (and (=> (= (ControlFlow 0 257098) 257426) anon12_Then_correct@@4) (=> (= (ControlFlow 0 257098) 257114) anon12_Else_correct@@4)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@22  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@24 T@$1_Event_EventHandle) ) (! (let ((stream@@23 (|Select__T@[$1_Event_EventHandle]Multiset_82546_| (|streams#$EventStore| $es) handle@@24)))
 (and (= (|l#Multiset_82546| stream@@23) 0) (forall ((v@@59 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_82546| stream@@23) v@@59) 0)
 :qid |AccountLimitsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountLimitsbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 256518) 257098)) anon0$1_correct@@22)))
(let ((anon0_correct@@22  (=> (and (= (|l#Vec_18658| (|p#$Mutation_127147| $t9@@9)) 0) (= (ControlFlow 0 256528) 256518)) inline$$InitEventStore$0$anon0_correct@@22)))
(let ((PreconditionGeneratedEntry_correct@@15  (=> (= (ControlFlow 0 311504) 256528) anon0_correct@@22)))
