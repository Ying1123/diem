...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 289248) (let ((anon7_Then_correct  (=> $t4 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_142163| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_142099| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 $t5)) (and (= $t5 $t5) (= (ControlFlow 0 213898) (- 0 289535)))) false))))
(let ((L3_correct  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 213796) (- 0 289592)) (not false)) (=> (not false) (=> (= (ControlFlow 0 213796) (- 0 289599)) (= $t1@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_142099| $1_VASP_ChildVASP_$memory) _$t0) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_142163| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_142099| $1_VASP_ChildVASP_$memory) _$t0))) _$t0))))))))
(let ((anon7_Else_correct  (=> (and (not $t4) (|$IsValid'address'| $t3)) (=> (and (and (= $t3 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_142163| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_142099| $1_VASP_ChildVASP_$memory) _$t0)))) (= $t3 $t3)) (and (= $t1@0 $t3) (= (ControlFlow 0 213852) 213796))) L3_correct))))
(let ((anon6_Then_correct  (=> (and $t2 (= $t4  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_142163| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_142099| $1_VASP_ChildVASP_$memory) _$t0))))) (and (=> (= (ControlFlow 0 213822) 213898) anon7_Then_correct) (=> (= (ControlFlow 0 213822) 213852) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (and (not $t2) (= _$t0 _$t0)) (and (= $t1@0 _$t0) (= (ControlFlow 0 213764) 213796))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_142099| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_142163| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_142099| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |DualAttestationbpl.13181:20|
 :skolemid |278|
)) (=> (and (and (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (= (|Select__T@[Int]Bool_| (|domain#$Memory_142163| $1_VASP_ParentVASP_$memory) addr)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr)) 5))))
 :qid |DualAttestationbpl.13185:20|
 :skolemid |279|
)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (= (|Select__T@[Int]Bool_| (|domain#$Memory_142099| $1_VASP_ChildVASP_$memory) addr@@0)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@0)) 6))))
 :qid |DualAttestationbpl.13189:20|
 :skolemid |280|
))) (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_148067| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@1) (or (|Select__T@[Int]Bool_| (|domain#$Memory_142163| $1_VASP_ParentVASP_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_142099| $1_VASP_ChildVASP_$memory) addr@@1))))
 :qid |DualAttestationbpl.13193:20|
 :skolemid |281|
)) (|$IsValid'address'| _$t0))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_142099| $1_VASP_ChildVASP_$memory) $a_0)))
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_142163| $1_VASP_ParentVASP_$memory) $a_0@@0)))
...
))) (and (= _$t0 _$t0) (= $t2 (|Select__T@[Int]Bool_| (|domain#$Memory_142099| $1_VASP_ChildVASP_$memory) _$t0))))) (and (=> (= (ControlFlow 0 213750) 213822) anon6_Then_correct) (=> (= (ControlFlow 0 213750) 213764) anon6_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2431:13|
 :skolemid |69|
))) (= (ControlFlow 0 213562) 213750)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 289248) 213562) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))
))
(check-sat)
(pop 1)
