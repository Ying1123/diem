...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 752745) (let ((anon4_Else_correct  (=> (and (not $abort_flag@3) (= $t12 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_278443| $1_VASPDomain_VASPDomains_$memory@2) _$t1)))) (and (=> (= (ControlFlow 0 546022) (- 0 755698)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1))) (and (=> (= (ControlFlow 0 546022) (- 0 755709)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (and (=> (= (ControlFlow 0 546022) (- 0 755719)) (not (exists ((i@@59 Int) ) (!  (and (and (|$IsValid'u64'| i@@59) (and (>= i@@59 0) (< i@@59 (seq.len $t3)))) (= (seq.nth $t3 i@@59) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
)))) (=> (not (exists ((i@@60 Int) ) (!  (and (and (|$IsValid'u64'| i@@60) (and (>= i@@60 0) (< i@@60 (seq.len $t3)))) (= (seq.nth $t3 i@@60) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
))) (and (=> (= (ControlFlow 0 546022) (- 0 755731)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 546022) (- 0 755743)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t4)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t4)) 1))) (and (=> (= (ControlFlow 0 546022) (- 0 755761)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 546022) (- 0 755775)) (not (> (seq.len _$t2) 63))) (=> (not (> (seq.len _$t2) 63)) (and (=> (= (ControlFlow 0 546022) (- 0 755787)) (exists ((i@@61 Int) ) (!  (and (and (|$IsValid'u64'| i@@61) (and (>= i@@61 0) (< i@@61 (seq.len $t12)))) (= (seq.nth $t12 i@@61) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
))) (=> (exists ((i@@62 Int) ) (!  (and (and (|$IsValid'u64'| i@@62) (and (>= i@@62 0) (< i@@62 (seq.len $t12)))) (= (seq.nth $t12 i@@62) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
)) (and (=> (= (ControlFlow 0 546022) (- 0 755797)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t5)))
(let ((stream_new (let ((len (|l#Multiset_181229| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@0) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@0) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t5 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t5)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_181229| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@1) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@1) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t5 stream_new@@0))))))
 ...
 :qid |TreasuryComplianceScriptsbpl.3464:13|
 :skolemid |95|
))))) (=> (= (ControlFlow 0 546022) (- 0 755822)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t5)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_181229| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@2) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@2) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $EmptyEventStore) $t5 stream_new@@1))))))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@3 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@1) handle@@3)) (|l#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@1) handle@@3))) (forall ((v@@51 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| actual@@1) handle@@3)) v@@51) (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| expected@@1) handle@@3)) v@@51))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3464:13|
...
(let ((anon4_Then_correct  (=> (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (=> (= (ControlFlow 0 546278) (- 0 755462)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (exists ((i@@63 Int) ) (!  (and (and (|$IsValid'u64'| i@@63) (and (>= i@@63 0) (< i@@63 (seq.len $t3)))) (= (seq.nth $t3 i@@63) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t4))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (> (seq.len _$t2) 63))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (exists ((i@@64 Int) ) (!  (and (and (|$IsValid'u64'| i@@64) (and (>= i@@64 0) (< i@@64 (seq.len $t3)))) (= (seq.nth $t3 i@@64) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t4))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (> (seq.len _$t2) 63)) (=> (= (ControlFlow 0 546278) (- 0 755528)) (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1)) (= 5 $abort_code@4)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= 5 $abort_code@4))) (and (exists ((i@@65 Int) ) (!  (and (and (|$IsValid'u64'| i@@65) (and (>= i@@65 0) (< i@@65 (seq.len $t3)))) (= (seq.nth $t3 i@@65) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
)) (= 7 $abort_code@4))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) $t4)) (= 5 $abort_code@4))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $abort_code@4))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $abort_code@4))) (and (> (seq.len _$t2) 63) (= 7 $abort_code@4))) (= 3 $abort_code@4)) (= 2 $abort_code@4)) (= 5 $abort_code@4)) (= 7 $abort_code@4))))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon44_Else_correct  (=> (not $abort_flag@2) (=> (and (and (= $abort_code@4 $abort_code@3) (= $abort_flag@3 $abort_flag@2)) (and (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory@0) (= $es@2 $es@0))) (and (=> (= (ControlFlow 0 545564) 546278) anon4_Then_correct) (=> (= (ControlFlow 0 545564) 546022) anon4_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$L7_correct  (=> (and (and (= $abort_code@4 inline$$1_VASPDomain_add_vasp_domain$0$$t17@1) (= $abort_flag@3 true)) (and (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory@1) (= $es@2 $es@1))) (and (=> (= (ControlFlow 0 544622) 546278) anon4_Then_correct) (=> (= (ControlFlow 0 544622) 546022) anon4_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon44_Then_correct  (=> (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@3) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory@0)) (and (= $es@1 $es@0) (= (ControlFlow 0 545578) 544622))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((|inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| (|v#$Mutation_213547| inline$$1_VASPDomain_add_vasp_domain$0$$t34@1)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_181229| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@3) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| inline$$1_VASPDomain_add_vasp_domain$0$$t36@1))))
(Multiset_181229 (|Store__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@3) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| inline$$1_VASPDomain_add_vasp_domain$0$$t36@1) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 545548) 545578) inline$$1_VASPDomain_add_vasp_domain$0$anon44_Then_correct) (=> (= (ControlFlow 0 545548) 545564) inline$$1_VASPDomain_add_vasp_domain$0$anon44_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon43_Else_correct  (=> (and (and (not $abort_flag@2) (= inline$$1_VASPDomain_add_vasp_domain$0$$t34@1 ($Mutation_213547 (|l#$Mutation_278539| inline$$1_VASPDomain_add_vasp_domain$0$$t33@2) (seq.++ (|p#$Mutation_278539| inline$$1_VASPDomain_add_vasp_domain$0$$t33@2) (seq.unit 0)) (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|v#$Mutation_278539| inline$$1_VASPDomain_add_vasp_domain$0$$t33@2))))) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t36@1 ($1_VASPDomain_VASPDomainEvent false inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 _$t1)) (= (ControlFlow 0 545554) 545548))) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon43_Then_correct  (=> (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@3) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory@0)) (and (= $es@1 $es) (= (ControlFlow 0 545592) 544622))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon42_Then$1_correct  (=> (= inline$$1_VASPDomain_add_vasp_domain$0$$t33@2 inline$$1_VASPDomain_add_vasp_domain$0$$t33@0) (=> (and (= $abort_flag@2 true) (= $abort_code@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 545644) 545592) inline$$1_VASPDomain_add_vasp_domain$0$anon43_Then_correct) (=> (= (ControlFlow 0 545644) 545554) inline$$1_VASPDomain_add_vasp_domain$0$anon43_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon42_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= (ControlFlow 0 545642) 545644)) inline$$1_VASPDomain_add_vasp_domain$0$anon42_Then$1_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon42_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t33@1 ($Mutation_278539 ($Global 186537453) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (= inline$$1_VASPDomain_add_vasp_domain$0$$t33@2 inline$$1_VASPDomain_add_vasp_domain$0$$t33@1)) (and (= $abort_flag@2 $abort_flag@1) (= $abort_code@3 $abort_code@2))) (and (=> (= (ControlFlow 0 545439) 545592) inline$$1_VASPDomain_add_vasp_domain$0$anon43_Then_correct) (=> (= (ControlFlow 0 545439) 545554) inline$$1_VASPDomain_add_vasp_domain$0$anon43_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon41_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_VASPDomain_add_vasp_domain$0$$t24@3 ($Mutation_278478 (|l#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2) (|p#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2) ($1_VASPDomain_VASPDomains (|v#$Mutation_198443| |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$m'@1|))))) (and (= $1_VASPDomain_VASPDomains_$memory@0 ($Memory_278443 (|Store__T@[Int]Bool_| (|domain#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t24@3)) true) (|Store__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t24@3)) (|v#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t24@3)))) (|$IsValid'address'| 186537453))) (and (=> (= (ControlFlow 0 545417) 545642) inline$$1_VASPDomain_add_vasp_domain$0$anon42_Then_correct) (=> (= (ControlFlow 0 545417) 545439) inline$$1_VASPDomain_add_vasp_domain$0$anon42_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon41_Then_correct  (=> (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@2) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 545658) 544622))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((|inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$m'@1| ($Mutation_198443 (|l#$Mutation_198443| inline$$1_VASPDomain_add_vasp_domain$0$$t31@1) (|p#$Mutation_198443| inline$$1_VASPDomain_add_vasp_domain$0$$t31@1) (seq.++ (|v#$Mutation_198443| inline$$1_VASPDomain_add_vasp_domain$0$$t31@1) (seq.unit inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)))) (and (=> (= (ControlFlow 0 545369) 545658) inline$$1_VASPDomain_add_vasp_domain$0$anon41_Then_correct) (=> (= (ControlFlow 0 545369) 545417) inline$$1_VASPDomain_add_vasp_domain$0$anon41_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon40_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t31@1 ($Mutation_198443 (|l#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2) (seq.++ (|p#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2) (seq.unit 0)) (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2)))) (= (ControlFlow 0 545375) 545369)) |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$anon0_correct|))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon40_Else_correct  (=> (and (not inline$$Not$0$dst@1) (= inline$$1_VASPDomain_add_vasp_domain$0$$t30@0 inline$$1_VASPDomain_add_vasp_domain$0$$t30@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t30@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 545302) 544622))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon39_Else$1_correct  (=> (|$IsValid'u64'| 3) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_add_vasp_domain$0$$t30@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t30@0 7)) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t30@0 inline$$1_VASPDomain_add_vasp_domain$0$$t30@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 545286) 545375) inline$$1_VASPDomain_add_vasp_domain$0$anon40_Then_correct) (=> (= (ControlFlow 0 545286) 545302) inline$$1_VASPDomain_add_vasp_domain$0$anon40_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1|)) (= (ControlFlow 0 545246) 545286)) inline$$1_VASPDomain_add_vasp_domain$0$anon39_Else$1_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon39_Else_correct  (=> (and (not $abort_flag@1) (= (ControlFlow 0 545252) 545246)) inline$$Not$0$anon0_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon39_Then_correct  (=> (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@2) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 545672) 544622))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((|inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| (exists ((i@@66 Int) ) (!  (and (and (|$IsValid'u64'| i@@66) (and (>= i@@66 0) (< i@@66 (seq.len inline$$1_VASPDomain_add_vasp_domain$0$$t26@1)))) (= (seq.nth inline$$1_VASPDomain_add_vasp_domain$0$$t26@1 i@@66) inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
))) (and (=> (= (ControlFlow 0 545202) 545672) inline$$1_VASPDomain_add_vasp_domain$0$anon39_Then_correct) (=> (= (ControlFlow 0 545202) 545252) inline$$1_VASPDomain_add_vasp_domain$0$anon39_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon38_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t26@1 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2))) (= (ControlFlow 0 545208) 545202))) |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon38_Then_correct  (=> (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@2) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 545686) 544622))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$L3_correct  (=> (= $abort_code@2 inline$$1_VASPDomain_create_vasp_domain$0$$t4@1) (=> (and (= $abort_flag@1 true) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@0)) (and (=> (= (ControlFlow 0 545102) 545686) inline$$1_VASPDomain_add_vasp_domain$0$anon38_Then_correct) (=> (= (ControlFlow 0 545102) 545208) inline$$1_VASPDomain_add_vasp_domain$0$anon38_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= (ControlFlow 0 545096) 545102))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 $abort_code@1) (= (ControlFlow 0 545134) 545102))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct  (=> (and inline$$Le$0$dst@1 (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 ($1_VASPDomain_VASPDomain _$t2))) (=> (and (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1))) (and (=> (= (ControlFlow 0 545120) 545686) inline$$1_VASPDomain_add_vasp_domain$0$anon38_Then_correct) (=> (= (ControlFlow 0 545120) 545208) inline$$1_VASPDomain_add_vasp_domain$0$anon38_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 7)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 545080) 545120) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct) (=> (= (ControlFlow 0 545080) 545096) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 545044) 545080)) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 545050) 545044)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (seq.len _$t2)) (and (=> (= (ControlFlow 0 544984) 545134) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct) (=> (= (ControlFlow 0 544984) 545050) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct)))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct  (=> (and (= _$t2 _$t2) (= (ControlFlow 0 544990) 544984)) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon37_Else_correct  (=> (and (and (not $abort_flag@0) (= |inline$$1_VASPDomain_add_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1| (|v#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2))) (and (= |inline$$1_VASPDomain_add_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1| |inline$$1_VASPDomain_add_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1|) (= (ControlFlow 0 545140) 544990))) inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon37_Then_correct  (=> (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@1) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 545700) 544622))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon36_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$1_VASPDomain_add_vasp_domain$0$$t24@2 inline$$1_VASPDomain_add_vasp_domain$0$$t24@0)) (and (=> (= (ControlFlow 0 545752) 545700) inline$$1_VASPDomain_add_vasp_domain$0$anon37_Then_correct) (=> (= (ControlFlow 0 545752) 545140) inline$$1_VASPDomain_add_vasp_domain$0$anon37_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon36_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1)) (= (ControlFlow 0 545750) 545752)) inline$$1_VASPDomain_add_vasp_domain$0$anon36_Then$1_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon36_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t24@1 ($Mutation_278478 ($Global _$t1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1))) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t24@2 inline$$1_VASPDomain_add_vasp_domain$0$$t24@1))) (and (=> (= (ControlFlow 0 544706) 545700) inline$$1_VASPDomain_add_vasp_domain$0$anon37_Then_correct) (=> (= (ControlFlow 0 544706) 545140) inline$$1_VASPDomain_add_vasp_domain$0$anon37_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon35_Then_correct  (=> inline$$1_VASPDomain_add_vasp_domain$0$$t21@1 (and (=> (= (ControlFlow 0 544684) 545750) inline$$1_VASPDomain_add_vasp_domain$0$anon36_Then_correct) (=> (= (ControlFlow 0 544684) 544706) inline$$1_VASPDomain_add_vasp_domain$0$anon36_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon35_Else_correct  (=> (and (not inline$$1_VASPDomain_add_vasp_domain$0$$t21@1) (= inline$$1_VASPDomain_add_vasp_domain$0$$t23@0 inline$$1_VASPDomain_add_vasp_domain$0$$t23@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t23@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 544680) 544622))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon34_Then_correct  (=> inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 (=> (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t21@1 (|Select__T@[Int]Bool_| (|domain#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1)) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_add_vasp_domain$0$$t23@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t23@0 5)) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t23@0 inline$$1_VASPDomain_add_vasp_domain$0$$t23@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t21@1 inline$$1_VASPDomain_add_vasp_domain$0$$t21@1))) (and (=> (= (ControlFlow 0 544664) 544684) inline$$1_VASPDomain_add_vasp_domain$0$anon35_Then_correct) (=> (= (ControlFlow 0 544664) 544680) inline$$1_VASPDomain_add_vasp_domain$0$anon35_Else_correct)))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon34_Else_correct  (=> (and (not inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1) (= inline$$1_VASPDomain_add_vasp_domain$0$$t20@0 inline$$1_VASPDomain_add_vasp_domain$0$$t20@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t20@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 544616) 544622))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon33_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_add_vasp_domain$0$$t20@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t20@0 5)) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t20@0 inline$$1_VASPDomain_add_vasp_domain$0$$t20@0) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1))) (and (=> (= (ControlFlow 0 544600) 544664) inline$$1_VASPDomain_add_vasp_domain$0$anon34_Then_correct) (=> (= (ControlFlow 0 544600) 544616) inline$$1_VASPDomain_add_vasp_domain$0$anon34_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon32_Then_correct  (=> inline$$1_VASPDomain_add_vasp_domain$0$$t16@0 (=> (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_add_vasp_domain$0$$t15@0)) (= 5 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_add_vasp_domain$0$$t15@0)) 1)) (= 3 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0))) (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@0 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1 $es) (= (ControlFlow 0 545838) 544622))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon33_Then_correct true))
(let ((inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct  (=> (|$IsValid'address'| 186537453) (=> (and (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1)) (and (=> (= (ControlFlow 0 544558) 545766) inline$$1_VASPDomain_add_vasp_domain$0$anon33_Then_correct) (=> (= (ControlFlow 0 544558) 544600) inline$$1_VASPDomain_add_vasp_domain$0$anon33_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon32_Else_correct  (=> (and (not inline$$1_VASPDomain_add_vasp_domain$0$$t16@0) (= (ControlFlow 0 544564) 544558)) inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon0_correct  (=> (and (= (seq.len (|p#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t9@0)) 0) (= (seq.len (|p#$Mutation_278478| inline$$1_VASPDomain_add_vasp_domain$0$$t24@0)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_198443| inline$$1_VASPDomain_add_vasp_domain$0$$t31@0)) 0) (= (seq.len (|p#$Mutation_278539| inline$$1_VASPDomain_add_vasp_domain$0$$t33@0)) 0)) (and (= (seq.len (|p#$Mutation_213547| inline$$1_VASPDomain_add_vasp_domain$0$$t34@0)) 0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t11@0 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1))))) (=> (and (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t12@0 (|$addr#$signer| _$t0)) (= inline$$1_VASPDomain_add_vasp_domain$0$$t13@0 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t14@0 ($1_VASPDomain_VASPDomainEvent false ($1_VASPDomain_VASPDomain _$t2) _$t1)) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t15@0 (|$addr#$signer| _$t0)) (= inline$$1_VASPDomain_add_vasp_domain$0$$t16@0  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_add_vasp_domain$0$$t15@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_add_vasp_domain$0$$t15@0)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))) (and (=> (= (ControlFlow 0 544471) 545838) inline$$1_VASPDomain_add_vasp_domain$0$anon32_Then_correct) (=> (= (ControlFlow 0 544471) 544564) inline$$1_VASPDomain_add_vasp_domain$0$anon32_Else_correct)))))))
(let ((anon0$1_correct  (=> (and (and (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_220584| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@0)) 4))))
 :qid |TreasuryComplianceScriptsbpl.32245:20|
 :skolemid |630|
 ...
 :qid |TreasuryComplianceScriptsbpl.32249:20|
 :skolemid |631|
 ...
 :qid |TreasuryComplianceScriptsbpl.32253:20|
 :skolemid |632|
 ...
 :qid |TreasuryComplianceScriptsbpl.32257:20|
 :skolemid |633|
)))) (and (and (forall ((mint_cap_owner Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233559| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) mint_cap_owner) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) mint_cap_owner)) 1))))
 :qid |TreasuryComplianceScriptsbpl.32261:22|
 :skolemid |634|
 ...
 :qid |TreasuryComplianceScriptsbpl.32261:269|
 :skolemid |635|
 ...
 :qid |TreasuryComplianceScriptsbpl.32261:517|
 :skolemid |636|
)))) (and (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_228752| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1)) 1))))
 :qid |TreasuryComplianceScriptsbpl.32265:22|
 :skolemid |637|
 ...
 :qid |TreasuryComplianceScriptsbpl.32265:232|
 :skolemid |638|
 ...
 :qid |TreasuryComplianceScriptsbpl.32269:293|
 :skolemid |641|
 ...
 :qid |TreasuryComplianceScriptsbpl.32269:565|
 :skolemid |642|
))))) (=> (and (and (and (and (and (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_271409| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@4) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@4)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@4)) 6)))))
 :qid |TreasuryComplianceScriptsbpl.32273:22|
 :skolemid |643|
)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_271473| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@5) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@5)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@5)) 6)))))
 :qid |TreasuryComplianceScriptsbpl.32273:388|
 :skolemid |644|
))) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_271537| |$1_AccountLimits_Window'#0'_$memory|) addr@@6) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@6) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@6)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@6)) 6)))))
 :qid |TreasuryComplianceScriptsbpl.32273:755|
 :skolemid |645|
))) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_288663| $1_DualAttestation_Credential_$memory) addr1@@5) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr1@@5)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.32277:20|
 :skolemid |646|
))) (and (and (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_296946| $1_DiemAccount_DiemAccount_$memory) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@7)))
 :qid |TreasuryComplianceScriptsbpl.32281:20|
 :skolemid |647|
)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) addr@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@8)) 1))))
 :qid |TreasuryComplianceScriptsbpl.32285:20|
 :skolemid |648|
))) (and (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_296697| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_296780| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@9)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@9)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@9)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@9)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.32289:20|
 :skolemid |649|
)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_292558| $1_DesignatedDealer_Dealer_$memory) addr@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@10)) 2))))
 :qid |TreasuryComplianceScriptsbpl.32293:20|
 :skolemid |650|
))))) (and (and (and (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_288663| $1_DualAttestation_Credential_$memory) addr@@11) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@11)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@11)) 5)))))
 :qid |TreasuryComplianceScriptsbpl.32297:20|
 :skolemid |651|
)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221188| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@12) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@12)) 3))))
 :qid |TreasuryComplianceScriptsbpl.32301:20|
 :skolemid |652|
))) (and (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_220584| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@13) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@13)) 4))))
 :qid |TreasuryComplianceScriptsbpl.32305:20|
 :skolemid |653|
)) (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_281718| $1_VASP_ParentVASP_$memory) addr@@14) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@14)) 5))))
 :qid |TreasuryComplianceScriptsbpl.32309:20|
 :skolemid |654|
)))) (and (and (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_281654| $1_VASP_ChildVASP_$memory) addr@@15) (and (|Select__T@[Int]Bool_| (|domain#$Memory_220257| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) addr@@15)) 6))))
 :qid |TreasuryComplianceScriptsbpl.32313:20|
 :skolemid |655|
)) (|$IsValid'address'| (|$addr#$signer| _$t0))) (and (|$IsValid'address'| _$t1) (|$IsValid'vec'u8''| _$t2))))) (and (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |TreasuryComplianceScriptsbpl.32325:20|
 :skolemid |656|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_220257| $1_Roles_RoleId_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@0)))
(|$IsValid'$1_VASPDomain_VASPDomainManager'| $rsc@@0))
 :qid |TreasuryComplianceScriptsbpl.32329:20|
 :skolemid |657|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) $a_0@@1)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc@@1) (and (and (let (($range_1 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@67 $i_2))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1) i@@67))) 63)))
 :qid |TreasuryComplianceScriptsbpl.32334:140|
 :skolemid |658|
))) (let (($range_3 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@68 $i_4))
(let (($range_5 ($Range (+ i@@68 1) (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@14 $i_6))
 (not (= (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1) i@@68) (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1) j@@14)))))
 :qid |TreasuryComplianceScriptsbpl.32336:98|
 :skolemid |659|
)))))
 :qid |TreasuryComplianceScriptsbpl.32335:202|
 :skolemid |660|
...
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 :qid |TreasuryComplianceScriptsbpl.32337:229|
 :skolemid |661|
))))))
 :qid |TreasuryComplianceScriptsbpl.32333:20|
 :skolemid |662|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) $a_0@@1))
)) (= $t3 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1))))) (and (and (= $t4 (|$addr#$signer| _$t0)) (= $t5 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $t6 ($1_VASPDomain_VASPDomainEvent false ($1_VASPDomain_VASPDomain _$t2) _$t1)) (let ((addr@@16 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_219763| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_296946| $1_DiemAccount_DiemAccount_$memory) addr@@16)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_293319| $1_AccountFreezing_FreezingBit_$memory) addr@@16) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_293319| $1_AccountFreezing_FreezingBit_$memory) addr@@16))))))))) (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= _$t2 _$t2) (= $t7 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_278443| $1_VASPDomain_VASPDomains_$memory) _$t1))))) (and (and (= $t8 (|$addr#$signer| _$t0)) (= $t9 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_278076| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $t10 ($1_VASPDomain_VASPDomainEvent false ($1_VASPDomain_VASPDomain _$t2) _$t1)) (= (ControlFlow 0 545842) 544471)))))) inline$$1_VASPDomain_add_vasp_domain$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_181229_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_181229| stream@@4) 0) (forall ((v@@52 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_181229| stream@@4) v@@52) 0)
 :qid |TreasuryComplianceScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |TreasuryComplianceScriptsbpl.3448:13|
 :skolemid |94|
))) (= (ControlFlow 0 542065) 545842)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 752745) 542065) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
