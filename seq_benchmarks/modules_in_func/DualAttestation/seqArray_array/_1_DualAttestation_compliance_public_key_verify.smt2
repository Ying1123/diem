...
(assert (not
 (=> (= (ControlFlow 0 0) 333788) (let ((anon12_Else_correct@@3  (=> (not $abort_flag@0@@4) (=> (and (= $t8@0@@5 (|$compliance_public_key#$1_DualAttestation_Credential| $t7@1@@1)) (= $t8@0@@5 $t8@0@@5)) (and (=> (= (ControlFlow 0 247879) (- 0 334112)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@15)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@15))) (and (=> (= (ControlFlow 0 247879) (- 0 334123)) (|$IsEqual'vec'u8''| $t8@0@@5 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@15)))) (=> (|$IsEqual'vec'u8''| $t8@0@@5 (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@15))) (and (=> (= (ControlFlow 0 247879) (- 0 334134)) (forall ((addr1@@36 Int) ) (!  (=> (|$IsValid'address'| addr1@@36) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@36) (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@36)))
 :qid |DualAttestationbpl.15219:15|
 :skolemid |342|
))) (=> (forall ((addr1@@37 Int) ) (!  (=> (|$IsValid'address'| addr1@@37) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@37) (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@37)))
 :qid |DualAttestationbpl.15219:15|
 :skolemid |342|
)) (and (=> (= (ControlFlow 0 247879) (- 0 334159)) (forall ((addr1@@38 Int) ) (!  (=> (|$IsValid'address'| addr1@@38) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@38)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@38))))
 :qid |DualAttestationbpl.15224:15|
 :skolemid |343|
))) (=> (forall ((addr1@@39 Int) ) (!  (=> (|$IsValid'address'| addr1@@39) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@39)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@39))))
 :qid |DualAttestationbpl.15224:15|
 :skolemid |343|
)) (and (=> (= (ControlFlow 0 247879) (- 0 334188)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)))) (and (=> (= (ControlFlow 0 247879) (- 0 334205)) (forall ((addr1@@40 Int) ) (!  (=> (|$IsValid'address'| addr1@@40) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@40) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@40)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@40)))))
 :qid |DualAttestationbpl.15234:15|
 :skolemid |344|
))) (=> (forall ((addr1@@41 Int) ) (!  (=> (|$IsValid'address'| addr1@@41) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@41) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@41)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@41)))))
 :qid |DualAttestationbpl.15234:15|
 :skolemid |344|
)) (=> (= (ControlFlow 0 247879) (- 0 334241)) (forall ((addr1@@42 Int) ) (!  (=> (|$IsValid'address'| addr1@@42) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@42) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@42)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@42)))))
 :qid |DualAttestationbpl.15239:15|
 :skolemid |345|
)))))))))))))))))))
(let ((L3_correct@@2  (and (=> (= (ControlFlow 0 247669) (- 0 334065)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@15))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@15)) (=> (= (ControlFlow 0 247669) (- 0 334071)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@15)) (= 5 $t6@0@@2)))))))
(let ((anon12_Then_correct@@3  (=> (and (and $abort_flag@0@@4 (= $abort_code@1@@4 $abort_code@1@@4)) (and (= $t6@0@@2 $abort_code@1@@4) (= (ControlFlow 0 247893) 247669))) L3_correct@@2)))
(let ((anon11_Then$1_correct@@2  (=> (= $t7@1@@1 $t7@@4) (=> (and (= $abort_flag@0@@4 true) (= $abort_code@1@@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 247945) 247893) anon12_Then_correct@@3) (=> (= (ControlFlow 0 247945) 247879) anon12_Else_correct@@3))))))
(let ((anon11_Then_correct@@8  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@15)) (= (ControlFlow 0 247943) 247945)) anon11_Then$1_correct@@2)))
(let ((anon11_Else_correct@@8  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@15) (=> (and (and (= $t7@0@@1 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@15)) (= $t7@1@@1 $t7@0@@1)) (and (= $abort_flag@0@@4 false) (= $abort_code@1@@4 $abort_code@0@@4))) (and (=> (= (ControlFlow 0 247687) 247893) anon12_Then_correct@@3) (=> (= (ControlFlow 0 247687) 247879) anon12_Else_correct@@3))))))
(let ((anon10_Then_correct@@7  (=> $t3@0@@1 (and (=> (= (ControlFlow 0 247673) 247943) anon11_Then_correct@@8) (=> (= (ControlFlow 0 247673) 247687) anon11_Else_correct@@8)))))
(let ((anon10_Else_correct@@7  (=> (and (and (not $t3@0@@1) (= $t5@@9 $t5@@9)) (and (= $t6@0@@2 $t5@@9) (= (ControlFlow 0 247637) 247669))) L3_correct@@2)))
(let ((anon0$1_correct@@15  (=> (and (forall ((addr1@@43 Int) ) (!  (=> (|$IsValid'address'| addr1@@43) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@43) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@43) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@43)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@43) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@43)) 2)))))
 :qid |DualAttestationbpl.15116:20|
 :skolemid |340|
)) (|$IsValid'address'| _$t0@@15)) (=> (and (and (and (forall (($a_0@@33 Int) ) (! (let (($rsc@@33 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) $a_0@@33)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@33))
 :qid |DualAttestationbpl.15123:20|
 :skolemid |341|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) $a_0@@33))
)) (= _$t0@@15 _$t0@@15)) (and (= $t3@0@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) _$t0@@15)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5@@9) (= $t5@@9 5)) (and (= $t5@@9 $t5@@9) (= $t3@0@@1 $t3@0@@1)))) (and (=> (= (ControlFlow 0 247621) 247673) anon10_Then_correct@@7) (=> (= (ControlFlow 0 247621) 247637) anon10_Else_correct@@7))))))
(let ((inline$$InitEventStore$0$anon0_correct@@15  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@17 T@$1_Event_EventHandle) ) (! (let ((stream@@16 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $es) handle@@17)))
 (and (= (|l#Multiset_93630| stream@@16) 0) (forall ((v@@67 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@16) v@@67) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2823:13|
 :skolemid |103|
))) (= (ControlFlow 0 247500) 247621)) anon0$1_correct@@15)))
(let ((anon0_correct@@15  (=> (= (ControlFlow 0 333788) 247500) inline$$InitEventStore$0$anon0_correct@@15)))
anon0_correct@@15))))))))))))
))
(check-sat)
(pop 1)
