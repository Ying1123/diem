...
(assert (not
 ...
 :qid |AccountLimitsbpl.20435:474|
 :skolemid |585|
))) (and (=> (= (ControlFlow 0 333558) (- 0 442511)) (and (and (forall ((window_addr@@5 Int) ) (!  (=> (|$IsValid'address'| window_addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0|) window_addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_179731| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0|) window_addr@@5)))))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_112887_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 331927) 332391)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (|l#Vec_27093| (|p#$Mutation_185748| $t9)) 0) (= (ControlFlow 0 331937) 331927)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 441157) 331937) anon0_correct)))
