...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 230801) (let ((L5_correct  (and (=> (= (ControlFlow 0 170754) (- 0 231361)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 170754) (- 0 231371)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= 5 $t2@0)))))))
(let ((anon14_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2)) (= $t2 $t2)) (and (= $t2@0 $t2) (= (ControlFlow 0 170714) 170754))) L5_correct))))
(let ((anon13_Then_correct  (=> $t4 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2)) (= $t2 $t2)) (and (= $t2@0 $t2) (= (ControlFlow 0 170780) 170754))) L5_correct))))
(let ((L3_correct  (=> (= $t0@0 $t0@0) (and (=> (= (ControlFlow 0 170612) (- 0 231318)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (= (ControlFlow 0 170612) (- 0 231333)) (= $t0@0  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))
(let ((anon14_Else_correct  (=> (not $t6) (=> (and (|$IsValid'vec'u8''| $t5) (= $t5 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (= $t7@0 (= $t3 $t5)) (= $t7@0 $t7@0)) (and (= $t0@0 $t7@0) (= (ControlFlow 0 170688) 170612))) L3_correct)))))
(let ((anon13_Else_correct  (=> (and (and (not $t4) (|$IsValid'vec'u8''| $t3)) (and (= $t3 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 170654) 170714) anon14_Then_correct) (=> (= (ControlFlow 0 170654) 170688) anon14_Else_correct)))))
(let ((anon12_Then_correct  (=> (and |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (= $t4  (not (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 170626) 170780) anon13_Then_correct) (=> (= (ControlFlow 0 170626) 170654) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|) (= false false)) (and (= $t0@0 false) (= (ControlFlow 0 170572) 170612))) L3_correct)))
(let ((anon11_Else_correct  (=> (not false) (and (=> (= (ControlFlow 0 170552) 170626) anon12_Then_correct) (=> (= (ControlFlow 0 170552) 170572) anon12_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((|inline$$1_Diem_is_currency'$1_XDX_XDX'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|)) (and (=> (= (ControlFlow 0 170538) 170794) anon11_Then_correct) (=> (= (ControlFlow 0 170538) 170552) anon11_Else_correct))))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114469| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |XDXbpl.10881:22|
 :skolemid |218|
)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114560| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXbpl.10881:222|
 :skolemid |219|
))) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114651| |$1_Diem_Preburn'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_109118| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXbpl.10881:423|
 :skolemid |220|
))) (=> (and (and (and (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114878| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_108912| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |XDXbpl.10885:22|
 :skolemid |221|
)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114977| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXbpl.10885:227|
 :skolemid |222|
))) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115076| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_109118| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXbpl.10885:433|
 :skolemid |223|
))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_99833| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0)))
 ...
 :qid |XDXbpl.10893:20|
 :skolemid |224|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@0)))
 ...
 :qid |XDXbpl.10897:20|
 :skolemid |225|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101361| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@0))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_68954_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |XDXbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 170205) 170544)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 230801) 170205) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))
))
(check-sat)
(pop 1)
