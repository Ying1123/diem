...
(declare-fun $t14@0 () T@$Mutation_13443)
(declare-fun $t13@1 () T@$Mutation_191261)
(declare-fun $t14@1 () T@$Mutation_13443)
...
(declare-fun $t13 () T@$Mutation_191261)
(declare-fun $t13@0 () T@$Mutation_191261)
...
(declare-fun $t14 () T@$Mutation_13443)
(push 1)
(set-info :boogie-vc-id $1_DualAttestation_set_microdiem_limit$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 326809) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t14@0 ($Mutation_13443 (|l#$Mutation_191261| $t13@1) (seq.++ (|p#$Mutation_191261| $t13@1) (seq.unit 0)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|v#$Mutation_191261| $t13@1)))) (= $t14@1 ($Mutation_13443 (|l#$Mutation_13443| $t14@0) (|p#$Mutation_13443| $t14@0) _$t1))) (and (= $t13@2 ($Mutation_191261 (|l#$Mutation_191261| $t13@1) (|p#$Mutation_191261| $t13@1) ($1_DualAttestation_Limit (|v#$Mutation_13443| $t14@1)))) (= $1_DualAttestation_Limit_$memory@0 ($Memory_124467 (|Store__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) (|a#$Global| (|l#$Mutation_191261| $t13@2)) true) (|Store__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) (|a#$Global| (|l#$Mutation_191261| $t13@2)) (|v#$Mutation_191261| $t13@2)))))) (and (=> (= (ControlFlow 0 247826) (- 0 327656)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory@0) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory@0) 173345816)) (and (=> (= (ControlFlow 0 247826) (- 0 327671)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 247826) (- 0 327683)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) $t4)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) $t4)) 1))) (and (=> (= (ControlFlow 0 247826) (- 0 327701)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 247826) (- 0 327715)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816))) (and (=> (= (ControlFlow 0 247826) (- 0 327725)) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory@0) 173345816)) _$t1)) (=> (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory@0) 173345816)) _$t1) (and (=> (= (ControlFlow 0 247826) (- 0 327738)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1) (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1)))
 :qid |DualAttestationbpl.18916:15|
 :skolemid |415|
 ...
 :qid |DualAttestationbpl.18916:15|
 :skolemid |415|
)) (and (=> (= (ControlFlow 0 247826) (- 0 327763)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1))))
 :qid |DualAttestationbpl.18921:15|
 :skolemid |416|
 ...
 :qid |DualAttestationbpl.18921:15|
 :skolemid |416|
)) (and (=> (= (ControlFlow 0 247826) (- 0 327792)) (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@3) (= (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@3)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@3)))))
 :qid |DualAttestationbpl.18926:15|
 :skolemid |417|
 ...
 :qid |DualAttestationbpl.18926:15|
 :skolemid |417|
)) (=> (= (ControlFlow 0 247826) (- 0 327828)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5) (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)))))
 :qid |DualAttestationbpl.18931:15|
 :skolemid |418|
)))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 247532) (- 0 327478)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816))) (=> (= (ControlFlow 0 247532) (- 0 327518)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t7@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (= 5 $t7@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 247840) 247532))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= $t13@1 $t13) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 247892) 247840) anon15_Then_correct) (=> (= (ControlFlow 0 247892) 247826) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (= (ControlFlow 0 247890) 247892)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816) (=> (and (and (= $t13@0 ($Mutation_191261 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816))) (= $t13@1 $t13@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 247564) 247840) anon15_Then_correct) (=> (= (ControlFlow 0 247564) 247826) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and $t9@0 (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 247542) 247890) anon14_Then_correct) (=> (= (ControlFlow 0 247542) 247564) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (and (not $t9@0) (= $t11 $t11)) (and (= $t7@0 $t11) (= (ControlFlow 0 247404) 247532))) L3_correct)))
(let ((anon12_Else_correct  (=> (and (and (and (not $t6) (|$IsValid'address'| 173345816)) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t11) (= $t11 5)) (and (= $t11 $t11) (= $t9@0 $t9@0)))) (and (=> (= (ControlFlow 0 247388) 247542) anon13_Then_correct) (=> (= (ControlFlow 0 247388) 247404) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> $t6 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) $t5)) 1)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 247964) 247532))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((mint_cap_owner Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_148973| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner) (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) mint_cap_owner) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) mint_cap_owner)) 1))))
 :qid |DualAttestationbpl.18706:21|
 :skolemid |406|
 ...
 :qid |DualAttestationbpl.18706:268|
 :skolemid |407|
))) (and (forall ((addr1@@6 Int) ) (!  (=> (|$IsValid'address'| addr1@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_144253| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1@@6) (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@6)) 1))))
 :qid |DualAttestationbpl.18710:21|
 :skolemid |408|
)) (forall ((addr1@@7 Int) ) (!  (=> (|$IsValid'address'| addr1@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_144340| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr1@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@7)) 1))))
 :qid |DualAttestationbpl.18710:231|
 :skolemid |409|
)))) (=> (and (and (and (and (forall ((addr1@@8 Int) ) (!  (=> (|$IsValid'address'| addr1@@8) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_149642| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_149233| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1@@8)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@8)) 2))))
 :qid |DualAttestationbpl.18714:21|
 :skolemid |410|
)) (forall ((addr1@@9 Int) ) (!  (=> (|$IsValid'address'| addr1@@9) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_149741| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr1@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_149324| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr1@@9)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@9)) 2))))
 :qid |DualAttestationbpl.18714:292|
 :skolemid |411|
))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816))) (and (forall ((addr1@@10 Int) ) (!  (=> (|$IsValid'address'| addr1@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@10) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@10)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@10)) 2)))))
 :qid |DualAttestationbpl.18726:20|
 :skolemid |412|
)) (|$IsValid'address'| (|$addr#$signer| _$t0)))) (and (and (and (|$IsValid'u64'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DualAttestationbpl.18735:20|
 :skolemid |413|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) $a_0@@0)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc@@0))
 :qid |DualAttestationbpl.18739:20|
 :skolemid |414|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) $a_0@@0))
)) (= $t4 (|$addr#$signer| _$t0)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) $t5)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))))))) (and (=> (= (ControlFlow 0 247340) 247964) anon12_Then_correct) (=> (= (ControlFlow 0 247340) 247388) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2787:13|
 :skolemid |79|
))) (= (ControlFlow 0 246987) 247340)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (seq.len (|p#$Mutation_191261| $t13)) 0) (=> (and (= (seq.len (|p#$Mutation_13443| $t14)) 0) (= (ControlFlow 0 246997) 246987)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 326809) 246997) anon0_correct)))
