...
(declare-fun $t20 () T@$1_DiemAccount_CreateAccountEvent)
...
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@3 () T@$Memory_469220)
...
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@1 () T@$Memory_469220)
(declare-fun inline$$1_ValidatorConfig_publish$0$$t7@1 () Int)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@2 () T@$Memory_469220)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@0 () T@$Memory_469220)
...
(declare-fun MapConstVec_377448 (T@$1_ValidatorConfig_Config) |T@[Int]$1_ValidatorConfig_Config|)
(declare-fun DefaultVecElem_377448 () T@$1_ValidatorConfig_Config)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2195960) (let ((L2_correct  (and (=> (= (ControlFlow 0 1531079) (- 0 2199690)) (or (or (or (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (= _$t1 0)) (= _$t1 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_37831| _$t2)) 32))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) _$t1))) (=> (or (or (or (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (= _$t1 0)) (= _$t1 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_37831| _$t2)) 32))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) _$t1)) (=> (= (ControlFlow 0 1531079) (- 0 2199791)) (or (or (or (or (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (= 6 $t8@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) (= 5 $t8@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8@0))) (and (= _$t1 0) (= 7 $t8@0))) (and (= _$t1 1) (= 7 $t8@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1) (= 6 $t8@0))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (= 5 $t8@0))) (and (not (= (+ 16 (|l#Vec_37831| _$t2)) 32)) (= 7 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t8@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) _$t1) (= 6 $t8@0))))))))
(let ((anon31_Then_correct  (=> $t17 (=> (and (and (or (or (or (or (and (= $t13 0) (= 7 $t8)) (and (= $t13 1) (= 7 $t8))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t13) (= 6 $t8))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (= 5 $t8))) (and (not (= (+ 16 (|l#Vec_37831| _$t2)) 32)) (= 7 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 1530751) 1531079))) L2_correct))))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t8@0 $abort_code@3) (= (ControlFlow 0 1531093) 1531079))) L2_correct)))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 1531107) 1531079))) L2_correct)))
(let ((anon28_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 1531121) 1531079))) L2_correct)))
(let ((anon26_Then_correct  (=> $t7 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t6)) 0)) (= 3 $t8))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 1531227) 1531079))) L2_correct))))
(let ((anon24_correct  (=> (= $t18 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816)) (=> (and (= $t19 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (= $t20 ($1_DiemAccount_CreateAccountEvent (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@3) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))))) (=> (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t13)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@2) $t13) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory@2) $t13))))) (and (and (= (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t18) (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t14) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t14)))) (= (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t18) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t14) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t14))))) (and (not (= (|l#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t13)))) 0)) (= $t13 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_416410| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t13)))) 0)))))) (and (and (and (not (= (|l#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t13)))) 0)) (= $t13 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_416449| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) $t13)))) 0)))) (= $t21 $t20)) (and (and (= $t22 $t19) (= $es@0 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) $t22)))
(let ((stream_new (let ((len (|l#Multiset_416285| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t21))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t21) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) $t22 stream_new)))))) (and (= $t23 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (= $t24 ($1_DiemAccount_CreateAccountEvent _$t1 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@3) _$t1)))))))) (and (=> (= (ControlFlow 0 1530597) (- 0 2199412)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (and (=> (= (ControlFlow 0 1530597) (- 0 2199421)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 1530597) (- 0 2199433)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5)) 0))) (and (=> (= (ControlFlow 0 1530597) (- 0 2199451)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 1530597) (- 0 2199465)) (not (= _$t1 0))) (=> (not (= _$t1 0)) (and (=> (= (ControlFlow 0 1530597) (- 0 2199475)) (not (= _$t1 1))) (=> (not (= _$t1 1)) (and (=> (= (ControlFlow 0 1530597) (- 0 2199485)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (=> (= (ControlFlow 0 1530597) (- 0 2199494)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (and (=> (= (ControlFlow 0 1530597) (- 0 2199511)) (not (not (= (+ 16 (|l#Vec_37831| _$t2)) 32)))) (=> (not (not (= (+ 16 (|l#Vec_37831| _$t2)) 32))) (and (=> (= (ControlFlow 0 1530597) (- 0 2199529)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1530597) (- 0 2199539)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) _$t1)) (and (=> (= (ControlFlow 0 1530597) (- 0 2199548)) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) _$t1) (and (=> (= (ControlFlow 0 1530597) (- 0 2199555)) (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@3) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@3) _$t1) (and (=> (= (ControlFlow 0 1530597) (- 0 2199562)) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@3) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@3) _$t1) (and (=> (= (ControlFlow 0 1530597) (- 0 2199569)) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@3) _$t1)) 3)) (=> (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@3) _$t1)) 3) (and (=> (= (ControlFlow 0 1530597) (- 0 2199582)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory@2) addr@@0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)))))
 :qid |DiemAccountbpl.62488:15|
 :skolemid |2453|
 ...
 :qid |DiemAccountbpl.62488:15|
 :skolemid |2453|
)) (and (=> (= (ControlFlow 0 1530597) (- 0 2199617)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t23)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_416285| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t24))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t24) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t23 stream_new@@0))))))
...
(let ((expected@@0 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t23)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_416285| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t24))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t24) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t23 stream_new@@1))))))
 ...
 :qid |DiemAccountbpl.3536:13|
 :skolemid |130|
))))) (=> (= (ControlFlow 0 1530597) (- 0 2199642)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t23)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_416285| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@3) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t24))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@3) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t24) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t23 stream_new@@2))))))
...
(let ((anon35_Else_correct  (=> (and (and (not |$temp_0'bool'@3|) (= $1_DiemAccount_AccountOperationsCapability_$memory@1 ($Memory_465211 (|Store__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 false) (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@1) (= (ControlFlow 0 1530180) 1530597))) anon24_correct)))
(let ((anon35_Then_correct  (=> (and (and |$temp_0'bool'@3| (= $1_DiemAccount_AccountOperationsCapability_$memory@0 ($Memory_465211 (|Store__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 true) (|Store__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 |$temp_0'$1_DiemAccount_AccountOperationsCapability'@0|)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@0) (= (ControlFlow 0 1530609) 1530597))) anon24_correct)))
(let ((anon34_Else_correct  (=> (not |$temp_0'bool'@2|) (=> (and (= $1_AccountFreezing_FreezingBit_$memory@1 ($Memory_590069 (|Store__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t13 false) (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@1)) (and (=> (= (ControlFlow 0 1530166) 1530609) anon35_Then_correct) (=> (= (ControlFlow 0 1530166) 1530180) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> |$temp_0'bool'@2| (=> (and (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_590069 (|Store__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t13 true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t13 |$temp_0'$1_AccountFreezing_FreezingBit'@0|))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@0)) (and (=> (= (ControlFlow 0 1530621) 1530609) anon35_Then_correct) (=> (= (ControlFlow 0 1530621) 1530180) anon35_Else_correct))))))
(let ((anon33_Else_correct  (=> (and (not |$temp_0'bool'@1|) (= $1_Event_EventHandleGenerator_$memory@1 ($Memory_456329 (|Store__T@[Int]Bool_| (|domain#$Memory_456329| $1_Event_EventHandleGenerator_$memory) $t13 false) (|contents#$Memory_456329| $1_Event_EventHandleGenerator_$memory)))) (and (=> (= (ControlFlow 0 1530152) 1530621) anon34_Then_correct) (=> (= (ControlFlow 0 1530152) 1530166) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (and |$temp_0'bool'@1| (= $1_Event_EventHandleGenerator_$memory@0 ($Memory_456329 (|Store__T@[Int]Bool_| (|domain#$Memory_456329| $1_Event_EventHandleGenerator_$memory) $t13 true) (|Store__T@[Int]$1_Event_EventHandleGenerator_| (|contents#$Memory_456329| $1_Event_EventHandleGenerator_$memory) $t13 |$temp_0'$1_Event_EventHandleGenerator'@0|)))) (and (=> (= (ControlFlow 0 1530633) 1530621) anon34_Then_correct) (=> (= (ControlFlow 0 1530633) 1530166) anon34_Else_correct)))))
(let ((anon32_Else_correct  (=> (not |$temp_0'bool'@0|) (=> (and (= $1_DiemAccount_DiemAccount_$memory@1 ($Memory_468705 (|Store__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t13 false) (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@1)) (and (=> (= (ControlFlow 0 1530138) 1530633) anon33_Then_correct) (=> (= (ControlFlow 0 1530138) 1530152) anon33_Else_correct))))))
(let ((anon32_Then_correct  (=> |$temp_0'bool'@0| (=> (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_468705 (|Store__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t13 true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $t13 |$temp_0'$1_DiemAccount_DiemAccount'@0|))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@0)) (and (=> (= (ControlFlow 0 1530645) 1530633) anon33_Then_correct) (=> (= (ControlFlow 0 1530645) 1530152) anon33_Else_correct))))))
(let ((anon31_Else_correct  (=> (not $t17) (and (=> (= (ControlFlow 0 1530126) 1530645) anon32_Then_correct) (=> (= (ControlFlow 0 1530126) 1530138) anon32_Else_correct)))))
(let ((anon30_Else_correct  (=> (not $abort_flag@2) (=> (and (and (= $t13 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t14 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (and (= $t15 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t16 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))) (and (=> (= (ControlFlow 0 1530120) (- 0 2198927)) (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@3) $t13)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@3) $t13) (=> (= $t17  (or (or (or (or (= $t13 0) (= $t13 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $t13)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_37831| _$t2)) 32)))) (and (=> (= (ControlFlow 0 1530120) 1530751) anon31_Then_correct) (=> (= (ControlFlow 0 1530120) 1530126) anon31_Else_correct)))))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon20_Else_correct  (=> (and (and (not $abort_flag@1) (= $abort_code@3 $abort_code@2)) (and (= $1_ValidatorConfig_ValidatorConfig_$memory@3 $1_ValidatorConfig_ValidatorConfig_$memory@1) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 1529758) 1531093) anon30_Then_correct) (=> (= (ControlFlow 0 1529758) 1530120) anon30_Else_correct)))))
(let ((inline$$1_ValidatorConfig_publish$0$L3_correct  (=> (= $abort_code@3 inline$$1_ValidatorConfig_publish$0$$t7@1) (=> (and (= $1_ValidatorConfig_ValidatorConfig_$memory@3 $1_ValidatorConfig_ValidatorConfig_$memory@2) (= $abort_flag@2 true)) (and (=> (= (ControlFlow 0 1529664) 1531093) anon30_Then_correct) (=> (= (ControlFlow 0 1529664) 1530120) anon30_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon20_Then_correct  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory@1)) (and (= inline$$1_ValidatorConfig_publish$0$$t7@1 $abort_code@2) (= (ControlFlow 0 1529772) 1529664))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Then$1_correct  (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= $abort_flag@1 true)) (and (=> (= (ControlFlow 0 1529824) 1529772) inline$$1_ValidatorConfig_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 1529824) 1529758) inline$$1_ValidatorConfig_publish$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 1529822) 1529824)) inline$$1_ValidatorConfig_publish$0$anon19_Then$1_correct)))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (and (and (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_469220 (|Store__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) inline$$1_ValidatorConfig_publish$0$$t18@1))) (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory@0)) (and (= $abort_code@2 $abort_code@1) (= $abort_flag@1 $abort_flag@0))) (and (=> (= (ControlFlow 0 1529748) 1529772) inline$$1_ValidatorConfig_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 1529748) 1529758) inline$$1_ValidatorConfig_publish$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon18_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (and (and (|$IsValid'$1_Option_Option'$1_ValidatorConfig_Config''| inline$$1_ValidatorConfig_publish$0$$t16@0) (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| inline$$1_ValidatorConfig_publish$0$$t16@0)) 1)) (|$IsEqual'vec'$1_ValidatorConfig_Config''| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| inline$$1_ValidatorConfig_publish$0$$t16@0) (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_416371 (MapConstVec_377448 DefaultVecElem_377448) 0))))) (and (and (|$IsValid'$1_Option_Option'address''| inline$$1_ValidatorConfig_publish$0$$t17@0) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_publish$0$$t17@0)) 1)) (and (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_publish$0$$t17@0) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0)))) (= inline$$1_ValidatorConfig_publish$0$$t18@1 ($1_ValidatorConfig_ValidatorConfig inline$$1_ValidatorConfig_publish$0$$t16@0 inline$$1_ValidatorConfig_publish$0$$t17@0 _$t3))))) (and (=> (= (ControlFlow 0 1529726) 1529822) inline$$1_ValidatorConfig_publish$0$anon19_Then_correct) (=> (= (ControlFlow 0 1529726) 1529748) inline$$1_ValidatorConfig_publish$0$anon19_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon18_Else_correct  (=> (not inline$$Not$0$dst@1) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t15@0 inline$$1_ValidatorConfig_publish$0$$t15@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t7@1 inline$$1_ValidatorConfig_publish$0$$t15@0) (= (ControlFlow 0 1529658) 1529664))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_ValidatorConfig_publish$0$$t15@0) (= inline$$1_ValidatorConfig_publish$0$$t15@0 6)) (and (= inline$$1_ValidatorConfig_publish$0$$t15@0 inline$$1_ValidatorConfig_publish$0$$t15@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 1529642) 1529726) inline$$1_ValidatorConfig_publish$0$anon18_Then_correct) (=> (= (ControlFlow 0 1529642) 1529658) inline$$1_ValidatorConfig_publish$0$anon18_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not inline$$1_ValidatorConfig_publish$0$$t12@1)) (= (ControlFlow 0 1529602) 1529642)) inline$$1_ValidatorConfig_publish$0$anon17_Else$1_correct)))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t10@0) (=> (and (and (|$IsValid'address'| inline$$1_ValidatorConfig_publish$0$$t11@0) (= inline$$1_ValidatorConfig_publish$0$$t11@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (and (= inline$$1_ValidatorConfig_publish$0$$t12@1 (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_publish$0$$t11@0)) (= (ControlFlow 0 1529608) 1529602))) inline$$Not$0$anon0_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Then_correct  (=> (and inline$$1_ValidatorConfig_publish$0$$t10@0 (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@3) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (= 5 inline$$1_ValidatorConfig_publish$0$$t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@3) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) 3)) (= 3 inline$$1_ValidatorConfig_publish$0$$t7@0)))) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t7@0 inline$$1_ValidatorConfig_publish$0$$t7@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t7@1 inline$$1_ValidatorConfig_publish$0$$t7@0) (= (ControlFlow 0 1529880) 1529664))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon16_Else_correct  (=> (and (not inline$$1_ValidatorConfig_publish$0$$t9@0) (= inline$$1_ValidatorConfig_publish$0$$t10@0  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@3) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@3) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) 3))))) (and (=> (= (ControlFlow 0 1529546) 1529880) inline$$1_ValidatorConfig_publish$0$anon17_Then_correct) (=> (= (ControlFlow 0 1529546) 1529608) inline$$1_ValidatorConfig_publish$0$anon17_Else_correct)))))
(let ((inline$$1_ValidatorConfig_publish$0$anon16_Then_correct  (=> (and inline$$1_ValidatorConfig_publish$0$$t9@0 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_ValidatorConfig_publish$0$$t7@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t8@0)) (= 5 inline$$1_ValidatorConfig_publish$0$$t7@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t8@0)) 0)) (= 3 inline$$1_ValidatorConfig_publish$0$$t7@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_ValidatorConfig_publish$0$$t7@0)))) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t7@0 inline$$1_ValidatorConfig_publish$0$$t7@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t7@1 inline$$1_ValidatorConfig_publish$0$$t7@0) (= (ControlFlow 0 1529972) 1529664))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon15_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t6@0) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t8@0 (|$addr#$signer| _$t0)) (= inline$$1_ValidatorConfig_publish$0$$t9@0  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t8@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t8@0)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))))) (and (=> (= (ControlFlow 0 1529506) 1529972) inline$$1_ValidatorConfig_publish$0$anon16_Then_correct) (=> (= (ControlFlow 0 1529506) 1529546) inline$$1_ValidatorConfig_publish$0$anon16_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon15_Then_correct  (=> inline$$1_ValidatorConfig_publish$0$$t6@0 (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_ValidatorConfig_publish$0$$t7@0)) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t7@0 inline$$1_ValidatorConfig_publish$0$$t7@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t7@1 inline$$1_ValidatorConfig_publish$0$$t7@0) (= (ControlFlow 0 1529998) 1529664))) inline$$1_ValidatorConfig_publish$0$L3_correct)))))
(let ((inline$$1_ValidatorConfig_publish$0$anon0_correct  (=> (= inline$$1_ValidatorConfig_publish$0$$t5@0 (|$addr#$signer| _$t0)) (=> (and (and (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1) (= _$t0 _$t0)) (and (= _$t3 _$t3) (= inline$$1_ValidatorConfig_publish$0$$t6@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (and (=> (= (ControlFlow 0 1529434) 1529998) inline$$1_ValidatorConfig_publish$0$anon15_Then_correct) (=> (= (ControlFlow 0 1529434) 1529506) inline$$1_ValidatorConfig_publish$0$anon15_Else_correct))))))
(let ((anon29_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t12 (|$addr#$signer| _$t0)) (= (ControlFlow 0 1530002) 1529434)) inline$$1_ValidatorConfig_publish$0$anon0_correct))))
(let ((anon28_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 1528643) 1531107) anon29_Then_correct) (=> (= (ControlFlow 0 1528643) 1530002) anon29_Else_correct)))))
(let ((inline$$1_Roles_new_validator_role$0$L2_correct  (=> (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (=> (= (ControlFlow 0 1528518) 1531121) anon28_Then_correct) (=> (= (ControlFlow 0 1528518) 1528643) anon28_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon9_Then_correct  (=> inline$$1_Roles_new_validator_role$0$$t9@0 (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= 6 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (= inline$$1_Roles_new_validator_role$0$$t6@0 inline$$1_Roles_new_validator_role$0$$t6@0) (= (ControlFlow 0 1528512) 1528518))) inline$$1_Roles_new_validator_role$0$L2_correct))))
(let ((inline$$1_Roles_new_validator_role$0$anon8_Then_correct  (=> (and (and inline$$1_Roles_new_validator_role$0$$t5@0 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) (= 5 inline$$1_Roles_new_validator_role$0$$t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) 0)) (= 3 inline$$1_Roles_new_validator_role$0$$t6@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_Roles_new_validator_role$0$$t6@0)))) (and (= inline$$1_Roles_new_validator_role$0$$t6@0 inline$$1_Roles_new_validator_role$0$$t6@0) (= (ControlFlow 0 1528610) 1528518))) inline$$1_Roles_new_validator_role$0$L2_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon7_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (and (and (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) 3) (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory@2)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1528470) 1531121) anon28_Then_correct) (=> (= (ControlFlow 0 1528470) 1528643) anon28_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon10_Else_correct  (=> (and (and (not |inline$$1_Roles_new_validator_role$0$$temp_0'bool'@1|) (= $1_Roles_RoleId_$memory@1 ($Memory_465676 (|Store__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) false) (|contents#$Memory_465676| $1_Roles_RoleId_$memory)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@1) (= (ControlFlow 0 1528444) 1528470))) inline$$1_Roles_new_validator_role$0$anon7_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon10_Then_correct  (=> (and (and |inline$$1_Roles_new_validator_role$0$$temp_0'bool'@1| (= $1_Roles_RoleId_$memory@0 ($Memory_465676 (|Store__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) |inline$$1_Roles_new_validator_role$0$$temp_0'$1_Roles_RoleId'@1|)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@0) (= (ControlFlow 0 1528484) 1528470))) inline$$1_Roles_new_validator_role$0$anon7_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon9_Else_correct  (=> (not inline$$1_Roles_new_validator_role$0$$t9@0) (and (=> (= (ControlFlow 0 1528430) 1528484) inline$$1_Roles_new_validator_role$0$anon10_Then_correct) (=> (= (ControlFlow 0 1528430) 1528444) inline$$1_Roles_new_validator_role$0$anon10_Else_correct)))))
(let ((inline$$1_Roles_new_validator_role$0$anon8_Else_correct  (=> (and (not inline$$1_Roles_new_validator_role$0$$t5@0) (|$IsValid'u64'| 3)) (=> (and (and (= inline$$1_Roles_new_validator_role$0$$t8@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= 3 0) (= inline$$1_Roles_new_validator_role$0$$t8@0 173345816))) (and (=> (= 3 1) (= inline$$1_Roles_new_validator_role$0$$t8@0 186537453)) (= inline$$1_Roles_new_validator_role$0$$t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))))) (and (=> (= (ControlFlow 0 1528424) 1528512) inline$$1_Roles_new_validator_role$0$anon9_Then_correct) (=> (= (ControlFlow 0 1528424) 1528430) inline$$1_Roles_new_validator_role$0$anon9_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon0_correct  (=> (and (= inline$$1_Roles_new_validator_role$0$$t2@0 (|$addr#$signer| _$t0)) (= inline$$1_Roles_new_validator_role$0$$t3@0 (|$addr#$signer| _$t0))) (=> (and (and (= _$t0 _$t0) (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1)) (and (= inline$$1_Roles_new_validator_role$0$$t4@0 (|$addr#$signer| _$t0)) (= inline$$1_Roles_new_validator_role$0$$t5@0  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))) (and (=> (= (ControlFlow 0 1528358) 1528610) inline$$1_Roles_new_validator_role$0$anon8_Then_correct) (=> (= (ControlFlow 0 1528358) 1528424) inline$$1_Roles_new_validator_role$0$anon8_Else_correct))))))
(let ((anon27_Else_correct  (=> (and (and (not false) (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1)) (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 1528614) (- 0 2197752)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= (ControlFlow 0 1528614) 1528358) inline$$1_Roles_new_validator_role$0$anon0_correct))))))
(let ((anon27_Then_correct true))
(let ((inline$$1_DiemAccount_create_signer$0$anon0_correct  (=> (= inline$$1_DiemAccount_create_signer$0$signer@1 ($signer _$t1)) (and (=> (= (ControlFlow 0 1527731) 1531135) anon27_Then_correct) (=> (= (ControlFlow 0 1527731) 1528614) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (not $t7) (= (ControlFlow 0 1527737) 1527731)) inline$$1_DiemAccount_create_signer$0$anon0_correct)))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (and (and (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@2)) 4))))
 ...
 :qid |DiemAccountbpl.62080:20|
 :skolemid |2439|
))))))) (and (and (and (and (and (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468892| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@18)))
 :qid |DiemAccountbpl.62084:22|
 :skolemid |2440|
 ...
 :qid |DiemAccountbpl.62084:415|
 :skolemid |2442|
))) (and (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@21) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@21)) 3))))
 :qid |DiemAccountbpl.62088:20|
 :skolemid |2443|
)) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@22) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@22)) 4))))
 :qid |DiemAccountbpl.62092:20|
 :skolemid |2444|
)))) (and (and (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469420| $1_VASP_ParentVASP_$memory) addr@@23) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@23)) 5))))
 :qid |DiemAccountbpl.62096:20|
 :skolemid |2445|
)) (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469520| $1_VASP_ChildVASP_$memory) addr@@24) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@24)) 6))))
 :qid |DiemAccountbpl.62100:20|
 :skolemid |2446|
))) (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (|$IsValid'address'| _$t1)))) (and (and (and (and (|$IsValid'vec'u8''| _$t2) (|$IsValid'vec'u8''| _$t3)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemAccountbpl.62115:20|
 :skolemid |2447|
...
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |DiemAccountbpl.62119:20|
 :skolemid |2448|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0@@0))
)))) (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@1) (and (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@1))) 1) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@1))) 1))))
 :qid |DiemAccountbpl.62123:20|
 :skolemid |2449|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1))
...
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@2))
 :qid |DiemAccountbpl.62127:20|
 :skolemid |2450|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_590069| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2))
))) (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $a_0@@3)))
 ...
 :qid |DiemAccountbpl.62131:20|
 :skolemid |2451|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) $a_0@@3))
)) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_465211| $1_DiemAccount_AccountOperationsCapability_$memory) $a_0@@4)))
(|$IsValid'$1_DiemAccount_AccountOperationsCapability'| $rsc@@4))
 :qid |DiemAccountbpl.62135:20|
 :skolemid |2452|
...
))))) (and (and (and (= $t5 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies _$t1)) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= $t6 (|$addr#$signer| _$t0)) (= $t7  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t6))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t6)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))))))) (and (=> (= (ControlFlow 0 1527693) 1531227) anon26_Then_correct) (=> (= (ControlFlow 0 1527693) 1527737) anon26_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1526206) 1527693)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2195960) 1526206) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
