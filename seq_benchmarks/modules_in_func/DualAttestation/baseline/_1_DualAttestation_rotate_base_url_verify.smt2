...
(declare-fun $1_DualAttestation_Credential_$memory@0 () T@$Memory_135596)
...
(declare-fun $t16@2 () T@$Mutation_198374)
...
(declare-fun |Store__T@[$1_Event_EventHandle]Multiset_93630_| (|T@[$1_Event_EventHandle]Multiset_93630| T@$1_Event_EventHandle T@Multiset_93630) |T@[$1_Event_EventHandle]Multiset_93630|)
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_93630|) ( ?x1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_93630)) (! (= (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|Store__T@[$1_Event_EventHandle]Multiset_93630_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_93630|) ( ?x1 T@$1_Event_EventHandle) ( ?y1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_93630)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|Store__T@[$1_Event_EventHandle]Multiset_93630_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[$1_Event_EventHandle]Multiset_93630_| ?x0 ?y1))) :weight 0)))
(declare-fun $t15@0 () Int)
(declare-fun $abort_code@1 () Int)
(declare-fun |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| () T@$1_Event_EventHandle)
(declare-fun $t18@0 () T@$Mutation_124897)
...
(declare-fun $t16@1 () T@$Mutation_198374)
(declare-fun $t17@0 () T@$Mutation_118865)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t17@1 () T@$Mutation_118865)
(declare-fun $t16 () T@$Mutation_198374)
(declare-fun $t11 () Int)
(declare-fun $t16@0 () T@$Mutation_198374)
...
(declare-fun $t8 () Int)
(declare-fun $t5 () T@$Mutation_198374)
(declare-fun $t17 () T@$Mutation_118865)
(declare-fun $t18 () T@$Mutation_124897)
(push 1)
(set-info :boogie-vc-id $1_DualAttestation_rotate_base_url$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 341418) (let ((anon19_Else_correct  (=> (and (not $abort_flag@0) (= $1_DualAttestation_Credential_$memory@0 ($Memory_135596 (|Store__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_198374| $t16@2)) true) (|Store__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_198374| $t16@2)) (|v#$Mutation_198374| $t16@2))))) (and (=> (= (ControlFlow 0 256946) (- 0 342228)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory@0) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |DualAttestationbpl.18213:15|
 :skolemid |417|
))) (=> (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory@0) addr1@@0) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@0)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@0)) 2)))))
 :qid |DualAttestationbpl.18213:15|
 :skolemid |417|
)) (and (=> (= (ControlFlow 0 256946) (- 0 342264)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) $t6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) $t6))) (and (=> (= (ControlFlow 0 256946) (- 0 342276)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 256946) (- 0 342286)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory@0) $t7)) _$t1)) (=> (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory@0) $t7)) _$t1) (and (=> (= (ControlFlow 0 256946) (- 0 342299)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (= addr1@@1 $t7)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory@0) addr1@@1)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@1)))))
 :qid |DualAttestationbpl.18237:15|
 :skolemid |418|
))) (=> (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (not (= addr1@@2 $t7)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory@0) addr1@@2)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@2)))))
 :qid |DualAttestationbpl.18237:15|
 :skolemid |418|
)) (and (=> (= (ControlFlow 0 256946) (- 0 342337)) (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory@0) addr1@@3)))
 :qid |DualAttestationbpl.18242:15|
 :skolemid |419|
))) (=> (forall ((addr1@@4 Int) ) (!  (=> (|$IsValid'address'| addr1@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory@0) addr1@@4)))
 :qid |DualAttestationbpl.18242:15|
 :skolemid |419|
)) (and (=> (= (ControlFlow 0 256946) (- 0 342361)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory@0) addr1@@5))))
 :qid |DualAttestationbpl.18247:15|
 :skolemid |420|
))) (=> (forall ((addr1@@6 Int) ) (!  (=> (|$IsValid'address'| addr1@@6) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory@0) addr1@@6))))
 :qid |DualAttestationbpl.18247:15|
 :skolemid |420|
)) (and (=> (= (ControlFlow 0 256946) (- 0 342389)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)))) (and (=> (= (ControlFlow 0 256946) (- 0 342406)) (forall ((addr1@@7 Int) ) (!  (=> (|$IsValid'address'| addr1@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@7) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory@0) addr1@@7)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@7)))))
 :qid |DualAttestationbpl.18257:15|
 :skolemid |421|
))) (=> (forall ((addr1@@8 Int) ) (!  (=> (|$IsValid'address'| addr1@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@8) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory@0) addr1@@8)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@8)))))
 :qid |DualAttestationbpl.18257:15|
 :skolemid |421|
)) (and (=> (= (ControlFlow 0 256946) (- 0 342441)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new (let ((len (|l#Multiset_93630| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@0) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_93630 (|Store__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@0) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new))))))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@1 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| expected) handle@@1)) (|l#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| actual) handle@@1))) (forall ((v@@51 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| expected) handle@@1)) v@@51) (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| actual) handle@@1)) v@@51))
 :qid |DualAttestationbpl.164:13|
 :skolemid |5|
)))
 :qid |DualAttestationbpl.2839:13|
 :skolemid |104|
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_93630| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@1) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_93630 (|Store__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@1) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@0))))))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@2 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| expected@@0) handle@@2)) (|l#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| actual@@0) handle@@2))) (forall ((v@@52 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| expected@@0) handle@@2)) v@@52) (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| actual@@0) handle@@2)) v@@52))
 :qid |DualAttestationbpl.164:13|
 :skolemid |5|
)))
 :qid |DualAttestationbpl.2839:13|
 :skolemid |104|
))))) (=> (= (ControlFlow 0 256946) (- 0 342466)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_93630| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@2) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_93630 (|Store__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@2) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@1))))))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@3 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| actual@@1) handle@@3)) (|l#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| expected@@1) handle@@3))) (forall ((v@@53 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| actual@@1) handle@@3)) v@@53) (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| expected@@1) handle@@3)) v@@53))
 :qid |DualAttestationbpl.164:13|
 :skolemid |5|
)))
 :qid |DualAttestationbpl.2839:13|
...
(let ((L3_correct  (and (=> (= (ControlFlow 0 256442) (- 0 342159)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 256442) (- 0 342173)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) $t6)) (= 5 $t15@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t15@0))))))))
(let ((anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 256960) 256442))) L3_correct)))
(let ((|inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| (|v#$Mutation_124897| $t18@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_93630| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t21@0))))
(Multiset_93630 (|Store__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t21@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 256645) 256960) anon19_Then_correct) (=> (= (ControlFlow 0 256645) 256946) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (not $t20) (=> (and (and (|$IsValid'u64'| $t19) (= $t19 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= $t21@0 ($1_DualAttestation_BaseUrlRotationEvent _$t1 $t19)) (= (ControlFlow 0 256651) 256645))) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|))))
(let ((anon18_Then_correct  (=> $t20 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t15)) (= $t15 $t15)) (and (= $t15@0 $t15) (= (ControlFlow 0 256986) 256442))) L3_correct))))
(let ((anon17_Else_correct  (=> (and (and (and (not $abort_flag@0) (= |$temp_0'$1_DualAttestation_Credential'@0| (|v#$Mutation_198374| $t16@1))) (and (= |$temp_0'$1_DualAttestation_Credential'@0| |$temp_0'$1_DualAttestation_Credential'@0|) (= $t17@0 ($Mutation_118865 (|l#$Mutation_198374| $t16@1) (let ((l (|l#Vec_29042| (|p#$Mutation_198374| $t16@1))))
(Vec_29042 (|Store__T@[Int]Int_| (|v#Vec_29042| (|p#$Mutation_198374| $t16@1)) l 1) (+ l 1))) (|$base_url#$1_DualAttestation_Credential| (|v#$Mutation_198374| $t16@1)))))) (and (and (= $t17@1 ($Mutation_118865 (|l#$Mutation_118865| $t17@0) (|p#$Mutation_118865| $t17@0) _$t1)) (= $t16@2 ($Mutation_198374 (|l#$Mutation_198374| $t16@1) (|p#$Mutation_198374| $t16@1) ($1_DualAttestation_Credential (|$human_name#$1_DualAttestation_Credential| (|v#$Mutation_198374| $t16@1)) (|v#$Mutation_118865| $t17@1) (|$compliance_public_key#$1_DualAttestation_Credential| (|v#$Mutation_198374| $t16@1)) (|$expiration_date#$1_DualAttestation_Credential| (|v#$Mutation_198374| $t16@1)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_198374| $t16@1)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_198374| $t16@1)))))) (and (= $t18@0 ($Mutation_124897 (|l#$Mutation_198374| $t16@2) (let ((l@@0 (|l#Vec_29042| (|p#$Mutation_198374| $t16@2))))
(Vec_29042 (|Store__T@[Int]Int_| (|v#Vec_29042| (|p#$Mutation_198374| $t16@2)) l@@0 5) (+ l@@0 1))) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_198374| $t16@2)))) (= $t20  (not (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 256546) 256986) anon18_Then_correct) (=> (= (ControlFlow 0 256546) 256651) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 257000) 256442))) L3_correct)))
(let ((anon16_Then$1_correct  (=> (= $t16@1 $t16) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 257052) 257000) anon17_Then_correct) (=> (= (ControlFlow 0 257052) 256546) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) $t11)) (= (ControlFlow 0 257050) 257052)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) $t11) (=> (and (and (= $t16@0 ($Mutation_198374 ($Global $t11) (Vec_29042 (MapConstVec_13534 DefaultVecElem_13534) 0) (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) $t11))) (= $t16@1 $t16@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 256468) 257000) anon17_Then_correct) (=> (= (ControlFlow 0 256468) 256546) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t12@0 (and (=> (= (ControlFlow 0 256446) 257050) anon16_Then_correct) (=> (= (ControlFlow 0 256446) 256468) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not $t12@0) (= $t14 $t14)) (and (= $t15@0 $t14) (= (ControlFlow 0 256386) 256442))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_147257| $1_DiemConfig_Configuration_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_146867| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_169399| $1_XDX_Reserve_$memory) 173345816)))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_152871| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166895| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@9 Int) ) (!  (=> (|$IsValid'address'| addr1@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@9) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@9)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_133552| $1_Roles_RoleId_$memory) addr1@@9)) 2)))))
 :qid |DualAttestationbpl.18009:20|
 :skolemid |414|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (|$IsValid'vec'u8''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DualAttestationbpl.18018:20|
 :skolemid |415|
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) $a_0@@0)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@0))
 :qid |DualAttestationbpl.18022:20|
 :skolemid |416|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) $a_0@@0))
))))) (=> (and (and (and (and (= $t6 (|$addr#$signer| _$t0)) (= $t7 (|$addr#$signer| _$t0))) (and (= $t8 (|$addr#$signer| _$t0)) (= $t9 (|$base_url_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) $t8))))) (and (and (= $t10 ($1_DualAttestation_BaseUrlRotationEvent _$t1 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_131694| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| $t11)))) (and (and (and (= $t11 (|$addr#$signer| _$t0)) (= $t11 $t11)) (and (= $t12@0 (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) $t11)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14) (= $t14 5)) (and (= $t14 $t14) (= $t12@0 $t12@0))))) (and (=> (= (ControlFlow 0 256370) 256446) anon15_Then_correct) (=> (= (ControlFlow 0 256370) 256386) anon15_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_93630| stream@@4) 0) (forall ((v@@54 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@4) v@@54) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2823:13|
 :skolemid |103|
))) (= (ControlFlow 0 256065) 256370)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_29042| (|p#$Mutation_198374| $t5)) 0) (=> (and (and (= (|l#Vec_29042| (|p#$Mutation_198374| $t16)) 0) (= (|l#Vec_29042| (|p#$Mutation_118865| $t17)) 0)) (and (= (|l#Vec_29042| (|p#$Mutation_124897| $t18)) 0) (= (ControlFlow 0 256075) 256065))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 341418) 256075) anon0_correct)))
