...
(assert (not
 ...
 :qid |Rolesbpl.6894:15|
 :skolemid |196|
)) (=> (= (ControlFlow 0 204338) (- 0 284345)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6))))
 :qid |Rolesbpl.6898:15|
 :skolemid |197|
)))))))))))))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 204404) 204352) anon12_Then_correct) (=> (= (ControlFlow 0 204404) 204338) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) _$t0)) (= (ControlFlow 0 204402) 204404)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 203957) 204352) anon12_Then_correct) (=> (= (ControlFlow 0 203957) 204338) anon12_Else_correct))))))
...
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Rolesbpl.6792:20|
 :skolemid |190|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) _$t0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 203917) 203943) anon10_Then_correct) (=> (= (ControlFlow 0 203917) 203933) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_83264_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 203833) 203917)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 283799) 203833) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))
))
(check-sat)
(pop 1)
