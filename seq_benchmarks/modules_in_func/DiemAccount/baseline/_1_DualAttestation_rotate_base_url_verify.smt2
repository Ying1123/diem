...
(declare-fun $t16@2 () T@$Mutation_558933)
...
(declare-fun $t18@0 () T@$Mutation_456960)
...
(declare-fun $t16@1 () T@$Mutation_558933)
(declare-fun $t17@0 () T@$Mutation_449654)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t17@1 () T@$Mutation_449654)
(declare-fun $t16 () T@$Mutation_558933)
(declare-fun $t11 () Int)
(declare-fun $t16@0 () T@$Mutation_558933)
...
(assert (not
 ...
 :qid |DiemAccountbpl.26535:15|
 :skolemid |445|
)) (and (=> (= (ControlFlow 0 1119297) (- 0 1911165)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t6))) (and (=> (= (ControlFlow 0 1119297) (- 0 1911177)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1119297) (- 0 1911187)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) $t7)) _$t1)) (=> (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) $t7)) _$t1) (and (=> (= (ControlFlow 0 1119297) (- 0 1911200)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (not (= addr1 $t7)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1)))))
 :qid |DiemAccountbpl.26559:15|
 :skolemid |446|
))) (=> (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (not (= addr1@@0 $t7)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@0)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@0)))))
 :qid |DiemAccountbpl.26559:15|
 :skolemid |446|
)) (and (=> (= (ControlFlow 0 1119297) (- 0 1911238)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@1)))
 :qid |DiemAccountbpl.26564:15|
 :skolemid |447|
 ...
 :qid |DiemAccountbpl.26564:15|
 :skolemid |447|
)) (and (=> (= (ControlFlow 0 1119297) (- 0 1911262)) (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@3))))
 :qid |DiemAccountbpl.26569:15|
 :skolemid |448|
 ...
 :qid |DiemAccountbpl.26569:15|
 :skolemid |448|
)) (and (=> (= (ControlFlow 0 1119297) (- 0 1911290)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816)))) (and (=> (= (ControlFlow 0 1119297) (- 0 1911307)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@5) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@5)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@5)))))
 :qid |DiemAccountbpl.26579:15|
 :skolemid |449|
))) (=> (forall ((addr1@@6 Int) ) (!  (=> (|$IsValid'address'| addr1@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@6) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@6)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@6)))))
 :qid |DiemAccountbpl.26579:15|
 :skolemid |449|
)) (and (=> (= (ControlFlow 0 1119297) (- 0 1911342)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new (let ((len (|l#Multiset_416285| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_416285| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@0))))))
 ...
 :qid |DiemAccountbpl.3536:13|
 :skolemid |130|
))))) (=> (= (ControlFlow 0 1119297) (- 0 1911367)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_416285| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@2) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@2) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@1))))))
...
(let ((L3_correct  (and (=> (= (ControlFlow 0 1118758) (- 0 1911023)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 1118758) (- 0 1911037)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t6)) (= 5 $t15@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t15@0))))))))
(let ((anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 1119311) 1118758))) L3_correct)))
(let ((|inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| (|v#$Mutation_456960| $t18@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_416285| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t21@0))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t21@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 1118961) 1119311) anon19_Then_correct) (=> (= (ControlFlow 0 1118961) 1119297) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (not $t20) (=> (and (and (|$IsValid'u64'| $t19) (= $t19 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= $t21@0 ($1_DualAttestation_BaseUrlRotationEvent _$t1 $t19)) (= (ControlFlow 0 1118967) 1118961))) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|))))
(let ((anon18_Then_correct  (=> $t20 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t15)) (= $t15 $t15)) (and (= $t15@0 $t15) (= (ControlFlow 0 1119337) 1118758))) L3_correct))))
(let ((anon17_Else_correct  (=> (and (and (and (not $abort_flag@0) (= |$temp_0'$1_DualAttestation_Credential'@0| (|v#$Mutation_558933| $t16@1))) (and (= |$temp_0'$1_DualAttestation_Credential'@0| |$temp_0'$1_DualAttestation_Credential'@0|) (= $t17@0 ($Mutation_449654 (|l#$Mutation_558933| $t16@1) (let ((l (|l#Vec_37831| (|p#$Mutation_558933| $t16@1))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_558933| $t16@1)) l 1) (+ l 1))) (|$base_url#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t16@1)))))) (and (and (= $t17@1 ($Mutation_449654 (|l#$Mutation_449654| $t17@0) (|p#$Mutation_449654| $t17@0) _$t1)) (= $t16@2 ($Mutation_558933 (|l#$Mutation_558933| $t16@1) (|p#$Mutation_558933| $t16@1) ($1_DualAttestation_Credential (|$human_name#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t16@1)) (|v#$Mutation_449654| $t17@1) (|$compliance_public_key#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t16@1)) (|$expiration_date#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t16@1)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t16@1)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t16@1)))))) (and (= $t18@0 ($Mutation_456960 (|l#$Mutation_558933| $t16@2) (let ((l@@0 (|l#Vec_37831| (|p#$Mutation_558933| $t16@2))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_558933| $t16@2)) l@@0 5) (+ l@@0 1))) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t16@2)))) (= $t20  (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 1118862) 1119337) anon18_Then_correct) (=> (= (ControlFlow 0 1118862) 1118967) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 1119351) 1118758))) L3_correct)))
(let ((anon16_Then$1_correct  (=> (= $t16@1 $t16) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1119403) 1119351) anon17_Then_correct) (=> (= (ControlFlow 0 1119403) 1118862) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t11)) (= (ControlFlow 0 1119401) 1119403)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t11) (=> (and (and (= $t16@0 ($Mutation_558933 ($Global $t11) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) $t11))) (= $t16@1 $t16@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1118784) 1119351) anon17_Then_correct) (=> (= (ControlFlow 0 1118784) 1118862) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t12@0 (and (=> (= (ControlFlow 0 1118762) 1119401) anon16_Then_correct) (=> (= (ControlFlow 0 1118762) 1118784) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not $t12@0) (= $t14 $t14)) (and (= $t15@0 $t14) (= (ControlFlow 0 1118702) 1118758))) L3_correct)))
...
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@0))
 :qid |DiemAccountbpl.26338:20|
 :skolemid |443|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) $a_0@@0))
))))) (=> (and (and (and (and (= $t6 (|$addr#$signer| _$t0)) (= $t7 (|$addr#$signer| _$t0))) (and (= $t8 (|$addr#$signer| _$t0)) (= $t9 (|$base_url_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) $t8))))) (and (and (= $t10 ($1_DualAttestation_BaseUrlRotationEvent _$t1 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| $t11)))) (and (and (and (= $t11 (|$addr#$signer| _$t0)) (= $t11 $t11)) (and (= $t12@0 (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t11)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14) (= $t14 5)) (and (= $t14 $t14) (= $t12@0 $t12@0))))) (and (=> (= (ControlFlow 0 1118686) 1118762) anon15_Then_correct) (=> (= (ControlFlow 0 1118686) 1118702) anon15_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1118381) 1118686)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_37831| (|p#$Mutation_558933| $t5)) 0) (=> (and (and (= (|l#Vec_37831| (|p#$Mutation_558933| $t16)) 0) (= (|l#Vec_37831| (|p#$Mutation_449654| $t17)) 0)) (and (= (|l#Vec_37831| (|p#$Mutation_456960| $t18)) 0) (= (ControlFlow 0 1118391) 1118381))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 1910282) 1118391) anon0_correct)))
