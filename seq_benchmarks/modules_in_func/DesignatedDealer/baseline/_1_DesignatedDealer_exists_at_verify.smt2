...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 306426) (let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_161495| $1_DesignatedDealer_Dealer_$memory) $a_0)))
(|$IsValid'$1_DesignatedDealer_Dealer'| $rsc))
 :qid |DesignatedDealerbpl.12656:20|
 :skolemid |298|
 :pattern ( (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_161495| $1_DesignatedDealer_Dealer_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_161495| $1_DesignatedDealer_Dealer_$memory) _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 222726) (- 0 306519)) (not false)) (=> (not false) (=> (= (ControlFlow 0 222726) (- 0 306526)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_161495| $1_DesignatedDealer_Dealer_$memory) _$t0)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_89261_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DesignatedDealerbpl.2945:13|
 :skolemid |105|
))) (= (ControlFlow 0 222642) 222726)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 306426) 222642) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
