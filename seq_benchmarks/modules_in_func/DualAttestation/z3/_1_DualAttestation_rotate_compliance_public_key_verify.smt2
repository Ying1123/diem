...
(declare-fun $t21 () T@$Mutation_187670)
(declare-fun $t13 () Int)
(declare-fun $t21@0 () T@$Mutation_187670)
...
(declare-fun $t10 () Int)
(declare-fun $t7 () T@$Mutation_187670)
(declare-fun $t22 () T@$Mutation_111899)
(declare-fun $t23 () T@$Mutation_116783)
(push 1)
(set-info :boogie-vc-id $1_DualAttestation_rotate_compliance_public_key$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 325605) (let ((anon26_Else_correct  (=> (and (not $abort_flag@0) (= $1_DualAttestation_Credential_$memory@0 ($Memory_126892 (|Store__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_187670| $t21@2)) true) (|Store__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_187670| $t21@2)) (|v#$Mutation_187670| $t21@2))))) (and (=> (= (ControlFlow 0 246625) (- 0 326529)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |DualAttestationbpl.18574:15|
 :skolemid |401|
))) (=> (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@0) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@0)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@0)) 2)))))
 :qid |DualAttestationbpl.18574:15|
 :skolemid |401|
)) (and (=> (= (ControlFlow 0 246625) (- 0 326565)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t1)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t1))) (and (=> (= (ControlFlow 0 246625) (- 0 326575)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t8))) (and (=> (= (ControlFlow 0 246625) (- 0 326587)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 246625) (- 0 326597)) (= (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory@0) $t9)) _$t1)) (=> (= (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory@0) $t9)) _$t1) (and (=> (= (ControlFlow 0 246625) (- 0 326610)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (= addr1@@1 $t9)) (= (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@1)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1)))))
 :qid |DualAttestationbpl.18603:15|
 :skolemid |402|
))) (=> (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (not (= addr1@@2 $t9)) (= (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@2)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@2)))))
 :qid |DualAttestationbpl.18603:15|
 :skolemid |402|
)) (and (=> (= (ControlFlow 0 246625) (- 0 326648)) (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@3)))
 :qid |DualAttestationbpl.18608:15|
 :skolemid |403|
))) (=> (forall ((addr1@@4 Int) ) (!  (=> (|$IsValid'address'| addr1@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@4)))
 :qid |DualAttestationbpl.18608:15|
 :skolemid |403|
)) (and (=> (= (ControlFlow 0 246625) (- 0 326672)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@5))))
 :qid |DualAttestationbpl.18613:15|
 :skolemid |404|
))) (=> (forall ((addr1@@6 Int) ) (!  (=> (|$IsValid'address'| addr1@@6) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@6))))
 :qid |DualAttestationbpl.18613:15|
 :skolemid |404|
)) (and (=> (= (ControlFlow 0 246625) (- 0 326700)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)))) (and (=> (= (ControlFlow 0 246625) (- 0 326717)) (forall ((addr1@@7 Int) ) (!  (=> (|$IsValid'address'| addr1@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@7) (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@7)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@7)))))
 :qid |DualAttestationbpl.18623:15|
 :skolemid |405|
))) (=> (forall ((addr1@@8 Int) ) (!  (=> (|$IsValid'address'| addr1@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@8) (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@8)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@8)))))
 :qid |DualAttestationbpl.18623:15|
 :skolemid |405|
)) (and (=> (= (ControlFlow 0 246625) (- 0 326752)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new (let ((len (|l#Multiset_91859| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@0) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_91859 (|Store__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@0) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new))))))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@1 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| expected) handle@@1)) (|l#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| actual) handle@@1))) (forall ((v@@41 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| expected) handle@@1)) v@@41) (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| actual) handle@@1)) v@@41))
 :qid |DualAttestationbpl.139:13|
 :skolemid |3|
)))
 :qid |DualAttestationbpl.2803:13|
 :skolemid |80|
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_91859| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@1) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_91859 (|Store__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@1) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@0))))))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@2 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| expected@@0) handle@@2)) (|l#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| actual@@0) handle@@2))) (forall ((v@@42 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| expected@@0) handle@@2)) v@@42) (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| actual@@0) handle@@2)) v@@42))
 :qid |DualAttestationbpl.139:13|
 :skolemid |3|
)))
 :qid |DualAttestationbpl.2803:13|
 :skolemid |80|
))))) (=> (= (ControlFlow 0 246625) (- 0 326777)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_91859| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@2) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_91859 (|Store__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@2) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@1))))))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@3 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| actual@@1) handle@@3)) (|l#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| expected@@1) handle@@3))) (forall ((v@@43 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| actual@@1) handle@@3)) v@@43) (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| expected@@1) handle@@3)) v@@43))
 :qid |DualAttestationbpl.139:13|
 :skolemid |3|
)))
 :qid |DualAttestationbpl.2803:13|
...
(let ((L5_correct  (and (=> (= (ControlFlow 0 246019) (- 0 326439)) (or (or (not ($1_Signature_$ed25519_validate_pubkey _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (or (or (not ($1_Signature_$ed25519_validate_pubkey _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 246019) (- 0 326460)) (or (or (and (not ($1_Signature_$ed25519_validate_pubkey _$t1)) (= 7 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t8)) (= 5 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t17@0))))))))
(let ((anon26_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 246639) 246019))) L5_correct)))
(let ((|inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1| (|v#$Mutation_116783| $t23@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_91859| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@3) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t26@0))))
(Multiset_91859 (|Store__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@3) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t26@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 246314) 246639) anon26_Then_correct) (=> (= (ControlFlow 0 246314) 246625) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (not $t25) (=> (and (and (|$IsValid'u64'| $t24) (= $t24 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= $t26@0 ($1_DualAttestation_ComplianceKeyRotationEvent _$t1 $t24)) (= (ControlFlow 0 246320) 246314))) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|))))
(let ((anon25_Then_correct  (=> $t25 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t17)) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 246665) 246019))) L5_correct))))
(let ((anon24_Else_correct  (=> (and (and (and (not $abort_flag@0) (= |$temp_0'$1_DualAttestation_Credential'@0| (|v#$Mutation_187670| $t21@1))) (and (= |$temp_0'$1_DualAttestation_Credential'@0| |$temp_0'$1_DualAttestation_Credential'@0|) (= $t22@0 ($Mutation_111899 (|l#$Mutation_187670| $t21@1) (seq.++ (|p#$Mutation_187670| $t21@1) (seq.unit 2)) (|$compliance_public_key#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t21@1)))))) (and (and (= $t22@1 ($Mutation_111899 (|l#$Mutation_111899| $t22@0) (|p#$Mutation_111899| $t22@0) _$t1)) (= $t21@2 ($Mutation_187670 (|l#$Mutation_187670| $t21@1) (|p#$Mutation_187670| $t21@1) ($1_DualAttestation_Credential (|$human_name#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t21@1)) (|$base_url#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t21@1)) (|v#$Mutation_111899| $t22@1) (|$expiration_date#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t21@1)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t21@1)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t21@1)))))) (and (= $t23@0 ($Mutation_116783 (|l#$Mutation_187670| $t21@2) (seq.++ (|p#$Mutation_187670| $t21@2) (seq.unit 4)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t21@2)))) (= $t25  (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 246215) 246665) anon25_Then_correct) (=> (= (ControlFlow 0 246215) 246320) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 246679) 246019))) L5_correct)))
(let ((anon23_Then$1_correct  (=> (= $t21@1 $t21) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 246731) 246679) anon24_Then_correct) (=> (= (ControlFlow 0 246731) 246215) anon24_Else_correct))))))
(let ((anon23_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t13)) (= (ControlFlow 0 246729) 246731)) anon23_Then$1_correct)))
(let ((anon23_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t13) (=> (and (and (= $t21@0 ($Mutation_187670 ($Global $t13) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) $t13))) (= $t21@1 $t21@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 246137) 246679) anon24_Then_correct) (=> (= (ControlFlow 0 246137) 246215) anon24_Else_correct))))))
(let ((anon22_Then_correct  (=> inline$$1_Signature_ed25519_validate_pubkey$0$res@1 (and (=> (= (ControlFlow 0 246115) 246729) anon23_Then_correct) (=> (= (ControlFlow 0 246115) 246137) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (and (not inline$$1_Signature_ed25519_validate_pubkey$0$res@1) (= $t20 $t20)) (and (= $t17@0 $t20) (= (ControlFlow 0 246111) 246019))) L5_correct)))
(let ((anon21_Else_correct  (=> (and (not false) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t20) (= $t20 7)) (and (= $t20 $t20) (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 inline$$1_Signature_ed25519_validate_pubkey$0$res@1))) (and (=> (= (ControlFlow 0 246095) 246115) anon22_Then_correct) (=> (= (ControlFlow 0 246095) 246111) anon22_Else_correct))))))
(let ((inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct  (=> (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 ($1_Signature_$ed25519_validate_pubkey _$t1)) (and (=> (= (ControlFlow 0 246053) 246745) anon21_Then_correct) (=> (= (ControlFlow 0 246053) 246095) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (and $t14@0 (= (ControlFlow 0 246059) 246053)) inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct)))
(let ((anon20_Else_correct  (=> (and (and (not $t14@0) (= $t16 $t16)) (and (= $t17@0 $t16) (= (ControlFlow 0 245939) 246019))) L5_correct)))
(let ((anon0$1_correct  (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138391| $1_DiemConfig_Configuration_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138001| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_159326| $1_XDX_Reserve_$memory) 173345816)))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_143664| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_156819| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_124467| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@9 Int) ) (!  (=> (|$IsValid'address'| addr1@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@9) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@9)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_124848| $1_Roles_RoleId_$memory) addr1@@9)) 2)))))
 :qid |DualAttestationbpl.18318:20|
 :skolemid |398|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (|$IsValid'vec'u8''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DualAttestationbpl.18327:20|
 :skolemid |399|
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) $a_0@@0)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@0))
 :qid |DualAttestationbpl.18331:20|
 :skolemid |400|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) $a_0@@0))
))))) (=> (and (and (and (and (= $t8 (|$addr#$signer| _$t0)) (= $t9 (|$addr#$signer| _$t0))) (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) $t10))))) (and (and (= $t12 ($1_DualAttestation_ComplianceKeyRotationEvent _$t1 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| $t13)))) (and (and (and (= $t13 (|$addr#$signer| _$t0)) (= $t13 $t13)) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t13)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t16) (= $t16 5)) (and (= $t16 $t16) (= $t14@0 $t14@0))))) (and (=> (= (ControlFlow 0 245923) 246059) anon20_Then_correct) (=> (= (ControlFlow 0 245923) 245939) anon20_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_91859| stream@@4) 0) (forall ((v@@44 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@4) v@@44) 0)
 :qid |DualAttestationbpl.134:13|
 :skolemid |2|
))))
 :qid |DualAttestationbpl.2787:13|
 :skolemid |79|
))) (= (ControlFlow 0 245618) 245923)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (seq.len (|p#$Mutation_187670| $t7)) 0) (=> (and (and (= (seq.len (|p#$Mutation_187670| $t21)) 0) (= (seq.len (|p#$Mutation_111899| $t22)) 0)) (and (= (seq.len (|p#$Mutation_116783| $t23)) 0) (= (ControlFlow 0 245628) 245618))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 325605) 245628) anon0_correct)))
