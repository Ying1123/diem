...
(let ((anon0$1_correct  (=> (and (and (and (and (and (and (and (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_101801| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address) (= config_address 173345816)))
 :qid |DiemConsensusConfigbpl.11817:25|
 :skolemid |218|
 ...
 :qid |DiemConsensusConfigbpl.11817:244|
 :skolemid |219|
 ...
 :qid |DiemConsensusConfigbpl.11817:484|
 :skolemid |220|
 ...
 :qid |DiemConsensusConfigbpl.11817:746|
 :skolemid |221|
 ...
 :qid |DiemConsensusConfigbpl.11817:984|
 :skolemid |222|
 ...
 :qid |DiemConsensusConfigbpl.11817:1208|
 :skolemid |223|
