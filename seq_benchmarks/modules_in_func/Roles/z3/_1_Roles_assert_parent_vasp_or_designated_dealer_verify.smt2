...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 278576) (let ((anon19_Then_correct  (=> $t5@0 (and (=> (= (ControlFlow 0 198259) (- 0 278994)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t8))) (and (=> (= (ControlFlow 0 198259) (- 0 279006)) (not (and (not (= $t9 5)) (not (= $t9 2))))) (=> (not (and (not (= $t9 5)) (not (= $t9 2)))) (and (=> (= (ControlFlow 0 198259) (- 0 279029)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@0)) 0))))
 ...
 :qid |Rolesbpl.5805:15|
 :skolemid |156|
)) (=> (= (ControlFlow 0 198259) (- 0 279323)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) addr@@12)) 6))))
 :qid |Rolesbpl.5809:15|
 :skolemid |157|
))))))))))))))))))))))
(let ((L9_correct  (and (=> (= (ControlFlow 0 197734) (- 0 279403)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t8)) (and (not (= $t9 5)) (not (= $t9 2))))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t8)) (and (not (= $t9 5)) (not (= $t9 2)))) (=> (= (ControlFlow 0 197734) (- 0 279430)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t8)) (= 5 $t14@0)) (and (and (not (= $t9 5)) (not (= $t9 2))) (= 3 $t14@0))))))))
(let ((anon19_Else_correct  (=> (and (and (not $t5@0) (= $t23 $t23)) (and (= $t14@0 $t23) (= (ControlFlow 0 197860) 197734))) L9_correct)))
(let ((L5_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| $t23) (= $t23 3)) (and (= $t23 $t23) (= $t5@0 $t5@0))) (and (=> (= (ControlFlow 0 197844) 198259) anon19_Then_correct) (=> (= (ControlFlow 0 197844) 197860) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (not $t18@0) (|$IsValid'u64'| 2)) (=> (and (and (= $t21@0 (= $t16@0 2)) (= $t21@0 $t21@0)) (and (= $t5@0 $t21@0) (= (ControlFlow 0 197810) 197844))) L5_correct))))
(let ((anon18_Then_correct  (=> (and (and $t18@0 (= true true)) (and (= $t5@0 true) (= (ControlFlow 0 198277) 197844))) L5_correct)))
(let ((anon17_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t16@0 (|$role_id#$1_Roles_RoleId| $t15@1)) (= $t16@0 $t16@0)) (and (|$IsValid'u64'| 5) (= $t18@0 (= $t16@0 5)))) (and (=> (= (ControlFlow 0 197784) 198277) anon18_Then_correct) (=> (= (ControlFlow 0 197784) 197810) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 198291) 197734))) L9_correct)))
(let ((anon16_Then$1_correct  (=> (= $t15@1 $t15) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 198343) 198291) anon17_Then_correct) (=> (= (ControlFlow 0 198343) 197784) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t10)) (= (ControlFlow 0 198341) 198343)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t10) (=> (and (and (= $t15@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t10)) (= $t15@1 $t15@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 197752) 198291) anon17_Then_correct) (=> (= (ControlFlow 0 197752) 197784) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t11@0 (and (=> (= (ControlFlow 0 197738) 198341) anon16_Then_correct) (=> (= (ControlFlow 0 197738) 197752) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not $t11@0) (= $t13 $t13)) (and (= $t14@0 $t13) (= (ControlFlow 0 197654) 197734))) L9_correct)))
(let ((anon0$1_correct  (=> (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Rolesbpl.5570:20|
 :skolemid |150|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $a_0))
))) (=> (and (and (= $t8 (|$addr#$signer| _$t0)) (= $t9 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113383| $1_Roles_RoleId_$memory) $t8)))) (and (= _$t0 _$t0) (|$IsValid'address'| $t10))) (=> (and (and (and (= $t10 (|$addr#$signer| _$t0)) (= $t10 $t10)) (and (= $t11@0 (|Select__T@[Int]Bool_| (|domain#$Memory_113383| $1_Roles_RoleId_$memory) $t10)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t13) (= $t13 5)) (and (= $t13 $t13) (= $t11@0 $t11@0)))) (and (=> (= (ControlFlow 0 197638) 197738) anon15_Then_correct) (=> (= (ControlFlow 0 197638) 197654) anon15_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_83264_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 197508) 197638)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 278576) 197508) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))
))
(check-sat)
(pop 1)
