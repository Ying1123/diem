...
(declare-datatypes ((T@$Mutation_7056 0)) ((($Mutation_7056 (|l#$Mutation_7056| T@$Location) (|p#$Mutation_7056| T@Vec_2977) (|v#$Mutation_7056| T@Vec_2977) ) ) ))
...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |opaquedefaultz3bpl.190:23|
 :skolemid |6|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |opaquedefaultz3bpl.194:24|
 :skolemid |7|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |opaquedefaultz3bpl.198:25|
 :skolemid |8|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |opaquedefaultz3bpl.202:24|
 :skolemid |9|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |opaquedefaultz3bpl.206:28|
 :skolemid |10|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |opaquedefaultz3bpl.216:19|
 :skolemid |11|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |opaquedefaultz3bpl.482:15|
 :skolemid |15|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |opaquedefaultz3bpl.491:15|
 :skolemid |16|
...
(assert (forall ((v1 T@Vec_2977) (v2 T@Vec_2977) ) (! (= (|$IsEqual'vec'u8''| v1 v2)  (and (= (|l#Vec_2977| v1) (|l#Vec_2977| v2)) (forall ((i@@0 Int) ) (!  (=> (InRangeVec_2977 v1 i@@0) (= (|Select__T@[Int]Int_| (|v#Vec_2977| v1) i@@0) (|Select__T@[Int]Int_| (|v#Vec_2977| v2) i@@0)))
 :qid |opaquedefaultz3bpl.615:13|
 :skolemid |17|
))))
 :qid |opaquedefaultz3bpl.613:28|
 :skolemid |18|
...
(assert (forall ((v@@4 T@Vec_2977) ) (! (= (|$IsValid'vec'u8''| v@@4)  (and (|$IsValid'u64'| (|l#Vec_2977| v@@4)) (forall ((i@@1 Int) ) (!  (=> (InRangeVec_2977 v@@4 i@@1) (|$IsValid'u8'| (|Select__T@[Int]Int_| (|v#Vec_2977| v@@4) i@@1)))
 :qid |opaquedefaultz3bpl.621:13|
 :skolemid |19|
))))
 :qid |opaquedefaultz3bpl.619:28|
 :skolemid |20|
...
(ite  (not (exists ((i@@3 Int) ) (!  (and (and (|$IsValid'u64'| i@@3) (InRangeVec_2977 v@@5 i@@3)) (= (|Select__T@[Int]Int_| (|v#Vec_2977| v@@5) i@@3) e))
 ...
 :qid |opaquedefaultz3bpl.634:17|
 :skolemid |22|
)))))
 :qid |opaquedefaultz3bpl.630:15|
 :skolemid |23|
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10213) (let ((anon4_Else_correct  (=> (not $t1@0) (=> (and (and (|$IsValid'u64'| $t0) (= $t0 2)) (and (= $t0 $t0) (= (ControlFlow 0 9529) (- 0 10290)))) (= $t0 2)))))
(let ((anon4_Then_correct true))
(let ((anon0$1_correct  (and (=> (= (ControlFlow 0 9495) 9545) anon4_Then_correct) (=> (= (ControlFlow 0 9495) 9529) anon4_Else_correct))))
(let ((anon0_correct  (=> (= (ControlFlow 0 10213) 9495) anon0$1_correct)))
anon0_correct)))))
))
(check-sat)
(pop 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10316) (let ((anon0$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (= 1 1) (= (ControlFlow 0 9625) (- 0 10359))) (= 1 2)))))
(let ((anon0_correct  (=> (= (ControlFlow 0 10316) 9625) anon0$1_correct)))
anon0_correct)))
))
(check-sat)
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 10316)))
(get-value ((ControlFlow 0 9625)))
(assert (not (= (ControlFlow 0 9625) (- 10359))))
(check-sat)
(pop 1)
; Invalid
