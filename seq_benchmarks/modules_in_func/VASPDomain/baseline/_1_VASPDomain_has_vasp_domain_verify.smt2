...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 238345) (let ((anon18_Else_correct  (=> (and (not $abort_flag@1) (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1|)) (and (=> (= (ControlFlow 0 173540) (- 0 239168)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) _$t0))) (and (=> (= (ControlFlow 0 173540) (- 0 239179)) (not (> (|l#Vec_21007| _$t1) 63))) (=> (not (> (|l#Vec_21007| _$t1) 63)) (=> (= (ControlFlow 0 173540) (- 0 239191)) (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| (exists ((i@@95 Int) ) (!  (and (and (|$IsValid'u64'| i@@95) (InRangeVec_63741 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) _$t0)) i@@95)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_71617| (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) _$t0))) i@@95)) (|$domain#$1_VASPDomain_VASPDomain| $t6)))
 :qid |VASPDomainbpl.1712:13|
 :skolemid |63|
)))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 172966) (- 0 239105)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) _$t0)) (> (|l#Vec_21007| _$t1) 63))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) _$t0)) (> (|l#Vec_21007| _$t1) 63)) (=> (= (ControlFlow 0 172966) (- 0 239120)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) _$t0)) (= 5 $t10@0)) (and (> (|l#Vec_21007| _$t1) 63) (= 7 $t10@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 173554) 172966))) L3_correct)))
(let ((|inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| (exists ((i@@96 Int) ) (!  (and (and (|$IsValid'u64'| i@@96) (InRangeVec_63741 $t13@0 i@@96)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_71617| $t13@0) i@@96)) (|$domain#$1_VASPDomain_VASPDomain| inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)))
 :qid |VASPDomainbpl.1712:13|
 :skolemid |63|
))) (and (=> (= (ControlFlow 0 173474) 173554) anon18_Then_correct) (=> (= (ControlFlow 0 173474) 173540) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)) (and (= $t13@0 (|$domains#$1_VASPDomain_VASPDomains| $t11@1)) (= (ControlFlow 0 173480) 173474))) |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 173568) 172966))) L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$L3_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 inline$$1_VASPDomain_create_vasp_domain$0$$t4@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@0)) (and (=> (= (ControlFlow 0 173376) 173568) anon17_Then_correct) (=> (= (ControlFlow 0 173376) 173480) anon17_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= (ControlFlow 0 173370) 173376))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 $abort_code@1) (= (ControlFlow 0 173408) 173376))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct  (=> (and inline$$Le$0$dst@1 (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 ($1_VASPDomain_VASPDomain _$t1))) (=> (and (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1))) (and (=> (= (ControlFlow 0 173394) 173568) anon17_Then_correct) (=> (= (ControlFlow 0 173394) 173480) anon17_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 7)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 173354) 173394) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct) (=> (= (ControlFlow 0 173354) 173370) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 173318) 173354)) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 173324) 173318)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (|l#Vec_21007| _$t1)) (and (=> (= (ControlFlow 0 173258) 173408) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct) (=> (= (ControlFlow 0 173258) 173324) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct)))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct  (=> (and (= _$t1 _$t1) (= (ControlFlow 0 173264) 173258)) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((anon16_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t11@1 $t11@1) (= (ControlFlow 0 173414) 173264)) inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct))))
(let ((anon16_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 173582) 172966))) L3_correct)))
(let ((anon15_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 173634) 173582) anon16_Then_correct) (=> (= (ControlFlow 0 173634) 173414) anon16_Else_correct))))))
(let ((anon15_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) _$t0)) (= (ControlFlow 0 173632) 173634)) anon15_Then$1_correct)))
(let ((anon15_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) _$t0) (=> (and (and (= $t11@0 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) _$t0)) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 172984) 173582) anon16_Then_correct) (=> (= (ControlFlow 0 172984) 173414) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7@0 (and (=> (= (ControlFlow 0 172970) 173632) anon15_Then_correct) (=> (= (ControlFlow 0 172970) 172984) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (and (not $t7@0) (= $t9 $t9)) (and (= $t10@0 $t9) (= (ControlFlow 0 172906) 172966))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (|$IsValid'address'| _$t0) (|$IsValid'vec'u8''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) $a_0)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc) (and (and (let (($range_1 ($Range 0 (|l#Vec_71617| (|$domains#$1_VASPDomain_VASPDomains| $rsc)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@97 $i_2))
(<= (|l#Vec_21007| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_71617| (|$domains#$1_VASPDomain_VASPDomains| $rsc)) i@@97))) 63)))
 :qid |VASPDomainbpl.10017:140|
 :skolemid |210|
))) (let (($range_3 ($Range 0 (|l#Vec_71617| (|$domains#$1_VASPDomain_VASPDomains| $rsc)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@98 $i_4))
(let (($range_5 ($Range (+ i@@98 1) (|l#Vec_71617| (|$domains#$1_VASPDomain_VASPDomains| $rsc)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@30 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_71617| (|$domains#$1_VASPDomain_VASPDomains| $rsc)) i@@98)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_71617| (|$domains#$1_VASPDomain_VASPDomains| $rsc)) j@@30))))))
 :qid |VASPDomainbpl.10019:98|
 :skolemid |211|
)))))
 :qid |VASPDomainbpl.10018:202|
 :skolemid |212|
...
(<= (|l#Vec_21007| (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 :qid |VASPDomainbpl.10020:229|
 :skolemid |213|
))))))
 :qid |VASPDomainbpl.10016:20|
 :skolemid |214|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) $a_0))
)) (= $t6 ($1_VASPDomain_VASPDomain _$t1)))) (=> (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_132335| $1_VASPDomain_VASPDomains_$memory) _$t0)) (|$IsValid'u64'| 4))) (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= $t7@0 $t7@0)))) (and (=> (= (ControlFlow 0 172890) 172970) anon14_Then_correct) (=> (= (ControlFlow 0 172890) 172906) anon14_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_70934_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPDomainbpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 172618) 172890)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 238345) 172618) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
