...
procedure {:timeLimit 40} $1_DiemTimestamp_update_global_time$verify(_$t0: int, _$t1: int, _$t2: int) returns ()
{
    ...
    var $temp_0'u64': int;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#108: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    ...
    // @108 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:78:9+77
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#108 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;
...
L5:
    ...
    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountFreezing::FreezeEventsHolder>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assert Implies(DiemTimestamp::$is_operating(), exists<AccountFreezing::FreezeEventsHolder>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:193:9+119
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:193:9+119
    assume {:print "$at(4,7575,7694)"} true;
    assert {:msg "assert_failed(4,7575,7694): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assert Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:201:9+119
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:201:9+119
    assume {:print "$at(4,7888,8007)"} true;
    assert {:msg "assert_failed(4,7888,8007): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assert Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:206:9+129
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:206:9+129
    assume {:print "$at(4,8172,8301)"} true;
    assert {:msg "assert_failed(4,8172,8301): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assert Implies(DiemTimestamp::$is_operating(), exists<AccountFreezing::FreezeEventsHolder>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:213:9+114
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:213:9+114
    assume {:print "$at(4,8557,8671)"} true;
    assert {:msg "assert_failed(4,8557,8671): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));
...
L7:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@108]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#108);
...
L8:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_operating[@108]()), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$VM_RESERVED_ADDRESS[]())), (if Eq<address>($t1, CoreAddresses::$VM_RESERVED_ADDRESS[]()) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}})) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:5+795
    assume {:print "$at(17,3408,4203)"} true;
    assert {:msg "assert_failed(17,3408,4203): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#108) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS())) || if ($IsEqual'address'($t1, $1_CoreAddresses_$VM_RESERVED_ADDRESS())) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)));

    // assert Or(Or(And(Not(DiemTimestamp::$is_operating[@108]()), Eq(1, $t11)), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$VM_RESERVED_ADDRESS[]()), Eq(2, $t11))), And((if Eq<address>($t1, CoreAddresses::$VM_RESERVED_ADDRESS[]()) {{let ; Neq<u64>($t9, $t2)}} else {{let ; Ge($t9, $t2)}}), Eq(7, $t11))) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:76:5+795
    assert {:msg "assert_failed(17,3408,4203): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#108) && $IsEqual'u8'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$VM_RESERVED_ADDRESS()) && $IsEqual'u8'(2, $t11))) || (if ($IsEqual'address'($t1, $1_CoreAddresses_$VM_RESERVED_ADDRESS())) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'u8'(7, $t11)));
...
L7:
    ...
    // @184 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@184](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
L6:
    ...
    // @156 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@156](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
L7:
    ...
    // @174 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@174](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
// fun AccountFreezing::initialize [verification] at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:49:5+508
procedure {:timeLimit 40} $1_AccountFreezing_initialize$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
    ...
    var $1_AccountFreezing_FreezeEventsHolder_$memory#141: $Memory $1_AccountFreezing_FreezeEventsHolder;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:49:5+508
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(4,1621,2129)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountFreezing::FreezeEventsHolder>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:49:5+508
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:193:9+119
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:49:5+508
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:201:9+119
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:49:5+508
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:206:9+129
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:49:5+508
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:49:5+508
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<AccountFreezing::FreezeEventsHolder>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:49:5+508
    ...
    // @140 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:49:5+1
    assume {:print "$at(4,1621,1622)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#140 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @141 := save_mem(AccountFreezing::FreezeEventsHolder) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:49:5+1
    $1_AccountFreezing_FreezeEventsHolder_$memory#141 := $1_AccountFreezing_FreezeEventsHolder_$memory;

    // @142 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:49:5+1
...
L2:
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@140]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:142:9+51
    assume {:print "$at(17,5802,5853)"} true;
    assert {:msg "assert_failed(17,5802,5853): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#140);
    ...
    // assert Not(exists[@141]<AccountFreezing::FreezeEventsHolder>($t3)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:65:9+74
    assume {:print "$at(4,2340,2414)"} true;
    assert {:msg "assert_failed(4,2340,2414): function does not abort under this condition"}
      !$ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory#141, $t3);

    // assert exists<AccountFreezing::FreezeEventsHolder>($t3) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:66:9+41
    assume {:print "$at(4,2423,2464)"} true;
    assert {:msg "assert_failed(4,2423,2464): post-condition does not hold"}
      $ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory, $t3);

    // assert forall addr: TypeDomain<address>() where exists[@142]<AccountFreezing::FreezingBit>(addr): Eq<bool>(select AccountFreezing::FreezingBit.is_frozen(global<AccountFreezing::FreezingBit>(addr)), select AccountFreezing::FreezingBit.is_frozen(global[@142]<AccountFreezing::FreezingBit>(addr))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:223:9+159
    assume {:print "$at(4,9112,9271)"} true;
    assert {:msg "assert_failed(4,9112,9271): post-condition does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory#142, addr))  ==> ($IsEqual'bool'($is_frozen#$1_AccountFreezing_FreezingBit($ResourceValue($1_AccountFreezing_FreezingBit_$memory, addr)), $is_frozen#$1_AccountFreezing_FreezingBit($ResourceValue($1_AccountFreezing_FreezingBit_$memory#142, addr)))));
...
L3:
    ...
    // assert Or(Or(Not(DiemTimestamp::$is_genesis[@140]()), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), exists[@141]<AccountFreezing::FreezeEventsHolder>($t3)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:61:5+336
    assume {:print "$at(4,2134,2470)"} true;
    assert {:msg "assert_failed(4,2134,2470): abort not covered by any of the `aborts_if` clauses"}
      ((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#140) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || $ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory#141, $t3));

    // assert Or(Or(And(Not(DiemTimestamp::$is_genesis[@140]()), Eq(1, $t5)), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t5))), And(exists[@141]<AccountFreezing::FreezeEventsHolder>($t3), Eq(6, $t5))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:61:5+336
    assert {:msg "assert_failed(4,2134,2470): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#140) && $IsEqual'u8'(1, $t5)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t5))) || ($ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory#141, $t3) && $IsEqual'u8'(6, $t5)));

    // abort($t5) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:61:5+336
    $abort_code := $t5;
    $abort_flag := true;
    return;
...
// fun AccountFreezing::account_is_frozen [verification] at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:5+163
procedure {:timeLimit 40} $1_AccountFreezing_account_is_frozen$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_AccountFreezing_FreezingBit_$memory#90: $Memory $1_AccountFreezing_FreezingBit;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:5+163
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:201:9+119
    assume {:print "$at(4,6541,6704)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:5+163
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:206:9+129
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:168:17+6
    assume {:print "$at(4,6805,6811)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<AccountFreezing::FreezingBit>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:168:17+6
    ...
    // @90 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:5+1
    assume {:print "$at(4,6541,6542)"} true;
    $1_AccountFreezing_FreezingBit_$memory#90 := $1_AccountFreezing_FreezingBit_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:161:5+1
    assume {:print "$track_local(28,0,0):", $t0} $t0 == $t0;

    // $t2 := exists<AccountFreezing::FreezingBit>($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+6
    assume {:print "$at(4,6626,6632)"} true;
    $t2 := $ResourceExists($1_AccountFreezing_FreezingBit_$memory, $t0);

    // if ($t2) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
    if ($t2) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:65+4
L0:

    // $t3 := get_global<AccountFreezing::FreezingBit>($t0) on_abort goto L5 with $t4 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:38+13
    ...
    if ($abort_flag) {
        assume {:print "$at(4,6655,6668)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(28,0):", $t4} $t4 == $t4;
        goto L5;
    }

    // $t5 := get_field<AccountFreezing::FreezingBit>.is_frozen($t3) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:38+42
    $t5 := $is_frozen#$1_AccountFreezing_FreezingBit($t3);

    // $t1 := $t5 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
    $t1 := $t5;

    // trace_local[tmp#$1]($t5) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
    assume {:print "$track_local(28,0,1):", $t5} $t5 == $t5;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
L2:

    // $t6 := false at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
    $t6 := false;
    assume $IsValid'bool'($t6);

    // $t1 := $t6 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
    $t1 := $t6;

    // trace_local[tmp#$1]($t6) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
    assume {:print "$track_local(28,0,1):", $t6} $t6 == $t6;

    // label L3 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
L3:

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:163:9+71
    assume {:print "$track_return(28,0,0):", $t1} $t1 == $t1;

    // label L4 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:164:6+1
    assume {:print "$at(4,6703,6704)"} true;
L4:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:166:9+16
    assume {:print "$at(4,6742,6758)"} true;
    assert {:msg "assert_failed(4,6742,6758): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, AccountFreezing::spec_account_is_frozen($t0)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:168:9+47
    assume {:print "$at(4,6797,6844)"} true;
    assert {:msg "assert_failed(4,6797,6844): post-condition does not hold"}
      $IsEqual'bool'($t1, $1_AccountFreezing_spec_account_is_frozen($1_AccountFreezing_FreezingBit_$memory, $t0));

    // assert forall addr: TypeDomain<address>() where exists[@90]<AccountFreezing::FreezingBit>(addr): Eq<bool>(select AccountFreezing::FreezingBit.is_frozen(global<AccountFreezing::FreezingBit>(addr)), select AccountFreezing::FreezingBit.is_frozen(global[@90]<AccountFreezing::FreezingBit>(addr))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:223:9+159
    assume {:print "$at(4,9112,9271)"} true;
    assert {:msg "assert_failed(4,9112,9271): post-condition does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory#90, addr))  ==> ($IsEqual'bool'($is_frozen#$1_AccountFreezing_FreezingBit($ResourceValue($1_AccountFreezing_FreezingBit_$memory, addr)), $is_frozen#$1_AccountFreezing_FreezingBit($ResourceValue($1_AccountFreezing_FreezingBit_$memory#90, addr)))));

    // return $t1 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:223:9+159
    $ret0 := $t1;
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:164:6+1
    assume {:print "$at(4,6703,6704)"} true;
L5:

    // assert false at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:165:5+141
    assume {:print "$at(4,6709,6850)"} true;
    assert {:msg "assert_failed(4,6709,6850): abort not covered by any of the `aborts_if` clauses"}
      false;

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:165:5+141
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun AccountFreezing::assert_not_frozen [verification] at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:172:5+160
procedure {:timeLimit 40} $1_AccountFreezing_assert_not_frozen$verify(_$t0: int) returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_AccountFreezing_FreezingBit_$memory#91: $Memory $1_AccountFreezing_FreezingBit;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:172:5+160
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:201:9+119
    assume {:print "$at(4,6902,7062)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), AccountFreezing::spec_account_is_not_frozen(CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:172:5+160
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:206:9+129
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_AccountFreezing_spec_account_is_not_frozen($1_AccountFreezing_FreezingBit_$memory, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:172:5+160
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<AccountFreezing::FreezingBit>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:172:5+160
    assume (forall $a_0: int :: {$ResourceValue($1_AccountFreezing_FreezingBit_$memory, $a_0)}(var $rsc := $ResourceValue($1_AccountFreezing_FreezingBit_$memory, $a_0);
    ($IsValid'$1_AccountFreezing_FreezingBit'($rsc))));

    // @91 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:172:5+1
    $1_AccountFreezing_FreezingBit_$memory#91 := $1_AccountFreezing_FreezingBit_$memory;

    // trace_local[account]($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:172:5+1
    assume {:print "$track_local(28,1,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:17+26
    // >> opaque call: $t3 := AccountFreezing::account_is_frozen($t0)
    assume {:print "$at(4,6988,7014)"} true;

    // $t3 := opaque begin: AccountFreezing::account_is_frozen($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:17+26

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:17+26
    assume $IsValid'bool'($t3);

    // assume Eq<bool>($t3, AccountFreezing::spec_account_is_frozen($t0)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:17+26
    assume $IsEqual'bool'($t3, $1_AccountFreezing_spec_account_is_frozen($1_AccountFreezing_FreezingBit_$memory, $t0));

    // $t3 := opaque end: AccountFreezing::account_is_frozen($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:17+26

    // $t4 := !($t3) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:16+1
    call $t4 := $Not($t3);

    // $t5 := 5 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:67+15
    $t5 := 5;
    assume $IsValid'u64'($t5);

    // nop at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:45+38
    // >> opaque call: $t6 := Errors::invalid_state($t5)

    // $t6 := opaque begin: Errors::invalid_state($t5) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:45+38

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:45+38
    assume $IsValid'u64'($t6);

    // assume Eq<u64>($t6, 1) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:45+38
    assume $IsEqual'u64'($t6, 1);

    // $t6 := opaque end: Errors::invalid_state($t5) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:45+38

    // trace_local[tmp#$2]($t6) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:9+75
    assume {:print "$track_local(28,1,2):", $t6} $t6 == $t6;

    // trace_local[tmp#$1]($t4) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:9+75
    assume {:print "$track_local(28,1,1):", $t4} $t4 == $t4;

    // if ($t4) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:9+75
    if ($t4) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:9+75
L1:

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:9+75
    assume {:print "$at(4,6980,7055)"} true;
    assume {:print "$track_abort(28,1):", $t6} $t6 == $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:9+75
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:173:84+1
L0:

    // label L2 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:174:5+1
    assume {:print "$at(4,7061,7062)"} true;
L2:

    // assert Not(AccountFreezing::spec_account_is_frozen[@91]($t0)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:181:9+69
    assume {:print "$at(4,7220,7289)"} true;
    assert {:msg "assert_failed(4,7220,7289): function does not abort under this condition"}
      !$1_AccountFreezing_spec_account_is_frozen($1_AccountFreezing_FreezingBit_$memory#91, $t0);

    // assert forall addr: TypeDomain<address>() where exists[@91]<AccountFreezing::FreezingBit>(addr): Eq<bool>(select AccountFreezing::FreezingBit.is_frozen(global<AccountFreezing::FreezingBit>(addr)), select AccountFreezing::FreezingBit.is_frozen(global[@91]<AccountFreezing::FreezingBit>(addr))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:223:9+159
    assume {:print "$at(4,9112,9271)"} true;
    assert {:msg "assert_failed(4,9112,9271): post-condition does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory#91, addr))  ==> ($IsEqual'bool'($is_frozen#$1_AccountFreezing_FreezingBit($ResourceValue($1_AccountFreezing_FreezingBit_$memory, addr)), $is_frozen#$1_AccountFreezing_FreezingBit($ResourceValue($1_AccountFreezing_FreezingBit_$memory#91, addr)))));

    // return () at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:223:9+159
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:174:5+1
    assume {:print "$at(4,7061,7062)"} true;
L3:

    // assert AccountFreezing::spec_account_is_frozen[@91]($t0) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:175:5+85
    assume {:print "$at(4,7067,7152)"} true;
    assert {:msg "assert_failed(4,7067,7152): abort not covered by any of the `aborts_if` clauses"}
      $1_AccountFreezing_spec_account_is_frozen($1_AccountFreezing_FreezingBit_$memory#91, $t0);

    // assert And(AccountFreezing::spec_account_is_frozen[@91]($t0), Eq(1, $t6)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:175:5+85
    assert {:msg "assert_failed(4,7067,7152): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ($1_AccountFreezing_spec_account_is_frozen($1_AccountFreezing_FreezingBit_$memory#91, $t0) && $IsEqual'u8'(1, $t6));

    // abort($t6) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:175:5+85
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
procedure {:timeLimit 40} $1_AccountFreezing_create$verify(_$t0: int) returns ()
{
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_AccountFreezing_FreezingBit_$memory#92: $Memory $1_AccountFreezing_FreezingBit;
    var $1_AccountFreezing_FreezingBit_$memory#236: $Memory $1_AccountFreezing_FreezingBit;
    $t0 := _$t0;
    ...
    // @92 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:76:9+35
    $1_AccountFreezing_FreezingBit_$memory#92 := $1_AccountFreezing_FreezingBit_$memory;
...
L0:
    ...
    // @236 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:69:5+236
    // state save for global update invariants
    assume {:print "$at(4,2476,2712)"} true;
    $1_AccountFreezing_FreezingBit_$memory#236 := $1_AccountFreezing_FreezingBit_$memory;
    ...
    // assert forall addr: TypeDomain<address>() where exists[@236]<AccountFreezing::FreezingBit>(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:210:9+102
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:210:9+102
    assume {:print "$at(4,8360,8462)"} true;
    assert {:msg "assert_failed(4,8360,8462): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory#236, addr))  ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory, addr)));

    // label L2 at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:73:5+1
    assume {:print "$at(4,2711,2712)"} true;
L2:

    // assert Not(exists[@92]<AccountFreezing::FreezingBit>($t4)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:77:9+67
    assume {:print "$at(4,2836,2903)"} true;
    assert {:msg "assert_failed(4,2836,2903): function does not abort under this condition"}
      !$ResourceExists($1_AccountFreezing_FreezingBit_$memory#92, $t4);
    ...
    // assert forall addr: TypeDomain<address>() where exists[@92]<AccountFreezing::FreezingBit>(addr): Eq<bool>(select AccountFreezing::FreezingBit.is_frozen(global<AccountFreezing::FreezingBit>(addr)), select AccountFreezing::FreezingBit.is_frozen(global[@92]<AccountFreezing::FreezingBit>(addr))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:223:9+159
    assume {:print "$at(4,9112,9271)"} true;
    assert {:msg "assert_failed(4,9112,9271): post-condition does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory#92, addr))  ==> ($IsEqual'bool'($is_frozen#$1_AccountFreezing_FreezingBit($ResourceValue($1_AccountFreezing_FreezingBit_$memory, addr)), $is_frozen#$1_AccountFreezing_FreezingBit($ResourceValue($1_AccountFreezing_FreezingBit_$memory#92, addr)))));
...
L3:
    ...
    // assert exists[@92]<AccountFreezing::FreezingBit>($t4) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:74:5+242
    assume {:print "$at(4,2717,2959)"} true;
    assert {:msg "assert_failed(4,2717,2959): abort not covered by any of the `aborts_if` clauses"}
      $ResourceExists($1_AccountFreezing_FreezingBit_$memory#92, $t4);

    // assert And(exists[@92]<AccountFreezing::FreezingBit>($t4), Eq(6, $t10)) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:74:5+242
    assert {:msg "assert_failed(4,2717,2959): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ($ResourceExists($1_AccountFreezing_FreezingBit_$memory#92, $t4) && $IsEqual'u8'(6, $t10));
...
procedure {:timeLimit 40} $1_AccountFreezing_freeze_account$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    var $1_AccountFreezing_FreezingBit_$memory#126: $Memory $1_AccountFreezing_FreezingBit;
    var $1_AccountFreezing_FreezingBit_$memory#238: $Memory $1_AccountFreezing_FreezingBit;
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // @124 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:82:5+1
    ...
    // @125 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:82:5+1
    $1_Roles_RoleId_$memory#125 := $1_Roles_RoleId_$memory;

    // @126 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:82:5+1
    $1_AccountFreezing_FreezingBit_$memory#126 := $1_AccountFreezing_FreezingBit_$memory;
...
L4:
    ...
    // @238 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:82:5+1052
    // state save for global update invariants
    assume {:print "$at(4,3003,4055)"} true;
    $1_AccountFreezing_FreezingBit_$memory#238 := $1_AccountFreezing_FreezingBit_$memory;
    ...
    // assert forall addr: TypeDomain<address>() where exists[@238]<AccountFreezing::FreezingBit>(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:210:9+102
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:210:9+102
    assume {:print "$at(4,8360,8462)"} true;
    assert {:msg "assert_failed(4,8360,8462): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory#238, addr))  ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory, addr)));
...
L6:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@124]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#124);

    // assert Not(Not(exists[@125]<Roles::RoleId>($t9))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    assume {:print "$at(26,24063,24122)"} true;
    assert {:msg "assert_failed(26,24063,24122): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#125, $t9);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t9)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    assume {:print "$at(26,24131,24228)"} true;
    assert {:msg "assert_failed(26,24131,24228): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t9)), 1);
    ...
    // assert Not(Not(exists[@126]<AccountFreezing::FreezingBit>($t1))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:108:9+74
    assume {:print "$at(4,4411,4485)"} true;
    assert {:msg "assert_failed(4,4411,4485): function does not abort under this condition"}
      !!$ResourceExists($1_AccountFreezing_FreezingBit_$memory#126, $t1);
...
L7:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_operating[@124]()), Not(exists[@125]<Roles::RoleId>($t9))), Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t9)), 1)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), Eq<address>($t1, CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Eq<address>($t1, CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), Not(exists[@126]<AccountFreezing::FreezingBit>($t1))), Not(exists[@125]<Roles::RoleId>($t12))), Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t12)), 1)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:103:5+523
    assume {:print "$at(4,4060,4583)"} true;
    assert {:msg "assert_failed(4,4060,4583): abort not covered by any of the `aborts_if` clauses"}
      (((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#124) || !$ResourceExists($1_Roles_RoleId_$memory#125, $t9)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t9)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || $IsEqual'address'($t1, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || $IsEqual'address'($t1, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || !$ResourceExists($1_AccountFreezing_FreezingBit_$memory#126, $t1)) || !$ResourceExists($1_Roles_RoleId_$memory#125, $t12)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t12)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@124]()), Eq(1, $t14)), And(Not(exists[@125]<Roles::RoleId>($t9)), Eq(5, $t14))), And(Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t9)), 1), Eq(3, $t14))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t14))), And(Eq<address>($t1, CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(7, $t14))), And(Eq<address>($t1, CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(7, $t14))), And(Not(exists[@126]<AccountFreezing::FreezingBit>($t1)), Eq(5, $t14))), And(Not(exists[@125]<Roles::RoleId>($t12)), Eq(5, $t14))), And(Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t12)), 1), Eq(3, $t14))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t14))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:103:5+523
    assert {:msg "assert_failed(4,4060,4583): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#124) && $IsEqual'u8'(1, $t14)) || (!$ResourceExists($1_Roles_RoleId_$memory#125, $t9) && $IsEqual'u8'(5, $t14))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t9)), 1) && $IsEqual'u8'(3, $t14))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t14))) || ($IsEqual'address'($t1, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(7, $t14))) || ($IsEqual'address'($t1, $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(7, $t14))) || (!$ResourceExists($1_AccountFreezing_FreezingBit_$memory#126, $t1) && $IsEqual'u8'(5, $t14))) || (!$ResourceExists($1_Roles_RoleId_$memory#125, $t12) && $IsEqual'u8'(5, $t14))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t12)), 1) && $IsEqual'u8'(3, $t14))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t14)));
...
procedure {:timeLimit 40} $1_AccountFreezing_unfreeze_account$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    var $1_AccountFreezing_FreezingBit_$memory#123: $Memory $1_AccountFreezing_FreezingBit;
    var $1_AccountFreezing_FreezingBit_$memory#237: $Memory $1_AccountFreezing_FreezingBit;
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // @121 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:124:5+1
    ...
    // @122 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:124:5+1
    $1_Roles_RoleId_$memory#122 := $1_Roles_RoleId_$memory;

    // @123 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:124:5+1
    $1_AccountFreezing_FreezingBit_$memory#123 := $1_AccountFreezing_FreezingBit_$memory;
...
L0:
    ...
    // @237 := save_mem(AccountFreezing::FreezingBit) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:124:5+765
    // state save for global update invariants
    assume {:print "$at(4,5007,5772)"} true;
    $1_AccountFreezing_FreezingBit_$memory#237 := $1_AccountFreezing_FreezingBit_$memory;
    ...
    // assert forall addr: TypeDomain<address>() where exists[@237]<AccountFreezing::FreezingBit>(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:210:9+102
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:210:9+102
    assume {:print "$at(4,8360,8462)"} true;
    assert {:msg "assert_failed(4,8360,8462): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory#237, addr))  ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory, addr)));
...
L2:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@121]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#121);

    // assert Not(Not(exists[@122]<Roles::RoleId>($t5))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    assume {:print "$at(26,24063,24122)"} true;
    assert {:msg "assert_failed(26,24063,24122): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#122, $t5);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t5)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    assume {:print "$at(26,24131,24228)"} true;
    assert {:msg "assert_failed(26,24131,24228): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t5)), 1);
    ...
    // assert Not(Not(exists[@123]<AccountFreezing::FreezingBit>($t1))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:145:9+76
    assume {:print "$at(4,5916,5992)"} true;
    assert {:msg "assert_failed(4,5916,5992): function does not abort under this condition"}
      !!$ResourceExists($1_AccountFreezing_FreezingBit_$memory#123, $t1);

    // assert Not(Not(exists[@122]<Roles::RoleId>($t8))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    assume {:print "$at(26,24063,24122)"} true;
    assert {:msg "assert_failed(26,24063,24122): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#122, $t8);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t8)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    assume {:print "$at(26,24131,24228)"} true;
    assert {:msg "assert_failed(26,24131,24228): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t8)), 1);
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_operating[@121]()), Not(exists[@122]<Roles::RoleId>($t5))), Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t5)), 1)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), Not(exists[@123]<AccountFreezing::FreezingBit>($t1))), Not(exists[@122]<Roles::RoleId>($t8))), Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t8)), 1)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:142:5+318
    assume {:print "$at(4,5777,6095)"} true;
    assert {:msg "assert_failed(4,5777,6095): abort not covered by any of the `aborts_if` clauses"}
      (((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#121) || !$ResourceExists($1_Roles_RoleId_$memory#122, $t5)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t5)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || !$ResourceExists($1_AccountFreezing_FreezingBit_$memory#123, $t1)) || !$ResourceExists($1_Roles_RoleId_$memory#122, $t8)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t8)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assert Or(Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@121]()), Eq(1, $t10)), And(Not(exists[@122]<Roles::RoleId>($t5)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t5)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t10))), And(Not(exists[@123]<AccountFreezing::FreezingBit>($t1)), Eq(5, $t10))), And(Not(exists[@122]<Roles::RoleId>($t8)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t8)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t10))) at /home/ying/diem/language/diem-framework/modules/AccountFreezing.move:142:5+318
    assert {:msg "assert_failed(4,5777,6095): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#121) && $IsEqual'u8'(1, $t10)) || (!$ResourceExists($1_Roles_RoleId_$memory#122, $t5) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t5)), 1) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t10))) || (!$ResourceExists($1_AccountFreezing_FreezingBit_$memory#123, $t1) && $IsEqual'u8'(5, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#122, $t8) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t8)), 1) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t10)));
...
L8:
    ...
    // @150 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@150](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
...
L7:
    ...
    // @168 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@168](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L7:
    ...
    // @162 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@162](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
