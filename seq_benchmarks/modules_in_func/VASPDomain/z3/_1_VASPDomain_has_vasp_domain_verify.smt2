...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 222478) (let ((anon18_Else_correct  (=> (and (not $abort_flag@1) (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1|)) (and (=> (= (ControlFlow 0 162832) (- 0 223301)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0))) (and (=> (= (ControlFlow 0 162832) (- 0 223312)) (not (> (seq.len _$t1) 63))) (=> (not (> (seq.len _$t1) 63)) (=> (= (ControlFlow 0 162832) (- 0 223324)) (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| (exists ((i@@44 Int) ) (!  (and (and (|$IsValid'u64'| i@@44) (and (>= i@@44 0) (< i@@44 (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0)))))) (= (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0)) i@@44) $t6))
 :qid |VASPDomainbpl.1680:13|
 :skolemid |47|
)))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 162258) (- 0 223238)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0)) (> (seq.len _$t1) 63))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0)) (> (seq.len _$t1) 63)) (=> (= (ControlFlow 0 162258) (- 0 223253)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0)) (= 5 $t10@0)) (and (> (seq.len _$t1) 63) (= 7 $t10@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 162846) 162258))) L3_correct)))
(let ((|inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| (exists ((i@@45 Int) ) (!  (and (and (|$IsValid'u64'| i@@45) (and (>= i@@45 0) (< i@@45 (seq.len $t13@0)))) (= (seq.nth $t13@0 i@@45) inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1))
 :qid |VASPDomainbpl.1680:13|
 :skolemid |47|
))) (and (=> (= (ControlFlow 0 162766) 162846) anon18_Then_correct) (=> (= (ControlFlow 0 162766) 162832) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)) (and (= $t13@0 (|$domains#$1_VASPDomain_VASPDomains| $t11@1)) (= (ControlFlow 0 162772) 162766))) |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 162860) 162258))) L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$L3_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 inline$$1_VASPDomain_create_vasp_domain$0$$t4@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@0)) (and (=> (= (ControlFlow 0 162668) 162860) anon17_Then_correct) (=> (= (ControlFlow 0 162668) 162772) anon17_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= (ControlFlow 0 162662) 162668))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 $abort_code@1) (= (ControlFlow 0 162700) 162668))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct  (=> (and inline$$Le$0$dst@1 (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 ($1_VASPDomain_VASPDomain _$t1))) (=> (and (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1))) (and (=> (= (ControlFlow 0 162686) 162860) anon17_Then_correct) (=> (= (ControlFlow 0 162686) 162772) anon17_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 7)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 162646) 162686) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct) (=> (= (ControlFlow 0 162646) 162662) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 162610) 162646)) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 162616) 162610)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (seq.len _$t1)) (and (=> (= (ControlFlow 0 162550) 162700) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct) (=> (= (ControlFlow 0 162550) 162616) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct)))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct  (=> (and (= _$t1 _$t1) (= (ControlFlow 0 162556) 162550)) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((anon16_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t11@1 $t11@1) (= (ControlFlow 0 162706) 162556)) inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct))))
(let ((anon16_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 162874) 162258))) L3_correct)))
(let ((anon15_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 162926) 162874) anon16_Then_correct) (=> (= (ControlFlow 0 162926) 162706) anon16_Else_correct))))))
(let ((anon15_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0)) (= (ControlFlow 0 162924) 162926)) anon15_Then$1_correct)))
(let ((anon15_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0) (=> (and (and (= $t11@0 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0)) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 162276) 162874) anon16_Then_correct) (=> (= (ControlFlow 0 162276) 162706) anon16_Else_correct))))))
...
(let ((anon14_Else_correct  (=> (and (and (not $t7@0) (= $t9 $t9)) (and (= $t10@0 $t9) (= (ControlFlow 0 162198) 162258))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (|$IsValid'address'| _$t0) (|$IsValid'vec'u8''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) $a_0)))
...
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc) i@@46))) 63)))
...
(let (($range_5 ($Range (+ i@@47 1) (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@10 $i_6))
 (not (= (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc) i@@47) (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc) j@@10)))))
...
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 ...
 :skolemid |190|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) $a_0))
)) (= $t6 ($1_VASPDomain_VASPDomain _$t1)))) (=> (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_122748| $1_VASPDomain_VASPDomains_$memory) _$t0)) (|$IsValid'u64'| 4))) (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= $t7@0 $t7@0)))) (and (=> (= (ControlFlow 0 162182) 162262) anon14_Then_correct) (=> (= (ControlFlow 0 162182) 162198) anon14_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_69290_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPDomainbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 161910) 162182)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 222478) 161910) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))
))
(check-sat)
