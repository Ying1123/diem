...
L2:
    ...
    // trace_local[account#1792]($t17) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:955:13+7
...
procedure {:timeLimit 40} $1_DiemConsensusConfig_initialize$verify(_$t0: int) returns ()
{
    ...
    // @145 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:14:5+1
    assume {:print "$at(14,468,469)"} true;
    $1_Roles_RoleId_$memory#145 := $1_Roles_RoleId_$memory;

    // @148 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:14:5+1
    $1_DiemConfig_Configuration_$memory#148 := $1_DiemConfig_Configuration_$memory;

    // @146 := save_mem(DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:14:5+1
    ...
    // @147 := save_mem(DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:14:5+1
...
L5:
    ...
    // @149 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:9+91
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@149](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:16:9+91
...
L1:
    ...
    // assert Not(DiemConfig::spec_is_published[@146]<DiemConsensusConfig::DiemConsensusConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:257:9+38
    ...
    // assert Not(exists[@147]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:258:9+86
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@148](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:144:9+52
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Not(exists[@145]<Roles::RoleId>($t1)), Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t1)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), DiemConfig::spec_is_published[@146]<DiemConsensusConfig::DiemConsensusConfig>()), exists[@147]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0))), Not(exists[@145]<Roles::RoleId>($t2))), Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t2)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:5+408
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(And(Not(exists[@145]<Roles::RoleId>($t1)), Eq(5, $t5)), And(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t1)), 0), Eq(3, $t5))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t5))), DiemConfig::spec_is_published[@146]<DiemConsensusConfig::DiemConsensusConfig>()), exists[@147]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0))), And(Not(exists[@145]<Roles::RoleId>($t2)), Eq(5, $t5))), And(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t2)), 0), Eq(3, $t5))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t5))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:18:5+408
    assert {:msg "assert_failed(14,669,1077): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((!$ResourceExists($1_Roles_RoleId_$memory#145, $t1) && $IsEqual'num'(5, $t5)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t1)), 0) && $IsEqual'num'(3, $t5))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t5))) || $1_DiemConfig_spec_is_published'$1_DiemConsensusConfig_DiemConsensusConfig'($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#146)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#147, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory#145, $t2) && $IsEqual'num'(5, $t5))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t2)), 0) && $IsEqual'num'(3, $t5))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t5)));
...
procedure {:timeLimit 40} $1_DiemConsensusConfig_set$verify(_$t0: int, _$t1: Vec (int)) returns ()
{
    ...
    // @163 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:29:5+1
    ...
    // @162 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:29:5+1
    $1_Roles_RoleId_$memory#162 := $1_Roles_RoleId_$memory;

    // @167 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:29:5+1
    $1_DiemConfig_Configuration_$memory#167 := $1_DiemConfig_Configuration_$memory;

    // @166 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:29:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#166 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @165 := save_mem(DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:29:5+1
    ...
    // @164 := save_mem(DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:29:5+1
...
L7:
    ...
    // @168 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+93
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@168](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:34:9+93
...
L1:
    ...
    // assert Not(Not(exists[@162]<Roles::RoleId>($t2))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    assume {:print "$at(26,23574,23633)"} true;
    assert {:msg "assert_failed(26,23574,23633): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#162, $t2);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@162]<Roles::RoleId>($t2)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    assume {:print "$at(26,23642,23729)"} true;
    assert {:msg "assert_failed(26,23642,23729): function does not abort under this condition"}
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@163]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
    ...
    // assert Not(Not(exists[@164]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:137:9+129
    ...
    // assert Not(Not(exists[@165]<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:101:9+76
    assume {:print "$at(13,3859,3935)"} true;
    assert {:msg "assert_failed(13,3859,3935): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#165, 173345816);
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@167](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:144:9+52
    assume {:print "$at(13,5734,5786)"} true;
    assert {:msg "assert_failed(13,5734,5786): post-condition does not hold"}
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Not(exists[@162]<Roles::RoleId>($t2)), Neq<u64>(select Roles::RoleId.role_id(global[@162]<Roles::RoleId>($t2)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), Not(DiemTimestamp::$is_operating[@163]())), Not(exists[@164]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0)))), Not(exists[@165]<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(a550c18))), And(And(And(And(DiemTimestamp::$is_operating[@163](), DiemConfig::$reconfiguration_enabled[@166]()), Gt(DiemTimestamp::spec_now_microseconds[@163](), 0)), Lt(select DiemConfig::Configuration.epoch($t3), 18446744073709551615)), Lt($t4, select DiemConfig::Configuration.last_reconfiguration_time($t3)))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:39:5+410
    assume {:print "$at(14,1391,1801)"} true;
    assert {:msg "assert_failed(14,1391,1801): abort not covered by any of the `aborts_if` clauses"}
      ((((((!$ResourceExists($1_Roles_RoleId_$memory#162, $t2) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#162, $t2)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163)) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#164, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#165, 173345816)) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#166)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) > 0)) && ($epoch#$1_DiemConfig_Configuration($t3) < 18446744073709551615)) && ($t4 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t3))));

    // assert Or(Or(Or(Or(Or(Or(And(Not(exists[@162]<Roles::RoleId>($t2)), Eq(5, $t6)), And(Neq<u64>(select Roles::RoleId.role_id(global[@162]<Roles::RoleId>($t2)), 0), Eq(3, $t6))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t6))), And(Not(DiemTimestamp::$is_operating[@163]()), Eq(1, $t6))), And(Not(exists[@164]<DiemConfig::ModifyConfigCapability<DiemConsensusConfig::DiemConsensusConfig>>(Signer::spec_address_of[]($t0))), Eq(4, $t6))), And(Not(exists[@165]<DiemConfig::DiemConfig<DiemConsensusConfig::DiemConsensusConfig>>(a550c18)), Eq(5, $t6))), And(And(And(And(And(DiemTimestamp::$is_operating[@163](), DiemConfig::$reconfiguration_enabled[@166]()), Gt(DiemTimestamp::spec_now_microseconds[@163](), 0)), Lt(select DiemConfig::Configuration.epoch($t3), 18446744073709551615)), Lt($t4, select DiemConfig::Configuration.last_reconfiguration_time($t3))), Eq(1, $t6))) at /home/ying/diem/language/diem-framework/modules/DiemConsensusConfig.move:39:5+410
    assert {:msg "assert_failed(14,1391,1801): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$ResourceExists($1_Roles_RoleId_$memory#162, $t2) && $IsEqual'num'(5, $t6)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#162, $t2)), 0) && $IsEqual'num'(3, $t6))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t6))) || (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) && $IsEqual'num'(1, $t6))) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#164, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(4, $t6))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory#165, 173345816) && $IsEqual'num'(5, $t6))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#166)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#163) > 0)) && ($epoch#$1_DiemConfig_Configuration($t3) < 18446744073709551615)) && ($t4 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t3))) && $IsEqual'num'(1, $t6)));
...
L7:
    ...
    // @161 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@161](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
...
L7:
    ...
    // @155 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@155](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
...
procedure {:timeLimit 40} $1_Genesis_initialize$verify(_$t0: int, _$t1: int, _$t2: Vec (int), _$t3: Vec (int), _$t4: Vec (Vec (int)), _$t5: bool, _$t6: Vec (int), _$t7: Vec (int), _$t8: int, _$t9: int) returns ()
{
    ...
    // trace_local[dr_account#2015]($t0) at /home/ying/diem/language/diem-framework/modules/Genesis.move:40:13+10
    assume {:print "$at(22,1422,1432)"} true;
    assume {:print "$track_local(35,1,10):", $t0} $t0 == $t0;

    // trace_local[tc_account#2016]($t1) at /home/ying/diem/language/diem-framework/modules/Genesis.move:41:13+10
