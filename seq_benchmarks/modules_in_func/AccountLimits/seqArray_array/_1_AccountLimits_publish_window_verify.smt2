...
(assert (not
 (=> (= (ControlFlow 0 0) 416044) (let ((anon25_Else_correct  (=> (not $abort_flag@1@@5) (and (=> (= (ControlFlow 0 305403) (- 0 417694)) (and (and (forall ((window_addr@@20 Int) ) (!  (=> (|$IsValid'address'| window_addr@@20) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@20) (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@20)))
 :qid |AccountLimitsbpl.15223:17|
 :skolemid |313|
)) (forall ((window_addr@@21 Int) ) (!  (=> (|$IsValid'address'| window_addr@@21) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@21) (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@21)))
 :qid |AccountLimitsbpl.15223:245|
 :skolemid |314|
))) (forall ((window_addr@@22 Int) ) (!  (=> (|$IsValid'address'| window_addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@22) (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory@1|) window_addr@@22)))
 :qid |AccountLimitsbpl.15223:474|
 :skolemid |315|
)))) (=> (and (and (forall ((window_addr@@23 Int) ) (!  (=> (|$IsValid'address'| window_addr@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@23) (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@23)))
 :qid |AccountLimitsbpl.15223:17|
 :skolemid |313|
)) (forall ((window_addr@@24 Int) ) (!  (=> (|$IsValid'address'| window_addr@@24) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@24) (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@24)))
 :qid |AccountLimitsbpl.15223:245|
 :skolemid |314|
))) (forall ((window_addr@@25 Int) ) (!  (=> (|$IsValid'address'| window_addr@@25) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@25) (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory@1|) window_addr@@25)))
 :qid |AccountLimitsbpl.15223:474|
 :skolemid |315|
))) (and (=> (= (ControlFlow 0 305403) (- 0 417766)) (and (and (forall ((window_addr@@26 Int) ) (!  (=> (|$IsValid'address'| window_addr@@26) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@26) (|Select__T@[Int]Bool_| (|domain#$Memory_179731| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@26)))))
 :qid |AccountLimitsbpl.15229:17|
 :skolemid |316|
)) (forall ((window_addr@@27 Int) ) (!  (=> (|$IsValid'address'| window_addr@@27) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@27) (|Select__T@[Int]Bool_| (|domain#$Memory_179805| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@27)))))
 :qid |AccountLimitsbpl.15229:364|
 :skolemid |317|
))) (forall ((window_addr@@28 Int) ) (!  (=> (|$IsValid'address'| window_addr@@28) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory@1|) window_addr@@28) (|Select__T@[Int]Bool_| (|domain#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory@1|) window_addr@@28)))))
 :qid |AccountLimitsbpl.15229:712|
 :skolemid |318|
)))) (=> (and (and (forall ((window_addr@@29 Int) ) (!  (=> (|$IsValid'address'| window_addr@@29) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@29) (|Select__T@[Int]Bool_| (|domain#$Memory_179731| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@29)))))
 :qid |AccountLimitsbpl.15229:17|
 :skolemid |316|
)) (forall ((window_addr@@30 Int) ) (!  (=> (|$IsValid'address'| window_addr@@30) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@30) (|Select__T@[Int]Bool_| (|domain#$Memory_179805| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@30)))))
 :qid |AccountLimitsbpl.15229:364|
 :skolemid |317|
))) (forall ((window_addr@@31 Int) ) (!  (=> (|$IsValid'address'| window_addr@@31) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory@1|) window_addr@@31) (|Select__T@[Int]Bool_| (|domain#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory@1|) window_addr@@31)))))
 :qid |AccountLimitsbpl.15229:712|
 :skolemid |318|
))) (and (=> (= (ControlFlow 0 305403) (- 0 417858)) (and (and (forall ((addr@@92 Int) ) (!  (=> (|$IsValid'address'| addr@@92) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@92) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@92) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@92)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@92)) 6)))))
 :qid |AccountLimitsbpl.15235:17|
 :skolemid |319|
)) (forall ((addr@@93 Int) ) (!  (=> (|$IsValid'address'| addr@@93) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@93) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@93) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@93)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@93)) 6)))))
 :qid |AccountLimitsbpl.15235:383|
 :skolemid |320|
))) (forall ((addr@@94 Int) ) (!  (=> (|$IsValid'address'| addr@@94) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory@1|) addr@@94) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@94) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@94)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@94)) 6)))))
 :qid |AccountLimitsbpl.15235:750|
 :skolemid |321|
)))) (=> (and (and (forall ((addr@@95 Int) ) (!  (=> (|$IsValid'address'| addr@@95) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@95) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@95) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@95)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@95)) 6)))))
 :qid |AccountLimitsbpl.15235:17|
 :skolemid |319|
)) (forall ((addr@@96 Int) ) (!  (=> (|$IsValid'address'| addr@@96) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@96) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@96) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@96)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@96)) 6)))))
 :qid |AccountLimitsbpl.15235:383|
 :skolemid |320|
))) (forall ((addr@@97 Int) ) (!  (=> (|$IsValid'address'| addr@@97) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory@1|) addr@@97) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@97) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@97)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@97)) 6)))))
 :qid |AccountLimitsbpl.15235:750|
 :skolemid |321|
))) (and (=> (= (ControlFlow 0 305403) (- 0 418020)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) _$t2))) (and (=> (= (ControlFlow 0 305403) (- 0 418031)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) (|$addr#$signer| _$t1@@12)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) (|$addr#$signer| _$t1@@12))) (and (=> (= (ControlFlow 0 305403) (- 0 418042)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t7@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t7@@0))) (and (=> (= (ControlFlow 0 305403) (- 0 418054)) (not (and (not (= $t8@@4 5)) (not (= $t8@@4 6))))) (=> (not (and (not (= $t8@@4 5)) (not (= $t8@@4 6)))) (and (=> (= (ControlFlow 0 305403) (- 0 418077)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t9@@6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t9@@6))) (and (=> (= (ControlFlow 0 305403) (- 0 418089)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t9@@6)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t9@@6)) 0))) (=> (= (ControlFlow 0 305403) (- 0 418107)) (not (not (= (|$addr#$signer| _$t0@@16) 173345816)))))))))))))))))))))))))
(let ((inline$$1_AccountLimits_current_time$0$anon7_Then_correct true))
(let ((L5_correct  (and (=> (= (ControlFlow 0 304228) (- 0 417478)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) _$t2)) (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) (|$addr#$signer| _$t1@@12))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t7@@0))) (and (not (= $t8@@4 5)) (not (= $t8@@4 6)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t9@@6))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t9@@6)) 0))) (not (= (|$addr#$signer| _$t0@@16) 173345816)))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) _$t2)) (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) (|$addr#$signer| _$t1@@12))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t7@@0))) (and (not (= $t8@@4 5)) (not (= $t8@@4 6)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t9@@6))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t9@@6)) 0))) (not (= (|$addr#$signer| _$t0@@16) 173345816))) (=> (= (ControlFlow 0 304228) (- 0 417556)) (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) _$t2)) (= 5 $t12@0@@2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) (|$addr#$signer| _$t1@@12)) (= 6 $t12@0@@2))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t7@@0)) (= 5 $t12@0@@2))) (and (and (not (= $t8@@4 5)) (not (= $t8@@4 6))) (= 3 $t12@0@@2))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t9@@6)) (= 5 $t12@0@@2))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t9@@6)) 0)) (= 3 $t12@0@@2))) (and (not (= (|$addr#$signer| _$t0@@16) 173345816)) (= 2 $t12@0@@2))))))))
(let ((anon25_Then_correct  (=> (and (and $abort_flag@1@@5 (= $abort_code@2@@5 $abort_code@2@@5)) (and (= $t12@0@@2 $abort_code@2@@5) (= (ControlFlow 0 305417) 304228))) L5_correct)))
(let ((anon24_Then$1_correct  (=> (= |$1_AccountLimits_Window'#0'_$memory@1| |$1_AccountLimits_Window'#0'_$memory|) (=> (and (= $abort_code@2@@5 $EXEC_FAILURE_CODE) (= $abort_flag@1@@5 true)) (and (=> (= (ControlFlow 0 305469) 305417) anon25_Then_correct) (=> (= (ControlFlow 0 305469) 305403) anon25_Else_correct))))))
(let ((anon24_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) (|$addr#$signer| _$t1@@12)) (= (ControlFlow 0 305467) 305469)) anon24_Then$1_correct)))
(let ((anon24_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) (|$addr#$signer| _$t1@@12))) (=> (and (and (= |$1_AccountLimits_Window'#0'_$memory@0| ($Memory_150738 (|Store__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) (|$addr#$signer| _$t1@@12) true) (|Store__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) (|$addr#$signer| _$t1@@12) $t28@0@@2))) (= |$1_AccountLimits_Window'#0'_$memory@1| |$1_AccountLimits_Window'#0'_$memory@0|)) (and (= $abort_code@2@@5 $abort_code@1@@6) (= $abort_flag@1@@5 $abort_flag@0@@6))) (and (=> (= (ControlFlow 0 304964) 305417) anon25_Then_correct) (=> (= (ControlFlow 0 304964) 305403) anon25_Else_correct))))))
(let ((anon23_Else_correct  (=> (not $abort_flag@0@@6) (=> (and (and (|$IsValid'u64'| 0) (|$IsValid'u64'| 0)) (and (|$IsValid'u64'| 0) (= $t28@0@@2 (|$1_AccountLimits_Window'#0'| inline$$1_AccountLimits_current_time$0$$ret0@1 0 0 0 _$t2)))) (and (=> (= (ControlFlow 0 304942) 305467) anon24_Then_correct) (=> (= (ControlFlow 0 304942) 304964) anon24_Else_correct))))))
(let ((anon23_Then_correct  (=> (and (and $abort_flag@0@@6 (= $abort_code@1@@6 $abort_code@1@@6)) (and (= $t12@0@@2 $abort_code@1@@6) (= (ControlFlow 0 305483) 304228))) L5_correct)))
(let ((inline$$1_AccountLimits_current_time$0$L5_correct  (=> (= $abort_flag@0@@6 true) (=> (and (= $abort_code@1@@6 inline$$1_AccountLimits_current_time$0$$t2@1) (= inline$$1_AccountLimits_current_time$0$$ret0@1 inline$$1_AccountLimits_current_time$0$$ret0@0)) (and (=> (= (ControlFlow 0 304848) 305483) anon23_Then_correct) (=> (= (ControlFlow 0 304848) 304942) anon23_Else_correct))))))
(let ((inline$$1_AccountLimits_current_time$0$anon9_Then_correct  (=> inline$$1_AccountLimits_current_time$0$$t5@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_AccountLimits_current_time$0$$t2@0)) (= inline$$1_AccountLimits_current_time$0$$t2@0 inline$$1_AccountLimits_current_time$0$$t2@0)) (and (= inline$$1_AccountLimits_current_time$0$$t2@1 inline$$1_AccountLimits_current_time$0$$t2@0) (= (ControlFlow 0 304842) 304848))) inline$$1_AccountLimits_current_time$0$L5_correct))))
(let ((inline$$1_AccountLimits_current_time$0$L3_correct  (=> (and (and (= inline$$1_AccountLimits_current_time$0$$t0@1 inline$$1_AccountLimits_current_time$0$$t0@1) (= $abort_flag@0@@6 false)) (and (= $abort_code@1@@6 $abort_code@0@@6) (= inline$$1_AccountLimits_current_time$0$$ret0@1 inline$$1_AccountLimits_current_time$0$$t0@1))) (and (=> (= (ControlFlow 0 304816) 305483) anon23_Then_correct) (=> (= (ControlFlow 0 304816) 304942) anon23_Else_correct)))))
(let ((inline$$1_AccountLimits_current_time$0$anon9_Else_correct  (=> (and (not inline$$1_AccountLimits_current_time$0$$t5@0) (|$IsValid'u64'| inline$$1_AccountLimits_current_time$0$$t4@0)) (=> (and (and (= inline$$1_AccountLimits_current_time$0$$t4@0 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= inline$$1_AccountLimits_current_time$0$$t4@0 inline$$1_AccountLimits_current_time$0$$t4@0)) (and (= inline$$1_AccountLimits_current_time$0$$t0@1 inline$$1_AccountLimits_current_time$0$$t4@0) (= (ControlFlow 0 304804) 304816))) inline$$1_AccountLimits_current_time$0$L3_correct))))
(let ((inline$$1_AccountLimits_current_time$0$anon8_Else_correct  (=> (and (not inline$$Not$1$dst@1) (= inline$$1_AccountLimits_current_time$0$$t5@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 304778) 304842) inline$$1_AccountLimits_current_time$0$anon9_Then_correct) (=> (= (ControlFlow 0 304778) 304804) inline$$1_AccountLimits_current_time$0$anon9_Else_correct)))))
(let ((inline$$1_AccountLimits_current_time$0$anon8_Then_correct  (=> inline$$Not$1$dst@1 (=> (and (and (|$IsValid'u64'| 0) (= 0 0)) (and (= inline$$1_AccountLimits_current_time$0$$t0@1 0) (= (ControlFlow 0 304866) 304816))) inline$$1_AccountLimits_current_time$0$L3_correct))))
(let ((inline$$1_AccountLimits_current_time$0$anon7_Else_correct  (=> (not false) (and (=> (= (ControlFlow 0 304762) 304866) inline$$1_AccountLimits_current_time$0$anon8_Then_correct) (=> (= (ControlFlow 0 304762) 304778) inline$$1_AccountLimits_current_time$0$anon8_Else_correct)))))
(let ((inline$$1_DiemTimestamp_is_genesis$0$anon0$1_correct  (=> (= inline$$Not$1$dst@1 inline$$Not$1$dst@1) (and (=> (= (ControlFlow 0 304748) 304880) inline$$1_AccountLimits_current_time$0$anon7_Then_correct) (=> (= (ControlFlow 0 304748) 304762) inline$$1_AccountLimits_current_time$0$anon7_Else_correct)))))
(let ((inline$$Not$1$anon0_correct  (=> (and (= inline$$Not$1$dst@1  (not inline$$1_DiemTimestamp_is_genesis$0$$t1@1)) (= (ControlFlow 0 304730) 304748)) inline$$1_DiemTimestamp_is_genesis$0$anon0$1_correct)))
(let ((inline$$1_DiemTimestamp_is_genesis$0$anon0_correct  (=> (|$IsValid'address'| 173345816) (=> (and (= inline$$1_DiemTimestamp_is_genesis$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (ControlFlow 0 304736) 304730)) inline$$Not$1$anon0_correct))))
(let ((inline$$1_AccountLimits_current_time$0$anon0_correct  (=> (= (ControlFlow 0 304754) 304736) inline$$1_DiemTimestamp_is_genesis$0$anon0_correct)))
(let ((anon22_Then_correct  (=> (and inline$$Not$0$dst@1@@0 (= (ControlFlow 0 304886) 304754)) inline$$1_AccountLimits_current_time$0$anon0_correct)))
(let ((anon22_Else_correct  (=> (and (and (not inline$$Not$0$dst@1@@0) (= $t23@@2 $t23@@2)) (and (= $t12@0@@2 $t23@@2) (= (ControlFlow 0 304402) 304228))) L5_correct)))
(let ((anon21_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t23@@2) (= $t23@@2 6)) (and (= $t23@@2 $t23@@2) (= inline$$Not$0$dst@1@@0 inline$$Not$0$dst@1@@0))) (and (=> (= (ControlFlow 0 304386) 304886) anon22_Then_correct) (=> (= (ControlFlow 0 304386) 304402) anon22_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@0  (=> (and (= inline$$Not$0$dst@1@@0  (not $t20@0@@2)) (= (ControlFlow 0 304346) 304386)) anon21_Else$1_correct)))
(let ((anon21_Else_correct  (=> (not $t18@@2) (=> (and (and (|$IsValid'address'| $t19@@2) (= $t19@@2 (|$addr#$signer| _$t1@@12))) (and (= $t20@0@@2 (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) $t19@@2)) (= (ControlFlow 0 304352) 304346))) inline$$Not$0$anon0_correct@@0))))
(let ((anon21_Then_correct  (=> $t18@@2 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t16@@5)) (= 5 $t12)) (and (and (not (= $t17@@2 5)) (not (= $t17@@2 6))) (= 3 $t12))) (= $t12 $t12)) (and (= $t12@0@@2 $t12) (= (ControlFlow 0 305539) 304228))) L5_correct))))
(let ((anon20_Then_correct  (=> (and (and $t13@0@@3 (= $t16@@5 (|$addr#$signer| _$t1@@12))) (and (= $t17@@2 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t16@@5))) (= $t18@@2  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t16@@5)) (and (not (= $t17@@2 5)) (not (= $t17@@2 6))))))) (and (=> (= (ControlFlow 0 304290) 305539) anon21_Then_correct) (=> (= (ControlFlow 0 304290) 304352) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (and (not $t13@0@@3) (= $t15@@2 $t15@@2)) (and (= $t12@0@@2 $t15@@2) (= (ControlFlow 0 303992) 304228))) L5_correct)))
(let ((anon19_Else_correct  (=> (not $t11) (=> (and (= $t13@0@@3 (|Select__T@[Int]Bool_| (|domain#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) _$t2)) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t15@@2) (= $t15@@2 5)) (and (= $t15@@2 $t15@@2) (= $t13@0@@3 $t13@0@@3))) (and (=> (= (ControlFlow 0 303976) 304290) anon20_Then_correct) (=> (= (ControlFlow 0 303976) 303992) anon20_Else_correct)))))))
(let ((anon19_Then_correct  (=> $t11 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0@@16) 173345816)) (= 2 $t12)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t10@@0)) (= 5 $t12))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t10@@0)) 0)) (= 3 $t12))) (and (not (= (|$addr#$signer| _$t0@@16) 173345816)) (= 2 $t12))) (= $t12 $t12)) (and (= $t12@0@@2 $t12) (= (ControlFlow 0 305631) 304228))) L5_correct))))
(let ((anon0$1_correct@@16  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (and (forall ((window_addr@@32 Int) ) (!  (=> (|$IsValid'address'| window_addr@@32) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@32) (|Select__T@[Int]Bool_| (|domain#$Memory_179731| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@32)))))
 :qid |AccountLimitsbpl.14912:22|
 :skolemid |303|
)) (forall ((window_addr@@33 Int) ) (!  (=> (|$IsValid'address'| window_addr@@33) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@33) (|Select__T@[Int]Bool_| (|domain#$Memory_179805| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@33)))))
 :qid |AccountLimitsbpl.14912:369|
 :skolemid |304|
))) (forall ((window_addr@@34 Int) ) (!  (=> (|$IsValid'address'| window_addr@@34) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@34) (|Select__T@[Int]Bool_| (|domain#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@34)))))
 :qid |AccountLimitsbpl.14912:717|
 :skolemid |305|
))) (=> (and (and (and (and (and (and (forall ((addr@@98 Int) ) (!  (=> (|$IsValid'address'| addr@@98) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) addr@@98) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@98) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@98)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@98)) 6)))))
 :qid |AccountLimitsbpl.14916:22|
 :skolemid |306|
)) (forall ((addr@@99 Int) ) (!  (=> (|$IsValid'address'| addr@@99) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150607| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@99) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@99) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@99)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@99)) 6)))))
 :qid |AccountLimitsbpl.14916:388|
 :skolemid |307|
))) (forall ((addr@@100 Int) ) (!  (=> (|$IsValid'address'| addr@@100) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) addr@@100) (and (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) addr@@100) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@100)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) addr@@100)) 6)))))
 :qid |AccountLimitsbpl.14916:755|
 :skolemid |308|
))) (|$IsValid'address'| (|$addr#$signer| _$t0@@16))) (and (|$IsValid'address'| (|$addr#$signer| _$t1@@12)) (|$IsValid'address'| _$t2))) (and (and (forall (($a_0@@24 Int) ) (! (let (($rsc@@24 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@24)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@24))
 :qid |AccountLimitsbpl.14928:20|
 :skolemid |309|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_147890| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@24))
)) (forall (($a_0@@25 Int) ) (! (let (($rsc@@25 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $a_0@@25)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@25))
 :qid |AccountLimitsbpl.14932:20|
 :skolemid |310|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $a_0@@25))
))) (and (forall (($a_0@@26 Int) ) (! (let (($rsc@@26 (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'#0'_| (|contents#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $a_0@@26)))
 ...
 :qid |AccountLimitsbpl.14936:20|
 :skolemid |311|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'#0'_| (|contents#$Memory_179879| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $a_0@@26))
)) (forall (($a_0@@27 Int) ) (! (let (($rsc@@27 (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@27)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc@@27))
 :qid |AccountLimitsbpl.14940:20|
 :skolemid |312|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_150738| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@27))
))))) (and (and (and (= $t7@@0 (|$addr#$signer| _$t1@@12)) (= $t8@@4 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t7@@0)))) (and (= $t9@@6 (|$addr#$signer| _$t0@@16)) (= _$t0@@16 _$t0@@16))) (and (and (= _$t1@@12 _$t1@@12) (= _$t2 _$t2)) (and (= $t10@@0 (|$addr#$signer| _$t0@@16)) (= $t11  (or (or (or (not (= (|$addr#$signer| _$t0@@16) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_148428| $1_Roles_RoleId_$memory) $t10@@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_148428| $1_Roles_RoleId_$memory) $t10@@0)) 0))) (not (= (|$addr#$signer| _$t0@@16) 173345816)))))))) (and (=> (= (ControlFlow 0 303934) 305631) anon19_Then_correct) (=> (= (ControlFlow 0 303934) 303976) anon19_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@16  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@18 T@$1_Event_EventHandle) ) (! (let ((stream@@17 (|Select__T@[$1_Event_EventHandle]Multiset_112887_| (|streams#$EventStore| $es) handle@@18)))
 (and (= (|l#Multiset_112887| stream@@17) 0) (forall ((v@@61 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_112887| stream@@17) v@@61) 0)
 :qid |AccountLimitsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountLimitsbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 303394) 303934)) anon0$1_correct@@16)))
(let ((anon0_correct@@16  (=> (= (ControlFlow 0 416044) 303394) inline$$InitEventStore$0$anon0_correct@@16)))
anon0_correct@@16))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
