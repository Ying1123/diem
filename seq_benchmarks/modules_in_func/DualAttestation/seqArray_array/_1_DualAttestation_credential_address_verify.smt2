...
(assert (not
 (=> (= (ControlFlow 0 0) 334285) (let ((anon7_Then_correct  (=> $t4@@6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@16)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@16))) (= 7 $t5@@10)) (and (= $t5@@10 $t5@@10) (= (ControlFlow 0 248460) (- 0 334511)))) false))))
(let ((L3_correct@@3  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 248358) (- 0 334568)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 248358) (- 0 334575)) (= $t1@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@16) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@16) _$t0@@16 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@16))) _$t0@@16))) (=> (= $t1@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@16) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@16) _$t0@@16 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@16))) _$t0@@16)) (and (=> (= (ControlFlow 0 248358) (- 0 334588)) (forall ((addr1@@44 Int) ) (!  (=> (|$IsValid'address'| addr1@@44) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@44) (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@44)))
 :qid |DualAttestationbpl.15413:15|
 :skolemid |349|
))) (=> (forall ((addr1@@45 Int) ) (!  (=> (|$IsValid'address'| addr1@@45) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@45) (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@45)))
 :qid |DualAttestationbpl.15413:15|
 :skolemid |349|
)) (and (=> (= (ControlFlow 0 248358) (- 0 334613)) (forall ((addr1@@46 Int) ) (!  (=> (|$IsValid'address'| addr1@@46) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@46)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@46))))
 :qid |DualAttestationbpl.15418:15|
 :skolemid |350|
))) (=> (forall ((addr1@@47 Int) ) (!  (=> (|$IsValid'address'| addr1@@47) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@47)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@47))))
 :qid |DualAttestationbpl.15418:15|
 :skolemid |350|
)) (and (=> (= (ControlFlow 0 248358) (- 0 334642)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_133171| $1_DualAttestation_Limit_$memory) 173345816)))) (and (=> (= (ControlFlow 0 248358) (- 0 334659)) (forall ((addr1@@48 Int) ) (!  (=> (|$IsValid'address'| addr1@@48) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@48) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@48)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@48)))))
 :qid |DualAttestationbpl.15428:15|
 :skolemid |351|
))) (=> (forall ((addr1@@49 Int) ) (!  (=> (|$IsValid'address'| addr1@@49) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@49) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@49)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@49)))))
 :qid |DualAttestationbpl.15428:15|
 :skolemid |351|
)) (=> (= (ControlFlow 0 248358) (- 0 334695)) (forall ((addr1@@50 Int) ) (!  (=> (|$IsValid'address'| addr1@@50) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@50) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@50)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_135596| $1_DualAttestation_Credential_$memory) addr1@@50)))))
 :qid |DualAttestationbpl.15433:15|
 :skolemid |352|
))))))))))))))))))
(let ((anon7_Else_correct  (=> (and (not $t4@@6) (|$IsValid'address'| $t3@@6)) (=> (and (and (= $t3@@6 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@16) _$t0@@16 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@16)))) (= $t3@@6 $t3@@6)) (and (= $t1@0 $t3@@6) (= (ControlFlow 0 248414) 248358))) L3_correct@@3))))
(let ((anon6_Then_correct  (=> (and $t2@@6 (= $t4@@6  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) _$t0@@16)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@16))))) (and (=> (= (ControlFlow 0 248384) 248460) anon7_Then_correct) (=> (= (ControlFlow 0 248384) 248414) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (and (not $t2@@6) (= _$t0@@16 _$t0@@16)) (and (= $t1@0 _$t0@@16) (= (ControlFlow 0 248180) 248358))) L3_correct@@3)))
(let ((anon0$1_correct@@16  (=> (and (forall ((child_addr@@3 Int) ) (!  (=> (|$IsValid'address'| child_addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) child_addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_171117| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) child_addr@@3)))))
 :qid |DualAttestationbpl.15287:20|
 :skolemid |346|
)) (|$IsValid'address'| _$t0@@16)) (=> (and (and (forall (($a_0@@34 Int) ) (! (let (($rsc@@34 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) $a_0@@34)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc@@34))
 :qid |DualAttestationbpl.15294:20|
 :skolemid |347|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_171053| $1_VASP_ChildVASP_$memory) $a_0@@34))
)) (forall (($a_0@@35 Int) ) (! (let (($rsc@@35 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_171117| $1_VASP_ParentVASP_$memory) $a_0@@35)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@35))
 :qid |DualAttestationbpl.15298:20|
 :skolemid |348|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_171117| $1_VASP_ParentVASP_$memory) $a_0@@35))
))) (and (= _$t0@@16 _$t0@@16) (= $t2@@6 (|Select__T@[Int]Bool_| (|domain#$Memory_171053| $1_VASP_ChildVASP_$memory) _$t0@@16)))) (and (=> (= (ControlFlow 0 248166) 248384) anon6_Then_correct) (=> (= (ControlFlow 0 248166) 248180) anon6_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@16  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@18 T@$1_Event_EventHandle) ) (! (let ((stream@@17 (|Select__T@[$1_Event_EventHandle]Multiset_93630_| (|streams#$EventStore| $es) handle@@18)))
 (and (= (|l#Multiset_93630| stream@@17) 0) (forall ((v@@68 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_93630| stream@@17) v@@68) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2823:13|
 :skolemid |103|
))) (= (ControlFlow 0 248045) 248166)) anon0$1_correct@@16)))
(let ((anon0_correct@@16  (=> (= (ControlFlow 0 334285) 248045) inline$$InitEventStore$0$anon0_correct@@16)))
anon0_correct@@16)))))))))
))
(check-sat)
(pop 1)
