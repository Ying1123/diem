...
(declare-fun $t18@0 () T@$Mutation_116783)
...
(declare-fun $t16 () T@$Mutation_187670)
(declare-fun $t11 () Int)
...
(declare-fun $t8 () Int)
(declare-fun $t5 () T@$Mutation_187670)
(declare-fun $t17 () T@$Mutation_111899)
...
(assert (not
 ...
 :qid |DualAttestationbpl.18146:15|
 :skolemid |393|
)) (and (=> (= (ControlFlow 0 245265) (- 0 325372)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t6))) (and (=> (= (ControlFlow 0 245265) (- 0 325384)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 245265) (- 0 325394)) (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory@0) $t7)) _$t1)) (=> (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory@0) $t7)) _$t1) (and (=> (= (ControlFlow 0 245265) (- 0 325407)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (= addr1@@1 $t7)) (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@1)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@1)))))
 :qid |DualAttestationbpl.18170:15|
 :skolemid |394|
))) (=> (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (not (= addr1@@2 $t7)) (= (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@2)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@2)))))
 :qid |DualAttestationbpl.18170:15|
 :skolemid |394|
)) (and (=> (= (ControlFlow 0 245265) (- 0 325445)) (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@3)))
 ...
 :qid |DualAttestationbpl.18175:15|
 :skolemid |395|
)) (and (=> (= (ControlFlow 0 245265) (- 0 325469)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) addr1@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory@0) addr1@@5))))
...
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new (let ((len (|l#Multiset_91859| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@0) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_91859 (|Store__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@0) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_91859| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@1) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_91859 (|Store__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@1) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@0))))))
...
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_91859| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@2) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_91859 (|Store__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@2) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@1))))))
...
(let ((L3_correct  (and (=> (= (ControlFlow 0 244761) (- 0 325267)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 244761) (- 0 325281)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t6)) (= 5 $t15@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t15@0))))))))
(let ((anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 245279) 244761))) L3_correct)))
(let ((|inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| (|v#$Mutation_116783| $t18@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_91859| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t21@0))))
(Multiset_91859 (|Store__T@[$EventRep]Int_| (|v#Multiset_91859| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t21@0) (+ cnt@@2 1)) (+ len@@2 1))))))
...
(let ((anon18_Else_correct  (=> (not $t20) (=> (and (and (|$IsValid'u64'| $t19) (= $t19 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= $t21@0 ($1_DualAttestation_BaseUrlRotationEvent _$t1 $t19)) (= (ControlFlow 0 244970) 244964))) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|))))
(let ((anon18_Then_correct  (=> $t20 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t15)) (= $t15 $t15)) (and (= $t15@0 $t15) (= (ControlFlow 0 245305) 244761))) L3_correct))))
(let ((anon17_Else_correct  (=> (and (and (and (not $abort_flag@0) (= |$temp_0'$1_DualAttestation_Credential'@0| (|v#$Mutation_187670| $t16@1))) (and (= |$temp_0'$1_DualAttestation_Credential'@0| |$temp_0'$1_DualAttestation_Credential'@0|) (= $t17@0 ($Mutation_111899 (|l#$Mutation_187670| $t16@1) (seq.++ (|p#$Mutation_187670| $t16@1) (seq.unit 1)) (|$base_url#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t16@1)))))) (and (and (= $t17@1 ($Mutation_111899 (|l#$Mutation_111899| $t17@0) (|p#$Mutation_111899| $t17@0) _$t1)) (= $t16@2 ($Mutation_187670 (|l#$Mutation_187670| $t16@1) (|p#$Mutation_187670| $t16@1) ($1_DualAttestation_Credential (|$human_name#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t16@1)) (|v#$Mutation_111899| $t17@1) (|$compliance_public_key#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t16@1)) (|$expiration_date#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t16@1)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t16@1)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t16@1)))))) (and (= $t18@0 ($Mutation_116783 (|l#$Mutation_187670| $t16@2) (seq.++ (|p#$Mutation_187670| $t16@2) (seq.unit 5)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_187670| $t16@2)))) (= $t20  (not (|Select__T@[Int]Bool_| (|domain#$Memory_122999| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 244865) 245305) anon18_Then_correct) (=> (= (ControlFlow 0 244865) 244970) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 245319) 244761))) L3_correct)))
(let ((anon16_Then$1_correct  (=> (= $t16@1 $t16) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 245371) 245319) anon17_Then_correct) (=> (= (ControlFlow 0 245371) 244865) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t11)) (= (ControlFlow 0 245369) 245371)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126892| $1_DualAttestation_Credential_$memory) $t11) (=> (and (and (= $t16@0 ($Mutation_187670 ($Global $t11) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_126892| $1_DualAttestation_Credential_$memory) $t11))) (= $t16@1 $t16@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 244787) 245319) anon17_Then_correct) (=> (= (ControlFlow 0 244787) 244865) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t12@0 (and (=> (= (ControlFlow 0 244765) 245369) anon16_Then_correct) (=> (= (ControlFlow 0 244765) 244787) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not $t12@0) (= $t14 $t14)) (and (= $t15@0 $t14) (= (ControlFlow 0 244705) 244761))) L3_correct)))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_91859_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DualAttestationbpl.2787:13|
 :skolemid |79|
))) (= (ControlFlow 0 244384) 244689)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (seq.len (|p#$Mutation_187670| $t5)) 0) (=> (and (and (= (seq.len (|p#$Mutation_187670| $t16)) 0) (= (seq.len (|p#$Mutation_111899| $t17)) 0)) (and (= (seq.len (|p#$Mutation_116783| $t18)) 0) (= (ControlFlow 0 244394) 244384))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 324526) 244394) anon0_correct)))
