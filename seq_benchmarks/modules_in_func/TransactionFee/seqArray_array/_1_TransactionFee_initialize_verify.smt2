...
(let ((anon9_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) $t4)) (= 5 $t3)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t3))) (and (not (= (|$addr#$signer| _$t0@@0) 186537453)) (= 2 $t3))) (= $t3 $t3)) (and (= $t3@0 $t3) (= (ControlFlow 0 224675) 224603))) L2_correct))))
...
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon25_Then_correct|  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_130984| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0@@0)) (= (ControlFlow 0 224163) 224165)) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon25_Then$1_correct|)))
...
(let ((|inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon7_Then_correct|  (=> |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t3@0| (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t2@0|)) (= 5 |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t2@0|)) 1)) (= 3 |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|))) (and (not (= (|$addr#$signer| _$t0@@0) 186537453)) (= 2 |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|))) (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0| |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|)) (and (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@1| |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|) (= (ControlFlow 0 224043) 223945))) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$L2_correct|))))
...
(let ((|inline$$1_Diem_zero'$1_XUS_XUS'$1$anon3_Else_correct|  (=> (not |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t0@0|) (=> (and (|$IsValid'u64'| 0) (= |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t3@1| (|$1_Diem_Diem'$1_XUS_XUS'| 0))) (=> (and (and (= |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t3@1| |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t3@1|) (= $abort_code@2 $abort_code@1@@0)) (and (= $abort_flag@1 $abort_flag@0@@0) (= |inline$$1_Diem_zero'$1_XUS_XUS'$1$$ret0@1| |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t3@1|))) (and (=> (= (ControlFlow 0 223867) 223939) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon9_Then_correct|) (=> (= (ControlFlow 0 223867) 223925) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon9_Else_correct|)))))))
...
(let ((|inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon0_correct|  (=> (and (and (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t1@0| (|$addr#$signer| _$t0@@0)) (= _$t0@@0 _$t0@@0)) (and (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t2@0| (|$addr#$signer| _$t0@@0)) (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t3@0|  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t2@0|)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t2@0|)) 1))) (not (= (|$addr#$signer| _$t0@@0) 186537453)))))) (and (=> (= (ControlFlow 0 223664) 224043) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon7_Then_correct|) (=> (= (ControlFlow 0 223664) 223682) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon7_Else_correct|)))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon23_Else_correct|  (=> (not $abort_flag@0@@0) (=> (and (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t12@0| (|$addr#$signer| _$t0@@0)) (= (ControlFlow 0 224049) 223664)) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon0_correct|))))
...
(let ((|inline$$1_Diem_zero'$1_XUS_XUS'$0$anon3_Else_correct|  (=> (not |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t0@0|) (=> (and (|$IsValid'u64'| 0) (= |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t3@1| (|$1_Diem_Diem'$1_XUS_XUS'| 0))) (=> (and (and (= |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t3@1| |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t3@1|) (= $abort_flag@0@@0 false)) (and (= $abort_code@1@@0 $abort_code@0@@0) (= |inline$$1_Diem_zero'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t3@1|))) (and (=> (= (ControlFlow 0 223184) 224193) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon23_Then_correct|) (=> (= (ControlFlow 0 223184) 224049) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon23_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'$1_XUS_XUS'$0$anon3_Then_correct|  (=> |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t0@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_138932| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t1@0|)) (=> (and (and (= |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t1@0| |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t1@0|) (= $abort_flag@0@@0 true)) (and (= $abort_code@1@@0 |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t1@0|) (= |inline$$1_Diem_zero'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_zero'$1_XUS_XUS'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 223214) 224193) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon23_Then_correct|) (=> (= (ControlFlow 0 223214) 224049) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon23_Else_correct|)))))))
...
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon19_Then_correct|  (=> (and |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t4@0| (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t3@0|)) (= 5 |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t3@0|)) 1)) (= 3 |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|))) (and (not (= (|$addr#$signer| _$t0@@0) 186537453)) (= 2 |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|)))) (=> (and (and (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0| |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|) (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@1| |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|)) (and (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@2| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (= (ControlFlow 0 224305) 223001))) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$L3_correct|))))
...
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@0))
 ...
 :skolemid |220|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) $a_0@@1)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@1))
 :qid |TransactionFeebpl.15114:20|
 :skolemid |221|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) $a_0@@1))
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_138932| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@2)))
 ...
 :skolemid |222|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_138932| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@2))
)))) (and (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_TransactionFee_TransactionFee'$1_XUS_XUS'_| (|contents#$Memory_130984| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) $a_0@@3)))
(|$IsValid'$1_TransactionFee_TransactionFee'$1_XUS_XUS''| $rsc@@3))
 :qid |TransactionFeebpl.15122:20|
 :skolemid |223|
 :pattern ( (|Select__T@[Int]$1_TransactionFee_TransactionFee'$1_XUS_XUS'_| (|contents#$Memory_130984| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) $a_0@@3))
)) (= $t1 (|$addr#$signer| _$t0@@0))) (and (= _$t0@@0 _$t0@@0) (= $t2  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 222068) 224701) anon8_Then_correct) (=> (= (ControlFlow 0 222068) 222128) anon8_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_91738_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_91738| stream@@1) 0) (forall ((v@@49 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_91738| stream@@1) v@@49) 0)
 :qid |TransactionFeebpl.159:13|
 :skolemid |4|
))))
 :qid |TransactionFeebpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 221452) 222068)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 326018) 221452) inline$$InitEventStore$0$anon0_correct@@0)))
anon0_correct@@0)))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
