...
(assert (not
 (=> (= (ControlFlow 0 0) 1161103) (let ((L2_correct@@16  (and (=> (= (ControlFlow 0 822453) (- 0 1162391)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t1@@4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t1@@4)) 1))) (not (= (|$addr#$signer| _$t0@@34) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t1@@4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t1@@4)) 1))) (not (= (|$addr#$signer| _$t0@@34) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 822453) (- 0 1162431)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t1@@4)) (= 5 $t4@0@@3)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t1@@4)) 1)) (= 3 $t4@0@@3))) (and (not (= (|$addr#$signer| _$t0@@34) 186537453)) (= 2 $t4@0@@3))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t4@0@@3))))))))
(let ((anon10_Then_correct@@15  (=> (and (and $abort_flag@0@@26 (= $abort_code@1@@26 $abort_code@1@@26)) (and (= $t4@0@@3 $abort_code@1@@26) (= (ControlFlow 0 822325) 822453))) L2_correct@@16)))
(let ((anon9_Then_correct@@14  (=> $t5@@20 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t4@@13)) (= $t4@@13 $t4@@13)) (and (= $t4@0@@3 $t4@@13) (= (ControlFlow 0 822479) 822453))) L2_correct@@16))))
(let ((anon8_Then_correct@@3  (=> $t3@@13 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t2@@13)) (= 5 $t4@@13)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t2@@13)) 1)) (= 3 $t4@@13))) (and (not (= (|$addr#$signer| _$t0@@34) 186537453)) (= 2 $t4@@13))) (= $t4@@13 $t4@@13)) (and (= $t4@0@@3 $t4@@13) (= (ControlFlow 0 822551) 822453))) L2_correct@@16))))
(let ((anon10_Else_correct@@15  (=> (not $abort_flag@0@@26) (=> (and (= $t7@0 (|$1_Diem_Preburn'#0'| |inline$$1_Diem_zero'#0'$0$$ret0@1|)) (= $t7@0 $t7@0)) (and (=> (= (ControlFlow 0 822311) (- 0 1162047)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t1@@4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t1@@4))) (and (=> (= (ControlFlow 0 822311) (- 0 1162059)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t1@@4)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t1@@4)) 1))) (and (=> (= (ControlFlow 0 822311) (- 0 1162077)) (not (not (= (|$addr#$signer| _$t0@@34) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@34) 186537453))) (and (=> (= (ControlFlow 0 822311) (- 0 1162091)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 822311) (- 0 1162101)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 822311) (- 0 1162122)) (forall ((addr@@889 Int) ) (!  (=> (|$IsValid'address'| addr@@889) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@889)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@889))))
 :qid |Diembpl.26760:15|
 :skolemid |1355|
))) (=> (forall ((addr@@890 Int) ) (!  (=> (|$IsValid'address'| addr@@890) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@890)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@890))))
 :qid |Diembpl.26760:15|
 :skolemid |1355|
)) (and (=> (= (ControlFlow 0 822311) (- 0 1162151)) (forall ((addr@@891 Int) ) (!  (=> (|$IsValid'address'| addr@@891) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@891) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@891)))
 :qid |Diembpl.26765:15|
 :skolemid |1356|
))) (=> (forall ((addr@@892 Int) ) (!  (=> (|$IsValid'address'| addr@@892) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@892) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@892)))
 :qid |Diembpl.26765:15|
 :skolemid |1356|
)) (and (=> (= (ControlFlow 0 822311) (- 0 1162176)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 822311) (- 0 1162197)) (forall ((addr@@893 Int) ) (!  (=> (|$IsValid'address'| addr@@893) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@893)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@893))))
 :qid |Diembpl.26775:15|
 :skolemid |1357|
))) (=> (forall ((addr@@894 Int) ) (!  (=> (|$IsValid'address'| addr@@894) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@894)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@894))))
 :qid |Diembpl.26775:15|
 :skolemid |1357|
)) (and (=> (= (ControlFlow 0 822311) (- 0 1162226)) (forall ((addr@@895 Int) ) (!  (=> (|$IsValid'address'| addr@@895) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@895) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@895)))
 :qid |Diembpl.26780:15|
 :skolemid |1358|
))) (=> (forall ((addr@@896 Int) ) (!  (=> (|$IsValid'address'| addr@@896) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@896) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@896)))
 :qid |Diembpl.26780:15|
 :skolemid |1358|
)) (and (=> (= (ControlFlow 0 822311) (- 0 1162251)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 822311) (- 0 1162272)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 822311) (- 0 1162293)) (forall ((addr@@897 Int) ) (!  (=> (|$IsValid'address'| addr@@897) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@897) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@897))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@897))))
 :qid |Diembpl.26795:15|
 :skolemid |1359|
))) (=> (forall ((addr@@898 Int) ) (!  (=> (|$IsValid'address'| addr@@898) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@898) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@898))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@898))))
 :qid |Diembpl.26795:15|
 :skolemid |1359|
)) (and (=> (= (ControlFlow 0 822311) (- 0 1162329)) (forall ((addr@@899 Int) ) (!  (=> (|$IsValid'address'| addr@@899) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@899) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@899)))
 :qid |Diembpl.26800:15|
 :skolemid |1360|
))) (=> (forall ((addr@@900 Int) ) (!  (=> (|$IsValid'address'| addr@@900) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@900) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@900)))
 :qid |Diembpl.26800:15|
 :skolemid |1360|
...
(let ((|inline$$1_Diem_zero'#0'$0$anon3_Else_correct|  (=> (not |inline$$1_Diem_zero'#0'$0$$t0@0|) (=> (and (|$IsValid'u64'| 0) (= |inline$$1_Diem_zero'#0'$0$$t3@1| (|$1_Diem_Diem'#0'| 0))) (=> (and (and (= |inline$$1_Diem_zero'#0'$0$$t3@1| |inline$$1_Diem_zero'#0'$0$$t3@1|) (= $abort_flag@0@@26 false)) (and (= $abort_code@1@@26 $abort_code@0@@26) (= |inline$$1_Diem_zero'#0'$0$$ret0@1| |inline$$1_Diem_zero'#0'$0$$t3@1|))) (and (=> (= (ControlFlow 0 821919) 822325) anon10_Then_correct@@15) (=> (= (ControlFlow 0 821919) 822311) anon10_Else_correct@@15)))))))
(let ((|inline$$1_Diem_zero'#0'$0$anon3_Then_correct|  (=> |inline$$1_Diem_zero'#0'$0$$t0@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_zero'#0'$0$$t1@0|)) (=> (and (and (= |inline$$1_Diem_zero'#0'$0$$t1@0| |inline$$1_Diem_zero'#0'$0$$t1@0|) (= $abort_flag@0@@26 true)) (and (= $abort_code@1@@26 |inline$$1_Diem_zero'#0'$0$$t1@0|) (= |inline$$1_Diem_zero'#0'$0$$ret0@1| |inline$$1_Diem_zero'#0'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 821949) 822325) anon10_Then_correct@@15) (=> (= (ControlFlow 0 821949) 822311) anon10_Else_correct@@15)))))))
...
(let ((anon9_Else_correct@@14  (=> (and (not $t5@@20) (= (ControlFlow 0 821955) 821891)) |inline$$1_Diem_zero'#0'$0$anon0_correct|)))
(let ((anon8_Else_correct@@3  (=> (and (not $t3@@13) (= $t5@@20  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 821734) 822479) anon9_Then_correct@@14) (=> (= (ControlFlow 0 821734) 821955) anon9_Else_correct@@14)))))
(let ((anon0$1_correct@@43  (=> (and (and (forall ((mint_cap_owner@@11 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) mint_cap_owner@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) mint_cap_owner@@11)) 1))))
 :qid |Diembpl.26588:22|
 :skolemid |1335|
)) (forall ((mint_cap_owner@@12 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316220| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner@@12) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) mint_cap_owner@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) mint_cap_owner@@12)) 1))))
 :qid |Diembpl.26588:269|
 :skolemid |1336|
))) (forall ((mint_cap_owner@@13 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner@@13) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) mint_cap_owner@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) mint_cap_owner@@13)) 1))))
 :qid |Diembpl.26588:517|
 :skolemid |1337|
))) (=> (and (and (and (and (forall ((addr3@@188 Int) ) (!  (=> (|$IsValid'address'| addr3@@188) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3@@188) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.26592:22|
 :skolemid |1338|
)) (forall ((addr3@@189 Int) ) (!  (=> (|$IsValid'address'| addr3@@189) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316220| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@189) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |Diembpl.26592:261|
 :skolemid |1339|
))) (forall ((addr3@@190 Int) ) (!  (=> (|$IsValid'address'| addr3@@190) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr3@@190) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |Diembpl.26592:501|
 :skolemid |1340|
))) (and (and (forall ((addr1@@86 Int) ) (!  (=> (|$IsValid'address'| addr1@@86) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316394| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1@@86) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@86) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@86)) 1))))
 :qid |Diembpl.26596:22|
 :skolemid |1341|
)) (forall ((addr1@@87 Int) ) (!  (=> (|$IsValid'address'| addr1@@87) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316479| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr1@@87) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@87) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@87)) 1))))
 :qid |Diembpl.26596:232|
 :skolemid |1342|
))) (forall ((addr1@@88 Int) ) (!  (=> (|$IsValid'address'| addr1@@88) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr1@@88) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@88) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@88)) 1))))
 :qid |Diembpl.26596:443|
 :skolemid |1343|
)))) (and (and (and (forall ((addr1@@89 Int) ) (!  (=> (|$IsValid'address'| addr1@@89) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1@@89) (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1@@89)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@89) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@89)) 2))))
 :qid |Diembpl.26600:22|
 :skolemid |1344|
)) (forall ((addr1@@90 Int) ) (!  (=> (|$IsValid'address'| addr1@@90) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr1@@90) (|Select__T@[Int]Bool_| (|domain#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr1@@90)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@90) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@90)) 2))))
 :qid |Diembpl.26600:293|
 :skolemid |1345|
))) (forall ((addr1@@91 Int) ) (!  (=> (|$IsValid'address'| addr1@@91) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr1@@91) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr1@@91)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@91) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@91)) 2))))
 :qid |Diembpl.26600:565|
 :skolemid |1346|
))) (and (and (forall ((addr@@901 Int) ) (!  (=> (|$IsValid'address'| addr@@901) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@901) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.26604:22|
 :skolemid |1347|
)) (forall ((addr@@902 Int) ) (!  (=> (|$IsValid'address'| addr@@902) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@902) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.26604:222|
 :skolemid |1348|
))) (forall ((addr@@903 Int) ) (!  (=> (|$IsValid'address'| addr@@903) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@903) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.26604:423|
 :skolemid |1349|
))))) (=> (and (and (and (and (and (forall ((addr@@904 Int) ) (!  (=> (|$IsValid'address'| addr@@904) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@904) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.26608:22|
 :skolemid |1350|
)) (forall ((addr@@905 Int) ) (!  (=> (|$IsValid'address'| addr@@905) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@905) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.26608:227|
 :skolemid |1351|
))) (forall ((addr@@906 Int) ) (!  (=> (|$IsValid'address'| addr@@906) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@906) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.26608:433|
 :skolemid |1352|
))) (|$IsValid'address'| (|$addr#$signer| _$t0@@34))) (and (forall (($a_0@@65 Int) ) (! (let (($rsc@@65 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $a_0@@65)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@65))
 :qid |Diembpl.26614:20|
 :skolemid |1353|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $a_0@@65))
)) (forall (($a_0@@66 Int) ) (! (let (($rsc@@66 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@66)))
 ...
 :skolemid |1354|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@66))
)))) (and (and (= $t1@@4 (|$addr#$signer| _$t0@@34)) (= _$t0@@34 _$t0@@34)) (and (= $t2@@13 (|$addr#$signer| _$t0@@34)) (= $t3@@13  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t2@@13)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t2@@13)) 1))) (not (= (|$addr#$signer| _$t0@@34) 186537453))))))) (and (=> (= (ControlFlow 0 821716) 822551) anon8_Then_correct@@3) (=> (= (ControlFlow 0 821716) 821734) anon8_Else_correct@@3)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@43  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@105 T@$1_Event_EventHandle) ) (! (let ((stream@@134 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@105)))
 (and (= (|l#Multiset_275813| stream@@134) 0) (forall ((v@@152 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@134) v@@152) 0)
 :qid |Diembpl.159:13|
 :skolemid |4|
))))
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 821106) 821716)) anon0$1_correct@@43)))
(let ((anon0_correct@@43  (=> (= (ControlFlow 0 1161103) 821106) inline$$InitEventStore$0$anon0_correct@@43)))
anon0_correct@@43))))))))))))))
))
(check-sat)
(pop 1)
