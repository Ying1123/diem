...
(assert (not (= i1 i3)))
(assert (not (= i1 i2)))
(assert (not (= (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store a1 i1 e1) i2 e2) i3 e3) i4 e4) i5 e5) i6 e6) i7 e7) i8 e8) i9 e9) i10 e10) i11 e11) i12 e12) i13 e13) i14 e14) i15 e15) i16 e16) i17 e17) i18 e18) i19 e19) i20 e20) i21 e21) i22 e22) i23 e23) i24 e24) i25 e25) i26 e26) i27 e27) i28 e28) i29 e29) i30 e30) (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store a1 i21 e21) i13 e13) i4 e4) i12 e12) i19 e19) i6 e6) i3 e3) i7 e7) i18 e18) i24 e24) i5 e5) i14 e14) i29 e29) i9 e9) i11 e11) i2 e2) i25 e25) i8 e8) i26 e26) i1 e1) i27 e27) i23 e23) i17 e17) i30 e30) i15 e15) i20 e20) i28 e28) i10 e10) i22 e22) i16 e16))))
(check-sat)
(exit)
