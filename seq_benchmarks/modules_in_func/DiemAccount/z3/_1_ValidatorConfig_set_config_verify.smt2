...
(declare-fun $t25 () T@$Mutation_474524)
...
(declare-fun $t11 () T@$Mutation_474524)
...
(assert (not
 ...
 :qid |DiemAccountbpl.9202:15|
 :skolemid |229|
)) (and (=> (= (ControlFlow 0 1096889) (- 0 2042849)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr)) 3))))
 ...
 :qid |DiemAccountbpl.9208:15|
 :skolemid |230|
)) (and (=> (= (ControlFlow 0 1096889) (- 0 2042874)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@1)) 3))))
...
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0)) 0)) a@@2)))
 ...
 :qid |DiemAccountbpl.9226:592|
 :skolemid |235|
))) (and (=> (= (ControlFlow 0 1096889) (- 0 2043065)) (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (= (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@19)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@19)) 3))))
 ...
 :qid |DiemAccountbpl.9233:15|
 :skolemid |236|
)) (and (=> (= (ControlFlow 0 1096889) (- 0 2043093)) (not (not (= (|$addr#$signer| _$t0) (let ((t_ref@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@1)) 0)))))) (=> (not (not (= (|$addr#$signer| _$t0) (let ((t_ref@@2 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@2)) 0))))) (and (=> (= (ControlFlow 0 1096889) (- 0 2043109)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t2)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t2))) (and (=> (= (ControlFlow 0 1096889) (- 0 2043119)) (not (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0))))) (=> (not (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0)))) (and (=> (= (ControlFlow 0 1096889) (- 0 2043130)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (and (=> (= (ControlFlow 0 1096889) (- 0 2043141)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0) _$t1) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0) _$t1)))) 0)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0) _$t1) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0) _$t1)))) 0))) (=> (= (ControlFlow 0 1096889) (- 0 2043148)) (= (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0) _$t1) ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (seq.unit ($1_ValidatorConfig_Config _$t2 _$t3 _$t4))) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))))))))))))))))))))))))))))))))))))))
(let ((anon26_Then_correct true))
(let ((anon24_Then_correct true))
(let ((L7_correct  (and (=> (= (ControlFlow 0 1096047) (- 0 2042508)) (or (or (or (not (= (|$addr#$signer| _$t0) (let ((t_ref@@3 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@3)) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2))) (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) (=> (or (or (or (not (= (|$addr#$signer| _$t0) (let ((t_ref@@4 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@4)) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2))) (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (=> (= (ControlFlow 0 1096047) (- 0 2042542)) (or (or (or (and (not (= (|$addr#$signer| _$t0) (let ((t_ref@@5 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@5)) 0)))) (= 7 $t15@0)) (and (not ($1_Signature_$ed25519_validate_pubkey _$t2)) (= 7 $t15@0))) (and (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0))) (= 7 $t15@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (= 5 $t15@0))))))))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 1096903) 1096047))) L7_correct)))
(let ((anon28_Then$1_correct  (=> (= $t25@1 $t25) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1096955) 1096903) anon29_Then_correct) (=> (= (ControlFlow 0 1096955) 1096889) anon29_Else_correct))))))
(let ((anon28_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (= (ControlFlow 0 1096953) 1096955)) anon28_Then$1_correct)))
(let ((anon28_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (=> (and (and (= $t25@0 ($Mutation_474524 ($Global _$t1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (= $t25@1 $t25@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1096334) 1096903) anon29_Then_correct) (=> (= (ControlFlow 0 1096334) 1096889) anon29_Else_correct))))))
(let ((anon27_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (and (=> (= (ControlFlow 0 1096312) (- 0 2042380)) (|Select__T@[Int]Bool_| $1_ValidatorConfig_ValidatorConfig_$modifies _$t1)) (=> (|Select__T@[Int]Bool_| $1_ValidatorConfig_ValidatorConfig_$modifies _$t1) (and (=> (= (ControlFlow 0 1096312) 1096953) anon28_Then_correct) (=> (= (ControlFlow 0 1096312) 1096334) anon28_Else_correct)))))))
(let ((anon27_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= $t24 $t24)) (and (= $t15@0 $t24) (= (ControlFlow 0 1096302) 1096047))) L7_correct)))
(let ((anon26_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t24) (= $t24 5)) (and (= $t24 $t24) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 1096286) 1096312) anon27_Then_correct) (=> (= (ControlFlow 0 1096286) 1096302) anon27_Else_correct))))))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= _$t1 _$t1) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 1096244) 1096969) anon26_Then_correct) (=> (= (ControlFlow 0 1096244) 1096286) anon26_Else_correct))))))
(let ((anon25_Then_correct  (=> (and inline$$1_Signature_ed25519_validate_pubkey$0$res@1 (= (ControlFlow 0 1096250) 1096244)) inline$$1_ValidatorConfig_exists_config$0$anon0_correct)))
(let ((anon25_Else_correct  (=> (and (and (not inline$$1_Signature_ed25519_validate_pubkey$0$res@1) (= $t21 $t21)) (and (= $t15@0 $t21) (= (ControlFlow 0 1096143) 1096047))) L7_correct)))
(let ((anon24_Else_correct  (=> (and (not false) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t21) (= $t21 7)) (and (= $t21 $t21) (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 inline$$1_Signature_ed25519_validate_pubkey$0$res@1))) (and (=> (= (ControlFlow 0 1096127) 1096250) anon25_Then_correct) (=> (= (ControlFlow 0 1096127) 1096143) anon25_Else_correct))))))
(let ((inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct  (=> (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 ($1_Signature_$ed25519_validate_pubkey _$t2)) (and (=> (= (ControlFlow 0 1096081) 1096983) anon24_Then_correct) (=> (= (ControlFlow 0 1096081) 1096127) anon24_Else_correct)))))
(let ((anon23_Then_correct  (=> (and $t16@0 (= (ControlFlow 0 1096087) 1096081)) inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct)))
(let ((anon23_Else_correct  (=> (and (and (not $t16@0) (= $t18 $t18)) (and (= $t15@0 $t18) (= (ControlFlow 0 1095923) 1096047))) L7_correct)))
(let ((anon22_Else_correct  (=> (not $t14) (=> (and (and (and (|$IsValid'address'| $t13) (= $t13 (let ((t_ref@@6 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@6)) 0)))) (and (= $t16@0 (= $t12 $t13)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t18) (= $t18 7)) (and (= $t18 $t18) (= $t16@0 $t16@0)))) (and (=> (= (ControlFlow 0 1095907) 1096087) anon23_Then_correct) (=> (= (ControlFlow 0 1095907) 1095923) anon23_Else_correct))))))
(let ((anon22_Then_correct  (=> $t14 (=> (and (and (or (and (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0))) (= 7 $t15)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (= 5 $t15))) (= $t15 $t15)) (and (= $t15@0 $t15) (= (ControlFlow 0 1097029) 1096047))) L7_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@21) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@21)) 3))))
 :qid |DiemAccountbpl.8880:20|
 :skolemid |223|
)) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@22) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@22)) 3))))
 :qid |DiemAccountbpl.8884:20|
 :skolemid |224|
))) (and (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@23) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@23)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@23)) 3))))
 :qid |DiemAccountbpl.8888:20|
 :skolemid |225|
)) (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@24)) 3))))
 :qid |DiemAccountbpl.8892:20|
 :skolemid |226|
)))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (|$IsValid'address'| _$t1) (|$IsValid'vec'u8''| _$t2))) (and (and (|$IsValid'vec'u8''| _$t3) (|$IsValid'vec'u8''| _$t4)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0)))
 ...
 :skolemid |227|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0))
)) (|Select__T@[Int]Bool_| $1_ValidatorConfig_ValidatorConfig_$modifies _$t1)))) (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= _$t2 _$t2) (= _$t3 _$t3))) (and (and (= _$t4 _$t4) (|$IsValid'address'| $t12)) (and (= $t12 (|$addr#$signer| _$t0)) (= $t14  (or (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))))))) (and (=> (= (ControlFlow 0 1095849) 1097029) anon22_Then_correct) (=> (= (ControlFlow 0 1095849) 1095907) anon22_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3664:13|
 :skolemid |102|
))) (= (ControlFlow 0 1095581) 1095849)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (seq.len (|p#$Mutation_474524| $t11)) 0) (= (seq.len (|p#$Mutation_474524| $t25)) 0)) (and (= (seq.len (|p#$Mutation_478024| $t28)) 0) (= (ControlFlow 0 1095591) 1095581))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 2041706) 1095591) anon0_correct)))
