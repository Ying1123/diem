...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 220289) (let ((L5_correct  (and (=> (= (ControlFlow 0 160455) (- 0 221141)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (= (ControlFlow 0 160455) (- 0 221148)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= 5 $t5@0)))))))
(let ((anon10_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= $t5@0 $abort_code@3) (= (ControlFlow 0 160423) 160455))) L5_correct)))
(let ((anon8_Then_correct  (=> $t4 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= 5 $t5)) (= $t5 $t5)) (and (= $t5@0 $t5) (= (ControlFlow 0 160501) 160455))) L5_correct))))
...
(let ((inline$$1_Roles_has_role$0$anon11_Then_correct  (=> $abort_flag@0 (=> (and (and (= $abort_code@1 $abort_code@1) (= $abort_code@3 $abort_code@1)) (and (= $abort_flag@2 true) (= inline$$1_Roles_has_role$0$$ret0@1 inline$$1_Roles_has_role$0$$ret0@0))) (and (=> (= (ControlFlow 0 160247) 160341) inline$$1_Roles_has_diem_root_role$0$anon3_Then_correct) (=> (= (ControlFlow 0 160247) 160323) inline$$1_Roles_has_diem_root_role$0$anon3_Else_correct))))))
...
(let ((inline$$1_Roles_has_role$0$anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_98919| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0) (=> (and (and (= inline$$1_Roles_has_role$0$$t6@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_98919| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_Roles_has_role$0$$t6@2 inline$$1_Roles_has_role$0$$t6@1))) (and (=> (= (ControlFlow 0 160201) 160247) inline$$1_Roles_has_role$0$anon11_Then_correct) (=> (= (ControlFlow 0 160201) 160229) inline$$1_Roles_has_role$0$anon11_Else_correct))))))
...
(let ((inline$$1_Roles_has_role$0$anon9_Else_correct  (=> (and (not inline$$1_Roles_has_role$0$$t5@1) (= false false)) (=> (and (and (= $abort_code@2 $abort_code@0) (= inline$$1_Roles_has_role$0$$t2@1 false)) (and (= $abort_flag@1 false) (= (ControlFlow 0 160171) 160183))) inline$$1_Roles_has_role$0$L3_correct))))
(let ((inline$$1_Roles_has_role$0$anon0_correct  (=> (and (= _$t0 _$t0) (= 0 0)) (=> (and (and (|$IsValid'address'| inline$$1_Roles_has_role$0$$t4@0) (= inline$$1_Roles_has_role$0$$t4@0 (|$addr#$signer| _$t0))) (and (= inline$$1_Roles_has_role$0$$t4@0 inline$$1_Roles_has_role$0$$t4@0) (= inline$$1_Roles_has_role$0$$t5@1 (|Select__T@[Int]Bool_| (|domain#$Memory_98919| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0)))) (and (=> (= (ControlFlow 0 160151) 160187) inline$$1_Roles_has_role$0$anon9_Then_correct) (=> (= (ControlFlow 0 160151) 160171) inline$$1_Roles_has_role$0$anon9_Else_correct))))))
(let ((inline$$1_Roles_has_diem_root_role$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 160305) 160151)) inline$$1_Roles_has_role$0$anon0_correct))))
...
(let ((anon8_Else_correct  (=> (not $t4) (=> (and (and (|$IsValid'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| $t3) (= $t3 (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) addr@@0))))) (and (= $t3 $t3) (= $t6@0 (|$module_publishing_allowed#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| $t3)))) (and (=> (= (ControlFlow 0 159667) 160473) anon9_Then_correct) (=> (= (ControlFlow 0 159667) 160347) anon9_Else_correct))))))
(let ((anon0$1_correct  (=> (and (and (and (and (and (and (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100754| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address) (= config_address 173345816)))
 ...
 :skolemid |190|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_97094| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (|$IsValid'address'| (|$addr#$signer| _$t0)))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_98919| $1_Roles_RoleId_$memory) $a_0)))
...
))) (and (= _$t0 _$t0) (= $t4  (not (|Select__T@[Int]Bool_| (|domain#$Memory_98538| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 159637) 160501) anon8_Then_correct) (=> (= (ControlFlow 0 159637) 159667) anon8_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_68416_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTransactionPublishingOptionbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 159420) 159637)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 220289) 159420) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))
))
(check-sat)
(pop 1)
