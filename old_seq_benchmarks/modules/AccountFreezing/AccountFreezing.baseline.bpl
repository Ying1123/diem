...
L8:
    ...
    assert {:msg "assert_failed(17,3378,4123): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#108) && $IsEqual'num'(1, $t11)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 0) && $IsEqual'num'(2, $t11))) || (if ($IsEqual'address'($t1, 0)) then (!$IsEqual'u64'($t9, $t2)) else (($t9 >= $t2)) && $IsEqual'num'(7, $t11)));
...
L3:
    ...
    assert {:msg "assert_failed(4,2164,2500): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#140) && $IsEqual'num'(1, $t5)) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'num'(2, $t5))) || ($ResourceExists($1_AccountFreezing_FreezeEventsHolder_$memory#141, $t3) && $IsEqual'num'(6, $t5)));
...
L3:
    ...
    assert {:msg "assert_failed(4,6897,6982): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ($1_AccountFreezing_spec_account_is_frozen($1_AccountFreezing_FreezingBit_$memory#91, $t0) && $IsEqual'num'(1, $t6));
...
L3:
    ...
    assert {:msg "assert_failed(4,2747,2989): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ($ResourceExists($1_AccountFreezing_FreezingBit_$memory#92, $t4) && $IsEqual'num'(6, $t10));
...
L7:
    ...
    assert {:msg "assert_failed(4,4015,4488): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#124) && $IsEqual'num'(1, $t14)) || (!$ResourceExists($1_Roles_RoleId_$memory#125, $t9) && $IsEqual'num'(5, $t14))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t9)), 1) && $IsEqual'num'(3, $t14))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'num'(2, $t14))) || ($IsEqual'address'($t1, 173345816) && $IsEqual'num'(7, $t14))) || ($IsEqual'address'($t1, 186537453) && $IsEqual'num'(7, $t14))) || (!$ResourceExists($1_AccountFreezing_FreezingBit_$memory#126, $t1) && $IsEqual'num'(5, $t14))) || (!$ResourceExists($1_Roles_RoleId_$memory#125, $t12) && $IsEqual'num'(5, $t14))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t12)), 1) && $IsEqual'num'(3, $t14))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'num'(2, $t14)));
...
L3:
    ...
    assert {:msg "assert_failed(4,5632,5950): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#121) && $IsEqual'num'(1, $t10)) || (!$ResourceExists($1_Roles_RoleId_$memory#122, $t5) && $IsEqual'num'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t5)), 1) && $IsEqual'num'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'num'(2, $t10))) || (!$ResourceExists($1_AccountFreezing_FreezingBit_$memory#123, $t1) && $IsEqual'num'(5, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#122, $t8) && $IsEqual'num'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t8)), 1) && $IsEqual'num'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'num'(2, $t10)));
