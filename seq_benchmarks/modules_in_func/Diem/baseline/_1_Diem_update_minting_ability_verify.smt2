...
(declare-fun $t9@1 () T@$Mutation_401221)
(declare-fun $t10@0 () T@$Mutation_197257)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t10@1 () T@$Mutation_197257)
(declare-fun _$t1 () Bool)
(declare-fun $t9@2 () T@$Mutation_401221)
...
(declare-fun $t9 () T@$Mutation_401221)
(declare-fun $t9@0 () T@$Mutation_401221)
...
(declare-fun $t2 () T@$Mutation_401221)
(declare-fun $t10 () T@$Mutation_197257)
(push 1)
(set-info :boogie-vc-id $1_Diem_update_minting_ability$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1281294) (let ((L2_correct  (and (=> (= (ControlFlow 0 975150) (- 0 1283228)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 975150) (- 0 1283268)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6@0))))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 975022) 975150))) L2_correct)))
(let ((anon12_Then_correct  (=> $t7 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 975228) 975150))) L2_correct))))
(let ((anon11_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6))) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 975300) 975150))) L2_correct))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| (|v#$Mutation_401221| $t9@1))) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| |$temp_0'$1_Diem_CurrencyInfo'#0''@0|) (= $t10@0 ($Mutation_197257 (|l#$Mutation_401221| $t9@1) (let ((l (|l#Vec_28308| (|p#$Mutation_401221| $t9@1))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_401221| $t9@1)) l 7) (+ l 1))) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1))))) (and (= $t10@1 ($Mutation_197257 (|l#$Mutation_197257| $t10@0) (|p#$Mutation_197257| $t10@0) _$t1)) (= $t9@2 ($Mutation_401221 (|l#$Mutation_401221| $t9@1) (|p#$Mutation_401221| $t9@1) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1)) (|v#$Mutation_197257| $t10@1) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@1))))))) (and (=> (= (ControlFlow 0 975008) (- 0 1282276)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| $t9@2)) 10000000000)) (=> (and (and (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |Diembpl.54249:106|
 :skolemid |2980|
 ...
 :qid |Diembpl.54249:973|
 :skolemid |2982|
)))) (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_335624 (|Store__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| $t9@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| $t9@2)) (|v#$Mutation_401221| $t9@2))))) (and (=> (= (ControlFlow 0 975008) (- 0 1282463)) (and (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@2 Int) (mint_cap_owner2@@2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@2) (=> (|$IsValid'address'| mint_cap_owner2@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner1@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner2@@2)) (= mint_cap_owner1@@2 mint_cap_owner2@@2))))
 :qid |Diembpl.54272:101|
 :skolemid |2983|
 ...
 :qid |Diembpl.54272:968|
 :skolemid |2985|
)))) (and (=> (= (ControlFlow 0 975008) (- 0 1282598)) (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.54278:17|
 :skolemid |2986|
 ...
 :qid |Diembpl.54278:496|
 :skolemid |2988|
))) (and (=> (= (ControlFlow 0 975008) (- 0 1282667)) (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.54284:17|
 :skolemid |2989|
 ...
 :qid |Diembpl.54284:217|
 :skolemid |2990|
))) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |Diembpl.54284:418|
 :skolemid |2991|
 ...
 :qid |Diembpl.54284:217|
 :skolemid |2990|
))) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |Diembpl.54284:418|
 :skolemid |2991|
))) (and (=> (= (ControlFlow 0 975008) (- 0 1282736)) (and (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.54290:17|
 :skolemid |2992|
 ...
 :qid |Diembpl.54290:222|
 :skolemid |2993|
))) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |Diembpl.54290:428|
 :skolemid |2994|
 ...
 :qid |Diembpl.54290:222|
 :skolemid |2993|
))) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |Diembpl.54290:428|
 :skolemid |2994|
))) (and (=> (= (ControlFlow 0 975008) (- 0 1282805)) (and (and (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr)))
 :qid |Diembpl.54296:17|
 :skolemid |2995|
 ...
 :qid |Diembpl.54296:223|
 :skolemid |2996|
))) (forall ((dr_addr@@1 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@1)))
 :qid |Diembpl.54296:430|
 :skolemid |2997|
 ...
 :qid |Diembpl.54296:223|
 :skolemid |2996|
))) (forall ((dr_addr@@4 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@4)))
 :qid |Diembpl.54296:430|
 :skolemid |2997|
))) (and (=> (= (ControlFlow 0 975008) (- 0 1282880)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 975008) (- 0 1282890)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 975008) (- 0 1282902)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 975008) (- 0 1282920)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 975008) (- 0 1282934)) (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) _$t1)) (=> (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) _$t1) (and (=> (= (ControlFlow 0 975008) (- 0 1282945)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 975008) (- 0 1282965)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@12)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@12))))
 :qid |Diembpl.54335:15|
 :skolemid |2998|
))) (=> (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@13)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@13))))
 :qid |Diembpl.54335:15|
 :skolemid |2998|
)) (and (=> (= (ControlFlow 0 975008) (- 0 1282994)) (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@14)))
 :qid |Diembpl.54340:15|
 :skolemid |2999|
))) (=> (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@15)))
 :qid |Diembpl.54340:15|
 :skolemid |2999|
)) (and (=> (= (ControlFlow 0 975008) (- 0 1283019)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 975008) (- 0 1283039)) (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@16)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@16))))
 :qid |Diembpl.54350:15|
 :skolemid |3000|
))) (=> (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@17)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@17))))
 :qid |Diembpl.54350:15|
 :skolemid |3000|
)) (and (=> (= (ControlFlow 0 975008) (- 0 1283068)) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@18)))
 :qid |Diembpl.54355:15|
 :skolemid |3001|
))) (=> (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@19) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@19)))
 :qid |Diembpl.54355:15|
 :skolemid |3001|
)) (and (=> (= (ControlFlow 0 975008) (- 0 1283093)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 975008) (- 0 1283113)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 975008) (- 0 1283133)) (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@20) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@20))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@20))))
 :qid |Diembpl.54370:15|
 :skolemid |3002|
))) (=> (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@21) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@21))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@21))))
 :qid |Diembpl.54370:15|
 :skolemid |3002|
)) (and (=> (= (ControlFlow 0 975008) (- 0 1283169)) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@22) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@22)))
 :qid |Diembpl.54375:15|
 :skolemid |3003|
))) (=> (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@23) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@23)))
 :qid |Diembpl.54375:15|
 :skolemid |3003|
)) (=> (= (ControlFlow 0 975008) (- 0 1283194)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon13_Then$1_correct  (=> (= $t9@1 $t9) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 975202) 975022) anon14_Then_correct) (=> (= (ControlFlow 0 975202) 975008) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 975200) 975202)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t9@0 ($Mutation_401221 ($Global 173345816) (Vec_28308 (MapConstVec_13534 DefaultVecElem_13534) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t9@1 $t9@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 974012) 975022) anon14_Then_correct) (=> (= (ControlFlow 0 974012) 975008) anon14_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (not $t7) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 973990) 975200) anon13_Then_correct) (=> (= (ControlFlow 0 973990) 974012) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not $t5) (= $t7  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 973976) 975228) anon12_Then_correct) (=> (= (ControlFlow 0 973976) 973990) anon12_Else_correct)))))
(let ((anon0$1_correct  (=> (and (and (and (and (and (forall ((mint_cap_owner Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) mint_cap_owner) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) mint_cap_owner)) 1))))
 :qid |Diembpl.54078:22|
 :skolemid |2960|
 ...
 :qid |Diembpl.54082:501|
 :skolemid |2965|
)))) (and (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316394| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1)) 1))))
 :qid |Diembpl.54086:22|
 :skolemid |2966|
 ...
 :qid |Diembpl.54090:565|
 :skolemid |2971|
))))) (and (and (and (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@24) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.54094:22|
 :skolemid |2972|
 ...
 :qid |Diembpl.54094:423|
 :skolemid |2974|
))) (and (and (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@27) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.54098:22|
 :skolemid |2975|
 ...
 :qid |Diembpl.54098:433|
 :skolemid |2977|
)))) (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Diembpl.54107:20|
 :skolemid |2978|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 973338) 973958)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_28308| (|p#$Mutation_401221| $t2)) 0) (= (|l#Vec_28308| (|p#$Mutation_401221| $t9)) 0)) (and (= (|l#Vec_28308| (|p#$Mutation_197257| $t10)) 0) (= (ControlFlow 0 973348) 973338))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 1281294) 973348) anon0_correct)))
