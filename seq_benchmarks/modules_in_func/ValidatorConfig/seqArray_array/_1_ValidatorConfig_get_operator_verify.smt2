...
(assert (not
 (=> (= (ControlFlow 0 0) 104215) (let ((anon19_Else_correct@@1  (=> (and (and (not $t17) (|$IsValid'address'| $t16@@0)) (and (= $t16@@0 (|Select__T@[Int]Int_| (|v#Vec_15835| (|$vec#$1_Option_Option'address'| $t15@0@@0)) 0)) (= $t16@@0 $t16@@0))) (and (=> (= (ControlFlow 0 88771) (- 0 104783)) (not (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)))) 0))))) (=> (not (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)))) 0)))) (and (=> (= (ControlFlow 0 88771) (- 0 104794)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5))) (=> (= (ControlFlow 0 88771) (- 0 104805)) (= $t16@@0 (let ((t_ref@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)))
(|Select__T@[Int]Int_| (|v#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0))) 0)))))))))))
(let ((L5_correct@@0  (and (=> (= (ControlFlow 0 88597) (- 0 104708)) (or (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)))) (=> (or (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5))) (=> (= (ControlFlow 0 88597) (- 0 104722)) (or (and (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)))) 0))) (= 7 $t9@0@@1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)) (= 5 $t9@0@@1))))))))
(let ((anon19_Then_correct@@1  (=> $t17 (=> (and (and (and (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| $t15@0@@0)) 0) (= 7 $t9@@2)) (= $t9@@2 $t9@@2)) (and (= $t9@0@@1 $t9@@2) (= (ControlFlow 0 88795) 88597))) L5_correct@@0))))
(let ((anon18_Then_correct@@1  (=> $t12@@1 (=> (and (= $t15@0@@0 (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $t10@1@@0)) (= $t17 (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| $t15@0@@0)) 0))) (and (=> (= (ControlFlow 0 88707) 88795) anon19_Then_correct@@1) (=> (= (ControlFlow 0 88707) 88771) anon19_Else_correct@@1))))))
(let ((anon18_Else_correct@@1  (=> (and (and (not $t12@@1) (= $t14@@1 $t14@@1)) (and (= $t9@0@@1 $t14@@1) (= (ControlFlow 0 88691) 88597))) L5_correct@@0)))
(let ((anon17_Else_correct@@1  (=> (not $abort_flag@0@@3) (=> (and (and (and (= $t10@1@@0 $t10@1@@0) (= $t11@0@@1 (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $t10@1@@0))) (and (= $t12@@1  (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| $t11@0@@1)) 0))) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14@@1) (= $t14@@1 7)) (and (= $t14@@1 $t14@@1) (= $t12@@1 $t12@@1)))) (and (=> (= (ControlFlow 0 88675) 88707) anon18_Then_correct@@1) (=> (= (ControlFlow 0 88675) 88691) anon18_Else_correct@@1))))))
(let ((anon17_Then_correct@@1  (=> (and (and $abort_flag@0@@3 (= $abort_code@1@@3 $abort_code@1@@3)) (and (= $t9@0@@1 $abort_code@1@@3) (= (ControlFlow 0 88809) 88597))) L5_correct@@0)))
(let ((anon16_Then$1_correct  (=> (= $t10@1@@0 $t10@@1) (=> (and (= $abort_flag@0@@3 true) (= $abort_code@1@@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 88861) 88809) anon17_Then_correct@@1) (=> (= (ControlFlow 0 88861) 88675) anon17_Else_correct@@1))))))
(let ((anon16_Then_correct@@0  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)) (= (ControlFlow 0 88859) 88861)) anon16_Then$1_correct)))
(let ((anon16_Else_correct@@0  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5) (=> (and (and (= $t10@0@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)) (= $t10@1@@0 $t10@0@@1)) (and (= $abort_flag@0@@3 false) (= $abort_code@1@@3 $abort_code@0@@3))) (and (=> (= (ControlFlow 0 88615) 88809) anon17_Then_correct@@1) (=> (= (ControlFlow 0 88615) 88675) anon17_Else_correct@@1))))))
(let ((anon15_Then_correct  (=> $t6@0@@0 (and (=> (= (ControlFlow 0 88601) 88859) anon16_Then_correct@@0) (=> (= (ControlFlow 0 88601) 88615) anon16_Else_correct@@0)))))
(let ((anon15_Else_correct  (=> (and (and (not $t6@0@@0) (= $t8@@1 $t8@@1)) (and (= $t9@0@@1 $t8@@1) (= (ControlFlow 0 88537) 88597))) L5_correct@@0)))
(let ((anon0$1_correct@@5  (=> (forall ((addr@@77 Int) ) (!  (=> (|$IsValid'address'| addr@@77) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@77) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@77) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@77)) 3))))
 :qid |ValidatorConfigbpl.4356:20|
 :skolemid |174|
)) (=> (and (and (forall ((addr@@78 Int) ) (!  (=> (|$IsValid'address'| addr@@78) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@78) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@78) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@78)) 3))))
 :qid |ValidatorConfigbpl.4360:20|
 :skolemid |175|
)) (forall ((addr@@79 Int) ) (!  (=> (|$IsValid'address'| addr@@79) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@79) (not (= (|l#Vec_34709| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@79)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@79) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@79)) 3))))
 :qid |ValidatorConfigbpl.4364:20|
 :skolemid |176|
))) (and (forall ((addr@@80 Int) ) (!  (=> (|$IsValid'address'| addr@@80) (= (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@80)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@80) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@80)) 3))))
 :qid |ValidatorConfigbpl.4368:20|
 :skolemid |177|
)) (|$IsValid'address'| _$t0@@5))) (=> (and (and (and (forall (($a_0@@6 Int) ) (! (let (($rsc@@6 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@6)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@6) (and (<= (|l#Vec_34709| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@6))) 1) (<= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@6))) 1))))
 :qid |ValidatorConfigbpl.4375:20|
 :skolemid |178|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@6))
)) (= _$t0@@5 _$t0@@5)) (and (= $t6@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@5)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t8@@1) (= $t8@@1 5)) (and (= $t8@@1 $t8@@1) (= $t6@0@@0 $t6@0@@0)))) (and (=> (= (ControlFlow 0 88521) 88601) anon15_Then_correct) (=> (= (ControlFlow 0 88521) 88537) anon15_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@5  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@7 T@$1_Event_EventHandle) ) (! (let ((stream@@6 (|Select__T@[$1_Event_EventHandle]Multiset_34623_| (|streams#$EventStore| $es) handle@@7)))
 (and (= (|l#Multiset_34623| stream@@6) 0) (forall ((v@@42 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_34623| stream@@6) v@@42) 0)
 :qid |ValidatorConfigbpl.159:13|
 :skolemid |4|
))))
 :qid |ValidatorConfigbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 88313) 88521)) anon0$1_correct@@5)))
(let ((anon0_correct@@5  (=> (= (ControlFlow 0 104215) 88313) inline$$InitEventStore$0$anon0_correct@@5)))
anon0_correct@@5))))))))))))))))
))
(check-sat)
(pop 1)
