...
(let ((L3_correct  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 1578342) (- 0 2232348)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_468705| $1_DiemAccount_DiemAccount_$memory) addr@@0)))))
 ...
 :qid |DiemAccountbpl.70880:15|
 :skolemid |2703|
)) (=> (= (ControlFlow 0 1578342) (- 0 2232384)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2) (>= (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2))) (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_596570| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2))))))
 :qid |DiemAccountbpl.70885:15|
 :skolemid |2704|
))))))))
(let ((anon11_Else_correct  (=> (and (and (not $abort_flag@0) (= |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1| |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1|)) (and (= $t1@0 |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1|) (= (ControlFlow 0 1578840) 1578342))) L3_correct)))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$L2_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 |inline$$1_VASP_has_account_limits'#0'$0$$t3@1|) (= |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1| |inline$$1_VASP_has_account_limits'#0'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 1578778) 1578854) anon11_Then_correct) (=> (= (ControlFlow 0 1578778) 1578840) anon11_Else_correct))))))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon5_Then_correct|  (=> |inline$$1_VASP_has_account_limits'#0'$0$$t2@0| (=> (and (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469420| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469520| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 |inline$$1_VASP_has_account_limits'#0'$0$$t3@0|)) (= |inline$$1_VASP_has_account_limits'#0'$0$$t3@0| |inline$$1_VASP_has_account_limits'#0'$0$$t3@0|)) (and (= |inline$$1_VASP_has_account_limits'#0'$0$$t3@1| |inline$$1_VASP_has_account_limits'#0'$0$$t3@0|) (= (ControlFlow 0 1578816) 1578778))) |inline$$1_VASP_has_account_limits'#0'$0$L2_correct|))))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon6_Else_correct|  (=> (not false) (=> (and (and (= |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1|) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1| |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1|))) (and (=> (= (ControlFlow 0 1578758) 1578854) anon11_Then_correct) (=> (= (ControlFlow 0 1578758) 1578840) anon11_Else_correct))))))
(let ((|inline$$1_AccountLimits_has_window_published'#0'$1$anon0_correct|  (=> (= |inline$$1_VASP_has_account_limits'#0'$0$$t1@0| |inline$$1_VASP_has_account_limits'#0'$0$$t1@0|) (=> (and (= |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_525805| |$1_AccountLimits_Window'#0'_$memory|) |inline$$1_VASP_has_account_limits'#0'$0$$t1@0|)) (= |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1|)) (and (=> (= (ControlFlow 0 1578734) 1578772) |inline$$1_VASP_has_account_limits'#0'$0$anon6_Then_correct|) (=> (= (ControlFlow 0 1578734) 1578758) |inline$$1_VASP_has_account_limits'#0'$0$anon6_Else_correct|))))))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon5_Else_correct|  (=> (and (and (not |inline$$1_VASP_has_account_limits'#0'$0$$t2@0|) (|$IsValid'address'| |inline$$1_VASP_has_account_limits'#0'$0$$t1@0|)) (and (= |inline$$1_VASP_has_account_limits'#0'$0$$t1@0| (ite (|Select__T@[Int]Bool_| (|domain#$Memory_469420| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_469520| $1_VASP_ChildVASP_$memory) _$t0)))) (= (ControlFlow 0 1578740) 1578734))) |inline$$1_AccountLimits_has_window_published'#0'$1$anon0_correct|)))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon0_correct|  (=> (and (= _$t0 _$t0) (= |inline$$1_VASP_has_account_limits'#0'$0$$t2@0|  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469420| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469520| $1_VASP_ChildVASP_$memory) _$t0))))) (and (=> (= (ControlFlow 0 1578615) 1578816) |inline$$1_VASP_has_account_limits'#0'$0$anon5_Then_correct|) (=> (= (ControlFlow 0 1578615) 1578740) |inline$$1_VASP_has_account_limits'#0'$0$anon5_Else_correct|)))))
(let ((anon10_Then_correct  (=> (and $t2 (= (ControlFlow 0 1578822) 1578615)) |inline$$1_VASP_has_account_limits'#0'$0$anon0_correct|)))
(let ((anon12_Else_correct  (=> (and (and (not false) (= |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1|)) (and (= $t1@0 |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1|) (= (ControlFlow 0 1578252) 1578342))) L3_correct)))
(let ((anon12_Then_correct true))
(let ((|inline$$1_AccountLimits_has_window_published'#0'$0$anon0_correct|  (=> (= _$t0 _$t0) (=> (and (= |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_525805| |$1_AccountLimits_Window'#0'_$memory|) _$t0)) (= |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1578228) 1578356) anon12_Then_correct) (=> (= (ControlFlow 0 1578228) 1578252) anon12_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (not $t2) (= (ControlFlow 0 1578234) 1578228)) |inline$$1_AccountLimits_has_window_published'#0'$0$anon0_correct|)))
(let ((anon0$1_correct  (=> (and (and (forall ((window_addr Int) ) (!  (=> (|$IsValid'address'| window_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_525677| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_525873| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_525677| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr)))))
 :qid |DiemAccountbpl.70759:22|
 :skolemid |2691|
 ...
 :qid |DiemAccountbpl.70767:20|
 :skolemid |2697|
))) (and (and (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469420| $1_VASP_ParentVASP_$memory) addr@@6) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@6)) 5))))
 :qid |DiemAccountbpl.70771:20|
 :skolemid |2698|
)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469520| $1_VASP_ChildVASP_$memory) addr@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@7)) 6))))
 :qid |DiemAccountbpl.70775:20|
 :skolemid |2699|
))) (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_525805| |$1_AccountLimits_Window'#0'_$memory|) $a_0)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc))
 :qid |DiemAccountbpl.70781:20|
 :skolemid |2700|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_525805| |$1_AccountLimits_Window'#0'_$memory|) $a_0))
)))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_469520| $1_VASP_ChildVASP_$memory) $a_0@@0)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc@@0))
 :qid |DiemAccountbpl.70785:20|
 :skolemid |2701|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_469520| $1_VASP_ChildVASP_$memory) $a_0@@0))
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_469420| $1_VASP_ParentVASP_$memory) $a_0@@1)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@1))
 :qid |DiemAccountbpl.70789:20|
 :skolemid |2702|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_469420| $1_VASP_ParentVASP_$memory) $a_0@@1))
))) (and (= _$t0 _$t0) (= $t2  (or (|Select__T@[Int]Bool_| (|domain#$Memory_469420| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_469520| $1_VASP_ChildVASP_$memory) _$t0))))))) (and (=> (= (ControlFlow 0 1578125) 1578822) anon10_Then_correct) (=> (= (ControlFlow 0 1578125) 1578234) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1577690) 1578125)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2231495) 1577690) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
