...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 270770) (let ((anon11_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 199005) (- 0 271073))) false))))
(let ((L3_correct  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 198933) (- 0 271133)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 198933) (- 0 271140)) (= $t1@0  (and (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (not (= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))))) (=> (= $t1@0  (and (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (not (= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0)))) (=> (= (ControlFlow 0 198933) (- 0 271151)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1))))))
 :qid |ValidatorConfigbpl.7640:15|
 :skolemid |234|
))))))))))
(let ((anon11_Else_correct  (=> (and (not $abort_flag@0) (= $t5@0 (|$config#$1_ValidatorConfig_ValidatorConfig| $t3@1))) (=> (and (and (= $t6  (not (= (|l#Vec_77870| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t5@0)) 0))) (= $t6 $t6)) (and (= $t1@0 $t6) (= (ControlFlow 0 198983) 198933))) L3_correct))))
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 199057) 199005) anon11_Then_correct) (=> (= (ControlFlow 0 199057) 198983) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (ControlFlow 0 199055) 199057)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= $t3@1 $t3@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 198951) 199005) anon11_Then_correct) (=> (= (ControlFlow 0 198951) 198983) anon11_Else_correct))))))
(let ((anon9_Then_correct  (=> $t2@0 (and (=> (= (ControlFlow 0 198937) 199055) anon10_Then_correct) (=> (= (ControlFlow 0 198937) 198951) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (and (not $t2@0) (= false false)) (and (= $t1@0 false) (= (ControlFlow 0 198866) 198933))) L3_correct)))
...
))) (and (= _$t0 _$t0) (= $t2@0 (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) (and (=> (= (ControlFlow 0 198846) 198937) anon9_Then_correct) (=> (= (ControlFlow 0 198846) 198866) anon9_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_77784_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 198689) 198846)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 270770) 198689) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
