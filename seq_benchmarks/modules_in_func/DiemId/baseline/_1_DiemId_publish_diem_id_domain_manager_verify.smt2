...
(declare-fun $1_DiemId_DiemIdDomainManager_$memory@1 () T@$Memory_144697)
(declare-fun $t6@0 () Int)
(declare-fun $abort_code@1 () Int)
(declare-fun $1_DiemId_DiemIdDomainManager_$memory@0 () T@$Memory_144697)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 241154) (let ((anon18_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 176374) (- 0 241820)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 176374) (- 0 241832)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 176374) (- 0 241850)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 176374) (- 0 241864)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 176374) (- 0 241872)) (|Select__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory@1) (|$addr#$signer| _$t0))))))))))))))
(let ((anon16_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 176178) (- 0 241702)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 176178) (- 0 241740)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) 186537453) (= 6 $t6@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 176388) 176178))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $1_DiemId_DiemIdDomainManager_$memory@1 $1_DiemId_DiemIdDomainManager_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 176440) 176388) anon18_Then_correct) (=> (= (ControlFlow 0 176440) 176374) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 176438) 176440)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_DiemId_DiemIdDomainManager_$memory@0 ($Memory_144697 (|Store__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0) $t13@0))) (= $1_DiemId_DiemIdDomainManager_$memory@1 $1_DiemId_DiemIdDomainManager_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 176302) 176388) anon18_Then_correct) (=> (= (ControlFlow 0 176302) 176374) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not false) (= $t13@0 ($1_DiemId_DiemIdDomainManager |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 176280) (- 0 241597)) (|Select__T@[Int]Bool_| $1_DiemId_DiemIdDomainManager_$modifies (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| $1_DiemId_DiemIdDomainManager_$modifies (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 176280) 176438) anon17_Then_correct) (=> (= (ControlFlow 0 176280) 176302) anon17_Else_correct)))))))
(let ((|inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 176250) 176454) anon16_Then_correct) (=> (= (ControlFlow 0 176250) 176280) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 176256) 176250)) |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|)))
(let ((anon15_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t11 $t11)) (and (= $t6@0 $t11) (= (ControlFlow 0 176054) 176178))) L3_correct)))
(let ((anon14_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t11) (= $t11 6)) (and (= $t11 $t11) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 176038) 176256) anon15_Then_correct) (=> (= (ControlFlow 0 176038) 176054) anon15_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t8@0)) (= (ControlFlow 0 175998) 176038)) anon14_Else$1_correct)))
(let ((anon14_Else_correct  (=> (not $t5) (=> (and (and (|$IsValid'address'| $t7) (= $t7 (|$addr#$signer| _$t0))) (and (= $t8@0 (|Select__T@[Int]Bool_| (|domain#$Memory_144697| $1_DiemId_DiemIdDomainManager_$memory) $t7)) (= (ControlFlow 0 176004) 175998))) inline$$Not$0$anon0_correct))))
(let ((anon14_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_110256| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_110256| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6))) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 176526) 176178))) L3_correct))))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_71640_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemIdbpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 175794) 175942)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 241154) 175794) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
