...
(assert (not
 (=> (= (ControlFlow 0 0) 104137) (let ((anon0$1_correct@@4  (=> (|$IsValid'$1_ValidatorConfig_Config'| _$t0@@4) (=> (and (and (= _$t0@@4 _$t0@@4) (= $t1@0@@0 (|$consensus_pubkey#$1_ValidatorConfig_Config| _$t0@@4))) (and (= $t1@0@@0 $t1@0@@0) (= (ControlFlow 0 88242) (- 0 104200)))) (not false)))))
(let ((inline$$InitEventStore$0$anon0_correct@@4  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@6 T@$1_Event_EventHandle) ) (! (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_34623_| (|streams#$EventStore| $es) handle@@6)))
 (and (= (|l#Multiset_34623| stream@@5) 0) (forall ((v@@41 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_34623| stream@@5) v@@41) 0)
 :qid |ValidatorConfigbpl.159:13|
 :skolemid |4|
))))
 :qid |ValidatorConfigbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 88198) 88242)) anon0$1_correct@@4)))
(let ((anon0_correct@@4  (=> (= (ControlFlow 0 104137) 88198) inline$$InitEventStore$0$anon0_correct@@4)))
anon0_correct@@4))))
))
(check-sat)
(pop 1)
