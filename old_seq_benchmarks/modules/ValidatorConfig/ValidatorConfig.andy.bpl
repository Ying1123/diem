...
procedure {:timeLimit 40} $1_Roles_grant_role$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // @96 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/Roles.move:180:9+30
...
L0:
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/Roles.move:162:5+199
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/Roles.move:162:5+199
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:342:9+112
    assume {:print "$at(36,14787,14899)"} true;
    assert {:msg "assert_failed(36,14787,14899): global memory invariant does not hold"}
    ...
    // assert forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:347:9+112
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:347:9+112
    assume {:print "$at(36,15128,15240)"} true;
    assert {:msg "assert_failed(36,15128,15240): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assert forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:354:9+107
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:354:9+107
    assume {:print "$at(36,15574,15681)"} true;
    assert {:msg "assert_failed(36,15574,15681): global memory invariant does not hold"}
...
L2:
    ...
    // assert Not(exists[@96]<Roles::RoleId>(Signer::$address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/Roles.move:177:9+62
...
L3:
    ...
    // assert exists[@96]<Roles::RoleId>(Signer::$address_of[]($t0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:166:5+369
    assume {:print "$at(26,7054,7423)"} true;
    assert {:msg "assert_failed(26,7054,7423): abort not covered by any of the `aborts_if` clauses"}
      $ResourceExists($1_Roles_RoleId_$memory#96, $1_Signer_$address_of($t0));

    // assert And(exists[@96]<Roles::RoleId>(Signer::$address_of[]($t0)), Eq(6, $t10)) at /home/ying/diem/language/diem-framework/modules/Roles.move:166:5+369
...
// spec fun at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:261:5+259
...
// spec fun at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:276:5+379
...
// spec fun at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:255:10+111
...
// spec fun at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:361:10+122
...
// fun ValidatorConfig::get_human_name [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:261:5+259
procedure {:timeLimit 40} $1_ValidatorConfig_get_human_name$verify(_$t0: int) returns ($ret0: Vec (int))
{
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:261:5+259
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:342:9+112
    assume {:print "$at(36,11816,12075)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:261:5+259
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:354:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:270:17+6
    assume {:print "$at(36,12185,12191)"} true;
    assume $IsValid'address'($t0);
    ...
    // @94 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:261:5+1
    assume {:print "$at(36,11816,11817)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#94 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:261:5+1
    assume {:print "$track_local(9,3,0):", $t0} $t0 == $t0;

    // $t4 := exists<ValidatorConfig::ValidatorConfig>($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:16+6
    assume {:print "$at(36,11911,11917)"} true;
    $t4 := $ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0);

    // $t5 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:69+17
    $t5 := 0;
    assume $IsValid'u64'($t5);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:47+40
    // >> opaque call: $t6 := Errors::not_published($t5)

    // $t6 := opaque begin: Errors::not_published($t5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:47+40

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:47+40
    assume $IsValid'u64'($t6);

    // assume Eq<u64>($t6, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:47+40
    assume $IsEqual'u64'($t6, 5);

    // $t6 := opaque end: Errors::not_published($t5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:47+40

    // trace_local[tmp#$3]($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:9+79
    assume {:print "$track_local(9,3,3):", $t6} $t6 == $t6;

    // trace_local[tmp#$2]($t4) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:9+79
    assume {:print "$track_local(9,3,2):", $t4} $t4 == $t4;

    // if ($t4) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:9+79
    if ($t4) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:9+79
L1:

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:9+79
    assume {:print "$at(36,11904,11983)"} true;
    assume {:print "$track_abort(9,3):", $t6} $t6 == $t6;

    // $t7 := move($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:9+79
    $t7 := $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:262:9+79
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:263:52+4
    assume {:print "$at(36,12036,12040)"} true;
L0:

    // $t8 := get_global<ValidatorConfig::ValidatorConfig>($t0) on_abort goto L3 with $t7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:263:21+13
    ...
    if ($abort_flag) {
        assume {:print "$at(36,12005,12018)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(9,3):", $t7} $t7 == $t7;
        goto L3;
    }

    // trace_local[t_ref]($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:263:13+5
    assume {:print "$track_local(9,3,1):", $t8} $t8 == $t8;

    // $t9 := get_field<ValidatorConfig::ValidatorConfig>.human_name($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:264:10+17
    assume {:print "$at(36,12052,12069)"} true;
    $t9 := $human_name#$1_ValidatorConfig_ValidatorConfig($t8);

    // trace_return[0]($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:264:9+18
    assume {:print "$track_return(9,3,0):", $t9} $t9 == $t9;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:5+1
    assume {:print "$at(36,12074,12075)"} true;
L2:

    // assert Not(Not(ValidatorConfig::$exists_config[@94]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:89:9+58
    assume {:print "$at(36,3508,3566)"} true;
    assert {:msg "assert_failed(36,3508,3566): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#94, $t0);

    // assert Eq<vector<u8>>($t9, ValidatorConfig::$get_human_name($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:270:9+39
    assume {:print "$at(36,12177,12216)"} true;
    assert {:msg "assert_failed(36,12177,12216): post-condition does not hold"}
    ...
    assume {:print "$at(36,14114,14303)"} true;
    assert {:msg "assert_failed(36,14114,14303): post-condition does not hold"}
    ...
    // return $t9 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:324:9+189
    $ret0 := $t9;
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:265:5+1
    assume {:print "$at(36,12074,12075)"} true;
L3:

    // assert Not(ValidatorConfig::$exists_config[@94]($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:267:5+141
    assume {:print "$at(36,12081,12222)"} true;
    assert {:msg "assert_failed(36,12081,12222): abort not covered by any of the `aborts_if` clauses"}
      !$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#94, $t0);

    // assert And(Not(ValidatorConfig::$exists_config[@94]($t0)), Eq(5, $t7)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:267:5+141
    assert {:msg "assert_failed(36,12081,12222): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#94, $t0) && $IsEqual'u8'(5, $t7));

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:267:5+141
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::publish [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+602
procedure {:timeLimit 40} $1_ValidatorConfig_publish$verify(_$t0: int, _$t1: int, _$t2: Vec (int)) returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(a550c18)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+602
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(36,2026,2628)"} true;
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorOperatorConfig::$has_validator_operator_config(addr): Roles::spec_has_validator_operator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+602
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+602
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:342:9+112
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+602
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:354:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+602
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+602
    assume $IsValid'address'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+602
    assume $IsValid'vec'u8''($t2);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+602
    ...
    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+602
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));
    ...
    // @136 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+1
    ...
    // @137 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+1
    $1_Roles_RoleId_$memory#137 := $1_Roles_RoleId_$memory;

    // @135 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+1
...
L7:
    ...
    assume ((((!$IsEqual'address'($1_Signer_spec_address_of($t1), 173345816) && $IsEqual'u8'(2, $t7)) || (!$ResourceExists($1_Roles_RoleId_$memory, $t8) && $IsEqual'u8'(5, $t7))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t8)), 0) && $IsEqual'u8'(3, $t7))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 173345816) && $IsEqual'u8'(2, $t7)));
...
L0:
    ...
    // @243 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:47:5+602
    ...
    // assert forall validator: TypeDomain<address>() where ValidatorConfig::$is_valid[@243](validator): ValidatorConfig::$is_valid(validator) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:333:9+107
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:333:9+107
    assume {:print "$at(36,14514,14621)"} true;
    assert {:msg "assert_failed(36,14514,14621): global memory invariant does not hold"}
...
L2:
    ...
    // assert Not(ValidatorConfig::$exists_config[@135](Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:77:9+83
    assume {:print "$at(36,3123,3206)"} true;
    assert {:msg "assert_failed(36,3123,3206): function does not abort under this condition"}
      !$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#135, $1_Signer_spec_address_of($t0));

    // assert Not(Not(DiemTimestamp::$is_operating[@136]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
    ...
    // assert Not(Not(exists[@137]<Roles::RoleId>($t5))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>($t5)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    ...
    // assert Not(Not(exists[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/Roles.move:578:9+69
    assume {:print "$at(26,25793,25862)"} true;
    assert {:msg "assert_failed(26,25793,25862): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0));

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0))), 3)) at /home/ying/diem/language/diem-framework/modules/Roles.move:579:9+97
    assume {:print "$at(26,25871,25968)"} true;
    assert {:msg "assert_failed(26,25871,25968): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0))), 3);

    // assert ValidatorConfig::$exists_config(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:68:9+66
    assume {:print "$at(36,2751,2817)"} true;
    assert {:msg "assert_failed(36,2751,2817): post-condition does not hold"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:324:9+189
    return;
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(ValidatorConfig::$exists_config[@135](Signer::spec_address_of[]($t0)), Not(DiemTimestamp::$is_operating[@136]())), Not(exists[@137]<Roles::RoleId>($t5))), Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>($t5)), 0)), Neq<address>(Signer::spec_address_of[]($t1), a550c18)), Not(exists[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0)))), Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0))), 3)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:66:5+189
    assume {:print "$at(36,2634,2823)"} true;
    assert {:msg "assert_failed(36,2634,2823): abort not covered by any of the `aborts_if` clauses"}
      (((((($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#135, $1_Signer_spec_address_of($t0)) || !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#136)) || !$ResourceExists($1_Roles_RoleId_$memory#137, $t5)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $t5)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), 173345816)) || !$ResourceExists($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0))) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0))), 3));

    // assert Or(Or(Or(Or(Or(Or(And(ValidatorConfig::$exists_config[@135](Signer::spec_address_of[]($t0)), Eq(6, $t7)), And(Not(DiemTimestamp::$is_operating[@136]()), Eq(1, $t7))), And(Not(exists[@137]<Roles::RoleId>($t5)), Eq(5, $t7))), And(Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>($t5)), 0), Eq(3, $t7))), And(Neq<address>(Signer::spec_address_of[]($t1), a550c18), Eq(2, $t7))), And(Not(exists[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0))), Eq(5, $t7))), And(Neq<u64>(select Roles::RoleId.role_id(global[@137]<Roles::RoleId>(Signer::spec_address_of[]($t0))), 3), Eq(3, $t7))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:66:5+189
    assert {:msg "assert_failed(36,2634,2823): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#135, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(6, $t7)) || (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#136) && $IsEqual'u8'(1, $t7))) || (!$ResourceExists($1_Roles_RoleId_$memory#137, $t5) && $IsEqual'u8'(5, $t7))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $t5)), 0) && $IsEqual'u8'(3, $t7))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 173345816) && $IsEqual'u8'(2, $t7))) || (!$ResourceExists($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(5, $t7))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0))), 3) && $IsEqual'u8'(3, $t7)));

    // abort($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:66:5+189
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::exists_config [baseline] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:82:5+84
procedure {:inline 1} $1_ValidatorConfig_exists_config(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:82:5+1
    assume {:print "$at(36,3288,3289)"} true;
    assume {:print "$track_local(9,0,0):", $t0} $t0 == $t0;

    // $t1 := exists<ValidatorConfig::ValidatorConfig>($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:83:9+6
    assume {:print "$at(36,3337,3343)"} true;
    $t1 := $ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:83:9+29
    assume {:print "$track_return(9,0,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:84:5+1
    assume {:print "$at(36,3371,3372)"} true;
L1:

    // return $t1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:84:5+1
    $ret0 := $t1;
    return;

}

// fun ValidatorConfig::exists_config [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:82:5+84
procedure {:timeLimit 40} $1_ValidatorConfig_exists_config$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:82:5+84
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:342:9+112
    assume {:print "$at(36,3288,3372)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:82:5+84
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:354:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:82:5+84
    assume $IsValid'address'($t0);
    ...
    // @92 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:82:5+1
...
L1:
    ...
    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:84:5+1
    assert {:msg "assert_failed(36,3371,3372): function does not abort under this condition"}
      !false;
    ...
    // return $t1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:324:9+189
    $ret0 := $t1;
    return;

}

// fun ValidatorConfig::get_config [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:240:5+341
procedure {:timeLimit 40} $1_ValidatorConfig_get_config$verify(_$t0: int) returns ($ret0: $1_ValidatorConfig_Config)
{
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:240:5+341
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:342:9+112
    assume {:print "$at(36,10953,11294)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:240:5+341
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:354:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:251:17+6
    assume {:print "$at(36,11503,11509)"} true;
    assume $IsValid'address'($t0);
    ...
    // @130 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:240:5+1
    assume {:print "$at(36,10953,10954)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#130 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:240:5+1
    assume {:print "$track_local(9,1,0):", $t0} $t0 == $t0;

    // $t6 := ValidatorConfig::exists_config($t0) on_abort goto L5 with $t7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:16+19
    assume {:print "$at(36,11040,11059)"} true;
    ...
    // $t8 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:59+17
    $t8 := 0;
    assume $IsValid'u64'($t8);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:37+40
    // >> opaque call: $t8 := Errors::not_published($t7)

    // $t9 := opaque begin: Errors::not_published($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:37+40

    // assume WellFormed($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:37+40
    assume $IsValid'u64'($t9);

    // assume Eq<u64>($t9, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:37+40
    assume $IsEqual'u64'($t9, 5);

    // $t9 := opaque end: Errors::not_published($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:37+40

    // trace_local[tmp#$3]($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:9+69
    assume {:print "$track_local(9,1,3):", $t9} $t9 == $t9;

    // trace_local[tmp#$2]($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:9+69
    assume {:print "$track_local(9,1,2):", $t6} $t6 == $t6;

    // if ($t6) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:9+69
    if ($t6) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:9+69
L1:

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:9+69
    assume {:print "$at(36,11033,11102)"} true;
    assume {:print "$track_abort(9,1):", $t9} $t9 == $t9;

    // $t7 := move($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:9+69
    $t7 := $t9;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:241:9+69
    goto L5;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:242:54+4
    assume {:print "$at(36,11157,11161)"} true;
L0:

    // $t10 := get_global<ValidatorConfig::ValidatorConfig>($t0) on_abort goto L5 with $t7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:242:23+13
    if (!$ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
    ...
    if ($abort_flag) {
        assume {:print "$at(36,11126,11139)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(9,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t11 := get_field<ValidatorConfig::ValidatorConfig>.config($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:242:22+44
    $t11 := $config#$1_ValidatorConfig_ValidatorConfig($t10);

    // trace_local[config]($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:242:13+6
    assume {:print "$track_local(9,1,1):", $t11} $t11 == $t11;

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:16+23
    // >> opaque call: $t11 := Option::is_some<ValidatorConfig::Config>($t10)
    assume {:print "$at(36,11186,11209)"} true;

    // $t12 := opaque begin: Option::is_some<ValidatorConfig::Config>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:16+23

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:16+23
    assume $IsValid'bool'($t12);

    // assume Eq<bool>($t12, Option::$is_some<ValidatorConfig::Config>($t11)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:16+23
    assume $IsEqual'bool'($t12, $1_Option_$is_some'$1_ValidatorConfig_Config'($t11));

    // $t12 := opaque end: Option::is_some<ValidatorConfig::Config>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:16+23

    // $t13 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:66+17
    $t13 := 0;
    assume $IsValid'u64'($t13);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:41+43
    // >> opaque call: $t13 := Errors::invalid_argument($t12)

    // $t14 := opaque begin: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:41+43

    // assume WellFormed($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:41+43
    assume $IsValid'u64'($t14);

    // assume Eq<u64>($t14, 7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:41+43
    assume $IsEqual'u64'($t14, 7);

    // $t14 := opaque end: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:41+43

    // trace_local[tmp#$5]($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:9+76
    assume {:print "$track_local(9,1,5):", $t14} $t14 == $t14;

    // trace_local[tmp#$4]($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:9+76
    assume {:print "$track_local(9,1,4):", $t12} $t12 == $t12;

    // if ($t12) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:9+76
    if ($t12) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:9+76
L3:

    // destroy($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:9+76

    // trace_abort($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:9+76
    assume {:print "$at(36,11179,11255)"} true;
    assume {:print "$track_abort(9,1):", $t14} $t14 == $t14;

    // $t7 := move($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:9+76
    $t7 := $t14;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:243:9+76
    goto L5;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:25+6
    assume {:print "$at(36,11281,11287)"} true;
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22
    // >> opaque call: $t14 := Option::borrow<ValidatorConfig::Config>($t10)

    // $t15 := opaque begin: Option::borrow<ValidatorConfig::Config>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22

    // assume Identical($t16, Option::$is_none<ValidatorConfig::Config>($t11)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22
    assume ($t16 == $1_Option_$is_none'$1_ValidatorConfig_Config'($t11));

    // if ($t16) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22
    if ($t16) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22
L7:

    // assume And(Option::$is_none<ValidatorConfig::Config>($t11), Eq(7, $t7)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22
    assume ($1_Option_$is_none'$1_ValidatorConfig_Config'($t11) && $IsEqual'u8'(7, $t7));

    // trace_abort($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22
    assume {:print "$at(36,11266,11288)"} true;
    assume {:print "$track_abort(9,1):", $t7} $t7 == $t7;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22
L6:

    // assume WellFormed($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22
    assume $IsValid'$1_ValidatorConfig_Config'($t15);

    // assume Eq<ValidatorConfig::Config>($t15, Option::$borrow<ValidatorConfig::Config>($t11)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22
    assume $IsEqual'$1_ValidatorConfig_Config'($t15, $1_Option_$borrow'$1_ValidatorConfig_Config'($t11));

    // $t15 := opaque end: Option::borrow<ValidatorConfig::Config>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:10+22

    // trace_return[0]($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:244:9+23
    assume {:print "$track_return(9,1,0):", $t15} $t15 == $t15;

    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:245:5+1
    assume {:print "$at(36,11293,11294)"} true;
L4:

    // assert Not(Not(ValidatorConfig::$exists_config[@130]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:89:9+58
    assume {:print "$at(36,3508,3566)"} true;
    assert {:msg "assert_failed(36,3508,3566): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#130, $t0);

    // assert Not(Option::$is_none[]<ValidatorConfig::Config>(select ValidatorConfig::ValidatorConfig.config(global[@130]<ValidatorConfig::ValidatorConfig>($t0)))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:250:9+94
    assume {:print "$at(36,11392,11486)"} true;
    assert {:msg "assert_failed(36,11392,11486): function does not abort under this condition"}
    ...
    // assert Eq<ValidatorConfig::Config>($t15, ValidatorConfig::spec_get_config($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:251:9+40
    assume {:print "$at(36,11495,11535)"} true;
    assert {:msg "assert_failed(36,11495,11535): post-condition does not hold"}
    ...
    // return $t15 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:324:9+189
    $ret0 := $t15;
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:245:5+1
    assume {:print "$at(36,11293,11294)"} true;
L5:

    // assert Or(Not(ValidatorConfig::$exists_config[@130]($t0)), Option::$is_none[]<ValidatorConfig::Config>(select ValidatorConfig::ValidatorConfig.config(global[@130]<ValidatorConfig::ValidatorConfig>($t0)))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:5+241
    assume {:print "$at(36,11300,11541)"} true;
    assert {:msg "assert_failed(36,11300,11541): abort not covered by any of the `aborts_if` clauses"}
    ...
    // assert Or(And(Not(ValidatorConfig::$exists_config[@130]($t0)), Eq(5, $t7)), And(Option::$is_none[]<ValidatorConfig::Config>(select ValidatorConfig::ValidatorConfig.config(global[@130]<ValidatorConfig::ValidatorConfig>($t0))), Eq(7, $t7))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:5+241
    assert {:msg "assert_failed(36,11300,11541): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:247:5+241
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::get_consensus_pubkey [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:297:5+110
procedure {:timeLimit 40} $1_ValidatorConfig_get_consensus_pubkey$verify(_$t0: $1_ValidatorConfig_Config) returns ($ret0: Vec (int))
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:297:5+110
    assume {:print "$at(36,13127,13237)"} true;
    assume $IsValid'$1_ValidatorConfig_Config'($t0);

    // @91 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:297:5+1
    $1_ValidatorConfig_ValidatorConfig_$memory#91 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[config_ref]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:297:5+1
    assume {:print "$track_local(9,2,0):", $t0} $t0 == $t0;

    // $t1 := get_field<ValidatorConfig::Config>.consensus_pubkey($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:298:9+28
    assume {:print "$at(36,13203,13231)"} true;
    $t1 := $consensus_pubkey#$1_ValidatorConfig_Config($t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:298:9+28
    assume {:print "$track_return(9,2,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:299:5+1
    assume {:print "$at(36,13236,13237)"} true;
L1:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:299:5+1
    assert {:msg "assert_failed(36,13236,13237): function does not abort under this condition"}
      !false;
...
// fun ValidatorConfig::get_operator [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:276:5+379
procedure {:timeLimit 40} $1_ValidatorConfig_get_operator$verify(_$t0: int) returns ($ret0: int)
{
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:276:5+379
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:342:9+112
    assume {:print "$at(36,12358,12737)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:276:5+379
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:354:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:286:17+6
    assume {:print "$at(36,12839,12845)"} true;
    assume $IsValid'address'($t0);
    ...
    // @129 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:276:5+1
    assume {:print "$at(36,12358,12359)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#129 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:276:5+1
    assume {:print "$track_local(9,4,0):", $t0} $t0 == $t0;

    // $t6 := exists<ValidatorConfig::ValidatorConfig>($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:16+6
    assume {:print "$at(36,12448,12454)"} true;
    $t6 := $ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0);

    // $t7 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:69+17
    $t7 := 0;
    assume $IsValid'u64'($t7);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:47+40
    // >> opaque call: $t8 := Errors::not_published($t7)

    // $t8 := opaque begin: Errors::not_published($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:47+40

    // assume WellFormed($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:47+40
    assume $IsValid'u64'($t8);

    // assume Eq<u64>($t8, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:47+40
    assume $IsEqual'u64'($t8, 5);

    // $t8 := opaque end: Errors::not_published($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:47+40

    // trace_local[tmp#$3]($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:9+79
    assume {:print "$track_local(9,4,3):", $t8} $t8 == $t8;

    // trace_local[tmp#$2]($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:9+79
    assume {:print "$track_local(9,4,2):", $t6} $t6 == $t6;

    // if ($t6) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:9+79
    if ($t6) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:9+79
L1:

    // trace_abort($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:9+79
    assume {:print "$at(36,12441,12520)"} true;
    assume {:print "$track_abort(9,4):", $t8} $t8 == $t8;

    // $t9 := move($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:9+79
    $t9 := $t8;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:277:9+79
    goto L5;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:278:52+4
    assume {:print "$at(36,12573,12577)"} true;
L0:

    // $t10 := get_global<ValidatorConfig::ValidatorConfig>($t0) on_abort goto L5 with $t9 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:278:21+13
    if (!$ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
        $t10 := $ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, $t0);
    ...
    if ($abort_flag) {
        assume {:print "$at(36,12542,12555)"} true;
        $t9 := $abort_code;
        assume {:print "$track_abort(9,4):", $t9} $t9 == $t9;
        goto L5;
    }

    // trace_local[t_ref]($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:278:13+5
    assume {:print "$track_local(9,4,1):", $t10} $t10 == $t10;

    // $t11 := get_field<ValidatorConfig::ValidatorConfig>.operator_account($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:32+23
    assume {:print "$at(36,12611,12634)"} true;
    $t11 := $operator_account#$1_ValidatorConfig_ValidatorConfig($t10);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:16+40
    // >> opaque call: $t11 := Option::is_some<address>($t10)

    // $t12 := opaque begin: Option::is_some<address>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:16+40

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:16+40
    assume $IsValid'bool'($t12);

    // assume Eq<bool>($t12, Option::$is_some<address>($t11)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:16+40
    assume $IsEqual'bool'($t12, $1_Option_$is_some'address'($t11));

    // $t12 := opaque end: Option::is_some<address>($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:16+40

    // $t13 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:83+17
    $t13 := 0;
    assume $IsValid'u64'($t13);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:58+43
    // >> opaque call: $t13 := Errors::invalid_argument($t12)

    // $t14 := opaque begin: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:58+43

    // assume WellFormed($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:58+43
    assume $IsValid'u64'($t14);

    // assume Eq<u64>($t14, 7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:58+43
    assume $IsEqual'u64'($t14, 7);

    // $t14 := opaque end: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:58+43

    // trace_local[tmp#$5]($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:9+93
    assume {:print "$track_local(9,4,5):", $t14} $t14 == $t14;

    // trace_local[tmp#$4]($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:9+93
    assume {:print "$track_local(9,4,4):", $t12} $t12 == $t12;

    // if ($t12) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:9+93
    if ($t12) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:9+93
L3:

    // destroy($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:9+93

    // trace_abort($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:9+93
    assume {:print "$at(36,12588,12681)"} true;
    assume {:print "$track_abort(9,4):", $t14} $t14 == $t14;

    // $t9 := move($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:9+93
    $t9 := $t14;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:279:9+93
    goto L5;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:26+5
    assume {:print "$at(36,12708,12713)"} true;
L2:

    // $t15 := get_field<ValidatorConfig::ValidatorConfig>.operator_account($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:25+23
    $t15 := $operator_account#$1_ValidatorConfig_ValidatorConfig($t10);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39
    // >> opaque call: $t15 := Option::borrow<address>($t14)

    // $t16 := opaque begin: Option::borrow<address>($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39

    // assume Identical($t17, Option::$is_none<address>($t15)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39
    assume ($t17 == $1_Option_$is_none'address'($t15));

    // if ($t17) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39
    if ($t17) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39
L7:

    // assume And(Option::$is_none<address>($t15), Eq(7, $t9)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39
    assume ($1_Option_$is_none'address'($t15) && $IsEqual'u8'(7, $t9));

    // trace_abort($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39
    assume {:print "$at(36,12692,12731)"} true;
    assume {:print "$track_abort(9,4):", $t9} $t9 == $t9;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39
L6:

    // assume WellFormed($t16) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39
    assume $IsValid'address'($t16);

    // assume Eq<address>($t16, Option::$borrow<address>($t15)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39
    assume $IsEqual'address'($t16, $1_Option_$borrow'address'($t15));

    // $t16 := opaque end: Option::borrow<address>($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:10+39

    // trace_return[0]($t16) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:280:9+40
    assume {:print "$track_return(9,4,0):", $t16} $t16 == $t16;

    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:281:5+1
    assume {:print "$at(36,12736,12737)"} true;
L4:

    // assert Not(Not(ValidatorConfig::spec_has_operator[@129]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:292:9+65
    assume {:print "$at(36,12988,13053)"} true;
    assert {:msg "assert_failed(36,12988,13053): function does not abort under this condition"}
      !!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#129, $t0);

    // assert Not(Not(ValidatorConfig::$exists_config[@129]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:89:9+58
    assume {:print "$at(36,3508,3566)"} true;
    assert {:msg "assert_failed(36,3508,3566): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#129, $t0);

    // assert Eq<address>($t16, ValidatorConfig::$get_operator($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:286:9+37
    assume {:print "$at(36,12831,12868)"} true;
    assert {:msg "assert_failed(36,12831,12868): post-condition does not hold"}
      $IsEqual'address'($t16, $1_ValidatorConfig_$get_operator($1_ValidatorConfig_ValidatorConfig_$memory, $t0));

    // assert forall addr1: TypeDomain<address>() where exists[@129]<ValidatorConfig::ValidatorConfig>(addr1): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr1)), select ValidatorConfig::ValidatorConfig.operator_account(global[@129]<ValidatorConfig::ValidatorConfig>(addr1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:324:9+189
    assume {:print "$at(36,14114,14303)"} true;
    assert {:msg "assert_failed(36,14114,14303): post-condition does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory#129, addr1))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr1)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#129, addr1)))));

    // return $t16 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:324:9+189
    $ret0 := $t16;
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:281:5+1
    assume {:print "$at(36,12736,12737)"} true;
L5:

    // assert Or(Not(ValidatorConfig::spec_has_operator[@129]($t0)), Not(ValidatorConfig::$exists_config[@129]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:5+131
    assume {:print "$at(36,12743,12874)"} true;
    assert {:msg "assert_failed(36,12743,12874): abort not covered by any of the `aborts_if` clauses"}
      (!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#129, $t0) || !$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#129, $t0));

    // assert Or(And(Not(ValidatorConfig::spec_has_operator[@129]($t0)), Eq(7, $t9)), And(Not(ValidatorConfig::$exists_config[@129]($t0)), Eq(5, $t9))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:5+131
    assert {:msg "assert_failed(36,12743,12874): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#129, $t0) && $IsEqual'u8'(7, $t9)) || (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#129, $t0) && $IsEqual'u8'(5, $t9)));

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:283:5+131
    $abort_code := $t9;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::get_validator_network_addresses [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:303:5+132
procedure {:timeLimit 40} $1_ValidatorConfig_get_validator_network_addresses$verify(_$t0: $1_ValidatorConfig_Config) returns ($ret0: Vec (int))
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:303:5+132
    assume {:print "$at(36,13316,13448)"} true;
    assume $IsValid'$1_ValidatorConfig_Config'($t0);

    // @90 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:303:5+1
    $1_ValidatorConfig_ValidatorConfig_$memory#90 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[config_ref]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:303:5+1
    assume {:print "$track_local(9,5,0):", $t0} $t0 == $t0;

    // $t1 := get_field<ValidatorConfig::Config>.validator_network_addresses($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:304:9+39
    assume {:print "$at(36,13403,13442)"} true;
    $t1 := $validator_network_addresses#$1_ValidatorConfig_Config($t0);

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:304:9+39
    assume {:print "$track_return(9,5,0):", $t1} $t1 == $t1;

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:305:5+1
    assume {:print "$at(36,13447,13448)"} true;
L1:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:305:5+1
    assert {:msg "assert_failed(36,13447,13448): function does not abort under this condition"}
      !false;
...
// fun ValidatorConfig::is_valid [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:228:5+176
procedure {:timeLimit 40} $1_ValidatorConfig_is_valid$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    var $temp_0'address': int;
    var $temp_0'bool': bool;
    var $1_ValidatorConfig_ValidatorConfig_$memory#108: $Memory $1_ValidatorConfig_ValidatorConfig;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:228:5+176
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:342:9+112
    assume {:print "$at(36,10554,10730)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:228:5+176
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:354:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:235:17+6
    assume {:print "$at(36,10816,10822)"} true;
    assume $IsValid'address'($t0);
    ...
    // @108 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:228:5+1
    assume {:print "$at(36,10554,10555)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#108 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[addr]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:228:5+1
    assume {:print "$track_local(9,6,0):", $t0} $t0 == $t0;

    // $t2 := exists<ValidatorConfig::ValidatorConfig>($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+6
    assume {:print "$at(36,10630,10636)"} true;
    $t2 := $ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0);

    // if ($t2) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
    if ($t2) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
L1:

    // goto L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
    goto L2;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:90+4
L0:

    // $t3 := get_global<ValidatorConfig::ValidatorConfig>($t0) on_abort goto L5 with $t4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:59+13
    if (!$ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
    ...
    if ($abort_flag) {
        assume {:print "$at(36,10680,10693)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(9,6):", $t4} $t4 == $t4;
        goto L5;
    }

    // $t5 := get_field<ValidatorConfig::ValidatorConfig>.config($t3) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:58+44
    $t5 := $config#$1_ValidatorConfig_ValidatorConfig($t3);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:42+61
    // >> opaque call: $t5 := Option::is_some<ValidatorConfig::Config>($t4)

    // $t6 := opaque begin: Option::is_some<ValidatorConfig::Config>($t5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:42+61

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:42+61
    assume $IsValid'bool'($t6);

    // assume Eq<bool>($t6, Option::$is_some<ValidatorConfig::Config>($t5)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:42+61
    assume $IsEqual'bool'($t6, $1_Option_$is_some'$1_ValidatorConfig_Config'($t5));

    // $t6 := opaque end: Option::is_some<ValidatorConfig::Config>($t5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:42+61

    // $t1 := $t6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
    $t1 := $t6;

    // trace_local[tmp#$1]($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
    assume {:print "$track_local(9,6,1):", $t6} $t6 == $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
    goto L3;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
L2:

    // $t7 := false at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
    $t7 := false;
    assume $IsValid'bool'($t7);

    // $t1 := $t7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
    $t1 := $t7;

    // trace_local[tmp#$1]($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
    assume {:print "$track_local(9,6,1):", $t7} $t7 == $t7;

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
L3:

    // trace_return[0]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:229:9+94
    assume {:print "$track_return(9,6,0):", $t1} $t1 == $t1;

    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:230:5+1
    assume {:print "$at(36,10729,10730)"} true;
L4:

    // assert Not(false) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:234:9+16
    assume {:print "$at(36,10783,10799)"} true;
    assert {:msg "assert_failed(36,10783,10799): function does not abort under this condition"}
      !false;

    // assert Eq<bool>($t1, ValidatorConfig::$is_valid($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:235:9+33
    assume {:print "$at(36,10808,10841)"} true;
    assert {:msg "assert_failed(36,10808,10841): post-condition does not hold"}
      $IsEqual'bool'($t1, $1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, $t0));

    // assert forall addr1: TypeDomain<address>() where exists[@108]<ValidatorConfig::ValidatorConfig>(addr1): Eq<Option::Option<address>>(select ValidatorConfig::ValidatorConfig.operator_account(global<ValidatorConfig::ValidatorConfig>(addr1)), select ValidatorConfig::ValidatorConfig.operator_account(global[@108]<ValidatorConfig::ValidatorConfig>(addr1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:324:9+189
    assume {:print "$at(36,14114,14303)"} true;
    assert {:msg "assert_failed(36,14114,14303): post-condition does not hold"}
      (forall addr1: int :: $IsValid'address'(addr1) ==> ($ResourceExists($1_ValidatorConfig_ValidatorConfig_$memory#108, addr1))  ==> ($IsEqual'$1_Option_Option'address''($operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory, addr1)), $operator_account#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#108, addr1)))));

    // return $t1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:324:9+189
    $ret0 := $t1;
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:230:5+1
    assume {:print "$at(36,10729,10730)"} true;
L5:

    // assert false at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:5+111
    assume {:print "$at(36,10736,10847)"} true;
    assert {:msg "assert_failed(36,10736,10847): abort not covered by any of the `aborts_if` clauses"}
      false;

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:232:5+111
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::remove_operator [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:143:5+404
procedure {:timeLimit 40} $1_ValidatorConfig_remove_operator$verify(_$t0: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorOperatorConfig::$has_validator_operator_config(addr): Roles::spec_has_validator_operator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:143:5+404
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:74:9+137
    assume {:print "$at(36,6335,6739)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_operator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:143:5+404
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:342:9+112
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:143:5+404
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:354:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:143:5+404
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:143:5+404
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));
    ...
    // assume Identical($t4, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:153:9+56
    assume {:print "$at(36,6867,6923)"} true;
    assume ($t4 == $1_Signer_spec_address_of($t0));

    // @111 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:143:5+1
    assume {:print "$at(36,6335,6336)"} true;
    $1_Roles_RoleId_$memory#111 := $1_Roles_RoleId_$memory;

    // @112 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:143:5+1
    $1_ValidatorConfig_ValidatorConfig_$memory#112 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[validator_account]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:143:5+1
    assume {:print "$track_local(9,8,0):", $t0} $t0 == $t0;

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:144:9+42
    // >> opaque call: Roles::assert_validator($t0)
    assume {:print "$at(36,6425,6467)"} true;

    // opaque begin: Roles::assert_validator($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:144:9+42

    // assume Identical($t5, Or(Not(exists<Roles::RoleId>(Signer::$address_of($t0))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(Signer::$address_of($t0))), 3))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:144:9+42
    ...
    // if ($t5) goto L5 else goto L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:144:9+42
    if ($t5) { goto L5; } else { goto L4; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:144:9+42
L5:

    // assume Or(And(Not(exists<Roles::RoleId>(Signer::$address_of($t0))), Eq(5, $t6)), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(Signer::$address_of($t0))), 3), Eq(3, $t6))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:144:9+42
    ...
    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:144:9+42
    assume {:print "$at(36,6425,6467)"} true;
    assume {:print "$track_abort(9,8):", $t6} $t6 == $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:144:9+42
    goto L3;

    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:144:9+42
L4:

    // opaque end: Roles::assert_validator($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:144:9+42

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:145:22+37
    // >> opaque call: $t4 := Signer::address_of($t0)
    assume {:print "$at(36,6490,6527)"} true;

    // $t7 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:145:22+37

    // assume WellFormed($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:145:22+37
    assume $IsValid'address'($t7);

    // assume Eq<address>($t7, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:145:22+37
    assume $IsEqual'address'($t7, $1_Signer_spec_address_of($t0));

    // $t7 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:145:22+37

    // trace_local[sender]($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:145:13+6
    assume {:print "$track_local(9,8,1):", $t7} $t7 == $t7;

    // $t8 := ValidatorConfig::exists_config($t7) on_abort goto L3 with $t6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:16+21
    assume {:print "$at(36,6580,6601)"} true;
    ...
    // $t9 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:61+17
    $t9 := 0;
    assume $IsValid'u64'($t9);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:39+40
    // >> opaque call: $t7 := Errors::not_published($t6)

    // $t10 := opaque begin: Errors::not_published($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:39+40

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:39+40
    assume $IsValid'u64'($t10);

    // assume Eq<u64>($t10, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:39+40
    assume $IsEqual'u64'($t10, 5);

    // $t10 := opaque end: Errors::not_published($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:39+40

    // trace_local[tmp#$3]($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+71
    assume {:print "$track_local(9,8,3):", $t10} $t10 == $t10;

    // trace_local[tmp#$2]($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+71
    assume {:print "$track_local(9,8,2):", $t8} $t8 == $t8;

    // if ($t8) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+71
    if ($t8) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+71
L1:

    // trace_abort($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+71
    assume {:print "$at(36,6573,6644)"} true;
    assume {:print "$track_abort(9,8):", $t10} $t10 == $t10;

    // $t6 := move($t10) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+71
    $t6 := $t10;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:147:9+71
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:73+14
    assume {:print "$at(36,6718,6732)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:73+14
    // >> opaque call: $t8 := Option::none<address>()

    // $t11 := opaque begin: Option::none<address>() at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:73+14

    // assume And(WellFormed($t11), Le(Len<address>(select Option::Option.vec($t11)), 1)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:73+14
    assume ($IsValid'$1_Option_Option'address''($t11) && (LenVec($vec#$1_Option_Option'address'($t11)) <= 1));

    // assume Eq<Option::Option<address>>($t11, Option::spec_none<address>()) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:73+14
    assume $IsEqual'$1_Option_Option'address''($t11, $1_Option_spec_none'address'());

    // $t11 := opaque end: Option::none<address>() at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:73+14

    // $t12 := borrow_global<ValidatorConfig::ValidatorConfig>($t7) on_abort goto L3 with $t6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:10+17
    ...
    if ($abort_flag) {
        assume {:print "$at(36,6655,6672)"} true;
        $t6 := $abort_code;
        assume {:print "$track_abort(9,8):", $t6} $t6 == $t6;
        goto L3;
    }

    // $t13 := borrow_field<ValidatorConfig::ValidatorConfig>.operator_account($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:9+61
    $t13 := $ChildMutation($t12, 1, $operator_account#$1_ValidatorConfig_ValidatorConfig($Dereference($t12)));

    // write_ref($t13, $t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:9+78
    $t13 := $UpdateMutation($t13, $t11);

    // write_back[Reference($t12).operator_account]($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:9+78
    $t12 := $UpdateMutation($t12, $Update'$1_ValidatorConfig_ValidatorConfig'_operator_account($Dereference($t12), $Dereference($t13)));

    // assert Le(Len<ValidatorConfig::Config>(select Option::Option.vec(select ValidatorConfig::ValidatorConfig.config($t12))), 1) at /home/ying/diem/language/move-stdlib/modules/Option.move:14:9+24
    ...
    // assert Le(Len<address>(select Option::Option.vec(select ValidatorConfig::ValidatorConfig.operator_account($t12))), 1) at /home/ying/diem/language/move-stdlib/modules/Option.move:14:9+24
    // data invariant at /home/ying/diem/language/move-stdlib/modules/Option.move:14:9+24
    assert {:msg "assert_failed(45,551,575): data invariant does not hold"}
      (LenVec($vec#$1_Option_Option'address'($operator_account#$1_ValidatorConfig_ValidatorConfig($Dereference($t12)))) <= 1);

    // @241 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:143:5+404
    // state save for global update invariants
    assume {:print "$at(36,6335,6739)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#241 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // write_back[ValidatorConfig::ValidatorConfig@]($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:148:9+78
    assume {:print "$at(36,6654,6732)"} true;
    ...
    // assert forall validator: TypeDomain<address>() where ValidatorConfig::$is_valid[@241](validator): ValidatorConfig::$is_valid(validator) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:333:9+107
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:333:9+107
    assume {:print "$at(36,14514,14621)"} true;
    assert {:msg "assert_failed(36,14514,14621): global memory invariant does not hold"}
    ...
    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:149:5+1
    assume {:print "$at(36,6738,6739)"} true;
L2:

    // assert Not(Not(exists[@111]<Roles::RoleId>($t4))) at /home/ying/diem/language/diem-framework/modules/Roles.move:578:9+69
    assume {:print "$at(26,25793,25862)"} true;
    assert {:msg "assert_failed(26,25793,25862): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#111, $t4);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@111]<Roles::RoleId>($t4)), 3)) at /home/ying/diem/language/diem-framework/modules/Roles.move:579:9+97
    assume {:print "$at(26,25871,25968)"} true;
    assert {:msg "assert_failed(26,25871,25968): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#111, $t4)), 3);

    // assert Not(Not(ValidatorConfig::$exists_config[@112]($t4))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:89:9+58
    assume {:print "$at(36,3508,3566)"} true;
    assert {:msg "assert_failed(36,3508,3566): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#112, $t4);

    // assert Not(ValidatorConfig::spec_has_operator(Signer::spec_address_of($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:156:9+71
    assume {:print "$at(36,7058,7129)"} true;
    assert {:msg "assert_failed(36,7058,7129): post-condition does not hold"}
    ...
    assume {:print "$at(36,7224,7389)"} true;
    assert {:msg "assert_failed(36,7224,7389): post-condition does not hold"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:159:9+165
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:149:5+1
    assume {:print "$at(36,6738,6739)"} true;
L3:

    // assert Or(Or(Not(exists[@111]<Roles::RoleId>($t4)), Neq<u64>(select Roles::RoleId.role_id(global[@111]<Roles::RoleId>($t4)), 3)), Not(ValidatorConfig::$exists_config[@112]($t4))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:5+650
    assume {:print "$at(36,6745,7395)"} true;
    assert {:msg "assert_failed(36,6745,7395): abort not covered by any of the `aborts_if` clauses"}
    ...
    // assert Or(Or(And(Not(exists[@111]<Roles::RoleId>($t4)), Eq(5, $t6)), And(Neq<u64>(select Roles::RoleId.role_id(global[@111]<Roles::RoleId>($t4)), 3), Eq(3, $t6))), And(Not(ValidatorConfig::$exists_config[@112]($t4)), Eq(5, $t6))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:5+650
    assert {:msg "assert_failed(36,6745,7395): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:151:5+650
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::set_config [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1025
procedure {:timeLimit 40} $1_ValidatorConfig_set_config$verify(_$t0: int, _$t1: int, _$t2: Vec (int), _$t3: Vec (int), _$t4: Vec (int)) returns ()
{
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1025
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:342:9+112
    assume {:print "$at(36,7817,8842)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1025
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:354:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1025
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1025
    assume $IsValid'address'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1025
    assume $IsValid'vec'u8''($t2);

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1025
    assume $IsValid'vec'u8''($t3);

    // assume WellFormed($t4) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1025
    ...
    // assume CanModify<ValidatorConfig::ValidatorConfig>($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:196:9+49
    assume {:print "$at(36,8896,8945)"} true;
    assume $1_ValidatorConfig_ValidatorConfig_$modifies[$t1];

    // @145 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:196:9+49
    $1_ValidatorConfig_ValidatorConfig_$memory#145 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[validator_operator_account]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1
    assume {:print "$at(36,7817,7818)"} true;
    assume {:print "$track_local(9,9,0):", $t0} $t0 == $t0;

    // trace_local[validator_addr]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1
    assume {:print "$track_local(9,9,1):", $t1} $t1 == $t1;

    // trace_local[consensus_pubkey]($t2) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1
    assume {:print "$track_local(9,9,2):", $t2} $t2 == $t2;

    // trace_local[validator_network_addresses]($t3) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1
    assume {:print "$track_local(9,9,3):", $t3} $t3 == $t3;

    // trace_local[fullnode_network_addresses]($t4) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1
    assume {:print "$track_local(9,9,4):", $t4} $t4 == $t4;

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:13+46
    // >> opaque call: $t12 := Signer::address_of($t0)
    assume {:print "$at(36,8114,8160)"} true;

    // $t12 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:13+46

    // assume WellFormed($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:13+46
    assume $IsValid'address'($t12);

    // assume Eq<address>($t12, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:13+46
    assume $IsEqual'address'($t12, $1_Signer_spec_address_of($t0));

    // $t12 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:13+46

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28
    // >> opaque call: $t13 := ValidatorConfig::get_operator($t1)

    // $t13 := opaque begin: ValidatorConfig::get_operator($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28

    // assume Identical($t14, Or(Not(ValidatorConfig::spec_has_operator($t1)), Not(ValidatorConfig::$exists_config($t1)))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28
    ...
    // if ($t14) goto L9 else goto L8 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28
    if ($t14) { goto L9; } else { goto L8; }

    // label L9 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28
L9:

    // assume Or(And(Not(ValidatorConfig::spec_has_operator($t1)), Eq(7, $t15)), And(Not(ValidatorConfig::$exists_config($t1)), Eq(5, $t15))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28
    ...
    // trace_abort($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28
    assume {:print "$at(36,8164,8192)"} true;
    assume {:print "$track_abort(9,9):", $t15} $t15 == $t15;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28
    goto L7;

    // label L8 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28
L8:

    // assume WellFormed($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28
    assume $IsValid'address'($t13);

    // assume Eq<address>($t13, ValidatorConfig::$get_operator($t1)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28
    assume $IsEqual'address'($t13, $1_ValidatorConfig_$get_operator($1_ValidatorConfig_ValidatorConfig_$memory, $t1));

    // $t13 := opaque end: ValidatorConfig::get_operator($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:63+28

    // $t16 := ==($t12, $t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:178:60+2
    $t16 := $IsEqual'address'($t12, $t13);

    // $t17 := 1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:179:38+27
    assume {:print "$at(36,8231,8258)"} true;
    $t17 := 1;
    assume $IsValid'u64'($t17);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:179:13+53
    // >> opaque call: $t16 := Errors::invalid_argument($t15)

    // $t18 := opaque begin: Errors::invalid_argument($t17) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:179:13+53

    // assume WellFormed($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:179:13+53
    assume $IsValid'u64'($t18);

    // assume Eq<u64>($t18, 7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:179:13+53
    assume $IsEqual'u64'($t18, 7);

    // $t18 := opaque end: Errors::invalid_argument($t17) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:179:13+53

    // trace_local[tmp#$7]($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:177:9+175
    assume {:print "$at(36,8094,8269)"} true;
    assume {:print "$track_local(9,9,7):", $t18} $t18 == $t18;

    // trace_local[tmp#$6]($t16) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:177:9+175
    assume {:print "$track_local(9,9,6):", $t16} $t16 == $t16;

    // if ($t16) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:177:9+175
    if ($t16) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:177:9+175
L1:

    // trace_abort($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:177:9+175
    assume {:print "$at(36,8094,8269)"} true;
    assume {:print "$track_abort(9,9):", $t18} $t18 == $t18;

    // $t15 := move($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:177:9+175
    $t15 := $t18;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:177:9+175
    goto L7;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:182:48+21
    assume {:print "$at(36,8334,8355)"} true;
L0:

    // $t19 := Signature::ed25519_validate_pubkey($t2) on_abort goto L7 with $t15 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:182:13+57
    call $t19 := $1_Signature_ed25519_validate_pubkey($t2);
    if ($abort_flag) {
        assume {:print "$at(36,8299,8356)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(9,9):", $t15} $t15 == $t15;
        goto L7;
    }

    // $t20 := 2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:183:38+22
    assume {:print "$at(36,8395,8417)"} true;
    $t20 := 2;
    assume $IsValid'u64'($t20);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:183:13+48
    // >> opaque call: $t19 := Errors::invalid_argument($t18)

    // $t21 := opaque begin: Errors::invalid_argument($t20) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:183:13+48

    // assume WellFormed($t21) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:183:13+48
    assume $IsValid'u64'($t21);

    // assume Eq<u64>($t21, 7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:183:13+48
    assume $IsEqual'u64'($t21, 7);

    // $t21 := opaque end: Errors::invalid_argument($t20) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:183:13+48

    // trace_local[tmp#$9]($t21) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:9+149
    assume {:print "$at(36,8279,8428)"} true;
    assume {:print "$track_local(9,9,9):", $t21} $t21 == $t21;

    // trace_local[tmp#$8]($t19) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:9+149
    assume {:print "$track_local(9,9,8):", $t19} $t19 == $t19;

    // if ($t19) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:9+149
    if ($t19) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:9+149
L3:

    // trace_abort($t21) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:9+149
    assume {:print "$at(36,8279,8428)"} true;
    assume {:print "$track_abort(9,9):", $t21} $t21 == $t21;

    // $t15 := move($t21) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:9+149
    $t15 := $t21;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:181:9+149
    goto L7;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:30+14
    assume {:print "$at(36,8537,8551)"} true;
L2:

    // $t22 := ValidatorConfig::exists_config($t1) on_abort goto L7 with $t15 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:16+29
    call $t22 := $1_ValidatorConfig_exists_config($t1);
    if ($abort_flag) {
        assume {:print "$at(36,8523,8552)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(9,9):", $t15} $t15 == $t15;
        goto L7;
    }

    // $t23 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:69+17
    $t23 := 0;
    assume $IsValid'u64'($t23);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:47+40
    // >> opaque call: $t22 := Errors::not_published($t21)

    // $t24 := opaque begin: Errors::not_published($t23) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:47+40

    // assume WellFormed($t24) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:47+40
    assume $IsValid'u64'($t24);

    // assume Eq<u64>($t24, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:47+40
    assume $IsEqual'u64'($t24, 5);

    // $t24 := opaque end: Errors::not_published($t23) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:47+40

    // trace_local[tmp#$11]($t24) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:9+79
    assume {:print "$track_local(9,9,11):", $t24} $t24 == $t24;

    // trace_local[tmp#$10]($t22) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:9+79
    assume {:print "$track_local(9,9,10):", $t22} $t22 == $t22;

    // if ($t22) goto L4 else goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:9+79
    if ($t22) { goto L4; } else { goto L5; }

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:9+79
L5:

    // trace_abort($t24) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:9+79
    assume {:print "$at(36,8516,8595)"} true;
    assume {:print "$track_abort(9,9):", $t24} $t24 == $t24;

    // $t15 := move($t24) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:9+79
    $t15 := $t24;

    // goto L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:186:9+79
    goto L7;

    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:187:56+14
    assume {:print "$at(36,8652,8666)"} true;
L4:

    // assert CanModify<ValidatorConfig::ValidatorConfig>($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:187:21+17
    assert {:msg "assert_failed(36,8617,8634): caller does not have permission to modify `ValidatorConfig::ValidatorConfig` at given address"}
      $1_ValidatorConfig_ValidatorConfig_$modifies[$t1];

    // $t25 := borrow_global<ValidatorConfig::ValidatorConfig>($t1) on_abort goto L7 with $t15 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:187:21+17
    ...
    if ($abort_flag) {
        assume {:print "$at(36,8617,8634)"} true;
        $t15 := $abort_code;
        assume {:print "$track_abort(9,9):", $t15} $t15 == $t15;
        goto L7;
    }

    // trace_local[t_ref]($t25) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:187:13+5
    $temp_0'$1_ValidatorConfig_ValidatorConfig' := $Dereference($t25);
    assume {:print "$track_local(9,9,5):", $temp_0'$1_ValidatorConfig_ValidatorConfig'} $temp_0'$1_ValidatorConfig_ValidatorConfig' == $temp_0'$1_ValidatorConfig_ValidatorConfig';

    // $t26 := pack ValidatorConfig::Config($t2, $t3, $t4) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:188:37+129
    assume {:print "$at(36,8705,8834)"} true;
    $t26 := $1_ValidatorConfig_Config($t2, $t3, $t4);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:188:24+143
    // >> opaque call: $t25 := Option::some<ValidatorConfig::Config>($t24)

    // $t27 := opaque begin: Option::some<ValidatorConfig::Config>($t26) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:188:24+143

    // assume And(WellFormed($t27), Le(Len<ValidatorConfig::Config>(select Option::Option.vec($t27)), 1)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:188:24+143
    assume ($IsValid'$1_Option_Option'$1_ValidatorConfig_Config''($t27) && (LenVec($vec#$1_Option_Option'$1_ValidatorConfig_Config'($t27)) <= 1));

    // assume Eq<Option::Option<ValidatorConfig::Config>>($t27, Option::spec_some<ValidatorConfig::Config>($t26)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:188:24+143
    assume $IsEqual'$1_Option_Option'$1_ValidatorConfig_Config''($t27, $1_Option_spec_some'$1_ValidatorConfig_Config'($t26));

    // $t27 := opaque end: Option::some<ValidatorConfig::Config>($t26) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:188:24+143

    // $t28 := borrow_field<ValidatorConfig::ValidatorConfig>.config($t25) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:188:9+12
    $t28 := $ChildMutation($t25, 0, $config#$1_ValidatorConfig_ValidatorConfig($Dereference($t25)));

    // write_ref($t28, $t27) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:188:9+158
    $t28 := $UpdateMutation($t28, $t27);

    // write_back[Reference($t25).config]($t28) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:188:9+158
    ...
    // @244 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:170:5+1025
    // state save for global update invariants
    assume {:print "$at(36,7817,8842)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#244 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // write_back[ValidatorConfig::ValidatorConfig@]($t25) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:188:9+158
    assume {:print "$at(36,8677,8835)"} true;
    ...
    // assert forall validator: TypeDomain<address>() where ValidatorConfig::$is_valid[@244](validator): ValidatorConfig::$is_valid(validator) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:333:9+107
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:333:9+107
    assume {:print "$at(36,14514,14621)"} true;
    assert {:msg "assert_failed(36,14514,14621): global memory invariant does not hold"}
    ...
    // label L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:193:5+1
    assume {:print "$at(36,8841,8842)"} true;
L6:

    // assert Not(Neq<address>(Signer::$address_of[]($t0), ValidatorConfig::$get_operator[@145]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:212:9+131
    assume {:print "$at(36,9693,9824)"} true;
    assert {:msg "assert_failed(36,9693,9824): function does not abort under this condition"}
      !!$IsEqual'address'($1_Signer_$address_of($t0), $1_ValidatorConfig_$get_operator($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1));

    // assert Not(Not(Signature::$ed25519_validate_pubkey[]($t2))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:215:9+94
    assume {:print "$at(36,9892,9986)"} true;
    assert {:msg "assert_failed(36,9892,9986): function does not abort under this condition"}
      !!$1_Signature_$ed25519_validate_pubkey($t2);

    // assert Not(Not(ValidatorConfig::spec_has_operator[@145]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:292:9+65
    assume {:print "$at(36,12988,13053)"} true;
    assert {:msg "assert_failed(36,12988,13053): function does not abort under this condition"}
      !!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1);

    // assert Not(Not(ValidatorConfig::$exists_config[@145]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:89:9+58
    assume {:print "$at(36,3508,3566)"} true;
    assert {:msg "assert_failed(36,3508,3566): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1);

    // assert ValidatorConfig::$is_valid($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:198:9+33
    assume {:print "$at(36,8989,9022)"} true;
    assert {:msg "assert_failed(36,8989,9022): post-condition does not hold"}
    ...
    assume {:print "$at(36,9031,9527)"} true;
    assert {:msg "assert_failed(36,9031,9527): post-condition does not hold"}
    ...
    // label L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:193:5+1
    assume {:print "$at(36,8841,8842)"} true;
L7:

    // assert Or(Or(Or(Neq<address>(Signer::$address_of[]($t0), ValidatorConfig::$get_operator[@145]($t1)), Not(Signature::$ed25519_validate_pubkey[]($t2))), Not(ValidatorConfig::spec_has_operator[@145]($t1))), Not(ValidatorConfig::$exists_config[@145]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:194:5+686
    assume {:print "$at(36,8847,9533)"} true;
    assert {:msg "assert_failed(36,8847,9533): abort not covered by any of the `aborts_if` clauses"}
    ...
    assert {:msg "assert_failed(36,8847,9533): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:194:5+686
    $abort_code := $t15;
    $abort_flag := true;
    return;
...
// fun ValidatorConfig::set_operator [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+705
procedure {:timeLimit 40} $1_ValidatorConfig_set_operator$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorOperatorConfig::$has_validator_operator_config(addr): Roles::spec_has_validator_operator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+705
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:74:9+137
    assume {:print "$at(36,3957,4662)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_operator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$exists_config(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+705
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:342:9+112
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorConfig::$is_valid(addr): Roles::spec_has_validator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+705
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:354:9+107
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorConfig_$is_valid($1_ValidatorConfig_ValidatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+705
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+705
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+705
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<ValidatorOperatorConfig::ValidatorOperatorConfig>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+705
    ...
    // assume Identical($t7, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:112:9+56
    assume {:print "$at(36,4786,4842)"} true;
    assume ($t7 == $1_Signer_spec_address_of($t0));

    // assume Identical($t8, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:122:9+64
    assume {:print "$at(36,5182,5246)"} true;
    assume ($t8 == $1_Signer_spec_address_of($t0));

    // assume Identical($t9, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:133:9+64
    assume {:print "$at(36,5757,5821)"} true;
    assume ($t9 == $1_Signer_spec_address_of($t0));

    // @114 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+1
    assume {:print "$at(36,3957,3958)"} true;
    $1_Roles_RoleId_$memory#114 := $1_Roles_RoleId_$memory;

    // @115 := save_mem(ValidatorOperatorConfig::ValidatorOperatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+1
    $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115 := $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory;

    // @116 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+1
    $1_ValidatorConfig_ValidatorConfig_$memory#116 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // trace_local[validator_account]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+1
    assume {:print "$track_local(9,10,0):", $t0} $t0 == $t0;

    // trace_local[operator_addr]($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+1
    assume {:print "$track_local(9,10,1):", $t1} $t1 == $t1;

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:99:9+42
    // >> opaque call: Roles::assert_validator($t0)
    assume {:print "$at(36,4068,4110)"} true;

    // opaque begin: Roles::assert_validator($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:99:9+42

    // assume Identical($t10, Or(Not(exists<Roles::RoleId>(Signer::$address_of($t0))), Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(Signer::$address_of($t0))), 3))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:99:9+42
    assume ($t10 == (!$ResourceExists($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0))), 3)));

    // if ($t10) goto L7 else goto L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:99:9+42
    if ($t10) { goto L7; } else { goto L6; }

    // label L7 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:99:9+42
L7:

    // assume Or(And(Not(exists<Roles::RoleId>(Signer::$address_of($t0))), Eq(5, $t11)), And(Neq<u64>(select Roles::RoleId.role_id(global<Roles::RoleId>(Signer::$address_of($t0))), 3), Eq(3, $t11))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:99:9+42
    ...
    // trace_abort($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:99:9+42
    assume {:print "$at(36,4068,4110)"} true;
    assume {:print "$track_abort(9,10):", $t11} $t11 == $t11;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:99:9+42
    goto L5;

    // label L6 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:99:9+42
L6:

    // opaque end: Roles::assert_validator($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:99:9+42

    // $t12 := ValidatorOperatorConfig::has_validator_operator_config($t1) on_abort goto L5 with $t11 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:103:13+69
    assume {:print "$at(36,4269,4338)"} true;
    ...
    // $t13 := 3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:104:38+25
    assume {:print "$at(36,4377,4402)"} true;
    $t13 := 3;
    assume $IsValid'u64'($t13);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:104:13+51
    // >> opaque call: $t9 := Errors::invalid_argument($t8)

    // $t14 := opaque begin: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:104:13+51

    // assume WellFormed($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:104:13+51
    assume $IsValid'u64'($t14);

    // assume Eq<u64>($t14, 7) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:104:13+51
    assume $IsEqual'u64'($t14, 7);

    // $t14 := opaque end: Errors::invalid_argument($t13) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:104:13+51

    // trace_local[tmp#$4]($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+164
    assume {:print "$at(36,4249,4413)"} true;
    assume {:print "$track_local(9,10,4):", $t14} $t14 == $t14;

    // trace_local[tmp#$3]($t12) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+164
    assume {:print "$track_local(9,10,3):", $t12} $t12 == $t12;

    // if ($t12) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+164
    if ($t12) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+164
L1:

    // destroy($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+164

    // trace_abort($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+164
    assume {:print "$at(36,4249,4413)"} true;
    assume {:print "$track_abort(9,10):", $t14} $t14 == $t14;

    // $t11 := move($t14) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+164
    $t11 := $t14;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:102:9+164
    goto L5;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:106:41+17
    assume {:print "$at(36,4455,4472)"} true;
L0:

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:106:22+37
    // >> opaque call: $t10 := Signer::address_of($t0)

    // $t15 := opaque begin: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:106:22+37

    // assume WellFormed($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:106:22+37
    assume $IsValid'address'($t15);

    // assume Eq<address>($t15, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:106:22+37
    assume $IsEqual'address'($t15, $1_Signer_spec_address_of($t0));

    // $t15 := opaque end: Signer::address_of($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:106:22+37

    // trace_local[sender]($t15) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:106:13+6
    assume {:print "$track_local(9,10,2):", $t15} $t15 == $t15;

    // $t16 := ValidatorConfig::exists_config($t15) on_abort goto L5 with $t11 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:16+21
    assume {:print "$at(36,4490,4511)"} true;
    ...
    // $t17 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:61+17
    $t17 := 0;
    assume $IsValid'u64'($t17);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:39+40
    // >> opaque call: $t13 := Errors::not_published($t12)

    // $t18 := opaque begin: Errors::not_published($t17) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:39+40

    // assume WellFormed($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:39+40
    assume $IsValid'u64'($t18);

    // assume Eq<u64>($t18, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:39+40
    assume $IsEqual'u64'($t18, 5);

    // $t18 := opaque end: Errors::not_published($t17) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:39+40

    // trace_local[tmp#$6]($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:9+71
    assume {:print "$track_local(9,10,6):", $t18} $t18 == $t18;

    // trace_local[tmp#$5]($t16) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:9+71
    assume {:print "$track_local(9,10,5):", $t16} $t16 == $t16;

    // if ($t16) goto L2 else goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:9+71
    if ($t16) { goto L2; } else { goto L3; }

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:9+71
L3:

    // trace_abort($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:9+71
    assume {:print "$at(36,4483,4554)"} true;
    assume {:print "$track_abort(9,10):", $t18} $t18 == $t18;

    // $t11 := move($t18) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:9+71
    $t11 := $t18;

    // goto L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:107:9+71
    goto L5;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:108:86+13
    assume {:print "$at(36,4641,4654)"} true;
L2:

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:108:73+27
    // >> opaque call: $t14 := Option::some<address>($t1)

    // $t19 := opaque begin: Option::some<address>($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:108:73+27

    // assume And(WellFormed($t19), Le(Len<address>(select Option::Option.vec($t19)), 1)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:108:73+27
    assume ($IsValid'$1_Option_Option'address''($t19) && (LenVec($vec#$1_Option_Option'address'($t19)) <= 1));

    // assume Eq<Option::Option<address>>($t19, Option::spec_some<address>($t1)) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:108:73+27
    assume $IsEqual'$1_Option_Option'address''($t19, $1_Option_spec_some'address'($t1));

    // $t19 := opaque end: Option::some<address>($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:108:73+27

    // $t20 := borrow_global<ValidatorConfig::ValidatorConfig>($t15) on_abort goto L5 with $t11 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:108:10+17
    ...
    if ($abort_flag) {
        assume {:print "$at(36,4565,4582)"} true;
        $t11 := $abort_code;
        assume {:print "$track_abort(9,10):", $t11} $t11 == $t11;
        goto L5;
    }

    // $t21 := borrow_field<ValidatorConfig::ValidatorConfig>.operator_account($t20) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:108:9+61
    $t21 := $ChildMutation($t20, 1, $operator_account#$1_ValidatorConfig_ValidatorConfig($Dereference($t20)));

    // write_ref($t21, $t19) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:108:9+91
    $t21 := $UpdateMutation($t21, $t19);

    // write_back[Reference($t20).operator_account]($t21) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:108:9+91
    $t20 := $UpdateMutation($t20, $Update'$1_ValidatorConfig_ValidatorConfig'_operator_account($Dereference($t20), $Dereference($t21)));

    // assert Le(Len<ValidatorConfig::Config>(select Option::Option.vec(select ValidatorConfig::ValidatorConfig.config($t20))), 1) at /home/ying/diem/language/move-stdlib/modules/Option.move:14:9+24
    // data invariant at /home/ying/diem/language/move-stdlib/modules/Option.move:14:9+24
    assume {:print "$at(45,551,575)"} true;
    assert {:msg "assert_failed(45,551,575): data invariant does not hold"}
      (LenVec($vec#$1_Option_Option'$1_ValidatorConfig_Config'($config#$1_ValidatorConfig_ValidatorConfig($Dereference($t20)))) <= 1);

    // assert Le(Len<address>(select Option::Option.vec(select ValidatorConfig::ValidatorConfig.operator_account($t20))), 1) at /home/ying/diem/language/move-stdlib/modules/Option.move:14:9+24
    // data invariant at /home/ying/diem/language/move-stdlib/modules/Option.move:14:9+24
    assert {:msg "assert_failed(45,551,575): data invariant does not hold"}
      (LenVec($vec#$1_Option_Option'address'($operator_account#$1_ValidatorConfig_ValidatorConfig($Dereference($t20)))) <= 1);

    // @242 := save_mem(ValidatorConfig::ValidatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:98:5+705
    // state save for global update invariants
    assume {:print "$at(36,3957,4662)"} true;
    $1_ValidatorConfig_ValidatorConfig_$memory#242 := $1_ValidatorConfig_ValidatorConfig_$memory;

    // write_back[ValidatorConfig::ValidatorConfig@]($t20) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:108:9+91
    assume {:print "$at(36,4564,4655)"} true;
    ...
    // assert forall validator: TypeDomain<address>() where ValidatorConfig::$is_valid[@242](validator): ValidatorConfig::$is_valid(validator) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:333:9+107
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:333:9+107
    assume {:print "$at(36,14514,14621)"} true;
    assert {:msg "assert_failed(36,14514,14621): global memory invariant does not hold"}
    ...
    // label L4 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:109:5+1
    assume {:print "$at(36,4661,4662)"} true;
L4:

    // assert Not(Not(exists[@114]<Roles::RoleId>($t7))) at /home/ying/diem/language/diem-framework/modules/Roles.move:578:9+69
    assume {:print "$at(26,25793,25862)"} true;
    assert {:msg "assert_failed(26,25793,25862): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#114, $t7);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@114]<Roles::RoleId>($t7)), 3)) at /home/ying/diem/language/diem-framework/modules/Roles.move:579:9+97
    assume {:print "$at(26,25871,25968)"} true;
    assert {:msg "assert_failed(26,25871,25968): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#114, $t7)), 3);

    // assert Not(Not(ValidatorOperatorConfig::$has_validator_operator_config[@115]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:124:9+123
    assume {:print "$at(36,5332,5455)"} true;
    assert {:msg "assert_failed(36,5332,5455): function does not abort under this condition"}
    ...
    // assert Not(Not(ValidatorOperatorConfig::$has_validator_operator_config[@115]($t1))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:127:9+108
    assume {:print "$at(36,5529,5637)"} true;
    assert {:msg "assert_failed(36,5529,5637): function does not abort under this condition"}
      !!$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115, $t1);

    // assert Not(Not(exists[@114]<Roles::RoleId>($t8))) at /home/ying/diem/language/diem-framework/modules/Roles.move:578:9+69
    assume {:print "$at(26,25793,25862)"} true;
    assert {:msg "assert_failed(26,25793,25862): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#114, $t8);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@114]<Roles::RoleId>($t8)), 3)) at /home/ying/diem/language/diem-framework/modules/Roles.move:579:9+97
    assume {:print "$at(26,25871,25968)"} true;
    assert {:msg "assert_failed(26,25871,25968): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#114, $t8)), 3);

    // assert Not(Not(ValidatorConfig::$exists_config[@116]($t8))) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:89:9+58
    assume {:print "$at(36,3508,3566)"} true;
    assert {:msg "assert_failed(36,3508,3566): function does not abort under this condition"}
      !!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#116, $t8);

    // assert ValidatorConfig::spec_has_operator($t9) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:134:9+42
    assume {:print "$at(36,5830,5872)"} true;
    assert {:msg "assert_failed(36,5830,5872): post-condition does not hold"}
      $1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory, $t9);

    // assert Eq<address>(ValidatorConfig::$get_operator($t9), $t1) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:135:9+54
    assume {:print "$at(36,5881,5935)"} true;
    assert {:msg "assert_failed(36,5881,5935): post-condition does not hold"}
    ...
    assume {:print "$at(36,6029,6202)"} true;
    assert {:msg "assert_failed(36,6029,6202): post-condition does not hold"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:137:9+173
    return;

    // label L5 at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:109:5+1
    assume {:print "$at(36,4661,4662)"} true;
L5:
    ...
    assume {:print "$at(36,4667,4990)"} true;
    assert {:msg "assert_failed(36,4667,4990): abort not covered by any of the `aborts_if` clauses"}
    ...
    assert {:msg "assert_failed(36,4667,4990): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
    ...
    // abort($t11) at /home/ying/diem/language/diem-framework/modules/ValidatorConfig.move:110:5+323
    $abort_code := $t11;
    $abort_flag := true;
    return;
