...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |addressserializationconstantsizeSmtSeqz3bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.461:15|
 :skolemid |14|
...
(assert (forall ((v@@4 (Seq Int)) ) (! (= (|$IsValid'vec'u8''| v@@4)  (and (|$IsValid'u64'| (seq.len v@@4)) (forall ((i@@0 Int) ) (!  (=> (and (>= i@@0 0) (< i@@0 (seq.len v@@4))) (|$IsValid'u8'| (seq.nth v@@4 i@@0)))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.590:13|
 :skolemid |15|
))))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.588:28|
 :skolemid |16|
 :pattern ( (|$IsValid'vec'u8''| v@@4))
)))
(assert (forall ((v@@5 (Seq Int)) (e Int) ) (! (let ((i@@1 (|$IndexOfVec'u8'| v@@5 e)))
(ite  (not (exists ((i@@2 Int) ) (!  (and (and (|$IsValid'u64'| i@@2) (and (>= i@@2 0) (< i@@2 (seq.len v@@5)))) (= (seq.nth v@@5 i@@2) e))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.595:13|
 :skolemid |17|
))) (= i@@1 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@1) (and (>= i@@1 0) (< i@@1 (seq.len v@@5)))) (= (seq.nth v@@5 i@@1) e)) (forall ((j Int) ) (!  (=> (and (and (|$IsValid'u64'| j) (>= j 0)) (< j i@@1)) (not (= (seq.nth v@@5 j) e)))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.603:17|
 :skolemid |18|
)))))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.599:15|
 :skolemid |19|
 :pattern ( (|$IndexOfVec'u8'| v@@5 e))
)))
(assert (forall ((v1 (Seq Int)) (v2 (Seq Int)) ) (! (= (= v1 v2) (= ($1_Hash_sha2 v1) ($1_Hash_sha2 v2)))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.776:15|
 :skolemid |20|
 :pattern ( ($1_Hash_sha2 v1) ($1_Hash_sha2 v2))
)))
(assert (forall ((v1@@0 (Seq Int)) (v2@@0 (Seq Int)) ) (! (= (= v1@@0 v2@@0) (= ($1_Hash_sha3 v1@@0) ($1_Hash_sha3 v2@@0)))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.792:15|
 :skolemid |21|
 :pattern ( ($1_Hash_sha3 v1@@0) ($1_Hash_sha3 v2@@0))
)))
(assert (forall ((k1 (Seq Int)) (k2 (Seq Int)) ) (!  (=> (= k1 k2) (= ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2)))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.839:15|
 :skolemid |22|
 :pattern ( ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2))
)))
(assert (forall ((s1 (Seq Int)) (s2 (Seq Int)) (k1@@0 (Seq Int)) (k2@@0 (Seq Int)) (m1 (Seq Int)) (m2 (Seq Int)) ) (!  (=> (and (and (= s1 s2) (= k1@@0 k2@@0)) (= m1 m2)) (= ($1_Signature_$ed25519_verify s1 k1@@0 m1) ($1_Signature_$ed25519_verify s2 k2@@0 m2)))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.842:15|
 :skolemid |23|
 :pattern ( ($1_Signature_$ed25519_verify s1 k1@@0 m1) ($1_Signature_$ed25519_verify s2 k2@@0 m2))
)))
(assert (forall ((v1@@1 |T@#0|) (v2@@1 |T@#0|) ) (! (= (= v1@@1 v2@@1) (= (|$1_BCS_serialize'#0'| v1@@1) (|$1_BCS_serialize'#0'| v2@@1)))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.869:15|
 :skolemid |24|
...
(assert (forall ((v@@6 |T@#0|) ) (! (let ((r@@0 (|$1_BCS_serialize'#0'| v@@6)))
 ...
 :qid |addressserializationconstantsizeSmtSeqz3bpl.874:15|
 :skolemid |25|
...
(assert (forall ((v1@@2 Int) (v2@@2 Int) ) (! (= (= v1@@2 v2@@2) (= (|$1_BCS_serialize'address'| v1@@2) (|$1_BCS_serialize'address'| v2@@2)))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.896:15|
 :skolemid |26|
...
(assert (forall ((v@@7 Int) ) (! (let ((r@@1 (|$1_BCS_serialize'address'| v@@7)))
 ...
 :qid |addressserializationconstantsizeSmtSeqz3bpl.901:15|
 :skolemid |27|
...
(= (seq.len r@@2) $serialized_address_len))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.915:15|
 :skolemid |28|
...
(assert (forall ((v@@9 (Seq Int)) ) (! (let ((r@@3 (ReverseVec_3283 v@@9)))
 ...
 :qid |addressserializationconstantsizeSmtSeqz3bpl.67:18|
 :skolemid |0|
 :pattern ( (seq.nth r@@3 i@@3))
))))
 :qid |addressserializationconstantsizeSmtSeqz3bpl.64:32|
 :skolemid |1|
 :pattern ( (ReverseVec_3283 v@@9))
)))
(assert (forall ((|l#0| Bool) (i@@4 Int) ) (! (= (|Select__T@[Int]Bool_| (|lambda#0| |l#0|) i@@4) |l#0|)
 :qid |addressserializationconstantsizeSmtSeqz3bpl.245:54|
 :skolemid |29|
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10381) (let ((anon7_Else_correct  (=> (not false) (=> (and (= call1formal@res@0 call1formal@res@0) (= call1formal@res@0@@0 call1formal@res@0@@0)) (and (=> (= (ControlFlow 0 10016) (- 0 10565)) (= (seq.len (|$1_BCS_serialize'#0'| _$t0)) (seq.len (|$1_BCS_serialize'#0'| _$t1)))) (=> (= (seq.len (|$1_BCS_serialize'#0'| _$t0)) (seq.len (|$1_BCS_serialize'#0'| _$t1))) (=> (= (ControlFlow 0 10016) (- 0 10580)) (= (seq.len call1formal@res@0) (seq.len call1formal@res@0@@0)))))))))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (and (not false) (= call1formal@res@0@@0 (|$1_BCS_serialize'#0'| _$t1))) (and (=> (= (ControlFlow 0 9964) 10030) anon7_Then_correct) (=> (= (ControlFlow 0 9964) 10016) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((anon0$1_correct  (=> (= _$t0 _$t0) (=> (and (= _$t1 _$t1) (= call1formal@res@0 (|$1_BCS_serialize'#0'| _$t0))) (and (=> (= (ControlFlow 0 9958) 10050) anon6_Then_correct) (=> (= (ControlFlow 0 9958) 9964) anon6_Else_correct))))))
(let ((anon0_correct  (=> (= (ControlFlow 0 10381) 9958) anon0$1_correct)))
anon0_correct)))))))
))
(check-sat)
