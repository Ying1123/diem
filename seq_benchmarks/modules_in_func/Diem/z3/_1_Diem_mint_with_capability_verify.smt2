...
(declare-fun $t17 () T@$Mutation_312314)
(declare-fun $t17@0 () T@$Mutation_312314)
...
(declare-fun $t7 () T@$Mutation_312314)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 894876) (let ((L7_correct  (=> (= $t36@0 (|$1_Diem_Diem'#0'| _$t0)) (=> (and (= $t36@0 $t36@0) (= $t37 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816))) (and (=> (= (ControlFlow 0 660391) (- 0 896884)) (not (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (not (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 660391) (- 0 896896)) (not (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t0) $MAX_U128))) (=> (not (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t0) $MAX_U128)) (and (=> (= (ControlFlow 0 660391) (- 0 896913)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 660391) (- 0 896923)) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816) (and (=> (= (ControlFlow 0 660391) (- 0 896931)) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816) (and (=> (= (ControlFlow 0 660391) (- 0 896939)) (= $t37 (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t0) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8)))) (=> (= $t37 (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t0) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))) (and (=> (= (ControlFlow 0 660391) (- 0 896957)) (= (|$value#$1_Diem_Diem'#0'| $t36@0) _$t0)) (=> (= (|$value#$1_Diem_Diem'#0'| $t36@0) _$t0) (and (=> (= (ControlFlow 0 660391) (- 0 896966)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr))))
 ...
 :qid |Diembpl.29257:15|
 :skolemid |1041|
)) (and (=> (= (ControlFlow 0 660391) (- 0 896995)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)))
 ...
 :qid |Diembpl.29262:15|
 :skolemid |1042|
)) (and (=> (= (ControlFlow 0 660391) (- 0 897020)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 660391) (- 0 897040)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3))))
 ...
 :qid |Diembpl.29272:15|
 :skolemid |1043|
)) (and (=> (= (ControlFlow 0 660391) (- 0 897069)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)))
 ...
 :qid |Diembpl.29277:15|
 :skolemid |1044|
)) (and (=> (= (ControlFlow 0 660391) (- 0 897094)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 660391) (- 0 897114)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 660391) (- 0 897134)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7))))
 ...
 :qid |Diembpl.29292:15|
 :skolemid |1045|
)) (and (=> (= (ControlFlow 0 660391) (- 0 897170)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9)))
 ...
 :qid |Diembpl.29297:15|
 :skolemid |1046|
)) (and (=> (= (ControlFlow 0 660391) (- 0 897195)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9)) (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9)) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@0)))) $EmptyEventStore)))
 ...
 :qid |Diembpl.2748:13|
 :skolemid |75|
))))) (=> (= (ControlFlow 0 660391) (- 0 897226)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
(let ((anon42_Else_correct  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 660732) (- 0 896603)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_255740 (|Store__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_312314| $t17@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_312314| $t17@2)) (|v#$Mutation_312314| $t17@2)))) (and (=> (= (ControlFlow 0 660732) (- 0 896651)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 ...
 :qid |Diembpl.29100:15|
 :skolemid |1034|
)) (and (=> (= (ControlFlow 0 660732) (- 0 896719)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 ...
 :qid |Diembpl.29106:15|
 :skolemid |1035|
)) (and (=> (= (ControlFlow 0 660732) (- 0 896742)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) dr_addr)))
 ...
 :qid |Diembpl.29112:15|
 :skolemid |1036|
)) (and (=> (= (ControlFlow 0 660732) (- 0 896766)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |Diembpl.3809:13|
 :skolemid |111|
 ...
 :qid |Diembpl.3809:13|
 :skolemid |111|
)))) (and (=> (= (ControlFlow 0 660732) (- 0 896790)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |Diembpl.3809:13|
 :skolemid |111|
 ...
 :qid |Diembpl.3809:13|
 :skolemid |111|
)))) (and (=> (= (ControlFlow 0 660732) (- 0 896814)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |Diembpl.3814:13|
 :skolemid |112|
 ...
 :qid |Diembpl.3814:13|
 :skolemid |112|
))) (=> (= $es@1 $es@0) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@1|) (= (ControlFlow 0 660732) 660391)) L7_correct))))))))))))))))))))))
(let ((anon41_Else_correct  (=> (not inline$$Not$0$dst@1) (and (=> (= (ControlFlow 0 659975) (- 0 896195)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_255740 (|Store__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_312314| $t17@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_312314| $t17@2)) (|v#$Mutation_312314| $t17@2)))) (and (=> (= (ControlFlow 0 659975) (- 0 896243)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1@@1 Int) (mint_cap_owner2@@1 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@1) (=> (|$IsValid'address'| mint_cap_owner2@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@1)) (= mint_cap_owner1@@1 mint_cap_owner2@@1))))
 ...
 :qid |Diembpl.29166:15|
 :skolemid |1038|
)) (and (=> (= (ControlFlow 0 659975) (- 0 896311)) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@13) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 ...
 :qid |Diembpl.29172:15|
 :skolemid |1039|
)) (and (=> (= (ControlFlow 0 659975) (- 0 896334)) (forall ((dr_addr@@1 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@1)))
 ...
 :qid |Diembpl.29178:15|
 :skolemid |1040|
)) (and (=> (= (ControlFlow 0 659975) (- 0 896358)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@5 Int) ) (!  (and (|$IsValid'address'| a@@5) (and ($1_Signer_is_txn_signer_addr a@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a@@5)) 1))))
 :qid |Diembpl.3809:13|
 :skolemid |111|
 ...
 :qid |Diembpl.3809:13|
 :skolemid |111|
)))) (and (=> (= (ControlFlow 0 659975) (- 0 896382)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@7 Int) ) (!  (and (|$IsValid'address'| a@@7) (and ($1_Signer_is_txn_signer_addr a@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a@@7)) 1))))
 :qid |Diembpl.3809:13|
 :skolemid |111|
 ...
 :qid |Diembpl.3809:13|
 :skolemid |111|
)))) (and (=> (= (ControlFlow 0 659975) (- 0 896406)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (exists ((a@@9 Int) ) (!  (and (|$IsValid'address'| a@@9) (and ($1_Signer_is_txn_signer_addr a@@9) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) a@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) a@@9)) 0))))
 :qid |Diembpl.3814:13|
 :skolemid |112|
 ...
 :qid |Diembpl.3814:13|
 :skolemid |112|
))) (=> (= $es@1 $es) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@0|) (= (ControlFlow 0 659975) 660391)) L7_correct))))))))))))))))))))))
(let ((L9_correct  (and (=> (= (ControlFlow 0 658941) (- 0 896515)) (or (or (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t0) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t0) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 658941) (- 0 896543)) (or (or (and (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= 1 $t13@0)) (and (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t0) $MAX_U128) (= 8 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t13@0))))))))
(let ((anon42_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t13@0 $abort_code@5) (= (ControlFlow 0 660746) 658941))) L9_correct)))
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_MintEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 660486) 660746) anon42_Then_correct) (=> (= (ControlFlow 0 660486) 660732) anon42_Else_correct)))))
(let ((anon41_Then_correct  (=> (and (and inline$$Not$0$dst@1 (= $t34@0 ($Mutation_240633 (|l#$Mutation_312314| $t17@2) (seq.++ (|p#$Mutation_312314| $t17@2) (seq.unit 8)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@2))))) (and (= $t35@0 ($1_Diem_MintEvent _$t0 $t14)) (= (ControlFlow 0 660492) 660486))) |inline$$1_Event_emit_event'$1_Diem_MintEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not $t32@0)) (and (=> (= (ControlFlow 0 659727) 660492) anon41_Then_correct) (=> (= (ControlFlow 0 659727) 659975) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (not $abort_flag@4) (= $t31@0 ($Mutation_13443 (|l#$Mutation_312314| $t17@1) (seq.++ (|p#$Mutation_312314| $t17@1) (seq.unit 0)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1))))) (=> (and (and (= $t31@1 ($Mutation_13443 (|l#$Mutation_13443| $t31@0) (|p#$Mutation_13443| $t31@0) inline$$AddU128$0$dst@2)) (= $t17@2 ($Mutation_312314 (|l#$Mutation_312314| $t17@1) (|p#$Mutation_312314| $t17@1) (|$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_13443| $t31@1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)))))) (and (= $t32@0 (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@2))) (= (ControlFlow 0 659733) 659727))) inline$$Not$0$anon0_correct))))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t13@0 $abort_code@5) (= (ControlFlow 0 660760) 658941))) L9_correct)))
(let ((inline$$AddU128$0$anon3_Then$1_correct  (=> (= $abort_code@5 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@4 true) (= inline$$AddU128$0$dst@2 inline$$AddU128$0$dst@0)) (and (=> (= (ControlFlow 0 659643) 660760) anon40_Then_correct) (=> (= (ControlFlow 0 659643) 659733) anon40_Else_correct))))))
(let ((inline$$AddU128$0$anon3_Then_correct  (=> (and (> (+ $t28@0 inline$$CastU128$1$dst@1) $MAX_U128) (= (ControlFlow 0 659641) 659643)) inline$$AddU128$0$anon3_Then$1_correct)))
(let ((inline$$AddU128$0$anon3_Else_correct  (=> (>= $MAX_U128 (+ $t28@0 inline$$CastU128$1$dst@1)) (=> (and (and (= inline$$AddU128$0$dst@1 (+ $t28@0 inline$$CastU128$1$dst@1)) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@4 $abort_flag@3) (= inline$$AddU128$0$dst@2 inline$$AddU128$0$dst@1))) (and (=> (= (ControlFlow 0 659589) 660760) anon40_Then_correct) (=> (= (ControlFlow 0 659589) 659733) anon40_Else_correct))))))
(let ((anon39_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 659649) 659641) inline$$AddU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 659649) 659589) inline$$AddU128$0$anon3_Else_correct)))))
(let ((anon39_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t13@0 $abort_code@4) (= (ControlFlow 0 660774) 658941))) L9_correct)))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_flag@3 true) (=> (and (= $abort_code@4 $EXEC_FAILURE_CODE) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 659482) 660774) anon39_Then_correct) (=> (= (ControlFlow 0 659482) 659649) anon39_Else_correct))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> _$t0 $MAX_U128) (= (ControlFlow 0 659480) 659482)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t0) (= $abort_flag@3 $abort_flag@2)) (and (= $abort_code@4 $abort_code@3) (= inline$$CastU128$1$dst@1 _$t0))) (and (=> (= (ControlFlow 0 659432) 660774) anon39_Then_correct) (=> (= (ControlFlow 0 659432) 659649) anon39_Else_correct)))))
(let ((anon38_Then_correct  (=> (and inline$$Ge$0$dst@1 (= $t28@0 (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)))) (and (=> (= (ControlFlow 0 659488) 659480) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 659488) 659432) inline$$CastU128$1$anon3_Else_correct)))))
(let ((anon38_Else_correct  (=> (not inline$$Ge$0$dst@1) (and (=> (= (ControlFlow 0 659353) (- 0 895882)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) 10000000000)) (=> (= $t27 $t27) (=> (and (= $t13@0 $t27) (= (ControlFlow 0 659353) 658941)) L9_correct)))))))
(let ((anon37_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t27) (= $t27 8)) (and (= $t27 $t27) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 659311) 659488) anon38_Then_correct) (=> (= (ControlFlow 0 659311) 659353) anon38_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= inline$$Sub$0$dst@2 inline$$CastU128$0$dst@1)) (= (ControlFlow 0 659275) 659311)) anon37_Else$1_correct)))
(let ((anon37_Else_correct  (=> (and (not $abort_flag@2) (= (ControlFlow 0 659281) 659275)) inline$$Ge$0$anon0_correct)))
(let ((anon37_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t13@0 $abort_code@3) (= (ControlFlow 0 660788) 658941))) L9_correct)))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 659221) 660788) anon37_Then_correct) (=> (= (ControlFlow 0 659221) 659281) anon37_Else_correct))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> _$t0 $MAX_U128) (= (ControlFlow 0 659219) 659221)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t0) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$CastU128$0$dst@1 _$t0))) (and (=> (= (ControlFlow 0 659171) 660788) anon37_Then_correct) (=> (= (ControlFlow 0 659171) 659281) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 659227) 659219) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 659227) 659171) inline$$CastU128$0$anon3_Else_correct)))))
(let ((anon36_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t13@0 $abort_code@2) (= (ControlFlow 0 660802) 658941))) L9_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 659088) 660802) anon36_Then_correct) (=> (= (ControlFlow 0 659088) 659227) anon36_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< 340282366920938463463374607431768211455 $t22@0) (= (ControlFlow 0 659086) 659088)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= $t22@0 340282366920938463463374607431768211455) (=> (and (and (= inline$$Sub$0$dst@1 (- 340282366920938463463374607431768211455 $t22@0)) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 659038) 660802) anon36_Then_correct) (=> (= (ControlFlow 0 659038) 659227) anon36_Else_correct))))))
(let ((anon35_Then_correct  (=> $t18@0 (=> (and (|$IsValid'u128'| 340282366920938463463374607431768211455) (= $t22@0 (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)))) (and (=> (= (ControlFlow 0 659094) 659086) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 659094) 659038) inline$$Sub$0$anon3_Else_correct))))))
(let ((anon35_Else_correct  (=> (not $t18@0) (and (=> (= (ControlFlow 0 658845) (- 0 895625)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1)) 10000000000)) (=> (= $t20 $t20) (=> (and (= $t13@0 $t20) (= (ControlFlow 0 658845) 658941)) L9_correct)))))))
(let ((anon34_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| (|v#$Mutation_312314| $t17@1)) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| |$temp_0'$1_Diem_CurrencyInfo'#0''@0|)) (and (= $t18@0 (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_312314| $t17@1))) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| $t20) (= $t20 1)) (and (= $t20 $t20) (= $t18@0 $t18@0)))) (and (=> (= (ControlFlow 0 658803) 659094) anon35_Then_correct) (=> (= (ControlFlow 0 658803) 658845) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t13@0 $abort_code@1) (= (ControlFlow 0 660816) 658941))) L9_correct)))
(let ((anon33_Then$1_correct  (=> (= $t17@1 $t17) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 660868) 660816) anon34_Then_correct) (=> (= (ControlFlow 0 660868) 658803) anon34_Else_correct))))))
(let ((anon33_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 660866) 660868)) anon33_Then$1_correct)))
(let ((anon33_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t17@0 ($Mutation_312314 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t17@1 $t17@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 658749) 660816) anon34_Then_correct) (=> (= (ControlFlow 0 658749) 658803) anon34_Else_correct))))))
(let ((anon32_Else_correct  (=> (not $t15) (=> (and (and (|$IsValid'vec'u8''| $t14) (= $t14 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t14 $t14) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 658727) (- 0 895458)) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (and (=> (= (ControlFlow 0 658727) 660866) anon33_Then_correct) (=> (= (ControlFlow 0 658727) 658749) anon33_Else_correct))))))))
(let ((anon32_Then_correct  (=> $t15 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t13)) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 660894) 658941))) L9_correct))))
(let ((anon31_Else_correct  (=> (and (not $t12) (= $t15  (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 658689) 660894) anon32_Then_correct) (=> (= (ControlFlow 0 658689) 658727) anon32_Else_correct)))))
(let ((anon31_Then_correct  (=> $t12 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t13)) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 660920) 658941))) L9_correct))))
(let ((anon0$1_correct  (=> (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@3 Int) (mint_cap_owner2@@3 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@3) (=> (|$IsValid'address'| mint_cap_owner2@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@3)) (= mint_cap_owner1@@3 mint_cap_owner2@@3))))
 ...
 :skolemid |1029|
))) (forall ((addr3@@3 Int) ) (!  (=> (|$IsValid'address'| addr3@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr3@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |Diembpl.28729:20|
 :skolemid |1030|
))) (=> (and (and (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.28733:20|
 :skolemid |1031|
)) (|$IsValid'u64'| _$t0)) (and (|$IsValid'$1_Diem_MintCapability'#0''| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0)))
...
)))) (=> (and (and (and (= $t8 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t9 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t10 (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t9)) (= $t11 ($1_Diem_MintEvent _$t0 (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t9))))) (and (and (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t12  (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 658671) 660920) anon31_Then_correct) (=> (= (ControlFlow 0 658671) 658689) anon31_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 658428) 658671)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (seq.len (|p#$Mutation_312314| $t7)) 0) (=> (and (and (= (seq.len (|p#$Mutation_312314| $t17)) 0) (= (seq.len (|p#$Mutation_13443| $t31)) 0)) (and (= (seq.len (|p#$Mutation_240633| $t34)) 0) (= (ControlFlow 0 658438) 658428))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 894876) 658438) anon0_correct)))
