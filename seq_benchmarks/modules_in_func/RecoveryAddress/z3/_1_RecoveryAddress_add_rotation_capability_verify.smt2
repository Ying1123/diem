...
(declare-fun $t20@0 () T@$Mutation_31869)
...
(declare-fun $t19 () T@$Mutation_59432)
(declare-fun $t19@0 () T@$Mutation_59432)
...
(declare-fun $t8 () T@$Mutation_31869)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 80801) (let ((anon30_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t19@2 ($Mutation_59432 (|l#$Mutation_59432| $t19@1) (|p#$Mutation_59432| $t19@1) ($1_RecoveryAddress_RecoveryAddress (|v#$Mutation_31869| |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1|)))) (= $1_RecoveryAddress_RecoveryAddress_$memory@0 ($Memory_47125 (|Store__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) (|a#$Global| (|l#$Mutation_59432| $t19@2)) true) (|Store__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) (|a#$Global| (|l#$Mutation_59432| $t19@2)) (|v#$Mutation_59432| $t19@2))))) (and (=> (= (ControlFlow 0 72708) (- 0 81819)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr)) 0)) addr))))
 :qid |RecoveryAddressbpl.5746:15|
 :skolemid |187|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@0) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@0))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@0)) 0)) addr@@0))))
 :qid |RecoveryAddressbpl.5746:15|
 :skolemid |187|
)) (and (=> (= (ControlFlow 0 72708) (- 0 81866)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@1)))
 :qid |RecoveryAddressbpl.5752:15|
 :skolemid |188|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@2)))
 :qid |RecoveryAddressbpl.5752:15|
 :skolemid |188|
)) (and (=> (= (ControlFlow 0 72708) (- 0 81890)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@3)))
 :qid |RecoveryAddressbpl.5758:15|
 :skolemid |189|
))) (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@4)))
 :qid |RecoveryAddressbpl.5758:15|
 :skolemid |189|
)) (and (=> (= (ControlFlow 0 72708) (- 0 81914)) (forall ((recovery_addr Int) (to_recovery_addr Int) ) (!  (=> (|$IsValid'address'| recovery_addr) (=> (|$IsValid'address'| to_recovery_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr) (=> (exists ((i@@24 Int) ) (!  (and (and (|$IsValid'u64'| i@@24) (and (<= 0 i@@24) (< i@@24 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr)) i@@24)) to_recovery_addr))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
)) (exists ((i@@25 Int) ) (!  (and (and (|$IsValid'u64'| i@@25) (and (<= 0 i@@25) (< i@@25 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr)) i@@25)) to_recovery_addr))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
))))))
 ...
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
)) (exists ((i@@27 Int) ) (!  (and (and (|$IsValid'u64'| i@@27) (and (<= 0 i@@27) (< i@@27 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr@@0)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr@@0)) i@@27)) to_recovery_addr@@0))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
))))))
 :qid |RecoveryAddressbpl.5764:15|
 :skolemid |190|
)) (and (=> (= (ControlFlow 0 72708) (- 0 81955)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@5) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) addr@@5))))
 :qid |RecoveryAddressbpl.5770:15|
 :skolemid |191|
))) (=> (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@6) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) addr@@6))))
 :qid |RecoveryAddressbpl.5770:15|
 :skolemid |191|
)) (=> (= $t27 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) _$t1)))) (and (=> (= (ControlFlow 0 72708) (- 0 81998)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (and (=> (= (ControlFlow 0 72708) (- 0 82009)) (not (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256))) (=> (not (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (and (=> (= (ControlFlow 0 72708) (- 0 82026)) (not (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) $t10)))))))) (=> (not (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) $t10))))))) (=> (= (ControlFlow 0 72708) (- 0 82040)) (= (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@0) _$t1)) (- $t27 1)) _$t0)))))))))))))))))))))))
(let ((anon24_Then_correct true))
(let ((L7_correct  (and (=> (= (ControlFlow 0 71963) (- 0 81683)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) $t10)))))))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) $t10))))))) (=> (= (ControlFlow 0 71963) (- 0 81714)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= 5 $t14@0)) (and (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256) (= 8 $t14@0))) (and (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) $t10)))))) (= 7 $t14@0))))))))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 72722) 71963))) L7_correct)))
(let ((|inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| ($Mutation_31869 (|l#$Mutation_31869| $t20@0) (|p#$Mutation_31869| $t20@0) (seq.++ (|v#$Mutation_31869| $t20@0) (seq.unit _$t0)))) (and (=> (= (ControlFlow 0 72411) 72722) anon30_Then_correct) (=> (= (ControlFlow 0 72411) 72708) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (and inline$$Lt$0$dst@1 (= (ControlFlow 0 72417) 72411)) |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|)))
(let ((anon29_Else_correct  (=> (and (and (not inline$$Lt$0$dst@1) (= $t26 $t26)) (and (= $t14@0 $t26) (= (ControlFlow 0 72356) 71963))) L7_correct)))
(let ((anon28_Else$1_correct  (=> (|$IsValid'u64'| 6) (=> (and (and (|$IsValid'u64'| $t26) (= $t26 8)) (and (= $t26 $t26) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 72340) 72417) anon29_Then_correct) (=> (= (ControlFlow 0 72340) 72356) anon29_Else_correct))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| 256)) (= (ControlFlow 0 72300) 72340)) anon28_Else$1_correct)))
(let ((anon28_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 256) (= (ControlFlow 0 72306) 72300)) inline$$Lt$0$anon0_correct))))
(let ((anon28_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 72736) 71963))) L7_correct)))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| (seq.len $t21@0)) (and (=> (= (ControlFlow 0 72240) 72736) anon28_Then_correct) (=> (= (ControlFlow 0 72240) 72306) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (not $abort_flag@0) (= $t20@0 ($Mutation_31869 (|l#$Mutation_59432| $t19@1) (seq.++ (|p#$Mutation_59432| $t19@1) (seq.unit 0)) (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|v#$Mutation_59432| $t19@1))))) (=> (and (and (= |$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@0| (|v#$Mutation_31869| $t20@0)) (= |$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@0| |$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@0|)) (and (= $t21@0 (|v#$Mutation_31869| $t20@0)) (= (ControlFlow 0 72246) 72240))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((anon27_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 72750) 71963))) L7_correct)))
(let ((anon26_Then$1_correct  (=> (= $t19@1 $t19) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 72802) 72750) anon27_Then_correct) (=> (= (ControlFlow 0 72802) 72246) anon27_Else_correct))))))
(let ((anon26_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= (ControlFlow 0 72800) 72802)) anon26_Then$1_correct)))
(let ((anon26_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1) (=> (and (and (= $t19@0 ($Mutation_59432 ($Global _$t1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (= $t19@1 $t19@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 72174) 72750) anon27_Then_correct) (=> (= (ControlFlow 0 72174) 72246) anon27_Else_correct))))))
(let ((anon25_Then_correct  (=> $t16 (and (=> (= (ControlFlow 0 72152) 72800) anon26_Then_correct) (=> (= (ControlFlow 0 72152) 72174) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (and (not $t16) (= $t18 $t18)) (and (= $t14@0 $t18) (= (ControlFlow 0 72148) 71963))) L7_correct)))
(let ((anon24_Else_correct  (=> (and (and (and (not false) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (= $t16  (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)))))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t18) (= $t18 7)) (and (= $t18 $t18) (= $t16 $t16)))) (and (=> (= (ControlFlow 0 72132) 72152) anon25_Then_correct) (=> (= (ControlFlow 0 72132) 72148) anon25_Else_correct)))))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t0)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 72060) 72816) anon24_Then_correct) (=> (= (ControlFlow 0 72060) 72132) anon24_Else_correct))))))
(let ((anon23_Then_correct  (=> (and $t11@0 (= (ControlFlow 0 72066) 72060)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct)))
(let ((anon23_Else_correct  (=> (and (and (not $t11@0) (= $t13 $t13)) (and (= $t14@0 $t13) (= (ControlFlow 0 71855) 71963))) L7_correct)))
(let ((anon0$1_correct  (=> (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |RecoveryAddressbpl.5471:20|
 :skolemid |179|
)) (=> (and (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (= (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) addr@@7)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_43878| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_43878| $1_Roles_RoleId_$memory) addr@@7)) 5))))
 :qid |RecoveryAddressbpl.5475:20|
 :skolemid |180|
)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (= (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) addr@@8)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_43878| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_43878| $1_Roles_RoleId_$memory) addr@@8)) 6))))
 :qid |RecoveryAddressbpl.5479:20|
 :skolemid |181|
))) (=> (and (and (and (and (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@9) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@9))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@9)) 0)) addr@@9))))
 :qid |RecoveryAddressbpl.5483:20|
 :skolemid |182|
)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@10) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) addr@@10))))
 :qid |RecoveryAddressbpl.5487:20|
 :skolemid |183|
))) (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| _$t0) (|$IsValid'address'| _$t1))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) $a_0)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc))
 :qid |RecoveryAddressbpl.5496:20|
 :skolemid |184|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_45801| $1_VASP_ParentVASP_$memory) $a_0@@0)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@0))
 :qid |RecoveryAddressbpl.5500:20|
 :skolemid |185|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_45801| $1_VASP_ParentVASP_$memory) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@1)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@1))
 :qid |RecoveryAddressbpl.5504:20|
 :skolemid |186|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@1))
)) (= $t10 (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t0))))) (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t11@0 (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| $t13) (= $t13 5)) (and (= $t13 $t13) (= $t11@0 $t11@0))))) (and (=> (= (ControlFlow 0 71839) 72066) anon23_Then_correct) (=> (= (ControlFlow 0 71839) 71855) anon23_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_28061_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |RecoveryAddressbpl.1832:13|
 :skolemid |49|
))) (= (ControlFlow 0 71538) 71839)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (seq.len (|p#$Mutation_31869| $t8)) 0) (= (seq.len (|p#$Mutation_59432| $t19)) 0)) (and (= (seq.len (|p#$Mutation_31869| $t20)) 0) (= (ControlFlow 0 71548) 71538))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 80801) 71548) anon0_correct)))
