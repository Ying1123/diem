...
(declare-fun $t7@0 () T@$Mutation_100577)
...
(declare-fun $t4 () T@$Mutation_100577)
(declare-fun $t7 () T@$Mutation_100577)
(declare-fun $t9 () T@$Mutation_100577)
(push 1)
(set-info :boogie-vc-id $1_DualAttestation_dual_attestation_message$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 289623) (let ((anon16_Else_correct  (=> (and (and (not false) (= $t3@2 (|v#$Mutation_100577| |inline$$1_Vector_append'u8'$2$m'@1|))) (and (= $t3@2 $t3@2) (= (ControlFlow 0 214390) (- 0 290152)))) (not false))))
(let ((anon16_Then_correct true))
(let ((|inline$$1_Vector_append'u8'$2$anon0_correct|  (=> (= |inline$$1_Vector_append'u8'$2$m'@1| ($Mutation_100577 (|l#$Mutation_100577| $t9@0) (|p#$Mutation_100577| $t9@0) (seq.++ (|v#$Mutation_100577| $t9@0) $t10@0))) (and (=> (= (ControlFlow 0 214352) 214404) anon16_Then_correct) (=> (= (ControlFlow 0 214352) 214390) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not false) (= $t3@1 (|v#$Mutation_100577| |inline$$1_Vector_append'u8'$1$m'@1|))) (=> (and (and (= $t9@0 ($Mutation_100577 ($Local 3) (as seq.empty (Seq Int)) $t3@1)) (= $t10@0 (seq.++ (seq.++ (seq.++ (seq.++ (seq.++ (seq.++ (seq.++ (seq.unit 64) (seq.unit 64)) (seq.unit 36)) (seq.unit 36)) (seq.++ (seq.++ (seq.++ (seq.unit 68) (seq.unit 73)) (seq.unit 69)) (seq.unit 77))) (seq.++ (seq.++ (seq.++ (seq.unit 95) (seq.unit 65)) (seq.unit 84)) (seq.unit 84))) (seq.++ (seq.++ (seq.++ (seq.unit 69) (seq.unit 83)) (seq.unit 84)) (seq.unit 36))) (seq.++ (seq.++ (seq.unit 36) (seq.unit 64)) (seq.unit 64))))) (and (|$IsValid'vec'u8''| $t10@0) (= (ControlFlow 0 214358) 214352))) |inline$$1_Vector_append'u8'$2$anon0_correct|))))
(let ((anon15_Then_correct true))
(let ((|inline$$1_Vector_append'u8'$1$anon0_correct|  (=> (= |inline$$1_Vector_append'u8'$1$m'@1| ($Mutation_100577 (|l#$Mutation_100577| $t7@0) (|p#$Mutation_100577| $t7@0) (seq.++ (|v#$Mutation_100577| $t7@0) call1formal@res@0))) (and (=> (= (ControlFlow 0 214211) 214428) anon15_Then_correct) (=> (= (ControlFlow 0 214211) 214358) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not false) (= (ControlFlow 0 214217) 214211)) |inline$$1_Vector_append'u8'$1$anon0_correct|)))
(let ((anon14_Then_correct true))
(let ((anon13_Else_correct  (=> (and (and (not false) (= $t3@0 (|v#$Mutation_100577| |inline$$1_Vector_append'u8'$0$m'@1|))) (and (= $t7@0 ($Mutation_100577 ($Local 3) (as seq.empty (Seq Int)) $t3@0)) (= call1formal@res@0 (|$1_BCS_serialize'u64'| _$t2)))) (and (=> (= (ControlFlow 0 214154) 214442) anon14_Then_correct) (=> (= (ControlFlow 0 214154) 214217) anon14_Else_correct)))))
...
(let ((anon12_Else_correct  (=> (and (not false) (= (ControlFlow 0 214130) 214124)) |inline$$1_Vector_append'u8'$0$anon0_correct|)))
(let ((anon12_Then_correct true))
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (and (|$IsValid'vec'u8''| _$t1) (|$IsValid'u64'| _$t2)) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (= _$t2 _$t2) (= _$t1 _$t1)) (and (= $t4@0 ($Mutation_100577 ($Local 3) (as seq.empty (Seq Int)) _$t1)) (= call1formal@res@0@@0 (|$1_BCS_serialize'address'| _$t0))))) (and (=> (= (ControlFlow 0 214067) 214470) anon12_Then_correct) (=> (= (ControlFlow 0 214067) 214130) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2431:13|
 :skolemid |69|
))) (= (ControlFlow 0 214001) 214067)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (seq.len (|p#$Mutation_100577| $t4)) 0) (= (seq.len (|p#$Mutation_100577| $t7)) 0)) (and (= (seq.len (|p#$Mutation_100577| $t9)) 0) (= (ControlFlow 0 214011) 214001))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 289623) 214011) anon0_correct)))
