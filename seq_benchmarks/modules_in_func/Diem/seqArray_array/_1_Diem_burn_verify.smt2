...
(assert (not
 (=> (= (ControlFlow 0 0) 1087700) (let ((anon15_Else_correct@@0  (=> (not $abort_flag@7) (and (=> (= (ControlFlow 0 727322) (- 0 1091816)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@16))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@16)))) (and (=> (= (ControlFlow 0 727322) (- 0 1091829)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7))) (and (=> (= (ControlFlow 0 727322) (- 0 1091840)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7))) (and (=> (= (ControlFlow 0 727322) (- 0 1091851)) (not (let (($range_0@@3 ($Range 0 (|l#Vec_276448| $t7@@4))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@100 $i_1@@3))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t7@@4) i@@100)))) _$t2))))
 :qid |Diembpl.12777:57|
 :skolemid |586|
))))) (=> (not (let (($range_0@@4 ($Range 0 (|l#Vec_276448| $t7@@4))))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((i@@101 $i_1@@4))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t7@@4) i@@101)))) _$t2))))
 :qid |Diembpl.12777:57|
 :skolemid |586|
)))) (and (=> (= (ControlFlow 0 727322) (- 0 1091898)) (not (= $t8@@7 0))) (=> (not (= $t8@@7 0)) (and (=> (= (ControlFlow 0 727322) (- 0 1091909)) (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t9@@7) $t8@@7))) (=> (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t9@@7) $t8@@7)) (and (=> (= (ControlFlow 0 727322) (- 0 1091922)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t9@@7) $t8@@7))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t9@@7) $t8@@7)) (and (=> (= (ControlFlow 0 727322) (- 0 1091935)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 727322) (- 0 1091945)) (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t10@@1))))) (=> (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t10@@1)))) (and (=> (= (ControlFlow 0 727322) (- 0 1091968)) (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t10@@1))))) (=> (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t10@@1)))) (and (=> (= (ControlFlow 0 727322) (- 0 1091991)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) _$t1@@7))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) _$t1@@7)) (and (=> (= (ControlFlow 0 727322) (- 0 1092004)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 727322) (- 0 1092024)) (forall ((addr@@385 Int) ) (!  (=> (|$IsValid'address'| addr@@385) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@385)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@385))))
 :qid |Diembpl.12823:15|
 :skolemid |587|
))) (=> (forall ((addr@@386 Int) ) (!  (=> (|$IsValid'address'| addr@@386) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@386)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@386))))
 :qid |Diembpl.12823:15|
 :skolemid |587|
)) (and (=> (= (ControlFlow 0 727322) (- 0 1092053)) (forall ((addr@@387 Int) ) (!  (=> (|$IsValid'address'| addr@@387) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@387) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@387)))
 :qid |Diembpl.12828:15|
 :skolemid |588|
))) (=> (forall ((addr@@388 Int) ) (!  (=> (|$IsValid'address'| addr@@388) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@388) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@388)))
 :qid |Diembpl.12828:15|
 :skolemid |588|
)) (and (=> (= (ControlFlow 0 727322) (- 0 1092078)) (forall ((addr@@389 Int) ) (!  (=> (|$IsValid'address'| addr@@389) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@389)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@389))))
 :qid |Diembpl.12833:15|
 :skolemid |589|
))) (=> (forall ((addr@@390 Int) ) (!  (=> (|$IsValid'address'| addr@@390) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@390)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@390))))
 :qid |Diembpl.12833:15|
 :skolemid |589|
)) (and (=> (= (ControlFlow 0 727322) (- 0 1092107)) (forall ((addr@@391 Int) ) (!  (=> (|$IsValid'address'| addr@@391) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@391) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@391)))
 :qid |Diembpl.12838:15|
 :skolemid |590|
))) (=> (forall ((addr@@392 Int) ) (!  (=> (|$IsValid'address'| addr@@392) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@392) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@392)))
 :qid |Diembpl.12838:15|
 :skolemid |590|
)) (and (=> (= (ControlFlow 0 727322) (- 0 1092132)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 727322) (- 0 1092152)) (forall ((addr@@393 Int) ) (!  (=> (|$IsValid'address'| addr@@393) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@393) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@393))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) addr@@393))))
 :qid |Diembpl.12848:15|
 :skolemid |591|
))) (=> (forall ((addr@@394 Int) ) (!  (=> (|$IsValid'address'| addr@@394) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@394) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@394))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) addr@@394))))
 :qid |Diembpl.12848:15|
 :skolemid |591|
)) (and (=> (= (ControlFlow 0 727322) (- 0 1092187)) (forall ((addr@@395 Int) ) (!  (=> (|$IsValid'address'| addr@@395) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@395) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) addr@@395)))
 :qid |Diembpl.12853:15|
 :skolemid |592|
))) (=> (forall ((addr@@396 Int) ) (!  (=> (|$IsValid'address'| addr@@396) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@396) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@4|) addr@@396)))
 :qid |Diembpl.12853:15|
 :skolemid |592|
)) (and (=> (= (ControlFlow 0 727322) (- 0 1092211)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory@7|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 727322) (- 0 1092231)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@5) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@5) (|streams#$EventStore| $es)))))
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11@@0)) (let ((stream@@26 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t13@@0)))
(let ((stream_new (let ((len (|l#Multiset_275813| stream@@26)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@26) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12@@0 _$t1@@7)))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@26) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12@@0 _$t1@@7)) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t13@@0 stream_new)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@27 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| expected) handle@@27)) (|l#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| actual) handle@@27))) (forall ((v@@74 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| expected) handle@@27)) v@@74) (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| actual) handle@@27)) v@@74))
 :qid |Diembpl.164:13|
 :skolemid |5|
)))
 :qid |Diembpl.2780:13|
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11@@0)) (let ((stream@@27 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t13@@0)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_275813| stream@@27)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@27) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12@@0 _$t1@@7)))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@27) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12@@0 _$t1@@7)) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t13@@0 stream_new@@0)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@28 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| expected@@0) handle@@28)) (|l#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| actual@@0) handle@@28))) (forall ((v@@75 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| expected@@0) handle@@28)) v@@75) (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| actual@@0) handle@@28)) v@@75))
 :qid |Diembpl.164:13|
 :skolemid |5|
)))
 :qid |Diembpl.2780:13|
 :skolemid |99|
))))) (=> (= (ControlFlow 0 727322) (- 0 1092272)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@5) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@5) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11@@0)) (let ((stream@@28 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t13@@0)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_275813| stream@@28)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@28) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12@@0 _$t1@@7)))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@28) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2)))) $t12@@0 _$t1@@7)) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $EmptyEventStore) $t13@@0 stream_new@@1)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@29 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| actual@@1) handle@@29)) (|l#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| expected@@1) handle@@29))) (forall ((v@@76 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| actual@@1) handle@@29)) v@@76) (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| expected@@1) handle@@29)) v@@76))
 :qid |Diembpl.164:13|
 :skolemid |5|
)))
 :qid |Diembpl.2780:13|
...
(let ((L3_correct@@3  (and (=> (= (ControlFlow 0 722365) (- 0 1091540)) (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@16))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7))) (let (($range_0@@5 ($Range 0 (|l#Vec_276448| $t7@@4))))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((i@@102 $i_1@@5))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t7@@4) i@@102)))) _$t2))))
 :qid |Diembpl.12880:283|
 :skolemid |593|
)))) (= $t8@@7 0)) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t9@@7) $t8@@7)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t9@@7) $t8@@7)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@16))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7))) (let (($range_0@@6 ($Range 0 (|l#Vec_276448| $t7@@4))))
(forall (($i_1@@6 Int) ) (!  (=> ($InRange $range_0@@6 $i_1@@6) (let ((i@@103 $i_1@@6))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t7@@4) i@@103)))) _$t2))))
 :qid |Diembpl.12880:283|
 :skolemid |593|
)))) (= $t8@@7 0)) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t9@@7) $t8@@7)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t9@@7) $t8@@7)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 722365) (- 0 1091643)) (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0@@16))) (= 4 $t18@0@@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7)) (= 5 $t18@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7)) (= 5 $t18@0@@0))) (and (let (($range_0@@7 ($Range 0 (|l#Vec_276448| $t7@@4))))
(forall (($i_1@@7 Int) ) (!  (=> ($InRange $range_0@@7 $i_1@@7) (let ((i@@104 $i_1@@7))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| $t7@@4) i@@104)))) _$t2))))
 :qid |Diembpl.12885:368|
 :skolemid |594|
))) (= 1 $t18@0@@0))) (and (= $t8@@7 0) (= 1 $t18@0@@0))) (and (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t9@@7) $t8@@7) (= 8 $t18@0@@0))) (and (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t9@@7) $t8@@7) (= 8 $t18@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t18@0@@0))))))))
(let ((anon15_Then_correct@@0  (=> (and (and $abort_flag@7 (= $abort_code@8 $abort_code@8)) (and (= $t18@0@@0 $abort_code@8) (= (ControlFlow 0 727336) 722365))) L3_correct@@3)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|  (=> (= $abort_code@8 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1|) (=> (and (and (= $es@5 $es@4) (= |$1_Diem_CurrencyInfo'#0'_$memory@7| |$1_Diem_CurrencyInfo'#0'_$memory@6|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@4| |$1_Diem_PreburnQueue'#0'_$memory@3|) (= $abort_flag@7 true))) (and (=> (= (ControlFlow 0 726680) 727336) anon15_Then_correct@@0) (=> (= (ControlFlow 0 726680) 727322) anon15_Else_correct@@0))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon13_Then_correct|  (=> |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0| (=> (and (and (and (> (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) 0) (= 7 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 726674) 726680)))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|  (=> $abort_flag@6 (=> (and (= $abort_code@7 $abort_code@7) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| $abort_code@7)) (=> (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 726694) 726680))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon10_Then_correct|  (=> (and (and (and |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0| (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7)) (= 5 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)) (and (let ((|inline$$1_Diem_burn_with_capability'#0'$0$$range_0| ($Range 0 (|l#Vec_276448| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'#0'$0$$i_1| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'#0'$0$$range_0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1|) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$i| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1|))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|) |inline$$1_Diem_burn_with_capability'#0'$0$i|)))) _$t2))))
 :qid |unknown.0:0|
 :skolemid |716|
))) (= 1 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@4 $es) (= (ControlFlow 0 726787) 726680)))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon13_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0|) (= $abort_code@8 $abort_code@7)) (=> (and (and (= $es@5 $es@3) (= |$1_Diem_CurrencyInfo'#0'_$memory@7| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@4| |$1_Diem_PreburnQueue'#0'_$memory@2|) (= $abort_flag@7 $abort_flag@6))) (and (=> (= (ControlFlow 0 726646) 727336) anon15_Then_correct@@0) (=> (= (ControlFlow 0 726646) 727322) anon15_Else_correct@@0))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|  (=> (not $abort_flag@6) (=> (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t3@1| (|v#$Mutation_376858| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t3@1|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0| (> (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) 0)))) (and (=> (= (ControlFlow 0 726638) 726674) |inline$$1_Diem_burn_with_capability'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 726638) 726646) |inline$$1_Diem_burn_with_capability'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|  (=> (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| (|v#$Mutation_376858| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1|)) (=> (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2|) (= |$1_Diem_CurrencyInfo'#0'_$memory@5| |$1_Diem_CurrencyInfo'#0'_$memory@4|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1|) (= $abort_code@7 $abort_code@6)) (and (= $abort_flag@6 $abort_flag@5) (= $es@3 $es@2))) (and (=> (= (ControlFlow 0 726279) 726694) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 726279) 726638) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Else_correct|  (=> (not $abort_flag@5) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@3| ($Memory_335624 (|Store__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)))) (= $es@2 $es@0)) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@4| |$1_Diem_CurrencyInfo'#0'_$memory@3|) (= (ControlFlow 0 726404) 726279))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Else_correct|  (=> (not inline$$Not$0$dst@1@@3) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_335624 (|Store__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)))) (= $es@2 $es)) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@4| |$1_Diem_CurrencyInfo'#0'_$memory@1|) (= (ControlFlow 0 726265) 726279))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|  (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@5| |$1_Diem_CurrencyInfo'#0'_$memory@2|) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@0|) (= $abort_code@7 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1|)) (and (= $abort_flag@6 true) (= $es@3 $es@1))) (and (=> (= (ControlFlow 0 725195) 726694) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 725195) 726638) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Then_correct|  (=> (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@6) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es@0) (= (ControlFlow 0 726418) 725195))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| (|v#$Mutation_306796| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1|)) (= $es@0 (let ((stream@@29 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_275813| stream@@29)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@29) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1|))))
(Multiset_275813 (|Store__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@29) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1|) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 726376) 726418) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Then_correct|) (=> (= (ControlFlow 0 726376) 726404) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Then_correct|  (=> (and (and inline$$Not$0$dst@1@@3 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1| ($Mutation_306796 (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|) (let ((l@@1 (|l#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) l@@1 9) (+ l@@1 1))) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1| ($1_Diem_BurnEvent |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| _$t1@@7)) (= (ControlFlow 0 726382) 726376))) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct@@3  (=> (= inline$$Not$0$dst@1@@3  (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t50@1|)) (and (=> (= (ControlFlow 0 726237) 726382) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Then_correct|) (=> (= (ControlFlow 0 726237) 726265) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|  (=> (and (not $abort_flag@5) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1| ($Mutation_13929 (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (let ((l@@2 (|l#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) l@@2 1) (+ l@@2 1))) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@2| ($Mutation_13929 (|l#$Mutation_13929| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1|) (|p#$Mutation_13929| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1|) inline$$Sub$1$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4| ($Mutation_401221 (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (|p#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|v#$Mutation_13929| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@2|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t50@1| (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|))) (= (ControlFlow 0 726243) 726237))) inline$$Not$0$anon0_correct@@3))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|  (=> (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@6) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 726432) 725195))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$Sub$1$anon3_Then$1_correct  (=> (= $abort_flag@5 true) (=> (and (= $abort_code@6 $EXEC_FAILURE_CODE) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@0)) (and (=> (= (ControlFlow 0 726153) 726432) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 726153) 726243) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|))))))
(let ((inline$$Sub$1$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= (ControlFlow 0 726151) 726153)) inline$$Sub$1$anon3_Then$1_correct)))
(let ((inline$$Sub$1$anon3_Else_correct  (=> (<= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1|) (=> (and (and (= inline$$Sub$1$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|)) (= $abort_flag@5 $abort_flag@4)) (and (= $abort_code@6 $abort_code@5) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@1))) (and (=> (= (ControlFlow 0 726103) 726432) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 726103) 726243) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Then_correct|  (=> (and inline$$Ge$1$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))) (and (=> (= (ControlFlow 0 726159) 726151) inline$$Sub$1$anon3_Then_correct) (=> (= (ControlFlow 0 726159) 726103) inline$$Sub$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Else_correct|  (=> (not inline$$Ge$1$dst@1) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_335624 (|Store__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@0|)) (and (= $es@1 $es) (= (ControlFlow 0 726012) 725195))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else$1_correct|  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= inline$$Ge$1$dst@1 inline$$Ge$1$dst@1))) (and (=> (= (ControlFlow 0 725984) 726159) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Then_correct|) (=> (= (ControlFlow 0 725984) 726012) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Else_correct|))))))
(let ((inline$$Ge$1$anon0_correct  (=> (and (= inline$$Ge$1$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t43@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|)) (= (ControlFlow 0 725948) 725984)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|  (=> (and (not $abort_flag@4) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1| ($Mutation_13929 (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (let ((l@@3 (|l#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) l@@3 0) (+ l@@3 1))) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@2| ($Mutation_13929 (|l#$Mutation_13929| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1|) (|p#$Mutation_13929| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1|) inline$$Sub$0$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3| ($Mutation_401221 (|l#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (|p#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (|$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_13929| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@2|) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t43@1| (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|))) (= (ControlFlow 0 725954) 725948))) inline$$Ge$1$anon0_correct))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|  (=> (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@5) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 726446) 725195))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_code@5 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@4 true) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 725854) 726446) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 725854) 725954) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| inline$$CastU128$1$dst@1) (= (ControlFlow 0 725852) 725854)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1|) (=> (and (and (= inline$$Sub$0$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| inline$$CastU128$1$dst@1)) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@4 $abort_flag@3) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 725804) 726446) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 725804) 725954) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 725860) 725852) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 725860) 725804) inline$$Sub$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|  (=> (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@4) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 726460) 725195))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_flag@3 true) (=> (and (= $abort_code@4 $EXEC_FAILURE_CODE) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 725709) 726460) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 725709) 725860) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 725707) 725709)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= $abort_flag@3 $abort_flag@2@@2)) (and (= $abort_code@4 $abort_code@3@@2) (= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|))) (and (=> (= (ControlFlow 0 725659) 726460) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 725659) 725860) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Then_correct|  (=> (and inline$$Ge$0$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)))) (and (=> (= (ControlFlow 0 725715) 725707) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 725715) 725659) inline$$CastU128$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Else_correct|  (=> (and (not inline$$Ge$0$dst@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 725580) 725195))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else$1_correct|  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 725564) 725715) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Then_correct|) (=> (= (ControlFlow 0 725564) 725580) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Else_correct|))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t34@1| inline$$CastU128$0$dst@1)) (= (ControlFlow 0 725528) 725564)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|  (=> (and (not $abort_flag@2@@2) (= (ControlFlow 0 725534) 725528)) inline$$Ge$0$anon0_correct)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|  (=> (and $abort_flag@2@@2 (= $abort_code@3@@2 $abort_code@3@@2)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@3@@2) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 726474) 725195))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_code@3@@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2@@2 true) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 725474) 726474) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 725474) 725534) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 725472) 725474)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= $abort_code@3@@2 $abort_code@2@@2)) (and (= $abort_flag@2@@2 $abort_flag@1@@2) (= inline$$CastU128$0$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|))) (and (=> (= (ControlFlow 0 725424) 726474) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 725424) 725534) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|  (=> (and (and (not $abort_flag@1@@2) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t34@1| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))) (and (=> (= (ControlFlow 0 725480) 725472) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 725480) 725424) inline$$CastU128$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|  (=> (and $abort_flag@1@@2 (= $abort_code@2@@2 $abort_code@2@@2)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@2@@2) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 726488) 725195))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then$1_correct|  (=> (= $abort_flag@1@@2 true) (=> (and (= $abort_code@2@@2 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0|)) (and (=> (= (ControlFlow 0 726540) 726488) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 726540) 725480) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 726538) 726540)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1| ($Mutation_401221 ($Global 173345816) (Vec_28308 (MapConstVec_13534 DefaultVecElem_13534) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $abort_flag@1@@2 $abort_flag@0@@8)) (and (= $abort_code@2@@2 $abort_code@1@@8) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1|))) (and (=> (= (ControlFlow 0 725329) 726488) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 725329) 725480) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 725307) 726538) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then_correct|) (=> (= (ControlFlow 0 725307) 725329) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 726566) 725195)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Then_correct|  (=> inline$$Gt$0$dst@1@@0 (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1| ($Mutation_401271 (|l#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (let ((l@@4 (|l#Vec_28308| (|p#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)) l@@4 0) (+ l@@4 1))) (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1| (|v#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2| ($Mutation_401271 (|l#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|) (|p#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|) |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Diem'#0''@1|)) (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)))) (=> (and (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)) (|$IsValid'$1_Diem_Diem'#0''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|)) (and (= (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|) (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1|)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)) 0))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1| ($Mutation_376858 (|l#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (|p#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (|$1_Diem_Preburn'#0'| (|v#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 725293) 726566) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Then_correct|) (=> (= (ControlFlow 0 725293) 725307) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Else_correct|  (=> (and (not inline$$Gt$0$dst@1@@0) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 725189) 725195))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else$1_correct|  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| 1)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= inline$$Gt$0$dst@1@@0 inline$$Gt$0$dst@1@@0))) (and (=> (= (ControlFlow 0 725173) 725293) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Then_correct|) (=> (= (ControlFlow 0 725173) 725189) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Else_correct|))))))
(let ((inline$$Gt$0$anon0_correct@@0  (=> (and (= inline$$Gt$0$dst@1@@0 (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t22@1| 0)) (= (ControlFlow 0 725137) 725173)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else_correct|  (=> (and (and (and (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0|) (|$IsValid'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0|)) (and (|$IsEqual'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0|))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t21@1| (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t22@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t21@1|))) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 725143) 725137)))) inline$$Gt$0$anon0_correct@@0)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 726592) 725195)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon0_correct|  (=> (= (|l#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t10@0|)) 0) (=> (and (and (and (and (= (|l#Vec_28308| (|p#$Mutation_401271| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@0|)) 0) (= (|l#Vec_28308| (|p#$Mutation_401221| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0|)) 0)) (and (= (|l#Vec_28308| (|p#$Mutation_13929| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@0|)) 0) (= (|l#Vec_28308| (|p#$Mutation_13929| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@0|)) 0))) (and (and (= (|l#Vec_28308| (|p#$Mutation_306796| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@0|)) 0) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t12@0| (|v#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t13@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t12@0|))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t14@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t15@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t16@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t17@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t15@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1| (|v#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1|) (= _$t1@@7 _$t1@@7)) (and (= $t19@1 $t19@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))) (and (=> (= (ControlFlow 0 725055) 726592) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Then_correct|) (=> (= (ControlFlow 0 725055) 725143) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|  (=> (and (|$IsValid'$1_Diem_PreburnWithMetadata'#0''| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t1@@7))) (=> (and (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|))) _$t2) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t18@1| (|$metadata#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1|))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1| ($Mutation_376858 ($Local 3) (Vec_28308 (MapConstVec_13534 DefaultVecElem_13534) 0) |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t20@0| (|v#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t21@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t20@0|))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t22@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t23@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t24@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t25@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t23@0|)) (= (ControlFlow 0 726598) 725055)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon0_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon11_Else_correct|  (=> (and (and (not |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'bool'@1|) (= |$1_Diem_PreburnQueue'#0'_$memory@1| ($Memory_316949 (|Store__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7 false) (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@1|) (= (ControlFlow 0 723495) 726598))) |inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon11_Then_correct|  (=> (and (and |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'bool'@1| (= |$1_Diem_PreburnQueue'#0'_$memory@0@@0| ($Memory_316949 (|Store__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7 true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7 |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'$1_Diem_PreburnQueue'#0''@1|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@0@@0|) (= (ControlFlow 0 726706) 726598))) |inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon10_Else_correct|  (=> (not |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0|) (and (=> (= (ControlFlow 0 723483) 726706) |inline$$1_Diem_burn_with_capability'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 723483) 723495) |inline$$1_Diem_burn_with_capability'#0'$0$anon11_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon0_correct|  (=> (and (= (|l#Vec_28308| (|p#$Mutation_376858| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@0|)) 0) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t6@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t7@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t8@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t9@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7))))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t10@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t8@0|))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t12@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= _$t1@@7 _$t1@@7))) (and (and (= $t19@1 $t19@1) (= _$t2 _$t2)) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0|  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7)) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$$range_0@@0| ($Range 0 (|l#Vec_276448| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'#0'$0$$range_0@@0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0|) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$i@@0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0|))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|) |inline$$1_Diem_burn_with_capability'#0'$0$i@@0|)))) _$t2))))
 :qid |unknown.0:0|
 :skolemid |715|
)))))))) (and (=> (= (ControlFlow 0 723475) 726787) |inline$$1_Diem_burn_with_capability'#0'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 723475) 723483) |inline$$1_Diem_burn_with_capability'#0'$0$anon10_Else_correct|)))))))
(let ((anon14_Else_correct@@1  (=> (and (not $abort_flag@0@@8) (= $t20 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (and (and (and (= $t21 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t22 (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t20))) (and (= $t23 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= $t24@@0 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7))))) (and (and (= $t25@@0 (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t23))) (= $t26@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t27 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= (ControlFlow 0 726791) 723475)))) |inline$$1_Diem_burn_with_capability'#0'$0$anon0_correct|))))
(let ((anon14_Then_correct@@1  (=> (and (and $abort_flag@0@@8 (= $abort_code@1@@8 $abort_code@1@@8)) (and (= $t18@0@@0 $abort_code@1@@8) (= (ControlFlow 0 727350) 722365))) L3_correct@@3)))
(let ((anon13_Then$1_correct  (=> (= $t19@1 $t19) (=> (and (= $abort_flag@0@@8 true) (= $abort_code@1@@8 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 727402) 727350) anon14_Then_correct@@1) (=> (= (ControlFlow 0 727402) 726791) anon14_Else_correct@@1))))))
(let ((anon13_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t14)) (= (ControlFlow 0 727400) 727402)) anon13_Then$1_correct)))
(let ((anon13_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t14) (=> (and (and (= $t19@0@@0 (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t14)) (= $t19@1 $t19@0@@0)) (and (= $abort_flag@0@@8 false) (= $abort_code@1@@8 $abort_code@0@@8))) (and (=> (= (ControlFlow 0 722385) 727350) anon14_Then_correct@@1) (=> (= (ControlFlow 0 722385) 726791) anon14_Else_correct@@1))))))
(let ((anon12_Then_correct@@1  (=> $t15@0 (and (=> (= (ControlFlow 0 722371) 727400) anon13_Then_correct@@1) (=> (= (ControlFlow 0 722371) 722385) anon13_Else_correct@@1)))))
(let ((anon12_Else_correct@@1  (=> (and (and (not $t15@0) (= $t17 $t17)) (and (= $t18@0@@0 $t17) (= (ControlFlow 0 722071) 722365))) L3_correct@@3)))
(let ((anon0$1_correct@@25  (=> (and (and (and (forall ((addr3@@44 Int) ) (!  (=> (|$IsValid'address'| addr3@@44) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316135| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3@@44) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |Diembpl.12530:22|
 :skolemid |561|
)) (forall ((addr3@@45 Int) ) (!  (=> (|$IsValid'address'| addr3@@45) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316220| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@45) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |Diembpl.12530:261|
 :skolemid |562|
))) (forall ((addr3@@46 Int) ) (!  (=> (|$IsValid'address'| addr3@@46) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr3@@46) (and (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |Diembpl.12530:501|
 :skolemid |563|
))) (and (and (forall ((addr1@@32 Int) ) (!  (=> (|$IsValid'address'| addr1@@32) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316394| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1@@32) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@32)) 1))))
 :qid |Diembpl.12534:22|
 :skolemid |564|
)) (forall ((addr1@@33 Int) ) (!  (=> (|$IsValid'address'| addr1@@33) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316479| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr1@@33) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@33)) 1))))
 :qid |Diembpl.12534:232|
 :skolemid |565|
))) (forall ((addr1@@34 Int) ) (!  (=> (|$IsValid'address'| addr1@@34) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr1@@34) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@34)) 1))))
 :qid |Diembpl.12534:443|
 :skolemid |566|
)))) (=> (and (and (and (and (forall ((addr1@@35 Int) ) (!  (=> (|$IsValid'address'| addr1@@35) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1@@35) (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1@@35)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@35)) 2))))
 :qid |Diembpl.12538:22|
 :skolemid |567|
)) (forall ((addr1@@36 Int) ) (!  (=> (|$IsValid'address'| addr1@@36) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr1@@36) (|Select__T@[Int]Bool_| (|domain#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr1@@36)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@36) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@36)) 2))))
 :qid |Diembpl.12538:293|
 :skolemid |568|
))) (forall ((addr1@@37 Int) ) (!  (=> (|$IsValid'address'| addr1@@37) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr1@@37) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr1@@37)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@37) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_314087| $1_Roles_RoleId_$memory) addr1@@37)) 2))))
 :qid |Diembpl.12538:565|
 :skolemid |569|
))) (and (and (forall ((dd_addr@@17 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@17) (and (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_Preburn'$1_XUS_XUS'_| (|contents#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@17))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) dd_addr@@17)))))
 :qid |Diembpl.12542:22|
 :skolemid |570|
)) (forall ((dd_addr@@18 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@18) (and (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_Preburn'$1_XDX_XDX'_| (|contents#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@18))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) dd_addr@@18)))))
 :qid |Diembpl.12542:375|
 :skolemid |571|
))) (forall ((dd_addr@@19 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@19) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@19) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@19))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@19)))))
 :qid |Diembpl.12542:729|
 :skolemid |572|
)))) (and (and (and (forall ((dd_addr@@20 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@20) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) dd_addr@@20) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@20))))
 :qid |Diembpl.12546:22|
 :skolemid |573|
)) (forall ((dd_addr@@21 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@21) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) dd_addr@@21) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@21))))
 :qid |Diembpl.12546:220|
 :skolemid |574|
))) (forall ((dd_addr@@22 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@22) (not (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@22))))
 :qid |Diembpl.12546:419|
 :skolemid |575|
))) (and (and (forall ((addr@@397 Int) ) (!  (=> (|$IsValid'address'| addr@@397) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316715| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@397) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.12550:22|
 :skolemid |576|
)) (forall ((addr@@398 Int) ) (!  (=> (|$IsValid'address'| addr@@398) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316862| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@398) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.12550:222|
 :skolemid |577|
))) (forall ((addr@@399 Int) ) (!  (=> (|$IsValid'address'| addr@@399) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@399) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.12550:423|
 :skolemid |578|
))))) (=> (and (and (and (and (and (forall ((addr@@400 Int) ) (!  (=> (|$IsValid'address'| addr@@400) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316655| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@400) (|Select__T@[Int]Bool_| (|domain#$Memory_335386| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |Diembpl.12554:22|
 :skolemid |579|
)) (forall ((addr@@401 Int) ) (!  (=> (|$IsValid'address'| addr@@401) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316802| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@401) (|Select__T@[Int]Bool_| (|domain#$Memory_335505| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |Diembpl.12554:227|
 :skolemid |580|
))) (forall ((addr@@402 Int) ) (!  (=> (|$IsValid'address'| addr@@402) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@402) (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.12554:433|
 :skolemid |581|
))) (and (|$IsValid'address'| (|$addr#$signer| _$t0@@16)) (|$IsValid'address'| _$t1@@7))) (and (and (and (|$IsValid'u64'| _$t2) (forall (($a_0@@29 Int) ) (! (let (($rsc@@29 (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $a_0@@29)))
(|$IsValid'$1_Diem_BurnCapability'#0''| $rsc@@29))
 :qid |Diembpl.12566:20|
 :skolemid |582|
 :pattern ( (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $a_0@@29))
))) (and (forall (($a_0@@30 Int) ) (! (let (($rsc@@30 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@30)))
 ...
 :qid |Diembpl.12570:20|
 :skolemid |583|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@30))
)) (forall (($a_0@@31 Int) ) (! (let (($rsc@@31 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@31)))
 (and (|$IsValid'$1_Diem_PreburnQueue'#0''| $rsc@@31) (and (<= (|l#Vec_276448| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@31)) 256) (let (($range_1@@0 ($Range 0 (|l#Vec_276448| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@31)))))
(forall (($i_2@@0 Int) ) (!  (=> ($InRange $range_1@@0 $i_2@@0) (let ((i@@105 $i_2@@0))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_276448| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@31)) i@@105)))) 0)))
 :qid |Diembpl.12575:199|
 :skolemid |584|
))))))
 :qid |Diembpl.12574:20|
 :skolemid |585|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@31))
)))) (and (and (= $t6@@16 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= $t7@@4 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) _$t1@@7)))) (and (= $t8@@7 (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t6@@16))) (= $t9@@7 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (and (and (and (= $t10@@1 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t2))) (= $t11@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t12@@0 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t13@@0 (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t11@@0)))) (and (and (= _$t0@@16 _$t0@@16) (= _$t1@@7 _$t1@@7)) (and (= _$t2 _$t2) (|$IsValid'address'| $t14)))) (and (and (and (= $t14 (|$addr#$signer| _$t0@@16)) (= $t14 $t14)) (and (= $t15@0 (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) $t14)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t17) (= $t17 4)) (and (= $t17 $t17) (= $t15@0 $t15@0)))))) (and (=> (= (ControlFlow 0 722055) 722371) anon12_Then_correct@@1) (=> (= (ControlFlow 0 722055) 722071) anon12_Else_correct@@1)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@25  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@30 T@$1_Event_EventHandle) ) (! (let ((stream@@30 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@30)))
 (and (= (|l#Multiset_275813| stream@@30) 0) (forall ((v@@77 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_275813| stream@@30) v@@77) 0)
 :qid |Diembpl.159:13|
 :skolemid |4|
))))
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 721135) 722055)) anon0$1_correct@@25)))
(let ((anon0_correct@@25  (=> (= (ControlFlow 0 1087700) 721135) inline$$InitEventStore$0$anon0_correct@@25)))
anon0_correct@@25)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
