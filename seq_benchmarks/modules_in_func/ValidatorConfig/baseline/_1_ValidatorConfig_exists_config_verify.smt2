...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 268993) (let ((anon0$1_correct  (=> (and (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113268| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113268| $1_Roles_RoleId_$memory) addr@@0)) 3))))
 :qid |ValidatorConfigbpl.6797:20|
 :skolemid |213|
 ...
 :qid |ValidatorConfigbpl.6801:20|
 :skolemid |214|
 ...
 :qid |ValidatorConfigbpl.6805:20|
 :skolemid |215|
)) (|$IsValid'address'| _$t0))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0)))
 ...
 :qid |ValidatorConfigbpl.6811:20|
 :skolemid |216|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_77784_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 196644) 196848)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 268993) 196644) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
