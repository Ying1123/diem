...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 308292) (let ((anon14_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t18@0 (|$config#$1_DiemSystem_ValidatorInfo| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (= $t18@0 $t18@0)) (and (=> (= (ControlFlow 0 227329) (- 0 309324)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 227329) (- 0 309336)) (not (not (let (($range_0 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@47) _$t0)))
 :qid |DiemSystembpl.6950:125|
 :skolemid |215|
))))) (and (=> (= (ControlFlow 0 227329) (- 0 309347)) (let (($range_0@@1 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@2 173345816))
...
(exists (($i_1@@1 Int) ) (!  (and (InRangeVec_78413 $range_0@@1 $i_1@@1) (let ((info (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $range_0@@1) $i_1@@1)))
...
(exists (($i_1@@2 Int) ) (!  (and (InRangeVec_78413 $range_0@@2 $i_1@@2) (let ((info@@0 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $range_0@@2) $i_1@@2)))
 ...
 :qid |DiemSystembpl.8584:176|
 :skolemid |273|
))) (=> (= (ControlFlow 0 227329) (- 0 309393)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@4 173345816))
...
(let ((L3_correct  (and (=> (= (ControlFlow 0 227049) (- 0 309252)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (not (let (($range_0@@3 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@6 173345816))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@48) _$t0)))
 :qid |DiemSystembpl.6950:125|
 :skolemid |215|
)))))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (not (let (($range_0@@4 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@7 173345816))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@49) _$t0)))
 :qid |DiemSystembpl.6950:125|
 :skolemid |215|
))))) (=> (= (ControlFlow 0 227049) (- 0 309267)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t7@0)) (and (not (let (($range_0@@5 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@8 173345816))
...
(exists (($i_1@@5 Int) ) (!  (and (InRangeVec_78413 $range_0@@5 $i_1@@5) (let ((v@@50 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $range_0@@5) $i_1@@5)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@50) _$t0)))
 :qid |DiemSystembpl.6950:125|
 :skolemid |215|
)))) (= 7 $t7@0))))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 227343) 227049))) L3_correct)))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@0|)) (and (=> (= (ControlFlow 0 227218) 227343) anon14_Then_correct) (=> (= (ControlFlow 0 227218) 227329) anon14_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_78413 $t14@0 $t15)) (= (ControlFlow 0 227216) 227218)) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|  (=> (InRangeVec_78413 $t14@0 $t15) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t14@0) $t15)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1|))) (and (=> (= (ControlFlow 0 227166) 227343) anon14_Then_correct) (=> (= (ControlFlow 0 227166) 227329) anon14_Else_correct))))))
(let ((anon13_Else_correct  (=> (not $t16) (=> (and (|$IsValid'u64'| $t15) (= $t15 (|Select__T@[Int]Int_| (|v#Vec_28829| (|$vec#$1_Option_Option'u64'| $t10)) 0))) (and (=> (= (ControlFlow 0 227224) 227216) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 227224) 227166) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|))))))
(let ((anon13_Then_correct  (=> $t16 (=> (and (and (and (= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t10)) 0) (= 7 $t7)) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 227367) 227049))) L3_correct))))
(let ((anon12_Then_correct  (=> $t11 (=> (and (= $t14@0 (|$validators#$1_DiemSystem_DiemSystem| $t5)) (= $t16 (= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t10)) 0))) (and (=> (= (ControlFlow 0 227065) 227367) anon13_Then_correct) (=> (= (ControlFlow 0 227065) 227224) anon13_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (and (not $t11) (= $t13 $t13)) (and (= $t7@0 $t13) (= (ControlFlow 0 226989) 227049))) L3_correct)))
(let ((anon11_Else_correct  (=> (not $t6) (=> (and (|$IsValid'$1_DiemSystem_DiemSystem'| $t5) (let (($range_0@@6 ($Range 0 (|l#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| $t5)))))
(let (($range_1 ($Range 0 (|l#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| $t5)))))
(forall (($i_2 Int) ($i_3 Int) ) (!  (=> ($InRange $range_0@@6 $i_2) (=> ($InRange $range_1 $i_3) (let ((i@@90 $i_2))
(let ((j@@28 $i_3))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| $t5)) i@@90)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| $t5)) j@@28))) (= i@@90 j@@28))))))
 :qid |DiemSystembpl.8415:222|
 :skolemid |270|
))))) (=> (and (and (and (and (and (= (|$scheme#$1_DiemSystem_DiemSystem| $t5) (|$scheme#$1_DiemSystem_DiemSystem| (let ((addr@@9 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@9))))) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| $t5) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@9 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@9)))))) (= $t5 $t5)) (and (= $t8@0 (|$validators#$1_DiemSystem_DiemSystem| $t5)) (= $t9 (|l#Vec_87979| $t8@0)))) (and (and (|$IsValid'$1_Option_Option'u64''| $t10) (<= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t10)) 1)) (=> (let (($range_0@@7 ($Range 0 $t9)))
(forall (($i_1@@6 Int) ) (!  (=> ($InRange $range_0@@7 $i_1@@6) (let ((i@@91 $i_1@@6))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t8@0) i@@91)) _$t0))))
 :qid |DiemSystembpl.8445:54|
 :skolemid |271|
))) (= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t10)) 0)))) (and (and (and (=> (let (($range_0@@8 ($Range 0 $t9)))
(exists (($i_1@@7 Int) ) (!  (and ($InRange $range_0@@8 $i_1@@7) (let ((i@@92 $i_1@@7))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t8@0) i@@92)) _$t0)))
 :qid |DiemSystembpl.8449:54|
 :skolemid |272|
))) (and (not (= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t10)) 0)) (let ((at (|Select__T@[Int]Int_| (|v#Vec_28829| (|$vec#$1_Option_Option'u64'| $t10)) 0)))
 (and (and (<= 0 at) (< at $t9)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t8@0) at)) _$t0))))) (= $t10 $t10)) (and (= $t11  (not (= (|l#Vec_28829| (|$vec#$1_Option_Option'u64'| $t10)) 0))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t13) (= $t13 7)) (and (= $t13 $t13) (= $t11 $t11))))) (and (=> (= (ControlFlow 0 226973) 227065) anon12_Then_correct) (=> (= (ControlFlow 0 226973) 226989) anon12_Else_correct)))))))
(let ((anon11_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t7)) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 227395) 227049))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (and (and (and (and (and (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address) (= config_address 173345816)))
 :qid |DiemSystembpl.8353:24|
 :skolemid |261|
 ...
 :qid |DiemSystembpl.8353:969|
 :skolemid |265|
))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124079| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_125607| $1_DiemSystem_CapabilityHolder_$memory) 173345816)))) (and (let (($range_0@@9 ($Range 0 (|l#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@10 173345816))
...
(forall (($i_1@@8 Int) ) (!  (=> ($InRange $range_0@@9 $i_1@@8) (let ((i1 $i_1@@8))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_125988| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@11 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@11))))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_125988| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@11 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@11))))) i1)))) 3))))
 :qid |DiemSystembpl.8361:151|
 :skolemid |266|
))) (let (($range_0@@10 ($Range 0 (|l#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@12 173345816))
...
(= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@13 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))) i1@@0)) 1)))
 :qid |DiemSystembpl.8366:151|
 :skolemid |267|
))))) (and (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0)))
...
(forall (($i_3@@0 Int) ($i_4 Int) ) (!  (=> ($InRange $range_1@@0 $i_3@@0) (=> ($InRange $range_2 $i_4) (let ((i@@93 $i_3@@0))
(let ((j@@29 $i_4))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc))) i@@93)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc))) j@@29))) (= i@@93 j@@29))))))
 :qid |DiemSystembpl.8375:367|
 :skolemid |268|
))))))
 :qid |DiemSystembpl.8374:20|
 :skolemid |269|
...
))) (and (= _$t0 _$t0) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 226664) 227395) anon11_Then_correct) (=> (= (ControlFlow 0 226664) 226973) anon11_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_87682_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_87682| stream@@0) 0) (forall ((v@@51 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_87682| stream@@0) v@@51) 0)
 :qid |DiemSystembpl.159:13|
 :skolemid |4|
))))
 :qid |DiemSystembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 226284) 226664)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 308292) 226284) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
