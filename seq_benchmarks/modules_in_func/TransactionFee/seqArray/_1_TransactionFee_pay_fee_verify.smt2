...
(assert (not
 (=> (= (ControlFlow 0 0) 337932) (let ((anon22_Else_correct@@2  (=> (not $t14@@0) (=> (and (= $t12@1 ($Mutation_143508 (|l#$Mutation_143508| $t12@0) (|p#$Mutation_143508| $t12@0) |$temp_0'$1_Diem_Diem'#0''@0@@0|)) (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_143508| $t12@1))) (=> (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_143508| $t12@1)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_143508| $t12@1)) (+ (|$value#$1_Diem_Diem'#0'| $t13@0) (|$value#$1_Diem_Diem'#0'| _$t0@@6)))) (and (= $t11@2 ($Mutation_170516 (|l#$Mutation_170516| $t11@1) (|p#$Mutation_170516| $t11@1) (|$1_TransactionFee_TransactionFee'#0'| (|v#$Mutation_143508| $t12@1) (|$preburn#$1_TransactionFee_TransactionFee'#0'| (|v#$Mutation_170516| $t11@1))))) (= |$1_TransactionFee_TransactionFee'#0'_$memory@0@@1| ($Memory_163323 (|Store__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|a#$Global| (|l#$Mutation_170516| $t11@2)) true) (|Store__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|a#$Global| (|l#$Mutation_170516| $t11@2)) (|v#$Mutation_170516| $t11@2)))))) (and (=> (= (ControlFlow 0 255767) (- 0 338708)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_122309| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_122309| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)) (=> (= $t15@@2 (|$balance#$1_TransactionFee_TransactionFee'#0'| (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory@0@@1|) 186537453))) (and (=> (= (ControlFlow 0 255767) (- 0 338736)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 255767) (- 0 338746)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (and (=> (= (ControlFlow 0 255767) (- 0 338756)) (not (> (+ (|$value#$1_Diem_Diem'#0'| $t4@@2) (|$value#$1_Diem_Diem'#0'| _$t0@@6)) 18446744073709551615))) (=> (not (> (+ (|$value#$1_Diem_Diem'#0'| $t4@@2) (|$value#$1_Diem_Diem'#0'| _$t0@@6)) 18446744073709551615)) (=> (= (ControlFlow 0 255767) (- 0 338774)) (= (|$value#$1_Diem_Diem'#0'| $t15@@2) (+ (|$value#$1_Diem_Diem'#0'| $t4@@2) (|$value#$1_Diem_Diem'#0'| _$t0@@6))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 255529) (- 0 338550)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (> (+ (|$value#$1_Diem_Diem'#0'| $t4@@2) (|$value#$1_Diem_Diem'#0'| _$t0@@6)) 18446744073709551615))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (> (+ (|$value#$1_Diem_Diem'#0'| $t4@@2) (|$value#$1_Diem_Diem'#0'| _$t0@@6)) 18446744073709551615)) (=> (= (ControlFlow 0 255529) (- 0 338577)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= 5 $t6@0))) (and (> (+ (|$value#$1_Diem_Diem'#0'| $t4@@2) (|$value#$1_Diem_Diem'#0'| _$t0@@6)) 18446744073709551615) (= 8 $t6@0))))))))
(let ((anon22_Then_correct@@2  (=> $t14@@0 (=> (and (and (and (> (+ (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_143508| $t12@0)) (|$value#$1_Diem_Diem'#0'| _$t0@@6)) 18446744073709551615) (= 8 $t6@@4)) (= $t6@@4 $t6@@4)) (and (= $t6@0 $t6@@4) (= (ControlFlow 0 255803) 255529))) L3_correct))))
(let ((anon21_Else_correct@@2  (=> (and (not $abort_flag@0@@6) (= |$temp_0'$1_TransactionFee_TransactionFee'#0''@0@@0| (|v#$Mutation_170516| $t11@1))) (=> (and (and (= |$temp_0'$1_TransactionFee_TransactionFee'#0''@0@@0| |$temp_0'$1_TransactionFee_TransactionFee'#0''@0@@0|) (= $t12@0 ($Mutation_143508 (|l#$Mutation_170516| $t11@1) (seq.++ (|p#$Mutation_170516| $t11@1) (seq.unit 0)) (|$balance#$1_TransactionFee_TransactionFee'#0'| (|v#$Mutation_170516| $t11@1))))) (and (= $t13@0 (|v#$Mutation_143508| $t12@0)) (= $t14@@0 (> (+ (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_143508| $t12@0)) (|$value#$1_Diem_Diem'#0'| _$t0@@6)) 18446744073709551615)))) (and (=> (= (ControlFlow 0 255617) 255803) anon22_Then_correct@@2) (=> (= (ControlFlow 0 255617) 255767) anon22_Else_correct@@2))))))
(let ((anon21_Then_correct@@2  (=> (and (and $abort_flag@0@@6 (= $abort_code@1@@6 $abort_code@1@@6)) (and (= $t6@0 $abort_code@1@@6) (= (ControlFlow 0 255817) 255529))) L3_correct)))
(let ((anon20_Then$1_correct  (=> (= $t11@1 $t11@@3) (=> (and (= $abort_flag@0@@6 true) (= $abort_code@1@@6 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 255869) 255817) anon21_Then_correct@@2) (=> (= (ControlFlow 0 255869) 255617) anon21_Else_correct@@2))))))
(let ((anon20_Then_correct@@2  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= (ControlFlow 0 255867) 255869)) anon20_Then$1_correct)))
(let ((anon20_Else_correct@@2  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453) (=> (and (and (= $t11@0@@0 ($Mutation_170516 ($Global 186537453) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))) (= $t11@1 $t11@0@@0)) (and (= $abort_flag@0@@6 false) (= $abort_code@1@@6 $abort_code@0@@6))) (and (=> (= (ControlFlow 0 255561) 255817) anon21_Then_correct@@2) (=> (= (ControlFlow 0 255561) 255617) anon21_Else_correct@@2))))))
(let ((anon19_Then_correct@@1  (=> (and |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1@@1| (|$IsValid'address'| 186537453)) (and (=> (= (ControlFlow 0 255539) 255867) anon20_Then_correct@@2) (=> (= (ControlFlow 0 255539) 255561) anon20_Else_correct@@2)))))
(let ((anon19_Else_correct@@1  (=> (and (and (not |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1@@1|) (= $t9@@3 $t9@@3)) (and (= $t6@0 $t9@@3) (= (ControlFlow 0 255437) 255529))) L3_correct)))
(let ((anon18_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t9@@3) (= $t9@@3 5)) (and (= $t9@@3 $t9@@3) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1@@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1@@1|))) (and (=> (= (ControlFlow 0 255421) 255539) anon19_Then_correct@@1) (=> (= (ControlFlow 0 255421) 255437) anon19_Else_correct@@1))))))
(let ((anon17_Then_correct  (=> $t5@@3 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t6@@4)) (= $t6@@4 $t6@@4)) (and (= $t6@0 $t6@@4) (= (ControlFlow 0 255909) 255529))) L3_correct))))
(let ((anon18_Then_correct true))
(let ((|inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct@@1|  (=> (|$IsValid'address'| 186537453) (=> (and (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1@@1| (|Select__T@[Int]Bool_| (|domain#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1@@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1@@1|)) (and (=> (= (ControlFlow 0 255379) 255883) anon18_Then_correct) (=> (= (ControlFlow 0 255379) 255421) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (not $t5@@3) (= (ControlFlow 0 255385) 255379)) |inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct@@1|)))
(let ((anon0$1_correct@@6  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_124603| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_124213| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_129756| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_158479| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_161370| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_129820| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_158698| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_122309| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (and (|$IsValid'$1_Diem_Diem'#0''| _$t0@@6) (forall (($a_0@@28 Int) ) (! (let (($rsc@@28 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@28)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@28))
 :qid |TransactionFeebpl.18488:20|
 :skolemid |314|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@28))
)))) (and (and (forall (($a_0@@29 Int) ) (! (let (($rsc@@29 (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@29)))
(|$IsValid'$1_TransactionFee_TransactionFee'#0''| $rsc@@29))
 :qid |TransactionFeebpl.18492:20|
 :skolemid |315|
 :pattern ( (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@29))
)) (= $t4@@2 (|$balance#$1_TransactionFee_TransactionFee'#0'| (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_163323| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (and (= _$t0@@6 _$t0@@6) (= $t5@@3  (not (|Select__T@[Int]Bool_| (|domain#$Memory_120865| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 255292) 255909) anon17_Then_correct) (=> (= (ControlFlow 0 255292) 255385) anon17_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@6  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@8 T@$1_Event_EventHandle) ) (! (let ((stream@@13 (|Select__T@[$1_Event_EventHandle]Multiset_89967_| (|streams#$EventStore| $es) handle@@8)))
 (and (= (|l#Multiset_89967| stream@@13) 0) (forall ((v@@45 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_89967| stream@@13) v@@45) 0)
 :qid |TransactionFeebpl.134:13|
 :skolemid |2|
))))
 :qid |TransactionFeebpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 255098) 255292)) anon0$1_correct@@6)))
(let ((anon0_correct@@6  (=> (and (and (= (seq.len (|p#$Mutation_170516| $t3@@2)) 0) (= (seq.len (|p#$Mutation_170516| $t11@@3)) 0)) (and (= (seq.len (|p#$Mutation_143508| $t12@@5)) 0) (= (ControlFlow 0 255108) 255098))) inline$$InitEventStore$0$anon0_correct@@6)))
(let ((PreconditionGeneratedEntry_correct@@3  (=> (= (ControlFlow 0 337932) 255108) anon0_correct@@6)))
