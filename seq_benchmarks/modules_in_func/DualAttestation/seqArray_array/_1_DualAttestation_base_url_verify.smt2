...
(assert (not
 (=> (= (ControlFlow 0 0) 302874) (let ((anon12_Else_correct@@1  (=> (not $abort_flag@0@@3) (=> (and (= $t8@0@@4 (|$base_url#$1_DualAttestation_Credential| $t7@1@@0)) (= $t8@0@@4 $t8@0@@4)) (and (=> (= (ControlFlow 0 223213) (- 0 303224)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@7)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@7))) (=> (= (ControlFlow 0 223213) (- 0 303235)) (|$IsEqual'vec'u8''| $t8@0@@4 (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@7))))))))))
(let ((L3_correct@@1  (and (=> (= (ControlFlow 0 223147) (- 0 303177)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@7))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@7)) (=> (= (ControlFlow 0 223147) (- 0 303183)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@7)) (= 5 $t6@0@@1)))))))
(let ((anon12_Then_correct@@1  (=> (and (and $abort_flag@0@@3 (= $abort_code@1@@3 $abort_code@1@@3)) (and (= $t6@0@@1 $abort_code@1@@3) (= (ControlFlow 0 223227) 223147))) L3_correct@@1)))
(let ((anon11_Then$1_correct@@1  (=> (= $t7@1@@0 $t7@@2) (=> (and (= $abort_flag@0@@3 true) (= $abort_code@1@@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 223279) 223227) anon12_Then_correct@@1) (=> (= (ControlFlow 0 223279) 223213) anon12_Else_correct@@1))))))
(let ((anon11_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@7)) (= (ControlFlow 0 223277) 223279)) anon11_Then$1_correct@@1)))
(let ((anon11_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@7) (=> (and (and (= $t7@0@@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@7)) (= $t7@1@@0 $t7@0@@0)) (and (= $abort_flag@0@@3 false) (= $abort_code@1@@3 $abort_code@0@@3))) (and (=> (= (ControlFlow 0 223165) 223227) anon12_Then_correct@@1) (=> (= (ControlFlow 0 223165) 223213) anon12_Else_correct@@1))))))
(let ((anon10_Then_correct@@1  (=> $t3@0@@0 (and (=> (= (ControlFlow 0 223151) 223277) anon11_Then_correct@@1) (=> (= (ControlFlow 0 223151) 223165) anon11_Else_correct@@1)))))
(let ((anon10_Else_correct@@1  (=> (and (and (not $t3@0@@0) (= $t5@@1 $t5@@1)) (and (= $t6@0@@1 $t5@@1) (= (ControlFlow 0 223115) 223147))) L3_correct@@1)))
(let ((anon0$1_correct@@7  (=> (forall ((addr1@@7 Int) ) (!  (=> (|$IsValid'address'| addr1@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr1@@7) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@7)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@7)) 2)))))
 :qid |DualAttestationbpl.12956:20|
 :skolemid |292|
)) (=> (and (forall ((addr@@70 Int) ) (!  (=> (|$IsValid'address'| addr@@70) (= (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr@@70)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@70) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@70)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@70) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@70)) 5)))))
 :qid |DualAttestationbpl.12960:20|
 :skolemid |293|
)) (|$IsValid'address'| _$t0@@7)) (=> (and (and (and (forall (($a_0@@23 Int) ) (! (let (($rsc@@23 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0@@23)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@23))
 :qid |DualAttestationbpl.12967:20|
 :skolemid |294|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0@@23))
)) (= _$t0@@7 _$t0@@7)) (and (= $t3@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@7)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5@@1) (= $t5@@1 5)) (and (= $t5@@1 $t5@@1) (= $t3@0@@0 $t3@0@@0)))) (and (=> (= (ControlFlow 0 223099) 223151) anon10_Then_correct@@1) (=> (= (ControlFlow 0 223099) 223115) anon10_Else_correct@@1)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@7  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@9 T@$1_Event_EventHandle) ) (! (let ((stream@@8 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@9)))
 (and (= (|l#Multiset_86488| stream@@8) 0) (forall ((v@@51 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@8) v@@51) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 222949) 223099)) anon0$1_correct@@7)))
(let ((anon0_correct@@7  (=> (= (ControlFlow 0 302874) 222949) inline$$InitEventStore$0$anon0_correct@@7)))
anon0_correct@@7))))))))))))
))
(check-sat)
(pop 1)
