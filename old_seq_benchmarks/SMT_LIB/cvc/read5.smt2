...
(assert (let ((?v_3 (ite (= a aa) false true)) (?v_4 (ite (= aa aaa) false true)) (?v_1 (seq.update (store (store S a v) aa vv) aaa vvv)) (?v_0 (store S aaa vvv)) (?v_2 (store S aa vv))) (not (ite (ite (ite (ite (= a aaa) false true) (ite ?v_3 ?v_4 false) false) (ite (= (store (store ?v_0 a v) aa vv) ?v_1) (ite (= (store (store ?v_0 aa vv) a v) ?v_1) (ite (= (store (store ?v_2 a v) aaa vvv) ?v_1) (= (store (store ?v_2 aaa vvv) a v) ?v_1) false) false) false) true) (ite (ite (= ?v_1 (store (store (store S bbb www) bb ww) b w)) (ite (ite ?v_3 (ite ?v_4 (ite (ite (= aa b) false true) (ite (ite (= aa bb) false true) (ite (= aa bbb) false true) false) false) false) false) (= (seq.nth S aa) vv) true) true) (ite (= S (store SS a v)) (= S (store SS a (select S a))) true) false) false))))
(check-sat)
(exit)
