...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |mutrefbpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |mutrefbpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |mutrefbpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |mutrefbpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |mutrefbpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |mutrefbpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |mutrefbpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |mutrefbpl.461:15|
 :skolemid |14|
...
(assert (forall ((v@@4 (Seq T@$1_TestMutRef_T)) ) (! (= (|$IsValid'vec'$1_TestMutRef_T''| v@@4)  (and (|$IsValid'u64'| (seq.len v@@4)) (forall ((i@@0 Int) ) (!  (=> (and (>= i@@0 0) (< i@@0 (seq.len v@@4))) (|$IsValid'$1_TestMutRef_T'| (seq.nth v@@4 i@@0)))
 :qid |mutrefbpl.590:13|
 :skolemid |15|
))))
 :qid |mutrefbpl.588:41|
 :skolemid |16|
...
(ite  (not (exists ((i@@2 Int) ) (!  (and (and (|$IsValid'u64'| i@@2) (and (>= i@@2 0) (< i@@2 (seq.len v@@5)))) (= (seq.nth v@@5 i@@2) e))
 :qid |mutrefbpl.595:13|
 :skolemid |17|
))) (= i@@1 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@1) (and (>= i@@1 0) (< i@@1 (seq.len v@@5)))) (= (seq.nth v@@5 i@@1) e)) (forall ((j Int) ) (!  (=> (and (and (|$IsValid'u64'| j) (>= j 0)) (< j i@@1)) (not (= (seq.nth v@@5 j) e)))
 :qid |mutrefbpl.603:17|
 :skolemid |18|
)))))
 :qid |mutrefbpl.599:15|
 :skolemid |19|
...
(assert (forall ((|l#0| Bool) (i@@11 Int) ) (! (= (|Select_[$int]$bool| (|lambda#0| |l#0|) i@@11) |l#0|)
 :qid |mutrefbpl.245:54|
 :skolemid |47|
 :pattern ( (|Select_[$int]$bool| (|lambda#0| |l#0|) i@@11))
)))
...
(let ((anon9_Else_correct  (=> (and (not false) (= |$temp_0'u64'@0@@0| (|v#$Mutation_4535| inline$$1_TestMutRef_return_ref_different_path$0$$t2@1))) (=> (and (and (= |$temp_0'u64'@0@@0| |$temp_0'u64'@0@@0|) (|$IsValid'u64'| 5)) (and (= $t7@0 ($Mutation_4535 (|l#$Mutation_4535| inline$$1_TestMutRef_return_ref_different_path$0$$t2@1) (|p#$Mutation_4535| inline$$1_TestMutRef_return_ref_different_path$0$$t2@1) 5)) (= $t10@0  (and (= (|l#$Mutation_22996| $t6@0) (|l#$Mutation_4535| $t7@0)) (let ((pp@@0 (|p#$Mutation_22996| $t6@0)))
...
(let ((anon0$1_correct@@0  (=> (and (and (= _$t0 _$t0) (|$IsValid'u64'| 1)) (and (|$IsValid'u64'| 2) (= $t5@0 ($1_TestMutRef_T 2)))) (and (=> (= (ControlFlow 0 34553) (- 0 45296)) (> (|$value#$1_TestMutRef_T| $t5@0) 0)) (=> (> (|$value#$1_TestMutRef_T| $t5@0) 0) (=> (and (and (= $t2@0 ($1_TestMutRef_N 1 $t5@0)) (= $t2@0 $t2@0)) (and (= $t6@0 ($Mutation_22996 ($Local 2) (as seq.empty (Seq Int)) $t2@0)) (= (ControlFlow 0 34553) 34447))) inline$$1_TestMutRef_return_ref_different_path$0$anon0_correct))))))
(let ((anon0_correct@@0  (=> (and (and (= (seq.len (|p#$Mutation_4535| $t1)) 0) (= (seq.len (|p#$Mutation_22996| $t6)) 0)) (and (= (seq.len (|p#$Mutation_4535| $t7)) 0) (= (ControlFlow 0 34096) 34553))) anon0$1_correct@@0)))
(let ((PreconditionGeneratedEntry_correct@@0  (=> (= (ControlFlow 0 45141) 34096) anon0_correct@@0)))
