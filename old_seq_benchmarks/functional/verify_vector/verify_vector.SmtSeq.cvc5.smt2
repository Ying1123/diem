...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |verifyvectorSmtSeqcvc4bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |verifyvectorSmtSeqcvc4bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |verifyvectorSmtSeqcvc4bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |verifyvectorSmtSeqcvc4bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |verifyvectorSmtSeqcvc4bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |verifyvectorSmtSeqcvc4bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |verifyvectorSmtSeqcvc4bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |verifyvectorSmtSeqcvc4bpl.461:15|
 :skolemid |14|
 :pattern ( ($shr src1@@0 p@@0))
)))
(assert (forall ((v@@4 (Seq |T@#0|)) ) (! (= (|$IsValid'vec'#0''| v@@4)  (and (|$IsValid'u64'| (seq.len v@@4)) (forall ((i@@0 Int) ) (!  (=> (and (>= i@@0 0) (< i@@0 (seq.len v@@4))) true)
 :qid |verifyvectorSmtSeqcvc4bpl.590:13|
 :skolemid |15|
))))
 :qid |verifyvectorSmtSeqcvc4bpl.588:28|
 :skolemid |16|
 :pattern ( (|$IsValid'vec'#0''| v@@4))
)))
(assert (forall ((v@@5 (Seq |T@#0|)) (e |T@#0|) ) (! (let ((i@@1 (|$IndexOfVec'#0'| v@@5 e)))
(ite  (not (exists ((i@@2 Int) ) (!  (and (and (|$IsValid'u64'| i@@2) (and (>= i@@2 0) (< i@@2 (seq.len v@@5)))) (= (seq.nth v@@5 i@@2) e))
 :qid |verifyvectorSmtSeqcvc4bpl.595:13|
 :skolemid |17|
))) (= i@@1 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@1) (and (>= i@@1 0) (< i@@1 (seq.len v@@5)))) (= (seq.nth v@@5 i@@1) e)) (forall ((j Int) ) (!  (=> (and (and (|$IsValid'u64'| j) (>= j 0)) (< j i@@1)) (not (= (seq.nth v@@5 j) e)))
 :qid |verifyvectorSmtSeqcvc4bpl.603:17|
 :skolemid |18|
)))))
 :qid |verifyvectorSmtSeqcvc4bpl.599:15|
 :skolemid |19|
...
(assert (forall ((v@@6 (Seq Int)) ) (! (= (|$IsValid'vec'u8''| v@@6)  (and (|$IsValid'u64'| (seq.len v@@6)) (forall ((i@@3 Int) ) (!  (=> (and (>= i@@3 0) (< i@@3 (seq.len v@@6))) (|$IsValid'u8'| (seq.nth v@@6 i@@3)))
 :qid |verifyvectorSmtSeqcvc4bpl.770:13|
 :skolemid |20|
))))
 :qid |verifyvectorSmtSeqcvc4bpl.768:28|
 :skolemid |21|
 :pattern ( (|$IsValid'vec'u8''| v@@6))
)))
(assert (forall ((v@@7 (Seq Int)) (e@@0 Int) ) (! (let ((i@@4 (|$IndexOfVec'u8'| v@@7 e@@0)))
(ite  (not (exists ((i@@5 Int) ) (!  (and (and (|$IsValid'u64'| i@@5) (and (>= i@@5 0) (< i@@5 (seq.len v@@7)))) (= (seq.nth v@@7 i@@5) e@@0))
 :qid |verifyvectorSmtSeqcvc4bpl.775:13|
 :skolemid |22|
))) (= i@@4 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@4) (and (>= i@@4 0) (< i@@4 (seq.len v@@7)))) (= (seq.nth v@@7 i@@4) e@@0)) (forall ((j@@0 Int) ) (!  (=> (and (and (|$IsValid'u64'| j@@0) (>= j@@0 0)) (< j@@0 i@@4)) (not (= (seq.nth v@@7 j@@0) e@@0)))
 :qid |verifyvectorSmtSeqcvc4bpl.783:17|
 :skolemid |23|
)))))
 :qid |verifyvectorSmtSeqcvc4bpl.779:15|
 :skolemid |24|
 :pattern ( (|$IndexOfVec'u8'| v@@7 e@@0))
)))
(assert (forall ((v1 (Seq Int)) (v2 (Seq Int)) ) (! (= (= v1 v2) (= ($1_Hash_sha2 v1) ($1_Hash_sha2 v2)))
 :qid |verifyvectorSmtSeqcvc4bpl.956:15|
 :skolemid |25|
 :pattern ( ($1_Hash_sha2 v1) ($1_Hash_sha2 v2))
)))
(assert (forall ((v1@@0 (Seq Int)) (v2@@0 (Seq Int)) ) (! (= (= v1@@0 v2@@0) (= ($1_Hash_sha3 v1@@0) ($1_Hash_sha3 v2@@0)))
 :qid |verifyvectorSmtSeqcvc4bpl.972:15|
 :skolemid |26|
 :pattern ( ($1_Hash_sha3 v1@@0) ($1_Hash_sha3 v2@@0))
)))
(assert (forall ((k1 (Seq Int)) (k2 (Seq Int)) ) (!  (=> (= k1 k2) (= ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2)))
 :qid |verifyvectorSmtSeqcvc4bpl.1019:15|
 :skolemid |27|
 :pattern ( ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2))
)))
(assert (forall ((s1 (Seq Int)) (s2 (Seq Int)) (k1@@0 (Seq Int)) (k2@@0 (Seq Int)) (m1 (Seq Int)) (m2 (Seq Int)) ) (!  (=> (and (and (= s1 s2) (= k1@@0 k2@@0)) (= m1 m2)) (= ($1_Signature_$ed25519_verify s1 k1@@0 m1) ($1_Signature_$ed25519_verify s2 k2@@0 m2)))
 :qid |verifyvectorSmtSeqcvc4bpl.1022:15|
 :skolemid |28|
...
(assert (forall ((v@@8 (Seq |T@#0|)) ) (! (let ((r@@0 (ReverseVec_14622 v@@8)))
 ...
 :qid |verifyvectorSmtSeqcvc4bpl.67:18|
 :skolemid |0|
 :pattern ( (seq.nth r@@0 i@@6))
))))
 :qid |verifyvectorSmtSeqcvc4bpl.64:32|
 :skolemid |1|
...
(assert (forall ((|l#0| Bool) (i@@8 Int) ) (! (= (|Select__T@[Int]Bool_| (|lambda#0| |l#0|) i@@8) |l#0|)
 :qid |verifyvectorSmtSeqcvc4bpl.245:54|
 :skolemid |68|
...
(= (seq.nth (|v#$Mutation_18313| |inline$$1_Vector_push_back'#0'$0$m'@1|) k) (seq.nth $t15@0 k))))
 :qid |verifyvectorSmtSeqcvc4bpl.1387:57|
 :skolemid |35|
...
(= (seq.nth (|v#$Mutation_18313| |inline$$1_Vector_pop_back'#0'$0$m'@2|) k@@0) (seq.nth _$t1 (- (- (seq.len _$t1) 1) k@@0)))))
 :qid |verifyvectorSmtSeqcvc4bpl.1393:71|
 :skolemid |36|
...
(= (seq.nth (|v#$Mutation_18313| |inline$$1_Vector_push_back'#0'$0$m'@1|) k@@1) (seq.nth _$t1 (- k@@1 (seq.len $t16@0))))))
 :qid |verifyvectorSmtSeqcvc4bpl.1399:81|
 :skolemid |37|
)))))))))))))))))
...
(= (seq.nth (|v#$Mutation_18313| _$t0) k@@2) (seq.nth $t11@0 k@@2))))
 :qid |verifyvectorSmtSeqcvc4bpl.1213:57|
 :skolemid |29|
...
(= (seq.nth (|v#$Mutation_18313| |inline$$1_Vector_reverse'#0'$0$m'@1|) k@@3) (seq.nth _$t1 (- (- (seq.len _$t1) 1) k@@3)))))
 :qid |verifyvectorSmtSeqcvc4bpl.1219:71|
 :skolemid |30|
...
(= (seq.nth (|v#$Mutation_18313| _$t0) k@@4) (seq.nth _$t1 (- k@@4 (seq.len $t12@0))))))
 :qid |verifyvectorSmtSeqcvc4bpl.1225:81|
 :skolemid |31|
...
(= (seq.nth (|v#$Mutation_18313| $t0@0) k@@5) (seq.nth $t7@0 k@@5))))
 :qid |verifyvectorSmtSeqcvc4bpl.1271:61|
 :skolemid |32|
...
(= (seq.nth (|v#$Mutation_18313| $t17@1) k@@6) (seq.nth _$t1 (- (- (seq.len _$t1) 1) k@@6)))))
 :qid |verifyvectorSmtSeqcvc4bpl.1276:76|
 :skolemid |33|
...
(= (seq.nth (|v#$Mutation_18313| $t0@0) k@@7) (seq.nth _$t1 (- k@@7 (seq.len $t8@0))))))
 :qid |verifyvectorSmtSeqcvc4bpl.1281:85|
 :skolemid |34|
