...
(assert (not
 (=> (= (ControlFlow 0 0) 415235) (let ((L11_correct  (=> (= $t3@0 $t3@0) (and (=> (= (ControlFlow 0 302742) (- 0 415579)) (not false)) (=> (not false) (=> (= (ControlFlow 0 302742) (- 0 415586)) (= $t3@0  (and (and (and (= (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15) $MAX_U64) (= (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15) $MAX_U64)) (= (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15) $MAX_U64)) (= (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15) 86400000000)))))))))
(let ((anon12_Else_correct@@1  (=> (and (and (not $t2@0) (= false false)) (and (= $t3@0 false) (= (ControlFlow 0 302714) 302742))) L11_correct)))
(let ((anon12_Then_correct@@1  (=> $t2@0 (=> (and (= $t15@0@@2 (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15)) (|$IsValid'u64'| 86400000000)) (=> (and (and (= $t17@0@@2 (= $t15@0@@2 86400000000)) (= $t17@0@@2 $t17@0@@2)) (and (= $t3@0 $t17@0@@2) (= (ControlFlow 0 302772) 302742))) L11_correct)))))
(let ((anon11_Else_correct@@6  (=> (not $t1@0@@6) (=> (and (= false false) (= $t2@0 false)) (and (=> (= (ControlFlow 0 302692) 302772) anon12_Then_correct@@1) (=> (= (ControlFlow 0 302692) 302714) anon12_Else_correct@@1))))))
(let ((anon11_Then_correct@@6  (=> (and $t1@0@@6 (= $t11@0@@6 (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15))) (=> (and (and (|$IsValid'u64'| 18446744073709551615) (= $t13@0@@2 (= $t11@0@@6 18446744073709551615))) (and (= $t13@0@@2 $t13@0@@2) (= $t2@0 $t13@0@@2))) (and (=> (= (ControlFlow 0 302802) 302772) anon12_Then_correct@@1) (=> (= (ControlFlow 0 302802) 302714) anon12_Else_correct@@1))))))
(let ((anon10_Else_correct@@5  (=> (not $t6@0@@3) (=> (and (= false false) (= $t1@0@@6 false)) (and (=> (= (ControlFlow 0 302670) 302802) anon11_Then_correct@@6) (=> (= (ControlFlow 0 302670) 302692) anon11_Else_correct@@6))))))
(let ((anon10_Then_correct@@5  (=> (and $t6@0@@3 (= $t7@0@@0 (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15))) (=> (and (and (|$IsValid'u64'| 18446744073709551615) (= $t9@0@@2 (= $t7@0@@0 18446744073709551615))) (and (= $t9@0@@2 $t9@0@@2) (= $t1@0@@6 $t9@0@@2))) (and (=> (= (ControlFlow 0 302832) 302802) anon11_Then_correct@@6) (=> (= (ControlFlow 0 302832) 302692) anon11_Else_correct@@6))))))
(let ((anon0$1_correct@@15  (=> (and (|$IsValid'$1_AccountLimits_LimitsDefinition'#0''| _$t0@@15) (and (and (and (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15) 0) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15) 0)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15) 0)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15) 0))) (=> (and (and (= _$t0@@15 _$t0@@15) (= $t4@0 (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@15))) (and (|$IsValid'u64'| 18446744073709551615) (= $t6@0@@3 (= $t4@0 18446744073709551615)))) (and (=> (= (ControlFlow 0 302650) 302832) anon10_Then_correct@@5) (=> (= (ControlFlow 0 302650) 302670) anon10_Else_correct@@5))))))
(let ((inline$$InitEventStore$0$anon0_correct@@15  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@17 T@$1_Event_EventHandle) ) (! (let ((stream@@16 (|Select__T@[$1_Event_EventHandle]Multiset_112887_| (|streams#$EventStore| $es) handle@@17)))
 (and (= (|l#Multiset_112887| stream@@16) 0) (forall ((v@@60 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_112887| stream@@16) v@@60) 0)
 :qid |AccountLimitsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountLimitsbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 302566) 302650)) anon0$1_correct@@15)))
(let ((anon0_correct@@15  (=> (= (ControlFlow 0 415235) 302566) inline$$InitEventStore$0$anon0_correct@@15)))
anon0_correct@@15)))))))))))
))
(check-sat)
(pop 1)
