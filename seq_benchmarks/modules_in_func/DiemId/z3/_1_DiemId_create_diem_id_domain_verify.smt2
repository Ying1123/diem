...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 223754) (let ((L3_correct  (and (=> (= (ControlFlow 0 163339) (- 0 223996)) (> (seq.len _$t0) 63)) (=> (> (seq.len _$t0) 63) (=> (= (ControlFlow 0 163339) (- 0 224003)) (and (> (seq.len _$t0) 63) (= 7 $t4@0)))))))
(let ((anon8_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= $t8 $t8)) (and (= $t4@0 $t8) (= (ControlFlow 0 163307) 163339))) L3_correct)))
(let ((anon8_Then_correct  (=> (and inline$$Le$0$dst@1 (= $t9@0 ($1_DiemId_DiemIdDomain _$t0))) (and (=> (= (ControlFlow 0 163393) (- 0 223925)) (<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| $t9@0)) 63)) (=> (<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| $t9@0)) 63) (=> (= $t9@0 $t9@0) (and (=> (= (ControlFlow 0 163393) (- 0 223948)) (not (> (seq.len _$t0) 63))) (=> (not (> (seq.len _$t0) 63)) (=> (= (ControlFlow 0 163393) (- 0 223960)) (= $t9@0 ($1_DiemId_DiemIdDomain _$t0)))))))))))
(let ((anon7_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| $t8) (= $t8 7)) (and (= $t8 $t8) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 163291) 163393) anon8_Then_correct) (=> (= (ControlFlow 0 163291) 163307) anon8_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 163255) 163291)) anon7_Else$1_correct)))
(let ((anon7_Else_correct  (=> (not false) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 163261) 163255)) inline$$Le$0$anon0_correct))))
(let ((anon7_Then_correct true))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (seq.len _$t0)) (and (=> (= (ControlFlow 0 163195) 163407) anon7_Then_correct) (=> (= (ControlFlow 0 163195) 163261) anon7_Else_correct)))))
(let ((anon0$1_correct  (=> (|$IsValid'vec'u8''| _$t0) (=> (and (= _$t0 _$t0) (= (ControlFlow 0 163201) 163195)) |inline$$1_Vector_length'u8'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_69963_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemIdbpl.2728:13|
 :skolemid |74|
))) (= (ControlFlow 0 163137) 163201)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 223754) 163137) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
