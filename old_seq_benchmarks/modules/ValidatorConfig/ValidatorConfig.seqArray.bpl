...
L3:
    ...
    assert {:msg "assert_failed(26,7054,7423): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ($ResourceExists($1_Roles_RoleId_$memory#96, $1_Signer_$address_of($t0)) && $IsEqual'num'(6, $t10));
...
L3:
    ...
    assert {:msg "assert_failed(36,12081,12222): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#94, $t0) && $IsEqual'num'(5, $t7));
...
L3:
    ...
    assert {:msg "assert_failed(36,2634,2823): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((($1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#135, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(6, $t7)) || (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#136) && $IsEqual'num'(1, $t7))) || (!$ResourceExists($1_Roles_RoleId_$memory#137, $t5) && $IsEqual'num'(5, $t7))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $t5)), 0) && $IsEqual'num'(3, $t7))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), 173345816) && $IsEqual'num'(2, $t7))) || (!$ResourceExists($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(5, $t7))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#137, $1_Signer_spec_address_of($t0))), 3) && $IsEqual'num'(3, $t7)));
...
L5:
    ...
    assert {:msg "assert_failed(36,11300,11541): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#130, $t0) && $IsEqual'num'(5, $t7)) || ($1_Option_$is_none'$1_ValidatorConfig_Config'($config#$1_ValidatorConfig_ValidatorConfig($ResourceValue($1_ValidatorConfig_ValidatorConfig_$memory#130, $t0))) && $IsEqual'num'(7, $t7)));
...
L5:
    ...
    assert {:msg "assert_failed(36,12743,12874): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#129, $t0) && $IsEqual'num'(7, $t9)) || (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#129, $t0) && $IsEqual'num'(5, $t9)));
...
L5:
    ...
    assume ((!$ResourceExists($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0)) && $IsEqual'num'(5, $t6)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0))), 3) && $IsEqual'num'(3, $t6)));
...
L3:
    ...
    assert {:msg "assert_failed(36,6745,7395): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$ResourceExists($1_Roles_RoleId_$memory#111, $t4) && $IsEqual'num'(5, $t6)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#111, $t4)), 3) && $IsEqual'num'(3, $t6))) || (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#112, $t4) && $IsEqual'num'(5, $t6)));
...
L7:
    ...
    assert {:msg "assert_failed(36,8847,9533): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((!$IsEqual'address'($1_Signer_$address_of($t0), $1_ValidatorConfig_$get_operator($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1)) && $IsEqual'num'(7, $t15)) || (!$1_Signature_$ed25519_validate_pubkey($t2) && $IsEqual'num'(7, $t15))) || (!$1_ValidatorConfig_spec_has_operator($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1) && $IsEqual'num'(7, $t15))) || (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#145, $t1) && $IsEqual'num'(5, $t15)));
...
L7:
    ...
    assume ((!$ResourceExists($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0)) && $IsEqual'num'(5, $t11)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $1_Signer_$address_of($t0))), 3) && $IsEqual'num'(3, $t11)));
...
L5:
    ...
    assert {:msg "assert_failed(36,4667,4990): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$ResourceExists($1_Roles_RoleId_$memory#114, $t7) && $IsEqual'num'(5, $t11)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#114, $t7)), 3) && $IsEqual'num'(3, $t11))) || (!$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115, $t1) && $IsEqual'num'(7, $t11))) || (!$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#115, $t1) && $IsEqual'num'(5, $t11))) || (!$ResourceExists($1_Roles_RoleId_$memory#114, $t8) && $IsEqual'num'(5, $t11))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#114, $t8)), 3) && $IsEqual'num'(3, $t11))) || (!$1_ValidatorConfig_$exists_config($1_ValidatorConfig_ValidatorConfig_$memory#116, $t8) && $IsEqual'num'(5, $t11)));
