...
L5:
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assert Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:72:9+89
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:72:9+89
    assume {:print "$at(20,2605,2694)"} true;
    assert {:msg "assert_failed(20,2605,2694): global memory invariant does not hold"}
...
// fun DiemVersion::initialize [verification] at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+298
procedure {:timeLimit 40} $1_DiemVersion_initialize$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+298
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(20,615,913)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+298
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+298
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:72:9+89
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+298
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+298
    assume $IsValid'u64'($t1);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+298
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+298
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+298
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+298
    ...
    // @146 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+1
    assume {:print "$at(20,615,616)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @145 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+1
    $1_Roles_RoleId_$memory#145 := $1_Roles_RoleId_$memory;

    // @149 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+1
    $1_DiemConfig_Configuration_$memory#149 := $1_DiemConfig_Configuration_$memory;

    // @147 := save_mem(DiemConfig::DiemConfig<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+1
    ...
    // @148 := save_mem(DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:19:5+1
...
L1:
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@146]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:142:9+51
    ...
    // assert Not(DiemConfig::spec_is_published[@147]<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:260:9+38
    ...
    // assert Not(exists[@148]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:261:9+86
    ...
    // assert Not(Not(exists[@145]<Roles::RoleId>($t3))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#145, $t3);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t3)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
    ...
    // assert exists<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:267:9+84
    ...
    // assert DiemConfig::spec_is_published<DiemVersion::DiemVersion>() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:145:9+36
    ...
    // assert Eq<DiemVersion::DiemVersion>(DiemConfig::$get<DiemVersion::DiemVersion>(), pack DiemVersion::DiemVersion($t1)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:146:9+33
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@149](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:147:9+52
    ...
    // assert Implies(DiemConfig::spec_is_published[@147]<DiemVersion::DiemVersion>(), Eq<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(global<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(CoreAddresses::$DIEM_ROOT_ADDRESS()), global[@147]<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:79:9+234
    assume {:print "$at(20,2850,3084)"} true;
    assert {:msg "assert_failed(20,2850,3084): post-condition does not hold"}
      ($1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#147) ==> $IsEqual'$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion''($ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()), $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#147, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())));

    // return () at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:79:9+234
    return;
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Not(exists[@145]<Roles::RoleId>($t2)), Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t2)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Not(DiemTimestamp::$is_genesis[@146]())), DiemConfig::spec_is_published[@147]<DiemVersion::DiemVersion>()), exists[@148]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0))), Not(exists[@145]<Roles::RoleId>($t3))), Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t3)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:27:5+412
    assume {:print "$at(20,918,1330)"} true;
    assert {:msg "assert_failed(20,918,1330): abort not covered by any of the `aborts_if` clauses"}
      ((((((((!$ResourceExists($1_Roles_RoleId_$memory#145, $t2) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t2)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146)) || $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#147)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#148, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#145, $t3)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t3)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(And(Not(exists[@145]<Roles::RoleId>($t2)), Eq(5, $t5)), And(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t2)), 0), Eq(3, $t5))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t5))), And(Not(DiemTimestamp::$is_genesis[@146]()), Eq(1, $t5))), DiemConfig::spec_is_published[@147]<DiemVersion::DiemVersion>()), exists[@148]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0))), And(Not(exists[@145]<Roles::RoleId>($t3)), Eq(5, $t5))), And(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t3)), 0), Eq(3, $t5))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t5))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:27:5+412
    assert {:msg "assert_failed(20,918,1330): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((((!$ResourceExists($1_Roles_RoleId_$memory#145, $t2) && $IsEqual'u8'(5, $t5)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t2)), 0) && $IsEqual'u8'(3, $t5))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t5))) || (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) && $IsEqual'u8'(1, $t5))) || $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#147)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#148, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory#145, $t3) && $IsEqual'u8'(5, $t5))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t3)), 0) && $IsEqual'u8'(3, $t5))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t5)));

    // abort($t5) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:27:5+412
    $abort_code := $t5;
    $abort_flag := true;
    return;
...
// fun DiemVersion::set [verification] at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
procedure {:timeLimit 40} $1_DiemVersion_set$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(20,1410,1854)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:72:9+89
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
    assume $IsValid'u64'($t1);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion''($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+444
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion''($rsc))));
    ...
    // @180 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+1
    ...
    // @179 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+1
    $1_Roles_RoleId_$memory#179 := $1_Roles_RoleId_$memory;

    // @184 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+1
    $1_DiemConfig_Configuration_$memory#184 := $1_DiemConfig_Configuration_$memory;

    // @183 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#183 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @181 := save_mem(DiemConfig::DiemConfig<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+1
    ...
    // @182 := save_mem(DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:37:5+1
...
L10:
    ...
    // @185 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@185](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:49:9+97
...
L2:
    ...
    // assert Not(Not(exists[@179]<Roles::RoleId>($t5))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#179, $t5);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@179]<Roles::RoleId>($t5)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@180]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180);

    // assert Not(Ge(select DiemVersion::DiemVersion.major(DiemConfig::$get[@181]<DiemVersion::DiemVersion>()), $t1)) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:59:9+86
    assume {:print "$at(20,2087,2173)"} true;
    assert {:msg "assert_failed(20,2087,2173): function does not abort under this condition"}
    ...
    // assert Not(Not(exists[@182]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:140:9+129
    ...
    // assert Not(Not(exists[@181]<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:104:9+101
    assume {:print "$at(13,3930,4031)"} true;
    assert {:msg "assert_failed(13,3930,4031): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@184](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:147:9+52
    assume {:print "$at(13,5905,5957)"} true;
    assert {:msg "assert_failed(13,5905,5957): post-condition does not hold"}
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Not(exists[@179]<Roles::RoleId>($t5)), Neq<u64>(select Roles::RoleId.role_id(global[@179]<Roles::RoleId>($t5)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Not(DiemTimestamp::$is_operating[@180]())), Ge(select DiemVersion::DiemVersion.major(DiemConfig::$get[@181]<DiemVersion::DiemVersion>()), $t1)), Not(exists[@182]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0)))), Not(exists[@181]<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))), And(And(And(And(DiemTimestamp::$is_operating[@180](), DiemConfig::$reconfiguration_enabled[@183]()), Gt(DiemTimestamp::spec_now_microseconds[@180](), 0)), Lt(select DiemConfig::Configuration.epoch($t6), 18446744073709551615)), Lt($t7, select DiemConfig::Configuration.last_reconfiguration_time($t6)))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:54:5+480
    assume {:print "$at(20,1859,2339)"} true;
    assert {:msg "assert_failed(20,1859,2339): abort not covered by any of the `aborts_if` clauses"}
      (((((((!$ResourceExists($1_Roles_RoleId_$memory#179, $t5) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#179, $t5)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180)) || ($major#$1_DiemVersion_DiemVersion($1_DiemConfig_$get'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181)) >= $t1)) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#182, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#183)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) > 0)) && ($epoch#$1_DiemConfig_Configuration($t6) < 18446744073709551615)) && ($t7 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t6))));

    // assert Or(Or(Or(Or(Or(Or(Or(And(Not(exists[@179]<Roles::RoleId>($t5)), Eq(5, $t9)), And(Neq<u64>(select Roles::RoleId.role_id(global[@179]<Roles::RoleId>($t5)), 0), Eq(3, $t9))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t9))), And(Not(DiemTimestamp::$is_operating[@180]()), Eq(1, $t9))), And(Ge(select DiemVersion::DiemVersion.major(DiemConfig::$get[@181]<DiemVersion::DiemVersion>()), $t1), Eq(7, $t9))), And(Not(exists[@182]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0))), Eq(4, $t9))), And(Not(exists[@181]<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Eq(5, $t9))), And(And(And(And(And(DiemTimestamp::$is_operating[@180](), DiemConfig::$reconfiguration_enabled[@183]()), Gt(DiemTimestamp::spec_now_microseconds[@180](), 0)), Lt(select DiemConfig::Configuration.epoch($t6), 18446744073709551615)), Lt($t7, select DiemConfig::Configuration.last_reconfiguration_time($t6))), Eq(1, $t9))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:54:5+480
    assert {:msg "assert_failed(20,1859,2339): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((!$ResourceExists($1_Roles_RoleId_$memory#179, $t5) && $IsEqual'u8'(5, $t9)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#179, $t5)), 0) && $IsEqual'u8'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t9))) || (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) && $IsEqual'u8'(1, $t9))) || (($major#$1_DiemVersion_DiemVersion($1_DiemConfig_$get'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181)) >= $t1) && $IsEqual'u8'(7, $t9))) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#182, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t9))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t9))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#183)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) > 0)) && ($epoch#$1_DiemConfig_Configuration($t6) < 18446744073709551615)) && ($t7 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t6))) && $IsEqual'u8'(1, $t9)));

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:54:5+480
    $abort_code := $t9;
    $abort_flag := true;
    return;
