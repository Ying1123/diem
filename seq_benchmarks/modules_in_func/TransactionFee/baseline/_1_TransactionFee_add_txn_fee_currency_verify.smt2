...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 328312) (let ((anon26_Else_correct  (=> (and (and (not $abort_flag@3) (= (ControlFlow 0 226829) (- 0 329847))) (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_130984| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))))
(let ((anon26_Then_correct true))
(let ((anon25_Then$1_correct  (=> (and (= $abort_flag@3 true) (= $abort_code@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 226895) 226843) anon26_Then_correct) (=> (= (ControlFlow 0 226895) 226829) anon26_Else_correct)))))
(let ((anon25_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|$addr#$signer| _$t0)) (= (ControlFlow 0 226893) 226895)) anon25_Then$1_correct)))
(let ((anon25_Else_correct  (=> (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|$addr#$signer| _$t0))) (= |$1_TransactionFee_TransactionFee'#0'_$memory@0| ($Memory_173582 (|Store__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) (|$addr#$signer| _$t0) $t14@0)))) (and (= $abort_flag@3 $abort_flag@2) (= $abort_code@4 $abort_code@3))) (and (=> (= (ControlFlow 0 226807) 226843) anon26_Then_correct) (=> (= (ControlFlow 0 226807) 226829) anon26_Else_correct)))))
(let ((anon24_Else_correct  (=> (not $abort_flag@2) (=> (and (= $t14@0 (|$1_TransactionFee_TransactionFee'#0'| |inline$$1_Diem_zero'#0'$0$$ret0| |inline$$1_Diem_create_preburn'#0'$0$$ret0|)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129531| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_130984| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (and (=> (= (ControlFlow 0 226785) 226893) anon25_Then_correct) (=> (= (ControlFlow 0 226785) 226807) anon25_Else_correct))))))
(let ((anon24_Then_correct true))
(let ((|inline$$1_Diem_create_preburn'#0'$0$L2_correct|  (=> (and (= $abort_code@3 |inline$$1_Diem_create_preburn'#0'$0$$t4@1|) (= $abort_flag@2 true)) (and (=> (= (ControlFlow 0 226651) 226909) anon24_Then_correct) (=> (= (ControlFlow 0 226651) 226785) anon24_Else_correct)))))
(let ((|inline$$1_Diem_create_preburn'#0'$0$anon9_Then_correct|  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= |inline$$1_Diem_create_preburn'#0'$0$$t4@1| $abort_code@2) (= (ControlFlow 0 226645) 226651))) |inline$$1_Diem_create_preburn'#0'$0$L2_correct|)))
...
(let ((|inline$$1_Diem_create_preburn'#0'$0$anon7_Then_correct|  (=> |inline$$1_Diem_create_preburn'#0'$0$$t3@0| (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'#0'$0$$t2@0|)) (= 5 |inline$$1_Diem_create_preburn'#0'$0$$t4@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'#0'$0$$t2@0|)) 1)) (= 3 |inline$$1_Diem_create_preburn'#0'$0$$t4@0|))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 |inline$$1_Diem_create_preburn'#0'$0$$t4@0|))) (= |inline$$1_Diem_create_preburn'#0'$0$$t4@0| |inline$$1_Diem_create_preburn'#0'$0$$t4@0|)) (and (= |inline$$1_Diem_create_preburn'#0'$0$$t4@1| |inline$$1_Diem_create_preburn'#0'$0$$t4@0|) (= (ControlFlow 0 226749) 226651))) |inline$$1_Diem_create_preburn'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_create_preburn'#0'$0$anon9_Else_correct|  (=> (not $abort_flag@1) (=> (and (and (= |inline$$1_Diem_create_preburn'#0'$0$$t7@1| (|$1_Diem_Preburn'#0'| |inline$$1_Diem_zero'#0'$1$$ret0@1|)) (= |inline$$1_Diem_create_preburn'#0'$0$$t7@1| |inline$$1_Diem_create_preburn'#0'$0$$t7@1|)) (and (= $abort_code@3 $abort_code@2) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 226631) 226909) anon24_Then_correct) (=> (= (ControlFlow 0 226631) 226785) anon24_Else_correct))))))
(let ((|inline$$1_Diem_zero'#0'$1$anon3_Else_correct|  (=> (not |inline$$1_Diem_zero'#0'$1$$t0@0|) (=> (and (|$IsValid'u64'| 0) (= |inline$$1_Diem_zero'#0'$1$$t3@1| (|$1_Diem_Diem'#0'| 0))) (=> (and (and (= |inline$$1_Diem_zero'#0'$1$$t3@1| |inline$$1_Diem_zero'#0'$1$$t3@1|) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_Diem_zero'#0'$1$$ret0@1| |inline$$1_Diem_zero'#0'$1$$t3@1|))) (and (=> (= (ControlFlow 0 226573) 226645) |inline$$1_Diem_create_preburn'#0'$0$anon9_Then_correct|) (=> (= (ControlFlow 0 226573) 226631) |inline$$1_Diem_create_preburn'#0'$0$anon9_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'#0'$1$anon3_Then_correct|  (=> |inline$$1_Diem_zero'#0'$1$$t0@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_zero'#0'$1$$t1@0|)) (=> (and (and (= |inline$$1_Diem_zero'#0'$1$$t1@0| |inline$$1_Diem_zero'#0'$1$$t1@0|) (= $abort_code@2 |inline$$1_Diem_zero'#0'$1$$t1@0|)) (and (= $abort_flag@1 true) (= |inline$$1_Diem_zero'#0'$1$$ret0@1| |inline$$1_Diem_zero'#0'$1$$ret0@0|))) (and (=> (= (ControlFlow 0 226603) 226645) |inline$$1_Diem_create_preburn'#0'$0$anon9_Then_correct|) (=> (= (ControlFlow 0 226603) 226631) |inline$$1_Diem_create_preburn'#0'$0$anon9_Else_correct|)))))))
...
(let ((|inline$$1_Diem_create_preburn'#0'$0$anon0_correct|  (=> (and (and (= |inline$$1_Diem_create_preburn'#0'$0$$t1@0| (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= |inline$$1_Diem_create_preburn'#0'$0$$t2@0| (|$addr#$signer| _$t0)) (= |inline$$1_Diem_create_preburn'#0'$0$$t3@0|  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'#0'$0$$t2@0|)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'#0'$0$$t2@0|)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))))) (and (=> (= (ControlFlow 0 226370) 226749) |inline$$1_Diem_create_preburn'#0'$0$anon7_Then_correct|) (=> (= (ControlFlow 0 226370) 226388) |inline$$1_Diem_create_preburn'#0'$0$anon7_Else_correct|)))))
(let ((anon23_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t12 (|$addr#$signer| _$t0)) (= (ControlFlow 0 226755) 226370)) |inline$$1_Diem_create_preburn'#0'$0$anon0_correct|))))
(let ((anon23_Then_correct true))
(let ((|inline$$1_Diem_zero'#0'$0$anon3_Else_correct|  (=> (and (not |inline$$1_Diem_zero'#0'$0$$t0@0|) (|$IsValid'u64'| 0)) (=> (and (and (= |inline$$1_Diem_zero'#0'$0$$t3@1| (|$1_Diem_Diem'#0'| 0)) (= |inline$$1_Diem_zero'#0'$0$$t3@1| |inline$$1_Diem_zero'#0'$0$$t3@1|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 225890) 226923) anon23_Then_correct) (=> (= (ControlFlow 0 225890) 226755) anon23_Else_correct))))))
(let ((|inline$$1_Diem_zero'#0'$0$anon3_Then_correct|  (=> |inline$$1_Diem_zero'#0'$0$$t0@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_zero'#0'$0$$t1@0|)) (= |inline$$1_Diem_zero'#0'$0$$t1@0| |inline$$1_Diem_zero'#0'$0$$t1@0|)) (and (= $abort_flag@0 true) (= $abort_code@1 |inline$$1_Diem_zero'#0'$0$$t1@0|))) (and (=> (= (ControlFlow 0 225920) 226923) anon23_Then_correct) (=> (= (ControlFlow 0 225920) 226755) anon23_Else_correct))))))
...
(let ((anon22_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 225926) 225862)) |inline$$1_Diem_zero'#0'$0$anon0_correct|)))
(let ((anon22_Else_correct true))
(let ((anon21_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t10) (= $t10 6)) (and (= $t10 $t10) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 225685) 225926) anon22_Then_correct) (=> (= (ControlFlow 0 225685) 225701) anon22_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|)) (= (ControlFlow 0 225645) 225685)) anon21_Else$1_correct)))
(let ((anon21_Else_correct  (=> (and (not false) (= (ControlFlow 0 225651) 225645)) inline$$Not$0$anon0_correct)))
(let ((anon21_Then_correct true))
(let ((|inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 186537453) (=> (and (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 225601) 226937) anon21_Then_correct) (=> (= (ControlFlow 0 225601) 225651) anon21_Else_correct))))))
(let ((anon20_Else_correct  (=> (and (not $t6) (= (ControlFlow 0 225607) 225601)) |inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|)))
(let ((anon20_Then_correct true))
(let ((anon19_Else_correct  (=> (and (not $t4) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 225514) 226963) anon20_Then_correct) (=> (= (ControlFlow 0 225514) 225607) anon20_Else_correct)))))
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@0)))
 ...
 :skolemid |239|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_139144| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@0))
)))) (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@1)))
(|$IsValid'$1_TransactionFee_TransactionFee'#0''| $rsc@@1))
 :qid |TransactionFeebpl.15569:20|
 :skolemid |240|
 :pattern ( (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_173582| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@1))
)) (= _$t0 _$t0)) (and (= $t3 (|$addr#$signer| _$t0)) (= $t4  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_131378| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_131378| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))) (and (=> (= (ControlFlow 0 225496) 227035) anon19_Then_correct) (=> (= (ControlFlow 0 225496) 225514) anon19_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_91738_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |TransactionFeebpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 224976) 225496)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 328312) 224976) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
