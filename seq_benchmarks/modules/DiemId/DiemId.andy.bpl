...
L7:
    ...
    // @182 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@182](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
...
L7:
    ...
    // @172 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@172](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
...
L2:
    ...
    // trace_local[account#1821]($t17) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:955:13+7
...
procedure {:inline 1} $1_DiemId_tc_domain_manager_exists() returns ($ret0: bool)
{
    ...
    assume {:print "$track_return(32,7,0):", $t1} $t1 == $t1;
...
procedure {:timeLimit 40} $1_DiemId_add_diem_id_domain$verify(_$t0: int, _$t1: int, _$t2: Vec (int)) returns ()
{
    // declare local variables
    var $t3: $Mutation ($1_DiemId_DiemIdDomains);
    var $t4: $1_DiemId_DiemIdDomain;
    var $t5: bool;
    var $t6: int;
    var $t7: bool;
    var $t8: int;
    ...
    var $1_DiemId_DiemIdDomainManager_$memory#121: $Memory $1_DiemId_DiemIdDomainManager;
    ...
    // @122 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemId.move:143:5+1
    assume {:print "$at(15,5837,5838)"} true;
    $1_Roles_RoleId_$memory#122 := $1_Roles_RoleId_$memory;

    // @121 := save_mem(DiemId::DiemIdDomainManager) at /home/ying/diem/language/diem-framework/modules/DiemId.move:143:5+1
    $1_DiemId_DiemIdDomainManager_$memory#121 := $1_DiemId_DiemIdDomainManager_$memory;

    // @120 := save_mem(DiemId::DiemIdDomains) at /home/ying/diem/language/diem-framework/modules/DiemId.move:143:5+1
...
L9:
    ...
    assume (((!$ResourceExists($1_Roles_RoleId_$memory, $t15) && $IsEqual'u8'(5, $t17)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory, $t15)), 1) && $IsEqual'u8'(3, $t17))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t17)));

    // trace_abort($t17) at /home/ying/diem/language/diem-framework/modules/DiemId.move:148:9+45
    assume {:print "$at(15,6011,6056)"} true;
    assume {:print "$track_abort(32,0):", $t17} $t17 == $t17;
...
L8:
    ...
    // trace_local[tmp#$6]($t20) at /home/ying/diem/language/diem-framework/modules/DiemId.move:149:9+82
    assume {:print "$track_local(32,0,6):", $t20} $t20 == $t20;

    // trace_local[tmp#$5]($t18) at /home/ying/diem/language/diem-framework/modules/DiemId.move:149:9+82
    assume {:print "$track_local(32,0,5):", $t18} $t18 == $t18;
...
L1:
    ...
    assume {:print "$track_abort(32,0):", $t20} $t20 == $t20;
...
L0:
    ...
    // trace_local[tmp#$8]($t23) at /home/ying/diem/language/diem-framework/modules/DiemId.move:150:9+127
    assume {:print "$at(15,6158,6285)"} true;
    assume {:print "$track_local(32,0,8):", $t23} $t23 == $t23;

    // trace_local[tmp#$7]($t21) at /home/ying/diem/language/diem-framework/modules/DiemId.move:150:9+127
    assume {:print "$track_local(32,0,7):", $t21} $t21 == $t21;
...
L3:
    ...
    assume {:print "$at(15,6158,6285)"} true;
    assume {:print "$track_abort(32,0):", $t23} $t23 == $t23;
...
L2:
    ...
    assume {:print "$track_local(32,0,3):", $temp_0'$1_DiemId_DiemIdDomains'} $temp_0'$1_DiemId_DiemIdDomains' == $temp_0'$1_DiemId_DiemIdDomains';
    ...
    assume {:print "$track_local(32,0,4):", $t25} $t25 == $t25;
    ...
    // trace_local[tmp#$10]($t30) at /home/ying/diem/language/diem-framework/modules/DiemId.move:158:9+152
    assume {:print "$at(15,6430,6582)"} true;
    assume {:print "$track_local(32,0,10):", $t30} $t30 == $t30;

    // trace_local[tmp#$9]($t28) at /home/ying/diem/language/diem-framework/modules/DiemId.move:158:9+152
    assume {:print "$track_local(32,0,9):", $t28} $t28 == $t28;
...
L5:
    ...
    assume {:print "$at(15,6430,6582)"} true;
    assume {:print "$track_abort(32,0):", $t30} $t30 == $t30;
...
L6:
    ...
    // assert Not(Not(exists[@120]<DiemId::DiemIdDomains>($t1))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:186:9+69
    assume {:print "$at(15,7420,7489)"} true;
    assert {:msg "assert_failed(15,7420,7489): function does not abort under this condition"}
      !!$ResourceExists($1_DiemId_DiemIdDomains_$memory#120, $t1);

    // assert Not(Not(DiemId::$tc_domain_manager_exists[@121]())) at /home/ying/diem/language/diem-framework/modules/DiemId.move:187:9+65
    assume {:print "$at(15,7498,7563)"} true;
    assert {:msg "assert_failed(15,7498,7563): function does not abort under this condition"}
      !!$1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#121);
    ...
    // assert Not(Not(exists[@122]<Roles::RoleId>($t12))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    assume {:print "$at(26,23933,23992)"} true;
    assert {:msg "assert_failed(26,23933,23992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#122, $t12);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t12)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    assume {:print "$at(26,24001,24098)"} true;
    assert {:msg "assert_failed(26,24001,24098): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t12)), 1);
...
L7:
    ...
    // assert Or(Or(Or(Or(Or(Or(Not(exists[@120]<DiemId::DiemIdDomains>($t1)), Not(DiemId::$tc_domain_manager_exists[@121]())), ContainsVec<DiemId::DiemIdDomain>($t11, pack DiemId::DiemIdDomain($t2))), Not(exists[@122]<Roles::RoleId>($t12))), Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t12)), 1)), Neq<address>(Signer::spec_address_of[]($t0), b1e55ed)), Gt(Vector::$length[]<u8>($t2), 63)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:174:5+150
    assume {:print "$at(15,6956,7106)"} true;
    assert {:msg "assert_failed(15,6956,7106): abort not covered by any of the `aborts_if` clauses"}
      ((((((!$ResourceExists($1_DiemId_DiemIdDomains_$memory#120, $t1) || !$1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#121)) || $ContainsVec'$1_DiemId_DiemIdDomain'($t11, $1_DiemId_DiemIdDomain($t2))) || !$ResourceExists($1_Roles_RoleId_$memory#122, $t12)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t12)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453)) || ($1_Vector_$length'u8'($t2) > 63));

    // assert Or(Or(Or(Or(Or(Or(And(Not(exists[@120]<DiemId::DiemIdDomains>($t1)), Eq(5, $t17)), And(Not(DiemId::$tc_domain_manager_exists[@121]()), Eq(5, $t17))), And(ContainsVec<DiemId::DiemIdDomain>($t11, pack DiemId::DiemIdDomain($t2)), Eq(7, $t17))), And(Not(exists[@122]<Roles::RoleId>($t12)), Eq(5, $t17))), And(Neq<u64>(select Roles::RoleId.role_id(global[@122]<Roles::RoleId>($t12)), 1), Eq(3, $t17))), And(Neq<address>(Signer::spec_address_of[]($t0), b1e55ed), Eq(2, $t17))), And(Gt(Vector::$length[]<u8>($t2), 63), Eq(7, $t17))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:174:5+150
    assert {:msg "assert_failed(15,6956,7106): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$ResourceExists($1_DiemId_DiemIdDomains_$memory#120, $t1) && $IsEqual'u8'(5, $t17)) || (!$1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#121) && $IsEqual'u8'(5, $t17))) || ($ContainsVec'$1_DiemId_DiemIdDomain'($t11, $1_DiemId_DiemIdDomain($t2)) && $IsEqual'u8'(7, $t17))) || (!$ResourceExists($1_Roles_RoleId_$memory#122, $t12) && $IsEqual'u8'(5, $t17))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#122, $t12)), 1) && $IsEqual'u8'(3, $t17))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t17))) || (($1_Vector_$length'u8'($t2) > 63) && $IsEqual'u8'(7, $t17)));
...
L1:
    ...
    assume {:print "$track_abort(32,1):", $t8} $t8 == $t8;
...
L0:
    ...
    assume {:print "$track_return(32,1,0):", $t9} $t9 == $t9;
...
L3:
    ...
    assert {:msg "assert_failed(15,2511,2640): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (($1_Vector_$length'u8'($t0) > 63) && $IsEqual'u8'(7, $t4));
...
{
    // declare local variables
    var $t2: $1_DiemId_DiemIdDomains;
    var $t3: $1_DiemId_DiemIdDomain;
    var $t4: bool;
    var $t5: int;
    ...
    var $temp_0'u64': int;
    var $temp_0'vec'u8'': Vec (int);
    var $1_DiemId_DiemIdDomains_$memory#104: $Memory $1_DiemId_DiemIdDomains;
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // @104 := save_mem(DiemId::DiemIdDomains) at /home/ying/diem/language/diem-framework/modules/DiemId.move:275:5+1
    assume {:print "$at(15,10838,10839)"} true;
    $1_DiemId_DiemIdDomains_$memory#104 := $1_DiemId_DiemIdDomains_$memory;
    ...
    // trace_local[tmp#$5]($t9) at /home/ying/diem/language/diem-framework/modules/DiemId.move:276:9+124
    assume {:print "$at(15,10942,11066)"} true;
    assume {:print "$track_local(32,2,5):", $t9} $t9 == $t9;

    // trace_local[tmp#$4]($t7) at /home/ying/diem/language/diem-framework/modules/DiemId.move:276:9+124
    assume {:print "$track_local(32,2,4):", $t7} $t7 == $t7;
...
L1:
    ...
    assume {:print "$at(15,10942,11066)"} true;
    assume {:print "$track_abort(32,2):", $t9} $t9 == $t9;
...
L0:
    ...
    assume {:print "$track_local(32,2,3):", $t12} $t12 == $t12;
...
L3:
    ...
    // assert Or(Not(exists[@104]<DiemId::DiemIdDomains>($t0)), Gt(Vector::$length[]<u8>($t1), 63)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:284:5+205
    ...
    assert {:msg "assert_failed(15,11272,11477): abort not covered by any of the `aborts_if` clauses"}
      (!$ResourceExists($1_DiemId_DiemIdDomains_$memory#104, $t0) || ($1_Vector_$length'u8'($t1) > 63));

    // assert Or(And(Not(exists[@104]<DiemId::DiemIdDomains>($t0)), Eq(5, $t10)), And(Gt(Vector::$length[]<u8>($t1), 63), Eq(7, $t10))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:284:5+205
    assert {:msg "assert_failed(15,11272,11477): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((!$ResourceExists($1_DiemId_DiemIdDomains_$memory#104, $t0) && $IsEqual'u8'(5, $t10)) || (($1_Vector_$length'u8'($t1) > 63) && $IsEqual'u8'(7, $t10)));
...
procedure {:timeLimit 40} $1_DiemId_has_diem_id_domains$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    assume {:print "$track_return(32,3,0):", $t1} $t1 == $t1;
...
procedure {:timeLimit 40} $1_DiemId_publish_diem_id_domain_manager$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_Roles_RoleId_$memory#142: $Memory $1_Roles_RoleId;
    var $1_DiemId_DiemIdDomainManager_$memory#143: $Memory $1_DiemId_DiemIdDomainManager;
    $t0 := _$t0;
    ...
    // @142 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemId.move:136:9+74
    $1_Roles_RoleId_$memory#142 := $1_Roles_RoleId_$memory;

    // @143 := save_mem(DiemId::DiemIdDomainManager) at /home/ying/diem/language/diem-framework/modules/DiemId.move:136:9+74
    $1_DiemId_DiemIdDomainManager_$memory#143 := $1_DiemId_DiemIdDomainManager_$memory;
...
L1:
    ...
    assume {:print "$at(15,4799,4953)"} true;
    assume {:print "$track_abort(32,4):", $t11} $t11 == $t11;
...
L0:
    ...
    assert {:msg "assert_failed(15,4963,4970): caller does not have permission to modify `DiemId::DiemIdDomainManager` at given address"}
      $1_DiemId_DiemIdDomainManager_$modifies[$t0];
...
L2:
    ...
    // assert Not(Not(exists[@142]<Roles::RoleId>($t3))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    assume {:print "$at(26,23933,23992)"} true;
    assert {:msg "assert_failed(26,23933,23992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#142, $t3);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@142]<Roles::RoleId>($t3)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    assume {:print "$at(26,24001,24098)"} true;
    assert {:msg "assert_failed(26,24001,24098): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#142, $t3)), 1);
    ...
    // assert Not(DiemId::$tc_domain_manager_exists[@143]()) at /home/ying/diem/language/diem-framework/modules/DiemId.move:134:9+68
    assume {:print "$at(15,5281,5349)"} true;
    assert {:msg "assert_failed(15,5281,5349): function does not abort under this condition"}
      !$1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#143);
...
L3:
    ...
    // assert Or(Or(Or(Not(exists[@142]<Roles::RoleId>($t3)), Neq<u64>(select Roles::RoleId.role_id(global[@142]<Roles::RoleId>($t3)), 1)), Neq<address>(Signer::spec_address_of[]($t0), b1e55ed)), DiemId::$tc_domain_manager_exists[@143]()) at /home/ying/diem/language/diem-framework/modules/DiemId.move:132:5+360
    assume {:print "$at(15,5160,5520)"} true;
    assert {:msg "assert_failed(15,5160,5520): abort not covered by any of the `aborts_if` clauses"}
      (((!$ResourceExists($1_Roles_RoleId_$memory#142, $t3) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#142, $t3)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453)) || $1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#143));

    // assert Or(Or(Or(And(Not(exists[@142]<Roles::RoleId>($t3)), Eq(5, $t6)), And(Neq<u64>(select Roles::RoleId.role_id(global[@142]<Roles::RoleId>($t3)), 1), Eq(3, $t6))), And(Neq<address>(Signer::spec_address_of[]($t0), b1e55ed), Eq(2, $t6))), And(DiemId::$tc_domain_manager_exists[@143](), Eq(6, $t6))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:132:5+360
    assert {:msg "assert_failed(15,5160,5520): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((!$ResourceExists($1_Roles_RoleId_$memory#142, $t3) && $IsEqual'u8'(5, $t6)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#142, $t3)), 1) && $IsEqual'u8'(3, $t6))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t6))) || ($1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#143) && $IsEqual'u8'(6, $t6)));
...
procedure {:timeLimit 40} $1_DiemId_publish_diem_id_domains$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
    ...
    var $1_DiemId_DiemIdDomains_$memory#106: $Memory $1_DiemId_DiemIdDomains;
    $t0 := _$t0;
    ...
    // @105 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemId.move:78:5+1
    assume {:print "$at(15,3102,3103)"} true;
    $1_Roles_RoleId_$memory#105 := $1_Roles_RoleId_$memory;

    // @106 := save_mem(DiemId::DiemIdDomains) at /home/ying/diem/language/diem-framework/modules/DiemId.move:78:5+1
    $1_DiemId_DiemIdDomains_$memory#106 := $1_DiemId_DiemIdDomains_$memory;
...
L5:
    ...
    assume {:print "$at(15,3185,3229)"} true;
    assume {:print "$track_abort(32,5):", $t7} $t7 == $t7;
...
L1:
    ...
    assume {:print "$at(15,3239,3381)"} true;
    assume {:print "$track_abort(32,5):", $t12} $t12 == $t12;
...
L2:
    ...
    // assert Not(Not(exists[@105]<Roles::RoleId>($t4))) at /home/ying/diem/language/diem-framework/modules/Roles.move:541:9+59
    assume {:print "$at(26,24232,24291)"} true;
    assert {:msg "assert_failed(26,24232,24291): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#105, $t4);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@105]<Roles::RoleId>($t4)), 5)) at /home/ying/diem/language/diem-framework/modules/Roles.move:542:9+89
    assume {:print "$at(26,24300,24389)"} true;
    assert {:msg "assert_failed(26,24300,24389): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#105, $t4)), 5);

    // assert Not(DiemId::$has_diem_id_domains[@106]($t3)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:98:9+72
    assume {:print "$at(15,3831,3903)"} true;
    assert {:msg "assert_failed(15,3831,3903): function does not abort under this condition"}
      !$1_DiemId_$has_diem_id_domains($1_DiemId_DiemIdDomains_$memory#106, $t3);
...
L3:
    ...
    // assert Or(Or(Not(exists[@105]<Roles::RoleId>($t4)), Neq<u64>(select Roles::RoleId.role_id(global[@105]<Roles::RoleId>($t4)), 5)), DiemId::$has_diem_id_domains[@106]($t3)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:90:5+259
    assume {:print "$at(15,3488,3747)"} true;
    assert {:msg "assert_failed(15,3488,3747): abort not covered by any of the `aborts_if` clauses"}
      ((!$ResourceExists($1_Roles_RoleId_$memory#105, $t4) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#105, $t4)), 5)) || $1_DiemId_$has_diem_id_domains($1_DiemId_DiemIdDomains_$memory#106, $t3));

    // assert Or(Or(And(Not(exists[@105]<Roles::RoleId>($t4)), Eq(5, $t7)), And(Neq<u64>(select Roles::RoleId.role_id(global[@105]<Roles::RoleId>($t4)), 5), Eq(3, $t7))), And(DiemId::$has_diem_id_domains[@106]($t3), Eq(6, $t7))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:90:5+259
    assert {:msg "assert_failed(15,3488,3747): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((!$ResourceExists($1_Roles_RoleId_$memory#105, $t4) && $IsEqual'u8'(5, $t7)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#105, $t4)), 5) && $IsEqual'u8'(3, $t7))) || ($1_DiemId_$has_diem_id_domains($1_DiemId_DiemIdDomains_$memory#106, $t3) && $IsEqual'u8'(6, $t7)));
...
procedure {:timeLimit 40} $1_DiemId_remove_diem_id_domain$verify(_$t0: int, _$t1: int, _$t2: Vec (int)) returns ()
{
    // declare local variables
    var $t3: $Mutation ($1_DiemId_DiemIdDomains);
    var $t4: $1_DiemId_DiemIdDomain;
    ...
    // @125 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemId.move:209:5+1
    assume {:print "$at(15,8334,8335)"} true;
    $1_Roles_RoleId_$memory#125 := $1_Roles_RoleId_$memory;

    // @124 := save_mem(DiemId::DiemIdDomainManager) at /home/ying/diem/language/diem-framework/modules/DiemId.move:209:5+1
    $1_DiemId_DiemIdDomainManager_$memory#124 := $1_DiemId_DiemIdDomainManager_$memory;

    // @123 := save_mem(DiemId::DiemIdDomains) at /home/ying/diem/language/diem-framework/modules/DiemId.move:209:5+1
    ...
    assume {:print "$track_local(32,6,0):", $t0} $t0 == $t0;
    ...
    assume {:print "$track_local(32,6,2):", $t2} $t2 == $t2;
...
L9:
    ...
    assume {:print "$at(15,8511,8556)"} true;
    assume {:print "$track_abort(32,6):", $t17} $t17 == $t17;
...
L8:
    ...
    // trace_local[tmp#$8]($t20) at /home/ying/diem/language/diem-framework/modules/DiemId.move:215:9+82
    assume {:print "$track_local(32,6,8):", $t20} $t20 == $t20;

    // trace_local[tmp#$7]($t18) at /home/ying/diem/language/diem-framework/modules/DiemId.move:215:9+82
    assume {:print "$track_local(32,6,7):", $t18} $t18 == $t18;
...
L1:
    ...
    assume {:print "$track_abort(32,6):", $t20} $t20 == $t20;
...
L0:
    ...
    // trace_local[tmp#$10]($t23) at /home/ying/diem/language/diem-framework/modules/DiemId.move:216:9+127
    assume {:print "$at(15,8658,8785)"} true;
    assume {:print "$track_local(32,6,10):", $t23} $t23 == $t23;

    // trace_local[tmp#$9]($t21) at /home/ying/diem/language/diem-framework/modules/DiemId.move:216:9+127
    assume {:print "$track_local(32,6,9):", $t21} $t21 == $t21;
...
L3:
    ...
    assume {:print "$at(15,8658,8785)"} true;
    assume {:print "$track_abort(32,6):", $t23} $t23 == $t23;
...
L2:
    ...
    $temp_0'$1_DiemId_DiemIdDomains' := $Dereference($t24);
    assume {:print "$track_local(32,6,3):", $temp_0'$1_DiemId_DiemIdDomains'} $temp_0'$1_DiemId_DiemIdDomains' == $temp_0'$1_DiemId_DiemIdDomains';
    ...
    assume {:print "$track_local(32,6,4):", $t25} $t25 == $t25;
...
L5:
    ...
    assume {:print "$at(15,9123,9172)"} true;
    assume {:print "$track_abort(32,6):", $t30} $t30 == $t30;
...
L6:
    ...
    // assert Not(Not(exists[@123]<DiemId::DiemIdDomains>($t1))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:252:9+69
    ...
    // assert Not(Not(DiemId::$tc_domain_manager_exists[@124]())) at /home/ying/diem/language/diem-framework/modules/DiemId.move:253:9+65
    ...
    // assert Not(Not(exists[@125]<Roles::RoleId>($t12))) at /home/ying/diem/language/diem-framework/modules/Roles.move:534:9+59
    assume {:print "$at(26,23933,23992)"} true;
    assert {:msg "assert_failed(26,23933,23992): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#125, $t12);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t12)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:535:9+97
    assume {:print "$at(26,24001,24098)"} true;
    assert {:msg "assert_failed(26,24001,24098): function does not abort under this condition"}
...
L7:
    ...
    // assert Or(Or(Or(Or(Or(Or(Not(exists[@123]<DiemId::DiemIdDomains>($t1)), Not(DiemId::$tc_domain_manager_exists[@124]())), Not(ContainsVec<DiemId::DiemIdDomain>($t11, pack DiemId::DiemIdDomain($t2)))), Not(exists[@125]<Roles::RoleId>($t12))), Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t12)), 1)), Neq<address>(Signer::spec_address_of[]($t0), b1e55ed)), Gt(Vector::$length[]<u8>($t2), 63)) at /home/ying/diem/language/diem-framework/modules/DiemId.move:240:5+162
    assume {:print "$at(15,9485,9647)"} true;
    ...
    // assert Or(Or(Or(Or(Or(Or(And(Not(exists[@123]<DiemId::DiemIdDomains>($t1)), Eq(5, $t17)), And(Not(DiemId::$tc_domain_manager_exists[@124]()), Eq(5, $t17))), And(Not(ContainsVec<DiemId::DiemIdDomain>($t11, pack DiemId::DiemIdDomain($t2))), Eq(7, $t17))), And(Not(exists[@125]<Roles::RoleId>($t12)), Eq(5, $t17))), And(Neq<u64>(select Roles::RoleId.role_id(global[@125]<Roles::RoleId>($t12)), 1), Eq(3, $t17))), And(Neq<address>(Signer::spec_address_of[]($t0), b1e55ed), Eq(2, $t17))), And(Gt(Vector::$length[]<u8>($t2), 63), Eq(7, $t17))) at /home/ying/diem/language/diem-framework/modules/DiemId.move:240:5+162
    assert {:msg "assert_failed(15,9485,9647): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((!$ResourceExists($1_DiemId_DiemIdDomains_$memory#123, $t1) && $IsEqual'u8'(5, $t17)) || (!$1_DiemId_$tc_domain_manager_exists($1_DiemId_DiemIdDomainManager_$memory#124) && $IsEqual'u8'(5, $t17))) || (!$ContainsVec'$1_DiemId_DiemIdDomain'($t11, $1_DiemId_DiemIdDomain($t2)) && $IsEqual'u8'(7, $t17))) || (!$ResourceExists($1_Roles_RoleId_$memory#125, $t12) && $IsEqual'u8'(5, $t17))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#125, $t12)), 1) && $IsEqual'u8'(3, $t17))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 186537453) && $IsEqual'u8'(2, $t17))) || (($1_Vector_$length'u8'($t2) > 63) && $IsEqual'u8'(7, $t17)));
...
procedure {:timeLimit 40} $1_Genesis_initialize$verify(_$t0: int, _$t1: int, _$t2: Vec (int), _$t3: Vec (int), _$t4: Vec (Vec (int)), _$t5: bool, _$t6: Vec (int), _$t7: Vec (int), _$t8: int, _$t9: int) returns ()
{
    ...
    // trace_local[dr_account#2062]($t0) at /home/ying/diem/language/diem-framework/modules/Genesis.move:40:13+10
    assume {:print "$at(22,1422,1432)"} true;
    assume {:print "$track_local(35,1,10):", $t0} $t0 == $t0;

    // trace_local[tc_account#2063]($t1) at /home/ying/diem/language/diem-framework/modules/Genesis.move:41:13+10
