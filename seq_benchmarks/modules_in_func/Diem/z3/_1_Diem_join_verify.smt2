...
(declare-fun $t5 () Bool)
(declare-fun $t3@1 () T@$Mutation_312361)
(declare-fun $t3@0 () T@$Mutation_312361)
...
(declare-fun $t3 () T@$Mutation_312361)
(push 1)
(set-info :boogie-vc-id $1_Diem_join$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 888626) (let ((anon4_Else_correct  (=> (not $t5) (=> (and (= $t3@1 ($Mutation_312361 (|l#$Mutation_312361| $t3@0) (|p#$Mutation_312361| $t3@0) |$temp_0'$1_Diem_Diem'#0''@0|)) (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_312361| $t3@1))) (=> (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_312361| $t3@1)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_312361| $t3@1)) (+ (|$value#$1_Diem_Diem'#0'| $t4@0) (|$value#$1_Diem_Diem'#0'| _$t1)))) (and (= $t0@0 (|v#$Mutation_312361| $t3@1)) (= $t0@0 $t0@0))) (and (=> (= (ControlFlow 0 651882) (- 0 888919)) (not (> (+ (|$value#$1_Diem_Diem'#0'| _$t0) (|$value#$1_Diem_Diem'#0'| _$t1)) $MAX_U64))) (=> (not (> (+ (|$value#$1_Diem_Diem'#0'| _$t0) (|$value#$1_Diem_Diem'#0'| _$t1)) $MAX_U64)) (and (=> (= (ControlFlow 0 651882) (- 0 888936)) (= (|$value#$1_Diem_Diem'#0'| $t0@0) (+ (|$value#$1_Diem_Diem'#0'| _$t0) (|$value#$1_Diem_Diem'#0'| _$t1)))) (=> (= (|$value#$1_Diem_Diem'#0'| $t0@0) (+ (|$value#$1_Diem_Diem'#0'| _$t0) (|$value#$1_Diem_Diem'#0'| _$t1))) (and (=> (= (ControlFlow 0 651882) (- 0 888952)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 651882) (- 0 888973)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr))))
 ...
 :qid |Diembpl.26879:15|
 :skolemid |957|
)) (and (=> (= (ControlFlow 0 651882) (- 0 889002)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)))
 ...
 :qid |Diembpl.26884:15|
 :skolemid |958|
)) (and (=> (= (ControlFlow 0 651882) (- 0 889027)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 651882) (- 0 889048)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3))))
 ...
 :qid |Diembpl.26894:15|
 :skolemid |959|
)) (and (=> (= (ControlFlow 0 651882) (- 0 889077)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)))
 ...
 :qid |Diembpl.26899:15|
 :skolemid |960|
)) (and (=> (= (ControlFlow 0 651882) (- 0 889102)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 651882) (- 0 889123)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 651882) (- 0 889144)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7))))
 ...
 :qid |Diembpl.26914:15|
 :skolemid |961|
)) (=> (= (ControlFlow 0 651882) (- 0 889180)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9)))
 :qid |Diembpl.26919:15|
 :skolemid |962|
))))))))))))))))))))))))))))))
(let ((anon4_Then_correct  (=> $t5 (=> (and (and (> (+ (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_312361| $t3@0)) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615) (= 8 $t6)) (= $t6 $t6)) (and (=> (= (ControlFlow 0 651960) (- 0 888814)) (> (+ (|$value#$1_Diem_Diem'#0'| _$t0) (|$value#$1_Diem_Diem'#0'| _$t1)) $MAX_U64)) (=> (> (+ (|$value#$1_Diem_Diem'#0'| _$t0) (|$value#$1_Diem_Diem'#0'| _$t1)) $MAX_U64) (=> (= (ControlFlow 0 651960) (- 0 888826)) (and (> (+ (|$value#$1_Diem_Diem'#0'| _$t0) (|$value#$1_Diem_Diem'#0'| _$t1)) $MAX_U64) (= 8 $t6)))))))))
(let ((anon0$1_correct  (=> (|$IsValid'$1_Diem_Diem'#0''| _$t0) (=> (and (|$IsValid'$1_Diem_Diem'#0''| _$t1) (= _$t0 _$t0)) (=> (and (and (= _$t1 _$t1) (= $t3@0 ($Mutation_312361 ($Local 0) (as seq.empty (Seq Int)) _$t0))) (and (= $t4@0 (|v#$Mutation_312361| $t3@0)) (= $t5 (> (+ (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_312361| $t3@0)) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615)))) (and (=> (= (ControlFlow 0 651528) 651960) anon4_Then_correct) (=> (= (ControlFlow 0 651528) 651882) anon4_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 651444) 651528)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (seq.len (|p#$Mutation_312361| $t3)) 0) (= (ControlFlow 0 651454) 651444)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 888626) 651454) anon0_correct)))
