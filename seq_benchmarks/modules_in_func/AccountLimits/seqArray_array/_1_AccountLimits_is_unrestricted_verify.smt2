...
(assert (not
 (=> (= (ControlFlow 0 0) 284569) (let ((L11_correct  (=> (= $t3@0 $t3@0) (and (=> (= (ControlFlow 0 226126) (- 0 284913)) (not false)) (=> (not false) (=> (= (ControlFlow 0 226126) (- 0 284920)) (= $t3@0  (and (and (and (= (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8) $MAX_U64) (= (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8) $MAX_U64)) (= (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8) $MAX_U64)) (= (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8) 86400000000)))))))))
(let ((anon12_Else_correct@@0  (=> (and (and (not $t2@0) (= false false)) (and (= $t3@0 false) (= (ControlFlow 0 226098) 226126))) L11_correct)))
(let ((anon12_Then_correct@@0  (=> $t2@0 (=> (and (= $t15@0@@2 (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8)) (|$IsValid'u64'| 86400000000)) (=> (and (and (= $t17@0@@2 (= $t15@0@@2 86400000000)) (= $t17@0@@2 $t17@0@@2)) (and (= $t3@0 $t17@0@@2) (= (ControlFlow 0 226156) 226126))) L11_correct)))))
(let ((anon11_Else_correct@@0  (=> (not $t1@0@@6) (=> (and (= false false) (= $t2@0 false)) (and (=> (= (ControlFlow 0 226076) 226156) anon12_Then_correct@@0) (=> (= (ControlFlow 0 226076) 226098) anon12_Else_correct@@0))))))
(let ((anon11_Then_correct@@0  (=> (and $t1@0@@6 (= $t11@0@@6 (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8))) (=> (and (and (|$IsValid'u64'| 18446744073709551615) (= $t13@0@@2 (= $t11@0@@6 18446744073709551615))) (and (= $t13@0@@2 $t13@0@@2) (= $t2@0 $t13@0@@2))) (and (=> (= (ControlFlow 0 226186) 226156) anon12_Then_correct@@0) (=> (= (ControlFlow 0 226186) 226098) anon12_Else_correct@@0))))))
(let ((anon10_Else_correct@@0  (=> (not $t6@0@@3) (=> (and (= false false) (= $t1@0@@6 false)) (and (=> (= (ControlFlow 0 226054) 226186) anon11_Then_correct@@0) (=> (= (ControlFlow 0 226054) 226076) anon11_Else_correct@@0))))))
(let ((anon10_Then_correct@@0  (=> (and $t6@0@@3 (= $t7@0@@0 (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8))) (=> (and (and (|$IsValid'u64'| 18446744073709551615) (= $t9@0@@2 (= $t7@0@@0 18446744073709551615))) (and (= $t9@0@@2 $t9@0@@2) (= $t1@0@@6 $t9@0@@2))) (and (=> (= (ControlFlow 0 226216) 226186) anon11_Then_correct@@0) (=> (= (ControlFlow 0 226216) 226076) anon11_Else_correct@@0))))))
(let ((anon0$1_correct@@8  (=> (and (|$IsValid'$1_AccountLimits_LimitsDefinition'#0''| _$t0@@8) (and (and (and (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8) 0) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8) 0)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8) 0)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8) 0))) (=> (and (and (= _$t0@@8 _$t0@@8) (= $t4@0 (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| _$t0@@8))) (and (|$IsValid'u64'| 18446744073709551615) (= $t6@0@@3 (= $t4@0 18446744073709551615)))) (and (=> (= (ControlFlow 0 226034) 226216) anon10_Then_correct@@0) (=> (= (ControlFlow 0 226034) 226054) anon10_Else_correct@@0))))))
(let ((inline$$InitEventStore$0$anon0_correct@@8  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@10 T@$1_Event_EventHandle) ) (! (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_82546_| (|streams#$EventStore| $es) handle@@10)))
 (and (= (|l#Multiset_82546| stream@@9) 0) (forall ((v@@45 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_82546| stream@@9) v@@45) 0)
 :qid |AccountLimitsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountLimitsbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 225950) 226034)) anon0$1_correct@@8)))
(let ((anon0_correct@@8  (=> (= (ControlFlow 0 284569) 225950) inline$$InitEventStore$0$anon0_correct@@8)))
anon0_correct@@8)))))))))))
))
(check-sat)
(pop 1)
