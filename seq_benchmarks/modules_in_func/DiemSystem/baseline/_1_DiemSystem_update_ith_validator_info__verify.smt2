...
(declare-fun $t0@1 () T@$Mutation_98322)
(declare-fun _$t1 () Int)
(declare-fun $t6 () T@$1_ValidatorConfig_Config)
(declare-fun $t7@0 () T@Vec_87979)
...
(declare-fun $t22@1 () T@$Mutation_107343)
(declare-fun $t22@0 () T@$Mutation_107343)
(declare-fun $t20 () T@$1_ValidatorConfig_Config)
(declare-fun $t14@0 () T@$Mutation_99309)
(declare-fun |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2| () T@$Mutation_99309)
(declare-fun $t0@0 () T@$Mutation_98322)
(declare-fun |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1| () T@$Mutation_98322)
(declare-fun |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@4| () T@Vec_87979)
(declare-fun |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@3| () T@Vec_87979)
...
(declare-fun |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@2| () T@Vec_87979)
(declare-fun $t16 () Bool)
(declare-fun |$temp_0'$1_DiemSystem_ValidatorInfo'@0| () T@$1_DiemSystem_ValidatorInfo)
(declare-fun $t15@0 () Int)
(declare-fun |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@0| () T@$Mutation_99309)
(declare-fun |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@0| () T@$Mutation_98322)
(declare-fun |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$v@1| () T@Vec_87979)
(declare-fun |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@1| () T@$Mutation_99309)
(declare-fun _$t0 () T@$Mutation_98322)
(declare-fun $abort_code@0 () Int)
(declare-fun inline$$Ge$0$dst@1 () Bool)
(declare-fun |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@1| () T@Vec_87979)
...
(declare-fun $t2 () T@$Mutation_107343)
(declare-fun $t5 () T@$Mutation_99309)
(declare-fun $t14 () T@$Mutation_99309)
(declare-fun $t22 () T@$Mutation_107343)
(push 1)
(set-info :boogie-vc-id $1_DiemSystem_update_ith_validator_info_$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 317473) (let ((L10_correct  (=> (= (ControlFlow 0 237761) (- 0 318674)) false)))
(let ((anon25_Then_correct  (=> (and (and $t21 (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) $t19@0)) (= 5 $t10)) (and (= (|l#Vec_87775| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) $t19@0)))) 0) (= 7 $t10)))) (and (= $t10 $t10) (= (ControlFlow 0 237751) 237761))) L10_correct)))
(let ((anon23_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 237803) 237761)) L10_correct))))
(let ((L9_correct  (and (=> (= (ControlFlow 0 237675) (- 0 318520)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 237675) (- 0 318527)) (= $t13@0  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|v#$Mutation_98322| $t0@1)) _$t1))) (not (= (|l#Vec_87775| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|v#$Mutation_98322| $t0@1)) _$t1)))))) 0))) (not (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| $t6) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1)))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| $t6) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1))))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| $t6) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1))))))))) (=> (= $t13@0  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|v#$Mutation_98322| $t0@1)) _$t1))) (not (= (|l#Vec_87775| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|v#$Mutation_98322| $t0@1)) _$t1)))))) 0))) (not (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| $t6) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1)))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| $t6) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1))))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| $t6) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1)))))))) (and (=> (= (ControlFlow 0 237675) (- 0 318559)) (=> $t13@0 (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|v#$Mutation_98322| $t0@1) (Vec_87979 (|Store__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1 ($1_DiemSystem_ValidatorInfo (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1)) (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1)) $t6 (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1)))) (|l#Vec_87979| $t7@0))))) (=> (=> $t13@0 (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|v#$Mutation_98322| $t0@1) (Vec_87979 (|Store__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1 ($1_DiemSystem_ValidatorInfo (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1)) (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1)) $t6 (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1)))) (|l#Vec_87979| $t7@0)))) (and (=> (= (ControlFlow 0 237675) (- 0 318582)) (=> (not $t13@0) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|v#$Mutation_98322| $t0@1) $t7@0))) (=> (=> (not $t13@0) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|v#$Mutation_98322| $t0@1) $t7@0)) (and (=> (= (ControlFlow 0 237675) (- 0 318596)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|v#$Mutation_98322| $t0@1) (Vec_87979 (|Store__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|v#$Mutation_98322| $t0@1)) _$t1)) (|l#Vec_87979| $t7@0)))) (=> (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|v#$Mutation_98322| $t0@1) (Vec_87979 (|Store__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| $t7@0) _$t1 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|v#$Mutation_98322| $t0@1)) _$t1)) (|l#Vec_87979| $t7@0))) (and (=> (= (ControlFlow 0 237675) (- 0 318614)) (let (($range_0 ($Range 0 (|l#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@0))))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i1 $i_1))
(= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@1))))) i1)) 1)))
 :qid |DiemSystembpl.11422:146|
 :skolemid |354|
)))) (=> (let (($range_0@@0 ($Range 0 (|l#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@2 173345816))
...
(= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@3 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@3))))) i1@@0)) 1)))
 :qid |DiemSystembpl.11422:146|
 :skolemid |354|
))) (=> (= (ControlFlow 0 237675) (- 0 318658)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@4 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@4)))) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@5 173345816))
...
(let ((anon26_Else_correct  (=> (and (not $t24@0) (= $t22@1 ($Mutation_107343 (|l#$Mutation_107343| $t22@0) (|p#$Mutation_107343| $t22@0) $t20))) (=> (and (and (and (= $t14@0 ($Mutation_99309 (|l#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|) (|p#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|) ($1_DiemSystem_ValidatorInfo (|$addr#$1_DiemSystem_ValidatorInfo| (|v#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|v#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (|v#$Mutation_107343| $t22@1) (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (|v#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|))))) (= $t0@0 ($Mutation_98322 (|l#$Mutation_98322| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1|) (|p#$Mutation_98322| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1|) (Vec_87979 (|Store__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|v#$Mutation_98322| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1|)) (|Select__T@[Int]Int_| (|v#Vec_28829| (|p#$Mutation_99309| $t14@0)) (|l#Vec_28829| (|p#$Mutation_98322| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1|))) (|v#$Mutation_99309| $t14@0)) (|l#Vec_87979| (|v#$Mutation_98322| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1|)))))) (and (= true true) (= |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@4| (|v#$Mutation_98322| $t0@0)))) (and (and (= |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@4| |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@4|) (= $t0@1 $t0@0)) (and (= $t13@0 true) (= (ControlFlow 0 237506) 237675)))) L9_correct))))
(let ((anon26_Then_correct  (=> $t24@0 (=> (and (= false false) (= |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@3| (|v#$Mutation_98322| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1|))) (=> (and (and (= |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@3| |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@3|) (= $t0@1 |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1|)) (and (= $t13@0 false) (= (ControlFlow 0 237703) 237675))) L9_correct)))))
(let ((anon25_Else_correct  (=> (and (not $t21) (|$IsValid'$1_ValidatorConfig_Config'| $t20)) (=> (and (and (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| $t20) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_87775| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) $t19@0)))) 0))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| $t20) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_87775| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) $t19@0)))) 0)))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| $t20) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_87775| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) $t19@0)))) 0)))) (and (= $t20 $t20) (= $t22@0 ($Mutation_107343 (|l#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|) (let ((l (|l#Vec_28829| (|p#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|))))
(Vec_28829 (|Store__T@[Int]Int_| (|v#Vec_28829| (|p#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) l 2) (+ l 1))) (|$config#$1_DiemSystem_ValidatorInfo| (|v#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|)))))) (and (and (= |$temp_0'$1_ValidatorConfig_Config'@0| (|v#$Mutation_107343| $t22@0)) (= |$temp_0'$1_ValidatorConfig_Config'@0| |$temp_0'$1_ValidatorConfig_Config'@0|)) (and (= $t23@0 (|v#$Mutation_107343| $t22@0)) (= $t24@0  (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| $t23@0) (|$consensus_pubkey#$1_ValidatorConfig_Config| $t20)) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| $t23@0) (|$validator_network_addresses#$1_ValidatorConfig_Config| $t20))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| $t23@0) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| $t20))))))) (and (=> (= (ControlFlow 0 237426) 237703) anon26_Then_correct) (=> (= (ControlFlow 0 237426) 237506) anon26_Else_correct))))))
(let ((anon24_Else_correct  (=> (not inline$$Not$0$dst@1) (=> (and (= $t19@0 (|$addr#$1_DiemSystem_ValidatorInfo| (|v#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|))) (= $t21  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) $t19@0)) (= (|l#Vec_87775| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) $t19@0)))) 0)))) (and (=> (= (ControlFlow 0 237364) 237751) anon25_Then_correct) (=> (= (ControlFlow 0 237364) 237426) anon25_Else_correct))))))
(let ((anon24_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (= false false) (= |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@2| (|v#$Mutation_98322| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1|))) (=> (and (and (= |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@2| |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@2|) (= $t0@1 |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1|)) (and (= $t13@0 false) (= (ControlFlow 0 237789) 237675))) L9_correct)))))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not $t16)) (and (=> (= (ControlFlow 0 237320) 237789) anon24_Then_correct) (=> (= (ControlFlow 0 237320) 237364) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_DiemSystem_ValidatorInfo'@0| (|v#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|))) (=> (and (and (= |$temp_0'$1_DiemSystem_ValidatorInfo'@0| |$temp_0'$1_DiemSystem_ValidatorInfo'@0|) (= $t15@0 (|$addr#$1_DiemSystem_ValidatorInfo| (|v#$Mutation_99309| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2|)))) (and (= $t16  (and (|Select__T@[Int]Bool_| (|domain#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) $t15@0) (not (= (|l#Vec_87775| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) $t15@0)))) 0)))) (= (ControlFlow 0 237326) 237320))) inline$$Not$0$anon0_correct))))
(let ((|inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|  (=> (and (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (= |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@0|) (= |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@0|))) (and (=> (= (ControlFlow 0 237242) 237803) anon23_Then_correct) (=> (= (ControlFlow 0 237242) 237326) anon23_Else_correct)))))
(let ((|inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_78413 |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$v@1| _$t1)) (= (ControlFlow 0 237240) 237242)) |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|  (=> (and (InRangeVec_78413 |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$v@1| _$t1) (= |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@1| ($Mutation_99309 (|l#$Mutation_98322| _$t0) (let ((l@@0 (|l#Vec_28829| (|p#$Mutation_98322| _$t0))))
(Vec_28829 (|Store__T@[Int]Int_| (|v#Vec_28829| (|p#$Mutation_98322| _$t0)) l@@0 _$t1) (+ l@@0 1))) (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$v@1|) _$t1)))) (=> (and (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0)) (and (= |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$dst@1|) (= |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$m'@1| _$t0))) (and (=> (= (ControlFlow 0 237190) 237803) anon23_Then_correct) (=> (= (ControlFlow 0 237190) 237326) anon23_Else_correct))))))
(let ((|inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|  (=> (= |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$v@1| (|v#$Mutation_98322| _$t0)) (and (=> (= (ControlFlow 0 237160) 237240) |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 237160) 237190) |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|)))))
(let ((anon22_Else_correct  (=> (and (not inline$$Ge$0$dst@1) (= (ControlFlow 0 237250) 237160)) |inline$$1_Vector_borrow_mut'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|)))
(let ((anon22_Then_correct  (=> inline$$Ge$0$dst@1 (=> (and (= false false) (= |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@1| (|v#$Mutation_98322| _$t0))) (=> (and (and (= |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@1| |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@1|) (= $t0@1 _$t0)) (and (= $t13@0 false) (= (ControlFlow 0 237831) 237675))) L9_correct)))))
(let ((inline$$Ge$0$anon0_correct  (=> (= inline$$Ge$0$dst@1 (>= _$t1 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (and (=> (= (ControlFlow 0 237046) 237831) anon22_Then_correct) (=> (= (ControlFlow 0 237046) 237250) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (not false) (=> (and (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (= (ControlFlow 0 237052) 237046)) inline$$Ge$0$anon0_correct))))
(let ((anon21_Then_correct true))
(let ((|inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| (|l#Vec_87979| $t8@0)) (and (=> (= (ControlFlow 0 236984) 237845) anon21_Then_correct) (=> (= (ControlFlow 0 236984) 237052) anon21_Else_correct)))))
(let ((anon0$1_correct  (=> (and (and (and (= (|l#$Mutation_98322| _$t0) ($Param 0)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@6) (and (|Select__T@[Int]Bool_| (|domain#$Memory_125988| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_125988| $1_Roles_RoleId_$memory) addr@@6)) 3))))
 :qid |DiemSystembpl.11101:20|
 :skolemid |349|
))) (and (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_125988| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_125988| $1_Roles_RoleId_$memory) addr@@7)) 3))))
 :qid |DiemSystembpl.11105:20|
 :skolemid |350|
)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@8) (not (= (|l#Vec_87775| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@8)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_125988| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_125988| $1_Roles_RoleId_$memory) addr@@8)) 3))))
 :qid |DiemSystembpl.11109:20|
 :skolemid |351|
)))) (and (and (|$IsValid'vec'$1_DiemSystem_ValidatorInfo''| (|v#$Mutation_98322| _$t0)) (|$IsValid'u64'| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc) (and (<= (|l#Vec_87775| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc))) 1) (<= (|l#Vec_28829| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc))) 1))))
 :qid |DiemSystembpl.11119:20|
 :skolemid |352|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0))
)) (= $t6 (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_87775| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139153| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|v#$Mutation_98322| _$t0)) _$t1)))))) 0))))) (=> (and (and (and (and (<= 0 _$t1) (< _$t1 (|l#Vec_87979| (|v#$Mutation_98322| _$t0)))) (let (($range_0@@1 ($Range 0 (|l#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@9 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@9))))))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i1@@1 $i_1@@1))
(= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_87979| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@10 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_125534| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@10))))) i1@@1)) 1)))
 :qid |DiemSystembpl.11132:151|
 :skolemid |353|
)))) (and (= $t7@0 (|v#$Mutation_98322| _$t0)) (= |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@0| (|v#$Mutation_98322| _$t0)))) (and (and (= |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@0| |$temp_0'vec'$1_DiemSystem_ValidatorInfo''@0|) (= _$t1 _$t1)) (and (= $t8@0 (|v#$Mutation_98322| _$t0)) (= (ControlFlow 0 236990) 236984)))) |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_87682_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemSystembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 236686) 236990)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_28829| (|p#$Mutation_107343| $t2)) 0) (=> (and (and (= (|l#Vec_28829| (|p#$Mutation_99309| $t5)) 0) (= (|l#Vec_28829| (|p#$Mutation_99309| $t14)) 0)) (and (= (|l#Vec_28829| (|p#$Mutation_107343| $t22)) 0) (= (ControlFlow 0 236696) 236686))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 317473) 236696) anon0_correct)))
