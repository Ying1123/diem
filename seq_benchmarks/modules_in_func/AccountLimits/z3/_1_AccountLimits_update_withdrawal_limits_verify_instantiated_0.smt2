...
(assert (not
 ...
 :qid |AccountLimitsbpl.17078:15|
 :skolemid |594|
)) (and (=> (= (ControlFlow 0 251715) (- 0 302569)) (forall ((window_addr@@1 Int) ) (!  (=> (|$IsValid'address'| window_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0|) window_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0|) window_addr@@1)))))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 250159) 250762)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (seq.len (|p#$Mutation_122739| $t9)) 0) (= (ControlFlow 0 250169) 250159)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 301134) 250169) anon0_correct)))
