...
))) (=> (and (and (|$IsValid'address'| 173345816) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (= $t1@0 $t1@0) (= (ControlFlow 0 147055) (- 0 202326)))) (not false)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_64028_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTimestampbpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 146979) 147055)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 202232) 146979) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
