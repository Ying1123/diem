...
(assert (not
 (=> (= (ControlFlow 0 0) 1894954) (let ((anon21_Else_correct@@1  (=> (not $abort_flag@0@@2) (and (=> (= (ControlFlow 0 1101437) (- 0 1896068)) (forall ((addr@@108 Int) ) (!  (=> (|$IsValid'address'| addr@@108) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@1) addr@@108) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@108) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@108)) 3))))
 :qid |DiemAccountbpl.10519:15|
 :skolemid |261|
))) (=> (forall ((addr@@109 Int) ) (!  (=> (|$IsValid'address'| addr@@109) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@1) addr@@109) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@109) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@109)) 3))))
 :qid |DiemAccountbpl.10519:15|
 :skolemid |261|
)) (and (=> (= (ControlFlow 0 1101437) (- 0 1896096)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0@@9)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0@@9))) (and (=> (= (ControlFlow 0 1101437) (- 0 1896107)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1101437) (- 0 1896117)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5@@8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5@@8))) (and (=> (= (ControlFlow 0 1101437) (- 0 1896129)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5@@8)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5@@8)) 0))) (and (=> (= (ControlFlow 0 1101437) (- 0 1896147)) (not (not (= (|$addr#$signer| _$t1@@8) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t1@@8) 173345816))) (and (=> (= (ControlFlow 0 1101437) (- 0 1896161)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9)))) (and (=> (= (ControlFlow 0 1101437) (- 0 1896174)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9))) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9))) 3))) (and (=> (= (ControlFlow 0 1101437) (- 0 1896193)) (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@1) (|$addr#$signer| _$t0@@9))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@1) (|$addr#$signer| _$t0@@9)) (=> (= (ControlFlow 0 1101437) (- 0 1896202)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr1) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory@1) addr1))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr1))))))
 :qid |DiemAccountbpl.10568:15|
 :skolemid |262|
))))))))))))))))))))))))
(let ((L3_correct@@1  (and (=> (= (ControlFlow 0 1101144) (- 0 1895860)) (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0@@9)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5@@8))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5@@8)) 0))) (not (= (|$addr#$signer| _$t1@@8) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9)))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9))) 3)))) (=> (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0@@9)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5@@8))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5@@8)) 0))) (not (= (|$addr#$signer| _$t1@@8) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9)))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9))) 3))) (=> (= (ControlFlow 0 1101144) (- 0 1895934)) (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0@@9)) (= 6 $t7@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t7@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t5@@8)) (= 5 $t7@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t5@@8)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t1@@8) 173345816)) (= 2 $t7@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9))) (= 5 $t7@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9))) 3)) (= 3 $t7@0))))))))
(let ((anon21_Then_correct@@1  (=> (and (and $abort_flag@0@@2 (= $abort_code@1@@2 $abort_code@1@@2)) (and (= $t7@0 $abort_code@1@@2) (= (ControlFlow 0 1101451) 1101144))) L3_correct@@1)))
(let ((anon20_Then$1_correct  (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory) (=> (and (= $abort_flag@0@@2 true) (= $abort_code@1@@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1101503) 1101451) anon21_Then_correct@@1) (=> (= (ControlFlow 0 1101503) 1101437) anon21_Else_correct@@1))))))
(let ((anon20_Then_correct@@1  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0@@9)) (= (ControlFlow 0 1101501) 1101503)) anon20_Then$1_correct)))
(let ((anon20_Else_correct@@1  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0@@9))) (=> (and (and (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_469220 (|Store__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0@@9) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| _$t0@@9) $t18@0@@0))) (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory@0)) (and (= $abort_flag@0@@2 false) (= $abort_code@1@@2 $abort_code@0@@2))) (and (=> (= (ControlFlow 0 1101255) 1101451) anon21_Then_correct@@1) (=> (= (ControlFlow 0 1101255) 1101437) anon21_Else_correct@@1))))))
(let ((anon19_Then_correct@@0  (=> inline$$Not$0$dst@1@@1 (=> (and (and (|$IsValid'$1_Option_Option'$1_ValidatorConfig_Config''| $t16@@0) (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t16@@0)) 1)) (|$IsEqual'vec'$1_ValidatorConfig_Config''| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t16@@0) (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_416371 (MapConstVec_377448 DefaultVecElem_377448) 0))))) (=> (and (and (and (|$IsValid'$1_Option_Option'address''| $t17) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| $t17)) 1)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| $t17) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0))))) (and (= $t18@0@@0 ($1_ValidatorConfig_ValidatorConfig $t16@@0 $t17 _$t2@@1)) (forall ((addr@@110 Int) ) (!  (=> (|$IsValid'address'| addr@@110) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@110) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@110) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@110)) 3))))
 :qid |DiemAccountbpl.10499:20|
 :skolemid |260|
)))) (and (=> (= (ControlFlow 0 1101233) 1101501) anon20_Then_correct@@1) (=> (= (ControlFlow 0 1101233) 1101255) anon20_Else_correct@@1)))))))
(let ((anon19_Else_correct@@0  (=> (and (and (not inline$$Not$0$dst@1@@1) (= $t15 $t15)) (and (= $t7@0 $t15) (= (ControlFlow 0 1100912) 1101144))) L3_correct@@1)))
(let ((anon18_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t15) (= $t15 6)) (and (= $t15 $t15) (= inline$$Not$0$dst@1@@1 inline$$Not$0$dst@1@@1))) (and (=> (= (ControlFlow 0 1100896) 1101233) anon19_Then_correct@@0) (=> (= (ControlFlow 0 1100896) 1100912) anon19_Else_correct@@0))))))
(let ((inline$$Not$0$anon0_correct@@1  (=> (and (= inline$$Not$0$dst@1@@1  (not $t12@0)) (= (ControlFlow 0 1100856) 1100896)) anon18_Else$1_correct)))
(let ((anon18_Else_correct@@0  (=> (not $t10@@2) (=> (and (and (|$IsValid'address'| $t11@@1) (= $t11@@1 (|$addr#$signer| _$t0@@9))) (and (= $t12@0 (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $t11@@1)) (= (ControlFlow 0 1100862) 1100856))) inline$$Not$0$anon0_correct@@1))))
(let ((anon18_Then_correct@@0  (=> $t10@@2 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9))) (= 5 $t7@@2)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9))) 3)) (= 3 $t7@@2))) (= $t7@@2 $t7@@2)) (and (= $t7@0 $t7@@2) (= (ControlFlow 0 1101559) 1101144))) L3_correct@@1))))
(let ((anon17_Else_correct@@0  (=> (and (not $t9@@8) (= $t10@@2  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0@@9))) 3))))) (and (=> (= (ControlFlow 0 1100800) 1101559) anon18_Then_correct@@0) (=> (= (ControlFlow 0 1100800) 1100862) anon18_Else_correct@@0)))))
(let ((anon17_Then_correct@@0  (=> $t9@@8 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t1@@8) 173345816)) (= 2 $t7@@2)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@5)) (= 5 $t7@@2))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@5)) 0)) (= 3 $t7@@2))) (and (not (= (|$addr#$signer| _$t1@@8) 173345816)) (= 2 $t7@@2))) (= $t7@@2 $t7@@2)) (and (= $t7@0 $t7@@2) (= (ControlFlow 0 1101651) 1101144))) L3_correct@@1))))
(let ((anon16_Else_correct@@0  (=> (not $t6@@7) (=> (and (= $t8@@5 (|$addr#$signer| _$t1@@8)) (= $t9@@8  (or (or (or (not (= (|$addr#$signer| _$t1@@8) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $t8@@5)) 0))) (not (= (|$addr#$signer| _$t1@@8) 173345816))))) (and (=> (= (ControlFlow 0 1100760) 1101651) anon17_Then_correct@@0) (=> (= (ControlFlow 0 1100760) 1100800) anon17_Else_correct@@0))))))
(let ((anon16_Then_correct@@0  (=> $t6@@7 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t7@@2)) (= $t7@@2 $t7@@2)) (and (= $t7@0 $t7@@2) (= (ControlFlow 0 1101677) 1101144))) L3_correct@@1))))
(let ((anon0$1_correct@@9  (=> (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((addr@@111 Int) ) (!  (=> (|$IsValid'address'| addr@@111) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@111) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@111) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@111)) 4))))
 :qid |DiemAccountbpl.10244:20|
 :skolemid |253|
))) (and (forall ((addr@@112 Int) ) (!  (=> (|$IsValid'address'| addr@@112) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@112) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@112) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@112)) 3))))
 :qid |DiemAccountbpl.10248:20|
 :skolemid |254|
)) (forall ((addr@@113 Int) ) (!  (=> (|$IsValid'address'| addr@@113) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@113) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@113) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@113)) 3))))
 :qid |DiemAccountbpl.10252:20|
 :skolemid |255|
)))) (and (and (forall ((addr@@114 Int) ) (!  (=> (|$IsValid'address'| addr@@114) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@114) (not (= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@114)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@114)) 3))))
 :qid |DiemAccountbpl.10256:20|
 :skolemid |256|
)) (|$IsValid'address'| (|$addr#$signer| _$t0@@9))) (and (|$IsValid'address'| (|$addr#$signer| _$t1@@8)) (|$IsValid'vec'u8''| _$t2@@1)))) (and (and (and (forall (($a_0@@13 Int) ) (! (let (($rsc@@13 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@13)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@13))
 :qid |DiemAccountbpl.10268:20|
 :skolemid |257|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@13))
)) (forall (($a_0@@14 Int) ) (! (let (($rsc@@14 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0@@14)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@14))
 :qid |DiemAccountbpl.10272:20|
 :skolemid |258|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) $a_0@@14))
))) (and (forall (($a_0@@15 Int) ) (! (let (($rsc@@15 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@15)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@15) (and (<= (|l#Vec_416371| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@15))) 1) (<= (|l#Vec_37831| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@15))) 1))))
 :qid |DiemAccountbpl.10276:20|
 :skolemid |259|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_469220| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@15))
)) (= $t5@@8 (|$addr#$signer| _$t1@@8)))) (and (and (= _$t0@@9 _$t0@@9) (= _$t1@@8 _$t1@@8)) (and (= _$t2@@1 _$t2@@1) (= $t6@@7  (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 1100688) 1101677) anon16_Then_correct@@0) (=> (= (ControlFlow 0 1100688) 1100760) anon16_Else_correct@@0)))))
(let ((inline$$InitEventStore$0$anon0_correct@@9  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@11 T@$1_Event_EventHandle) ) (! (let ((stream@@10 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@11)))
 (and (= (|l#Multiset_416285| stream@@10) 0) (forall ((v@@74 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@10) v@@74) 0)
 :qid |DiemAccountbpl.159:13|
 :skolemid |4|
))))
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1100416) 1100688)) anon0$1_correct@@9)))
(let ((anon0_correct@@9  (=> (= (ControlFlow 0 1894954) 1100416) inline$$InitEventStore$0$anon0_correct@@9)))
anon0_correct@@9))))))))))))))))))))
))
(check-sat)
(pop 1)
