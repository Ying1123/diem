...
(declare-fun $t9 () T@$Mutation_224513)
...
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@2)) i@@44)))) 0)))
 ...
 :skolemid |271|
)))) (=> (let (($range_0@@0 ($Range 0 (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@2))))))
...
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@2)) i@@45)))) 0)))
 ...
 :qid |Diembpl.7549:15|
 :skolemid |276|
)) (and (=> (= (ControlFlow 0 539656) (- 0 806436)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)))
 :qid |Diembpl.7554:15|
 :skolemid |277|
 ...
 :qid |Diembpl.7564:15|
 :skolemid |278|
)) (and (=> (= (ControlFlow 0 539656) (- 0 806511)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)))
 :qid |Diembpl.7569:15|
 :skolemid |279|
...
(let ((anon28_Else_correct  (=> (not inline$$Lt$0$dst@1) (and (=> (= (ControlFlow 0 539016) (- 0 805810)) (<= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1))) 256)) (=> (<= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1))) 256) (and (=> (= (ControlFlow 0 539016) (- 0 805824)) (let (($range_0@@1 ($Range 0 (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1))))))
...
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1)) i@@46)))) 0)))
 ...
 :skolemid |270|
)))) (=> (let (($range_0@@2 ($Range 0 (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1))))))
...
(let ((anon27_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 256) (= (ControlFlow 0 538899) 538893)) inline$$Lt$0$anon0_correct))))
(let ((anon27_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 539684) 538518))) L7_correct)))
...
(let ((anon25_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t13) (=> (and (and (= $t25@0 ($Mutation_270395 ($Global $t13) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t13))) (= $t25@1 $t25@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 538767) 539698) anon26_Then_correct) (=> (= (ControlFlow 0 538767) 538839) anon26_Else_correct))))))
...
(let ((anon22_Then_correct  (=> (and (and $t14@0 (= $t18@0 (|$preburn#$1_Diem_PreburnWithMetadata'#0'| _$t1))) (and (= $t19@0 (|$to_burn#$1_Diem_Preburn'#0'| $t18@0)) (= (ControlFlow 0 538629) 538623))) |inline$$1_Diem_value'#0'$0$anon0_correct|)))
(let ((anon22_Else_correct  (=> (and (and (not $t14@0) (= $t16 $t16)) (and (= $t17@0 $t16) (= (ControlFlow 0 538394) 538518))) L7_correct)))
(let ((anon0$1_correct  (=> (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr1@@1)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) addr1@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) addr1@@1)) 2))))
 :qid |Diembpl.7168:20|
 :skolemid |265|
 ...
 :qid |Diembpl.7176:20|
 :skolemid |267|
))) (=> (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'$1_Diem_PreburnWithMetadata'#0''| _$t1)) (=> (and (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0)))
...
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc) i@@48)))) 0)))
 ...
 :qid |Diembpl.7185:20|
 :skolemid |269|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0))
)) (= $t10 (|$addr#$signer| _$t0))) (and (= $t11 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t10))) (= $t12 (|$addr#$signer| _$t0)))) (and (and (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| $t10) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| $t13)))) (and (and (and (= $t13 (|$addr#$signer| _$t0)) (= $t13 $t13)) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t13)) (|$IsValid'u64'| 11))) (and (and (|$IsValid'u64'| $t16) (= $t16 1)) (and (= $t16 $t16) (= $t14@0 $t14@0))))) (and (=> (= (ControlFlow 0 538378) 538629) anon22_Then_correct) (=> (= (ControlFlow 0 538378) 538394) anon22_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 538042) 538378)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (seq.len (|p#$Mutation_224513| $t9)) 0) (= (seq.len (|p#$Mutation_270395| $t25)) 0)) (and (= (seq.len (|p#$Mutation_224513| $t26)) 0) (= (ControlFlow 0 538052) 538042))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 804924) 538052) anon0_correct)))
PreconditionGeneratedEntry_correct))))))))))))))))))))))))))))))
))
(check-sat)
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 804924)))
(get-value ((ControlFlow 0 538052)))
(get-value ((ControlFlow 0 538042)))
(get-value ((ControlFlow 0 538378)))
(get-value ((ControlFlow 0 538629)))
(get-value ((ControlFlow 0 538623)))
(get-value ((ControlFlow 0 538689)))
(get-value ((ControlFlow 0 538683)))
(get-value ((ControlFlow 0 538719)))
(get-value ((ControlFlow 0 538745)))
(get-value ((ControlFlow 0 538767)))
(get-value ((ControlFlow 0 538839)))
(get-value ((ControlFlow 0 538833)))
(get-value ((ControlFlow 0 538899)))
(get-value ((ControlFlow 0 538893)))
(get-value ((ControlFlow 0 538933)))
(get-value ((ControlFlow 0 539077)))
(get-value ((ControlFlow 0 539071)))
(get-value ((ControlFlow 0 539656)))
(assert (not (= (ControlFlow 0 539656) (- 806096))))
(check-sat)
(pop 1)
; Invalid
(reset)
