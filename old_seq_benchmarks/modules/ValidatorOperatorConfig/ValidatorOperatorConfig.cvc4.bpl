...
procedure {:timeLimit 40} $1_Roles_grant_role$verify(_$t0: int, _$t1: int) returns ()
{
    ...
    var $temp_0'u64': int;
    var $1_Roles_RoleId_$memory#92: $Memory $1_Roles_RoleId;
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // @92 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/Roles.move:182:9+30
    $1_Roles_RoleId_$memory#92 := $1_Roles_RoleId_$memory;
...
L0:
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorOperatorConfig::$has_validator_operator_config(addr): Roles::spec_has_validator_operator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/Roles.move:164:5+199
    ...
    // assert forall addr: TypeDomain<address>() where ValidatorOperatorConfig::$has_validator_operator_config(addr): Roles::spec_has_validator_operator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:77:9+137
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:77:9+137
    assume {:print "$at(36,3073,3210)"} true;
    assert {:msg "assert_failed(36,3073,3210): global memory invariant does not hold"}
...
L2:
    ...
    // assert Not(exists[@92]<Roles::RoleId>(Signer::$address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/Roles.move:179:9+62
    assume {:print "$at(26,7535,7597)"} true;
    assert {:msg "assert_failed(26,7535,7597): function does not abort under this condition"}
      !$ResourceExists($1_Roles_RoleId_$memory#92, $1_Signer_$address_of($t0));
...
L3:
    ...
    // assert exists[@92]<Roles::RoleId>(Signer::$address_of[]($t0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:168:5+419
    assume {:print "$at(26,7034,7453)"} true;
    assert {:msg "assert_failed(26,7034,7453): abort not covered by any of the `aborts_if` clauses"}
      $ResourceExists($1_Roles_RoleId_$memory#92, $1_Signer_$address_of($t0));

    // assert And(exists[@92]<Roles::RoleId>(Signer::$address_of[]($t0)), Eq(6, $t10)) at /home/ying/diem/language/diem-framework/modules/Roles.move:168:5+419
    assert {:msg "assert_failed(26,7034,7453): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ($ResourceExists($1_Roles_RoleId_$memory#92, $1_Signer_$address_of($t0)) && $IsEqual'u8'(6, $t10));
...
// spec fun at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:55:5+320
...
// fun ValidatorOperatorConfig::publish [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+589
procedure {:timeLimit 40} $1_ValidatorOperatorConfig_publish$verify(_$t0: int, _$t1: int, _$t2: Vec (int)) returns ()
{
    // declare local variables
    var $t3: bool;
    var $t4: int;
    ...
    var $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#124: $Memory $1_ValidatorOperatorConfig_ValidatorOperatorConfig;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#125: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#228: $Memory $1_ValidatorOperatorConfig_ValidatorOperatorConfig;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+589
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(36,466,1055)"} true;
    ...
    // assume forall addr: TypeDomain<address>() where ValidatorOperatorConfig::$has_validator_operator_config(addr): Roles::spec_has_validator_operator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+589
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:77:9+137
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_operator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+589
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+589
    assume $IsValid'address'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+589
    assume $IsValid'vec'u8''($t2);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+589
    ...
    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+589
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<ValidatorOperatorConfig::ValidatorOperatorConfig>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+589
    ...
    // @125 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+1
    ...
    // @123 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+1
    $1_Roles_RoleId_$memory#123 := $1_Roles_RoleId_$memory;

    // @124 := save_mem(ValidatorOperatorConfig::ValidatorOperatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+1
    $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#124 := $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory;
...
L0:
    ...
    // @228 := save_mem(ValidatorOperatorConfig::ValidatorOperatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:19:5+589
    // state save for global update invariants
    assume {:print "$at(36,466,1055)"} true;
    $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#228 := $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory;
    ...
    // assert forall addr: TypeDomain<address>() where exists[@228]<ValidatorOperatorConfig::ValidatorOperatorConfig>(addr): exists<ValidatorOperatorConfig::ValidatorOperatorConfig>(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:83:9+138
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:83:9+138
    assume {:print "$at(36,3266,3404)"} true;
    assert {:msg "assert_failed(36,3266,3404): global memory invariant does not hold"}
      (forall addr: int :: $IsValid'address'(addr) ==> ($ResourceExists($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#228, addr))  ==> ($ResourceExists($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, addr)));
...
L2:
    ...
    // assert Not(Not(exists[@123]<Roles::RoleId>($t5))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#123, $t5);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>($t5)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $t5)), 0);

    // assert Not(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$DIEM_ROOT_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/CoreAddresses.move:70:9+108
    assume {:print "$at(8,2901,3009)"} true;
    assert {:msg "assert_failed(8,2901,3009): function does not abort under this condition"}
      !!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$DIEM_ROOT_ADDRESS());

    // assert Not(Not(exists[@123]<Roles::RoleId>(Signer::$address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/Roles.move:586:9+78
    assume {:print "$at(26,26203,26281)"} true;
    assert {:msg "assert_failed(26,26203,26281): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#123, $1_Signer_$address_of($t0));

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>(Signer::$address_of[]($t0))), 4)) at /home/ying/diem/language/diem-framework/modules/Roles.move:587:9+127
    assume {:print "$at(26,26290,26417)"} true;
    assert {:msg "assert_failed(26,26290,26417): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $1_Signer_$address_of($t0))), 4);

    // assert Not(ValidatorOperatorConfig::$has_validator_operator_config[@124](Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:49:9+108
    assume {:print "$at(36,1768,1876)"} true;
    assert {:msg "assert_failed(36,1768,1876): function does not abort under this condition"}
      !$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#124, $1_Signer_spec_address_of($t0));

    // assert Not(Not(DiemTimestamp::$is_operating[@125]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    ...
    // assert Not(Not(exists[@123]<Roles::RoleId>($t6))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#123, $t6);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>($t6)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $t6)), 0);
    ...
    // assert Not(Not(exists[@123]<Roles::RoleId>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/Roles.move:586:9+78
    assume {:print "$at(26,26203,26281)"} true;
    assert {:msg "assert_failed(26,26203,26281): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#123, $1_Signer_spec_address_of($t0));

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>(Signer::spec_address_of[]($t0))), 4)) at /home/ying/diem/language/diem-framework/modules/Roles.move:587:9+127
    assume {:print "$at(26,26290,26417)"} true;
    assert {:msg "assert_failed(26,26290,26417): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $1_Signer_spec_address_of($t0))), 4);

    // assert ValidatorOperatorConfig::$has_validator_operator_config(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:40:9+91
    assume {:print "$at(36,1386,1477)"} true;
    assert {:msg "assert_failed(36,1386,1477): post-condition does not hold"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:40:9+91
    return;
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Not(exists[@123]<Roles::RoleId>($t5)), Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>($t5)), 0)), Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Not(exists[@123]<Roles::RoleId>(Signer::$address_of[]($t0)))), Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>(Signer::$address_of[]($t0))), 4)), ValidatorOperatorConfig::$has_validator_operator_config[@124](Signer::spec_address_of[]($t0))), Not(DiemTimestamp::$is_operating[@125]())), Not(exists[@123]<Roles::RoleId>($t6))), Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>($t6)), 0)), Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Not(exists[@123]<Roles::RoleId>(Signer::spec_address_of[]($t0)))), Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>(Signer::spec_address_of[]($t0))), 4)) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:36:5+423
    assume {:print "$at(36,1060,1483)"} true;
    assert {:msg "assert_failed(36,1060,1483): abort not covered by any of the `aborts_if` clauses"}
      (((((((((((!$ResourceExists($1_Roles_RoleId_$memory#123, $t5) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $t5)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$ResourceExists($1_Roles_RoleId_$memory#123, $1_Signer_$address_of($t0))) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $1_Signer_$address_of($t0))), 4)) || $1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#124, $1_Signer_spec_address_of($t0))) || !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#125)) || !$ResourceExists($1_Roles_RoleId_$memory#123, $t6)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $t6)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$ResourceExists($1_Roles_RoleId_$memory#123, $1_Signer_spec_address_of($t0))) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $1_Signer_spec_address_of($t0))), 4));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(And(Not(exists[@123]<Roles::RoleId>($t5)), Eq(5, $t8)), And(Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>($t5)), 0), Eq(3, $t8))), And(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t8))), And(Not(exists[@123]<Roles::RoleId>(Signer::$address_of[]($t0))), Eq(5, $t8))), And(Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>(Signer::$address_of[]($t0))), 4), Eq(3, $t8))), And(ValidatorOperatorConfig::$has_validator_operator_config[@124](Signer::spec_address_of[]($t0)), Eq(6, $t8))), And(Not(DiemTimestamp::$is_operating[@125]()), Eq(1, $t8))), And(Not(exists[@123]<Roles::RoleId>($t6)), Eq(5, $t8))), And(Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>($t6)), 0), Eq(3, $t8))), And(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t8))), And(Not(exists[@123]<Roles::RoleId>(Signer::spec_address_of[]($t0))), Eq(5, $t8))), And(Neq<u64>(select Roles::RoleId.role_id(global[@123]<Roles::RoleId>(Signer::spec_address_of[]($t0))), 4), Eq(3, $t8))) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:36:5+423
    assert {:msg "assert_failed(36,1060,1483): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((((((!$ResourceExists($1_Roles_RoleId_$memory#123, $t5) && $IsEqual'u8'(5, $t8)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $t5)), 0) && $IsEqual'u8'(3, $t8))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t8))) || (!$ResourceExists($1_Roles_RoleId_$memory#123, $1_Signer_$address_of($t0)) && $IsEqual'u8'(5, $t8))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $1_Signer_$address_of($t0))), 4) && $IsEqual'u8'(3, $t8))) || ($1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#124, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(6, $t8))) || (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#125) && $IsEqual'u8'(1, $t8))) || (!$ResourceExists($1_Roles_RoleId_$memory#123, $t6) && $IsEqual'u8'(5, $t8))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $t6)), 0) && $IsEqual'u8'(3, $t8))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t8))) || (!$ResourceExists($1_Roles_RoleId_$memory#123, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(5, $t8))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#123, $1_Signer_spec_address_of($t0))), 4) && $IsEqual'u8'(3, $t8)));

    // abort($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:36:5+423
    $abort_code := $t8;
    $abort_flag := true;
    return;
...
// fun ValidatorOperatorConfig::get_human_name [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:55:5+320
procedure {:timeLimit 40} $1_ValidatorOperatorConfig_get_human_name$verify(_$t0: int) returns ($ret0: Vec (int))
{
    ...
    var $temp_0'u64': int;
    var $temp_0'vec'u8'': Vec (int);
    var $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#90: $Memory $1_ValidatorOperatorConfig_ValidatorOperatorConfig;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorOperatorConfig::$has_validator_operator_config(addr): Roles::spec_has_validator_operator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:55:5+320
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:77:9+137
    assume {:print "$at(36,1994,2314)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_operator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:62:17+6
    assume {:print "$at(36,2482,2488)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<ValidatorOperatorConfig::ValidatorOperatorConfig>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:62:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, $a_0)}(var $rsc := $ResourceValue($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, $a_0);
    ($IsValid'$1_ValidatorOperatorConfig_ValidatorOperatorConfig'($rsc))));

    // @90 := save_mem(ValidatorOperatorConfig::ValidatorOperatorConfig) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:55:5+1
    assume {:print "$at(36,1994,1995)"} true;
    $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#90 := $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory;

    // trace_local[validator_operator_addr]($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:55:5+1
    assume {:print "$track_local(17,0,0):", $t0} $t0 == $t0;

    // $t3 := ValidatorOperatorConfig::has_validator_operator_config($t0) on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:16+54
    assume {:print "$at(36,2116,2170)"} true;
    call $t3 := $1_ValidatorOperatorConfig_has_validator_operator_config($t0);
    if ($abort_flag) {
        assume {:print "$at(36,2116,2170)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(17,0):", $t4} $t4 == $t4;
        goto L3;
    }

    // $t5 := 0 at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:94+26
    $t5 := 0;
    assume $IsValid'u64'($t5);

    // nop at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:72+49
    // >> opaque call: $t5 := Errors::not_published($t4)

    // $t6 := opaque begin: Errors::not_published($t5) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:72+49

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:72+49
    assume $IsValid'u64'($t6);

    // assume Eq<u64>($t6, 5) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:72+49
    assume $IsEqual'u64'($t6, 5);

    // $t6 := opaque end: Errors::not_published($t5) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:72+49

    // trace_local[tmp#$2]($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:9+113
    assume {:print "$track_local(17,0,2):", $t6} $t6 == $t6;

    // trace_local[tmp#$1]($t3) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:9+113
    assume {:print "$track_local(17,0,1):", $t3} $t3 == $t3;

    // if ($t3) goto L0 else goto L1 at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:9+113
    if ($t3) { goto L0; } else { goto L1; }

    // label L1 at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:9+113
L1:

    // trace_abort($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:9+113
    assume {:print "$at(36,2109,2222)"} true;
    assume {:print "$track_abort(17,0):", $t6} $t6 == $t6;

    // $t4 := move($t6) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:9+113
    $t4 := $t6;

    // goto L3 at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:56:9+113
    goto L3;

    // label L0 at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:57:50+23
    assume {:print "$at(36,2273,2296)"} true;
L0:

    // $t7 := get_global<ValidatorOperatorConfig::ValidatorOperatorConfig>($t0) on_abort goto L3 with $t4 at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:57:11+13
    if (!$ResourceExists($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
    ...
    if ($abort_flag) {
        assume {:print "$at(36,2234,2247)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(17,0):", $t4} $t4 == $t4;
        goto L3;
    }

    // $t8 := get_field<ValidatorOperatorConfig::ValidatorOperatorConfig>.human_name($t7) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:57:10+75
    $t8 := $human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig($t7);

    // trace_return[0]($t8) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:57:9+76
    assume {:print "$track_return(17,0,0):", $t8} $t8 == $t8;

    // label L2 at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:58:5+1
    assume {:print "$at(36,2313,2314)"} true;
L2:

    // assert Not(Not(ValidatorOperatorConfig::$has_validator_operator_config[@90]($t0))) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:61:9+93
    assume {:print "$at(36,2372,2465)"} true;
    assert {:msg "assert_failed(36,2372,2465): function does not abort under this condition"}
      !!$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#90, $t0);

    // assert Eq<vector<u8>>($t8, ValidatorOperatorConfig::$get_human_name($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:62:9+58
    assume {:print "$at(36,2474,2532)"} true;
    assert {:msg "assert_failed(36,2474,2532): post-condition does not hold"}
      $IsEqual'vec'u8''($t8, $1_ValidatorOperatorConfig_$get_human_name($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, $t0));

    // return $t8 at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:62:9+58
    $ret0 := $t8;
    return;

    // label L3 at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:58:5+1
    assume {:print "$at(36,2313,2314)"} true;
L3:

    // assert Not(ValidatorOperatorConfig::$has_validator_operator_config[@90]($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:59:5+219
    assume {:print "$at(36,2319,2538)"} true;
    assert {:msg "assert_failed(36,2319,2538): abort not covered by any of the `aborts_if` clauses"}
      !$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#90, $t0);

    // assert And(Not(ValidatorOperatorConfig::$has_validator_operator_config[@90]($t0)), Eq(5, $t4)) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:59:5+219
    assert {:msg "assert_failed(36,2319,2538): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (!$1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory#90, $t0) && $IsEqual'u8'(5, $t4));

    // abort($t4) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:59:5+219
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun ValidatorOperatorConfig::has_validator_operator_config [verification] at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:64:5+153
procedure {:timeLimit 40} $1_ValidatorOperatorConfig_has_validator_operator_config$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    // bytecode translation starts here
    // assume forall addr: TypeDomain<address>() where ValidatorOperatorConfig::$has_validator_operator_config(addr): Roles::spec_has_validator_operator_role_addr(addr) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:64:5+153
    // global invariant at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:77:9+137
    assume {:print "$at(36,2543,2696)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_ValidatorOperatorConfig_$has_validator_operator_config($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, addr))  ==> ($1_Roles_spec_has_validator_operator_role_addr($1_Roles_RoleId_$memory, addr)));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:68:17+6
    assume {:print "$at(36,2754,2760)"} true;
    assume $IsValid'address'($t0);

    // assume forall $rsc: ResourceDomain<ValidatorOperatorConfig::ValidatorOperatorConfig>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:68:17+6
    assume (forall $a_0: int :: {$ResourceValue($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, $a_0)}(var $rsc := $ResourceValue($1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory, $a_0);
    ($IsValid'$1_ValidatorOperatorConfig_ValidatorOperatorConfig'($rsc))));
...
L1:
    ...
    // assert Eq<bool>($t1, ValidatorOperatorConfig::$has_validator_operator_config($t0)) at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:68:9+73
    assume {:print "$at(36,2746,2819)"} true;
    assert {:msg "assert_failed(36,2746,2819): post-condition does not hold"}
    ...
    // return $t1 at /home/ying/diem/language/diem-framework/modules/ValidatorOperatorConfig.move:68:9+73
    $ret0 := $t1;
    return;
