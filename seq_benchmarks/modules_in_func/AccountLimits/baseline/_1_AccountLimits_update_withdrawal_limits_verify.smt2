...
(assert (not
 ...
 :qid |AccountLimitsbpl.20118:474|
 :skolemid |567|
))) (and (=> (= (ControlFlow 0 331427) (- 0 440680)) (and (and (forall ((window_addr@@5 Int) ) (!  (=> (|$IsValid'address'| window_addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_179731| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_150476| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@5)))))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_112887_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 329796) 330260)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (|l#Vec_27093| (|p#$Mutation_182906| $t9)) 0) (= (ControlFlow 0 329806) 329796)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 439326) 329806) anon0_correct)))
