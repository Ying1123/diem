...
(assert (not
 (=> (= (ControlFlow 0 0) 358572) (let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon15_Then_correct true))
(let ((anon4_Else_correct@@2  (=> (not $abort_flag@1@@5) (and (=> (= (ControlFlow 0 252537) (- 0 360005)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) $t2@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) $t2@@1))) (and (=> (= (ControlFlow 0 252537) (- 0 360017)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) $t2@@1)) 5)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) $t2@@1)) 5))) (and (=> (= (ControlFlow 0 252537) (- 0 360035)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) $t1@@0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) $t1@@0)) (and (=> (= (ControlFlow 0 252537) (- 0 360045)) (|Select__T@[Int]Bool_| (|domain#$Memory_164446| $1_VASPDomain_VASPDomains_$memory@3) $t1@@0)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164446| $1_VASPDomain_VASPDomains_$memory@3) $t1@@0) (=> (= (ControlFlow 0 252537) (- 0 360053)) (= (|l#Vec_91804| (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_164446| $1_VASPDomain_VASPDomains_$memory@3) $t1@@0))) 0)))))))))))))
(let ((anon4_Then_correct@@2  (=> (and $abort_flag@1@@5 (= $abort_code@2@@5 $abort_code@2@@5)) (and (=> (= (ControlFlow 0 252661) (- 0 359898)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) $t2@@1)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) $t2@@1)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) $t1@@0))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) $t2@@1)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) $t2@@1)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) $t1@@0)) (=> (= (ControlFlow 0 252661) (- 0 359927)) (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) $t2@@1)) (= 5 $abort_code@2@@5)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) $t2@@1)) 5)) (= 3 $abort_code@2@@5))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) $t1@@0) (= 6 $abort_code@2@@5))) (= 6 $abort_code@2@@5)) (= 3 $abort_code@2@@5))))))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Else_correct  (=> (and (and (not $abort_flag@0@@5) (= $abort_flag@1@@5 $abort_flag@0@@5)) (and (= $1_VASPDomain_VASPDomains_$memory@3 $1_VASPDomain_VASPDomains_$memory@1) (= $abort_code@2@@5 $abort_code@1@@5))) (and (=> (= (ControlFlow 0 252331) 252661) anon4_Then_correct@@2) (=> (= (ControlFlow 0 252331) 252537) anon4_Else_correct@@2)))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$L3_correct  (=> (= $abort_flag@1@@5 true) (=> (and (= $1_VASPDomain_VASPDomains_$memory@3 $1_VASPDomain_VASPDomains_$memory@2) (= $abort_code@2@@5 inline$$1_VASPDomain_publish_vasp_domains$0$$t7@1)) (and (=> (= (ControlFlow 0 252253) 252661) anon4_Then_correct@@2) (=> (= (ControlFlow 0 252253) 252537) anon4_Else_correct@@2))))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Then_correct  (=> $abort_flag@0@@5 (=> (and (and (= $abort_code@1@@5 $abort_code@1@@5) (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory@1)) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t7@1 $abort_code@1@@5) (= (ControlFlow 0 252345) 252253))) inline$$1_VASPDomain_publish_vasp_domains$0$L3_correct))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Then$1_correct  (=> (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory) (=> (and (= $abort_flag@0@@5 true) (= $abort_code@1@@5 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 252397) 252345) inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Then_correct) (=> (= (ControlFlow 0 252397) 252331) inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Else_correct))))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0@@5)) (= (ControlFlow 0 252395) 252397)) inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Then$1_correct)))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0@@5))) (=> (and (and (= $1_VASPDomain_VASPDomains_$memory@0 ($Memory_164446 (|Store__T@[Int]Bool_| (|domain#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0@@5) true) (|Store__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0@@5) inline$$1_VASPDomain_publish_vasp_domains$0$$t14@1))) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory@0)) (and (= $abort_flag@0@@5 false) (= $abort_code@1@@5 $abort_code@0@@5))) (and (=> (= (ControlFlow 0 252321) 252345) inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Then_correct) (=> (= (ControlFlow 0 252321) 252331) inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Else_correct))))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon15_Else_correct  (=> (and (not false) (= inline$$1_VASPDomain_publish_vasp_domains$0$$t14@1 ($1_VASPDomain_VASPDomains |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$v@1|))) (and (=> (= (ControlFlow 0 252299) 252395) inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Then_correct) (=> (= (ControlFlow 0 252299) 252321) inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Else_correct)))))
(let ((|inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$v@1| (Vec_91804 (MapConstVec_82163 DefaultVecElem_82163) 0)) (and (=> (= (ControlFlow 0 252279) 252411) inline$$1_VASPDomain_publish_vasp_domains$0$anon15_Then_correct) (=> (= (ControlFlow 0 252279) 252299) inline$$1_VASPDomain_publish_vasp_domains$0$anon15_Else_correct)))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon14_Then_correct  (=> (and inline$$Not$0$dst@1@@5 (= (ControlFlow 0 252285) 252279)) |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon14_Else_correct  (=> (not inline$$Not$0$dst@1@@5) (=> (and (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0 inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0) (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory)) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t7@1 inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0) (= (ControlFlow 0 252247) 252253))) inline$$1_VASPDomain_publish_vasp_domains$0$L3_correct))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0) (= inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0 6)) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0 inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0) (= inline$$Not$0$dst@1@@5 inline$$Not$0$dst@1@@5))) (and (=> (= (ControlFlow 0 252231) 252285) inline$$1_VASPDomain_publish_vasp_domains$0$anon14_Then_correct) (=> (= (ControlFlow 0 252231) 252247) inline$$1_VASPDomain_publish_vasp_domains$0$anon14_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@5  (=> (and (= inline$$Not$0$dst@1@@5  (not inline$$1_VASPDomain_publish_vasp_domains$0$$t9@1)) (= (ControlFlow 0 252191) 252231)) inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Else$1_correct)))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Else_correct  (=> (not inline$$1_VASPDomain_publish_vasp_domains$0$$t6@0) (=> (and (and (|$IsValid'address'| inline$$1_VASPDomain_publish_vasp_domains$0$$t8@0) (= inline$$1_VASPDomain_publish_vasp_domains$0$$t8@0 (|$addr#$signer| _$t0@@5))) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t9@1 (|Select__T@[Int]Bool_| (|domain#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) inline$$1_VASPDomain_publish_vasp_domains$0$$t8@0)) (= (ControlFlow 0 252197) 252191))) inline$$Not$0$anon0_correct@@5))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Then_correct  (=> (and inline$$1_VASPDomain_publish_vasp_domains$0$$t6@0 (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_publish_vasp_domains$0$$t5@0)) (= 5 inline$$1_VASPDomain_publish_vasp_domains$0$$t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_publish_vasp_domains$0$$t5@0)) 5)) (= 3 inline$$1_VASPDomain_publish_vasp_domains$0$$t7@0)))) (=> (and (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t7@0 inline$$1_VASPDomain_publish_vasp_domains$0$$t7@0) (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory)) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t7@1 inline$$1_VASPDomain_publish_vasp_domains$0$$t7@0) (= (ControlFlow 0 252463) 252253))) inline$$1_VASPDomain_publish_vasp_domains$0$L3_correct))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon0_correct  (=> (= inline$$1_VASPDomain_publish_vasp_domains$0$$t3@0 (|$addr#$signer| _$t0@@5)) (=> (and (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t4@0 (|$addr#$signer| _$t0@@5)) (= _$t0@@5 _$t0@@5)) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t5@0 (|$addr#$signer| _$t0@@5)) (= inline$$1_VASPDomain_publish_vasp_domains$0$$t6@0  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_publish_vasp_domains$0$$t5@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_publish_vasp_domains$0$$t5@0)) 5)))))) (and (=> (= (ControlFlow 0 252135) 252463) inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Then_correct) (=> (= (ControlFlow 0 252135) 252197) inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Else_correct))))))
(let ((anon0$1_correct@@5  (=> (and (forall ((addr@@202 Int) ) (!  (=> (|$IsValid'address'| addr@@202) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_138625| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@202) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@202) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@202)) 4))))
 :qid |AccountAdministrationScriptsbpl.17771:20|
 :skolemid |407|
)) (forall ((addr@@203 Int) ) (!  (=> (|$IsValid'address'| addr@@203) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139588| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@203) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@203) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@203)) 3))))
 :qid |AccountAdministrationScriptsbpl.17775:20|
 :skolemid |408|
))) (=> (and (and (forall ((addr@@204 Int) ) (!  (=> (|$IsValid'address'| addr@@204) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139588| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@204) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@204) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@204)) 3))))
 :qid |AccountAdministrationScriptsbpl.17779:20|
 :skolemid |409|
)) (forall ((addr@@205 Int) ) (!  (=> (|$IsValid'address'| addr@@205) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_139588| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@205) (not (= (|l#Vec_91119| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_139588| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@205)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@205) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@205)) 3))))
 :qid |AccountAdministrationScriptsbpl.17783:20|
 :skolemid |410|
))) (and (forall ((mint_cap_owner@@5 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_152578| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) mint_cap_owner@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) mint_cap_owner@@5)) 1))))
 :qid |AccountAdministrationScriptsbpl.17787:21|
 :skolemid |411|
)) (forall ((mint_cap_owner@@6 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_152665| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner@@6) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) mint_cap_owner@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) mint_cap_owner@@6)) 1))))
 :qid |AccountAdministrationScriptsbpl.17787:268|
 :skolemid |412|
)))) (=> (and (and (and (forall ((addr1@@14 Int) ) (!  (=> (|$IsValid'address'| addr1@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147080| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1@@14) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@14)) 1))))
 :qid |AccountAdministrationScriptsbpl.17791:21|
 :skolemid |413|
)) (forall ((addr1@@15 Int) ) (!  (=> (|$IsValid'address'| addr1@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147167| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr1@@15) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@15)) 1))))
 :qid |AccountAdministrationScriptsbpl.17791:231|
 :skolemid |414|
))) (and (forall ((addr1@@16 Int) ) (!  (=> (|$IsValid'address'| addr1@@16) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_153244| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1@@16) (|Select__T@[Int]Bool_| (|domain#$Memory_152832| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1@@16)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@16)) 2))))
 :qid |AccountAdministrationScriptsbpl.17795:21|
 :skolemid |415|
)) (forall ((addr1@@17 Int) ) (!  (=> (|$IsValid'address'| addr1@@17) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_153361| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr1@@17) (|Select__T@[Int]Bool_| (|domain#$Memory_152913| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr1@@17)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@17)) 2))))
 :qid |AccountAdministrationScriptsbpl.17795:292|
 :skolemid |416|
)))) (and (and (forall ((addr1@@18 Int) ) (!  (=> (|$IsValid'address'| addr1@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) addr1@@18) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@18)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr1@@18)) 2)))))
 :qid |AccountAdministrationScriptsbpl.17803:20|
 :skolemid |417|
)) (forall ((addr@@206 Int) ) (!  (=> (|$IsValid'address'| addr@@206) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@206) (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@206)))
 :qid |AccountAdministrationScriptsbpl.17807:20|
 :skolemid |418|
))) (and (forall ((addr@@207 Int) ) (!  (=> (|$IsValid'address'| addr@@207) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164510| $1_VASPDomain_VASPDomainManager_$memory) addr@@207) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@207) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@207)) 1))))
 :qid |AccountAdministrationScriptsbpl.17811:20|
 :skolemid |419|
)) (forall ((addr@@208 Int) ) (!  (=> (|$IsValid'address'| addr@@208) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_174178| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@208) (|Select__T@[Int]Bool_| (|domain#$Memory_174269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@208)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@208) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@208)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@208) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@208)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@208) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@208)) 2)))))
 :qid |AccountAdministrationScriptsbpl.17815:20|
 :skolemid |420|
))))) (=> (and (and (and (and (forall ((addr@@209 Int) ) (!  (=> (|$IsValid'address'| addr@@209) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_171666| $1_DesignatedDealer_Dealer_$memory) addr@@209) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@209) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@209)) 2))))
 :qid |AccountAdministrationScriptsbpl.17819:20|
 :skolemid |421|
)) (forall ((addr@@210 Int) ) (!  (=> (|$IsValid'address'| addr@@210) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166928| $1_DualAttestation_Credential_$memory) addr@@210) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@210) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@210)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@210) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@210)) 5)))))
 :qid |AccountAdministrationScriptsbpl.17823:20|
 :skolemid |422|
))) (and (forall ((addr@@211 Int) ) (!  (=> (|$IsValid'address'| addr@@211) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139588| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@211) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@211) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@211)) 3))))
 :qid |AccountAdministrationScriptsbpl.17827:20|
 :skolemid |423|
)) (forall ((addr@@212 Int) ) (!  (=> (|$IsValid'address'| addr@@212) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_138625| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@212) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@212) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@212)) 4))))
 :qid |AccountAdministrationScriptsbpl.17831:20|
 :skolemid |424|
)))) (and (and (forall ((addr@@213 Int) ) (!  (=> (|$IsValid'address'| addr@@213) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_165462| $1_VASP_ParentVASP_$memory) addr@@213) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@213) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@213)) 5))))
 :qid |AccountAdministrationScriptsbpl.17835:20|
 :skolemid |425|
)) (forall ((addr@@214 Int) ) (!  (=> (|$IsValid'address'| addr@@214) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_165398| $1_VASP_ChildVASP_$memory) addr@@214) (and (|Select__T@[Int]Bool_| (|domain#$Memory_137392| $1_Roles_RoleId_$memory) addr@@214) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) addr@@214)) 6))))
 :qid |AccountAdministrationScriptsbpl.17839:20|
 :skolemid |426|
))) (and (|$IsValid'address'| (|$addr#$signer| _$t0@@5)) (forall (($a_0@@20 Int) ) (! (let (($rsc@@20 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) $a_0@@20)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@20))
 :qid |AccountAdministrationScriptsbpl.17845:20|
 :skolemid |427|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_137392| $1_Roles_RoleId_$memory) $a_0@@20))
))))) (and (and (and (forall (($a_0@@21 Int) ) (! (let (($rsc@@21 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) $a_0@@21)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc@@21) (and (and (let (($range_1 ($Range 0 (|l#Vec_91804| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@21)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@122 $i_2))
(<= (|l#Vec_25477| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_91804| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@21)) i@@122))) 63)))
 :qid |AccountAdministrationScriptsbpl.17850:140|
 :skolemid |428|
))) (let (($range_3 ($Range 0 (|l#Vec_91804| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@21)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@123 $i_4))
(let (($range_5 ($Range (+ i@@123 1) (|l#Vec_91804| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@21)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@39 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_91804| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@21)) i@@123)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_91804| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@21)) j@@39))))))
 :qid |AccountAdministrationScriptsbpl.17852:98|
 :skolemid |429|
)))))
 :qid |AccountAdministrationScriptsbpl.17851:202|
 :skolemid |430|
)))) (let (($range_7 (|$domains#$1_VASPDomain_VASPDomains| $rsc@@21)))
(forall (($i_8 Int) ) (!  (=> (InRangeVec_82143 $range_7 $i_8) (let (($elem (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_91804| $range_7) $i_8)))
(<= (|l#Vec_25477| (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 :qid |AccountAdministrationScriptsbpl.17853:229|
 :skolemid |431|
))))))
 :qid |AccountAdministrationScriptsbpl.17849:20|
 :skolemid |432|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_164446| $1_VASPDomain_VASPDomains_$memory) $a_0@@21))
)) (= $t1@@0 (|$addr#$signer| _$t0@@5))) (and (= $t2@@1 (|$addr#$signer| _$t0@@5)) (let ((addr@@215 (|$addr#$signer| _$t0@@5)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_136874| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_172934| $1_DiemAccount_DiemAccount_$memory) addr@@215)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) addr@@215) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_171919| $1_AccountFreezing_FreezingBit_$memory) addr@@215)))))))) (and (and (= _$t0@@5 _$t0@@5) (= $t3@@2 (|$addr#$signer| _$t0@@5))) (and (= $t4@@2 (|$addr#$signer| _$t0@@5)) (= (ControlFlow 0 252467) 252135))))) inline$$1_VASPDomain_publish_vasp_domains$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@5  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@7 T@$1_Event_EventHandle) ) (! (let ((stream@@6 (|Select__T@[$1_Event_EventHandle]Multiset_91033_| (|streams#$EventStore| $es) handle@@7)))
 (and (= (|l#Multiset_91033| stream@@6) 0) (forall ((v@@66 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_91033| stream@@6) v@@66) 0)
 :qid |AccountAdministrationScriptsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountAdministrationScriptsbpl.3307:13|
 :skolemid |119|
))) (= (ControlFlow 0 250807) 252467)) anon0$1_correct@@5)))
(let ((anon0_correct@@5  (=> (= (ControlFlow 0 358572) 250807) inline$$InitEventStore$0$anon0_correct@@5)))
anon0_correct@@5))))))))))))))))))))))
))
(check-sat)
(pop 1)
