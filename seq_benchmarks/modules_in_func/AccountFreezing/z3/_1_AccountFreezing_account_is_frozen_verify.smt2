...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 210463) (let ((anon11_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 152978) (- 0 210693))) false))))
(let ((L3_correct  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 152918) (- 0 210739)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 152918) (- 0 210746)) (= $t1@0  (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0))))) (=> (= $t1@0  (and (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0)))) (=> (= (ControlFlow 0 152918) (- 0 210757)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) addr@@0) (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) addr@@0)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) addr@@0)))))
 :qid |AccountFreezingbpl.11127:15|
 :skolemid |185|
))))))))))
(let ((anon11_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t5@0 (|$is_frozen#$1_AccountFreezing_FreezingBit| $t3@1)) (= $t5@0 $t5@0)) (and (= $t1@0 $t5@0) (= (ControlFlow 0 152956) 152918))) L3_correct))))
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 153030) 152978) anon11_Then_correct) (=> (= (ControlFlow 0 153030) 152956) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0)) (= (ControlFlow 0 153028) 153030)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_96379| $1_AccountFreezing_FreezingBit_$memory) _$t0)) (= $t3@1 $t3@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 152936) 152978) anon11_Then_correct) (=> (= (ControlFlow 0 152936) 152956) anon11_Else_correct))))))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_66189_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountFreezingbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 152747) 152831)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 210463) 152747) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
