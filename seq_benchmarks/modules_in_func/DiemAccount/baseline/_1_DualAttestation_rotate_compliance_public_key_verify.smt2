...
(declare-fun $t21@2 () T@$Mutation_558933)
...
(declare-fun $t23@0 () T@$Mutation_456960)
...
(declare-fun $t21@1 () T@$Mutation_558933)
(declare-fun $t22@0 () T@$Mutation_449654)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t22@1 () T@$Mutation_449654)
(declare-fun $t21 () T@$Mutation_558933)
(declare-fun $t13 () Int)
(declare-fun $t21@0 () T@$Mutation_558933)
...
(declare-fun $t10 () Int)
(declare-fun $t7 () T@$Mutation_558933)
(declare-fun $t22 () T@$Mutation_449654)
(declare-fun $t23 () T@$Mutation_456960)
(push 1)
(set-info :boogie-vc-id $1_DualAttestation_rotate_compliance_public_key$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1911398) (let ((anon26_Else_correct  (=> (not $abort_flag@0) (=> (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr@@0) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@0)) 5)))))
 :qid |DiemAccountbpl.26958:20|
 :skolemid |453|
)) (= $1_DualAttestation_Credential_$memory@0 ($Memory_469122 (|Store__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_558933| $t21@2)) true) (|Store__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_558933| $t21@2)) (|v#$Mutation_558933| $t21@2))))) (and (=> (= (ControlFlow 0 1120695) (- 0 1912359)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr@@1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@1)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@1)) 5)))))
 :qid |DiemAccountbpl.26969:15|
 :skolemid |454|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr@@2) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@2)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr@@2)) 5)))))
 :qid |DiemAccountbpl.26969:15|
 :skolemid |454|
)) (and (=> (= (ControlFlow 0 1120695) (- 0 1912395)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t1)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t1))) (and (=> (= (ControlFlow 0 1120695) (- 0 1912405)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t8))) (and (=> (= (ControlFlow 0 1120695) (- 0 1912417)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1120695) (- 0 1912427)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) $t9)) _$t1)) (=> (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) $t9)) _$t1) (and (=> (= (ControlFlow 0 1120695) (- 0 1912440)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (not (= addr1 $t9)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1)))))
 :qid |DiemAccountbpl.26998:15|
 :skolemid |455|
))) (=> (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (not (= addr1@@0 $t9)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@0)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@0)))))
 :qid |DiemAccountbpl.26998:15|
 :skolemid |455|
)) (and (=> (= (ControlFlow 0 1120695) (- 0 1912478)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@1)))
 :qid |DiemAccountbpl.27003:15|
 :skolemid |456|
))) (=> (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@2)))
 :qid |DiemAccountbpl.27003:15|
 :skolemid |456|
)) (and (=> (= (ControlFlow 0 1120695) (- 0 1912502)) (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@3))))
 :qid |DiemAccountbpl.27008:15|
 :skolemid |457|
))) (=> (forall ((addr1@@4 Int) ) (!  (=> (|$IsValid'address'| addr1@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@4))))
 :qid |DiemAccountbpl.27008:15|
 :skolemid |457|
)) (and (=> (= (ControlFlow 0 1120695) (- 0 1912530)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816)))) (and (=> (= (ControlFlow 0 1120695) (- 0 1912547)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@5) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@5)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@5)))))
 :qid |DiemAccountbpl.27018:15|
 :skolemid |458|
))) (=> (forall ((addr1@@6 Int) ) (!  (=> (|$IsValid'address'| addr1@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@6) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory@0) addr1@@6)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@6)))))
 :qid |DiemAccountbpl.27018:15|
 :skolemid |458|
)) (and (=> (= (ControlFlow 0 1120695) (- 0 1912582)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new (let ((len (|l#Multiset_416285| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@0) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_416285| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@1) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@0))))))
 ...
 :qid |DiemAccountbpl.3536:13|
 :skolemid |130|
))))) (=> (= (ControlFlow 0 1120695) (- 0 1912607)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_416285| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@2) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@2) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@1))))))
...
(let ((L5_correct  (and (=> (= (ControlFlow 0 1120054) (- 0 1912232)) (or (or (not ($1_Signature_$ed25519_validate_pubkey _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (or (or (not ($1_Signature_$ed25519_validate_pubkey _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 1120054) (- 0 1912253)) (or (or (and (not ($1_Signature_$ed25519_validate_pubkey _$t1)) (= 7 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t8)) (= 5 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t17@0))))))))
(let ((anon26_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 1120709) 1120054))) L5_correct)))
(let ((|inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1| (|v#$Mutation_456960| $t23@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_416285| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@3) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t26@0))))
(Multiset_416285 (|Store__T@[$EventRep]Int_| (|v#Multiset_416285| stream@@3) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t26@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 1120349) 1120709) anon26_Then_correct) (=> (= (ControlFlow 0 1120349) 1120695) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (not $t25) (=> (and (and (|$IsValid'u64'| $t24) (= $t24 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= $t26@0 ($1_DualAttestation_ComplianceKeyRotationEvent _$t1 $t24)) (= (ControlFlow 0 1120355) 1120349))) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|))))
(let ((anon25_Then_correct  (=> $t25 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t17)) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 1120735) 1120054))) L5_correct))))
(let ((anon24_Else_correct  (=> (and (and (and (not $abort_flag@0) (= |$temp_0'$1_DualAttestation_Credential'@0| (|v#$Mutation_558933| $t21@1))) (and (= |$temp_0'$1_DualAttestation_Credential'@0| |$temp_0'$1_DualAttestation_Credential'@0|) (= $t22@0 ($Mutation_449654 (|l#$Mutation_558933| $t21@1) (let ((l (|l#Vec_37831| (|p#$Mutation_558933| $t21@1))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_558933| $t21@1)) l 2) (+ l 1))) (|$compliance_public_key#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t21@1)))))) (and (and (= $t22@1 ($Mutation_449654 (|l#$Mutation_449654| $t22@0) (|p#$Mutation_449654| $t22@0) _$t1)) (= $t21@2 ($Mutation_558933 (|l#$Mutation_558933| $t21@1) (|p#$Mutation_558933| $t21@1) ($1_DualAttestation_Credential (|$human_name#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t21@1)) (|$base_url#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t21@1)) (|v#$Mutation_449654| $t22@1) (|$expiration_date#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t21@1)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t21@1)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t21@1)))))) (and (= $t23@0 ($Mutation_456960 (|l#$Mutation_558933| $t21@2) (let ((l@@0 (|l#Vec_37831| (|p#$Mutation_558933| $t21@2))))
(Vec_37831 (|Store__T@[Int]Int_| (|v#Vec_37831| (|p#$Mutation_558933| $t21@2)) l@@0 4) (+ l@@0 1))) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_558933| $t21@2)))) (= $t25  (not (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 1120250) 1120735) anon25_Then_correct) (=> (= (ControlFlow 0 1120250) 1120355) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 1120749) 1120054))) L5_correct)))
(let ((anon23_Then$1_correct  (=> (= $t21@1 $t21) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1120801) 1120749) anon24_Then_correct) (=> (= (ControlFlow 0 1120801) 1120250) anon24_Else_correct))))))
(let ((anon23_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t13)) (= (ControlFlow 0 1120799) 1120801)) anon23_Then$1_correct)))
(let ((anon23_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t13) (=> (and (and (= $t21@0 ($Mutation_558933 ($Global $t13) (Vec_37831 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) $t13))) (= $t21@1 $t21@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1120172) 1120749) anon24_Then_correct) (=> (= (ControlFlow 0 1120172) 1120250) anon24_Else_correct))))))
(let ((anon22_Then_correct  (=> inline$$1_Signature_ed25519_validate_pubkey$0$res@1 (and (=> (= (ControlFlow 0 1120150) 1120799) anon23_Then_correct) (=> (= (ControlFlow 0 1120150) 1120172) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (and (not inline$$1_Signature_ed25519_validate_pubkey$0$res@1) (= $t20 $t20)) (and (= $t17@0 $t20) (= (ControlFlow 0 1120146) 1120054))) L5_correct)))
(let ((anon21_Else_correct  (=> (and (not false) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t20) (= $t20 7)) (and (= $t20 $t20) (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 inline$$1_Signature_ed25519_validate_pubkey$0$res@1))) (and (=> (= (ControlFlow 0 1120130) 1120150) anon22_Then_correct) (=> (= (ControlFlow 0 1120130) 1120146) anon22_Else_correct))))))
(let ((inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct  (=> (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 ($1_Signature_$ed25519_validate_pubkey _$t1)) (and (=> (= (ControlFlow 0 1120088) 1120815) anon21_Then_correct) (=> (= (ControlFlow 0 1120088) 1120130) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (and $t14@0 (= (ControlFlow 0 1120094) 1120088)) inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct)))
(let ((anon20_Else_correct  (=> (and (and (not $t14@0) (= $t16 $t16)) (and (= $t17@0 $t16) (= (ControlFlow 0 1119974) 1120054))) L5_correct)))
(let ((anon0$1_correct  (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_496194| $1_DiemConfig_Configuration_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_495758| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_531513| $1_XDX_Reserve_$memory) 173345816)))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_501831| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_526329| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_553588| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@7 Int) ) (!  (=> (|$IsValid'address'| addr1@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) addr1@@7) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr1@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr1@@7)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465676| $1_Roles_RoleId_$memory) addr1@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_465676| $1_Roles_RoleId_$memory) addr1@@7)) 2)))))
 :qid |DiemAccountbpl.26707:20|
 :skolemid |450|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) (|$IsValid'vec'u8''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemAccountbpl.26716:20|
 :skolemid |451|
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) $a_0@@0)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@0))
 :qid |DiemAccountbpl.26720:20|
 :skolemid |452|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) $a_0@@0))
))))) (=> (and (and (and (and (= $t8 (|$addr#$signer| _$t0)) (= $t9 (|$addr#$signer| _$t0))) (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_469122| $1_DualAttestation_Credential_$memory) $t10))))) (and (and (= $t12 ($1_DualAttestation_ComplianceKeyRotationEvent _$t1 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_463734| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| $t13)))) (and (and (and (= $t13 (|$addr#$signer| _$t0)) (= $t13 $t13)) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_469122| $1_DualAttestation_Credential_$memory) $t13)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t16) (= $t16 5)) (and (= $t16 $t16) (= $t14@0 $t14@0))))) (and (=> (= (ControlFlow 0 1119958) 1120094) anon20_Then_correct) (=> (= (ControlFlow 0 1119958) 1119974) anon20_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_416285_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemAccountbpl.3520:13|
 :skolemid |129|
))) (= (ControlFlow 0 1119653) 1119958)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_37831| (|p#$Mutation_558933| $t7)) 0) (=> (and (and (= (|l#Vec_37831| (|p#$Mutation_558933| $t21)) 0) (= (|l#Vec_37831| (|p#$Mutation_449654| $t22)) 0)) (and (= (|l#Vec_37831| (|p#$Mutation_456960| $t23)) 0) (= (ControlFlow 0 1119663) 1119653))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 1911398) 1119663) anon0_correct)))
