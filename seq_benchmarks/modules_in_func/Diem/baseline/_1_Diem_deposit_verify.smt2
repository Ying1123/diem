...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 1165334) (let ((anon11_Else_correct  (=> (and (not $abort_flag@1) (= $t16@0 ($Mutation_13929 (|l#$Mutation_401271| _$t0) (let ((l (|l#Vec_28308| (|p#$Mutation_401271| _$t0))))
(Vec_28308 (|Store__T@[Int]Int_| (|v#Vec_28308| (|p#$Mutation_401271| _$t0)) l 0) (+ l 1))) (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| _$t0))))) (=> (and (and (= $t16@1 ($Mutation_13929 (|l#$Mutation_13929| $t16@0) (|p#$Mutation_13929| $t16@0) inline$$AddU64$0$dst@2)) (= $t0@0 ($Mutation_401271 (|l#$Mutation_401271| _$t0) (|p#$Mutation_401271| _$t0) (|$1_Diem_Diem'#0'| (|v#$Mutation_13929| $t16@1))))) (and (= |$temp_0'$1_Diem_Diem'#0''@1| (|v#$Mutation_401271| $t0@0)) (= |$temp_0'$1_Diem_Diem'#0''@1| |$temp_0'$1_Diem_Diem'#0''@1|))) (and (=> (= (ControlFlow 0 826964) (- 0 1165926)) (not (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615))) (=> (not (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615)) (and (=> (= (ControlFlow 0 826964) (- 0 1165943)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| $t0@0)) (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)))) (=> (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| $t0@0)) (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1))) (and (=> (= (ControlFlow 0 826964) (- 0 1165961)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 826964) (- 0 1165982)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@0))))
 :qid |Diembpl.27570:15|
 :skolemid |1413|
 ...
 :qid |Diembpl.27570:15|
 :skolemid |1413|
)) (and (=> (= (ControlFlow 0 826964) (- 0 1166011)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_316305| |$1_Diem_MintCapability'#0'_$memory|) addr@@2)))
 :qid |Diembpl.27575:15|
 :skolemid |1414|
 ...
 :qid |Diembpl.27575:15|
 :skolemid |1414|
)) (and (=> (= (ControlFlow 0 826964) (- 0 1166036)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 826964) (- 0 1166057)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4))))
 :qid |Diembpl.27585:15|
 :skolemid |1415|
 ...
 :qid |Diembpl.27585:15|
 :skolemid |1415|
)) (and (=> (= (ControlFlow 0 826964) (- 0 1166086)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_316564| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6)))
 :qid |Diembpl.27590:15|
 :skolemid |1416|
 ...
 :qid |Diembpl.27590:15|
 :skolemid |1416|
)) (and (=> (= (ControlFlow 0 826964) (- 0 1166111)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 826964) (- 0 1166132)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 826964) (- 0 1166153)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_317009| |$1_Diem_Preburn'#0'_$memory|) addr@@8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8))))
 :qid |Diembpl.27605:15|
 :skolemid |1417|
 ...
 :qid |Diembpl.27605:15|
 :skolemid |1417|
)) (and (=> (= (ControlFlow 0 826964) (- 0 1166189)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_316949| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10)))
 :qid |Diembpl.27610:15|
 :skolemid |1418|
 ...
 :qid |Diembpl.27610:15|
 :skolemid |1418|
)) (=> (= (ControlFlow 0 826964) (- 0 1166214)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_335624| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 826429) (- 0 1165824)) (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615)) (=> (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615) (=> (= (ControlFlow 0 826429) (- 0 1165836)) (and (> (+ (|$value#$1_Diem_Diem'#0'| $t5@0) (|$value#$1_Diem_Diem'#0'| _$t1)) 18446744073709551615) (= 8 $t10@0)))))))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 826978) 826429))) L3_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 826586) 826978) anon11_Then_correct) (=> (= (ControlFlow 0 826586) 826964) anon11_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t14@0 $t6@0) $MAX_U64) (= (ControlFlow 0 826584) 826586)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t14@0 $t6@0)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t14@0 $t6@0)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 826532) 826978) anon11_Then_correct) (=> (= (ControlFlow 0 826532) 826964) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and inline$$Ge$0$dst@1 (= $t14@0 (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| _$t0)))) (and (=> (= (ControlFlow 0 826592) 826584) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 826592) 826532) inline$$AddU64$0$anon3_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not inline$$Ge$0$dst@1) (= $t13 $t13)) (and (= $t10@0 $t13) (= (ControlFlow 0 826385) 826429))) L3_correct)))
(let ((anon9_Else$1_correct  (=> (|$IsValid'u64'| 7) (=> (and (and (|$IsValid'u64'| $t13) (= $t13 8)) (and (= $t13 $t13) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 826369) 826592) anon10_Then_correct) (=> (= (ControlFlow 0 826369) 826385) anon10_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= inline$$Sub$0$dst@2 $t6@0)) (= (ControlFlow 0 826333) 826369)) anon9_Else$1_correct)))
(let ((anon9_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 826339) 826333)) inline$$Ge$0$anon0_correct)))
(let ((anon9_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 826992) 826429))) L3_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 826279) 826992) anon9_Then_correct) (=> (= (ControlFlow 0 826279) 826339) anon9_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< 18446744073709551615 $t8@0) (= (ControlFlow 0 826277) 826279)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= $t8@0 18446744073709551615) (=> (and (and (= inline$$Sub$0$dst@1 (- 18446744073709551615 $t8@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 826229) 826992) anon9_Then_correct) (=> (= (ControlFlow 0 826229) 826339) anon9_Else_correct))))))
(let ((anon0$1_correct  (=> (= (|l#$Mutation_401271| _$t0) ($Param 0)) (=> (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_401271| _$t0)) (|$IsValid'$1_Diem_Diem'#0''| _$t1)) (=> (and (and (and (= $t5@0 (|v#$Mutation_401271| _$t0)) (= |$temp_0'$1_Diem_Diem'#0''@0| (|v#$Mutation_401271| _$t0))) (and (= |$temp_0'$1_Diem_Diem'#0''@0| |$temp_0'$1_Diem_Diem'#0''@0|) (= _$t1 _$t1))) (and (and (= $t6@0 (|$value#$1_Diem_Diem'#0'| _$t1)) (= $t6@0 $t6@0)) (and (|$IsValid'u64'| 18446744073709551615) (= $t8@0 (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_401271| _$t0)))))) (and (=> (= (ControlFlow 0 826285) 826277) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 826285) 826229) inline$$Sub$0$anon3_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_275813_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Diembpl.2764:13|
 :skolemid |98|
))) (= (ControlFlow 0 826058) 826285)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (|l#Vec_28308| (|p#$Mutation_13929| $t16)) 0) (= (ControlFlow 0 826068) 826058)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 1165334) 826068) anon0_correct)))
