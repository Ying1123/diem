...
L5:
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:54:5+794
    ...
    // assert Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:70:9+89
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:70:9+89
    assume {:print "$at(20,2608,2697)"} true;
    assert {:msg "assert_failed(20,2608,2697): global memory invariant does not hold"}
...
// fun DiemVersion::initialize [verification] at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+298
procedure {:timeLimit 40} $1_DiemVersion_initialize$verify(_$t0: int, _$t1: int) returns ()
{
    // declare local variables
    var $t2: int;
    var $t3: int;
    ...
    var $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#147: $Memory $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion';
    var $1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#148: $Memory $1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion';
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+298
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(20,618,916)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+298
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+298
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:70:9+89
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+298
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+298
    assume $IsValid'u64'($t1);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+298
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+298
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+298
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+298
    ...
    // @146 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+1
    assume {:print "$at(20,618,619)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @145 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+1
    $1_Roles_RoleId_$memory#145 := $1_Roles_RoleId_$memory;

    // @149 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+1
    $1_DiemConfig_Configuration_$memory#149 := $1_DiemConfig_Configuration_$memory;

    // @147 := save_mem(DiemConfig::DiemConfig<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+1
    $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#147 := $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory;

    // @148 := save_mem(DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:17:5+1
    $1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#148 := $1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory;
...
L1:
    ...
    // assert Not(Not(exists[@145]<Roles::RoleId>($t2))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    assume {:print "$at(26,23574,23633)"} true;
    assert {:msg "assert_failed(26,23574,23633): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#145, $t2);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t2)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    assume {:print "$at(26,23642,23729)"} true;
    assert {:msg "assert_failed(26,23642,23729): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t2)), 0);
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@146]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:140:9+51
    assume {:print "$at(17,5622,5673)"} true;
    assert {:msg "assert_failed(17,5622,5673): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146);

    // assert Not(DiemConfig::spec_is_published[@147]<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:257:9+38
    assume {:print "$at(13,10749,10787)"} true;
    assert {:msg "assert_failed(13,10749,10787): function does not abort under this condition"}
      !$1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#147);

    // assert Not(exists[@148]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:258:9+86
    assume {:print "$at(13,10796,10882)"} true;
    assert {:msg "assert_failed(13,10796,10882): function does not abort under this condition"}
      !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#148, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@145]<Roles::RoleId>($t3))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    assume {:print "$at(26,23574,23633)"} true;
    assert {:msg "assert_failed(26,23574,23633): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#145, $t3);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t3)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    assume {:print "$at(26,23642,23729)"} true;
    assert {:msg "assert_failed(26,23642,23729): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t3)), 0);
    ...
    // assert exists<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:264:9+84
    assume {:print "$at(13,11036,11120)"} true;
    assert {:msg "assert_failed(13,11036,11120): post-condition does not hold"}
      $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory, $1_Signer_spec_address_of($t0));

    // assert DiemConfig::spec_is_published<DiemVersion::DiemVersion>() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:142:9+36
    assume {:print "$at(13,5647,5683)"} true;
    assert {:msg "assert_failed(13,5647,5683): post-condition does not hold"}
      $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory);

    // assert Eq<DiemVersion::DiemVersion>(DiemConfig::$get<DiemVersion::DiemVersion>(), pack DiemVersion::DiemVersion($t1)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:143:9+33
    assume {:print "$at(13,5692,5725)"} true;
    assert {:msg "assert_failed(13,5692,5725): post-condition does not hold"}
      $IsEqual'$1_DiemVersion_DiemVersion'($1_DiemConfig_$get'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory), $1_DiemVersion_DiemVersion($t1));

    // assert Eq<bool>(DiemConfig::spec_has_config[@149](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:144:9+52
    assume {:print "$at(13,5734,5786)"} true;
    assert {:msg "assert_failed(13,5734,5786): post-condition does not hold"}
      $IsEqual'bool'($1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory#149), $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assert Implies(DiemConfig::spec_is_published[@147]<DiemVersion::DiemVersion>(), Eq<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(global<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(a550c18), global[@147]<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:77:9+184
    assume {:print "$at(20,2853,3037)"} true;
    assert {:msg "assert_failed(20,2853,3037): post-condition does not hold"}
      ($1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#147) ==> $IsEqual'$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion''($ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, 173345816), $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#147, 173345816)));

    // return () at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:77:9+184
    return;
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Not(exists[@145]<Roles::RoleId>($t2)), Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t2)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), Not(DiemTimestamp::$is_genesis[@146]())), DiemConfig::spec_is_published[@147]<DiemVersion::DiemVersion>()), exists[@148]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0))), Not(exists[@145]<Roles::RoleId>($t3))), Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t3)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:25:5+412
    assume {:print "$at(20,921,1333)"} true;
    assert {:msg "assert_failed(20,921,1333): abort not covered by any of the `aborts_if` clauses"}
      ((((((((!$ResourceExists($1_Roles_RoleId_$memory#145, $t2) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t2)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146)) || $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#147)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#148, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#145, $t3)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t3)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(And(Not(exists[@145]<Roles::RoleId>($t2)), Eq(5, $t5)), And(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t2)), 0), Eq(3, $t5))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t5))), And(Not(DiemTimestamp::$is_genesis[@146]()), Eq(1, $t5))), DiemConfig::spec_is_published[@147]<DiemVersion::DiemVersion>()), exists[@148]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0))), And(Not(exists[@145]<Roles::RoleId>($t3)), Eq(5, $t5))), And(Neq<u64>(select Roles::RoleId.role_id(global[@145]<Roles::RoleId>($t3)), 0), Eq(3, $t5))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t5))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:25:5+412
    assert {:msg "assert_failed(20,921,1333): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((((!$ResourceExists($1_Roles_RoleId_$memory#145, $t2) && $IsEqual'u8'(5, $t5)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t2)), 0) && $IsEqual'u8'(3, $t5))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t5))) || (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#146) && $IsEqual'u8'(1, $t5))) || $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#147)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#148, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory#145, $t3) && $IsEqual'u8'(5, $t5))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#145, $t3)), 0) && $IsEqual'u8'(3, $t5))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t5)));

    // abort($t5) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:25:5+412
    $abort_code := $t5;
    $abort_flag := true;
    return;
...
// fun DiemVersion::set [verification] at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
procedure {:timeLimit 40} $1_DiemVersion_set$verify(_$t0: int, _$t1: int) returns ()
{
    // declare local variables
    ...
    var $temp_0'bool': bool;
    var $temp_0'u64': int;
    var $1_Roles_RoleId_$memory#179: $Memory $1_Roles_RoleId;
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181: $Memory $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion';
    var $1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#182: $Memory $1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion';
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(a550c18)) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:169:9+72
    assume {:print "$at(20,1413,1857)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, 173345816));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:409:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVersion::DiemVersion>()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:70:9+89
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
    assume $IsValid'u64'($t1);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion''($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+444
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion''($rsc))));
    ...
    // @180 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+1
    assume {:print "$at(20,1413,1414)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @179 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+1
    $1_Roles_RoleId_$memory#179 := $1_Roles_RoleId_$memory;

    // @184 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+1
    $1_DiemConfig_Configuration_$memory#184 := $1_DiemConfig_Configuration_$memory;

    // @183 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#183 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @181 := save_mem(DiemConfig::DiemConfig<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+1
    $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181 := $1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory;

    // @182 := save_mem(DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:35:5+1
    $1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#182 := $1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory;
...
L5:
    ...
    assume {:print "$at(20,1471,1504)"} true;
    assume {:print "$track_abort(33,1):", $t9} $t9 == $t9;
...
L8:
    ...
    assume {:print "$track_local(33,1,2):", $t12} $t12 == $t12;
...
L1:
    ...
    assume {:print "$at(20,1619,1742)"} true;
    assume {:print "$track_abort(33,1):", $t17} $t17 == $t17;
...
L10:
    ...
    // @185 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:47:9+97
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@185](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:47:9+97
...
L2:
    ...
    // assert Not(Not(exists[@179]<Roles::RoleId>($t5))) at /home/ying/diem/language/diem-framework/modules/Roles.move:526:9+59
    assume {:print "$at(26,23574,23633)"} true;
    assert {:msg "assert_failed(26,23574,23633): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#179, $t5);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@179]<Roles::RoleId>($t5)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:527:9+87
    assume {:print "$at(26,23642,23729)"} true;
    assert {:msg "assert_failed(26,23642,23729): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#179, $t5)), 0);
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@180]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:160:9+53
    assume {:print "$at(17,6375,6428)"} true;
    assert {:msg "assert_failed(17,6375,6428): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180);

    // assert Not(Ge(select DiemVersion::DiemVersion.major(DiemConfig::$get[@181]<DiemVersion::DiemVersion>()), $t1)) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:57:9+86
    assume {:print "$at(20,2090,2176)"} true;
    assert {:msg "assert_failed(20,2090,2176): function does not abort under this condition"}
      !($major#$1_DiemVersion_DiemVersion($1_DiemConfig_$get'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181)) >= $t1);

    // assert Not(Not(exists[@182]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:137:9+129
    assume {:print "$at(13,5441,5570)"} true;
    assert {:msg "assert_failed(13,5441,5570): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#182, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@181]<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(a550c18))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:101:9+76
    assume {:print "$at(13,3859,3935)"} true;
    assert {:msg "assert_failed(13,3859,3935): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181, 173345816);

    // assert Not(And(And(And(And(DiemTimestamp::$is_operating[@180](), DiemConfig::$reconfiguration_enabled[@183]()), Gt(DiemTimestamp::spec_now_microseconds[@180](), 0)), Lt(select DiemConfig::Configuration.epoch($t6), 18446744073709551615)), Lt($t7, select DiemConfig::Configuration.last_reconfiguration_time($t6)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:359:9+283
    assume {:print "$at(13,15496,15779)"} true;
    assert {:msg "assert_failed(13,15496,15779): function does not abort under this condition"}
      !(((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#183)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) > 0)) && ($epoch#$1_DiemConfig_Configuration($t6) < 18446744073709551615)) && ($t7 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t6)));
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@184](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:144:9+52
    assume {:print "$at(13,5734,5786)"} true;
    assert {:msg "assert_failed(13,5734,5786): post-condition does not hold"}
...
L3:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Not(exists[@179]<Roles::RoleId>($t5)), Neq<u64>(select Roles::RoleId.role_id(global[@179]<Roles::RoleId>($t5)), 0)), Neq<address>(Signer::spec_address_of[]($t0), a550c18)), Not(DiemTimestamp::$is_operating[@180]())), Ge(select DiemVersion::DiemVersion.major(DiemConfig::$get[@181]<DiemVersion::DiemVersion>()), $t1)), Not(exists[@182]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0)))), Not(exists[@181]<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(a550c18))), And(And(And(And(DiemTimestamp::$is_operating[@180](), DiemConfig::$reconfiguration_enabled[@183]()), Gt(DiemTimestamp::spec_now_microseconds[@180](), 0)), Lt(select DiemConfig::Configuration.epoch($t6), 18446744073709551615)), Lt($t7, select DiemConfig::Configuration.last_reconfiguration_time($t6)))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:52:5+480
    assume {:print "$at(20,1862,2342)"} true;
    assert {:msg "assert_failed(20,1862,2342): abort not covered by any of the `aborts_if` clauses"}
      (((((((!$ResourceExists($1_Roles_RoleId_$memory#179, $t5) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#179, $t5)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816)) || !$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180)) || ($major#$1_DiemVersion_DiemVersion($1_DiemConfig_$get'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181)) >= $t1)) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#182, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181, 173345816)) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#183)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) > 0)) && ($epoch#$1_DiemConfig_Configuration($t6) < 18446744073709551615)) && ($t7 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t6))));

    // assert Or(Or(Or(Or(Or(Or(Or(And(Not(exists[@179]<Roles::RoleId>($t5)), Eq(5, $t9)), And(Neq<u64>(select Roles::RoleId.role_id(global[@179]<Roles::RoleId>($t5)), 0), Eq(3, $t9))), And(Neq<address>(Signer::spec_address_of[]($t0), a550c18), Eq(2, $t9))), And(Not(DiemTimestamp::$is_operating[@180]()), Eq(1, $t9))), And(Ge(select DiemVersion::DiemVersion.major(DiemConfig::$get[@181]<DiemVersion::DiemVersion>()), $t1), Eq(7, $t9))), And(Not(exists[@182]<DiemConfig::ModifyConfigCapability<DiemVersion::DiemVersion>>(Signer::spec_address_of[]($t0))), Eq(4, $t9))), And(Not(exists[@181]<DiemConfig::DiemConfig<DiemVersion::DiemVersion>>(a550c18)), Eq(5, $t9))), And(And(And(And(And(DiemTimestamp::$is_operating[@180](), DiemConfig::$reconfiguration_enabled[@183]()), Gt(DiemTimestamp::spec_now_microseconds[@180](), 0)), Lt(select DiemConfig::Configuration.epoch($t6), 18446744073709551615)), Lt($t7, select DiemConfig::Configuration.last_reconfiguration_time($t6))), Eq(1, $t9))) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:52:5+480
    assert {:msg "assert_failed(20,1862,2342): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((((((!$ResourceExists($1_Roles_RoleId_$memory#179, $t5) && $IsEqual'u8'(5, $t9)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#179, $t5)), 0) && $IsEqual'u8'(3, $t9))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), 173345816) && $IsEqual'u8'(2, $t9))) || (!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) && $IsEqual'u8'(1, $t9))) || (($major#$1_DiemVersion_DiemVersion($1_DiemConfig_$get'$1_DiemVersion_DiemVersion'($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181)) >= $t1) && $IsEqual'u8'(7, $t9))) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'_$memory#182, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t9))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory#181, 173345816) && $IsEqual'u8'(5, $t9))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#183)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#180) > 0)) && ($epoch#$1_DiemConfig_Configuration($t6) < 18446744073709551615)) && ($t7 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t6))) && $IsEqual'u8'(1, $t9)));

    // abort($t9) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:52:5+480
    $abort_code := $t9;
    $abort_flag := true;
    return;
