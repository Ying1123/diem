...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 218925) (let ((anon24_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 159573) (- 0 219582)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 159573) (- 0 219597)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 159573) (- 0 219607)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 159573) (- 0 219621)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816)) (and (=> (= (ControlFlow 0 159573) (- 0 219629)) (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory@1) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory@1) 173345816) (=> (= (ControlFlow 0 159573) (- 0 219635)) (= (|$height#$1_DiemBlock_BlockMetadata| (|Select__T@[Int]$1_DiemBlock_BlockMetadata_| (|contents#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory@1) 173345816)) 0)))))))))))))))
(let ((anon22_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 159377) (- 0 219508)) (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (=> (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816)) (=> (= (ControlFlow 0 159377) (- 0 219529)) (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t4@0)) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t4@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) 173345816) (= 6 $t4@0))))))))
(let ((anon24_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t4@0 $abort_code@1) (= (ControlFlow 0 159587) 159377))) L3_correct)))
(let ((anon23_Then$1_correct  (=> (= $1_DiemBlock_BlockMetadata_$memory@1 $1_DiemBlock_BlockMetadata_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 159639) 159587) anon24_Then_correct) (=> (= (ControlFlow 0 159639) 159573) anon24_Else_correct))))))
(let ((anon23_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 159637) 159639)) anon23_Then$1_correct)))
(let ((anon23_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_DiemBlock_BlockMetadata_$memory@0 ($Memory_102007 (|Store__T@[Int]Bool_| (|domain#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemBlock_BlockMetadata_| (|contents#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) (|$addr#$signer| _$t0) $t12@0))) (= $1_DiemBlock_BlockMetadata_$memory@1 $1_DiemBlock_BlockMetadata_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 159503) 159587) anon24_Then_correct) (=> (= (ControlFlow 0 159503) 159573) anon24_Else_correct))))))
(let ((anon22_Else_correct  (=> (and (not false) (= $t12@0 ($1_DiemBlock_BlockMetadata 0 |inline$$1_Event_new_event_handle'$1_DiemBlock_NewBlockEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 159481) 159637) anon23_Then_correct) (=> (= (ControlFlow 0 159481) 159503) anon23_Else_correct)))))
(let ((|inline$$1_Event_new_event_handle'$1_DiemBlock_NewBlockEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemBlock_NewBlockEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemBlock_NewBlockEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 159457) 159653) anon22_Then_correct) (=> (= (ControlFlow 0 159457) 159481) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 159463) 159457)) |inline$$1_Event_new_event_handle'$1_DiemBlock_NewBlockEvent'$0$anon0_correct|))))
(let ((anon21_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t9 $t9)) (and (= $t4@0 $t9) (= (ControlFlow 0 159297) 159377))) L3_correct)))
(let ((anon20_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t9) (= $t9 6)) (and (= $t9 $t9) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 159281) 159463) anon21_Then_correct) (=> (= (ControlFlow 0 159281) 159297) anon21_Else_correct))))))
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemBlock_BlockMetadata_| (|contents#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) $a_0@@0)))
(|$IsValid'$1_DiemBlock_BlockMetadata'| $rsc@@0))
 :qid |DiemBlockbpl.12883:20|
 :skolemid |231|
 :pattern ( (|Select__T@[Int]$1_DiemBlock_BlockMetadata_| (|contents#$Memory_102007| $1_DiemBlock_BlockMetadata_$memory) $a_0@@0))
))) (and (= _$t0 _$t0) (= $t3  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100554| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 159092) 159723) anon18_Then_correct) (=> (= (ControlFlow 0 159092) 159114) anon18_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_65564_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemBlockbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 158958) 159092)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 218925) 158958) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))
))
(check-sat)
(pop 1)
