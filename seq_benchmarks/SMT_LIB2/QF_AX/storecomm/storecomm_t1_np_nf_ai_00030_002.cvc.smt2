...
(assert (not (= i1 i3)))
(assert (not (= i1 i2)))
(assert (not (= (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store a1 i1 e1) i2 e2) i3 e3) i4 e4) i5 e5) i6 e6) i7 e7) i8 e8) i9 e9) i10 e10) i11 e11) i12 e12) i13 e13) i14 e14) i15 e15) i16 e16) i17 e17) i18 e18) i19 e19) i20 e20) i21 e21) i22 e22) i23 e23) i24 e24) i25 e25) i26 e26) i27 e27) i28 e28) i29 e29) i30 e30) (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store a1 i9 e9) i15 e15) i24 e24) i8 e8) i6 e6) i12 e12) i19 e19) i2 e2) i4 e4) i28 e28) i3 e3) i26 e26) i17 e17) i29 e29) i20 e20) i23 e23) i21 e21) i18 e18) i22 e22) i14 e14) i27 e27) i10 e10) i5 e5) i16 e16) i13 e13) i25 e25) i30 e30) i1 e1) i7 e7) i11 e11))))
(check-sat)
(exit)
