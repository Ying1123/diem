...
L8:
    ...
    // @146 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@146](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:100:19+208
...
L7:
    ...
    // @180 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@180](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:25:9+134
...
L6:
    ...
    // @152 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@152](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:59:9+35
...
L7:
    ...
    // @170 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@170](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:43:9+186
...
L2:
    ...
    // trace_local[account#1843]($t17) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:955:13+7
...
function {:inline} $IsEqual'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'(s1: $1_SharedEd25519PublicKey_SharedEd25519PublicKey, s2: $1_SharedEd25519PublicKey_SharedEd25519PublicKey): bool {
    $IsEqual'vec'u8''($key#$1_SharedEd25519PublicKey_SharedEd25519PublicKey(s1), $key#$1_SharedEd25519PublicKey_SharedEd25519PublicKey(s2))
    && $IsEqual'$1_DiemAccount_KeyRotationCapability'($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey(s1), $rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey(s2))}
...
procedure {:timeLimit 40} $1_SharedEd25519PublicKey_publish$verify(_$t0: int, _$t1: Vec (int)) returns ()
{
    ...
    assume {:print "$at(27,1433,1808)"} true;
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<Roles::RoleId>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:30:5+375
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:30:5+375
    ...
    // assume true at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:30:5+375
    ...
    assume {:print "$at(27,1991,2035)"} true;
    assume ($t5 == $1_Signer_spec_address_of($t0));

    // assume Identical($t6, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:964:9+52
    assume {:print "$at(11,43085,43137)"} true;
    assume ($t6 == $1_Signer_spec_address_of($t0));
    ...
    assume {:print "$at(27,2531,2575)"} true;
    assume ($t7 == $1_Signer_spec_address_of($t0));

    // @141 := save_mem(DiemAccount::DiemAccount) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:30:5+1
    assume {:print "$at(27,1433,1434)"} true;
    $1_DiemAccount_DiemAccount_$memory#141 := $1_DiemAccount_DiemAccount_$memory;

    // @140 := save_mem(SharedEd25519PublicKey::SharedEd25519PublicKey) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:30:5+1
    ...
    assume {:print "$at(27,1547,1550)"} true;
    $t8 := $EmptyVec'u8'();
    assume $IsValid'vec'u8''($t8);

    // assume Identical($t9, Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:964:9+52
    assume {:print "$at(11,43085,43137)"} true;
    assume ($t9 == $1_Signer_spec_address_of($t0));
    ...
    assume {:print "$at(27,1578,1631)"} true;
    ...
    // $t2 := pack SharedEd25519PublicKey::SharedEd25519PublicKey($t8, $t10) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:31:17+136
    assume {:print "$at(27,1505,1641)"} true;
    $t2 := $1_SharedEd25519PublicKey_SharedEd25519PublicKey($t8, $t10);

    // trace_local[t]($t2) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:31:13+1
    assume {:print "$track_local(32,2,2):", $t2} $t2 == $t2;

    // $t12 := borrow_local($t2) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:35:21+6
    assume {:print "$at(27,1663,1669)"} true;
    ...
    if ($abort_flag) {
        assume {:print "$at(27,1651,1675)"} true;
        $t11 := $abort_code;
        assume {:print "$track_abort(32,2):", $t11} $t11 == $t11;
        goto L3;
    }

    // write_back[LocalRoot($t2)@]($t12) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:35:9+24
    $t2 := $Dereference($t12);

    // nop at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:36:27+27
    // >> opaque call: $t8 := Signer::address_of($t0)
    assume {:print "$at(27,1703,1730)"} true;
    ...
    if ($abort_flag) {
        assume {:print "$at(27,1693,1731)"} true;
        $t11 := $abort_code;
        assume {:print "$track_abort(32,2):", $t11} $t11 == $t11;
        goto L3;
    }
    ...
    // trace_local[tmp#$4]($t17) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:36:9+87
    assume {:print "$track_local(32,2,4):", $t17} $t17 == $t17;

    // trace_local[tmp#$3]($t15) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:36:9+87
...
L1:
    ...
    assume {:print "$at(27,1685,1772)"} true;
    ...
    assume {:print "$at(27,1790,1797)"} true;
L0:

    // $t18 := move($t2) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:37:26+1
    $t18 := $t2;

    // @233 := save_mem(SharedEd25519PublicKey::SharedEd25519PublicKey) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:30:5+375
    ...
    assume {:print "$at(27,1782,1789)"} true;
    ...
    // assert forall addr: TypeDomain<address>() where exists[@233]<SharedEd25519PublicKey::SharedEd25519PublicKey>(addr): exists<SharedEd25519PublicKey::SharedEd25519PublicKey>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:145:9+136
    // global invariant at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:145:9+136
    assume {:print "$at(27,6066,6202)"} true;
    assert {:msg "assert_failed(27,6066,6202): global memory invariant does not hold"}
    ...
    assume {:print "$at(27,1807,1808)"} true;
L2:

    // assert Not(SharedEd25519PublicKey::$exists_at[@140]($t5)) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:55:9+57
    assume {:print "$at(27,2376,2433)"} true;
    assert {:msg "assert_failed(27,2376,2433): function does not abort under this condition"}
      !$1_SharedEd25519PublicKey_$exists_at($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#140, $t5);

    // assert Not(Not(DiemAccount::$exists_at[@141]($t6))) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:965:9+62
    ...
    // assert Not(DiemAccount::$delegated_key_rotation_capability[@141](Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:970:9+105
    ...
    // assert Not(Neq<num>(Len<u8>(Authenticator::spec_ed25519_authentication_key[]($t1)), 32)) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:929:9+74
    ...
    assume {:print "$at(27,2585,2609)"} true;
    assert {:msg "assert_failed(27,2585,2609): post-condition does not hold"}
    ...
    assume {:print "$at(27,3908,3949)"} true;
    assert {:msg "assert_failed(27,3908,3949): post-condition does not hold"}
...
L3:
    ...
    assume {:print "$at(27,1813,1898)"} true;
    assert {:msg "assert_failed(27,1813,1898): abort not covered by any of the `aborts_if` clauses"}
    ...
    assert {:msg "assert_failed(27,1813,1898): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((($1_SharedEd25519PublicKey_$exists_at($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#140, $t5) && $IsEqual'num'(6, $t11)) || (!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#141, $t6) && $IsEqual'num'(5, $t11))) || ($1_DiemAccount_$delegated_key_rotation_capability($1_DiemAccount_DiemAccount_$memory#141, $1_Signer_spec_address_of($t0)) && $IsEqual'num'(1, $t11))) || (!$1_Signature_$ed25519_validate_pubkey($t1) && $IsEqual'num'(7, $t11))) || (!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#141, $account_address#$1_DiemAccount_KeyRotationCapability($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($1_SharedEd25519PublicKey_SharedEd25519PublicKey($EmptyVec'u8'(), $1_DiemAccount_spec_get_key_rotation_cap($1_DiemAccount_DiemAccount_$memory#141, $t5))))) && $IsEqual'num'(5, $t11))) || (!$IsEqual'num'(LenVec($1_Authenticator_spec_ed25519_authentication_key($t1)), 32) && $IsEqual'num'(7, $t11)));
...
procedure {:inline 1} $1_SharedEd25519PublicKey_exists_at(_$t0: int) returns ($ret0: bool)
{
    ...
    assume {:print "$at(27,5758,5759)"} true;
    ...
    assume {:print "$at(27,5810,5816)"} true;
    ...
    assume {:print "$at(27,5851,5852)"} true;
L1:
...
procedure {:timeLimit 40} $1_SharedEd25519PublicKey_exists_at$verify(_$t0: int) returns ($ret0: bool)
{
    ...
    assume {:print "$at(27,5758,5852)"} true;
    assume $IsValid'address'($t0);
...
procedure {:timeLimit 40} $1_SharedEd25519PublicKey_key$verify(_$t0: int) returns ($ret0: Vec (int))
{
    ...
    assume {:print "$at(27,5470,5678)"} true;
    assume $IsValid'address'($t0);
    ...
    assume {:print "$at(27,5561,5576)"} true;
...
L1:
    ...
    assume {:print "$at(27,5554,5613)"} true;
    ...
    assume {:print "$at(27,5663,5667)"} true;
L0:
    ...
    if ($abort_flag) {
        assume {:print "$at(27,5625,5638)"} true;
        $t4 := $abort_code;
        assume {:print "$track_abort(32,1):", $t4} $t4 == $t4;
        goto L3;
    }
    ...
    assume {:print "$at(27,5677,5678)"} true;
L2:
...
procedure {:timeLimit 40} $1_SharedEd25519PublicKey_rotate_key$verify(_$t0: int, _$t1: Vec (int)) returns ()
{
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2203:9+147
    assume {:print "$at(27,4383,4693)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> (($1_DiemAccount_$delegated_key_rotation_capability($1_DiemAccount_DiemAccount_$memory, addr) || $1_DiemAccount_spec_holds_own_key_rotation_cap($1_DiemAccount_DiemAccount_$memory, addr))));
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<Roles::RoleId>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:103:5+310
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2305:9+82
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> ($ResourceExists($1_Roles_RoleId_$memory, addr)));

    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:103:5+310
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2324:9+97
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory, addr)));

    // assume true at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:103:5+310
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2327:9+115
    assume true;
    ...
    assume {:print "$at(27,4896,4940)"} true;
    assume ($t5 == $1_Signer_spec_address_of($t0));
    ...
    assume {:print "$at(27,5201,5245)"} true;
    assume ($t6 == $1_Signer_spec_address_of($t0));

    // @111 := save_mem(DiemAccount::DiemAccount) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:103:5+1
    assume {:print "$at(27,4383,4384)"} true;
    $1_DiemAccount_DiemAccount_$memory#111 := $1_DiemAccount_DiemAccount_$memory;

    // @110 := save_mem(SharedEd25519PublicKey::SharedEd25519PublicKey) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:103:5+1
    ...
    assume {:print "$at(27,4504,4531)"} true;
    ...
    assume {:print "$track_local(32,3,2):", $t7} $t7 == $t7;
    ...
    assume {:print "$at(27,4548,4563)"} true;
    ...
    // trace_local[tmp#$4]($t11) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:9+59
    assume {:print "$track_local(32,3,4):", $t11} $t11 == $t11;

    // trace_local[tmp#$3]($t8) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:105:9+59
    assume {:print "$track_local(32,3,3):", $t8} $t8 == $t8;
...
L1:
    ...
    assume {:print "$at(27,4541,4600)"} true;
    ...
    assume {:print "$at(27,4664,4668)"} true;
L0:
    ...
    if ($abort_flag) {
        assume {:print "$at(27,4622,4639)"} true;
        $t9 := $abort_code;
        assume {:print "$track_abort(32,3):", $t9} $t9 == $t9;
        goto L3;
    }
    ...
    call $t12 := $1_SharedEd25519PublicKey_rotate_key_($t12, $t1);
    if ($abort_flag) {
        assume {:print "$at(27,4610,4686)"} true;
        $t9 := $abort_code;
        assume {:print "$track_abort(32,3):", $t9} $t9 == $t9;
        goto L3;
    }

    // @232 := save_mem(SharedEd25519PublicKey::SharedEd25519PublicKey) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:103:5+310
    // state save for global update invariants
    assume {:print "$at(27,4383,4693)"} true;
    ...
    // assert forall addr: TypeDomain<address>() where exists[@232]<SharedEd25519PublicKey::SharedEd25519PublicKey>(addr): exists<SharedEd25519PublicKey::SharedEd25519PublicKey>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:145:9+136
    // global invariant at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:145:9+136
    assume {:print "$at(27,6066,6202)"} true;
    assert {:msg "assert_failed(27,6066,6202): global memory invariant does not hold"}
    ...
    assume {:print "$at(27,4692,4693)"} true;
L2:

    // assert Not(Not(SharedEd25519PublicKey::$exists_at[@110]($t5))) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:116:9+54
    assume {:print "$at(27,4949,5003)"} true;
    assert {:msg "assert_failed(27,4949,5003): function does not abort under this condition"}
    ...
    // assert Not(Not(DiemAccount::$exists_at[@111](select DiemAccount::KeyRotationCapability.account_address(select SharedEd25519PublicKey::SharedEd25519PublicKey.rotation_cap(global[@110]<SharedEd25519PublicKey::SharedEd25519PublicKey>($t5)))))) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:928:9+69
    assume {:print "$at(11,41306,41375)"} true;
    assert {:msg "assert_failed(11,41306,41375): function does not abort under this condition"}
...
L3:
    ...
    assume {:print "$at(27,4698,4790)"} true;
    assert {:msg "assert_failed(27,4698,4790): abort not covered by any of the `aborts_if` clauses"}
    ...
    assert {:msg "assert_failed(27,4698,4790): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      ((((!$1_SharedEd25519PublicKey_$exists_at($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#110, $t5) && $IsEqual'num'(5, $t9)) || (!$1_Signature_$ed25519_validate_pubkey($t1) && $IsEqual'num'(7, $t9))) || (!$1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory#111, $account_address#$1_DiemAccount_KeyRotationCapability($rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey($ResourceValue($1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory#110, $t5)))) && $IsEqual'num'(5, $t9))) || (!$IsEqual'num'(LenVec($1_Authenticator_spec_ed25519_authentication_key($t1)), 32) && $IsEqual'num'(7, $t9)));
...
procedure {:inline 1} $1_SharedEd25519PublicKey_rotate_key_(_$t0: $Mutation ($1_SharedEd25519PublicKey_SharedEd25519PublicKey), _$t1: Vec (int)) returns ($ret0: $Mutation ($1_SharedEd25519PublicKey_SharedEd25519PublicKey))
{
    ...
    assume {:print "$at(27,2729,2730)"} true;
    ...
    assume {:print "$at(27,2898,2953)"} true;
    ...
    assume {:print "$at(27,2992,3013)"} true;
    $t6 := 0;
    assume $IsValid'u64'($t6);
    ...
    assume {:print "$at(27,2878,3024)"} true;
...
L1:
    ...
    assume {:print "$at(27,3087,3097)"} true;
L0:
    ...
    assume {:print "$at(27,3124,3186)"} true;
    ...
    assume {:print "$at(27,3034,3196)"} true;
    ...
    assume {:print "$at(27,3206,3220)"} true;
    ...
    assume {:print "$at(27,3243,3244)"} true;
L2:
...
procedure {:timeLimit 40} $1_SharedEd25519PublicKey_rotate_key_$verify(_$t0: $Mutation ($1_SharedEd25519PublicKey_SharedEd25519PublicKey), _$t1: Vec (int)) returns ($ret0: $Mutation ($1_SharedEd25519PublicKey_SharedEd25519PublicKey))
{
    ...
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2203:9+147
    assume {:print "$at(27,2729,3244)"} true;
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> (($1_DiemAccount_$delegated_key_rotation_capability($1_DiemAccount_DiemAccount_$memory, addr) || $1_DiemAccount_spec_holds_own_key_rotation_cap($1_DiemAccount_DiemAccount_$memory, addr))));
    ...
    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<Roles::RoleId>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:66:5+515
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2305:9+82
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> ($ResourceExists($1_Roles_RoleId_$memory, addr)));

    // assume forall addr: TypeDomain<address>() where DiemAccount::$exists_at(addr): exists<AccountFreezing::FreezingBit>(addr) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:66:5+515
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2324:9+97
    assume (forall addr: int :: $IsValid'address'(addr) ==> ($1_DiemAccount_$exists_at($1_DiemAccount_DiemAccount_$memory, addr))  ==> ($ResourceExists($1_AccountFreezing_FreezingBit_$memory, addr)));

    // assume true at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:66:5+515
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:2327:9+115
    assume true;
    ...
    // @105 := save_mem(DiemAccount::DiemAccount) at /home/ying/diem/language/diem-framework/modules/SharedEd25519PublicKey.move:66:5+1
...
L2:
    ...
    // assert Not(Not(DiemAccount::$exists_at[@105](select DiemAccount::KeyRotationCapability.account_address(select SharedEd25519PublicKey::SharedEd25519PublicKey.rotation_cap($t4))))) at /home/ying/diem/language/diem-framework/modules/DiemAccount.move:928:9+69
    assume {:print "$at(11,41306,41375)"} true;
    assert {:msg "assert_failed(11,41306,41375): function does not abort under this condition"}
...
L3:
    ...
    assume {:print "$at(27,3249,3344)"} true;
    assert {:msg "assert_failed(27,3249,3344): abort not covered by any of the `aborts_if` clauses"}
    ...
    assert {:msg "assert_failed(27,3249,3344): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
...
procedure {:inline 1} $1_DiemBlock_is_initialized() returns ($ret0: bool)
{
    ...
    assume {:print "$track_return(33,3,0):", $t1} $t1 == $t1;
...
L7:
    ...
    // @164 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@164](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:97:9+283
...
L7:
    ...
    // @158 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@158](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:20:9+130
...
procedure {:timeLimit 40} $1_Genesis_initialize$verify(_$t0: int, _$t1: int, _$t2: Vec (int), _$t3: Vec (int), _$t4: Vec (Vec (int)), _$t5: bool, _$t6: Vec (int), _$t7: Vec (int), _$t8: int, _$t9: int) returns ()
{
    ...
    // trace_local[dr_account#2066]($t0) at /home/ying/diem/language/diem-framework/modules/Genesis.move:40:13+10
    assume {:print "$at(22,1422,1432)"} true;
    assume {:print "$track_local(36,1,10):", $t0} $t0 == $t0;

    // trace_local[tc_account#2067]($t1) at /home/ying/diem/language/diem-framework/modules/Genesis.move:41:13+10
