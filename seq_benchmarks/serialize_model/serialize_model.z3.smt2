...
(assert (forall ((v@@6 |T@#0|) ) (! (let ((r@@0 (|$1_BCS_serialize'#0'| v@@6)))
 ...
 :qid |serializemodelz3bpl.874:15|
 :skolemid |25|
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10372) (let ((anon7_Else_correct  (=> (and (and (not false) (= call1formal@res@0 call1formal@res@0)) (and (= call1formal@res@0@@0 call1formal@res@0@@0) (= call1formal@res@0 call1formal@res@0))) (and (=> (= (ControlFlow 0 9949) (- 0 10572)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 9949) (- 0 10579)) (= call1formal@res@0@@0 call1formal@res@0)) (=> (= call1formal@res@0@@0 call1formal@res@0) (=> (= (ControlFlow 0 9949) (- 0 10586)) (> (seq.len call1formal@res@0@@0) 0)))))))))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (not false) (=> (and (= call1formal@res@0@@0 call1formal@res@0@@0) (= call1formal@res@0 (|$1_BCS_serialize'#0'| _$t1))) (and (=> (= (ControlFlow 0 9893) 9963) anon7_Then_correct) (=> (= (ControlFlow 0 9893) 9949) anon7_Else_correct))))))
(let ((anon6_Then_correct true))
(let ((anon0$1_correct  (=> (= _$t0 _$t0) (=> (and (= _$t1 _$t1) (= call1formal@res@0@@0 (|$1_BCS_serialize'#0'| _$t0))) (and (=> (= (ControlFlow 0 9879) 9987) anon6_Then_correct) (=> (= (ControlFlow 0 9879) 9893) anon6_Else_correct))))))
(let ((anon0_correct  (=> (= (ControlFlow 0 10372) 9879) anon0$1_correct)))
anon0_correct)))))))
))
(check-sat)
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 10372)))
(get-value ((ControlFlow 0 9879)))
(get-value ((ControlFlow 0 9893)))
(get-value ((ControlFlow 0 9949)))
(assert (not (= (ControlFlow 0 9949) (- 10579))))
(check-sat)
(pop 1)
; Invalid
