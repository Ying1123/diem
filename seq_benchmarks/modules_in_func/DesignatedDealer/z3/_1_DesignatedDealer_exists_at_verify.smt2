...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 289554) (let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) $a_0)))
(|$IsValid'$1_DesignatedDealer_Dealer'| $rsc))
 :qid |DesignatedDealerbpl.12585:20|
 :skolemid |272|
 :pattern ( (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 211065) (- 0 289647)) (not false)) (=> (not false) (=> (= (ControlFlow 0 211065) (- 0 289654)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_150885| $1_DesignatedDealer_Dealer_$memory) _$t0)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_87373_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DesignatedDealerbpl.2908:13|
 :skolemid |79|
))) (= (ControlFlow 0 210981) 211065)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 289554) 210981) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
