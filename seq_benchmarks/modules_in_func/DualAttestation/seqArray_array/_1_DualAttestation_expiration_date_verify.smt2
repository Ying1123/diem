...
(assert (not
 (=> (= (ControlFlow 0 0) 307992) (let ((anon12_Else_correct@@4  (=> (not $abort_flag@0@@5) (=> (and (= $t8@0@@6 (|$expiration_date#$1_DualAttestation_Credential| $t7@1@@2)) (= $t8@0@@6 $t8@0@@6)) (and (=> (= (ControlFlow 0 228884) (- 0 308342)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@14)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@14))) (=> (= (ControlFlow 0 228884) (- 0 308353)) (= $t8@0@@6 (|$expiration_date#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@14))))))))))
(let ((L3_correct@@4  (and (=> (= (ControlFlow 0 228818) (- 0 308295)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@14))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@14)) (=> (= (ControlFlow 0 228818) (- 0 308301)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@14)) (= 5 $t6@0@@3)))))))
(let ((anon12_Then_correct@@4  (=> (and (and $abort_flag@0@@5 (= $abort_code@1@@5 $abort_code@1@@5)) (and (= $t6@0@@3 $abort_code@1@@5) (= (ControlFlow 0 228898) 228818))) L3_correct@@4)))
(let ((anon11_Then$1_correct@@3  (=> (= $t7@1@@2 $t7@@5) (=> (and (= $abort_flag@0@@5 true) (= $abort_code@1@@5 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 228950) 228898) anon12_Then_correct@@4) (=> (= (ControlFlow 0 228950) 228884) anon12_Else_correct@@4))))))
(let ((anon11_Then_correct@@3  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@14)) (= (ControlFlow 0 228948) 228950)) anon11_Then$1_correct@@3)))
(let ((anon11_Else_correct@@3  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@14) (=> (and (and (= $t7@0@@3 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@14)) (= $t7@1@@2 $t7@0@@3)) (and (= $abort_flag@0@@5 false) (= $abort_code@1@@5 $abort_code@0@@5))) (and (=> (= (ControlFlow 0 228836) 228898) anon12_Then_correct@@4) (=> (= (ControlFlow 0 228836) 228884) anon12_Else_correct@@4))))))
(let ((anon10_Then_correct@@3  (=> $t3@0@@6 (and (=> (= (ControlFlow 0 228822) 228948) anon11_Then_correct@@3) (=> (= (ControlFlow 0 228822) 228836) anon11_Else_correct@@3)))))
(let ((anon10_Else_correct@@3  (=> (and (and (not $t3@0@@6) (= $t5@@4 $t5@@4)) (and (= $t6@0@@3 $t5@@4) (= (ControlFlow 0 228786) 228818))) L3_correct@@4)))
(let ((anon0$1_correct@@14  (=> (forall ((addr1@@9 Int) ) (!  (=> (|$IsValid'address'| addr1@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr1@@9) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@9)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@9)) 2)))))
 :qid |DualAttestationbpl.15069:20|
 :skolemid |337|
)) (=> (and (forall ((addr@@87 Int) ) (!  (=> (|$IsValid'address'| addr@@87) (= (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr@@87)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@87) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@87)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@87) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@87)) 5)))))
 :qid |DualAttestationbpl.15073:20|
 :skolemid |338|
)) (|$IsValid'address'| _$t0@@14)) (=> (and (and (and (forall (($a_0@@39 Int) ) (! (let (($rsc@@39 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0@@39)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@39))
 :qid |DualAttestationbpl.15080:20|
 :skolemid |339|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0@@39))
)) (= _$t0@@14 _$t0@@14)) (and (= $t3@0@@6 (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0@@14)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5@@4) (= $t5@@4 5)) (and (= $t5@@4 $t5@@4) (= $t3@0@@6 $t3@0@@6)))) (and (=> (= (ControlFlow 0 228770) 228822) anon10_Then_correct@@3) (=> (= (ControlFlow 0 228770) 228786) anon10_Else_correct@@3)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@14  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@16 T@$1_Event_EventHandle) ) (! (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@16)))
 (and (= (|l#Multiset_86488| stream@@15) 0) (forall ((v@@58 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@15) v@@58) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 228620) 228770)) anon0$1_correct@@14)))
(let ((anon0_correct@@14  (=> (= (ControlFlow 0 307992) 228620) inline$$InitEventStore$0$anon0_correct@@14)))
anon0_correct@@14))))))))))))
))
(check-sat)
(pop 1)
