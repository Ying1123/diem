...
L5:
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assert Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:219:9+90
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:219:9+90
    assume {:print "$at(19,9515,9605)"} true;
    assert {:msg "assert_failed(19,9515,9605): global memory invariant does not hold"}
...
// fun DiemVMConfig::initialize [verification] at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1150
procedure {:timeLimit 40} $1_DiemVMConfig_initialize$verify(_$t0: int, _$t1: Vec (int), _$t2: Vec (int)) returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1150
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(19,3416,4566)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1150
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1150
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:219:9+90
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1150
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1150
    assume $IsValid'vec'u8''($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1150
    assume $IsValid'vec'u8''($t2);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1150
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1150
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1150
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1150
    ...
    // @152 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1
    assume {:print "$at(19,3416,3417)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#152 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @151 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1
    $1_Roles_RoleId_$memory#151 := $1_Roles_RoleId_$memory;

    // @155 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1
    $1_DiemConfig_Configuration_$memory#155 := $1_DiemConfig_Configuration_$memory;

    // @153 := save_mem(DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1
    ...
    // @154 := save_mem(DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:76:5+1
...
L1:
    ...
    // assert Not(Not(exists[@151]<Roles::RoleId>($t5))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    ...
    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t5)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    ...
    // assert Not(Not(DiemTimestamp::$is_genesis[@152]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:142:9+51
    ...
    // assert Not(DiemConfig::spec_is_published[@153]<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:260:9+38
    ...
    // assert Not(exists[@154]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:261:9+86
    ...
    // assert Not(Not(exists[@151]<Roles::RoleId>($t6))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#151, $t6);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t6)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
    ...
    // assert exists<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:267:9+84
    ...
    // assert DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>() at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:145:9+36
    ...
    // assert Eq<DiemVMConfig::DiemVMConfig>(DiemConfig::$get<DiemVMConfig::DiemVMConfig>(), pack DiemVMConfig::DiemVMConfig(pack DiemVMConfig::GasSchedule($t1, $t2, $t4))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:146:9+33
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@155](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:147:9+52
    ...
    // assert Implies(DiemConfig::spec_is_published[@153]<DiemVMConfig::DiemVMConfig>(), Eq<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(global<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS()), global[@153]<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:226:9+237
    assume {:print "$at(19,9782,10019)"} true;
    assert {:msg "assert_failed(19,9782,10019): post-condition does not hold"}
      ($1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#153) ==> $IsEqual'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig''($ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()), $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#153, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())));

    // return () at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:226:9+237
    return;
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Not(exists[@151]<Roles::RoleId>($t5)), Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t5)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Not(DiemTimestamp::$is_genesis[@152]())), DiemConfig::spec_is_published[@153]<DiemVMConfig::DiemVMConfig>()), exists[@154]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0))), Not(exists[@151]<Roles::RoleId>($t6))), Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t6)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:111:5+1132
    assume {:print "$at(19,4571,5703)"} true;
    assert {:msg "assert_failed(19,4571,5703): abort not covered by any of the `aborts_if` clauses"}
      ((((((((!$ResourceExists($1_Roles_RoleId_$memory#151, $t5) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#151, $t5)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#152)) || $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#153)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#154, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#151, $t6)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#151, $t6)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(And(Not(exists[@151]<Roles::RoleId>($t5)), Eq(5, $t8)), And(Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t5)), 0), Eq(3, $t8))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t8))), And(Not(DiemTimestamp::$is_genesis[@152]()), Eq(1, $t8))), DiemConfig::spec_is_published[@153]<DiemVMConfig::DiemVMConfig>()), exists[@154]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0))), And(Not(exists[@151]<Roles::RoleId>($t6)), Eq(5, $t8))), And(Neq<u64>(select Roles::RoleId.role_id(global[@151]<Roles::RoleId>($t6)), 0), Eq(3, $t8))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t8))) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:111:5+1132
    assert {:msg "assert_failed(19,4571,5703): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((((!$ResourceExists($1_Roles_RoleId_$memory#151, $t5) && $IsEqual'u8'(5, $t8)) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#151, $t5)), 0) && $IsEqual'u8'(3, $t8))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t8))) || (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#152) && $IsEqual'u8'(1, $t8))) || $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#153)) || $ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#154, $1_Signer_spec_address_of($t0))) || (!$ResourceExists($1_Roles_RoleId_$memory#151, $t6) && $IsEqual'u8'(5, $t8))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#151, $t6)), 0) && $IsEqual'u8'(3, $t8))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t8)));

    // abort($t8) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:111:5+1132
    $abort_code := $t8;
    $abort_flag := true;
    return;
...
// fun DiemVMConfig::set_gas_constants [verification] at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
procedure {:timeLimit 40} $1_DiemVMConfig_set_gas_constants$verify(_$t0: int, _$t1: int, _$t2: int, _$t3: int, _$t4: int, _$t5: int, _$t6: int, _$t7: int, _$t8: int, _$t9: int, _$t10: int, _$t11: int) returns ()
{
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(19,5709,7730)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:412:9+62
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_has_config($1_DiemConfig_Configuration_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:219:9+90
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory));

    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'u64'($t1);

    // assume WellFormed($t2) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'u64'($t2);

    // assume WellFormed($t3) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'u64'($t3);

    // assume WellFormed($t4) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'u64'($t4);

    // assume WellFormed($t5) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'u64'($t5);

    // assume WellFormed($t6) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'u64'($t6);

    // assume WellFormed($t7) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'u64'($t7);

    // assume WellFormed($t8) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'u64'($t8);

    // assume WellFormed($t9) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'u64'($t9);

    // assume WellFormed($t10) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'u64'($t10);

    // assume WellFormed($t11) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume $IsValid'u64'($t11);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig''($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+2021
    assume (forall $a_0: int :: {$ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory, $a_0);
    ($IsValid'$1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig''($rsc))));
    ...
    // @179 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    ...
    // @180 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    $1_Roles_RoleId_$memory#180 := $1_Roles_RoleId_$memory;

    // @184 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    $1_DiemConfig_Configuration_$memory#184 := $1_DiemConfig_Configuration_$memory;

    // @183 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#183 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @182 := save_mem(DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
    ...
    // @181 := save_mem(DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:141:5+1
...
L12:
    ...
    // @185 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@185](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:181:9+35
...
L4:
    ...
    // assert Not(Not(DiemTimestamp::$is_operating[@179]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:162:9+53
    assume {:print "$at(17,6580,6633)"} true;
    assert {:msg "assert_failed(17,6580,6633): function does not abort under this condition"}
      !!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179);

    // assert Not(Not(exists[@180]<Roles::RoleId>($t19))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#180, $t19);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@180]<Roles::RoleId>($t19)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
    ...
    // assert Not(Not(exists[@181]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:140:9+129
    ...
    // assert Not(Not(exists[@182]<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:104:9+101
    assume {:print "$at(13,3930,4031)"} true;
    assert {:msg "assert_failed(13,3930,4031): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#182, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());
    ...
    // assert Not(Gt($t7, $t8)) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:188:9+88
    assume {:print "$at(19,8060,8148)"} true;
    assert {:msg "assert_failed(19,8060,8148): function does not abort under this condition"}
      !($t7 > $t8);

    // assert Not(Gt($t3, $t6)) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:189:9+96
    assume {:print "$at(19,8157,8253)"} true;
    assert {:msg "assert_failed(19,8157,8253): function does not abort under this condition"}
      !($t3 > $t6);

    // assert DiemConfig::spec_is_published<DiemVMConfig::DiemVMConfig>() at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:191:9+54
    assume {:print "$at(19,8328,8382)"} true;
    assert {:msg "assert_failed(19,8328,8382): post-condition does not hold"}
      $1_DiemConfig_spec_is_published'$1_DiemVMConfig_DiemVMConfig'($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory);
    ...
    assume {:print "$at(19,8391,9300)"} true;
    assert {:msg "assert_failed(19,8391,9300): post-condition does not hold"}
    ...
    // assert Eq<bool>(DiemConfig::spec_has_config[@184](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:211:9+76
    assume {:print "$at(19,9309,9385)"} true;
    assert {:msg "assert_failed(19,9309,9385): post-condition does not hold"}
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:211:9+76
    return;
...
L5:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Not(DiemTimestamp::$is_operating[@179]()), Not(exists[@180]<Roles::RoleId>($t19))), Neq<u64>(select Roles::RoleId.role_id(global[@180]<Roles::RoleId>($t19)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Not(exists[@181]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0)))), Not(exists[@182]<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))), And(And(And(And(DiemTimestamp::$is_operating[@179](), DiemConfig::$reconfiguration_enabled[@183]()), Gt(DiemTimestamp::spec_now_microseconds[@179](), 0)), Lt(select DiemConfig::Configuration.epoch($t20), 18446744073709551615)), Lt($t21, select DiemConfig::Configuration.last_reconfiguration_time($t20)))), Gt($t7, $t8)), Gt($t3, $t6)) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:183:5+1656
    assume {:print "$at(19,7735,9391)"} true;
    assert {:msg "assert_failed(19,7735,9391): abort not covered by any of the `aborts_if` clauses"}
      ((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) || !$ResourceExists($1_Roles_RoleId_$memory#180, $t19)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#180, $t19)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#181, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#182, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#183)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) > 0)) && ($epoch#$1_DiemConfig_Configuration($t20) < 18446744073709551615)) && ($t21 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t20)))) || ($t7 > $t8)) || ($t3 > $t6));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(And(Not(DiemTimestamp::$is_operating[@179]()), Eq(1, $t23)), And(Not(exists[@180]<Roles::RoleId>($t19)), Eq(5, $t23))), And(Neq<u64>(select Roles::RoleId.role_id(global[@180]<Roles::RoleId>($t19)), 0), Eq(3, $t23))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t23))), And(Not(exists[@181]<DiemConfig::ModifyConfigCapability<DiemVMConfig::DiemVMConfig>>(Signer::spec_address_of[]($t0))), Eq(4, $t23))), And(Not(exists[@182]<DiemConfig::DiemConfig<DiemVMConfig::DiemVMConfig>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Eq(5, $t23))), And(And(And(And(And(DiemTimestamp::$is_operating[@179](), DiemConfig::$reconfiguration_enabled[@183]()), Gt(DiemTimestamp::spec_now_microseconds[@179](), 0)), Lt(select DiemConfig::Configuration.epoch($t20), 18446744073709551615)), Lt($t21, select DiemConfig::Configuration.last_reconfiguration_time($t20))), Eq(1, $t23))), And(Gt($t7, $t8), Eq(7, $t23))), And(Gt($t3, $t6), Eq(7, $t23))) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:183:5+1656
    assert {:msg "assert_failed(19,7735,9391): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((((!$1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) && $IsEqual'u8'(1, $t23)) || (!$ResourceExists($1_Roles_RoleId_$memory#180, $t19) && $IsEqual'u8'(5, $t23))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#180, $t19)), 0) && $IsEqual'u8'(3, $t23))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t23))) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig'_$memory#181, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t23))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory#182, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t23))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#183)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#179) > 0)) && ($epoch#$1_DiemConfig_Configuration($t20) < 18446744073709551615)) && ($t21 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t20))) && $IsEqual'u8'(1, $t23))) || (($t7 > $t8) && $IsEqual'u8'(7, $t23))) || (($t3 > $t6) && $IsEqual'u8'(7, $t23)));

    // abort($t23) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:183:5+1656
    $abort_code := $t23;
    $abort_flag := true;
    return;
