...
L5:
    ...
    // assume Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XUS::XUS>()) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountLimits::LimitsDefinition<XUS::XUS>>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:56:5+844
    ...
    // assert Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XUS::XUS>()) at /home/ying/diem/language/diem-framework/modules/XUS.move:60:9+69
    // global invariant at /home/ying/diem/language/diem-framework/modules/XUS.move:60:9+69
    assume {:print "$at(38,2276,2345)"} true;
    assert {:msg "assert_failed(38,2276,2345): global memory invariant does not hold"}
    ...
    // assert Implies(DiemTimestamp::$is_operating(), exists<AccountLimits::LimitsDefinition<XUS::XUS>>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/XUS.move:65:9+137
    // global invariant at /home/ying/diem/language/diem-framework/modules/XUS.move:65:9+137
    assume {:print "$at(38,2622,2759)"} true;
    assert {:msg "assert_failed(38,2622,2759): global memory invariant does not hold"}
      ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));
...
L7:
    ...
    // @172 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@172](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:27:9+134
...
L6:
    ...
    // @144 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@144](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:61:9+35
...
// fun XUS::initialize [verification] at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
procedure {:timeLimit 40} $1_XUS_initialize$verify(_$t0: int, _$t1: int) returns ()
{
    // declare local variables
    var $t2: int;
    var $t3: int;
    ...
    var $t1: int;
    var $temp_0'address': int;
    var $1_Diem_MintCapability'$1_XUS_XUS'_$memory#209: $Memory $1_Diem_MintCapability'$1_XUS_XUS';
    var $1_Roles_RoleId_$memory#210: $Memory $1_Roles_RoleId;
    var $1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#211: $Memory $1_Diem_CurrencyInfo'$1_XUS_XUS';
    var $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212: $Memory $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies';
    var $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#213: $Memory $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies';
    var $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214: $Memory $1_DiemTimestamp_CurrentTimeMicroseconds;
    var $1_DiemConfig_DisableReconfiguration_$memory#215: $Memory $1_DiemConfig_DisableReconfiguration;
    var $1_Diem_BurnCapability'$1_XUS_XUS'_$memory#216: $Memory $1_Diem_BurnCapability'$1_XUS_XUS';
    var $1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory#217: $Memory $1_AccountLimits_LimitsDefinition'$1_XUS_XUS';
    $t0 := _$t0;
    $t1 := _$t1;
    ...
    // bytecode translation starts here
    // assume Implies(DiemTimestamp::$is_operating(), exists<DiemTimestamp::CurrentTimeMicroseconds>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    // global invariant at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:171:9+97
    assume {:print "$at(38,399,994)"} true;
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    ...
    // assume Implies(DiemTimestamp::$is_operating(), DiemConfig::spec_is_published<RegisteredCurrencies::RegisteredCurrencies>()) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    ...
    // assume true at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    // global invariant at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:552:9+318
    assume true;

    // assume Implies(DiemTimestamp::$is_operating(), Diem::$is_currency<XUS::XUS>()) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    // global invariant at /home/ying/diem/language/diem-framework/modules/XUS.move:60:9+69
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $1_Diem_$is_currency'$1_XUS_XUS'($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory));

    // assume Implies(DiemTimestamp::$is_operating(), exists<AccountLimits::LimitsDefinition<XUS::XUS>>(CoreAddresses::$DIEM_ROOT_ADDRESS())) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    // global invariant at /home/ying/diem/language/diem-framework/modules/XUS.move:65:9+137
    assume ($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory) ==> $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()));

    // assume forall addr: TypeDomain<address>() where exists<AccountLimits::LimitsDefinition<XUS::XUS>>(addr): Eq<address>(addr, CoreAddresses::$DIEM_ROOT_ADDRESS()) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    ...
    // assume WellFormed($t0) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    assume $IsValid'address'($t1);

    // assume forall $rsc: ResourceDomain<DiemTimestamp::CurrentTimeMicroseconds>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    assume (forall $a_0: int :: {$ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0)}(var $rsc := $ResourceValue($1_DiemTimestamp_CurrentTimeMicroseconds_$memory, $a_0);
    ($IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'($rsc))));

    // assume forall $rsc: ResourceDomain<Roles::RoleId>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    assume (forall $a_0: int :: {$ResourceValue($1_Roles_RoleId_$memory, $a_0)}(var $rsc := $ResourceValue($1_Roles_RoleId_$memory, $a_0);
    ($IsValid'$1_Roles_RoleId'($rsc))));

    // assume forall $rsc: ResourceDomain<DiemConfig::Configuration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DisableReconfiguration>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    ...
    // assume forall $rsc: ResourceDomain<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    ...
    // assume forall $rsc: ResourceDomain<Diem::BurnCapability<XUS::XUS>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    ...
    // assume forall $rsc: ResourceDomain<Diem::CurrencyInfo<XUS::XUS>>(): And(WellFormed($rsc), And(Lt(0, select Diem::CurrencyInfo.scaling_factor($rsc)), Le(select Diem::CurrencyInfo.scaling_factor($rsc), 10000000000))) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    ...
    // assume forall $rsc: ResourceDomain<Diem::MintCapability<XUS::XUS>>(): WellFormed($rsc) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+595
    ...
    // @214 := save_mem(DiemTimestamp::CurrentTimeMicroseconds) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+1
    assume {:print "$at(38,399,400)"} true;
    $1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214 := $1_DiemTimestamp_CurrentTimeMicroseconds_$memory;

    // @210 := save_mem(Roles::RoleId) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+1
    $1_Roles_RoleId_$memory#210 := $1_Roles_RoleId_$memory;

    // @215 := save_mem(DiemConfig::DisableReconfiguration) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+1
    $1_DiemConfig_DisableReconfiguration_$memory#215 := $1_DiemConfig_DisableReconfiguration_$memory;

    // @212 := save_mem(DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+1
    $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212 := $1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory;

    // @213 := save_mem(DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+1
    $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#213 := $1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory;

    // @216 := save_mem(Diem::BurnCapability<XUS::XUS>) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+1
    $1_Diem_BurnCapability'$1_XUS_XUS'_$memory#216 := $1_Diem_BurnCapability'$1_XUS_XUS'_$memory;

    // @211 := save_mem(Diem::CurrencyInfo<XUS::XUS>) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+1
    $1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#211 := $1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory;

    // @209 := save_mem(Diem::MintCapability<XUS::XUS>) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+1
    $1_Diem_MintCapability'$1_XUS_XUS'_$memory#209 := $1_Diem_MintCapability'$1_XUS_XUS'_$memory;

    // @217 := save_mem(AccountLimits::LimitsDefinition<XUS::XUS>) at /home/ying/diem/language/diem-framework/modules/XUS.move:15:5+1
    $1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory#217 := $1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory;
...
L1:
    ...
    // assert Not(exists[@209]<Diem::MintCapability<XUS::XUS>>(Signer::spec_address_of[]($t1))) at /home/ying/diem/language/diem-framework/modules/Diem.move:1341:9+111
    assume {:print "$at(10,64191,64302)"} true;
    assert {:msg "assert_failed(10,64191,64302): function does not abort under this condition"}
      !$ResourceExists($1_Diem_MintCapability'$1_XUS_XUS'_$memory#209, $1_Signer_spec_address_of($t1));

    // assert Not(Not(exists[@210]<Roles::RoleId>($t2))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    assume {:print "$at(26,24063,24122)"} true;
    assert {:msg "assert_failed(26,24063,24122): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#210, $t2);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t2)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    assume {:print "$at(26,24131,24228)"} true;
    assert {:msg "assert_failed(26,24131,24228): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t2)), 1);
    ...
    // assert Not(exists[@211]<Diem::CurrencyInfo<XUS::XUS>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/Diem.move:1283:9+121
    assume {:print "$at(10,61831,61952)"} true;
    assert {:msg "assert_failed(10,61831,61952): function does not abort under this condition"}
      !$ResourceExists($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#211, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@210]<Roles::RoleId>($t3))) at /home/ying/diem/language/diem-framework/modules/Roles.move:528:9+59
    assume {:print "$at(26,23704,23763)"} true;
    assert {:msg "assert_failed(26,23704,23763): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#210, $t3);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t3)), 0)) at /home/ying/diem/language/diem-framework/modules/Roles.move:529:9+87
    assume {:print "$at(26,23772,23859)"} true;
    assert {:msg "assert_failed(26,23772,23859): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t3)), 0);
    ...
    // assert Not(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@212]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 85, 83])) at /home/ying/diem/language/diem-framework/modules/RegisteredCurrencies.move:72:9+154
    assume {:print "$at(25,2617,2771)"} true;
    assert {:msg "assert_failed(25,2617,2771): function does not abort under this condition"}
      !$ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212)), MakeVec3(88, 85, 83));

    // assert Not(Not(exists[@213]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:140:9+129
    assume {:print "$at(13,5612,5741)"} true;
    assert {:msg "assert_failed(13,5612,5741): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#213, $1_Signer_spec_address_of($t0));

    // assert Not(Not(exists[@212]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:104:9+101
    assume {:print "$at(13,3930,4031)"} true;
    assert {:msg "assert_failed(13,3930,4031): function does not abort under this condition"}
      !!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212, $1_CoreAddresses_$DIEM_ROOT_ADDRESS());

    // assert Not(And(And(And(And(DiemTimestamp::$is_operating[@214](), DiemConfig::$reconfiguration_enabled[@215]()), Gt(DiemTimestamp::spec_now_microseconds[@214](), 0)), Lt(select DiemConfig::Configuration.epoch($t4), 18446744073709551615)), Lt($t5, select DiemConfig::Configuration.last_reconfiguration_time($t4)))) at /home/ying/diem/language/diem-framework/modules/DiemConfig.move:362:9+283
    assume {:print "$at(13,16092,16375)"} true;
    assert {:msg "assert_failed(13,16092,16375): function does not abort under this condition"}
      !(((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#215)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) > 0)) && ($epoch#$1_DiemConfig_Configuration($t4) < 18446744073709551615)) && ($t5 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t4)));

    // assert Not(exists[@216]<Diem::BurnCapability<XUS::XUS>>(Signer::spec_address_of[]($t1))) at /home/ying/diem/language/diem-framework/modules/Diem.move:286:9+111
    assume {:print "$at(10,14286,14397)"} true;
    assert {:msg "assert_failed(10,14286,14397): function does not abort under this condition"}
      !$ResourceExists($1_Diem_BurnCapability'$1_XUS_XUS'_$memory#216, $1_Signer_spec_address_of($t1));

    // assert Not(Not(exists[@210]<Roles::RoleId>($t6))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    assume {:print "$at(26,24063,24122)"} true;
    assert {:msg "assert_failed(26,24063,24122): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#210, $t6);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t6)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    assume {:print "$at(26,24131,24228)"} true;
    assert {:msg "assert_failed(26,24131,24228): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t6)), 1);
    ...
    // assert Not(exists[@217]<AccountLimits::LimitsDefinition<XUS::XUS>>(Signer::spec_address_of[]($t0))) at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:211:9+130
    assume {:print "$at(5,8837,8967)"} true;
    assert {:msg "assert_failed(5,8837,8967): function does not abort under this condition"}
      !$ResourceExists($1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory#217, $1_Signer_spec_address_of($t0));

    // assert Not(Not(DiemTimestamp::$is_genesis[@214]())) at /home/ying/diem/language/diem-framework/modules/DiemTimestamp.move:142:9+51
    ...
    // assert Not(Not(exists[@210]<Roles::RoleId>($t8))) at /home/ying/diem/language/diem-framework/modules/Roles.move:536:9+59
    assume {:print "$at(26,24063,24122)"} true;
    assert {:msg "assert_failed(26,24063,24122): function does not abort under this condition"}
      !!$ResourceExists($1_Roles_RoleId_$memory#210, $t8);

    // assert Not(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t8)), 1)) at /home/ying/diem/language/diem-framework/modules/Roles.move:537:9+97
    assume {:print "$at(26,24131,24228)"} true;
    assert {:msg "assert_failed(26,24131,24228): function does not abort under this condition"}
      !!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t8)), 1);
    ...
    // assert Diem::spec_has_mint_capability<XUS::XUS>(Signer::spec_address_of($t1)) at /home/ying/diem/language/diem-framework/modules/Diem.move:1347:9+80
    ...
    // assert exists<AccountLimits::LimitsDefinition<XUS::XUS>>(Signer::spec_address_of($t0)) at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:216:9+85
    ...
    // return () at /home/ying/diem/language/diem-framework/modules/AccountLimits.move:216:9+85
    return;
...
L2:
    ...
    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(exists[@209]<Diem::MintCapability<XUS::XUS>>(Signer::spec_address_of[]($t1)), Not(exists[@210]<Roles::RoleId>($t2))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t2)), 1)), Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), Or(Eq<u64>(1000000, 0), Gt(1000000, 10000000000))), exists[@211]<Diem::CurrencyInfo<XUS::XUS>>(Signer::spec_address_of[]($t0))), Not(exists[@210]<Roles::RoleId>($t3))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t3)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$CURRENCY_INFO_ADDRESS[]())), ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@212]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 85, 83])), Not(exists[@213]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0)))), Not(exists[@212]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]()))), And(And(And(And(DiemTimestamp::$is_operating[@214](), DiemConfig::$reconfiguration_enabled[@215]()), Gt(DiemTimestamp::spec_now_microseconds[@214](), 0)), Lt(select DiemConfig::Configuration.epoch($t4), 18446744073709551615)), Lt($t5, select DiemConfig::Configuration.last_reconfiguration_time($t4)))), exists[@216]<Diem::BurnCapability<XUS::XUS>>(Signer::spec_address_of[]($t1))), Not(exists[@210]<Roles::RoleId>($t6))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t6)), 1)), Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())), exists[@217]<AccountLimits::LimitsDefinition<XUS::XUS>>(Signer::spec_address_of[]($t0))), Not(DiemTimestamp::$is_genesis[@214]())), Not(exists[@210]<Roles::RoleId>($t7))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t7)), 0)), Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Not(exists[@210]<Roles::RoleId>($t8))), Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t8)), 1)), Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]())) at /home/ying/diem/language/diem-framework/modules/XUS.move:32:5+971
    assume {:print "$at(38,999,1970)"} true;
    assert {:msg "assert_failed(38,999,1970): abort not covered by any of the `aborts_if` clauses"}
      ((((((((((((((((((((((((($ResourceExists($1_Diem_MintCapability'$1_XUS_XUS'_$memory#209, $1_Signer_spec_address_of($t1)) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t2)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t2)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || ($IsEqual'u128'(1000000, 0) || (1000000 > 10000000000))) || $ResourceExists($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#211, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t3)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t3)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$CURRENCY_INFO_ADDRESS())) || $ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212)), MakeVec3(88, 85, 83))) || !$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#213, $1_Signer_spec_address_of($t0))) || !$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212, $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || (((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#215)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) > 0)) && ($epoch#$1_DiemConfig_Configuration($t4) < 18446744073709551615)) && ($t5 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t4)))) || $ResourceExists($1_Diem_BurnCapability'$1_XUS_XUS'_$memory#216, $1_Signer_spec_address_of($t1))) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t6)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t6)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS())) || $ResourceExists($1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory#217, $1_Signer_spec_address_of($t0))) || !$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214)) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t7)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t7)), 0)) || !$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS())) || !$ResourceExists($1_Roles_RoleId_$memory#210, $t8)) || !$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t8)), 1)) || !$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()));

    // assert Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(And(exists[@209]<Diem::MintCapability<XUS::XUS>>(Signer::spec_address_of[]($t1)), Eq(6, $t10)), And(Not(exists[@210]<Roles::RoleId>($t2)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t2)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t10))), And(Or(Eq<u64>(1000000, 0), Gt(1000000, 10000000000)), Eq(7, $t10))), And(exists[@211]<Diem::CurrencyInfo<XUS::XUS>>(Signer::spec_address_of[]($t0)), Eq(6, $t10))), And(Not(exists[@210]<Roles::RoleId>($t3)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t3)), 0), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t10))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$CURRENCY_INFO_ADDRESS[]()), Eq(2, $t10))), And(ContainsVec<vector<u8>>(select RegisteredCurrencies::RegisteredCurrencies.currency_codes(DiemConfig::$get[@212]<RegisteredCurrencies::RegisteredCurrencies>()), [88, 85, 83]), Eq(7, $t10))), And(Not(exists[@213]<DiemConfig::ModifyConfigCapability<RegisteredCurrencies::RegisteredCurrencies>>(Signer::spec_address_of[]($t0))), Eq(4, $t10))), And(Not(exists[@212]<DiemConfig::DiemConfig<RegisteredCurrencies::RegisteredCurrencies>>(CoreAddresses::$DIEM_ROOT_ADDRESS[]())), Eq(5, $t10))), And(And(And(And(And(DiemTimestamp::$is_operating[@214](), DiemConfig::$reconfiguration_enabled[@215]()), Gt(DiemTimestamp::spec_now_microseconds[@214](), 0)), Lt(select DiemConfig::Configuration.epoch($t4), 18446744073709551615)), Lt($t5, select DiemConfig::Configuration.last_reconfiguration_time($t4))), Eq(1, $t10))), And(exists[@216]<Diem::BurnCapability<XUS::XUS>>(Signer::spec_address_of[]($t1)), Eq(6, $t10))), And(Not(exists[@210]<Roles::RoleId>($t6)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t6)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t10))), And(exists[@217]<AccountLimits::LimitsDefinition<XUS::XUS>>(Signer::spec_address_of[]($t0)), Eq(6, $t10))), And(Not(DiemTimestamp::$is_genesis[@214]()), Eq(1, $t10))), And(Not(exists[@210]<Roles::RoleId>($t7)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t7)), 0), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t0), CoreAddresses::$DIEM_ROOT_ADDRESS[]()), Eq(2, $t10))), And(Not(exists[@210]<Roles::RoleId>($t8)), Eq(5, $t10))), And(Neq<u64>(select Roles::RoleId.role_id(global[@210]<Roles::RoleId>($t8)), 1), Eq(3, $t10))), And(Neq<address>(Signer::spec_address_of[]($t1), CoreAddresses::$TREASURY_COMPLIANCE_ADDRESS[]()), Eq(2, $t10))) at /home/ying/diem/language/diem-framework/modules/XUS.move:32:5+971
    assert {:msg "assert_failed(38,999,1970): abort code not covered by any of the `aborts_if` or `aborts_with` clauses"}
      (((((((((((((((((((((((((($ResourceExists($1_Diem_MintCapability'$1_XUS_XUS'_$memory#209, $1_Signer_spec_address_of($t1)) && $IsEqual'u8'(6, $t10)) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t2) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t2)), 1) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t10))) || (($IsEqual'u128'(1000000, 0) || (1000000 > 10000000000)) && $IsEqual'u8'(7, $t10))) || ($ResourceExists($1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory#211, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(6, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t3) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t3)), 0) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$CURRENCY_INFO_ADDRESS()) && $IsEqual'u8'(2, $t10))) || ($ContainsVec'vec'u8''($currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies($1_DiemConfig_$get'$1_RegisteredCurrencies_RegisteredCurrencies'($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212)), MakeVec3(88, 85, 83)) && $IsEqual'u8'(7, $t10))) || (!$ResourceExists($1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#213, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(4, $t10))) || (!$ResourceExists($1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory#212, $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(5, $t10))) || ((((($1_DiemTimestamp_$is_operating($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) && $1_DiemConfig_$reconfiguration_enabled($1_DiemConfig_DisableReconfiguration_$memory#215)) && ($1_DiemTimestamp_spec_now_microseconds($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) > 0)) && ($epoch#$1_DiemConfig_Configuration($t4) < 18446744073709551615)) && ($t5 < $last_reconfiguration_time#$1_DiemConfig_Configuration($t4))) && $IsEqual'u8'(1, $t10))) || ($ResourceExists($1_Diem_BurnCapability'$1_XUS_XUS'_$memory#216, $1_Signer_spec_address_of($t1)) && $IsEqual'u8'(6, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t6) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t6)), 1) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t10))) || ($ResourceExists($1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory#217, $1_Signer_spec_address_of($t0)) && $IsEqual'u8'(6, $t10))) || (!$1_DiemTimestamp_$is_genesis($1_DiemTimestamp_CurrentTimeMicroseconds_$memory#214) && $IsEqual'u8'(1, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t7) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t7)), 0) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t0), $1_CoreAddresses_$DIEM_ROOT_ADDRESS()) && $IsEqual'u8'(2, $t10))) || (!$ResourceExists($1_Roles_RoleId_$memory#210, $t8) && $IsEqual'u8'(5, $t10))) || (!$IsEqual'u64'($role_id#$1_Roles_RoleId($ResourceValue($1_Roles_RoleId_$memory#210, $t8)), 1) && $IsEqual'u8'(3, $t10))) || (!$IsEqual'address'($1_Signer_spec_address_of($t1), $1_CoreAddresses_$TREASURY_COMPLIANCE_ADDRESS()) && $IsEqual'u8'(2, $t10)));

    // abort($t10) at /home/ying/diem/language/diem-framework/modules/XUS.move:32:5+971
    $abort_code := $t10;
    $abort_flag := true;
    return;
...
L7:
    ...
    // @162 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@162](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemTransactionPublishingOption.move:46:9+186
...
L8:
    ...
    // @138 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@138](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemSystem.move:103:19+208
...
L7:
    ...
    // @156 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@156](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVMConfig.move:100:9+283
...
L7:
    ...
    // @150 := save_mem(DiemConfig::Configuration) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
    ...
    // assume Eq<bool>(DiemConfig::spec_has_config[@150](), DiemConfig::spec_has_config()) at /home/ying/diem/language/diem-framework/modules/DiemVersion.move:22:9+130
