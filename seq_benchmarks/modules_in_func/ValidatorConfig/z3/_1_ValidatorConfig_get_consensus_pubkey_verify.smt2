...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 255036) (let ((anon0$1_correct  (=> (and (and (|$IsValid'$1_ValidatorConfig_Config'| _$t0) (= _$t0 _$t0)) (and (= $t1@0 (|$consensus_pubkey#$1_ValidatorConfig_Config| _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 187601) (- 0 255104)) (not false)) (=> (not false) (=> (= (ControlFlow 0 187601) (- 0 255111)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1) (= (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1)))))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_76195_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 187518) 187601)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 255036) 187518) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
