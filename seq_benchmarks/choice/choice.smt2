...
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 17434)))
(get-value ((ControlFlow 0 15294)))
(get-value ((ControlFlow 0 15324)))
(get-value ((ControlFlow 0 15318)))
(get-value ((ControlFlow 0 15425)))
(get-value ((ControlFlow 0 15419)))
(get-value ((ControlFlow 0 15498)))
(get-value ((ControlFlow 0 15492)))
(get-value ((ControlFlow 0 15571)))
(get-value ((ControlFlow 0 15565)))
(get-value ((ControlFlow 0 15644)))
(get-value ((ControlFlow 0 15638)))
(get-value ((ControlFlow 0 15680)))
(assert (not (= (ControlFlow 0 15680) (- 17813))))
(check-sat)
(pop 1)
; Invalid
...
(declare-fun $t10 () Int)
(declare-fun |inline$$1_Vector_push_back'u64'$3$m'@1@@0| () T@$Mutation_9728)
(declare-fun |inline$$1_Vector_push_back'u64'$2$m'@1@@0| () T@$Mutation_9728)
(declare-fun |inline$$1_Vector_push_back'u64'$1$m'@1@@0| () T@$Mutation_9728)
(declare-fun |inline$$1_Vector_push_back'u64'$0$m'@1@@0| () T@$Mutation_9728)
(declare-fun $t3@0@@0 () T@$Mutation_9728)
(declare-fun |inline$$1_Vector_empty'u64'$0$v@1@@0| () (Seq Int))
(declare-fun |$temp_0'vec'u64''@0@@0| () (Seq Int))
(declare-fun $t1@@0 () T@$Mutation_9728)
(declare-fun $t3@@1 () T@$Mutation_9728)
(push 1)
(set-info :boogie-vc-id $42_TestSome_test_not_using_min_incorrect$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 17840) (let ((anon19_Else_correct  (=> (not false) (=> (and (and (= $t0@0@@0 (|v#$Mutation_9728| |inline$$1_Vector_push_back'u64'$4$m'@1|)) (= $t0@0@@0 $t0@0@@0)) (and (= $t10 ($choice_5 $t0@0@@0)) (= (ControlFlow 0 16362) (- 0 18288)))) (= ($choice_5 $t0@0@@0) 1)))))
(let ((anon19_Then_correct true))
(let ((|inline$$1_Vector_push_back'u64'$4$anon0_correct|  (=> (= |inline$$1_Vector_push_back'u64'$4$m'@1| ($Mutation_9728 (|l#$Mutation_9728| |inline$$1_Vector_push_back'u64'$3$m'@1@@0|) (|p#$Mutation_9728| |inline$$1_Vector_push_back'u64'$3$m'@1@@0|) (seq.++ (|v#$Mutation_9728| |inline$$1_Vector_push_back'u64'$3$m'@1@@0|) (seq.unit 2)))) (and (=> (= (ControlFlow 0 16310) 16376) anon19_Then_correct) (=> (= (ControlFlow 0 16310) 16362) anon19_Else_correct)))))
...
(let ((|inline$$1_Vector_push_back'u64'$3$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$3$m'@1@@0| ($Mutation_9728 (|l#$Mutation_9728| |inline$$1_Vector_push_back'u64'$2$m'@1@@0|) (|p#$Mutation_9728| |inline$$1_Vector_push_back'u64'$2$m'@1@@0|) (seq.++ (|v#$Mutation_9728| |inline$$1_Vector_push_back'u64'$2$m'@1@@0|) (seq.unit 2)))) (and (=> (= (ControlFlow 0 16237) 16396) anon18_Then_correct) (=> (= (ControlFlow 0 16237) 16316) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (not false) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 16243) 16237)) |inline$$1_Vector_push_back'u64'$3$anon0_correct@@0|))))
(let ((anon17_Then_correct true))
(let ((|inline$$1_Vector_push_back'u64'$2$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$2$m'@1@@0| ($Mutation_9728 (|l#$Mutation_9728| |inline$$1_Vector_push_back'u64'$1$m'@1@@0|) (|p#$Mutation_9728| |inline$$1_Vector_push_back'u64'$1$m'@1@@0|) (seq.++ (|v#$Mutation_9728| |inline$$1_Vector_push_back'u64'$1$m'@1@@0|) (seq.unit 3)))) (and (=> (= (ControlFlow 0 16164) 16410) anon17_Then_correct) (=> (= (ControlFlow 0 16164) 16243) anon17_Else_correct)))))
(let ((anon16_Else_correct@@0  (=> (not false) (=> (and (|$IsValid'u64'| 3) (= (ControlFlow 0 16170) 16164)) |inline$$1_Vector_push_back'u64'$2$anon0_correct@@0|))))
(let ((anon16_Then_correct@@0 true))
(let ((|inline$$1_Vector_push_back'u64'$1$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$1$m'@1@@0| ($Mutation_9728 (|l#$Mutation_9728| |inline$$1_Vector_push_back'u64'$0$m'@1@@0|) (|p#$Mutation_9728| |inline$$1_Vector_push_back'u64'$0$m'@1@@0|) (seq.++ (|v#$Mutation_9728| |inline$$1_Vector_push_back'u64'$0$m'@1@@0|) (seq.unit 2)))) (and (=> (= (ControlFlow 0 16091) 16424) anon16_Then_correct@@0) (=> (= (ControlFlow 0 16091) 16170) anon16_Else_correct@@0)))))
(let ((anon15_Else_correct@@1  (=> (not false) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 16097) 16091)) |inline$$1_Vector_push_back'u64'$1$anon0_correct@@0|))))
(let ((anon15_Then_correct@@1 true))
(let ((|inline$$1_Vector_push_back'u64'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$0$m'@1@@0| ($Mutation_9728 (|l#$Mutation_9728| $t3@0@@0) (|p#$Mutation_9728| $t3@0@@0) (seq.++ (|v#$Mutation_9728| $t3@0@@0) (seq.unit 1)))) (and (=> (= (ControlFlow 0 16018) 16438) anon15_Then_correct@@1) (=> (= (ControlFlow 0 16018) 16097) anon15_Else_correct@@1)))))
(let ((anon14_Else_correct@@1  (=> (not false) (=> (and (= |inline$$1_Vector_empty'u64'$0$v@1@@0| |inline$$1_Vector_empty'u64'$0$v@1@@0|) (= $t3@0@@0 ($Mutation_9728 ($Local 0) (as seq.empty (Seq Int)) |inline$$1_Vector_empty'u64'$0$v@1@@0|))) (=> (and (and (= |$temp_0'vec'u64''@0@@0| (|v#$Mutation_9728| $t3@0@@0)) (= |$temp_0'vec'u64''@0@@0| |$temp_0'vec'u64''@0@@0|)) (and (|$IsValid'u64'| 1) (= (ControlFlow 0 16024) 16018))) |inline$$1_Vector_push_back'u64'$0$anon0_correct@@0|)))))
(let ((anon14_Then_correct@@1 true))
(let ((|inline$$1_Vector_empty'u64'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_empty'u64'$0$v@1@@0| (as seq.empty (Seq Int))) (and (=> (= (ControlFlow 0 15917) 16452) anon14_Then_correct@@1) (=> (= (ControlFlow 0 15917) 16024) anon14_Else_correct@@1)))))
(let ((anon0$1_correct@@3  (=> (= (ControlFlow 0 15923) 15917) |inline$$1_Vector_empty'u64'$0$anon0_correct@@0|)))
(let ((anon0_correct@@3  (=> (= (seq.len (|p#$Mutation_9728| $t1@@0)) 0) (=> (and (= (seq.len (|p#$Mutation_9728| $t3@@1)) 0) (= (ControlFlow 0 15893) 15923)) anon0$1_correct@@3))))
(let ((PreconditionGeneratedEntry_correct@@0  (=> (= (ControlFlow 0 17840) 15893) anon0_correct@@3)))
PreconditionGeneratedEntry_correct@@0))))))))))))))))))))))
))
(check-sat)
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 17840)))
(get-value ((ControlFlow 0 15893)))
(get-value ((ControlFlow 0 15923)))
(get-value ((ControlFlow 0 15917)))
(get-value ((ControlFlow 0 16024)))
(get-value ((ControlFlow 0 16018)))
(get-value ((ControlFlow 0 16097)))
(get-value ((ControlFlow 0 16091)))
(get-value ((ControlFlow 0 16170)))
(get-value ((ControlFlow 0 16164)))
(get-value ((ControlFlow 0 16243)))
(get-value ((ControlFlow 0 16237)))
(get-value ((ControlFlow 0 16316)))
(get-value ((ControlFlow 0 16310)))
(get-value ((ControlFlow 0 16362)))
(assert (not (= (ControlFlow 0 16362) (- 18288))))
(check-sat)
(pop 1)
; Invalid
...
(assert (not
 (=> (= (ControlFlow 0 0) 18317) (let ((anon4_Else_correct  (=> (and (and (not $abort_flag@0@@0) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (= $t4@@1 ($choice_0 (+ _$t0@@1 42))) (= (ControlFlow 0 16813) (- 0 18514)))) (<= inline$$AddU64$0$dst@2 ($choice_0 (+ _$t0@@1 42))))))
(let ((anon4_Then_correct true))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_flag@0@@0 true) (=> (and (= $abort_code@1@@0 $EXEC_FAILURE_CODE) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 16761) 16831) anon4_Then_correct) (=> (= (ControlFlow 0 16761) 16813) anon4_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ _$t0@@1 42) $MAX_U64) (= (ControlFlow 0 16759) 16761)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ _$t0@@1 42)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ _$t0@@1 42)) (= $abort_flag@0@@0 false)) (and (= $abort_code@1@@0 $abort_code@0@@0) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 16707) 16831) anon4_Then_correct) (=> (= (ControlFlow 0 16707) 16813) anon4_Else_correct))))))
(let ((anon0$1_correct@@4  (=> (|$IsValid'u64'| _$t0@@1) (=> (and (= _$t0@@1 _$t0@@1) (|$IsValid'u64'| 42)) (and (=> (= (ControlFlow 0 16767) 16759) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 16767) 16707) inline$$AddU64$0$anon3_Else_correct))))))
(let ((anon0_correct@@4  (=> (= (ControlFlow 0 18317) 16767) anon0$1_correct@@4)))
anon0_correct@@4))))))))
))
(check-sat)
(pop 1)
