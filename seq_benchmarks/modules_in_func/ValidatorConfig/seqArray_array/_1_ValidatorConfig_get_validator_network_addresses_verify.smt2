...
(assert (not
 (=> (= (ControlFlow 0 0) 270651) (let ((anon0$1_correct@@13  (=> (and (and (|$IsValid'$1_ValidatorConfig_Config'| _$t0@@13) (= _$t0@@13 _$t0@@13)) (and (= $t1@0@@1 (|$validator_network_addresses#$1_ValidatorConfig_Config| _$t0@@13)) (= $t1@0@@1 $t1@0@@1))) (and (=> (= (ControlFlow 0 198612) (- 0 270719)) (not false)) (=> (not false) (=> (= (ControlFlow 0 198612) (- 0 270726)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@5) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@5))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_115312| $1_ValidatorConfig_ValidatorConfig_$memory) addr1@@5))))))
 :qid |ValidatorConfigbpl.7493:15|
 :skolemid |229|
))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@13  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@15 T@$1_Event_EventHandle) ) (! (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_77784_| (|streams#$EventStore| $es) handle@@15)))
 (and (= (|l#Multiset_77784| stream@@14) 0) (forall ((v@@58 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_77784| stream@@14) v@@58) 0)
 :qid |ValidatorConfigbpl.159:13|
 :skolemid |4|
))))
 :qid |ValidatorConfigbpl.2583:13|
 :skolemid |91|
))) (= (ControlFlow 0 198529) 198612)) anon0$1_correct@@13)))
(let ((anon0_correct@@13  (=> (= (ControlFlow 0 270651) 198529) inline$$InitEventStore$0$anon0_correct@@13)))
anon0_correct@@13))))
))
(check-sat)
(pop 1)
