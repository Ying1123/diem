...
(assert (not
 (=> (= (ControlFlow 0 0) 163209) (let ((L2_correct  (and (=> (= (ControlFlow 0 144979) (- 0 166684)) (or (or (or (or (or (or (or (or (or (or (or (or (or (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@23 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@23)) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2))) (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2))) (not (= (let ((t_ref@@24 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@24)) 0)) $t9@@1))) (not (let (($range_0@@19 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@97 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@97))))))
(exists (($i_1@@19 Int) ) (!  (and (and (>= $i_1@@19 0) (< $i_1@@19 (seq.len $range_0@@19))) (let ((v@@57 (seq.nth $range_0@@19 $i_1@@19)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@57) _$t1@@2)))
 :qid |ValidatorAdministrationScriptsbpl.4568:125|
 :skolemid |126|
))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t10@@1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t10@@1)) 4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2))) (and $t5@@0 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t11@@1) 18446744073709551615)) (< $t12@@1 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t11@@1))))) (and $t5@@0 (> $t7@@1 (- 18446744073709551615 300000000)))) (and $t5@@0 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t7@@1 300000000)))) (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@25 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@25)) 0)))))) (=> (or (or (or (or (or (or (or (or (or (or (or (or (or (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@26 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@26)) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2))) (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2))) (not (= (let ((t_ref@@27 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@27)) 0)) $t9@@1))) (not (let (($range_0@@20 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@98 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@98))))))
(exists (($i_1@@20 Int) ) (!  (and (and (>= $i_1@@20 0) (< $i_1@@20 (seq.len $range_0@@20))) (let ((v@@58 (seq.nth $range_0@@20 $i_1@@20)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@58) _$t1@@2)))
 :qid |ValidatorAdministrationScriptsbpl.4568:125|
 :skolemid |126|
))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t10@@1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t10@@1)) 4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2))) (and $t5@@0 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t11@@1) 18446744073709551615)) (< $t12@@1 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t11@@1))))) (and $t5@@0 (> $t7@@1 (- 18446744073709551615 300000000)))) (and $t5@@0 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t7@@1 300000000)))) (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@28 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@28)) 0))))) (=> (= (ControlFlow 0 144979) (- 0 166866)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@29 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@29)) 0)))) (= 7 $t16)) (and (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2)) (= 7 $t16))) (and (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))) 0))) (= 7 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)) (= 5 $t16))) (and (not (= (let ((t_ref@@30 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@30)) 0)) $t9@@1)) (= 7 $t16))) (and (not (let (($range_0@@21 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@99 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@99))))))
(exists (($i_1@@21 Int) ) (!  (and (and (>= $i_1@@21 0) (< $i_1@@21 (seq.len $range_0@@21))) (let ((v@@59 (seq.nth $range_0@@21 $i_1@@21)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@59) _$t1@@2)))
 :qid |ValidatorAdministrationScriptsbpl.4568:125|
 :skolemid |126|
)))) (= 7 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t10@@1)) (= 5 $t16))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t10@@1)) 4)) (= 3 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)) (= 5 $t16))) (and (and $t5@@0 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t11@@1) 18446744073709551615)) (< $t12@@1 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t11@@1)))) (= 1 $t16))) (and (and $t5@@0 (> $t7@@1 (- 18446744073709551615 300000000))) (= 8 $t16))) (and (and $t5@@0 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t7@@1 300000000))) (= 8 $t16))) (and (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@31 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@31)) 0)))) (= 7 $t16))) (= 5 $t16)) (= 3 $t16)) (= 7 $t16)) (= 1 $t16)))))))
(let ((anon17_Then_correct  (=> (and (and $t29 (or (or (or (or (or (or (or (or (or (or (and (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2)))) 0))) (= 7 $t16)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2)) (= 5 $t16))) (and (not (= (let ((t_ref@@32 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@32)) 0)) $t20@@1)) (= 7 $t16))) (and (not (let (($range_0@@22 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@100 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@100))))))
(exists (($i_1@@22 Int) ) (!  (and (and (>= $i_1@@22 0) (< $i_1@@22 (seq.len $range_0@@22))) (let ((v@@60 (seq.nth $range_0@@22 $i_1@@22)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@60) _$t1@@2)))
 :qid |ValidatorAdministrationScriptsbpl.4568:125|
 :skolemid |126|
)))) (= 7 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t21@@1)) (= 5 $t16))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t21@@1)) 4)) (= 3 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2)) (= 5 $t16))) (and (and $t17 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t23@@1) 18446744073709551615)) (< $t24@@1 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t23@@1)))) (= 1 $t16))) (and (and $t17 (> $t19@@1 (- 18446744073709551615 300000000))) (= 8 $t16))) (and (and $t17 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t19@@1 300000000))) (= 8 $t16)))) (and (= $t16 $t16) (= (ControlFlow 0 144415) 144979))) L2_correct)))
(let ((anon15_Then_correct  (=> (and (and $t15@@1 (or (or (or (and (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@33 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@33)) 0)))) (= 7 $t16)) (and (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2)) (= 7 $t16))) (and (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))) 0))) (= 7 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)) (= 5 $t16)))) (and (= $t16 $t16) (= (ControlFlow 0 145077) 144979))) L2_correct)))
(let ((anon13_correct  (=> (and (= $t30 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@101 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2@@1|) addr@@101))))) (= $t31 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_85880| $1_DiemConfig_Configuration_$memory@2@@1) 173345816))) (=> (and (and (and (and (= $t32 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t33 ($1_DiemConfig_NewEpochEvent (|$epoch#$1_DiemConfig_Configuration| $t31)))) (and (= (seq.len $t30) (seq.len $t22@@1)) (let (($range_0@@23 ($Range 0 (seq.len $t22@@1))))
(forall (($i_1@@23 Int) ) (!  (=> ($InRange $range_0@@23 $i_1@@23) (let ((i@@44 $i_1@@23))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t30 i@@44)) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t22@@1 i@@44)))))
 :qid |ValidatorAdministrationScriptsbpl.8822:62|
 :skolemid |309|
))))) (and (and (let (($range_0@@24 ($Range 0 (seq.len $t22@@1))))
(forall (($i_1@@24 Int) ) (!  (=> ($InRange $range_0@@24 $i_1@@24) (let ((i@@45 $i_1@@24))
 (=> (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t22@@1 i@@45)) _$t1@@2)) (= (seq.nth $t30 i@@45) (seq.nth $t22@@1 i@@45)))))
 :qid |ValidatorAdministrationScriptsbpl.8826:62|
 :skolemid |310|
))) (let (($range_0@@25 ($Range 0 (seq.len $t22@@1))))
(forall (($i_1@@25 Int) ) (!  (=> ($InRange $range_0@@25 $i_1@@25) (let ((i@@46 $i_1@@25))
 (or (= (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth $t30 i@@46)) (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth $t22@@1 i@@46))) (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t22@@1 i@@46)) _$t1@@2) (= (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth $t30 i@@46)) (let ((config (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2))))
(seq.nth (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config) 0)))))))
 :qid |ValidatorAdministrationScriptsbpl.8830:62|
 :skolemid |311|
)))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) _$t1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) _$t1@@2)) 3)))) (and (and (and (= $t34 $t33) (= $t35 $t27@@1)) (and (= $t36  (and $t25@@1 (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t32 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t26@@1)))))) (= $es@0@@1 (ite $t36 (let ((stream@@11 (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| $es) $t35)))
(let ((stream_new@@7 (let ((len@@7 (|l#Multiset_54442| stream@@11)))
(let ((cnt@@7 (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| stream@@11) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t34))))
(Multiset_54442 (|Store__T@[$EventRep]Int_| (|v#Multiset_54442| stream@@11) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t34) (+ cnt@@7 1)) (+ len@@7 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| $es) $t35 stream_new@@7)))) $es)))) (and (and (= $t37 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@102 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2@@1|) addr@@102))))) (= $t38 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_85880| $1_DiemConfig_Configuration_$memory@2@@1) 173345816))) (and (= $t39 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t40 ($1_DiemConfig_NewEpochEvent (|$epoch#$1_DiemConfig_Configuration| $t38))))))) (and (=> (= (ControlFlow 0 144125) (- 0 166140)) (not (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@34 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@34)) 0)))))) (=> (not (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@35 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@35)) 0))))) (and (=> (= (ControlFlow 0 144125) (- 0 166156)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2))) (and (=> (= (ControlFlow 0 144125) (- 0 166166)) (not (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))) 0))))) (=> (not (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))) 0)))) (and (=> (= (ControlFlow 0 144125) (- 0 166177)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2))) (and (=> (= (ControlFlow 0 144125) (- 0 166188)) (not (not (= (let ((t_ref@@36 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@36)) 0)) $t9@@1)))) (=> (not (not (= (let ((t_ref@@37 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@37)) 0)) $t9@@1))) (and (=> (= (ControlFlow 0 144125) (- 0 166203)) (not (not (let (($range_0@@26 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@103 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@103))))))
(exists (($i_1@@26 Int) ) (!  (and (and (>= $i_1@@26 0) (< $i_1@@26 (seq.len $range_0@@26))) (let ((v@@61 (seq.nth $range_0@@26 $i_1@@26)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@61) _$t1@@2)))
 :qid |ValidatorAdministrationScriptsbpl.4568:125|
 :skolemid |126|
)))))) (=> (not (not (let (($range_0@@27 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@104 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@104))))))
(exists (($i_1@@27 Int) ) (!  (and (and (>= $i_1@@27 0) (< $i_1@@27 (seq.len $range_0@@27))) (let ((v@@62 (seq.nth $range_0@@27 $i_1@@27)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@62) _$t1@@2)))
 :qid |ValidatorAdministrationScriptsbpl.4568:125|
 :skolemid |126|
))))) (and (=> (= (ControlFlow 0 144125) (- 0 166214)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 144125) (- 0 166224)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t10@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t10@@1))) (and (=> (= (ControlFlow 0 144125) (- 0 166236)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t10@@1)) 4)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t10@@1)) 4))) (and (=> (= (ControlFlow 0 144125) (- 0 166254)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2))) (and (=> (= (ControlFlow 0 144125) (- 0 166265)) (not (and $t5@@0 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t11@@1) 18446744073709551615)) (< $t12@@1 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t11@@1)))))) (=> (not (and $t5@@0 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t11@@1) 18446744073709551615)) (< $t12@@1 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t11@@1))))) (and (=> (= (ControlFlow 0 144125) (- 0 166311)) (not (and $t5@@0 (> $t7@@1 (- 18446744073709551615 300000000))))) (=> (not (and $t5@@0 (> $t7@@1 (- 18446744073709551615 300000000)))) (and (=> (= (ControlFlow 0 144125) (- 0 166330)) (not (and $t5@@0 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t7@@1 300000000))))) (=> (not (and $t5@@0 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t7@@1 300000000)))) (and (=> (= (ControlFlow 0 144125) (- 0 166350)) (not (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@38 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@38)) 0)))))) (=> (not (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@39 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@39)) 0))))) (and (=> (= (ControlFlow 0 144125) (- 0 166366)) (= (seq.len $t37) (seq.len $t8@@1))) (=> (= (seq.len $t37) (seq.len $t8@@1)) (and (=> (= (ControlFlow 0 144125) (- 0 166379)) (let (($range_0@@28 ($Range 0 (seq.len $t8@@1))))
(forall (($i_1@@28 Int) ) (!  (=> ($InRange $range_0@@28 $i_1@@28) (let ((i@@47 $i_1@@28))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t37 i@@47)) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t8@@1 i@@47)))))
 :qid |ValidatorAdministrationScriptsbpl.8950:56|
 :skolemid |312|
)))) (=> (let (($range_0@@29 ($Range 0 (seq.len $t8@@1))))
(forall (($i_1@@29 Int) ) (!  (=> ($InRange $range_0@@29 $i_1@@29) (let ((i@@48 $i_1@@29))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t37 i@@48)) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t8@@1 i@@48)))))
 :qid |ValidatorAdministrationScriptsbpl.8950:56|
 :skolemid |312|
))) (and (=> (= (ControlFlow 0 144125) (- 0 166425)) (let (($range_0@@30 ($Range 0 (seq.len $t8@@1))))
(forall (($i_1@@30 Int) ) (!  (=> ($InRange $range_0@@30 $i_1@@30) (let ((i@@49 $i_1@@30))
 (=> (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t8@@1 i@@49)) _$t1@@2)) (= (seq.nth $t37 i@@49) (seq.nth $t8@@1 i@@49)))))
 :qid |ValidatorAdministrationScriptsbpl.8956:56|
 :skolemid |313|
)))) (=> (let (($range_0@@31 ($Range 0 (seq.len $t8@@1))))
(forall (($i_1@@31 Int) ) (!  (=> ($InRange $range_0@@31 $i_1@@31) (let ((i@@50 $i_1@@31))
 (=> (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t8@@1 i@@50)) _$t1@@2)) (= (seq.nth $t37 i@@50) (seq.nth $t8@@1 i@@50)))))
 :qid |ValidatorAdministrationScriptsbpl.8956:56|
 :skolemid |313|
))) (and (=> (= (ControlFlow 0 144125) (- 0 166482)) (let (($range_0@@32 ($Range 0 (seq.len $t8@@1))))
(forall (($i_1@@32 Int) ) (!  (=> ($InRange $range_0@@32 $i_1@@32) (let ((i@@51 $i_1@@32))
 (or (= (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth $t37 i@@51)) (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth $t8@@1 i@@51))) (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t8@@1 i@@51)) _$t1@@2) (= (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth $t37 i@@51)) (let ((config@@0 (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2))))
(seq.nth (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config@@0) 0)))))))
 :qid |ValidatorAdministrationScriptsbpl.8962:56|
 :skolemid |314|
)))) (=> (let (($range_0@@33 ($Range 0 (seq.len $t8@@1))))
(forall (($i_1@@33 Int) ) (!  (=> ($InRange $range_0@@33 $i_1@@33) (let ((i@@52 $i_1@@33))
 (or (= (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth $t37 i@@52)) (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth $t8@@1 i@@52))) (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth $t8@@1 i@@52)) _$t1@@2) (= (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth $t37 i@@52)) (let ((config@@1 (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2))))
(seq.nth (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config@@1) 0)))))))
 :qid |ValidatorAdministrationScriptsbpl.8962:56|
 :skolemid |314|
))) (and (=> (= (ControlFlow 0 144125) (- 0 166557)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) _$t1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) _$t1@@2)) 3))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) _$t1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) _$t1@@2)) 3)) (and (=> (= (ControlFlow 0 144125) (- 0 166565)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2)))) 0)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2)))) 0))) (and (=> (= (ControlFlow 0 144125) (- 0 166572)) (= (seq.nth (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2))) 0) ($1_ValidatorConfig_Config _$t2@@2 _$t3@@2 _$t4@@0))) (=> (= (seq.nth (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2))) 0) ($1_ValidatorConfig_Config _$t2@@2 _$t3@@2 _$t4@@0)) (and (=> (= (ControlFlow 0 144125) (- 0 166586)) (let ((actual@@5 ($EventStore (- (|counter#$EventStore| $es@0@@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0@@1) (|streams#$EventStore| $es)))))
(let ((expected@@5 (ite  (and $t5@@0 (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t39 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t13@@1))))) (let ((stream@@12 (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| $EmptyEventStore) $t14@@1)))
(let ((stream_new@@8 (let ((len@@8 (|l#Multiset_54442| stream@@12)))
(let ((cnt@@8 (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| stream@@12) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40))))
(Multiset_54442 (|Store__T@[$EventRep]Int_| (|v#Multiset_54442| stream@@12) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40) (+ cnt@@8 1)) (+ len@@8 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| $EmptyEventStore) $t14@@1 stream_new@@8)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@5) (|counter#$EventStore| actual@@5)) (forall ((handle@@10 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| expected@@5) handle@@10)) (|l#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| actual@@5) handle@@10))) (forall ((v@@63 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| expected@@5) handle@@10)) v@@63) (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| actual@@5) handle@@10)) v@@63))
...
(let ((expected@@6 (ite  (and $t5@@0 (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t39 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t13@@1))))) (let ((stream@@13 (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| $EmptyEventStore) $t14@@1)))
(let ((stream_new@@9 (let ((len@@9 (|l#Multiset_54442| stream@@13)))
(let ((cnt@@9 (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| stream@@13) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40))))
(Multiset_54442 (|Store__T@[$EventRep]Int_| (|v#Multiset_54442| stream@@13) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40) (+ cnt@@9 1)) (+ len@@9 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| $EmptyEventStore) $t14@@1 stream_new@@9)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@6) (|counter#$EventStore| actual@@6)) (forall ((handle@@11 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| expected@@6) handle@@11)) (|l#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| actual@@6) handle@@11))) (forall ((v@@64 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| expected@@6) handle@@11)) v@@64) (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| actual@@6) handle@@11)) v@@64))
 :qid |ValidatorAdministrationScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |ValidatorAdministrationScriptsbpl.2568:13|
 :skolemid |70|
))))) (=> (= (ControlFlow 0 144125) (- 0 166635)) (let ((actual@@7 ($EventStore (- (|counter#$EventStore| $es@0@@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0@@1) (|streams#$EventStore| $es)))))
(let ((expected@@7 (ite  (and $t5@@0 (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t39 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t13@@1))))) (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| $EmptyEventStore) $t14@@1)))
(let ((stream_new@@10 (let ((len@@10 (|l#Multiset_54442| stream@@14)))
(let ((cnt@@10 (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| stream@@14) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40))))
(Multiset_54442 (|Store__T@[$EventRep]Int_| (|v#Multiset_54442| stream@@14) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40) (+ cnt@@10 1)) (+ len@@10 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| $EmptyEventStore) $t14@@1 stream_new@@10)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| actual@@7) (|counter#$EventStore| expected@@7)) (forall ((handle@@12 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| actual@@7) handle@@12)) (|l#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| expected@@7) handle@@12))) (forall ((v@@65 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| actual@@7) handle@@12)) v@@65) (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| expected@@7) handle@@12)) v@@65))
 :qid |ValidatorAdministrationScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |ValidatorAdministrationScriptsbpl.2568:13|
...
(let ((anon19_Else_correct  (=> (and (and (not |$temp_0'bool'@2|) (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1@@1| ($Memory_85687 (|Store__T@[Int]Bool_| (|domain#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816 false) (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|)))) (and (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2@@1| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1@@1|) (= (ControlFlow 0 143225) 144125))) anon13_correct)))
(let ((anon19_Then_correct  (=> (and (and |$temp_0'bool'@2| (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@0@@1| ($Memory_85687 (|Store__T@[Int]Bool_| (|domain#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816 true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816 |$temp_0'$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem''@0|)))) (and (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2@@1| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@0@@1|) (= (ControlFlow 0 144137) 144125))) anon13_correct)))
(let ((anon18_Else_correct  (=> (not |$temp_0'bool'@1|) (=> (and (= $1_DiemConfig_Configuration_$memory@1@@1 ($Memory_85880 (|Store__T@[Int]Bool_| (|domain#$Memory_85880| $1_DiemConfig_Configuration_$memory) 173345816 false) (|contents#$Memory_85880| $1_DiemConfig_Configuration_$memory))) (= $1_DiemConfig_Configuration_$memory@2@@1 $1_DiemConfig_Configuration_$memory@1@@1)) (and (=> (= (ControlFlow 0 143211) 144137) anon19_Then_correct) (=> (= (ControlFlow 0 143211) 143225) anon19_Else_correct))))))
(let ((anon18_Then_correct  (=> |$temp_0'bool'@1| (=> (and (= $1_DiemConfig_Configuration_$memory@0@@1 ($Memory_85880 (|Store__T@[Int]Bool_| (|domain#$Memory_85880| $1_DiemConfig_Configuration_$memory) 173345816 true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_85880| $1_DiemConfig_Configuration_$memory) 173345816 |$temp_0'$1_DiemConfig_Configuration'@0|))) (= $1_DiemConfig_Configuration_$memory@2@@1 $1_DiemConfig_Configuration_$memory@0@@1)) (and (=> (= (ControlFlow 0 144149) 144137) anon19_Then_correct) (=> (= (ControlFlow 0 144149) 143225) anon19_Else_correct))))))
(let ((anon17_Else_correct  (=> (not $t29) (and (=> (= (ControlFlow 0 143199) 144149) anon18_Then_correct) (=> (= (ControlFlow 0 143199) 143211) anon18_Else_correct)))))
(let ((anon5_correct@@0  (=> (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2)))) 0))) (and (= (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2) ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (seq.unit ($1_ValidatorConfig_Config _$t2@@2 _$t3@@2 _$t4@@0))) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))) (= $t17  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2)))) 0))) (let (($range_0@@34 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@105 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@105))))))
(exists (($i_1@@34 Int) ) (!  (and (and (>= $i_1@@34 0) (< $i_1@@34 (seq.len $range_0@@34))) (let ((v_info (seq.nth $range_0@@34 $i_1@@34)))
 ...
 :qid |ValidatorAdministrationScriptsbpl.8711:223|
 :skolemid |307|
))))))) (and (and (= $t18@@1 ($choice_0 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@106 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@106)))) _$t1@@2)) (= $t19@@1 (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@107 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@107)))) $t18@@1)))) (and (= $t20@@1 (|$addr#$signer| _$t0@@2)) (= $t21@@1 (|$addr#$signer| _$t0@@2))))) (and (and (and (= $t22@@1 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@108 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@108))))) (= $t23@@1 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_85880| $1_DiemConfig_Configuration_$memory) 173345816))) (and (= $t24@@1 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t25@@1  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2)))) 0))) (let (($range_0@@35 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@109 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@109))))))
(exists (($i_1@@35 Int) ) (!  (and (and (>= $i_1@@35 0) (< $i_1@@35 (seq.len $range_0@@35))) (let ((v_info@@0 (seq.nth $range_0@@35 $i_1@@35)))
 ...
 :qid |ValidatorAdministrationScriptsbpl.8744:223|
 :skolemid |308|
))))))) (and (and (= $t26@@1 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_85880| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t27@@1 (|$events#$1_DiemConfig_Configuration| $t26@@1))) (and (= $t28@@1 (|$addr#$signer| _$t0@@2)) (= $t29  (or (or (or (or (or (or (or (or (or (or (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2))) (not (= (let ((t_ref@@40 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@40)) 0)) $t20@@1))) (not (let (($range_0@@36 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@110 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@110))))))
(exists (($i_1@@36 Int) ) (!  (and (and (>= $i_1@@36 0) (< $i_1@@36 (seq.len $range_0@@36))) (let ((v@@66 (seq.nth $range_0@@36 $i_1@@36)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@66) _$t1@@2)))
 :qid |ValidatorAdministrationScriptsbpl.4568:125|
 :skolemid |126|
))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) $t21@@1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $t21@@1)) 4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory@2@@0) _$t1@@2))) (and $t17 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t23@@1) 18446744073709551615)) (< $t24@@1 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t23@@1))))) (and $t17 (> $t19@@1 (- 18446744073709551615 300000000)))) (and $t17 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t19@@1 300000000))))))))) (and (=> (= (ControlFlow 0 143193) 144415) anon17_Then_correct) (=> (= (ControlFlow 0 143193) 143199) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (and (not |$temp_0'bool'@0@@0|) (= $1_ValidatorConfig_ValidatorConfig_$memory@1@@0 ($Memory_83469 (|Store__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2 false) (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory)))) (and (= $1_ValidatorConfig_ValidatorConfig_$memory@2@@0 $1_ValidatorConfig_ValidatorConfig_$memory@1@@0) (= (ControlFlow 0 142747) 143193))) anon5_correct@@0)))
(let ((anon16_Then_correct  (=> (and (and |$temp_0'bool'@0@@0| (= $1_ValidatorConfig_ValidatorConfig_$memory@0@@0 ($Memory_83469 (|Store__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2 true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2 |$temp_0'$1_ValidatorConfig_ValidatorConfig'@0@@0|)))) (and (= $1_ValidatorConfig_ValidatorConfig_$memory@2@@0 $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) (= (ControlFlow 0 144991) 143193))) anon5_correct@@0)))
(let ((anon15_Else_correct  (=> (not $t15@@1) (and (=> (= (ControlFlow 0 142735) 144991) anon16_Then_correct) (=> (= (ControlFlow 0 142735) 142747) anon16_Else_correct)))))
(let ((anon0$1_correct@@2  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (forall ((addr@@111 Int) ) (!  (=> (|$IsValid'address'| addr@@111) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@111) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@111)) 0)) (= addr@@111 173345816)))
 :qid |ValidatorAdministrationScriptsbpl.8327:20|
 :skolemid |269|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) 173345816)) 0)))) (=> (and (and (forall ((addr@@112 Int) ) (!  (=> (|$IsValid'address'| addr@@112) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@112) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@112)) 1)) (= addr@@112 186537453)))
 :qid |ValidatorAdministrationScriptsbpl.8335:20|
 :skolemid |270|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) 186537453)) 1)))) (and (forall ((addr@@113 Int) ) (!  (=> (|$IsValid'address'| addr@@113) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@113) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@113)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@113) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@113)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@113) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@113)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@113) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@113)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.8343:20|
 :skolemid |271|
)) (forall ((addr@@114 Int) ) (!  (=> (|$IsValid'address'| addr@@114) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@114)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@114)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@114)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@114)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.8347:20|
 :skolemid |272|
)))) (=> (and (and (and (and (forall ((addr@@115 Int) ) (!  (=> (|$IsValid'address'| addr@@115) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@115)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@115)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@115)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@115)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.8351:20|
 :skolemid |273|
)) (forall ((addr@@116 Int) ) (!  (=> (|$IsValid'address'| addr@@116) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@116)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@116)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@116)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@116)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.8355:20|
 :skolemid |274|
))) (and (forall ((addr@@117 Int) ) (!  (=> (|$IsValid'address'| addr@@117) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@117)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@117)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@117)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@117)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.8359:20|
 :skolemid |275|
)) (forall ((addr@@118 Int) ) (!  (=> (|$IsValid'address'| addr@@118) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@118)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@118)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@118)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@118)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.8363:20|
 :skolemid |276|
)))) (and (and (forall ((addr@@119 Int) ) (!  (=> (|$IsValid'address'| addr@@119) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@119)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@119)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@119)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@119)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.8367:20|
 :skolemid |277|
)) (forall ((addr@@120 Int) ) (!  (=> (|$IsValid'address'| addr@@120) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@120) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@120)) 4))))
 :qid |ValidatorAdministrationScriptsbpl.8371:20|
 :skolemid |278|
))) (and (forall ((addr@@121 Int) ) (!  (=> (|$IsValid'address'| addr@@121) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@121) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@121) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@121)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.8375:20|
 :skolemid |279|
)) (forall ((addr@@122 Int) ) (!  (=> (|$IsValid'address'| addr@@122) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@122) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@122)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.8379:20|
 :skolemid |280|
))))) (and (and (and (forall ((addr@@123 Int) ) (!  (=> (|$IsValid'address'| addr@@123) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@123) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@123)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@123)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.8383:20|
 :skolemid |281|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_85237| $1_SlidingNonce_SlidingNonce_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_85237| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_85880| $1_DiemConfig_Configuration_$memory) 173345816)))) (and (and (forall ((config_address@@1 Int) ) (!  (=> (|$IsValid'address'| config_address@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address@@1) (= config_address@@1 173345816)))
 :qid |ValidatorAdministrationScriptsbpl.8399:20|
 :skolemid |282|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_87199| $1_DiemSystem_CapabilityHolder_$memory) 173345816)))) (and (forall ((addr@@124 Int) ) (!  (=> (|$IsValid'address'| addr@@124) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@124) (= addr@@124 173345816)))
 :qid |ValidatorAdministrationScriptsbpl.8407:20|
 :skolemid |283|
)) (let (($range_0@@37 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@125 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@125))))))))
(forall (($i_1@@37 Int) ) (!  (=> ($InRange $range_0@@37 $i_1@@37) (let ((i1@@3 $i_1@@37))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@126 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@126)))) i1@@3))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@126 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@126)))) i1@@3)))) 3))))
 :qid |ValidatorAdministrationScriptsbpl.8411:151|
 :skolemid |284|
))))))) (=> (and (and (and (and (and (and (let (($range_0@@38 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@127 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@127))))))))
(forall (($i_1@@38 Int) ) (!  (=> ($InRange $range_0@@38 $i_1@@38) (let ((i1@@4 $i_1@@38))
(= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@128 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@128)))) i1@@4)) 1)))
 :qid |ValidatorAdministrationScriptsbpl.8416:151|
 :skolemid |285|
))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_85979| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_92226| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_96466| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_96772| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_92290| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_96685| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_97657| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_97900| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_97836| $1_DualAttestation_Credential_$memory) addr1@@1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr1@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr1@@1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr1@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr1@@1)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.8453:20|
 :skolemid |286|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_86043| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_98970| $1_ChainId_ChainId_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_99316| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_99003| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_99003| $1_AccountFreezing_FreezingBit_$memory) 173345816)))))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_99003| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_99003| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_99316| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)))))) (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_100113| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_100506| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816))) (and (forall ((addr@@129 Int) ) (!  (=> (|$IsValid'address'| addr@@129) (= (|Select__T@[Int]Bool_| (|domain#$Memory_99483| $1_DiemAccount_DiemAccount_$memory) addr@@129) (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@129)))
 :qid |ValidatorAdministrationScriptsbpl.8489:20|
 :skolemid |287|
)) (forall ((addr@@130 Int) ) (!  (=> (|$IsValid'address'| addr@@130) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97281| $1_VASPDomain_VASPDomainManager_$memory) addr@@130)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@130)) 1))))
 :qid |ValidatorAdministrationScriptsbpl.8493:20|
 :skolemid |288|
)))) (and (and (forall ((addr@@131 Int) ) (!  (=> (|$IsValid'address'| addr@@131) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97380| $1_VASPDomain_VASPDomains_$memory) addr@@131)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@131)) 5))))
 :qid |ValidatorAdministrationScriptsbpl.8497:20|
 :skolemid |289|
)) (forall ((addr@@132 Int) ) (!  (=> (|$IsValid'address'| addr@@132) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_100248| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@132) (|Select__T@[Int]Bool_| (|domain#$Memory_100339| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@132)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@132)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@132)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@132)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.8501:20|
 :skolemid |290|
))) (and (forall ((addr@@133 Int) ) (!  (=> (|$IsValid'address'| addr@@133) (= (|Select__T@[Int]Bool_| (|domain#$Memory_98755| $1_DesignatedDealer_Dealer_$memory) addr@@133)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@133)) 2))))
 :qid |ValidatorAdministrationScriptsbpl.8505:20|
 :skolemid |291|
)) (forall ((addr@@134 Int) ) (!  (=> (|$IsValid'address'| addr@@134) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97836| $1_DualAttestation_Credential_$memory) addr@@134)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@134) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@134)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@134) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@134)) 5)))))
 :qid |ValidatorAdministrationScriptsbpl.8509:20|
 :skolemid |292|
))))) (and (and (and (forall ((addr@@135 Int) ) (!  (=> (|$IsValid'address'| addr@@135) (= (|Select__T@[Int]Bool_| (|domain#$Memory_85237| $1_SlidingNonce_SlidingNonce_$memory) addr@@135)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@135) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@135)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@135) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@135)) 1)))))
 :qid |ValidatorAdministrationScriptsbpl.8513:20|
 :skolemid |293|
)) (forall ((addr@@136 Int) ) (!  (=> (|$IsValid'address'| addr@@136) (= (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@136)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@136) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@136)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.8517:20|
 :skolemid |294|
))) (and (forall ((addr@@137 Int) ) (!  (=> (|$IsValid'address'| addr@@137) (= (|Select__T@[Int]Bool_| (|domain#$Memory_82585| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@137)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@137) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@137)) 4))))
 :qid |ValidatorAdministrationScriptsbpl.8521:20|
 :skolemid |295|
)) (forall ((addr@@138 Int) ) (!  (=> (|$IsValid'address'| addr@@138) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97477| $1_VASP_ParentVASP_$memory) addr@@138)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@138) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@138)) 5))))
 :qid |ValidatorAdministrationScriptsbpl.8525:20|
 :skolemid |296|
)))) (and (and (forall ((addr@@139 Int) ) (!  (=> (|$IsValid'address'| addr@@139) (= (|Select__T@[Int]Bool_| (|domain#$Memory_97413| $1_VASP_ChildVASP_$memory) addr@@139)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_82190| $1_Roles_RoleId_$memory) addr@@139) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) addr@@139)) 6))))
 :qid |ValidatorAdministrationScriptsbpl.8529:20|
 :skolemid |297|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_103005| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_86107| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_86171| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))))))) (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@2)) ($1_Signer_is_txn_signer _$t0@@2)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@2))) (and (and (|$IsValid'address'| _$t1@@2) (|$IsValid'vec'u8''| _$t2@@2)) (and (|$IsValid'vec'u8''| _$t3@@2) (|$IsValid'vec'u8''| _$t4@@0)))) (and (and (and (forall (($a_0@@16 Int) ) (! (let (($rsc@@16 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@16)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@16))
 :qid |ValidatorAdministrationScriptsbpl.8559:20|
 :skolemid |298|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@16))
)) (forall (($a_0@@17 Int) ) (! (let (($rsc@@17 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $a_0@@17)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@17))
 :qid |ValidatorAdministrationScriptsbpl.8563:20|
 :skolemid |299|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_82190| $1_Roles_RoleId_$memory) $a_0@@17))
))) (and (forall (($a_0@@18 Int) ) (! (let (($rsc@@18 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@18)))
 ...
 :qid |ValidatorAdministrationScriptsbpl.8567:20|
 :skolemid |300|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@18))
)) (forall (($a_0@@19 Int) ) (! (let (($rsc@@19 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_85880| $1_DiemConfig_Configuration_$memory) $a_0@@19)))
(|$IsValid'$1_DiemConfig_Configuration'| $rsc@@19))
 :qid |ValidatorAdministrationScriptsbpl.8571:20|
 :skolemid |301|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_85880| $1_DiemConfig_Configuration_$memory) $a_0@@19))
)))) (and (and (forall (($a_0@@20 Int) ) (! (let (($rsc@@20 (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@20)))
(|$IsValid'$1_DiemConfig_DisableReconfiguration'| $rsc@@20))
 :qid |ValidatorAdministrationScriptsbpl.8575:20|
 :skolemid |302|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_85768| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@20))
)) (forall (($a_0@@21 Int) ) (! (let (($rsc@@21 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@21)))
...
(forall (($i_3@@3 Int) ($i_4@@1 Int) ) (!  (=> ($InRange $range_1@@1 $i_3@@3) (=> ($InRange $range_2@@3 $i_4@@1) (let ((i@@53 $i_3@@3))
(let ((j@@11 $i_4@@1))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@21)) i@@53)) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@21)) j@@11))) (= i@@53 j@@11))))))
 :qid |ValidatorAdministrationScriptsbpl.8580:367|
 :skolemid |303|
))))))
 :qid |ValidatorAdministrationScriptsbpl.8579:20|
 :skolemid |304|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@21))
))) (and (forall (($a_0@@22 Int) ) (! (let (($rsc@@22 (|Select__T@[Int]$1_DiemSystem_CapabilityHolder_| (|contents#$Memory_87199| $1_DiemSystem_CapabilityHolder_$memory) $a_0@@22)))
(|$IsValid'$1_DiemSystem_CapabilityHolder'| $rsc@@22))
 :qid |ValidatorAdministrationScriptsbpl.8585:20|
 :skolemid |305|
 :pattern ( (|Select__T@[Int]$1_DiemSystem_CapabilityHolder_| (|contents#$Memory_87199| $1_DiemSystem_CapabilityHolder_$memory) $a_0@@22))
)) (= $t5@@0 (let (($range_0@@39 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@140 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@140))))))
(exists (($i_1@@39 Int) ) (!  (and (and (>= $i_1@@39 0) (< $i_1@@39 (seq.len $range_0@@39))) (let ((v_info@@1 (seq.nth $range_0@@39 $i_1@@39)))
 ...
 :qid |ValidatorAdministrationScriptsbpl.8590:140|
 :skolemid |306|
)))))))) (and (and (and (and (= $t6@@2 ($choice_0 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@141 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@141)))) _$t1@@2)) (= $t7@@1 (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@142 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@142)))) $t6@@2)))) (and (= $t8@@1 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@143 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_85687| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@143))))) (= $t9@@1 (|$addr#$signer| _$t0@@2)))) (and (and (= $t10@@1 (|$addr#$signer| _$t0@@2)) (= $t11@@1 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_85880| $1_DiemConfig_Configuration_$memory) 173345816))) (and (= $t12@@1 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t13@@1 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_85880| $1_DiemConfig_Configuration_$memory) 173345816))))) (and (and (and (= $t14@@1 (|$events#$1_DiemConfig_Configuration| $t13@@1)) (let ((addr@@144 (|$addr#$signer| _$t0@@2)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_82009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_99483| $1_DiemAccount_DiemAccount_$memory) addr@@144)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_99003| $1_AccountFreezing_FreezingBit_$memory) addr@@144) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_99003| $1_AccountFreezing_FreezingBit_$memory) addr@@144))))))) (and (= _$t0@@2 _$t0@@2) (= _$t1@@2 _$t1@@2))) (and (and (= _$t2@@2 _$t2@@2) (= _$t3@@2 _$t3@@2)) (and (= _$t4@@0 _$t4@@0) (= $t15@@1  (or (or (or (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@41 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@41)) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2@@2))) (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_83469| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@2)))))))))) (and (=> (= (ControlFlow 0 142727) 145077) anon15_Then_correct) (=> (= (ControlFlow 0 142727) 142735) anon15_Else_correct)))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@13 T@$1_Event_EventHandle) ) (! (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_54442_| (|streams#$EventStore| $es) handle@@13)))
 (and (= (|l#Multiset_54442| stream@@15) 0) (forall ((v@@67 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_54442| stream@@15) v@@67) 0)
 :qid |ValidatorAdministrationScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |ValidatorAdministrationScriptsbpl.2552:13|
 :skolemid |69|
))) (= (ControlFlow 0 141104) 142727)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 163209) 141104) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2)))))))))))))))))
))
(check-sat)
(pop 1)
