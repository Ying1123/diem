...
(assert (not
 (=> (= (ControlFlow 0 0) 101123) (let ((anon12_Else_correct@@0  (=> (and (and (not $abort_flag@0@@0) (= $t8@1 $t8@1)) (and (= $t9@0 (|$human_name#$1_ValidatorConfig_ValidatorConfig| $t8@1)) (= $t9@0 $t9@0))) (and (=> (= (ControlFlow 0 85140) (- 0 101539)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@0))) (=> (= (ControlFlow 0 85140) (- 0 101550)) (|$IsEqual'vec'u8''| $t9@0 (let ((t_ref (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@0)))
(|$human_name#$1_ValidatorConfig_ValidatorConfig| t_ref)))))))))
(let ((L3_correct@@0  (and (=> (= (ControlFlow 0 85068) (- 0 101484)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@0)) (=> (= (ControlFlow 0 85068) (- 0 101490)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@0)) (= 5 $t7@0)))))))
(let ((anon12_Then_correct@@0  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= $t7@0 $abort_code@1@@0) (= (ControlFlow 0 85154) 85068))) L3_correct@@0)))
(let ((anon11_Then$1_correct@@0  (=> (= $t8@1 $t8) (=> (and (= $abort_flag@0@@0 true) (= $abort_code@1@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 85206) 85154) anon12_Then_correct@@0) (=> (= (ControlFlow 0 85206) 85140) anon12_Else_correct@@0))))))
(let ((anon11_Then_correct@@0  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@0)) (= (ControlFlow 0 85204) 85206)) anon11_Then$1_correct@@0)))
(let ((anon11_Else_correct@@0  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@0) (=> (and (and (= $t8@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@0)) (= $t8@1 $t8@0)) (and (= $abort_flag@0@@0 false) (= $abort_code@1@@0 $abort_code@0@@0))) (and (=> (= (ControlFlow 0 85086) 85154) anon12_Then_correct@@0) (=> (= (ControlFlow 0 85086) 85140) anon12_Else_correct@@0))))))
(let ((anon10_Then_correct@@0  (=> $t4@0 (and (=> (= (ControlFlow 0 85072) 85204) anon11_Then_correct@@0) (=> (= (ControlFlow 0 85072) 85086) anon11_Else_correct@@0)))))
(let ((anon10_Else_correct@@0  (=> (and (and (not $t4@0) (= $t6 $t6)) (and (= $t7@0 $t6) (= (ControlFlow 0 85036) 85068))) L3_correct@@0)))
(let ((anon0$1_correct@@0  (=> (forall ((addr@@45 Int) ) (!  (=> (|$IsValid'address'| addr@@45) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@45) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@45) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@45)) 3))))
 :qid |ValidatorConfigbpl.3334:20|
 :skolemid |136|
)) (=> (and (and (forall ((addr@@46 Int) ) (!  (=> (|$IsValid'address'| addr@@46) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@46) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@46) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@46)) 3))))
 :qid |ValidatorConfigbpl.3338:20|
 :skolemid |137|
)) (forall ((addr@@47 Int) ) (!  (=> (|$IsValid'address'| addr@@47) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@47) (not (= (|l#Vec_34709| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@47)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@47) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@47)) 3))))
 :qid |ValidatorConfigbpl.3342:20|
 :skolemid |138|
))) (and (forall ((addr@@48 Int) ) (!  (=> (|$IsValid'address'| addr@@48) (= (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@48)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@48) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@48)) 3))))
 :qid |ValidatorConfigbpl.3346:20|
 :skolemid |139|
)) (|$IsValid'address'| _$t0@@0))) (=> (and (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@0)))
...
)) (= _$t0@@0 _$t0@@0)) (and (= $t4@0 (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0@@0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t6) (= $t6 5)) (and (= $t6 $t6) (= $t4@0 $t4@0)))) (and (=> (= (ControlFlow 0 85020) 85072) anon10_Then_correct@@0) (=> (= (ControlFlow 0 85020) 85036) anon10_Else_correct@@0)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_34623_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_34623| stream@@1) 0) (forall ((v@@37 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_34623| stream@@1) v@@37) 0)
 :qid |ValidatorConfigbpl.159:13|
 :skolemid |4|
))))
 :qid |ValidatorConfigbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 84812) 85020)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 101123) 84812) inline$$InitEventStore$0$anon0_correct@@0)))
anon0_correct@@0))))))))))))
))
(check-sat)
(pop 1)
