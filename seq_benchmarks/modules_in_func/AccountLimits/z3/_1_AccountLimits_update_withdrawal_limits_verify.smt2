...
(assert (not
 ...
 :qid |AccountLimitsbpl.16669:15|
 :skolemid |585|
)) (and (=> (= (ControlFlow 0 249645) (- 0 300818)) (forall ((window_addr@@1 Int) ) (!  (=> (|$IsValid'address'| window_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@0|) window_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@0|) window_addr@@1)))))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 248112) 248692)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (seq.len (|p#$Mutation_119553| $t9)) 0) (= (ControlFlow 0 248122) 248112)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 299406) 248122) anon0_correct)))
