...
(let ((anon22_Then_correct@@7  (=> $abort_flag@1 (=> (and (= $abort_code@2 $abort_code@2) (= (ControlFlow 0 547195) 547205)) L9_correct))))
(let ((anon20_Then_correct@@6  (=> $abort_flag@0@@25 (=> (and (= $abort_code@1@@25 $abort_code@1@@25) (= (ControlFlow 0 547271) 547205)) L9_correct))))
(let ((anon22_Else_correct@@7  (=> (and (not $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 547181) (- 0 874194)) (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (=> (= (ControlFlow 0 547181) (- 0 874201)) (let (($range_0@@44 ($Range 0 inline$$AddU64$0$dst@2)))
(forall (($i_1@@38 Int) ) (!  (=> ($InRange $range_0@@44 $i_1@@38) (let ((j@@24 $i_1@@38))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 j@@24)) _$t1@@23))))
 :qid |DiemSystembpl.20173:49|
 :skolemid |621|
)))))))))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 547112) 547195) anon22_Then_correct@@7) (=> (= (ControlFlow 0 547112) 547181) anon22_Else_correct@@7))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t8@0@@1 1) $MAX_U64) (= (ControlFlow 0 547110) 547112)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t8@0@@1 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t8@0@@1 1)) (= $abort_code@2 $abort_code@1@@25)) (and (= $abort_flag@1 $abort_flag@0@@25) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 547058) 547195) anon22_Then_correct@@7) (=> (= (ControlFlow 0 547058) 547181) anon22_Else_correct@@7))))))
(let ((anon21_Else_correct@@6  (=> (and (not $t12@1) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 547118) 547110) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 547118) 547058) inline$$AddU64$0$anon3_Else_correct)))))
(let ((L8_correct@@0  (and (=> (= (ControlFlow 0 546782) (- 0 873970)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 546782) (- 0 873977)) (=> (let (($range_0@@45 ($Range 0 $t5@@17)))
(forall (($i_1@@39 Int) ) (!  (=> ($InRange $range_0@@45 $i_1@@39) (let ((i@@82 $i_1@@39))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 i@@82)) _$t1@@23))))
 :qid |DiemSystembpl.20192:49|
 :skolemid |622|
))) (= (seq.len (|$vec#$1_Option_Option'u64'| $t16@0@@5)) 0))) (=> (=> (let (($range_0@@46 ($Range 0 $t5@@17)))
(forall (($i_1@@40 Int) ) (!  (=> ($InRange $range_0@@46 $i_1@@40) (let ((i@@83 $i_1@@40))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 i@@83)) _$t1@@23))))
 :qid |DiemSystembpl.20192:49|
 :skolemid |622|
))) (= (seq.len (|$vec#$1_Option_Option'u64'| $t16@0@@5)) 0)) (and (=> (= (ControlFlow 0 546782) (- 0 874020)) (=> (let (($range_0@@47 ($Range 0 $t5@@17)))
(exists (($i_1@@41 Int) ) (!  (and ($InRange $range_0@@47 $i_1@@41) (let ((i@@84 $i_1@@41))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 i@@84)) _$t1@@23)))
 :qid |DiemSystembpl.20198:49|
 :skolemid |623|
))) (and (not (= (seq.len (|$vec#$1_Option_Option'u64'| $t16@0@@5)) 0)) (let ((at@@0 (seq.nth (|$vec#$1_Option_Option'u64'| $t16@0@@5) 0)))
(= at@@0 ($choice_0 _$t0@@26 _$t1@@23)))))) (=> (=> (let (($range_0@@48 ($Range 0 $t5@@17)))
(exists (($i_1@@42 Int) ) (!  (and ($InRange $range_0@@48 $i_1@@42) (let ((i@@85 $i_1@@42))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 i@@85)) _$t1@@23)))
 :qid |DiemSystembpl.20198:49|
 :skolemid |623|
))) (and (not (= (seq.len (|$vec#$1_Option_Option'u64'| $t16@0@@5)) 0)) (let ((at@@1 (seq.nth (|$vec#$1_Option_Option'u64'| $t16@0@@5) 0)))
(= at@@1 ($choice_0 _$t0@@26 _$t1@@23))))) (=> (= (ControlFlow 0 546782) (- 0 874076)) (= (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@476 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@476)))) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@477 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@477))))))))))))))
(let ((anon21_Then_correct@@6  (=> $t12@1 (and (=> (= (ControlFlow 0 547257) (- 0 873913)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 $t8@0@@1)) _$t1@@23)) (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 $t8@0@@1)) _$t1@@23) (=> (and (|$IsValid'$1_Option_Option'u64''| $t15@@13) (<= (seq.len (|$vec#$1_Option_Option'u64'| $t15@@13)) 1)) (=> (and (and (= $t15@@13 (|$1_Option_Option'u64'| (seq.unit $t8@0@@1))) (= $t15@@13 $t15@@13)) (and (= $t16@0@@5 $t15@@13) (= (ControlFlow 0 547257) 546782))) L8_correct@@0)))))))
(let ((anon20_Else_correct@@6  (=> (and (and (not $abort_flag@0@@25) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2@@1| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2@@1|)) (and (= $t11@1 (|$addr#$1_DiemSystem_ValidatorInfo| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2@@1|)) (= $t12@1 (= $t11@1 _$t1@@23)))) (and (=> (= (ControlFlow 0 546953) 547257) anon21_Then_correct@@6) (=> (= (ControlFlow 0 546953) 547118) anon21_Else_correct@@6)))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct@@1|  (=> (= $abort_flag@0@@25 true) (=> (and (= $abort_code@1@@25 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2@@1| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@0@@1|)) (and (=> (= (ControlFlow 0 546921) 547271) anon20_Then_correct@@6) (=> (= (ControlFlow 0 546921) 546953) anon20_Else_correct@@6))))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct@@1|  (=> (and (not (and (>= $t8@0@@1 0) (< $t8@0@@1 (seq.len _$t0@@26)))) (= (ControlFlow 0 546919) 546921)) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct@@1|)))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct@@1|  (=> (and (>= $t8@0@@1 0) (< $t8@0@@1 (seq.len _$t0@@26))) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1@@1| (seq.nth _$t0@@26 $t8@0@@1)) (= $abort_flag@0@@25 false)) (and (= $abort_code@1@@25 $abort_code@0@@25) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2@@1| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1@@1|))) (and (=> (= (ControlFlow 0 546869) 547271) anon20_Then_correct@@6) (=> (= (ControlFlow 0 546869) 546953) anon20_Else_correct@@6))))))
(let ((anon19_Then_correct@@15  (=> inline$$Lt$0$dst@1@@2 (and (=> (= (ControlFlow 0 546927) 546919) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct@@1|) (=> (= (ControlFlow 0 546927) 546869) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct@@1|)))))
(let ((anon19_Else_correct@@15  (=> (not inline$$Lt$0$dst@1@@2) (and (=> (= (ControlFlow 0 546654) (- 0 873722)) (= $t8@0@@1 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (= $t8@0@@1 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (and (=> (= (ControlFlow 0 546654) (- 0 873729)) (let (($range_0@@49 ($Range 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)))
(forall (($i_1@@43 Int) ) (!  (=> ($InRange $range_0@@49 $i_1@@43) (let ((j@@25 $i_1@@43))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 j@@25)) _$t1@@23))))
 :qid |DiemSystembpl.20137:48|
 :skolemid |620|
)))) (=> (let (($range_0@@50 ($Range 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)))
(forall (($i_1@@44 Int) ) (!  (=> ($InRange $range_0@@50 $i_1@@44) (let ((j@@26 $i_1@@44))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 j@@26)) _$t1@@23))))
 :qid |DiemSystembpl.20137:48|
 :skolemid |620|
))) (=> (and (|$IsValid'$1_Option_Option'u64''| $t17@@6) (<= (seq.len (|$vec#$1_Option_Option'u64'| $t17@@6)) 1)) (=> (and (and (= $t17@@6 (|$1_Option_Option'u64'| (as seq.empty (Seq Int)))) (= $t17@@6 $t17@@6)) (and (= $t16@0@@5 $t17@@6) (= (ControlFlow 0 546654) 546782))) L8_correct@@0)))))))))
(let ((anon18_Else$1_correct  (and (=> (= (ControlFlow 0 546569) 546927) anon19_Then_correct@@15) (=> (= (ControlFlow 0 546569) 546654) anon19_Else_correct@@15))))
(let ((inline$$Lt$0$anon0_correct@@2  (=> (and (= inline$$Lt$0$dst@1@@2 (< $t8@0@@1 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (= (ControlFlow 0 546559) 546569)) anon18_Else$1_correct)))
(let ((anon18_Else_correct@@15  (=> (and (and (not false) (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (and (|$IsValid'u64'| 0) (= 0 0))) (and (=> (= (ControlFlow 0 546565) (- 0 873560)) (<= 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (<= 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (and (=> (= (ControlFlow 0 546565) (- 0 873567)) (let (($range_0@@51 ($Range 0 0)))
(forall (($i_1@@45 Int) ) (!  (=> ($InRange $range_0@@51 $i_1@@45) (let ((j@@27 $i_1@@45))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 j@@27)) _$t1@@23))))
 :qid |DiemSystembpl.19984:48|
 :skolemid |618|
)))) (=> (let (($range_0@@52 ($Range 0 0)))
(forall (($i_1@@46 Int) ) (!  (=> ($InRange $range_0@@52 $i_1@@46) (let ((j@@28 $i_1@@46))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 j@@28)) _$t1@@23))))
 :qid |DiemSystembpl.19984:48|
 :skolemid |618|
))) (=> (|$IsValid'u64'| $t8@0@@1) (=> (and (and (and (|$IsValid'$1_DiemSystem_ValidatorInfo'| $t10@0) (|$IsValid'address'| $t11@0@@10)) (and (|$IsValid'u64'| $t13@0@@5) (|$IsValid'u64'| $t14@0@@9))) (and (and (not false) (<= $t8@0@@1 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (and (let (($range_0@@53 ($Range 0 $t8@0@@1)))
(forall (($i_1@@47 Int) ) (!  (=> ($InRange $range_0@@53 $i_1@@47) (let ((j@@29 $i_1@@47))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth _$t0@@26 j@@29)) _$t1@@23))))
 :qid |DiemSystembpl.20024:53|
 :skolemid |619|
))) (= (ControlFlow 0 546565) 546559)))) inline$$Lt$0$anon0_correct@@2)))))))))
(let ((anon18_Then_correct@@15 true))
(let ((|inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| (seq.len _$t0@@26)) (and (=> (= (ControlFlow 0 546355) 547285) anon18_Then_correct@@15) (=> (= (ControlFlow 0 546355) 546565) anon18_Else_correct@@15)))))
(let ((anon0$1_correct@@27  (=> (and (|$IsValid'vec'$1_DiemSystem_ValidatorInfo''| _$t0@@26) (|$IsValid'address'| _$t1@@23)) (=> (and (and (= $t5@@17 (seq.len _$t0@@26)) (= _$t0@@26 _$t0@@26)) (and (= _$t1@@23 _$t1@@23) (= (ControlFlow 0 546361) 546355))) |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct@@27  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@47 T@$1_Event_EventHandle) ) (! (let ((stream@@57 (|Select__T@[$1_Event_EventHandle]Multiset_200533_| (|streams#$EventStore| $es) handle@@47)))
 (and (= (|l#Multiset_200533| stream@@57) 0) (forall ((v@@108 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_200533| stream@@57) v@@108) 0)
 :qid |DiemSystembpl.134:13|
 :skolemid |2|
))))
 :qid |DiemSystembpl.3452:13|
 :skolemid |94|
))) (= (ControlFlow 0 546275) 546361)) anon0$1_correct@@27)))
(let ((anon0_correct@@27  (=> (= (ControlFlow 0 873354) 546275) inline$$InitEventStore$0$anon0_correct@@27)))
anon0_correct@@27)))))))))))))))))))))))))
))
(check-sat)
(pop 1)
