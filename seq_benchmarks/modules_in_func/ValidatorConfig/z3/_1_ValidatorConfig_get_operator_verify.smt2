...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 255155) (let ((anon19_Else_correct  (=> (and (and (not $t17) (|$IsValid'address'| $t16)) (and (= $t16 (seq.nth (|$vec#$1_Option_Option'address'| $t15@0) 0)) (= $t16 $t16))) (and (=> (= (ControlFlow 0 188150) (- 0 255700)) (not (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))))) (=> (not (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0)))) (and (=> (= (ControlFlow 0 188150) (- 0 255711)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0))) (and (=> (= (ControlFlow 0 188150) (- 0 255722)) (= $t16 (let ((t_ref (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref)) 0)))) (=> (= $t16 (let ((t_ref@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0)) 0))) (=> (= (ControlFlow 0 188150) (- 0 255734)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1) (= (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr1)))))
 :qid |ValidatorConfigbpl.7392:15|
 :skolemid |206|
))))))))))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 187939) (- 0 255625)) (or (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) (=> (or (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0))) (=> (= (ControlFlow 0 187939) (- 0 255639)) (or (and (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))) (= 7 $t9@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= 5 $t9@0))))))))
(let ((anon19_Then_correct  (=> $t17 (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'address'| $t15@0)) 0) (= 7 $t9)) (= $t9 $t9)) (and (= $t9@0 $t9) (= (ControlFlow 0 188174) 187939))) L5_correct))))
(let ((anon18_Then_correct  (=> $t12 (=> (and (= $t15@0 (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $t10@1)) (= $t17 (= (seq.len (|$vec#$1_Option_Option'address'| $t15@0)) 0))) (and (=> (= (ControlFlow 0 188049) 188174) anon19_Then_correct) (=> (= (ControlFlow 0 188049) 188150) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (and (not $t12) (= $t14 $t14)) (and (= $t9@0 $t14) (= (ControlFlow 0 188033) 187939))) L5_correct)))
(let ((anon17_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= $t10@1 $t10@1) (= $t11@0 (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $t10@1))) (and (= $t12  (not (= (seq.len (|$vec#$1_Option_Option'address'| $t11@0)) 0))) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14) (= $t14 7)) (and (= $t14 $t14) (= $t12 $t12)))) (and (=> (= (ControlFlow 0 188017) 188049) anon18_Then_correct) (=> (= (ControlFlow 0 188017) 188033) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t9@0 $abort_code@1) (= (ControlFlow 0 188188) 187939))) L5_correct)))
(let ((anon16_Then$1_correct  (=> (= $t10@1 $t10) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 188240) 188188) anon17_Then_correct) (=> (= (ControlFlow 0 188240) 188017) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (ControlFlow 0 188238) 188240)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (=> (and (and (= $t10@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= $t10@1 $t10@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 187957) 188188) anon17_Then_correct) (=> (= (ControlFlow 0 187957) 188017) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t6@0 (and (=> (= (ControlFlow 0 187943) 188238) anon16_Then_correct) (=> (= (ControlFlow 0 187943) 187957) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not $t6@0) (= $t8 $t8)) (and (= $t9@0 $t8) (= (ControlFlow 0 187879) 187939))) L5_correct)))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105364| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105364| $1_Roles_RoleId_$memory) addr@@0)) 3))))
 :qid |ValidatorConfigbpl.7179:20|
 :skolemid |202|
)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105364| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105364| $1_Roles_RoleId_$memory) addr@@1)) 3))))
 :qid |ValidatorConfigbpl.7183:20|
 :skolemid |203|
 ...
 :qid |ValidatorConfigbpl.7187:20|
 :skolemid |204|
)) (|$IsValid'address'| _$t0))) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0)))
 ...
 :qid |ValidatorConfigbpl.7194:20|
 :skolemid |205|
...
)) (= _$t0 _$t0)) (and (= $t6@0 (|Select__T@[Int]Bool_| (|domain#$Memory_107408| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t8) (= $t8 5)) (and (= $t8 $t8) (= $t6@0 $t6@0)))) (and (=> (= (ControlFlow 0 187863) 187943) anon15_Then_correct) (=> (= (ControlFlow 0 187863) 187879) anon15_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_76195_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2548:13|
 :skolemid |69|
))) (= (ControlFlow 0 187678) 187863)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 255155) 187678) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
