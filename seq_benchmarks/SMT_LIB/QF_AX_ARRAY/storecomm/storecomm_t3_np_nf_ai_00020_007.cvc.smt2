...
(assert (not (= i1 i3)))
(assert (not (= i1 i2)))
(assert (let ((?v_0 (store a1 i1 e1))) (not (= (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store ?v_0 i2 e2) i3 e3) i4 e4) i5 e5) i6 e6) i7 e7) i8 e8) i9 e9) i10 e10) i11 e11) i12 e12) i13 e13) i14 e14) i15 e15) i16 e16) i17 e17) i18 e18) i19 e19) i20 e20) (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store (store ?v_0 i10 e10) i17 e17) i3 e3) i11 e11) i12 e12) i16 e16) i6 e6) i19 e19) i4 e4) i14 e14) i5 e5) i9 e9) i18 e18) i20 e20) i13 e13) i15 e15) i2 e2) i8 e8) i7 e7)))))
(check-sat)
(exit)
